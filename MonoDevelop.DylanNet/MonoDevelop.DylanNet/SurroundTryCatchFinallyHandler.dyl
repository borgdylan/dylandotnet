...
namespace MonoDevelop.DylanNet
	...
	class public auto ansi SurroundTryCatchFinallyHandler extends CommandHandler
		...
		method family override void Run()
		    ...
		    if !string::IsNullOrEmpty(textEditorData::get_SelectedText()) then
		    	...
		    	::Append(c"catch ex as Exception\n")::Append(indent)::Append(c"finally\n")::Append(indent)::Append("end try")
