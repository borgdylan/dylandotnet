...
Dim MakeNameparam00 As ParameterBuilder = MakeName.DefineParameter(0, ParameterAttributes.RetVal, "")
...
Dim MakeNodeparam00 As ParameterBuilder = MakeNode.DefineParameter(0, ParameterAttributes.RetVal, "")
...
Dim MakeAttrparam00 As ParameterBuilder = MakeAttr.DefineParameter(0, ParameterAttributes.RetVal, "")
...
Dim AddAttrArrparam00 As ParameterBuilder = AddAttrArr.DefineParameter(0, ParameterAttributes.RetVal, "")
...
Dim AddNodeparam00 As ParameterBuilder = AddNode.DefineParameter(0, ParameterAttributes.RetVal, "")
...
Dim AddNodeArrparam00 As ParameterBuilder = AddNodeArr.DefineParameter(0, ParameterAttributes.RetVal, "")
...
Dim SetValparam00 As ParameterBuilder = SetVal.DefineParameter(0, ParameterAttributes.RetVal, "")
...
Dim GetValparam00 As ParameterBuilder = GetVal.DefineParameter(0, ParameterAttributes.RetVal, "")
...
Dim XPathSelectElparam00 As ParameterBuilder = XPathSelectEl.DefineParameter(0, ParameterAttributes.RetVal, "")
...
Dim remelemparam00 As ParameterBuilder = remelem.DefineParameter(0, ParameterAttributes.RetVal, "")
...
Dim StringParserparam00 As ParameterBuilder = StringParser.DefineParameter(0, ParameterAttributes.RetVal, "")
...
Dim StringParser2dsparam00 As ParameterBuilder = StringParser2ds.DefineParameter(0, ParameterAttributes.RetVal, "")
...
Dim LikeOPparam00 As ParameterBuilder = LikeOP.DefineParameter(0, ParameterAttributes.RetVal, "")
...
Dim locbldr45 As LocalBuilder = LikeOPIL.DeclareLocal(GetType(CompareMethod))
locbldr45.SetLocalSymInfo("binmet")
LikeOPIL.Emit(OpCodes.Ldc_I4, CInt(0))
Typ = GetType(System.Int32)
LikeOPIL.Emit(OpCodes.Stloc, 0)
LikeOPIL.MarkSequencePoint(doc4, 266, 1, 266, 100)
Dim locbldr46 As LocalBuilder = LikeOPIL.DeclareLocal(GetType(System.Boolean))
locbldr46.SetLocalSymInfo("likefunc")
Dim typ28(-1) As Type
...
ReDim Preserve typ28(UBound(typ28) + 1)
typ28(UBound(typ28)) = Typ
LikeOPIL.Emit(OpCodes.Call, GetType(LikeOperator).GetMethod("LikeString", typ28))
Typ = GetType(LikeOperator).GetMethod("LikeString", typ28).ReturnType
LikeOPIL.Emit(OpCodes.Stloc, 1)
LikeOPIL.MarkSequencePoint(doc4, 268, 1, 268, 100)
LikeOPIL.Emit(OpCodes.Ldloc, 1)
Typ = GetType(System.Boolean)
LikeOPIL.MarkSequencePoint(doc4, 270, 1, 270, 100)
...
Dim RetPrecparam00 As ParameterBuilder = RetPrec.DefineParameter(0, ParameterAttributes.RetVal, "")
Dim RetPrecparam01 As ParameterBuilder = RetPrec.DefineParameter(1, ParameterAttributes.None, "chr")
RetPrecIL.MarkSequencePoint(doc4, 273, 1, 273, 100)
Dim label11 As System.Reflection.Emit.Label = RetPrecIL.DefineLabel()
RetPrecIL.MarkSequencePoint(doc4, 275, 1, 275, 100)
Dim locbldr47 As LocalBuilder = RetPrecIL.DeclareLocal(GetType(System.Int32))
locbldr47.SetLocalSymInfo("comp")
...
RetPrecIL.MarkSequencePoint(doc4, 278, 1, 278, 100)
Dim locbldr50 As LocalBuilder = RetPrecIL.DeclareLocal(GetType(System.Boolean))
locbldr50.SetLocalSymInfo("b3")
RetPrecIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
...
Sub WinApi()
Dim WinApi As TypeBuilder = mdl.DefineType("dylan.NET.Utils" & "." & "WinApi", TypeAttributes.Public Or TypeAttributes.AutoLayout Or TypeAttributes.AnsiClass, GetType(System.Object))
Dim typ0(-1) As Type
ReDim Preserve typ0(UBound(typ0) + 1)
typ0(UBound(typ0)) = GetType(System.Int32)
Dim MessageBeep As MethodBuilder = WinApi.DefinePInvokeMethod("MessageBeep", "user32.dll", MethodAttributes.Public Or MethodAttributes.Static Or MethodAttributes.PinvokeImpl, CallingConventions.Standard , GetType(System.Boolean), typ0, System.Runtime.InteropServices.CallingConvention.Winapi, System.Runtime.InteropServices.CharSet.Auto)
MessageBeep.SetImplementationFlags(MessageBeep.GetMethodImplementationFlags() Or MethodImplAttributes.PreserveSig)
Dim MessageBeepparam00 As ParameterBuilder = MessageBeep.DefineParameter(0, ParameterAttributes.RetVal, "")
Dim MessageBeepparam01 As ParameterBuilder = MessageBeep.DefineParameter(1, ParameterAttributes.In, "uType")
Dim MessageBeepparam00MAType As Type = GetType(System.Runtime.InteropServices.MarshalAsAttribute)
Dim MessageBeepparam00MACtor As ConstructorInfo = MessageBeepparam00MAType.GetConstructor(New Type() { GetType(System.Runtime.InteropServices.UnmanagedType) })
Dim MessageBeepparam00MABuilder As CustomAttributeBuilder = New CustomAttributeBuilder(MessageBeepparam00MACtor, New Object() {System.Runtime.InteropServices.UnmanagedType.Bool})
MessageBeepparam00.SetCustomAttribute(MessageBeepparam00MABuilder)
...
ReDim Preserve typ1(UBound(typ1) + 1)
typ1(UBound(typ1)) = GetType(System.Int32)
Dim Beep As MethodBuilder = WinApi.DefinePInvokeMethod("Beep", "kernel32.dll", MethodAttributes.Public Or MethodAttributes.Static Or MethodAttributes.PinvokeImpl, CallingConventions.Standard , GetType(System.Boolean), typ1, System.Runtime.InteropServices.CallingConvention.Winapi, System.Runtime.InteropServices.CharSet.Auto)
Beep.SetImplementationFlags(Beep.GetMethodImplementationFlags() Or MethodImplAttributes.PreserveSig)
Dim Beepparam00 As ParameterBuilder = Beep.DefineParameter(0, ParameterAttributes.RetVal, "")
Dim Beepparam01 As ParameterBuilder = Beep.DefineParameter(1, ParameterAttributes.In, "dwFreq")
Dim Beepparam02 As ParameterBuilder = Beep.DefineParameter(2, ParameterAttributes.In, "dwDuration")
Dim Beepparam00MAType As Type = GetType(System.Runtime.InteropServices.MarshalAsAttribute)
Dim Beepparam00MACtor As ConstructorInfo = Beepparam00MAType.GetConstructor(New Type() { GetType(System.Runtime.InteropServices.UnmanagedType) })
Dim Beepparam00MABuilder As CustomAttributeBuilder = New CustomAttributeBuilder(Beepparam00MACtor, New Object() {System.Runtime.InteropServices.UnmanagedType.Bool})
Beepparam00.SetCustomAttribute(Beepparam00MABuilder)

Dim FreeConsole As MethodBuilder = WinApi.DefinePInvokeMethod("FreeConsole", "kernel32.dll", MethodAttributes.Public Or MethodAttributes.Static Or MethodAttributes.PinvokeImpl, CallingConventions.Standard , GetType(System.Boolean), Type.EmptyTypes, System.Runtime.InteropServices.CallingConvention.Winapi, System.Runtime.InteropServices.CharSet.Auto)
FreeConsole.SetImplementationFlags(FreeConsole.GetMethodImplementationFlags() Or MethodImplAttributes.PreserveSig)
Dim FreeConsoleparam00 As ParameterBuilder = FreeConsole.DefineParameter(0, ParameterAttributes.RetVal, "")
Dim FreeConsoleparam00MAType As Type = GetType(System.Runtime.InteropServices.MarshalAsAttribute)
Dim FreeConsoleparam00MACtor As ConstructorInfo = FreeConsoleparam00MAType.GetConstructor(New Type() { GetType(System.Runtime.InteropServices.UnmanagedType) })
Dim FreeConsoleparam00MABuilder As CustomAttributeBuilder = New CustomAttributeBuilder(FreeConsoleparam00MACtor, New Object() {System.Runtime.InteropServices.UnmanagedType.Bool})
FreeConsoleparam00.SetCustomAttribute(FreeConsoleparam00MABuilder)

Dim AllocConsole As MethodBuilder = WinApi.DefinePInvokeMethod("AllocConsole", "kernel32.dll", MethodAttributes.Public Or MethodAttributes.Static Or MethodAttributes.PinvokeImpl, CallingConventions.Standard , GetType(System.Boolean), Type.EmptyTypes, System.Runtime.InteropServices.CallingConvention.Winapi, System.Runtime.InteropServices.CharSet.Auto)
AllocConsole.SetImplementationFlags(AllocConsole.GetMethodImplementationFlags() Or MethodImplAttributes.PreserveSig)
Dim AllocConsoleparam00 As ParameterBuilder = AllocConsole.DefineParameter(0, ParameterAttributes.RetVal, "")
Dim AllocConsoleparam00MAType As Type = GetType(System.Runtime.InteropServices.MarshalAsAttribute)
Dim AllocConsoleparam00MACtor As ConstructorInfo = AllocConsoleparam00MAType.GetConstructor(New Type() { GetType(System.Runtime.InteropServices.UnmanagedType) })
Dim AllocConsoleparam00MABuilder As CustomAttributeBuilder = New CustomAttributeBuilder(AllocConsoleparam00MACtor, New Object() {System.Runtime.InteropServices.UnmanagedType.Bool})
AllocConsoleparam00.SetCustomAttribute(AllocConsoleparam00MABuilder)

Dim typ2(-1) As Type
ReDim Preserve typ2(UBound(typ2) + 1)
typ2(UBound(typ2)) = GetType(System.Int32)
Dim AttachConsole As MethodBuilder = WinApi.DefinePInvokeMethod("AttachConsole", "kernel32.dll", MethodAttributes.Public Or MethodAttributes.Static Or MethodAttributes.PinvokeImpl, CallingConventions.Standard , GetType(System.Boolean), typ2, System.Runtime.InteropServices.CallingConvention.Winapi, System.Runtime.InteropServices.CharSet.Auto)
AttachConsole.SetImplementationFlags(AttachConsole.GetMethodImplementationFlags() Or MethodImplAttributes.PreserveSig)
Dim AttachConsoleparam00 As ParameterBuilder = AttachConsole.DefineParameter(0, ParameterAttributes.RetVal, "")
Dim AttachConsoleparam01 As ParameterBuilder = AttachConsole.DefineParameter(1, ParameterAttributes.In, "dwProcessId")
Dim AttachConsoleparam00MAType As Type = GetType(System.Runtime.InteropServices.MarshalAsAttribute)
Dim AttachConsoleparam00MACtor As ConstructorInfo = AttachConsoleparam00MAType.GetConstructor(New Type() { GetType(System.Runtime.InteropServices.UnmanagedType) })
Dim AttachConsoleparam00MABuilder As CustomAttributeBuilder = New CustomAttributeBuilder(AttachConsoleparam00MACtor, New Object() {System.Runtime.InteropServices.UnmanagedType.Bool})
AttachConsoleparam00.SetCustomAttribute(AttachConsoleparam00MABuilder)

WinApi.CreateType()
End Sub

Sub WinSnd()
Dim WinSnd As TypeBuilder = mdl.DefineType("dylan.NET.Utils" & "." & "WinSnd", TypeAttributes.Public Or TypeAttributes.AutoLayout Or TypeAttributes.AnsiClass, GetType(System.Object))
Dim SimpleBeep As FieldBuilder = WinSnd.DefineField("SimpleBeep", GetType(System.Int32), FieldAttributes.Public Or FieldAttributes.Static Or FieldAttributes.InitOnly)
Dim ErrorSnd As FieldBuilder = WinSnd.DefineField("ErrorSnd", GetType(System.Int32), FieldAttributes.Public Or FieldAttributes.Static Or FieldAttributes.InitOnly)
Dim InformationSnd As FieldBuilder = WinSnd.DefineField("InformationSnd", GetType(System.Int32), FieldAttributes.Public Or FieldAttributes.Static Or FieldAttributes.InitOnly)
Dim QuestionSnd As FieldBuilder = WinSnd.DefineField("QuestionSnd", GetType(System.Int32), FieldAttributes.Public Or FieldAttributes.Static Or FieldAttributes.InitOnly)
Dim WarningSnd As FieldBuilder = WinSnd.DefineField("WarningSnd", GetType(System.Int32), FieldAttributes.Public Or FieldAttributes.Static Or FieldAttributes.InitOnly)
Dim OkSnd As FieldBuilder = WinSnd.DefineField("OkSnd", GetType(System.Int32), FieldAttributes.Public Or FieldAttributes.Static Or FieldAttributes.InitOnly)
Dim ctor0 As ConstructorBuilder = WinSnd.DefineConstructor(MethodAttributes.Public Or MethodAttributes.Static,CallingConventions.Standard , Type.EmptyTypes)
Dim ctor0IL As ILGenerator = ctor0.GetILGenerator()
Dim ctor0param00 As ParameterBuilder = ctor0.DefineParameter(0, ParameterAttributes.RetVal, "")
ctor0IL.MarkSequencePoint(doc5, 45, 1, 45, 100)
Dim locbldr51 As LocalBuilder = ctor0IL.DeclareLocal(GetType(System.Globalization.NumberStyles))
locbldr51.SetLocalSymInfo("ns")
ctor0IL.Emit(OpCodes.Ldc_I4, CInt(515))
Typ = GetType(System.Int32)
ctor0IL.Emit(OpCodes.Stloc, 0)
ctor0IL.MarkSequencePoint(doc5, 46, 1, 46, 100)
Dim typ0(-1) As Type
ctor0IL.Emit(OpCodes.Ldstr, "FFFFFFFF")
Typ = GetType(System.String)
ReDim Preserve typ0(UBound(typ0) + 1)
typ0(UBound(typ0)) = Typ
ctor0IL.Emit(OpCodes.Ldloc, 0)
Typ = GetType(System.Globalization.NumberStyles)
ReDim Preserve typ0(UBound(typ0) + 1)
typ0(UBound(typ0)) = Typ
ctor0IL.Emit(OpCodes.Call, GetType(Int32).GetMethod("Parse", typ0))
Typ = GetType(Int32).GetMethod("Parse", typ0).ReturnType
ctor0IL.Emit(OpCodes.Stsfld, SimpleBeep)
ctor0IL.MarkSequencePoint(doc5, 47, 1, 47, 100)
Dim typ1(-1) As Type
ctor0IL.Emit(OpCodes.Ldstr, "10")
Typ = GetType(System.String)
ReDim Preserve typ1(UBound(typ1) + 1)
typ1(UBound(typ1)) = Typ
ctor0IL.Emit(OpCodes.Ldloc, 0)
...
ReDim Preserve typ1(UBound(typ1) + 1)
typ1(UBound(typ1)) = Typ
ctor0IL.Emit(OpCodes.Call, GetType(Int32).GetMethod("Parse", typ1))
Typ = GetType(Int32).GetMethod("Parse", typ1).ReturnType
ctor0IL.Emit(OpCodes.Stsfld, ErrorSnd)
ctor0IL.MarkSequencePoint(doc5, 48, 1, 48, 100)
Dim typ2(-1) As Type
ctor0IL.Emit(OpCodes.Ldstr, "40")
Typ = GetType(System.String)
ReDim Preserve typ2(UBound(typ2) + 1)
...
ReDim Preserve typ2(UBound(typ2) + 1)
typ2(UBound(typ2)) = Typ
ctor0IL.Emit(OpCodes.Call, GetType(Int32).GetMethod("Parse", typ2))
Typ = GetType(Int32).GetMethod("Parse", typ2).ReturnType
ctor0IL.Emit(OpCodes.Stsfld, InformationSnd)
ctor0IL.MarkSequencePoint(doc5, 49, 1, 49, 100)
Dim typ3(-1) As Type
ctor0IL.Emit(OpCodes.Ldstr, "20")
Typ = GetType(System.String)
ReDim Preserve typ3(UBound(typ3) + 1)
typ3(UBound(typ3)) = Typ
ctor0IL.Emit(OpCodes.Ldloc, 0)
...
ReDim Preserve typ3(UBound(typ3) + 1)
typ3(UBound(typ3)) = Typ
ctor0IL.Emit(OpCodes.Call, GetType(Int32).GetMethod("Parse", typ3))
Typ = GetType(Int32).GetMethod("Parse", typ3).ReturnType
ctor0IL.Emit(OpCodes.Stsfld, QuestionSnd)
ctor0IL.MarkSequencePoint(doc5, 50, 1, 50, 100)
ctor0IL.Emit(OpCodes.Ret)
WinSnd.CreateType()
End Sub
...
doc5 = mdl.DefineDocument("E:\Code\dylannet\dnu\winapi.txt", Guid.Empty, Guid.Empty, Guid.Empty)
addstr("dnu")
addasm(asm)
