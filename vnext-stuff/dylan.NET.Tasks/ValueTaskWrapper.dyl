...
class public ValueTaskAwaiterWrapper implements IAwaiter, INotifyCompletion

	field private ValueTaskAwaiter _awaiter

	method public void ValueTaskAwaiterWrapper(var awaiter as ValueTaskAwaiter)
		mybase::ctor()
		_awaiter = awaiter
	end method
...
class public ValueTaskWrapper implements IAwaitable

	field private ValueTask _awaitable

	method public void ValueTaskWrapper(var awaitable as ValueTask)
		mybase::ctor()
		_awaitable = awaitable
	end method

	method public final virtual IAwaiter GetAwaiter()
		return new ValueTaskAwaiterWrapper(_awaitable::GetAwaiter())
	end method
