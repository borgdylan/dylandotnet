...
RemTokenIL.MarkSequencePoint(doc3, 61, 1, 61, 100)
...
RemTokenIL.MarkSequencePoint(doc3, 66, 1, 66, 100)
...
Typ = GetType(System.Boolean)
Dim fa21 As System.Reflection.Emit.Label = setFlgIL.DefineLabel()
Dim tru21 As System.Reflection.Emit.Label = setFlgIL.DefineLabel()
Dim cont21 As System.Reflection.Emit.Label = setFlgIL.DefineLabel()
setFlgIL.Emit(OpCodes.Beq, tru21)
setFlgIL.Emit(OpCodes.Br, fa21)
setFlgIL.MarkLabel(tru21)
...
setFlgIL.Emit(OpCodes.Br, cont21)
setFlgIL.MarkLabel(fa21)
setFlgIL.Emit(OpCodes.Br, cont21)
setFlgIL.MarkLabel(cont21)
...
setFlgIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa22 As System.Reflection.Emit.Label = setFlgIL.DefineLabel()
Dim tru22 As System.Reflection.Emit.Label = setFlgIL.DefineLabel()
Dim cont22 As System.Reflection.Emit.Label = setFlgIL.DefineLabel()
setFlgIL.Emit(OpCodes.Beq, tru22)
setFlgIL.Emit(OpCodes.Br, fa22)
setFlgIL.MarkLabel(tru22)
...
setFlgIL.Emit(OpCodes.Br, cont22)
setFlgIL.MarkLabel(fa22)
setFlgIL.Emit(OpCodes.Br, cont22)
setFlgIL.MarkLabel(cont22)
...
AddAttrIL.Emit(OpCodes.Bgt, tru23)
...
AddAttrIL.Emit(OpCodes.Beq, tru24)
...
AddAttrIL.Emit(OpCodes.Beq, fa25)
AddAttrIL.Emit(OpCodes.Br, tru25)
...
AddAttrIL.Emit(OpCodes.Bgt, tru26)
...
AddAttrIL.Emit(OpCodes.Beq, tru27)
...
AddAttrIL.Emit(OpCodes.Beq, fa28)
AddAttrIL.Emit(OpCodes.Br, tru28)
