...
Dim ArrLoc As FieldBuilder = Ident.DefineField("ArrLoc", asm.GetType("tokenizer.AST.Tokens.Token"), FieldAttributes.Public)
...
ctor1IL.Emit(OpCodes.Ldarg_0)
ctor1IL.Emit(OpCodes.Newobj, asm.GetType("tokenizer.AST.Tokens.Token").GetConstructor(Type.EmptyTypes))
