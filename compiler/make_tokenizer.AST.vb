...
Dim locbldr26 As LocalBuilder = setFlgIL.DeclareLocal(GetType(System.Type))
locbldr26.SetLocalSymInfo("typ")
setFlgIL.MarkSequencePoint(doc27, 20, 1, 20, 100)
Dim locbldr27 As LocalBuilder = setFlgIL.DeclareLocal(GetType(System.Boolean))
locbldr27.SetLocalSymInfo("b")
...
Typ = GetType(System.Boolean)
Dim fa16 As System.Reflection.Emit.Label = setFlgIL.DefineLabel()
Dim tru16 As System.Reflection.Emit.Label = setFlgIL.DefineLabel()
Dim cont16 As System.Reflection.Emit.Label = setFlgIL.DefineLabel()
setFlgIL.Emit(OpCodes.Beq, tru16)
setFlgIL.Emit(OpCodes.Br, fa16)
setFlgIL.MarkLabel(tru16)
...
setFlgIL.Emit(OpCodes.Br, cont16)
setFlgIL.MarkLabel(fa16)
setFlgIL.Emit(OpCodes.Br, cont16)
setFlgIL.MarkLabel(cont16)
...
setFlgIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa17 As System.Reflection.Emit.Label = setFlgIL.DefineLabel()
Dim tru17 As System.Reflection.Emit.Label = setFlgIL.DefineLabel()
Dim cont17 As System.Reflection.Emit.Label = setFlgIL.DefineLabel()
setFlgIL.Emit(OpCodes.Beq, tru17)
setFlgIL.Emit(OpCodes.Br, fa17)
setFlgIL.MarkLabel(tru17)
...
setFlgIL.Emit(OpCodes.Br, cont17)
setFlgIL.MarkLabel(fa17)
setFlgIL.Emit(OpCodes.Br, cont17)
setFlgIL.MarkLabel(cont17)
...
locbldr29.SetLocalSymInfo("destl")
...
locbldr30.SetLocalSymInfo("stopel")
AddAttrIL.Emit(OpCodes.Ldloc, 0)
Typ = GetType(System.Int32)
AddAttrIL.Emit(OpCodes.Ldc_I4, CInt(1))
Typ = GetType(System.Int32)
...
Dim locbldr32 As LocalBuilder = AddAttrIL.DeclareLocal(asm.GetType("dylan.NET.Tokenizer.AST.Tokens.Attributes.Attribute").MakeArrayType())
locbldr32.SetLocalSymInfo("destarr")
...
Dim locbldr52 As LocalBuilder = AddParamIL.DeclareLocal(asm.GetType("dylan.NET.Tokenizer.AST.Exprs.Expr").MakeArrayType())
...
AddParamIL.Emit(OpCodes.Bgt, tru30)
AddParamIL.Emit(OpCodes.Br, fa30)
...
AddParamIL.Emit(OpCodes.Ldloc, 2)
Typ = GetType(System.Int32)
Dim fa31 As System.Reflection.Emit.Label = AddParamIL.DefineLabel()
Dim tru31 As System.Reflection.Emit.Label = AddParamIL.DefineLabel()
Dim cont31 As System.Reflection.Emit.Label = AddParamIL.DefineLabel()
AddParamIL.Emit(OpCodes.Beq, tru31)
AddParamIL.Emit(OpCodes.Br, fa31)
AddParamIL.MarkLabel(tru31)
...
AddParamIL.Emit(OpCodes.Br, cont31)
AddParamIL.MarkLabel(fa31)
AddParamIL.MarkSequencePoint(doc40, 85, 1, 85, 100)
AddParamIL.Emit(OpCodes.Ldloc, 2)
Typ = GetType(System.Int32)
AddParamIL.Emit(OpCodes.Ldc_I4, CInt(-1))
Typ = GetType(System.Int32)
Dim fa32 As System.Reflection.Emit.Label = AddParamIL.DefineLabel()
Dim tru32 As System.Reflection.Emit.Label = AddParamIL.DefineLabel()
Dim cont32 As System.Reflection.Emit.Label = AddParamIL.DefineLabel()
AddParamIL.Emit(OpCodes.Beq, fa32)
AddParamIL.Emit(OpCodes.Br, tru32)
AddParamIL.MarkLabel(tru32)
