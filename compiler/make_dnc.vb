...
Dim typ1(-1) As Type
mainIL.Emit(OpCodes.Ldstr, "dylan.NET Compiler v. 11.2.7.5 Alpha for Microsoft (R) .NET Framework (R) v. 3.5 SP1")
...
Dim typ5(-1) As Type
mainIL.Emit(OpCodes.Ldstr, "Usage: dylandotnet <file-name>")
Typ = GetType(System.String)
