...
Dim locbldr73 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(AutoLayoutAttr))
locbldr73.SetLocalSymInfo("autattr")
...
Dim locbldr74 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(AutoClassAttr))
locbldr74.SetLocalSymInfo("autcattr")
...
Dim locbldr75 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(AnsiClassAttr))
locbldr75.SetLocalSymInfo("ansattr")
...
Dim locbldr76 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(BeforeFieldInitAttr))
locbldr76.SetLocalSymInfo("bfiattr")
...
Dim locbldr77 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(StringTok))
locbldr77.SetLocalSymInfo("strtok")
...
ReDim Preserve typ74(UBound(typ74) + 1)
typ74(UBound(typ74)) = Typ
OptimizeIL.Emit(OpCodes.Call, GetType(String).GetMethod("Compare", typ74))
...
Dim locbldr78 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(VoidTok))
locbldr78.SetLocalSymInfo("voidtok")
...
OptimizeIL.Emit(OpCodes.Call, GetType(System.Type).GetMethod("GetTypeFromHandle", typ75))
...
ReDim Preserve typ76(UBound(typ76) + 1)
typ76(UBound(typ76)) = Typ
OptimizeIL.Emit(OpCodes.Call, GetType(String).GetMethod("Compare", typ76))
...
Dim locbldr79 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(DecimalTok))
locbldr79.SetLocalSymInfo("decitok")
...
OptimizeIL.Emit(OpCodes.Call, GetType(System.Type).GetMethod("GetTypeFromHandle", typ77))
...
Dim locbldr80 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(IntegerTok))
locbldr80.SetLocalSymInfo("inttok")
...
Dim locbldr81 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(IntPtrTok))
locbldr81.SetLocalSymInfo("intptok")
...
OptimizeIL.Emit(OpCodes.Call, GetType(System.Type).GetMethod("GetTypeFromHandle", typ81))
...
ReDim Preserve typ82(UBound(typ82) + 1)
typ82(UBound(typ82)) = Typ
OptimizeIL.Emit(OpCodes.Call, GetType(String).GetMethod("Compare", typ82))
...
Dim locbldr82 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(UIntegerTok))
locbldr82.SetLocalSymInfo("uinttok")
...
OptimizeIL.Emit(OpCodes.Call, GetType(System.Type).GetMethod("GetTypeFromHandle", typ83))
...
ReDim Preserve typ84(UBound(typ84) + 1)
typ84(UBound(typ84)) = Typ
OptimizeIL.Emit(OpCodes.Call, GetType(String).GetMethod("Compare", typ84))
...
Dim locbldr83 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(DoubleTok))
locbldr83.SetLocalSymInfo("dbltok")
...
ReDim Preserve typ86(UBound(typ86) + 1)
typ86(UBound(typ86)) = Typ
OptimizeIL.Emit(OpCodes.Call, GetType(String).GetMethod("Compare", typ86))
...
Dim locbldr84 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(BooleanTok))
locbldr84.SetLocalSymInfo("booltok")
...
OptimizeIL.Emit(OpCodes.Call, GetType(System.Type).GetMethod("GetTypeFromHandle", typ87))
...
ReDim Preserve typ88(UBound(typ88) + 1)
typ88(UBound(typ88)) = Typ
OptimizeIL.Emit(OpCodes.Call, GetType(String).GetMethod("Compare", typ88))
Typ = GetType(String).GetMethod("Compare", typ88).ReturnType
OptimizeIL.Emit(OpCodes.Stloc, 0)
...
Dim locbldr85 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(CharTok))
locbldr85.SetLocalSymInfo("chrtok")
...
OptimizeIL.Emit(OpCodes.Call, GetType(System.Type).GetMethod("GetTypeFromHandle", typ89))
...
ReDim Preserve typ90(UBound(typ90) + 1)
typ90(UBound(typ90)) = Typ
OptimizeIL.Emit(OpCodes.Call, GetType(String).GetMethod("Compare", typ90))
...
Dim locbldr86 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(SingleTok))
locbldr86.SetLocalSymInfo("sngtok")
...
ReDim Preserve typ92(UBound(typ92) + 1)
typ92(UBound(typ92)) = Typ
OptimizeIL.Emit(OpCodes.Call, GetType(String).GetMethod("Compare", typ92))
Typ = GetType(String).GetMethod("Compare", typ92).ReturnType
OptimizeIL.Emit(OpCodes.Stloc, 0)
...
Dim locbldr87 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(SByteTok))
locbldr87.SetLocalSymInfo("sbytok")
...
OptimizeIL.Emit(OpCodes.Call, GetType(System.Type).GetMethod("GetTypeFromHandle", typ93))
...
ReDim Preserve typ94(UBound(typ94) + 1)
typ94(UBound(typ94)) = Typ
OptimizeIL.Emit(OpCodes.Call, GetType(String).GetMethod("Compare", typ94))
Typ = GetType(String).GetMethod("Compare", typ94).ReturnType
OptimizeIL.Emit(OpCodes.Stloc, 0)
...
Dim locbldr88 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(ByteTok))
locbldr88.SetLocalSymInfo("byttok")
...
OptimizeIL.Emit(OpCodes.Call, GetType(System.Type).GetMethod("GetTypeFromHandle", typ95))
...
ReDim Preserve typ96(UBound(typ96) + 1)
typ96(UBound(typ96)) = Typ
OptimizeIL.Emit(OpCodes.Call, GetType(String).GetMethod("Compare", typ96))
...
Dim locbldr89 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(ShortTok))
locbldr89.SetLocalSymInfo("shtok")
...
ReDim Preserve typ98(UBound(typ98) + 1)
typ98(UBound(typ98)) = Typ
OptimizeIL.Emit(OpCodes.Call, GetType(String).GetMethod("Compare", typ98))
...
Dim locbldr90 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(UShortTok))
locbldr90.SetLocalSymInfo("ushtok")
...
OptimizeIL.Emit(OpCodes.Call, GetType(System.Type).GetMethod("GetTypeFromHandle", typ99))
...
ReDim Preserve typ100(UBound(typ100) + 1)
typ100(UBound(typ100)) = Typ
OptimizeIL.Emit(OpCodes.Call, GetType(String).GetMethod("Compare", typ100))
...
Dim locbldr91 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(LongTok))
locbldr91.SetLocalSymInfo("lngtok")
...
ReDim Preserve typ102(UBound(typ102) + 1)
typ102(UBound(typ102)) = Typ
OptimizeIL.Emit(OpCodes.Call, GetType(String).GetMethod("Compare", typ102))
...
Dim locbldr92 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(ULongTok))
locbldr92.SetLocalSymInfo("ulngtok")
...
OptimizeIL.Emit(OpCodes.Call, GetType(System.Type).GetMethod("GetTypeFromHandle", typ103))
...
Dim locbldr93 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(ObjectTok))
locbldr93.SetLocalSymInfo("objtok")
...
OptimizeIL.Emit(OpCodes.Call, GetType(System.Type).GetMethod("GetTypeFromHandle", typ105))
...
Dim locbldr94 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(commentTok))
locbldr94.SetLocalSymInfo("comtok")
...
Dim locbldr95 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(NullLiteral))
locbldr95.SetLocalSymInfo("nulllit")
...
Dim locbldr96 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(BooleanLiteral))
locbldr96.SetLocalSymInfo("boolit")
...
ReDim Preserve typ112(UBound(typ112) + 1)
typ112(UBound(typ112)) = Typ
OptimizeIL.Emit(OpCodes.Call, GetType(Utils.ParseUtils).GetMethod("LikeOP", typ112))
Typ = GetType(Utils.ParseUtils).GetMethod("LikeOP", typ112).ReturnType
OptimizeIL.Emit(OpCodes.Stloc, 1)
...
Dim locbldr97 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(CharLiteral))
locbldr97.SetLocalSymInfo("chrlit")
...
OptimizeIL.Emit(OpCodes.Call, GetType(System.Convert).GetMethod("ToChar", typ113))
Typ = GetType(System.Convert).GetMethod("ToChar", typ113).ReturnType
...
OptimizeIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("Trim", typ114))
Typ = Typ03.GetMethod("Trim", typ114).ReturnType
OptimizeIL.Emit(OpCodes.Stloc, 2)
...
Dim typ115 As Type() = {Typ}
OptimizeIL.Emit(OpCodes.Call, GetType(System.Convert).GetMethod("ToChar", typ115))
Typ = GetType(System.Convert).GetMethod("ToChar", typ115).ReturnType
...
ReDim Preserve typ116(UBound(typ116) + 1)
typ116(UBound(typ116)) = Typ
OptimizeIL.Emit(OpCodes.Call, GetType(String).GetMethod("Concat", typ116))
Typ = GetType(String).GetMethod("Concat", typ116).ReturnType
OptimizeIL.Emit(OpCodes.Stloc, 2)
...
Dim locbldr98 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(StringLiteral))
locbldr98.SetLocalSymInfo("strlit")
...
Typ = GetType(Token).GetField("Value").FieldType
OptimizeIL.Emit(OpCodes.Stloc, 2)
OptimizeIL.MarkSequencePoint(doc3, 1011, 1, 1011, 100)
OptimizeIL.Emit(OpCodes.Ldc_I4, CInt(1))
Typ = GetType(System.Int32)
OptimizeIL.Emit(OpCodes.Conv_U)
OptimizeIL.Emit(OpCodes.Newarr, GetType(System.Char))
OptimizeIL.Emit(OpCodes.Stloc, 3)
OptimizeIL.MarkSequencePoint(doc3, 1012, 1, 1012, 100)
OptimizeIL.Emit(OpCodes.Ldloc, 3)
Typ = GetType(System.Char).MakeArrayType()
Typ02 = Typ
OptimizeIL.Emit(OpCodes.Ldc_I4, CInt(0))
...
OptimizeIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("Trim", typ120))
Typ = Typ03.GetMethod("Trim", typ120).ReturnType
OptimizeIL.Emit(OpCodes.Stloc, 2)
...
ReDim Preserve typ121(UBound(typ121) + 1)
typ121(UBound(typ121)) = Typ
OptimizeIL.Emit(OpCodes.Call, GetType(Utils.ParseUtils).GetMethod("LikeOP", typ121))
Typ = GetType(Utils.ParseUtils).GetMethod("LikeOP", typ121).ReturnType
OptimizeIL.Emit(OpCodes.Stloc, 1)
...
OptimizeIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("EndsWith", typ124))
Typ = Typ03.GetMethod("EndsWith", typ124).ReturnType
OptimizeIL.Emit(OpCodes.Stloc, 1)
...
locbldr99.SetLocalSymInfo("dlit2")
...
OptimizeIL.Emit(OpCodes.Call, GetType(System.Convert).GetMethod("ToChar", typ125))
Typ = GetType(System.Convert).GetMethod("ToChar", typ125).ReturnType
OptimizeIL.Emit(OpCodes.Stelem, GetType(System.Char).MakeArrayType().GetElementType())
...
OptimizeIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("TrimEnd", typ126))
Typ = Typ03.GetMethod("TrimEnd", typ126).ReturnType
OptimizeIL.Emit(OpCodes.Stloc, 2)
...
Dim typ127 As Type() = {Typ}
OptimizeIL.Emit(OpCodes.Call, GetType(System.Convert).GetMethod("ToDouble", typ127))
Typ = GetType(System.Convert).GetMethod("ToDouble", typ127).ReturnType
...
ReDim Preserve typ128(UBound(typ128) + 1)
typ128(UBound(typ128)) = Typ
OptimizeIL.Emit(OpCodes.Call, GetType(Utils.ParseUtils).GetMethod("LikeOP", typ128))
Typ = GetType(Utils.ParseUtils).GetMethod("LikeOP", typ128).ReturnType
OptimizeIL.Emit(OpCodes.Stloc, 1)
...
OptimizeIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("EndsWith", typ131))
Typ = Typ03.GetMethod("EndsWith", typ131).ReturnType
OptimizeIL.Emit(OpCodes.Stloc, 1)
...
locbldr100.SetLocalSymInfo("flit")
...
OptimizeIL.Emit(OpCodes.Call, GetType(System.Convert).GetMethod("ToChar", typ132))
Typ = GetType(System.Convert).GetMethod("ToChar", typ132).ReturnType
OptimizeIL.Emit(OpCodes.Stelem, GetType(System.Char).MakeArrayType().GetElementType())
...
OptimizeIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("TrimEnd", typ133))
Typ = Typ03.GetMethod("TrimEnd", typ133).ReturnType
OptimizeIL.Emit(OpCodes.Stloc, 2)
...
OptimizeIL.Emit(OpCodes.Call, GetType(System.Convert).GetMethod("ToSingle", typ134))
Typ = GetType(System.Convert).GetMethod("ToSingle", typ134).ReturnType
...
ReDim Preserve typ135(UBound(typ135) + 1)
typ135(UBound(typ135)) = Typ
OptimizeIL.Emit(OpCodes.Call, GetType(Utils.ParseUtils).GetMethod("LikeOP", typ135))
Typ = GetType(Utils.ParseUtils).GetMethod("LikeOP", typ135).ReturnType
OptimizeIL.Emit(OpCodes.Stloc, 1)
...
Dim locbldr101 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(DoubleLiteral))
locbldr101.SetLocalSymInfo("dlit")
OptimizeIL.Emit(OpCodes.Newobj, GetType(DoubleLiteral).GetConstructor(Type.EmptyTypes))
...
OptimizeIL.Emit(OpCodes.Call, GetType(System.Convert).GetMethod("ToDouble", typ138))
Typ = GetType(System.Convert).GetMethod("ToDouble", typ138).ReturnType
OptimizeIL.Emit(OpCodes.Stfld, GetType(DoubleLiteral).GetField("NumVal"))
...
ReDim Preserve typ139(UBound(typ139) + 1)
typ139(UBound(typ139)) = Typ
OptimizeIL.Emit(OpCodes.Call, GetType(Utils.ParseUtils).GetMethod("LikeOP", typ139))
Typ = GetType(Utils.ParseUtils).GetMethod("LikeOP", typ139).ReturnType
OptimizeIL.Emit(OpCodes.Stloc, 1)
OptimizeIL.MarkSequencePoint(doc3, 1089, 1, 1089, 100)
OptimizeIL.Emit(OpCodes.Ldloc, 1)
Typ = GetType(System.Boolean)
OptimizeIL.Emit(OpCodes.Stloc, 4)
OptimizeIL.MarkSequencePoint(doc3, 1090, 1, 1090, 100)
...
OptimizeIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("EndsWith", typ142))
Typ = Typ03.GetMethod("EndsWith", typ142).ReturnType
OptimizeIL.Emit(OpCodes.Stloc, 1)
...
locbldr102.SetLocalSymInfo("dlit3")
OptimizeIL.Emit(OpCodes.Newobj, GetType(DoubleLiteral).GetConstructor(Type.EmptyTypes))
...
OptimizeIL.Emit(OpCodes.Ldstr, "d")
Typ = GetType(System.String)
Dim typ143 As Type() = {Typ}
OptimizeIL.Emit(OpCodes.Call, GetType(System.Convert).GetMethod("ToChar", typ143))
Typ = GetType(System.Convert).GetMethod("ToChar", typ143).ReturnType
OptimizeIL.Emit(OpCodes.Stelem, GetType(System.Char).MakeArrayType().GetElementType())
...
OptimizeIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("TrimEnd", typ144))
Typ = Typ03.GetMethod("TrimEnd", typ144).ReturnType
OptimizeIL.Emit(OpCodes.Stloc, 2)
...
OptimizeIL.Emit(OpCodes.Ldfld, GetType(DoubleLiteral).GetField("Value"))
Typ = GetType(DoubleLiteral).GetField("Value").FieldType
Dim typ145 As Type() = {Typ}
OptimizeIL.Emit(OpCodes.Call, GetType(System.Convert).GetMethod("ToDouble", typ145))
Typ = GetType(System.Convert).GetMethod("ToDouble", typ145).ReturnType
OptimizeIL.Emit(OpCodes.Stfld, GetType(DoubleLiteral).GetField("NumVal"))
...
ReDim Preserve typ146(UBound(typ146) + 1)
typ146(UBound(typ146)) = Typ
OptimizeIL.Emit(OpCodes.Call, GetType(Utils.ParseUtils).GetMethod("LikeOP", typ146))
Typ = GetType(Utils.ParseUtils).GetMethod("LikeOP", typ146).ReturnType
OptimizeIL.Emit(OpCodes.Stloc, 1)
...
OptimizeIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("EndsWith", typ149))
Typ = Typ03.GetMethod("EndsWith", typ149).ReturnType
OptimizeIL.Emit(OpCodes.Stloc, 1)
...
Dim locbldr103 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(FloatLiteral))
locbldr103.SetLocalSymInfo("flit2")
OptimizeIL.Emit(OpCodes.Newobj, GetType(FloatLiteral).GetConstructor(Type.EmptyTypes))
...
OptimizeIL.Emit(OpCodes.Call, GetType(System.Convert).GetMethod("ToChar", typ150))
Typ = GetType(System.Convert).GetMethod("ToChar", typ150).ReturnType
OptimizeIL.Emit(OpCodes.Stelem, GetType(System.Char).MakeArrayType().GetElementType())
...
OptimizeIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("TrimEnd", typ151))
Typ = Typ03.GetMethod("TrimEnd", typ151).ReturnType
OptimizeIL.Emit(OpCodes.Stloc, 2)
...
OptimizeIL.Emit(OpCodes.Call, GetType(System.Convert).GetMethod("ToSingle", typ152))
Typ = GetType(System.Convert).GetMethod("ToSingle", typ152).ReturnType
OptimizeIL.Emit(OpCodes.Stfld, GetType(FloatLiteral).GetField("NumVal"))
...
ReDim Preserve typ153(UBound(typ153) + 1)
typ153(UBound(typ153)) = Typ
OptimizeIL.Emit(OpCodes.Call, GetType(Utils.ParseUtils).GetMethod("LikeOP", typ153))
Typ = GetType(Utils.ParseUtils).GetMethod("LikeOP", typ153).ReturnType
OptimizeIL.Emit(OpCodes.Stloc, 1)
...
OptimizeIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("EndsWith", typ156))
Typ = Typ03.GetMethod("EndsWith", typ156).ReturnType
OptimizeIL.Emit(OpCodes.Stloc, 1)
...
Dim locbldr104 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(UIntLiteral))
locbldr104.SetLocalSymInfo("uilit2")
...
Typ = GetType(System.String)
Dim typ157 As Type() = {Typ}
OptimizeIL.Emit(OpCodes.Call, GetType(System.Convert).GetMethod("ToChar", typ157))
Typ = GetType(System.Convert).GetMethod("ToChar", typ157).ReturnType
OptimizeIL.Emit(OpCodes.Stelem, GetType(System.Char).MakeArrayType().GetElementType())
...
OptimizeIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("TrimEnd", typ158))
Typ = Typ03.GetMethod("TrimEnd", typ158).ReturnType
OptimizeIL.Emit(OpCodes.Stloc, 2)
...
Typ = GetType(System.String)
Dim typ159 As Type() = {Typ}
OptimizeIL.Emit(OpCodes.Call, GetType(System.Convert).GetMethod("ToChar", typ159))
Typ = GetType(System.Convert).GetMethod("ToChar", typ159).ReturnType
OptimizeIL.Emit(OpCodes.Stelem, GetType(System.Char).MakeArrayType().GetElementType())
...
OptimizeIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("TrimEnd", typ160))
Typ = Typ03.GetMethod("TrimEnd", typ160).ReturnType
OptimizeIL.Emit(OpCodes.Stloc, 2)
OptimizeIL.MarkSequencePoint(doc3, 1153, 1, 1153, 100)
OptimizeIL.Emit(OpCodes.Ldloc, 104)
Typ = GetType(UIntLiteral)
OptimizeIL.Emit(OpCodes.Ldloc, 2)
Typ = GetType(System.String)
...
OptimizeIL.Emit(OpCodes.Call, GetType(Convert).GetMethod("ToUInt32", typ161))
Typ = GetType(Convert).GetMethod("ToUInt32", typ161).ReturnType
...
ReDim Preserve typ162(UBound(typ162) + 1)
typ162(UBound(typ162)) = Typ
OptimizeIL.Emit(OpCodes.Call, GetType(Utils.ParseUtils).GetMethod("LikeOP", typ162))
Typ = GetType(Utils.ParseUtils).GetMethod("LikeOP", typ162).ReturnType
OptimizeIL.Emit(OpCodes.Stloc, 1)
...
OptimizeIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("EndsWith", typ165))
Typ = Typ03.GetMethod("EndsWith", typ165).ReturnType
OptimizeIL.Emit(OpCodes.Stloc, 1)
...
Dim locbldr105 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(IntPtrLiteral))
locbldr105.SetLocalSymInfo("iplit2")
...
Typ = GetType(System.String)
Dim typ166 As Type() = {Typ}
OptimizeIL.Emit(OpCodes.Call, GetType(System.Convert).GetMethod("ToChar", typ166))
Typ = GetType(System.Convert).GetMethod("ToChar", typ166).ReturnType
OptimizeIL.Emit(OpCodes.Stelem, GetType(System.Char).MakeArrayType().GetElementType())
...
OptimizeIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("TrimEnd", typ167))
Typ = Typ03.GetMethod("TrimEnd", typ167).ReturnType
OptimizeIL.Emit(OpCodes.Stloc, 2)
...
OptimizeIL.Emit(OpCodes.Call, GetType(System.Convert).GetMethod("ToChar", typ168))
...
OptimizeIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("TrimEnd", typ169))
Typ = Typ03.GetMethod("TrimEnd", typ169).ReturnType
OptimizeIL.Emit(OpCodes.Stloc, 2)
OptimizeIL.MarkSequencePoint(doc3, 1178, 1, 1178, 100)
OptimizeIL.Emit(OpCodes.Ldloc, 105)
Typ = GetType(IntPtrLiteral)
OptimizeIL.Emit(OpCodes.Ldloc, 2)
Typ = GetType(System.String)
...
Dim typ171 As Type() = {Typ}
OptimizeIL.Emit(OpCodes.Call, GetType(System.Convert).GetMethod("ToInt32", typ171))
Typ = GetType(System.Convert).GetMethod("ToInt32", typ171).ReturnType
ReDim Preserve typ170(UBound(typ170) + 1)
typ170(UBound(typ170)) = Typ
OptimizeIL.Emit(OpCodes.Newobj, GetType(IntPtr).GetConstructor(typ170))
...
ReDim Preserve typ172(UBound(typ172) + 1)
typ172(UBound(typ172)) = Typ
OptimizeIL.Emit(OpCodes.Call, GetType(Utils.ParseUtils).GetMethod("LikeOP", typ172))
Typ = GetType(Utils.ParseUtils).GetMethod("LikeOP", typ172).ReturnType
OptimizeIL.Emit(OpCodes.Stloc, 1)
...
OptimizeIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("EndsWith", typ175))
Typ = Typ03.GetMethod("EndsWith", typ175).ReturnType
OptimizeIL.Emit(OpCodes.Stloc, 1)
...
Dim locbldr106 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(IntLiteral))
locbldr106.SetLocalSymInfo("ilit2")
...
OptimizeIL.Emit(OpCodes.Ldstr, "i")
Typ = GetType(System.String)
Dim typ176 As Type() = {Typ}
OptimizeIL.Emit(OpCodes.Call, GetType(System.Convert).GetMethod("ToChar", typ176))
Typ = GetType(System.Convert).GetMethod("ToChar", typ176).ReturnType
OptimizeIL.Emit(OpCodes.Stelem, GetType(System.Char).MakeArrayType().GetElementType())
...
OptimizeIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("TrimEnd", typ177))
Typ = Typ03.GetMethod("TrimEnd", typ177).ReturnType
OptimizeIL.Emit(OpCodes.Stloc, 2)
...
Dim typ178 As Type() = {Typ}
OptimizeIL.Emit(OpCodes.Call, GetType(System.Convert).GetMethod("ToInt32", typ178))
Typ = GetType(System.Convert).GetMethod("ToInt32", typ178).ReturnType
OptimizeIL.Emit(OpCodes.Stfld, GetType(IntLiteral).GetField("NumVal"))
OptimizeIL.MarkSequencePoint(doc3, 1204, 1, 1204, 100)
OptimizeIL.Emit(OpCodes.Ldloc, 106)
Typ = GetType(IntLiteral)
OptimizeIL.Emit(OpCodes.Starg, 1)
...
ReDim Preserve typ179(UBound(typ179) + 1)
typ179(UBound(typ179)) = Typ
OptimizeIL.Emit(OpCodes.Call, GetType(Utils.ParseUtils).GetMethod("LikeOP", typ179))
Typ = GetType(Utils.ParseUtils).GetMethod("LikeOP", typ179).ReturnType
OptimizeIL.Emit(OpCodes.Stloc, 1)
...
OptimizeIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("EndsWith", typ182))
Typ = Typ03.GetMethod("EndsWith", typ182).ReturnType
OptimizeIL.Emit(OpCodes.Stloc, 1)
...
Dim locbldr107 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(ULongLiteral))
locbldr107.SetLocalSymInfo("ullit")
...
Typ = GetType(System.String)
Dim typ183 As Type() = {Typ}
OptimizeIL.Emit(OpCodes.Call, GetType(System.Convert).GetMethod("ToChar", typ183))
Typ = GetType(System.Convert).GetMethod("ToChar", typ183).ReturnType
OptimizeIL.Emit(OpCodes.Stelem, GetType(System.Char).MakeArrayType().GetElementType())
...
OptimizeIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("TrimEnd", typ184))
Typ = Typ03.GetMethod("TrimEnd", typ184).ReturnType
OptimizeIL.Emit(OpCodes.Stloc, 2)
...
OptimizeIL.Emit(OpCodes.Ldstr, "u")
Typ = GetType(System.String)
Dim typ185 As Type() = {Typ}
OptimizeIL.Emit(OpCodes.Call, GetType(System.Convert).GetMethod("ToChar", typ185))
Typ = GetType(System.Convert).GetMethod("ToChar", typ185).ReturnType
OptimizeIL.Emit(OpCodes.Stelem, GetType(System.Char).MakeArrayType().GetElementType())
...
OptimizeIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("TrimEnd", typ186))
Typ = Typ03.GetMethod("TrimEnd", typ186).ReturnType
OptimizeIL.Emit(OpCodes.Stloc, 2)
...
OptimizeIL.Emit(OpCodes.Call, GetType(Convert).GetMethod("ToUInt64", typ187))
Typ = GetType(Convert).GetMethod("ToUInt64", typ187).ReturnType
...
ReDim Preserve typ188(UBound(typ188) + 1)
typ188(UBound(typ188)) = Typ
OptimizeIL.Emit(OpCodes.Call, GetType(Utils.ParseUtils).GetMethod("LikeOP", typ188))
Typ = GetType(Utils.ParseUtils).GetMethod("LikeOP", typ188).ReturnType
OptimizeIL.Emit(OpCodes.Stloc, 1)
...
OptimizeIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("EndsWith", typ191))
Typ = Typ03.GetMethod("EndsWith", typ191).ReturnType
OptimizeIL.Emit(OpCodes.Stloc, 1)
...
Dim locbldr108 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(LongLiteral))
locbldr108.SetLocalSymInfo("llit")
...
OptimizeIL.Emit(OpCodes.Ldstr, "l")
Typ = GetType(System.String)
Dim typ192 As Type() = {Typ}
OptimizeIL.Emit(OpCodes.Call, GetType(System.Convert).GetMethod("ToChar", typ192))
Typ = GetType(System.Convert).GetMethod("ToChar", typ192).ReturnType
OptimizeIL.Emit(OpCodes.Stelem, GetType(System.Char).MakeArrayType().GetElementType())
...
OptimizeIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("TrimEnd", typ193))
Typ = Typ03.GetMethod("TrimEnd", typ193).ReturnType
OptimizeIL.Emit(OpCodes.Stloc, 2)
...
OptimizeIL.Emit(OpCodes.Call, GetType(System.Convert).GetMethod("ToInt64", typ194))
Typ = GetType(System.Convert).GetMethod("ToInt64", typ194).ReturnType
...
ReDim Preserve typ195(UBound(typ195) + 1)
typ195(UBound(typ195)) = Typ
OptimizeIL.Emit(OpCodes.Call, GetType(Utils.ParseUtils).GetMethod("LikeOP", typ195))
Typ = GetType(Utils.ParseUtils).GetMethod("LikeOP", typ195).ReturnType
OptimizeIL.Emit(OpCodes.Stloc, 1)
...
OptimizeIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("EndsWith", typ198))
Typ = Typ03.GetMethod("EndsWith", typ198).ReturnType
OptimizeIL.Emit(OpCodes.Stloc, 1)
...
Dim locbldr109 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(UShortLiteral))
locbldr109.SetLocalSymInfo("uslit")
...
Typ = GetType(System.String)
Dim typ199 As Type() = {Typ}
OptimizeIL.Emit(OpCodes.Call, GetType(System.Convert).GetMethod("ToChar", typ199))
Typ = GetType(System.Convert).GetMethod("ToChar", typ199).ReturnType
OptimizeIL.Emit(OpCodes.Stelem, GetType(System.Char).MakeArrayType().GetElementType())
...
OptimizeIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("TrimEnd", typ200))
Typ = Typ03.GetMethod("TrimEnd", typ200).ReturnType
OptimizeIL.Emit(OpCodes.Stloc, 2)
...
OptimizeIL.Emit(OpCodes.Ldstr, "u")
Typ = GetType(System.String)
Dim typ201 As Type() = {Typ}
OptimizeIL.Emit(OpCodes.Call, GetType(System.Convert).GetMethod("ToChar", typ201))
Typ = GetType(System.Convert).GetMethod("ToChar", typ201).ReturnType
OptimizeIL.Emit(OpCodes.Stelem, GetType(System.Char).MakeArrayType().GetElementType())
...
OptimizeIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("TrimEnd", typ202))
Typ = Typ03.GetMethod("TrimEnd", typ202).ReturnType
OptimizeIL.Emit(OpCodes.Stloc, 2)
...
OptimizeIL.Emit(OpCodes.Call, GetType(Convert).GetMethod("ToUInt16", typ203))
Typ = GetType(Convert).GetMethod("ToUInt16", typ203).ReturnType
...
ReDim Preserve typ204(UBound(typ204) + 1)
typ204(UBound(typ204)) = Typ
OptimizeIL.Emit(OpCodes.Call, GetType(Utils.ParseUtils).GetMethod("LikeOP", typ204))
Typ = GetType(Utils.ParseUtils).GetMethod("LikeOP", typ204).ReturnType
OptimizeIL.Emit(OpCodes.Stloc, 1)
...
OptimizeIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("EndsWith", typ207))
Typ = Typ03.GetMethod("EndsWith", typ207).ReturnType
OptimizeIL.Emit(OpCodes.Stloc, 1)
...
Dim locbldr110 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(ShortLiteral))
locbldr110.SetLocalSymInfo("slit")
...
OptimizeIL.Emit(OpCodes.Ldstr, "s")
Typ = GetType(System.String)
Dim typ208 As Type() = {Typ}
OptimizeIL.Emit(OpCodes.Call, GetType(System.Convert).GetMethod("ToChar", typ208))
Typ = GetType(System.Convert).GetMethod("ToChar", typ208).ReturnType
OptimizeIL.Emit(OpCodes.Stelem, GetType(System.Char).MakeArrayType().GetElementType())
...
OptimizeIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("TrimEnd", typ209))
Typ = Typ03.GetMethod("TrimEnd", typ209).ReturnType
OptimizeIL.Emit(OpCodes.Stloc, 2)
...
Dim typ210 As Type() = {Typ}
OptimizeIL.Emit(OpCodes.Call, GetType(System.Convert).GetMethod("ToInt16", typ210))
Typ = GetType(System.Convert).GetMethod("ToInt16", typ210).ReturnType
...
ReDim Preserve typ211(UBound(typ211) + 1)
typ211(UBound(typ211)) = Typ
OptimizeIL.Emit(OpCodes.Call, GetType(Utils.ParseUtils).GetMethod("LikeOP", typ211))
Typ = GetType(Utils.ParseUtils).GetMethod("LikeOP", typ211).ReturnType
OptimizeIL.Emit(OpCodes.Stloc, 1)
...
OptimizeIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("EndsWith", typ214))
Typ = Typ03.GetMethod("EndsWith", typ214).ReturnType
OptimizeIL.Emit(OpCodes.Stloc, 1)
...
Dim locbldr111 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(ByteLiteral))
locbldr111.SetLocalSymInfo("ublit")
...
Typ = GetType(System.String)
Dim typ215 As Type() = {Typ}
OptimizeIL.Emit(OpCodes.Call, GetType(System.Convert).GetMethod("ToChar", typ215))
Typ = GetType(System.Convert).GetMethod("ToChar", typ215).ReturnType
OptimizeIL.Emit(OpCodes.Stelem, GetType(System.Char).MakeArrayType().GetElementType())
...
OptimizeIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("TrimEnd", typ216))
Typ = Typ03.GetMethod("TrimEnd", typ216).ReturnType
OptimizeIL.Emit(OpCodes.Stloc, 2)
...
OptimizeIL.Emit(OpCodes.Ldstr, "u")
Typ = GetType(System.String)
Dim typ217 As Type() = {Typ}
OptimizeIL.Emit(OpCodes.Call, GetType(System.Convert).GetMethod("ToChar", typ217))
Typ = GetType(System.Convert).GetMethod("ToChar", typ217).ReturnType
OptimizeIL.Emit(OpCodes.Stelem, GetType(System.Char).MakeArrayType().GetElementType())
...
OptimizeIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("TrimEnd", typ218))
Typ = Typ03.GetMethod("TrimEnd", typ218).ReturnType
OptimizeIL.Emit(OpCodes.Stloc, 2)
...
OptimizeIL.Emit(OpCodes.Call, GetType(Convert).GetMethod("ToByte", typ219))
Typ = GetType(Convert).GetMethod("ToByte", typ219).ReturnType
...
ReDim Preserve typ220(UBound(typ220) + 1)
typ220(UBound(typ220)) = Typ
OptimizeIL.Emit(OpCodes.Call, GetType(Utils.ParseUtils).GetMethod("LikeOP", typ220))
Typ = GetType(Utils.ParseUtils).GetMethod("LikeOP", typ220).ReturnType
OptimizeIL.Emit(OpCodes.Stloc, 1)
...
OptimizeIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("EndsWith", typ223))
Typ = Typ03.GetMethod("EndsWith", typ223).ReturnType
OptimizeIL.Emit(OpCodes.Stloc, 1)
...
Dim locbldr112 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(SByteLiteral))
locbldr112.SetLocalSymInfo("blit")
...
OptimizeIL.Emit(OpCodes.Ldstr, "b")
Typ = GetType(System.String)
Dim typ224 As Type() = {Typ}
OptimizeIL.Emit(OpCodes.Call, GetType(System.Convert).GetMethod("ToChar", typ224))
Typ = GetType(System.Convert).GetMethod("ToChar", typ224).ReturnType
OptimizeIL.Emit(OpCodes.Stelem, GetType(System.Char).MakeArrayType().GetElementType())
...
OptimizeIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("TrimEnd", typ225))
Typ = Typ03.GetMethod("TrimEnd", typ225).ReturnType
OptimizeIL.Emit(OpCodes.Stloc, 2)
...
Dim typ226 As Type() = {Typ}
OptimizeIL.Emit(OpCodes.Call, GetType(System.Convert).GetMethod("ToSByte", typ226))
Typ = GetType(System.Convert).GetMethod("ToSByte", typ226).ReturnType
...
ReDim Preserve typ227(UBound(typ227) + 1)
typ227(UBound(typ227)) = Typ
OptimizeIL.Emit(OpCodes.Call, GetType(Utils.ParseUtils).GetMethod("LikeOP", typ227))
Typ = GetType(Utils.ParseUtils).GetMethod("LikeOP", typ227).ReturnType
OptimizeIL.Emit(OpCodes.Stloc, 1)
...
Dim locbldr113 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(IntLiteral))
locbldr113.SetLocalSymInfo("ilit")
OptimizeIL.Emit(OpCodes.Newobj, GetType(IntLiteral).GetConstructor(Type.EmptyTypes))
...
Typ = GetType(System.String)
OptimizeIL.Emit(OpCodes.Stfld, GetType(IntLiteral).GetField("Value"))
OptimizeIL.MarkSequencePoint(doc3, 1370, 1, 1370, 100)
OptimizeIL.Emit(OpCodes.Ldloc, 113)
Typ = GetType(IntLiteral)
OptimizeIL.Emit(OpCodes.Ldloc, 113)
Typ = GetType(IntLiteral)
OptimizeIL.Emit(OpCodes.Ldfld, GetType(IntLiteral).GetField("Value"))
Typ = GetType(IntLiteral).GetField("Value").FieldType
Dim typ230 As Type() = {Typ}
OptimizeIL.Emit(OpCodes.Call, GetType(System.Convert).GetMethod("ToInt32", typ230))
Typ = GetType(System.Convert).GetMethod("ToInt32", typ230).ReturnType
OptimizeIL.Emit(OpCodes.Stfld, GetType(IntLiteral).GetField("NumVal"))
OptimizeIL.MarkSequencePoint(doc3, 1371, 1, 1371, 100)
OptimizeIL.Emit(OpCodes.Ldloc, 113)
Typ = GetType(IntLiteral)
OptimizeIL.Emit(OpCodes.Starg, 1)
...
OptimizeIL.MarkSequencePoint(doc3, 1376, 1, 1376, 100)
...
ReDim Preserve typ231(UBound(typ231) + 1)
typ231(UBound(typ231)) = Typ
OptimizeIL.Emit(OpCodes.Call, GetType(Utils.ParseUtils).GetMethod("LikeOP", typ231))
Typ = GetType(Utils.ParseUtils).GetMethod("LikeOP", typ231).ReturnType
OptimizeIL.Emit(OpCodes.Stloc, 1)
OptimizeIL.MarkSequencePoint(doc3, 1377, 1, 1377, 100)
OptimizeIL.Emit(OpCodes.Ldloc, 1)
Typ = GetType(System.Boolean)
OptimizeIL.Emit(OpCodes.Stloc, 4)
OptimizeIL.MarkSequencePoint(doc3, 1378, 1, 1378, 100)
...
OptimizeIL.MarkSequencePoint(doc3, 1384, 1, 1384, 100)
Dim locbldr114 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(Ident))
locbldr114.SetLocalSymInfo("idt")
OptimizeIL.Emit(OpCodes.Newobj, GetType(Ident).GetConstructor(Type.EmptyTypes))
OptimizeIL.Emit(OpCodes.Stloc, 114)
OptimizeIL.MarkSequencePoint(doc3, 1385, 1, 1385, 100)
...
OptimizeIL.MarkSequencePoint(doc3, 1392, 1, 1392, 100)
...
locbldr115.SetLocalSymInfo("tok")
...
locbldr116.SetLocalSymInfo("typ")
...
Dim locbldr117 As LocalBuilder = checkVarAsIL.DeclareLocal(GetType(VarExpr))
locbldr117.SetLocalSymInfo("vars")
...
Typ = GetType(System.Boolean)
Dim fa114 As System.Reflection.Emit.Label = checkVarAsIL.DefineLabel()
Dim tru114 As System.Reflection.Emit.Label = checkVarAsIL.DefineLabel()
Dim cont114 As System.Reflection.Emit.Label = checkVarAsIL.DefineLabel()
checkVarAsIL.Emit(OpCodes.Beq, tru114)
checkVarAsIL.Emit(OpCodes.Br, fa114)
checkVarAsIL.MarkLabel(tru114)
...
locbldr118.SetLocalSymInfo("tok2")
checkVarAsIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Expr)
checkVarAsIL.Emit(OpCodes.Ldfld, GetType(Expr).GetField("Tokens"))
Typ = GetType(Expr).GetField("Tokens").FieldType
...
Dim locbldr119 As LocalBuilder = checkVarAsIL.DeclareLocal(GetType(System.Type))
locbldr119.SetLocalSymInfo("typ2")
...
Dim locbldr120 As LocalBuilder = checkVarAsIL.DeclareLocal(GetType(System.Boolean))
locbldr120.SetLocalSymInfo("b2")
Dim typ4(-1) As Type
...
checkVarAsIL.Emit(OpCodes.Beq, fa115)
checkVarAsIL.Emit(OpCodes.Br, tru115)
checkVarAsIL.MarkLabel(tru115)
checkVarAsIL.MarkSequencePoint(doc4, 27, 1, 27, 100)
Dim locbldr121 As LocalBuilder = checkVarAsIL.DeclareLocal(GetType(Token))
locbldr121.SetLocalSymInfo("t")
checkVarAsIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Expr)
checkVarAsIL.Emit(OpCodes.Ldfld, GetType(Expr).GetField("Tokens"))
Typ = GetType(Expr).GetField("Tokens").FieldType
...
Dim locbldr122 As LocalBuilder = checkVarAsIL.DeclareLocal(GetType(TypeTok))
locbldr122.SetLocalSymInfo("tt")
...
checkVarAsIL.Emit(OpCodes.Br, cont114)
checkVarAsIL.MarkLabel(fa114)
checkVarAsIL.Emit(OpCodes.Br, cont114)
checkVarAsIL.MarkLabel(cont114)
...
Dim locbldr123 As LocalBuilder = procMethodCallIL.DeclareLocal(GetType(MethodNameTok))
locbldr123.SetLocalSymInfo("mn")
...
Dim locbldr124 As LocalBuilder = procMethodCallIL.DeclareLocal(GetType(MethodCallTok))
locbldr124.SetLocalSymInfo("mct")
...
Dim locbldr125 As LocalBuilder = procMethodCallIL.DeclareLocal(GetType(Ident))
locbldr125.SetLocalSymInfo("idt")
...
Dim locbldr126 As LocalBuilder = procMethodCallIL.DeclareLocal(GetType(Expr))
locbldr126.SetLocalSymInfo("ep2")
...
Dim locbldr127 As LocalBuilder = procMethodCallIL.DeclareLocal(GetType(System.Int32))
locbldr127.SetLocalSymInfo("lvl")
...
Dim locbldr128 As LocalBuilder = procMethodCallIL.DeclareLocal(GetType(System.Boolean))
locbldr128.SetLocalSymInfo("d")
...
Dim locbldr129 As LocalBuilder = procMethodCallIL.DeclareLocal(GetType(System.Int32))
locbldr129.SetLocalSymInfo("j")
...
Dim locbldr130 As LocalBuilder = procMethodCallIL.DeclareLocal(GetType(Token))
locbldr130.SetLocalSymInfo("tok2")
procMethodCallIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Expr)
procMethodCallIL.Emit(OpCodes.Ldfld, GetType(Expr).GetField("Tokens"))
Typ = GetType(Expr).GetField("Tokens").FieldType
...
Dim locbldr131 As LocalBuilder = procMethodCallIL.DeclareLocal(GetType(System.Type))
locbldr131.SetLocalSymInfo("typ2")
procMethodCallIL.MarkSequencePoint(doc4, 77, 1, 77, 100)
Dim locbldr132 As LocalBuilder = procMethodCallIL.DeclareLocal(GetType(System.Boolean))
locbldr132.SetLocalSymInfo("b2")
procMethodCallIL.MarkSequencePoint(doc4, 78, 1, 78, 100)
Dim locbldr133 As LocalBuilder = procMethodCallIL.DeclareLocal(GetType(System.Int32))
...
procMethodCallIL.Emit(OpCodes.Bgt, tru118)
...
procMethodCallIL.Emit(OpCodes.Beq, tru119)
...
procMethodCallIL.Emit(OpCodes.Bgt, tru122)
...
procMethodCallIL.Emit(OpCodes.Beq, tru123)
...
Dim locbldr134 As LocalBuilder = procNewCallIL.DeclareLocal(GetType(NewCallTok))
locbldr134.SetLocalSymInfo("nct")
...
Dim locbldr135 As LocalBuilder = procNewCallIL.DeclareLocal(GetType(TypeTok))
locbldr135.SetLocalSymInfo("tt")
procNewCallIL.MarkSequencePoint(doc4, 178, 1, 178, 100)
Dim locbldr136 As LocalBuilder = procNewCallIL.DeclareLocal(GetType(Expr))
locbldr136.SetLocalSymInfo("ep2")
...
Dim locbldr137 As LocalBuilder = procNewCallIL.DeclareLocal(GetType(System.Int32))
locbldr137.SetLocalSymInfo("lvl")
...
Dim locbldr138 As LocalBuilder = procNewCallIL.DeclareLocal(GetType(System.Boolean))
locbldr138.SetLocalSymInfo("d")
procNewCallIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
procNewCallIL.Emit(OpCodes.Stloc, 4)
procNewCallIL.MarkSequencePoint(doc4, 181, 1, 181, 100)
Dim locbldr139 As LocalBuilder = procNewCallIL.DeclareLocal(GetType(System.Int32))
locbldr139.SetLocalSymInfo("j")
...
Dim locbldr140 As LocalBuilder = procNewCallIL.DeclareLocal(GetType(Token))
...
Dim locbldr141 As LocalBuilder = procNewCallIL.DeclareLocal(GetType(System.Type))
locbldr141.SetLocalSymInfo("typ2")
procNewCallIL.MarkSequencePoint(doc4, 190, 1, 190, 100)
Dim locbldr142 As LocalBuilder = procNewCallIL.DeclareLocal(GetType(System.Boolean))
locbldr142.SetLocalSymInfo("b2")
procNewCallIL.MarkSequencePoint(doc4, 191, 1, 191, 100)
Dim locbldr143 As LocalBuilder = procNewCallIL.DeclareLocal(GetType(System.Int32))
...
procNewCallIL.Emit(OpCodes.Bgt, tru127)
...
procNewCallIL.Emit(OpCodes.Beq, tru128)
...
procNewCallIL.Emit(OpCodes.Bgt, tru131)
...
procNewCallIL.Emit(OpCodes.Beq, tru132)
...
Dim locbldr144 As LocalBuilder = procIdentArrayAccessIL.DeclareLocal(GetType(Ident))
locbldr144.SetLocalSymInfo("idt")
...
Dim locbldr145 As LocalBuilder = procIdentArrayAccessIL.DeclareLocal(GetType(Expr))
locbldr145.SetLocalSymInfo("ep2")
...
Dim locbldr146 As LocalBuilder = procIdentArrayAccessIL.DeclareLocal(GetType(System.Int32))
locbldr146.SetLocalSymInfo("lvl")
...
Dim locbldr147 As LocalBuilder = procIdentArrayAccessIL.DeclareLocal(GetType(System.Boolean))
locbldr147.SetLocalSymInfo("d")
...
Dim locbldr148 As LocalBuilder = procIdentArrayAccessIL.DeclareLocal(GetType(System.Int32))
locbldr148.SetLocalSymInfo("j")
...
Dim locbldr149 As LocalBuilder = procIdentArrayAccessIL.DeclareLocal(GetType(Token))
...
Dim locbldr150 As LocalBuilder = procIdentArrayAccessIL.DeclareLocal(GetType(System.Type))
locbldr150.SetLocalSymInfo("typ2")
procIdentArrayAccessIL.MarkSequencePoint(doc4, 301, 1, 301, 100)
Dim locbldr151 As LocalBuilder = procIdentArrayAccessIL.DeclareLocal(GetType(System.Boolean))
locbldr151.SetLocalSymInfo("b2")
procIdentArrayAccessIL.MarkSequencePoint(doc4, 302, 1, 302, 100)
Dim locbldr152 As LocalBuilder = procIdentArrayAccessIL.DeclareLocal(GetType(System.Int32))
...
Dim locbldr153 As LocalBuilder = procMtdArrayAccessIL.DeclareLocal(GetType(MethodCallTok))
locbldr153.SetLocalSymInfo("mtd")
...
Dim locbldr154 As LocalBuilder = procMtdArrayAccessIL.DeclareLocal(GetType(MethodNameTok))
...
Dim locbldr155 As LocalBuilder = procMtdArrayAccessIL.DeclareLocal(GetType(Expr))
locbldr155.SetLocalSymInfo("ep2")
...
Dim locbldr156 As LocalBuilder = procMtdArrayAccessIL.DeclareLocal(GetType(System.Int32))
locbldr156.SetLocalSymInfo("lvl")
...
Dim locbldr157 As LocalBuilder = procMtdArrayAccessIL.DeclareLocal(GetType(System.Boolean))
locbldr157.SetLocalSymInfo("d")
...
Dim locbldr158 As LocalBuilder = procMtdArrayAccessIL.DeclareLocal(GetType(System.Int32))
locbldr158.SetLocalSymInfo("j")
...
Dim locbldr159 As LocalBuilder = procMtdArrayAccessIL.DeclareLocal(GetType(Token))
locbldr159.SetLocalSymInfo("tok2")
procMtdArrayAccessIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Expr)
procMtdArrayAccessIL.Emit(OpCodes.Ldfld, GetType(Expr).GetField("Tokens"))
Typ = GetType(Expr).GetField("Tokens").FieldType
...
Dim locbldr160 As LocalBuilder = procMtdArrayAccessIL.DeclareLocal(GetType(System.Type))
locbldr160.SetLocalSymInfo("typ2")
procMtdArrayAccessIL.MarkSequencePoint(doc4, 396, 1, 396, 100)
Dim locbldr161 As LocalBuilder = procMtdArrayAccessIL.DeclareLocal(GetType(System.Boolean))
locbldr161.SetLocalSymInfo("b2")
procMtdArrayAccessIL.MarkSequencePoint(doc4, 397, 1, 397, 100)
Dim locbldr162 As LocalBuilder = procMtdArrayAccessIL.DeclareLocal(GetType(System.Int32))
...
Dim locbldr163 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(System.Int32))
...
locbldr166.SetLocalSymInfo("identtrnoff")
OptimizeIL.Emit(OpCodes.Ldc_I4, 0)
Typ = GetType(System.Boolean)
OptimizeIL.Emit(OpCodes.Stloc, 3)
...
locbldr167.SetLocalSymInfo("mcbool")
OptimizeIL.Emit(OpCodes.Ldc_I4, 0)
Typ = GetType(System.Boolean)
OptimizeIL.Emit(OpCodes.Stloc, 4)
...
locbldr168.SetLocalSymInfo("mcflgc")
OptimizeIL.Emit(OpCodes.Ldc_I4, 0)
Typ = GetType(System.Boolean)
OptimizeIL.Emit(OpCodes.Stloc, 5)
...
locbldr169.SetLocalSymInfo("iflgc")
OptimizeIL.Emit(OpCodes.Ldc_I4, 0)
Typ = GetType(System.Boolean)
OptimizeIL.Emit(OpCodes.Stloc, 6)
...
locbldr172.SetLocalSymInfo("nctok")
OptimizeIL.Emit(OpCodes.Ldnull)
OptimizeIL.Emit(OpCodes.Stloc, 9)
OptimizeIL.MarkSequencePoint(doc4, 487, 1, 487, 100)
Dim locbldr173 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(TypeTok))
locbldr173.SetLocalSymInfo("ncttok")
OptimizeIL.Emit(OpCodes.Ldnull)
OptimizeIL.Emit(OpCodes.Stloc, 10)
OptimizeIL.MarkSequencePoint(doc4, 488, 1, 488, 100)
Dim locbldr174 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(Token))
locbldr174.SetLocalSymInfo("gtctok")
OptimizeIL.Emit(OpCodes.Ldnull)
OptimizeIL.Emit(OpCodes.Stloc, 11)
OptimizeIL.MarkSequencePoint(doc4, 489, 1, 489, 100)
Dim locbldr175 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(TypeTok))
locbldr175.SetLocalSymInfo("gtcttok")
OptimizeIL.Emit(OpCodes.Ldnull)
OptimizeIL.Emit(OpCodes.Stloc, 12)
OptimizeIL.MarkSequencePoint(doc4, 490, 1, 490, 100)
Dim locbldr176 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(Token))
locbldr176.SetLocalSymInfo("mctok2")
OptimizeIL.Emit(OpCodes.Ldnull)
OptimizeIL.Emit(OpCodes.Stloc, 13)
OptimizeIL.MarkSequencePoint(doc4, 491, 1, 491, 100)
Dim locbldr177 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(Ident))
locbldr177.SetLocalSymInfo("mcident")
OptimizeIL.Emit(OpCodes.Ldnull)
OptimizeIL.Emit(OpCodes.Stloc, 14)
OptimizeIL.MarkSequencePoint(doc4, 492, 1, 492, 100)
Dim locbldr178 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(MethodCallTok))
locbldr178.SetLocalSymInfo("mcmetcall")
OptimizeIL.Emit(OpCodes.Ldnull)
OptimizeIL.Emit(OpCodes.Stloc, 15)
OptimizeIL.MarkSequencePoint(doc4, 493, 1, 493, 100)
Dim locbldr179 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(MethodNameTok))
locbldr179.SetLocalSymInfo("mcmetname")
OptimizeIL.Emit(OpCodes.Ldnull)
OptimizeIL.Emit(OpCodes.Stloc, 16)
OptimizeIL.MarkSequencePoint(doc4, 494, 1, 494, 100)
Dim locbldr180 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(StringLiteral))
locbldr180.SetLocalSymInfo("mcstr")
OptimizeIL.Emit(OpCodes.Ldnull)
OptimizeIL.Emit(OpCodes.Stloc, 17)
OptimizeIL.MarkSequencePoint(doc4, 495, 1, 495, 100)
Dim locbldr181 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(System.Int32))
locbldr181.SetLocalSymInfo("mcint")
OptimizeIL.Emit(OpCodes.Ldc_I4, CInt(0))
Typ = GetType(System.Int32)
OptimizeIL.Emit(OpCodes.Stloc, 18)
...
OptimizeIL.Emit(OpCodes.Blt, tru146)
OptimizeIL.Emit(OpCodes.Br, fa146)
...
Dim locbldr182 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(Token))
locbldr182.SetLocalSymInfo("tok")
OptimizeIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Expr)
OptimizeIL.Emit(OpCodes.Ldfld, GetType(Expr).GetField("Tokens"))
Typ = GetType(Expr).GetField("Tokens").FieldType
...
Dim locbldr183 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(System.Type))
locbldr183.SetLocalSymInfo("typ")
OptimizeIL.MarkSequencePoint(doc4, 516, 1, 516, 100)
Dim locbldr184 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(System.Boolean))
locbldr184.SetLocalSymInfo("b")
OptimizeIL.MarkSequencePoint(doc4, 517, 1, 517, 100)
Dim locbldr185 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(System.String))
locbldr185.SetLocalSymInfo("str")
...
OptimizeIL.Emit(OpCodes.Beq, fa149)
OptimizeIL.Emit(OpCodes.Br, tru149)
OptimizeIL.MarkLabel(tru149)
OptimizeIL.MarkSequencePoint(doc4, 531, 1, 531, 100)
Dim locbldr186 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(Token))
locbldr186.SetLocalSymInfo("tk")
OptimizeIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Expr)
OptimizeIL.Emit(OpCodes.Ldfld, GetType(Expr).GetField("Tokens"))
Typ = GetType(Expr).GetField("Tokens").FieldType
...
locbldr187.SetLocalSymInfo("ttk")
...
Dim locbldr188 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(Token))
locbldr188.SetLocalSymInfo("tk2")
OptimizeIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Expr)
OptimizeIL.Emit(OpCodes.Ldfld, GetType(Expr).GetField("Tokens"))
Typ = GetType(Expr).GetField("Tokens").FieldType
...
Dim locbldr189 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(TypeTok))
locbldr189.SetLocalSymInfo("ttk2")
OptimizeIL.Emit(OpCodes.Newobj, GetType(TypeTok).GetConstructor(Type.EmptyTypes))
OptimizeIL.Emit(OpCodes.Stloc, 26)
...
OptimizeIL.Emit(OpCodes.Beq, fa154)
OptimizeIL.Emit(OpCodes.Br, tru154)
...
OptimizeIL.Emit(OpCodes.Beq, fa156)
OptimizeIL.Emit(OpCodes.Br, tru156)
...
locbldr190.SetLocalSymInfo("tt1")
OptimizeIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Expr)
OptimizeIL.Emit(OpCodes.Ldfld, GetType(Expr).GetField("Tokens"))
Typ = GetType(Expr).GetField("Tokens").FieldType
...
Dim locbldr191 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(Ident))
locbldr191.SetLocalSymInfo("id1")
OptimizeIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Expr)
OptimizeIL.Emit(OpCodes.Ldfld, GetType(Expr).GetField("Tokens"))
Typ = GetType(Expr).GetField("Tokens").FieldType
...
Dim locbldr192 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(CharLiteral))
locbldr192.SetLocalSymInfo("cl1")
OptimizeIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Expr)
OptimizeIL.Emit(OpCodes.Ldfld, GetType(Expr).GetField("Tokens"))
Typ = GetType(Expr).GetField("Tokens").FieldType
...
Dim locbldr193 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(NullLiteral))
locbldr193.SetLocalSymInfo("nul1")
OptimizeIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Expr)
OptimizeIL.Emit(OpCodes.Ldfld, GetType(Expr).GetField("Tokens"))
Typ = GetType(Expr).GetField("Tokens").FieldType
...
Dim locbldr194 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(StringLiteral))
locbldr194.SetLocalSymInfo("sl1")
OptimizeIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Expr)
OptimizeIL.Emit(OpCodes.Ldfld, GetType(Expr).GetField("Tokens"))
Typ = GetType(Expr).GetField("Tokens").FieldType
...
Dim locbldr195 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(BooleanLiteral))
locbldr195.SetLocalSymInfo("bl1")
OptimizeIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Expr)
OptimizeIL.Emit(OpCodes.Ldfld, GetType(Expr).GetField("Tokens"))
Typ = GetType(Expr).GetField("Tokens").FieldType
...
Dim locbldr196 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(NumberLiteral))
locbldr196.SetLocalSymInfo("nl1")
OptimizeIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Expr)
OptimizeIL.Emit(OpCodes.Ldfld, GetType(Expr).GetField("Tokens"))
Typ = GetType(Expr).GetField("Tokens").FieldType
...
OptimizeIL.Emit(OpCodes.Beq, fa171)
OptimizeIL.Emit(OpCodes.Br, tru171)
...
Dim locbldr197 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(NewCallTok))
locbldr197.SetLocalSymInfo("nctoken")
OptimizeIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Expr)
OptimizeIL.Emit(OpCodes.Ldfld, GetType(Expr).GetField("Tokens"))
Typ = GetType(Expr).GetField("Tokens").FieldType
...
Dim locbldr198 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(Expr).MakeArrayType())
locbldr198.SetLocalSymInfo("ncprs")
OptimizeIL.Emit(OpCodes.Ldloc, 34)
Typ = GetType(NewCallTok)
...
Dim locbldr199 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(System.Int32))
locbldr199.SetLocalSymInfo("ncln2")
OptimizeIL.Emit(OpCodes.Ldloc, 35)
...
locbldr200.SetLocalSymInfo("nci2")
OptimizeIL.Emit(OpCodes.Ldc_I4, CInt(-1))
Typ = GetType(System.Int32)
OptimizeIL.Emit(OpCodes.Stloc, 37)
...
OptimizeIL.Emit(OpCodes.Blt, tru172)
...
OptimizeIL.Emit(OpCodes.Beq, fa175)
OptimizeIL.Emit(OpCodes.Br, tru175)
...
Dim locbldr201 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(GettypeCallTok))
locbldr201.SetLocalSymInfo("gtctoken")
...
Dim locbldr202 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(MethodCallTok))
locbldr202.SetLocalSymInfo("mct")
OptimizeIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Expr)
OptimizeIL.Emit(OpCodes.Ldfld, GetType(Expr).GetField("Tokens"))
Typ = GetType(Expr).GetField("Tokens").FieldType
...
Dim locbldr203 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(Expr).MakeArrayType())
locbldr203.SetLocalSymInfo("prs")
OptimizeIL.Emit(OpCodes.Ldloc, 39)
Typ = GetType(MethodCallTok)
...
Dim locbldr204 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(System.Int32))
locbldr204.SetLocalSymInfo("ln2")
OptimizeIL.Emit(OpCodes.Ldloc, 40)
Typ = GetType(Expr).MakeArrayType()
OptimizeIL.Emit(OpCodes.Ldlen)
OptimizeIL.Emit(OpCodes.Conv_I4)
...
OptimizeIL.Emit(OpCodes.Blt, tru179)
...
Dim locbldr206 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(Ident))
locbldr206.SetLocalSymInfo("aidt")
OptimizeIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Expr)
OptimizeIL.Emit(OpCodes.Ldfld, GetType(Expr).GetField("Tokens"))
Typ = GetType(Expr).GetField("Tokens").FieldType
...
Dim locbldr207 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(Expr))
locbldr207.SetLocalSymInfo("arriloc")
OptimizeIL.Emit(OpCodes.Ldloc, 43)
Typ = GetType(Ident)
...
Dim locbldr208 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(MethodCallTok))
locbldr208.SetLocalSymInfo("amtd")
OptimizeIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Expr)
OptimizeIL.Emit(OpCodes.Ldfld, GetType(Expr).GetField("Tokens"))
Typ = GetType(Expr).GetField("Tokens").FieldType
...
Dim locbldr209 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(MethodNameTok))
locbldr209.SetLocalSymInfo("amtdn")
OptimizeIL.Emit(OpCodes.Ldloc, 45)
Typ = GetType(MethodCallTok)
...
OptimizeIL.Emit(OpCodes.Bgt, tru184)
...
OptimizeIL.Emit(OpCodes.Bge, tru185)
...
OptimizeIL.Emit(OpCodes.Ble, tru194)
...
OptimizeIL.Emit(OpCodes.Beq, tru195)
...
Dim locbldr210 As LocalBuilder = checkRefasmIL.DeclareLocal(GetType(Token))
...
Dim locbldr211 As LocalBuilder = checkRefasmIL.DeclareLocal(GetType(System.Type))
...
Dim locbldr212 As LocalBuilder = checkRefasmIL.DeclareLocal(GetType(RefasmStmt))
locbldr212.SetLocalSymInfo("refasms")
...
Typ = GetType(System.Boolean)
Dim fa197 As System.Reflection.Emit.Label = checkRefasmIL.DefineLabel()
Dim tru197 As System.Reflection.Emit.Label = checkRefasmIL.DefineLabel()
Dim cont197 As System.Reflection.Emit.Label = checkRefasmIL.DefineLabel()
checkRefasmIL.Emit(OpCodes.Beq, tru197)
checkRefasmIL.Emit(OpCodes.Br, fa197)
checkRefasmIL.MarkLabel(tru197)
...
checkRefasmIL.Emit(OpCodes.Br, cont197)
checkRefasmIL.MarkLabel(fa197)
checkRefasmIL.Emit(OpCodes.Br, cont197)
checkRefasmIL.MarkLabel(cont197)
...
Dim locbldr213 As LocalBuilder = checkIfIL.DeclareLocal(GetType(Token))
locbldr213.SetLocalSymInfo("tok")
...
Dim locbldr214 As LocalBuilder = checkIfIL.DeclareLocal(GetType(System.Type))
locbldr214.SetLocalSymInfo("typ")
...
Dim locbldr215 As LocalBuilder = checkIfIL.DeclareLocal(GetType(IfStmt))
locbldr215.SetLocalSymInfo("ifs")
...
Dim locbldr216 As LocalBuilder = checkIfIL.DeclareLocal(GetType(Expr))
locbldr216.SetLocalSymInfo("exp")
...
Typ = GetType(System.Boolean)
Dim fa198 As System.Reflection.Emit.Label = checkIfIL.DefineLabel()
Dim tru198 As System.Reflection.Emit.Label = checkIfIL.DefineLabel()
Dim cont198 As System.Reflection.Emit.Label = checkIfIL.DefineLabel()
checkIfIL.Emit(OpCodes.Beq, tru198)
checkIfIL.Emit(OpCodes.Br, fa198)
checkIfIL.MarkLabel(tru198)
...
Dim locbldr217 As LocalBuilder = checkIfIL.DeclareLocal(GetType(System.Int32))
locbldr217.SetLocalSymInfo("i")
checkIfIL.Emit(OpCodes.Ldc_I4, CInt(0))
Typ = GetType(System.Int32)
...
Dim locbldr219 As LocalBuilder = checkIfIL.DeclareLocal(GetType(System.Boolean))
locbldr219.SetLocalSymInfo("b2")
...
Dim locbldr220 As LocalBuilder = checkIfIL.DeclareLocal(asm.GetType("dylan.NET.Tokenizer.Parser.ExprOptimizer"))
locbldr220.SetLocalSymInfo("eop")
...
checkIfIL.Emit(OpCodes.Br, cont198)
checkIfIL.MarkLabel(fa198)
checkIfIL.Emit(OpCodes.Br, cont198)
checkIfIL.MarkLabel(cont198)
...
Dim locbldr221 As LocalBuilder = checkElseIfIL.DeclareLocal(GetType(Token))
locbldr221.SetLocalSymInfo("tok")
...
Dim locbldr222 As LocalBuilder = checkElseIfIL.DeclareLocal(GetType(System.Type))
locbldr222.SetLocalSymInfo("typ")
...
Dim locbldr223 As LocalBuilder = checkElseIfIL.DeclareLocal(GetType(ElseIfStmt))
locbldr223.SetLocalSymInfo("ifs")
...
Dim locbldr224 As LocalBuilder = checkElseIfIL.DeclareLocal(GetType(Expr))
locbldr224.SetLocalSymInfo("exp")
...
Typ = GetType(System.Boolean)
Dim fa201 As System.Reflection.Emit.Label = checkElseIfIL.DefineLabel()
Dim tru201 As System.Reflection.Emit.Label = checkElseIfIL.DefineLabel()
Dim cont201 As System.Reflection.Emit.Label = checkElseIfIL.DefineLabel()
checkElseIfIL.Emit(OpCodes.Beq, tru201)
checkElseIfIL.Emit(OpCodes.Br, fa201)
checkElseIfIL.MarkLabel(tru201)
...
Dim locbldr225 As LocalBuilder = checkElseIfIL.DeclareLocal(GetType(System.Int32))
locbldr225.SetLocalSymInfo("i")
checkElseIfIL.Emit(OpCodes.Ldc_I4, CInt(0))
Typ = GetType(System.Int32)
...
locbldr226.SetLocalSymInfo("len")
checkElseIfIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
checkElseIfIL.Emit(OpCodes.Ldfld, GetType(Stmt).GetField("Tokens"))
Typ = GetType(Stmt).GetField("Tokens").FieldType
...
Dim locbldr227 As LocalBuilder = checkElseIfIL.DeclareLocal(GetType(System.Boolean))
locbldr227.SetLocalSymInfo("b2")
...
Dim locbldr228 As LocalBuilder = checkElseIfIL.DeclareLocal(asm.GetType("dylan.NET.Tokenizer.Parser.ExprOptimizer"))
...
checkElseIfIL.Emit(OpCodes.Br, cont201)
checkElseIfIL.MarkLabel(fa201)
checkElseIfIL.Emit(OpCodes.Br, cont201)
checkElseIfIL.MarkLabel(cont201)
...
Dim locbldr229 As LocalBuilder = checkDebugIL.DeclareLocal(GetType(Token))
...
Dim locbldr230 As LocalBuilder = checkDebugIL.DeclareLocal(GetType(System.Type))
...
Dim locbldr231 As LocalBuilder = checkDebugIL.DeclareLocal(GetType(DebugStmt))
locbldr231.SetLocalSymInfo("dbgs")
...
Typ = GetType(System.Boolean)
Dim fa204 As System.Reflection.Emit.Label = checkDebugIL.DefineLabel()
Dim tru204 As System.Reflection.Emit.Label = checkDebugIL.DefineLabel()
Dim cont204 As System.Reflection.Emit.Label = checkDebugIL.DefineLabel()
checkDebugIL.Emit(OpCodes.Beq, tru204)
checkDebugIL.Emit(OpCodes.Br, fa204)
checkDebugIL.MarkLabel(tru204)
...
checkDebugIL.Emit(OpCodes.Br, cont204)
checkDebugIL.MarkLabel(fa204)
checkDebugIL.Emit(OpCodes.Br, cont204)
checkDebugIL.MarkLabel(cont204)
...
Dim locbldr232 As LocalBuilder = checkScopeIL.DeclareLocal(GetType(Token))
...
Dim locbldr233 As LocalBuilder = checkScopeIL.DeclareLocal(GetType(System.Type))
...
Dim locbldr234 As LocalBuilder = checkScopeIL.DeclareLocal(GetType(ScopeStmt))
locbldr234.SetLocalSymInfo("scps")
...
Typ = GetType(System.Boolean)
Dim fa205 As System.Reflection.Emit.Label = checkScopeIL.DefineLabel()
Dim tru205 As System.Reflection.Emit.Label = checkScopeIL.DefineLabel()
Dim cont205 As System.Reflection.Emit.Label = checkScopeIL.DefineLabel()
checkScopeIL.Emit(OpCodes.Beq, tru205)
checkScopeIL.Emit(OpCodes.Br, fa205)
checkScopeIL.MarkLabel(tru205)
...
checkScopeIL.Emit(OpCodes.Br, cont205)
checkScopeIL.MarkLabel(fa205)
checkScopeIL.Emit(OpCodes.Br, cont205)
checkScopeIL.MarkLabel(cont205)
...
Dim locbldr235 As LocalBuilder = checkImportIL.DeclareLocal(GetType(Token))
...
Dim locbldr236 As LocalBuilder = checkImportIL.DeclareLocal(GetType(System.Type))
...
Dim locbldr237 As LocalBuilder = checkImportIL.DeclareLocal(GetType(ImportStmt))
locbldr237.SetLocalSymInfo("imps")
...
Typ = GetType(System.Boolean)
Dim fa206 As System.Reflection.Emit.Label = checkImportIL.DefineLabel()
Dim tru206 As System.Reflection.Emit.Label = checkImportIL.DefineLabel()
Dim cont206 As System.Reflection.Emit.Label = checkImportIL.DefineLabel()
checkImportIL.Emit(OpCodes.Beq, tru206)
checkImportIL.Emit(OpCodes.Br, fa206)
checkImportIL.MarkLabel(tru206)
...
checkImportIL.Emit(OpCodes.Br, cont206)
checkImportIL.MarkLabel(fa206)
checkImportIL.Emit(OpCodes.Br, cont206)
checkImportIL.MarkLabel(cont206)
...
Dim locbldr238 As LocalBuilder = checkLocimportIL.DeclareLocal(GetType(Token))
locbldr238.SetLocalSymInfo("tok")
...
Dim locbldr239 As LocalBuilder = checkLocimportIL.DeclareLocal(GetType(System.Type))
locbldr239.SetLocalSymInfo("typ")
...
Dim locbldr240 As LocalBuilder = checkLocimportIL.DeclareLocal(GetType(LocimportStmt))
locbldr240.SetLocalSymInfo("limps")
...
Typ = GetType(System.Boolean)
Dim fa207 As System.Reflection.Emit.Label = checkLocimportIL.DefineLabel()
Dim tru207 As System.Reflection.Emit.Label = checkLocimportIL.DefineLabel()
Dim cont207 As System.Reflection.Emit.Label = checkLocimportIL.DefineLabel()
checkLocimportIL.Emit(OpCodes.Beq, tru207)
checkLocimportIL.Emit(OpCodes.Br, fa207)
checkLocimportIL.MarkLabel(tru207)
...
checkLocimportIL.Emit(OpCodes.Br, cont207)
checkLocimportIL.MarkLabel(fa207)
checkLocimportIL.Emit(OpCodes.Br, cont207)
checkLocimportIL.MarkLabel(cont207)
...
Dim locbldr241 As LocalBuilder = checkReturnIL.DeclareLocal(GetType(Token))
...
Dim locbldr242 As LocalBuilder = checkReturnIL.DeclareLocal(GetType(System.Type))
...
Dim locbldr243 As LocalBuilder = checkReturnIL.DeclareLocal(GetType(ReturnStmt))
locbldr243.SetLocalSymInfo("rets")
...
Typ = GetType(System.Boolean)
Dim fa208 As System.Reflection.Emit.Label = checkReturnIL.DefineLabel()
Dim tru208 As System.Reflection.Emit.Label = checkReturnIL.DefineLabel()
Dim cont208 As System.Reflection.Emit.Label = checkReturnIL.DefineLabel()
checkReturnIL.Emit(OpCodes.Beq, tru208)
checkReturnIL.Emit(OpCodes.Br, fa208)
checkReturnIL.MarkLabel(tru208)
...
Dim locbldr244 As LocalBuilder = checkReturnIL.DeclareLocal(GetType(System.Int32))
...
locbldr245.SetLocalSymInfo("len")
checkReturnIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
checkReturnIL.Emit(OpCodes.Ldfld, GetType(Stmt).GetField("Tokens"))
Typ = GetType(Stmt).GetField("Tokens").FieldType
...
Dim locbldr246 As LocalBuilder = checkReturnIL.DeclareLocal(GetType(Expr))
locbldr246.SetLocalSymInfo("exp")
...
checkReturnIL.Emit(OpCodes.Bge, tru210)
...
checkReturnIL.Emit(OpCodes.Beq, tru211)
...
Dim locbldr247 As LocalBuilder = checkReturnIL.DeclareLocal(asm.GetType("dylan.NET.Tokenizer.Parser.ExprOptimizer"))
locbldr247.SetLocalSymInfo("eopt")
...
checkReturnIL.Emit(OpCodes.Br, cont208)
checkReturnIL.MarkLabel(fa208)
checkReturnIL.Emit(OpCodes.Br, cont208)
checkReturnIL.MarkLabel(cont208)
...
Dim locbldr248 As LocalBuilder = checkCmtIL.DeclareLocal(GetType(Token))
locbldr248.SetLocalSymInfo("tok")
...
Dim locbldr249 As LocalBuilder = checkCmtIL.DeclareLocal(GetType(System.Type))
locbldr249.SetLocalSymInfo("typ")
...
Dim locbldr250 As LocalBuilder = checkCmtIL.DeclareLocal(GetType(CommentStmt))
locbldr250.SetLocalSymInfo("cmts")
...
Typ = GetType(System.Boolean)
Dim fa212 As System.Reflection.Emit.Label = checkCmtIL.DefineLabel()
Dim tru212 As System.Reflection.Emit.Label = checkCmtIL.DefineLabel()
Dim cont212 As System.Reflection.Emit.Label = checkCmtIL.DefineLabel()
checkCmtIL.Emit(OpCodes.Beq, tru212)
checkCmtIL.Emit(OpCodes.Br, fa212)
checkCmtIL.MarkLabel(tru212)
...
checkCmtIL.Emit(OpCodes.Br, cont212)
checkCmtIL.MarkLabel(fa212)
checkCmtIL.Emit(OpCodes.Br, cont212)
checkCmtIL.MarkLabel(cont212)
...
Typ = GetType(System.Int32)
Dim fa213 As System.Reflection.Emit.Label = checkElseIL.DefineLabel()
Dim tru213 As System.Reflection.Emit.Label = checkElseIL.DefineLabel()
Dim cont213 As System.Reflection.Emit.Label = checkElseIL.DefineLabel()
checkElseIL.Emit(OpCodes.Blt, tru213)
checkElseIL.Emit(OpCodes.Br, fa213)
checkElseIL.MarkLabel(tru213)
checkElseIL.MarkSequencePoint(doc5, 249, 1, 249, 100)
Dim locbldr251 As LocalBuilder = checkElseIL.DeclareLocal(GetType(Token))
locbldr251.SetLocalSymInfo("tok1")
checkElseIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
checkElseIL.Emit(OpCodes.Ldfld, GetType(Stmt).GetField("Tokens"))
Typ = GetType(Stmt).GetField("Tokens").FieldType
...
Dim locbldr252 As LocalBuilder = checkElseIL.DeclareLocal(GetType(System.Type))
locbldr252.SetLocalSymInfo("typ1")
...
Dim locbldr253 As LocalBuilder = checkElseIL.DeclareLocal(GetType(System.Boolean))
locbldr253.SetLocalSymInfo("b1")
Dim typ41(-1) As Type
...
Dim locbldr254 As LocalBuilder = checkElseIL.DeclareLocal(GetType(ElseStmt))
locbldr254.SetLocalSymInfo("els")
...
checkElseIL.Emit(OpCodes.Beq, tru214)
...
checkElseIL.Emit(OpCodes.Br, cont213)
checkElseIL.MarkLabel(fa213)
checkElseIL.Emit(OpCodes.Br, cont213)
checkElseIL.MarkLabel(cont213)
...
Typ = GetType(System.Int32)
Dim fa215 As System.Reflection.Emit.Label = checkEndIfIL.DefineLabel()
Dim tru215 As System.Reflection.Emit.Label = checkEndIfIL.DefineLabel()
Dim cont215 As System.Reflection.Emit.Label = checkEndIfIL.DefineLabel()
checkEndIfIL.Emit(OpCodes.Bge, tru215)
checkEndIfIL.Emit(OpCodes.Br, fa215)
checkEndIfIL.MarkLabel(tru215)
checkEndIfIL.MarkSequencePoint(doc5, 267, 1, 267, 100)
Dim locbldr255 As LocalBuilder = checkEndIfIL.DeclareLocal(GetType(Token))
locbldr255.SetLocalSymInfo("tok1")
checkEndIfIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
checkEndIfIL.Emit(OpCodes.Ldfld, GetType(Stmt).GetField("Tokens"))
Typ = GetType(Stmt).GetField("Tokens").FieldType
...
Dim locbldr256 As LocalBuilder = checkEndIfIL.DeclareLocal(GetType(System.Type))
locbldr256.SetLocalSymInfo("typ1")
...
Dim locbldr257 As LocalBuilder = checkEndIfIL.DeclareLocal(GetType(System.Boolean))
locbldr257.SetLocalSymInfo("b1")
Dim typ44(-1) As Type
...
Dim locbldr258 As LocalBuilder = checkEndIfIL.DeclareLocal(GetType(Token))
locbldr258.SetLocalSymInfo("tok2")
checkEndIfIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
checkEndIfIL.Emit(OpCodes.Ldfld, GetType(Stmt).GetField("Tokens"))
Typ = GetType(Stmt).GetField("Tokens").FieldType
...
Dim locbldr259 As LocalBuilder = checkEndIfIL.DeclareLocal(GetType(System.Type))
locbldr259.SetLocalSymInfo("typ2")
...
Dim locbldr260 As LocalBuilder = checkEndIfIL.DeclareLocal(GetType(System.Boolean))
locbldr260.SetLocalSymInfo("b2")
Dim typ46(-1) As Type
...
Dim locbldr261 As LocalBuilder = checkEndIfIL.DeclareLocal(GetType(EndIfStmt))
locbldr261.SetLocalSymInfo("eifs")
...
checkEndIfIL.Emit(OpCodes.Beq, tru216)
...
checkEndIfIL.Emit(OpCodes.Br, cont215)
checkEndIfIL.MarkLabel(fa215)
checkEndIfIL.Emit(OpCodes.Br, cont215)
checkEndIfIL.MarkLabel(cont215)
...
Typ = GetType(System.Int32)
Dim fa217 As System.Reflection.Emit.Label = checkEndMtdIL.DefineLabel()
Dim tru217 As System.Reflection.Emit.Label = checkEndMtdIL.DefineLabel()
Dim cont217 As System.Reflection.Emit.Label = checkEndMtdIL.DefineLabel()
checkEndMtdIL.Emit(OpCodes.Bge, tru217)
checkEndMtdIL.Emit(OpCodes.Br, fa217)
checkEndMtdIL.MarkLabel(tru217)
checkEndMtdIL.MarkSequencePoint(doc5, 290, 1, 290, 100)
Dim locbldr262 As LocalBuilder = checkEndMtdIL.DeclareLocal(GetType(Token))
locbldr262.SetLocalSymInfo("tok1")
checkEndMtdIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
checkEndMtdIL.Emit(OpCodes.Ldfld, GetType(Stmt).GetField("Tokens"))
Typ = GetType(Stmt).GetField("Tokens").FieldType
...
Dim locbldr263 As LocalBuilder = checkEndMtdIL.DeclareLocal(GetType(System.Type))
locbldr263.SetLocalSymInfo("typ1")
...
Dim locbldr264 As LocalBuilder = checkEndMtdIL.DeclareLocal(GetType(System.Boolean))
locbldr264.SetLocalSymInfo("b1")
Dim typ49(-1) As Type
...
Dim locbldr265 As LocalBuilder = checkEndMtdIL.DeclareLocal(GetType(Token))
locbldr265.SetLocalSymInfo("tok2")
checkEndMtdIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
checkEndMtdIL.Emit(OpCodes.Ldfld, GetType(Stmt).GetField("Tokens"))
Typ = GetType(Stmt).GetField("Tokens").FieldType
...
Dim locbldr266 As LocalBuilder = checkEndMtdIL.DeclareLocal(GetType(System.Type))
locbldr266.SetLocalSymInfo("typ2")
...
Dim locbldr267 As LocalBuilder = checkEndMtdIL.DeclareLocal(GetType(System.Boolean))
locbldr267.SetLocalSymInfo("b2")
Dim typ51(-1) As Type
...
Dim locbldr268 As LocalBuilder = checkEndMtdIL.DeclareLocal(GetType(EndMethodStmt))
locbldr268.SetLocalSymInfo("ems")
...
checkEndMtdIL.Emit(OpCodes.Beq, tru218)
...
checkEndMtdIL.Emit(OpCodes.Br, cont217)
checkEndMtdIL.MarkLabel(fa217)
checkEndMtdIL.Emit(OpCodes.Br, cont217)
checkEndMtdIL.MarkLabel(cont217)
...
Typ = GetType(System.Int32)
Dim fa219 As System.Reflection.Emit.Label = checkEndClsIL.DefineLabel()
Dim tru219 As System.Reflection.Emit.Label = checkEndClsIL.DefineLabel()
Dim cont219 As System.Reflection.Emit.Label = checkEndClsIL.DefineLabel()
checkEndClsIL.Emit(OpCodes.Bge, tru219)
checkEndClsIL.Emit(OpCodes.Br, fa219)
checkEndClsIL.MarkLabel(tru219)
checkEndClsIL.MarkSequencePoint(doc5, 312, 1, 312, 100)
Dim locbldr269 As LocalBuilder = checkEndClsIL.DeclareLocal(GetType(Token))
locbldr269.SetLocalSymInfo("tok1")
checkEndClsIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
checkEndClsIL.Emit(OpCodes.Ldfld, GetType(Stmt).GetField("Tokens"))
Typ = GetType(Stmt).GetField("Tokens").FieldType
...
Dim locbldr270 As LocalBuilder = checkEndClsIL.DeclareLocal(GetType(System.Type))
locbldr270.SetLocalSymInfo("typ1")
...
Dim locbldr271 As LocalBuilder = checkEndClsIL.DeclareLocal(GetType(System.Boolean))
locbldr271.SetLocalSymInfo("b1")
Dim typ54(-1) As Type
...
Dim locbldr272 As LocalBuilder = checkEndClsIL.DeclareLocal(GetType(Token))
locbldr272.SetLocalSymInfo("tok2")
checkEndClsIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
checkEndClsIL.Emit(OpCodes.Ldfld, GetType(Stmt).GetField("Tokens"))
Typ = GetType(Stmt).GetField("Tokens").FieldType
...
Dim locbldr273 As LocalBuilder = checkEndClsIL.DeclareLocal(GetType(System.Type))
locbldr273.SetLocalSymInfo("typ2")
...
Dim locbldr274 As LocalBuilder = checkEndClsIL.DeclareLocal(GetType(System.Boolean))
locbldr274.SetLocalSymInfo("b2")
Dim typ56(-1) As Type
...
Dim locbldr275 As LocalBuilder = checkEndClsIL.DeclareLocal(GetType(EndClassStmt))
locbldr275.SetLocalSymInfo("ecs")
...
checkEndClsIL.Emit(OpCodes.Beq, tru220)
...
checkEndClsIL.Emit(OpCodes.Br, cont219)
checkEndClsIL.MarkLabel(fa219)
checkEndClsIL.Emit(OpCodes.Br, cont219)
checkEndClsIL.MarkLabel(cont219)
...
Dim locbldr276 As LocalBuilder = checkAssemblyIL.DeclareLocal(GetType(Token))
locbldr276.SetLocalSymInfo("tok")
...
Dim locbldr277 As LocalBuilder = checkAssemblyIL.DeclareLocal(GetType(System.Type))
locbldr277.SetLocalSymInfo("typ")
...
Dim locbldr278 As LocalBuilder = checkAssemblyIL.DeclareLocal(GetType(AssemblyStmt))
locbldr278.SetLocalSymInfo("asms")
...
Typ = GetType(System.Boolean)
Dim fa221 As System.Reflection.Emit.Label = checkAssemblyIL.DefineLabel()
Dim tru221 As System.Reflection.Emit.Label = checkAssemblyIL.DefineLabel()
Dim cont221 As System.Reflection.Emit.Label = checkAssemblyIL.DefineLabel()
checkAssemblyIL.Emit(OpCodes.Beq, tru221)
checkAssemblyIL.Emit(OpCodes.Br, fa221)
checkAssemblyIL.MarkLabel(tru221)
...
checkAssemblyIL.Emit(OpCodes.Br, cont221)
checkAssemblyIL.MarkLabel(fa221)
checkAssemblyIL.Emit(OpCodes.Br, cont221)
checkAssemblyIL.MarkLabel(cont221)
...
Dim locbldr279 As LocalBuilder = checkVerIL.DeclareLocal(GetType(Token))
locbldr279.SetLocalSymInfo("tok")
...
Dim locbldr280 As LocalBuilder = checkVerIL.DeclareLocal(GetType(System.Type))
locbldr280.SetLocalSymInfo("typ")
...
Dim locbldr281 As LocalBuilder = checkVerIL.DeclareLocal(GetType(VerStmt))
locbldr281.SetLocalSymInfo("vers")
...
Typ = GetType(System.Boolean)
Dim fa222 As System.Reflection.Emit.Label = checkVerIL.DefineLabel()
Dim tru222 As System.Reflection.Emit.Label = checkVerIL.DefineLabel()
Dim cont222 As System.Reflection.Emit.Label = checkVerIL.DefineLabel()
checkVerIL.Emit(OpCodes.Beq, tru222)
checkVerIL.Emit(OpCodes.Br, fa222)
checkVerIL.MarkLabel(tru222)
...
Dim locbldr282 As LocalBuilder = checkVerIL.DeclareLocal(GetType(System.String).MakeArrayType())
locbldr282.SetLocalSymInfo("ars")
Dim typ63(-1) As Type
checkVerIL.Emit(OpCodes.Ldloc, 0)
Typ = GetType(Token)
...
Dim locbldr283 As LocalBuilder = checkVerIL.DeclareLocal(GetType(System.Int32).MakeArrayType())
locbldr283.SetLocalSymInfo("ari")
...
Dim locbldr284 As LocalBuilder = checkVerIL.DeclareLocal(GetType(IntLiteral).MakeArrayType())
locbldr284.SetLocalSymInfo("intla")
checkVerIL.Emit(OpCodes.Ldc_I4, CInt(4))
Typ = GetType(System.Int32)
checkVerIL.Emit(OpCodes.Conv_U)
...
Dim locbldr285 As LocalBuilder = checkVerIL.DeclareLocal(GetType(IntLiteral))
locbldr285.SetLocalSymInfo("intl")
...
checkVerIL.Emit(OpCodes.Br, cont222)
checkVerIL.MarkLabel(fa222)
checkVerIL.Emit(OpCodes.Br, cont222)
checkVerIL.MarkLabel(cont222)
...
Dim locbldr286 As LocalBuilder = checkClassIL.DeclareLocal(GetType(Token))
locbldr286.SetLocalSymInfo("tok")
...
Dim locbldr287 As LocalBuilder = checkClassIL.DeclareLocal(GetType(System.Type))
locbldr287.SetLocalSymInfo("typ")
...
Dim locbldr288 As LocalBuilder = checkClassIL.DeclareLocal(GetType(ClassStmt))
locbldr288.SetLocalSymInfo("clss")
...
Dim locbldr289 As LocalBuilder = checkClassIL.DeclareLocal(GetType(Attributes.Attribute))
locbldr289.SetLocalSymInfo("att")
...
Typ = GetType(System.Boolean)
Dim fa223 As System.Reflection.Emit.Label = checkClassIL.DefineLabel()
Dim tru223 As System.Reflection.Emit.Label = checkClassIL.DefineLabel()
Dim cont223 As System.Reflection.Emit.Label = checkClassIL.DefineLabel()
checkClassIL.Emit(OpCodes.Beq, tru223)
checkClassIL.Emit(OpCodes.Br, fa223)
checkClassIL.MarkLabel(tru223)
...
Dim locbldr290 As LocalBuilder = checkClassIL.DeclareLocal(GetType(System.Int32))
locbldr290.SetLocalSymInfo("i")
checkClassIL.Emit(OpCodes.Ldc_I4, CInt(0))
Typ = GetType(System.Int32)
...
locbldr291.SetLocalSymInfo("len")
checkClassIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
checkClassIL.Emit(OpCodes.Ldfld, GetType(Stmt).GetField("Tokens"))
Typ = GetType(Stmt).GetField("Tokens").FieldType
...
Dim locbldr292 As LocalBuilder = checkClassIL.DeclareLocal(GetType(System.Boolean))
locbldr292.SetLocalSymInfo("bl")
...
Dim locbldr293 As LocalBuilder = checkClassIL.DeclareLocal(GetType(Token))
locbldr293.SetLocalSymInfo("tok2")
checkClassIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
checkClassIL.Emit(OpCodes.Ldfld, GetType(Stmt).GetField("Tokens"))
Typ = GetType(Stmt).GetField("Tokens").FieldType
...
Dim locbldr294 As LocalBuilder = checkClassIL.DeclareLocal(GetType(System.Type))
locbldr294.SetLocalSymInfo("typ2")
...
Dim locbldr295 As LocalBuilder = checkClassIL.DeclareLocal(GetType(System.Boolean))
locbldr295.SetLocalSymInfo("b2")
Dim typ79(-1) As Type
...
checkClassIL.Emit(OpCodes.Beq, fa226)
checkClassIL.Emit(OpCodes.Br, tru226)
checkClassIL.MarkLabel(tru226)
checkClassIL.MarkSequencePoint(doc5, 424, 1, 424, 100)
Dim locbldr296 As LocalBuilder = checkClassIL.DeclareLocal(GetType(Token))
locbldr296.SetLocalSymInfo("t")
checkClassIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
checkClassIL.Emit(OpCodes.Ldfld, GetType(Stmt).GetField("Tokens"))
Typ = GetType(Stmt).GetField("Tokens").FieldType
...
Dim locbldr297 As LocalBuilder = checkClassIL.DeclareLocal(GetType(TypeTok))
locbldr297.SetLocalSymInfo("tt")
...
checkClassIL.Emit(OpCodes.Beq, tru227)
checkClassIL.Emit(OpCodes.Br, fa227)
...
checkClassIL.Emit(OpCodes.Br, cont223)
checkClassIL.MarkLabel(fa223)
checkClassIL.Emit(OpCodes.Br, cont223)
checkClassIL.MarkLabel(cont223)
...
Dim locbldr298 As LocalBuilder = checkFieldIL.DeclareLocal(GetType(Token))
locbldr298.SetLocalSymInfo("tok")
...
Dim locbldr299 As LocalBuilder = checkFieldIL.DeclareLocal(GetType(System.Type))
locbldr299.SetLocalSymInfo("typ")
...
Dim locbldr300 As LocalBuilder = checkFieldIL.DeclareLocal(GetType(FieldStmt))
locbldr300.SetLocalSymInfo("flss")
...
Dim locbldr301 As LocalBuilder = checkFieldIL.DeclareLocal(GetType(Attributes.Attribute))
locbldr301.SetLocalSymInfo("att")
...
Typ = GetType(System.Boolean)
Dim fa228 As System.Reflection.Emit.Label = checkFieldIL.DefineLabel()
Dim tru228 As System.Reflection.Emit.Label = checkFieldIL.DefineLabel()
Dim cont228 As System.Reflection.Emit.Label = checkFieldIL.DefineLabel()
checkFieldIL.Emit(OpCodes.Beq, tru228)
checkFieldIL.Emit(OpCodes.Br, fa228)
checkFieldIL.MarkLabel(tru228)
checkFieldIL.MarkSequencePoint(doc5, 461, 1, 461, 100)
Dim locbldr302 As LocalBuilder = checkFieldIL.DeclareLocal(GetType(Expr))
locbldr302.SetLocalSymInfo("tempexp")
...
Dim locbldr303 As LocalBuilder = checkFieldIL.DeclareLocal(asm.GetType("dylan.NET.Tokenizer.Parser.ExprOptimizer"))
locbldr303.SetLocalSymInfo("eop")
...
Dim locbldr304 As LocalBuilder = checkFieldIL.DeclareLocal(GetType(System.Int32))
locbldr304.SetLocalSymInfo("i")
checkFieldIL.Emit(OpCodes.Ldc_I4, CInt(0))
Typ = GetType(System.Int32)
...
Dim locbldr306 As LocalBuilder = checkFieldIL.DeclareLocal(GetType(System.Boolean))
locbldr306.SetLocalSymInfo("bl")
checkFieldIL.Emit(OpCodes.Ldc_I4, 0)
Typ = GetType(System.Boolean)
...
Dim locbldr307 As LocalBuilder = checkFieldIL.DeclareLocal(GetType(Token))
locbldr307.SetLocalSymInfo("tok2")
checkFieldIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
checkFieldIL.Emit(OpCodes.Ldfld, GetType(Stmt).GetField("Tokens"))
Typ = GetType(Stmt).GetField("Tokens").FieldType
...
Dim locbldr308 As LocalBuilder = checkFieldIL.DeclareLocal(GetType(System.Type))
locbldr308.SetLocalSymInfo("typ2")
...
Dim locbldr309 As LocalBuilder = checkFieldIL.DeclareLocal(GetType(System.Boolean))
locbldr309.SetLocalSymInfo("b2")
Dim typ90(-1) As Type
...
checkFieldIL.Emit(OpCodes.Beq, fa231)
checkFieldIL.Emit(OpCodes.Br, tru231)
checkFieldIL.MarkLabel(tru231)
checkFieldIL.MarkSequencePoint(doc5, 505, 1, 505, 100)
Dim locbldr310 As LocalBuilder = checkFieldIL.DeclareLocal(GetType(Token))
locbldr310.SetLocalSymInfo("t")
checkFieldIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
checkFieldIL.Emit(OpCodes.Ldfld, GetType(Stmt).GetField("Tokens"))
Typ = GetType(Stmt).GetField("Tokens").FieldType
...
Dim locbldr311 As LocalBuilder = checkFieldIL.DeclareLocal(GetType(TypeTok))
locbldr311.SetLocalSymInfo("tt")
...
checkFieldIL.Emit(OpCodes.Br, cont228)
checkFieldIL.MarkLabel(fa228)
checkFieldIL.Emit(OpCodes.Br, cont228)
checkFieldIL.MarkLabel(cont228)
...
Dim locbldr312 As LocalBuilder = checkMethodIL.DeclareLocal(GetType(Token))
locbldr312.SetLocalSymInfo("tok")
...
Dim locbldr313 As LocalBuilder = checkMethodIL.DeclareLocal(GetType(System.Type))
locbldr313.SetLocalSymInfo("typ")
...
Dim locbldr314 As LocalBuilder = checkMethodIL.DeclareLocal(GetType(MethodStmt))
locbldr314.SetLocalSymInfo("mtss")
...
Dim locbldr315 As LocalBuilder = checkMethodIL.DeclareLocal(GetType(Attributes.Attribute))
locbldr315.SetLocalSymInfo("att")
...
Dim locbldr316 As LocalBuilder = checkMethodIL.DeclareLocal(GetType(Ident))
locbldr316.SetLocalSymInfo("mn")
...
Dim locbldr317 As LocalBuilder = checkMethodIL.DeclareLocal(GetType(Expr))
locbldr317.SetLocalSymInfo("exp")
checkMethodIL.Emit(OpCodes.Ldnull)
checkMethodIL.Emit(OpCodes.Stloc, 5)
checkMethodIL.MarkSequencePoint(doc5, 531, 1, 531, 100)
Dim locbldr318 As LocalBuilder = checkMethodIL.DeclareLocal(GetType(System.Boolean))
locbldr318.SetLocalSymInfo("d")
...
Dim locbldr319 As LocalBuilder = checkMethodIL.DeclareLocal(GetType(Expr))
locbldr319.SetLocalSymInfo("tempexp")
...
Dim locbldr320 As LocalBuilder = checkMethodIL.DeclareLocal(asm.GetType("dylan.NET.Tokenizer.Parser.ExprOptimizer"))
locbldr320.SetLocalSymInfo("eop")
...
Dim locbldr321 As LocalBuilder = checkMethodIL.DeclareLocal(GetType(System.Int32))
locbldr321.SetLocalSymInfo("i")
checkMethodIL.Emit(OpCodes.Ldc_I4, CInt(0))
Typ = GetType(System.Int32)
...
locbldr322.SetLocalSymInfo("len")
checkMethodIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
checkMethodIL.Emit(OpCodes.Ldfld, GetType(Stmt).GetField("Tokens"))
Typ = GetType(Stmt).GetField("Tokens").FieldType
...
Dim locbldr323 As LocalBuilder = checkMethodIL.DeclareLocal(GetType(System.Boolean))
locbldr323.SetLocalSymInfo("bl")
checkMethodIL.Emit(OpCodes.Ldc_I4, 0)
Typ = GetType(System.Boolean)
...
Dim locbldr324 As LocalBuilder = checkMethodIL.DeclareLocal(GetType(Token))
locbldr324.SetLocalSymInfo("tok2")
checkMethodIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
checkMethodIL.Emit(OpCodes.Ldfld, GetType(Stmt).GetField("Tokens"))
Typ = GetType(Stmt).GetField("Tokens").FieldType
...
Dim locbldr325 As LocalBuilder = checkMethodIL.DeclareLocal(GetType(System.Type))
locbldr325.SetLocalSymInfo("typ2")
checkMethodIL.MarkSequencePoint(doc5, 585, 1, 585, 100)
Dim locbldr326 As LocalBuilder = checkMethodIL.DeclareLocal(GetType(System.Boolean))
locbldr326.SetLocalSymInfo("b2")
...
checkMethodIL.Emit(OpCodes.Beq, fa235)
checkMethodIL.Emit(OpCodes.Br, tru235)
checkMethodIL.MarkLabel(tru235)
checkMethodIL.MarkSequencePoint(doc5, 591, 1, 591, 100)
Dim locbldr327 As LocalBuilder = checkMethodIL.DeclareLocal(GetType(Token))
locbldr327.SetLocalSymInfo("t")
checkMethodIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
checkMethodIL.Emit(OpCodes.Ldfld, GetType(Stmt).GetField("Tokens"))
Typ = GetType(Stmt).GetField("Tokens").FieldType
...
Dim locbldr328 As LocalBuilder = checkMethodIL.DeclareLocal(GetType(TypeTok))
locbldr328.SetLocalSymInfo("tt")
...
Dim locbldr329 As LocalBuilder = checkMethodIL.DeclareLocal(asm.GetType("dylan.NET.Tokenizer.Parser.ExprOptimizer"))
locbldr329.SetLocalSymInfo("eopt2")
checkMethodIL.Emit(OpCodes.Newobj, asm.GetType("dylan.NET.Tokenizer.Parser.ExprOptimizer").GetConstructor(Type.EmptyTypes))
...
locbldr330.SetLocalSymInfo("eopt1")
checkMethodIL.Emit(OpCodes.Newobj, asm.GetType("dylan.NET.Tokenizer.Parser.ExprOptimizer").GetConstructor(Type.EmptyTypes))
...
Dim locbldr331 As LocalBuilder = checkMethodCallIL.DeclareLocal(GetType(Token))
locbldr331.SetLocalSymInfo("tok")
checkMethodCallIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
checkMethodCallIL.Emit(OpCodes.Ldfld, GetType(Stmt).GetField("Tokens"))
Typ = GetType(Stmt).GetField("Tokens").FieldType
...
Dim locbldr332 As LocalBuilder = checkMethodCallIL.DeclareLocal(GetType(System.Type))
locbldr332.SetLocalSymInfo("typ")
...
Dim locbldr333 As LocalBuilder = checkMethodCallIL.DeclareLocal(GetType(Token))
locbldr333.SetLocalSymInfo("tokb")
checkMethodCallIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
checkMethodCallIL.Emit(OpCodes.Ldfld, GetType(Stmt).GetField("Tokens"))
Typ = GetType(Stmt).GetField("Tokens").FieldType
...
Dim locbldr334 As LocalBuilder = checkMethodCallIL.DeclareLocal(GetType(System.Type))
locbldr334.SetLocalSymInfo("typb")
...
Dim locbldr335 As LocalBuilder = checkMethodCallIL.DeclareLocal(GetType(System.Boolean))
locbldr335.SetLocalSymInfo("ba")
Dim typ118(-1) As Type
...
Dim locbldr337 As LocalBuilder = checkMethodCallIL.DeclareLocal(GetType(MethodCallStmt))
locbldr337.SetLocalSymInfo("mtcss")
...
Dim locbldr338 As LocalBuilder = checkMethodCallIL.DeclareLocal(GetType(MethodNameTok))
locbldr338.SetLocalSymInfo("mn")
...
Dim locbldr339 As LocalBuilder = checkMethodCallIL.DeclareLocal(GetType(MethodCallTok))
locbldr339.SetLocalSymInfo("mct")
...
Dim locbldr340 As LocalBuilder = checkMethodCallIL.DeclareLocal(GetType(Ident))
locbldr340.SetLocalSymInfo("idt")
...
Dim locbldr341 As LocalBuilder = checkMethodCallIL.DeclareLocal(GetType(Expr))
locbldr341.SetLocalSymInfo("exp")
...
Dim locbldr342 As LocalBuilder = checkMethodCallIL.DeclareLocal(GetType(System.Int32))
locbldr342.SetLocalSymInfo("lvl")
checkMethodCallIL.Emit(OpCodes.Ldc_I4, CInt(1))
Typ = GetType(System.Int32)
checkMethodCallIL.Emit(OpCodes.Stloc, 11)
checkMethodCallIL.MarkSequencePoint(doc5, 695, 1, 695, 100)
Dim locbldr343 As LocalBuilder = checkMethodCallIL.DeclareLocal(GetType(System.Boolean))
locbldr343.SetLocalSymInfo("d")
...
Dim locbldr344 As LocalBuilder = checkMethodCallIL.DeclareLocal(GetType(System.Int32))
locbldr344.SetLocalSymInfo("i")
checkMethodCallIL.Emit(OpCodes.Ldc_I4, CInt(1))
Typ = GetType(System.Int32)
...
Dim locbldr345 As LocalBuilder = checkMethodCallIL.DeclareLocal(GetType(Token))
locbldr345.SetLocalSymInfo("tok2")
checkMethodCallIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
checkMethodCallIL.Emit(OpCodes.Ldfld, GetType(Stmt).GetField("Tokens"))
Typ = GetType(Stmt).GetField("Tokens").FieldType
...
Dim locbldr346 As LocalBuilder = checkMethodCallIL.DeclareLocal(GetType(System.Type))
locbldr346.SetLocalSymInfo("typ2")
checkMethodCallIL.MarkSequencePoint(doc5, 709, 1, 709, 100)
Dim locbldr347 As LocalBuilder = checkMethodCallIL.DeclareLocal(GetType(System.Boolean))
locbldr347.SetLocalSymInfo("b2")
checkMethodCallIL.MarkSequencePoint(doc5, 710, 1, 710, 100)
Dim locbldr348 As LocalBuilder = checkMethodCallIL.DeclareLocal(GetType(System.Int32))
locbldr348.SetLocalSymInfo("len")
checkMethodCallIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
checkMethodCallIL.Emit(OpCodes.Ldfld, GetType(Stmt).GetField("Tokens"))
Typ = GetType(Stmt).GetField("Tokens").FieldType
...
Dim locbldr349 As LocalBuilder = checkMethodCallIL.DeclareLocal(asm.GetType("dylan.NET.Tokenizer.Parser.ExprOptimizer"))
locbldr349.SetLocalSymInfo("eopt")
...
checkMethodCallIL.Emit(OpCodes.Bgt, tru250)
...
checkMethodCallIL.Emit(OpCodes.Beq, tru251)
...
checkMethodCallIL.Emit(OpCodes.Bgt, tru254)
...
checkMethodCallIL.Emit(OpCodes.Beq, tru255)
...
Dim locbldr350 As LocalBuilder = checkVarAsIL.DeclareLocal(GetType(Token))
locbldr350.SetLocalSymInfo("tok")
checkVarAsIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
...
Dim locbldr351 As LocalBuilder = checkVarAsIL.DeclareLocal(GetType(System.Type))
locbldr351.SetLocalSymInfo("typ")
checkVarAsIL.Emit(OpCodes.Ldtoken, GetType(VarTok))
...
Dim locbldr352 As LocalBuilder = checkVarAsIL.DeclareLocal(GetType(VarStmt))
locbldr352.SetLocalSymInfo("vars")
...
checkVarAsIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa257 As System.Reflection.Emit.Label = checkVarAsIL.DefineLabel()
Dim tru257 As System.Reflection.Emit.Label = checkVarAsIL.DefineLabel()
Dim cont257 As System.Reflection.Emit.Label = checkVarAsIL.DefineLabel()
checkVarAsIL.Emit(OpCodes.Beq, tru257)
checkVarAsIL.Emit(OpCodes.Br, fa257)
checkVarAsIL.MarkLabel(tru257)
...
Dim locbldr353 As LocalBuilder = checkVarAsIL.DeclareLocal(GetType(Expr))
locbldr353.SetLocalSymInfo("tempexp")
...
Dim locbldr354 As LocalBuilder = checkVarAsIL.DeclareLocal(asm.GetType("dylan.NET.Tokenizer.Parser.ExprOptimizer"))
locbldr354.SetLocalSymInfo("eop")
...
Dim locbldr355 As LocalBuilder = checkVarAsIL.DeclareLocal(GetType(Token))
locbldr355.SetLocalSymInfo("tok2")
checkVarAsIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
checkVarAsIL.Emit(OpCodes.Ldfld, GetType(Stmt).GetField("Tokens"))
Typ = GetType(Stmt).GetField("Tokens").FieldType
...
Dim locbldr356 As LocalBuilder = checkVarAsIL.DeclareLocal(GetType(System.Type))
locbldr356.SetLocalSymInfo("typ2")
checkVarAsIL.Emit(OpCodes.Ldtoken, GetType(TypeTok))
...
Dim locbldr357 As LocalBuilder = checkVarAsIL.DeclareLocal(GetType(System.Boolean))
locbldr357.SetLocalSymInfo("b2")
Dim typ136(-1) As Type
checkVarAsIL.Emit(OpCodes.Ldloc, 6)
Typ = GetType(System.Type)
Typ03 = Typ
...
checkVarAsIL.Emit(OpCodes.Beq, fa258)
checkVarAsIL.Emit(OpCodes.Br, tru258)
checkVarAsIL.MarkLabel(tru258)
checkVarAsIL.MarkSequencePoint(doc5, 815, 1, 815, 100)
Dim locbldr358 As LocalBuilder = checkVarAsIL.DeclareLocal(GetType(Token))
locbldr358.SetLocalSymInfo("t")
checkVarAsIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
checkVarAsIL.Emit(OpCodes.Ldfld, GetType(Stmt).GetField("Tokens"))
Typ = GetType(Stmt).GetField("Tokens").FieldType
...
Dim locbldr359 As LocalBuilder = checkVarAsIL.DeclareLocal(GetType(TypeTok))
locbldr359.SetLocalSymInfo("tt")
checkVarAsIL.Emit(OpCodes.Newobj, GetType(TypeTok).GetConstructor(Type.EmptyTypes))
...
checkVarAsIL.Emit(OpCodes.Br, cont257)
checkVarAsIL.MarkLabel(fa257)
checkVarAsIL.Emit(OpCodes.Br, cont257)
checkVarAsIL.MarkLabel(cont257)
...
Dim locbldr360 As LocalBuilder = AssOptIL.DeclareLocal(GetType(AssignStmt))
locbldr360.SetLocalSymInfo("asss")
AssOptIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
AssOptIL.Emit(OpCodes.Stloc, 0)
AssOptIL.MarkSequencePoint(doc5, 831, 1, 831, 100)
Dim locbldr361 As LocalBuilder = AssOptIL.DeclareLocal(GetType(Expr))
locbldr361.SetLocalSymInfo("le")
...
Dim locbldr362 As LocalBuilder = AssOptIL.DeclareLocal(GetType(Token))
locbldr362.SetLocalSymInfo("tok")
...
Dim locbldr363 As LocalBuilder = AssOptIL.DeclareLocal(GetType(System.Type))
locbldr363.SetLocalSymInfo("typ")
...
Dim locbldr364 As LocalBuilder = AssOptIL.DeclareLocal(GetType(System.Boolean))
locbldr364.SetLocalSymInfo("b")
Dim typ139(-1) As Type
...
Dim locbldr365 As LocalBuilder = AssOptIL.DeclareLocal(GetType(VarAsgnStmt))
locbldr365.SetLocalSymInfo("vass")
...
Typ = GetType(System.Boolean)
Dim fa259 As System.Reflection.Emit.Label = AssOptIL.DefineLabel()
Dim tru259 As System.Reflection.Emit.Label = AssOptIL.DefineLabel()
Dim cont259 As System.Reflection.Emit.Label = AssOptIL.DefineLabel()
AssOptIL.Emit(OpCodes.Beq, tru259)
AssOptIL.Emit(OpCodes.Br, fa259)
AssOptIL.MarkLabel(tru259)
...
Dim locbldr366 As LocalBuilder = AssOptIL.DeclareLocal(GetType(Token))
locbldr366.SetLocalSymInfo("tok2")
AssOptIL.Emit(OpCodes.Ldloc, 1)
Typ = GetType(Expr)
AssOptIL.Emit(OpCodes.Ldfld, GetType(Expr).GetField("Tokens"))
Typ = GetType(Expr).GetField("Tokens").FieldType
...
Dim locbldr367 As LocalBuilder = AssOptIL.DeclareLocal(GetType(System.Type))
locbldr367.SetLocalSymInfo("typ2")
...
Dim locbldr368 As LocalBuilder = AssOptIL.DeclareLocal(GetType(System.Boolean))
locbldr368.SetLocalSymInfo("b2")
Dim typ141(-1) As Type
...
AssOptIL.Emit(OpCodes.Beq, fa260)
AssOptIL.Emit(OpCodes.Br, tru260)
AssOptIL.MarkLabel(tru260)
AssOptIL.MarkSequencePoint(doc5, 846, 1, 846, 100)
Dim locbldr369 As LocalBuilder = AssOptIL.DeclareLocal(GetType(Token))
locbldr369.SetLocalSymInfo("t")
AssOptIL.Emit(OpCodes.Ldloc, 1)
Typ = GetType(Expr)
AssOptIL.Emit(OpCodes.Ldfld, GetType(Expr).GetField("Tokens"))
Typ = GetType(Expr).GetField("Tokens").FieldType
...
Dim locbldr370 As LocalBuilder = AssOptIL.DeclareLocal(GetType(TypeTok))
locbldr370.SetLocalSymInfo("tt")
...
Dim locbldr371 As LocalBuilder = AssOptIL.DeclareLocal(asm.GetType("dylan.NET.Tokenizer.Parser.ExprOptimizer"))
locbldr371.SetLocalSymInfo("eop")
...
Dim locbldr372 As LocalBuilder = checkAssignIL.DeclareLocal(GetType(Token))
locbldr372.SetLocalSymInfo("tok")
checkAssignIL.Emit(OpCodes.Ldnull)
checkAssignIL.Emit(OpCodes.Stloc, 0)
checkAssignIL.MarkSequencePoint(doc5, 868, 1, 868, 100)
Dim locbldr373 As LocalBuilder = checkAssignIL.DeclareLocal(GetType(System.Type))
locbldr373.SetLocalSymInfo("typ")
...
Dim locbldr374 As LocalBuilder = checkAssignIL.DeclareLocal(GetType(AssignStmt))
locbldr374.SetLocalSymInfo("asss")
...
Dim locbldr375 As LocalBuilder = checkAssignIL.DeclareLocal(GetType(System.Boolean))
locbldr375.SetLocalSymInfo("c")
checkAssignIL.Emit(OpCodes.Ldc_I4, 0)
Typ = GetType(System.Boolean)
checkAssignIL.Emit(OpCodes.Stloc, 3)
checkAssignIL.MarkSequencePoint(doc5, 871, 1, 871, 100)
Dim locbldr376 As LocalBuilder = checkAssignIL.DeclareLocal(GetType(Expr))
locbldr376.SetLocalSymInfo("re")
...
locbldr377.SetLocalSymInfo("le")
checkAssignIL.Emit(OpCodes.Newobj, GetType(Expr).GetConstructor(Type.EmptyTypes))
checkAssignIL.Emit(OpCodes.Stloc, 5)
checkAssignIL.MarkSequencePoint(doc5, 873, 1, 873, 100)
Dim locbldr378 As LocalBuilder = checkAssignIL.DeclareLocal(GetType(System.Int32))
locbldr378.SetLocalSymInfo("i")
...
locbldr379.SetLocalSymInfo("len")
...
locbldr380.SetLocalSymInfo("assind")
...
Typ = GetType(System.Boolean)
Dim fa261 As System.Reflection.Emit.Label = checkAssignIL.DefineLabel()
Dim tru261 As System.Reflection.Emit.Label = checkAssignIL.DefineLabel()
Dim cont261 As System.Reflection.Emit.Label = checkAssignIL.DefineLabel()
checkAssignIL.Emit(OpCodes.Beq, tru261)
checkAssignIL.Emit(OpCodes.Br, fa261)
checkAssignIL.MarkLabel(tru261)
...
checkAssignIL.Emit(OpCodes.Br, cont261)
checkAssignIL.MarkLabel(fa261)
checkAssignIL.Emit(OpCodes.Br, cont261)
checkAssignIL.MarkLabel(cont261)
...
checkAssignIL.Emit(OpCodes.Beq, fa263)
checkAssignIL.Emit(OpCodes.Br, tru263)
...
checkAssignIL.Emit(OpCodes.Beq, tru264)
checkAssignIL.Emit(OpCodes.Br, fa264)
...
Dim locbldr381 As LocalBuilder = checkAssignIL.DeclareLocal(asm.GetType("dylan.NET.Tokenizer.Parser.ExprOptimizer"))
locbldr381.SetLocalSymInfo("eop")
...
Dim locbldr382 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(System.Int32))
locbldr382.SetLocalSymInfo("i")
OptimizeIL.Emit(OpCodes.Ldc_I4, CInt(-1))
Typ = GetType(System.Int32)
OptimizeIL.Emit(OpCodes.Stloc, 0)
...
locbldr383.SetLocalSymInfo("len")
OptimizeIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
...
Dim locbldr384 As LocalBuilder = OptimizeIL.DeclareLocal(asm.GetType("dylan.NET.Tokenizer.Parser.TokenOptimizer"))
locbldr384.SetLocalSymInfo("to")
OptimizeIL.Emit(OpCodes.Ldnull)
OptimizeIL.Emit(OpCodes.Stloc, 2)
OptimizeIL.MarkSequencePoint(doc5, 973, 1, 973, 100)
Dim locbldr385 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(Stmt))
locbldr385.SetLocalSymInfo("tmpstm")
OptimizeIL.Emit(OpCodes.Ldnull)
OptimizeIL.Emit(OpCodes.Stloc, 3)
OptimizeIL.MarkSequencePoint(doc5, 974, 1, 974, 100)
Dim locbldr386 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(System.Boolean))
locbldr386.SetLocalSymInfo("compb")
OptimizeIL.Emit(OpCodes.Ldc_I4, 0)
Typ = GetType(System.Boolean)
OptimizeIL.Emit(OpCodes.Stloc, 4)
...
OptimizeIL.Emit(OpCodes.Blt, tru266)
...
Dim locbldr387 As LocalBuilder = ParseIL.DeclareLocal(GetType(System.Int32))
locbldr387.SetLocalSymInfo("i")
ParseIL.Emit(OpCodes.Ldc_I4, CInt(-1))
Typ = GetType(System.Int32)
ParseIL.Emit(OpCodes.Stloc, 0)
ParseIL.MarkSequencePoint(doc6, 13, 1, 13, 100)
Dim locbldr388 As LocalBuilder = ParseIL.DeclareLocal(asm.GetType("dylan.NET.Tokenizer.Parser.StmtOptimizer"))
locbldr388.SetLocalSymInfo("so")
ParseIL.Emit(OpCodes.Ldnull)
ParseIL.Emit(OpCodes.Stloc, 1)
ParseIL.MarkSequencePoint(doc6, 14, 1, 14, 100)
Dim locbldr389 As LocalBuilder = ParseIL.DeclareLocal(GetType(System.Int32))
locbldr389.SetLocalSymInfo("len")
...
ParseIL.Emit(OpCodes.Ldloc, 2)
Typ = GetType(System.Int32)
Dim fa292 As System.Reflection.Emit.Label = ParseIL.DefineLabel()
Dim tru292 As System.Reflection.Emit.Label = ParseIL.DefineLabel()
Dim cont292 As System.Reflection.Emit.Label = ParseIL.DefineLabel()
ParseIL.Emit(OpCodes.Beq, tru292)
ParseIL.Emit(OpCodes.Br, fa292)
ParseIL.MarkLabel(tru292)
ParseIL.MarkSequencePoint(doc6, 27, 1, 27, 100)
ParseIL.Emit(OpCodes.Br, label1)
ParseIL.MarkSequencePoint(doc6, 28, 1, 28, 100)
ParseIL.Emit(OpCodes.Br, cont292)
ParseIL.MarkLabel(fa292)
ParseIL.MarkSequencePoint(doc6, 29, 1, 29, 100)
ParseIL.Emit(OpCodes.Br, label0)
ParseIL.MarkSequencePoint(doc6, 30, 1, 30, 100)
ParseIL.Emit(OpCodes.Br, cont292)
ParseIL.MarkLabel(cont292)
