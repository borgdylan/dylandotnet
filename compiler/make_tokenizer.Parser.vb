...
SetUnaryFalseIL.MarkSequencePoint(doc2, 34, 1, 34, 100)
SetUnaryFalseIL.Emit(OpCodes.Ldc_I4, 0)
Typ = GetType(System.Boolean)
SetUnaryFalseIL.Emit(OpCodes.Stsfld, NegFlag)
SetUnaryFalseIL.MarkSequencePoint(doc2, 35, 1, 35, 100)
SetUnaryFalseIL.Emit(OpCodes.Ldc_I4, 0)
Typ = GetType(System.Boolean)
...
UpdateIdentIL.MarkSequencePoint(doc2, 47, 1, 47, 100)
...
UpdateIdentIL.MarkSequencePoint(doc2, 48, 1, 48, 100)
UpdateIdentIL.Emit(OpCodes.Ldarg, 0)
Typ = GetType(Ident)
...
UpdateIdentIL.MarkSequencePoint(doc2, 49, 1, 49, 100)
UpdateIdentIL.Emit(OpCodes.Ldarg, 0)
Typ = GetType(Ident)
...
OptimizeIL.MarkLabel(label0)
OptimizeIL.MarkSequencePoint(doc4, 42, 1, 42, 100)
OptimizeIL.Emit(OpCodes.Ldloc, 1)
Typ = GetType(System.Int32)
OptimizeIL.Emit(OpCodes.Ldc_I4, CInt(1))
Typ = GetType(System.Int32)
...
OptimizeIL.Emit(OpCodes.Stloc, 1)
OptimizeIL.MarkSequencePoint(doc4, 44, 1, 44, 100)
OptimizeIL.Emit(OpCodes.Ldloc, 1)
Typ = GetType(System.Int32)
OptimizeIL.Emit(OpCodes.Ldloc, 0)
Typ = GetType(System.Int32)
...
OptimizeIL.Emit(OpCodes.Br, label0)
OptimizeIL.MarkSequencePoint(doc4, 48, 1, 48, 100)
OptimizeIL.Emit(OpCodes.Br, cont79)
OptimizeIL.MarkLabel(cont79)
OptimizeIL.MarkSequencePoint(doc4, 50, 1, 50, 100)
...
Dim locbldr92 As LocalBuilder = checkRefasmIL.DeclareLocal(GetType(Token))
...
Dim locbldr93 As LocalBuilder = checkRefasmIL.DeclareLocal(GetType(System.Type))
...
Dim locbldr94 As LocalBuilder = checkRefasmIL.DeclareLocal(GetType(RefasmStmt))
locbldr94.SetLocalSymInfo("refasms")
...
Typ = GetType(System.Boolean)
Dim fa80 As System.Reflection.Emit.Label = checkRefasmIL.DefineLabel()
Dim tru80 As System.Reflection.Emit.Label = checkRefasmIL.DefineLabel()
Dim cont80 As System.Reflection.Emit.Label = checkRefasmIL.DefineLabel()
checkRefasmIL.Emit(OpCodes.Beq, tru80)
checkRefasmIL.Emit(OpCodes.Br, fa80)
checkRefasmIL.MarkLabel(tru80)
...
checkRefasmIL.Emit(OpCodes.Br, cont80)
checkRefasmIL.MarkLabel(fa80)
checkRefasmIL.Emit(OpCodes.Br, cont80)
checkRefasmIL.MarkLabel(cont80)
...
Dim locbldr95 As LocalBuilder = checkImportIL.DeclareLocal(GetType(Token))
locbldr95.SetLocalSymInfo("tok")
...
Dim locbldr96 As LocalBuilder = checkImportIL.DeclareLocal(GetType(System.Type))
...
Dim locbldr97 As LocalBuilder = checkImportIL.DeclareLocal(GetType(ImportStmt))
locbldr97.SetLocalSymInfo("imps")
...
Typ = GetType(System.Boolean)
Dim fa81 As System.Reflection.Emit.Label = checkImportIL.DefineLabel()
Dim tru81 As System.Reflection.Emit.Label = checkImportIL.DefineLabel()
Dim cont81 As System.Reflection.Emit.Label = checkImportIL.DefineLabel()
checkImportIL.Emit(OpCodes.Beq, tru81)
checkImportIL.Emit(OpCodes.Br, fa81)
checkImportIL.MarkLabel(tru81)
...
checkImportIL.Emit(OpCodes.Br, cont81)
checkImportIL.MarkLabel(fa81)
checkImportIL.Emit(OpCodes.Br, cont81)
checkImportIL.MarkLabel(cont81)
...
Dim locbldr98 As LocalBuilder = checkLocimportIL.DeclareLocal(GetType(Token))
...
Dim locbldr99 As LocalBuilder = checkLocimportIL.DeclareLocal(GetType(System.Type))
...
Dim locbldr100 As LocalBuilder = checkLocimportIL.DeclareLocal(GetType(LocimportStmt))
locbldr100.SetLocalSymInfo("limps")
...
Typ = GetType(System.Boolean)
Dim fa82 As System.Reflection.Emit.Label = checkLocimportIL.DefineLabel()
Dim tru82 As System.Reflection.Emit.Label = checkLocimportIL.DefineLabel()
Dim cont82 As System.Reflection.Emit.Label = checkLocimportIL.DefineLabel()
checkLocimportIL.Emit(OpCodes.Beq, tru82)
checkLocimportIL.Emit(OpCodes.Br, fa82)
checkLocimportIL.MarkLabel(tru82)
...
checkLocimportIL.Emit(OpCodes.Br, cont82)
checkLocimportIL.MarkLabel(fa82)
checkLocimportIL.Emit(OpCodes.Br, cont82)
checkLocimportIL.MarkLabel(cont82)
...
Dim locbldr101 As LocalBuilder = checkCmtIL.DeclareLocal(GetType(Token))
...
Dim locbldr102 As LocalBuilder = checkCmtIL.DeclareLocal(GetType(System.Type))
...
Dim locbldr103 As LocalBuilder = checkCmtIL.DeclareLocal(GetType(CommentStmt))
locbldr103.SetLocalSymInfo("cmts")
...
Typ = GetType(System.Boolean)
Dim fa83 As System.Reflection.Emit.Label = checkCmtIL.DefineLabel()
Dim tru83 As System.Reflection.Emit.Label = checkCmtIL.DefineLabel()
Dim cont83 As System.Reflection.Emit.Label = checkCmtIL.DefineLabel()
checkCmtIL.Emit(OpCodes.Beq, tru83)
checkCmtIL.Emit(OpCodes.Br, fa83)
checkCmtIL.MarkLabel(tru83)
...
checkCmtIL.Emit(OpCodes.Br, cont83)
checkCmtIL.MarkLabel(fa83)
checkCmtIL.Emit(OpCodes.Br, cont83)
checkCmtIL.MarkLabel(cont83)
...
Typ = GetType(System.Int32)
Dim fa84 As System.Reflection.Emit.Label = checkEndMtdIL.DefineLabel()
Dim tru84 As System.Reflection.Emit.Label = checkEndMtdIL.DefineLabel()
Dim cont84 As System.Reflection.Emit.Label = checkEndMtdIL.DefineLabel()
checkEndMtdIL.Emit(OpCodes.Bge, tru84)
checkEndMtdIL.Emit(OpCodes.Br, fa84)
checkEndMtdIL.MarkLabel(tru84)
checkEndMtdIL.MarkSequencePoint(doc5, 57, 1, 57, 100)
Dim locbldr104 As LocalBuilder = checkEndMtdIL.DeclareLocal(GetType(Token))
locbldr104.SetLocalSymInfo("tok1")
checkEndMtdIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
checkEndMtdIL.Emit(OpCodes.Ldfld, GetType(Stmt).GetField("Tokens"))
Typ = GetType(Stmt).GetField("Tokens").FieldType
...
Dim locbldr105 As LocalBuilder = checkEndMtdIL.DeclareLocal(GetType(System.Type))
locbldr105.SetLocalSymInfo("typ1")
...
Dim locbldr106 As LocalBuilder = checkEndMtdIL.DeclareLocal(GetType(System.Boolean))
locbldr106.SetLocalSymInfo("b1")
Dim typ14(-1) As Type
...
Dim locbldr107 As LocalBuilder = checkEndMtdIL.DeclareLocal(GetType(Token))
...
Dim locbldr108 As LocalBuilder = checkEndMtdIL.DeclareLocal(GetType(System.Type))
...
Dim locbldr109 As LocalBuilder = checkEndMtdIL.DeclareLocal(GetType(System.Boolean))
...
Dim locbldr110 As LocalBuilder = checkEndMtdIL.DeclareLocal(GetType(EndMethodStmt))
locbldr110.SetLocalSymInfo("ems")
...
Typ = GetType(System.Boolean)
Dim fa85 As System.Reflection.Emit.Label = checkEndMtdIL.DefineLabel()
Dim tru85 As System.Reflection.Emit.Label = checkEndMtdIL.DefineLabel()
Dim cont85 As System.Reflection.Emit.Label = checkEndMtdIL.DefineLabel()
checkEndMtdIL.Emit(OpCodes.Beq, tru85)
checkEndMtdIL.Emit(OpCodes.Br, fa85)
checkEndMtdIL.MarkLabel(tru85)
...
checkEndMtdIL.Emit(OpCodes.Br, cont85)
checkEndMtdIL.MarkLabel(fa85)
checkEndMtdIL.Emit(OpCodes.Br, cont85)
checkEndMtdIL.MarkLabel(cont85)
checkEndMtdIL.MarkSequencePoint(doc5, 72, 1, 72, 100)
checkEndMtdIL.Emit(OpCodes.Br, cont84)
checkEndMtdIL.MarkLabel(fa84)
checkEndMtdIL.Emit(OpCodes.Br, cont84)
checkEndMtdIL.MarkLabel(cont84)
...
Typ = GetType(System.Int32)
Dim fa86 As System.Reflection.Emit.Label = checkEndClsIL.DefineLabel()
Dim tru86 As System.Reflection.Emit.Label = checkEndClsIL.DefineLabel()
Dim cont86 As System.Reflection.Emit.Label = checkEndClsIL.DefineLabel()
checkEndClsIL.Emit(OpCodes.Bge, tru86)
checkEndClsIL.Emit(OpCodes.Br, fa86)
checkEndClsIL.MarkLabel(tru86)
checkEndClsIL.MarkSequencePoint(doc5, 79, 1, 79, 100)
Dim locbldr111 As LocalBuilder = checkEndClsIL.DeclareLocal(GetType(Token))
locbldr111.SetLocalSymInfo("tok1")
checkEndClsIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
checkEndClsIL.Emit(OpCodes.Ldfld, GetType(Stmt).GetField("Tokens"))
Typ = GetType(Stmt).GetField("Tokens").FieldType
...
Dim locbldr112 As LocalBuilder = checkEndClsIL.DeclareLocal(GetType(System.Type))
locbldr112.SetLocalSymInfo("typ1")
...
Dim locbldr113 As LocalBuilder = checkEndClsIL.DeclareLocal(GetType(System.Boolean))
locbldr113.SetLocalSymInfo("b1")
Dim typ19(-1) As Type
...
Dim locbldr114 As LocalBuilder = checkEndClsIL.DeclareLocal(GetType(Token))
locbldr114.SetLocalSymInfo("tok2")
checkEndClsIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
checkEndClsIL.Emit(OpCodes.Ldfld, GetType(Stmt).GetField("Tokens"))
Typ = GetType(Stmt).GetField("Tokens").FieldType
...
Dim locbldr115 As LocalBuilder = checkEndClsIL.DeclareLocal(GetType(System.Type))
locbldr115.SetLocalSymInfo("typ2")
...
Dim locbldr116 As LocalBuilder = checkEndClsIL.DeclareLocal(GetType(System.Boolean))
locbldr116.SetLocalSymInfo("b2")
Dim typ21(-1) As Type
...
Dim locbldr117 As LocalBuilder = checkEndClsIL.DeclareLocal(GetType(EndClassStmt))
locbldr117.SetLocalSymInfo("ecs")
...
Typ = GetType(System.Boolean)
Dim fa87 As System.Reflection.Emit.Label = checkEndClsIL.DefineLabel()
Dim tru87 As System.Reflection.Emit.Label = checkEndClsIL.DefineLabel()
Dim cont87 As System.Reflection.Emit.Label = checkEndClsIL.DefineLabel()
checkEndClsIL.Emit(OpCodes.Beq, tru87)
checkEndClsIL.Emit(OpCodes.Br, fa87)
checkEndClsIL.MarkLabel(tru87)
...
checkEndClsIL.Emit(OpCodes.Br, cont87)
checkEndClsIL.MarkLabel(fa87)
checkEndClsIL.Emit(OpCodes.Br, cont87)
checkEndClsIL.MarkLabel(cont87)
checkEndClsIL.MarkSequencePoint(doc5, 94, 1, 94, 100)
checkEndClsIL.Emit(OpCodes.Br, cont86)
checkEndClsIL.MarkLabel(fa86)
checkEndClsIL.Emit(OpCodes.Br, cont86)
checkEndClsIL.MarkLabel(cont86)
...
Dim locbldr118 As LocalBuilder = checkAssemblyIL.DeclareLocal(GetType(Token))
locbldr118.SetLocalSymInfo("tok")
...
Dim locbldr119 As LocalBuilder = checkAssemblyIL.DeclareLocal(GetType(System.Type))
...
Dim locbldr120 As LocalBuilder = checkAssemblyIL.DeclareLocal(GetType(AssemblyStmt))
locbldr120.SetLocalSymInfo("asms")
...
Typ = GetType(System.Boolean)
Dim fa88 As System.Reflection.Emit.Label = checkAssemblyIL.DefineLabel()
Dim tru88 As System.Reflection.Emit.Label = checkAssemblyIL.DefineLabel()
Dim cont88 As System.Reflection.Emit.Label = checkAssemblyIL.DefineLabel()
checkAssemblyIL.Emit(OpCodes.Beq, tru88)
checkAssemblyIL.Emit(OpCodes.Br, fa88)
checkAssemblyIL.MarkLabel(tru88)
...
checkAssemblyIL.Emit(OpCodes.Br, cont88)
checkAssemblyIL.MarkLabel(fa88)
checkAssemblyIL.Emit(OpCodes.Br, cont88)
checkAssemblyIL.MarkLabel(cont88)
...
Dim locbldr121 As LocalBuilder = checkVerIL.DeclareLocal(GetType(Token))
locbldr121.SetLocalSymInfo("tok")
...
Dim locbldr122 As LocalBuilder = checkVerIL.DeclareLocal(GetType(System.Type))
locbldr122.SetLocalSymInfo("typ")
...
Dim locbldr123 As LocalBuilder = checkVerIL.DeclareLocal(GetType(VerStmt))
locbldr123.SetLocalSymInfo("vers")
...
Typ = GetType(System.Boolean)
Dim fa89 As System.Reflection.Emit.Label = checkVerIL.DefineLabel()
Dim tru89 As System.Reflection.Emit.Label = checkVerIL.DefineLabel()
Dim cont89 As System.Reflection.Emit.Label = checkVerIL.DefineLabel()
checkVerIL.Emit(OpCodes.Beq, tru89)
checkVerIL.Emit(OpCodes.Br, fa89)
checkVerIL.MarkLabel(tru89)
...
Dim locbldr124 As LocalBuilder = checkVerIL.DeclareLocal(GetType(System.String).MakeArrayType())
locbldr124.SetLocalSymInfo("ars")
Dim typ28(-1) As Type
checkVerIL.Emit(OpCodes.Ldloc, 0)
Typ = GetType(Token)
...
Dim locbldr125 As LocalBuilder = checkVerIL.DeclareLocal(GetType(System.Int32).MakeArrayType())
locbldr125.SetLocalSymInfo("ari")
...
Dim locbldr126 As LocalBuilder = checkVerIL.DeclareLocal(GetType(IntLiteral).MakeArrayType())
locbldr126.SetLocalSymInfo("intla")
checkVerIL.Emit(OpCodes.Ldc_I4, CInt(4))
Typ = GetType(System.Int32)
checkVerIL.Emit(OpCodes.Conv_U)
...
Dim locbldr127 As LocalBuilder = checkVerIL.DeclareLocal(GetType(IntLiteral))
locbldr127.SetLocalSymInfo("intl")
...
checkVerIL.Emit(OpCodes.Br, cont89)
checkVerIL.MarkLabel(fa89)
checkVerIL.Emit(OpCodes.Br, cont89)
checkVerIL.MarkLabel(cont89)
...
Dim locbldr128 As LocalBuilder = checkClassIL.DeclareLocal(GetType(Token))
...
Dim locbldr129 As LocalBuilder = checkClassIL.DeclareLocal(GetType(System.Type))
...
Dim locbldr130 As LocalBuilder = checkClassIL.DeclareLocal(GetType(ClassStmt))
locbldr130.SetLocalSymInfo("clss")
...
Dim locbldr131 As LocalBuilder = checkClassIL.DeclareLocal(GetType(Attributes.Attribute))
locbldr131.SetLocalSymInfo("att")
...
Typ = GetType(System.Boolean)
Dim fa90 As System.Reflection.Emit.Label = checkClassIL.DefineLabel()
Dim tru90 As System.Reflection.Emit.Label = checkClassIL.DefineLabel()
Dim cont90 As System.Reflection.Emit.Label = checkClassIL.DefineLabel()
checkClassIL.Emit(OpCodes.Beq, tru90)
checkClassIL.Emit(OpCodes.Br, fa90)
checkClassIL.MarkLabel(tru90)
...
Dim locbldr132 As LocalBuilder = checkClassIL.DeclareLocal(GetType(System.Int32))
locbldr132.SetLocalSymInfo("i")
checkClassIL.Emit(OpCodes.Ldc_I4, CInt(0))
Typ = GetType(System.Int32)
checkClassIL.Emit(OpCodes.Stloc, 4)
checkClassIL.MarkSequencePoint(doc5, 165, 1, 165, 100)
Dim locbldr133 As LocalBuilder = checkClassIL.DeclareLocal(GetType(System.Int32))
...
Dim locbldr134 As LocalBuilder = checkClassIL.DeclareLocal(GetType(System.Boolean))
locbldr134.SetLocalSymInfo("bl")
...
checkClassIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa91 As System.Reflection.Emit.Label = checkClassIL.DefineLabel()
Dim tru91 As System.Reflection.Emit.Label = checkClassIL.DefineLabel()
Dim cont91 As System.Reflection.Emit.Label = checkClassIL.DefineLabel()
checkClassIL.Emit(OpCodes.Beq, tru91)
checkClassIL.Emit(OpCodes.Br, fa91)
checkClassIL.MarkLabel(tru91)
...
checkClassIL.Emit(OpCodes.Br, cont91)
checkClassIL.MarkLabel(fa91)
checkClassIL.MarkSequencePoint(doc5, 180, 1, 180, 100)
Dim locbldr135 As LocalBuilder = checkClassIL.DeclareLocal(GetType(Token))
locbldr135.SetLocalSymInfo("tok2")
checkClassIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
checkClassIL.Emit(OpCodes.Ldfld, GetType(Stmt).GetField("Tokens"))
Typ = GetType(Stmt).GetField("Tokens").FieldType
...
Dim locbldr136 As LocalBuilder = checkClassIL.DeclareLocal(GetType(System.Type))
locbldr136.SetLocalSymInfo("typ2")
...
Dim locbldr137 As LocalBuilder = checkClassIL.DeclareLocal(GetType(System.Boolean))
locbldr137.SetLocalSymInfo("b2")
Dim typ44(-1) As Type
...
checkClassIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa92 As System.Reflection.Emit.Label = checkClassIL.DefineLabel()
Dim tru92 As System.Reflection.Emit.Label = checkClassIL.DefineLabel()
Dim cont92 As System.Reflection.Emit.Label = checkClassIL.DefineLabel()
checkClassIL.Emit(OpCodes.Beq, tru92)
checkClassIL.Emit(OpCodes.Br, fa92)
checkClassIL.MarkLabel(tru92)
...
checkClassIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa93 As System.Reflection.Emit.Label = checkClassIL.DefineLabel()
Dim tru93 As System.Reflection.Emit.Label = checkClassIL.DefineLabel()
Dim cont93 As System.Reflection.Emit.Label = checkClassIL.DefineLabel()
checkClassIL.Emit(OpCodes.Beq, fa93)
checkClassIL.Emit(OpCodes.Br, tru93)
checkClassIL.MarkLabel(tru93)
checkClassIL.MarkSequencePoint(doc5, 191, 1, 191, 100)
Dim locbldr138 As LocalBuilder = checkClassIL.DeclareLocal(GetType(Token))
locbldr138.SetLocalSymInfo("t")
checkClassIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
checkClassIL.Emit(OpCodes.Ldfld, GetType(Stmt).GetField("Tokens"))
Typ = GetType(Stmt).GetField("Tokens").FieldType
...
Dim locbldr139 As LocalBuilder = checkClassIL.DeclareLocal(GetType(TypeTok))
locbldr139.SetLocalSymInfo("tt")
...
checkClassIL.Emit(OpCodes.Br, cont93)
checkClassIL.MarkLabel(fa93)
...
checkClassIL.Emit(OpCodes.Br, cont93)
checkClassIL.MarkLabel(cont93)
checkClassIL.MarkSequencePoint(doc5, 199, 1, 199, 100)
checkClassIL.Emit(OpCodes.Br, cont92)
checkClassIL.MarkLabel(fa92)
...
checkClassIL.Emit(OpCodes.Br, cont92)
checkClassIL.MarkLabel(cont92)
checkClassIL.MarkSequencePoint(doc5, 203, 1, 203, 100)
checkClassIL.Emit(OpCodes.Br, cont91)
checkClassIL.MarkLabel(cont91)
checkClassIL.MarkSequencePoint(doc5, 205, 1, 205, 100)
checkClassIL.Emit(OpCodes.Ldloc, 4)
Typ = GetType(System.Int32)
checkClassIL.Emit(OpCodes.Ldloc, 5)
Typ = GetType(System.Int32)
Dim fa94 As System.Reflection.Emit.Label = checkClassIL.DefineLabel()
Dim tru94 As System.Reflection.Emit.Label = checkClassIL.DefineLabel()
Dim cont94 As System.Reflection.Emit.Label = checkClassIL.DefineLabel()
checkClassIL.Emit(OpCodes.Beq, tru94)
checkClassIL.Emit(OpCodes.Br, fa94)
checkClassIL.MarkLabel(tru94)
...
checkClassIL.Emit(OpCodes.Br, cont94)
checkClassIL.MarkLabel(fa94)
...
checkClassIL.Emit(OpCodes.Br, cont90)
checkClassIL.MarkLabel(fa90)
checkClassIL.Emit(OpCodes.Br, cont90)
checkClassIL.MarkLabel(cont90)
...
Dim locbldr140 As LocalBuilder = checkMethodIL.DeclareLocal(GetType(Token))
...
Dim locbldr141 As LocalBuilder = checkMethodIL.DeclareLocal(GetType(System.Type))
...
Dim locbldr142 As LocalBuilder = checkMethodIL.DeclareLocal(GetType(MethodStmt))
locbldr142.SetLocalSymInfo("mtss")
...
Dim locbldr143 As LocalBuilder = checkMethodIL.DeclareLocal(GetType(Attributes.Attribute))
locbldr143.SetLocalSymInfo("att")
...
Dim locbldr144 As LocalBuilder = checkMethodIL.DeclareLocal(GetType(Ident))
locbldr144.SetLocalSymInfo("mn")
...
Dim locbldr145 As LocalBuilder = checkMethodIL.DeclareLocal(GetType(Expr))
locbldr145.SetLocalSymInfo("exp")
checkMethodIL.Emit(OpCodes.Ldnull)
checkMethodIL.Emit(OpCodes.Stloc, 5)
checkMethodIL.MarkSequencePoint(doc5, 226, 1, 226, 100)
Dim locbldr146 As LocalBuilder = checkMethodIL.DeclareLocal(GetType(System.Boolean))
locbldr146.SetLocalSymInfo("d")
...
Typ = GetType(System.Boolean)
Dim fa95 As System.Reflection.Emit.Label = checkMethodIL.DefineLabel()
Dim tru95 As System.Reflection.Emit.Label = checkMethodIL.DefineLabel()
Dim cont95 As System.Reflection.Emit.Label = checkMethodIL.DefineLabel()
checkMethodIL.Emit(OpCodes.Beq, tru95)
checkMethodIL.Emit(OpCodes.Br, fa95)
checkMethodIL.MarkLabel(tru95)
...
Dim locbldr147 As LocalBuilder = checkMethodIL.DeclareLocal(GetType(System.Int32))
locbldr147.SetLocalSymInfo("i")
checkMethodIL.Emit(OpCodes.Ldc_I4, CInt(0))
Typ = GetType(System.Int32)
checkMethodIL.Emit(OpCodes.Stloc, 7)
checkMethodIL.MarkSequencePoint(doc5, 238, 1, 238, 100)
Dim locbldr148 As LocalBuilder = checkMethodIL.DeclareLocal(GetType(System.Int32))
...
Dim locbldr149 As LocalBuilder = checkMethodIL.DeclareLocal(GetType(System.Boolean))
locbldr149.SetLocalSymInfo("bl")
checkMethodIL.Emit(OpCodes.Ldc_I4, 0)
Typ = GetType(System.Boolean)
...
checkMethodIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa96 As System.Reflection.Emit.Label = checkMethodIL.DefineLabel()
Dim tru96 As System.Reflection.Emit.Label = checkMethodIL.DefineLabel()
Dim cont96 As System.Reflection.Emit.Label = checkMethodIL.DefineLabel()
checkMethodIL.Emit(OpCodes.Beq, tru96)
checkMethodIL.Emit(OpCodes.Br, fa96)
checkMethodIL.MarkLabel(tru96)
...
checkMethodIL.Emit(OpCodes.Br, cont96)
checkMethodIL.MarkLabel(fa96)
...
checkMethodIL.Emit(OpCodes.Br, cont96)
checkMethodIL.MarkLabel(cont96)
checkMethodIL.MarkSequencePoint(doc5, 257, 1, 257, 100)
checkMethodIL.Emit(OpCodes.Ldloc, 7)
Typ = GetType(System.Int32)
checkMethodIL.Emit(OpCodes.Ldloc, 8)
Typ = GetType(System.Int32)
Dim fa97 As System.Reflection.Emit.Label = checkMethodIL.DefineLabel()
Dim tru97 As System.Reflection.Emit.Label = checkMethodIL.DefineLabel()
Dim cont97 As System.Reflection.Emit.Label = checkMethodIL.DefineLabel()
checkMethodIL.Emit(OpCodes.Beq, tru97)
checkMethodIL.Emit(OpCodes.Br, fa97)
checkMethodIL.MarkLabel(tru97)
...
checkMethodIL.Emit(OpCodes.Br, cont97)
checkMethodIL.MarkLabel(fa97)
...
checkMethodIL.Emit(OpCodes.Br, cont97)
checkMethodIL.MarkLabel(cont97)
...
Dim locbldr150 As LocalBuilder = checkMethodIL.DeclareLocal(GetType(Token))
...
Dim locbldr151 As LocalBuilder = checkMethodIL.DeclareLocal(GetType(System.Type))
...
checkMethodIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa98 As System.Reflection.Emit.Label = checkMethodIL.DefineLabel()
Dim tru98 As System.Reflection.Emit.Label = checkMethodIL.DefineLabel()
Dim cont98 As System.Reflection.Emit.Label = checkMethodIL.DefineLabel()
checkMethodIL.Emit(OpCodes.Beq, fa98)
checkMethodIL.Emit(OpCodes.Br, tru98)
checkMethodIL.MarkLabel(tru98)
checkMethodIL.MarkSequencePoint(doc5, 278, 1, 278, 100)
Dim locbldr153 As LocalBuilder = checkMethodIL.DeclareLocal(GetType(Token))
locbldr153.SetLocalSymInfo("t")
checkMethodIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
checkMethodIL.Emit(OpCodes.Ldfld, GetType(Stmt).GetField("Tokens"))
Typ = GetType(Stmt).GetField("Tokens").FieldType
...
Dim locbldr154 As LocalBuilder = checkMethodIL.DeclareLocal(GetType(TypeTok))
locbldr154.SetLocalSymInfo("tt")
...
checkMethodIL.Emit(OpCodes.Br, cont98)
checkMethodIL.MarkLabel(fa98)
...
checkMethodIL.Emit(OpCodes.Br, cont98)
checkMethodIL.MarkLabel(cont98)
...
checkMethodIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa99 As System.Reflection.Emit.Label = checkMethodIL.DefineLabel()
Dim tru99 As System.Reflection.Emit.Label = checkMethodIL.DefineLabel()
Dim cont99 As System.Reflection.Emit.Label = checkMethodIL.DefineLabel()
checkMethodIL.Emit(OpCodes.Beq, tru99)
checkMethodIL.Emit(OpCodes.Br, fa99)
checkMethodIL.MarkLabel(tru99)
...
checkMethodIL.Emit(OpCodes.Br, cont99)
checkMethodIL.MarkLabel(fa99)
checkMethodIL.Emit(OpCodes.Br, cont99)
checkMethodIL.MarkLabel(cont99)
...
checkMethodIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa100 As System.Reflection.Emit.Label = checkMethodIL.DefineLabel()
Dim tru100 As System.Reflection.Emit.Label = checkMethodIL.DefineLabel()
Dim cont100 As System.Reflection.Emit.Label = checkMethodIL.DefineLabel()
checkMethodIL.Emit(OpCodes.Beq, tru100)
checkMethodIL.Emit(OpCodes.Br, fa100)
checkMethodIL.MarkLabel(tru100)
...
Dim locbldr155 As LocalBuilder = checkMethodIL.DeclareLocal(asm.GetType("dylan.NET.Tokenizer.Parser.ExprOptimizer"))
locbldr155.SetLocalSymInfo("eopt2")
...
checkMethodIL.Emit(OpCodes.Beq, tru104)
checkMethodIL.Emit(OpCodes.Br, fa104)
...
Dim locbldr156 As LocalBuilder = checkMethodIL.DeclareLocal(asm.GetType("dylan.NET.Tokenizer.Parser.ExprOptimizer"))
locbldr156.SetLocalSymInfo("eopt1")
checkMethodIL.Emit(OpCodes.Newobj, asm.GetType("dylan.NET.Tokenizer.Parser.ExprOptimizer").GetConstructor(Type.EmptyTypes))
...
checkMethodIL.Emit(OpCodes.Br, cont100)
checkMethodIL.MarkLabel(fa100)
checkMethodIL.Emit(OpCodes.Br, cont100)
checkMethodIL.MarkLabel(cont100)
checkMethodIL.MarkSequencePoint(doc5, 360, 1, 360, 100)
checkMethodIL.Emit(OpCodes.Br, cont95)
checkMethodIL.MarkLabel(fa95)
checkMethodIL.Emit(OpCodes.Br, cont95)
checkMethodIL.MarkLabel(cont95)
...
Typ = GetType(System.Int32)
Dim fa109 As System.Reflection.Emit.Label = checkMethodCallIL.DefineLabel()
Dim tru109 As System.Reflection.Emit.Label = checkMethodCallIL.DefineLabel()
Dim cont109 As System.Reflection.Emit.Label = checkMethodCallIL.DefineLabel()
checkMethodCallIL.Emit(OpCodes.Bgt, tru109)
checkMethodCallIL.Emit(OpCodes.Br, fa109)
checkMethodCallIL.MarkLabel(tru109)
checkMethodCallIL.MarkSequencePoint(doc5, 367, 1, 367, 100)
Dim locbldr157 As LocalBuilder = checkMethodCallIL.DeclareLocal(GetType(Token))
...
Dim locbldr158 As LocalBuilder = checkMethodCallIL.DeclareLocal(GetType(System.Type))
...
Dim locbldr159 As LocalBuilder = checkMethodCallIL.DeclareLocal(GetType(Token))
locbldr159.SetLocalSymInfo("tokb")
checkMethodCallIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
checkMethodCallIL.Emit(OpCodes.Ldfld, GetType(Stmt).GetField("Tokens"))
Typ = GetType(Stmt).GetField("Tokens").FieldType
...
Dim locbldr160 As LocalBuilder = checkMethodCallIL.DeclareLocal(GetType(System.Type))
locbldr160.SetLocalSymInfo("typb")
...
Dim locbldr161 As LocalBuilder = checkMethodCallIL.DeclareLocal(GetType(System.Boolean))
locbldr161.SetLocalSymInfo("ba")
Dim typ73(-1) As Type
...
Dim locbldr162 As LocalBuilder = checkMethodCallIL.DeclareLocal(GetType(System.Boolean))
locbldr162.SetLocalSymInfo("bb")
Dim typ74(-1) As Type
...
Dim locbldr163 As LocalBuilder = checkMethodCallIL.DeclareLocal(GetType(MethodCallStmt))
locbldr163.SetLocalSymInfo("mtcss")
...
Dim locbldr164 As LocalBuilder = checkMethodCallIL.DeclareLocal(GetType(MethodNameTok))
locbldr164.SetLocalSymInfo("mn")
...
Dim locbldr165 As LocalBuilder = checkMethodCallIL.DeclareLocal(GetType(MethodCallTok))
locbldr165.SetLocalSymInfo("mct")
...
Dim locbldr166 As LocalBuilder = checkMethodCallIL.DeclareLocal(GetType(Ident))
locbldr166.SetLocalSymInfo("idt")
...
Dim locbldr167 As LocalBuilder = checkMethodCallIL.DeclareLocal(GetType(Expr))
locbldr167.SetLocalSymInfo("exp")
...
Dim locbldr168 As LocalBuilder = checkMethodCallIL.DeclareLocal(GetType(System.Int32))
locbldr168.SetLocalSymInfo("lvl")
checkMethodCallIL.Emit(OpCodes.Ldc_I4, CInt(1))
Typ = GetType(System.Int32)
checkMethodCallIL.Emit(OpCodes.Stloc, 11)
checkMethodCallIL.MarkSequencePoint(doc5, 382, 1, 382, 100)
Dim locbldr169 As LocalBuilder = checkMethodCallIL.DeclareLocal(GetType(System.Boolean))
locbldr169.SetLocalSymInfo("d")
...
Dim locbldr170 As LocalBuilder = checkMethodCallIL.DeclareLocal(GetType(System.Int32))
...
checkMethodCallIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa110 As System.Reflection.Emit.Label = checkMethodCallIL.DefineLabel()
Dim tru110 As System.Reflection.Emit.Label = checkMethodCallIL.DefineLabel()
Dim cont110 As System.Reflection.Emit.Label = checkMethodCallIL.DefineLabel()
checkMethodCallIL.Emit(OpCodes.Beq, tru110)
checkMethodCallIL.Emit(OpCodes.Br, fa110)
checkMethodCallIL.MarkLabel(tru110)
...
Dim locbldr171 As LocalBuilder = checkMethodCallIL.DeclareLocal(GetType(Token))
...
Dim locbldr172 As LocalBuilder = checkMethodCallIL.DeclareLocal(GetType(System.Type))
locbldr172.SetLocalSymInfo("typ2")
checkMethodCallIL.MarkSequencePoint(doc5, 396, 1, 396, 100)
Dim locbldr173 As LocalBuilder = checkMethodCallIL.DeclareLocal(GetType(System.Boolean))
locbldr173.SetLocalSymInfo("b2")
...
checkMethodCallIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa111 As System.Reflection.Emit.Label = checkMethodCallIL.DefineLabel()
Dim tru111 As System.Reflection.Emit.Label = checkMethodCallIL.DefineLabel()
Dim cont111 As System.Reflection.Emit.Label = checkMethodCallIL.DefineLabel()
checkMethodCallIL.Emit(OpCodes.Beq, tru111)
checkMethodCallIL.Emit(OpCodes.Br, fa111)
checkMethodCallIL.MarkLabel(tru111)
...
checkMethodCallIL.Emit(OpCodes.Ldc_I4, CInt(0))
Typ = GetType(System.Int32)
Dim fa112 As System.Reflection.Emit.Label = checkMethodCallIL.DefineLabel()
Dim tru112 As System.Reflection.Emit.Label = checkMethodCallIL.DefineLabel()
Dim cont112 As System.Reflection.Emit.Label = checkMethodCallIL.DefineLabel()
checkMethodCallIL.Emit(OpCodes.Beq, tru112)
checkMethodCallIL.Emit(OpCodes.Br, fa112)
checkMethodCallIL.MarkLabel(tru112)
...
checkMethodCallIL.Emit(OpCodes.Br, cont112)
checkMethodCallIL.MarkLabel(fa112)
...
checkMethodCallIL.Emit(OpCodes.Br, cont112)
checkMethodCallIL.MarkLabel(cont112)
checkMethodCallIL.MarkSequencePoint(doc5, 421, 1, 421, 100)
checkMethodCallIL.Emit(OpCodes.Br, label9)
checkMethodCallIL.MarkSequencePoint(doc5, 422, 1, 422, 100)
checkMethodCallIL.Emit(OpCodes.Br, cont111)
checkMethodCallIL.MarkLabel(fa111)
checkMethodCallIL.Emit(OpCodes.Br, cont111)
checkMethodCallIL.MarkLabel(cont111)
...
checkMethodCallIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa113 As System.Reflection.Emit.Label = checkMethodCallIL.DefineLabel()
Dim tru113 As System.Reflection.Emit.Label = checkMethodCallIL.DefineLabel()
Dim cont113 As System.Reflection.Emit.Label = checkMethodCallIL.DefineLabel()
checkMethodCallIL.Emit(OpCodes.Beq, tru113)
checkMethodCallIL.Emit(OpCodes.Br, fa113)
checkMethodCallIL.MarkLabel(tru113)
...
checkMethodCallIL.Emit(OpCodes.Br, cont113)
checkMethodCallIL.MarkLabel(fa113)
checkMethodCallIL.Emit(OpCodes.Br, cont113)
checkMethodCallIL.MarkLabel(cont113)
...
checkMethodCallIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa114 As System.Reflection.Emit.Label = checkMethodCallIL.DefineLabel()
Dim tru114 As System.Reflection.Emit.Label = checkMethodCallIL.DefineLabel()
Dim cont114 As System.Reflection.Emit.Label = checkMethodCallIL.DefineLabel()
checkMethodCallIL.Emit(OpCodes.Beq, tru114)
checkMethodCallIL.Emit(OpCodes.Br, fa114)
checkMethodCallIL.MarkLabel(tru114)
...
checkMethodCallIL.Emit(OpCodes.Beq, tru115)
...
checkMethodCallIL.Emit(OpCodes.Br, cont114)
checkMethodCallIL.MarkLabel(fa114)
checkMethodCallIL.Emit(OpCodes.Br, cont114)
checkMethodCallIL.MarkLabel(cont114)
...
checkMethodCallIL.Emit(OpCodes.Br, cont110)
checkMethodCallIL.MarkLabel(fa110)
checkMethodCallIL.Emit(OpCodes.Br, cont110)
checkMethodCallIL.MarkLabel(cont110)
checkMethodCallIL.MarkSequencePoint(doc5, 467, 1, 467, 100)
checkMethodCallIL.Emit(OpCodes.Br, cont109)
checkMethodCallIL.MarkLabel(fa109)
checkMethodCallIL.Emit(OpCodes.Br, cont109)
checkMethodCallIL.MarkLabel(cont109)
...
Dim locbldr175 As LocalBuilder = checkVarAsIL.DeclareLocal(GetType(Token))
locbldr175.SetLocalSymInfo("tok")
checkVarAsIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
...
Dim locbldr176 As LocalBuilder = checkVarAsIL.DeclareLocal(GetType(System.Type))
locbldr176.SetLocalSymInfo("typ")
checkVarAsIL.Emit(OpCodes.Ldtoken, GetType(VarTok))
...
Dim locbldr177 As LocalBuilder = checkVarAsIL.DeclareLocal(GetType(VarStmt))
locbldr177.SetLocalSymInfo("vars")
...
checkVarAsIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa118 As System.Reflection.Emit.Label = checkVarAsIL.DefineLabel()
Dim tru118 As System.Reflection.Emit.Label = checkVarAsIL.DefineLabel()
Dim cont118 As System.Reflection.Emit.Label = checkVarAsIL.DefineLabel()
checkVarAsIL.Emit(OpCodes.Beq, tru118)
checkVarAsIL.Emit(OpCodes.Br, fa118)
checkVarAsIL.MarkLabel(tru118)
...
Dim locbldr178 As LocalBuilder = checkVarAsIL.DeclareLocal(GetType(Token))
locbldr178.SetLocalSymInfo("tok2")
checkVarAsIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
checkVarAsIL.Emit(OpCodes.Ldfld, GetType(Stmt).GetField("Tokens"))
Typ = GetType(Stmt).GetField("Tokens").FieldType
...
Dim locbldr179 As LocalBuilder = checkVarAsIL.DeclareLocal(GetType(System.Type))
locbldr179.SetLocalSymInfo("typ2")
checkVarAsIL.Emit(OpCodes.Ldtoken, GetType(TypeTok))
...
Dim locbldr180 As LocalBuilder = checkVarAsIL.DeclareLocal(GetType(System.Boolean))
locbldr180.SetLocalSymInfo("b2")
Dim typ88(-1) As Type
checkVarAsIL.Emit(OpCodes.Ldloc, 4)
Typ = GetType(System.Type)
Typ03 = Typ
...
checkVarAsIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa119 As System.Reflection.Emit.Label = checkVarAsIL.DefineLabel()
Dim tru119 As System.Reflection.Emit.Label = checkVarAsIL.DefineLabel()
Dim cont119 As System.Reflection.Emit.Label = checkVarAsIL.DefineLabel()
checkVarAsIL.Emit(OpCodes.Beq, fa119)
checkVarAsIL.Emit(OpCodes.Br, tru119)
checkVarAsIL.MarkLabel(tru119)
checkVarAsIL.MarkSequencePoint(doc5, 487, 1, 487, 100)
Dim locbldr181 As LocalBuilder = checkVarAsIL.DeclareLocal(GetType(Token))
locbldr181.SetLocalSymInfo("t")
checkVarAsIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
checkVarAsIL.Emit(OpCodes.Ldfld, GetType(Stmt).GetField("Tokens"))
Typ = GetType(Stmt).GetField("Tokens").FieldType
...
Dim locbldr182 As LocalBuilder = checkVarAsIL.DeclareLocal(GetType(TypeTok))
locbldr182.SetLocalSymInfo("tt")
checkVarAsIL.Emit(OpCodes.Newobj, GetType(TypeTok).GetConstructor(Type.EmptyTypes))
checkVarAsIL.Emit(OpCodes.Stloc, 7)
...
checkVarAsIL.Emit(OpCodes.Br, cont119)
checkVarAsIL.MarkLabel(fa119)
...
checkVarAsIL.Emit(OpCodes.Br, cont119)
checkVarAsIL.MarkLabel(cont119)
checkVarAsIL.MarkSequencePoint(doc5, 496, 1, 496, 100)
checkVarAsIL.Emit(OpCodes.Br, cont118)
checkVarAsIL.MarkLabel(fa118)
checkVarAsIL.Emit(OpCodes.Br, cont118)
checkVarAsIL.MarkLabel(cont118)
...
Dim locbldr183 As LocalBuilder = AssOptIL.DeclareLocal(GetType(AssignStmt))
locbldr183.SetLocalSymInfo("asss")
AssOptIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
AssOptIL.Emit(OpCodes.Stloc, 0)
AssOptIL.MarkSequencePoint(doc5, 503, 1, 503, 100)
Dim locbldr184 As LocalBuilder = AssOptIL.DeclareLocal(GetType(Expr))
locbldr184.SetLocalSymInfo("le")
...
Dim locbldr185 As LocalBuilder = AssOptIL.DeclareLocal(GetType(Token))
...
Dim locbldr186 As LocalBuilder = AssOptIL.DeclareLocal(GetType(System.Type))
...
Dim locbldr187 As LocalBuilder = AssOptIL.DeclareLocal(GetType(System.Boolean))
locbldr187.SetLocalSymInfo("b")
Dim typ91(-1) As Type
...
Dim locbldr188 As LocalBuilder = AssOptIL.DeclareLocal(GetType(VarAsgnStmt))
locbldr188.SetLocalSymInfo("vass")
...
Typ = GetType(System.Boolean)
Dim fa120 As System.Reflection.Emit.Label = AssOptIL.DefineLabel()
Dim tru120 As System.Reflection.Emit.Label = AssOptIL.DefineLabel()
Dim cont120 As System.Reflection.Emit.Label = AssOptIL.DefineLabel()
AssOptIL.Emit(OpCodes.Beq, tru120)
AssOptIL.Emit(OpCodes.Br, fa120)
AssOptIL.MarkLabel(tru120)
...
Dim locbldr189 As LocalBuilder = AssOptIL.DeclareLocal(GetType(Token))
...
Dim locbldr190 As LocalBuilder = AssOptIL.DeclareLocal(GetType(System.Type))
...
Dim locbldr191 As LocalBuilder = AssOptIL.DeclareLocal(GetType(System.Boolean))
...
AssOptIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa121 As System.Reflection.Emit.Label = AssOptIL.DefineLabel()
Dim tru121 As System.Reflection.Emit.Label = AssOptIL.DefineLabel()
Dim cont121 As System.Reflection.Emit.Label = AssOptIL.DefineLabel()
AssOptIL.Emit(OpCodes.Beq, fa121)
AssOptIL.Emit(OpCodes.Br, tru121)
AssOptIL.MarkLabel(tru121)
AssOptIL.MarkSequencePoint(doc5, 518, 1, 518, 100)
Dim locbldr192 As LocalBuilder = AssOptIL.DeclareLocal(GetType(Token))
...
Dim locbldr193 As LocalBuilder = AssOptIL.DeclareLocal(GetType(TypeTok))
...
AssOptIL.Emit(OpCodes.Br, cont121)
AssOptIL.MarkLabel(fa121)
...
Dim locbldr194 As LocalBuilder = AssOptIL.DeclareLocal(asm.GetType("dylan.NET.Tokenizer.Parser.ExprOptimizer"))
locbldr194.SetLocalSymInfo("eop")
...
Dim locbldr195 As LocalBuilder = checkAssignIL.DeclareLocal(GetType(Token))
...
Dim locbldr196 As LocalBuilder = checkAssignIL.DeclareLocal(GetType(System.Type))
...
Dim locbldr197 As LocalBuilder = checkAssignIL.DeclareLocal(GetType(AssignStmt))
locbldr197.SetLocalSymInfo("asss")
...
Dim locbldr198 As LocalBuilder = checkAssignIL.DeclareLocal(GetType(System.Boolean))
locbldr198.SetLocalSymInfo("c")
checkAssignIL.Emit(OpCodes.Ldc_I4, 0)
Typ = GetType(System.Boolean)
checkAssignIL.Emit(OpCodes.Stloc, 3)
checkAssignIL.MarkSequencePoint(doc5, 543, 1, 543, 100)
Dim locbldr199 As LocalBuilder = checkAssignIL.DeclareLocal(GetType(Expr))
locbldr199.SetLocalSymInfo("re")
...
Dim locbldr200 As LocalBuilder = checkAssignIL.DeclareLocal(GetType(Expr))
locbldr200.SetLocalSymInfo("le")
checkAssignIL.Emit(OpCodes.Newobj, GetType(Expr).GetConstructor(Type.EmptyTypes))
checkAssignIL.Emit(OpCodes.Stloc, 5)
checkAssignIL.MarkSequencePoint(doc5, 545, 1, 545, 100)
Dim locbldr201 As LocalBuilder = checkAssignIL.DeclareLocal(GetType(System.Int32))
...
Dim locbldr202 As LocalBuilder = checkAssignIL.DeclareLocal(GetType(System.Int32))
...
Dim locbldr203 As LocalBuilder = checkAssignIL.DeclareLocal(GetType(System.Int32))
locbldr203.SetLocalSymInfo("assind")
...
Typ = GetType(System.Boolean)
Dim fa122 As System.Reflection.Emit.Label = checkAssignIL.DefineLabel()
Dim tru122 As System.Reflection.Emit.Label = checkAssignIL.DefineLabel()
Dim cont122 As System.Reflection.Emit.Label = checkAssignIL.DefineLabel()
checkAssignIL.Emit(OpCodes.Beq, tru122)
checkAssignIL.Emit(OpCodes.Br, fa122)
checkAssignIL.MarkLabel(tru122)
...
checkAssignIL.Emit(OpCodes.Br, cont122)
checkAssignIL.MarkLabel(fa122)
checkAssignIL.Emit(OpCodes.Br, cont122)
checkAssignIL.MarkLabel(cont122)
checkAssignIL.MarkSequencePoint(doc5, 564, 1, 564, 100)
checkAssignIL.Emit(OpCodes.Ldloc, 6)
Typ = GetType(System.Int32)
checkAssignIL.Emit(OpCodes.Ldloc, 7)
Typ = GetType(System.Int32)
Dim fa123 As System.Reflection.Emit.Label = checkAssignIL.DefineLabel()
Dim tru123 As System.Reflection.Emit.Label = checkAssignIL.DefineLabel()
Dim cont123 As System.Reflection.Emit.Label = checkAssignIL.DefineLabel()
checkAssignIL.Emit(OpCodes.Beq, tru123)
checkAssignIL.Emit(OpCodes.Br, fa123)
checkAssignIL.MarkLabel(tru123)
checkAssignIL.MarkSequencePoint(doc5, 565, 1, 565, 100)
checkAssignIL.Emit(OpCodes.Br, label11)
checkAssignIL.MarkSequencePoint(doc5, 566, 1, 566, 100)
checkAssignIL.Emit(OpCodes.Br, cont123)
checkAssignIL.MarkLabel(fa123)
...
checkAssignIL.Emit(OpCodes.Br, cont123)
checkAssignIL.MarkLabel(cont123)
...
checkAssignIL.Emit(OpCodes.Ldc_I4, CInt(0))
Typ = GetType(System.Int32)
Dim fa124 As System.Reflection.Emit.Label = checkAssignIL.DefineLabel()
Dim tru124 As System.Reflection.Emit.Label = checkAssignIL.DefineLabel()
Dim cont124 As System.Reflection.Emit.Label = checkAssignIL.DefineLabel()
checkAssignIL.Emit(OpCodes.Beq, fa124)
checkAssignIL.Emit(OpCodes.Br, tru124)
checkAssignIL.MarkLabel(tru124)
...
checkAssignIL.Emit(OpCodes.Ldloc, 7)
Typ = GetType(System.Int32)
Dim fa125 As System.Reflection.Emit.Label = checkAssignIL.DefineLabel()
Dim tru125 As System.Reflection.Emit.Label = checkAssignIL.DefineLabel()
Dim cont125 As System.Reflection.Emit.Label = checkAssignIL.DefineLabel()
checkAssignIL.Emit(OpCodes.Beq, tru125)
checkAssignIL.Emit(OpCodes.Br, fa125)
checkAssignIL.MarkLabel(tru125)
...
checkAssignIL.Emit(OpCodes.Br, cont125)
checkAssignIL.MarkLabel(fa125)
...
checkAssignIL.Emit(OpCodes.Br, cont125)
checkAssignIL.MarkLabel(cont125)
...
checkAssignIL.Emit(OpCodes.Ldloc, 7)
Typ = GetType(System.Int32)
Dim fa126 As System.Reflection.Emit.Label = checkAssignIL.DefineLabel()
Dim tru126 As System.Reflection.Emit.Label = checkAssignIL.DefineLabel()
Dim cont126 As System.Reflection.Emit.Label = checkAssignIL.DefineLabel()
checkAssignIL.Emit(OpCodes.Beq, tru126)
checkAssignIL.Emit(OpCodes.Br, fa126)
checkAssignIL.MarkLabel(tru126)
...
checkAssignIL.Emit(OpCodes.Br, cont126)
checkAssignIL.MarkLabel(fa126)
...
checkAssignIL.Emit(OpCodes.Br, cont126)
checkAssignIL.MarkLabel(cont126)
...
checkAssignIL.Emit(OpCodes.Br, cont124)
checkAssignIL.MarkLabel(fa124)
...
checkAssignIL.Emit(OpCodes.Br, cont124)
checkAssignIL.MarkLabel(cont124)
...
locbldr205.SetLocalSymInfo("len")
OptimizeIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
...
Dim locbldr206 As LocalBuilder = OptimizeIL.DeclareLocal(asm.GetType("dylan.NET.Tokenizer.Parser.TokenOptimizer"))
locbldr206.SetLocalSymInfo("to")
OptimizeIL.Emit(OpCodes.Ldnull)
OptimizeIL.Emit(OpCodes.Stloc, 2)
OptimizeIL.MarkSequencePoint(doc5, 641, 1, 641, 100)
Dim locbldr207 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(Stmt))
locbldr207.SetLocalSymInfo("tmpstm")
OptimizeIL.Emit(OpCodes.Ldnull)
OptimizeIL.Emit(OpCodes.Stloc, 3)
OptimizeIL.MarkSequencePoint(doc5, 642, 1, 642, 100)
Dim locbldr208 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(System.Boolean))
locbldr208.SetLocalSymInfo("compb")
OptimizeIL.Emit(OpCodes.Ldc_I4, 0)
Typ = GetType(System.Boolean)
OptimizeIL.Emit(OpCodes.Stloc, 4)
...
Dim locbldr209 As LocalBuilder = ParseIL.DeclareLocal(GetType(System.Int32))
locbldr209.SetLocalSymInfo("i")
ParseIL.Emit(OpCodes.Ldc_I4, CInt(-1))
Typ = GetType(System.Int32)
ParseIL.Emit(OpCodes.Stloc, 0)
ParseIL.MarkSequencePoint(doc6, 5, 1, 5, 100)
Dim locbldr210 As LocalBuilder = ParseIL.DeclareLocal(asm.GetType("dylan.NET.Tokenizer.Parser.StmtOptimizer"))
locbldr210.SetLocalSymInfo("so")
ParseIL.Emit(OpCodes.Ldnull)
ParseIL.Emit(OpCodes.Stloc, 1)
ParseIL.MarkSequencePoint(doc6, 6, 1, 6, 100)
Dim locbldr211 As LocalBuilder = ParseIL.DeclareLocal(GetType(System.Int32))
...
ParseIL.Emit(OpCodes.Ldloc, 2)
Typ = GetType(System.Int32)
Dim fa145 As System.Reflection.Emit.Label = ParseIL.DefineLabel()
Dim tru145 As System.Reflection.Emit.Label = ParseIL.DefineLabel()
Dim cont145 As System.Reflection.Emit.Label = ParseIL.DefineLabel()
ParseIL.Emit(OpCodes.Beq, tru145)
ParseIL.Emit(OpCodes.Br, fa145)
ParseIL.MarkLabel(tru145)
ParseIL.MarkSequencePoint(doc6, 19, 1, 19, 100)
ParseIL.Emit(OpCodes.Br, label1)
ParseIL.MarkSequencePoint(doc6, 20, 1, 20, 100)
ParseIL.Emit(OpCodes.Br, cont145)
ParseIL.MarkLabel(fa145)
ParseIL.MarkSequencePoint(doc6, 21, 1, 21, 100)
ParseIL.Emit(OpCodes.Br, label0)
ParseIL.MarkSequencePoint(doc6, 22, 1, 22, 100)
ParseIL.Emit(OpCodes.Br, cont145)
ParseIL.MarkLabel(cont145)
