...
Dim locbldr123 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(System.Int32))
...
Dim locbldr124 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(System.Int32))
locbldr124.SetLocalSymInfo("i")
OptimizeIL.Emit(OpCodes.Ldc_I4, CInt(-1))
Typ = GetType(System.Int32)
OptimizeIL.Emit(OpCodes.Stloc, 1)
OptimizeIL.MarkSequencePoint(doc4, 165, 1, 165, 100)
Dim locbldr125 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(System.Int32))
locbldr125.SetLocalSymInfo("j")
OptimizeIL.Emit(OpCodes.Ldc_I4, CInt(-1))
Typ = GetType(System.Int32)
OptimizeIL.Emit(OpCodes.Stloc, 2)
...
OptimizeIL.Emit(OpCodes.Blt, tru112)
...
Dim locbldr126 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(Token))
...
Dim locbldr127 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(System.Type))
locbldr127.SetLocalSymInfo("typ")
OptimizeIL.MarkSequencePoint(doc4, 183, 1, 183, 100)
Dim locbldr128 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(System.Boolean))
locbldr128.SetLocalSymInfo("b")
OptimizeIL.MarkSequencePoint(doc4, 184, 1, 184, 100)
Dim locbldr129 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(System.String))
locbldr129.SetLocalSymInfo("str")
...
OptimizeIL.Emit(OpCodes.Call, GetType(System.Type).GetMethod("GetTypeFromHandle", typ24))
...
ReDim Preserve typ25(UBound(typ25) + 1)
typ25(UBound(typ25)) = Typ
OptimizeIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("RemToken", typ25))
...
ReDim Preserve typ26(UBound(typ26) + 1)
typ26(UBound(typ26)) = Typ
OptimizeIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("IsInstanceOfType", typ26))
...
OptimizeIL.Emit(OpCodes.Beq, fa114)
OptimizeIL.Emit(OpCodes.Br, tru114)
OptimizeIL.MarkLabel(tru114)
OptimizeIL.MarkSequencePoint(doc4, 198, 1, 198, 100)
Dim locbldr130 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(Token))
locbldr130.SetLocalSymInfo("tk")
OptimizeIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Expr)
OptimizeIL.Emit(OpCodes.Ldfld, GetType(Expr).GetField("Tokens"))
Typ = GetType(Expr).GetField("Tokens").FieldType
...
Dim locbldr131 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(TypeTok))
locbldr131.SetLocalSymInfo("ttk")
...
OptimizeIL.MarkSequencePoint(doc4, 204, 1, 204, 100)
OptimizeIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Expr)
OptimizeIL.Emit(OpCodes.Ldfld, GetType(Expr).GetField("Tokens"))
Typ = GetType(Expr).GetField("Tokens").FieldType
...
OptimizeIL.MarkSequencePoint(doc4, 207, 1, 207, 100)
OptimizeIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Expr)
OptimizeIL.Emit(OpCodes.Ldfld, GetType(Expr).GetField("Tokens"))
Typ = GetType(Expr).GetField("Tokens").FieldType
...
OptimizeIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa115 As System.Reflection.Emit.Label = OptimizeIL.DefineLabel()
Dim tru115 As System.Reflection.Emit.Label = OptimizeIL.DefineLabel()
Dim cont115 As System.Reflection.Emit.Label = OptimizeIL.DefineLabel()
OptimizeIL.Emit(OpCodes.Beq, tru115)
OptimizeIL.Emit(OpCodes.Br, fa115)
OptimizeIL.MarkLabel(tru115)
OptimizeIL.MarkSequencePoint(doc4, 215, 1, 215, 100)
OptimizeIL.Emit(OpCodes.Ldtoken, GetType(TypeTok))
Dim typ29 As Type() = {GetType(System.RuntimeTypeHandle)}
OptimizeIL.Emit(OpCodes.Call, GetType(System.Type).GetMethod("GetTypeFromHandle", typ29))
...
ReDim Preserve typ30(UBound(typ30) + 1)
typ30(UBound(typ30)) = Typ
OptimizeIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("RemToken", typ30))
Typ = Typ03.GetMethod("RemToken", typ30).ReturnType
If Typ.ToString() = GetType(System.Void).ToString() Then
...
OptimizeIL.Emit(OpCodes.Sub)
OptimizeIL.Emit(OpCodes.Stloc, 1)
OptimizeIL.MarkSequencePoint(doc4, 218, 1, 218, 100)
OptimizeIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Expr)
OptimizeIL.Emit(OpCodes.Ldfld, GetType(Expr).GetField("Tokens"))
Typ = GetType(Expr).GetField("Tokens").FieldType
...
OptimizeIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa116 As System.Reflection.Emit.Label = OptimizeIL.DefineLabel()
Dim tru116 As System.Reflection.Emit.Label = OptimizeIL.DefineLabel()
Dim cont116 As System.Reflection.Emit.Label = OptimizeIL.DefineLabel()
OptimizeIL.Emit(OpCodes.Beq, fa116)
OptimizeIL.Emit(OpCodes.Br, tru116)
OptimizeIL.MarkLabel(tru116)
OptimizeIL.MarkSequencePoint(doc4, 223, 1, 223, 100)
Dim locbldr132 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(Token))
locbldr132.SetLocalSymInfo("tk2")
OptimizeIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Expr)
OptimizeIL.Emit(OpCodes.Ldfld, GetType(Expr).GetField("Tokens"))
Typ = GetType(Expr).GetField("Tokens").FieldType
...
Dim locbldr133 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(TypeTok))
locbldr133.SetLocalSymInfo("ttk2")
OptimizeIL.Emit(OpCodes.Newobj, GetType(TypeTok).GetConstructor(Type.EmptyTypes))
OptimizeIL.Emit(OpCodes.Stloc, 10)
...
OptimizeIL.Emit(OpCodes.Br, cont116)
OptimizeIL.MarkLabel(fa116)
...
OptimizeIL.Emit(OpCodes.Br, cont116)
OptimizeIL.MarkLabel(cont116)
OptimizeIL.MarkSequencePoint(doc4, 232, 1, 232, 100)
OptimizeIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Expr)
OptimizeIL.Emit(OpCodes.Ldfld, GetType(Expr).GetField("Tokens"))
Typ = GetType(Expr).GetField("Tokens").FieldType
...
OptimizeIL.Emit(OpCodes.Br, cont115)
OptimizeIL.MarkLabel(fa115)
OptimizeIL.Emit(OpCodes.Br, cont115)
OptimizeIL.MarkLabel(cont115)
...
OptimizeIL.Emit(OpCodes.Ldc_I4, 0)
Typ = GetType(System.Boolean)
Dim fa117 As System.Reflection.Emit.Label = OptimizeIL.DefineLabel()
Dim tru117 As System.Reflection.Emit.Label = OptimizeIL.DefineLabel()
Dim cont117 As System.Reflection.Emit.Label = OptimizeIL.DefineLabel()
OptimizeIL.Emit(OpCodes.Beq, tru117)
OptimizeIL.Emit(OpCodes.Br, fa117)
OptimizeIL.MarkLabel(tru117)
...
OptimizeIL.Emit(OpCodes.Call, GetType(System.Type).GetMethod("GetTypeFromHandle", typ32))
...
ReDim Preserve typ33(UBound(typ33) + 1)
typ33(UBound(typ33)) = Typ
OptimizeIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("IsInstanceOfType", typ33))
...
OptimizeIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa118 As System.Reflection.Emit.Label = OptimizeIL.DefineLabel()
Dim tru118 As System.Reflection.Emit.Label = OptimizeIL.DefineLabel()
Dim cont118 As System.Reflection.Emit.Label = OptimizeIL.DefineLabel()
OptimizeIL.Emit(OpCodes.Beq, tru118)
OptimizeIL.Emit(OpCodes.Br, fa118)
OptimizeIL.MarkLabel(tru118)
...
OptimizeIL.Emit(OpCodes.Ldc_I4, 0)
Typ = GetType(System.Boolean)
Dim fa119 As System.Reflection.Emit.Label = OptimizeIL.DefineLabel()
Dim tru119 As System.Reflection.Emit.Label = OptimizeIL.DefineLabel()
Dim cont119 As System.Reflection.Emit.Label = OptimizeIL.DefineLabel()
OptimizeIL.Emit(OpCodes.Beq, fa119)
OptimizeIL.Emit(OpCodes.Br, tru119)
OptimizeIL.MarkLabel(tru119)
OptimizeIL.MarkSequencePoint(doc4, 245, 1, 245, 100)
OptimizeIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
...
ReDim Preserve typ34(UBound(typ34) + 1)
typ34(UBound(typ34)) = Typ
OptimizeIL.Emit(OpCodes.Call, GetType(String).GetMethod("Concat", typ34))
...
Typ = asm.GetType("dylan.NET.Tokenizer.Parser.ParserFlags").GetField("OrdOp").FieldType
OptimizeIL.Emit(OpCodes.Stloc, 6)
OptimizeIL.MarkSequencePoint(doc4, 248, 1, 248, 100)
OptimizeIL.Emit(OpCodes.Ldloc, 6)
Typ = GetType(System.String)
Typ03 = Typ
...
OptimizeIL.Emit(OpCodes.Br, cont119)
OptimizeIL.MarkLabel(fa119)
OptimizeIL.Emit(OpCodes.Br, cont119)
OptimizeIL.MarkLabel(cont119)
...
ReDim Preserve typ36(UBound(typ36) + 1)
typ36(UBound(typ36)) = Typ
OptimizeIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("RemToken", typ36))
...
OptimizeIL.Emit(OpCodes.Br, cont118)
OptimizeIL.MarkLabel(fa118)
OptimizeIL.Emit(OpCodes.Br, cont118)
OptimizeIL.MarkLabel(cont118)
OptimizeIL.MarkSequencePoint(doc4, 257, 1, 257, 100)
OptimizeIL.Emit(OpCodes.Ldtoken, GetType(TypeTok))
Dim typ37 As Type() = {GetType(System.RuntimeTypeHandle)}
OptimizeIL.Emit(OpCodes.Call, GetType(System.Type).GetMethod("GetTypeFromHandle", typ37))
Typ = GetType(System.Type).GetMethod("GetTypeFromHandle", typ37).ReturnType
OptimizeIL.Emit(OpCodes.Stloc, 4)
OptimizeIL.MarkSequencePoint(doc4, 258, 1, 258, 100)
Dim typ38(-1) As Type
OptimizeIL.Emit(OpCodes.Ldloc, 4)
Typ = GetType(System.Type)
Typ03 = Typ
...
ReDim Preserve typ38(UBound(typ38) + 1)
typ38(UBound(typ38)) = Typ
OptimizeIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("IsInstanceOfType", typ38))
...
OptimizeIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa120 As System.Reflection.Emit.Label = OptimizeIL.DefineLabel()
Dim tru120 As System.Reflection.Emit.Label = OptimizeIL.DefineLabel()
Dim cont120 As System.Reflection.Emit.Label = OptimizeIL.DefineLabel()
OptimizeIL.Emit(OpCodes.Beq, tru120)
OptimizeIL.Emit(OpCodes.Br, fa120)
OptimizeIL.MarkLabel(tru120)
OptimizeIL.MarkSequencePoint(doc4, 261, 1, 261, 100)
OptimizeIL.Emit(OpCodes.Ldsfld, asm.GetType("dylan.NET.Tokenizer.Parser.ParserFlags").GetField("DurConvFlag"))
Typ = asm.GetType("dylan.NET.Tokenizer.Parser.ParserFlags").GetField("DurConvFlag").FieldType
OptimizeIL.Emit(OpCodes.Ldc_I4, 0)
Typ = GetType(System.Boolean)
Dim fa121 As System.Reflection.Emit.Label = OptimizeIL.DefineLabel()
Dim tru121 As System.Reflection.Emit.Label = OptimizeIL.DefineLabel()
Dim cont121 As System.Reflection.Emit.Label = OptimizeIL.DefineLabel()
OptimizeIL.Emit(OpCodes.Beq, fa121)
OptimizeIL.Emit(OpCodes.Br, tru121)
OptimizeIL.MarkLabel(tru121)
OptimizeIL.MarkSequencePoint(doc4, 262, 1, 262, 100)
Dim locbldr134 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(TypeTok))
locbldr134.SetLocalSymInfo("tt1")
OptimizeIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Expr)
OptimizeIL.Emit(OpCodes.Ldfld, GetType(Expr).GetField("Tokens"))
Typ = GetType(Expr).GetField("Tokens").FieldType
...
ReDim Preserve typ39(UBound(typ39) + 1)
typ39(UBound(typ39)) = Typ
OptimizeIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("RemToken", typ39))
...
OptimizeIL.Emit(OpCodes.Br, cont121)
OptimizeIL.MarkLabel(fa121)
OptimizeIL.MarkSequencePoint(doc4, 268, 1, 268, 100)
OptimizeIL.Emit(OpCodes.Br, cont121)
OptimizeIL.MarkLabel(cont121)
OptimizeIL.MarkSequencePoint(doc4, 269, 1, 269, 100)
OptimizeIL.Emit(OpCodes.Br, label5)
OptimizeIL.MarkSequencePoint(doc4, 270, 1, 270, 100)
OptimizeIL.Emit(OpCodes.Br, cont120)
OptimizeIL.MarkLabel(fa120)
OptimizeIL.Emit(OpCodes.Br, cont120)
OptimizeIL.MarkLabel(cont120)
...
OptimizeIL.Emit(OpCodes.Call, GetType(System.Type).GetMethod("GetTypeFromHandle", typ40))
...
ReDim Preserve typ41(UBound(typ41) + 1)
typ41(UBound(typ41)) = Typ
OptimizeIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("IsInstanceOfType", typ41))
...
OptimizeIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa122 As System.Reflection.Emit.Label = OptimizeIL.DefineLabel()
Dim tru122 As System.Reflection.Emit.Label = OptimizeIL.DefineLabel()
Dim cont122 As System.Reflection.Emit.Label = OptimizeIL.DefineLabel()
OptimizeIL.Emit(OpCodes.Beq, tru122)
OptimizeIL.Emit(OpCodes.Br, fa122)
OptimizeIL.MarkLabel(tru122)
...
OptimizeIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa123 As System.Reflection.Emit.Label = OptimizeIL.DefineLabel()
Dim tru123 As System.Reflection.Emit.Label = OptimizeIL.DefineLabel()
Dim cont123 As System.Reflection.Emit.Label = OptimizeIL.DefineLabel()
OptimizeIL.Emit(OpCodes.Beq, tru123)
OptimizeIL.Emit(OpCodes.Br, fa123)
OptimizeIL.MarkLabel(tru123)
OptimizeIL.MarkSequencePoint(doc4, 278, 1, 278, 100)
Dim locbldr135 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(Ident))
locbldr135.SetLocalSymInfo("id1")
OptimizeIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Expr)
OptimizeIL.Emit(OpCodes.Ldfld, GetType(Expr).GetField("Tokens"))
Typ = GetType(Expr).GetField("Tokens").FieldType
...
ReDim Preserve typ42(UBound(typ42) + 1)
typ42(UBound(typ42)) = Typ
OptimizeIL.Emit(OpCodes.Call, asm.GetType("dylan.NET.Tokenizer.Parser.ParserFlags").GetMethod("UpdateIdent", typ42))
Typ = asm.GetType("dylan.NET.Tokenizer.Parser.ParserFlags").GetMethod("UpdateIdent", typ42).ReturnType
Typ = Typ02
OptimizeIL.Emit(OpCodes.Stelem, Typ.GetElementType())
...
OptimizeIL.Emit(OpCodes.Br, cont123)
OptimizeIL.MarkLabel(fa123)
OptimizeIL.Emit(OpCodes.Br, cont123)
OptimizeIL.MarkLabel(cont123)
OptimizeIL.MarkSequencePoint(doc4, 283, 1, 283, 100)
OptimizeIL.Emit(OpCodes.Br, label5)
OptimizeIL.MarkSequencePoint(doc4, 284, 1, 284, 100)
OptimizeIL.Emit(OpCodes.Br, cont122)
OptimizeIL.MarkLabel(fa122)
OptimizeIL.Emit(OpCodes.Br, cont122)
OptimizeIL.MarkLabel(cont122)
...
OptimizeIL.Emit(OpCodes.Call, GetType(System.Type).GetMethod("GetTypeFromHandle", typ43))
Typ = GetType(System.Type).GetMethod("GetTypeFromHandle", typ43).ReturnType
OptimizeIL.Emit(OpCodes.Stloc, 4)
OptimizeIL.MarkSequencePoint(doc4, 287, 1, 287, 100)
Dim typ44(-1) As Type
OptimizeIL.Emit(OpCodes.Ldloc, 4)
Typ = GetType(System.Type)
Typ03 = Typ
...
ReDim Preserve typ44(UBound(typ44) + 1)
typ44(UBound(typ44)) = Typ
OptimizeIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("IsInstanceOfType", typ44))
...
OptimizeIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa124 As System.Reflection.Emit.Label = OptimizeIL.DefineLabel()
Dim tru124 As System.Reflection.Emit.Label = OptimizeIL.DefineLabel()
Dim cont124 As System.Reflection.Emit.Label = OptimizeIL.DefineLabel()
OptimizeIL.Emit(OpCodes.Beq, tru124)
OptimizeIL.Emit(OpCodes.Br, fa124)
OptimizeIL.MarkLabel(tru124)
OptimizeIL.MarkSequencePoint(doc4, 290, 1, 290, 100)
OptimizeIL.Emit(OpCodes.Ldsfld, asm.GetType("dylan.NET.Tokenizer.Parser.ParserFlags").GetField("isChanged"))
Typ = asm.GetType("dylan.NET.Tokenizer.Parser.ParserFlags").GetField("isChanged").FieldType
OptimizeIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa125 As System.Reflection.Emit.Label = OptimizeIL.DefineLabel()
Dim tru125 As System.Reflection.Emit.Label = OptimizeIL.DefineLabel()
Dim cont125 As System.Reflection.Emit.Label = OptimizeIL.DefineLabel()
OptimizeIL.Emit(OpCodes.Beq, tru125)
OptimizeIL.Emit(OpCodes.Br, fa125)
OptimizeIL.MarkLabel(tru125)
OptimizeIL.MarkSequencePoint(doc4, 291, 1, 291, 100)
Dim locbldr136 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(CharLiteral))
locbldr136.SetLocalSymInfo("cl1")
OptimizeIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Expr)
OptimizeIL.Emit(OpCodes.Ldfld, GetType(Expr).GetField("Tokens"))
Typ = GetType(Expr).GetField("Tokens").FieldType
...
ReDim Preserve typ45(UBound(typ45) + 1)
typ45(UBound(typ45)) = Typ
OptimizeIL.Emit(OpCodes.Call, asm.GetType("dylan.NET.Tokenizer.Parser.ParserFlags").GetMethod("UpdateCharLit", typ45))
Typ = asm.GetType("dylan.NET.Tokenizer.Parser.ParserFlags").GetMethod("UpdateCharLit", typ45).ReturnType
Typ = Typ02
OptimizeIL.Emit(OpCodes.Stelem, Typ.GetElementType())
...
OptimizeIL.Emit(OpCodes.Br, cont125)
OptimizeIL.MarkLabel(fa125)
OptimizeIL.Emit(OpCodes.Br, cont125)
OptimizeIL.MarkLabel(cont125)
OptimizeIL.MarkSequencePoint(doc4, 296, 1, 296, 100)
OptimizeIL.Emit(OpCodes.Br, label5)
OptimizeIL.MarkSequencePoint(doc4, 297, 1, 297, 100)
OptimizeIL.Emit(OpCodes.Br, cont124)
OptimizeIL.MarkLabel(fa124)
OptimizeIL.Emit(OpCodes.Br, cont124)
OptimizeIL.MarkLabel(cont124)
...
ReDim Preserve typ47(UBound(typ47) + 1)
typ47(UBound(typ47)) = Typ
OptimizeIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("IsInstanceOfType", typ47))
...
OptimizeIL.Emit(OpCodes.Beq, tru126)
...
Dim locbldr137 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(StringLiteral))
locbldr137.SetLocalSymInfo("sl1")
OptimizeIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Expr)
OptimizeIL.Emit(OpCodes.Ldfld, GetType(Expr).GetField("Tokens"))
Typ = GetType(Expr).GetField("Tokens").FieldType
...
ReDim Preserve typ48(UBound(typ48) + 1)
typ48(UBound(typ48)) = Typ
OptimizeIL.Emit(OpCodes.Call, asm.GetType("dylan.NET.Tokenizer.Parser.ParserFlags").GetMethod("UpdateStringLit", typ48))
Typ = asm.GetType("dylan.NET.Tokenizer.Parser.ParserFlags").GetMethod("UpdateStringLit", typ48).ReturnType
Typ = Typ02
OptimizeIL.Emit(OpCodes.Stelem, Typ.GetElementType())
...
Dim locbldr138 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(BooleanLiteral))
locbldr138.SetLocalSymInfo("bl1")
OptimizeIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Expr)
OptimizeIL.Emit(OpCodes.Ldfld, GetType(Expr).GetField("Tokens"))
Typ = GetType(Expr).GetField("Tokens").FieldType
...
ReDim Preserve typ51(UBound(typ51) + 1)
typ51(UBound(typ51)) = Typ
OptimizeIL.Emit(OpCodes.Call, asm.GetType("dylan.NET.Tokenizer.Parser.ParserFlags").GetMethod("UpdateBoolLit", typ51))
Typ = asm.GetType("dylan.NET.Tokenizer.Parser.ParserFlags").GetMethod("UpdateBoolLit", typ51).ReturnType
Typ = Typ02
OptimizeIL.Emit(OpCodes.Stelem, Typ.GetElementType())
...
OptimizeIL.Emit(OpCodes.Call, GetType(System.Type).GetMethod("GetTypeFromHandle", typ52))
...
Dim locbldr139 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(NumberLiteral))
locbldr139.SetLocalSymInfo("nl1")
OptimizeIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Expr)
OptimizeIL.Emit(OpCodes.Ldfld, GetType(Expr).GetField("Tokens"))
Typ = GetType(Expr).GetField("Tokens").FieldType
...
ReDim Preserve typ54(UBound(typ54) + 1)
typ54(UBound(typ54)) = Typ
OptimizeIL.Emit(OpCodes.Call, asm.GetType("dylan.NET.Tokenizer.Parser.ParserFlags").GetMethod("UpdateNumLit", typ54))
Typ = asm.GetType("dylan.NET.Tokenizer.Parser.ParserFlags").GetMethod("UpdateNumLit", typ54).ReturnType
Typ = Typ02
OptimizeIL.Emit(OpCodes.Stelem, Typ.GetElementType())
...
OptimizeIL.MarkSequencePoint(doc4, 339, 1, 339, 100)
...
OptimizeIL.Emit(OpCodes.Stloc, 4)
OptimizeIL.MarkSequencePoint(doc4, 340, 1, 340, 100)
Dim typ56(-1) As Type
OptimizeIL.Emit(OpCodes.Ldloc, 4)
Typ = GetType(System.Type)
Typ03 = Typ
...
ReDim Preserve typ56(UBound(typ56) + 1)
typ56(UBound(typ56)) = Typ
OptimizeIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("IsInstanceOfType", typ56))
Typ = Typ03.GetMethod("IsInstanceOfType", typ56).ReturnType
OptimizeIL.Emit(OpCodes.Stloc, 5)
OptimizeIL.MarkSequencePoint(doc4, 342, 1, 342, 100)
OptimizeIL.Emit(OpCodes.Ldloc, 5)
Typ = GetType(System.Boolean)
OptimizeIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
...
OptimizeIL.MarkSequencePoint(doc4, 343, 1, 343, 100)
...
OptimizeIL.MarkSequencePoint(doc4, 344, 1, 344, 100)
OptimizeIL.Emit(OpCodes.Ldc_I4, 0)
Typ = GetType(System.Boolean)
OptimizeIL.Emit(OpCodes.Stsfld, asm.GetType("dylan.NET.Tokenizer.Parser.ParserFlags").GetField("IdentFlag"))
OptimizeIL.MarkSequencePoint(doc4, 345, 1, 345, 100)
...
OptimizeIL.Emit(OpCodes.Starg, 1)
OptimizeIL.MarkSequencePoint(doc4, 346, 1, 346, 100)
OptimizeIL.Emit(OpCodes.Ldloc, 1)
Typ = GetType(System.Int32)
OptimizeIL.Emit(OpCodes.Ldc_I4, CInt(1))
Typ = GetType(System.Int32)
OptimizeIL.Emit(OpCodes.Sub)
OptimizeIL.Emit(OpCodes.Stloc, 1)
OptimizeIL.MarkSequencePoint(doc4, 347, 1, 347, 100)
OptimizeIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Expr)
OptimizeIL.Emit(OpCodes.Ldfld, GetType(Expr).GetField("Tokens"))
Typ = GetType(Expr).GetField("Tokens").FieldType
...
OptimizeIL.Emit(OpCodes.Sub)
OptimizeIL.Emit(OpCodes.Stloc, 0)
OptimizeIL.MarkSequencePoint(doc4, 349, 1, 349, 100)
Dim locbldr140 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(MethodCallTok))
locbldr140.SetLocalSymInfo("mct")
OptimizeIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Expr)
OptimizeIL.Emit(OpCodes.Ldfld, GetType(Expr).GetField("Tokens"))
Typ = GetType(Expr).GetField("Tokens").FieldType
...
Typ = Typ.GetElementType()
OptimizeIL.Emit(OpCodes.Stloc, 17)
OptimizeIL.MarkSequencePoint(doc4, 350, 1, 350, 100)
Dim locbldr141 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(Expr).MakeArrayType())
locbldr141.SetLocalSymInfo("prs")
OptimizeIL.Emit(OpCodes.Ldloc, 17)
Typ = GetType(MethodCallTok)
OptimizeIL.Emit(OpCodes.Ldfld, GetType(MethodCallTok).GetField("Params"))
Typ = GetType(MethodCallTok).GetField("Params").FieldType
OptimizeIL.Emit(OpCodes.Stloc, 18)
OptimizeIL.MarkSequencePoint(doc4, 351, 1, 351, 100)
Dim locbldr142 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(System.Int32))
locbldr142.SetLocalSymInfo("ln2")
OptimizeIL.Emit(OpCodes.Ldloc, 18)
...
OptimizeIL.Emit(OpCodes.Sub)
OptimizeIL.Emit(OpCodes.Stloc, 19)
OptimizeIL.MarkSequencePoint(doc4, 353, 1, 353, 100)
Dim locbldr143 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(System.Int32))
locbldr143.SetLocalSymInfo("i2")
OptimizeIL.Emit(OpCodes.Ldc_I4, CInt(-1))
Typ = GetType(System.Int32)
OptimizeIL.Emit(OpCodes.Stloc, 20)
OptimizeIL.MarkSequencePoint(doc4, 354, 1, 354, 100)
Dim label6 As System.Reflection.Emit.Label = OptimizeIL.DefineLabel()
OptimizeIL.MarkSequencePoint(doc4, 355, 1, 355, 100)
...
OptimizeIL.Emit(OpCodes.Blt, tru134)
...
OptimizeIL.MarkSequencePoint(doc4, 361, 1, 361, 100)
...
OptimizeIL.Emit(OpCodes.Bgt, tru136)
...
OptimizeIL.Emit(OpCodes.Br, cont117)
OptimizeIL.MarkLabel(fa117)
OptimizeIL.Emit(OpCodes.Br, cont117)
OptimizeIL.MarkLabel(cont117)
...
OptimizeIL.MarkSequencePoint(doc4, 391, 1, 391, 100)
...
Dim locbldr144 As LocalBuilder = checkRefasmIL.DeclareLocal(GetType(Token))
locbldr144.SetLocalSymInfo("tok")
...
Dim locbldr145 As LocalBuilder = checkRefasmIL.DeclareLocal(GetType(System.Type))
...
Dim locbldr146 As LocalBuilder = checkRefasmIL.DeclareLocal(GetType(RefasmStmt))
locbldr146.SetLocalSymInfo("refasms")
...
Typ = GetType(System.Boolean)
Dim fa138 As System.Reflection.Emit.Label = checkRefasmIL.DefineLabel()
Dim tru138 As System.Reflection.Emit.Label = checkRefasmIL.DefineLabel()
Dim cont138 As System.Reflection.Emit.Label = checkRefasmIL.DefineLabel()
checkRefasmIL.Emit(OpCodes.Beq, tru138)
checkRefasmIL.Emit(OpCodes.Br, fa138)
checkRefasmIL.MarkLabel(tru138)
...
checkRefasmIL.Emit(OpCodes.Br, cont138)
checkRefasmIL.MarkLabel(fa138)
checkRefasmIL.Emit(OpCodes.Br, cont138)
checkRefasmIL.MarkLabel(cont138)
...
Dim locbldr147 As LocalBuilder = checkDebugIL.DeclareLocal(GetType(Token))
...
Dim locbldr148 As LocalBuilder = checkDebugIL.DeclareLocal(GetType(System.Type))
...
Dim locbldr149 As LocalBuilder = checkDebugIL.DeclareLocal(GetType(DebugStmt))
locbldr149.SetLocalSymInfo("dbgs")
...
Typ = GetType(System.Boolean)
Dim fa139 As System.Reflection.Emit.Label = checkDebugIL.DefineLabel()
Dim tru139 As System.Reflection.Emit.Label = checkDebugIL.DefineLabel()
Dim cont139 As System.Reflection.Emit.Label = checkDebugIL.DefineLabel()
checkDebugIL.Emit(OpCodes.Beq, tru139)
checkDebugIL.Emit(OpCodes.Br, fa139)
checkDebugIL.MarkLabel(tru139)
...
checkDebugIL.Emit(OpCodes.Br, cont139)
checkDebugIL.MarkLabel(fa139)
checkDebugIL.Emit(OpCodes.Br, cont139)
checkDebugIL.MarkLabel(cont139)
...
Dim locbldr150 As LocalBuilder = checkImportIL.DeclareLocal(GetType(Token))
locbldr150.SetLocalSymInfo("tok")
...
Dim locbldr151 As LocalBuilder = checkImportIL.DeclareLocal(GetType(System.Type))
locbldr151.SetLocalSymInfo("typ")
...
Dim locbldr152 As LocalBuilder = checkImportIL.DeclareLocal(GetType(ImportStmt))
locbldr152.SetLocalSymInfo("imps")
...
Typ = GetType(System.Boolean)
Dim fa140 As System.Reflection.Emit.Label = checkImportIL.DefineLabel()
Dim tru140 As System.Reflection.Emit.Label = checkImportIL.DefineLabel()
Dim cont140 As System.Reflection.Emit.Label = checkImportIL.DefineLabel()
checkImportIL.Emit(OpCodes.Beq, tru140)
checkImportIL.Emit(OpCodes.Br, fa140)
checkImportIL.MarkLabel(tru140)
...
checkImportIL.Emit(OpCodes.Br, cont140)
checkImportIL.MarkLabel(fa140)
checkImportIL.Emit(OpCodes.Br, cont140)
checkImportIL.MarkLabel(cont140)
...
Dim locbldr153 As LocalBuilder = checkLocimportIL.DeclareLocal(GetType(Token))
locbldr153.SetLocalSymInfo("tok")
...
Dim locbldr154 As LocalBuilder = checkLocimportIL.DeclareLocal(GetType(System.Type))
...
Dim locbldr155 As LocalBuilder = checkLocimportIL.DeclareLocal(GetType(LocimportStmt))
locbldr155.SetLocalSymInfo("limps")
...
Typ = GetType(System.Boolean)
Dim fa141 As System.Reflection.Emit.Label = checkLocimportIL.DefineLabel()
Dim tru141 As System.Reflection.Emit.Label = checkLocimportIL.DefineLabel()
Dim cont141 As System.Reflection.Emit.Label = checkLocimportIL.DefineLabel()
checkLocimportIL.Emit(OpCodes.Beq, tru141)
checkLocimportIL.Emit(OpCodes.Br, fa141)
checkLocimportIL.MarkLabel(tru141)
...
checkLocimportIL.Emit(OpCodes.Br, cont141)
checkLocimportIL.MarkLabel(fa141)
checkLocimportIL.Emit(OpCodes.Br, cont141)
checkLocimportIL.MarkLabel(cont141)
...
Dim locbldr156 As LocalBuilder = checkCmtIL.DeclareLocal(GetType(Token))
...
Dim locbldr157 As LocalBuilder = checkCmtIL.DeclareLocal(GetType(System.Type))
locbldr157.SetLocalSymInfo("typ")
...
Dim locbldr158 As LocalBuilder = checkCmtIL.DeclareLocal(GetType(CommentStmt))
locbldr158.SetLocalSymInfo("cmts")
...
Typ = GetType(System.Boolean)
Dim fa142 As System.Reflection.Emit.Label = checkCmtIL.DefineLabel()
Dim tru142 As System.Reflection.Emit.Label = checkCmtIL.DefineLabel()
Dim cont142 As System.Reflection.Emit.Label = checkCmtIL.DefineLabel()
checkCmtIL.Emit(OpCodes.Beq, tru142)
checkCmtIL.Emit(OpCodes.Br, fa142)
checkCmtIL.MarkLabel(tru142)
...
checkCmtIL.Emit(OpCodes.Br, cont142)
checkCmtIL.MarkLabel(fa142)
checkCmtIL.Emit(OpCodes.Br, cont142)
checkCmtIL.MarkLabel(cont142)
...
Typ = GetType(System.Int32)
Dim fa143 As System.Reflection.Emit.Label = checkEndMtdIL.DefineLabel()
Dim tru143 As System.Reflection.Emit.Label = checkEndMtdIL.DefineLabel()
Dim cont143 As System.Reflection.Emit.Label = checkEndMtdIL.DefineLabel()
checkEndMtdIL.Emit(OpCodes.Bge, tru143)
checkEndMtdIL.Emit(OpCodes.Br, fa143)
checkEndMtdIL.MarkLabel(tru143)
checkEndMtdIL.MarkSequencePoint(doc5, 72, 1, 72, 100)
Dim locbldr159 As LocalBuilder = checkEndMtdIL.DeclareLocal(GetType(Token))
locbldr159.SetLocalSymInfo("tok1")
checkEndMtdIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
checkEndMtdIL.Emit(OpCodes.Ldfld, GetType(Stmt).GetField("Tokens"))
Typ = GetType(Stmt).GetField("Tokens").FieldType
...
Dim locbldr160 As LocalBuilder = checkEndMtdIL.DeclareLocal(GetType(System.Type))
locbldr160.SetLocalSymInfo("typ1")
...
Dim locbldr161 As LocalBuilder = checkEndMtdIL.DeclareLocal(GetType(System.Boolean))
locbldr161.SetLocalSymInfo("b1")
Dim typ18(-1) As Type
...
Dim locbldr162 As LocalBuilder = checkEndMtdIL.DeclareLocal(GetType(Token))
locbldr162.SetLocalSymInfo("tok2")
checkEndMtdIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
checkEndMtdIL.Emit(OpCodes.Ldfld, GetType(Stmt).GetField("Tokens"))
Typ = GetType(Stmt).GetField("Tokens").FieldType
...
Dim locbldr163 As LocalBuilder = checkEndMtdIL.DeclareLocal(GetType(System.Type))
locbldr163.SetLocalSymInfo("typ2")
...
Dim locbldr164 As LocalBuilder = checkEndMtdIL.DeclareLocal(GetType(System.Boolean))
locbldr164.SetLocalSymInfo("b2")
Dim typ20(-1) As Type
...
Dim locbldr165 As LocalBuilder = checkEndMtdIL.DeclareLocal(GetType(EndMethodStmt))
locbldr165.SetLocalSymInfo("ems")
...
Typ = GetType(System.Boolean)
Dim fa144 As System.Reflection.Emit.Label = checkEndMtdIL.DefineLabel()
Dim tru144 As System.Reflection.Emit.Label = checkEndMtdIL.DefineLabel()
Dim cont144 As System.Reflection.Emit.Label = checkEndMtdIL.DefineLabel()
checkEndMtdIL.Emit(OpCodes.Beq, tru144)
checkEndMtdIL.Emit(OpCodes.Br, fa144)
checkEndMtdIL.MarkLabel(tru144)
...
checkEndMtdIL.Emit(OpCodes.Br, cont144)
checkEndMtdIL.MarkLabel(fa144)
checkEndMtdIL.Emit(OpCodes.Br, cont144)
checkEndMtdIL.MarkLabel(cont144)
checkEndMtdIL.MarkSequencePoint(doc5, 87, 1, 87, 100)
checkEndMtdIL.Emit(OpCodes.Br, cont143)
checkEndMtdIL.MarkLabel(fa143)
checkEndMtdIL.Emit(OpCodes.Br, cont143)
checkEndMtdIL.MarkLabel(cont143)
...
Typ = GetType(System.Int32)
Dim fa145 As System.Reflection.Emit.Label = checkEndClsIL.DefineLabel()
Dim tru145 As System.Reflection.Emit.Label = checkEndClsIL.DefineLabel()
Dim cont145 As System.Reflection.Emit.Label = checkEndClsIL.DefineLabel()
checkEndClsIL.Emit(OpCodes.Bge, tru145)
checkEndClsIL.Emit(OpCodes.Br, fa145)
checkEndClsIL.MarkLabel(tru145)
checkEndClsIL.MarkSequencePoint(doc5, 94, 1, 94, 100)
Dim locbldr166 As LocalBuilder = checkEndClsIL.DeclareLocal(GetType(Token))
locbldr166.SetLocalSymInfo("tok1")
checkEndClsIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
checkEndClsIL.Emit(OpCodes.Ldfld, GetType(Stmt).GetField("Tokens"))
Typ = GetType(Stmt).GetField("Tokens").FieldType
...
Dim locbldr167 As LocalBuilder = checkEndClsIL.DeclareLocal(GetType(System.Type))
locbldr167.SetLocalSymInfo("typ1")
...
Dim locbldr168 As LocalBuilder = checkEndClsIL.DeclareLocal(GetType(System.Boolean))
locbldr168.SetLocalSymInfo("b1")
Dim typ23(-1) As Type
...
Dim locbldr169 As LocalBuilder = checkEndClsIL.DeclareLocal(GetType(Token))
locbldr169.SetLocalSymInfo("tok2")
checkEndClsIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
checkEndClsIL.Emit(OpCodes.Ldfld, GetType(Stmt).GetField("Tokens"))
Typ = GetType(Stmt).GetField("Tokens").FieldType
...
Dim locbldr170 As LocalBuilder = checkEndClsIL.DeclareLocal(GetType(System.Type))
...
Dim locbldr171 As LocalBuilder = checkEndClsIL.DeclareLocal(GetType(System.Boolean))
...
Dim locbldr172 As LocalBuilder = checkEndClsIL.DeclareLocal(GetType(EndClassStmt))
locbldr172.SetLocalSymInfo("ecs")
...
Typ = GetType(System.Boolean)
Dim fa146 As System.Reflection.Emit.Label = checkEndClsIL.DefineLabel()
Dim tru146 As System.Reflection.Emit.Label = checkEndClsIL.DefineLabel()
Dim cont146 As System.Reflection.Emit.Label = checkEndClsIL.DefineLabel()
checkEndClsIL.Emit(OpCodes.Beq, tru146)
checkEndClsIL.Emit(OpCodes.Br, fa146)
checkEndClsIL.MarkLabel(tru146)
...
checkEndClsIL.Emit(OpCodes.Br, cont146)
checkEndClsIL.MarkLabel(fa146)
checkEndClsIL.Emit(OpCodes.Br, cont146)
checkEndClsIL.MarkLabel(cont146)
checkEndClsIL.MarkSequencePoint(doc5, 109, 1, 109, 100)
checkEndClsIL.Emit(OpCodes.Br, cont145)
checkEndClsIL.MarkLabel(fa145)
checkEndClsIL.Emit(OpCodes.Br, cont145)
checkEndClsIL.MarkLabel(cont145)
...
Dim locbldr173 As LocalBuilder = checkAssemblyIL.DeclareLocal(GetType(Token))
...
Dim locbldr174 As LocalBuilder = checkAssemblyIL.DeclareLocal(GetType(System.Type))
...
Dim locbldr175 As LocalBuilder = checkAssemblyIL.DeclareLocal(GetType(AssemblyStmt))
locbldr175.SetLocalSymInfo("asms")
...
Typ = GetType(System.Boolean)
Dim fa147 As System.Reflection.Emit.Label = checkAssemblyIL.DefineLabel()
Dim tru147 As System.Reflection.Emit.Label = checkAssemblyIL.DefineLabel()
Dim cont147 As System.Reflection.Emit.Label = checkAssemblyIL.DefineLabel()
checkAssemblyIL.Emit(OpCodes.Beq, tru147)
checkAssemblyIL.Emit(OpCodes.Br, fa147)
checkAssemblyIL.MarkLabel(tru147)
...
checkAssemblyIL.Emit(OpCodes.Br, cont147)
checkAssemblyIL.MarkLabel(fa147)
checkAssemblyIL.Emit(OpCodes.Br, cont147)
checkAssemblyIL.MarkLabel(cont147)
...
Dim locbldr176 As LocalBuilder = checkVerIL.DeclareLocal(GetType(Token))
locbldr176.SetLocalSymInfo("tok")
...
Dim locbldr177 As LocalBuilder = checkVerIL.DeclareLocal(GetType(System.Type))
...
Dim locbldr178 As LocalBuilder = checkVerIL.DeclareLocal(GetType(VerStmt))
locbldr178.SetLocalSymInfo("vers")
...
Typ = GetType(System.Boolean)
Dim fa148 As System.Reflection.Emit.Label = checkVerIL.DefineLabel()
Dim tru148 As System.Reflection.Emit.Label = checkVerIL.DefineLabel()
Dim cont148 As System.Reflection.Emit.Label = checkVerIL.DefineLabel()
checkVerIL.Emit(OpCodes.Beq, tru148)
checkVerIL.Emit(OpCodes.Br, fa148)
checkVerIL.MarkLabel(tru148)
...
Dim locbldr179 As LocalBuilder = checkVerIL.DeclareLocal(GetType(System.String).MakeArrayType())
locbldr179.SetLocalSymInfo("ars")
Dim typ32(-1) As Type
checkVerIL.Emit(OpCodes.Ldloc, 0)
Typ = GetType(Token)
...
Dim locbldr180 As LocalBuilder = checkVerIL.DeclareLocal(GetType(System.Int32).MakeArrayType())
locbldr180.SetLocalSymInfo("ari")
...
Dim locbldr181 As LocalBuilder = checkVerIL.DeclareLocal(GetType(IntLiteral).MakeArrayType())
locbldr181.SetLocalSymInfo("intla")
checkVerIL.Emit(OpCodes.Ldc_I4, CInt(4))
Typ = GetType(System.Int32)
checkVerIL.Emit(OpCodes.Conv_U)
...
Dim locbldr182 As LocalBuilder = checkVerIL.DeclareLocal(GetType(IntLiteral))
locbldr182.SetLocalSymInfo("intl")
...
checkVerIL.Emit(OpCodes.Br, cont148)
checkVerIL.MarkLabel(fa148)
checkVerIL.Emit(OpCodes.Br, cont148)
checkVerIL.MarkLabel(cont148)
...
Dim locbldr183 As LocalBuilder = checkClassIL.DeclareLocal(GetType(Token))
...
Dim locbldr184 As LocalBuilder = checkClassIL.DeclareLocal(GetType(System.Type))
...
Dim locbldr185 As LocalBuilder = checkClassIL.DeclareLocal(GetType(ClassStmt))
locbldr185.SetLocalSymInfo("clss")
...
Dim locbldr186 As LocalBuilder = checkClassIL.DeclareLocal(GetType(Attributes.Attribute))
locbldr186.SetLocalSymInfo("att")
...
Typ = GetType(System.Boolean)
Dim fa149 As System.Reflection.Emit.Label = checkClassIL.DefineLabel()
Dim tru149 As System.Reflection.Emit.Label = checkClassIL.DefineLabel()
Dim cont149 As System.Reflection.Emit.Label = checkClassIL.DefineLabel()
checkClassIL.Emit(OpCodes.Beq, tru149)
checkClassIL.Emit(OpCodes.Br, fa149)
checkClassIL.MarkLabel(tru149)
...
Dim locbldr187 As LocalBuilder = checkClassIL.DeclareLocal(GetType(System.Int32))
locbldr187.SetLocalSymInfo("i")
checkClassIL.Emit(OpCodes.Ldc_I4, CInt(0))
Typ = GetType(System.Int32)
checkClassIL.Emit(OpCodes.Stloc, 4)
checkClassIL.MarkSequencePoint(doc5, 180, 1, 180, 100)
Dim locbldr188 As LocalBuilder = checkClassIL.DeclareLocal(GetType(System.Int32))
...
Dim locbldr189 As LocalBuilder = checkClassIL.DeclareLocal(GetType(System.Boolean))
locbldr189.SetLocalSymInfo("bl")
...
checkClassIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa150 As System.Reflection.Emit.Label = checkClassIL.DefineLabel()
Dim tru150 As System.Reflection.Emit.Label = checkClassIL.DefineLabel()
Dim cont150 As System.Reflection.Emit.Label = checkClassIL.DefineLabel()
checkClassIL.Emit(OpCodes.Beq, tru150)
checkClassIL.Emit(OpCodes.Br, fa150)
checkClassIL.MarkLabel(tru150)
...
checkClassIL.Emit(OpCodes.Br, cont150)
checkClassIL.MarkLabel(fa150)
checkClassIL.MarkSequencePoint(doc5, 195, 1, 195, 100)
Dim locbldr190 As LocalBuilder = checkClassIL.DeclareLocal(GetType(Token))
locbldr190.SetLocalSymInfo("tok2")
checkClassIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
checkClassIL.Emit(OpCodes.Ldfld, GetType(Stmt).GetField("Tokens"))
Typ = GetType(Stmt).GetField("Tokens").FieldType
...
Dim locbldr191 As LocalBuilder = checkClassIL.DeclareLocal(GetType(System.Type))
locbldr191.SetLocalSymInfo("typ2")
...
Dim locbldr192 As LocalBuilder = checkClassIL.DeclareLocal(GetType(System.Boolean))
locbldr192.SetLocalSymInfo("b2")
Dim typ48(-1) As Type
...
checkClassIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa151 As System.Reflection.Emit.Label = checkClassIL.DefineLabel()
Dim tru151 As System.Reflection.Emit.Label = checkClassIL.DefineLabel()
Dim cont151 As System.Reflection.Emit.Label = checkClassIL.DefineLabel()
checkClassIL.Emit(OpCodes.Beq, tru151)
checkClassIL.Emit(OpCodes.Br, fa151)
checkClassIL.MarkLabel(tru151)
...
checkClassIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa152 As System.Reflection.Emit.Label = checkClassIL.DefineLabel()
Dim tru152 As System.Reflection.Emit.Label = checkClassIL.DefineLabel()
Dim cont152 As System.Reflection.Emit.Label = checkClassIL.DefineLabel()
checkClassIL.Emit(OpCodes.Beq, fa152)
checkClassIL.Emit(OpCodes.Br, tru152)
checkClassIL.MarkLabel(tru152)
checkClassIL.MarkSequencePoint(doc5, 206, 1, 206, 100)
Dim locbldr193 As LocalBuilder = checkClassIL.DeclareLocal(GetType(Token))
locbldr193.SetLocalSymInfo("t")
checkClassIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
checkClassIL.Emit(OpCodes.Ldfld, GetType(Stmt).GetField("Tokens"))
Typ = GetType(Stmt).GetField("Tokens").FieldType
...
Dim locbldr194 As LocalBuilder = checkClassIL.DeclareLocal(GetType(TypeTok))
...
checkClassIL.Emit(OpCodes.Br, cont152)
checkClassIL.MarkLabel(fa152)
...
checkClassIL.Emit(OpCodes.Br, cont152)
checkClassIL.MarkLabel(cont152)
checkClassIL.MarkSequencePoint(doc5, 214, 1, 214, 100)
checkClassIL.Emit(OpCodes.Br, cont151)
checkClassIL.MarkLabel(fa151)
...
checkClassIL.Emit(OpCodes.Br, cont151)
checkClassIL.MarkLabel(cont151)
checkClassIL.MarkSequencePoint(doc5, 218, 1, 218, 100)
checkClassIL.Emit(OpCodes.Br, cont150)
checkClassIL.MarkLabel(cont150)
checkClassIL.MarkSequencePoint(doc5, 220, 1, 220, 100)
checkClassIL.Emit(OpCodes.Ldloc, 4)
Typ = GetType(System.Int32)
checkClassIL.Emit(OpCodes.Ldloc, 5)
Typ = GetType(System.Int32)
Dim fa153 As System.Reflection.Emit.Label = checkClassIL.DefineLabel()
Dim tru153 As System.Reflection.Emit.Label = checkClassIL.DefineLabel()
Dim cont153 As System.Reflection.Emit.Label = checkClassIL.DefineLabel()
checkClassIL.Emit(OpCodes.Beq, tru153)
checkClassIL.Emit(OpCodes.Br, fa153)
checkClassIL.MarkLabel(tru153)
...
checkClassIL.Emit(OpCodes.Br, cont153)
checkClassIL.MarkLabel(fa153)
...
checkClassIL.Emit(OpCodes.Br, cont153)
checkClassIL.MarkLabel(cont153)
...
checkClassIL.Emit(OpCodes.Br, cont149)
checkClassIL.MarkLabel(fa149)
checkClassIL.Emit(OpCodes.Br, cont149)
checkClassIL.MarkLabel(cont149)
...
Dim locbldr195 As LocalBuilder = checkFieldIL.DeclareLocal(GetType(Token))
locbldr195.SetLocalSymInfo("tok")
...
Dim locbldr196 As LocalBuilder = checkFieldIL.DeclareLocal(GetType(System.Type))
locbldr196.SetLocalSymInfo("typ")
...
Dim locbldr197 As LocalBuilder = checkFieldIL.DeclareLocal(GetType(FieldStmt))
locbldr197.SetLocalSymInfo("flss")
...
Dim locbldr198 As LocalBuilder = checkFieldIL.DeclareLocal(GetType(Attributes.Attribute))
locbldr198.SetLocalSymInfo("att")
...
Typ = GetType(System.Boolean)
Dim fa154 As System.Reflection.Emit.Label = checkFieldIL.DefineLabel()
Dim tru154 As System.Reflection.Emit.Label = checkFieldIL.DefineLabel()
Dim cont154 As System.Reflection.Emit.Label = checkFieldIL.DefineLabel()
checkFieldIL.Emit(OpCodes.Beq, tru154)
checkFieldIL.Emit(OpCodes.Br, fa154)
checkFieldIL.MarkLabel(tru154)
checkFieldIL.MarkSequencePoint(doc5, 243, 1, 243, 100)
Dim locbldr199 As LocalBuilder = checkFieldIL.DeclareLocal(GetType(Expr))
locbldr199.SetLocalSymInfo("tempexp")
...
Dim locbldr200 As LocalBuilder = checkFieldIL.DeclareLocal(asm.GetType("dylan.NET.Tokenizer.Parser.ExprOptimizer"))
locbldr200.SetLocalSymInfo("eop")
...
Dim locbldr201 As LocalBuilder = checkFieldIL.DeclareLocal(GetType(System.Int32))
locbldr201.SetLocalSymInfo("i")
checkFieldIL.Emit(OpCodes.Ldc_I4, CInt(0))
Typ = GetType(System.Int32)
checkFieldIL.Emit(OpCodes.Stloc, 6)
checkFieldIL.MarkSequencePoint(doc5, 258, 1, 258, 100)
Dim locbldr202 As LocalBuilder = checkFieldIL.DeclareLocal(GetType(System.Int32))
...
Dim locbldr203 As LocalBuilder = checkFieldIL.DeclareLocal(GetType(System.Boolean))
locbldr203.SetLocalSymInfo("bl")
checkFieldIL.Emit(OpCodes.Ldc_I4, 0)
Typ = GetType(System.Boolean)
...
checkFieldIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa155 As System.Reflection.Emit.Label = checkFieldIL.DefineLabel()
Dim tru155 As System.Reflection.Emit.Label = checkFieldIL.DefineLabel()
Dim cont155 As System.Reflection.Emit.Label = checkFieldIL.DefineLabel()
checkFieldIL.Emit(OpCodes.Beq, tru155)
checkFieldIL.Emit(OpCodes.Br, fa155)
checkFieldIL.MarkLabel(tru155)
...
checkFieldIL.Emit(OpCodes.Br, cont155)
checkFieldIL.MarkLabel(fa155)
checkFieldIL.Emit(OpCodes.Br, cont155)
checkFieldIL.MarkLabel(cont155)
checkFieldIL.MarkSequencePoint(doc5, 273, 1, 273, 100)
checkFieldIL.Emit(OpCodes.Ldloc, 6)
Typ = GetType(System.Int32)
checkFieldIL.Emit(OpCodes.Ldloc, 7)
Typ = GetType(System.Int32)
Dim fa156 As System.Reflection.Emit.Label = checkFieldIL.DefineLabel()
Dim tru156 As System.Reflection.Emit.Label = checkFieldIL.DefineLabel()
Dim cont156 As System.Reflection.Emit.Label = checkFieldIL.DefineLabel()
checkFieldIL.Emit(OpCodes.Beq, tru156)
checkFieldIL.Emit(OpCodes.Br, fa156)
checkFieldIL.MarkLabel(tru156)
...
checkFieldIL.Emit(OpCodes.Br, cont156)
checkFieldIL.MarkLabel(fa156)
...
checkFieldIL.Emit(OpCodes.Br, cont156)
checkFieldIL.MarkLabel(cont156)
...
Dim locbldr204 As LocalBuilder = checkFieldIL.DeclareLocal(GetType(Token))
...
Dim locbldr205 As LocalBuilder = checkFieldIL.DeclareLocal(GetType(System.Type))
...
Dim locbldr206 As LocalBuilder = checkFieldIL.DeclareLocal(GetType(System.Boolean))
...
checkFieldIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa157 As System.Reflection.Emit.Label = checkFieldIL.DefineLabel()
Dim tru157 As System.Reflection.Emit.Label = checkFieldIL.DefineLabel()
Dim cont157 As System.Reflection.Emit.Label = checkFieldIL.DefineLabel()
checkFieldIL.Emit(OpCodes.Beq, fa157)
checkFieldIL.Emit(OpCodes.Br, tru157)
checkFieldIL.MarkLabel(tru157)
checkFieldIL.MarkSequencePoint(doc5, 287, 1, 287, 100)
Dim locbldr207 As LocalBuilder = checkFieldIL.DeclareLocal(GetType(Token))
locbldr207.SetLocalSymInfo("t")
checkFieldIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
checkFieldIL.Emit(OpCodes.Ldfld, GetType(Stmt).GetField("Tokens"))
Typ = GetType(Stmt).GetField("Tokens").FieldType
...
Dim locbldr208 As LocalBuilder = checkFieldIL.DeclareLocal(GetType(TypeTok))
locbldr208.SetLocalSymInfo("tt")
...
checkFieldIL.Emit(OpCodes.Br, cont157)
checkFieldIL.MarkLabel(fa157)
...
checkFieldIL.Emit(OpCodes.Br, cont157)
checkFieldIL.MarkLabel(cont157)
...
checkFieldIL.Emit(OpCodes.Br, cont154)
checkFieldIL.MarkLabel(fa154)
checkFieldIL.Emit(OpCodes.Br, cont154)
checkFieldIL.MarkLabel(cont154)
...
Dim locbldr209 As LocalBuilder = checkMethodIL.DeclareLocal(GetType(Token))
...
Dim locbldr210 As LocalBuilder = checkMethodIL.DeclareLocal(GetType(System.Type))
...
Dim locbldr211 As LocalBuilder = checkMethodIL.DeclareLocal(GetType(MethodStmt))
locbldr211.SetLocalSymInfo("mtss")
...
Dim locbldr212 As LocalBuilder = checkMethodIL.DeclareLocal(GetType(Attributes.Attribute))
locbldr212.SetLocalSymInfo("att")
...
Dim locbldr213 As LocalBuilder = checkMethodIL.DeclareLocal(GetType(Ident))
locbldr213.SetLocalSymInfo("mn")
...
Dim locbldr214 As LocalBuilder = checkMethodIL.DeclareLocal(GetType(Expr))
locbldr214.SetLocalSymInfo("exp")
checkMethodIL.Emit(OpCodes.Ldnull)
checkMethodIL.Emit(OpCodes.Stloc, 5)
checkMethodIL.MarkSequencePoint(doc5, 313, 1, 313, 100)
Dim locbldr215 As LocalBuilder = checkMethodIL.DeclareLocal(GetType(System.Boolean))
locbldr215.SetLocalSymInfo("d")
...
Typ = GetType(System.Boolean)
Dim fa158 As System.Reflection.Emit.Label = checkMethodIL.DefineLabel()
Dim tru158 As System.Reflection.Emit.Label = checkMethodIL.DefineLabel()
Dim cont158 As System.Reflection.Emit.Label = checkMethodIL.DefineLabel()
checkMethodIL.Emit(OpCodes.Beq, tru158)
checkMethodIL.Emit(OpCodes.Br, fa158)
checkMethodIL.MarkLabel(tru158)
checkMethodIL.MarkSequencePoint(doc5, 317, 1, 317, 100)
Dim locbldr216 As LocalBuilder = checkMethodIL.DeclareLocal(GetType(Expr))
locbldr216.SetLocalSymInfo("tempexp")
...
Dim locbldr217 As LocalBuilder = checkMethodIL.DeclareLocal(asm.GetType("dylan.NET.Tokenizer.Parser.ExprOptimizer"))
...
Dim locbldr218 As LocalBuilder = checkMethodIL.DeclareLocal(GetType(System.Int32))
locbldr218.SetLocalSymInfo("i")
checkMethodIL.Emit(OpCodes.Ldc_I4, CInt(0))
Typ = GetType(System.Int32)
checkMethodIL.Emit(OpCodes.Stloc, 9)
checkMethodIL.MarkSequencePoint(doc5, 333, 1, 333, 100)
Dim locbldr219 As LocalBuilder = checkMethodIL.DeclareLocal(GetType(System.Int32))
...
Dim locbldr220 As LocalBuilder = checkMethodIL.DeclareLocal(GetType(System.Boolean))
locbldr220.SetLocalSymInfo("bl")
checkMethodIL.Emit(OpCodes.Ldc_I4, 0)
Typ = GetType(System.Boolean)
...
checkMethodIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa159 As System.Reflection.Emit.Label = checkMethodIL.DefineLabel()
Dim tru159 As System.Reflection.Emit.Label = checkMethodIL.DefineLabel()
Dim cont159 As System.Reflection.Emit.Label = checkMethodIL.DefineLabel()
checkMethodIL.Emit(OpCodes.Beq, tru159)
checkMethodIL.Emit(OpCodes.Br, fa159)
checkMethodIL.MarkLabel(tru159)
...
checkMethodIL.Emit(OpCodes.Br, cont159)
checkMethodIL.MarkLabel(fa159)
...
checkMethodIL.Emit(OpCodes.Br, cont159)
checkMethodIL.MarkLabel(cont159)
checkMethodIL.MarkSequencePoint(doc5, 352, 1, 352, 100)
checkMethodIL.Emit(OpCodes.Ldloc, 9)
Typ = GetType(System.Int32)
checkMethodIL.Emit(OpCodes.Ldloc, 10)
Typ = GetType(System.Int32)
Dim fa160 As System.Reflection.Emit.Label = checkMethodIL.DefineLabel()
Dim tru160 As System.Reflection.Emit.Label = checkMethodIL.DefineLabel()
Dim cont160 As System.Reflection.Emit.Label = checkMethodIL.DefineLabel()
checkMethodIL.Emit(OpCodes.Beq, tru160)
checkMethodIL.Emit(OpCodes.Br, fa160)
checkMethodIL.MarkLabel(tru160)
...
checkMethodIL.Emit(OpCodes.Br, cont160)
checkMethodIL.MarkLabel(fa160)
...
checkMethodIL.Emit(OpCodes.Br, cont160)
checkMethodIL.MarkLabel(cont160)
...
Dim locbldr221 As LocalBuilder = checkMethodIL.DeclareLocal(GetType(Token))
locbldr221.SetLocalSymInfo("tok2")
checkMethodIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
checkMethodIL.Emit(OpCodes.Ldfld, GetType(Stmt).GetField("Tokens"))
Typ = GetType(Stmt).GetField("Tokens").FieldType
...
Dim locbldr222 As LocalBuilder = checkMethodIL.DeclareLocal(GetType(System.Type))
locbldr222.SetLocalSymInfo("typ2")
checkMethodIL.MarkSequencePoint(doc5, 367, 1, 367, 100)
Dim locbldr223 As LocalBuilder = checkMethodIL.DeclareLocal(GetType(System.Boolean))
locbldr223.SetLocalSymInfo("b2")
...
checkMethodIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa161 As System.Reflection.Emit.Label = checkMethodIL.DefineLabel()
Dim tru161 As System.Reflection.Emit.Label = checkMethodIL.DefineLabel()
Dim cont161 As System.Reflection.Emit.Label = checkMethodIL.DefineLabel()
checkMethodIL.Emit(OpCodes.Beq, fa161)
checkMethodIL.Emit(OpCodes.Br, tru161)
checkMethodIL.MarkLabel(tru161)
checkMethodIL.MarkSequencePoint(doc5, 373, 1, 373, 100)
Dim locbldr224 As LocalBuilder = checkMethodIL.DeclareLocal(GetType(Token))
locbldr224.SetLocalSymInfo("t")
checkMethodIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
checkMethodIL.Emit(OpCodes.Ldfld, GetType(Stmt).GetField("Tokens"))
Typ = GetType(Stmt).GetField("Tokens").FieldType
...
Dim locbldr225 As LocalBuilder = checkMethodIL.DeclareLocal(GetType(TypeTok))
locbldr225.SetLocalSymInfo("tt")
...
checkMethodIL.Emit(OpCodes.Br, cont161)
checkMethodIL.MarkLabel(fa161)
...
checkMethodIL.Emit(OpCodes.Br, cont161)
checkMethodIL.MarkLabel(cont161)
...
checkMethodIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa162 As System.Reflection.Emit.Label = checkMethodIL.DefineLabel()
Dim tru162 As System.Reflection.Emit.Label = checkMethodIL.DefineLabel()
Dim cont162 As System.Reflection.Emit.Label = checkMethodIL.DefineLabel()
checkMethodIL.Emit(OpCodes.Beq, tru162)
checkMethodIL.Emit(OpCodes.Br, fa162)
checkMethodIL.MarkLabel(tru162)
...
checkMethodIL.Emit(OpCodes.Br, cont162)
checkMethodIL.MarkLabel(fa162)
checkMethodIL.Emit(OpCodes.Br, cont162)
checkMethodIL.MarkLabel(cont162)
...
checkMethodIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa163 As System.Reflection.Emit.Label = checkMethodIL.DefineLabel()
Dim tru163 As System.Reflection.Emit.Label = checkMethodIL.DefineLabel()
Dim cont163 As System.Reflection.Emit.Label = checkMethodIL.DefineLabel()
checkMethodIL.Emit(OpCodes.Beq, tru163)
checkMethodIL.Emit(OpCodes.Br, fa163)
checkMethodIL.MarkLabel(tru163)
...
checkMethodIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa164 As System.Reflection.Emit.Label = checkMethodIL.DefineLabel()
Dim tru164 As System.Reflection.Emit.Label = checkMethodIL.DefineLabel()
Dim cont164 As System.Reflection.Emit.Label = checkMethodIL.DefineLabel()
checkMethodIL.Emit(OpCodes.Beq, tru164)
checkMethodIL.Emit(OpCodes.Br, fa164)
checkMethodIL.MarkLabel(tru164)
checkMethodIL.MarkSequencePoint(doc5, 409, 1, 409, 100)
checkMethodIL.Emit(OpCodes.Ldloc, 6)
Typ = GetType(System.Boolean)
checkMethodIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa165 As System.Reflection.Emit.Label = checkMethodIL.DefineLabel()
Dim tru165 As System.Reflection.Emit.Label = checkMethodIL.DefineLabel()
Dim cont165 As System.Reflection.Emit.Label = checkMethodIL.DefineLabel()
checkMethodIL.Emit(OpCodes.Beq, tru165)
checkMethodIL.Emit(OpCodes.Br, fa165)
checkMethodIL.MarkLabel(tru165)
checkMethodIL.MarkSequencePoint(doc5, 410, 1, 410, 100)
Dim locbldr226 As LocalBuilder = checkMethodIL.DeclareLocal(asm.GetType("dylan.NET.Tokenizer.Parser.ExprOptimizer"))
locbldr226.SetLocalSymInfo("eopt2")
checkMethodIL.Emit(OpCodes.Newobj, asm.GetType("dylan.NET.Tokenizer.Parser.ExprOptimizer").GetConstructor(Type.EmptyTypes))
...
checkMethodIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa166 As System.Reflection.Emit.Label = checkMethodIL.DefineLabel()
Dim tru166 As System.Reflection.Emit.Label = checkMethodIL.DefineLabel()
Dim cont166 As System.Reflection.Emit.Label = checkMethodIL.DefineLabel()
checkMethodIL.Emit(OpCodes.Beq, tru166)
checkMethodIL.Emit(OpCodes.Br, fa166)
checkMethodIL.MarkLabel(tru166)
...
checkMethodIL.Emit(OpCodes.Br, cont166)
checkMethodIL.MarkLabel(fa166)
checkMethodIL.Emit(OpCodes.Br, cont166)
checkMethodIL.MarkLabel(cont166)
checkMethodIL.MarkSequencePoint(doc5, 415, 1, 415, 100)
checkMethodIL.Emit(OpCodes.Br, cont165)
checkMethodIL.MarkLabel(fa165)
checkMethodIL.Emit(OpCodes.Br, cont165)
checkMethodIL.MarkLabel(cont165)
...
checkMethodIL.Emit(OpCodes.Br, cont164)
checkMethodIL.MarkLabel(fa164)
checkMethodIL.Emit(OpCodes.Br, cont164)
checkMethodIL.MarkLabel(cont164)
...
checkMethodIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa167 As System.Reflection.Emit.Label = checkMethodIL.DefineLabel()
Dim tru167 As System.Reflection.Emit.Label = checkMethodIL.DefineLabel()
Dim cont167 As System.Reflection.Emit.Label = checkMethodIL.DefineLabel()
checkMethodIL.Emit(OpCodes.Beq, tru167)
checkMethodIL.Emit(OpCodes.Br, fa167)
checkMethodIL.MarkLabel(tru167)
...
checkMethodIL.Emit(OpCodes.Br, cont167)
checkMethodIL.MarkLabel(fa167)
checkMethodIL.Emit(OpCodes.Br, cont167)
checkMethodIL.MarkLabel(cont167)
...
checkMethodIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa168 As System.Reflection.Emit.Label = checkMethodIL.DefineLabel()
Dim tru168 As System.Reflection.Emit.Label = checkMethodIL.DefineLabel()
Dim cont168 As System.Reflection.Emit.Label = checkMethodIL.DefineLabel()
checkMethodIL.Emit(OpCodes.Beq, tru168)
checkMethodIL.Emit(OpCodes.Br, fa168)
checkMethodIL.MarkLabel(tru168)
checkMethodIL.MarkSequencePoint(doc5, 432, 1, 432, 100)
Dim locbldr227 As LocalBuilder = checkMethodIL.DeclareLocal(asm.GetType("dylan.NET.Tokenizer.Parser.ExprOptimizer"))
locbldr227.SetLocalSymInfo("eopt1")
checkMethodIL.Emit(OpCodes.Newobj, asm.GetType("dylan.NET.Tokenizer.Parser.ExprOptimizer").GetConstructor(Type.EmptyTypes))
...
checkMethodIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa169 As System.Reflection.Emit.Label = checkMethodIL.DefineLabel()
Dim tru169 As System.Reflection.Emit.Label = checkMethodIL.DefineLabel()
Dim cont169 As System.Reflection.Emit.Label = checkMethodIL.DefineLabel()
checkMethodIL.Emit(OpCodes.Beq, tru169)
checkMethodIL.Emit(OpCodes.Br, fa169)
checkMethodIL.MarkLabel(tru169)
...
checkMethodIL.Emit(OpCodes.Br, cont169)
checkMethodIL.MarkLabel(fa169)
checkMethodIL.Emit(OpCodes.Br, cont169)
checkMethodIL.MarkLabel(cont169)
checkMethodIL.MarkSequencePoint(doc5, 437, 1, 437, 100)
checkMethodIL.Emit(OpCodes.Ldc_I4, 0)
Typ = GetType(System.Boolean)
checkMethodIL.Emit(OpCodes.Stloc, 6)
checkMethodIL.MarkSequencePoint(doc5, 438, 1, 438, 100)
checkMethodIL.Emit(OpCodes.Br, cont168)
checkMethodIL.MarkLabel(fa168)
checkMethodIL.Emit(OpCodes.Br, cont168)
checkMethodIL.MarkLabel(cont168)
checkMethodIL.MarkSequencePoint(doc5, 440, 1, 440, 100)
checkMethodIL.Emit(OpCodes.Ldloc, 6)
Typ = GetType(System.Boolean)
checkMethodIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa170 As System.Reflection.Emit.Label = checkMethodIL.DefineLabel()
Dim tru170 As System.Reflection.Emit.Label = checkMethodIL.DefineLabel()
Dim cont170 As System.Reflection.Emit.Label = checkMethodIL.DefineLabel()
checkMethodIL.Emit(OpCodes.Beq, tru170)
checkMethodIL.Emit(OpCodes.Br, fa170)
checkMethodIL.MarkLabel(tru170)
...
checkMethodIL.Emit(OpCodes.Br, cont170)
checkMethodIL.MarkLabel(fa170)
checkMethodIL.Emit(OpCodes.Br, cont170)
checkMethodIL.MarkLabel(cont170)
checkMethodIL.MarkSequencePoint(doc5, 445, 1, 445, 100)
checkMethodIL.Emit(OpCodes.Ldloc, 9)
Typ = GetType(System.Int32)
checkMethodIL.Emit(OpCodes.Ldloc, 10)
Typ = GetType(System.Int32)
Dim fa171 As System.Reflection.Emit.Label = checkMethodIL.DefineLabel()
Dim tru171 As System.Reflection.Emit.Label = checkMethodIL.DefineLabel()
Dim cont171 As System.Reflection.Emit.Label = checkMethodIL.DefineLabel()
checkMethodIL.Emit(OpCodes.Beq, tru171)
checkMethodIL.Emit(OpCodes.Br, fa171)
checkMethodIL.MarkLabel(tru171)
checkMethodIL.MarkSequencePoint(doc5, 446, 1, 446, 100)
checkMethodIL.Emit(OpCodes.Br, label8)
checkMethodIL.MarkSequencePoint(doc5, 447, 1, 447, 100)
checkMethodIL.Emit(OpCodes.Br, cont171)
checkMethodIL.MarkLabel(fa171)
...
checkMethodIL.Emit(OpCodes.Br, cont171)
checkMethodIL.MarkLabel(cont171)
...
checkMethodIL.Emit(OpCodes.Br, cont163)
checkMethodIL.MarkLabel(fa163)
checkMethodIL.Emit(OpCodes.Br, cont163)
checkMethodIL.MarkLabel(cont163)
checkMethodIL.MarkSequencePoint(doc5, 455, 1, 455, 100)
checkMethodIL.Emit(OpCodes.Br, cont158)
checkMethodIL.MarkLabel(fa158)
checkMethodIL.Emit(OpCodes.Br, cont158)
checkMethodIL.MarkLabel(cont158)
...
Typ = GetType(System.Int32)
Dim fa172 As System.Reflection.Emit.Label = checkMethodCallIL.DefineLabel()
Dim tru172 As System.Reflection.Emit.Label = checkMethodCallIL.DefineLabel()
Dim cont172 As System.Reflection.Emit.Label = checkMethodCallIL.DefineLabel()
checkMethodCallIL.Emit(OpCodes.Bgt, tru172)
checkMethodCallIL.Emit(OpCodes.Br, fa172)
checkMethodCallIL.MarkLabel(tru172)
checkMethodCallIL.MarkSequencePoint(doc5, 462, 1, 462, 100)
Dim locbldr228 As LocalBuilder = checkMethodCallIL.DeclareLocal(GetType(Token))
locbldr228.SetLocalSymInfo("tok")
checkMethodCallIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
checkMethodCallIL.Emit(OpCodes.Ldfld, GetType(Stmt).GetField("Tokens"))
Typ = GetType(Stmt).GetField("Tokens").FieldType
...
Dim locbldr229 As LocalBuilder = checkMethodCallIL.DeclareLocal(GetType(System.Type))
...
Dim locbldr230 As LocalBuilder = checkMethodCallIL.DeclareLocal(GetType(Token))
locbldr230.SetLocalSymInfo("tokb")
checkMethodCallIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
checkMethodCallIL.Emit(OpCodes.Ldfld, GetType(Stmt).GetField("Tokens"))
Typ = GetType(Stmt).GetField("Tokens").FieldType
...
Dim locbldr231 As LocalBuilder = checkMethodCallIL.DeclareLocal(GetType(System.Type))
locbldr231.SetLocalSymInfo("typb")
...
Dim locbldr232 As LocalBuilder = checkMethodCallIL.DeclareLocal(GetType(System.Boolean))
locbldr232.SetLocalSymInfo("ba")
Dim typ87(-1) As Type
...
Dim locbldr233 As LocalBuilder = checkMethodCallIL.DeclareLocal(GetType(System.Boolean))
locbldr233.SetLocalSymInfo("bb")
Dim typ88(-1) As Type
...
Dim locbldr234 As LocalBuilder = checkMethodCallIL.DeclareLocal(GetType(MethodCallStmt))
locbldr234.SetLocalSymInfo("mtcss")
...
Dim locbldr235 As LocalBuilder = checkMethodCallIL.DeclareLocal(GetType(MethodNameTok))
locbldr235.SetLocalSymInfo("mn")
...
Dim locbldr236 As LocalBuilder = checkMethodCallIL.DeclareLocal(GetType(MethodCallTok))
locbldr236.SetLocalSymInfo("mct")
...
Dim locbldr237 As LocalBuilder = checkMethodCallIL.DeclareLocal(GetType(Ident))
locbldr237.SetLocalSymInfo("idt")
...
Dim locbldr238 As LocalBuilder = checkMethodCallIL.DeclareLocal(GetType(Expr))
...
Dim locbldr239 As LocalBuilder = checkMethodCallIL.DeclareLocal(GetType(System.Int32))
locbldr239.SetLocalSymInfo("lvl")
checkMethodCallIL.Emit(OpCodes.Ldc_I4, CInt(1))
Typ = GetType(System.Int32)
checkMethodCallIL.Emit(OpCodes.Stloc, 11)
checkMethodCallIL.MarkSequencePoint(doc5, 477, 1, 477, 100)
Dim locbldr240 As LocalBuilder = checkMethodCallIL.DeclareLocal(GetType(System.Boolean))
locbldr240.SetLocalSymInfo("d")
...
Dim locbldr241 As LocalBuilder = checkMethodCallIL.DeclareLocal(GetType(System.Int32))
...
checkMethodCallIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa173 As System.Reflection.Emit.Label = checkMethodCallIL.DefineLabel()
Dim tru173 As System.Reflection.Emit.Label = checkMethodCallIL.DefineLabel()
Dim cont173 As System.Reflection.Emit.Label = checkMethodCallIL.DefineLabel()
checkMethodCallIL.Emit(OpCodes.Beq, tru173)
checkMethodCallIL.Emit(OpCodes.Br, fa173)
checkMethodCallIL.MarkLabel(tru173)
...
Dim locbldr242 As LocalBuilder = checkMethodCallIL.DeclareLocal(GetType(Token))
...
Dim locbldr243 As LocalBuilder = checkMethodCallIL.DeclareLocal(GetType(System.Type))
locbldr243.SetLocalSymInfo("typ2")
checkMethodCallIL.MarkSequencePoint(doc5, 491, 1, 491, 100)
Dim locbldr244 As LocalBuilder = checkMethodCallIL.DeclareLocal(GetType(System.Boolean))
locbldr244.SetLocalSymInfo("b2")
checkMethodCallIL.MarkSequencePoint(doc5, 492, 1, 492, 100)
Dim locbldr245 As LocalBuilder = checkMethodCallIL.DeclareLocal(GetType(System.Int32))
...
Dim locbldr246 As LocalBuilder = checkMethodCallIL.DeclareLocal(asm.GetType("dylan.NET.Tokenizer.Parser.ExprOptimizer"))
locbldr246.SetLocalSymInfo("eopt")
...
checkMethodCallIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa174 As System.Reflection.Emit.Label = checkMethodCallIL.DefineLabel()
Dim tru174 As System.Reflection.Emit.Label = checkMethodCallIL.DefineLabel()
Dim cont174 As System.Reflection.Emit.Label = checkMethodCallIL.DefineLabel()
checkMethodCallIL.Emit(OpCodes.Beq, tru174)
checkMethodCallIL.Emit(OpCodes.Br, fa174)
checkMethodCallIL.MarkLabel(tru174)
...
checkMethodCallIL.Emit(OpCodes.Ldc_I4, CInt(0))
Typ = GetType(System.Int32)
Dim fa175 As System.Reflection.Emit.Label = checkMethodCallIL.DefineLabel()
Dim tru175 As System.Reflection.Emit.Label = checkMethodCallIL.DefineLabel()
Dim cont175 As System.Reflection.Emit.Label = checkMethodCallIL.DefineLabel()
checkMethodCallIL.Emit(OpCodes.Beq, tru175)
checkMethodCallIL.Emit(OpCodes.Br, fa175)
checkMethodCallIL.MarkLabel(tru175)
...
checkMethodCallIL.Emit(OpCodes.Br, cont175)
checkMethodCallIL.MarkLabel(fa175)
...
checkMethodCallIL.Emit(OpCodes.Br, cont175)
checkMethodCallIL.MarkLabel(cont175)
checkMethodCallIL.MarkSequencePoint(doc5, 518, 1, 518, 100)
checkMethodCallIL.Emit(OpCodes.Br, label11)
checkMethodCallIL.MarkSequencePoint(doc5, 519, 1, 519, 100)
checkMethodCallIL.Emit(OpCodes.Br, cont174)
checkMethodCallIL.MarkLabel(fa174)
checkMethodCallIL.Emit(OpCodes.Br, cont174)
checkMethodCallIL.MarkLabel(cont174)
...
checkMethodCallIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa176 As System.Reflection.Emit.Label = checkMethodCallIL.DefineLabel()
Dim tru176 As System.Reflection.Emit.Label = checkMethodCallIL.DefineLabel()
Dim cont176 As System.Reflection.Emit.Label = checkMethodCallIL.DefineLabel()
checkMethodCallIL.Emit(OpCodes.Beq, tru176)
checkMethodCallIL.Emit(OpCodes.Br, fa176)
checkMethodCallIL.MarkLabel(tru176)
...
checkMethodCallIL.Emit(OpCodes.Br, cont176)
checkMethodCallIL.MarkLabel(fa176)
checkMethodCallIL.Emit(OpCodes.Br, cont176)
checkMethodCallIL.MarkLabel(cont176)
...
checkMethodCallIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa177 As System.Reflection.Emit.Label = checkMethodCallIL.DefineLabel()
Dim tru177 As System.Reflection.Emit.Label = checkMethodCallIL.DefineLabel()
Dim cont177 As System.Reflection.Emit.Label = checkMethodCallIL.DefineLabel()
checkMethodCallIL.Emit(OpCodes.Beq, tru177)
checkMethodCallIL.Emit(OpCodes.Br, fa177)
checkMethodCallIL.MarkLabel(tru177)
checkMethodCallIL.MarkSequencePoint(doc5, 534, 1, 534, 100)
checkMethodCallIL.Emit(OpCodes.Ldloc, 11)
Typ = GetType(System.Int32)
checkMethodCallIL.Emit(OpCodes.Ldc_I4, CInt(1))
Typ = GetType(System.Int32)
Dim fa178 As System.Reflection.Emit.Label = checkMethodCallIL.DefineLabel()
Dim tru178 As System.Reflection.Emit.Label = checkMethodCallIL.DefineLabel()
Dim cont178 As System.Reflection.Emit.Label = checkMethodCallIL.DefineLabel()
checkMethodCallIL.Emit(OpCodes.Beq, tru178)
checkMethodCallIL.Emit(OpCodes.Br, fa178)
checkMethodCallIL.MarkLabel(tru178)
...
checkMethodCallIL.Emit(OpCodes.Br, cont178)
checkMethodCallIL.MarkLabel(fa178)
...
checkMethodCallIL.Emit(OpCodes.Br, cont178)
checkMethodCallIL.MarkLabel(cont178)
checkMethodCallIL.MarkSequencePoint(doc5, 544, 1, 544, 100)
checkMethodCallIL.Emit(OpCodes.Br, cont177)
checkMethodCallIL.MarkLabel(fa177)
...
checkMethodCallIL.Emit(OpCodes.Br, cont177)
checkMethodCallIL.MarkLabel(cont177)
...
checkMethodCallIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa179 As System.Reflection.Emit.Label = checkMethodCallIL.DefineLabel()
Dim tru179 As System.Reflection.Emit.Label = checkMethodCallIL.DefineLabel()
Dim cont179 As System.Reflection.Emit.Label = checkMethodCallIL.DefineLabel()
checkMethodCallIL.Emit(OpCodes.Beq, tru179)
checkMethodCallIL.Emit(OpCodes.Br, fa179)
checkMethodCallIL.MarkLabel(tru179)
...
checkMethodCallIL.Emit(OpCodes.Br, cont179)
checkMethodCallIL.MarkLabel(fa179)
checkMethodCallIL.Emit(OpCodes.Br, cont179)
checkMethodCallIL.MarkLabel(cont179)
checkMethodCallIL.MarkSequencePoint(doc5, 555, 1, 555, 100)
checkMethodCallIL.Emit(OpCodes.Ldloc, 13)
Typ = GetType(System.Int32)
checkMethodCallIL.Emit(OpCodes.Ldloc, 17)
Typ = GetType(System.Int32)
Dim fa180 As System.Reflection.Emit.Label = checkMethodCallIL.DefineLabel()
Dim tru180 As System.Reflection.Emit.Label = checkMethodCallIL.DefineLabel()
Dim cont180 As System.Reflection.Emit.Label = checkMethodCallIL.DefineLabel()
checkMethodCallIL.Emit(OpCodes.Beq, tru180)
checkMethodCallIL.Emit(OpCodes.Br, fa180)
checkMethodCallIL.MarkLabel(tru180)
checkMethodCallIL.MarkSequencePoint(doc5, 556, 1, 556, 100)
checkMethodCallIL.Emit(OpCodes.Br, label10)
checkMethodCallIL.MarkSequencePoint(doc5, 557, 1, 557, 100)
checkMethodCallIL.Emit(OpCodes.Br, cont180)
checkMethodCallIL.MarkLabel(fa180)
...
checkMethodCallIL.Emit(OpCodes.Br, cont180)
checkMethodCallIL.MarkLabel(cont180)
...
checkMethodCallIL.Emit(OpCodes.Br, cont173)
checkMethodCallIL.MarkLabel(fa173)
checkMethodCallIL.Emit(OpCodes.Br, cont173)
checkMethodCallIL.MarkLabel(cont173)
checkMethodCallIL.MarkSequencePoint(doc5, 568, 1, 568, 100)
checkMethodCallIL.Emit(OpCodes.Br, cont172)
checkMethodCallIL.MarkLabel(fa172)
checkMethodCallIL.Emit(OpCodes.Br, cont172)
checkMethodCallIL.MarkLabel(cont172)
...
Dim locbldr247 As LocalBuilder = checkVarAsIL.DeclareLocal(GetType(Token))
...
Dim locbldr248 As LocalBuilder = checkVarAsIL.DeclareLocal(GetType(System.Type))
...
Dim locbldr249 As LocalBuilder = checkVarAsIL.DeclareLocal(GetType(VarStmt))
locbldr249.SetLocalSymInfo("vars")
...
checkVarAsIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa181 As System.Reflection.Emit.Label = checkVarAsIL.DefineLabel()
Dim tru181 As System.Reflection.Emit.Label = checkVarAsIL.DefineLabel()
Dim cont181 As System.Reflection.Emit.Label = checkVarAsIL.DefineLabel()
checkVarAsIL.Emit(OpCodes.Beq, tru181)
checkVarAsIL.Emit(OpCodes.Br, fa181)
checkVarAsIL.MarkLabel(tru181)
...
Dim locbldr250 As LocalBuilder = checkVarAsIL.DeclareLocal(GetType(Expr))
locbldr250.SetLocalSymInfo("tempexp")
...
Dim locbldr251 As LocalBuilder = checkVarAsIL.DeclareLocal(asm.GetType("dylan.NET.Tokenizer.Parser.ExprOptimizer"))
locbldr251.SetLocalSymInfo("eop")
...
Dim locbldr252 As LocalBuilder = checkVarAsIL.DeclareLocal(GetType(Token))
...
Dim locbldr253 As LocalBuilder = checkVarAsIL.DeclareLocal(GetType(System.Type))
...
Dim locbldr254 As LocalBuilder = checkVarAsIL.DeclareLocal(GetType(System.Boolean))
...
checkVarAsIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa182 As System.Reflection.Emit.Label = checkVarAsIL.DefineLabel()
Dim tru182 As System.Reflection.Emit.Label = checkVarAsIL.DefineLabel()
Dim cont182 As System.Reflection.Emit.Label = checkVarAsIL.DefineLabel()
checkVarAsIL.Emit(OpCodes.Beq, fa182)
checkVarAsIL.Emit(OpCodes.Br, tru182)
checkVarAsIL.MarkLabel(tru182)
checkVarAsIL.MarkSequencePoint(doc5, 593, 1, 593, 100)
Dim locbldr255 As LocalBuilder = checkVarAsIL.DeclareLocal(GetType(Token))
locbldr255.SetLocalSymInfo("t")
checkVarAsIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
checkVarAsIL.Emit(OpCodes.Ldfld, GetType(Stmt).GetField("Tokens"))
Typ = GetType(Stmt).GetField("Tokens").FieldType
...
Dim locbldr256 As LocalBuilder = checkVarAsIL.DeclareLocal(GetType(TypeTok))
locbldr256.SetLocalSymInfo("tt")
checkVarAsIL.Emit(OpCodes.Newobj, GetType(TypeTok).GetConstructor(Type.EmptyTypes))
...
checkVarAsIL.Emit(OpCodes.Br, cont182)
checkVarAsIL.MarkLabel(fa182)
...
checkVarAsIL.Emit(OpCodes.Br, cont182)
checkVarAsIL.MarkLabel(cont182)
checkVarAsIL.MarkSequencePoint(doc5, 602, 1, 602, 100)
checkVarAsIL.Emit(OpCodes.Br, cont181)
checkVarAsIL.MarkLabel(fa181)
checkVarAsIL.Emit(OpCodes.Br, cont181)
checkVarAsIL.MarkLabel(cont181)
...
Dim locbldr257 As LocalBuilder = AssOptIL.DeclareLocal(GetType(AssignStmt))
locbldr257.SetLocalSymInfo("asss")
AssOptIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
AssOptIL.Emit(OpCodes.Stloc, 0)
AssOptIL.MarkSequencePoint(doc5, 609, 1, 609, 100)
Dim locbldr258 As LocalBuilder = AssOptIL.DeclareLocal(GetType(Expr))
locbldr258.SetLocalSymInfo("le")
...
Dim locbldr259 As LocalBuilder = AssOptIL.DeclareLocal(GetType(Token))
locbldr259.SetLocalSymInfo("tok")
...
Dim locbldr260 As LocalBuilder = AssOptIL.DeclareLocal(GetType(System.Type))
locbldr260.SetLocalSymInfo("typ")
...
Dim locbldr261 As LocalBuilder = AssOptIL.DeclareLocal(GetType(System.Boolean))
locbldr261.SetLocalSymInfo("b")
Dim typ108(-1) As Type
...
Dim locbldr262 As LocalBuilder = AssOptIL.DeclareLocal(GetType(VarAsgnStmt))
locbldr262.SetLocalSymInfo("vass")
...
Typ = GetType(System.Boolean)
Dim fa183 As System.Reflection.Emit.Label = AssOptIL.DefineLabel()
Dim tru183 As System.Reflection.Emit.Label = AssOptIL.DefineLabel()
Dim cont183 As System.Reflection.Emit.Label = AssOptIL.DefineLabel()
AssOptIL.Emit(OpCodes.Beq, tru183)
AssOptIL.Emit(OpCodes.Br, fa183)
AssOptIL.MarkLabel(tru183)
...
Dim locbldr263 As LocalBuilder = AssOptIL.DeclareLocal(GetType(Token))
locbldr263.SetLocalSymInfo("tok2")
AssOptIL.Emit(OpCodes.Ldloc, 1)
Typ = GetType(Expr)
AssOptIL.Emit(OpCodes.Ldfld, GetType(Expr).GetField("Tokens"))
Typ = GetType(Expr).GetField("Tokens").FieldType
...
Dim locbldr264 As LocalBuilder = AssOptIL.DeclareLocal(GetType(System.Type))
locbldr264.SetLocalSymInfo("typ2")
...
Dim locbldr265 As LocalBuilder = AssOptIL.DeclareLocal(GetType(System.Boolean))
locbldr265.SetLocalSymInfo("b2")
Dim typ110(-1) As Type
...
AssOptIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa184 As System.Reflection.Emit.Label = AssOptIL.DefineLabel()
Dim tru184 As System.Reflection.Emit.Label = AssOptIL.DefineLabel()
Dim cont184 As System.Reflection.Emit.Label = AssOptIL.DefineLabel()
AssOptIL.Emit(OpCodes.Beq, fa184)
AssOptIL.Emit(OpCodes.Br, tru184)
AssOptIL.MarkLabel(tru184)
AssOptIL.MarkSequencePoint(doc5, 624, 1, 624, 100)
Dim locbldr266 As LocalBuilder = AssOptIL.DeclareLocal(GetType(Token))
locbldr266.SetLocalSymInfo("t")
AssOptIL.Emit(OpCodes.Ldloc, 1)
Typ = GetType(Expr)
AssOptIL.Emit(OpCodes.Ldfld, GetType(Expr).GetField("Tokens"))
Typ = GetType(Expr).GetField("Tokens").FieldType
...
Dim locbldr267 As LocalBuilder = AssOptIL.DeclareLocal(GetType(TypeTok))
locbldr267.SetLocalSymInfo("tt")
...
AssOptIL.Emit(OpCodes.Br, cont184)
AssOptIL.MarkLabel(fa184)
...
Dim locbldr268 As LocalBuilder = AssOptIL.DeclareLocal(asm.GetType("dylan.NET.Tokenizer.Parser.ExprOptimizer"))
locbldr268.SetLocalSymInfo("eop")
...
Dim locbldr269 As LocalBuilder = checkAssignIL.DeclareLocal(GetType(Token))
locbldr269.SetLocalSymInfo("tok")
checkAssignIL.Emit(OpCodes.Ldnull)
checkAssignIL.Emit(OpCodes.Stloc, 0)
checkAssignIL.MarkSequencePoint(doc5, 646, 1, 646, 100)
Dim locbldr270 As LocalBuilder = checkAssignIL.DeclareLocal(GetType(System.Type))
locbldr270.SetLocalSymInfo("typ")
...
Dim locbldr271 As LocalBuilder = checkAssignIL.DeclareLocal(GetType(AssignStmt))
locbldr271.SetLocalSymInfo("asss")
...
Dim locbldr272 As LocalBuilder = checkAssignIL.DeclareLocal(GetType(System.Boolean))
locbldr272.SetLocalSymInfo("c")
checkAssignIL.Emit(OpCodes.Ldc_I4, 0)
Typ = GetType(System.Boolean)
checkAssignIL.Emit(OpCodes.Stloc, 3)
checkAssignIL.MarkSequencePoint(doc5, 649, 1, 649, 100)
Dim locbldr273 As LocalBuilder = checkAssignIL.DeclareLocal(GetType(Expr))
locbldr273.SetLocalSymInfo("re")
...
Dim locbldr274 As LocalBuilder = checkAssignIL.DeclareLocal(GetType(Expr))
locbldr274.SetLocalSymInfo("le")
checkAssignIL.Emit(OpCodes.Newobj, GetType(Expr).GetConstructor(Type.EmptyTypes))
checkAssignIL.Emit(OpCodes.Stloc, 5)
checkAssignIL.MarkSequencePoint(doc5, 651, 1, 651, 100)
Dim locbldr275 As LocalBuilder = checkAssignIL.DeclareLocal(GetType(System.Int32))
...
Dim locbldr276 As LocalBuilder = checkAssignIL.DeclareLocal(GetType(System.Int32))
locbldr276.SetLocalSymInfo("len")
...
Dim locbldr277 As LocalBuilder = checkAssignIL.DeclareLocal(GetType(System.Int32))
locbldr277.SetLocalSymInfo("assind")
...
Typ = GetType(System.Boolean)
Dim fa185 As System.Reflection.Emit.Label = checkAssignIL.DefineLabel()
Dim tru185 As System.Reflection.Emit.Label = checkAssignIL.DefineLabel()
Dim cont185 As System.Reflection.Emit.Label = checkAssignIL.DefineLabel()
checkAssignIL.Emit(OpCodes.Beq, tru185)
checkAssignIL.Emit(OpCodes.Br, fa185)
checkAssignIL.MarkLabel(tru185)
...
checkAssignIL.Emit(OpCodes.Br, cont185)
checkAssignIL.MarkLabel(fa185)
checkAssignIL.Emit(OpCodes.Br, cont185)
checkAssignIL.MarkLabel(cont185)
checkAssignIL.MarkSequencePoint(doc5, 670, 1, 670, 100)
checkAssignIL.Emit(OpCodes.Ldloc, 6)
Typ = GetType(System.Int32)
checkAssignIL.Emit(OpCodes.Ldloc, 7)
Typ = GetType(System.Int32)
Dim fa186 As System.Reflection.Emit.Label = checkAssignIL.DefineLabel()
Dim tru186 As System.Reflection.Emit.Label = checkAssignIL.DefineLabel()
Dim cont186 As System.Reflection.Emit.Label = checkAssignIL.DefineLabel()
checkAssignIL.Emit(OpCodes.Beq, tru186)
checkAssignIL.Emit(OpCodes.Br, fa186)
checkAssignIL.MarkLabel(tru186)
checkAssignIL.MarkSequencePoint(doc5, 671, 1, 671, 100)
checkAssignIL.Emit(OpCodes.Br, label13)
checkAssignIL.MarkSequencePoint(doc5, 672, 1, 672, 100)
checkAssignIL.Emit(OpCodes.Br, cont186)
checkAssignIL.MarkLabel(fa186)
...
checkAssignIL.Emit(OpCodes.Br, cont186)
checkAssignIL.MarkLabel(cont186)
...
checkAssignIL.Emit(OpCodes.Ldc_I4, CInt(0))
Typ = GetType(System.Int32)
Dim fa187 As System.Reflection.Emit.Label = checkAssignIL.DefineLabel()
Dim tru187 As System.Reflection.Emit.Label = checkAssignIL.DefineLabel()
Dim cont187 As System.Reflection.Emit.Label = checkAssignIL.DefineLabel()
checkAssignIL.Emit(OpCodes.Beq, fa187)
checkAssignIL.Emit(OpCodes.Br, tru187)
checkAssignIL.MarkLabel(tru187)
...
checkAssignIL.Emit(OpCodes.Ldloc, 7)
Typ = GetType(System.Int32)
Dim fa188 As System.Reflection.Emit.Label = checkAssignIL.DefineLabel()
Dim tru188 As System.Reflection.Emit.Label = checkAssignIL.DefineLabel()
Dim cont188 As System.Reflection.Emit.Label = checkAssignIL.DefineLabel()
checkAssignIL.Emit(OpCodes.Beq, tru188)
checkAssignIL.Emit(OpCodes.Br, fa188)
checkAssignIL.MarkLabel(tru188)
...
checkAssignIL.Emit(OpCodes.Br, cont188)
checkAssignIL.MarkLabel(fa188)
...
checkAssignIL.Emit(OpCodes.Br, cont188)
checkAssignIL.MarkLabel(cont188)
...
checkAssignIL.Emit(OpCodes.Ldloc, 7)
Typ = GetType(System.Int32)
Dim fa189 As System.Reflection.Emit.Label = checkAssignIL.DefineLabel()
Dim tru189 As System.Reflection.Emit.Label = checkAssignIL.DefineLabel()
Dim cont189 As System.Reflection.Emit.Label = checkAssignIL.DefineLabel()
checkAssignIL.Emit(OpCodes.Beq, tru189)
checkAssignIL.Emit(OpCodes.Br, fa189)
checkAssignIL.MarkLabel(tru189)
...
checkAssignIL.Emit(OpCodes.Br, cont189)
checkAssignIL.MarkLabel(fa189)
...
checkAssignIL.Emit(OpCodes.Br, cont189)
checkAssignIL.MarkLabel(cont189)
...
Dim locbldr278 As LocalBuilder = checkAssignIL.DeclareLocal(asm.GetType("dylan.NET.Tokenizer.Parser.ExprOptimizer"))
locbldr278.SetLocalSymInfo("eop")
...
checkAssignIL.Emit(OpCodes.Br, cont187)
checkAssignIL.MarkLabel(fa187)
...
checkAssignIL.Emit(OpCodes.Br, cont187)
checkAssignIL.MarkLabel(cont187)
...
Dim locbldr279 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(System.Int32))
locbldr279.SetLocalSymInfo("i")
OptimizeIL.Emit(OpCodes.Ldc_I4, CInt(-1))
Typ = GetType(System.Int32)
OptimizeIL.Emit(OpCodes.Stloc, 0)
OptimizeIL.MarkSequencePoint(doc5, 749, 1, 749, 100)
Dim locbldr280 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(System.Int32))
...
Dim locbldr281 As LocalBuilder = OptimizeIL.DeclareLocal(asm.GetType("dylan.NET.Tokenizer.Parser.TokenOptimizer"))
locbldr281.SetLocalSymInfo("to")
OptimizeIL.Emit(OpCodes.Ldnull)
OptimizeIL.Emit(OpCodes.Stloc, 2)
OptimizeIL.MarkSequencePoint(doc5, 751, 1, 751, 100)
Dim locbldr282 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(Stmt))
locbldr282.SetLocalSymInfo("tmpstm")
OptimizeIL.Emit(OpCodes.Ldnull)
OptimizeIL.Emit(OpCodes.Stloc, 3)
OptimizeIL.MarkSequencePoint(doc5, 752, 1, 752, 100)
Dim locbldr283 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(System.Boolean))
locbldr283.SetLocalSymInfo("compb")
OptimizeIL.Emit(OpCodes.Ldc_I4, 0)
Typ = GetType(System.Boolean)
OptimizeIL.Emit(OpCodes.Stloc, 4)
...
OptimizeIL.Emit(OpCodes.Blt, tru190)
...
OptimizeIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa198 As System.Reflection.Emit.Label = OptimizeIL.DefineLabel()
Dim tru198 As System.Reflection.Emit.Label = OptimizeIL.DefineLabel()
Dim cont198 As System.Reflection.Emit.Label = OptimizeIL.DefineLabel()
OptimizeIL.Emit(OpCodes.Beq, tru198)
OptimizeIL.Emit(OpCodes.Br, fa198)
OptimizeIL.MarkLabel(tru198)
...
OptimizeIL.Emit(OpCodes.Br, cont198)
OptimizeIL.MarkLabel(fa198)
OptimizeIL.Emit(OpCodes.Br, cont198)
OptimizeIL.MarkLabel(cont198)
...
OptimizeIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa199 As System.Reflection.Emit.Label = OptimizeIL.DefineLabel()
Dim tru199 As System.Reflection.Emit.Label = OptimizeIL.DefineLabel()
Dim cont199 As System.Reflection.Emit.Label = OptimizeIL.DefineLabel()
OptimizeIL.Emit(OpCodes.Beq, tru199)
OptimizeIL.Emit(OpCodes.Br, fa199)
OptimizeIL.MarkLabel(tru199)
...
OptimizeIL.Emit(OpCodes.Br, cont199)
OptimizeIL.MarkLabel(fa199)
OptimizeIL.Emit(OpCodes.Br, cont199)
OptimizeIL.MarkLabel(cont199)
...
OptimizeIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa200 As System.Reflection.Emit.Label = OptimizeIL.DefineLabel()
Dim tru200 As System.Reflection.Emit.Label = OptimizeIL.DefineLabel()
Dim cont200 As System.Reflection.Emit.Label = OptimizeIL.DefineLabel()
OptimizeIL.Emit(OpCodes.Beq, tru200)
OptimizeIL.Emit(OpCodes.Br, fa200)
OptimizeIL.MarkLabel(tru200)
...
OptimizeIL.Emit(OpCodes.Br, cont200)
OptimizeIL.MarkLabel(fa200)
OptimizeIL.Emit(OpCodes.Br, cont200)
OptimizeIL.MarkLabel(cont200)
...
OptimizeIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa201 As System.Reflection.Emit.Label = OptimizeIL.DefineLabel()
Dim tru201 As System.Reflection.Emit.Label = OptimizeIL.DefineLabel()
Dim cont201 As System.Reflection.Emit.Label = OptimizeIL.DefineLabel()
OptimizeIL.Emit(OpCodes.Beq, tru201)
OptimizeIL.Emit(OpCodes.Br, fa201)
OptimizeIL.MarkLabel(tru201)
...
OptimizeIL.Emit(OpCodes.Br, cont201)
OptimizeIL.MarkLabel(fa201)
OptimizeIL.Emit(OpCodes.Br, cont201)
OptimizeIL.MarkLabel(cont201)
...
OptimizeIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa202 As System.Reflection.Emit.Label = OptimizeIL.DefineLabel()
Dim tru202 As System.Reflection.Emit.Label = OptimizeIL.DefineLabel()
Dim cont202 As System.Reflection.Emit.Label = OptimizeIL.DefineLabel()
OptimizeIL.Emit(OpCodes.Beq, tru202)
OptimizeIL.Emit(OpCodes.Br, fa202)
OptimizeIL.MarkLabel(tru202)
...
OptimizeIL.Emit(OpCodes.Br, cont202)
OptimizeIL.MarkLabel(fa202)
OptimizeIL.Emit(OpCodes.Br, cont202)
OptimizeIL.MarkLabel(cont202)
...
OptimizeIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa203 As System.Reflection.Emit.Label = OptimizeIL.DefineLabel()
Dim tru203 As System.Reflection.Emit.Label = OptimizeIL.DefineLabel()
Dim cont203 As System.Reflection.Emit.Label = OptimizeIL.DefineLabel()
OptimizeIL.Emit(OpCodes.Beq, tru203)
OptimizeIL.Emit(OpCodes.Br, fa203)
OptimizeIL.MarkLabel(tru203)
...
OptimizeIL.Emit(OpCodes.Br, cont203)
OptimizeIL.MarkLabel(fa203)
OptimizeIL.Emit(OpCodes.Br, cont203)
OptimizeIL.MarkLabel(cont203)
...
OptimizeIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa204 As System.Reflection.Emit.Label = OptimizeIL.DefineLabel()
Dim tru204 As System.Reflection.Emit.Label = OptimizeIL.DefineLabel()
Dim cont204 As System.Reflection.Emit.Label = OptimizeIL.DefineLabel()
OptimizeIL.Emit(OpCodes.Beq, tru204)
OptimizeIL.Emit(OpCodes.Br, fa204)
OptimizeIL.MarkLabel(tru204)
...
OptimizeIL.Emit(OpCodes.Br, cont204)
OptimizeIL.MarkLabel(fa204)
OptimizeIL.Emit(OpCodes.Br, cont204)
OptimizeIL.MarkLabel(cont204)
...
OptimizeIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa205 As System.Reflection.Emit.Label = OptimizeIL.DefineLabel()
Dim tru205 As System.Reflection.Emit.Label = OptimizeIL.DefineLabel()
Dim cont205 As System.Reflection.Emit.Label = OptimizeIL.DefineLabel()
OptimizeIL.Emit(OpCodes.Beq, tru205)
OptimizeIL.Emit(OpCodes.Br, fa205)
OptimizeIL.MarkLabel(tru205)
...
OptimizeIL.Emit(OpCodes.Br, cont205)
OptimizeIL.MarkLabel(fa205)
OptimizeIL.Emit(OpCodes.Br, cont205)
OptimizeIL.MarkLabel(cont205)
...
OptimizeIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa206 As System.Reflection.Emit.Label = OptimizeIL.DefineLabel()
Dim tru206 As System.Reflection.Emit.Label = OptimizeIL.DefineLabel()
Dim cont206 As System.Reflection.Emit.Label = OptimizeIL.DefineLabel()
OptimizeIL.Emit(OpCodes.Beq, tru206)
OptimizeIL.Emit(OpCodes.Br, fa206)
OptimizeIL.MarkLabel(tru206)
...
OptimizeIL.Emit(OpCodes.Br, cont206)
OptimizeIL.MarkLabel(fa206)
OptimizeIL.Emit(OpCodes.Br, cont206)
OptimizeIL.MarkLabel(cont206)
...
OptimizeIL.Emit(OpCodes.Beq, tru207)
...
Dim locbldr284 As LocalBuilder = ParseIL.DeclareLocal(GetType(System.Int32))
locbldr284.SetLocalSymInfo("i")
ParseIL.Emit(OpCodes.Ldc_I4, CInt(-1))
Typ = GetType(System.Int32)
ParseIL.Emit(OpCodes.Stloc, 0)
ParseIL.MarkSequencePoint(doc6, 5, 1, 5, 100)
Dim locbldr285 As LocalBuilder = ParseIL.DeclareLocal(asm.GetType("dylan.NET.Tokenizer.Parser.StmtOptimizer"))
locbldr285.SetLocalSymInfo("so")
ParseIL.Emit(OpCodes.Ldnull)
ParseIL.Emit(OpCodes.Stloc, 1)
ParseIL.MarkSequencePoint(doc6, 6, 1, 6, 100)
Dim locbldr286 As LocalBuilder = ParseIL.DeclareLocal(GetType(System.Int32))
locbldr286.SetLocalSymInfo("len")
...
ParseIL.Emit(OpCodes.Ldloc, 2)
Typ = GetType(System.Int32)
Dim fa210 As System.Reflection.Emit.Label = ParseIL.DefineLabel()
Dim tru210 As System.Reflection.Emit.Label = ParseIL.DefineLabel()
Dim cont210 As System.Reflection.Emit.Label = ParseIL.DefineLabel()
ParseIL.Emit(OpCodes.Beq, tru210)
ParseIL.Emit(OpCodes.Br, fa210)
ParseIL.MarkLabel(tru210)
ParseIL.MarkSequencePoint(doc6, 19, 1, 19, 100)
ParseIL.Emit(OpCodes.Br, label1)
ParseIL.MarkSequencePoint(doc6, 20, 1, 20, 100)
ParseIL.Emit(OpCodes.Br, cont210)
ParseIL.MarkLabel(fa210)
ParseIL.MarkSequencePoint(doc6, 21, 1, 21, 100)
ParseIL.Emit(OpCodes.Br, label0)
ParseIL.MarkSequencePoint(doc6, 22, 1, 22, 100)
ParseIL.Emit(OpCodes.Br, cont210)
ParseIL.MarkLabel(cont210)
