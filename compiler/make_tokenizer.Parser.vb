...
Dim locbldr32 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(LParen))
locbldr32.SetLocalSymInfo("lpar")
...
Dim locbldr33 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(RParen))
locbldr33.SetLocalSymInfo("rpar")
...
Dim locbldr34 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(LRSParen))
locbldr34.SetLocalSymInfo("lrspar")
...
Dim locbldr35 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(Ampersand))
locbldr35.SetLocalSymInfo("ampsig")
...
Dim locbldr36 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(LSParen))
locbldr36.SetLocalSymInfo("lspar")
...
Dim locbldr37 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(RSParen))
locbldr37.SetLocalSymInfo("rspar")
...
Dim locbldr38 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(Pipe))
locbldr38.SetLocalSymInfo("pip")
...
Dim locbldr39 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(Comma))
locbldr39.SetLocalSymInfo("com")
...
Dim locbldr40 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(DollarSign))
locbldr40.SetLocalSymInfo("ds")
...
Dim locbldr41 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(IfTok))
locbldr41.SetLocalSymInfo("iftk")
...
Dim locbldr42 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(ThenTok))
locbldr42.SetLocalSymInfo("thentk")
...
Dim locbldr43 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(RefasmTok))
locbldr43.SetLocalSymInfo("ratk")
...
Dim locbldr44 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(DebugTok))
locbldr44.SetLocalSymInfo("dgtk")
...
Dim locbldr45 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(ImportTok))
locbldr45.SetLocalSymInfo("imptk")
...
Dim locbldr46 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(LocimportTok))
locbldr46.SetLocalSymInfo("limptk")
...
Dim locbldr47 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(AssemblyTok))
locbldr47.SetLocalSymInfo("asmtk")
...
Dim locbldr48 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(VerTok))
locbldr48.SetLocalSymInfo("vertk")
...
Dim locbldr49 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(OnTok))
locbldr49.SetLocalSymInfo("ontk")
...
Dim locbldr50 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(OffTok))
locbldr50.SetLocalSymInfo("offtk")
...
Dim locbldr51 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(ExeTok))
locbldr51.SetLocalSymInfo("extk")
...
Dim locbldr52 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(DllTok))
locbldr52.SetLocalSymInfo("dltk")
...
Dim locbldr53 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(FieldTok))
locbldr53.SetLocalSymInfo("fltk")
...
Dim locbldr54 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(ClassTok))
locbldr54.SetLocalSymInfo("cltk")
...
Dim locbldr55 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(ExtendsTok))
locbldr55.SetLocalSymInfo("exttk")
...
Dim locbldr56 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(MethodTok))
locbldr56.SetLocalSymInfo("mettk")
...
Dim locbldr57 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(EndTok))
locbldr57.SetLocalSymInfo("entk")
...
Dim locbldr58 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(VarTok))
locbldr58.SetLocalSymInfo("vrtk")
...
Dim locbldr59 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(AsTok))
locbldr59.SetLocalSymInfo("astk")
...
Dim locbldr60 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(OfTok))
locbldr60.SetLocalSymInfo("oftk")
...
Dim locbldr61 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(PrivateAttr))
locbldr61.SetLocalSymInfo("privattr")
...
Dim locbldr62 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(PublicAttr))
locbldr62.SetLocalSymInfo("pubattr")
...
Dim locbldr63 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(InitOnlyAttr))
locbldr63.SetLocalSymInfo("initoattr")
...
Dim locbldr64 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(StaticAttr))
locbldr64.SetLocalSymInfo("statattr")
...
Dim locbldr65 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(AutoLayoutAttr))
locbldr65.SetLocalSymInfo("autattr")
...
Dim locbldr66 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(AutoClassAttr))
locbldr66.SetLocalSymInfo("autcattr")
...
Dim locbldr67 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(AnsiClassAttr))
locbldr67.SetLocalSymInfo("ansattr")
...
Dim locbldr68 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(BeforeFieldInitAttr))
locbldr68.SetLocalSymInfo("bfiattr")
...
Dim locbldr69 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(StringTok))
locbldr69.SetLocalSymInfo("strtok")
...
Dim locbldr70 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(VoidTok))
locbldr70.SetLocalSymInfo("voidtok")
...
Dim locbldr71 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(DecimalTok))
locbldr71.SetLocalSymInfo("decitok")
...
Dim locbldr72 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(IntegerTok))
locbldr72.SetLocalSymInfo("inttok")
...
Dim locbldr73 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(IntPtrTok))
locbldr73.SetLocalSymInfo("intptok")
...
Dim locbldr74 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(UIntegerTok))
locbldr74.SetLocalSymInfo("uinttok")
...
Dim locbldr75 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(DoubleTok))
locbldr75.SetLocalSymInfo("dbltok")
...
Dim locbldr76 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(BooleanTok))
locbldr76.SetLocalSymInfo("booltok")
...
Dim locbldr77 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(CharTok))
locbldr77.SetLocalSymInfo("chrtok")
...
Dim locbldr78 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(SingleTok))
locbldr78.SetLocalSymInfo("sngtok")
...
Dim locbldr79 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(SByteTok))
locbldr79.SetLocalSymInfo("sbytok")
...
Dim locbldr80 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(ByteTok))
locbldr80.SetLocalSymInfo("byttok")
...
Dim locbldr81 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(ShortTok))
locbldr81.SetLocalSymInfo("shtok")
...
Dim locbldr82 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(UShortTok))
locbldr82.SetLocalSymInfo("ushtok")
...
Dim locbldr83 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(LongTok))
locbldr83.SetLocalSymInfo("lngtok")
...
Dim locbldr84 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(ULongTok))
locbldr84.SetLocalSymInfo("ulngtok")
...
Dim locbldr85 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(ObjectTok))
locbldr85.SetLocalSymInfo("objtok")
...
Dim locbldr86 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(commentTok))
locbldr86.SetLocalSymInfo("comtok")
...
Dim locbldr87 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(BooleanLiteral))
locbldr87.SetLocalSymInfo("boolit")
...
Dim locbldr88 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(CharLiteral))
locbldr88.SetLocalSymInfo("chrlit")
...
OptimizeIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("Trim", typ105))
Typ = Typ03.GetMethod("Trim", typ105).ReturnType
OptimizeIL.Emit(OpCodes.Stloc, 2)
...
ReDim Preserve typ107(UBound(typ107) + 1)
typ107(UBound(typ107)) = Typ
OptimizeIL.Emit(OpCodes.Call, GetType(String).GetMethod("Concat", typ107))
Typ = GetType(String).GetMethod("Concat", typ107).ReturnType
OptimizeIL.Emit(OpCodes.Stloc, 2)
...
Dim locbldr89 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(StringLiteral))
locbldr89.SetLocalSymInfo("strlit")
...
OptimizeIL.Emit(OpCodes.Ldsfld, GetType(Utils.Constants).GetField("quot"))
Typ = GetType(Utils.Constants).GetField("quot").FieldType
Dim typ109 As Type() = {Typ}
OptimizeIL.Emit(OpCodes.Call, GetType(System.Convert).GetMethod("ToChar", typ109))
Typ = GetType(System.Convert).GetMethod("ToChar", typ109).ReturnType
OptimizeIL.Emit(OpCodes.Stelem, GetType(System.Char).MakeArrayType().GetElementType())
...
OptimizeIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("Trim", typ110))
Typ = Typ03.GetMethod("Trim", typ110).ReturnType
OptimizeIL.Emit(OpCodes.Stloc, 2)
...
OptimizeIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("EndsWith", typ114))
Typ = Typ03.GetMethod("EndsWith", typ114).ReturnType
OptimizeIL.Emit(OpCodes.Stloc, 1)
...
locbldr90.SetLocalSymInfo("dlit2")
...
OptimizeIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("TrimEnd", typ116))
Typ = Typ03.GetMethod("TrimEnd", typ116).ReturnType
OptimizeIL.Emit(OpCodes.Stloc, 2)
...
OptimizeIL.Emit(OpCodes.Call, GetType(System.Convert).GetMethod("ToDouble", typ117))
Typ = GetType(System.Convert).GetMethod("ToDouble", typ117).ReturnType
...
Dim locbldr91 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(FloatLiteral))
locbldr91.SetLocalSymInfo("flit")
...
OptimizeIL.Emit(OpCodes.Call, GetType(System.Convert).GetMethod("ToSingle", typ124))
Typ = GetType(System.Convert).GetMethod("ToSingle", typ124).ReturnType
...
locbldr92.SetLocalSymInfo("dlit")
OptimizeIL.Emit(OpCodes.Newobj, GetType(DoubleLiteral).GetConstructor(Type.EmptyTypes))
...
locbldr93.SetLocalSymInfo("dlit3")
OptimizeIL.Emit(OpCodes.Newobj, GetType(DoubleLiteral).GetConstructor(Type.EmptyTypes))
...
Dim locbldr94 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(FloatLiteral))
locbldr94.SetLocalSymInfo("flit2")
OptimizeIL.Emit(OpCodes.Newobj, GetType(FloatLiteral).GetConstructor(Type.EmptyTypes))
...
OptimizeIL.Emit(OpCodes.Call, GetType(System.Convert).GetMethod("ToSingle", typ142))
Typ = GetType(System.Convert).GetMethod("ToSingle", typ142).ReturnType
OptimizeIL.Emit(OpCodes.Stfld, GetType(FloatLiteral).GetField("NumVal"))
...
Dim locbldr95 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(UIntLiteral))
locbldr95.SetLocalSymInfo("uilit2")
...
OptimizeIL.Emit(OpCodes.Call, GetType(Convert).GetMethod("ToUInt32", typ151))
Typ = GetType(Convert).GetMethod("ToUInt32", typ151).ReturnType
...
OptimizeIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("EndsWith", typ155))
Typ = Typ03.GetMethod("EndsWith", typ155).ReturnType
OptimizeIL.Emit(OpCodes.Stloc, 1)
...
Dim locbldr96 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(IntPtrLiteral))
locbldr96.SetLocalSymInfo("iplit2")
...
Dim typ161 As Type() = {Typ}
OptimizeIL.Emit(OpCodes.Call, GetType(System.Convert).GetMethod("ToInt32", typ161))
Typ = GetType(System.Convert).GetMethod("ToInt32", typ161).ReturnType
ReDim Preserve typ160(UBound(typ160) + 1)
typ160(UBound(typ160)) = Typ
OptimizeIL.Emit(OpCodes.Newobj, GetType(IntPtr).GetConstructor(typ160))
...
Dim locbldr97 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(IntLiteral))
locbldr97.SetLocalSymInfo("ilit2")
...
Dim locbldr98 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(ULongLiteral))
locbldr98.SetLocalSymInfo("ullit")
...
OptimizeIL.Emit(OpCodes.Call, GetType(Convert).GetMethod("ToUInt64", typ177))
Typ = GetType(Convert).GetMethod("ToUInt64", typ177).ReturnType
...
OptimizeIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("EndsWith", typ181))
Typ = Typ03.GetMethod("EndsWith", typ181).ReturnType
OptimizeIL.Emit(OpCodes.Stloc, 1)
...
Dim locbldr99 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(LongLiteral))
locbldr99.SetLocalSymInfo("llit")
...
OptimizeIL.Emit(OpCodes.Call, GetType(System.Convert).GetMethod("ToInt64", typ184))
Typ = GetType(System.Convert).GetMethod("ToInt64", typ184).ReturnType
...
Dim locbldr100 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(UShortLiteral))
locbldr100.SetLocalSymInfo("uslit")
...
OptimizeIL.Emit(OpCodes.Call, GetType(Convert).GetMethod("ToUInt16", typ193))
Typ = GetType(Convert).GetMethod("ToUInt16", typ193).ReturnType
...
OptimizeIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("EndsWith", typ197))
Typ = Typ03.GetMethod("EndsWith", typ197).ReturnType
OptimizeIL.Emit(OpCodes.Stloc, 1)
...
Dim locbldr101 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(ShortLiteral))
locbldr101.SetLocalSymInfo("slit")
...
OptimizeIL.Emit(OpCodes.Call, GetType(System.Convert).GetMethod("ToInt16", typ200))
Typ = GetType(System.Convert).GetMethod("ToInt16", typ200).ReturnType
...
Dim locbldr102 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(ByteLiteral))
locbldr102.SetLocalSymInfo("ublit")
...
OptimizeIL.Emit(OpCodes.Call, GetType(Convert).GetMethod("ToByte", typ209))
Typ = GetType(Convert).GetMethod("ToByte", typ209).ReturnType
...
OptimizeIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("EndsWith", typ213))
Typ = Typ03.GetMethod("EndsWith", typ213).ReturnType
OptimizeIL.Emit(OpCodes.Stloc, 1)
...
Dim locbldr103 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(SByteLiteral))
locbldr103.SetLocalSymInfo("blit")
...
OptimizeIL.Emit(OpCodes.Call, GetType(System.Convert).GetMethod("ToSByte", typ216))
Typ = GetType(System.Convert).GetMethod("ToSByte", typ216).ReturnType
...
Dim locbldr104 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(IntLiteral))
locbldr104.SetLocalSymInfo("ilit")
OptimizeIL.Emit(OpCodes.Newobj, GetType(IntLiteral).GetConstructor(Type.EmptyTypes))
...
OptimizeIL.Emit(OpCodes.Ldfld, GetType(IntLiteral).GetField("Value"))
Typ = GetType(IntLiteral).GetField("Value").FieldType
Dim typ220 As Type() = {Typ}
OptimizeIL.Emit(OpCodes.Call, GetType(System.Convert).GetMethod("ToInt32", typ220))
Typ = GetType(System.Convert).GetMethod("ToInt32", typ220).ReturnType
OptimizeIL.Emit(OpCodes.Stfld, GetType(IntLiteral).GetField("NumVal"))
...
Dim locbldr105 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(Ident))
locbldr105.SetLocalSymInfo("idt")
...
Dim locbldr106 As LocalBuilder = checkVarAsIL.DeclareLocal(GetType(Token))
locbldr106.SetLocalSymInfo("tok")
...
Dim locbldr107 As LocalBuilder = checkVarAsIL.DeclareLocal(GetType(System.Type))
locbldr107.SetLocalSymInfo("typ")
...
Dim locbldr108 As LocalBuilder = checkVarAsIL.DeclareLocal(GetType(VarExpr))
locbldr108.SetLocalSymInfo("vars")
...
Typ = GetType(System.Boolean)
Dim fa105 As System.Reflection.Emit.Label = checkVarAsIL.DefineLabel()
Dim tru105 As System.Reflection.Emit.Label = checkVarAsIL.DefineLabel()
Dim cont105 As System.Reflection.Emit.Label = checkVarAsIL.DefineLabel()
checkVarAsIL.Emit(OpCodes.Beq, tru105)
checkVarAsIL.Emit(OpCodes.Br, fa105)
checkVarAsIL.MarkLabel(tru105)
...
Dim locbldr109 As LocalBuilder = checkVarAsIL.DeclareLocal(GetType(Token))
locbldr109.SetLocalSymInfo("tok2")
checkVarAsIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Expr)
checkVarAsIL.Emit(OpCodes.Ldfld, GetType(Expr).GetField("Tokens"))
Typ = GetType(Expr).GetField("Tokens").FieldType
...
Dim locbldr110 As LocalBuilder = checkVarAsIL.DeclareLocal(GetType(System.Type))
...
Dim locbldr111 As LocalBuilder = checkVarAsIL.DeclareLocal(GetType(System.Boolean))
locbldr111.SetLocalSymInfo("b2")
Dim typ4(-1) As Type
...
checkVarAsIL.Emit(OpCodes.Beq, fa106)
checkVarAsIL.Emit(OpCodes.Br, tru106)
...
Dim locbldr113 As LocalBuilder = checkVarAsIL.DeclareLocal(GetType(TypeTok))
locbldr113.SetLocalSymInfo("tt")
...
checkVarAsIL.Emit(OpCodes.Br, cont105)
checkVarAsIL.MarkLabel(fa105)
checkVarAsIL.Emit(OpCodes.Br, cont105)
checkVarAsIL.MarkLabel(cont105)
...
Dim locbldr114 As LocalBuilder = procMethodCallIL.DeclareLocal(GetType(MethodNameTok))
locbldr114.SetLocalSymInfo("mn")
...
Dim locbldr115 As LocalBuilder = procMethodCallIL.DeclareLocal(GetType(MethodCallTok))
locbldr115.SetLocalSymInfo("mct")
...
Dim locbldr116 As LocalBuilder = procMethodCallIL.DeclareLocal(GetType(Ident))
locbldr116.SetLocalSymInfo("idt")
...
Dim locbldr117 As LocalBuilder = procMethodCallIL.DeclareLocal(GetType(Expr))
locbldr117.SetLocalSymInfo("ep2")
...
locbldr118.SetLocalSymInfo("lvl")
...
Dim locbldr119 As LocalBuilder = procMethodCallIL.DeclareLocal(GetType(System.Boolean))
locbldr119.SetLocalSymInfo("d")
...
Dim locbldr121 As LocalBuilder = procMethodCallIL.DeclareLocal(GetType(Token))
...
Dim locbldr122 As LocalBuilder = procMethodCallIL.DeclareLocal(GetType(System.Type))
locbldr122.SetLocalSymInfo("typ2")
procMethodCallIL.MarkSequencePoint(doc4, 77, 1, 77, 100)
Dim locbldr123 As LocalBuilder = procMethodCallIL.DeclareLocal(GetType(System.Boolean))
...
procMethodCallIL.Emit(OpCodes.Beq, tru107)
procMethodCallIL.Emit(OpCodes.Br, fa107)
...
procMethodCallIL.Emit(OpCodes.Beq, fa109)
procMethodCallIL.Emit(OpCodes.Br, tru109)
...
procMethodCallIL.Emit(OpCodes.Beq, fa113)
procMethodCallIL.Emit(OpCodes.Br, tru113)
...
Dim locbldr125 As LocalBuilder = procIdentArrayAccessIL.DeclareLocal(GetType(Ident))
...
Dim locbldr126 As LocalBuilder = procIdentArrayAccessIL.DeclareLocal(GetType(Expr))
...
Dim locbldr128 As LocalBuilder = procIdentArrayAccessIL.DeclareLocal(GetType(System.Boolean))
...
Dim locbldr130 As LocalBuilder = procIdentArrayAccessIL.DeclareLocal(GetType(Token))
...
Dim locbldr131 As LocalBuilder = procIdentArrayAccessIL.DeclareLocal(GetType(System.Type))
locbldr131.SetLocalSymInfo("typ2")
procIdentArrayAccessIL.MarkSequencePoint(doc4, 189, 1, 189, 100)
Dim locbldr132 As LocalBuilder = procIdentArrayAccessIL.DeclareLocal(GetType(System.Boolean))
locbldr132.SetLocalSymInfo("b2")
procIdentArrayAccessIL.MarkSequencePoint(doc4, 190, 1, 190, 100)
Dim locbldr133 As LocalBuilder = procIdentArrayAccessIL.DeclareLocal(GetType(System.Int32))
...
Dim locbldr134 As LocalBuilder = procMtdArrayAccessIL.DeclareLocal(GetType(MethodCallTok))
locbldr134.SetLocalSymInfo("mtd")
...
Dim locbldr135 As LocalBuilder = procMtdArrayAccessIL.DeclareLocal(GetType(MethodNameTok))
locbldr135.SetLocalSymInfo("idt")
procMtdArrayAccessIL.Emit(OpCodes.Ldnull)
procMtdArrayAccessIL.Emit(OpCodes.Stloc, 1)
procMtdArrayAccessIL.MarkSequencePoint(doc4, 271, 1, 271, 100)
Dim locbldr136 As LocalBuilder = procMtdArrayAccessIL.DeclareLocal(GetType(Expr))
...
Dim locbldr138 As LocalBuilder = procMtdArrayAccessIL.DeclareLocal(GetType(System.Boolean))
...
Dim locbldr140 As LocalBuilder = procMtdArrayAccessIL.DeclareLocal(GetType(Token))
...
Dim locbldr141 As LocalBuilder = procMtdArrayAccessIL.DeclareLocal(GetType(System.Type))
locbldr141.SetLocalSymInfo("typ2")
procMtdArrayAccessIL.MarkSequencePoint(doc4, 284, 1, 284, 100)
Dim locbldr142 As LocalBuilder = procMtdArrayAccessIL.DeclareLocal(GetType(System.Boolean))
locbldr142.SetLocalSymInfo("b2")
procMtdArrayAccessIL.MarkSequencePoint(doc4, 285, 1, 285, 100)
Dim locbldr143 As LocalBuilder = procMtdArrayAccessIL.DeclareLocal(GetType(System.Int32))
...
locbldr147.SetLocalSymInfo("identtrnoff")
OptimizeIL.Emit(OpCodes.Ldc_I4, 0)
Typ = GetType(System.Boolean)
OptimizeIL.Emit(OpCodes.Stloc, 3)
...
locbldr148.SetLocalSymInfo("mcbool")
OptimizeIL.Emit(OpCodes.Ldc_I4, 0)
Typ = GetType(System.Boolean)
OptimizeIL.Emit(OpCodes.Stloc, 4)
...
locbldr149.SetLocalSymInfo("mcflgc")
OptimizeIL.Emit(OpCodes.Ldc_I4, 0)
Typ = GetType(System.Boolean)
OptimizeIL.Emit(OpCodes.Stloc, 5)
...
locbldr150.SetLocalSymInfo("iflgc")
OptimizeIL.Emit(OpCodes.Ldc_I4, 0)
Typ = GetType(System.Boolean)
OptimizeIL.Emit(OpCodes.Stloc, 6)
...
locbldr151.SetLocalSymInfo("sflgc")
OptimizeIL.Emit(OpCodes.Ldc_I4, 0)
Typ = GetType(System.Boolean)
OptimizeIL.Emit(OpCodes.Stloc, 7)
OptimizeIL.MarkSequencePoint(doc4, 373, 1, 373, 100)
Dim locbldr152 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(Token))
locbldr152.SetLocalSymInfo("mctok")
...
locbldr153.SetLocalSymInfo("mctok2")
OptimizeIL.Emit(OpCodes.Ldnull)
OptimizeIL.Emit(OpCodes.Stloc, 9)
OptimizeIL.MarkSequencePoint(doc4, 375, 1, 375, 100)
Dim locbldr154 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(Ident))
locbldr154.SetLocalSymInfo("mcident")
OptimizeIL.Emit(OpCodes.Ldnull)
OptimizeIL.Emit(OpCodes.Stloc, 10)
OptimizeIL.MarkSequencePoint(doc4, 376, 1, 376, 100)
Dim locbldr155 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(MethodCallTok))
locbldr155.SetLocalSymInfo("mcmetcall")
OptimizeIL.Emit(OpCodes.Ldnull)
OptimizeIL.Emit(OpCodes.Stloc, 11)
OptimizeIL.MarkSequencePoint(doc4, 377, 1, 377, 100)
Dim locbldr156 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(MethodNameTok))
locbldr156.SetLocalSymInfo("mcmetname")
OptimizeIL.Emit(OpCodes.Ldnull)
OptimizeIL.Emit(OpCodes.Stloc, 12)
OptimizeIL.MarkSequencePoint(doc4, 378, 1, 378, 100)
Dim locbldr157 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(StringLiteral))
locbldr157.SetLocalSymInfo("mcstr")
OptimizeIL.Emit(OpCodes.Ldnull)
OptimizeIL.Emit(OpCodes.Stloc, 13)
OptimizeIL.MarkSequencePoint(doc4, 379, 1, 379, 100)
Dim locbldr158 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(System.Int32))
locbldr158.SetLocalSymInfo("mcint")
OptimizeIL.Emit(OpCodes.Ldc_I4, CInt(0))
Typ = GetType(System.Int32)
OptimizeIL.Emit(OpCodes.Stloc, 14)
...
OptimizeIL.Emit(OpCodes.Blt, tru128)
...
OptimizeIL.Emit(OpCodes.Beq, tru129)
...
Dim locbldr159 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(Token))
locbldr159.SetLocalSymInfo("tok")
OptimizeIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Expr)
OptimizeIL.Emit(OpCodes.Ldfld, GetType(Expr).GetField("Tokens"))
Typ = GetType(Expr).GetField("Tokens").FieldType
...
Dim locbldr160 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(System.Type))
locbldr160.SetLocalSymInfo("typ")
OptimizeIL.MarkSequencePoint(doc4, 400, 1, 400, 100)
Dim locbldr161 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(System.Boolean))
locbldr161.SetLocalSymInfo("b")
OptimizeIL.MarkSequencePoint(doc4, 401, 1, 401, 100)
Dim locbldr162 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(System.String))
locbldr162.SetLocalSymInfo("str")
...
locbldr164.SetLocalSymInfo("ttk")
...
locbldr165.SetLocalSymInfo("tk2")
OptimizeIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Expr)
OptimizeIL.Emit(OpCodes.Ldfld, GetType(Expr).GetField("Tokens"))
Typ = GetType(Expr).GetField("Tokens").FieldType
...
locbldr166.SetLocalSymInfo("ttk2")
OptimizeIL.Emit(OpCodes.Newobj, GetType(TypeTok).GetConstructor(Type.EmptyTypes))
OptimizeIL.Emit(OpCodes.Stloc, 22)
...
locbldr167.SetLocalSymInfo("tt1")
OptimizeIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Expr)
OptimizeIL.Emit(OpCodes.Ldfld, GetType(Expr).GetField("Tokens"))
Typ = GetType(Expr).GetField("Tokens").FieldType
...
Dim locbldr168 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(Ident))
locbldr168.SetLocalSymInfo("id1")
OptimizeIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Expr)
OptimizeIL.Emit(OpCodes.Ldfld, GetType(Expr).GetField("Tokens"))
Typ = GetType(Expr).GetField("Tokens").FieldType
...
Dim locbldr169 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(CharLiteral))
locbldr169.SetLocalSymInfo("cl1")
OptimizeIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Expr)
OptimizeIL.Emit(OpCodes.Ldfld, GetType(Expr).GetField("Tokens"))
Typ = GetType(Expr).GetField("Tokens").FieldType
...
Dim locbldr170 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(StringLiteral))
locbldr170.SetLocalSymInfo("sl1")
OptimizeIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Expr)
OptimizeIL.Emit(OpCodes.Ldfld, GetType(Expr).GetField("Tokens"))
Typ = GetType(Expr).GetField("Tokens").FieldType
...
Dim locbldr171 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(BooleanLiteral))
locbldr171.SetLocalSymInfo("bl1")
OptimizeIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Expr)
OptimizeIL.Emit(OpCodes.Ldfld, GetType(Expr).GetField("Tokens"))
Typ = GetType(Expr).GetField("Tokens").FieldType
...
Dim locbldr172 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(NumberLiteral))
locbldr172.SetLocalSymInfo("nl1")
OptimizeIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Expr)
OptimizeIL.Emit(OpCodes.Ldfld, GetType(Expr).GetField("Tokens"))
Typ = GetType(Expr).GetField("Tokens").FieldType
...
Dim locbldr173 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(MethodCallTok))
locbldr173.SetLocalSymInfo("mct")
OptimizeIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Expr)
OptimizeIL.Emit(OpCodes.Ldfld, GetType(Expr).GetField("Tokens"))
Typ = GetType(Expr).GetField("Tokens").FieldType
...
Dim locbldr174 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(Expr).MakeArrayType())
locbldr174.SetLocalSymInfo("prs")
OptimizeIL.Emit(OpCodes.Ldloc, 29)
Typ = GetType(MethodCallTok)
...
Dim locbldr175 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(System.Int32))
locbldr175.SetLocalSymInfo("ln2")
OptimizeIL.Emit(OpCodes.Ldloc, 30)
...
OptimizeIL.Emit(OpCodes.Blt, tru153)
...
locbldr177.SetLocalSymInfo("aidt")
OptimizeIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Expr)
OptimizeIL.Emit(OpCodes.Ldfld, GetType(Expr).GetField("Tokens"))
Typ = GetType(Expr).GetField("Tokens").FieldType
...
Dim locbldr178 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(Expr))
locbldr178.SetLocalSymInfo("arriloc")
OptimizeIL.Emit(OpCodes.Ldloc, 33)
Typ = GetType(Ident)
...
locbldr179.SetLocalSymInfo("amtd")
OptimizeIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Expr)
OptimizeIL.Emit(OpCodes.Ldfld, GetType(Expr).GetField("Tokens"))
Typ = GetType(Expr).GetField("Tokens").FieldType
...
locbldr180.SetLocalSymInfo("amtdn")
OptimizeIL.Emit(OpCodes.Ldloc, 35)
Typ = GetType(MethodCallTok)
...
OptimizeIL.Emit(OpCodes.Bgt, tru158)
...
OptimizeIL.Emit(OpCodes.Bge, tru159)
...
OptimizeIL.Emit(OpCodes.Ble, tru168)
...
Dim locbldr181 As LocalBuilder = checkRefasmIL.DeclareLocal(GetType(Token))
...
Dim locbldr182 As LocalBuilder = checkRefasmIL.DeclareLocal(GetType(System.Type))
...
Dim locbldr183 As LocalBuilder = checkRefasmIL.DeclareLocal(GetType(RefasmStmt))
locbldr183.SetLocalSymInfo("refasms")
...
Typ = GetType(System.Boolean)
Dim fa171 As System.Reflection.Emit.Label = checkRefasmIL.DefineLabel()
Dim tru171 As System.Reflection.Emit.Label = checkRefasmIL.DefineLabel()
Dim cont171 As System.Reflection.Emit.Label = checkRefasmIL.DefineLabel()
checkRefasmIL.Emit(OpCodes.Beq, tru171)
checkRefasmIL.Emit(OpCodes.Br, fa171)
checkRefasmIL.MarkLabel(tru171)
...
checkRefasmIL.Emit(OpCodes.Br, cont171)
checkRefasmIL.MarkLabel(fa171)
checkRefasmIL.Emit(OpCodes.Br, cont171)
checkRefasmIL.MarkLabel(cont171)
...
Dim locbldr184 As LocalBuilder = checkDebugIL.DeclareLocal(GetType(Token))
...
Dim locbldr185 As LocalBuilder = checkDebugIL.DeclareLocal(GetType(System.Type))
...
Dim locbldr186 As LocalBuilder = checkDebugIL.DeclareLocal(GetType(DebugStmt))
locbldr186.SetLocalSymInfo("dbgs")
...
Typ = GetType(System.Boolean)
Dim fa172 As System.Reflection.Emit.Label = checkDebugIL.DefineLabel()
Dim tru172 As System.Reflection.Emit.Label = checkDebugIL.DefineLabel()
Dim cont172 As System.Reflection.Emit.Label = checkDebugIL.DefineLabel()
checkDebugIL.Emit(OpCodes.Beq, tru172)
checkDebugIL.Emit(OpCodes.Br, fa172)
checkDebugIL.MarkLabel(tru172)
...
checkDebugIL.Emit(OpCodes.Br, cont172)
checkDebugIL.MarkLabel(fa172)
checkDebugIL.Emit(OpCodes.Br, cont172)
checkDebugIL.MarkLabel(cont172)
...
Dim locbldr187 As LocalBuilder = checkImportIL.DeclareLocal(GetType(Token))
...
Dim locbldr188 As LocalBuilder = checkImportIL.DeclareLocal(GetType(System.Type))
...
Dim locbldr189 As LocalBuilder = checkImportIL.DeclareLocal(GetType(ImportStmt))
locbldr189.SetLocalSymInfo("imps")
...
Typ = GetType(System.Boolean)
Dim fa173 As System.Reflection.Emit.Label = checkImportIL.DefineLabel()
Dim tru173 As System.Reflection.Emit.Label = checkImportIL.DefineLabel()
Dim cont173 As System.Reflection.Emit.Label = checkImportIL.DefineLabel()
checkImportIL.Emit(OpCodes.Beq, tru173)
checkImportIL.Emit(OpCodes.Br, fa173)
checkImportIL.MarkLabel(tru173)
...
checkImportIL.Emit(OpCodes.Br, cont173)
checkImportIL.MarkLabel(fa173)
checkImportIL.Emit(OpCodes.Br, cont173)
checkImportIL.MarkLabel(cont173)
...
Dim locbldr190 As LocalBuilder = checkLocimportIL.DeclareLocal(GetType(Token))
...
Dim locbldr191 As LocalBuilder = checkLocimportIL.DeclareLocal(GetType(System.Type))
...
Dim locbldr192 As LocalBuilder = checkLocimportIL.DeclareLocal(GetType(LocimportStmt))
locbldr192.SetLocalSymInfo("limps")
...
Typ = GetType(System.Boolean)
Dim fa174 As System.Reflection.Emit.Label = checkLocimportIL.DefineLabel()
Dim tru174 As System.Reflection.Emit.Label = checkLocimportIL.DefineLabel()
Dim cont174 As System.Reflection.Emit.Label = checkLocimportIL.DefineLabel()
checkLocimportIL.Emit(OpCodes.Beq, tru174)
checkLocimportIL.Emit(OpCodes.Br, fa174)
checkLocimportIL.MarkLabel(tru174)
...
checkLocimportIL.Emit(OpCodes.Br, cont174)
checkLocimportIL.MarkLabel(fa174)
checkLocimportIL.Emit(OpCodes.Br, cont174)
checkLocimportIL.MarkLabel(cont174)
...
Dim locbldr193 As LocalBuilder = checkCmtIL.DeclareLocal(GetType(Token))
...
Dim locbldr194 As LocalBuilder = checkCmtIL.DeclareLocal(GetType(System.Type))
...
Dim locbldr195 As LocalBuilder = checkCmtIL.DeclareLocal(GetType(CommentStmt))
locbldr195.SetLocalSymInfo("cmts")
...
Typ = GetType(System.Boolean)
Dim fa175 As System.Reflection.Emit.Label = checkCmtIL.DefineLabel()
Dim tru175 As System.Reflection.Emit.Label = checkCmtIL.DefineLabel()
Dim cont175 As System.Reflection.Emit.Label = checkCmtIL.DefineLabel()
checkCmtIL.Emit(OpCodes.Beq, tru175)
checkCmtIL.Emit(OpCodes.Br, fa175)
checkCmtIL.MarkLabel(tru175)
...
checkCmtIL.Emit(OpCodes.Br, cont175)
checkCmtIL.MarkLabel(fa175)
checkCmtIL.Emit(OpCodes.Br, cont175)
checkCmtIL.MarkLabel(cont175)
...
Typ = GetType(System.Int32)
Dim fa176 As System.Reflection.Emit.Label = checkEndMtdIL.DefineLabel()
Dim tru176 As System.Reflection.Emit.Label = checkEndMtdIL.DefineLabel()
Dim cont176 As System.Reflection.Emit.Label = checkEndMtdIL.DefineLabel()
checkEndMtdIL.Emit(OpCodes.Bge, tru176)
checkEndMtdIL.Emit(OpCodes.Br, fa176)
checkEndMtdIL.MarkLabel(tru176)
checkEndMtdIL.MarkSequencePoint(doc5, 80, 1, 80, 100)
Dim locbldr196 As LocalBuilder = checkEndMtdIL.DeclareLocal(GetType(Token))
locbldr196.SetLocalSymInfo("tok1")
checkEndMtdIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
checkEndMtdIL.Emit(OpCodes.Ldfld, GetType(Stmt).GetField("Tokens"))
Typ = GetType(Stmt).GetField("Tokens").FieldType
...
Dim locbldr197 As LocalBuilder = checkEndMtdIL.DeclareLocal(GetType(System.Type))
locbldr197.SetLocalSymInfo("typ1")
...
Dim locbldr198 As LocalBuilder = checkEndMtdIL.DeclareLocal(GetType(System.Boolean))
locbldr198.SetLocalSymInfo("b1")
Dim typ18(-1) As Type
...
locbldr199.SetLocalSymInfo("tok2")
checkEndMtdIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
checkEndMtdIL.Emit(OpCodes.Ldfld, GetType(Stmt).GetField("Tokens"))
Typ = GetType(Stmt).GetField("Tokens").FieldType
...
locbldr200.SetLocalSymInfo("typ2")
...
Dim locbldr202 As LocalBuilder = checkEndMtdIL.DeclareLocal(GetType(EndMethodStmt))
locbldr202.SetLocalSymInfo("ems")
...
checkEndMtdIL.Emit(OpCodes.Beq, tru177)
...
checkEndMtdIL.Emit(OpCodes.Br, cont176)
checkEndMtdIL.MarkLabel(fa176)
checkEndMtdIL.Emit(OpCodes.Br, cont176)
checkEndMtdIL.MarkLabel(cont176)
...
Typ = GetType(System.Int32)
Dim fa178 As System.Reflection.Emit.Label = checkEndClsIL.DefineLabel()
Dim tru178 As System.Reflection.Emit.Label = checkEndClsIL.DefineLabel()
Dim cont178 As System.Reflection.Emit.Label = checkEndClsIL.DefineLabel()
checkEndClsIL.Emit(OpCodes.Bge, tru178)
checkEndClsIL.Emit(OpCodes.Br, fa178)
checkEndClsIL.MarkLabel(tru178)
checkEndClsIL.MarkSequencePoint(doc5, 102, 1, 102, 100)
Dim locbldr203 As LocalBuilder = checkEndClsIL.DeclareLocal(GetType(Token))
locbldr203.SetLocalSymInfo("tok1")
checkEndClsIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
checkEndClsIL.Emit(OpCodes.Ldfld, GetType(Stmt).GetField("Tokens"))
Typ = GetType(Stmt).GetField("Tokens").FieldType
...
Dim locbldr204 As LocalBuilder = checkEndClsIL.DeclareLocal(GetType(System.Type))
locbldr204.SetLocalSymInfo("typ1")
...
Dim locbldr205 As LocalBuilder = checkEndClsIL.DeclareLocal(GetType(System.Boolean))
locbldr205.SetLocalSymInfo("b1")
Dim typ23(-1) As Type
...
locbldr206.SetLocalSymInfo("tok2")
checkEndClsIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
checkEndClsIL.Emit(OpCodes.Ldfld, GetType(Stmt).GetField("Tokens"))
Typ = GetType(Stmt).GetField("Tokens").FieldType
...
locbldr207.SetLocalSymInfo("typ2")
...
Dim locbldr209 As LocalBuilder = checkEndClsIL.DeclareLocal(GetType(EndClassStmt))
locbldr209.SetLocalSymInfo("ecs")
...
checkEndClsIL.Emit(OpCodes.Beq, tru179)
...
checkEndClsIL.Emit(OpCodes.Br, cont178)
checkEndClsIL.MarkLabel(fa178)
checkEndClsIL.Emit(OpCodes.Br, cont178)
checkEndClsIL.MarkLabel(cont178)
...
Dim locbldr210 As LocalBuilder = checkAssemblyIL.DeclareLocal(GetType(Token))
...
Dim locbldr211 As LocalBuilder = checkAssemblyIL.DeclareLocal(GetType(System.Type))
...
Dim locbldr212 As LocalBuilder = checkAssemblyIL.DeclareLocal(GetType(AssemblyStmt))
locbldr212.SetLocalSymInfo("asms")
...
Typ = GetType(System.Boolean)
Dim fa180 As System.Reflection.Emit.Label = checkAssemblyIL.DefineLabel()
Dim tru180 As System.Reflection.Emit.Label = checkAssemblyIL.DefineLabel()
Dim cont180 As System.Reflection.Emit.Label = checkAssemblyIL.DefineLabel()
checkAssemblyIL.Emit(OpCodes.Beq, tru180)
checkAssemblyIL.Emit(OpCodes.Br, fa180)
checkAssemblyIL.MarkLabel(tru180)
...
checkAssemblyIL.Emit(OpCodes.Br, cont180)
checkAssemblyIL.MarkLabel(fa180)
checkAssemblyIL.Emit(OpCodes.Br, cont180)
checkAssemblyIL.MarkLabel(cont180)
...
Dim locbldr213 As LocalBuilder = checkVerIL.DeclareLocal(GetType(Token))
...
Dim locbldr214 As LocalBuilder = checkVerIL.DeclareLocal(GetType(System.Type))
...
Dim locbldr215 As LocalBuilder = checkVerIL.DeclareLocal(GetType(VerStmt))
locbldr215.SetLocalSymInfo("vers")
...
Typ = GetType(System.Boolean)
Dim fa181 As System.Reflection.Emit.Label = checkVerIL.DefineLabel()
Dim tru181 As System.Reflection.Emit.Label = checkVerIL.DefineLabel()
Dim cont181 As System.Reflection.Emit.Label = checkVerIL.DefineLabel()
checkVerIL.Emit(OpCodes.Beq, tru181)
checkVerIL.Emit(OpCodes.Br, fa181)
checkVerIL.MarkLabel(tru181)
...
Dim locbldr216 As LocalBuilder = checkVerIL.DeclareLocal(GetType(System.String).MakeArrayType())
locbldr216.SetLocalSymInfo("ars")
Dim typ32(-1) As Type
checkVerIL.Emit(OpCodes.Ldloc, 0)
Typ = GetType(Token)
...
Dim locbldr217 As LocalBuilder = checkVerIL.DeclareLocal(GetType(System.Int32).MakeArrayType())
locbldr217.SetLocalSymInfo("ari")
...
Dim locbldr218 As LocalBuilder = checkVerIL.DeclareLocal(GetType(IntLiteral).MakeArrayType())
locbldr218.SetLocalSymInfo("intla")
checkVerIL.Emit(OpCodes.Ldc_I4, CInt(4))
Typ = GetType(System.Int32)
checkVerIL.Emit(OpCodes.Conv_U)
...
Dim locbldr219 As LocalBuilder = checkVerIL.DeclareLocal(GetType(IntLiteral))
locbldr219.SetLocalSymInfo("intl")
...
checkVerIL.Emit(OpCodes.Br, cont181)
checkVerIL.MarkLabel(fa181)
checkVerIL.Emit(OpCodes.Br, cont181)
checkVerIL.MarkLabel(cont181)
...
Dim locbldr220 As LocalBuilder = checkClassIL.DeclareLocal(GetType(Token))
locbldr220.SetLocalSymInfo("tok")
...
Dim locbldr221 As LocalBuilder = checkClassIL.DeclareLocal(GetType(System.Type))
locbldr221.SetLocalSymInfo("typ")
...
Dim locbldr222 As LocalBuilder = checkClassIL.DeclareLocal(GetType(ClassStmt))
locbldr222.SetLocalSymInfo("clss")
...
Dim locbldr223 As LocalBuilder = checkClassIL.DeclareLocal(GetType(Attributes.Attribute))
locbldr223.SetLocalSymInfo("att")
...
Dim locbldr224 As LocalBuilder = checkClassIL.DeclareLocal(GetType(System.Int32))
locbldr224.SetLocalSymInfo("i")
checkClassIL.Emit(OpCodes.Ldc_I4, CInt(0))
Typ = GetType(System.Int32)
...
Dim locbldr226 As LocalBuilder = checkClassIL.DeclareLocal(GetType(System.Boolean))
locbldr226.SetLocalSymInfo("bl")
...
Dim locbldr227 As LocalBuilder = checkClassIL.DeclareLocal(GetType(Token))
locbldr227.SetLocalSymInfo("tok2")
checkClassIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
checkClassIL.Emit(OpCodes.Ldfld, GetType(Stmt).GetField("Tokens"))
Typ = GetType(Stmt).GetField("Tokens").FieldType
...
Dim locbldr228 As LocalBuilder = checkClassIL.DeclareLocal(GetType(System.Type))
locbldr228.SetLocalSymInfo("typ2")
...
checkClassIL.Emit(OpCodes.Beq, fa185)
checkClassIL.Emit(OpCodes.Br, tru185)
...
Dim locbldr231 As LocalBuilder = checkClassIL.DeclareLocal(GetType(TypeTok))
locbldr231.SetLocalSymInfo("tt")
...
Dim locbldr232 As LocalBuilder = checkFieldIL.DeclareLocal(GetType(Token))
...
Dim locbldr233 As LocalBuilder = checkFieldIL.DeclareLocal(GetType(System.Type))
...
Dim locbldr234 As LocalBuilder = checkFieldIL.DeclareLocal(GetType(FieldStmt))
locbldr234.SetLocalSymInfo("flss")
...
Dim locbldr235 As LocalBuilder = checkFieldIL.DeclareLocal(GetType(Attributes.Attribute))
locbldr235.SetLocalSymInfo("att")
...
Dim locbldr236 As LocalBuilder = checkFieldIL.DeclareLocal(GetType(Expr))
locbldr236.SetLocalSymInfo("tempexp")
...
Dim locbldr237 As LocalBuilder = checkFieldIL.DeclareLocal(asm.GetType("dylan.NET.Tokenizer.Parser.ExprOptimizer"))
locbldr237.SetLocalSymInfo("eop")
...
Dim locbldr238 As LocalBuilder = checkFieldIL.DeclareLocal(GetType(System.Int32))
...
locbldr239.SetLocalSymInfo("len")
checkFieldIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
checkFieldIL.Emit(OpCodes.Ldfld, GetType(Stmt).GetField("Tokens"))
Typ = GetType(Stmt).GetField("Tokens").FieldType
...
Dim locbldr240 As LocalBuilder = checkFieldIL.DeclareLocal(GetType(System.Boolean))
locbldr240.SetLocalSymInfo("bl")
checkFieldIL.Emit(OpCodes.Ldc_I4, 0)
Typ = GetType(System.Boolean)
...
Dim locbldr241 As LocalBuilder = checkFieldIL.DeclareLocal(GetType(Token))
locbldr241.SetLocalSymInfo("tok2")
checkFieldIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
checkFieldIL.Emit(OpCodes.Ldfld, GetType(Stmt).GetField("Tokens"))
Typ = GetType(Stmt).GetField("Tokens").FieldType
...
Dim locbldr242 As LocalBuilder = checkFieldIL.DeclareLocal(GetType(System.Type))
locbldr242.SetLocalSymInfo("typ2")
...
checkFieldIL.Emit(OpCodes.Beq, fa190)
checkFieldIL.Emit(OpCodes.Br, tru190)
...
Dim locbldr245 As LocalBuilder = checkFieldIL.DeclareLocal(GetType(TypeTok))
locbldr245.SetLocalSymInfo("tt")
...
Dim locbldr246 As LocalBuilder = checkMethodIL.DeclareLocal(GetType(Token))
locbldr246.SetLocalSymInfo("tok")
...
Dim locbldr247 As LocalBuilder = checkMethodIL.DeclareLocal(GetType(System.Type))
locbldr247.SetLocalSymInfo("typ")
...
Dim locbldr248 As LocalBuilder = checkMethodIL.DeclareLocal(GetType(MethodStmt))
locbldr248.SetLocalSymInfo("mtss")
...
Dim locbldr249 As LocalBuilder = checkMethodIL.DeclareLocal(GetType(Attributes.Attribute))
locbldr249.SetLocalSymInfo("att")
...
Dim locbldr250 As LocalBuilder = checkMethodIL.DeclareLocal(GetType(Ident))
locbldr250.SetLocalSymInfo("mn")
...
locbldr251.SetLocalSymInfo("exp")
checkMethodIL.Emit(OpCodes.Ldnull)
checkMethodIL.Emit(OpCodes.Stloc, 5)
checkMethodIL.MarkSequencePoint(doc5, 321, 1, 321, 100)
Dim locbldr252 As LocalBuilder = checkMethodIL.DeclareLocal(GetType(System.Boolean))
locbldr252.SetLocalSymInfo("d")
...
Dim locbldr253 As LocalBuilder = checkMethodIL.DeclareLocal(GetType(Expr))
locbldr253.SetLocalSymInfo("tempexp")
...
Dim locbldr254 As LocalBuilder = checkMethodIL.DeclareLocal(asm.GetType("dylan.NET.Tokenizer.Parser.ExprOptimizer"))
locbldr254.SetLocalSymInfo("eop")
...
Dim locbldr255 As LocalBuilder = checkMethodIL.DeclareLocal(GetType(System.Int32))
locbldr255.SetLocalSymInfo("i")
checkMethodIL.Emit(OpCodes.Ldc_I4, CInt(0))
Typ = GetType(System.Int32)
...
Dim locbldr257 As LocalBuilder = checkMethodIL.DeclareLocal(GetType(System.Boolean))
locbldr257.SetLocalSymInfo("bl")
checkMethodIL.Emit(OpCodes.Ldc_I4, 0)
Typ = GetType(System.Boolean)
...
Dim locbldr258 As LocalBuilder = checkMethodIL.DeclareLocal(GetType(Token))
...
Dim locbldr259 As LocalBuilder = checkMethodIL.DeclareLocal(GetType(System.Type))
...
checkMethodIL.Emit(OpCodes.Beq, fa194)
checkMethodIL.Emit(OpCodes.Br, tru194)
...
Dim locbldr262 As LocalBuilder = checkMethodIL.DeclareLocal(GetType(TypeTok))
locbldr262.SetLocalSymInfo("tt")
...
Dim locbldr263 As LocalBuilder = checkMethodIL.DeclareLocal(asm.GetType("dylan.NET.Tokenizer.Parser.ExprOptimizer"))
locbldr263.SetLocalSymInfo("eopt2")
checkMethodIL.Emit(OpCodes.Newobj, asm.GetType("dylan.NET.Tokenizer.Parser.ExprOptimizer").GetConstructor(Type.EmptyTypes))
...
locbldr264.SetLocalSymInfo("eopt1")
checkMethodIL.Emit(OpCodes.Newobj, asm.GetType("dylan.NET.Tokenizer.Parser.ExprOptimizer").GetConstructor(Type.EmptyTypes))
...
checkMethodCallIL.Emit(OpCodes.Bgt, tru205)
...
locbldr265.SetLocalSymInfo("tok")
checkMethodCallIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
checkMethodCallIL.Emit(OpCodes.Ldfld, GetType(Stmt).GetField("Tokens"))
Typ = GetType(Stmt).GetField("Tokens").FieldType
...
locbldr266.SetLocalSymInfo("typ")
...
Dim locbldr267 As LocalBuilder = checkMethodCallIL.DeclareLocal(GetType(Token))
locbldr267.SetLocalSymInfo("tokb")
checkMethodCallIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
checkMethodCallIL.Emit(OpCodes.Ldfld, GetType(Stmt).GetField("Tokens"))
Typ = GetType(Stmt).GetField("Tokens").FieldType
...
Dim locbldr268 As LocalBuilder = checkMethodCallIL.DeclareLocal(GetType(System.Type))
...
Dim locbldr269 As LocalBuilder = checkMethodCallIL.DeclareLocal(GetType(System.Boolean))
locbldr269.SetLocalSymInfo("ba")
Dim typ87(-1) As Type
...
Dim locbldr271 As LocalBuilder = checkMethodCallIL.DeclareLocal(GetType(MethodCallStmt))
locbldr271.SetLocalSymInfo("mtcss")
...
Dim locbldr272 As LocalBuilder = checkMethodCallIL.DeclareLocal(GetType(MethodNameTok))
locbldr272.SetLocalSymInfo("mn")
...
Dim locbldr273 As LocalBuilder = checkMethodCallIL.DeclareLocal(GetType(MethodCallTok))
locbldr273.SetLocalSymInfo("mct")
...
Dim locbldr274 As LocalBuilder = checkMethodCallIL.DeclareLocal(GetType(Ident))
locbldr274.SetLocalSymInfo("idt")
...
Dim locbldr275 As LocalBuilder = checkMethodCallIL.DeclareLocal(GetType(Expr))
locbldr275.SetLocalSymInfo("exp")
...
locbldr276.SetLocalSymInfo("lvl")
checkMethodCallIL.Emit(OpCodes.Ldc_I4, CInt(1))
Typ = GetType(System.Int32)
checkMethodCallIL.Emit(OpCodes.Stloc, 11)
checkMethodCallIL.MarkSequencePoint(doc5, 485, 1, 485, 100)
Dim locbldr277 As LocalBuilder = checkMethodCallIL.DeclareLocal(GetType(System.Boolean))
locbldr277.SetLocalSymInfo("d")
...
Dim locbldr278 As LocalBuilder = checkMethodCallIL.DeclareLocal(GetType(System.Int32))
locbldr278.SetLocalSymInfo("i")
checkMethodCallIL.Emit(OpCodes.Ldc_I4, CInt(1))
Typ = GetType(System.Int32)
...
Dim locbldr279 As LocalBuilder = checkMethodCallIL.DeclareLocal(GetType(Token))
locbldr279.SetLocalSymInfo("tok2")
checkMethodCallIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
checkMethodCallIL.Emit(OpCodes.Ldfld, GetType(Stmt).GetField("Tokens"))
Typ = GetType(Stmt).GetField("Tokens").FieldType
...
Dim locbldr280 As LocalBuilder = checkMethodCallIL.DeclareLocal(GetType(System.Type))
locbldr280.SetLocalSymInfo("typ2")
checkMethodCallIL.MarkSequencePoint(doc5, 499, 1, 499, 100)
Dim locbldr281 As LocalBuilder = checkMethodCallIL.DeclareLocal(GetType(System.Boolean))
locbldr281.SetLocalSymInfo("b2")
checkMethodCallIL.MarkSequencePoint(doc5, 500, 1, 500, 100)
Dim locbldr282 As LocalBuilder = checkMethodCallIL.DeclareLocal(GetType(System.Int32))
...
Dim locbldr283 As LocalBuilder = checkMethodCallIL.DeclareLocal(asm.GetType("dylan.NET.Tokenizer.Parser.ExprOptimizer"))
locbldr283.SetLocalSymInfo("eopt")
...
Dim locbldr284 As LocalBuilder = checkVarAsIL.DeclareLocal(GetType(Token))
locbldr284.SetLocalSymInfo("tok")
checkVarAsIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
...
Dim locbldr285 As LocalBuilder = checkVarAsIL.DeclareLocal(GetType(System.Type))
...
Dim locbldr286 As LocalBuilder = checkVarAsIL.DeclareLocal(GetType(VarStmt))
locbldr286.SetLocalSymInfo("vars")
...
checkVarAsIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa214 As System.Reflection.Emit.Label = checkVarAsIL.DefineLabel()
Dim tru214 As System.Reflection.Emit.Label = checkVarAsIL.DefineLabel()
Dim cont214 As System.Reflection.Emit.Label = checkVarAsIL.DefineLabel()
checkVarAsIL.Emit(OpCodes.Beq, tru214)
checkVarAsIL.Emit(OpCodes.Br, fa214)
checkVarAsIL.MarkLabel(tru214)
...
Dim locbldr287 As LocalBuilder = checkVarAsIL.DeclareLocal(GetType(Expr))
locbldr287.SetLocalSymInfo("tempexp")
...
Dim locbldr288 As LocalBuilder = checkVarAsIL.DeclareLocal(asm.GetType("dylan.NET.Tokenizer.Parser.ExprOptimizer"))
locbldr288.SetLocalSymInfo("eop")
...
Dim locbldr289 As LocalBuilder = checkVarAsIL.DeclareLocal(GetType(Token))
locbldr289.SetLocalSymInfo("tok2")
checkVarAsIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
checkVarAsIL.Emit(OpCodes.Ldfld, GetType(Stmt).GetField("Tokens"))
Typ = GetType(Stmt).GetField("Tokens").FieldType
...
Dim locbldr290 As LocalBuilder = checkVarAsIL.DeclareLocal(GetType(System.Type))
locbldr290.SetLocalSymInfo("typ2")
checkVarAsIL.Emit(OpCodes.Ldtoken, GetType(TypeTok))
...
Dim locbldr291 As LocalBuilder = checkVarAsIL.DeclareLocal(GetType(System.Boolean))
locbldr291.SetLocalSymInfo("b2")
Dim typ105(-1) As Type
checkVarAsIL.Emit(OpCodes.Ldloc, 6)
Typ = GetType(System.Type)
Typ03 = Typ
...
checkVarAsIL.Emit(OpCodes.Beq, fa215)
checkVarAsIL.Emit(OpCodes.Br, tru215)
...
Dim locbldr293 As LocalBuilder = checkVarAsIL.DeclareLocal(GetType(TypeTok))
locbldr293.SetLocalSymInfo("tt")
checkVarAsIL.Emit(OpCodes.Newobj, GetType(TypeTok).GetConstructor(Type.EmptyTypes))
...
checkVarAsIL.Emit(OpCodes.Br, cont214)
checkVarAsIL.MarkLabel(fa214)
checkVarAsIL.Emit(OpCodes.Br, cont214)
checkVarAsIL.MarkLabel(cont214)
...
Dim locbldr294 As LocalBuilder = AssOptIL.DeclareLocal(GetType(AssignStmt))
locbldr294.SetLocalSymInfo("asss")
AssOptIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
AssOptIL.Emit(OpCodes.Stloc, 0)
AssOptIL.MarkSequencePoint(doc5, 617, 1, 617, 100)
Dim locbldr295 As LocalBuilder = AssOptIL.DeclareLocal(GetType(Expr))
locbldr295.SetLocalSymInfo("le")
...
Dim locbldr296 As LocalBuilder = AssOptIL.DeclareLocal(GetType(Token))
locbldr296.SetLocalSymInfo("tok")
...
Dim locbldr297 As LocalBuilder = AssOptIL.DeclareLocal(GetType(System.Type))
locbldr297.SetLocalSymInfo("typ")
...
Dim locbldr298 As LocalBuilder = AssOptIL.DeclareLocal(GetType(System.Boolean))
locbldr298.SetLocalSymInfo("b")
Dim typ108(-1) As Type
...
Dim locbldr299 As LocalBuilder = AssOptIL.DeclareLocal(GetType(VarAsgnStmt))
locbldr299.SetLocalSymInfo("vass")
...
Typ = GetType(System.Boolean)
Dim fa216 As System.Reflection.Emit.Label = AssOptIL.DefineLabel()
Dim tru216 As System.Reflection.Emit.Label = AssOptIL.DefineLabel()
Dim cont216 As System.Reflection.Emit.Label = AssOptIL.DefineLabel()
AssOptIL.Emit(OpCodes.Beq, tru216)
AssOptIL.Emit(OpCodes.Br, fa216)
AssOptIL.MarkLabel(tru216)
...
Dim locbldr300 As LocalBuilder = AssOptIL.DeclareLocal(GetType(Token))
locbldr300.SetLocalSymInfo("tok2")
AssOptIL.Emit(OpCodes.Ldloc, 1)
Typ = GetType(Expr)
AssOptIL.Emit(OpCodes.Ldfld, GetType(Expr).GetField("Tokens"))
Typ = GetType(Expr).GetField("Tokens").FieldType
...
Dim locbldr301 As LocalBuilder = AssOptIL.DeclareLocal(GetType(System.Type))
locbldr301.SetLocalSymInfo("typ2")
...
Dim locbldr302 As LocalBuilder = AssOptIL.DeclareLocal(GetType(System.Boolean))
locbldr302.SetLocalSymInfo("b2")
Dim typ110(-1) As Type
...
AssOptIL.Emit(OpCodes.Beq, fa217)
AssOptIL.Emit(OpCodes.Br, tru217)
...
Dim locbldr304 As LocalBuilder = AssOptIL.DeclareLocal(GetType(TypeTok))
locbldr304.SetLocalSymInfo("tt")
...
Dim locbldr305 As LocalBuilder = AssOptIL.DeclareLocal(asm.GetType("dylan.NET.Tokenizer.Parser.ExprOptimizer"))
locbldr305.SetLocalSymInfo("eop")
...
Dim locbldr306 As LocalBuilder = checkAssignIL.DeclareLocal(GetType(Token))
locbldr306.SetLocalSymInfo("tok")
checkAssignIL.Emit(OpCodes.Ldnull)
checkAssignIL.Emit(OpCodes.Stloc, 0)
checkAssignIL.MarkSequencePoint(doc5, 654, 1, 654, 100)
Dim locbldr307 As LocalBuilder = checkAssignIL.DeclareLocal(GetType(System.Type))
locbldr307.SetLocalSymInfo("typ")
...
Dim locbldr308 As LocalBuilder = checkAssignIL.DeclareLocal(GetType(AssignStmt))
locbldr308.SetLocalSymInfo("asss")
...
Dim locbldr309 As LocalBuilder = checkAssignIL.DeclareLocal(GetType(System.Boolean))
locbldr309.SetLocalSymInfo("c")
checkAssignIL.Emit(OpCodes.Ldc_I4, 0)
Typ = GetType(System.Boolean)
checkAssignIL.Emit(OpCodes.Stloc, 3)
checkAssignIL.MarkSequencePoint(doc5, 657, 1, 657, 100)
Dim locbldr310 As LocalBuilder = checkAssignIL.DeclareLocal(GetType(Expr))
locbldr310.SetLocalSymInfo("re")
...
locbldr313.SetLocalSymInfo("len")
...
locbldr314.SetLocalSymInfo("assind")
...
checkAssignIL.Emit(OpCodes.Beq, tru218)
checkAssignIL.Emit(OpCodes.Br, fa218)
...
checkAssignIL.Emit(OpCodes.Beq, fa220)
checkAssignIL.Emit(OpCodes.Br, tru220)
...
checkAssignIL.Emit(OpCodes.Beq, tru221)
checkAssignIL.Emit(OpCodes.Br, fa221)
...
Dim locbldr315 As LocalBuilder = checkAssignIL.DeclareLocal(asm.GetType("dylan.NET.Tokenizer.Parser.ExprOptimizer"))
locbldr315.SetLocalSymInfo("eop")
...
Dim locbldr316 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(System.Int32))
locbldr316.SetLocalSymInfo("i")
OptimizeIL.Emit(OpCodes.Ldc_I4, CInt(-1))
Typ = GetType(System.Int32)
OptimizeIL.Emit(OpCodes.Stloc, 0)
...
locbldr317.SetLocalSymInfo("len")
OptimizeIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
...
Dim locbldr318 As LocalBuilder = OptimizeIL.DeclareLocal(asm.GetType("dylan.NET.Tokenizer.Parser.TokenOptimizer"))
locbldr318.SetLocalSymInfo("to")
OptimizeIL.Emit(OpCodes.Ldnull)
OptimizeIL.Emit(OpCodes.Stloc, 2)
OptimizeIL.MarkSequencePoint(doc5, 759, 1, 759, 100)
Dim locbldr319 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(Stmt))
locbldr319.SetLocalSymInfo("tmpstm")
OptimizeIL.Emit(OpCodes.Ldnull)
OptimizeIL.Emit(OpCodes.Stloc, 3)
OptimizeIL.MarkSequencePoint(doc5, 760, 1, 760, 100)
Dim locbldr320 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(System.Boolean))
locbldr320.SetLocalSymInfo("compb")
OptimizeIL.Emit(OpCodes.Ldc_I4, 0)
Typ = GetType(System.Boolean)
OptimizeIL.Emit(OpCodes.Stloc, 4)
...
OptimizeIL.Emit(OpCodes.Blt, tru223)
...
Dim locbldr322 As LocalBuilder = ParseIL.DeclareLocal(asm.GetType("dylan.NET.Tokenizer.Parser.StmtOptimizer"))
locbldr322.SetLocalSymInfo("so")
ParseIL.Emit(OpCodes.Ldnull)
ParseIL.Emit(OpCodes.Stloc, 1)
ParseIL.MarkSequencePoint(doc6, 14, 1, 14, 100)
Dim locbldr323 As LocalBuilder = ParseIL.DeclareLocal(GetType(System.Int32))
...
ParseIL.Emit(OpCodes.Ldloc, 2)
Typ = GetType(System.Int32)
Dim fa243 As System.Reflection.Emit.Label = ParseIL.DefineLabel()
Dim tru243 As System.Reflection.Emit.Label = ParseIL.DefineLabel()
Dim cont243 As System.Reflection.Emit.Label = ParseIL.DefineLabel()
ParseIL.Emit(OpCodes.Beq, tru243)
ParseIL.Emit(OpCodes.Br, fa243)
ParseIL.MarkLabel(tru243)
ParseIL.MarkSequencePoint(doc6, 27, 1, 27, 100)
ParseIL.Emit(OpCodes.Br, label1)
ParseIL.MarkSequencePoint(doc6, 28, 1, 28, 100)
ParseIL.Emit(OpCodes.Br, cont243)
ParseIL.MarkLabel(fa243)
ParseIL.MarkSequencePoint(doc6, 29, 1, 29, 100)
ParseIL.Emit(OpCodes.Br, label0)
ParseIL.MarkSequencePoint(doc6, 30, 1, 30, 100)
ParseIL.Emit(OpCodes.Br, cont243)
ParseIL.MarkLabel(cont243)
