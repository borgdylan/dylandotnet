...
Dim Optimize As MethodBuilder = StmtOptimizer.DefineMethod("Optimize", MethodAttributes.Public, GetType(Stmt), typ3)
Dim OptimizeIL As ILGenerator = Optimize.GetILGenerator()
Dim Optimizeparam00 As ParameterBuilder = Optimize.DefineParameter(0, ParameterAttributes.RetVal, "")
Dim Optimizeparam01 As ParameterBuilder = Optimize.DefineParameter(1, ParameterAttributes.None, "stm")
OptimizeIL.MarkSequencePoint(doc4, 16, 1, 16, 100)
Dim typ4(-1) As Type
OptimizeIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
...
ReDim Preserve typ4(UBound(typ4) + 1)
typ4(UBound(typ4)) = Typ
OptimizeIL.Emit(OpCodes.Call, GetType(Console).GetMethod("WriteLine", typ4))
...
Dim locbldr84 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(System.Int32))
locbldr84.SetLocalSymInfo("i")
OptimizeIL.Emit(OpCodes.Ldc_I4, CInt(-1))
Typ = GetType(System.Int32)
OptimizeIL.Emit(OpCodes.Stloc, 0)
OptimizeIL.MarkSequencePoint(doc4, 19, 1, 19, 100)
Dim locbldr85 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(System.Int32))
...
Typ = GetType(System.Int32)
OptimizeIL.Emit(OpCodes.Stloc, 1)
OptimizeIL.MarkSequencePoint(doc4, 20, 1, 20, 100)
Dim locbldr86 As LocalBuilder = OptimizeIL.DeclareLocal(asm.GetType("tokenizer.Parser.TokenOptimizer"))
locbldr86.SetLocalSymInfo("to")
OptimizeIL.Emit(OpCodes.Ldnull)
OptimizeIL.Emit(OpCodes.Stloc, 2)
OptimizeIL.MarkSequencePoint(doc4, 21, 1, 21, 100)
Dim locbldr87 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(Stmt))
locbldr87.SetLocalSymInfo("tmpstm")
OptimizeIL.Emit(OpCodes.Ldnull)
OptimizeIL.Emit(OpCodes.Stloc, 3)
OptimizeIL.MarkSequencePoint(doc4, 22, 1, 22, 100)
Dim locbldr88 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(System.Boolean))
locbldr88.SetLocalSymInfo("compb")
OptimizeIL.Emit(OpCodes.Ldc_I4, 0)
Typ = GetType(System.Boolean)
OptimizeIL.Emit(OpCodes.Stloc, 4)
...
Typ = GetType(System.Boolean)
OptimizeIL.Emit(OpCodes.Stsfld, asm.GetType("tokenizer.Parser.ParserFlags").GetField("NoOptFlag"))
OptimizeIL.MarkSequencePoint(doc4, 29, 1, 29, 100)
Dim label0 As System.Reflection.Emit.Label = OptimizeIL.DefineLabel()
...
OptimizeIL.MarkSequencePoint(doc4, 33, 1, 33, 100)
OptimizeIL.Emit(OpCodes.Ldloc, 1)
Typ = GetType(System.Int32)
OptimizeIL.Emit(OpCodes.Ldc_I4, CInt(0))
Typ = GetType(System.Int32)
...
ReDim Preserve typ5(UBound(typ5) + 1)
typ5(UBound(typ5)) = Typ
OptimizeIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("Optimize", typ5))
Typ = Typ03.GetMethod("Optimize", typ5).ReturnType
Typ = Typ02
...
OptimizeIL.Emit(OpCodes.Br, label1)
OptimizeIL.MarkSequencePoint(doc4, 55, 1, 55, 100)
...
OptimizeIL.MarkSequencePoint(doc4, 74, 1, 74, 100)
OptimizeIL.MarkLabel(label2)
OptimizeIL.MarkSequencePoint(doc4, 76, 1, 76, 100)
OptimizeIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
OptimizeIL.MarkSequencePoint(doc4, 77, 1, 77, 100)
OptimizeIL.Emit(OpCodes.Ret)
...
Dim locbldr89 As LocalBuilder = ParseIL.DeclareLocal(GetType(System.Int32))
...
Dim locbldr90 As LocalBuilder = ParseIL.DeclareLocal(asm.GetType("tokenizer.Parser.StmtOptimizer"))
locbldr90.SetLocalSymInfo("so")
ParseIL.Emit(OpCodes.Ldnull)
ParseIL.Emit(OpCodes.Stloc, 1)
ParseIL.MarkSequencePoint(doc5, 6, 1, 6, 100)
Dim locbldr91 As LocalBuilder = ParseIL.DeclareLocal(GetType(System.Int32))
...
ParseIL.Emit(OpCodes.Ldloc, 2)
Typ = GetType(System.Int32)
Dim fa82 As System.Reflection.Emit.Label = ParseIL.DefineLabel()
Dim tru82 As System.Reflection.Emit.Label = ParseIL.DefineLabel()
Dim cont82 As System.Reflection.Emit.Label = ParseIL.DefineLabel()
ParseIL.Emit(OpCodes.Beq, tru82)
ParseIL.Emit(OpCodes.Br, fa82)
ParseIL.MarkLabel(tru82)
ParseIL.MarkSequencePoint(doc5, 19, 1, 19, 100)
ParseIL.Emit(OpCodes.Br, label1)
ParseIL.MarkSequencePoint(doc5, 20, 1, 20, 100)
ParseIL.Emit(OpCodes.Br, cont82)
ParseIL.MarkLabel(fa82)
ParseIL.MarkSequencePoint(doc5, 21, 1, 21, 100)
ParseIL.Emit(OpCodes.Br, label0)
ParseIL.MarkSequencePoint(doc5, 22, 1, 22, 100)
ParseIL.Emit(OpCodes.Br, cont82)
ParseIL.MarkLabel(cont82)
