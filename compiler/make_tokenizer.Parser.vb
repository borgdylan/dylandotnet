...
checkImportIL.MarkSequencePoint(doc4, 15, 1, 15, 100)
...
checkImportIL.MarkSequencePoint(doc4, 16, 1, 16, 100)
...
Dim checkAssign As MethodBuilder = StmtOptimizer.DefineMethod("checkAssign", MethodAttributes.Public, GetType(Stmt), typ6)
...
checkAssignIL.MarkSequencePoint(doc4, 26, 1, 26, 100)
Dim locbldr87 As LocalBuilder = checkAssignIL.DeclareLocal(GetType(Token))
locbldr87.SetLocalSymInfo("tok")
checkAssignIL.Emit(OpCodes.Ldnull)
checkAssignIL.Emit(OpCodes.Stloc, 0)
checkAssignIL.MarkSequencePoint(doc4, 27, 1, 27, 100)
Dim locbldr88 As LocalBuilder = checkAssignIL.DeclareLocal(GetType(System.Type))
...
checkAssignIL.Emit(OpCodes.Call, GetType(System.Type).GetMethod("GetTypeFromHandle", typ7))
Typ = GetType(System.Type).GetMethod("GetTypeFromHandle", typ7).ReturnType
checkAssignIL.Emit(OpCodes.Stloc, 1)
checkAssignIL.MarkSequencePoint(doc4, 28, 1, 28, 100)
Dim locbldr89 As LocalBuilder = checkAssignIL.DeclareLocal(GetType(AssignStmt))
locbldr89.SetLocalSymInfo("asss")
checkAssignIL.Emit(OpCodes.Newobj, GetType(AssignStmt).GetConstructor(Type.EmptyTypes))
checkAssignIL.Emit(OpCodes.Stloc, 2)
checkAssignIL.MarkSequencePoint(doc4, 29, 1, 29, 100)
Dim locbldr90 As LocalBuilder = checkAssignIL.DeclareLocal(GetType(System.Boolean))
locbldr90.SetLocalSymInfo("c")
checkAssignIL.Emit(OpCodes.Ldc_I4, 0)
Typ = GetType(System.Boolean)
checkAssignIL.Emit(OpCodes.Stloc, 3)
checkAssignIL.MarkSequencePoint(doc4, 30, 1, 30, 100)
Dim locbldr91 As LocalBuilder = checkAssignIL.DeclareLocal(GetType(Expr))
locbldr91.SetLocalSymInfo("re")
checkAssignIL.Emit(OpCodes.Newobj, GetType(Expr).GetConstructor(Type.EmptyTypes))
checkAssignIL.Emit(OpCodes.Stloc, 4)
checkAssignIL.MarkSequencePoint(doc4, 31, 1, 31, 100)
Dim locbldr92 As LocalBuilder = checkAssignIL.DeclareLocal(GetType(Expr))
locbldr92.SetLocalSymInfo("le")
checkAssignIL.Emit(OpCodes.Newobj, GetType(Expr).GetConstructor(Type.EmptyTypes))
checkAssignIL.Emit(OpCodes.Stloc, 5)
checkAssignIL.MarkSequencePoint(doc4, 32, 1, 32, 100)
Dim locbldr93 As LocalBuilder = checkAssignIL.DeclareLocal(GetType(System.Int32))
locbldr93.SetLocalSymInfo("i")
checkAssignIL.Emit(OpCodes.Ldc_I4, CInt(-1))
Typ = GetType(System.Int32)
checkAssignIL.Emit(OpCodes.Stloc, 6)
checkAssignIL.MarkSequencePoint(doc4, 33, 1, 33, 100)
Dim locbldr94 As LocalBuilder = checkAssignIL.DeclareLocal(GetType(System.Int32))
...
checkAssignIL.MarkSequencePoint(doc4, 34, 1, 34, 100)
Dim locbldr95 As LocalBuilder = checkAssignIL.DeclareLocal(GetType(System.Int32))
locbldr95.SetLocalSymInfo("assind")
checkAssignIL.Emit(OpCodes.Ldc_I4, CInt(0))
Typ = GetType(System.Int32)
checkAssignIL.Emit(OpCodes.Stloc, 8)
checkAssignIL.MarkSequencePoint(doc4, 36, 1, 36, 100)
Dim label0 As System.Reflection.Emit.Label = checkAssignIL.DefineLabel()
checkAssignIL.MarkSequencePoint(doc4, 37, 1, 37, 100)
Dim label1 As System.Reflection.Emit.Label = checkAssignIL.DefineLabel()
checkAssignIL.MarkSequencePoint(doc4, 39, 1, 39, 100)
checkAssignIL.MarkLabel(label0)
checkAssignIL.MarkSequencePoint(doc4, 41, 1, 41, 100)
...
checkAssignIL.Emit(OpCodes.Stloc, 6)
checkAssignIL.MarkSequencePoint(doc4, 43, 1, 43, 100)
checkAssignIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
checkAssignIL.Emit(OpCodes.Ldfld, GetType(Stmt).GetField("Tokens"))
Typ = GetType(Stmt).GetField("Tokens").FieldType
...
Typ = Typ.GetElementType()
checkAssignIL.Emit(OpCodes.Stloc, 0)
checkAssignIL.MarkSequencePoint(doc4, 44, 1, 44, 100)
Dim typ8(-1) As Type
...
ReDim Preserve typ8(UBound(typ8) + 1)
typ8(UBound(typ8)) = Typ
checkAssignIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("IsInstanceOfType", typ8))
Typ = Typ03.GetMethod("IsInstanceOfType", typ8).ReturnType
checkAssignIL.Emit(OpCodes.Stloc, 3)
checkAssignIL.MarkSequencePoint(doc4, 46, 1, 46, 100)
checkAssignIL.Emit(OpCodes.Ldloc, 3)
Typ = GetType(System.Boolean)
checkAssignIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa76 As System.Reflection.Emit.Label = checkAssignIL.DefineLabel()
Dim tru76 As System.Reflection.Emit.Label = checkAssignIL.DefineLabel()
Dim cont76 As System.Reflection.Emit.Label = checkAssignIL.DefineLabel()
checkAssignIL.Emit(OpCodes.Beq, tru76)
checkAssignIL.Emit(OpCodes.Br, fa76)
checkAssignIL.MarkLabel(tru76)
checkAssignIL.MarkSequencePoint(doc4, 47, 1, 47, 100)
checkAssignIL.Emit(OpCodes.Ldloc, 6)
Typ = GetType(System.Int32)
checkAssignIL.Emit(OpCodes.Stloc, 8)
checkAssignIL.MarkSequencePoint(doc4, 48, 1, 48, 100)
checkAssignIL.Emit(OpCodes.Br, label1)
checkAssignIL.MarkSequencePoint(doc4, 49, 1, 49, 100)
checkAssignIL.Emit(OpCodes.Br, cont76)
checkAssignIL.MarkLabel(fa76)
checkAssignIL.Emit(OpCodes.Br, cont76)
checkAssignIL.MarkLabel(cont76)
checkAssignIL.MarkSequencePoint(doc4, 51, 1, 51, 100)
checkAssignIL.Emit(OpCodes.Ldloc, 6)
Typ = GetType(System.Int32)
checkAssignIL.Emit(OpCodes.Ldloc, 7)
Typ = GetType(System.Int32)
Dim fa77 As System.Reflection.Emit.Label = checkAssignIL.DefineLabel()
Dim tru77 As System.Reflection.Emit.Label = checkAssignIL.DefineLabel()
Dim cont77 As System.Reflection.Emit.Label = checkAssignIL.DefineLabel()
checkAssignIL.Emit(OpCodes.Beq, tru77)
checkAssignIL.Emit(OpCodes.Br, fa77)
checkAssignIL.MarkLabel(tru77)
checkAssignIL.MarkSequencePoint(doc4, 52, 1, 52, 100)
checkAssignIL.Emit(OpCodes.Br, label1)
checkAssignIL.MarkSequencePoint(doc4, 53, 1, 53, 100)
checkAssignIL.Emit(OpCodes.Br, cont77)
checkAssignIL.MarkLabel(fa77)
checkAssignIL.MarkSequencePoint(doc4, 54, 1, 54, 100)
checkAssignIL.Emit(OpCodes.Br, label0)
checkAssignIL.MarkSequencePoint(doc4, 55, 1, 55, 100)
checkAssignIL.Emit(OpCodes.Br, cont77)
checkAssignIL.MarkLabel(cont77)
checkAssignIL.MarkSequencePoint(doc4, 57, 1, 57, 100)
checkAssignIL.MarkLabel(label1)
checkAssignIL.MarkSequencePoint(doc4, 59, 1, 59, 100)
checkAssignIL.Emit(OpCodes.Ldloc, 8)
Typ = GetType(System.Int32)
checkAssignIL.Emit(OpCodes.Ldc_I4, CInt(0))
Typ = GetType(System.Int32)
Dim fa78 As System.Reflection.Emit.Label = checkAssignIL.DefineLabel()
Dim tru78 As System.Reflection.Emit.Label = checkAssignIL.DefineLabel()
Dim cont78 As System.Reflection.Emit.Label = checkAssignIL.DefineLabel()
checkAssignIL.Emit(OpCodes.Beq, fa78)
checkAssignIL.Emit(OpCodes.Br, tru78)
checkAssignIL.MarkLabel(tru78)
checkAssignIL.MarkSequencePoint(doc4, 61, 1, 61, 100)
checkAssignIL.Emit(OpCodes.Ldc_I4, CInt(-1))
Typ = GetType(System.Int32)
checkAssignIL.Emit(OpCodes.Stloc, 6)
checkAssignIL.MarkSequencePoint(doc4, 62, 1, 62, 100)
checkAssignIL.Emit(OpCodes.Ldloc, 8)
Typ = GetType(System.Int32)
checkAssignIL.Emit(OpCodes.Ldc_I4, CInt(1))
Typ = GetType(System.Int32)
checkAssignIL.Emit(OpCodes.Sub)
checkAssignIL.Emit(OpCodes.Stloc, 7)
checkAssignIL.MarkSequencePoint(doc4, 64, 1, 64, 100)
Dim label2 As System.Reflection.Emit.Label = checkAssignIL.DefineLabel()
checkAssignIL.MarkSequencePoint(doc4, 65, 1, 65, 100)
Dim label3 As System.Reflection.Emit.Label = checkAssignIL.DefineLabel()
checkAssignIL.MarkSequencePoint(doc4, 67, 1, 67, 100)
checkAssignIL.MarkLabel(label2)
checkAssignIL.MarkSequencePoint(doc4, 69, 1, 69, 100)
checkAssignIL.Emit(OpCodes.Ldloc, 6)
Typ = GetType(System.Int32)
checkAssignIL.Emit(OpCodes.Ldc_I4, CInt(1))
Typ = GetType(System.Int32)
checkAssignIL.Emit(OpCodes.Add)
checkAssignIL.Emit(OpCodes.Stloc, 6)
checkAssignIL.MarkSequencePoint(doc4, 71, 1, 71, 100)
Dim typ9(-1) As Type
...
ReDim Preserve typ9(UBound(typ9) + 1)
typ9(UBound(typ9)) = Typ
checkAssignIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("AddToken", typ9))
Typ = Typ03.GetMethod("AddToken", typ9).ReturnType
If Typ.ToString() = GetType(System.Void).ToString() Then

Else
checkAssignIL.Emit(OpCodes.Pop)
End If
checkAssignIL.MarkSequencePoint(doc4, 73, 1, 73, 100)
checkAssignIL.Emit(OpCodes.Ldloc, 6)
Typ = GetType(System.Int32)
checkAssignIL.Emit(OpCodes.Ldloc, 7)
Typ = GetType(System.Int32)
Dim fa79 As System.Reflection.Emit.Label = checkAssignIL.DefineLabel()
Dim tru79 As System.Reflection.Emit.Label = checkAssignIL.DefineLabel()
Dim cont79 As System.Reflection.Emit.Label = checkAssignIL.DefineLabel()
checkAssignIL.Emit(OpCodes.Beq, tru79)
checkAssignIL.Emit(OpCodes.Br, fa79)
checkAssignIL.MarkLabel(tru79)
checkAssignIL.MarkSequencePoint(doc4, 74, 1, 74, 100)
checkAssignIL.Emit(OpCodes.Br, label3)
checkAssignIL.MarkSequencePoint(doc4, 75, 1, 75, 100)
checkAssignIL.Emit(OpCodes.Br, cont79)
checkAssignIL.MarkLabel(fa79)
checkAssignIL.MarkSequencePoint(doc4, 76, 1, 76, 100)
checkAssignIL.Emit(OpCodes.Br, label2)
checkAssignIL.MarkSequencePoint(doc4, 77, 1, 77, 100)
checkAssignIL.Emit(OpCodes.Br, cont79)
checkAssignIL.MarkLabel(cont79)
checkAssignIL.MarkSequencePoint(doc4, 79, 1, 79, 100)
checkAssignIL.MarkLabel(label3)
checkAssignIL.MarkSequencePoint(doc4, 82, 1, 82, 100)
checkAssignIL.Emit(OpCodes.Ldloc, 8)
Typ = GetType(System.Int32)
checkAssignIL.Emit(OpCodes.Stloc, 6)
checkAssignIL.MarkSequencePoint(doc4, 83, 1, 83, 100)
checkAssignIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
checkAssignIL.Emit(OpCodes.Ldfld, GetType(Stmt).GetField("Tokens"))
Typ = GetType(Stmt).GetField("Tokens").FieldType
...
checkAssignIL.Emit(OpCodes.Sub)
checkAssignIL.Emit(OpCodes.Stloc, 7)
checkAssignIL.MarkSequencePoint(doc4, 85, 1, 85, 100)
Dim label4 As System.Reflection.Emit.Label = checkAssignIL.DefineLabel()
checkAssignIL.MarkSequencePoint(doc4, 86, 1, 86, 100)
Dim label5 As System.Reflection.Emit.Label = checkAssignIL.DefineLabel()
checkAssignIL.MarkSequencePoint(doc4, 88, 1, 88, 100)
checkAssignIL.MarkLabel(label4)
checkAssignIL.MarkSequencePoint(doc4, 90, 1, 90, 100)
checkAssignIL.Emit(OpCodes.Ldloc, 6)
Typ = GetType(System.Int32)
checkAssignIL.Emit(OpCodes.Ldc_I4, CInt(1))
Typ = GetType(System.Int32)
checkAssignIL.Emit(OpCodes.Add)
checkAssignIL.Emit(OpCodes.Stloc, 6)
checkAssignIL.MarkSequencePoint(doc4, 92, 1, 92, 100)
Dim typ10(-1) As Type
...
ReDim Preserve typ10(UBound(typ10) + 1)
typ10(UBound(typ10)) = Typ
checkAssignIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("AddToken", typ10))
Typ = Typ03.GetMethod("AddToken", typ10).ReturnType
If Typ.ToString() = GetType(System.Void).ToString() Then

Else
checkAssignIL.Emit(OpCodes.Pop)
End If
checkAssignIL.MarkSequencePoint(doc4, 94, 1, 94, 100)
checkAssignIL.Emit(OpCodes.Ldloc, 6)
Typ = GetType(System.Int32)
checkAssignIL.Emit(OpCodes.Ldloc, 7)
Typ = GetType(System.Int32)
Dim fa80 As System.Reflection.Emit.Label = checkAssignIL.DefineLabel()
Dim tru80 As System.Reflection.Emit.Label = checkAssignIL.DefineLabel()
Dim cont80 As System.Reflection.Emit.Label = checkAssignIL.DefineLabel()
checkAssignIL.Emit(OpCodes.Beq, tru80)
checkAssignIL.Emit(OpCodes.Br, fa80)
checkAssignIL.MarkLabel(tru80)
checkAssignIL.MarkSequencePoint(doc4, 95, 1, 95, 100)
checkAssignIL.Emit(OpCodes.Br, label5)
checkAssignIL.MarkSequencePoint(doc4, 96, 1, 96, 100)
checkAssignIL.Emit(OpCodes.Br, cont80)
checkAssignIL.MarkLabel(fa80)
checkAssignIL.MarkSequencePoint(doc4, 97, 1, 97, 100)
checkAssignIL.Emit(OpCodes.Br, label4)
checkAssignIL.MarkSequencePoint(doc4, 98, 1, 98, 100)
checkAssignIL.Emit(OpCodes.Br, cont80)
checkAssignIL.MarkLabel(cont80)
checkAssignIL.MarkSequencePoint(doc4, 100, 1, 100, 100)
checkAssignIL.MarkLabel(label5)
checkAssignIL.MarkSequencePoint(doc4, 102, 1, 102, 100)
...
checkAssignIL.MarkSequencePoint(doc4, 103, 1, 103, 100)
checkAssignIL.Emit(OpCodes.Ldloc, 2)
Typ = GetType(AssignStmt)
checkAssignIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
...
checkAssignIL.MarkSequencePoint(doc4, 104, 1, 104, 100)
checkAssignIL.Emit(OpCodes.Ldloc, 2)
Typ = GetType(AssignStmt)
checkAssignIL.Emit(OpCodes.Ldloc, 5)
Typ = GetType(Expr)
checkAssignIL.Emit(OpCodes.Stfld, GetType(AssignStmt).GetField("LExp"))
checkAssignIL.MarkSequencePoint(doc4, 105, 1, 105, 100)
checkAssignIL.Emit(OpCodes.Ldloc, 2)
Typ = GetType(AssignStmt)
checkAssignIL.Emit(OpCodes.Ldloc, 4)
Typ = GetType(Expr)
checkAssignIL.Emit(OpCodes.Stfld, GetType(AssignStmt).GetField("RExp"))
checkAssignIL.MarkSequencePoint(doc4, 107, 1, 107, 100)
...
checkAssignIL.MarkSequencePoint(doc4, 108, 1, 108, 100)
checkAssignIL.Emit(OpCodes.Ldloc, 2)
Typ = GetType(AssignStmt)
checkAssignIL.MarkSequencePoint(doc4, 110, 1, 110, 100)
checkAssignIL.Emit(OpCodes.Br, cont78)
checkAssignIL.MarkLabel(fa78)
checkAssignIL.MarkSequencePoint(doc4, 111, 1, 111, 100)
checkAssignIL.Emit(OpCodes.Ldarg, 2)
Typ = GetType(System.Boolean).MakeByRefType()
Typ04 = Typ.GetElementType()
checkAssignIL.Emit(OpCodes.Ldc_I4, 0)
Typ = GetType(System.Boolean)
checkAssignIL.Emit(OpCodes.Stobj, Typ04)
checkAssignIL.MarkSequencePoint(doc4, 112, 1, 112, 100)
checkAssignIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
checkAssignIL.MarkSequencePoint(doc4, 114, 1, 114, 100)
checkAssignIL.Emit(OpCodes.Br, cont78)
checkAssignIL.MarkLabel(cont78)
checkAssignIL.MarkSequencePoint(doc4, 116, 1, 116, 100)
checkAssignIL.Emit(OpCodes.Ret)
Dim typ11(-1) As Type
ReDim Preserve typ11(UBound(typ11) + 1)
typ11(UBound(typ11)) = GetType(Stmt)
Dim Optimize As MethodBuilder = StmtOptimizer.DefineMethod("Optimize", MethodAttributes.Public, GetType(Stmt), typ11)
Dim OptimizeIL As ILGenerator = Optimize.GetILGenerator()
Dim Optimizeparam00 As ParameterBuilder = Optimize.DefineParameter(0, ParameterAttributes.RetVal, "")
Dim Optimizeparam01 As ParameterBuilder = Optimize.DefineParameter(1, ParameterAttributes.None, "stm")
OptimizeIL.MarkSequencePoint(doc4, 120, 1, 120, 100)
Dim typ12(-1) As Type
OptimizeIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
...
ReDim Preserve typ12(UBound(typ12) + 1)
typ12(UBound(typ12)) = Typ
OptimizeIL.Emit(OpCodes.Call, GetType(Console).GetMethod("WriteLine", typ12))
...
End If
OptimizeIL.MarkSequencePoint(doc4, 122, 1, 122, 100)
Dim locbldr96 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(System.Int32))
locbldr96.SetLocalSymInfo("i")
OptimizeIL.Emit(OpCodes.Ldc_I4, CInt(-1))
Typ = GetType(System.Int32)
OptimizeIL.Emit(OpCodes.Stloc, 0)
OptimizeIL.MarkSequencePoint(doc4, 123, 1, 123, 100)
Dim locbldr97 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(System.Int32))
locbldr97.SetLocalSymInfo("len")
OptimizeIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
...
Typ = GetType(System.Int32)
OptimizeIL.Emit(OpCodes.Stloc, 1)
OptimizeIL.MarkSequencePoint(doc4, 124, 1, 124, 100)
Dim locbldr98 As LocalBuilder = OptimizeIL.DeclareLocal(asm.GetType("tokenizer.Parser.TokenOptimizer"))
locbldr98.SetLocalSymInfo("to")
OptimizeIL.Emit(OpCodes.Ldnull)
OptimizeIL.Emit(OpCodes.Stloc, 2)
OptimizeIL.MarkSequencePoint(doc4, 125, 1, 125, 100)
Dim locbldr99 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(Stmt))
locbldr99.SetLocalSymInfo("tmpstm")
OptimizeIL.Emit(OpCodes.Ldnull)
OptimizeIL.Emit(OpCodes.Stloc, 3)
OptimizeIL.MarkSequencePoint(doc4, 126, 1, 126, 100)
Dim locbldr100 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(System.Boolean))
locbldr100.SetLocalSymInfo("compb")
OptimizeIL.Emit(OpCodes.Ldc_I4, 0)
Typ = GetType(System.Boolean)
OptimizeIL.Emit(OpCodes.Stloc, 4)
OptimizeIL.MarkSequencePoint(doc4, 127, 1, 127, 100)
OptimizeIL.Emit(OpCodes.Ldloc, 1)
Typ = GetType(System.Int32)
OptimizeIL.Emit(OpCodes.Ldc_I4, CInt(1))
Typ = GetType(System.Int32)
...
OptimizeIL.Emit(OpCodes.Stloc, 1)
OptimizeIL.MarkSequencePoint(doc4, 129, 1, 129, 100)
OptimizeIL.Emit(OpCodes.Ldc_I4, 0)
Typ = GetType(System.Boolean)
OptimizeIL.Emit(OpCodes.Stsfld, asm.GetType("tokenizer.Parser.ParserFlags").GetField("IfFlag"))
OptimizeIL.MarkSequencePoint(doc4, 130, 1, 130, 100)
OptimizeIL.Emit(OpCodes.Ldc_I4, 0)
Typ = GetType(System.Boolean)
OptimizeIL.Emit(OpCodes.Stsfld, asm.GetType("tokenizer.Parser.ParserFlags").GetField("CmtFlag"))
OptimizeIL.MarkSequencePoint(doc4, 131, 1, 131, 100)
OptimizeIL.Emit(OpCodes.Ldc_I4, 0)
Typ = GetType(System.Boolean)
OptimizeIL.Emit(OpCodes.Stsfld, asm.GetType("tokenizer.Parser.ParserFlags").GetField("NoOptFlag"))
OptimizeIL.MarkSequencePoint(doc4, 133, 1, 133, 100)
Dim label6 As System.Reflection.Emit.Label = OptimizeIL.DefineLabel()
OptimizeIL.MarkSequencePoint(doc4, 134, 1, 134, 100)
Dim label7 As System.Reflection.Emit.Label = OptimizeIL.DefineLabel()
OptimizeIL.MarkSequencePoint(doc4, 135, 1, 135, 100)
Dim label8 As System.Reflection.Emit.Label = OptimizeIL.DefineLabel()
OptimizeIL.MarkSequencePoint(doc4, 137, 1, 137, 100)
OptimizeIL.Emit(OpCodes.Ldloc, 1)
Typ = GetType(System.Int32)
OptimizeIL.Emit(OpCodes.Ldc_I4, CInt(0))
Typ = GetType(System.Int32)
...
OptimizeIL.Emit(OpCodes.Blt, tru81)
OptimizeIL.Emit(OpCodes.Br, fa81)
OptimizeIL.MarkLabel(tru81)
OptimizeIL.MarkSequencePoint(doc4, 138, 1, 138, 100)
OptimizeIL.Emit(OpCodes.Br, label7)
OptimizeIL.MarkSequencePoint(doc4, 139, 1, 139, 100)
OptimizeIL.Emit(OpCodes.Br, cont81)
OptimizeIL.MarkLabel(fa81)
OptimizeIL.Emit(OpCodes.Br, cont81)
OptimizeIL.MarkLabel(cont81)
OptimizeIL.MarkSequencePoint(doc4, 141, 1, 141, 100)
OptimizeIL.MarkLabel(label6)
OptimizeIL.MarkSequencePoint(doc4, 143, 1, 143, 100)
OptimizeIL.Emit(OpCodes.Ldloc, 0)
Typ = GetType(System.Int32)
OptimizeIL.Emit(OpCodes.Ldc_I4, CInt(1))
Typ = GetType(System.Int32)
...
OptimizeIL.Emit(OpCodes.Stloc, 0)
OptimizeIL.MarkSequencePoint(doc4, 145, 1, 145, 100)
...
OptimizeIL.MarkSequencePoint(doc4, 146, 1, 146, 100)
OptimizeIL.Emit(OpCodes.Br, label7)
OptimizeIL.MarkSequencePoint(doc4, 147, 1, 147, 100)
OptimizeIL.Emit(OpCodes.Br, cont82)
OptimizeIL.MarkLabel(fa82)
OptimizeIL.Emit(OpCodes.Br, cont82)
OptimizeIL.MarkLabel(cont82)
OptimizeIL.MarkSequencePoint(doc4, 150, 1, 150, 100)
...
ReDim Preserve typ13(UBound(typ13) + 1)
typ13(UBound(typ13)) = Typ
OptimizeIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("Optimize", typ13))
Typ = Typ03.GetMethod("Optimize", typ13).ReturnType
Typ = Typ02
OptimizeIL.Emit(OpCodes.Stelem, Typ.GetElementType())
OptimizeIL.MarkSequencePoint(doc4, 157, 1, 157, 100)
OptimizeIL.Emit(OpCodes.Ldloc, 0)
Typ = GetType(System.Int32)
OptimizeIL.Emit(OpCodes.Ldloc, 1)
Typ = GetType(System.Int32)
...
OptimizeIL.MarkSequencePoint(doc4, 158, 1, 158, 100)
OptimizeIL.Emit(OpCodes.Br, label7)
OptimizeIL.MarkSequencePoint(doc4, 159, 1, 159, 100)
...
OptimizeIL.MarkSequencePoint(doc4, 166, 1, 166, 100)
...
OptimizeIL.Emit(OpCodes.Stloc, 3)
OptimizeIL.MarkSequencePoint(doc4, 185, 1, 185, 100)
OptimizeIL.Emit(OpCodes.Ldloc, 4)
Typ = GetType(System.Boolean)
OptimizeIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
...
Dim locbldr101 As LocalBuilder = ParseIL.DeclareLocal(GetType(System.Int32))
...
Dim locbldr102 As LocalBuilder = ParseIL.DeclareLocal(asm.GetType("tokenizer.Parser.StmtOptimizer"))
locbldr102.SetLocalSymInfo("so")
ParseIL.Emit(OpCodes.Ldnull)
ParseIL.Emit(OpCodes.Stloc, 1)
ParseIL.MarkSequencePoint(doc5, 6, 1, 6, 100)
Dim locbldr103 As LocalBuilder = ParseIL.DeclareLocal(GetType(System.Int32))
...
ParseIL.Emit(OpCodes.Ldloc, 2)
Typ = GetType(System.Int32)
Dim fa89 As System.Reflection.Emit.Label = ParseIL.DefineLabel()
Dim tru89 As System.Reflection.Emit.Label = ParseIL.DefineLabel()
Dim cont89 As System.Reflection.Emit.Label = ParseIL.DefineLabel()
ParseIL.Emit(OpCodes.Beq, tru89)
ParseIL.Emit(OpCodes.Br, fa89)
ParseIL.MarkLabel(tru89)
ParseIL.MarkSequencePoint(doc5, 19, 1, 19, 100)
ParseIL.Emit(OpCodes.Br, label1)
ParseIL.MarkSequencePoint(doc5, 20, 1, 20, 100)
ParseIL.Emit(OpCodes.Br, cont89)
ParseIL.MarkLabel(fa89)
ParseIL.MarkSequencePoint(doc5, 21, 1, 21, 100)
ParseIL.Emit(OpCodes.Br, label0)
ParseIL.MarkSequencePoint(doc5, 22, 1, 22, 100)
ParseIL.Emit(OpCodes.Br, cont89)
ParseIL.MarkLabel(cont89)
