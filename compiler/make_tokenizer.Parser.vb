...
Dim ArrSlot As FieldBuilder = ParserFlags.DefineField("ArrSlot", GetType(Token), FieldAttributes.Public Or FieldAttributes.Static)
...
SetUnaryFalseIL.MarkSequencePoint(doc2, 36, 1, 36, 100)
SetUnaryFalseIL.Emit(OpCodes.Ldc_I4, 0)
Typ = GetType(System.Boolean)
SetUnaryFalseIL.Emit(OpCodes.Stsfld, NegFlag)
SetUnaryFalseIL.MarkSequencePoint(doc2, 37, 1, 37, 100)
SetUnaryFalseIL.Emit(OpCodes.Ldc_I4, 0)
Typ = GetType(System.Boolean)
...
UpdateIdentIL.MarkSequencePoint(doc2, 50, 1, 50, 100)
...
UpdateIdentIL.MarkSequencePoint(doc2, 51, 1, 51, 100)
UpdateIdentIL.Emit(OpCodes.Ldarg, 0)
Typ = GetType(Ident)
...
Dim locbldr82 As LocalBuilder = checkVarAsIL.DeclareLocal(GetType(Token))
...
Dim locbldr83 As LocalBuilder = checkVarAsIL.DeclareLocal(GetType(System.Type))
...
Dim locbldr84 As LocalBuilder = checkVarAsIL.DeclareLocal(GetType(VarExpr))
locbldr84.SetLocalSymInfo("vars")
...
Typ = GetType(System.Boolean)
Dim fa77 As System.Reflection.Emit.Label = checkVarAsIL.DefineLabel()
Dim tru77 As System.Reflection.Emit.Label = checkVarAsIL.DefineLabel()
Dim cont77 As System.Reflection.Emit.Label = checkVarAsIL.DefineLabel()
checkVarAsIL.Emit(OpCodes.Beq, tru77)
checkVarAsIL.Emit(OpCodes.Br, fa77)
checkVarAsIL.MarkLabel(tru77)
...
Dim locbldr85 As LocalBuilder = checkVarAsIL.DeclareLocal(GetType(Token))
locbldr85.SetLocalSymInfo("tok2")
checkVarAsIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Expr)
checkVarAsIL.Emit(OpCodes.Ldfld, GetType(Expr).GetField("Tokens"))
Typ = GetType(Expr).GetField("Tokens").FieldType
...
Dim locbldr86 As LocalBuilder = checkVarAsIL.DeclareLocal(GetType(System.Type))
locbldr86.SetLocalSymInfo("typ2")
...
Dim locbldr87 As LocalBuilder = checkVarAsIL.DeclareLocal(GetType(System.Boolean))
locbldr87.SetLocalSymInfo("b2")
Dim typ4(-1) As Type
...
checkVarAsIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa78 As System.Reflection.Emit.Label = checkVarAsIL.DefineLabel()
Dim tru78 As System.Reflection.Emit.Label = checkVarAsIL.DefineLabel()
Dim cont78 As System.Reflection.Emit.Label = checkVarAsIL.DefineLabel()
checkVarAsIL.Emit(OpCodes.Beq, fa78)
checkVarAsIL.Emit(OpCodes.Br, tru78)
checkVarAsIL.MarkLabel(tru78)
checkVarAsIL.MarkSequencePoint(doc4, 19, 1, 19, 100)
Dim locbldr88 As LocalBuilder = checkVarAsIL.DeclareLocal(GetType(Token))
locbldr88.SetLocalSymInfo("t")
checkVarAsIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Expr)
checkVarAsIL.Emit(OpCodes.Ldfld, GetType(Expr).GetField("Tokens"))
Typ = GetType(Expr).GetField("Tokens").FieldType
...
Dim locbldr89 As LocalBuilder = checkVarAsIL.DeclareLocal(GetType(TypeTok))
locbldr89.SetLocalSymInfo("tt")
...
checkVarAsIL.Emit(OpCodes.Br, cont78)
checkVarAsIL.MarkLabel(fa78)
...
checkVarAsIL.Emit(OpCodes.Br, cont78)
checkVarAsIL.MarkLabel(cont78)
checkVarAsIL.MarkSequencePoint(doc4, 28, 1, 28, 100)
checkVarAsIL.Emit(OpCodes.Br, cont77)
checkVarAsIL.MarkLabel(fa77)
checkVarAsIL.Emit(OpCodes.Br, cont77)
checkVarAsIL.MarkLabel(cont77)
...
Dim typ5(-1) As Type
ReDim Preserve typ5(UBound(typ5) + 1)
typ5(UBound(typ5)) = GetType(Expr)
Dim Optimize As MethodBuilder = ExprOptimizer.DefineMethod("Optimize", MethodAttributes.Public, GetType(Expr), typ5)
Dim OptimizeIL As ILGenerator = Optimize.GetILGenerator()
Dim Optimizeparam00 As ParameterBuilder = Optimize.DefineParameter(0, ParameterAttributes.RetVal, "")
...
Dim locbldr90 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(System.Int32))
locbldr90.SetLocalSymInfo("len")
OptimizeIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Expr)
...
Dim locbldr91 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(System.Int32))
locbldr91.SetLocalSymInfo("i")
OptimizeIL.Emit(OpCodes.Ldc_I4, CInt(-1))
Typ = GetType(System.Int32)
OptimizeIL.Emit(OpCodes.Stloc, 1)
...
OptimizeIL.MarkLabel(label0)
OptimizeIL.MarkSequencePoint(doc4, 47, 1, 47, 100)
OptimizeIL.Emit(OpCodes.Ldloc, 1)
Typ = GetType(System.Int32)
OptimizeIL.Emit(OpCodes.Ldc_I4, CInt(1))
Typ = GetType(System.Int32)
...
OptimizeIL.Emit(OpCodes.Stloc, 1)
OptimizeIL.MarkSequencePoint(doc4, 49, 1, 49, 100)
Dim label2 As System.Reflection.Emit.Label = OptimizeIL.DefineLabel()
OptimizeIL.MarkSequencePoint(doc4, 51, 1, 51, 100)
Dim locbldr92 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(Token))
locbldr92.SetLocalSymInfo("tok")
OptimizeIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Expr)
OptimizeIL.Emit(OpCodes.Ldfld, GetType(Expr).GetField("Tokens"))
Typ = GetType(Expr).GetField("Tokens").FieldType
...
Typ = Typ.GetElementType()
OptimizeIL.Emit(OpCodes.Stloc, 2)
OptimizeIL.MarkSequencePoint(doc4, 52, 1, 52, 100)
Dim locbldr93 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(System.Type))
locbldr93.SetLocalSymInfo("typ")
OptimizeIL.MarkSequencePoint(doc4, 53, 1, 53, 100)
Dim locbldr94 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(System.Boolean))
locbldr94.SetLocalSymInfo("b")
OptimizeIL.MarkSequencePoint(doc4, 54, 1, 54, 100)
Dim locbldr95 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(System.String))
locbldr95.SetLocalSymInfo("str")
OptimizeIL.MarkSequencePoint(doc4, 56, 1, 56, 100)
OptimizeIL.Emit(OpCodes.Ldtoken, GetType(DollarSign))
Dim typ6 As Type() = {GetType(System.RuntimeTypeHandle)}
OptimizeIL.Emit(OpCodes.Call, GetType(System.Type).GetMethod("GetTypeFromHandle", typ6))
Typ = GetType(System.Type).GetMethod("GetTypeFromHandle", typ6).ReturnType
OptimizeIL.Emit(OpCodes.Stloc, 3)
OptimizeIL.MarkSequencePoint(doc4, 57, 1, 57, 100)
Dim typ7(-1) As Type
OptimizeIL.Emit(OpCodes.Ldloc, 3)
Typ = GetType(System.Type)
Typ03 = Typ
...
ReDim Preserve typ7(UBound(typ7) + 1)
typ7(UBound(typ7)) = Typ
OptimizeIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("IsInstanceOfType", typ7))
Typ = Typ03.GetMethod("IsInstanceOfType", typ7).ReturnType
OptimizeIL.Emit(OpCodes.Stloc, 4)
OptimizeIL.MarkSequencePoint(doc4, 59, 1, 59, 100)
OptimizeIL.Emit(OpCodes.Ldloc, 4)
Typ = GetType(System.Boolean)
OptimizeIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
...
OptimizeIL.MarkSequencePoint(doc4, 60, 1, 60, 100)
...
OptimizeIL.Emit(OpCodes.Beq, fa80)
OptimizeIL.Emit(OpCodes.Br, tru80)
OptimizeIL.MarkLabel(tru80)
OptimizeIL.MarkSequencePoint(doc4, 63, 1, 63, 100)
OptimizeIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
OptimizeIL.Emit(OpCodes.Stsfld, asm.GetType("dylan.NET.Tokenizer.Parser.ParserFlags").GetField("ConvFlag"))
OptimizeIL.MarkSequencePoint(doc4, 64, 1, 64, 100)
Dim typ8(-1) As Type
...
ReDim Preserve typ8(UBound(typ8) + 1)
typ8(UBound(typ8)) = Typ
OptimizeIL.Emit(OpCodes.Call, GetType(String).GetMethod("Concat", typ8))
...
OptimizeIL.MarkSequencePoint(doc4, 65, 1, 65, 100)
OptimizeIL.Emit(OpCodes.Ldsfld, asm.GetType("dylan.NET.Tokenizer.Parser.ParserFlags").GetField("OrdOp"))
Typ = asm.GetType("dylan.NET.Tokenizer.Parser.ParserFlags").GetField("OrdOp").FieldType
OptimizeIL.Emit(OpCodes.Stloc, 5)
OptimizeIL.MarkSequencePoint(doc4, 66, 1, 66, 100)
OptimizeIL.Emit(OpCodes.Ldloc, 5)
Typ = GetType(System.String)
Typ03 = Typ
...
OptimizeIL.Emit(OpCodes.Stloc, 5)
OptimizeIL.MarkSequencePoint(doc4, 67, 1, 67, 100)
OptimizeIL.Emit(OpCodes.Ldloc, 5)
Typ = GetType(System.String)
OptimizeIL.Emit(OpCodes.Stsfld, asm.GetType("dylan.NET.Tokenizer.Parser.ParserFlags").GetField("OrdOp"))
OptimizeIL.MarkSequencePoint(doc4, 68, 1, 68, 100)
OptimizeIL.Emit(OpCodes.Br, cont80)
OptimizeIL.MarkLabel(fa80)
OptimizeIL.Emit(OpCodes.Br, cont80)
OptimizeIL.MarkLabel(cont80)
OptimizeIL.MarkSequencePoint(doc4, 69, 1, 69, 100)
Dim typ10(-1) As Type
OptimizeIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Expr)
Typ03 = Typ
...
ReDim Preserve typ10(UBound(typ10) + 1)
typ10(UBound(typ10)) = Typ
OptimizeIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("RemToken", typ10))
Typ = Typ03.GetMethod("RemToken", typ10).ReturnType
If Typ.ToString() = GetType(System.Void).ToString() Then

Else
OptimizeIL.Emit(OpCodes.Pop)
End If
OptimizeIL.MarkSequencePoint(doc4, 70, 1, 70, 100)
OptimizeIL.Emit(OpCodes.Ldloc, 1)
Typ = GetType(System.Int32)
OptimizeIL.Emit(OpCodes.Ldc_I4, CInt(1))
Typ = GetType(System.Int32)
OptimizeIL.Emit(OpCodes.Sub)
OptimizeIL.Emit(OpCodes.Stloc, 1)
OptimizeIL.MarkSequencePoint(doc4, 71, 1, 71, 100)
OptimizeIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Expr)
OptimizeIL.Emit(OpCodes.Ldfld, GetType(Expr).GetField("Tokens"))
Typ = GetType(Expr).GetField("Tokens").FieldType
...
OptimizeIL.Emit(OpCodes.Sub)
OptimizeIL.Emit(OpCodes.Stloc, 0)
OptimizeIL.MarkSequencePoint(doc4, 72, 1, 72, 100)
OptimizeIL.Emit(OpCodes.Br, label2)
OptimizeIL.MarkSequencePoint(doc4, 73, 1, 73, 100)
OptimizeIL.Emit(OpCodes.Br, cont79)
OptimizeIL.MarkLabel(fa79)
OptimizeIL.Emit(OpCodes.Br, cont79)
OptimizeIL.MarkLabel(cont79)
OptimizeIL.MarkSequencePoint(doc4, 75, 1, 75, 100)
OptimizeIL.Emit(OpCodes.Ldtoken, GetType(TypeTok))
Dim typ11 As Type() = {GetType(System.RuntimeTypeHandle)}
OptimizeIL.Emit(OpCodes.Call, GetType(System.Type).GetMethod("GetTypeFromHandle", typ11))
Typ = GetType(System.Type).GetMethod("GetTypeFromHandle", typ11).ReturnType
OptimizeIL.Emit(OpCodes.Stloc, 3)
OptimizeIL.MarkSequencePoint(doc4, 76, 1, 76, 100)
Dim typ12(-1) As Type
OptimizeIL.Emit(OpCodes.Ldloc, 3)
Typ = GetType(System.Type)
Typ03 = Typ
...
ReDim Preserve typ12(UBound(typ12) + 1)
typ12(UBound(typ12)) = Typ
OptimizeIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("IsInstanceOfType", typ12))
Typ = Typ03.GetMethod("IsInstanceOfType", typ12).ReturnType
OptimizeIL.Emit(OpCodes.Stloc, 4)
OptimizeIL.MarkSequencePoint(doc4, 78, 1, 78, 100)
OptimizeIL.Emit(OpCodes.Ldloc, 4)
Typ = GetType(System.Boolean)
OptimizeIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
...
OptimizeIL.MarkSequencePoint(doc4, 79, 1, 79, 100)
OptimizeIL.Emit(OpCodes.Ldsfld, asm.GetType("dylan.NET.Tokenizer.Parser.ParserFlags").GetField("DurConvFlag"))
Typ = asm.GetType("dylan.NET.Tokenizer.Parser.ParserFlags").GetField("DurConvFlag").FieldType
OptimizeIL.Emit(OpCodes.Ldc_I4, 0)
Typ = GetType(System.Boolean)
...
OptimizeIL.Emit(OpCodes.Beq, fa82)
OptimizeIL.Emit(OpCodes.Br, tru82)
OptimizeIL.MarkLabel(tru82)
OptimizeIL.MarkSequencePoint(doc4, 80, 1, 80, 100)
Dim locbldr96 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(TypeTok))
locbldr96.SetLocalSymInfo("tt1")
OptimizeIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Expr)
OptimizeIL.Emit(OpCodes.Ldfld, GetType(Expr).GetField("Tokens"))
Typ = GetType(Expr).GetField("Tokens").FieldType
...
ReDim Preserve typ13(UBound(typ13) + 1)
typ13(UBound(typ13)) = Typ
OptimizeIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("RemToken", typ13))
Typ = Typ03.GetMethod("RemToken", typ13).ReturnType
If Typ.ToString() = GetType(System.Void).ToString() Then

Else
OptimizeIL.Emit(OpCodes.Pop)
End If
OptimizeIL.MarkSequencePoint(doc4, 83, 1, 83, 100)
OptimizeIL.Emit(OpCodes.Ldloc, 1)
Typ = GetType(System.Int32)
OptimizeIL.Emit(OpCodes.Ldc_I4, CInt(1))
Typ = GetType(System.Int32)
OptimizeIL.Emit(OpCodes.Sub)
OptimizeIL.Emit(OpCodes.Stloc, 1)
OptimizeIL.MarkSequencePoint(doc4, 84, 1, 84, 100)
OptimizeIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Expr)
OptimizeIL.Emit(OpCodes.Ldfld, GetType(Expr).GetField("Tokens"))
Typ = GetType(Expr).GetField("Tokens").FieldType
...
ReDim Preserve typ15(UBound(typ15) + 1)
typ15(UBound(typ15)) = Typ
OptimizeIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("IsInstanceOfType", typ15))
Typ = Typ03.GetMethod("IsInstanceOfType", typ15).ReturnType
OptimizeIL.Emit(OpCodes.Stloc, 4)
OptimizeIL.MarkSequencePoint(doc4, 92, 1, 92, 100)
OptimizeIL.Emit(OpCodes.Ldloc, 4)
Typ = GetType(System.Boolean)
OptimizeIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
...
OptimizeIL.MarkSequencePoint(doc4, 93, 1, 93, 100)
...
OptimizeIL.MarkSequencePoint(doc4, 94, 1, 94, 100)
Dim locbldr97 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(Ident))
locbldr97.SetLocalSymInfo("id1")
OptimizeIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Expr)
OptimizeIL.Emit(OpCodes.Ldfld, GetType(Expr).GetField("Tokens"))
Typ = GetType(Expr).GetField("Tokens").FieldType
...
Typ = Typ.GetElementType()
OptimizeIL.Emit(OpCodes.Stloc, 7)
OptimizeIL.MarkSequencePoint(doc4, 95, 1, 95, 100)
OptimizeIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Expr)
OptimizeIL.Emit(OpCodes.Ldfld, GetType(Expr).GetField("Tokens"))
Typ = GetType(Expr).GetField("Tokens").FieldType
...
ReDim Preserve typ16(UBound(typ16) + 1)
typ16(UBound(typ16)) = Typ
OptimizeIL.Emit(OpCodes.Call, asm.GetType("dylan.NET.Tokenizer.Parser.ParserFlags").GetMethod("UpdateIdent", typ16))
Typ = asm.GetType("dylan.NET.Tokenizer.Parser.ParserFlags").GetMethod("UpdateIdent", typ16).ReturnType
Typ = Typ02
OptimizeIL.Emit(OpCodes.Stelem, Typ.GetElementType())
OptimizeIL.MarkSequencePoint(doc4, 96, 1, 96, 100)
...
OptimizeIL.Emit(OpCodes.Pop)
End If
OptimizeIL.MarkSequencePoint(doc4, 97, 1, 97, 100)
OptimizeIL.Emit(OpCodes.Br, cont84)
OptimizeIL.MarkLabel(fa84)
OptimizeIL.Emit(OpCodes.Br, cont84)
OptimizeIL.MarkLabel(cont84)
OptimizeIL.MarkSequencePoint(doc4, 98, 1, 98, 100)
OptimizeIL.Emit(OpCodes.Br, label2)
OptimizeIL.MarkSequencePoint(doc4, 99, 1, 99, 100)
OptimizeIL.Emit(OpCodes.Br, cont83)
OptimizeIL.MarkLabel(fa83)
OptimizeIL.Emit(OpCodes.Br, cont83)
OptimizeIL.MarkLabel(cont83)
OptimizeIL.MarkSequencePoint(doc4, 101, 1, 101, 100)
OptimizeIL.MarkLabel(label2)
OptimizeIL.MarkSequencePoint(doc4, 103, 1, 103, 100)
OptimizeIL.Emit(OpCodes.Ldloc, 1)
Typ = GetType(System.Int32)
OptimizeIL.Emit(OpCodes.Ldloc, 0)
Typ = GetType(System.Int32)
...
OptimizeIL.MarkSequencePoint(doc4, 104, 1, 104, 100)
OptimizeIL.Emit(OpCodes.Br, label1)
OptimizeIL.MarkSequencePoint(doc4, 105, 1, 105, 100)
OptimizeIL.Emit(OpCodes.Br, cont85)
OptimizeIL.MarkLabel(fa85)
OptimizeIL.MarkSequencePoint(doc4, 106, 1, 106, 100)
OptimizeIL.Emit(OpCodes.Br, label0)
OptimizeIL.MarkSequencePoint(doc4, 107, 1, 107, 100)
OptimizeIL.Emit(OpCodes.Br, cont85)
OptimizeIL.MarkLabel(cont85)
OptimizeIL.MarkSequencePoint(doc4, 109, 1, 109, 100)
OptimizeIL.MarkLabel(label1)
OptimizeIL.MarkSequencePoint(doc4, 111, 1, 111, 100)
OptimizeIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Expr)
OptimizeIL.MarkSequencePoint(doc4, 112, 1, 112, 100)
OptimizeIL.Emit(OpCodes.Ret)
...
Dim locbldr98 As LocalBuilder = checkRefasmIL.DeclareLocal(GetType(Token))
locbldr98.SetLocalSymInfo("tok")
...
Dim locbldr99 As LocalBuilder = checkRefasmIL.DeclareLocal(GetType(System.Type))
...
Dim locbldr100 As LocalBuilder = checkRefasmIL.DeclareLocal(GetType(RefasmStmt))
locbldr100.SetLocalSymInfo("refasms")
...
Typ = GetType(System.Boolean)
Dim fa86 As System.Reflection.Emit.Label = checkRefasmIL.DefineLabel()
Dim tru86 As System.Reflection.Emit.Label = checkRefasmIL.DefineLabel()
Dim cont86 As System.Reflection.Emit.Label = checkRefasmIL.DefineLabel()
checkRefasmIL.Emit(OpCodes.Beq, tru86)
checkRefasmIL.Emit(OpCodes.Br, fa86)
checkRefasmIL.MarkLabel(tru86)
...
checkRefasmIL.Emit(OpCodes.Br, cont86)
checkRefasmIL.MarkLabel(fa86)
checkRefasmIL.Emit(OpCodes.Br, cont86)
checkRefasmIL.MarkLabel(cont86)
...
checkImportIL.MarkSequencePoint(doc5, 17, 1, 17, 100)
Dim locbldr101 As LocalBuilder = checkImportIL.DeclareLocal(GetType(Token))
...
checkImportIL.MarkSequencePoint(doc5, 18, 1, 18, 100)
Dim locbldr102 As LocalBuilder = checkImportIL.DeclareLocal(GetType(System.Type))
...
checkImportIL.MarkSequencePoint(doc5, 19, 1, 19, 100)
...
checkImportIL.MarkSequencePoint(doc5, 20, 1, 20, 100)
Dim locbldr103 As LocalBuilder = checkImportIL.DeclareLocal(GetType(ImportStmt))
locbldr103.SetLocalSymInfo("imps")
checkImportIL.Emit(OpCodes.Newobj, GetType(ImportStmt).GetConstructor(Type.EmptyTypes))
checkImportIL.Emit(OpCodes.Stloc, 2)
checkImportIL.MarkSequencePoint(doc5, 21, 1, 21, 100)
checkImportIL.Emit(OpCodes.Ldarg, 2)
Typ = GetType(System.Boolean).MakeByRefType()
...
Typ = GetType(System.Boolean)
Dim fa87 As System.Reflection.Emit.Label = checkImportIL.DefineLabel()
Dim tru87 As System.Reflection.Emit.Label = checkImportIL.DefineLabel()
Dim cont87 As System.Reflection.Emit.Label = checkImportIL.DefineLabel()
checkImportIL.Emit(OpCodes.Beq, tru87)
checkImportIL.Emit(OpCodes.Br, fa87)
checkImportIL.MarkLabel(tru87)
checkImportIL.MarkSequencePoint(doc5, 22, 1, 22, 100)
...
checkImportIL.MarkSequencePoint(doc5, 23, 1, 23, 100)
checkImportIL.Emit(OpCodes.Ldloc, 2)
Typ = GetType(ImportStmt)
checkImportIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
...
checkImportIL.MarkSequencePoint(doc5, 24, 1, 24, 100)
checkImportIL.Emit(OpCodes.Ldloc, 2)
Typ = GetType(ImportStmt)
checkImportIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
...
checkImportIL.MarkSequencePoint(doc5, 25, 1, 25, 100)
checkImportIL.Emit(OpCodes.Br, cont87)
checkImportIL.MarkLabel(fa87)
checkImportIL.Emit(OpCodes.Br, cont87)
checkImportIL.MarkLabel(cont87)
checkImportIL.MarkSequencePoint(doc5, 26, 1, 26, 100)
checkImportIL.Emit(OpCodes.Ldloc, 2)
Typ = GetType(ImportStmt)
checkImportIL.MarkSequencePoint(doc5, 27, 1, 27, 100)
...
checkLocimportIL.MarkSequencePoint(doc5, 30, 1, 30, 100)
Dim locbldr104 As LocalBuilder = checkLocimportIL.DeclareLocal(GetType(Token))
...
checkLocimportIL.MarkSequencePoint(doc5, 31, 1, 31, 100)
Dim locbldr105 As LocalBuilder = checkLocimportIL.DeclareLocal(GetType(System.Type))
...
checkLocimportIL.MarkSequencePoint(doc5, 32, 1, 32, 100)
...
checkLocimportIL.MarkSequencePoint(doc5, 33, 1, 33, 100)
Dim locbldr106 As LocalBuilder = checkLocimportIL.DeclareLocal(GetType(LocimportStmt))
locbldr106.SetLocalSymInfo("limps")
...
checkLocimportIL.MarkSequencePoint(doc5, 34, 1, 34, 100)
checkLocimportIL.Emit(OpCodes.Ldarg, 2)
Typ = GetType(System.Boolean).MakeByRefType()
...
Typ = GetType(System.Boolean)
Dim fa88 As System.Reflection.Emit.Label = checkLocimportIL.DefineLabel()
Dim tru88 As System.Reflection.Emit.Label = checkLocimportIL.DefineLabel()
Dim cont88 As System.Reflection.Emit.Label = checkLocimportIL.DefineLabel()
checkLocimportIL.Emit(OpCodes.Beq, tru88)
checkLocimportIL.Emit(OpCodes.Br, fa88)
checkLocimportIL.MarkLabel(tru88)
checkLocimportIL.MarkSequencePoint(doc5, 35, 1, 35, 100)
...
checkLocimportIL.MarkSequencePoint(doc5, 36, 1, 36, 100)
checkLocimportIL.Emit(OpCodes.Ldloc, 2)
Typ = GetType(LocimportStmt)
checkLocimportIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
...
checkLocimportIL.MarkSequencePoint(doc5, 37, 1, 37, 100)
checkLocimportIL.Emit(OpCodes.Ldloc, 2)
Typ = GetType(LocimportStmt)
checkLocimportIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
...
checkLocimportIL.MarkSequencePoint(doc5, 38, 1, 38, 100)
checkLocimportIL.Emit(OpCodes.Br, cont88)
checkLocimportIL.MarkLabel(fa88)
checkLocimportIL.Emit(OpCodes.Br, cont88)
checkLocimportIL.MarkLabel(cont88)
checkLocimportIL.MarkSequencePoint(doc5, 39, 1, 39, 100)
checkLocimportIL.Emit(OpCodes.Ldloc, 2)
Typ = GetType(LocimportStmt)
checkLocimportIL.MarkSequencePoint(doc5, 40, 1, 40, 100)
...
Dim checkCmt As MethodBuilder = StmtOptimizer.DefineMethod("checkCmt", MethodAttributes.Public, GetType(Stmt), typ9)
...
checkCmtIL.MarkSequencePoint(doc5, 43, 1, 43, 100)
Dim locbldr107 As LocalBuilder = checkCmtIL.DeclareLocal(GetType(Token))
...
checkCmtIL.MarkSequencePoint(doc5, 44, 1, 44, 100)
Dim locbldr108 As LocalBuilder = checkCmtIL.DeclareLocal(GetType(System.Type))
...
checkCmtIL.Emit(OpCodes.Call, GetType(System.Type).GetMethod("GetTypeFromHandle", typ10))
Typ = GetType(System.Type).GetMethod("GetTypeFromHandle", typ10).ReturnType
checkCmtIL.Emit(OpCodes.Stloc, 1)
checkCmtIL.MarkSequencePoint(doc5, 45, 1, 45, 100)
...
ReDim Preserve typ11(UBound(typ11) + 1)
typ11(UBound(typ11)) = Typ
checkCmtIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("IsInstanceOfType", typ11))
Typ = Typ03.GetMethod("IsInstanceOfType", typ11).ReturnType
checkCmtIL.Emit(OpCodes.Stobj, Typ04)
checkCmtIL.MarkSequencePoint(doc5, 46, 1, 46, 100)
Dim locbldr109 As LocalBuilder = checkCmtIL.DeclareLocal(GetType(CommentStmt))
locbldr109.SetLocalSymInfo("cmts")
checkCmtIL.Emit(OpCodes.Newobj, GetType(CommentStmt).GetConstructor(Type.EmptyTypes))
checkCmtIL.Emit(OpCodes.Stloc, 2)
checkCmtIL.MarkSequencePoint(doc5, 47, 1, 47, 100)
checkCmtIL.Emit(OpCodes.Ldarg, 2)
Typ = GetType(System.Boolean).MakeByRefType()
...
Typ = GetType(System.Boolean)
Dim fa89 As System.Reflection.Emit.Label = checkCmtIL.DefineLabel()
Dim tru89 As System.Reflection.Emit.Label = checkCmtIL.DefineLabel()
Dim cont89 As System.Reflection.Emit.Label = checkCmtIL.DefineLabel()
checkCmtIL.Emit(OpCodes.Beq, tru89)
checkCmtIL.Emit(OpCodes.Br, fa89)
checkCmtIL.MarkLabel(tru89)
checkCmtIL.MarkSequencePoint(doc5, 48, 1, 48, 100)
...
checkCmtIL.MarkSequencePoint(doc5, 49, 1, 49, 100)
checkCmtIL.Emit(OpCodes.Ldloc, 2)
Typ = GetType(CommentStmt)
checkCmtIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
...
checkCmtIL.MarkSequencePoint(doc5, 50, 1, 50, 100)
checkCmtIL.Emit(OpCodes.Br, cont89)
checkCmtIL.MarkLabel(fa89)
checkCmtIL.Emit(OpCodes.Br, cont89)
checkCmtIL.MarkLabel(cont89)
checkCmtIL.MarkSequencePoint(doc5, 51, 1, 51, 100)
checkCmtIL.Emit(OpCodes.Ldloc, 2)
Typ = GetType(CommentStmt)
checkCmtIL.MarkSequencePoint(doc5, 52, 1, 52, 100)
...
Dim checkEndMtd As MethodBuilder = StmtOptimizer.DefineMethod("checkEndMtd", MethodAttributes.Public, GetType(Stmt), typ12)
...
checkEndMtdIL.MarkSequencePoint(doc5, 55, 1, 55, 100)
...
Typ = GetType(System.Int32)
Dim fa90 As System.Reflection.Emit.Label = checkEndMtdIL.DefineLabel()
Dim tru90 As System.Reflection.Emit.Label = checkEndMtdIL.DefineLabel()
Dim cont90 As System.Reflection.Emit.Label = checkEndMtdIL.DefineLabel()
checkEndMtdIL.Emit(OpCodes.Bge, tru90)
checkEndMtdIL.Emit(OpCodes.Br, fa90)
checkEndMtdIL.MarkLabel(tru90)
checkEndMtdIL.MarkSequencePoint(doc5, 57, 1, 57, 100)
Dim locbldr110 As LocalBuilder = checkEndMtdIL.DeclareLocal(GetType(Token))
locbldr110.SetLocalSymInfo("tok1")
checkEndMtdIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
checkEndMtdIL.Emit(OpCodes.Ldfld, GetType(Stmt).GetField("Tokens"))
Typ = GetType(Stmt).GetField("Tokens").FieldType
...
checkEndMtdIL.MarkSequencePoint(doc5, 58, 1, 58, 100)
Dim locbldr111 As LocalBuilder = checkEndMtdIL.DeclareLocal(GetType(System.Type))
locbldr111.SetLocalSymInfo("typ1")
checkEndMtdIL.Emit(OpCodes.Ldtoken, GetType(EndTok))
Dim typ13 As Type() = {GetType(System.RuntimeTypeHandle)}
checkEndMtdIL.Emit(OpCodes.Call, GetType(System.Type).GetMethod("GetTypeFromHandle", typ13))
Typ = GetType(System.Type).GetMethod("GetTypeFromHandle", typ13).ReturnType
checkEndMtdIL.Emit(OpCodes.Stloc, 1)
checkEndMtdIL.MarkSequencePoint(doc5, 59, 1, 59, 100)
Dim locbldr112 As LocalBuilder = checkEndMtdIL.DeclareLocal(GetType(System.Boolean))
locbldr112.SetLocalSymInfo("b1")
Dim typ14(-1) As Type
...
ReDim Preserve typ14(UBound(typ14) + 1)
typ14(UBound(typ14)) = Typ
checkEndMtdIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("IsInstanceOfType", typ14))
Typ = Typ03.GetMethod("IsInstanceOfType", typ14).ReturnType
checkEndMtdIL.Emit(OpCodes.Stloc, 2)
checkEndMtdIL.MarkSequencePoint(doc5, 61, 1, 61, 100)
Dim locbldr113 As LocalBuilder = checkEndMtdIL.DeclareLocal(GetType(Token))
...
checkEndMtdIL.MarkSequencePoint(doc5, 62, 1, 62, 100)
Dim locbldr114 As LocalBuilder = checkEndMtdIL.DeclareLocal(GetType(System.Type))
...
checkEndMtdIL.Emit(OpCodes.Call, GetType(System.Type).GetMethod("GetTypeFromHandle", typ15))
Typ = GetType(System.Type).GetMethod("GetTypeFromHandle", typ15).ReturnType
checkEndMtdIL.Emit(OpCodes.Stloc, 4)
checkEndMtdIL.MarkSequencePoint(doc5, 63, 1, 63, 100)
Dim locbldr115 As LocalBuilder = checkEndMtdIL.DeclareLocal(GetType(System.Boolean))
...
ReDim Preserve typ16(UBound(typ16) + 1)
typ16(UBound(typ16)) = Typ
checkEndMtdIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("IsInstanceOfType", typ16))
Typ = Typ03.GetMethod("IsInstanceOfType", typ16).ReturnType
checkEndMtdIL.Emit(OpCodes.Stloc, 5)
checkEndMtdIL.MarkSequencePoint(doc5, 65, 1, 65, 100)
...
checkEndMtdIL.MarkSequencePoint(doc5, 67, 1, 67, 100)
Dim locbldr116 As LocalBuilder = checkEndMtdIL.DeclareLocal(GetType(EndMethodStmt))
locbldr116.SetLocalSymInfo("ems")
checkEndMtdIL.Emit(OpCodes.Newobj, GetType(EndMethodStmt).GetConstructor(Type.EmptyTypes))
checkEndMtdIL.Emit(OpCodes.Stloc, 6)
checkEndMtdIL.MarkSequencePoint(doc5, 68, 1, 68, 100)
checkEndMtdIL.Emit(OpCodes.Ldarg, 2)
Typ = GetType(System.Boolean).MakeByRefType()
...
Typ = GetType(System.Boolean)
Dim fa91 As System.Reflection.Emit.Label = checkEndMtdIL.DefineLabel()
Dim tru91 As System.Reflection.Emit.Label = checkEndMtdIL.DefineLabel()
Dim cont91 As System.Reflection.Emit.Label = checkEndMtdIL.DefineLabel()
checkEndMtdIL.Emit(OpCodes.Beq, tru91)
checkEndMtdIL.Emit(OpCodes.Br, fa91)
checkEndMtdIL.MarkLabel(tru91)
checkEndMtdIL.MarkSequencePoint(doc5, 69, 1, 69, 100)
...
checkEndMtdIL.MarkSequencePoint(doc5, 71, 1, 71, 100)
checkEndMtdIL.Emit(OpCodes.Br, cont91)
checkEndMtdIL.MarkLabel(fa91)
checkEndMtdIL.Emit(OpCodes.Br, cont91)
checkEndMtdIL.MarkLabel(cont91)
checkEndMtdIL.MarkSequencePoint(doc5, 72, 1, 72, 100)
checkEndMtdIL.Emit(OpCodes.Br, cont90)
checkEndMtdIL.MarkLabel(fa90)
checkEndMtdIL.Emit(OpCodes.Br, cont90)
checkEndMtdIL.MarkLabel(cont90)
...
Dim checkEndCls As MethodBuilder = StmtOptimizer.DefineMethod("checkEndCls", MethodAttributes.Public, GetType(Stmt), typ17)
...
checkEndClsIL.MarkSequencePoint(doc5, 77, 1, 77, 100)
...
Typ = GetType(System.Int32)
Dim fa92 As System.Reflection.Emit.Label = checkEndClsIL.DefineLabel()
Dim tru92 As System.Reflection.Emit.Label = checkEndClsIL.DefineLabel()
Dim cont92 As System.Reflection.Emit.Label = checkEndClsIL.DefineLabel()
checkEndClsIL.Emit(OpCodes.Bge, tru92)
checkEndClsIL.Emit(OpCodes.Br, fa92)
checkEndClsIL.MarkLabel(tru92)
checkEndClsIL.MarkSequencePoint(doc5, 79, 1, 79, 100)
Dim locbldr117 As LocalBuilder = checkEndClsIL.DeclareLocal(GetType(Token))
locbldr117.SetLocalSymInfo("tok1")
checkEndClsIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
checkEndClsIL.Emit(OpCodes.Ldfld, GetType(Stmt).GetField("Tokens"))
Typ = GetType(Stmt).GetField("Tokens").FieldType
...
checkEndClsIL.MarkSequencePoint(doc5, 80, 1, 80, 100)
Dim locbldr118 As LocalBuilder = checkEndClsIL.DeclareLocal(GetType(System.Type))
locbldr118.SetLocalSymInfo("typ1")
checkEndClsIL.Emit(OpCodes.Ldtoken, GetType(EndTok))
Dim typ18 As Type() = {GetType(System.RuntimeTypeHandle)}
checkEndClsIL.Emit(OpCodes.Call, GetType(System.Type).GetMethod("GetTypeFromHandle", typ18))
Typ = GetType(System.Type).GetMethod("GetTypeFromHandle", typ18).ReturnType
checkEndClsIL.Emit(OpCodes.Stloc, 1)
checkEndClsIL.MarkSequencePoint(doc5, 81, 1, 81, 100)
Dim locbldr119 As LocalBuilder = checkEndClsIL.DeclareLocal(GetType(System.Boolean))
locbldr119.SetLocalSymInfo("b1")
Dim typ19(-1) As Type
...
ReDim Preserve typ19(UBound(typ19) + 1)
typ19(UBound(typ19)) = Typ
checkEndClsIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("IsInstanceOfType", typ19))
Typ = Typ03.GetMethod("IsInstanceOfType", typ19).ReturnType
checkEndClsIL.Emit(OpCodes.Stloc, 2)
checkEndClsIL.MarkSequencePoint(doc5, 83, 1, 83, 100)
Dim locbldr120 As LocalBuilder = checkEndClsIL.DeclareLocal(GetType(Token))
locbldr120.SetLocalSymInfo("tok2")
checkEndClsIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
checkEndClsIL.Emit(OpCodes.Ldfld, GetType(Stmt).GetField("Tokens"))
Typ = GetType(Stmt).GetField("Tokens").FieldType
...
checkEndClsIL.MarkSequencePoint(doc5, 84, 1, 84, 100)
Dim locbldr121 As LocalBuilder = checkEndClsIL.DeclareLocal(GetType(System.Type))
locbldr121.SetLocalSymInfo("typ2")
checkEndClsIL.Emit(OpCodes.Ldtoken, GetType(ClassTok))
Dim typ20 As Type() = {GetType(System.RuntimeTypeHandle)}
checkEndClsIL.Emit(OpCodes.Call, GetType(System.Type).GetMethod("GetTypeFromHandle", typ20))
Typ = GetType(System.Type).GetMethod("GetTypeFromHandle", typ20).ReturnType
checkEndClsIL.Emit(OpCodes.Stloc, 4)
checkEndClsIL.MarkSequencePoint(doc5, 85, 1, 85, 100)
Dim locbldr122 As LocalBuilder = checkEndClsIL.DeclareLocal(GetType(System.Boolean))
locbldr122.SetLocalSymInfo("b2")
Dim typ21(-1) As Type
...
ReDim Preserve typ21(UBound(typ21) + 1)
typ21(UBound(typ21)) = Typ
checkEndClsIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("IsInstanceOfType", typ21))
Typ = Typ03.GetMethod("IsInstanceOfType", typ21).ReturnType
checkEndClsIL.Emit(OpCodes.Stloc, 5)
checkEndClsIL.MarkSequencePoint(doc5, 87, 1, 87, 100)
...
checkEndClsIL.MarkSequencePoint(doc5, 89, 1, 89, 100)
Dim locbldr123 As LocalBuilder = checkEndClsIL.DeclareLocal(GetType(EndClassStmt))
locbldr123.SetLocalSymInfo("ecs")
checkEndClsIL.Emit(OpCodes.Newobj, GetType(EndClassStmt).GetConstructor(Type.EmptyTypes))
checkEndClsIL.Emit(OpCodes.Stloc, 6)
checkEndClsIL.MarkSequencePoint(doc5, 90, 1, 90, 100)
checkEndClsIL.Emit(OpCodes.Ldarg, 2)
Typ = GetType(System.Boolean).MakeByRefType()
...
Typ = GetType(System.Boolean)
Dim fa93 As System.Reflection.Emit.Label = checkEndClsIL.DefineLabel()
Dim tru93 As System.Reflection.Emit.Label = checkEndClsIL.DefineLabel()
Dim cont93 As System.Reflection.Emit.Label = checkEndClsIL.DefineLabel()
checkEndClsIL.Emit(OpCodes.Beq, tru93)
checkEndClsIL.Emit(OpCodes.Br, fa93)
checkEndClsIL.MarkLabel(tru93)
checkEndClsIL.MarkSequencePoint(doc5, 91, 1, 91, 100)
...
checkEndClsIL.MarkSequencePoint(doc5, 93, 1, 93, 100)
checkEndClsIL.Emit(OpCodes.Br, cont93)
checkEndClsIL.MarkLabel(fa93)
checkEndClsIL.Emit(OpCodes.Br, cont93)
checkEndClsIL.MarkLabel(cont93)
checkEndClsIL.MarkSequencePoint(doc5, 94, 1, 94, 100)
checkEndClsIL.Emit(OpCodes.Br, cont92)
checkEndClsIL.MarkLabel(fa92)
checkEndClsIL.Emit(OpCodes.Br, cont92)
checkEndClsIL.MarkLabel(cont92)
...
Dim typ22(-1) As Type
ReDim Preserve typ22(UBound(typ22) + 1)
typ22(UBound(typ22)) = GetType(Stmt)
ReDim Preserve typ22(UBound(typ22) + 1)
typ22(UBound(typ22)) = GetType(System.Boolean).MakeByRefType()
Dim checkAssembly As MethodBuilder = StmtOptimizer.DefineMethod("checkAssembly", MethodAttributes.Public, GetType(Stmt), typ22)
...
checkAssemblyIL.MarkSequencePoint(doc5, 99, 1, 99, 100)
Dim locbldr124 As LocalBuilder = checkAssemblyIL.DeclareLocal(GetType(Token))
locbldr124.SetLocalSymInfo("tok")
...
checkAssemblyIL.MarkSequencePoint(doc5, 100, 1, 100, 100)
Dim locbldr125 As LocalBuilder = checkAssemblyIL.DeclareLocal(GetType(System.Type))
...
checkAssemblyIL.Emit(OpCodes.Call, GetType(System.Type).GetMethod("GetTypeFromHandle", typ23))
Typ = GetType(System.Type).GetMethod("GetTypeFromHandle", typ23).ReturnType
checkAssemblyIL.Emit(OpCodes.Stloc, 1)
checkAssemblyIL.MarkSequencePoint(doc5, 101, 1, 101, 100)
...
ReDim Preserve typ24(UBound(typ24) + 1)
typ24(UBound(typ24)) = Typ
checkAssemblyIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("IsInstanceOfType", typ24))
Typ = Typ03.GetMethod("IsInstanceOfType", typ24).ReturnType
checkAssemblyIL.Emit(OpCodes.Stobj, Typ04)
checkAssemblyIL.MarkSequencePoint(doc5, 102, 1, 102, 100)
Dim locbldr126 As LocalBuilder = checkAssemblyIL.DeclareLocal(GetType(AssemblyStmt))
locbldr126.SetLocalSymInfo("asms")
...
checkAssemblyIL.MarkSequencePoint(doc5, 103, 1, 103, 100)
checkAssemblyIL.Emit(OpCodes.Ldarg, 2)
Typ = GetType(System.Boolean).MakeByRefType()
...
Typ = GetType(System.Boolean)
Dim fa94 As System.Reflection.Emit.Label = checkAssemblyIL.DefineLabel()
Dim tru94 As System.Reflection.Emit.Label = checkAssemblyIL.DefineLabel()
Dim cont94 As System.Reflection.Emit.Label = checkAssemblyIL.DefineLabel()
checkAssemblyIL.Emit(OpCodes.Beq, tru94)
checkAssemblyIL.Emit(OpCodes.Br, fa94)
checkAssemblyIL.MarkLabel(tru94)
checkAssemblyIL.MarkSequencePoint(doc5, 104, 1, 104, 100)
...
checkAssemblyIL.MarkSequencePoint(doc5, 105, 1, 105, 100)
checkAssemblyIL.Emit(OpCodes.Ldloc, 2)
Typ = GetType(AssemblyStmt)
checkAssemblyIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
...
checkAssemblyIL.MarkSequencePoint(doc5, 106, 1, 106, 100)
checkAssemblyIL.Emit(OpCodes.Ldloc, 2)
Typ = GetType(AssemblyStmt)
checkAssemblyIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
...
checkAssemblyIL.MarkSequencePoint(doc5, 107, 1, 107, 100)
checkAssemblyIL.Emit(OpCodes.Ldloc, 2)
Typ = GetType(AssemblyStmt)
checkAssemblyIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
...
checkAssemblyIL.MarkSequencePoint(doc5, 108, 1, 108, 100)
checkAssemblyIL.Emit(OpCodes.Br, cont94)
checkAssemblyIL.MarkLabel(fa94)
checkAssemblyIL.Emit(OpCodes.Br, cont94)
checkAssemblyIL.MarkLabel(cont94)
checkAssemblyIL.MarkSequencePoint(doc5, 109, 1, 109, 100)
checkAssemblyIL.Emit(OpCodes.Ldloc, 2)
Typ = GetType(AssemblyStmt)
checkAssemblyIL.MarkSequencePoint(doc5, 110, 1, 110, 100)
...
Dim checkVer As MethodBuilder = StmtOptimizer.DefineMethod("checkVer", MethodAttributes.Public, GetType(Stmt), typ25)
...
checkVerIL.MarkSequencePoint(doc5, 113, 1, 113, 100)
Dim locbldr127 As LocalBuilder = checkVerIL.DeclareLocal(GetType(Token))
locbldr127.SetLocalSymInfo("tok")
...
checkVerIL.MarkSequencePoint(doc5, 114, 1, 114, 100)
Dim locbldr128 As LocalBuilder = checkVerIL.DeclareLocal(GetType(System.Type))
...
checkVerIL.Emit(OpCodes.Call, GetType(System.Type).GetMethod("GetTypeFromHandle", typ26))
Typ = GetType(System.Type).GetMethod("GetTypeFromHandle", typ26).ReturnType
checkVerIL.Emit(OpCodes.Stloc, 1)
checkVerIL.MarkSequencePoint(doc5, 115, 1, 115, 100)
...
ReDim Preserve typ27(UBound(typ27) + 1)
typ27(UBound(typ27)) = Typ
checkVerIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("IsInstanceOfType", typ27))
Typ = Typ03.GetMethod("IsInstanceOfType", typ27).ReturnType
checkVerIL.Emit(OpCodes.Stobj, Typ04)
checkVerIL.MarkSequencePoint(doc5, 116, 1, 116, 100)
Dim locbldr129 As LocalBuilder = checkVerIL.DeclareLocal(GetType(VerStmt))
locbldr129.SetLocalSymInfo("vers")
checkVerIL.Emit(OpCodes.Newobj, GetType(VerStmt).GetConstructor(Type.EmptyTypes))
checkVerIL.Emit(OpCodes.Stloc, 2)
checkVerIL.MarkSequencePoint(doc5, 117, 1, 117, 100)
checkVerIL.Emit(OpCodes.Ldarg, 2)
Typ = GetType(System.Boolean).MakeByRefType()
...
Typ = GetType(System.Boolean)
Dim fa95 As System.Reflection.Emit.Label = checkVerIL.DefineLabel()
Dim tru95 As System.Reflection.Emit.Label = checkVerIL.DefineLabel()
Dim cont95 As System.Reflection.Emit.Label = checkVerIL.DefineLabel()
checkVerIL.Emit(OpCodes.Beq, tru95)
checkVerIL.Emit(OpCodes.Br, fa95)
checkVerIL.MarkLabel(tru95)
checkVerIL.MarkSequencePoint(doc5, 118, 1, 118, 100)
...
checkVerIL.MarkSequencePoint(doc5, 119, 1, 119, 100)
checkVerIL.Emit(OpCodes.Ldloc, 2)
Typ = GetType(VerStmt)
checkVerIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
...
checkVerIL.MarkSequencePoint(doc5, 120, 1, 120, 100)
checkVerIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
checkVerIL.Emit(OpCodes.Ldfld, GetType(Stmt).GetField("Tokens"))
Typ = GetType(Stmt).GetField("Tokens").FieldType
...
Typ = Typ.GetElementType()
checkVerIL.Emit(OpCodes.Stloc, 0)
checkVerIL.MarkSequencePoint(doc5, 121, 1, 121, 100)
Dim locbldr130 As LocalBuilder = checkVerIL.DeclareLocal(GetType(System.String).MakeArrayType())
locbldr130.SetLocalSymInfo("ars")
Dim typ28(-1) As Type
checkVerIL.Emit(OpCodes.Ldloc, 0)
Typ = GetType(Token)
...
ReDim Preserve typ28(UBound(typ28) + 1)
typ28(UBound(typ28)) = Typ
checkVerIL.Emit(OpCodes.Call, GetType(Utils.ParseUtils).GetMethod("StringParser", typ28))
Typ = GetType(Utils.ParseUtils).GetMethod("StringParser", typ28).ReturnType
checkVerIL.Emit(OpCodes.Stloc, 3)
checkVerIL.MarkSequencePoint(doc5, 122, 1, 122, 100)
Dim locbldr131 As LocalBuilder = checkVerIL.DeclareLocal(GetType(System.Int32).MakeArrayType())
locbldr131.SetLocalSymInfo("ari")
checkVerIL.Emit(OpCodes.Ldc_I4, CInt(4))
Typ = GetType(System.Int32)
checkVerIL.Emit(OpCodes.Conv_U)
checkVerIL.Emit(OpCodes.Newarr, GetType(System.Int32))
checkVerIL.Emit(OpCodes.Stloc, 4)
checkVerIL.MarkSequencePoint(doc5, 123, 1, 123, 100)
...
checkVerIL.Emit(OpCodes.Call, GetType(System.Convert).GetMethod("ToInt32", typ29))
Typ = GetType(System.Convert).GetMethod("ToInt32", typ29).ReturnType
checkVerIL.Emit(OpCodes.Stelem, GetType(System.Int32).MakeArrayType().GetElementType())
checkVerIL.MarkSequencePoint(doc5, 124, 1, 124, 100)
checkVerIL.Emit(OpCodes.Ldloc, 4)
Typ = GetType(System.Int32).MakeArrayType()
Typ02 = Typ
checkVerIL.Emit(OpCodes.Ldc_I4, CInt(1))
...
checkVerIL.Emit(OpCodes.Call, GetType(System.Convert).GetMethod("ToInt32", typ30))
Typ = GetType(System.Convert).GetMethod("ToInt32", typ30).ReturnType
checkVerIL.Emit(OpCodes.Stelem, GetType(System.Int32).MakeArrayType().GetElementType())
checkVerIL.MarkSequencePoint(doc5, 125, 1, 125, 100)
checkVerIL.Emit(OpCodes.Ldloc, 4)
Typ = GetType(System.Int32).MakeArrayType()
Typ02 = Typ
...
checkVerIL.Emit(OpCodes.Ldelem, GetType(System.String).MakeArrayType().GetElementType())
Typ = GetType(System.String).MakeArrayType().GetElementType()
Dim typ31 As Type() = {Typ}
checkVerIL.Emit(OpCodes.Call, GetType(System.Convert).GetMethod("ToInt32", typ31))
Typ = GetType(System.Convert).GetMethod("ToInt32", typ31).ReturnType
checkVerIL.Emit(OpCodes.Stelem, GetType(System.Int32).MakeArrayType().GetElementType())
checkVerIL.MarkSequencePoint(doc5, 126, 1, 126, 100)
checkVerIL.Emit(OpCodes.Ldloc, 4)
Typ = GetType(System.Int32).MakeArrayType()
Typ02 = Typ
...
checkVerIL.Emit(OpCodes.Call, GetType(System.Convert).GetMethod("ToInt32", typ32))
Typ = GetType(System.Convert).GetMethod("ToInt32", typ32).ReturnType
checkVerIL.Emit(OpCodes.Stelem, GetType(System.Int32).MakeArrayType().GetElementType())
checkVerIL.MarkSequencePoint(doc5, 127, 1, 127, 100)
Dim locbldr132 As LocalBuilder = checkVerIL.DeclareLocal(GetType(IntLiteral).MakeArrayType())
locbldr132.SetLocalSymInfo("intla")
checkVerIL.Emit(OpCodes.Ldc_I4, CInt(4))
Typ = GetType(System.Int32)
checkVerIL.Emit(OpCodes.Conv_U)
...
Dim locbldr133 As LocalBuilder = checkVerIL.DeclareLocal(GetType(IntLiteral))
locbldr133.SetLocalSymInfo("intl")
...
ReDim Preserve typ33(UBound(typ33) + 1)
typ33(UBound(typ33)) = Typ
checkVerIL.Emit(OpCodes.Newobj, GetType(IntLiteral).GetConstructor(typ33))
checkVerIL.Emit(OpCodes.Stloc, 6)
...
ReDim Preserve typ34(UBound(typ34) + 1)
typ34(UBound(typ34)) = Typ
checkVerIL.Emit(OpCodes.Newobj, GetType(IntLiteral).GetConstructor(typ34))
checkVerIL.Emit(OpCodes.Stloc, 6)
...
ReDim Preserve typ35(UBound(typ35) + 1)
typ35(UBound(typ35)) = Typ
checkVerIL.Emit(OpCodes.Newobj, GetType(IntLiteral).GetConstructor(typ35))
checkVerIL.Emit(OpCodes.Stloc, 6)
...
ReDim Preserve typ36(UBound(typ36) + 1)
typ36(UBound(typ36)) = Typ
checkVerIL.Emit(OpCodes.Newobj, GetType(IntLiteral).GetConstructor(typ36))
checkVerIL.Emit(OpCodes.Stloc, 6)
...
checkVerIL.Emit(OpCodes.Br, cont95)
checkVerIL.MarkLabel(fa95)
checkVerIL.Emit(OpCodes.Br, cont95)
checkVerIL.MarkLabel(cont95)
...
Dim typ37(-1) As Type
ReDim Preserve typ37(UBound(typ37) + 1)
typ37(UBound(typ37)) = GetType(Stmt)
ReDim Preserve typ37(UBound(typ37) + 1)
typ37(UBound(typ37)) = GetType(System.Boolean).MakeByRefType()
Dim checkClass As MethodBuilder = StmtOptimizer.DefineMethod("checkClass", MethodAttributes.Public, GetType(Stmt), typ37)
...
checkClassIL.MarkSequencePoint(doc5, 151, 1, 151, 100)
Dim locbldr134 As LocalBuilder = checkClassIL.DeclareLocal(GetType(Token))
...
checkClassIL.MarkSequencePoint(doc5, 152, 1, 152, 100)
Dim locbldr135 As LocalBuilder = checkClassIL.DeclareLocal(GetType(System.Type))
...
checkClassIL.Emit(OpCodes.Call, GetType(System.Type).GetMethod("GetTypeFromHandle", typ38))
Typ = GetType(System.Type).GetMethod("GetTypeFromHandle", typ38).ReturnType
checkClassIL.Emit(OpCodes.Stloc, 1)
checkClassIL.MarkSequencePoint(doc5, 153, 1, 153, 100)
...
ReDim Preserve typ39(UBound(typ39) + 1)
typ39(UBound(typ39)) = Typ
checkClassIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("IsInstanceOfType", typ39))
Typ = Typ03.GetMethod("IsInstanceOfType", typ39).ReturnType
checkClassIL.Emit(OpCodes.Stobj, Typ04)
checkClassIL.MarkSequencePoint(doc5, 154, 1, 154, 100)
Dim locbldr136 As LocalBuilder = checkClassIL.DeclareLocal(GetType(ClassStmt))
locbldr136.SetLocalSymInfo("clss")
checkClassIL.Emit(OpCodes.Newobj, GetType(ClassStmt).GetConstructor(Type.EmptyTypes))
checkClassIL.Emit(OpCodes.Stloc, 2)
checkClassIL.MarkSequencePoint(doc5, 155, 1, 155, 100)
Dim locbldr137 As LocalBuilder = checkClassIL.DeclareLocal(GetType(Attributes.Attribute))
locbldr137.SetLocalSymInfo("att")
checkClassIL.Emit(OpCodes.Ldnull)
checkClassIL.Emit(OpCodes.Stloc, 3)
checkClassIL.MarkSequencePoint(doc5, 156, 1, 156, 100)
checkClassIL.Emit(OpCodes.Ldarg, 2)
Typ = GetType(System.Boolean).MakeByRefType()
...
Typ = GetType(System.Boolean)
Dim fa96 As System.Reflection.Emit.Label = checkClassIL.DefineLabel()
Dim tru96 As System.Reflection.Emit.Label = checkClassIL.DefineLabel()
Dim cont96 As System.Reflection.Emit.Label = checkClassIL.DefineLabel()
checkClassIL.Emit(OpCodes.Beq, tru96)
checkClassIL.Emit(OpCodes.Br, fa96)
checkClassIL.MarkLabel(tru96)
checkClassIL.MarkSequencePoint(doc5, 158, 1, 158, 100)
...
checkClassIL.MarkSequencePoint(doc5, 159, 1, 159, 100)
checkClassIL.Emit(OpCodes.Ldloc, 2)
Typ = GetType(ClassStmt)
checkClassIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
...
checkClassIL.MarkSequencePoint(doc5, 161, 1, 161, 100)
Dim label0 As System.Reflection.Emit.Label = checkClassIL.DefineLabel()
checkClassIL.MarkSequencePoint(doc5, 162, 1, 162, 100)
Dim label1 As System.Reflection.Emit.Label = checkClassIL.DefineLabel()
checkClassIL.MarkSequencePoint(doc5, 164, 1, 164, 100)
Dim locbldr138 As LocalBuilder = checkClassIL.DeclareLocal(GetType(System.Int32))
locbldr138.SetLocalSymInfo("i")
checkClassIL.Emit(OpCodes.Ldc_I4, CInt(0))
Typ = GetType(System.Int32)
checkClassIL.Emit(OpCodes.Stloc, 4)
checkClassIL.MarkSequencePoint(doc5, 165, 1, 165, 100)
Dim locbldr139 As LocalBuilder = checkClassIL.DeclareLocal(GetType(System.Int32))
locbldr139.SetLocalSymInfo("len")
checkClassIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
checkClassIL.Emit(OpCodes.Ldfld, GetType(Stmt).GetField("Tokens"))
Typ = GetType(Stmt).GetField("Tokens").FieldType
...
Dim locbldr140 As LocalBuilder = checkClassIL.DeclareLocal(GetType(System.Boolean))
locbldr140.SetLocalSymInfo("bl")
...
Typ = Typ.GetElementType()
checkClassIL.Emit(OpCodes.Stloc, 0)
checkClassIL.MarkSequencePoint(doc5, 172, 1, 172, 100)
checkClassIL.Emit(OpCodes.Ldtoken, GetType(Attributes.Attribute))
Dim typ40 As Type() = {GetType(System.RuntimeTypeHandle)}
checkClassIL.Emit(OpCodes.Call, GetType(System.Type).GetMethod("GetTypeFromHandle", typ40))
...
ReDim Preserve typ41(UBound(typ41) + 1)
typ41(UBound(typ41)) = Typ
checkClassIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("IsInstanceOfType", typ41))
...
checkClassIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa97 As System.Reflection.Emit.Label = checkClassIL.DefineLabel()
Dim tru97 As System.Reflection.Emit.Label = checkClassIL.DefineLabel()
Dim cont97 As System.Reflection.Emit.Label = checkClassIL.DefineLabel()
checkClassIL.Emit(OpCodes.Beq, tru97)
checkClassIL.Emit(OpCodes.Br, fa97)
checkClassIL.MarkLabel(tru97)
...
ReDim Preserve typ42(UBound(typ42) + 1)
typ42(UBound(typ42)) = Typ
checkClassIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("AddAttr", typ42))
Typ = Typ03.GetMethod("AddAttr", typ42).ReturnType
If Typ.ToString() = GetType(System.Void).ToString() Then
...
checkClassIL.Emit(OpCodes.Br, cont97)
checkClassIL.MarkLabel(fa97)
checkClassIL.MarkSequencePoint(doc5, 180, 1, 180, 100)
Dim locbldr141 As LocalBuilder = checkClassIL.DeclareLocal(GetType(Token))
...
Dim locbldr142 As LocalBuilder = checkClassIL.DeclareLocal(GetType(System.Type))
...
checkClassIL.Emit(OpCodes.Call, GetType(System.Type).GetMethod("GetTypeFromHandle", typ43))
...
Dim locbldr143 As LocalBuilder = checkClassIL.DeclareLocal(GetType(System.Boolean))
...
ReDim Preserve typ44(UBound(typ44) + 1)
typ44(UBound(typ44)) = Typ
checkClassIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("IsInstanceOfType", typ44))
...
checkClassIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa98 As System.Reflection.Emit.Label = checkClassIL.DefineLabel()
Dim tru98 As System.Reflection.Emit.Label = checkClassIL.DefineLabel()
Dim cont98 As System.Reflection.Emit.Label = checkClassIL.DefineLabel()
checkClassIL.Emit(OpCodes.Beq, tru98)
checkClassIL.Emit(OpCodes.Br, fa98)
checkClassIL.MarkLabel(tru98)
...
checkClassIL.Emit(OpCodes.Call, GetType(System.Type).GetMethod("GetTypeFromHandle", typ45))
...
ReDim Preserve typ46(UBound(typ46) + 1)
typ46(UBound(typ46)) = Typ
checkClassIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("IsInstanceOfType", typ46))
...
checkClassIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa99 As System.Reflection.Emit.Label = checkClassIL.DefineLabel()
Dim tru99 As System.Reflection.Emit.Label = checkClassIL.DefineLabel()
Dim cont99 As System.Reflection.Emit.Label = checkClassIL.DefineLabel()
checkClassIL.Emit(OpCodes.Beq, fa99)
checkClassIL.Emit(OpCodes.Br, tru99)
checkClassIL.MarkLabel(tru99)
checkClassIL.MarkSequencePoint(doc5, 191, 1, 191, 100)
Dim locbldr144 As LocalBuilder = checkClassIL.DeclareLocal(GetType(Token))
locbldr144.SetLocalSymInfo("t")
checkClassIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
checkClassIL.Emit(OpCodes.Ldfld, GetType(Stmt).GetField("Tokens"))
Typ = GetType(Stmt).GetField("Tokens").FieldType
...
Dim locbldr145 As LocalBuilder = checkClassIL.DeclareLocal(GetType(TypeTok))
locbldr145.SetLocalSymInfo("tt")
...
checkClassIL.Emit(OpCodes.Br, cont99)
checkClassIL.MarkLabel(fa99)
...
checkClassIL.Emit(OpCodes.Br, cont99)
checkClassIL.MarkLabel(cont99)
checkClassIL.MarkSequencePoint(doc5, 199, 1, 199, 100)
checkClassIL.Emit(OpCodes.Br, cont98)
checkClassIL.MarkLabel(fa98)
...
checkClassIL.Emit(OpCodes.Br, cont98)
checkClassIL.MarkLabel(cont98)
checkClassIL.MarkSequencePoint(doc5, 203, 1, 203, 100)
checkClassIL.Emit(OpCodes.Br, cont97)
checkClassIL.MarkLabel(cont97)
checkClassIL.MarkSequencePoint(doc5, 205, 1, 205, 100)
checkClassIL.Emit(OpCodes.Ldloc, 4)
Typ = GetType(System.Int32)
checkClassIL.Emit(OpCodes.Ldloc, 5)
Typ = GetType(System.Int32)
Dim fa100 As System.Reflection.Emit.Label = checkClassIL.DefineLabel()
Dim tru100 As System.Reflection.Emit.Label = checkClassIL.DefineLabel()
Dim cont100 As System.Reflection.Emit.Label = checkClassIL.DefineLabel()
checkClassIL.Emit(OpCodes.Beq, tru100)
checkClassIL.Emit(OpCodes.Br, fa100)
checkClassIL.MarkLabel(tru100)
...
checkClassIL.Emit(OpCodes.Br, cont100)
checkClassIL.MarkLabel(fa100)
...
checkClassIL.Emit(OpCodes.Br, cont100)
checkClassIL.MarkLabel(cont100)
...
checkClassIL.Emit(OpCodes.Br, cont96)
checkClassIL.MarkLabel(fa96)
checkClassIL.Emit(OpCodes.Br, cont96)
checkClassIL.MarkLabel(cont96)
...
Dim checkMethod As MethodBuilder = StmtOptimizer.DefineMethod("checkMethod", MethodAttributes.Public, GetType(Stmt), typ47)
...
checkMethodIL.MarkSequencePoint(doc5, 219, 1, 219, 100)
Dim locbldr146 As LocalBuilder = checkMethodIL.DeclareLocal(GetType(Token))
...
checkMethodIL.MarkSequencePoint(doc5, 220, 1, 220, 100)
Dim locbldr147 As LocalBuilder = checkMethodIL.DeclareLocal(GetType(System.Type))
...
checkMethodIL.Emit(OpCodes.Call, GetType(System.Type).GetMethod("GetTypeFromHandle", typ48))
Typ = GetType(System.Type).GetMethod("GetTypeFromHandle", typ48).ReturnType
checkMethodIL.Emit(OpCodes.Stloc, 1)
checkMethodIL.MarkSequencePoint(doc5, 221, 1, 221, 100)
...
ReDim Preserve typ49(UBound(typ49) + 1)
typ49(UBound(typ49)) = Typ
checkMethodIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("IsInstanceOfType", typ49))
Typ = Typ03.GetMethod("IsInstanceOfType", typ49).ReturnType
checkMethodIL.Emit(OpCodes.Stobj, Typ04)
checkMethodIL.MarkSequencePoint(doc5, 222, 1, 222, 100)
Dim locbldr148 As LocalBuilder = checkMethodIL.DeclareLocal(GetType(MethodStmt))
locbldr148.SetLocalSymInfo("mtss")
checkMethodIL.Emit(OpCodes.Newobj, GetType(MethodStmt).GetConstructor(Type.EmptyTypes))
checkMethodIL.Emit(OpCodes.Stloc, 2)
checkMethodIL.MarkSequencePoint(doc5, 223, 1, 223, 100)
Dim locbldr149 As LocalBuilder = checkMethodIL.DeclareLocal(GetType(Attributes.Attribute))
locbldr149.SetLocalSymInfo("att")
...
checkMethodIL.MarkSequencePoint(doc5, 224, 1, 224, 100)
Dim locbldr150 As LocalBuilder = checkMethodIL.DeclareLocal(GetType(Ident))
locbldr150.SetLocalSymInfo("mn")
checkMethodIL.Emit(OpCodes.Newobj, GetType(Ident).GetConstructor(Type.EmptyTypes))
checkMethodIL.Emit(OpCodes.Stloc, 4)
checkMethodIL.MarkSequencePoint(doc5, 225, 1, 225, 100)
Dim locbldr151 As LocalBuilder = checkMethodIL.DeclareLocal(GetType(Expr))
locbldr151.SetLocalSymInfo("exp")
checkMethodIL.Emit(OpCodes.Ldnull)
checkMethodIL.Emit(OpCodes.Stloc, 5)
checkMethodIL.MarkSequencePoint(doc5, 226, 1, 226, 100)
Dim locbldr152 As LocalBuilder = checkMethodIL.DeclareLocal(GetType(System.Boolean))
locbldr152.SetLocalSymInfo("d")
checkMethodIL.Emit(OpCodes.Ldc_I4, 0)
Typ = GetType(System.Boolean)
checkMethodIL.Emit(OpCodes.Stloc, 6)
checkMethodIL.MarkSequencePoint(doc5, 228, 1, 228, 100)
checkMethodIL.Emit(OpCodes.Ldarg, 2)
Typ = GetType(System.Boolean).MakeByRefType()
...
Typ = GetType(System.Boolean)
Dim fa101 As System.Reflection.Emit.Label = checkMethodIL.DefineLabel()
Dim tru101 As System.Reflection.Emit.Label = checkMethodIL.DefineLabel()
Dim cont101 As System.Reflection.Emit.Label = checkMethodIL.DefineLabel()
checkMethodIL.Emit(OpCodes.Beq, tru101)
checkMethodIL.Emit(OpCodes.Br, fa101)
checkMethodIL.MarkLabel(tru101)
checkMethodIL.MarkSequencePoint(doc5, 230, 1, 230, 100)
...
checkMethodIL.MarkSequencePoint(doc5, 231, 1, 231, 100)
checkMethodIL.Emit(OpCodes.Ldloc, 2)
Typ = GetType(MethodStmt)
checkMethodIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
...
checkMethodIL.MarkSequencePoint(doc5, 233, 1, 233, 100)
...
Dim locbldr153 As LocalBuilder = checkMethodIL.DeclareLocal(GetType(System.Int32))
locbldr153.SetLocalSymInfo("i")
checkMethodIL.Emit(OpCodes.Ldc_I4, CInt(0))
Typ = GetType(System.Int32)
checkMethodIL.Emit(OpCodes.Stloc, 7)
checkMethodIL.MarkSequencePoint(doc5, 238, 1, 238, 100)
Dim locbldr154 As LocalBuilder = checkMethodIL.DeclareLocal(GetType(System.Int32))
locbldr154.SetLocalSymInfo("len")
checkMethodIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
checkMethodIL.Emit(OpCodes.Ldfld, GetType(Stmt).GetField("Tokens"))
Typ = GetType(Stmt).GetField("Tokens").FieldType
...
Dim locbldr155 As LocalBuilder = checkMethodIL.DeclareLocal(GetType(System.Boolean))
locbldr155.SetLocalSymInfo("bl")
checkMethodIL.Emit(OpCodes.Ldc_I4, 0)
Typ = GetType(System.Boolean)
checkMethodIL.Emit(OpCodes.Stloc, 9)
checkMethodIL.MarkSequencePoint(doc5, 242, 1, 242, 100)
checkMethodIL.MarkLabel(label2)
checkMethodIL.MarkSequencePoint(doc5, 244, 1, 244, 100)
...
checkMethodIL.Emit(OpCodes.Call, GetType(System.Type).GetMethod("GetTypeFromHandle", typ50))
Typ = GetType(System.Type).GetMethod("GetTypeFromHandle", typ50).ReturnType
checkMethodIL.Emit(OpCodes.Stloc, 1)
checkMethodIL.MarkSequencePoint(doc5, 247, 1, 247, 100)
Dim typ51(-1) As Type
checkMethodIL.Emit(OpCodes.Ldloc, 1)
Typ = GetType(System.Type)
Typ03 = Typ
...
ReDim Preserve typ51(UBound(typ51) + 1)
typ51(UBound(typ51)) = Typ
checkMethodIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("IsInstanceOfType", typ51))
...
checkMethodIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa102 As System.Reflection.Emit.Label = checkMethodIL.DefineLabel()
Dim tru102 As System.Reflection.Emit.Label = checkMethodIL.DefineLabel()
Dim cont102 As System.Reflection.Emit.Label = checkMethodIL.DefineLabel()
checkMethodIL.Emit(OpCodes.Beq, tru102)
checkMethodIL.Emit(OpCodes.Br, fa102)
checkMethodIL.MarkLabel(tru102)
checkMethodIL.MarkSequencePoint(doc5, 250, 1, 250, 100)
checkMethodIL.Emit(OpCodes.Ldloc, 0)
Typ = GetType(Token)
checkMethodIL.Emit(OpCodes.Stloc, 3)
checkMethodIL.MarkSequencePoint(doc5, 251, 1, 251, 100)
Dim typ52(-1) As Type
checkMethodIL.Emit(OpCodes.Ldloc, 2)
Typ = GetType(MethodStmt)
Typ03 = Typ
...
ReDim Preserve typ52(UBound(typ52) + 1)
typ52(UBound(typ52)) = Typ
checkMethodIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("AddAttr", typ52))
Typ = Typ03.GetMethod("AddAttr", typ52).ReturnType
If Typ.ToString() = GetType(System.Void).ToString() Then
...
checkMethodIL.Emit(OpCodes.Br, cont102)
checkMethodIL.MarkLabel(fa102)
...
checkMethodIL.MarkSequencePoint(doc5, 255, 1, 255, 100)
checkMethodIL.Emit(OpCodes.Br, cont102)
checkMethodIL.MarkLabel(cont102)
checkMethodIL.MarkSequencePoint(doc5, 257, 1, 257, 100)
checkMethodIL.Emit(OpCodes.Ldloc, 7)
Typ = GetType(System.Int32)
checkMethodIL.Emit(OpCodes.Ldloc, 8)
Typ = GetType(System.Int32)
Dim fa103 As System.Reflection.Emit.Label = checkMethodIL.DefineLabel()
Dim tru103 As System.Reflection.Emit.Label = checkMethodIL.DefineLabel()
Dim cont103 As System.Reflection.Emit.Label = checkMethodIL.DefineLabel()
checkMethodIL.Emit(OpCodes.Beq, tru103)
checkMethodIL.Emit(OpCodes.Br, fa103)
checkMethodIL.MarkLabel(tru103)
checkMethodIL.MarkSequencePoint(doc5, 258, 1, 258, 100)
checkMethodIL.Emit(OpCodes.Br, label3)
checkMethodIL.MarkSequencePoint(doc5, 259, 1, 259, 100)
checkMethodIL.Emit(OpCodes.Br, cont103)
checkMethodIL.MarkLabel(fa103)
...
checkMethodIL.Emit(OpCodes.Br, cont103)
checkMethodIL.MarkLabel(cont103)
checkMethodIL.MarkSequencePoint(doc5, 263, 1, 263, 100)
...
Dim locbldr156 As LocalBuilder = checkMethodIL.DeclareLocal(GetType(Token))
...
checkMethodIL.MarkSequencePoint(doc5, 271, 1, 271, 100)
Dim locbldr157 As LocalBuilder = checkMethodIL.DeclareLocal(GetType(System.Type))
locbldr157.SetLocalSymInfo("typ2")
checkMethodIL.MarkSequencePoint(doc5, 272, 1, 272, 100)
Dim locbldr158 As LocalBuilder = checkMethodIL.DeclareLocal(GetType(System.Boolean))
...
Dim typ53 As Type() = {GetType(System.RuntimeTypeHandle)}
checkMethodIL.Emit(OpCodes.Call, GetType(System.Type).GetMethod("GetTypeFromHandle", typ53))
Typ = GetType(System.Type).GetMethod("GetTypeFromHandle", typ53).ReturnType
...
ReDim Preserve typ54(UBound(typ54) + 1)
typ54(UBound(typ54)) = Typ
checkMethodIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("IsInstanceOfType", typ54))
Typ = Typ03.GetMethod("IsInstanceOfType", typ54).ReturnType
checkMethodIL.Emit(OpCodes.Stloc, 12)
checkMethodIL.MarkSequencePoint(doc5, 277, 1, 277, 100)
checkMethodIL.Emit(OpCodes.Ldloc, 12)
Typ = GetType(System.Boolean)
checkMethodIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa104 As System.Reflection.Emit.Label = checkMethodIL.DefineLabel()
Dim tru104 As System.Reflection.Emit.Label = checkMethodIL.DefineLabel()
Dim cont104 As System.Reflection.Emit.Label = checkMethodIL.DefineLabel()
checkMethodIL.Emit(OpCodes.Beq, fa104)
checkMethodIL.Emit(OpCodes.Br, tru104)
checkMethodIL.MarkLabel(tru104)
checkMethodIL.MarkSequencePoint(doc5, 278, 1, 278, 100)
Dim locbldr159 As LocalBuilder = checkMethodIL.DeclareLocal(GetType(Token))
locbldr159.SetLocalSymInfo("t")
checkMethodIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
checkMethodIL.Emit(OpCodes.Ldfld, GetType(Stmt).GetField("Tokens"))
Typ = GetType(Stmt).GetField("Tokens").FieldType
...
checkMethodIL.MarkSequencePoint(doc5, 279, 1, 279, 100)
Dim locbldr160 As LocalBuilder = checkMethodIL.DeclareLocal(GetType(TypeTok))
locbldr160.SetLocalSymInfo("tt")
...
checkMethodIL.MarkSequencePoint(doc5, 281, 1, 281, 100)
checkMethodIL.Emit(OpCodes.Ldloc, 14)
Typ = GetType(TypeTok)
checkMethodIL.Emit(OpCodes.Ldloc, 13)
Typ = GetType(Token)
...
checkMethodIL.MarkSequencePoint(doc5, 282, 1, 282, 100)
checkMethodIL.Emit(OpCodes.Ldloc, 2)
Typ = GetType(MethodStmt)
checkMethodIL.Emit(OpCodes.Ldloc, 14)
Typ = GetType(TypeTok)
...
checkMethodIL.Emit(OpCodes.Br, cont104)
checkMethodIL.MarkLabel(fa104)
checkMethodIL.MarkSequencePoint(doc5, 284, 1, 284, 100)
checkMethodIL.Emit(OpCodes.Ldloc, 2)
Typ = GetType(MethodStmt)
checkMethodIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
...
checkMethodIL.Emit(OpCodes.Br, cont104)
checkMethodIL.MarkLabel(cont104)
...
Dim typ55 As Type() = {GetType(System.RuntimeTypeHandle)}
checkMethodIL.Emit(OpCodes.Call, GetType(System.Type).GetMethod("GetTypeFromHandle", typ55))
Typ = GetType(System.Type).GetMethod("GetTypeFromHandle", typ55).ReturnType
checkMethodIL.Emit(OpCodes.Stloc, 11)
checkMethodIL.MarkSequencePoint(doc5, 291, 1, 291, 100)
Dim typ56(-1) As Type
checkMethodIL.Emit(OpCodes.Ldloc, 11)
Typ = GetType(System.Type)
Typ03 = Typ
...
ReDim Preserve typ56(UBound(typ56) + 1)
typ56(UBound(typ56)) = Typ
checkMethodIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("IsInstanceOfType", typ56))
...
checkMethodIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa105 As System.Reflection.Emit.Label = checkMethodIL.DefineLabel()
Dim tru105 As System.Reflection.Emit.Label = checkMethodIL.DefineLabel()
Dim cont105 As System.Reflection.Emit.Label = checkMethodIL.DefineLabel()
checkMethodIL.Emit(OpCodes.Beq, tru105)
checkMethodIL.Emit(OpCodes.Br, fa105)
checkMethodIL.MarkLabel(tru105)
...
checkMethodIL.Emit(OpCodes.Br, cont105)
checkMethodIL.MarkLabel(fa105)
checkMethodIL.Emit(OpCodes.Br, cont105)
checkMethodIL.MarkLabel(cont105)
...
Typ = Typ.GetElementType()
checkMethodIL.Emit(OpCodes.Stloc, 10)
checkMethodIL.MarkSequencePoint(doc5, 301, 1, 301, 100)
...
checkMethodIL.Emit(OpCodes.Stloc, 12)
checkMethodIL.MarkSequencePoint(doc5, 303, 1, 303, 100)
checkMethodIL.Emit(OpCodes.Ldloc, 12)
Typ = GetType(System.Boolean)
checkMethodIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa106 As System.Reflection.Emit.Label = checkMethodIL.DefineLabel()
Dim tru106 As System.Reflection.Emit.Label = checkMethodIL.DefineLabel()
Dim cont106 As System.Reflection.Emit.Label = checkMethodIL.DefineLabel()
checkMethodIL.Emit(OpCodes.Beq, tru106)
checkMethodIL.Emit(OpCodes.Br, fa106)
checkMethodIL.MarkLabel(tru106)
...
checkMethodIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa107 As System.Reflection.Emit.Label = checkMethodIL.DefineLabel()
Dim tru107 As System.Reflection.Emit.Label = checkMethodIL.DefineLabel()
Dim cont107 As System.Reflection.Emit.Label = checkMethodIL.DefineLabel()
checkMethodIL.Emit(OpCodes.Beq, tru107)
checkMethodIL.Emit(OpCodes.Br, fa107)
checkMethodIL.MarkLabel(tru107)
checkMethodIL.MarkSequencePoint(doc5, 314, 1, 314, 100)
checkMethodIL.Emit(OpCodes.Ldloc, 6)
Typ = GetType(System.Boolean)
checkMethodIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa108 As System.Reflection.Emit.Label = checkMethodIL.DefineLabel()
Dim tru108 As System.Reflection.Emit.Label = checkMethodIL.DefineLabel()
Dim cont108 As System.Reflection.Emit.Label = checkMethodIL.DefineLabel()
checkMethodIL.Emit(OpCodes.Beq, tru108)
checkMethodIL.Emit(OpCodes.Br, fa108)
checkMethodIL.MarkLabel(tru108)
checkMethodIL.MarkSequencePoint(doc5, 315, 1, 315, 100)
Dim locbldr161 As LocalBuilder = checkMethodIL.DeclareLocal(asm.GetType("dylan.NET.Tokenizer.Parser.ExprOptimizer"))
locbldr161.SetLocalSymInfo("eopt2")
...
ReDim Preserve typ61(UBound(typ61) + 1)
typ61(UBound(typ61)) = Typ
checkMethodIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("checkVarAs", typ61))
Typ = Typ03.GetMethod("checkVarAs", typ61).ReturnType
checkMethodIL.Emit(OpCodes.Stloc, 5)
...
checkMethodIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa109 As System.Reflection.Emit.Label = checkMethodIL.DefineLabel()
Dim tru109 As System.Reflection.Emit.Label = checkMethodIL.DefineLabel()
Dim cont109 As System.Reflection.Emit.Label = checkMethodIL.DefineLabel()
checkMethodIL.Emit(OpCodes.Beq, tru109)
checkMethodIL.Emit(OpCodes.Br, fa109)
checkMethodIL.MarkLabel(tru109)
...
ReDim Preserve typ62(UBound(typ62) + 1)
typ62(UBound(typ62)) = Typ
checkMethodIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("AddParam", typ62))
Typ = Typ03.GetMethod("AddParam", typ62).ReturnType
If Typ.ToString() = GetType(System.Void).ToString() Then
...
checkMethodIL.Emit(OpCodes.Br, cont109)
checkMethodIL.MarkLabel(fa109)
checkMethodIL.Emit(OpCodes.Br, cont109)
checkMethodIL.MarkLabel(cont109)
checkMethodIL.MarkSequencePoint(doc5, 320, 1, 320, 100)
checkMethodIL.Emit(OpCodes.Br, cont108)
checkMethodIL.MarkLabel(fa108)
checkMethodIL.Emit(OpCodes.Br, cont108)
checkMethodIL.MarkLabel(cont108)
...
checkMethodIL.Emit(OpCodes.Br, cont107)
checkMethodIL.MarkLabel(fa107)
checkMethodIL.Emit(OpCodes.Br, cont107)
checkMethodIL.MarkLabel(cont107)
...
checkMethodIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa110 As System.Reflection.Emit.Label = checkMethodIL.DefineLabel()
Dim tru110 As System.Reflection.Emit.Label = checkMethodIL.DefineLabel()
Dim cont110 As System.Reflection.Emit.Label = checkMethodIL.DefineLabel()
checkMethodIL.Emit(OpCodes.Beq, tru110)
checkMethodIL.Emit(OpCodes.Br, fa110)
checkMethodIL.MarkLabel(tru110)
...
checkMethodIL.Emit(OpCodes.Br, cont110)
checkMethodIL.MarkLabel(fa110)
checkMethodIL.Emit(OpCodes.Br, cont110)
checkMethodIL.MarkLabel(cont110)
...
Dim typ65 As Type() = {GetType(System.RuntimeTypeHandle)}
checkMethodIL.Emit(OpCodes.Call, GetType(System.Type).GetMethod("GetTypeFromHandle", typ65))
Typ = GetType(System.Type).GetMethod("GetTypeFromHandle", typ65).ReturnType
checkMethodIL.Emit(OpCodes.Stloc, 11)
...
ReDim Preserve typ66(UBound(typ66) + 1)
typ66(UBound(typ66)) = Typ
checkMethodIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("IsInstanceOfType", typ66))
...
checkMethodIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa111 As System.Reflection.Emit.Label = checkMethodIL.DefineLabel()
Dim tru111 As System.Reflection.Emit.Label = checkMethodIL.DefineLabel()
Dim cont111 As System.Reflection.Emit.Label = checkMethodIL.DefineLabel()
checkMethodIL.Emit(OpCodes.Beq, tru111)
checkMethodIL.Emit(OpCodes.Br, fa111)
checkMethodIL.MarkLabel(tru111)
checkMethodIL.MarkSequencePoint(doc5, 337, 1, 337, 100)
Dim locbldr162 As LocalBuilder = checkMethodIL.DeclareLocal(asm.GetType("dylan.NET.Tokenizer.Parser.ExprOptimizer"))
locbldr162.SetLocalSymInfo("eopt1")
checkMethodIL.Emit(OpCodes.Newobj, asm.GetType("dylan.NET.Tokenizer.Parser.ExprOptimizer").GetConstructor(Type.EmptyTypes))
...
ReDim Preserve typ67(UBound(typ67) + 1)
typ67(UBound(typ67)) = Typ
checkMethodIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("checkVarAs", typ67))
Typ = Typ03.GetMethod("checkVarAs", typ67).ReturnType
checkMethodIL.Emit(OpCodes.Stloc, 5)
...
checkMethodIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa112 As System.Reflection.Emit.Label = checkMethodIL.DefineLabel()
Dim tru112 As System.Reflection.Emit.Label = checkMethodIL.DefineLabel()
Dim cont112 As System.Reflection.Emit.Label = checkMethodIL.DefineLabel()
checkMethodIL.Emit(OpCodes.Beq, tru112)
checkMethodIL.Emit(OpCodes.Br, fa112)
checkMethodIL.MarkLabel(tru112)
...
ReDim Preserve typ68(UBound(typ68) + 1)
typ68(UBound(typ68)) = Typ
checkMethodIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("AddParam", typ68))
Typ = Typ03.GetMethod("AddParam", typ68).ReturnType
If Typ.ToString() = GetType(System.Void).ToString() Then
...
checkMethodIL.Emit(OpCodes.Br, cont112)
checkMethodIL.MarkLabel(fa112)
checkMethodIL.Emit(OpCodes.Br, cont112)
checkMethodIL.MarkLabel(cont112)
checkMethodIL.MarkSequencePoint(doc5, 342, 1, 342, 100)
checkMethodIL.Emit(OpCodes.Ldc_I4, 0)
Typ = GetType(System.Boolean)
checkMethodIL.Emit(OpCodes.Stloc, 6)
checkMethodIL.MarkSequencePoint(doc5, 343, 1, 343, 100)
checkMethodIL.Emit(OpCodes.Br, cont111)
checkMethodIL.MarkLabel(fa111)
checkMethodIL.Emit(OpCodes.Br, cont111)
checkMethodIL.MarkLabel(cont111)
checkMethodIL.MarkSequencePoint(doc5, 345, 1, 345, 100)
checkMethodIL.Emit(OpCodes.Ldloc, 6)
Typ = GetType(System.Boolean)
checkMethodIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa113 As System.Reflection.Emit.Label = checkMethodIL.DefineLabel()
Dim tru113 As System.Reflection.Emit.Label = checkMethodIL.DefineLabel()
Dim cont113 As System.Reflection.Emit.Label = checkMethodIL.DefineLabel()
checkMethodIL.Emit(OpCodes.Beq, tru113)
checkMethodIL.Emit(OpCodes.Br, fa113)
checkMethodIL.MarkLabel(tru113)
...
checkMethodIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("AddToken", typ69))
Typ = Typ03.GetMethod("AddToken", typ69).ReturnType
If Typ.ToString() = GetType(System.Void).ToString() Then
...
checkMethodIL.Emit(OpCodes.Br, cont113)
checkMethodIL.MarkLabel(fa113)
checkMethodIL.Emit(OpCodes.Br, cont113)
checkMethodIL.MarkLabel(cont113)
checkMethodIL.MarkSequencePoint(doc5, 350, 1, 350, 100)
checkMethodIL.Emit(OpCodes.Ldloc, 7)
Typ = GetType(System.Int32)
checkMethodIL.Emit(OpCodes.Ldloc, 8)
Typ = GetType(System.Int32)
Dim fa114 As System.Reflection.Emit.Label = checkMethodIL.DefineLabel()
Dim tru114 As System.Reflection.Emit.Label = checkMethodIL.DefineLabel()
Dim cont114 As System.Reflection.Emit.Label = checkMethodIL.DefineLabel()
checkMethodIL.Emit(OpCodes.Beq, tru114)
checkMethodIL.Emit(OpCodes.Br, fa114)
checkMethodIL.MarkLabel(tru114)
checkMethodIL.MarkSequencePoint(doc5, 351, 1, 351, 100)
checkMethodIL.Emit(OpCodes.Br, label6)
checkMethodIL.MarkSequencePoint(doc5, 352, 1, 352, 100)
checkMethodIL.Emit(OpCodes.Br, cont114)
checkMethodIL.MarkLabel(fa114)
...
checkMethodIL.Emit(OpCodes.Br, cont114)
checkMethodIL.MarkLabel(cont114)
...
checkMethodIL.Emit(OpCodes.Br, cont106)
checkMethodIL.MarkLabel(fa106)
checkMethodIL.Emit(OpCodes.Br, cont106)
checkMethodIL.MarkLabel(cont106)
checkMethodIL.MarkSequencePoint(doc5, 360, 1, 360, 100)
checkMethodIL.Emit(OpCodes.Br, cont101)
checkMethodIL.MarkLabel(fa101)
checkMethodIL.Emit(OpCodes.Br, cont101)
checkMethodIL.MarkLabel(cont101)
...
Dim typ70(-1) As Type
ReDim Preserve typ70(UBound(typ70) + 1)
typ70(UBound(typ70)) = GetType(Stmt)
ReDim Preserve typ70(UBound(typ70) + 1)
typ70(UBound(typ70)) = GetType(System.Boolean).MakeByRefType()
Dim checkMethodCall As MethodBuilder = StmtOptimizer.DefineMethod("checkMethodCall", MethodAttributes.Public, GetType(Stmt), typ70)
...
checkMethodCallIL.MarkSequencePoint(doc5, 366, 1, 366, 100)
...
Typ = GetType(System.Int32)
Dim fa115 As System.Reflection.Emit.Label = checkMethodCallIL.DefineLabel()
Dim tru115 As System.Reflection.Emit.Label = checkMethodCallIL.DefineLabel()
Dim cont115 As System.Reflection.Emit.Label = checkMethodCallIL.DefineLabel()
checkMethodCallIL.Emit(OpCodes.Bgt, tru115)
checkMethodCallIL.Emit(OpCodes.Br, fa115)
checkMethodCallIL.MarkLabel(tru115)
checkMethodCallIL.MarkSequencePoint(doc5, 367, 1, 367, 100)
Dim locbldr163 As LocalBuilder = checkMethodCallIL.DeclareLocal(GetType(Token))
...
checkMethodCallIL.MarkSequencePoint(doc5, 368, 1, 368, 100)
Dim locbldr164 As LocalBuilder = checkMethodCallIL.DeclareLocal(GetType(System.Type))
locbldr164.SetLocalSymInfo("typ")
checkMethodCallIL.Emit(OpCodes.Ldtoken, GetType(Ident))
Dim typ71 As Type() = {GetType(System.RuntimeTypeHandle)}
checkMethodCallIL.Emit(OpCodes.Call, GetType(System.Type).GetMethod("GetTypeFromHandle", typ71))
Typ = GetType(System.Type).GetMethod("GetTypeFromHandle", typ71).ReturnType
checkMethodCallIL.Emit(OpCodes.Stloc, 1)
checkMethodCallIL.MarkSequencePoint(doc5, 369, 1, 369, 100)
Dim locbldr165 As LocalBuilder = checkMethodCallIL.DeclareLocal(GetType(Token))
locbldr165.SetLocalSymInfo("tokb")
checkMethodCallIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
checkMethodCallIL.Emit(OpCodes.Ldfld, GetType(Stmt).GetField("Tokens"))
Typ = GetType(Stmt).GetField("Tokens").FieldType
...
checkMethodCallIL.MarkSequencePoint(doc5, 370, 1, 370, 100)
Dim locbldr166 As LocalBuilder = checkMethodCallIL.DeclareLocal(GetType(System.Type))
locbldr166.SetLocalSymInfo("typb")
checkMethodCallIL.Emit(OpCodes.Ldtoken, GetType(LParen))
Dim typ72 As Type() = {GetType(System.RuntimeTypeHandle)}
checkMethodCallIL.Emit(OpCodes.Call, GetType(System.Type).GetMethod("GetTypeFromHandle", typ72))
Typ = GetType(System.Type).GetMethod("GetTypeFromHandle", typ72).ReturnType
checkMethodCallIL.Emit(OpCodes.Stloc, 3)
checkMethodCallIL.MarkSequencePoint(doc5, 371, 1, 371, 100)
Dim locbldr167 As LocalBuilder = checkMethodCallIL.DeclareLocal(GetType(System.Boolean))
locbldr167.SetLocalSymInfo("ba")
Dim typ73(-1) As Type
...
checkMethodCallIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("IsInstanceOfType", typ73))
Typ = Typ03.GetMethod("IsInstanceOfType", typ73).ReturnType
checkMethodCallIL.Emit(OpCodes.Stloc, 4)
checkMethodCallIL.MarkSequencePoint(doc5, 372, 1, 372, 100)
Dim locbldr168 As LocalBuilder = checkMethodCallIL.DeclareLocal(GetType(System.Boolean))
locbldr168.SetLocalSymInfo("bb")
Dim typ74(-1) As Type
...
ReDim Preserve typ74(UBound(typ74) + 1)
typ74(UBound(typ74)) = Typ
checkMethodCallIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("IsInstanceOfType", typ74))
Typ = Typ03.GetMethod("IsInstanceOfType", typ74).ReturnType
checkMethodCallIL.Emit(OpCodes.Stloc, 5)
checkMethodCallIL.MarkSequencePoint(doc5, 374, 1, 374, 100)
...
checkMethodCallIL.MarkSequencePoint(doc5, 376, 1, 376, 100)
Dim locbldr169 As LocalBuilder = checkMethodCallIL.DeclareLocal(GetType(MethodCallStmt))
locbldr169.SetLocalSymInfo("mtcss")
...
checkMethodCallIL.MarkSequencePoint(doc5, 377, 1, 377, 100)
Dim locbldr170 As LocalBuilder = checkMethodCallIL.DeclareLocal(GetType(MethodNameTok))
locbldr170.SetLocalSymInfo("mn")
...
checkMethodCallIL.MarkSequencePoint(doc5, 378, 1, 378, 100)
Dim locbldr171 As LocalBuilder = checkMethodCallIL.DeclareLocal(GetType(MethodCallTok))
...
checkMethodCallIL.MarkSequencePoint(doc5, 379, 1, 379, 100)
Dim locbldr172 As LocalBuilder = checkMethodCallIL.DeclareLocal(GetType(Ident))
locbldr172.SetLocalSymInfo("idt")
checkMethodCallIL.Emit(OpCodes.Ldnull)
checkMethodCallIL.Emit(OpCodes.Stloc, 9)
checkMethodCallIL.MarkSequencePoint(doc5, 380, 1, 380, 100)
Dim locbldr173 As LocalBuilder = checkMethodCallIL.DeclareLocal(GetType(Expr))
locbldr173.SetLocalSymInfo("exp")
...
Dim locbldr174 As LocalBuilder = checkMethodCallIL.DeclareLocal(GetType(System.Int32))
locbldr174.SetLocalSymInfo("lvl")
checkMethodCallIL.Emit(OpCodes.Ldc_I4, CInt(1))
Typ = GetType(System.Int32)
checkMethodCallIL.Emit(OpCodes.Stloc, 11)
checkMethodCallIL.MarkSequencePoint(doc5, 382, 1, 382, 100)
Dim locbldr175 As LocalBuilder = checkMethodCallIL.DeclareLocal(GetType(System.Boolean))
locbldr175.SetLocalSymInfo("d")
...
Dim locbldr176 As LocalBuilder = checkMethodCallIL.DeclareLocal(GetType(System.Int32))
...
checkMethodCallIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa116 As System.Reflection.Emit.Label = checkMethodCallIL.DefineLabel()
Dim tru116 As System.Reflection.Emit.Label = checkMethodCallIL.DefineLabel()
Dim cont116 As System.Reflection.Emit.Label = checkMethodCallIL.DefineLabel()
checkMethodCallIL.Emit(OpCodes.Beq, tru116)
checkMethodCallIL.Emit(OpCodes.Br, fa116)
checkMethodCallIL.MarkLabel(tru116)
...
checkMethodCallIL.MarkSequencePoint(doc5, 388, 1, 388, 100)
checkMethodCallIL.Emit(OpCodes.Ldloc, 6)
Typ = GetType(MethodCallStmt)
checkMethodCallIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
...
checkMethodCallIL.MarkSequencePoint(doc5, 390, 1, 390, 100)
checkMethodCallIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
checkMethodCallIL.Emit(OpCodes.Ldfld, GetType(Stmt).GetField("Tokens"))
Typ = GetType(Stmt).GetField("Tokens").FieldType
...
Dim locbldr177 As LocalBuilder = checkMethodCallIL.DeclareLocal(GetType(Token))
...
Dim locbldr178 As LocalBuilder = checkMethodCallIL.DeclareLocal(GetType(System.Type))
locbldr178.SetLocalSymInfo("typ2")
checkMethodCallIL.MarkSequencePoint(doc5, 396, 1, 396, 100)
Dim locbldr179 As LocalBuilder = checkMethodCallIL.DeclareLocal(GetType(System.Boolean))
locbldr179.SetLocalSymInfo("b2")
checkMethodCallIL.MarkSequencePoint(doc5, 397, 1, 397, 100)
Dim locbldr180 As LocalBuilder = checkMethodCallIL.DeclareLocal(GetType(System.Int32))
...
checkMethodCallIL.MarkSequencePoint(doc5, 399, 1, 399, 100)
...
checkMethodCallIL.MarkSequencePoint(doc5, 401, 1, 401, 100)
...
checkMethodCallIL.Emit(OpCodes.Stloc, 13)
checkMethodCallIL.MarkSequencePoint(doc5, 408, 1, 408, 100)
checkMethodCallIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
checkMethodCallIL.Emit(OpCodes.Ldfld, GetType(Stmt).GetField("Tokens"))
Typ = GetType(Stmt).GetField("Tokens").FieldType
...
checkMethodCallIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("IsInstanceOfType", typ76))
...
checkMethodCallIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa117 As System.Reflection.Emit.Label = checkMethodCallIL.DefineLabel()
Dim tru117 As System.Reflection.Emit.Label = checkMethodCallIL.DefineLabel()
Dim cont117 As System.Reflection.Emit.Label = checkMethodCallIL.DefineLabel()
checkMethodCallIL.Emit(OpCodes.Beq, tru117)
checkMethodCallIL.Emit(OpCodes.Br, fa117)
checkMethodCallIL.MarkLabel(tru117)
...
checkMethodCallIL.Emit(OpCodes.Ldc_I4, CInt(0))
Typ = GetType(System.Int32)
Dim fa118 As System.Reflection.Emit.Label = checkMethodCallIL.DefineLabel()
Dim tru118 As System.Reflection.Emit.Label = checkMethodCallIL.DefineLabel()
Dim cont118 As System.Reflection.Emit.Label = checkMethodCallIL.DefineLabel()
checkMethodCallIL.Emit(OpCodes.Beq, tru118)
checkMethodCallIL.Emit(OpCodes.Br, fa118)
checkMethodCallIL.MarkLabel(tru118)
checkMethodCallIL.MarkSequencePoint(doc5, 414, 1, 414, 100)
...
ReDim Preserve typ77(UBound(typ77) + 1)
typ77(UBound(typ77)) = Typ
checkMethodCallIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("AddParam", typ77))
Typ = Typ03.GetMethod("AddParam", typ77).ReturnType
If Typ.ToString() = GetType(System.Void).ToString() Then
...
checkMethodCallIL.Emit(OpCodes.Br, cont118)
checkMethodCallIL.MarkLabel(fa118)
checkMethodCallIL.MarkSequencePoint(doc5, 418, 1, 418, 100)
checkMethodCallIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
checkMethodCallIL.Emit(OpCodes.Stloc, 12)
checkMethodCallIL.MarkSequencePoint(doc5, 419, 1, 419, 100)
checkMethodCallIL.Emit(OpCodes.Br, label9)
checkMethodCallIL.MarkSequencePoint(doc5, 420, 1, 420, 100)
checkMethodCallIL.Emit(OpCodes.Br, cont118)
checkMethodCallIL.MarkLabel(cont118)
checkMethodCallIL.MarkSequencePoint(doc5, 421, 1, 421, 100)
checkMethodCallIL.Emit(OpCodes.Br, label9)
checkMethodCallIL.MarkSequencePoint(doc5, 422, 1, 422, 100)
checkMethodCallIL.Emit(OpCodes.Br, cont117)
checkMethodCallIL.MarkLabel(fa117)
checkMethodCallIL.Emit(OpCodes.Br, cont117)
checkMethodCallIL.MarkLabel(cont117)
...
checkMethodCallIL.Emit(OpCodes.Call, GetType(System.Type).GetMethod("GetTypeFromHandle", typ78))
...
ReDim Preserve typ79(UBound(typ79) + 1)
typ79(UBound(typ79)) = Typ
checkMethodCallIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("IsInstanceOfType", typ79))
...
checkMethodCallIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa119 As System.Reflection.Emit.Label = checkMethodCallIL.DefineLabel()
Dim tru119 As System.Reflection.Emit.Label = checkMethodCallIL.DefineLabel()
Dim cont119 As System.Reflection.Emit.Label = checkMethodCallIL.DefineLabel()
checkMethodCallIL.Emit(OpCodes.Beq, tru119)
checkMethodCallIL.Emit(OpCodes.Br, fa119)
checkMethodCallIL.MarkLabel(tru119)
...
checkMethodCallIL.Emit(OpCodes.Br, cont119)
checkMethodCallIL.MarkLabel(fa119)
checkMethodCallIL.Emit(OpCodes.Br, cont119)
checkMethodCallIL.MarkLabel(cont119)
...
checkMethodCallIL.Emit(OpCodes.Call, GetType(System.Type).GetMethod("GetTypeFromHandle", typ80))
...
checkMethodCallIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("IsInstanceOfType", typ81))
...
checkMethodCallIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa120 As System.Reflection.Emit.Label = checkMethodCallIL.DefineLabel()
Dim tru120 As System.Reflection.Emit.Label = checkMethodCallIL.DefineLabel()
Dim cont120 As System.Reflection.Emit.Label = checkMethodCallIL.DefineLabel()
checkMethodCallIL.Emit(OpCodes.Beq, tru120)
checkMethodCallIL.Emit(OpCodes.Br, fa120)
checkMethodCallIL.MarkLabel(tru120)
checkMethodCallIL.MarkSequencePoint(doc5, 437, 1, 437, 100)
checkMethodCallIL.Emit(OpCodes.Ldloc, 11)
Typ = GetType(System.Int32)
checkMethodCallIL.Emit(OpCodes.Ldc_I4, CInt(1))
Typ = GetType(System.Int32)
Dim fa121 As System.Reflection.Emit.Label = checkMethodCallIL.DefineLabel()
Dim tru121 As System.Reflection.Emit.Label = checkMethodCallIL.DefineLabel()
Dim cont121 As System.Reflection.Emit.Label = checkMethodCallIL.DefineLabel()
checkMethodCallIL.Emit(OpCodes.Beq, tru121)
checkMethodCallIL.Emit(OpCodes.Br, fa121)
checkMethodCallIL.MarkLabel(tru121)
...
checkMethodCallIL.Emit(OpCodes.Pop)
End If
checkMethodCallIL.MarkSequencePoint(doc5, 440, 1, 440, 100)
checkMethodCallIL.Emit(OpCodes.Newobj, GetType(Expr).GetConstructor(Type.EmptyTypes))
checkMethodCallIL.Emit(OpCodes.Stloc, 10)
checkMethodCallIL.MarkSequencePoint(doc5, 441, 1, 441, 100)
checkMethodCallIL.Emit(OpCodes.Br, label9)
checkMethodCallIL.MarkSequencePoint(doc5, 442, 1, 442, 100)
checkMethodCallIL.Emit(OpCodes.Br, cont121)
checkMethodCallIL.MarkLabel(fa121)
...
checkMethodCallIL.Emit(OpCodes.Br, cont121)
checkMethodCallIL.MarkLabel(cont121)
checkMethodCallIL.MarkSequencePoint(doc5, 446, 1, 446, 100)
checkMethodCallIL.Emit(OpCodes.Br, cont120)
checkMethodCallIL.MarkLabel(fa120)
checkMethodCallIL.Emit(OpCodes.Br, cont120)
checkMethodCallIL.MarkLabel(cont120)
...
checkMethodCallIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa122 As System.Reflection.Emit.Label = checkMethodCallIL.DefineLabel()
Dim tru122 As System.Reflection.Emit.Label = checkMethodCallIL.DefineLabel()
Dim cont122 As System.Reflection.Emit.Label = checkMethodCallIL.DefineLabel()
checkMethodCallIL.Emit(OpCodes.Beq, tru122)
checkMethodCallIL.Emit(OpCodes.Br, fa122)
checkMethodCallIL.MarkLabel(tru122)
...
ReDim Preserve typ83(UBound(typ83) + 1)
typ83(UBound(typ83)) = Typ
checkMethodCallIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("AddToken", typ83))
...
checkMethodCallIL.Emit(OpCodes.Br, cont122)
checkMethodCallIL.MarkLabel(fa122)
checkMethodCallIL.Emit(OpCodes.Br, cont122)
checkMethodCallIL.MarkLabel(cont122)
checkMethodCallIL.MarkSequencePoint(doc5, 454, 1, 454, 100)
checkMethodCallIL.Emit(OpCodes.Ldloc, 13)
Typ = GetType(System.Int32)
checkMethodCallIL.Emit(OpCodes.Ldloc, 17)
Typ = GetType(System.Int32)
Dim fa123 As System.Reflection.Emit.Label = checkMethodCallIL.DefineLabel()
Dim tru123 As System.Reflection.Emit.Label = checkMethodCallIL.DefineLabel()
Dim cont123 As System.Reflection.Emit.Label = checkMethodCallIL.DefineLabel()
checkMethodCallIL.Emit(OpCodes.Beq, tru123)
checkMethodCallIL.Emit(OpCodes.Br, fa123)
checkMethodCallIL.MarkLabel(tru123)
checkMethodCallIL.MarkSequencePoint(doc5, 455, 1, 455, 100)
checkMethodCallIL.Emit(OpCodes.Br, label8)
checkMethodCallIL.MarkSequencePoint(doc5, 456, 1, 456, 100)
checkMethodCallIL.Emit(OpCodes.Br, cont123)
checkMethodCallIL.MarkLabel(fa123)
...
checkMethodCallIL.Emit(OpCodes.Br, cont123)
checkMethodCallIL.MarkLabel(cont123)
...
checkMethodCallIL.Emit(OpCodes.Br, cont116)
checkMethodCallIL.MarkLabel(fa116)
checkMethodCallIL.Emit(OpCodes.Br, cont116)
checkMethodCallIL.MarkLabel(cont116)
checkMethodCallIL.MarkSequencePoint(doc5, 467, 1, 467, 100)
checkMethodCallIL.Emit(OpCodes.Br, cont115)
checkMethodCallIL.MarkLabel(fa115)
checkMethodCallIL.Emit(OpCodes.Br, cont115)
checkMethodCallIL.MarkLabel(cont115)
checkMethodCallIL.MarkSequencePoint(doc5, 468, 1, 468, 100)
checkMethodCallIL.Emit(OpCodes.Ldloc, 6)
Typ = GetType(MethodCallStmt)
...
Dim checkVarAs As MethodBuilder = StmtOptimizer.DefineMethod("checkVarAs", MethodAttributes.Public, GetType(Stmt), typ84)
Dim checkVarAsIL As ILGenerator = checkVarAs.GetILGenerator()
Dim checkVarAsparam00 As ParameterBuilder = checkVarAs.DefineParameter(0, ParameterAttributes.RetVal, "")
Dim checkVarAsparam01 As ParameterBuilder = checkVarAs.DefineParameter(1, ParameterAttributes.None, "stm")
Dim checkVarAsparam02 As ParameterBuilder = checkVarAs.DefineParameter(2, ParameterAttributes.None, "b")
checkVarAsIL.MarkSequencePoint(doc5, 472, 1, 472, 100)
Dim locbldr181 As LocalBuilder = checkVarAsIL.DeclareLocal(GetType(Token))
...
Typ = Typ.GetElementType()
checkVarAsIL.Emit(OpCodes.Stloc, 0)
checkVarAsIL.MarkSequencePoint(doc5, 473, 1, 473, 100)
Dim locbldr182 As LocalBuilder = checkVarAsIL.DeclareLocal(GetType(System.Type))
locbldr182.SetLocalSymInfo("typ")
checkVarAsIL.Emit(OpCodes.Ldtoken, GetType(VarTok))
Dim typ85 As Type() = {GetType(System.RuntimeTypeHandle)}
checkVarAsIL.Emit(OpCodes.Call, GetType(System.Type).GetMethod("GetTypeFromHandle", typ85))
Typ = GetType(System.Type).GetMethod("GetTypeFromHandle", typ85).ReturnType
checkVarAsIL.Emit(OpCodes.Stloc, 1)
checkVarAsIL.MarkSequencePoint(doc5, 474, 1, 474, 100)
checkVarAsIL.Emit(OpCodes.Ldarg, 2)
Typ = GetType(System.Boolean).MakeByRefType()
Typ04 = Typ.GetElementType()
Dim typ86(-1) As Type
...
ReDim Preserve typ86(UBound(typ86) + 1)
typ86(UBound(typ86)) = Typ
checkVarAsIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("IsInstanceOfType", typ86))
Typ = Typ03.GetMethod("IsInstanceOfType", typ86).ReturnType
checkVarAsIL.Emit(OpCodes.Stobj, Typ04)
checkVarAsIL.MarkSequencePoint(doc5, 475, 1, 475, 100)
Dim locbldr183 As LocalBuilder = checkVarAsIL.DeclareLocal(GetType(VarStmt))
locbldr183.SetLocalSymInfo("vars")
checkVarAsIL.Emit(OpCodes.Newobj, GetType(VarStmt).GetConstructor(Type.EmptyTypes))
checkVarAsIL.Emit(OpCodes.Stloc, 2)
checkVarAsIL.MarkSequencePoint(doc5, 477, 1, 477, 100)
checkVarAsIL.Emit(OpCodes.Ldarg, 2)
Typ = GetType(System.Boolean).MakeByRefType()
checkVarAsIL.Emit(OpCodes.Ldobj, Typ.GetElementType())
Typ = Typ.GetElementType()
checkVarAsIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa124 As System.Reflection.Emit.Label = checkVarAsIL.DefineLabel()
Dim tru124 As System.Reflection.Emit.Label = checkVarAsIL.DefineLabel()
Dim cont124 As System.Reflection.Emit.Label = checkVarAsIL.DefineLabel()
checkVarAsIL.Emit(OpCodes.Beq, tru124)
checkVarAsIL.Emit(OpCodes.Br, fa124)
checkVarAsIL.MarkLabel(tru124)
checkVarAsIL.MarkSequencePoint(doc5, 478, 1, 478, 100)
checkVarAsIL.Emit(OpCodes.Ldloc, 2)
Typ = GetType(VarStmt)
checkVarAsIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
...
checkVarAsIL.MarkSequencePoint(doc5, 479, 1, 479, 100)
checkVarAsIL.Emit(OpCodes.Ldloc, 2)
Typ = GetType(VarStmt)
checkVarAsIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
...
checkVarAsIL.MarkSequencePoint(doc5, 480, 1, 480, 100)
checkVarAsIL.Emit(OpCodes.Ldloc, 2)
Typ = GetType(VarStmt)
checkVarAsIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
...
checkVarAsIL.MarkSequencePoint(doc5, 482, 1, 482, 100)
Dim locbldr184 As LocalBuilder = checkVarAsIL.DeclareLocal(GetType(Token))
locbldr184.SetLocalSymInfo("tok2")
checkVarAsIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
checkVarAsIL.Emit(OpCodes.Ldfld, GetType(Stmt).GetField("Tokens"))
Typ = GetType(Stmt).GetField("Tokens").FieldType
...
Typ = Typ.GetElementType()
checkVarAsIL.Emit(OpCodes.Stloc, 3)
checkVarAsIL.MarkSequencePoint(doc5, 483, 1, 483, 100)
Dim locbldr185 As LocalBuilder = checkVarAsIL.DeclareLocal(GetType(System.Type))
locbldr185.SetLocalSymInfo("typ2")
checkVarAsIL.Emit(OpCodes.Ldtoken, GetType(TypeTok))
Dim typ87 As Type() = {GetType(System.RuntimeTypeHandle)}
checkVarAsIL.Emit(OpCodes.Call, GetType(System.Type).GetMethod("GetTypeFromHandle", typ87))
Typ = GetType(System.Type).GetMethod("GetTypeFromHandle", typ87).ReturnType
checkVarAsIL.Emit(OpCodes.Stloc, 4)
checkVarAsIL.MarkSequencePoint(doc5, 484, 1, 484, 100)
Dim locbldr186 As LocalBuilder = checkVarAsIL.DeclareLocal(GetType(System.Boolean))
locbldr186.SetLocalSymInfo("b2")
Dim typ88(-1) As Type
checkVarAsIL.Emit(OpCodes.Ldloc, 4)
Typ = GetType(System.Type)
Typ03 = Typ
...
ReDim Preserve typ88(UBound(typ88) + 1)
typ88(UBound(typ88)) = Typ
checkVarAsIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("IsInstanceOfType", typ88))
Typ = Typ03.GetMethod("IsInstanceOfType", typ88).ReturnType
checkVarAsIL.Emit(OpCodes.Stloc, 5)
checkVarAsIL.MarkSequencePoint(doc5, 486, 1, 486, 100)
checkVarAsIL.Emit(OpCodes.Ldloc, 5)
Typ = GetType(System.Boolean)
checkVarAsIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa125 As System.Reflection.Emit.Label = checkVarAsIL.DefineLabel()
Dim tru125 As System.Reflection.Emit.Label = checkVarAsIL.DefineLabel()
Dim cont125 As System.Reflection.Emit.Label = checkVarAsIL.DefineLabel()
checkVarAsIL.Emit(OpCodes.Beq, fa125)
checkVarAsIL.Emit(OpCodes.Br, tru125)
checkVarAsIL.MarkLabel(tru125)
checkVarAsIL.MarkSequencePoint(doc5, 487, 1, 487, 100)
Dim locbldr187 As LocalBuilder = checkVarAsIL.DeclareLocal(GetType(Token))
locbldr187.SetLocalSymInfo("t")
checkVarAsIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
checkVarAsIL.Emit(OpCodes.Ldfld, GetType(Stmt).GetField("Tokens"))
Typ = GetType(Stmt).GetField("Tokens").FieldType
...
Typ = Typ.GetElementType()
checkVarAsIL.Emit(OpCodes.Stloc, 6)
checkVarAsIL.MarkSequencePoint(doc5, 488, 1, 488, 100)
Dim locbldr188 As LocalBuilder = checkVarAsIL.DeclareLocal(GetType(TypeTok))
locbldr188.SetLocalSymInfo("tt")
checkVarAsIL.Emit(OpCodes.Newobj, GetType(TypeTok).GetConstructor(Type.EmptyTypes))
checkVarAsIL.Emit(OpCodes.Stloc, 7)
checkVarAsIL.MarkSequencePoint(doc5, 489, 1, 489, 100)
checkVarAsIL.Emit(OpCodes.Ldloc, 7)
Typ = GetType(TypeTok)
checkVarAsIL.Emit(OpCodes.Ldloc, 6)
Typ = GetType(Token)
...
Typ = GetType(Token).GetField("Line").FieldType
checkVarAsIL.Emit(OpCodes.Stfld, GetType(TypeTok).GetField("Line"))
checkVarAsIL.MarkSequencePoint(doc5, 490, 1, 490, 100)
checkVarAsIL.Emit(OpCodes.Ldloc, 7)
Typ = GetType(TypeTok)
checkVarAsIL.Emit(OpCodes.Ldloc, 6)
Typ = GetType(Token)
...
Typ = GetType(Token).GetField("Value").FieldType
checkVarAsIL.Emit(OpCodes.Stfld, GetType(TypeTok).GetField("Value"))
checkVarAsIL.MarkSequencePoint(doc5, 491, 1, 491, 100)
checkVarAsIL.Emit(OpCodes.Ldloc, 2)
Typ = GetType(VarStmt)
checkVarAsIL.Emit(OpCodes.Ldloc, 7)
Typ = GetType(TypeTok)
checkVarAsIL.Emit(OpCodes.Stfld, GetType(VarStmt).GetField("VarTyp"))
checkVarAsIL.MarkSequencePoint(doc5, 492, 1, 492, 100)
checkVarAsIL.Emit(OpCodes.Br, cont125)
checkVarAsIL.MarkLabel(fa125)
...
checkVarAsIL.Emit(OpCodes.Br, cont125)
checkVarAsIL.MarkLabel(cont125)
checkVarAsIL.MarkSequencePoint(doc5, 496, 1, 496, 100)
checkVarAsIL.Emit(OpCodes.Br, cont124)
checkVarAsIL.MarkLabel(fa124)
checkVarAsIL.Emit(OpCodes.Br, cont124)
checkVarAsIL.MarkLabel(cont124)
checkVarAsIL.MarkSequencePoint(doc5, 497, 1, 497, 100)
checkVarAsIL.Emit(OpCodes.Ldloc, 2)
Typ = GetType(VarStmt)
...
typ89(UBound(typ89)) = GetType(Stmt)
Dim AssOpt As MethodBuilder = StmtOptimizer.DefineMethod("AssOpt", MethodAttributes.Public, GetType(Stmt), typ89)
...
AssOptIL.MarkSequencePoint(doc5, 502, 1, 502, 100)
Dim locbldr189 As LocalBuilder = AssOptIL.DeclareLocal(GetType(AssignStmt))
locbldr189.SetLocalSymInfo("asss")
AssOptIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
AssOptIL.Emit(OpCodes.Stloc, 0)
AssOptIL.MarkSequencePoint(doc5, 503, 1, 503, 100)
Dim locbldr190 As LocalBuilder = AssOptIL.DeclareLocal(GetType(Expr))
locbldr190.SetLocalSymInfo("le")
...
AssOptIL.MarkSequencePoint(doc5, 504, 1, 504, 100)
Dim locbldr191 As LocalBuilder = AssOptIL.DeclareLocal(GetType(Token))
...
AssOptIL.MarkSequencePoint(doc5, 505, 1, 505, 100)
Dim locbldr192 As LocalBuilder = AssOptIL.DeclareLocal(GetType(System.Type))
...
AssOptIL.Emit(OpCodes.Call, GetType(System.Type).GetMethod("GetTypeFromHandle", typ90))
Typ = GetType(System.Type).GetMethod("GetTypeFromHandle", typ90).ReturnType
AssOptIL.Emit(OpCodes.Stloc, 3)
AssOptIL.MarkSequencePoint(doc5, 506, 1, 506, 100)
Dim locbldr193 As LocalBuilder = AssOptIL.DeclareLocal(GetType(System.Boolean))
...
ReDim Preserve typ91(UBound(typ91) + 1)
typ91(UBound(typ91)) = Typ
AssOptIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("IsInstanceOfType", typ91))
Typ = Typ03.GetMethod("IsInstanceOfType", typ91).ReturnType
AssOptIL.Emit(OpCodes.Stloc, 4)
AssOptIL.MarkSequencePoint(doc5, 507, 1, 507, 100)
Dim locbldr194 As LocalBuilder = AssOptIL.DeclareLocal(GetType(VarAsgnStmt))
locbldr194.SetLocalSymInfo("vass")
AssOptIL.Emit(OpCodes.Newobj, GetType(VarAsgnStmt).GetConstructor(Type.EmptyTypes))
AssOptIL.Emit(OpCodes.Stloc, 5)
AssOptIL.MarkSequencePoint(doc5, 508, 1, 508, 100)
AssOptIL.Emit(OpCodes.Ldloc, 4)
Typ = GetType(System.Boolean)
AssOptIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa126 As System.Reflection.Emit.Label = AssOptIL.DefineLabel()
Dim tru126 As System.Reflection.Emit.Label = AssOptIL.DefineLabel()
Dim cont126 As System.Reflection.Emit.Label = AssOptIL.DefineLabel()
AssOptIL.Emit(OpCodes.Beq, tru126)
AssOptIL.Emit(OpCodes.Br, fa126)
AssOptIL.MarkLabel(tru126)
AssOptIL.MarkSequencePoint(doc5, 509, 1, 509, 100)
...
AssOptIL.MarkSequencePoint(doc5, 510, 1, 510, 100)
AssOptIL.Emit(OpCodes.Ldloc, 5)
Typ = GetType(VarAsgnStmt)
AssOptIL.Emit(OpCodes.Ldloc, 0)
Typ = GetType(AssignStmt)
...
AssOptIL.MarkSequencePoint(doc5, 511, 1, 511, 100)
AssOptIL.Emit(OpCodes.Ldloc, 5)
Typ = GetType(VarAsgnStmt)
AssOptIL.Emit(OpCodes.Ldloc, 1)
Typ = GetType(Expr)
...
AssOptIL.MarkSequencePoint(doc5, 513, 1, 513, 100)
Dim locbldr195 As LocalBuilder = AssOptIL.DeclareLocal(GetType(Token))
locbldr195.SetLocalSymInfo("tok2")
AssOptIL.Emit(OpCodes.Ldloc, 1)
Typ = GetType(Expr)
AssOptIL.Emit(OpCodes.Ldfld, GetType(Expr).GetField("Tokens"))
Typ = GetType(Expr).GetField("Tokens").FieldType
...
AssOptIL.MarkSequencePoint(doc5, 514, 1, 514, 100)
Dim locbldr196 As LocalBuilder = AssOptIL.DeclareLocal(GetType(System.Type))
locbldr196.SetLocalSymInfo("typ2")
AssOptIL.Emit(OpCodes.Ldtoken, GetType(TypeTok))
Dim typ92 As Type() = {GetType(System.RuntimeTypeHandle)}
AssOptIL.Emit(OpCodes.Call, GetType(System.Type).GetMethod("GetTypeFromHandle", typ92))
Typ = GetType(System.Type).GetMethod("GetTypeFromHandle", typ92).ReturnType
AssOptIL.Emit(OpCodes.Stloc, 7)
AssOptIL.MarkSequencePoint(doc5, 515, 1, 515, 100)
Dim locbldr197 As LocalBuilder = AssOptIL.DeclareLocal(GetType(System.Boolean))
locbldr197.SetLocalSymInfo("b2")
Dim typ93(-1) As Type
...
ReDim Preserve typ93(UBound(typ93) + 1)
typ93(UBound(typ93)) = Typ
AssOptIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("IsInstanceOfType", typ93))
Typ = Typ03.GetMethod("IsInstanceOfType", typ93).ReturnType
AssOptIL.Emit(OpCodes.Stloc, 8)
AssOptIL.MarkSequencePoint(doc5, 517, 1, 517, 100)
AssOptIL.Emit(OpCodes.Ldloc, 8)
Typ = GetType(System.Boolean)
AssOptIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa127 As System.Reflection.Emit.Label = AssOptIL.DefineLabel()
Dim tru127 As System.Reflection.Emit.Label = AssOptIL.DefineLabel()
Dim cont127 As System.Reflection.Emit.Label = AssOptIL.DefineLabel()
AssOptIL.Emit(OpCodes.Beq, fa127)
AssOptIL.Emit(OpCodes.Br, tru127)
AssOptIL.MarkLabel(tru127)
AssOptIL.MarkSequencePoint(doc5, 518, 1, 518, 100)
Dim locbldr198 As LocalBuilder = AssOptIL.DeclareLocal(GetType(Token))
locbldr198.SetLocalSymInfo("t")
AssOptIL.Emit(OpCodes.Ldloc, 1)
Typ = GetType(Expr)
AssOptIL.Emit(OpCodes.Ldfld, GetType(Expr).GetField("Tokens"))
Typ = GetType(Expr).GetField("Tokens").FieldType
...
AssOptIL.MarkSequencePoint(doc5, 519, 1, 519, 100)
Dim locbldr199 As LocalBuilder = AssOptIL.DeclareLocal(GetType(TypeTok))
locbldr199.SetLocalSymInfo("tt")
AssOptIL.Emit(OpCodes.Newobj, GetType(TypeTok).GetConstructor(Type.EmptyTypes))
AssOptIL.Emit(OpCodes.Stloc, 10)
AssOptIL.MarkSequencePoint(doc5, 520, 1, 520, 100)
...
AssOptIL.MarkSequencePoint(doc5, 521, 1, 521, 100)
AssOptIL.Emit(OpCodes.Ldloc, 10)
Typ = GetType(TypeTok)
AssOptIL.Emit(OpCodes.Ldloc, 9)
Typ = GetType(Token)
...
AssOptIL.MarkSequencePoint(doc5, 522, 1, 522, 100)
AssOptIL.Emit(OpCodes.Ldloc, 5)
Typ = GetType(VarAsgnStmt)
AssOptIL.Emit(OpCodes.Ldloc, 10)
Typ = GetType(TypeTok)
...
AssOptIL.Emit(OpCodes.Br, cont127)
AssOptIL.MarkLabel(fa127)
...
Dim locbldr200 As LocalBuilder = AssOptIL.DeclareLocal(asm.GetType("dylan.NET.Tokenizer.Parser.ExprOptimizer"))
...
AssOptIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("Optimize", typ94))
...
AssOptIL.Emit(OpCodes.Br, cont126)
AssOptIL.MarkLabel(fa126)
AssOptIL.MarkSequencePoint(doc5, 533, 1, 533, 100)
AssOptIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
AssOptIL.MarkSequencePoint(doc5, 534, 1, 534, 100)
AssOptIL.Emit(OpCodes.Br, cont126)
AssOptIL.MarkLabel(cont126)
...
ReDim Preserve typ95(UBound(typ95) + 1)
typ95(UBound(typ95)) = GetType(System.Boolean).MakeByRefType()
Dim checkAssign As MethodBuilder = StmtOptimizer.DefineMethod("checkAssign", MethodAttributes.Public, GetType(Stmt), typ95)
...
checkAssignIL.MarkSequencePoint(doc5, 539, 1, 539, 100)
Dim locbldr201 As LocalBuilder = checkAssignIL.DeclareLocal(GetType(Token))
locbldr201.SetLocalSymInfo("tok")
checkAssignIL.Emit(OpCodes.Ldnull)
checkAssignIL.Emit(OpCodes.Stloc, 0)
checkAssignIL.MarkSequencePoint(doc5, 540, 1, 540, 100)
Dim locbldr202 As LocalBuilder = checkAssignIL.DeclareLocal(GetType(System.Type))
...
checkAssignIL.Emit(OpCodes.Call, GetType(System.Type).GetMethod("GetTypeFromHandle", typ96))
Typ = GetType(System.Type).GetMethod("GetTypeFromHandle", typ96).ReturnType
checkAssignIL.Emit(OpCodes.Stloc, 1)
checkAssignIL.MarkSequencePoint(doc5, 541, 1, 541, 100)
Dim locbldr203 As LocalBuilder = checkAssignIL.DeclareLocal(GetType(AssignStmt))
locbldr203.SetLocalSymInfo("asss")
checkAssignIL.Emit(OpCodes.Newobj, GetType(AssignStmt).GetConstructor(Type.EmptyTypes))
checkAssignIL.Emit(OpCodes.Stloc, 2)
checkAssignIL.MarkSequencePoint(doc5, 542, 1, 542, 100)
Dim locbldr204 As LocalBuilder = checkAssignIL.DeclareLocal(GetType(System.Boolean))
locbldr204.SetLocalSymInfo("c")
checkAssignIL.Emit(OpCodes.Ldc_I4, 0)
Typ = GetType(System.Boolean)
checkAssignIL.Emit(OpCodes.Stloc, 3)
checkAssignIL.MarkSequencePoint(doc5, 543, 1, 543, 100)
Dim locbldr205 As LocalBuilder = checkAssignIL.DeclareLocal(GetType(Expr))
locbldr205.SetLocalSymInfo("re")
checkAssignIL.Emit(OpCodes.Newobj, GetType(Expr).GetConstructor(Type.EmptyTypes))
checkAssignIL.Emit(OpCodes.Stloc, 4)
checkAssignIL.MarkSequencePoint(doc5, 544, 1, 544, 100)
Dim locbldr206 As LocalBuilder = checkAssignIL.DeclareLocal(GetType(Expr))
locbldr206.SetLocalSymInfo("le")
checkAssignIL.Emit(OpCodes.Newobj, GetType(Expr).GetConstructor(Type.EmptyTypes))
checkAssignIL.Emit(OpCodes.Stloc, 5)
checkAssignIL.MarkSequencePoint(doc5, 545, 1, 545, 100)
Dim locbldr207 As LocalBuilder = checkAssignIL.DeclareLocal(GetType(System.Int32))
locbldr207.SetLocalSymInfo("i")
checkAssignIL.Emit(OpCodes.Ldc_I4, CInt(-1))
Typ = GetType(System.Int32)
checkAssignIL.Emit(OpCodes.Stloc, 6)
checkAssignIL.MarkSequencePoint(doc5, 546, 1, 546, 100)
Dim locbldr208 As LocalBuilder = checkAssignIL.DeclareLocal(GetType(System.Int32))
...
checkAssignIL.MarkSequencePoint(doc5, 547, 1, 547, 100)
Dim locbldr209 As LocalBuilder = checkAssignIL.DeclareLocal(GetType(System.Int32))
locbldr209.SetLocalSymInfo("assind")
checkAssignIL.Emit(OpCodes.Ldc_I4, CInt(0))
Typ = GetType(System.Int32)
checkAssignIL.Emit(OpCodes.Stloc, 8)
checkAssignIL.MarkSequencePoint(doc5, 549, 1, 549, 100)
Dim label10 As System.Reflection.Emit.Label = checkAssignIL.DefineLabel()
checkAssignIL.MarkSequencePoint(doc5, 550, 1, 550, 100)
Dim label11 As System.Reflection.Emit.Label = checkAssignIL.DefineLabel()
checkAssignIL.MarkSequencePoint(doc5, 552, 1, 552, 100)
checkAssignIL.MarkLabel(label10)
checkAssignIL.MarkSequencePoint(doc5, 554, 1, 554, 100)
...
checkAssignIL.Emit(OpCodes.Stloc, 6)
checkAssignIL.MarkSequencePoint(doc5, 556, 1, 556, 100)
checkAssignIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
checkAssignIL.Emit(OpCodes.Ldfld, GetType(Stmt).GetField("Tokens"))
Typ = GetType(Stmt).GetField("Tokens").FieldType
...
Typ = Typ.GetElementType()
checkAssignIL.Emit(OpCodes.Stloc, 0)
checkAssignIL.MarkSequencePoint(doc5, 557, 1, 557, 100)
Dim typ97(-1) As Type
...
ReDim Preserve typ97(UBound(typ97) + 1)
typ97(UBound(typ97)) = Typ
checkAssignIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("IsInstanceOfType", typ97))
Typ = Typ03.GetMethod("IsInstanceOfType", typ97).ReturnType
checkAssignIL.Emit(OpCodes.Stloc, 3)
checkAssignIL.MarkSequencePoint(doc5, 559, 1, 559, 100)
checkAssignIL.Emit(OpCodes.Ldloc, 3)
Typ = GetType(System.Boolean)
checkAssignIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa128 As System.Reflection.Emit.Label = checkAssignIL.DefineLabel()
Dim tru128 As System.Reflection.Emit.Label = checkAssignIL.DefineLabel()
Dim cont128 As System.Reflection.Emit.Label = checkAssignIL.DefineLabel()
checkAssignIL.Emit(OpCodes.Beq, tru128)
checkAssignIL.Emit(OpCodes.Br, fa128)
checkAssignIL.MarkLabel(tru128)
...
checkAssignIL.Emit(OpCodes.Br, cont128)
checkAssignIL.MarkLabel(fa128)
checkAssignIL.Emit(OpCodes.Br, cont128)
checkAssignIL.MarkLabel(cont128)
checkAssignIL.MarkSequencePoint(doc5, 564, 1, 564, 100)
checkAssignIL.Emit(OpCodes.Ldloc, 6)
Typ = GetType(System.Int32)
checkAssignIL.Emit(OpCodes.Ldloc, 7)
Typ = GetType(System.Int32)
Dim fa129 As System.Reflection.Emit.Label = checkAssignIL.DefineLabel()
Dim tru129 As System.Reflection.Emit.Label = checkAssignIL.DefineLabel()
Dim cont129 As System.Reflection.Emit.Label = checkAssignIL.DefineLabel()
checkAssignIL.Emit(OpCodes.Beq, tru129)
checkAssignIL.Emit(OpCodes.Br, fa129)
checkAssignIL.MarkLabel(tru129)
checkAssignIL.MarkSequencePoint(doc5, 565, 1, 565, 100)
checkAssignIL.Emit(OpCodes.Br, label11)
checkAssignIL.MarkSequencePoint(doc5, 566, 1, 566, 100)
checkAssignIL.Emit(OpCodes.Br, cont129)
checkAssignIL.MarkLabel(fa129)
...
checkAssignIL.Emit(OpCodes.Br, cont129)
checkAssignIL.MarkLabel(cont129)
checkAssignIL.MarkSequencePoint(doc5, 570, 1, 570, 100)
checkAssignIL.MarkLabel(label11)
checkAssignIL.MarkSequencePoint(doc5, 572, 1, 572, 100)
checkAssignIL.Emit(OpCodes.Ldloc, 8)
Typ = GetType(System.Int32)
checkAssignIL.Emit(OpCodes.Ldc_I4, CInt(0))
Typ = GetType(System.Int32)
Dim fa130 As System.Reflection.Emit.Label = checkAssignIL.DefineLabel()
Dim tru130 As System.Reflection.Emit.Label = checkAssignIL.DefineLabel()
Dim cont130 As System.Reflection.Emit.Label = checkAssignIL.DefineLabel()
checkAssignIL.Emit(OpCodes.Beq, fa130)
checkAssignIL.Emit(OpCodes.Br, tru130)
checkAssignIL.MarkLabel(tru130)
checkAssignIL.MarkSequencePoint(doc5, 574, 1, 574, 100)
checkAssignIL.Emit(OpCodes.Ldc_I4, CInt(-1))
Typ = GetType(System.Int32)
checkAssignIL.Emit(OpCodes.Stloc, 6)
...
checkAssignIL.Emit(OpCodes.Add)
checkAssignIL.Emit(OpCodes.Stloc, 6)
checkAssignIL.MarkSequencePoint(doc5, 584, 1, 584, 100)
Dim typ98(-1) As Type
...
ReDim Preserve typ98(UBound(typ98) + 1)
typ98(UBound(typ98)) = Typ
checkAssignIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("AddToken", typ98))
Typ = Typ03.GetMethod("AddToken", typ98).ReturnType
If Typ.ToString() = GetType(System.Void).ToString() Then
...
checkAssignIL.Emit(OpCodes.Ldloc, 7)
Typ = GetType(System.Int32)
Dim fa131 As System.Reflection.Emit.Label = checkAssignIL.DefineLabel()
Dim tru131 As System.Reflection.Emit.Label = checkAssignIL.DefineLabel()
Dim cont131 As System.Reflection.Emit.Label = checkAssignIL.DefineLabel()
checkAssignIL.Emit(OpCodes.Beq, tru131)
checkAssignIL.Emit(OpCodes.Br, fa131)
checkAssignIL.MarkLabel(tru131)
...
checkAssignIL.Emit(OpCodes.Br, cont131)
checkAssignIL.MarkLabel(fa131)
checkAssignIL.MarkSequencePoint(doc5, 589, 1, 589, 100)
checkAssignIL.Emit(OpCodes.Br, label12)
checkAssignIL.MarkSequencePoint(doc5, 590, 1, 590, 100)
checkAssignIL.Emit(OpCodes.Br, cont131)
checkAssignIL.MarkLabel(cont131)
checkAssignIL.MarkSequencePoint(doc5, 592, 1, 592, 100)
...
ReDim Preserve typ99(UBound(typ99) + 1)
typ99(UBound(typ99)) = Typ
checkAssignIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("AddToken", typ99))
...
checkAssignIL.Emit(OpCodes.Ldloc, 7)
Typ = GetType(System.Int32)
Dim fa132 As System.Reflection.Emit.Label = checkAssignIL.DefineLabel()
Dim tru132 As System.Reflection.Emit.Label = checkAssignIL.DefineLabel()
Dim cont132 As System.Reflection.Emit.Label = checkAssignIL.DefineLabel()
checkAssignIL.Emit(OpCodes.Beq, tru132)
checkAssignIL.Emit(OpCodes.Br, fa132)
checkAssignIL.MarkLabel(tru132)
...
checkAssignIL.Emit(OpCodes.Br, cont132)
checkAssignIL.MarkLabel(fa132)
...
checkAssignIL.Emit(OpCodes.Br, cont132)
checkAssignIL.MarkLabel(cont132)
checkAssignIL.MarkSequencePoint(doc5, 613, 1, 613, 100)
checkAssignIL.MarkLabel(label15)
checkAssignIL.MarkSequencePoint(doc5, 615, 1, 615, 100)
...
checkAssignIL.MarkSequencePoint(doc5, 618, 1, 618, 100)
checkAssignIL.Emit(OpCodes.Ldloc, 2)
Typ = GetType(AssignStmt)
checkAssignIL.Emit(OpCodes.Ldloc, 4)
Typ = GetType(Expr)
...
checkAssignIL.Emit(OpCodes.Br, cont130)
checkAssignIL.MarkLabel(fa130)
checkAssignIL.MarkSequencePoint(doc5, 627, 1, 627, 100)
checkAssignIL.Emit(OpCodes.Ldarg, 2)
Typ = GetType(System.Boolean).MakeByRefType()
Typ04 = Typ.GetElementType()
checkAssignIL.Emit(OpCodes.Ldc_I4, 0)
...
ReDim Preserve typ102(UBound(typ102) + 1)
typ102(UBound(typ102)) = Typ
OptimizeIL.Emit(OpCodes.Call, GetType(Console).GetMethod("WriteLine", typ102))
Typ = GetType(Console).GetMethod("WriteLine", typ102).ReturnType
If Typ.ToString() = GetType(System.Void).ToString() Then

Else
OptimizeIL.Emit(OpCodes.Pop)
End If
OptimizeIL.MarkSequencePoint(doc5, 638, 1, 638, 100)
Dim locbldr210 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(System.Int32))
locbldr210.SetLocalSymInfo("i")
OptimizeIL.Emit(OpCodes.Ldc_I4, CInt(-1))
Typ = GetType(System.Int32)
OptimizeIL.Emit(OpCodes.Stloc, 0)
OptimizeIL.MarkSequencePoint(doc5, 639, 1, 639, 100)
Dim locbldr211 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(System.Int32))
locbldr211.SetLocalSymInfo("len")
OptimizeIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
...
Typ = GetType(System.Int32)
OptimizeIL.Emit(OpCodes.Stloc, 1)
OptimizeIL.MarkSequencePoint(doc5, 640, 1, 640, 100)
Dim locbldr212 As LocalBuilder = OptimizeIL.DeclareLocal(asm.GetType("dylan.NET.Tokenizer.Parser.TokenOptimizer"))
locbldr212.SetLocalSymInfo("to")
OptimizeIL.Emit(OpCodes.Ldnull)
OptimizeIL.Emit(OpCodes.Stloc, 2)
OptimizeIL.MarkSequencePoint(doc5, 641, 1, 641, 100)
Dim locbldr213 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(Stmt))
locbldr213.SetLocalSymInfo("tmpstm")
OptimizeIL.Emit(OpCodes.Ldnull)
OptimizeIL.Emit(OpCodes.Stloc, 3)
OptimizeIL.MarkSequencePoint(doc5, 642, 1, 642, 100)
Dim locbldr214 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(System.Boolean))
locbldr214.SetLocalSymInfo("compb")
OptimizeIL.Emit(OpCodes.Ldc_I4, 0)
Typ = GetType(System.Boolean)
OptimizeIL.Emit(OpCodes.Stloc, 4)
OptimizeIL.MarkSequencePoint(doc5, 643, 1, 643, 100)
OptimizeIL.Emit(OpCodes.Ldloc, 1)
Typ = GetType(System.Int32)
OptimizeIL.Emit(OpCodes.Ldc_I4, CInt(1))
Typ = GetType(System.Int32)
OptimizeIL.Emit(OpCodes.Sub)
OptimizeIL.Emit(OpCodes.Stloc, 1)
OptimizeIL.MarkSequencePoint(doc5, 645, 1, 645, 100)
OptimizeIL.Emit(OpCodes.Ldc_I4, 0)
Typ = GetType(System.Boolean)
OptimizeIL.Emit(OpCodes.Stsfld, asm.GetType("dylan.NET.Tokenizer.Parser.ParserFlags").GetField("IfFlag"))
OptimizeIL.MarkSequencePoint(doc5, 646, 1, 646, 100)
OptimizeIL.Emit(OpCodes.Ldc_I4, 0)
Typ = GetType(System.Boolean)
OptimizeIL.Emit(OpCodes.Stsfld, asm.GetType("dylan.NET.Tokenizer.Parser.ParserFlags").GetField("CmtFlag"))
OptimizeIL.MarkSequencePoint(doc5, 647, 1, 647, 100)
OptimizeIL.Emit(OpCodes.Ldc_I4, 0)
Typ = GetType(System.Boolean)
OptimizeIL.Emit(OpCodes.Stsfld, asm.GetType("dylan.NET.Tokenizer.Parser.ParserFlags").GetField("NoOptFlag"))
OptimizeIL.MarkSequencePoint(doc5, 649, 1, 649, 100)
Dim label16 As System.Reflection.Emit.Label = OptimizeIL.DefineLabel()
OptimizeIL.MarkSequencePoint(doc5, 650, 1, 650, 100)
Dim label17 As System.Reflection.Emit.Label = OptimizeIL.DefineLabel()
OptimizeIL.MarkSequencePoint(doc5, 651, 1, 651, 100)
Dim label18 As System.Reflection.Emit.Label = OptimizeIL.DefineLabel()
OptimizeIL.MarkSequencePoint(doc5, 653, 1, 653, 100)
OptimizeIL.Emit(OpCodes.Ldloc, 1)
Typ = GetType(System.Int32)
OptimizeIL.Emit(OpCodes.Ldc_I4, CInt(0))
Typ = GetType(System.Int32)
...
OptimizeIL.Emit(OpCodes.Blt, tru133)
OptimizeIL.Emit(OpCodes.Br, fa133)
OptimizeIL.MarkLabel(tru133)
OptimizeIL.MarkSequencePoint(doc5, 654, 1, 654, 100)
OptimizeIL.Emit(OpCodes.Br, label17)
OptimizeIL.MarkSequencePoint(doc5, 655, 1, 655, 100)
OptimizeIL.Emit(OpCodes.Br, cont133)
OptimizeIL.MarkLabel(fa133)
OptimizeIL.Emit(OpCodes.Br, cont133)
OptimizeIL.MarkLabel(cont133)
OptimizeIL.MarkSequencePoint(doc5, 657, 1, 657, 100)
OptimizeIL.MarkLabel(label16)
OptimizeIL.MarkSequencePoint(doc5, 659, 1, 659, 100)
OptimizeIL.Emit(OpCodes.Ldloc, 0)
Typ = GetType(System.Int32)
OptimizeIL.Emit(OpCodes.Ldc_I4, CInt(1))
Typ = GetType(System.Int32)
OptimizeIL.Emit(OpCodes.Add)
OptimizeIL.Emit(OpCodes.Stloc, 0)
OptimizeIL.MarkSequencePoint(doc5, 661, 1, 661, 100)
...
OptimizeIL.Emit(OpCodes.Br, label17)
OptimizeIL.MarkSequencePoint(doc5, 668, 1, 668, 100)
...
ReDim Preserve typ103(UBound(typ103) + 1)
typ103(UBound(typ103)) = Typ
OptimizeIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("Optimize", typ103))
...
OptimizeIL.MarkSequencePoint(doc5, 676, 1, 676, 100)
...
OptimizeIL.MarkSequencePoint(doc5, 682, 1, 682, 100)
...
OptimizeIL.MarkSequencePoint(doc5, 688, 1, 688, 100)
OptimizeIL.Emit(OpCodes.Ldloc, 3)
Typ = GetType(Stmt)
OptimizeIL.Emit(OpCodes.Starg, 1)
OptimizeIL.MarkSequencePoint(doc5, 689, 1, 689, 100)
OptimizeIL.Emit(OpCodes.Br, label18)
...
Typ = GetType(Stmt)
OptimizeIL.Emit(OpCodes.Starg, 1)
OptimizeIL.MarkSequencePoint(doc5, 696, 1, 696, 100)
OptimizeIL.Emit(OpCodes.Br, label18)
...
OptimizeIL.MarkSequencePoint(doc5, 702, 1, 702, 100)
OptimizeIL.Emit(OpCodes.Ldloc, 3)
Typ = GetType(Stmt)
OptimizeIL.Emit(OpCodes.Starg, 1)
OptimizeIL.MarkSequencePoint(doc5, 703, 1, 703, 100)
OptimizeIL.Emit(OpCodes.Br, label18)
OptimizeIL.MarkSequencePoint(doc5, 704, 1, 704, 100)
...
OptimizeIL.Emit(OpCodes.Stloc, 3)
OptimizeIL.MarkSequencePoint(doc5, 708, 1, 708, 100)
OptimizeIL.Emit(OpCodes.Ldloc, 4)
Typ = GetType(System.Boolean)
OptimizeIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
...
Typ = GetType(Stmt)
OptimizeIL.Emit(OpCodes.Starg, 1)
OptimizeIL.MarkSequencePoint(doc5, 710, 1, 710, 100)
OptimizeIL.Emit(OpCodes.Br, label18)
...
OptimizeIL.Emit(OpCodes.Stloc, 3)
OptimizeIL.MarkSequencePoint(doc5, 715, 1, 715, 100)
OptimizeIL.Emit(OpCodes.Ldloc, 4)
Typ = GetType(System.Boolean)
OptimizeIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
...
Typ = GetType(Stmt)
OptimizeIL.Emit(OpCodes.Starg, 1)
OptimizeIL.MarkSequencePoint(doc5, 717, 1, 717, 100)
OptimizeIL.Emit(OpCodes.Br, label18)
...
OptimizeIL.Emit(OpCodes.Stloc, 3)
OptimizeIL.MarkSequencePoint(doc5, 722, 1, 722, 100)
OptimizeIL.Emit(OpCodes.Ldloc, 4)
Typ = GetType(System.Boolean)
OptimizeIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
...
Typ = GetType(Stmt)
OptimizeIL.Emit(OpCodes.Starg, 1)
OptimizeIL.MarkSequencePoint(doc5, 724, 1, 724, 100)
OptimizeIL.Emit(OpCodes.Br, label18)
...
OptimizeIL.Emit(OpCodes.Stloc, 3)
OptimizeIL.MarkSequencePoint(doc5, 729, 1, 729, 100)
OptimizeIL.Emit(OpCodes.Ldloc, 4)
Typ = GetType(System.Boolean)
OptimizeIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
...
Typ = GetType(Stmt)
OptimizeIL.Emit(OpCodes.Starg, 1)
OptimizeIL.MarkSequencePoint(doc5, 731, 1, 731, 100)
OptimizeIL.Emit(OpCodes.Br, label18)
...
OptimizeIL.Emit(OpCodes.Stloc, 3)
OptimizeIL.MarkSequencePoint(doc5, 736, 1, 736, 100)
OptimizeIL.Emit(OpCodes.Ldloc, 4)
Typ = GetType(System.Boolean)
OptimizeIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
...
Typ = GetType(Stmt)
OptimizeIL.Emit(OpCodes.Starg, 1)
OptimizeIL.MarkSequencePoint(doc5, 738, 1, 738, 100)
OptimizeIL.Emit(OpCodes.Br, label18)
...
OptimizeIL.Emit(OpCodes.Stloc, 3)
OptimizeIL.MarkSequencePoint(doc5, 743, 1, 743, 100)
OptimizeIL.Emit(OpCodes.Ldloc, 4)
Typ = GetType(System.Boolean)
OptimizeIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
...
Typ = GetType(Stmt)
OptimizeIL.Emit(OpCodes.Starg, 1)
OptimizeIL.MarkSequencePoint(doc5, 745, 1, 745, 100)
OptimizeIL.Emit(OpCodes.Br, label18)
...
Typ = GetType(Stmt)
OptimizeIL.Emit(OpCodes.Starg, 1)
OptimizeIL.MarkSequencePoint(doc5, 766, 1, 766, 100)
OptimizeIL.Emit(OpCodes.Br, label18)
...
Dim locbldr215 As LocalBuilder = ParseIL.DeclareLocal(GetType(System.Int32))
locbldr215.SetLocalSymInfo("i")
ParseIL.Emit(OpCodes.Ldc_I4, CInt(-1))
Typ = GetType(System.Int32)
ParseIL.Emit(OpCodes.Stloc, 0)
ParseIL.MarkSequencePoint(doc6, 5, 1, 5, 100)
Dim locbldr216 As LocalBuilder = ParseIL.DeclareLocal(asm.GetType("dylan.NET.Tokenizer.Parser.StmtOptimizer"))
locbldr216.SetLocalSymInfo("so")
ParseIL.Emit(OpCodes.Ldnull)
ParseIL.Emit(OpCodes.Stloc, 1)
ParseIL.MarkSequencePoint(doc6, 6, 1, 6, 100)
Dim locbldr217 As LocalBuilder = ParseIL.DeclareLocal(GetType(System.Int32))
locbldr217.SetLocalSymInfo("len")
...
ParseIL.Emit(OpCodes.Ldloc, 2)
Typ = GetType(System.Int32)
Dim fa151 As System.Reflection.Emit.Label = ParseIL.DefineLabel()
Dim tru151 As System.Reflection.Emit.Label = ParseIL.DefineLabel()
Dim cont151 As System.Reflection.Emit.Label = ParseIL.DefineLabel()
ParseIL.Emit(OpCodes.Beq, tru151)
ParseIL.Emit(OpCodes.Br, fa151)
ParseIL.MarkLabel(tru151)
ParseIL.MarkSequencePoint(doc6, 19, 1, 19, 100)
ParseIL.Emit(OpCodes.Br, label1)
ParseIL.MarkSequencePoint(doc6, 20, 1, 20, 100)
ParseIL.Emit(OpCodes.Br, cont151)
ParseIL.MarkLabel(fa151)
ParseIL.MarkSequencePoint(doc6, 21, 1, 21, 100)
ParseIL.Emit(OpCodes.Br, label0)
ParseIL.MarkSequencePoint(doc6, 22, 1, 22, 100)
ParseIL.Emit(OpCodes.Br, cont151)
ParseIL.MarkLabel(cont151)
