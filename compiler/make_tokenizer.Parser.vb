...
Dim locbldr43 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(ThenTok))
locbldr43.SetLocalSymInfo("thentk")
...
Dim locbldr44 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(RefasmTok))
locbldr44.SetLocalSymInfo("ratk")
...
Dim locbldr45 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(DebugTok))
locbldr45.SetLocalSymInfo("dgtk")
...
Dim locbldr46 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(ImportTok))
locbldr46.SetLocalSymInfo("imptk")
...
Dim locbldr47 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(LocimportTok))
locbldr47.SetLocalSymInfo("limptk")
...
Dim locbldr48 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(AssemblyTok))
locbldr48.SetLocalSymInfo("asmtk")
...
Dim locbldr49 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(VerTok))
locbldr49.SetLocalSymInfo("vertk")
...
Dim locbldr50 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(OnTok))
locbldr50.SetLocalSymInfo("ontk")
...
Dim locbldr51 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(OffTok))
locbldr51.SetLocalSymInfo("offtk")
...
Dim locbldr52 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(ExeTok))
locbldr52.SetLocalSymInfo("extk")
...
Dim locbldr53 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(DllTok))
locbldr53.SetLocalSymInfo("dltk")
...
Dim locbldr54 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(FieldTok))
locbldr54.SetLocalSymInfo("fltk")
...
OptimizeIL.Emit(OpCodes.Stloc, 0)
OptimizeIL.MarkSequencePoint(doc3, 530, 1, 530, 100)
OptimizeIL.Emit(OpCodes.Ldloc, 0)
Typ = GetType(System.Int32)
OptimizeIL.Emit(OpCodes.Ldc_I4, CInt(0))
Typ = GetType(System.Int32)
...
Dim locbldr55 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(ClassTok))
locbldr55.SetLocalSymInfo("cltk")
...
OptimizeIL.Emit(OpCodes.Stloc, 0)
OptimizeIL.MarkSequencePoint(doc3, 540, 1, 540, 100)
OptimizeIL.Emit(OpCodes.Ldloc, 0)
Typ = GetType(System.Int32)
OptimizeIL.Emit(OpCodes.Ldc_I4, CInt(0))
Typ = GetType(System.Int32)
...
Dim locbldr56 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(ExtendsTok))
locbldr56.SetLocalSymInfo("exttk")
...
Dim locbldr57 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(MethodTok))
locbldr57.SetLocalSymInfo("mettk")
...
Dim locbldr58 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(EndTok))
locbldr58.SetLocalSymInfo("entk")
...
Dim locbldr59 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(VarTok))
locbldr59.SetLocalSymInfo("vrtk")
...
Dim locbldr60 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(AsTok))
locbldr60.SetLocalSymInfo("astk")
...
Dim locbldr61 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(OfTok))
locbldr61.SetLocalSymInfo("oftk")
...
Dim locbldr62 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(PrivateAttr))
locbldr62.SetLocalSymInfo("privattr")
...
Dim locbldr63 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(PublicAttr))
locbldr63.SetLocalSymInfo("pubattr")
...
Dim locbldr64 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(InitOnlyAttr))
locbldr64.SetLocalSymInfo("initoattr")
...
Dim locbldr65 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(StaticAttr))
locbldr65.SetLocalSymInfo("statattr")
...
Dim locbldr66 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(AutoLayoutAttr))
locbldr66.SetLocalSymInfo("autattr")
...
Dim locbldr67 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(AutoClassAttr))
locbldr67.SetLocalSymInfo("autcattr")
...
Dim locbldr68 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(AnsiClassAttr))
locbldr68.SetLocalSymInfo("ansattr")
...
Dim locbldr69 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(BeforeFieldInitAttr))
locbldr69.SetLocalSymInfo("bfiattr")
...
Dim locbldr70 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(StringTok))
locbldr70.SetLocalSymInfo("strtok")
...
Dim locbldr71 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(VoidTok))
locbldr71.SetLocalSymInfo("voidtok")
...
Dim locbldr72 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(DecimalTok))
locbldr72.SetLocalSymInfo("decitok")
...
Dim locbldr73 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(IntegerTok))
locbldr73.SetLocalSymInfo("inttok")
...
Dim locbldr74 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(IntPtrTok))
locbldr74.SetLocalSymInfo("intptok")
...
Dim locbldr75 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(UIntegerTok))
locbldr75.SetLocalSymInfo("uinttok")
...
Dim locbldr76 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(DoubleTok))
locbldr76.SetLocalSymInfo("dbltok")
...
Dim locbldr77 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(BooleanTok))
locbldr77.SetLocalSymInfo("booltok")
...
Dim locbldr78 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(CharTok))
locbldr78.SetLocalSymInfo("chrtok")
...
Dim locbldr79 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(SingleTok))
locbldr79.SetLocalSymInfo("sngtok")
...
Dim locbldr80 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(SByteTok))
locbldr80.SetLocalSymInfo("sbytok")
...
Dim locbldr81 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(ByteTok))
locbldr81.SetLocalSymInfo("byttok")
...
Dim locbldr82 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(ShortTok))
locbldr82.SetLocalSymInfo("shtok")
...
Dim locbldr83 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(UShortTok))
locbldr83.SetLocalSymInfo("ushtok")
...
Dim locbldr84 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(LongTok))
locbldr84.SetLocalSymInfo("lngtok")
...
Dim locbldr85 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(ULongTok))
locbldr85.SetLocalSymInfo("ulngtok")
...
Dim locbldr86 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(ObjectTok))
locbldr86.SetLocalSymInfo("objtok")
...
Dim locbldr87 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(commentTok))
locbldr87.SetLocalSymInfo("comtok")
...
Dim locbldr88 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(BooleanLiteral))
locbldr88.SetLocalSymInfo("boolit")
...
Dim locbldr89 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(CharLiteral))
locbldr89.SetLocalSymInfo("chrlit")
...
OptimizeIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("Trim", typ106))
Typ = Typ03.GetMethod("Trim", typ106).ReturnType
OptimizeIL.Emit(OpCodes.Stloc, 2)
...
ReDim Preserve typ108(UBound(typ108) + 1)
typ108(UBound(typ108)) = Typ
OptimizeIL.Emit(OpCodes.Call, GetType(String).GetMethod("Concat", typ108))
Typ = GetType(String).GetMethod("Concat", typ108).ReturnType
OptimizeIL.Emit(OpCodes.Stloc, 2)
...
Dim locbldr90 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(StringLiteral))
locbldr90.SetLocalSymInfo("strlit")
...
ReDim Preserve typ114(UBound(typ114) + 1)
typ114(UBound(typ114)) = Typ
OptimizeIL.Emit(OpCodes.Call, GetType(Utils.ParseUtils).GetMethod("LikeOP", typ114))
Typ = GetType(Utils.ParseUtils).GetMethod("LikeOP", typ114).ReturnType
OptimizeIL.Emit(OpCodes.Stloc, 1)
...
OptimizeIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("EndsWith", typ115))
Typ = Typ03.GetMethod("EndsWith", typ115).ReturnType
OptimizeIL.Emit(OpCodes.Stloc, 1)
...
locbldr91.SetLocalSymInfo("dlit2")
...
OptimizeIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("TrimEnd", typ117))
Typ = Typ03.GetMethod("TrimEnd", typ117).ReturnType
OptimizeIL.Emit(OpCodes.Stloc, 2)
...
OptimizeIL.Emit(OpCodes.Call, GetType(System.Convert).GetMethod("ToDouble", typ118))
Typ = GetType(System.Convert).GetMethod("ToDouble", typ118).ReturnType
...
OptimizeIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("EndsWith", typ122))
Typ = Typ03.GetMethod("EndsWith", typ122).ReturnType
OptimizeIL.Emit(OpCodes.Stloc, 1)
...
locbldr92.SetLocalSymInfo("flit")
...
OptimizeIL.Emit(OpCodes.Ldstr, "f")
Typ = GetType(System.String)
Dim typ123 As Type() = {Typ}
OptimizeIL.Emit(OpCodes.Call, GetType(System.Convert).GetMethod("ToChar", typ123))
Typ = GetType(System.Convert).GetMethod("ToChar", typ123).ReturnType
OptimizeIL.Emit(OpCodes.Stelem, GetType(System.Char).MakeArrayType().GetElementType())
...
OptimizeIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("TrimEnd", typ124))
Typ = Typ03.GetMethod("TrimEnd", typ124).ReturnType
OptimizeIL.Emit(OpCodes.Stloc, 2)
...
OptimizeIL.Emit(OpCodes.Call, GetType(System.Convert).GetMethod("ToSingle", typ125))
Typ = GetType(System.Convert).GetMethod("ToSingle", typ125).ReturnType
...
Dim locbldr93 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(DoubleLiteral))
locbldr93.SetLocalSymInfo("dlit")
OptimizeIL.Emit(OpCodes.Newobj, GetType(DoubleLiteral).GetConstructor(Type.EmptyTypes))
...
OptimizeIL.Emit(OpCodes.Call, GetType(System.Convert).GetMethod("ToDouble", typ129))
Typ = GetType(System.Convert).GetMethod("ToDouble", typ129).ReturnType
OptimizeIL.Emit(OpCodes.Stfld, GetType(DoubleLiteral).GetField("NumVal"))
...
OptimizeIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("EndsWith", typ133))
Typ = Typ03.GetMethod("EndsWith", typ133).ReturnType
OptimizeIL.Emit(OpCodes.Stloc, 1)
...
Dim locbldr94 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(DoubleLiteral))
locbldr94.SetLocalSymInfo("dlit3")
OptimizeIL.Emit(OpCodes.Newobj, GetType(DoubleLiteral).GetConstructor(Type.EmptyTypes))
...
OptimizeIL.Emit(OpCodes.Call, GetType(System.Convert).GetMethod("ToChar", typ134))
Typ = GetType(System.Convert).GetMethod("ToChar", typ134).ReturnType
OptimizeIL.Emit(OpCodes.Stelem, GetType(System.Char).MakeArrayType().GetElementType())
...
OptimizeIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("TrimEnd", typ135))
Typ = Typ03.GetMethod("TrimEnd", typ135).ReturnType
OptimizeIL.Emit(OpCodes.Stloc, 2)
...
OptimizeIL.Emit(OpCodes.Ldfld, GetType(DoubleLiteral).GetField("Value"))
Typ = GetType(DoubleLiteral).GetField("Value").FieldType
Dim typ136 As Type() = {Typ}
OptimizeIL.Emit(OpCodes.Call, GetType(System.Convert).GetMethod("ToDouble", typ136))
Typ = GetType(System.Convert).GetMethod("ToDouble", typ136).ReturnType
OptimizeIL.Emit(OpCodes.Stfld, GetType(DoubleLiteral).GetField("NumVal"))
...
OptimizeIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("EndsWith", typ140))
Typ = Typ03.GetMethod("EndsWith", typ140).ReturnType
OptimizeIL.Emit(OpCodes.Stloc, 1)
...
Dim locbldr95 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(FloatLiteral))
locbldr95.SetLocalSymInfo("flit2")
OptimizeIL.Emit(OpCodes.Newobj, GetType(FloatLiteral).GetConstructor(Type.EmptyTypes))
...
OptimizeIL.Emit(OpCodes.Call, GetType(System.Convert).GetMethod("ToChar", typ141))
Typ = GetType(System.Convert).GetMethod("ToChar", typ141).ReturnType
OptimizeIL.Emit(OpCodes.Stelem, GetType(System.Char).MakeArrayType().GetElementType())
...
OptimizeIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("TrimEnd", typ142))
Typ = Typ03.GetMethod("TrimEnd", typ142).ReturnType
OptimizeIL.Emit(OpCodes.Stloc, 2)
...
OptimizeIL.Emit(OpCodes.Call, GetType(System.Convert).GetMethod("ToSingle", typ143))
Typ = GetType(System.Convert).GetMethod("ToSingle", typ143).ReturnType
OptimizeIL.Emit(OpCodes.Stfld, GetType(FloatLiteral).GetField("NumVal"))
...
OptimizeIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("EndsWith", typ147))
Typ = Typ03.GetMethod("EndsWith", typ147).ReturnType
OptimizeIL.Emit(OpCodes.Stloc, 1)
...
Dim locbldr96 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(UIntLiteral))
locbldr96.SetLocalSymInfo("uilit2")
...
OptimizeIL.Emit(OpCodes.Call, GetType(System.Convert).GetMethod("ToChar", typ148))
Typ = GetType(System.Convert).GetMethod("ToChar", typ148).ReturnType
OptimizeIL.Emit(OpCodes.Stelem, GetType(System.Char).MakeArrayType().GetElementType())
...
OptimizeIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("TrimEnd", typ149))
Typ = Typ03.GetMethod("TrimEnd", typ149).ReturnType
OptimizeIL.Emit(OpCodes.Stloc, 2)
...
OptimizeIL.Emit(OpCodes.Call, GetType(Convert).GetMethod("ToUInt32", typ152))
Typ = GetType(Convert).GetMethod("ToUInt32", typ152).ReturnType
...
Dim locbldr97 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(IntPtrLiteral))
locbldr97.SetLocalSymInfo("iplit2")
...
Dim typ162 As Type() = {Typ}
OptimizeIL.Emit(OpCodes.Call, GetType(System.Convert).GetMethod("ToInt32", typ162))
Typ = GetType(System.Convert).GetMethod("ToInt32", typ162).ReturnType
ReDim Preserve typ161(UBound(typ161) + 1)
typ161(UBound(typ161)) = Typ
OptimizeIL.Emit(OpCodes.Newobj, GetType(IntPtr).GetConstructor(typ161))
...
Dim locbldr98 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(IntLiteral))
locbldr98.SetLocalSymInfo("ilit2")
...
OptimizeIL.Emit(OpCodes.Call, GetType(System.Convert).GetMethod("ToInt32", typ169))
Typ = GetType(System.Convert).GetMethod("ToInt32", typ169).ReturnType
...
OptimizeIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("EndsWith", typ173))
Typ = Typ03.GetMethod("EndsWith", typ173).ReturnType
OptimizeIL.Emit(OpCodes.Stloc, 1)
...
Dim locbldr99 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(ULongLiteral))
locbldr99.SetLocalSymInfo("ullit")
...
Typ = GetType(System.String)
Dim typ174 As Type() = {Typ}
OptimizeIL.Emit(OpCodes.Call, GetType(System.Convert).GetMethod("ToChar", typ174))
Typ = GetType(System.Convert).GetMethod("ToChar", typ174).ReturnType
OptimizeIL.Emit(OpCodes.Stelem, GetType(System.Char).MakeArrayType().GetElementType())
...
OptimizeIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("TrimEnd", typ175))
Typ = Typ03.GetMethod("TrimEnd", typ175).ReturnType
OptimizeIL.Emit(OpCodes.Stloc, 2)
...
OptimizeIL.Emit(OpCodes.Call, GetType(Convert).GetMethod("ToUInt64", typ178))
Typ = GetType(Convert).GetMethod("ToUInt64", typ178).ReturnType
...
Dim locbldr100 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(LongLiteral))
locbldr100.SetLocalSymInfo("llit")
...
OptimizeIL.Emit(OpCodes.Call, GetType(System.Convert).GetMethod("ToInt64", typ185))
Typ = GetType(System.Convert).GetMethod("ToInt64", typ185).ReturnType
...
OptimizeIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("EndsWith", typ189))
Typ = Typ03.GetMethod("EndsWith", typ189).ReturnType
OptimizeIL.Emit(OpCodes.Stloc, 1)
...
Dim locbldr101 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(UShortLiteral))
locbldr101.SetLocalSymInfo("uslit")
...
Typ = GetType(System.String)
Dim typ190 As Type() = {Typ}
OptimizeIL.Emit(OpCodes.Call, GetType(System.Convert).GetMethod("ToChar", typ190))
Typ = GetType(System.Convert).GetMethod("ToChar", typ190).ReturnType
OptimizeIL.Emit(OpCodes.Stelem, GetType(System.Char).MakeArrayType().GetElementType())
...
OptimizeIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("TrimEnd", typ191))
Typ = Typ03.GetMethod("TrimEnd", typ191).ReturnType
OptimizeIL.Emit(OpCodes.Stloc, 2)
...
OptimizeIL.Emit(OpCodes.Call, GetType(Convert).GetMethod("ToUInt16", typ194))
Typ = GetType(Convert).GetMethod("ToUInt16", typ194).ReturnType
...
Dim locbldr102 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(ShortLiteral))
locbldr102.SetLocalSymInfo("slit")
...
OptimizeIL.Emit(OpCodes.Call, GetType(System.Convert).GetMethod("ToInt16", typ201))
Typ = GetType(System.Convert).GetMethod("ToInt16", typ201).ReturnType
...
OptimizeIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("EndsWith", typ205))
Typ = Typ03.GetMethod("EndsWith", typ205).ReturnType
OptimizeIL.Emit(OpCodes.Stloc, 1)
...
Dim locbldr103 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(ByteLiteral))
locbldr103.SetLocalSymInfo("ublit")
...
Typ = GetType(System.String)
Dim typ206 As Type() = {Typ}
OptimizeIL.Emit(OpCodes.Call, GetType(System.Convert).GetMethod("ToChar", typ206))
Typ = GetType(System.Convert).GetMethod("ToChar", typ206).ReturnType
OptimizeIL.Emit(OpCodes.Stelem, GetType(System.Char).MakeArrayType().GetElementType())
...
OptimizeIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("TrimEnd", typ207))
Typ = Typ03.GetMethod("TrimEnd", typ207).ReturnType
OptimizeIL.Emit(OpCodes.Stloc, 2)
...
OptimizeIL.Emit(OpCodes.Call, GetType(Convert).GetMethod("ToByte", typ210))
Typ = GetType(Convert).GetMethod("ToByte", typ210).ReturnType
...
Dim locbldr104 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(SByteLiteral))
locbldr104.SetLocalSymInfo("blit")
...
OptimizeIL.Emit(OpCodes.Call, GetType(System.Convert).GetMethod("ToSByte", typ217))
Typ = GetType(System.Convert).GetMethod("ToSByte", typ217).ReturnType
...
Dim locbldr105 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(IntLiteral))
locbldr105.SetLocalSymInfo("ilit")
OptimizeIL.Emit(OpCodes.Newobj, GetType(IntLiteral).GetConstructor(Type.EmptyTypes))
...
OptimizeIL.Emit(OpCodes.Call, GetType(System.Convert).GetMethod("ToInt32", typ221))
Typ = GetType(System.Convert).GetMethod("ToInt32", typ221).ReturnType
OptimizeIL.Emit(OpCodes.Stfld, GetType(IntLiteral).GetField("NumVal"))
...
Dim locbldr106 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(Ident))
locbldr106.SetLocalSymInfo("idt")
...
locbldr107.SetLocalSymInfo("tok")
...
locbldr108.SetLocalSymInfo("typ")
...
Dim locbldr109 As LocalBuilder = checkVarAsIL.DeclareLocal(GetType(VarExpr))
locbldr109.SetLocalSymInfo("vars")
...
Typ = GetType(System.Boolean)
Dim fa106 As System.Reflection.Emit.Label = checkVarAsIL.DefineLabel()
Dim tru106 As System.Reflection.Emit.Label = checkVarAsIL.DefineLabel()
Dim cont106 As System.Reflection.Emit.Label = checkVarAsIL.DefineLabel()
checkVarAsIL.Emit(OpCodes.Beq, tru106)
checkVarAsIL.Emit(OpCodes.Br, fa106)
checkVarAsIL.MarkLabel(tru106)
...
locbldr110.SetLocalSymInfo("tok2")
checkVarAsIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Expr)
checkVarAsIL.Emit(OpCodes.Ldfld, GetType(Expr).GetField("Tokens"))
Typ = GetType(Expr).GetField("Tokens").FieldType
...
Dim locbldr111 As LocalBuilder = checkVarAsIL.DeclareLocal(GetType(System.Type))
...
Dim locbldr112 As LocalBuilder = checkVarAsIL.DeclareLocal(GetType(System.Boolean))
locbldr112.SetLocalSymInfo("b2")
Dim typ4(-1) As Type
...
checkVarAsIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa107 As System.Reflection.Emit.Label = checkVarAsIL.DefineLabel()
Dim tru107 As System.Reflection.Emit.Label = checkVarAsIL.DefineLabel()
Dim cont107 As System.Reflection.Emit.Label = checkVarAsIL.DefineLabel()
checkVarAsIL.Emit(OpCodes.Beq, fa107)
checkVarAsIL.Emit(OpCodes.Br, tru107)
checkVarAsIL.MarkLabel(tru107)
checkVarAsIL.MarkSequencePoint(doc4, 27, 1, 27, 100)
Dim locbldr113 As LocalBuilder = checkVarAsIL.DeclareLocal(GetType(Token))
locbldr113.SetLocalSymInfo("t")
checkVarAsIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Expr)
checkVarAsIL.Emit(OpCodes.Ldfld, GetType(Expr).GetField("Tokens"))
Typ = GetType(Expr).GetField("Tokens").FieldType
...
Dim locbldr114 As LocalBuilder = checkVarAsIL.DeclareLocal(GetType(TypeTok))
locbldr114.SetLocalSymInfo("tt")
...
checkVarAsIL.Emit(OpCodes.Br, cont107)
checkVarAsIL.MarkLabel(fa107)
...
checkVarAsIL.Emit(OpCodes.Br, cont107)
checkVarAsIL.MarkLabel(cont107)
checkVarAsIL.MarkSequencePoint(doc4, 36, 1, 36, 100)
checkVarAsIL.Emit(OpCodes.Br, cont106)
checkVarAsIL.MarkLabel(fa106)
checkVarAsIL.Emit(OpCodes.Br, cont106)
checkVarAsIL.MarkLabel(cont106)
...
Dim locbldr115 As LocalBuilder = procMethodCallIL.DeclareLocal(GetType(MethodNameTok))
locbldr115.SetLocalSymInfo("mn")
...
Dim locbldr116 As LocalBuilder = procMethodCallIL.DeclareLocal(GetType(MethodCallTok))
locbldr116.SetLocalSymInfo("mct")
...
Dim locbldr117 As LocalBuilder = procMethodCallIL.DeclareLocal(GetType(Ident))
locbldr117.SetLocalSymInfo("idt")
...
Dim locbldr118 As LocalBuilder = procMethodCallIL.DeclareLocal(GetType(Expr))
locbldr118.SetLocalSymInfo("ep2")
...
Dim locbldr119 As LocalBuilder = procMethodCallIL.DeclareLocal(GetType(System.Int32))
locbldr119.SetLocalSymInfo("lvl")
...
Dim locbldr120 As LocalBuilder = procMethodCallIL.DeclareLocal(GetType(System.Boolean))
locbldr120.SetLocalSymInfo("d")
...
Dim locbldr121 As LocalBuilder = procMethodCallIL.DeclareLocal(GetType(System.Int32))
locbldr121.SetLocalSymInfo("j")
...
Dim locbldr122 As LocalBuilder = procMethodCallIL.DeclareLocal(GetType(Token))
locbldr122.SetLocalSymInfo("tok2")
procMethodCallIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Expr)
procMethodCallIL.Emit(OpCodes.Ldfld, GetType(Expr).GetField("Tokens"))
Typ = GetType(Expr).GetField("Tokens").FieldType
...
Dim locbldr123 As LocalBuilder = procMethodCallIL.DeclareLocal(GetType(System.Type))
locbldr123.SetLocalSymInfo("typ2")
procMethodCallIL.MarkSequencePoint(doc4, 77, 1, 77, 100)
Dim locbldr124 As LocalBuilder = procMethodCallIL.DeclareLocal(GetType(System.Boolean))
locbldr124.SetLocalSymInfo("b2")
procMethodCallIL.MarkSequencePoint(doc4, 78, 1, 78, 100)
Dim locbldr125 As LocalBuilder = procMethodCallIL.DeclareLocal(GetType(System.Int32))
locbldr125.SetLocalSymInfo("len")
procMethodCallIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Expr)
procMethodCallIL.Emit(OpCodes.Ldfld, GetType(Expr).GetField("Tokens"))
Typ = GetType(Expr).GetField("Tokens").FieldType
...
procMethodCallIL.Emit(OpCodes.Beq, fa110)
procMethodCallIL.Emit(OpCodes.Br, tru110)
...
procMethodCallIL.Emit(OpCodes.Beq, tru111)
procMethodCallIL.Emit(OpCodes.Br, fa111)
...
procMethodCallIL.Emit(OpCodes.Beq, fa114)
procMethodCallIL.Emit(OpCodes.Br, tru114)
...
procMethodCallIL.Emit(OpCodes.Beq, tru115)
...
Dim locbldr126 As LocalBuilder = procIdentArrayAccessIL.DeclareLocal(GetType(Ident))
...
Dim locbldr127 As LocalBuilder = procIdentArrayAccessIL.DeclareLocal(GetType(Expr))
...
Dim locbldr128 As LocalBuilder = procIdentArrayAccessIL.DeclareLocal(GetType(System.Int32))
...
Dim locbldr129 As LocalBuilder = procIdentArrayAccessIL.DeclareLocal(GetType(System.Boolean))
...
Dim locbldr130 As LocalBuilder = procIdentArrayAccessIL.DeclareLocal(GetType(System.Int32))
...
Dim locbldr131 As LocalBuilder = procIdentArrayAccessIL.DeclareLocal(GetType(Token))
...
Dim locbldr132 As LocalBuilder = procIdentArrayAccessIL.DeclareLocal(GetType(System.Type))
locbldr132.SetLocalSymInfo("typ2")
procIdentArrayAccessIL.MarkSequencePoint(doc4, 189, 1, 189, 100)
Dim locbldr133 As LocalBuilder = procIdentArrayAccessIL.DeclareLocal(GetType(System.Boolean))
locbldr133.SetLocalSymInfo("b2")
procIdentArrayAccessIL.MarkSequencePoint(doc4, 190, 1, 190, 100)
Dim locbldr134 As LocalBuilder = procIdentArrayAccessIL.DeclareLocal(GetType(System.Int32))
...
procIdentArrayAccessIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa120 As System.Reflection.Emit.Label = procIdentArrayAccessIL.DefineLabel()
Dim tru120 As System.Reflection.Emit.Label = procIdentArrayAccessIL.DefineLabel()
Dim cont120 As System.Reflection.Emit.Label = procIdentArrayAccessIL.DefineLabel()
procIdentArrayAccessIL.Emit(OpCodes.Beq, tru120)
procIdentArrayAccessIL.Emit(OpCodes.Br, fa120)
procIdentArrayAccessIL.MarkLabel(tru120)
procIdentArrayAccessIL.MarkSequencePoint(doc4, 237, 1, 237, 100)
procIdentArrayAccessIL.Emit(OpCodes.Br, cont120)
procIdentArrayAccessIL.MarkLabel(fa120)
...
procIdentArrayAccessIL.Emit(OpCodes.Br, cont120)
procIdentArrayAccessIL.MarkLabel(cont120)
...
procIdentArrayAccessIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa121 As System.Reflection.Emit.Label = procIdentArrayAccessIL.DefineLabel()
Dim tru121 As System.Reflection.Emit.Label = procIdentArrayAccessIL.DefineLabel()
Dim cont121 As System.Reflection.Emit.Label = procIdentArrayAccessIL.DefineLabel()
procIdentArrayAccessIL.Emit(OpCodes.Beq, tru121)
procIdentArrayAccessIL.Emit(OpCodes.Br, fa121)
procIdentArrayAccessIL.MarkLabel(tru121)
...
procIdentArrayAccessIL.Emit(OpCodes.Br, cont121)
procIdentArrayAccessIL.MarkLabel(fa121)
procIdentArrayAccessIL.Emit(OpCodes.Br, cont121)
procIdentArrayAccessIL.MarkLabel(cont121)
procIdentArrayAccessIL.MarkSequencePoint(doc4, 251, 1, 251, 100)
procIdentArrayAccessIL.Emit(OpCodes.Ldarg, 2)
Typ = GetType(System.Int32)
procIdentArrayAccessIL.Emit(OpCodes.Ldloc, 8)
Typ = GetType(System.Int32)
Dim fa122 As System.Reflection.Emit.Label = procIdentArrayAccessIL.DefineLabel()
Dim tru122 As System.Reflection.Emit.Label = procIdentArrayAccessIL.DefineLabel()
Dim cont122 As System.Reflection.Emit.Label = procIdentArrayAccessIL.DefineLabel()
procIdentArrayAccessIL.Emit(OpCodes.Beq, tru122)
procIdentArrayAccessIL.Emit(OpCodes.Br, fa122)
procIdentArrayAccessIL.MarkLabel(tru122)
procIdentArrayAccessIL.MarkSequencePoint(doc4, 252, 1, 252, 100)
procIdentArrayAccessIL.Emit(OpCodes.Br, label4)
procIdentArrayAccessIL.MarkSequencePoint(doc4, 253, 1, 253, 100)
procIdentArrayAccessIL.Emit(OpCodes.Br, cont122)
procIdentArrayAccessIL.MarkLabel(fa122)
...
procIdentArrayAccessIL.Emit(OpCodes.Br, cont122)
procIdentArrayAccessIL.MarkLabel(cont122)
...
Dim locbldr135 As LocalBuilder = procMtdArrayAccessIL.DeclareLocal(GetType(MethodCallTok))
locbldr135.SetLocalSymInfo("mtd")
...
Dim locbldr136 As LocalBuilder = procMtdArrayAccessIL.DeclareLocal(GetType(MethodNameTok))
locbldr136.SetLocalSymInfo("idt")
procMtdArrayAccessIL.Emit(OpCodes.Ldnull)
procMtdArrayAccessIL.Emit(OpCodes.Stloc, 1)
procMtdArrayAccessIL.MarkSequencePoint(doc4, 271, 1, 271, 100)
Dim locbldr137 As LocalBuilder = procMtdArrayAccessIL.DeclareLocal(GetType(Expr))
...
Dim locbldr138 As LocalBuilder = procMtdArrayAccessIL.DeclareLocal(GetType(System.Int32))
...
Dim locbldr139 As LocalBuilder = procMtdArrayAccessIL.DeclareLocal(GetType(System.Boolean))
...
Dim locbldr140 As LocalBuilder = procMtdArrayAccessIL.DeclareLocal(GetType(System.Int32))
...
Dim locbldr141 As LocalBuilder = procMtdArrayAccessIL.DeclareLocal(GetType(Token))
...
Dim locbldr142 As LocalBuilder = procMtdArrayAccessIL.DeclareLocal(GetType(System.Type))
locbldr142.SetLocalSymInfo("typ2")
procMtdArrayAccessIL.MarkSequencePoint(doc4, 284, 1, 284, 100)
Dim locbldr143 As LocalBuilder = procMtdArrayAccessIL.DeclareLocal(GetType(System.Boolean))
locbldr143.SetLocalSymInfo("b2")
procMtdArrayAccessIL.MarkSequencePoint(doc4, 285, 1, 285, 100)
Dim locbldr144 As LocalBuilder = procMtdArrayAccessIL.DeclareLocal(GetType(System.Int32))
...
procMtdArrayAccessIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa126 As System.Reflection.Emit.Label = procMtdArrayAccessIL.DefineLabel()
Dim tru126 As System.Reflection.Emit.Label = procMtdArrayAccessIL.DefineLabel()
Dim cont126 As System.Reflection.Emit.Label = procMtdArrayAccessIL.DefineLabel()
procMtdArrayAccessIL.Emit(OpCodes.Beq, tru126)
procMtdArrayAccessIL.Emit(OpCodes.Br, fa126)
procMtdArrayAccessIL.MarkLabel(tru126)
procMtdArrayAccessIL.MarkSequencePoint(doc4, 332, 1, 332, 100)
procMtdArrayAccessIL.Emit(OpCodes.Br, cont126)
procMtdArrayAccessIL.MarkLabel(fa126)
...
procMtdArrayAccessIL.Emit(OpCodes.Br, cont126)
procMtdArrayAccessIL.MarkLabel(cont126)
...
procMtdArrayAccessIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa127 As System.Reflection.Emit.Label = procMtdArrayAccessIL.DefineLabel()
Dim tru127 As System.Reflection.Emit.Label = procMtdArrayAccessIL.DefineLabel()
Dim cont127 As System.Reflection.Emit.Label = procMtdArrayAccessIL.DefineLabel()
procMtdArrayAccessIL.Emit(OpCodes.Beq, tru127)
procMtdArrayAccessIL.Emit(OpCodes.Br, fa127)
procMtdArrayAccessIL.MarkLabel(tru127)
...
procMtdArrayAccessIL.Emit(OpCodes.Br, cont127)
procMtdArrayAccessIL.MarkLabel(fa127)
procMtdArrayAccessIL.Emit(OpCodes.Br, cont127)
procMtdArrayAccessIL.MarkLabel(cont127)
procMtdArrayAccessIL.MarkSequencePoint(doc4, 346, 1, 346, 100)
procMtdArrayAccessIL.Emit(OpCodes.Ldarg, 2)
Typ = GetType(System.Int32)
procMtdArrayAccessIL.Emit(OpCodes.Ldloc, 9)
Typ = GetType(System.Int32)
Dim fa128 As System.Reflection.Emit.Label = procMtdArrayAccessIL.DefineLabel()
Dim tru128 As System.Reflection.Emit.Label = procMtdArrayAccessIL.DefineLabel()
Dim cont128 As System.Reflection.Emit.Label = procMtdArrayAccessIL.DefineLabel()
procMtdArrayAccessIL.Emit(OpCodes.Beq, tru128)
procMtdArrayAccessIL.Emit(OpCodes.Br, fa128)
procMtdArrayAccessIL.MarkLabel(tru128)
procMtdArrayAccessIL.MarkSequencePoint(doc4, 347, 1, 347, 100)
procMtdArrayAccessIL.Emit(OpCodes.Br, label7)
procMtdArrayAccessIL.MarkSequencePoint(doc4, 348, 1, 348, 100)
procMtdArrayAccessIL.Emit(OpCodes.Br, cont128)
procMtdArrayAccessIL.MarkLabel(fa128)
...
procMtdArrayAccessIL.Emit(OpCodes.Br, cont128)
procMtdArrayAccessIL.MarkLabel(cont128)
...
Dim locbldr145 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(System.Int32))
locbldr145.SetLocalSymInfo("len")
OptimizeIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Expr)
...
Dim locbldr146 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(System.Int32))
locbldr146.SetLocalSymInfo("i")
OptimizeIL.Emit(OpCodes.Ldc_I4, CInt(-1))
Typ = GetType(System.Int32)
OptimizeIL.Emit(OpCodes.Stloc, 1)
OptimizeIL.MarkSequencePoint(doc4, 367, 1, 367, 100)
Dim locbldr147 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(System.Int32))
locbldr147.SetLocalSymInfo("j")
OptimizeIL.Emit(OpCodes.Ldc_I4, CInt(-1))
Typ = GetType(System.Int32)
OptimizeIL.Emit(OpCodes.Stloc, 2)
...
locbldr148.SetLocalSymInfo("identtrnoff")
OptimizeIL.Emit(OpCodes.Ldc_I4, 0)
Typ = GetType(System.Boolean)
OptimizeIL.Emit(OpCodes.Stloc, 3)
...
locbldr149.SetLocalSymInfo("mcbool")
OptimizeIL.Emit(OpCodes.Ldc_I4, 0)
Typ = GetType(System.Boolean)
OptimizeIL.Emit(OpCodes.Stloc, 4)
OptimizeIL.MarkSequencePoint(doc4, 370, 1, 370, 100)
Dim locbldr150 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(System.Boolean))
locbldr150.SetLocalSymInfo("mcflgc")
OptimizeIL.Emit(OpCodes.Ldc_I4, 0)
Typ = GetType(System.Boolean)
OptimizeIL.Emit(OpCodes.Stloc, 5)
OptimizeIL.MarkSequencePoint(doc4, 371, 1, 371, 100)
Dim locbldr151 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(System.Boolean))
locbldr151.SetLocalSymInfo("iflgc")
OptimizeIL.Emit(OpCodes.Ldc_I4, 0)
Typ = GetType(System.Boolean)
OptimizeIL.Emit(OpCodes.Stloc, 6)
OptimizeIL.MarkSequencePoint(doc4, 372, 1, 372, 100)
Dim locbldr152 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(System.Boolean))
locbldr152.SetLocalSymInfo("sflgc")
OptimizeIL.Emit(OpCodes.Ldc_I4, 0)
Typ = GetType(System.Boolean)
OptimizeIL.Emit(OpCodes.Stloc, 7)
OptimizeIL.MarkSequencePoint(doc4, 373, 1, 373, 100)
Dim locbldr153 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(Token))
locbldr153.SetLocalSymInfo("mctok")
OptimizeIL.Emit(OpCodes.Ldnull)
OptimizeIL.Emit(OpCodes.Stloc, 8)
OptimizeIL.MarkSequencePoint(doc4, 374, 1, 374, 100)
Dim locbldr154 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(Token))
locbldr154.SetLocalSymInfo("mctok2")
OptimizeIL.Emit(OpCodes.Ldnull)
OptimizeIL.Emit(OpCodes.Stloc, 9)
OptimizeIL.MarkSequencePoint(doc4, 375, 1, 375, 100)
Dim locbldr155 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(Ident))
locbldr155.SetLocalSymInfo("mcident")
OptimizeIL.Emit(OpCodes.Ldnull)
OptimizeIL.Emit(OpCodes.Stloc, 10)
OptimizeIL.MarkSequencePoint(doc4, 376, 1, 376, 100)
Dim locbldr156 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(MethodCallTok))
locbldr156.SetLocalSymInfo("mcmetcall")
OptimizeIL.Emit(OpCodes.Ldnull)
OptimizeIL.Emit(OpCodes.Stloc, 11)
OptimizeIL.MarkSequencePoint(doc4, 377, 1, 377, 100)
Dim locbldr157 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(MethodNameTok))
locbldr157.SetLocalSymInfo("mcmetname")
OptimizeIL.Emit(OpCodes.Ldnull)
OptimizeIL.Emit(OpCodes.Stloc, 12)
OptimizeIL.MarkSequencePoint(doc4, 378, 1, 378, 100)
Dim locbldr158 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(StringLiteral))
locbldr158.SetLocalSymInfo("mcstr")
OptimizeIL.Emit(OpCodes.Ldnull)
OptimizeIL.Emit(OpCodes.Stloc, 13)
OptimizeIL.MarkSequencePoint(doc4, 379, 1, 379, 100)
Dim locbldr159 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(System.Int32))
locbldr159.SetLocalSymInfo("mcint")
OptimizeIL.Emit(OpCodes.Ldc_I4, CInt(0))
Typ = GetType(System.Int32)
OptimizeIL.Emit(OpCodes.Stloc, 14)
...
OptimizeIL.Emit(OpCodes.Blt, tru129)
OptimizeIL.Emit(OpCodes.Br, fa129)
...
Dim locbldr160 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(Token))
locbldr160.SetLocalSymInfo("tok")
OptimizeIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Expr)
OptimizeIL.Emit(OpCodes.Ldfld, GetType(Expr).GetField("Tokens"))
Typ = GetType(Expr).GetField("Tokens").FieldType
...
Dim locbldr161 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(System.Type))
locbldr161.SetLocalSymInfo("typ")
OptimizeIL.MarkSequencePoint(doc4, 400, 1, 400, 100)
Dim locbldr162 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(System.Boolean))
locbldr162.SetLocalSymInfo("b")
OptimizeIL.MarkSequencePoint(doc4, 401, 1, 401, 100)
Dim locbldr163 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(System.String))
locbldr163.SetLocalSymInfo("str")
...
OptimizeIL.Emit(OpCodes.Beq, tru131)
OptimizeIL.Emit(OpCodes.Br, fa131)
...
OptimizeIL.Emit(OpCodes.Beq, fa132)
OptimizeIL.Emit(OpCodes.Br, tru132)
OptimizeIL.MarkLabel(tru132)
OptimizeIL.MarkSequencePoint(doc4, 415, 1, 415, 100)
Dim locbldr164 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(Token))
locbldr164.SetLocalSymInfo("tk")
OptimizeIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Expr)
OptimizeIL.Emit(OpCodes.Ldfld, GetType(Expr).GetField("Tokens"))
Typ = GetType(Expr).GetField("Tokens").FieldType
...
locbldr165.SetLocalSymInfo("ttk")
...
Dim locbldr166 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(Token))
locbldr166.SetLocalSymInfo("tk2")
OptimizeIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Expr)
OptimizeIL.Emit(OpCodes.Ldfld, GetType(Expr).GetField("Tokens"))
Typ = GetType(Expr).GetField("Tokens").FieldType
...
Dim locbldr167 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(TypeTok))
locbldr167.SetLocalSymInfo("ttk2")
OptimizeIL.Emit(OpCodes.Newobj, GetType(TypeTok).GetConstructor(Type.EmptyTypes))
OptimizeIL.Emit(OpCodes.Stloc, 22)
...
OptimizeIL.Emit(OpCodes.Beq, tru136)
OptimizeIL.Emit(OpCodes.Br, fa136)
...
OptimizeIL.Emit(OpCodes.Beq, fa137)
OptimizeIL.Emit(OpCodes.Br, tru137)
...
OptimizeIL.Emit(OpCodes.Beq, fa139)
OptimizeIL.Emit(OpCodes.Br, tru139)
OptimizeIL.MarkLabel(tru139)
OptimizeIL.MarkSequencePoint(doc4, 479, 1, 479, 100)
Dim locbldr168 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(TypeTok))
locbldr168.SetLocalSymInfo("tt1")
OptimizeIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Expr)
OptimizeIL.Emit(OpCodes.Ldfld, GetType(Expr).GetField("Tokens"))
Typ = GetType(Expr).GetField("Tokens").FieldType
...
Dim locbldr169 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(Ident))
locbldr169.SetLocalSymInfo("id1")
OptimizeIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Expr)
OptimizeIL.Emit(OpCodes.Ldfld, GetType(Expr).GetField("Tokens"))
Typ = GetType(Expr).GetField("Tokens").FieldType
...
Dim locbldr170 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(CharLiteral))
locbldr170.SetLocalSymInfo("cl1")
OptimizeIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Expr)
OptimizeIL.Emit(OpCodes.Ldfld, GetType(Expr).GetField("Tokens"))
Typ = GetType(Expr).GetField("Tokens").FieldType
...
Dim locbldr171 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(StringLiteral))
locbldr171.SetLocalSymInfo("sl1")
OptimizeIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Expr)
OptimizeIL.Emit(OpCodes.Ldfld, GetType(Expr).GetField("Tokens"))
Typ = GetType(Expr).GetField("Tokens").FieldType
...
Dim locbldr172 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(BooleanLiteral))
locbldr172.SetLocalSymInfo("bl1")
OptimizeIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Expr)
OptimizeIL.Emit(OpCodes.Ldfld, GetType(Expr).GetField("Tokens"))
Typ = GetType(Expr).GetField("Tokens").FieldType
...
Dim locbldr173 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(NumberLiteral))
locbldr173.SetLocalSymInfo("nl1")
OptimizeIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Expr)
OptimizeIL.Emit(OpCodes.Ldfld, GetType(Expr).GetField("Tokens"))
Typ = GetType(Expr).GetField("Tokens").FieldType
...
Dim locbldr174 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(MethodCallTok))
locbldr174.SetLocalSymInfo("mct")
OptimizeIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Expr)
OptimizeIL.Emit(OpCodes.Ldfld, GetType(Expr).GetField("Tokens"))
Typ = GetType(Expr).GetField("Tokens").FieldType
...
Dim locbldr175 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(Expr).MakeArrayType())
locbldr175.SetLocalSymInfo("prs")
OptimizeIL.Emit(OpCodes.Ldloc, 29)
Typ = GetType(MethodCallTok)
...
Dim locbldr176 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(System.Int32))
locbldr176.SetLocalSymInfo("ln2")
OptimizeIL.Emit(OpCodes.Ldloc, 30)
...
Dim locbldr177 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(System.Int32))
locbldr177.SetLocalSymInfo("i2")
OptimizeIL.Emit(OpCodes.Ldc_I4, CInt(-1))
Typ = GetType(System.Int32)
OptimizeIL.Emit(OpCodes.Stloc, 32)
...
OptimizeIL.Emit(OpCodes.Blt, tru154)
...
locbldr178.SetLocalSymInfo("aidt")
OptimizeIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Expr)
OptimizeIL.Emit(OpCodes.Ldfld, GetType(Expr).GetField("Tokens"))
Typ = GetType(Expr).GetField("Tokens").FieldType
...
Dim locbldr179 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(Expr))
locbldr179.SetLocalSymInfo("arriloc")
OptimizeIL.Emit(OpCodes.Ldloc, 33)
Typ = GetType(Ident)
...
Dim locbldr180 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(MethodCallTok))
locbldr180.SetLocalSymInfo("amtd")
OptimizeIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Expr)
OptimizeIL.Emit(OpCodes.Ldfld, GetType(Expr).GetField("Tokens"))
Typ = GetType(Expr).GetField("Tokens").FieldType
...
Dim locbldr181 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(MethodNameTok))
locbldr181.SetLocalSymInfo("amtdn")
OptimizeIL.Emit(OpCodes.Ldloc, 35)
Typ = GetType(MethodCallTok)
...
OptimizeIL.Emit(OpCodes.Bgt, tru159)
...
OptimizeIL.Emit(OpCodes.Bge, tru160)
...
OptimizeIL.Emit(OpCodes.Ble, tru169)
...
Dim locbldr182 As LocalBuilder = checkRefasmIL.DeclareLocal(GetType(Token))
...
Dim locbldr183 As LocalBuilder = checkRefasmIL.DeclareLocal(GetType(System.Type))
...
Dim locbldr184 As LocalBuilder = checkRefasmIL.DeclareLocal(GetType(RefasmStmt))
locbldr184.SetLocalSymInfo("refasms")
...
Typ = GetType(System.Boolean)
Dim fa172 As System.Reflection.Emit.Label = checkRefasmIL.DefineLabel()
Dim tru172 As System.Reflection.Emit.Label = checkRefasmIL.DefineLabel()
Dim cont172 As System.Reflection.Emit.Label = checkRefasmIL.DefineLabel()
checkRefasmIL.Emit(OpCodes.Beq, tru172)
checkRefasmIL.Emit(OpCodes.Br, fa172)
checkRefasmIL.MarkLabel(tru172)
...
checkRefasmIL.Emit(OpCodes.Br, cont172)
checkRefasmIL.MarkLabel(fa172)
checkRefasmIL.Emit(OpCodes.Br, cont172)
checkRefasmIL.MarkLabel(cont172)
...
Dim locbldr185 As LocalBuilder = checkDebugIL.DeclareLocal(GetType(Token))
...
Dim locbldr186 As LocalBuilder = checkDebugIL.DeclareLocal(GetType(System.Type))
...
Dim locbldr187 As LocalBuilder = checkDebugIL.DeclareLocal(GetType(DebugStmt))
locbldr187.SetLocalSymInfo("dbgs")
...
Typ = GetType(System.Boolean)
Dim fa173 As System.Reflection.Emit.Label = checkDebugIL.DefineLabel()
Dim tru173 As System.Reflection.Emit.Label = checkDebugIL.DefineLabel()
Dim cont173 As System.Reflection.Emit.Label = checkDebugIL.DefineLabel()
checkDebugIL.Emit(OpCodes.Beq, tru173)
checkDebugIL.Emit(OpCodes.Br, fa173)
checkDebugIL.MarkLabel(tru173)
...
checkDebugIL.Emit(OpCodes.Br, cont173)
checkDebugIL.MarkLabel(fa173)
checkDebugIL.Emit(OpCodes.Br, cont173)
checkDebugIL.MarkLabel(cont173)
...
Dim locbldr188 As LocalBuilder = checkImportIL.DeclareLocal(GetType(Token))
...
Dim locbldr189 As LocalBuilder = checkImportIL.DeclareLocal(GetType(System.Type))
...
Dim locbldr190 As LocalBuilder = checkImportIL.DeclareLocal(GetType(ImportStmt))
locbldr190.SetLocalSymInfo("imps")
...
Typ = GetType(System.Boolean)
Dim fa174 As System.Reflection.Emit.Label = checkImportIL.DefineLabel()
Dim tru174 As System.Reflection.Emit.Label = checkImportIL.DefineLabel()
Dim cont174 As System.Reflection.Emit.Label = checkImportIL.DefineLabel()
checkImportIL.Emit(OpCodes.Beq, tru174)
checkImportIL.Emit(OpCodes.Br, fa174)
checkImportIL.MarkLabel(tru174)
...
checkImportIL.Emit(OpCodes.Br, cont174)
checkImportIL.MarkLabel(fa174)
checkImportIL.Emit(OpCodes.Br, cont174)
checkImportIL.MarkLabel(cont174)
...
Dim locbldr191 As LocalBuilder = checkLocimportIL.DeclareLocal(GetType(Token))
...
Dim locbldr192 As LocalBuilder = checkLocimportIL.DeclareLocal(GetType(System.Type))
...
Dim locbldr193 As LocalBuilder = checkLocimportIL.DeclareLocal(GetType(LocimportStmt))
locbldr193.SetLocalSymInfo("limps")
...
Typ = GetType(System.Boolean)
Dim fa175 As System.Reflection.Emit.Label = checkLocimportIL.DefineLabel()
Dim tru175 As System.Reflection.Emit.Label = checkLocimportIL.DefineLabel()
Dim cont175 As System.Reflection.Emit.Label = checkLocimportIL.DefineLabel()
checkLocimportIL.Emit(OpCodes.Beq, tru175)
checkLocimportIL.Emit(OpCodes.Br, fa175)
checkLocimportIL.MarkLabel(tru175)
...
checkLocimportIL.Emit(OpCodes.Br, cont175)
checkLocimportIL.MarkLabel(fa175)
checkLocimportIL.Emit(OpCodes.Br, cont175)
checkLocimportIL.MarkLabel(cont175)
...
Dim locbldr194 As LocalBuilder = checkCmtIL.DeclareLocal(GetType(Token))
locbldr194.SetLocalSymInfo("tok")
...
Dim locbldr195 As LocalBuilder = checkCmtIL.DeclareLocal(GetType(System.Type))
locbldr195.SetLocalSymInfo("typ")
...
Dim locbldr196 As LocalBuilder = checkCmtIL.DeclareLocal(GetType(CommentStmt))
locbldr196.SetLocalSymInfo("cmts")
...
Typ = GetType(System.Boolean)
Dim fa176 As System.Reflection.Emit.Label = checkCmtIL.DefineLabel()
Dim tru176 As System.Reflection.Emit.Label = checkCmtIL.DefineLabel()
Dim cont176 As System.Reflection.Emit.Label = checkCmtIL.DefineLabel()
checkCmtIL.Emit(OpCodes.Beq, tru176)
checkCmtIL.Emit(OpCodes.Br, fa176)
checkCmtIL.MarkLabel(tru176)
...
checkCmtIL.Emit(OpCodes.Br, cont176)
checkCmtIL.MarkLabel(fa176)
checkCmtIL.Emit(OpCodes.Br, cont176)
checkCmtIL.MarkLabel(cont176)
...
Typ = GetType(System.Int32)
Dim fa177 As System.Reflection.Emit.Label = checkEndMtdIL.DefineLabel()
Dim tru177 As System.Reflection.Emit.Label = checkEndMtdIL.DefineLabel()
Dim cont177 As System.Reflection.Emit.Label = checkEndMtdIL.DefineLabel()
checkEndMtdIL.Emit(OpCodes.Bge, tru177)
checkEndMtdIL.Emit(OpCodes.Br, fa177)
checkEndMtdIL.MarkLabel(tru177)
checkEndMtdIL.MarkSequencePoint(doc5, 80, 1, 80, 100)
Dim locbldr197 As LocalBuilder = checkEndMtdIL.DeclareLocal(GetType(Token))
locbldr197.SetLocalSymInfo("tok1")
checkEndMtdIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
checkEndMtdIL.Emit(OpCodes.Ldfld, GetType(Stmt).GetField("Tokens"))
Typ = GetType(Stmt).GetField("Tokens").FieldType
...
locbldr198.SetLocalSymInfo("typ1")
...
Dim locbldr200 As LocalBuilder = checkEndMtdIL.DeclareLocal(GetType(Token))
locbldr200.SetLocalSymInfo("tok2")
checkEndMtdIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
checkEndMtdIL.Emit(OpCodes.Ldfld, GetType(Stmt).GetField("Tokens"))
Typ = GetType(Stmt).GetField("Tokens").FieldType
...
Dim locbldr201 As LocalBuilder = checkEndMtdIL.DeclareLocal(GetType(System.Type))
locbldr201.SetLocalSymInfo("typ2")
...
Dim locbldr202 As LocalBuilder = checkEndMtdIL.DeclareLocal(GetType(System.Boolean))
locbldr202.SetLocalSymInfo("b2")
Dim typ20(-1) As Type
...
Dim locbldr203 As LocalBuilder = checkEndMtdIL.DeclareLocal(GetType(EndMethodStmt))
locbldr203.SetLocalSymInfo("ems")
...
Typ = GetType(System.Boolean)
Dim fa178 As System.Reflection.Emit.Label = checkEndMtdIL.DefineLabel()
Dim tru178 As System.Reflection.Emit.Label = checkEndMtdIL.DefineLabel()
Dim cont178 As System.Reflection.Emit.Label = checkEndMtdIL.DefineLabel()
checkEndMtdIL.Emit(OpCodes.Beq, tru178)
checkEndMtdIL.Emit(OpCodes.Br, fa178)
checkEndMtdIL.MarkLabel(tru178)
...
checkEndMtdIL.Emit(OpCodes.Br, cont178)
checkEndMtdIL.MarkLabel(fa178)
checkEndMtdIL.Emit(OpCodes.Br, cont178)
checkEndMtdIL.MarkLabel(cont178)
checkEndMtdIL.MarkSequencePoint(doc5, 95, 1, 95, 100)
checkEndMtdIL.Emit(OpCodes.Br, cont177)
checkEndMtdIL.MarkLabel(fa177)
checkEndMtdIL.Emit(OpCodes.Br, cont177)
checkEndMtdIL.MarkLabel(cont177)
...
Typ = GetType(System.Int32)
Dim fa179 As System.Reflection.Emit.Label = checkEndClsIL.DefineLabel()
Dim tru179 As System.Reflection.Emit.Label = checkEndClsIL.DefineLabel()
Dim cont179 As System.Reflection.Emit.Label = checkEndClsIL.DefineLabel()
checkEndClsIL.Emit(OpCodes.Bge, tru179)
checkEndClsIL.Emit(OpCodes.Br, fa179)
checkEndClsIL.MarkLabel(tru179)
...
locbldr204.SetLocalSymInfo("tok1")
checkEndClsIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
checkEndClsIL.Emit(OpCodes.Ldfld, GetType(Stmt).GetField("Tokens"))
Typ = GetType(Stmt).GetField("Tokens").FieldType
...
locbldr205.SetLocalSymInfo("typ1")
...
Dim locbldr207 As LocalBuilder = checkEndClsIL.DeclareLocal(GetType(Token))
locbldr207.SetLocalSymInfo("tok2")
checkEndClsIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
checkEndClsIL.Emit(OpCodes.Ldfld, GetType(Stmt).GetField("Tokens"))
Typ = GetType(Stmt).GetField("Tokens").FieldType
...
Dim locbldr208 As LocalBuilder = checkEndClsIL.DeclareLocal(GetType(System.Type))
locbldr208.SetLocalSymInfo("typ2")
...
Dim locbldr209 As LocalBuilder = checkEndClsIL.DeclareLocal(GetType(System.Boolean))
locbldr209.SetLocalSymInfo("b2")
Dim typ25(-1) As Type
...
Dim locbldr210 As LocalBuilder = checkEndClsIL.DeclareLocal(GetType(EndClassStmt))
locbldr210.SetLocalSymInfo("ecs")
...
Typ = GetType(System.Boolean)
Dim fa180 As System.Reflection.Emit.Label = checkEndClsIL.DefineLabel()
Dim tru180 As System.Reflection.Emit.Label = checkEndClsIL.DefineLabel()
Dim cont180 As System.Reflection.Emit.Label = checkEndClsIL.DefineLabel()
checkEndClsIL.Emit(OpCodes.Beq, tru180)
checkEndClsIL.Emit(OpCodes.Br, fa180)
checkEndClsIL.MarkLabel(tru180)
...
checkEndClsIL.Emit(OpCodes.Br, cont180)
checkEndClsIL.MarkLabel(fa180)
checkEndClsIL.Emit(OpCodes.Br, cont180)
checkEndClsIL.MarkLabel(cont180)
checkEndClsIL.MarkSequencePoint(doc5, 117, 1, 117, 100)
checkEndClsIL.Emit(OpCodes.Br, cont179)
checkEndClsIL.MarkLabel(fa179)
checkEndClsIL.Emit(OpCodes.Br, cont179)
checkEndClsIL.MarkLabel(cont179)
...
Dim locbldr211 As LocalBuilder = checkAssemblyIL.DeclareLocal(GetType(Token))
...
Dim locbldr212 As LocalBuilder = checkAssemblyIL.DeclareLocal(GetType(System.Type))
...
Dim locbldr213 As LocalBuilder = checkAssemblyIL.DeclareLocal(GetType(AssemblyStmt))
locbldr213.SetLocalSymInfo("asms")
...
Typ = GetType(System.Boolean)
Dim fa181 As System.Reflection.Emit.Label = checkAssemblyIL.DefineLabel()
Dim tru181 As System.Reflection.Emit.Label = checkAssemblyIL.DefineLabel()
Dim cont181 As System.Reflection.Emit.Label = checkAssemblyIL.DefineLabel()
checkAssemblyIL.Emit(OpCodes.Beq, tru181)
checkAssemblyIL.Emit(OpCodes.Br, fa181)
checkAssemblyIL.MarkLabel(tru181)
...
checkAssemblyIL.Emit(OpCodes.Br, cont181)
checkAssemblyIL.MarkLabel(fa181)
checkAssemblyIL.Emit(OpCodes.Br, cont181)
checkAssemblyIL.MarkLabel(cont181)
...
Dim locbldr214 As LocalBuilder = checkVerIL.DeclareLocal(GetType(Token))
...
Dim locbldr215 As LocalBuilder = checkVerIL.DeclareLocal(GetType(System.Type))
...
Dim locbldr216 As LocalBuilder = checkVerIL.DeclareLocal(GetType(VerStmt))
locbldr216.SetLocalSymInfo("vers")
...
Typ = GetType(System.Boolean)
Dim fa182 As System.Reflection.Emit.Label = checkVerIL.DefineLabel()
Dim tru182 As System.Reflection.Emit.Label = checkVerIL.DefineLabel()
Dim cont182 As System.Reflection.Emit.Label = checkVerIL.DefineLabel()
checkVerIL.Emit(OpCodes.Beq, tru182)
checkVerIL.Emit(OpCodes.Br, fa182)
checkVerIL.MarkLabel(tru182)
...
Dim locbldr217 As LocalBuilder = checkVerIL.DeclareLocal(GetType(System.String).MakeArrayType())
locbldr217.SetLocalSymInfo("ars")
Dim typ32(-1) As Type
checkVerIL.Emit(OpCodes.Ldloc, 0)
Typ = GetType(Token)
...
Dim locbldr218 As LocalBuilder = checkVerIL.DeclareLocal(GetType(System.Int32).MakeArrayType())
locbldr218.SetLocalSymInfo("ari")
...
Dim locbldr219 As LocalBuilder = checkVerIL.DeclareLocal(GetType(IntLiteral).MakeArrayType())
locbldr219.SetLocalSymInfo("intla")
checkVerIL.Emit(OpCodes.Ldc_I4, CInt(4))
Typ = GetType(System.Int32)
checkVerIL.Emit(OpCodes.Conv_U)
...
Dim locbldr220 As LocalBuilder = checkVerIL.DeclareLocal(GetType(IntLiteral))
locbldr220.SetLocalSymInfo("intl")
...
checkVerIL.Emit(OpCodes.Br, cont182)
checkVerIL.MarkLabel(fa182)
checkVerIL.Emit(OpCodes.Br, cont182)
checkVerIL.MarkLabel(cont182)
...
Dim locbldr221 As LocalBuilder = checkClassIL.DeclareLocal(GetType(Token))
...
Dim locbldr222 As LocalBuilder = checkClassIL.DeclareLocal(GetType(System.Type))
...
Dim locbldr223 As LocalBuilder = checkClassIL.DeclareLocal(GetType(ClassStmt))
locbldr223.SetLocalSymInfo("clss")
...
Dim locbldr224 As LocalBuilder = checkClassIL.DeclareLocal(GetType(Attributes.Attribute))
locbldr224.SetLocalSymInfo("att")
...
checkClassIL.Emit(OpCodes.Beq, tru183)
checkClassIL.Emit(OpCodes.Br, fa183)
...
Dim locbldr225 As LocalBuilder = checkClassIL.DeclareLocal(GetType(System.Int32))
locbldr225.SetLocalSymInfo("i")
checkClassIL.Emit(OpCodes.Ldc_I4, CInt(0))
Typ = GetType(System.Int32)
checkClassIL.Emit(OpCodes.Stloc, 4)
checkClassIL.MarkSequencePoint(doc5, 188, 1, 188, 100)
Dim locbldr226 As LocalBuilder = checkClassIL.DeclareLocal(GetType(System.Int32))
...
locbldr228.SetLocalSymInfo("tok2")
checkClassIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
checkClassIL.Emit(OpCodes.Ldfld, GetType(Stmt).GetField("Tokens"))
Typ = GetType(Stmt).GetField("Tokens").FieldType
...
Dim locbldr229 As LocalBuilder = checkClassIL.DeclareLocal(GetType(System.Type))
locbldr229.SetLocalSymInfo("typ2")
...
Dim locbldr230 As LocalBuilder = checkClassIL.DeclareLocal(GetType(System.Boolean))
locbldr230.SetLocalSymInfo("b2")
Dim typ48(-1) As Type
...
checkClassIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa185 As System.Reflection.Emit.Label = checkClassIL.DefineLabel()
Dim tru185 As System.Reflection.Emit.Label = checkClassIL.DefineLabel()
Dim cont185 As System.Reflection.Emit.Label = checkClassIL.DefineLabel()
checkClassIL.Emit(OpCodes.Beq, tru185)
checkClassIL.Emit(OpCodes.Br, fa185)
checkClassIL.MarkLabel(tru185)
...
checkClassIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa186 As System.Reflection.Emit.Label = checkClassIL.DefineLabel()
Dim tru186 As System.Reflection.Emit.Label = checkClassIL.DefineLabel()
Dim cont186 As System.Reflection.Emit.Label = checkClassIL.DefineLabel()
checkClassIL.Emit(OpCodes.Beq, fa186)
checkClassIL.Emit(OpCodes.Br, tru186)
checkClassIL.MarkLabel(tru186)
checkClassIL.MarkSequencePoint(doc5, 214, 1, 214, 100)
Dim locbldr231 As LocalBuilder = checkClassIL.DeclareLocal(GetType(Token))
locbldr231.SetLocalSymInfo("t")
checkClassIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
checkClassIL.Emit(OpCodes.Ldfld, GetType(Stmt).GetField("Tokens"))
Typ = GetType(Stmt).GetField("Tokens").FieldType
...
Dim locbldr232 As LocalBuilder = checkClassIL.DeclareLocal(GetType(TypeTok))
locbldr232.SetLocalSymInfo("tt")
...
checkClassIL.Emit(OpCodes.Br, cont186)
checkClassIL.MarkLabel(fa186)
...
checkClassIL.Emit(OpCodes.Br, cont186)
checkClassIL.MarkLabel(cont186)
checkClassIL.MarkSequencePoint(doc5, 222, 1, 222, 100)
checkClassIL.Emit(OpCodes.Br, cont185)
checkClassIL.MarkLabel(fa185)
...
checkClassIL.Emit(OpCodes.Br, cont185)
checkClassIL.MarkLabel(cont185)
...
Typ = GetType(System.Int32)
Dim fa187 As System.Reflection.Emit.Label = checkClassIL.DefineLabel()
Dim tru187 As System.Reflection.Emit.Label = checkClassIL.DefineLabel()
Dim cont187 As System.Reflection.Emit.Label = checkClassIL.DefineLabel()
checkClassIL.Emit(OpCodes.Beq, tru187)
checkClassIL.Emit(OpCodes.Br, fa187)
checkClassIL.MarkLabel(tru187)
...
checkClassIL.Emit(OpCodes.Br, cont187)
checkClassIL.MarkLabel(fa187)
...
checkClassIL.Emit(OpCodes.Br, cont187)
checkClassIL.MarkLabel(cont187)
...
Dim locbldr233 As LocalBuilder = checkFieldIL.DeclareLocal(GetType(Token))
...
Dim locbldr234 As LocalBuilder = checkFieldIL.DeclareLocal(GetType(System.Type))
...
Dim locbldr235 As LocalBuilder = checkFieldIL.DeclareLocal(GetType(FieldStmt))
locbldr235.SetLocalSymInfo("flss")
...
Dim locbldr236 As LocalBuilder = checkFieldIL.DeclareLocal(GetType(Attributes.Attribute))
locbldr236.SetLocalSymInfo("att")
...
checkFieldIL.Emit(OpCodes.Beq, tru188)
checkFieldIL.Emit(OpCodes.Br, fa188)
checkFieldIL.MarkLabel(tru188)
checkFieldIL.MarkSequencePoint(doc5, 251, 1, 251, 100)
Dim locbldr237 As LocalBuilder = checkFieldIL.DeclareLocal(GetType(Expr))
locbldr237.SetLocalSymInfo("tempexp")
...
Dim locbldr238 As LocalBuilder = checkFieldIL.DeclareLocal(asm.GetType("dylan.NET.Tokenizer.Parser.ExprOptimizer"))
...
Dim locbldr239 As LocalBuilder = checkFieldIL.DeclareLocal(GetType(System.Int32))
locbldr239.SetLocalSymInfo("i")
checkFieldIL.Emit(OpCodes.Ldc_I4, CInt(0))
Typ = GetType(System.Int32)
checkFieldIL.Emit(OpCodes.Stloc, 6)
checkFieldIL.MarkSequencePoint(doc5, 266, 1, 266, 100)
Dim locbldr240 As LocalBuilder = checkFieldIL.DeclareLocal(GetType(System.Int32))
...
checkFieldIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa189 As System.Reflection.Emit.Label = checkFieldIL.DefineLabel()
Dim tru189 As System.Reflection.Emit.Label = checkFieldIL.DefineLabel()
Dim cont189 As System.Reflection.Emit.Label = checkFieldIL.DefineLabel()
checkFieldIL.Emit(OpCodes.Beq, tru189)
checkFieldIL.Emit(OpCodes.Br, fa189)
checkFieldIL.MarkLabel(tru189)
...
checkFieldIL.Emit(OpCodes.Br, cont189)
checkFieldIL.MarkLabel(fa189)
checkFieldIL.Emit(OpCodes.Br, cont189)
checkFieldIL.MarkLabel(cont189)
checkFieldIL.MarkSequencePoint(doc5, 281, 1, 281, 100)
checkFieldIL.Emit(OpCodes.Ldloc, 6)
Typ = GetType(System.Int32)
checkFieldIL.Emit(OpCodes.Ldloc, 7)
Typ = GetType(System.Int32)
Dim fa190 As System.Reflection.Emit.Label = checkFieldIL.DefineLabel()
Dim tru190 As System.Reflection.Emit.Label = checkFieldIL.DefineLabel()
Dim cont190 As System.Reflection.Emit.Label = checkFieldIL.DefineLabel()
checkFieldIL.Emit(OpCodes.Beq, tru190)
checkFieldIL.Emit(OpCodes.Br, fa190)
checkFieldIL.MarkLabel(tru190)
...
checkFieldIL.Emit(OpCodes.Br, cont190)
checkFieldIL.MarkLabel(fa190)
...
checkFieldIL.Emit(OpCodes.Br, cont190)
checkFieldIL.MarkLabel(cont190)
...
locbldr242.SetLocalSymInfo("tok2")
checkFieldIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
checkFieldIL.Emit(OpCodes.Ldfld, GetType(Stmt).GetField("Tokens"))
Typ = GetType(Stmt).GetField("Tokens").FieldType
...
Dim locbldr243 As LocalBuilder = checkFieldIL.DeclareLocal(GetType(System.Type))
locbldr243.SetLocalSymInfo("typ2")
...
Dim locbldr244 As LocalBuilder = checkFieldIL.DeclareLocal(GetType(System.Boolean))
locbldr244.SetLocalSymInfo("b2")
Dim typ59(-1) As Type
...
checkFieldIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa191 As System.Reflection.Emit.Label = checkFieldIL.DefineLabel()
Dim tru191 As System.Reflection.Emit.Label = checkFieldIL.DefineLabel()
Dim cont191 As System.Reflection.Emit.Label = checkFieldIL.DefineLabel()
checkFieldIL.Emit(OpCodes.Beq, fa191)
checkFieldIL.Emit(OpCodes.Br, tru191)
checkFieldIL.MarkLabel(tru191)
checkFieldIL.MarkSequencePoint(doc5, 295, 1, 295, 100)
Dim locbldr245 As LocalBuilder = checkFieldIL.DeclareLocal(GetType(Token))
locbldr245.SetLocalSymInfo("t")
checkFieldIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
checkFieldIL.Emit(OpCodes.Ldfld, GetType(Stmt).GetField("Tokens"))
Typ = GetType(Stmt).GetField("Tokens").FieldType
...
Dim locbldr246 As LocalBuilder = checkFieldIL.DeclareLocal(GetType(TypeTok))
locbldr246.SetLocalSymInfo("tt")
...
checkFieldIL.Emit(OpCodes.Br, cont191)
checkFieldIL.MarkLabel(fa191)
...
checkFieldIL.Emit(OpCodes.Br, cont191)
checkFieldIL.MarkLabel(cont191)
...
Dim locbldr247 As LocalBuilder = checkMethodIL.DeclareLocal(GetType(Token))
locbldr247.SetLocalSymInfo("tok")
...
Dim locbldr248 As LocalBuilder = checkMethodIL.DeclareLocal(GetType(System.Type))
locbldr248.SetLocalSymInfo("typ")
...
Dim locbldr249 As LocalBuilder = checkMethodIL.DeclareLocal(GetType(MethodStmt))
locbldr249.SetLocalSymInfo("mtss")
...
Dim locbldr250 As LocalBuilder = checkMethodIL.DeclareLocal(GetType(Attributes.Attribute))
locbldr250.SetLocalSymInfo("att")
...
Dim locbldr251 As LocalBuilder = checkMethodIL.DeclareLocal(GetType(Ident))
locbldr251.SetLocalSymInfo("mn")
...
Dim locbldr252 As LocalBuilder = checkMethodIL.DeclareLocal(GetType(Expr))
locbldr252.SetLocalSymInfo("exp")
checkMethodIL.Emit(OpCodes.Ldnull)
checkMethodIL.Emit(OpCodes.Stloc, 5)
checkMethodIL.MarkSequencePoint(doc5, 321, 1, 321, 100)
Dim locbldr253 As LocalBuilder = checkMethodIL.DeclareLocal(GetType(System.Boolean))
locbldr253.SetLocalSymInfo("d")
...
checkMethodIL.Emit(OpCodes.Beq, tru192)
checkMethodIL.Emit(OpCodes.Br, fa192)
checkMethodIL.MarkLabel(tru192)
checkMethodIL.MarkSequencePoint(doc5, 325, 1, 325, 100)
Dim locbldr254 As LocalBuilder = checkMethodIL.DeclareLocal(GetType(Expr))
locbldr254.SetLocalSymInfo("tempexp")
...
Dim locbldr255 As LocalBuilder = checkMethodIL.DeclareLocal(asm.GetType("dylan.NET.Tokenizer.Parser.ExprOptimizer"))
locbldr255.SetLocalSymInfo("eop")
...
Dim locbldr256 As LocalBuilder = checkMethodIL.DeclareLocal(GetType(System.Int32))
locbldr256.SetLocalSymInfo("i")
checkMethodIL.Emit(OpCodes.Ldc_I4, CInt(0))
Typ = GetType(System.Int32)
checkMethodIL.Emit(OpCodes.Stloc, 9)
checkMethodIL.MarkSequencePoint(doc5, 341, 1, 341, 100)
Dim locbldr257 As LocalBuilder = checkMethodIL.DeclareLocal(GetType(System.Int32))
locbldr257.SetLocalSymInfo("len")
checkMethodIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
checkMethodIL.Emit(OpCodes.Ldfld, GetType(Stmt).GetField("Tokens"))
Typ = GetType(Stmt).GetField("Tokens").FieldType
...
Dim locbldr260 As LocalBuilder = checkMethodIL.DeclareLocal(GetType(System.Type))
locbldr260.SetLocalSymInfo("typ2")
checkMethodIL.MarkSequencePoint(doc5, 375, 1, 375, 100)
Dim locbldr261 As LocalBuilder = checkMethodIL.DeclareLocal(GetType(System.Boolean))
...
checkMethodIL.Emit(OpCodes.Beq, fa195)
checkMethodIL.Emit(OpCodes.Br, tru195)
checkMethodIL.MarkLabel(tru195)
checkMethodIL.MarkSequencePoint(doc5, 381, 1, 381, 100)
Dim locbldr262 As LocalBuilder = checkMethodIL.DeclareLocal(GetType(Token))
locbldr262.SetLocalSymInfo("t")
checkMethodIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
checkMethodIL.Emit(OpCodes.Ldfld, GetType(Stmt).GetField("Tokens"))
Typ = GetType(Stmt).GetField("Tokens").FieldType
...
Dim locbldr263 As LocalBuilder = checkMethodIL.DeclareLocal(GetType(TypeTok))
locbldr263.SetLocalSymInfo("tt")
...
Dim locbldr264 As LocalBuilder = checkMethodIL.DeclareLocal(asm.GetType("dylan.NET.Tokenizer.Parser.ExprOptimizer"))
locbldr264.SetLocalSymInfo("eopt2")
checkMethodIL.Emit(OpCodes.Newobj, asm.GetType("dylan.NET.Tokenizer.Parser.ExprOptimizer").GetConstructor(Type.EmptyTypes))
...
Dim locbldr265 As LocalBuilder = checkMethodIL.DeclareLocal(asm.GetType("dylan.NET.Tokenizer.Parser.ExprOptimizer"))
locbldr265.SetLocalSymInfo("eopt1")
checkMethodIL.Emit(OpCodes.Newobj, asm.GetType("dylan.NET.Tokenizer.Parser.ExprOptimizer").GetConstructor(Type.EmptyTypes))
...
checkMethodIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa203 As System.Reflection.Emit.Label = checkMethodIL.DefineLabel()
Dim tru203 As System.Reflection.Emit.Label = checkMethodIL.DefineLabel()
Dim cont203 As System.Reflection.Emit.Label = checkMethodIL.DefineLabel()
checkMethodIL.Emit(OpCodes.Beq, tru203)
checkMethodIL.Emit(OpCodes.Br, fa203)
checkMethodIL.MarkLabel(tru203)
...
checkMethodIL.Emit(OpCodes.Br, cont203)
checkMethodIL.MarkLabel(fa203)
checkMethodIL.Emit(OpCodes.Br, cont203)
checkMethodIL.MarkLabel(cont203)
...
checkMethodIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa204 As System.Reflection.Emit.Label = checkMethodIL.DefineLabel()
Dim tru204 As System.Reflection.Emit.Label = checkMethodIL.DefineLabel()
Dim cont204 As System.Reflection.Emit.Label = checkMethodIL.DefineLabel()
checkMethodIL.Emit(OpCodes.Beq, tru204)
checkMethodIL.Emit(OpCodes.Br, fa204)
checkMethodIL.MarkLabel(tru204)
...
checkMethodIL.Emit(OpCodes.Br, cont204)
checkMethodIL.MarkLabel(fa204)
checkMethodIL.Emit(OpCodes.Br, cont204)
checkMethodIL.MarkLabel(cont204)
checkMethodIL.MarkSequencePoint(doc5, 453, 1, 453, 100)
checkMethodIL.Emit(OpCodes.Ldloc, 9)
Typ = GetType(System.Int32)
checkMethodIL.Emit(OpCodes.Ldloc, 10)
Typ = GetType(System.Int32)
Dim fa205 As System.Reflection.Emit.Label = checkMethodIL.DefineLabel()
Dim tru205 As System.Reflection.Emit.Label = checkMethodIL.DefineLabel()
Dim cont205 As System.Reflection.Emit.Label = checkMethodIL.DefineLabel()
checkMethodIL.Emit(OpCodes.Beq, tru205)
checkMethodIL.Emit(OpCodes.Br, fa205)
checkMethodIL.MarkLabel(tru205)
checkMethodIL.MarkSequencePoint(doc5, 454, 1, 454, 100)
checkMethodIL.Emit(OpCodes.Br, label8)
checkMethodIL.MarkSequencePoint(doc5, 455, 1, 455, 100)
checkMethodIL.Emit(OpCodes.Br, cont205)
checkMethodIL.MarkLabel(fa205)
...
checkMethodIL.Emit(OpCodes.Br, cont205)
checkMethodIL.MarkLabel(cont205)
...
checkMethodCallIL.Emit(OpCodes.Bgt, tru206)
...
Dim locbldr266 As LocalBuilder = checkMethodCallIL.DeclareLocal(GetType(Token))
...
Dim locbldr267 As LocalBuilder = checkMethodCallIL.DeclareLocal(GetType(System.Type))
...
Dim locbldr268 As LocalBuilder = checkMethodCallIL.DeclareLocal(GetType(Token))
locbldr268.SetLocalSymInfo("tokb")
checkMethodCallIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
checkMethodCallIL.Emit(OpCodes.Ldfld, GetType(Stmt).GetField("Tokens"))
Typ = GetType(Stmt).GetField("Tokens").FieldType
...
Dim locbldr269 As LocalBuilder = checkMethodCallIL.DeclareLocal(GetType(System.Type))
locbldr269.SetLocalSymInfo("typb")
...
Dim locbldr270 As LocalBuilder = checkMethodCallIL.DeclareLocal(GetType(System.Boolean))
locbldr270.SetLocalSymInfo("ba")
Dim typ87(-1) As Type
...
Dim locbldr271 As LocalBuilder = checkMethodCallIL.DeclareLocal(GetType(System.Boolean))
locbldr271.SetLocalSymInfo("bb")
Dim typ88(-1) As Type
...
Dim locbldr272 As LocalBuilder = checkMethodCallIL.DeclareLocal(GetType(MethodCallStmt))
locbldr272.SetLocalSymInfo("mtcss")
...
Dim locbldr273 As LocalBuilder = checkMethodCallIL.DeclareLocal(GetType(MethodNameTok))
locbldr273.SetLocalSymInfo("mn")
...
Dim locbldr274 As LocalBuilder = checkMethodCallIL.DeclareLocal(GetType(MethodCallTok))
locbldr274.SetLocalSymInfo("mct")
...
Dim locbldr275 As LocalBuilder = checkMethodCallIL.DeclareLocal(GetType(Ident))
locbldr275.SetLocalSymInfo("idt")
...
Dim locbldr276 As LocalBuilder = checkMethodCallIL.DeclareLocal(GetType(Expr))
locbldr276.SetLocalSymInfo("exp")
...
Dim locbldr277 As LocalBuilder = checkMethodCallIL.DeclareLocal(GetType(System.Int32))
locbldr277.SetLocalSymInfo("lvl")
checkMethodCallIL.Emit(OpCodes.Ldc_I4, CInt(1))
Typ = GetType(System.Int32)
checkMethodCallIL.Emit(OpCodes.Stloc, 11)
checkMethodCallIL.MarkSequencePoint(doc5, 485, 1, 485, 100)
Dim locbldr278 As LocalBuilder = checkMethodCallIL.DeclareLocal(GetType(System.Boolean))
locbldr278.SetLocalSymInfo("d")
...
Dim locbldr279 As LocalBuilder = checkMethodCallIL.DeclareLocal(GetType(System.Int32))
locbldr279.SetLocalSymInfo("i")
checkMethodCallIL.Emit(OpCodes.Ldc_I4, CInt(1))
Typ = GetType(System.Int32)
...
Dim locbldr280 As LocalBuilder = checkMethodCallIL.DeclareLocal(GetType(Token))
...
Dim locbldr281 As LocalBuilder = checkMethodCallIL.DeclareLocal(GetType(System.Type))
locbldr281.SetLocalSymInfo("typ2")
checkMethodCallIL.MarkSequencePoint(doc5, 499, 1, 499, 100)
Dim locbldr282 As LocalBuilder = checkMethodCallIL.DeclareLocal(GetType(System.Boolean))
locbldr282.SetLocalSymInfo("b2")
checkMethodCallIL.MarkSequencePoint(doc5, 500, 1, 500, 100)
Dim locbldr283 As LocalBuilder = checkMethodCallIL.DeclareLocal(GetType(System.Int32))
locbldr283.SetLocalSymInfo("len")
checkMethodCallIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
checkMethodCallIL.Emit(OpCodes.Ldfld, GetType(Stmt).GetField("Tokens"))
Typ = GetType(Stmt).GetField("Tokens").FieldType
...
Dim locbldr284 As LocalBuilder = checkMethodCallIL.DeclareLocal(asm.GetType("dylan.NET.Tokenizer.Parser.ExprOptimizer"))
locbldr284.SetLocalSymInfo("eopt")
...
checkMethodCallIL.Emit(OpCodes.Ldc_I4, CInt(1))
Typ = GetType(System.Int32)
Dim fa212 As System.Reflection.Emit.Label = checkMethodCallIL.DefineLabel()
Dim tru212 As System.Reflection.Emit.Label = checkMethodCallIL.DefineLabel()
Dim cont212 As System.Reflection.Emit.Label = checkMethodCallIL.DefineLabel()
checkMethodCallIL.Emit(OpCodes.Beq, tru212)
checkMethodCallIL.Emit(OpCodes.Br, fa212)
checkMethodCallIL.MarkLabel(tru212)
...
checkMethodCallIL.Emit(OpCodes.Br, cont212)
checkMethodCallIL.MarkLabel(fa212)
...
checkMethodCallIL.Emit(OpCodes.Br, cont212)
checkMethodCallIL.MarkLabel(cont212)
...
checkMethodCallIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa213 As System.Reflection.Emit.Label = checkMethodCallIL.DefineLabel()
Dim tru213 As System.Reflection.Emit.Label = checkMethodCallIL.DefineLabel()
Dim cont213 As System.Reflection.Emit.Label = checkMethodCallIL.DefineLabel()
checkMethodCallIL.Emit(OpCodes.Beq, tru213)
checkMethodCallIL.Emit(OpCodes.Br, fa213)
checkMethodCallIL.MarkLabel(tru213)
...
checkMethodCallIL.Emit(OpCodes.Br, cont213)
checkMethodCallIL.MarkLabel(fa213)
checkMethodCallIL.Emit(OpCodes.Br, cont213)
checkMethodCallIL.MarkLabel(cont213)
checkMethodCallIL.MarkSequencePoint(doc5, 563, 1, 563, 100)
checkMethodCallIL.Emit(OpCodes.Ldloc, 13)
Typ = GetType(System.Int32)
checkMethodCallIL.Emit(OpCodes.Ldloc, 17)
Typ = GetType(System.Int32)
Dim fa214 As System.Reflection.Emit.Label = checkMethodCallIL.DefineLabel()
Dim tru214 As System.Reflection.Emit.Label = checkMethodCallIL.DefineLabel()
Dim cont214 As System.Reflection.Emit.Label = checkMethodCallIL.DefineLabel()
checkMethodCallIL.Emit(OpCodes.Beq, tru214)
checkMethodCallIL.Emit(OpCodes.Br, fa214)
checkMethodCallIL.MarkLabel(tru214)
checkMethodCallIL.MarkSequencePoint(doc5, 564, 1, 564, 100)
checkMethodCallIL.Emit(OpCodes.Br, label10)
checkMethodCallIL.MarkSequencePoint(doc5, 565, 1, 565, 100)
checkMethodCallIL.Emit(OpCodes.Br, cont214)
checkMethodCallIL.MarkLabel(fa214)
...
checkMethodCallIL.Emit(OpCodes.Br, cont214)
checkMethodCallIL.MarkLabel(cont214)
...
Dim locbldr285 As LocalBuilder = checkVarAsIL.DeclareLocal(GetType(Token))
...
Dim locbldr286 As LocalBuilder = checkVarAsIL.DeclareLocal(GetType(System.Type))
...
Dim locbldr287 As LocalBuilder = checkVarAsIL.DeclareLocal(GetType(VarStmt))
locbldr287.SetLocalSymInfo("vars")
...
checkVarAsIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa215 As System.Reflection.Emit.Label = checkVarAsIL.DefineLabel()
Dim tru215 As System.Reflection.Emit.Label = checkVarAsIL.DefineLabel()
Dim cont215 As System.Reflection.Emit.Label = checkVarAsIL.DefineLabel()
checkVarAsIL.Emit(OpCodes.Beq, tru215)
checkVarAsIL.Emit(OpCodes.Br, fa215)
checkVarAsIL.MarkLabel(tru215)
...
Dim locbldr288 As LocalBuilder = checkVarAsIL.DeclareLocal(GetType(Expr))
locbldr288.SetLocalSymInfo("tempexp")
...
Dim locbldr289 As LocalBuilder = checkVarAsIL.DeclareLocal(asm.GetType("dylan.NET.Tokenizer.Parser.ExprOptimizer"))
locbldr289.SetLocalSymInfo("eop")
...
locbldr290.SetLocalSymInfo("tok2")
checkVarAsIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
checkVarAsIL.Emit(OpCodes.Ldfld, GetType(Stmt).GetField("Tokens"))
Typ = GetType(Stmt).GetField("Tokens").FieldType
...
Dim locbldr291 As LocalBuilder = checkVarAsIL.DeclareLocal(GetType(System.Type))
locbldr291.SetLocalSymInfo("typ2")
checkVarAsIL.Emit(OpCodes.Ldtoken, GetType(TypeTok))
...
Dim locbldr292 As LocalBuilder = checkVarAsIL.DeclareLocal(GetType(System.Boolean))
locbldr292.SetLocalSymInfo("b2")
...
checkVarAsIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa216 As System.Reflection.Emit.Label = checkVarAsIL.DefineLabel()
Dim tru216 As System.Reflection.Emit.Label = checkVarAsIL.DefineLabel()
Dim cont216 As System.Reflection.Emit.Label = checkVarAsIL.DefineLabel()
checkVarAsIL.Emit(OpCodes.Beq, fa216)
checkVarAsIL.Emit(OpCodes.Br, tru216)
checkVarAsIL.MarkLabel(tru216)
checkVarAsIL.MarkSequencePoint(doc5, 601, 1, 601, 100)
Dim locbldr293 As LocalBuilder = checkVarAsIL.DeclareLocal(GetType(Token))
locbldr293.SetLocalSymInfo("t")
checkVarAsIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
checkVarAsIL.Emit(OpCodes.Ldfld, GetType(Stmt).GetField("Tokens"))
Typ = GetType(Stmt).GetField("Tokens").FieldType
...
Dim locbldr294 As LocalBuilder = checkVarAsIL.DeclareLocal(GetType(TypeTok))
locbldr294.SetLocalSymInfo("tt")
checkVarAsIL.Emit(OpCodes.Newobj, GetType(TypeTok).GetConstructor(Type.EmptyTypes))
...
checkVarAsIL.Emit(OpCodes.Br, cont216)
checkVarAsIL.MarkLabel(fa216)
...
checkVarAsIL.Emit(OpCodes.Br, cont216)
checkVarAsIL.MarkLabel(cont216)
checkVarAsIL.MarkSequencePoint(doc5, 610, 1, 610, 100)
checkVarAsIL.Emit(OpCodes.Br, cont215)
checkVarAsIL.MarkLabel(fa215)
checkVarAsIL.Emit(OpCodes.Br, cont215)
checkVarAsIL.MarkLabel(cont215)
...
Dim locbldr295 As LocalBuilder = AssOptIL.DeclareLocal(GetType(AssignStmt))
locbldr295.SetLocalSymInfo("asss")
AssOptIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
AssOptIL.Emit(OpCodes.Stloc, 0)
AssOptIL.MarkSequencePoint(doc5, 617, 1, 617, 100)
Dim locbldr296 As LocalBuilder = AssOptIL.DeclareLocal(GetType(Expr))
locbldr296.SetLocalSymInfo("le")
...
Dim locbldr297 As LocalBuilder = AssOptIL.DeclareLocal(GetType(Token))
locbldr297.SetLocalSymInfo("tok")
...
Dim locbldr298 As LocalBuilder = AssOptIL.DeclareLocal(GetType(System.Type))
locbldr298.SetLocalSymInfo("typ")
...
Dim locbldr299 As LocalBuilder = AssOptIL.DeclareLocal(GetType(System.Boolean))
locbldr299.SetLocalSymInfo("b")
Dim typ108(-1) As Type
...
Dim locbldr300 As LocalBuilder = AssOptIL.DeclareLocal(GetType(VarAsgnStmt))
locbldr300.SetLocalSymInfo("vass")
...
Typ = GetType(System.Boolean)
Dim fa217 As System.Reflection.Emit.Label = AssOptIL.DefineLabel()
Dim tru217 As System.Reflection.Emit.Label = AssOptIL.DefineLabel()
Dim cont217 As System.Reflection.Emit.Label = AssOptIL.DefineLabel()
AssOptIL.Emit(OpCodes.Beq, tru217)
AssOptIL.Emit(OpCodes.Br, fa217)
AssOptIL.MarkLabel(tru217)
...
locbldr301.SetLocalSymInfo("tok2")
AssOptIL.Emit(OpCodes.Ldloc, 1)
Typ = GetType(Expr)
AssOptIL.Emit(OpCodes.Ldfld, GetType(Expr).GetField("Tokens"))
Typ = GetType(Expr).GetField("Tokens").FieldType
...
Dim locbldr302 As LocalBuilder = AssOptIL.DeclareLocal(GetType(System.Type))
locbldr302.SetLocalSymInfo("typ2")
...
Dim locbldr303 As LocalBuilder = AssOptIL.DeclareLocal(GetType(System.Boolean))
locbldr303.SetLocalSymInfo("b2")
...
AssOptIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa218 As System.Reflection.Emit.Label = AssOptIL.DefineLabel()
Dim tru218 As System.Reflection.Emit.Label = AssOptIL.DefineLabel()
Dim cont218 As System.Reflection.Emit.Label = AssOptIL.DefineLabel()
AssOptIL.Emit(OpCodes.Beq, fa218)
AssOptIL.Emit(OpCodes.Br, tru218)
AssOptIL.MarkLabel(tru218)
AssOptIL.MarkSequencePoint(doc5, 632, 1, 632, 100)
Dim locbldr304 As LocalBuilder = AssOptIL.DeclareLocal(GetType(Token))
locbldr304.SetLocalSymInfo("t")
AssOptIL.Emit(OpCodes.Ldloc, 1)
Typ = GetType(Expr)
AssOptIL.Emit(OpCodes.Ldfld, GetType(Expr).GetField("Tokens"))
Typ = GetType(Expr).GetField("Tokens").FieldType
...
Dim locbldr305 As LocalBuilder = AssOptIL.DeclareLocal(GetType(TypeTok))
locbldr305.SetLocalSymInfo("tt")
...
AssOptIL.Emit(OpCodes.Br, cont218)
AssOptIL.MarkLabel(fa218)
...
Dim locbldr306 As LocalBuilder = AssOptIL.DeclareLocal(asm.GetType("dylan.NET.Tokenizer.Parser.ExprOptimizer"))
locbldr306.SetLocalSymInfo("eop")
...
Dim locbldr307 As LocalBuilder = checkAssignIL.DeclareLocal(GetType(Token))
locbldr307.SetLocalSymInfo("tok")
checkAssignIL.Emit(OpCodes.Ldnull)
checkAssignIL.Emit(OpCodes.Stloc, 0)
checkAssignIL.MarkSequencePoint(doc5, 654, 1, 654, 100)
Dim locbldr308 As LocalBuilder = checkAssignIL.DeclareLocal(GetType(System.Type))
locbldr308.SetLocalSymInfo("typ")
...
Dim locbldr309 As LocalBuilder = checkAssignIL.DeclareLocal(GetType(AssignStmt))
locbldr309.SetLocalSymInfo("asss")
...
Dim locbldr310 As LocalBuilder = checkAssignIL.DeclareLocal(GetType(System.Boolean))
locbldr310.SetLocalSymInfo("c")
checkAssignIL.Emit(OpCodes.Ldc_I4, 0)
Typ = GetType(System.Boolean)
checkAssignIL.Emit(OpCodes.Stloc, 3)
checkAssignIL.MarkSequencePoint(doc5, 657, 1, 657, 100)
Dim locbldr311 As LocalBuilder = checkAssignIL.DeclareLocal(GetType(Expr))
locbldr311.SetLocalSymInfo("re")
...
Dim locbldr312 As LocalBuilder = checkAssignIL.DeclareLocal(GetType(Expr))
locbldr312.SetLocalSymInfo("le")
checkAssignIL.Emit(OpCodes.Newobj, GetType(Expr).GetConstructor(Type.EmptyTypes))
checkAssignIL.Emit(OpCodes.Stloc, 5)
checkAssignIL.MarkSequencePoint(doc5, 659, 1, 659, 100)
Dim locbldr313 As LocalBuilder = checkAssignIL.DeclareLocal(GetType(System.Int32))
locbldr313.SetLocalSymInfo("i")
...
Dim locbldr314 As LocalBuilder = checkAssignIL.DeclareLocal(GetType(System.Int32))
locbldr314.SetLocalSymInfo("len")
...
Dim locbldr315 As LocalBuilder = checkAssignIL.DeclareLocal(GetType(System.Int32))
locbldr315.SetLocalSymInfo("assind")
...
checkAssignIL.Emit(OpCodes.Ldc_I4, CInt(0))
Typ = GetType(System.Int32)
Dim fa221 As System.Reflection.Emit.Label = checkAssignIL.DefineLabel()
Dim tru221 As System.Reflection.Emit.Label = checkAssignIL.DefineLabel()
Dim cont221 As System.Reflection.Emit.Label = checkAssignIL.DefineLabel()
checkAssignIL.Emit(OpCodes.Beq, fa221)
checkAssignIL.Emit(OpCodes.Br, tru221)
checkAssignIL.MarkLabel(tru221)
...
checkAssignIL.Emit(OpCodes.Ldloc, 7)
Typ = GetType(System.Int32)
Dim fa222 As System.Reflection.Emit.Label = checkAssignIL.DefineLabel()
Dim tru222 As System.Reflection.Emit.Label = checkAssignIL.DefineLabel()
Dim cont222 As System.Reflection.Emit.Label = checkAssignIL.DefineLabel()
checkAssignIL.Emit(OpCodes.Beq, tru222)
checkAssignIL.Emit(OpCodes.Br, fa222)
checkAssignIL.MarkLabel(tru222)
...
checkAssignIL.Emit(OpCodes.Br, cont222)
checkAssignIL.MarkLabel(fa222)
...
checkAssignIL.Emit(OpCodes.Br, cont222)
checkAssignIL.MarkLabel(cont222)
...
checkAssignIL.Emit(OpCodes.Ldloc, 7)
Typ = GetType(System.Int32)
Dim fa223 As System.Reflection.Emit.Label = checkAssignIL.DefineLabel()
Dim tru223 As System.Reflection.Emit.Label = checkAssignIL.DefineLabel()
Dim cont223 As System.Reflection.Emit.Label = checkAssignIL.DefineLabel()
checkAssignIL.Emit(OpCodes.Beq, tru223)
checkAssignIL.Emit(OpCodes.Br, fa223)
checkAssignIL.MarkLabel(tru223)
...
checkAssignIL.Emit(OpCodes.Br, cont223)
checkAssignIL.MarkLabel(fa223)
...
checkAssignIL.Emit(OpCodes.Br, cont223)
checkAssignIL.MarkLabel(cont223)
...
Dim locbldr316 As LocalBuilder = checkAssignIL.DeclareLocal(asm.GetType("dylan.NET.Tokenizer.Parser.ExprOptimizer"))
locbldr316.SetLocalSymInfo("eop")
...
checkAssignIL.Emit(OpCodes.Br, cont221)
checkAssignIL.MarkLabel(fa221)
...
checkAssignIL.Emit(OpCodes.Br, cont221)
checkAssignIL.MarkLabel(cont221)
...
Dim locbldr317 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(System.Int32))
locbldr317.SetLocalSymInfo("i")
OptimizeIL.Emit(OpCodes.Ldc_I4, CInt(-1))
Typ = GetType(System.Int32)
OptimizeIL.Emit(OpCodes.Stloc, 0)
OptimizeIL.MarkSequencePoint(doc5, 757, 1, 757, 100)
Dim locbldr318 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(System.Int32))
locbldr318.SetLocalSymInfo("len")
OptimizeIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
...
Dim locbldr319 As LocalBuilder = OptimizeIL.DeclareLocal(asm.GetType("dylan.NET.Tokenizer.Parser.TokenOptimizer"))
locbldr319.SetLocalSymInfo("to")
OptimizeIL.Emit(OpCodes.Ldnull)
OptimizeIL.Emit(OpCodes.Stloc, 2)
OptimizeIL.MarkSequencePoint(doc5, 759, 1, 759, 100)
Dim locbldr320 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(Stmt))
locbldr320.SetLocalSymInfo("tmpstm")
OptimizeIL.Emit(OpCodes.Ldnull)
OptimizeIL.Emit(OpCodes.Stloc, 3)
OptimizeIL.MarkSequencePoint(doc5, 760, 1, 760, 100)
Dim locbldr321 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(System.Boolean))
locbldr321.SetLocalSymInfo("compb")
OptimizeIL.Emit(OpCodes.Ldc_I4, 0)
Typ = GetType(System.Boolean)
OptimizeIL.Emit(OpCodes.Stloc, 4)
...
OptimizeIL.Emit(OpCodes.Blt, tru224)
...
OptimizeIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa241 As System.Reflection.Emit.Label = OptimizeIL.DefineLabel()
Dim tru241 As System.Reflection.Emit.Label = OptimizeIL.DefineLabel()
Dim cont241 As System.Reflection.Emit.Label = OptimizeIL.DefineLabel()
OptimizeIL.Emit(OpCodes.Beq, tru241)
OptimizeIL.Emit(OpCodes.Br, fa241)
OptimizeIL.MarkLabel(tru241)
...
OptimizeIL.Emit(OpCodes.Br, cont241)
OptimizeIL.MarkLabel(fa241)
OptimizeIL.Emit(OpCodes.Br, cont241)
OptimizeIL.MarkLabel(cont241)
...
OptimizeIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa242 As System.Reflection.Emit.Label = OptimizeIL.DefineLabel()
Dim tru242 As System.Reflection.Emit.Label = OptimizeIL.DefineLabel()
Dim cont242 As System.Reflection.Emit.Label = OptimizeIL.DefineLabel()
OptimizeIL.Emit(OpCodes.Beq, tru242)
OptimizeIL.Emit(OpCodes.Br, fa242)
OptimizeIL.MarkLabel(tru242)
...
OptimizeIL.Emit(OpCodes.Br, cont242)
OptimizeIL.MarkLabel(fa242)
OptimizeIL.Emit(OpCodes.Br, cont242)
OptimizeIL.MarkLabel(cont242)
...
OptimizeIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa243 As System.Reflection.Emit.Label = OptimizeIL.DefineLabel()
Dim tru243 As System.Reflection.Emit.Label = OptimizeIL.DefineLabel()
Dim cont243 As System.Reflection.Emit.Label = OptimizeIL.DefineLabel()
OptimizeIL.Emit(OpCodes.Beq, tru243)
OptimizeIL.Emit(OpCodes.Br, fa243)
OptimizeIL.MarkLabel(tru243)
...
OptimizeIL.Emit(OpCodes.Br, cont243)
OptimizeIL.MarkLabel(fa243)
OptimizeIL.Emit(OpCodes.Br, cont243)
OptimizeIL.MarkLabel(cont243)
...
Dim locbldr322 As LocalBuilder = ParseIL.DeclareLocal(GetType(System.Int32))
...
Dim locbldr323 As LocalBuilder = ParseIL.DeclareLocal(asm.GetType("dylan.NET.Tokenizer.Parser.StmtOptimizer"))
locbldr323.SetLocalSymInfo("so")
ParseIL.Emit(OpCodes.Ldnull)
ParseIL.Emit(OpCodes.Stloc, 1)
ParseIL.MarkSequencePoint(doc6, 14, 1, 14, 100)
Dim locbldr324 As LocalBuilder = ParseIL.DeclareLocal(GetType(System.Int32))
locbldr324.SetLocalSymInfo("len")
...
ParseIL.Emit(OpCodes.Ldloc, 2)
Typ = GetType(System.Int32)
Dim fa244 As System.Reflection.Emit.Label = ParseIL.DefineLabel()
Dim tru244 As System.Reflection.Emit.Label = ParseIL.DefineLabel()
Dim cont244 As System.Reflection.Emit.Label = ParseIL.DefineLabel()
ParseIL.Emit(OpCodes.Beq, tru244)
ParseIL.Emit(OpCodes.Br, fa244)
ParseIL.MarkLabel(tru244)
ParseIL.MarkSequencePoint(doc6, 27, 1, 27, 100)
ParseIL.Emit(OpCodes.Br, label1)
ParseIL.MarkSequencePoint(doc6, 28, 1, 28, 100)
ParseIL.Emit(OpCodes.Br, cont244)
ParseIL.MarkLabel(fa244)
ParseIL.MarkSequencePoint(doc6, 29, 1, 29, 100)
ParseIL.Emit(OpCodes.Br, label0)
ParseIL.MarkSequencePoint(doc6, 30, 1, 30, 100)
ParseIL.Emit(OpCodes.Br, cont244)
ParseIL.MarkLabel(cont244)
