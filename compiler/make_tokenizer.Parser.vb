...
OptimizeIL.Emit(OpCodes.Ldstr, "#scope")
Typ = GetType(System.String)
ReDim Preserve typ45(UBound(typ45) + 1)
typ45(UBound(typ45)) = Typ
...
Dim locbldr50 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(ScopeTok))
locbldr50.SetLocalSymInfo("scptk")
OptimizeIL.Emit(OpCodes.Newobj, GetType(ScopeTok).GetConstructor(Type.EmptyTypes))
OptimizeIL.Emit(OpCodes.Stloc, 50)
OptimizeIL.MarkSequencePoint(doc3, 480, 1, 480, 100)
OptimizeIL.Emit(OpCodes.Ldloc, 50)
Typ = GetType(ScopeTok)
OptimizeIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Token)
OptimizeIL.Emit(OpCodes.Ldfld, GetType(Token).GetField("Line"))
Typ = GetType(Token).GetField("Line").FieldType
OptimizeIL.Emit(OpCodes.Stfld, GetType(ScopeTok).GetField("Line"))
...
OptimizeIL.Emit(OpCodes.Ldfld, GetType(Token).GetField("Value"))
Typ = GetType(Token).GetField("Value").FieldType
OptimizeIL.Emit(OpCodes.Stfld, GetType(ScopeTok).GetField("Value"))
...
Dim locbldr51 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(ImportTok))
locbldr51.SetLocalSymInfo("imptk")
...
Dim locbldr52 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(LocimportTok))
locbldr52.SetLocalSymInfo("limptk")
...
Dim locbldr53 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(AssemblyTok))
locbldr53.SetLocalSymInfo("asmtk")
...
OptimizeIL.Emit(OpCodes.Stloc, 0)
OptimizeIL.MarkSequencePoint(doc3, 520, 1, 520, 100)
OptimizeIL.Emit(OpCodes.Ldloc, 0)
Typ = GetType(System.Int32)
OptimizeIL.Emit(OpCodes.Ldc_I4, CInt(0))
Typ = GetType(System.Int32)
...
Dim locbldr54 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(VerTok))
locbldr54.SetLocalSymInfo("vertk")
...
Dim locbldr55 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(OnTok))
locbldr55.SetLocalSymInfo("ontk")
...
Dim locbldr56 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(OffTok))
locbldr56.SetLocalSymInfo("offtk")
...
Dim locbldr57 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(ExeTok))
locbldr57.SetLocalSymInfo("extk")
...
Dim locbldr58 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(DllTok))
locbldr58.SetLocalSymInfo("dltk")
...
Dim locbldr59 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(FieldTok))
locbldr59.SetLocalSymInfo("fltk")
...
Dim locbldr60 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(ClassTok))
locbldr60.SetLocalSymInfo("cltk")
...
Dim locbldr61 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(ExtendsTok))
locbldr61.SetLocalSymInfo("exttk")
...
Dim locbldr62 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(MethodTok))
locbldr62.SetLocalSymInfo("mettk")
...
Dim locbldr63 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(EndTok))
locbldr63.SetLocalSymInfo("entk")
...
OptimizeIL.Emit(OpCodes.Ldstr, "return")
Typ = GetType(System.String)
ReDim Preserve typ59(UBound(typ59) + 1)
typ59(UBound(typ59)) = Typ
...
Dim locbldr64 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(ReturnTok))
locbldr64.SetLocalSymInfo("rettk")
OptimizeIL.Emit(OpCodes.Newobj, GetType(ReturnTok).GetConstructor(Type.EmptyTypes))
OptimizeIL.Emit(OpCodes.Stloc, 64)
OptimizeIL.MarkSequencePoint(doc3, 623, 1, 623, 100)
OptimizeIL.Emit(OpCodes.Ldloc, 64)
Typ = GetType(ReturnTok)
OptimizeIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Token)
OptimizeIL.Emit(OpCodes.Ldfld, GetType(Token).GetField("Line"))
Typ = GetType(Token).GetField("Line").FieldType
OptimizeIL.Emit(OpCodes.Stfld, GetType(ReturnTok).GetField("Line"))
...
OptimizeIL.Emit(OpCodes.Ldfld, GetType(Token).GetField("Value"))
Typ = GetType(Token).GetField("Value").FieldType
OptimizeIL.Emit(OpCodes.Stfld, GetType(ReturnTok).GetField("Value"))
...
Dim locbldr65 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(VarTok))
locbldr65.SetLocalSymInfo("vrtk")
...
Dim locbldr66 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(AsTok))
locbldr66.SetLocalSymInfo("astk")
...
Dim locbldr67 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(OfTok))
locbldr67.SetLocalSymInfo("oftk")
...
Dim locbldr68 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(PrivateAttr))
locbldr68.SetLocalSymInfo("privattr")
...
Dim locbldr69 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(PublicAttr))
locbldr69.SetLocalSymInfo("pubattr")
...
Dim locbldr70 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(InitOnlyAttr))
locbldr70.SetLocalSymInfo("initoattr")
...
Dim locbldr71 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(StaticAttr))
locbldr71.SetLocalSymInfo("statattr")
...
OptimizeIL.Emit(OpCodes.Ldstr, "specialname")
Typ = GetType(System.String)
ReDim Preserve typ67(UBound(typ67) + 1)
typ67(UBound(typ67)) = Typ
...
Dim locbldr72 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(SpecialNameAttr))
locbldr72.SetLocalSymInfo("spnattr")
OptimizeIL.Emit(OpCodes.Newobj, GetType(SpecialNameAttr).GetConstructor(Type.EmptyTypes))
OptimizeIL.Emit(OpCodes.Stloc, 72)
OptimizeIL.MarkSequencePoint(doc3, 703, 1, 703, 100)
OptimizeIL.Emit(OpCodes.Ldloc, 72)
Typ = GetType(SpecialNameAttr)
OptimizeIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Token)
OptimizeIL.Emit(OpCodes.Ldfld, GetType(Token).GetField("Line"))
Typ = GetType(Token).GetField("Line").FieldType
OptimizeIL.Emit(OpCodes.Stfld, GetType(SpecialNameAttr).GetField("Line"))
...
OptimizeIL.Emit(OpCodes.Ldfld, GetType(Token).GetField("Value"))
Typ = GetType(Token).GetField("Value").FieldType
OptimizeIL.Emit(OpCodes.Stfld, GetType(SpecialNameAttr).GetField("Value"))
...
OptimizeIL.Emit(OpCodes.Ldstr, "virtual")
Typ = GetType(System.String)
ReDim Preserve typ68(UBound(typ68) + 1)
typ68(UBound(typ68)) = Typ
...
Dim locbldr73 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(VirtualAttr))
locbldr73.SetLocalSymInfo("virtattr")
OptimizeIL.Emit(OpCodes.Newobj, GetType(VirtualAttr).GetConstructor(Type.EmptyTypes))
OptimizeIL.Emit(OpCodes.Stloc, 73)
OptimizeIL.MarkSequencePoint(doc3, 713, 1, 713, 100)
OptimizeIL.Emit(OpCodes.Ldloc, 73)
Typ = GetType(VirtualAttr)
OptimizeIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Token)
OptimizeIL.Emit(OpCodes.Ldfld, GetType(Token).GetField("Line"))
Typ = GetType(Token).GetField("Line").FieldType
OptimizeIL.Emit(OpCodes.Stfld, GetType(VirtualAttr).GetField("Line"))
...
OptimizeIL.Emit(OpCodes.Ldfld, GetType(Token).GetField("Value"))
Typ = GetType(Token).GetField("Value").FieldType
OptimizeIL.Emit(OpCodes.Stfld, GetType(VirtualAttr).GetField("Value"))
...
Dim locbldr74 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(AutoLayoutAttr))
locbldr74.SetLocalSymInfo("autattr")
...
Dim locbldr75 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(AutoClassAttr))
locbldr75.SetLocalSymInfo("autcattr")
...
Dim locbldr76 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(AnsiClassAttr))
locbldr76.SetLocalSymInfo("ansattr")
...
Dim locbldr77 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(BeforeFieldInitAttr))
locbldr77.SetLocalSymInfo("bfiattr")
...
Dim locbldr78 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(StringTok))
locbldr78.SetLocalSymInfo("strtok")
...
Dim locbldr79 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(VoidTok))
locbldr79.SetLocalSymInfo("voidtok")
...
Dim locbldr80 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(DecimalTok))
locbldr80.SetLocalSymInfo("decitok")
...
Dim locbldr81 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(IntegerTok))
locbldr81.SetLocalSymInfo("inttok")
...
Dim locbldr82 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(IntPtrTok))
locbldr82.SetLocalSymInfo("intptok")
...
Dim locbldr83 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(UIntegerTok))
locbldr83.SetLocalSymInfo("uinttok")
...
Dim locbldr84 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(DoubleTok))
locbldr84.SetLocalSymInfo("dbltok")
...
Dim locbldr85 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(BooleanTok))
locbldr85.SetLocalSymInfo("booltok")
...
Dim locbldr86 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(CharTok))
locbldr86.SetLocalSymInfo("chrtok")
...
Dim locbldr87 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(SingleTok))
locbldr87.SetLocalSymInfo("sngtok")
...
Dim locbldr88 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(SByteTok))
locbldr88.SetLocalSymInfo("sbytok")
...
Dim locbldr89 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(ByteTok))
locbldr89.SetLocalSymInfo("byttok")
...
Dim locbldr90 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(ShortTok))
locbldr90.SetLocalSymInfo("shtok")
...
Dim locbldr91 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(UShortTok))
locbldr91.SetLocalSymInfo("ushtok")
...
Dim locbldr92 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(LongTok))
locbldr92.SetLocalSymInfo("lngtok")
...
ReDim Preserve typ103(UBound(typ103) + 1)
typ103(UBound(typ103)) = Typ
OptimizeIL.Emit(OpCodes.Call, GetType(String).GetMethod("Compare", typ103))
...
Dim locbldr93 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(ULongTok))
locbldr93.SetLocalSymInfo("ulngtok")
...
Dim locbldr94 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(ObjectTok))
locbldr94.SetLocalSymInfo("objtok")
...
ReDim Preserve typ107(UBound(typ107) + 1)
typ107(UBound(typ107)) = Typ
OptimizeIL.Emit(OpCodes.Call, GetType(Utils.ParseUtils).GetMethod("LikeOP", typ107))
Typ = GetType(Utils.ParseUtils).GetMethod("LikeOP", typ107).ReturnType
OptimizeIL.Emit(OpCodes.Stloc, 1)
...
Dim locbldr95 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(commentTok))
locbldr95.SetLocalSymInfo("comtok")
...
Typ = GetType(commentTok)
OptimizeIL.Emit(OpCodes.Starg, 1)
OptimizeIL.MarkSequencePoint(doc3, 956, 1, 956, 100)
OptimizeIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
...
Dim locbldr96 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(NullLiteral))
locbldr96.SetLocalSymInfo("nulllit")
...
ReDim Preserve typ109(UBound(typ109) + 1)
typ109(UBound(typ109)) = Typ
OptimizeIL.Emit(OpCodes.Call, GetType(String).GetMethod("Compare", typ109))
Typ = GetType(String).GetMethod("Compare", typ109).ReturnType
OptimizeIL.Emit(OpCodes.Stloc, 0)
...
ReDim Preserve typ110(UBound(typ110) + 1)
typ110(UBound(typ110)) = Typ
OptimizeIL.Emit(OpCodes.Call, GetType(String).GetMethod("Compare", typ110))
Typ = GetType(String).GetMethod("Compare", typ110).ReturnType
OptimizeIL.Emit(OpCodes.Stloc, 0)
OptimizeIL.MarkSequencePoint(doc3, 976, 1, 976, 100)
OptimizeIL.Emit(OpCodes.Ldloc, 0)
Typ = GetType(System.Int32)
OptimizeIL.Emit(OpCodes.Ldc_I4, CInt(0))
Typ = GetType(System.Int32)
...
Dim locbldr97 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(BooleanLiteral))
locbldr97.SetLocalSymInfo("boolit")
...
ReDim Preserve typ111(UBound(typ111) + 1)
typ111(UBound(typ111)) = Typ
OptimizeIL.Emit(OpCodes.Call, GetType(String).GetMethod("Compare", typ111))
Typ = GetType(String).GetMethod("Compare", typ111).ReturnType
OptimizeIL.Emit(OpCodes.Stloc, 0)
...
ReDim Preserve typ112(UBound(typ112) + 1)
typ112(UBound(typ112)) = Typ
OptimizeIL.Emit(OpCodes.Call, GetType(String).GetMethod("Compare", typ112))
Typ = GetType(String).GetMethod("Compare", typ112).ReturnType
OptimizeIL.Emit(OpCodes.Stloc, 0)
...
ReDim Preserve typ113(UBound(typ113) + 1)
typ113(UBound(typ113)) = Typ
OptimizeIL.Emit(OpCodes.Call, GetType(Utils.ParseUtils).GetMethod("LikeOP", typ113))
Typ = GetType(Utils.ParseUtils).GetMethod("LikeOP", typ113).ReturnType
OptimizeIL.Emit(OpCodes.Stloc, 1)
...
Dim locbldr98 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(CharLiteral))
locbldr98.SetLocalSymInfo("chrlit")
...
OptimizeIL.Emit(OpCodes.Call, GetType(System.Convert).GetMethod("ToChar", typ114))
Typ = GetType(System.Convert).GetMethod("ToChar", typ114).ReturnType
...
OptimizeIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("Trim", typ115))
Typ = Typ03.GetMethod("Trim", typ115).ReturnType
OptimizeIL.Emit(OpCodes.Stloc, 2)
...
ReDim Preserve typ117(UBound(typ117) + 1)
typ117(UBound(typ117)) = Typ
OptimizeIL.Emit(OpCodes.Call, GetType(String).GetMethod("Concat", typ117))
...
ReDim Preserve typ118(UBound(typ118) + 1)
typ118(UBound(typ118)) = Typ
OptimizeIL.Emit(OpCodes.Call, GetType(String).GetMethod("Concat", typ118))
Typ = GetType(String).GetMethod("Concat", typ118).ReturnType
OptimizeIL.Emit(OpCodes.Stloc, 2)
...
Dim locbldr99 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(StringLiteral))
locbldr99.SetLocalSymInfo("strlit")
...
OptimizeIL.Emit(OpCodes.Newarr, GetType(System.Char))
OptimizeIL.Emit(OpCodes.Stloc, 3)
OptimizeIL.MarkSequencePoint(doc3, 1022, 1, 1022, 100)
OptimizeIL.Emit(OpCodes.Ldloc, 3)
Typ = GetType(System.Char).MakeArrayType()
Typ02 = Typ
OptimizeIL.Emit(OpCodes.Ldc_I4, CInt(0))
...
OptimizeIL.Emit(OpCodes.Ldsfld, GetType(Utils.Constants).GetField("quot"))
Typ = GetType(Utils.Constants).GetField("quot").FieldType
Dim typ120 As Type() = {Typ}
OptimizeIL.Emit(OpCodes.Call, GetType(System.Convert).GetMethod("ToChar", typ120))
Typ = GetType(System.Convert).GetMethod("ToChar", typ120).ReturnType
OptimizeIL.Emit(OpCodes.Stelem, GetType(System.Char).MakeArrayType().GetElementType())
...
OptimizeIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("Trim", typ121))
Typ = Typ03.GetMethod("Trim", typ121).ReturnType
OptimizeIL.Emit(OpCodes.Stloc, 2)
...
OptimizeIL.Emit(OpCodes.Or)
OptimizeIL.Emit(OpCodes.Stloc, 4)
OptimizeIL.MarkSequencePoint(doc3, 1035, 1, 1035, 100)
OptimizeIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Token)
OptimizeIL.Emit(OpCodes.Ldfld, GetType(Token).GetField("Value"))
Typ = GetType(Token).GetField("Value").FieldType
OptimizeIL.Emit(OpCodes.Stloc, 2)
OptimizeIL.MarkSequencePoint(doc3, 1036, 1, 1036, 100)
...
Dim locbldr100 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(DoubleLiteral))
locbldr100.SetLocalSymInfo("dlit2")
...
Typ = GetType(Token).GetField("Value").FieldType
OptimizeIL.Emit(OpCodes.Stloc, 2)
OptimizeIL.MarkSequencePoint(doc3, 1043, 1, 1043, 100)
OptimizeIL.Emit(OpCodes.Ldc_I4, CInt(1))
Typ = GetType(System.Int32)
OptimizeIL.Emit(OpCodes.Conv_U)
OptimizeIL.Emit(OpCodes.Newarr, GetType(System.Char))
...
OptimizeIL.Emit(OpCodes.Call, GetType(System.Convert).GetMethod("ToDouble", typ128))
Typ = GetType(System.Convert).GetMethod("ToDouble", typ128).ReturnType
OptimizeIL.Emit(OpCodes.Stfld, GetType(DoubleLiteral).GetField("NumVal"))
OptimizeIL.MarkSequencePoint(doc3, 1048, 1, 1048, 100)
OptimizeIL.Emit(OpCodes.Ldloc, 100)
Typ = GetType(DoubleLiteral)
OptimizeIL.Emit(OpCodes.Starg, 1)
OptimizeIL.MarkSequencePoint(doc3, 1049, 1, 1049, 100)
OptimizeIL.Emit(OpCodes.Br, label0)
OptimizeIL.MarkSequencePoint(doc3, 1050, 1, 1050, 100)
...
OptimizeIL.Emit(OpCodes.Stloc, 1)
OptimizeIL.MarkSequencePoint(doc3, 1056, 1, 1056, 100)
OptimizeIL.Emit(OpCodes.Ldloc, 4)
Typ = GetType(System.Boolean)
OptimizeIL.Emit(OpCodes.Ldloc, 1)
Typ = GetType(System.Boolean)
OptimizeIL.Emit(OpCodes.Or)
OptimizeIL.Emit(OpCodes.Stloc, 4)
OptimizeIL.MarkSequencePoint(doc3, 1057, 1, 1057, 100)
...
Dim locbldr101 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(FloatLiteral))
locbldr101.SetLocalSymInfo("flit")
...
Typ = GetType(Token).GetField("Value").FieldType
OptimizeIL.Emit(OpCodes.Stloc, 2)
OptimizeIL.MarkSequencePoint(doc3, 1067, 1, 1067, 100)
OptimizeIL.Emit(OpCodes.Ldc_I4, CInt(1))
Typ = GetType(System.Int32)
OptimizeIL.Emit(OpCodes.Conv_U)
OptimizeIL.Emit(OpCodes.Newarr, GetType(System.Char))
...
OptimizeIL.Emit(OpCodes.Call, GetType(System.Convert).GetMethod("ToSingle", typ135))
Typ = GetType(System.Convert).GetMethod("ToSingle", typ135).ReturnType
...
OptimizeIL.Emit(OpCodes.Stloc, 1)
OptimizeIL.MarkSequencePoint(doc3, 1080, 1, 1080, 100)
OptimizeIL.Emit(OpCodes.Ldloc, 4)
Typ = GetType(System.Boolean)
OptimizeIL.Emit(OpCodes.Ldloc, 1)
Typ = GetType(System.Boolean)
...
Dim locbldr102 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(DoubleLiteral))
locbldr102.SetLocalSymInfo("dlit")
OptimizeIL.Emit(OpCodes.Newobj, GetType(DoubleLiteral).GetConstructor(Type.EmptyTypes))
...
OptimizeIL.Emit(OpCodes.Ldfld, GetType(DoubleLiteral).GetField("Value"))
Typ = GetType(DoubleLiteral).GetField("Value").FieldType
Dim typ139 As Type() = {Typ}
OptimizeIL.Emit(OpCodes.Call, GetType(System.Convert).GetMethod("ToDouble", typ139))
Typ = GetType(System.Convert).GetMethod("ToDouble", typ139).ReturnType
OptimizeIL.Emit(OpCodes.Stfld, GetType(DoubleLiteral).GetField("NumVal"))
...
ReDim Preserve typ140(UBound(typ140) + 1)
typ140(UBound(typ140)) = Typ
OptimizeIL.Emit(OpCodes.Call, GetType(Utils.ParseUtils).GetMethod("LikeOP", typ140))
Typ = GetType(Utils.ParseUtils).GetMethod("LikeOP", typ140).ReturnType
OptimizeIL.Emit(OpCodes.Stloc, 1)
...
ReDim Preserve typ141(UBound(typ141) + 1)
typ141(UBound(typ141)) = Typ
OptimizeIL.Emit(OpCodes.Call, GetType(Utils.ParseUtils).GetMethod("LikeOP", typ141))
Typ = GetType(Utils.ParseUtils).GetMethod("LikeOP", typ141).ReturnType
OptimizeIL.Emit(OpCodes.Stloc, 1)
...
ReDim Preserve typ142(UBound(typ142) + 1)
typ142(UBound(typ142)) = Typ
OptimizeIL.Emit(OpCodes.Call, GetType(Utils.ParseUtils).GetMethod("LikeOP", typ142))
Typ = GetType(Utils.ParseUtils).GetMethod("LikeOP", typ142).ReturnType
OptimizeIL.Emit(OpCodes.Stloc, 1)
OptimizeIL.MarkSequencePoint(doc3, 1103, 1, 1103, 100)
OptimizeIL.Emit(OpCodes.Ldloc, 4)
Typ = GetType(System.Boolean)
OptimizeIL.Emit(OpCodes.Ldloc, 1)
Typ = GetType(System.Boolean)
...
OptimizeIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("EndsWith", typ143))
Typ = Typ03.GetMethod("EndsWith", typ143).ReturnType
OptimizeIL.Emit(OpCodes.Stloc, 1)
...
Dim locbldr103 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(DoubleLiteral))
locbldr103.SetLocalSymInfo("dlit3")
OptimizeIL.Emit(OpCodes.Newobj, GetType(DoubleLiteral).GetConstructor(Type.EmptyTypes))
...
OptimizeIL.Emit(OpCodes.Newarr, GetType(System.Char))
OptimizeIL.Emit(OpCodes.Stloc, 3)
OptimizeIL.MarkSequencePoint(doc3, 1113, 1, 1113, 100)
OptimizeIL.Emit(OpCodes.Ldloc, 3)
Typ = GetType(System.Char).MakeArrayType()
Typ02 = Typ
OptimizeIL.Emit(OpCodes.Ldc_I4, CInt(0))
...
OptimizeIL.Emit(OpCodes.Call, GetType(System.Convert).GetMethod("ToChar", typ144))
Typ = GetType(System.Convert).GetMethod("ToChar", typ144).ReturnType
OptimizeIL.Emit(OpCodes.Stelem, GetType(System.Char).MakeArrayType().GetElementType())
...
OptimizeIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("TrimEnd", typ145))
Typ = Typ03.GetMethod("TrimEnd", typ145).ReturnType
OptimizeIL.Emit(OpCodes.Stloc, 2)
...
OptimizeIL.Emit(OpCodes.Call, GetType(System.Convert).GetMethod("ToDouble", typ146))
Typ = GetType(System.Convert).GetMethod("ToDouble", typ146).ReturnType
OptimizeIL.Emit(OpCodes.Stfld, GetType(DoubleLiteral).GetField("NumVal"))
...
ReDim Preserve typ149(UBound(typ149) + 1)
typ149(UBound(typ149)) = Typ
OptimizeIL.Emit(OpCodes.Call, GetType(Utils.ParseUtils).GetMethod("LikeOP", typ149))
Typ = GetType(Utils.ParseUtils).GetMethod("LikeOP", typ149).ReturnType
OptimizeIL.Emit(OpCodes.Stloc, 1)
...
Typ = GetType(Token).GetField("Value").FieldType
OptimizeIL.Emit(OpCodes.Stloc, 2)
OptimizeIL.MarkSequencePoint(doc3, 1128, 1, 1128, 100)
...
OptimizeIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("EndsWith", typ150))
Typ = Typ03.GetMethod("EndsWith", typ150).ReturnType
OptimizeIL.Emit(OpCodes.Stloc, 1)
...
Dim locbldr104 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(FloatLiteral))
locbldr104.SetLocalSymInfo("flit2")
OptimizeIL.Emit(OpCodes.Newobj, GetType(FloatLiteral).GetConstructor(Type.EmptyTypes))
...
OptimizeIL.Emit(OpCodes.Ldstr, "f")
Typ = GetType(System.String)
Dim typ151 As Type() = {Typ}
OptimizeIL.Emit(OpCodes.Call, GetType(System.Convert).GetMethod("ToChar", typ151))
Typ = GetType(System.Convert).GetMethod("ToChar", typ151).ReturnType
OptimizeIL.Emit(OpCodes.Stelem, GetType(System.Char).MakeArrayType().GetElementType())
...
OptimizeIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("TrimEnd", typ152))
Typ = Typ03.GetMethod("TrimEnd", typ152).ReturnType
OptimizeIL.Emit(OpCodes.Stloc, 2)
OptimizeIL.MarkSequencePoint(doc3, 1138, 1, 1138, 100)
OptimizeIL.Emit(OpCodes.Ldloc, 104)
Typ = GetType(FloatLiteral)
OptimizeIL.Emit(OpCodes.Ldloc, 2)
Typ = GetType(System.String)
...
OptimizeIL.Emit(OpCodes.Call, GetType(System.Convert).GetMethod("ToSingle", typ153))
Typ = GetType(System.Convert).GetMethod("ToSingle", typ153).ReturnType
OptimizeIL.Emit(OpCodes.Stfld, GetType(FloatLiteral).GetField("NumVal"))
...
ReDim Preserve typ156(UBound(typ156) + 1)
typ156(UBound(typ156)) = Typ
OptimizeIL.Emit(OpCodes.Call, GetType(Utils.ParseUtils).GetMethod("LikeOP", typ156))
Typ = GetType(Utils.ParseUtils).GetMethod("LikeOP", typ156).ReturnType
OptimizeIL.Emit(OpCodes.Stloc, 1)
...
OptimizeIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("EndsWith", typ157))
Typ = Typ03.GetMethod("EndsWith", typ157).ReturnType
OptimizeIL.Emit(OpCodes.Stloc, 1)
...
OptimizeIL.Emit(OpCodes.And)
OptimizeIL.Emit(OpCodes.Stloc, 4)
OptimizeIL.MarkSequencePoint(doc3, 1154, 1, 1154, 100)
OptimizeIL.Emit(OpCodes.Ldloc, 4)
Typ = GetType(System.Boolean)
OptimizeIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
...
Dim locbldr105 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(UIntLiteral))
locbldr105.SetLocalSymInfo("uilit2")
...
Typ = GetType(System.String)
Dim typ158 As Type() = {Typ}
OptimizeIL.Emit(OpCodes.Call, GetType(System.Convert).GetMethod("ToChar", typ158))
Typ = GetType(System.Convert).GetMethod("ToChar", typ158).ReturnType
OptimizeIL.Emit(OpCodes.Stelem, GetType(System.Char).MakeArrayType().GetElementType())
...
OptimizeIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("TrimEnd", typ159))
Typ = Typ03.GetMethod("TrimEnd", typ159).ReturnType
OptimizeIL.Emit(OpCodes.Stloc, 2)
...
Typ = GetType(System.String)
Dim typ160 As Type() = {Typ}
OptimizeIL.Emit(OpCodes.Call, GetType(System.Convert).GetMethod("ToChar", typ160))
Typ = GetType(System.Convert).GetMethod("ToChar", typ160).ReturnType
OptimizeIL.Emit(OpCodes.Stelem, GetType(System.Char).MakeArrayType().GetElementType())
...
OptimizeIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("TrimEnd", typ161))
Typ = Typ03.GetMethod("TrimEnd", typ161).ReturnType
OptimizeIL.Emit(OpCodes.Stloc, 2)
...
OptimizeIL.MarkSequencePoint(doc3, 1164, 1, 1164, 100)
OptimizeIL.Emit(OpCodes.Ldloc, 105)
Typ = GetType(UIntLiteral)
...
OptimizeIL.Emit(OpCodes.Call, GetType(Convert).GetMethod("ToUInt32", typ162))
Typ = GetType(Convert).GetMethod("ToUInt32", typ162).ReturnType
...
ReDim Preserve typ163(UBound(typ163) + 1)
typ163(UBound(typ163)) = Typ
OptimizeIL.Emit(OpCodes.Call, GetType(Utils.ParseUtils).GetMethod("LikeOP", typ163))
Typ = GetType(Utils.ParseUtils).GetMethod("LikeOP", typ163).ReturnType
OptimizeIL.Emit(OpCodes.Stloc, 1)
...
ReDim Preserve typ164(UBound(typ164) + 1)
typ164(UBound(typ164)) = Typ
OptimizeIL.Emit(OpCodes.Call, GetType(Utils.ParseUtils).GetMethod("LikeOP", typ164))
Typ = GetType(Utils.ParseUtils).GetMethod("LikeOP", typ164).ReturnType
OptimizeIL.Emit(OpCodes.Stloc, 1)
...
ReDim Preserve typ165(UBound(typ165) + 1)
typ165(UBound(typ165)) = Typ
OptimizeIL.Emit(OpCodes.Call, GetType(Utils.ParseUtils).GetMethod("LikeOP", typ165))
Typ = GetType(Utils.ParseUtils).GetMethod("LikeOP", typ165).ReturnType
OptimizeIL.Emit(OpCodes.Stloc, 1)
...
OptimizeIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("EndsWith", typ166))
Typ = Typ03.GetMethod("EndsWith", typ166).ReturnType
OptimizeIL.Emit(OpCodes.Stloc, 1)
OptimizeIL.MarkSequencePoint(doc3, 1177, 1, 1177, 100)
OptimizeIL.Emit(OpCodes.Ldloc, 4)
Typ = GetType(System.Boolean)
OptimizeIL.Emit(OpCodes.Ldloc, 1)
Typ = GetType(System.Boolean)
...
Dim locbldr106 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(IntPtrLiteral))
locbldr106.SetLocalSymInfo("iplit2")
...
Typ = GetType(System.String)
Dim typ167 As Type() = {Typ}
OptimizeIL.Emit(OpCodes.Call, GetType(System.Convert).GetMethod("ToChar", typ167))
Typ = GetType(System.Convert).GetMethod("ToChar", typ167).ReturnType
OptimizeIL.Emit(OpCodes.Stelem, GetType(System.Char).MakeArrayType().GetElementType())
...
OptimizeIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("TrimEnd", typ168))
Typ = Typ03.GetMethod("TrimEnd", typ168).ReturnType
OptimizeIL.Emit(OpCodes.Stloc, 2)
...
OptimizeIL.Emit(OpCodes.Ldstr, "i")
Typ = GetType(System.String)
Dim typ169 As Type() = {Typ}
OptimizeIL.Emit(OpCodes.Call, GetType(System.Convert).GetMethod("ToChar", typ169))
Typ = GetType(System.Convert).GetMethod("ToChar", typ169).ReturnType
OptimizeIL.Emit(OpCodes.Stelem, GetType(System.Char).MakeArrayType().GetElementType())
...
OptimizeIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("TrimEnd", typ170))
Typ = Typ03.GetMethod("TrimEnd", typ170).ReturnType
OptimizeIL.Emit(OpCodes.Stloc, 2)
OptimizeIL.MarkSequencePoint(doc3, 1188, 1, 1188, 100)
OptimizeIL.Emit(OpCodes.Ldloc, 106)
Typ = GetType(IntPtrLiteral)
OptimizeIL.Emit(OpCodes.Ldloc, 2)
Typ = GetType(System.String)
...
Dim typ172 As Type() = {Typ}
OptimizeIL.Emit(OpCodes.Call, GetType(System.Convert).GetMethod("ToInt32", typ172))
Typ = GetType(System.Convert).GetMethod("ToInt32", typ172).ReturnType
ReDim Preserve typ171(UBound(typ171) + 1)
typ171(UBound(typ171)) = Typ
OptimizeIL.Emit(OpCodes.Newobj, GetType(IntPtr).GetConstructor(typ171))
...
ReDim Preserve typ173(UBound(typ173) + 1)
typ173(UBound(typ173)) = Typ
OptimizeIL.Emit(OpCodes.Call, GetType(Utils.ParseUtils).GetMethod("LikeOP", typ173))
Typ = GetType(Utils.ParseUtils).GetMethod("LikeOP", typ173).ReturnType
OptimizeIL.Emit(OpCodes.Stloc, 1)
...
ReDim Preserve typ174(UBound(typ174) + 1)
typ174(UBound(typ174)) = Typ
OptimizeIL.Emit(OpCodes.Call, GetType(Utils.ParseUtils).GetMethod("LikeOP", typ174))
Typ = GetType(Utils.ParseUtils).GetMethod("LikeOP", typ174).ReturnType
OptimizeIL.Emit(OpCodes.Stloc, 1)
...
ReDim Preserve typ175(UBound(typ175) + 1)
typ175(UBound(typ175)) = Typ
OptimizeIL.Emit(OpCodes.Call, GetType(Utils.ParseUtils).GetMethod("LikeOP", typ175))
Typ = GetType(Utils.ParseUtils).GetMethod("LikeOP", typ175).ReturnType
OptimizeIL.Emit(OpCodes.Stloc, 1)
...
OptimizeIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("EndsWith", typ176))
Typ = Typ03.GetMethod("EndsWith", typ176).ReturnType
OptimizeIL.Emit(OpCodes.Stloc, 1)
OptimizeIL.MarkSequencePoint(doc3, 1203, 1, 1203, 100)
OptimizeIL.Emit(OpCodes.Ldloc, 4)
Typ = GetType(System.Boolean)
OptimizeIL.Emit(OpCodes.Ldloc, 1)
Typ = GetType(System.Boolean)
...
Dim locbldr107 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(IntLiteral))
locbldr107.SetLocalSymInfo("ilit2")
...
OptimizeIL.Emit(OpCodes.Ldstr, "i")
Typ = GetType(System.String)
Dim typ177 As Type() = {Typ}
OptimizeIL.Emit(OpCodes.Call, GetType(System.Convert).GetMethod("ToChar", typ177))
Typ = GetType(System.Convert).GetMethod("ToChar", typ177).ReturnType
OptimizeIL.Emit(OpCodes.Stelem, GetType(System.Char).MakeArrayType().GetElementType())
...
OptimizeIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("TrimEnd", typ178))
Typ = Typ03.GetMethod("TrimEnd", typ178).ReturnType
OptimizeIL.Emit(OpCodes.Stloc, 2)
...
Dim typ179 As Type() = {Typ}
OptimizeIL.Emit(OpCodes.Call, GetType(System.Convert).GetMethod("ToInt32", typ179))
Typ = GetType(System.Convert).GetMethod("ToInt32", typ179).ReturnType
OptimizeIL.Emit(OpCodes.Stfld, GetType(IntLiteral).GetField("NumVal"))
OptimizeIL.MarkSequencePoint(doc3, 1214, 1, 1214, 100)
OptimizeIL.Emit(OpCodes.Ldloc, 107)
Typ = GetType(IntLiteral)
OptimizeIL.Emit(OpCodes.Starg, 1)
...
ReDim Preserve typ180(UBound(typ180) + 1)
typ180(UBound(typ180)) = Typ
OptimizeIL.Emit(OpCodes.Call, GetType(Utils.ParseUtils).GetMethod("LikeOP", typ180))
Typ = GetType(Utils.ParseUtils).GetMethod("LikeOP", typ180).ReturnType
OptimizeIL.Emit(OpCodes.Stloc, 1)
...
ReDim Preserve typ181(UBound(typ181) + 1)
typ181(UBound(typ181)) = Typ
OptimizeIL.Emit(OpCodes.Call, GetType(Utils.ParseUtils).GetMethod("LikeOP", typ181))
Typ = GetType(Utils.ParseUtils).GetMethod("LikeOP", typ181).ReturnType
OptimizeIL.Emit(OpCodes.Stloc, 1)
...
ReDim Preserve typ182(UBound(typ182) + 1)
typ182(UBound(typ182)) = Typ
OptimizeIL.Emit(OpCodes.Call, GetType(Utils.ParseUtils).GetMethod("LikeOP", typ182))
Typ = GetType(Utils.ParseUtils).GetMethod("LikeOP", typ182).ReturnType
OptimizeIL.Emit(OpCodes.Stloc, 1)
...
OptimizeIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("EndsWith", typ183))
Typ = Typ03.GetMethod("EndsWith", typ183).ReturnType
OptimizeIL.Emit(OpCodes.Stloc, 1)
OptimizeIL.MarkSequencePoint(doc3, 1227, 1, 1227, 100)
OptimizeIL.Emit(OpCodes.Ldloc, 4)
Typ = GetType(System.Boolean)
OptimizeIL.Emit(OpCodes.Ldloc, 1)
Typ = GetType(System.Boolean)
...
Dim locbldr108 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(ULongLiteral))
locbldr108.SetLocalSymInfo("ullit")
...
Typ = GetType(System.String)
Dim typ184 As Type() = {Typ}
OptimizeIL.Emit(OpCodes.Call, GetType(System.Convert).GetMethod("ToChar", typ184))
Typ = GetType(System.Convert).GetMethod("ToChar", typ184).ReturnType
OptimizeIL.Emit(OpCodes.Stelem, GetType(System.Char).MakeArrayType().GetElementType())
...
OptimizeIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("TrimEnd", typ185))
Typ = Typ03.GetMethod("TrimEnd", typ185).ReturnType
OptimizeIL.Emit(OpCodes.Stloc, 2)
...
OptimizeIL.Emit(OpCodes.Ldstr, "u")
Typ = GetType(System.String)
Dim typ186 As Type() = {Typ}
OptimizeIL.Emit(OpCodes.Call, GetType(System.Convert).GetMethod("ToChar", typ186))
Typ = GetType(System.Convert).GetMethod("ToChar", typ186).ReturnType
OptimizeIL.Emit(OpCodes.Stelem, GetType(System.Char).MakeArrayType().GetElementType())
OptimizeIL.MarkSequencePoint(doc3, 1237, 1, 1237, 100)
...
OptimizeIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("TrimEnd", typ187))
Typ = Typ03.GetMethod("TrimEnd", typ187).ReturnType
OptimizeIL.Emit(OpCodes.Stloc, 2)
...
OptimizeIL.Emit(OpCodes.Call, GetType(Convert).GetMethod("ToUInt64", typ188))
Typ = GetType(Convert).GetMethod("ToUInt64", typ188).ReturnType
...
ReDim Preserve typ189(UBound(typ189) + 1)
typ189(UBound(typ189)) = Typ
OptimizeIL.Emit(OpCodes.Call, GetType(Utils.ParseUtils).GetMethod("LikeOP", typ189))
Typ = GetType(Utils.ParseUtils).GetMethod("LikeOP", typ189).ReturnType
OptimizeIL.Emit(OpCodes.Stloc, 1)
...
ReDim Preserve typ190(UBound(typ190) + 1)
typ190(UBound(typ190)) = Typ
OptimizeIL.Emit(OpCodes.Call, GetType(Utils.ParseUtils).GetMethod("LikeOP", typ190))
Typ = GetType(Utils.ParseUtils).GetMethod("LikeOP", typ190).ReturnType
OptimizeIL.Emit(OpCodes.Stloc, 1)
...
ReDim Preserve typ191(UBound(typ191) + 1)
typ191(UBound(typ191)) = Typ
OptimizeIL.Emit(OpCodes.Call, GetType(Utils.ParseUtils).GetMethod("LikeOP", typ191))
Typ = GetType(Utils.ParseUtils).GetMethod("LikeOP", typ191).ReturnType
OptimizeIL.Emit(OpCodes.Stloc, 1)
...
Typ = GetType(Token).GetField("Value").FieldType
OptimizeIL.Emit(OpCodes.Stloc, 2)
OptimizeIL.MarkSequencePoint(doc3, 1252, 1, 1252, 100)
...
OptimizeIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("EndsWith", typ192))
Typ = Typ03.GetMethod("EndsWith", typ192).ReturnType
OptimizeIL.Emit(OpCodes.Stloc, 1)
...
Dim locbldr109 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(LongLiteral))
locbldr109.SetLocalSymInfo("llit")
...
OptimizeIL.Emit(OpCodes.Ldstr, "l")
Typ = GetType(System.String)
Dim typ193 As Type() = {Typ}
OptimizeIL.Emit(OpCodes.Call, GetType(System.Convert).GetMethod("ToChar", typ193))
Typ = GetType(System.Convert).GetMethod("ToChar", typ193).ReturnType
OptimizeIL.Emit(OpCodes.Stelem, GetType(System.Char).MakeArrayType().GetElementType())
...
OptimizeIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("TrimEnd", typ194))
Typ = Typ03.GetMethod("TrimEnd", typ194).ReturnType
OptimizeIL.Emit(OpCodes.Stloc, 2)
OptimizeIL.MarkSequencePoint(doc3, 1262, 1, 1262, 100)
OptimizeIL.Emit(OpCodes.Ldloc, 109)
Typ = GetType(LongLiteral)
OptimizeIL.Emit(OpCodes.Ldloc, 2)
Typ = GetType(System.String)
...
Dim typ195 As Type() = {Typ}
OptimizeIL.Emit(OpCodes.Call, GetType(System.Convert).GetMethod("ToInt64", typ195))
Typ = GetType(System.Convert).GetMethod("ToInt64", typ195).ReturnType
...
ReDim Preserve typ196(UBound(typ196) + 1)
typ196(UBound(typ196)) = Typ
OptimizeIL.Emit(OpCodes.Call, GetType(Utils.ParseUtils).GetMethod("LikeOP", typ196))
Typ = GetType(Utils.ParseUtils).GetMethod("LikeOP", typ196).ReturnType
OptimizeIL.Emit(OpCodes.Stloc, 1)
...
ReDim Preserve typ197(UBound(typ197) + 1)
typ197(UBound(typ197)) = Typ
OptimizeIL.Emit(OpCodes.Call, GetType(Utils.ParseUtils).GetMethod("LikeOP", typ197))
Typ = GetType(Utils.ParseUtils).GetMethod("LikeOP", typ197).ReturnType
OptimizeIL.Emit(OpCodes.Stloc, 1)
...
ReDim Preserve typ198(UBound(typ198) + 1)
typ198(UBound(typ198)) = Typ
OptimizeIL.Emit(OpCodes.Call, GetType(Utils.ParseUtils).GetMethod("LikeOP", typ198))
Typ = GetType(Utils.ParseUtils).GetMethod("LikeOP", typ198).ReturnType
OptimizeIL.Emit(OpCodes.Stloc, 1)
...
Typ = GetType(Token).GetField("Value").FieldType
OptimizeIL.Emit(OpCodes.Stloc, 2)
OptimizeIL.MarkSequencePoint(doc3, 1275, 1, 1275, 100)
...
OptimizeIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("EndsWith", typ199))
Typ = Typ03.GetMethod("EndsWith", typ199).ReturnType
OptimizeIL.Emit(OpCodes.Stloc, 1)
...
Dim locbldr110 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(UShortLiteral))
locbldr110.SetLocalSymInfo("uslit")
...
Typ = GetType(System.String)
Dim typ200 As Type() = {Typ}
OptimizeIL.Emit(OpCodes.Call, GetType(System.Convert).GetMethod("ToChar", typ200))
Typ = GetType(System.Convert).GetMethod("ToChar", typ200).ReturnType
OptimizeIL.Emit(OpCodes.Stelem, GetType(System.Char).MakeArrayType().GetElementType())
...
OptimizeIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("TrimEnd", typ201))
Typ = Typ03.GetMethod("TrimEnd", typ201).ReturnType
OptimizeIL.Emit(OpCodes.Stloc, 2)
OptimizeIL.MarkSequencePoint(doc3, 1285, 1, 1285, 100)
OptimizeIL.Emit(OpCodes.Ldloc, 3)
Typ = GetType(System.Char).MakeArrayType()
Typ02 = Typ
OptimizeIL.Emit(OpCodes.Ldc_I4, CInt(0))
...
OptimizeIL.Emit(OpCodes.Call, GetType(System.Convert).GetMethod("ToChar", typ202))
Typ = GetType(System.Convert).GetMethod("ToChar", typ202).ReturnType
OptimizeIL.Emit(OpCodes.Stelem, GetType(System.Char).MakeArrayType().GetElementType())
...
OptimizeIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("TrimEnd", typ203))
Typ = Typ03.GetMethod("TrimEnd", typ203).ReturnType
OptimizeIL.Emit(OpCodes.Stloc, 2)
...
OptimizeIL.Emit(OpCodes.Call, GetType(Convert).GetMethod("ToUInt16", typ204))
Typ = GetType(Convert).GetMethod("ToUInt16", typ204).ReturnType
...
ReDim Preserve typ205(UBound(typ205) + 1)
typ205(UBound(typ205)) = Typ
OptimizeIL.Emit(OpCodes.Call, GetType(Utils.ParseUtils).GetMethod("LikeOP", typ205))
Typ = GetType(Utils.ParseUtils).GetMethod("LikeOP", typ205).ReturnType
OptimizeIL.Emit(OpCodes.Stloc, 1)
...
ReDim Preserve typ206(UBound(typ206) + 1)
typ206(UBound(typ206)) = Typ
OptimizeIL.Emit(OpCodes.Call, GetType(Utils.ParseUtils).GetMethod("LikeOP", typ206))
Typ = GetType(Utils.ParseUtils).GetMethod("LikeOP", typ206).ReturnType
OptimizeIL.Emit(OpCodes.Stloc, 1)
...
ReDim Preserve typ207(UBound(typ207) + 1)
typ207(UBound(typ207)) = Typ
OptimizeIL.Emit(OpCodes.Call, GetType(Utils.ParseUtils).GetMethod("LikeOP", typ207))
Typ = GetType(Utils.ParseUtils).GetMethod("LikeOP", typ207).ReturnType
OptimizeIL.Emit(OpCodes.Stloc, 1)
...
Typ = GetType(Token).GetField("Value").FieldType
OptimizeIL.Emit(OpCodes.Stloc, 2)
OptimizeIL.MarkSequencePoint(doc3, 1300, 1, 1300, 100)
...
OptimizeIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("EndsWith", typ208))
Typ = Typ03.GetMethod("EndsWith", typ208).ReturnType
OptimizeIL.Emit(OpCodes.Stloc, 1)
...
Dim locbldr111 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(ShortLiteral))
locbldr111.SetLocalSymInfo("slit")
...
OptimizeIL.Emit(OpCodes.Ldstr, "s")
Typ = GetType(System.String)
Dim typ209 As Type() = {Typ}
OptimizeIL.Emit(OpCodes.Call, GetType(System.Convert).GetMethod("ToChar", typ209))
Typ = GetType(System.Convert).GetMethod("ToChar", typ209).ReturnType
OptimizeIL.Emit(OpCodes.Stelem, GetType(System.Char).MakeArrayType().GetElementType())
...
OptimizeIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("TrimEnd", typ210))
Typ = Typ03.GetMethod("TrimEnd", typ210).ReturnType
OptimizeIL.Emit(OpCodes.Stloc, 2)
OptimizeIL.MarkSequencePoint(doc3, 1310, 1, 1310, 100)
OptimizeIL.Emit(OpCodes.Ldloc, 111)
Typ = GetType(ShortLiteral)
OptimizeIL.Emit(OpCodes.Ldloc, 2)
Typ = GetType(System.String)
...
Dim typ211 As Type() = {Typ}
OptimizeIL.Emit(OpCodes.Call, GetType(System.Convert).GetMethod("ToInt16", typ211))
Typ = GetType(System.Convert).GetMethod("ToInt16", typ211).ReturnType
...
ReDim Preserve typ212(UBound(typ212) + 1)
typ212(UBound(typ212)) = Typ
OptimizeIL.Emit(OpCodes.Call, GetType(Utils.ParseUtils).GetMethod("LikeOP", typ212))
Typ = GetType(Utils.ParseUtils).GetMethod("LikeOP", typ212).ReturnType
OptimizeIL.Emit(OpCodes.Stloc, 1)
...
ReDim Preserve typ213(UBound(typ213) + 1)
typ213(UBound(typ213)) = Typ
OptimizeIL.Emit(OpCodes.Call, GetType(Utils.ParseUtils).GetMethod("LikeOP", typ213))
Typ = GetType(Utils.ParseUtils).GetMethod("LikeOP", typ213).ReturnType
OptimizeIL.Emit(OpCodes.Stloc, 1)
...
ReDim Preserve typ214(UBound(typ214) + 1)
typ214(UBound(typ214)) = Typ
OptimizeIL.Emit(OpCodes.Call, GetType(Utils.ParseUtils).GetMethod("LikeOP", typ214))
Typ = GetType(Utils.ParseUtils).GetMethod("LikeOP", typ214).ReturnType
OptimizeIL.Emit(OpCodes.Stloc, 1)
...
Typ = GetType(Token).GetField("Value").FieldType
OptimizeIL.Emit(OpCodes.Stloc, 2)
OptimizeIL.MarkSequencePoint(doc3, 1323, 1, 1323, 100)
...
OptimizeIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("EndsWith", typ215))
Typ = Typ03.GetMethod("EndsWith", typ215).ReturnType
OptimizeIL.Emit(OpCodes.Stloc, 1)
...
Dim locbldr112 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(ByteLiteral))
locbldr112.SetLocalSymInfo("ublit")
OptimizeIL.Emit(OpCodes.Newobj, GetType(ByteLiteral).GetConstructor(Type.EmptyTypes))
OptimizeIL.Emit(OpCodes.Stloc, 112)
OptimizeIL.MarkSequencePoint(doc3, 1328, 1, 1328, 100)
OptimizeIL.Emit(OpCodes.Ldloc, 112)
...
Typ = GetType(Token).GetField("Value").FieldType
OptimizeIL.Emit(OpCodes.Stloc, 2)
OptimizeIL.MarkSequencePoint(doc3, 1330, 1, 1330, 100)
OptimizeIL.Emit(OpCodes.Ldc_I4, CInt(1))
Typ = GetType(System.Int32)
OptimizeIL.Emit(OpCodes.Conv_U)
OptimizeIL.Emit(OpCodes.Newarr, GetType(System.Char))
OptimizeIL.Emit(OpCodes.Stloc, 3)
OptimizeIL.MarkSequencePoint(doc3, 1331, 1, 1331, 100)
OptimizeIL.Emit(OpCodes.Ldloc, 3)
Typ = GetType(System.Char).MakeArrayType()
Typ02 = Typ
OptimizeIL.Emit(OpCodes.Ldc_I4, CInt(0))
...
OptimizeIL.Emit(OpCodes.Call, GetType(System.Convert).GetMethod("ToChar", typ216))
Typ = GetType(System.Convert).GetMethod("ToChar", typ216).ReturnType
OptimizeIL.Emit(OpCodes.Stelem, GetType(System.Char).MakeArrayType().GetElementType())
...
OptimizeIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("TrimEnd", typ217))
Typ = Typ03.GetMethod("TrimEnd", typ217).ReturnType
OptimizeIL.Emit(OpCodes.Stloc, 2)
...
OptimizeIL.Emit(OpCodes.Ldstr, "u")
Typ = GetType(System.String)
Dim typ218 As Type() = {Typ}
OptimizeIL.Emit(OpCodes.Call, GetType(System.Convert).GetMethod("ToChar", typ218))
Typ = GetType(System.Convert).GetMethod("ToChar", typ218).ReturnType
OptimizeIL.Emit(OpCodes.Stelem, GetType(System.Char).MakeArrayType().GetElementType())
...
OptimizeIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("TrimEnd", typ219))
Typ = Typ03.GetMethod("TrimEnd", typ219).ReturnType
OptimizeIL.Emit(OpCodes.Stloc, 2)
...
OptimizeIL.MarkSequencePoint(doc3, 1336, 1, 1336, 100)
OptimizeIL.Emit(OpCodes.Ldloc, 112)
Typ = GetType(ByteLiteral)
...
OptimizeIL.Emit(OpCodes.Call, GetType(Convert).GetMethod("ToByte", typ220))
Typ = GetType(Convert).GetMethod("ToByte", typ220).ReturnType
OptimizeIL.Emit(OpCodes.Stfld, GetType(ByteLiteral).GetField("NumVal"))
OptimizeIL.MarkSequencePoint(doc3, 1337, 1, 1337, 100)
OptimizeIL.Emit(OpCodes.Ldloc, 112)
Typ = GetType(ByteLiteral)
OptimizeIL.Emit(OpCodes.Starg, 1)
OptimizeIL.MarkSequencePoint(doc3, 1338, 1, 1338, 100)
OptimizeIL.Emit(OpCodes.Br, label0)
...
ReDim Preserve typ221(UBound(typ221) + 1)
typ221(UBound(typ221)) = Typ
OptimizeIL.Emit(OpCodes.Call, GetType(Utils.ParseUtils).GetMethod("LikeOP", typ221))
Typ = GetType(Utils.ParseUtils).GetMethod("LikeOP", typ221).ReturnType
OptimizeIL.Emit(OpCodes.Stloc, 1)
...
ReDim Preserve typ222(UBound(typ222) + 1)
typ222(UBound(typ222)) = Typ
OptimizeIL.Emit(OpCodes.Call, GetType(Utils.ParseUtils).GetMethod("LikeOP", typ222))
Typ = GetType(Utils.ParseUtils).GetMethod("LikeOP", typ222).ReturnType
OptimizeIL.Emit(OpCodes.Stloc, 1)
OptimizeIL.MarkSequencePoint(doc3, 1344, 1, 1344, 100)
OptimizeIL.Emit(OpCodes.Ldloc, 4)
Typ = GetType(System.Boolean)
OptimizeIL.Emit(OpCodes.Ldloc, 1)
Typ = GetType(System.Boolean)
OptimizeIL.Emit(OpCodes.Or)
OptimizeIL.Emit(OpCodes.Stloc, 4)
OptimizeIL.MarkSequencePoint(doc3, 1345, 1, 1345, 100)
...
ReDim Preserve typ223(UBound(typ223) + 1)
typ223(UBound(typ223)) = Typ
OptimizeIL.Emit(OpCodes.Call, GetType(Utils.ParseUtils).GetMethod("LikeOP", typ223))
Typ = GetType(Utils.ParseUtils).GetMethod("LikeOP", typ223).ReturnType
OptimizeIL.Emit(OpCodes.Stloc, 1)
...
OptimizeIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("EndsWith", typ224))
Typ = Typ03.GetMethod("EndsWith", typ224).ReturnType
OptimizeIL.Emit(OpCodes.Stloc, 1)
...
OptimizeIL.MarkSequencePoint(doc3, 1352, 1, 1352, 100)
Dim locbldr113 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(SByteLiteral))
locbldr113.SetLocalSymInfo("blit")
OptimizeIL.Emit(OpCodes.Newobj, GetType(SByteLiteral).GetConstructor(Type.EmptyTypes))
OptimizeIL.Emit(OpCodes.Stloc, 113)
OptimizeIL.MarkSequencePoint(doc3, 1353, 1, 1353, 100)
OptimizeIL.Emit(OpCodes.Ldloc, 113)
...
OptimizeIL.Emit(OpCodes.Ldstr, "b")
Typ = GetType(System.String)
Dim typ225 As Type() = {Typ}
OptimizeIL.Emit(OpCodes.Call, GetType(System.Convert).GetMethod("ToChar", typ225))
Typ = GetType(System.Convert).GetMethod("ToChar", typ225).ReturnType
OptimizeIL.Emit(OpCodes.Stelem, GetType(System.Char).MakeArrayType().GetElementType())
...
OptimizeIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("TrimEnd", typ226))
Typ = Typ03.GetMethod("TrimEnd", typ226).ReturnType
OptimizeIL.Emit(OpCodes.Stloc, 2)
...
OptimizeIL.Emit(OpCodes.Call, GetType(System.Convert).GetMethod("ToSByte", typ227))
Typ = GetType(System.Convert).GetMethod("ToSByte", typ227).ReturnType
OptimizeIL.Emit(OpCodes.Stfld, GetType(SByteLiteral).GetField("NumVal"))
OptimizeIL.MarkSequencePoint(doc3, 1360, 1, 1360, 100)
OptimizeIL.Emit(OpCodes.Ldloc, 113)
Typ = GetType(SByteLiteral)
OptimizeIL.Emit(OpCodes.Starg, 1)
OptimizeIL.MarkSequencePoint(doc3, 1361, 1, 1361, 100)
OptimizeIL.Emit(OpCodes.Br, label0)
...
OptimizeIL.MarkSequencePoint(doc3, 1364, 1, 1364, 100)
...
Typ = GetType(System.Boolean)
OptimizeIL.Emit(OpCodes.Stloc, 4)
OptimizeIL.MarkSequencePoint(doc3, 1366, 1, 1366, 100)
...
OptimizeIL.Emit(OpCodes.Stloc, 1)
OptimizeIL.MarkSequencePoint(doc3, 1367, 1, 1367, 100)
OptimizeIL.Emit(OpCodes.Ldloc, 4)
Typ = GetType(System.Boolean)
OptimizeIL.Emit(OpCodes.Ldloc, 1)
Typ = GetType(System.Boolean)
OptimizeIL.Emit(OpCodes.Or)
OptimizeIL.Emit(OpCodes.Stloc, 4)
OptimizeIL.MarkSequencePoint(doc3, 1368, 1, 1368, 100)
...
OptimizeIL.Emit(OpCodes.Stloc, 1)
OptimizeIL.MarkSequencePoint(doc3, 1369, 1, 1369, 100)
OptimizeIL.Emit(OpCodes.Ldloc, 4)
Typ = GetType(System.Boolean)
OptimizeIL.Emit(OpCodes.Ldloc, 1)
Typ = GetType(System.Boolean)
OptimizeIL.Emit(OpCodes.Or)
OptimizeIL.Emit(OpCodes.Stloc, 4)
OptimizeIL.MarkSequencePoint(doc3, 1372, 1, 1372, 100)
OptimizeIL.Emit(OpCodes.Ldloc, 4)
Typ = GetType(System.Boolean)
OptimizeIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
...
OptimizeIL.MarkSequencePoint(doc3, 1373, 1, 1373, 100)
Dim locbldr114 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(IntLiteral))
locbldr114.SetLocalSymInfo("ilit")
OptimizeIL.Emit(OpCodes.Newobj, GetType(IntLiteral).GetConstructor(Type.EmptyTypes))
OptimizeIL.Emit(OpCodes.Stloc, 114)
OptimizeIL.MarkSequencePoint(doc3, 1374, 1, 1374, 100)
OptimizeIL.Emit(OpCodes.Ldloc, 114)
Typ = GetType(IntLiteral)
OptimizeIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Token)
OptimizeIL.Emit(OpCodes.Ldfld, GetType(Token).GetField("Line"))
Typ = GetType(Token).GetField("Line").FieldType
OptimizeIL.Emit(OpCodes.Stfld, GetType(IntLiteral).GetField("Line"))
OptimizeIL.MarkSequencePoint(doc3, 1375, 1, 1375, 100)
OptimizeIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Token)
OptimizeIL.Emit(OpCodes.Ldfld, GetType(Token).GetField("Value"))
Typ = GetType(Token).GetField("Value").FieldType
OptimizeIL.Emit(OpCodes.Stloc, 2)
OptimizeIL.MarkSequencePoint(doc3, 1379, 1, 1379, 100)
OptimizeIL.Emit(OpCodes.Ldloc, 114)
Typ = GetType(IntLiteral)
OptimizeIL.Emit(OpCodes.Ldloc, 2)
Typ = GetType(System.String)
OptimizeIL.Emit(OpCodes.Stfld, GetType(IntLiteral).GetField("Value"))
OptimizeIL.MarkSequencePoint(doc3, 1380, 1, 1380, 100)
OptimizeIL.Emit(OpCodes.Ldloc, 114)
Typ = GetType(IntLiteral)
OptimizeIL.Emit(OpCodes.Ldloc, 114)
Typ = GetType(IntLiteral)
OptimizeIL.Emit(OpCodes.Ldfld, GetType(IntLiteral).GetField("Value"))
Typ = GetType(IntLiteral).GetField("Value").FieldType
Dim typ231 As Type() = {Typ}
OptimizeIL.Emit(OpCodes.Call, GetType(System.Convert).GetMethod("ToInt32", typ231))
Typ = GetType(System.Convert).GetMethod("ToInt32", typ231).ReturnType
OptimizeIL.Emit(OpCodes.Stfld, GetType(IntLiteral).GetField("NumVal"))
OptimizeIL.MarkSequencePoint(doc3, 1381, 1, 1381, 100)
OptimizeIL.Emit(OpCodes.Ldloc, 114)
Typ = GetType(IntLiteral)
OptimizeIL.Emit(OpCodes.Starg, 1)
OptimizeIL.MarkSequencePoint(doc3, 1382, 1, 1382, 100)
OptimizeIL.Emit(OpCodes.Br, label0)
OptimizeIL.MarkSequencePoint(doc3, 1383, 1, 1383, 100)
OptimizeIL.Emit(OpCodes.Br, cont113)
OptimizeIL.MarkLabel(fa113)
OptimizeIL.Emit(OpCodes.Br, cont113)
OptimizeIL.MarkLabel(cont113)
OptimizeIL.MarkSequencePoint(doc3, 1386, 1, 1386, 100)
...
ReDim Preserve typ232(UBound(typ232) + 1)
typ232(UBound(typ232)) = Typ
OptimizeIL.Emit(OpCodes.Call, GetType(Utils.ParseUtils).GetMethod("LikeOP", typ232))
Typ = GetType(Utils.ParseUtils).GetMethod("LikeOP", typ232).ReturnType
OptimizeIL.Emit(OpCodes.Stloc, 1)
OptimizeIL.MarkSequencePoint(doc3, 1387, 1, 1387, 100)
OptimizeIL.Emit(OpCodes.Ldloc, 1)
Typ = GetType(System.Boolean)
OptimizeIL.Emit(OpCodes.Stloc, 4)
OptimizeIL.MarkSequencePoint(doc3, 1388, 1, 1388, 100)
...
ReDim Preserve typ233(UBound(typ233) + 1)
typ233(UBound(typ233)) = Typ
OptimizeIL.Emit(OpCodes.Call, GetType(Utils.ParseUtils).GetMethod("LikeOP", typ233))
Typ = GetType(Utils.ParseUtils).GetMethod("LikeOP", typ233).ReturnType
OptimizeIL.Emit(OpCodes.Stloc, 1)
OptimizeIL.MarkSequencePoint(doc3, 1389, 1, 1389, 100)
OptimizeIL.Emit(OpCodes.Ldloc, 4)
Typ = GetType(System.Boolean)
OptimizeIL.Emit(OpCodes.Ldloc, 1)
Typ = GetType(System.Boolean)
OptimizeIL.Emit(OpCodes.Or)
OptimizeIL.Emit(OpCodes.Stloc, 4)
OptimizeIL.MarkSequencePoint(doc3, 1390, 1, 1390, 100)
...
ReDim Preserve typ234(UBound(typ234) + 1)
typ234(UBound(typ234)) = Typ
OptimizeIL.Emit(OpCodes.Call, GetType(Utils.ParseUtils).GetMethod("LikeOP", typ234))
Typ = GetType(Utils.ParseUtils).GetMethod("LikeOP", typ234).ReturnType
OptimizeIL.Emit(OpCodes.Stloc, 1)
OptimizeIL.MarkSequencePoint(doc3, 1391, 1, 1391, 100)
OptimizeIL.Emit(OpCodes.Ldloc, 4)
Typ = GetType(System.Boolean)
OptimizeIL.Emit(OpCodes.Ldloc, 1)
Typ = GetType(System.Boolean)
OptimizeIL.Emit(OpCodes.Or)
OptimizeIL.Emit(OpCodes.Stloc, 4)
OptimizeIL.MarkSequencePoint(doc3, 1393, 1, 1393, 100)
OptimizeIL.Emit(OpCodes.Ldloc, 4)
Typ = GetType(System.Boolean)
OptimizeIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
...
OptimizeIL.MarkSequencePoint(doc3, 1394, 1, 1394, 100)
Dim locbldr115 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(Ident))
locbldr115.SetLocalSymInfo("idt")
OptimizeIL.Emit(OpCodes.Newobj, GetType(Ident).GetConstructor(Type.EmptyTypes))
OptimizeIL.Emit(OpCodes.Stloc, 115)
OptimizeIL.MarkSequencePoint(doc3, 1395, 1, 1395, 100)
OptimizeIL.Emit(OpCodes.Ldloc, 115)
Typ = GetType(Ident)
OptimizeIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Token)
OptimizeIL.Emit(OpCodes.Ldfld, GetType(Token).GetField("Line"))
...
OptimizeIL.MarkSequencePoint(doc3, 1396, 1, 1396, 100)
OptimizeIL.Emit(OpCodes.Ldloc, 115)
Typ = GetType(Ident)
OptimizeIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Token)
...
OptimizeIL.MarkSequencePoint(doc3, 1397, 1, 1397, 100)
OptimizeIL.Emit(OpCodes.Ldloc, 115)
Typ = GetType(Ident)
OptimizeIL.Emit(OpCodes.Starg, 1)
OptimizeIL.MarkSequencePoint(doc3, 1398, 1, 1398, 100)
OptimizeIL.Emit(OpCodes.Br, label0)
OptimizeIL.MarkSequencePoint(doc3, 1399, 1, 1399, 100)
OptimizeIL.Emit(OpCodes.Br, cont114)
OptimizeIL.MarkLabel(fa114)
OptimizeIL.Emit(OpCodes.Br, cont114)
OptimizeIL.MarkLabel(cont114)
OptimizeIL.MarkSequencePoint(doc3, 1402, 1, 1402, 100)
OptimizeIL.MarkLabel(label0)
OptimizeIL.MarkSequencePoint(doc3, 1403, 1, 1403, 100)
OptimizeIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Token)
OptimizeIL.MarkSequencePoint(doc3, 1405, 1, 1405, 100)
...
Dim locbldr116 As LocalBuilder = checkVarAsIL.DeclareLocal(GetType(Token))
...
Dim locbldr117 As LocalBuilder = checkVarAsIL.DeclareLocal(GetType(System.Type))
...
Dim locbldr118 As LocalBuilder = checkVarAsIL.DeclareLocal(GetType(VarExpr))
locbldr118.SetLocalSymInfo("vars")
...
Typ = GetType(System.Boolean)
Dim fa115 As System.Reflection.Emit.Label = checkVarAsIL.DefineLabel()
Dim tru115 As System.Reflection.Emit.Label = checkVarAsIL.DefineLabel()
Dim cont115 As System.Reflection.Emit.Label = checkVarAsIL.DefineLabel()
checkVarAsIL.Emit(OpCodes.Beq, tru115)
checkVarAsIL.Emit(OpCodes.Br, fa115)
checkVarAsIL.MarkLabel(tru115)
...
Dim locbldr119 As LocalBuilder = checkVarAsIL.DeclareLocal(GetType(Token))
locbldr119.SetLocalSymInfo("tok2")
checkVarAsIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Expr)
checkVarAsIL.Emit(OpCodes.Ldfld, GetType(Expr).GetField("Tokens"))
Typ = GetType(Expr).GetField("Tokens").FieldType
...
Dim locbldr120 As LocalBuilder = checkVarAsIL.DeclareLocal(GetType(System.Type))
locbldr120.SetLocalSymInfo("typ2")
...
Dim locbldr121 As LocalBuilder = checkVarAsIL.DeclareLocal(GetType(System.Boolean))
locbldr121.SetLocalSymInfo("b2")
Dim typ4(-1) As Type
...
checkVarAsIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa116 As System.Reflection.Emit.Label = checkVarAsIL.DefineLabel()
Dim tru116 As System.Reflection.Emit.Label = checkVarAsIL.DefineLabel()
Dim cont116 As System.Reflection.Emit.Label = checkVarAsIL.DefineLabel()
checkVarAsIL.Emit(OpCodes.Beq, fa116)
checkVarAsIL.Emit(OpCodes.Br, tru116)
checkVarAsIL.MarkLabel(tru116)
checkVarAsIL.MarkSequencePoint(doc4, 27, 1, 27, 100)
Dim locbldr122 As LocalBuilder = checkVarAsIL.DeclareLocal(GetType(Token))
locbldr122.SetLocalSymInfo("t")
checkVarAsIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Expr)
checkVarAsIL.Emit(OpCodes.Ldfld, GetType(Expr).GetField("Tokens"))
Typ = GetType(Expr).GetField("Tokens").FieldType
...
Dim locbldr123 As LocalBuilder = checkVarAsIL.DeclareLocal(GetType(TypeTok))
locbldr123.SetLocalSymInfo("tt")
...
checkVarAsIL.Emit(OpCodes.Br, cont116)
checkVarAsIL.MarkLabel(fa116)
...
checkVarAsIL.Emit(OpCodes.Br, cont116)
checkVarAsIL.MarkLabel(cont116)
checkVarAsIL.MarkSequencePoint(doc4, 36, 1, 36, 100)
checkVarAsIL.Emit(OpCodes.Br, cont115)
checkVarAsIL.MarkLabel(fa115)
checkVarAsIL.Emit(OpCodes.Br, cont115)
checkVarAsIL.MarkLabel(cont115)
...
Dim locbldr124 As LocalBuilder = procMethodCallIL.DeclareLocal(GetType(MethodNameTok))
locbldr124.SetLocalSymInfo("mn")
...
Dim locbldr125 As LocalBuilder = procMethodCallIL.DeclareLocal(GetType(MethodCallTok))
locbldr125.SetLocalSymInfo("mct")
...
Dim locbldr126 As LocalBuilder = procMethodCallIL.DeclareLocal(GetType(Ident))
locbldr126.SetLocalSymInfo("idt")
...
Dim locbldr127 As LocalBuilder = procMethodCallIL.DeclareLocal(GetType(Expr))
locbldr127.SetLocalSymInfo("ep2")
...
Dim locbldr128 As LocalBuilder = procMethodCallIL.DeclareLocal(GetType(System.Int32))
locbldr128.SetLocalSymInfo("lvl")
...
Dim locbldr131 As LocalBuilder = procMethodCallIL.DeclareLocal(GetType(Token))
locbldr131.SetLocalSymInfo("tok2")
procMethodCallIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Expr)
procMethodCallIL.Emit(OpCodes.Ldfld, GetType(Expr).GetField("Tokens"))
Typ = GetType(Expr).GetField("Tokens").FieldType
...
Dim locbldr132 As LocalBuilder = procMethodCallIL.DeclareLocal(GetType(System.Type))
locbldr132.SetLocalSymInfo("typ2")
procMethodCallIL.MarkSequencePoint(doc4, 77, 1, 77, 100)
Dim locbldr133 As LocalBuilder = procMethodCallIL.DeclareLocal(GetType(System.Boolean))
locbldr133.SetLocalSymInfo("b2")
procMethodCallIL.MarkSequencePoint(doc4, 78, 1, 78, 100)
Dim locbldr134 As LocalBuilder = procMethodCallIL.DeclareLocal(GetType(System.Int32))
...
procMethodCallIL.Emit(OpCodes.Ldc_I4, CInt(1))
Typ = GetType(System.Int32)
Dim fa122 As System.Reflection.Emit.Label = procMethodCallIL.DefineLabel()
Dim tru122 As System.Reflection.Emit.Label = procMethodCallIL.DefineLabel()
Dim cont122 As System.Reflection.Emit.Label = procMethodCallIL.DefineLabel()
procMethodCallIL.Emit(OpCodes.Beq, tru122)
procMethodCallIL.Emit(OpCodes.Br, fa122)
procMethodCallIL.MarkLabel(tru122)
...
procMethodCallIL.Emit(OpCodes.Ldc_I4, CInt(0))
Typ = GetType(System.Int32)
Dim fa123 As System.Reflection.Emit.Label = procMethodCallIL.DefineLabel()
Dim tru123 As System.Reflection.Emit.Label = procMethodCallIL.DefineLabel()
Dim cont123 As System.Reflection.Emit.Label = procMethodCallIL.DefineLabel()
procMethodCallIL.Emit(OpCodes.Bgt, tru123)
procMethodCallIL.Emit(OpCodes.Br, fa123)
procMethodCallIL.MarkLabel(tru123)
...
procMethodCallIL.Emit(OpCodes.Br, cont123)
procMethodCallIL.MarkLabel(fa123)
procMethodCallIL.Emit(OpCodes.Br, cont123)
procMethodCallIL.MarkLabel(cont123)
...
procMethodCallIL.Emit(OpCodes.Br, cont122)
procMethodCallIL.MarkLabel(fa122)
...
procMethodCallIL.Emit(OpCodes.Br, cont122)
procMethodCallIL.MarkLabel(cont122)
...
procMethodCallIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa124 As System.Reflection.Emit.Label = procMethodCallIL.DefineLabel()
Dim tru124 As System.Reflection.Emit.Label = procMethodCallIL.DefineLabel()
Dim cont124 As System.Reflection.Emit.Label = procMethodCallIL.DefineLabel()
procMethodCallIL.Emit(OpCodes.Beq, tru124)
procMethodCallIL.Emit(OpCodes.Br, fa124)
procMethodCallIL.MarkLabel(tru124)
...
procMethodCallIL.Emit(OpCodes.Br, cont124)
procMethodCallIL.MarkLabel(fa124)
procMethodCallIL.Emit(OpCodes.Br, cont124)
procMethodCallIL.MarkLabel(cont124)
procMethodCallIL.MarkSequencePoint(doc4, 158, 1, 158, 100)
procMethodCallIL.Emit(OpCodes.Ldarg, 2)
Typ = GetType(System.Int32)
procMethodCallIL.Emit(OpCodes.Ldloc, 10)
Typ = GetType(System.Int32)
Dim fa125 As System.Reflection.Emit.Label = procMethodCallIL.DefineLabel()
Dim tru125 As System.Reflection.Emit.Label = procMethodCallIL.DefineLabel()
Dim cont125 As System.Reflection.Emit.Label = procMethodCallIL.DefineLabel()
procMethodCallIL.Emit(OpCodes.Beq, tru125)
procMethodCallIL.Emit(OpCodes.Br, fa125)
procMethodCallIL.MarkLabel(tru125)
procMethodCallIL.MarkSequencePoint(doc4, 159, 1, 159, 100)
procMethodCallIL.Emit(OpCodes.Br, label1)
procMethodCallIL.MarkSequencePoint(doc4, 160, 1, 160, 100)
procMethodCallIL.Emit(OpCodes.Br, cont125)
procMethodCallIL.MarkLabel(fa125)
...
procMethodCallIL.Emit(OpCodes.Br, cont125)
procMethodCallIL.MarkLabel(cont125)
...
Dim locbldr135 As LocalBuilder = procNewCallIL.DeclareLocal(GetType(NewCallTok))
locbldr135.SetLocalSymInfo("nct")
...
Dim locbldr136 As LocalBuilder = procNewCallIL.DeclareLocal(GetType(TypeTok))
locbldr136.SetLocalSymInfo("tt")
procNewCallIL.MarkSequencePoint(doc4, 178, 1, 178, 100)
Dim locbldr137 As LocalBuilder = procNewCallIL.DeclareLocal(GetType(Expr))
locbldr137.SetLocalSymInfo("ep2")
...
Dim locbldr138 As LocalBuilder = procNewCallIL.DeclareLocal(GetType(System.Int32))
locbldr138.SetLocalSymInfo("lvl")
...
Dim locbldr141 As LocalBuilder = procNewCallIL.DeclareLocal(GetType(Token))
locbldr141.SetLocalSymInfo("tok2")
procNewCallIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Expr)
procNewCallIL.Emit(OpCodes.Ldfld, GetType(Expr).GetField("Tokens"))
Typ = GetType(Expr).GetField("Tokens").FieldType
...
Dim locbldr142 As LocalBuilder = procNewCallIL.DeclareLocal(GetType(System.Type))
locbldr142.SetLocalSymInfo("typ2")
procNewCallIL.MarkSequencePoint(doc4, 190, 1, 190, 100)
Dim locbldr143 As LocalBuilder = procNewCallIL.DeclareLocal(GetType(System.Boolean))
locbldr143.SetLocalSymInfo("b2")
procNewCallIL.MarkSequencePoint(doc4, 191, 1, 191, 100)
Dim locbldr144 As LocalBuilder = procNewCallIL.DeclareLocal(GetType(System.Int32))
...
procNewCallIL.Emit(OpCodes.Ldc_I4, CInt(1))
Typ = GetType(System.Int32)
Dim fa131 As System.Reflection.Emit.Label = procNewCallIL.DefineLabel()
Dim tru131 As System.Reflection.Emit.Label = procNewCallIL.DefineLabel()
Dim cont131 As System.Reflection.Emit.Label = procNewCallIL.DefineLabel()
procNewCallIL.Emit(OpCodes.Beq, tru131)
procNewCallIL.Emit(OpCodes.Br, fa131)
procNewCallIL.MarkLabel(tru131)
...
procNewCallIL.Emit(OpCodes.Ldc_I4, CInt(0))
Typ = GetType(System.Int32)
Dim fa132 As System.Reflection.Emit.Label = procNewCallIL.DefineLabel()
Dim tru132 As System.Reflection.Emit.Label = procNewCallIL.DefineLabel()
Dim cont132 As System.Reflection.Emit.Label = procNewCallIL.DefineLabel()
procNewCallIL.Emit(OpCodes.Bgt, tru132)
procNewCallIL.Emit(OpCodes.Br, fa132)
procNewCallIL.MarkLabel(tru132)
...
procNewCallIL.Emit(OpCodes.Br, cont132)
procNewCallIL.MarkLabel(fa132)
procNewCallIL.Emit(OpCodes.Br, cont132)
procNewCallIL.MarkLabel(cont132)
...
procNewCallIL.Emit(OpCodes.Br, cont131)
procNewCallIL.MarkLabel(fa131)
...
procNewCallIL.Emit(OpCodes.Br, cont131)
procNewCallIL.MarkLabel(cont131)
...
procNewCallIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa133 As System.Reflection.Emit.Label = procNewCallIL.DefineLabel()
Dim tru133 As System.Reflection.Emit.Label = procNewCallIL.DefineLabel()
Dim cont133 As System.Reflection.Emit.Label = procNewCallIL.DefineLabel()
procNewCallIL.Emit(OpCodes.Beq, tru133)
procNewCallIL.Emit(OpCodes.Br, fa133)
procNewCallIL.MarkLabel(tru133)
...
procNewCallIL.Emit(OpCodes.Br, cont133)
procNewCallIL.MarkLabel(fa133)
procNewCallIL.Emit(OpCodes.Br, cont133)
procNewCallIL.MarkLabel(cont133)
procNewCallIL.MarkSequencePoint(doc4, 271, 1, 271, 100)
procNewCallIL.Emit(OpCodes.Ldarg, 2)
Typ = GetType(System.Int32)
procNewCallIL.Emit(OpCodes.Ldloc, 9)
Typ = GetType(System.Int32)
Dim fa134 As System.Reflection.Emit.Label = procNewCallIL.DefineLabel()
Dim tru134 As System.Reflection.Emit.Label = procNewCallIL.DefineLabel()
Dim cont134 As System.Reflection.Emit.Label = procNewCallIL.DefineLabel()
procNewCallIL.Emit(OpCodes.Beq, tru134)
procNewCallIL.Emit(OpCodes.Br, fa134)
procNewCallIL.MarkLabel(tru134)
procNewCallIL.MarkSequencePoint(doc4, 272, 1, 272, 100)
procNewCallIL.Emit(OpCodes.Br, label4)
procNewCallIL.MarkSequencePoint(doc4, 273, 1, 273, 100)
procNewCallIL.Emit(OpCodes.Br, cont134)
procNewCallIL.MarkLabel(fa134)
...
procNewCallIL.Emit(OpCodes.Br, cont134)
procNewCallIL.MarkLabel(cont134)
...
Dim locbldr145 As LocalBuilder = procIdentArrayAccessIL.DeclareLocal(GetType(Ident))
locbldr145.SetLocalSymInfo("idt")
...
Dim locbldr146 As LocalBuilder = procIdentArrayAccessIL.DeclareLocal(GetType(Expr))
locbldr146.SetLocalSymInfo("ep2")
...
Dim locbldr147 As LocalBuilder = procIdentArrayAccessIL.DeclareLocal(GetType(System.Int32))
locbldr147.SetLocalSymInfo("lvl")
...
Dim locbldr150 As LocalBuilder = procIdentArrayAccessIL.DeclareLocal(GetType(Token))
locbldr150.SetLocalSymInfo("tok2")
procIdentArrayAccessIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Expr)
procIdentArrayAccessIL.Emit(OpCodes.Ldfld, GetType(Expr).GetField("Tokens"))
Typ = GetType(Expr).GetField("Tokens").FieldType
...
Dim locbldr151 As LocalBuilder = procIdentArrayAccessIL.DeclareLocal(GetType(System.Type))
locbldr151.SetLocalSymInfo("typ2")
procIdentArrayAccessIL.MarkSequencePoint(doc4, 301, 1, 301, 100)
Dim locbldr152 As LocalBuilder = procIdentArrayAccessIL.DeclareLocal(GetType(System.Boolean))
locbldr152.SetLocalSymInfo("b2")
procIdentArrayAccessIL.MarkSequencePoint(doc4, 302, 1, 302, 100)
Dim locbldr153 As LocalBuilder = procIdentArrayAccessIL.DeclareLocal(GetType(System.Int32))
locbldr153.SetLocalSymInfo("len")
procIdentArrayAccessIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Expr)
procIdentArrayAccessIL.Emit(OpCodes.Ldfld, GetType(Expr).GetField("Tokens"))
Typ = GetType(Expr).GetField("Tokens").FieldType
...
procIdentArrayAccessIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa137 As System.Reflection.Emit.Label = procIdentArrayAccessIL.DefineLabel()
Dim tru137 As System.Reflection.Emit.Label = procIdentArrayAccessIL.DefineLabel()
Dim cont137 As System.Reflection.Emit.Label = procIdentArrayAccessIL.DefineLabel()
procIdentArrayAccessIL.Emit(OpCodes.Beq, tru137)
procIdentArrayAccessIL.Emit(OpCodes.Br, fa137)
procIdentArrayAccessIL.MarkLabel(tru137)
...
procIdentArrayAccessIL.Emit(OpCodes.Br, cont137)
procIdentArrayAccessIL.MarkLabel(fa137)
procIdentArrayAccessIL.Emit(OpCodes.Br, cont137)
procIdentArrayAccessIL.MarkLabel(cont137)
...
procIdentArrayAccessIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa138 As System.Reflection.Emit.Label = procIdentArrayAccessIL.DefineLabel()
Dim tru138 As System.Reflection.Emit.Label = procIdentArrayAccessIL.DefineLabel()
Dim cont138 As System.Reflection.Emit.Label = procIdentArrayAccessIL.DefineLabel()
procIdentArrayAccessIL.Emit(OpCodes.Beq, tru138)
procIdentArrayAccessIL.Emit(OpCodes.Br, fa138)
procIdentArrayAccessIL.MarkLabel(tru138)
procIdentArrayAccessIL.MarkSequencePoint(doc4, 349, 1, 349, 100)
procIdentArrayAccessIL.Emit(OpCodes.Br, cont138)
procIdentArrayAccessIL.MarkLabel(fa138)
...
procIdentArrayAccessIL.Emit(OpCodes.Br, cont138)
procIdentArrayAccessIL.MarkLabel(cont138)
...
procIdentArrayAccessIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa139 As System.Reflection.Emit.Label = procIdentArrayAccessIL.DefineLabel()
Dim tru139 As System.Reflection.Emit.Label = procIdentArrayAccessIL.DefineLabel()
Dim cont139 As System.Reflection.Emit.Label = procIdentArrayAccessIL.DefineLabel()
procIdentArrayAccessIL.Emit(OpCodes.Beq, tru139)
procIdentArrayAccessIL.Emit(OpCodes.Br, fa139)
procIdentArrayAccessIL.MarkLabel(tru139)
...
procIdentArrayAccessIL.Emit(OpCodes.Br, cont139)
procIdentArrayAccessIL.MarkLabel(fa139)
procIdentArrayAccessIL.Emit(OpCodes.Br, cont139)
procIdentArrayAccessIL.MarkLabel(cont139)
procIdentArrayAccessIL.MarkSequencePoint(doc4, 363, 1, 363, 100)
procIdentArrayAccessIL.Emit(OpCodes.Ldarg, 2)
Typ = GetType(System.Int32)
procIdentArrayAccessIL.Emit(OpCodes.Ldloc, 8)
Typ = GetType(System.Int32)
Dim fa140 As System.Reflection.Emit.Label = procIdentArrayAccessIL.DefineLabel()
Dim tru140 As System.Reflection.Emit.Label = procIdentArrayAccessIL.DefineLabel()
Dim cont140 As System.Reflection.Emit.Label = procIdentArrayAccessIL.DefineLabel()
procIdentArrayAccessIL.Emit(OpCodes.Beq, tru140)
procIdentArrayAccessIL.Emit(OpCodes.Br, fa140)
procIdentArrayAccessIL.MarkLabel(tru140)
procIdentArrayAccessIL.MarkSequencePoint(doc4, 364, 1, 364, 100)
procIdentArrayAccessIL.Emit(OpCodes.Br, label7)
procIdentArrayAccessIL.MarkSequencePoint(doc4, 365, 1, 365, 100)
procIdentArrayAccessIL.Emit(OpCodes.Br, cont140)
procIdentArrayAccessIL.MarkLabel(fa140)
...
procIdentArrayAccessIL.Emit(OpCodes.Br, cont140)
procIdentArrayAccessIL.MarkLabel(cont140)
...
Dim locbldr154 As LocalBuilder = procMtdArrayAccessIL.DeclareLocal(GetType(MethodCallTok))
locbldr154.SetLocalSymInfo("mtd")
...
Dim locbldr155 As LocalBuilder = procMtdArrayAccessIL.DeclareLocal(GetType(MethodNameTok))
locbldr155.SetLocalSymInfo("idt")
procMtdArrayAccessIL.Emit(OpCodes.Ldnull)
procMtdArrayAccessIL.Emit(OpCodes.Stloc, 1)
procMtdArrayAccessIL.MarkSequencePoint(doc4, 383, 1, 383, 100)
Dim locbldr156 As LocalBuilder = procMtdArrayAccessIL.DeclareLocal(GetType(Expr))
locbldr156.SetLocalSymInfo("ep2")
...
Dim locbldr157 As LocalBuilder = procMtdArrayAccessIL.DeclareLocal(GetType(System.Int32))
locbldr157.SetLocalSymInfo("lvl")
...
Dim locbldr160 As LocalBuilder = procMtdArrayAccessIL.DeclareLocal(GetType(Token))
locbldr160.SetLocalSymInfo("tok2")
procMtdArrayAccessIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Expr)
procMtdArrayAccessIL.Emit(OpCodes.Ldfld, GetType(Expr).GetField("Tokens"))
Typ = GetType(Expr).GetField("Tokens").FieldType
...
Dim locbldr161 As LocalBuilder = procMtdArrayAccessIL.DeclareLocal(GetType(System.Type))
locbldr161.SetLocalSymInfo("typ2")
procMtdArrayAccessIL.MarkSequencePoint(doc4, 396, 1, 396, 100)
Dim locbldr162 As LocalBuilder = procMtdArrayAccessIL.DeclareLocal(GetType(System.Boolean))
locbldr162.SetLocalSymInfo("b2")
procMtdArrayAccessIL.MarkSequencePoint(doc4, 397, 1, 397, 100)
Dim locbldr163 As LocalBuilder = procMtdArrayAccessIL.DeclareLocal(GetType(System.Int32))
locbldr163.SetLocalSymInfo("len")
procMtdArrayAccessIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Expr)
procMtdArrayAccessIL.Emit(OpCodes.Ldfld, GetType(Expr).GetField("Tokens"))
Typ = GetType(Expr).GetField("Tokens").FieldType
...
procMtdArrayAccessIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa143 As System.Reflection.Emit.Label = procMtdArrayAccessIL.DefineLabel()
Dim tru143 As System.Reflection.Emit.Label = procMtdArrayAccessIL.DefineLabel()
Dim cont143 As System.Reflection.Emit.Label = procMtdArrayAccessIL.DefineLabel()
procMtdArrayAccessIL.Emit(OpCodes.Beq, tru143)
procMtdArrayAccessIL.Emit(OpCodes.Br, fa143)
procMtdArrayAccessIL.MarkLabel(tru143)
...
procMtdArrayAccessIL.Emit(OpCodes.Br, cont143)
procMtdArrayAccessIL.MarkLabel(fa143)
procMtdArrayAccessIL.Emit(OpCodes.Br, cont143)
procMtdArrayAccessIL.MarkLabel(cont143)
...
procMtdArrayAccessIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa144 As System.Reflection.Emit.Label = procMtdArrayAccessIL.DefineLabel()
Dim tru144 As System.Reflection.Emit.Label = procMtdArrayAccessIL.DefineLabel()
Dim cont144 As System.Reflection.Emit.Label = procMtdArrayAccessIL.DefineLabel()
procMtdArrayAccessIL.Emit(OpCodes.Beq, tru144)
procMtdArrayAccessIL.Emit(OpCodes.Br, fa144)
procMtdArrayAccessIL.MarkLabel(tru144)
procMtdArrayAccessIL.MarkSequencePoint(doc4, 444, 1, 444, 100)
procMtdArrayAccessIL.Emit(OpCodes.Br, cont144)
procMtdArrayAccessIL.MarkLabel(fa144)
...
procMtdArrayAccessIL.Emit(OpCodes.Br, cont144)
procMtdArrayAccessIL.MarkLabel(cont144)
...
procMtdArrayAccessIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa145 As System.Reflection.Emit.Label = procMtdArrayAccessIL.DefineLabel()
Dim tru145 As System.Reflection.Emit.Label = procMtdArrayAccessIL.DefineLabel()
Dim cont145 As System.Reflection.Emit.Label = procMtdArrayAccessIL.DefineLabel()
procMtdArrayAccessIL.Emit(OpCodes.Beq, tru145)
procMtdArrayAccessIL.Emit(OpCodes.Br, fa145)
procMtdArrayAccessIL.MarkLabel(tru145)
...
procMtdArrayAccessIL.Emit(OpCodes.Br, cont145)
procMtdArrayAccessIL.MarkLabel(fa145)
procMtdArrayAccessIL.Emit(OpCodes.Br, cont145)
procMtdArrayAccessIL.MarkLabel(cont145)
procMtdArrayAccessIL.MarkSequencePoint(doc4, 458, 1, 458, 100)
procMtdArrayAccessIL.Emit(OpCodes.Ldarg, 2)
Typ = GetType(System.Int32)
procMtdArrayAccessIL.Emit(OpCodes.Ldloc, 9)
Typ = GetType(System.Int32)
Dim fa146 As System.Reflection.Emit.Label = procMtdArrayAccessIL.DefineLabel()
Dim tru146 As System.Reflection.Emit.Label = procMtdArrayAccessIL.DefineLabel()
Dim cont146 As System.Reflection.Emit.Label = procMtdArrayAccessIL.DefineLabel()
procMtdArrayAccessIL.Emit(OpCodes.Beq, tru146)
procMtdArrayAccessIL.Emit(OpCodes.Br, fa146)
procMtdArrayAccessIL.MarkLabel(tru146)
procMtdArrayAccessIL.MarkSequencePoint(doc4, 459, 1, 459, 100)
procMtdArrayAccessIL.Emit(OpCodes.Br, label10)
procMtdArrayAccessIL.MarkSequencePoint(doc4, 460, 1, 460, 100)
procMtdArrayAccessIL.Emit(OpCodes.Br, cont146)
procMtdArrayAccessIL.MarkLabel(fa146)
...
procMtdArrayAccessIL.Emit(OpCodes.Br, cont146)
procMtdArrayAccessIL.MarkLabel(cont146)
...
Dim locbldr164 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(System.Int32))
...
Dim locbldr165 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(System.Int32))
locbldr165.SetLocalSymInfo("i")
OptimizeIL.Emit(OpCodes.Ldc_I4, CInt(-1))
Typ = GetType(System.Int32)
OptimizeIL.Emit(OpCodes.Stloc, 1)
OptimizeIL.MarkSequencePoint(doc4, 479, 1, 479, 100)
Dim locbldr166 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(System.Int32))
locbldr166.SetLocalSymInfo("j")
OptimizeIL.Emit(OpCodes.Ldc_I4, CInt(-1))
Typ = GetType(System.Int32)
OptimizeIL.Emit(OpCodes.Stloc, 2)
...
locbldr167.SetLocalSymInfo("identtrnoff")
OptimizeIL.Emit(OpCodes.Ldc_I4, 0)
Typ = GetType(System.Boolean)
OptimizeIL.Emit(OpCodes.Stloc, 3)
OptimizeIL.MarkSequencePoint(doc4, 481, 1, 481, 100)
Dim locbldr168 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(System.Boolean))
locbldr168.SetLocalSymInfo("mcbool")
OptimizeIL.Emit(OpCodes.Ldc_I4, 0)
Typ = GetType(System.Boolean)
OptimizeIL.Emit(OpCodes.Stloc, 4)
OptimizeIL.MarkSequencePoint(doc4, 482, 1, 482, 100)
Dim locbldr169 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(System.Boolean))
locbldr169.SetLocalSymInfo("mcflgc")
OptimizeIL.Emit(OpCodes.Ldc_I4, 0)
Typ = GetType(System.Boolean)
OptimizeIL.Emit(OpCodes.Stloc, 5)
OptimizeIL.MarkSequencePoint(doc4, 483, 1, 483, 100)
Dim locbldr170 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(System.Boolean))
locbldr170.SetLocalSymInfo("iflgc")
OptimizeIL.Emit(OpCodes.Ldc_I4, 0)
Typ = GetType(System.Boolean)
OptimizeIL.Emit(OpCodes.Stloc, 6)
OptimizeIL.MarkSequencePoint(doc4, 484, 1, 484, 100)
Dim locbldr171 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(System.Boolean))
locbldr171.SetLocalSymInfo("sflgc")
OptimizeIL.Emit(OpCodes.Ldc_I4, 0)
Typ = GetType(System.Boolean)
OptimizeIL.Emit(OpCodes.Stloc, 7)
OptimizeIL.MarkSequencePoint(doc4, 485, 1, 485, 100)
Dim locbldr172 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(Token))
locbldr172.SetLocalSymInfo("mctok")
...
locbldr173.SetLocalSymInfo("nctok")
OptimizeIL.Emit(OpCodes.Ldnull)
OptimizeIL.Emit(OpCodes.Stloc, 9)
OptimizeIL.MarkSequencePoint(doc4, 487, 1, 487, 100)
Dim locbldr174 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(TypeTok))
locbldr174.SetLocalSymInfo("ncttok")
OptimizeIL.Emit(OpCodes.Ldnull)
OptimizeIL.Emit(OpCodes.Stloc, 10)
OptimizeIL.MarkSequencePoint(doc4, 488, 1, 488, 100)
Dim locbldr175 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(Token))
locbldr175.SetLocalSymInfo("gtctok")
OptimizeIL.Emit(OpCodes.Ldnull)
OptimizeIL.Emit(OpCodes.Stloc, 11)
OptimizeIL.MarkSequencePoint(doc4, 489, 1, 489, 100)
Dim locbldr176 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(TypeTok))
locbldr176.SetLocalSymInfo("gtcttok")
OptimizeIL.Emit(OpCodes.Ldnull)
OptimizeIL.Emit(OpCodes.Stloc, 12)
OptimizeIL.MarkSequencePoint(doc4, 490, 1, 490, 100)
Dim locbldr177 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(Token))
locbldr177.SetLocalSymInfo("mctok2")
OptimizeIL.Emit(OpCodes.Ldnull)
OptimizeIL.Emit(OpCodes.Stloc, 13)
OptimizeIL.MarkSequencePoint(doc4, 491, 1, 491, 100)
Dim locbldr178 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(Ident))
locbldr178.SetLocalSymInfo("mcident")
OptimizeIL.Emit(OpCodes.Ldnull)
OptimizeIL.Emit(OpCodes.Stloc, 14)
OptimizeIL.MarkSequencePoint(doc4, 492, 1, 492, 100)
Dim locbldr179 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(MethodCallTok))
locbldr179.SetLocalSymInfo("mcmetcall")
OptimizeIL.Emit(OpCodes.Ldnull)
OptimizeIL.Emit(OpCodes.Stloc, 15)
OptimizeIL.MarkSequencePoint(doc4, 493, 1, 493, 100)
Dim locbldr180 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(MethodNameTok))
locbldr180.SetLocalSymInfo("mcmetname")
OptimizeIL.Emit(OpCodes.Ldnull)
OptimizeIL.Emit(OpCodes.Stloc, 16)
OptimizeIL.MarkSequencePoint(doc4, 494, 1, 494, 100)
Dim locbldr181 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(StringLiteral))
locbldr181.SetLocalSymInfo("mcstr")
OptimizeIL.Emit(OpCodes.Ldnull)
OptimizeIL.Emit(OpCodes.Stloc, 17)
OptimizeIL.MarkSequencePoint(doc4, 495, 1, 495, 100)
Dim locbldr182 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(System.Int32))
locbldr182.SetLocalSymInfo("mcint")
OptimizeIL.Emit(OpCodes.Ldc_I4, CInt(0))
Typ = GetType(System.Int32)
OptimizeIL.Emit(OpCodes.Stloc, 18)
...
OptimizeIL.Emit(OpCodes.Blt, tru147)
...
OptimizeIL.Emit(OpCodes.Beq, tru148)
OptimizeIL.Emit(OpCodes.Br, fa148)
...
locbldr183.SetLocalSymInfo("tok")
OptimizeIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Expr)
OptimizeIL.Emit(OpCodes.Ldfld, GetType(Expr).GetField("Tokens"))
Typ = GetType(Expr).GetField("Tokens").FieldType
...
Dim locbldr184 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(System.Type))
locbldr184.SetLocalSymInfo("typ")
OptimizeIL.MarkSequencePoint(doc4, 516, 1, 516, 100)
Dim locbldr185 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(System.Boolean))
locbldr185.SetLocalSymInfo("b")
OptimizeIL.MarkSequencePoint(doc4, 517, 1, 517, 100)
Dim locbldr186 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(System.String))
locbldr186.SetLocalSymInfo("str")
...
OptimizeIL.Emit(OpCodes.Beq, fa150)
OptimizeIL.Emit(OpCodes.Br, tru150)
OptimizeIL.MarkLabel(tru150)
OptimizeIL.MarkSequencePoint(doc4, 531, 1, 531, 100)
Dim locbldr187 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(Token))
locbldr187.SetLocalSymInfo("tk")
OptimizeIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Expr)
OptimizeIL.Emit(OpCodes.Ldfld, GetType(Expr).GetField("Tokens"))
Typ = GetType(Expr).GetField("Tokens").FieldType
...
Dim locbldr188 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(TypeTok))
locbldr188.SetLocalSymInfo("ttk")
...
OptimizeIL.Emit(OpCodes.Beq, tru151)
OptimizeIL.Emit(OpCodes.Br, fa151)
...
OptimizeIL.Emit(OpCodes.Beq, fa152)
OptimizeIL.Emit(OpCodes.Br, tru152)
OptimizeIL.MarkLabel(tru152)
OptimizeIL.MarkSequencePoint(doc4, 556, 1, 556, 100)
Dim locbldr189 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(Token))
locbldr189.SetLocalSymInfo("tk2")
OptimizeIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Expr)
OptimizeIL.Emit(OpCodes.Ldfld, GetType(Expr).GetField("Tokens"))
Typ = GetType(Expr).GetField("Tokens").FieldType
...
Dim locbldr190 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(TypeTok))
locbldr190.SetLocalSymInfo("ttk2")
OptimizeIL.Emit(OpCodes.Newobj, GetType(TypeTok).GetConstructor(Type.EmptyTypes))
OptimizeIL.Emit(OpCodes.Stloc, 26)
...
OptimizeIL.Emit(OpCodes.Beq, tru153)
OptimizeIL.Emit(OpCodes.Br, fa153)
...
OptimizeIL.Emit(OpCodes.Beq, fa155)
OptimizeIL.Emit(OpCodes.Br, tru155)
...
OptimizeIL.Emit(OpCodes.Beq, fa157)
OptimizeIL.Emit(OpCodes.Br, tru157)
OptimizeIL.MarkLabel(tru157)
OptimizeIL.MarkSequencePoint(doc4, 595, 1, 595, 100)
Dim locbldr191 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(TypeTok))
locbldr191.SetLocalSymInfo("tt1")
OptimizeIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Expr)
OptimizeIL.Emit(OpCodes.Ldfld, GetType(Expr).GetField("Tokens"))
Typ = GetType(Expr).GetField("Tokens").FieldType
...
Dim locbldr192 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(Ident))
locbldr192.SetLocalSymInfo("id1")
OptimizeIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Expr)
OptimizeIL.Emit(OpCodes.Ldfld, GetType(Expr).GetField("Tokens"))
Typ = GetType(Expr).GetField("Tokens").FieldType
...
Dim locbldr193 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(CharLiteral))
locbldr193.SetLocalSymInfo("cl1")
OptimizeIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Expr)
OptimizeIL.Emit(OpCodes.Ldfld, GetType(Expr).GetField("Tokens"))
Typ = GetType(Expr).GetField("Tokens").FieldType
...
Dim locbldr194 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(NullLiteral))
locbldr194.SetLocalSymInfo("nul1")
OptimizeIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Expr)
OptimizeIL.Emit(OpCodes.Ldfld, GetType(Expr).GetField("Tokens"))
Typ = GetType(Expr).GetField("Tokens").FieldType
...
Dim locbldr195 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(StringLiteral))
locbldr195.SetLocalSymInfo("sl1")
OptimizeIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Expr)
OptimizeIL.Emit(OpCodes.Ldfld, GetType(Expr).GetField("Tokens"))
Typ = GetType(Expr).GetField("Tokens").FieldType
...
Dim locbldr196 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(BooleanLiteral))
locbldr196.SetLocalSymInfo("bl1")
OptimizeIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Expr)
OptimizeIL.Emit(OpCodes.Ldfld, GetType(Expr).GetField("Tokens"))
Typ = GetType(Expr).GetField("Tokens").FieldType
...
Dim locbldr197 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(NumberLiteral))
locbldr197.SetLocalSymInfo("nl1")
OptimizeIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Expr)
OptimizeIL.Emit(OpCodes.Ldfld, GetType(Expr).GetField("Tokens"))
Typ = GetType(Expr).GetField("Tokens").FieldType
...
Dim locbldr198 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(NewCallTok))
locbldr198.SetLocalSymInfo("nctoken")
OptimizeIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Expr)
OptimizeIL.Emit(OpCodes.Ldfld, GetType(Expr).GetField("Tokens"))
Typ = GetType(Expr).GetField("Tokens").FieldType
...
Dim locbldr199 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(Expr).MakeArrayType())
locbldr199.SetLocalSymInfo("ncprs")
OptimizeIL.Emit(OpCodes.Ldloc, 34)
Typ = GetType(NewCallTok)
...
Dim locbldr200 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(System.Int32))
locbldr200.SetLocalSymInfo("ncln2")
OptimizeIL.Emit(OpCodes.Ldloc, 35)
...
locbldr201.SetLocalSymInfo("nci2")
OptimizeIL.Emit(OpCodes.Ldc_I4, CInt(-1))
Typ = GetType(System.Int32)
OptimizeIL.Emit(OpCodes.Stloc, 37)
...
OptimizeIL.Emit(OpCodes.Blt, tru173)
...
OptimizeIL.Emit(OpCodes.Beq, fa176)
OptimizeIL.Emit(OpCodes.Br, tru176)
...
Dim locbldr202 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(GettypeCallTok))
locbldr202.SetLocalSymInfo("gtctoken")
...
Dim locbldr203 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(MethodCallTok))
locbldr203.SetLocalSymInfo("mct")
OptimizeIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Expr)
OptimizeIL.Emit(OpCodes.Ldfld, GetType(Expr).GetField("Tokens"))
Typ = GetType(Expr).GetField("Tokens").FieldType
...
Dim locbldr204 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(Expr).MakeArrayType())
locbldr204.SetLocalSymInfo("prs")
OptimizeIL.Emit(OpCodes.Ldloc, 39)
Typ = GetType(MethodCallTok)
...
Dim locbldr205 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(System.Int32))
locbldr205.SetLocalSymInfo("ln2")
OptimizeIL.Emit(OpCodes.Ldloc, 40)
Typ = GetType(Expr).MakeArrayType()
OptimizeIL.Emit(OpCodes.Ldlen)
OptimizeIL.Emit(OpCodes.Conv_I4)
...
Dim locbldr206 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(System.Int32))
locbldr206.SetLocalSymInfo("i2")
OptimizeIL.Emit(OpCodes.Ldc_I4, CInt(-1))
Typ = GetType(System.Int32)
OptimizeIL.Emit(OpCodes.Stloc, 42)
...
OptimizeIL.Emit(OpCodes.Blt, tru180)
...
OptimizeIL.Emit(OpCodes.Beq, tru182)
...
Dim locbldr207 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(Ident))
locbldr207.SetLocalSymInfo("aidt")
OptimizeIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Expr)
OptimizeIL.Emit(OpCodes.Ldfld, GetType(Expr).GetField("Tokens"))
Typ = GetType(Expr).GetField("Tokens").FieldType
...
Dim locbldr208 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(Expr))
locbldr208.SetLocalSymInfo("arriloc")
OptimizeIL.Emit(OpCodes.Ldloc, 43)
Typ = GetType(Ident)
...
Dim locbldr209 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(MethodCallTok))
locbldr209.SetLocalSymInfo("amtd")
OptimizeIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Expr)
OptimizeIL.Emit(OpCodes.Ldfld, GetType(Expr).GetField("Tokens"))
Typ = GetType(Expr).GetField("Tokens").FieldType
...
Dim locbldr210 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(MethodNameTok))
locbldr210.SetLocalSymInfo("amtdn")
OptimizeIL.Emit(OpCodes.Ldloc, 45)
Typ = GetType(MethodCallTok)
...
OptimizeIL.Emit(OpCodes.Bgt, tru185)
...
OptimizeIL.Emit(OpCodes.Bge, tru186)
...
OptimizeIL.Emit(OpCodes.Beq, tru191)
...
OptimizeIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa194 As System.Reflection.Emit.Label = OptimizeIL.DefineLabel()
Dim tru194 As System.Reflection.Emit.Label = OptimizeIL.DefineLabel()
Dim cont194 As System.Reflection.Emit.Label = OptimizeIL.DefineLabel()
OptimizeIL.Emit(OpCodes.Beq, tru194)
OptimizeIL.Emit(OpCodes.Br, fa194)
OptimizeIL.MarkLabel(tru194)
...
OptimizeIL.Emit(OpCodes.Br, cont194)
OptimizeIL.MarkLabel(fa194)
OptimizeIL.Emit(OpCodes.Br, cont194)
OptimizeIL.MarkLabel(cont194)
...
OptimizeIL.Emit(OpCodes.Ldc_I4, CInt(0))
Typ = GetType(System.Int32)
Dim fa195 As System.Reflection.Emit.Label = OptimizeIL.DefineLabel()
Dim tru195 As System.Reflection.Emit.Label = OptimizeIL.DefineLabel()
Dim cont195 As System.Reflection.Emit.Label = OptimizeIL.DefineLabel()
OptimizeIL.Emit(OpCodes.Ble, tru195)
OptimizeIL.Emit(OpCodes.Br, fa195)
OptimizeIL.MarkLabel(tru195)
OptimizeIL.MarkSequencePoint(doc4, 975, 1, 975, 100)
OptimizeIL.Emit(OpCodes.Br, label13)
OptimizeIL.MarkSequencePoint(doc4, 976, 1, 976, 100)
OptimizeIL.Emit(OpCodes.Br, cont195)
OptimizeIL.MarkLabel(fa195)
OptimizeIL.MarkSequencePoint(doc4, 977, 1, 977, 100)
OptimizeIL.Emit(OpCodes.Br, label12)
OptimizeIL.MarkSequencePoint(doc4, 978, 1, 978, 100)
OptimizeIL.Emit(OpCodes.Br, cont195)
OptimizeIL.MarkLabel(cont195)
...
OptimizeIL.Emit(OpCodes.Ldc_I4, 0)
Typ = GetType(System.Boolean)
Dim fa196 As System.Reflection.Emit.Label = OptimizeIL.DefineLabel()
Dim tru196 As System.Reflection.Emit.Label = OptimizeIL.DefineLabel()
Dim cont196 As System.Reflection.Emit.Label = OptimizeIL.DefineLabel()
OptimizeIL.Emit(OpCodes.Beq, tru196)
OptimizeIL.Emit(OpCodes.Br, fa196)
OptimizeIL.MarkLabel(tru196)
OptimizeIL.MarkSequencePoint(doc4, 985, 1, 985, 100)
OptimizeIL.Emit(OpCodes.Ldloc, 4)
Typ = GetType(System.Boolean)
OptimizeIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa197 As System.Reflection.Emit.Label = OptimizeIL.DefineLabel()
Dim tru197 As System.Reflection.Emit.Label = OptimizeIL.DefineLabel()
Dim cont197 As System.Reflection.Emit.Label = OptimizeIL.DefineLabel()
OptimizeIL.Emit(OpCodes.Beq, tru197)
OptimizeIL.Emit(OpCodes.Br, fa197)
OptimizeIL.MarkLabel(tru197)
...
OptimizeIL.Emit(OpCodes.Br, cont197)
OptimizeIL.MarkLabel(fa197)
OptimizeIL.Emit(OpCodes.Br, cont197)
OptimizeIL.MarkLabel(cont197)
OptimizeIL.MarkSequencePoint(doc4, 997, 1, 997, 100)
OptimizeIL.Emit(OpCodes.Br, cont196)
OptimizeIL.MarkLabel(fa196)
...
Dim locbldr211 As LocalBuilder = checkRefasmIL.DeclareLocal(GetType(Token))
locbldr211.SetLocalSymInfo("tok")
...
Dim locbldr212 As LocalBuilder = checkRefasmIL.DeclareLocal(GetType(System.Type))
...
Dim locbldr213 As LocalBuilder = checkRefasmIL.DeclareLocal(GetType(RefasmStmt))
locbldr213.SetLocalSymInfo("refasms")
...
Typ = GetType(System.Boolean)
Dim fa198 As System.Reflection.Emit.Label = checkRefasmIL.DefineLabel()
Dim tru198 As System.Reflection.Emit.Label = checkRefasmIL.DefineLabel()
Dim cont198 As System.Reflection.Emit.Label = checkRefasmIL.DefineLabel()
checkRefasmIL.Emit(OpCodes.Beq, tru198)
checkRefasmIL.Emit(OpCodes.Br, fa198)
checkRefasmIL.MarkLabel(tru198)
...
checkRefasmIL.Emit(OpCodes.Br, cont198)
checkRefasmIL.MarkLabel(fa198)
checkRefasmIL.Emit(OpCodes.Br, cont198)
checkRefasmIL.MarkLabel(cont198)
...
Dim locbldr214 As LocalBuilder = checkIfIL.DeclareLocal(GetType(Token))
locbldr214.SetLocalSymInfo("tok")
...
Dim locbldr215 As LocalBuilder = checkIfIL.DeclareLocal(GetType(System.Type))
...
Dim locbldr216 As LocalBuilder = checkIfIL.DeclareLocal(GetType(IfStmt))
locbldr216.SetLocalSymInfo("ifs")
...
Dim locbldr217 As LocalBuilder = checkIfIL.DeclareLocal(GetType(Expr))
locbldr217.SetLocalSymInfo("exp")
...
Typ = GetType(System.Boolean)
Dim fa199 As System.Reflection.Emit.Label = checkIfIL.DefineLabel()
Dim tru199 As System.Reflection.Emit.Label = checkIfIL.DefineLabel()
Dim cont199 As System.Reflection.Emit.Label = checkIfIL.DefineLabel()
checkIfIL.Emit(OpCodes.Beq, tru199)
checkIfIL.Emit(OpCodes.Br, fa199)
checkIfIL.MarkLabel(tru199)
...
Dim locbldr218 As LocalBuilder = checkIfIL.DeclareLocal(GetType(System.Int32))
locbldr218.SetLocalSymInfo("i")
checkIfIL.Emit(OpCodes.Ldc_I4, CInt(0))
Typ = GetType(System.Int32)
checkIfIL.Emit(OpCodes.Stloc, 4)
checkIfIL.MarkSequencePoint(doc5, 37, 1, 37, 100)
Dim locbldr219 As LocalBuilder = checkIfIL.DeclareLocal(GetType(System.Int32))
locbldr219.SetLocalSymInfo("len")
checkIfIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
checkIfIL.Emit(OpCodes.Ldfld, GetType(Stmt).GetField("Tokens"))
Typ = GetType(Stmt).GetField("Tokens").FieldType
...
Dim locbldr220 As LocalBuilder = checkIfIL.DeclareLocal(GetType(System.Boolean))
locbldr220.SetLocalSymInfo("b2")
...
checkIfIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa200 As System.Reflection.Emit.Label = checkIfIL.DefineLabel()
Dim tru200 As System.Reflection.Emit.Label = checkIfIL.DefineLabel()
Dim cont200 As System.Reflection.Emit.Label = checkIfIL.DefineLabel()
checkIfIL.Emit(OpCodes.Beq, tru200)
checkIfIL.Emit(OpCodes.Br, fa200)
checkIfIL.MarkLabel(tru200)
checkIfIL.MarkSequencePoint(doc5, 53, 1, 53, 100)
checkIfIL.Emit(OpCodes.Br, label0)
checkIfIL.MarkSequencePoint(doc5, 54, 1, 54, 100)
checkIfIL.Emit(OpCodes.Br, cont200)
checkIfIL.MarkLabel(fa200)
...
checkIfIL.Emit(OpCodes.Br, cont200)
checkIfIL.MarkLabel(cont200)
checkIfIL.MarkSequencePoint(doc5, 58, 1, 58, 100)
checkIfIL.Emit(OpCodes.Ldloc, 4)
Typ = GetType(System.Int32)
checkIfIL.Emit(OpCodes.Ldloc, 5)
Typ = GetType(System.Int32)
Dim fa201 As System.Reflection.Emit.Label = checkIfIL.DefineLabel()
Dim tru201 As System.Reflection.Emit.Label = checkIfIL.DefineLabel()
Dim cont201 As System.Reflection.Emit.Label = checkIfIL.DefineLabel()
checkIfIL.Emit(OpCodes.Beq, tru201)
checkIfIL.Emit(OpCodes.Br, fa201)
checkIfIL.MarkLabel(tru201)
checkIfIL.MarkSequencePoint(doc5, 59, 1, 59, 100)
checkIfIL.Emit(OpCodes.Br, label0)
checkIfIL.MarkSequencePoint(doc5, 60, 1, 60, 100)
checkIfIL.Emit(OpCodes.Br, cont201)
checkIfIL.MarkLabel(fa201)
checkIfIL.MarkSequencePoint(doc5, 61, 1, 61, 100)
checkIfIL.Emit(OpCodes.Br, label1)
checkIfIL.MarkSequencePoint(doc5, 62, 1, 62, 100)
checkIfIL.Emit(OpCodes.Br, cont201)
checkIfIL.MarkLabel(cont201)
checkIfIL.MarkSequencePoint(doc5, 64, 1, 64, 100)
checkIfIL.MarkLabel(label0)
checkIfIL.MarkSequencePoint(doc5, 66, 1, 66, 100)
Dim locbldr221 As LocalBuilder = checkIfIL.DeclareLocal(asm.GetType("dylan.NET.Tokenizer.Parser.ExprOptimizer"))
locbldr221.SetLocalSymInfo("eop")
...
checkIfIL.Emit(OpCodes.Br, cont199)
checkIfIL.MarkLabel(fa199)
checkIfIL.Emit(OpCodes.Br, cont199)
checkIfIL.MarkLabel(cont199)
...
Dim locbldr222 As LocalBuilder = checkElseIfIL.DeclareLocal(GetType(Token))
locbldr222.SetLocalSymInfo("tok")
...
Dim locbldr223 As LocalBuilder = checkElseIfIL.DeclareLocal(GetType(System.Type))
...
Dim locbldr224 As LocalBuilder = checkElseIfIL.DeclareLocal(GetType(ElseIfStmt))
locbldr224.SetLocalSymInfo("ifs")
...
Dim locbldr225 As LocalBuilder = checkElseIfIL.DeclareLocal(GetType(Expr))
locbldr225.SetLocalSymInfo("exp")
...
Typ = GetType(System.Boolean)
Dim fa202 As System.Reflection.Emit.Label = checkElseIfIL.DefineLabel()
Dim tru202 As System.Reflection.Emit.Label = checkElseIfIL.DefineLabel()
Dim cont202 As System.Reflection.Emit.Label = checkElseIfIL.DefineLabel()
checkElseIfIL.Emit(OpCodes.Beq, tru202)
checkElseIfIL.Emit(OpCodes.Br, fa202)
checkElseIfIL.MarkLabel(tru202)
...
Dim locbldr226 As LocalBuilder = checkElseIfIL.DeclareLocal(GetType(System.Int32))
locbldr226.SetLocalSymInfo("i")
checkElseIfIL.Emit(OpCodes.Ldc_I4, CInt(0))
Typ = GetType(System.Int32)
checkElseIfIL.Emit(OpCodes.Stloc, 4)
checkElseIfIL.MarkSequencePoint(doc5, 88, 1, 88, 100)
Dim locbldr227 As LocalBuilder = checkElseIfIL.DeclareLocal(GetType(System.Int32))
locbldr227.SetLocalSymInfo("len")
checkElseIfIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
checkElseIfIL.Emit(OpCodes.Ldfld, GetType(Stmt).GetField("Tokens"))
Typ = GetType(Stmt).GetField("Tokens").FieldType
...
Dim locbldr228 As LocalBuilder = checkElseIfIL.DeclareLocal(GetType(System.Boolean))
locbldr228.SetLocalSymInfo("b2")
...
checkElseIfIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa203 As System.Reflection.Emit.Label = checkElseIfIL.DefineLabel()
Dim tru203 As System.Reflection.Emit.Label = checkElseIfIL.DefineLabel()
Dim cont203 As System.Reflection.Emit.Label = checkElseIfIL.DefineLabel()
checkElseIfIL.Emit(OpCodes.Beq, tru203)
checkElseIfIL.Emit(OpCodes.Br, fa203)
checkElseIfIL.MarkLabel(tru203)
...
checkElseIfIL.Emit(OpCodes.Br, cont203)
checkElseIfIL.MarkLabel(fa203)
...
checkElseIfIL.Emit(OpCodes.Br, cont203)
checkElseIfIL.MarkLabel(cont203)
checkElseIfIL.MarkSequencePoint(doc5, 109, 1, 109, 100)
checkElseIfIL.Emit(OpCodes.Ldloc, 4)
Typ = GetType(System.Int32)
checkElseIfIL.Emit(OpCodes.Ldloc, 5)
Typ = GetType(System.Int32)
Dim fa204 As System.Reflection.Emit.Label = checkElseIfIL.DefineLabel()
Dim tru204 As System.Reflection.Emit.Label = checkElseIfIL.DefineLabel()
Dim cont204 As System.Reflection.Emit.Label = checkElseIfIL.DefineLabel()
checkElseIfIL.Emit(OpCodes.Beq, tru204)
checkElseIfIL.Emit(OpCodes.Br, fa204)
checkElseIfIL.MarkLabel(tru204)
checkElseIfIL.MarkSequencePoint(doc5, 110, 1, 110, 100)
checkElseIfIL.Emit(OpCodes.Br, label2)
checkElseIfIL.MarkSequencePoint(doc5, 111, 1, 111, 100)
checkElseIfIL.Emit(OpCodes.Br, cont204)
checkElseIfIL.MarkLabel(fa204)
...
checkElseIfIL.Emit(OpCodes.Br, cont204)
checkElseIfIL.MarkLabel(cont204)
...
Dim locbldr229 As LocalBuilder = checkElseIfIL.DeclareLocal(asm.GetType("dylan.NET.Tokenizer.Parser.ExprOptimizer"))
locbldr229.SetLocalSymInfo("eop")
...
checkElseIfIL.Emit(OpCodes.Br, cont202)
checkElseIfIL.MarkLabel(fa202)
checkElseIfIL.Emit(OpCodes.Br, cont202)
checkElseIfIL.MarkLabel(cont202)
...
Dim locbldr230 As LocalBuilder = checkDebugIL.DeclareLocal(GetType(Token))
locbldr230.SetLocalSymInfo("tok")
...
Dim locbldr231 As LocalBuilder = checkDebugIL.DeclareLocal(GetType(System.Type))
locbldr231.SetLocalSymInfo("typ")
...
Dim locbldr232 As LocalBuilder = checkDebugIL.DeclareLocal(GetType(DebugStmt))
locbldr232.SetLocalSymInfo("dbgs")
...
Typ = GetType(System.Boolean)
Dim fa205 As System.Reflection.Emit.Label = checkDebugIL.DefineLabel()
Dim tru205 As System.Reflection.Emit.Label = checkDebugIL.DefineLabel()
Dim cont205 As System.Reflection.Emit.Label = checkDebugIL.DefineLabel()
checkDebugIL.Emit(OpCodes.Beq, tru205)
checkDebugIL.Emit(OpCodes.Br, fa205)
checkDebugIL.MarkLabel(tru205)
...
checkDebugIL.Emit(OpCodes.Br, cont205)
checkDebugIL.MarkLabel(fa205)
checkDebugIL.Emit(OpCodes.Br, cont205)
checkDebugIL.MarkLabel(cont205)
...
Dim checkScope As MethodBuilder = StmtOptimizer.DefineMethod("checkScope", MethodAttributes.Public, GetType(Stmt), typ21)
Dim checkScopeIL As ILGenerator = checkScope.GetILGenerator()
Dim checkScopeparam01 As ParameterBuilder = checkScope.DefineParameter(1, ParameterAttributes.None, "stm")
Dim checkScopeparam02 As ParameterBuilder = checkScope.DefineParameter(2, ParameterAttributes.None, "b")
checkScopeIL.MarkSequencePoint(doc5, 141, 1, 141, 100)
Dim locbldr233 As LocalBuilder = checkScopeIL.DeclareLocal(GetType(Token))
locbldr233.SetLocalSymInfo("tok")
checkScopeIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
checkScopeIL.Emit(OpCodes.Ldfld, GetType(Stmt).GetField("Tokens"))
Typ = GetType(Stmt).GetField("Tokens").FieldType
Typ02 = Typ
checkScopeIL.Emit(OpCodes.Ldc_I4, CInt(0))
Typ = GetType(System.Int32)
checkScopeIL.Emit(OpCodes.Conv_U)
Typ = Typ02
checkScopeIL.Emit(OpCodes.Ldelem, Typ.GetElementType())
Typ = Typ.GetElementType()
checkScopeIL.Emit(OpCodes.Stloc, 0)
checkScopeIL.MarkSequencePoint(doc5, 142, 1, 142, 100)
Dim locbldr234 As LocalBuilder = checkScopeIL.DeclareLocal(GetType(System.Type))
locbldr234.SetLocalSymInfo("typ")
checkScopeIL.Emit(OpCodes.Ldtoken, GetType(ScopeTok))
Dim typ22 As Type() = {GetType(System.RuntimeTypeHandle)}
checkScopeIL.Emit(OpCodes.Call, GetType(System.Type).GetMethod("GetTypeFromHandle", typ22))
Typ = GetType(System.Type).GetMethod("GetTypeFromHandle", typ22).ReturnType
checkScopeIL.Emit(OpCodes.Stloc, 1)
checkScopeIL.MarkSequencePoint(doc5, 143, 1, 143, 100)
checkScopeIL.Emit(OpCodes.Ldarg, 2)
Typ = GetType(System.Boolean).MakeByRefType()
Typ04 = Typ.GetElementType()
Dim typ23(-1) As Type
checkScopeIL.Emit(OpCodes.Ldloc, 1)
Typ = GetType(System.Type)
Typ03 = Typ
checkScopeIL.Emit(OpCodes.Ldloc, 0)
Typ = GetType(Token)
checkScopeIL.Emit(OpCodes.Box,Typ)
Typ = GetType(System.Object)
ReDim Preserve typ23(UBound(typ23) + 1)
typ23(UBound(typ23)) = Typ
checkScopeIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("IsInstanceOfType", typ23))
Typ = Typ03.GetMethod("IsInstanceOfType", typ23).ReturnType
checkScopeIL.Emit(OpCodes.Stobj, Typ04)
checkScopeIL.MarkSequencePoint(doc5, 144, 1, 144, 100)
Dim locbldr235 As LocalBuilder = checkScopeIL.DeclareLocal(GetType(ScopeStmt))
locbldr235.SetLocalSymInfo("scps")
checkScopeIL.Emit(OpCodes.Newobj, GetType(ScopeStmt).GetConstructor(Type.EmptyTypes))
checkScopeIL.Emit(OpCodes.Stloc, 2)
checkScopeIL.MarkSequencePoint(doc5, 145, 1, 145, 100)
checkScopeIL.Emit(OpCodes.Ldarg, 2)
Typ = GetType(System.Boolean).MakeByRefType()
checkScopeIL.Emit(OpCodes.Ldobj, Typ.GetElementType())
Typ = Typ.GetElementType()
checkScopeIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa206 As System.Reflection.Emit.Label = checkScopeIL.DefineLabel()
Dim tru206 As System.Reflection.Emit.Label = checkScopeIL.DefineLabel()
Dim cont206 As System.Reflection.Emit.Label = checkScopeIL.DefineLabel()
checkScopeIL.Emit(OpCodes.Beq, tru206)
checkScopeIL.Emit(OpCodes.Br, fa206)
checkScopeIL.MarkLabel(tru206)
checkScopeIL.MarkSequencePoint(doc5, 146, 1, 146, 100)
checkScopeIL.Emit(OpCodes.Ldloc, 2)
Typ = GetType(ScopeStmt)
checkScopeIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
checkScopeIL.Emit(OpCodes.Ldfld, GetType(Stmt).GetField("Line"))
Typ = GetType(Stmt).GetField("Line").FieldType
checkScopeIL.Emit(OpCodes.Stfld, GetType(ScopeStmt).GetField("Line"))
checkScopeIL.MarkSequencePoint(doc5, 147, 1, 147, 100)
checkScopeIL.Emit(OpCodes.Ldloc, 2)
Typ = GetType(ScopeStmt)
checkScopeIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
checkScopeIL.Emit(OpCodes.Ldfld, GetType(Stmt).GetField("Tokens"))
Typ = GetType(Stmt).GetField("Tokens").FieldType
checkScopeIL.Emit(OpCodes.Stfld, GetType(ScopeStmt).GetField("Tokens"))
checkScopeIL.MarkSequencePoint(doc5, 148, 1, 148, 100)
checkScopeIL.Emit(OpCodes.Ldloc, 2)
Typ = GetType(ScopeStmt)
checkScopeIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
...
Typ = GetType(Stmt).GetField("Tokens").FieldType
Typ02 = Typ
checkScopeIL.Emit(OpCodes.Ldc_I4, CInt(1))
Typ = GetType(System.Int32)
checkScopeIL.Emit(OpCodes.Conv_U)
Typ = Typ02
checkScopeIL.Emit(OpCodes.Ldelem, Typ.GetElementType())
Typ = Typ.GetElementType()
checkScopeIL.Emit(OpCodes.Stfld, GetType(ScopeStmt).GetField("Opt"))
checkScopeIL.MarkSequencePoint(doc5, 149, 1, 149, 100)
checkScopeIL.Emit(OpCodes.Ldloc, 2)
Typ = GetType(ScopeStmt)
Typ03 = Typ
checkScopeIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("setFlg", Type.EmptyTypes))
Typ = Typ03.GetMethod("setFlg", Type.EmptyTypes).ReturnType
If Typ.ToString() = GetType(System.Void).ToString() Then

Else
checkScopeIL.Emit(OpCodes.Pop)
End If
checkScopeIL.MarkSequencePoint(doc5, 150, 1, 150, 100)
checkScopeIL.Emit(OpCodes.Br, cont206)
checkScopeIL.MarkLabel(fa206)
checkScopeIL.Emit(OpCodes.Br, cont206)
checkScopeIL.MarkLabel(cont206)
checkScopeIL.MarkSequencePoint(doc5, 151, 1, 151, 100)
checkScopeIL.Emit(OpCodes.Ldloc, 2)
Typ = GetType(ScopeStmt)
checkScopeIL.MarkSequencePoint(doc5, 152, 1, 152, 100)
checkScopeIL.Emit(OpCodes.Ret)
Dim typ25(-1) As Type
ReDim Preserve typ25(UBound(typ25) + 1)
typ25(UBound(typ25)) = GetType(Stmt)
ReDim Preserve typ25(UBound(typ25) + 1)
typ25(UBound(typ25)) = GetType(System.Boolean).MakeByRefType()
Dim checkImport As MethodBuilder = StmtOptimizer.DefineMethod("checkImport", MethodAttributes.Public, GetType(Stmt), typ25)
...
checkImportIL.MarkSequencePoint(doc5, 155, 1, 155, 100)
Dim locbldr236 As LocalBuilder = checkImportIL.DeclareLocal(GetType(Token))
locbldr236.SetLocalSymInfo("tok")
...
checkImportIL.MarkSequencePoint(doc5, 156, 1, 156, 100)
Dim locbldr237 As LocalBuilder = checkImportIL.DeclareLocal(GetType(System.Type))
locbldr237.SetLocalSymInfo("typ")
checkImportIL.Emit(OpCodes.Ldtoken, GetType(ImportTok))
Dim typ26 As Type() = {GetType(System.RuntimeTypeHandle)}
checkImportIL.Emit(OpCodes.Call, GetType(System.Type).GetMethod("GetTypeFromHandle", typ26))
Typ = GetType(System.Type).GetMethod("GetTypeFromHandle", typ26).ReturnType
checkImportIL.Emit(OpCodes.Stloc, 1)
checkImportIL.MarkSequencePoint(doc5, 157, 1, 157, 100)
...
ReDim Preserve typ27(UBound(typ27) + 1)
typ27(UBound(typ27)) = Typ
checkImportIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("IsInstanceOfType", typ27))
Typ = Typ03.GetMethod("IsInstanceOfType", typ27).ReturnType
checkImportIL.Emit(OpCodes.Stobj, Typ04)
checkImportIL.MarkSequencePoint(doc5, 158, 1, 158, 100)
Dim locbldr238 As LocalBuilder = checkImportIL.DeclareLocal(GetType(ImportStmt))
locbldr238.SetLocalSymInfo("imps")
checkImportIL.Emit(OpCodes.Newobj, GetType(ImportStmt).GetConstructor(Type.EmptyTypes))
checkImportIL.Emit(OpCodes.Stloc, 2)
checkImportIL.MarkSequencePoint(doc5, 159, 1, 159, 100)
checkImportIL.Emit(OpCodes.Ldarg, 2)
Typ = GetType(System.Boolean).MakeByRefType()
...
Typ = GetType(System.Boolean)
Dim fa207 As System.Reflection.Emit.Label = checkImportIL.DefineLabel()
Dim tru207 As System.Reflection.Emit.Label = checkImportIL.DefineLabel()
Dim cont207 As System.Reflection.Emit.Label = checkImportIL.DefineLabel()
checkImportIL.Emit(OpCodes.Beq, tru207)
checkImportIL.Emit(OpCodes.Br, fa207)
checkImportIL.MarkLabel(tru207)
checkImportIL.MarkSequencePoint(doc5, 160, 1, 160, 100)
...
checkImportIL.MarkSequencePoint(doc5, 161, 1, 161, 100)
checkImportIL.Emit(OpCodes.Ldloc, 2)
Typ = GetType(ImportStmt)
checkImportIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
...
checkImportIL.MarkSequencePoint(doc5, 162, 1, 162, 100)
checkImportIL.Emit(OpCodes.Ldloc, 2)
Typ = GetType(ImportStmt)
checkImportIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
...
checkImportIL.MarkSequencePoint(doc5, 163, 1, 163, 100)
checkImportIL.Emit(OpCodes.Br, cont207)
checkImportIL.MarkLabel(fa207)
checkImportIL.Emit(OpCodes.Br, cont207)
checkImportIL.MarkLabel(cont207)
checkImportIL.MarkSequencePoint(doc5, 164, 1, 164, 100)
checkImportIL.Emit(OpCodes.Ldloc, 2)
Typ = GetType(ImportStmt)
checkImportIL.MarkSequencePoint(doc5, 165, 1, 165, 100)
checkImportIL.Emit(OpCodes.Ret)
Dim typ28(-1) As Type
ReDim Preserve typ28(UBound(typ28) + 1)
typ28(UBound(typ28)) = GetType(Stmt)
ReDim Preserve typ28(UBound(typ28) + 1)
typ28(UBound(typ28)) = GetType(System.Boolean).MakeByRefType()
Dim checkLocimport As MethodBuilder = StmtOptimizer.DefineMethod("checkLocimport", MethodAttributes.Public, GetType(Stmt), typ28)
...
checkLocimportIL.MarkSequencePoint(doc5, 168, 1, 168, 100)
Dim locbldr239 As LocalBuilder = checkLocimportIL.DeclareLocal(GetType(Token))
locbldr239.SetLocalSymInfo("tok")
...
checkLocimportIL.MarkSequencePoint(doc5, 169, 1, 169, 100)
Dim locbldr240 As LocalBuilder = checkLocimportIL.DeclareLocal(GetType(System.Type))
locbldr240.SetLocalSymInfo("typ")
checkLocimportIL.Emit(OpCodes.Ldtoken, GetType(LocimportTok))
Dim typ29 As Type() = {GetType(System.RuntimeTypeHandle)}
checkLocimportIL.Emit(OpCodes.Call, GetType(System.Type).GetMethod("GetTypeFromHandle", typ29))
Typ = GetType(System.Type).GetMethod("GetTypeFromHandle", typ29).ReturnType
checkLocimportIL.Emit(OpCodes.Stloc, 1)
checkLocimportIL.MarkSequencePoint(doc5, 170, 1, 170, 100)
...
ReDim Preserve typ30(UBound(typ30) + 1)
typ30(UBound(typ30)) = Typ
checkLocimportIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("IsInstanceOfType", typ30))
Typ = Typ03.GetMethod("IsInstanceOfType", typ30).ReturnType
checkLocimportIL.Emit(OpCodes.Stobj, Typ04)
checkLocimportIL.MarkSequencePoint(doc5, 171, 1, 171, 100)
Dim locbldr241 As LocalBuilder = checkLocimportIL.DeclareLocal(GetType(LocimportStmt))
locbldr241.SetLocalSymInfo("limps")
...
checkLocimportIL.MarkSequencePoint(doc5, 172, 1, 172, 100)
checkLocimportIL.Emit(OpCodes.Ldarg, 2)
Typ = GetType(System.Boolean).MakeByRefType()
...
Typ = GetType(System.Boolean)
Dim fa208 As System.Reflection.Emit.Label = checkLocimportIL.DefineLabel()
Dim tru208 As System.Reflection.Emit.Label = checkLocimportIL.DefineLabel()
Dim cont208 As System.Reflection.Emit.Label = checkLocimportIL.DefineLabel()
checkLocimportIL.Emit(OpCodes.Beq, tru208)
checkLocimportIL.Emit(OpCodes.Br, fa208)
checkLocimportIL.MarkLabel(tru208)
checkLocimportIL.MarkSequencePoint(doc5, 173, 1, 173, 100)
...
checkLocimportIL.MarkSequencePoint(doc5, 174, 1, 174, 100)
checkLocimportIL.Emit(OpCodes.Ldloc, 2)
Typ = GetType(LocimportStmt)
checkLocimportIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
...
checkLocimportIL.MarkSequencePoint(doc5, 175, 1, 175, 100)
checkLocimportIL.Emit(OpCodes.Ldloc, 2)
Typ = GetType(LocimportStmt)
checkLocimportIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
...
checkLocimportIL.MarkSequencePoint(doc5, 176, 1, 176, 100)
checkLocimportIL.Emit(OpCodes.Br, cont208)
checkLocimportIL.MarkLabel(fa208)
checkLocimportIL.Emit(OpCodes.Br, cont208)
checkLocimportIL.MarkLabel(cont208)
checkLocimportIL.MarkSequencePoint(doc5, 177, 1, 177, 100)
checkLocimportIL.Emit(OpCodes.Ldloc, 2)
Typ = GetType(LocimportStmt)
checkLocimportIL.MarkSequencePoint(doc5, 178, 1, 178, 100)
checkLocimportIL.Emit(OpCodes.Ret)
Dim typ31(-1) As Type
ReDim Preserve typ31(UBound(typ31) + 1)
typ31(UBound(typ31)) = GetType(Stmt)
ReDim Preserve typ31(UBound(typ31) + 1)
typ31(UBound(typ31)) = GetType(System.Boolean).MakeByRefType()
Dim checkReturn As MethodBuilder = StmtOptimizer.DefineMethod("checkReturn", MethodAttributes.Public, GetType(Stmt), typ31)
Dim checkReturnIL As ILGenerator = checkReturn.GetILGenerator()
Dim checkReturnparam01 As ParameterBuilder = checkReturn.DefineParameter(1, ParameterAttributes.None, "stm")
Dim checkReturnparam02 As ParameterBuilder = checkReturn.DefineParameter(2, ParameterAttributes.None, "b")
checkReturnIL.MarkSequencePoint(doc5, 181, 1, 181, 100)
Dim locbldr242 As LocalBuilder = checkReturnIL.DeclareLocal(GetType(Token))
locbldr242.SetLocalSymInfo("tok")
checkReturnIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
checkReturnIL.Emit(OpCodes.Ldfld, GetType(Stmt).GetField("Tokens"))
Typ = GetType(Stmt).GetField("Tokens").FieldType
Typ02 = Typ
checkReturnIL.Emit(OpCodes.Ldc_I4, CInt(0))
Typ = GetType(System.Int32)
checkReturnIL.Emit(OpCodes.Conv_U)
Typ = Typ02
checkReturnIL.Emit(OpCodes.Ldelem, Typ.GetElementType())
Typ = Typ.GetElementType()
checkReturnIL.Emit(OpCodes.Stloc, 0)
checkReturnIL.MarkSequencePoint(doc5, 182, 1, 182, 100)
Dim locbldr243 As LocalBuilder = checkReturnIL.DeclareLocal(GetType(System.Type))
locbldr243.SetLocalSymInfo("typ")
checkReturnIL.Emit(OpCodes.Ldtoken, GetType(ReturnTok))
Dim typ32 As Type() = {GetType(System.RuntimeTypeHandle)}
checkReturnIL.Emit(OpCodes.Call, GetType(System.Type).GetMethod("GetTypeFromHandle", typ32))
Typ = GetType(System.Type).GetMethod("GetTypeFromHandle", typ32).ReturnType
checkReturnIL.Emit(OpCodes.Stloc, 1)
checkReturnIL.MarkSequencePoint(doc5, 183, 1, 183, 100)
checkReturnIL.Emit(OpCodes.Ldarg, 2)
Typ = GetType(System.Boolean).MakeByRefType()
Typ04 = Typ.GetElementType()
Dim typ33(-1) As Type
checkReturnIL.Emit(OpCodes.Ldloc, 1)
Typ = GetType(System.Type)
Typ03 = Typ
checkReturnIL.Emit(OpCodes.Ldloc, 0)
Typ = GetType(Token)
checkReturnIL.Emit(OpCodes.Box,Typ)
Typ = GetType(System.Object)
ReDim Preserve typ33(UBound(typ33) + 1)
typ33(UBound(typ33)) = Typ
checkReturnIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("IsInstanceOfType", typ33))
Typ = Typ03.GetMethod("IsInstanceOfType", typ33).ReturnType
checkReturnIL.Emit(OpCodes.Stobj, Typ04)
checkReturnIL.MarkSequencePoint(doc5, 184, 1, 184, 100)
Dim locbldr244 As LocalBuilder = checkReturnIL.DeclareLocal(GetType(ReturnStmt))
locbldr244.SetLocalSymInfo("rets")
checkReturnIL.Emit(OpCodes.Newobj, GetType(ReturnStmt).GetConstructor(Type.EmptyTypes))
checkReturnIL.Emit(OpCodes.Stloc, 2)
checkReturnIL.MarkSequencePoint(doc5, 185, 1, 185, 100)
checkReturnIL.Emit(OpCodes.Ldarg, 2)
Typ = GetType(System.Boolean).MakeByRefType()
checkReturnIL.Emit(OpCodes.Ldobj, Typ.GetElementType())
Typ = Typ.GetElementType()
checkReturnIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa209 As System.Reflection.Emit.Label = checkReturnIL.DefineLabel()
Dim tru209 As System.Reflection.Emit.Label = checkReturnIL.DefineLabel()
Dim cont209 As System.Reflection.Emit.Label = checkReturnIL.DefineLabel()
checkReturnIL.Emit(OpCodes.Beq, tru209)
checkReturnIL.Emit(OpCodes.Br, fa209)
checkReturnIL.MarkLabel(tru209)
checkReturnIL.MarkSequencePoint(doc5, 187, 1, 187, 100)
checkReturnIL.Emit(OpCodes.Ldloc, 2)
Typ = GetType(ReturnStmt)
checkReturnIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
checkReturnIL.Emit(OpCodes.Ldfld, GetType(Stmt).GetField("Line"))
Typ = GetType(Stmt).GetField("Line").FieldType
checkReturnIL.Emit(OpCodes.Stfld, GetType(ReturnStmt).GetField("Line"))
checkReturnIL.MarkSequencePoint(doc5, 188, 1, 188, 100)
checkReturnIL.Emit(OpCodes.Ldloc, 2)
Typ = GetType(ReturnStmt)
checkReturnIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
checkReturnIL.Emit(OpCodes.Ldfld, GetType(Stmt).GetField("Tokens"))
Typ = GetType(Stmt).GetField("Tokens").FieldType
checkReturnIL.Emit(OpCodes.Stfld, GetType(ReturnStmt).GetField("Tokens"))
checkReturnIL.MarkSequencePoint(doc5, 190, 1, 190, 100)
Dim label4 As System.Reflection.Emit.Label = checkReturnIL.DefineLabel()
checkReturnIL.MarkSequencePoint(doc5, 191, 1, 191, 100)
Dim label5 As System.Reflection.Emit.Label = checkReturnIL.DefineLabel()
checkReturnIL.MarkSequencePoint(doc5, 192, 1, 192, 100)
Dim label6 As System.Reflection.Emit.Label = checkReturnIL.DefineLabel()
checkReturnIL.MarkSequencePoint(doc5, 194, 1, 194, 100)
Dim locbldr245 As LocalBuilder = checkReturnIL.DeclareLocal(GetType(System.Int32))
locbldr245.SetLocalSymInfo("i")
checkReturnIL.Emit(OpCodes.Ldc_I4, CInt(0))
Typ = GetType(System.Int32)
checkReturnIL.Emit(OpCodes.Stloc, 3)
checkReturnIL.MarkSequencePoint(doc5, 195, 1, 195, 100)
Dim locbldr246 As LocalBuilder = checkReturnIL.DeclareLocal(GetType(System.Int32))
locbldr246.SetLocalSymInfo("len")
checkReturnIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
checkReturnIL.Emit(OpCodes.Ldfld, GetType(Stmt).GetField("Tokens"))
Typ = GetType(Stmt).GetField("Tokens").FieldType
checkReturnIL.Emit(OpCodes.Ldlen)
checkReturnIL.Emit(OpCodes.Conv_I4)
Typ = GetType(System.Int32)
checkReturnIL.Emit(OpCodes.Ldc_I4, CInt(1))
Typ = GetType(System.Int32)
checkReturnIL.Emit(OpCodes.Sub)
checkReturnIL.Emit(OpCodes.Stloc, 4)
checkReturnIL.MarkSequencePoint(doc5, 196, 1, 196, 100)
Dim locbldr247 As LocalBuilder = checkReturnIL.DeclareLocal(GetType(Expr))
locbldr247.SetLocalSymInfo("exp")
checkReturnIL.Emit(OpCodes.Ldnull)
checkReturnIL.Emit(OpCodes.Stloc, 5)
checkReturnIL.MarkSequencePoint(doc5, 198, 1, 198, 100)
checkReturnIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
checkReturnIL.Emit(OpCodes.Ldfld, GetType(Stmt).GetField("Tokens"))
Typ = GetType(Stmt).GetField("Tokens").FieldType
...
checkReturnIL.Emit(OpCodes.Ldc_I4, CInt(1))
Typ = GetType(System.Int32)
Dim fa210 As System.Reflection.Emit.Label = checkReturnIL.DefineLabel()
Dim tru210 As System.Reflection.Emit.Label = checkReturnIL.DefineLabel()
Dim cont210 As System.Reflection.Emit.Label = checkReturnIL.DefineLabel()
checkReturnIL.Emit(OpCodes.Beq, tru210)
checkReturnIL.Emit(OpCodes.Br, fa210)
checkReturnIL.MarkLabel(tru210)
checkReturnIL.MarkSequencePoint(doc5, 199, 1, 199, 100)
checkReturnIL.Emit(OpCodes.Ldloc, 2)
Typ = GetType(ReturnStmt)
checkReturnIL.Emit(OpCodes.Ldnull)
checkReturnIL.Emit(OpCodes.Stfld, GetType(ReturnStmt).GetField("RExp"))
checkReturnIL.MarkSequencePoint(doc5, 200, 1, 200, 100)
checkReturnIL.Emit(OpCodes.Br, label4)
checkReturnIL.MarkSequencePoint(doc5, 201, 1, 201, 100)
checkReturnIL.Emit(OpCodes.Br, cont210)
checkReturnIL.MarkLabel(fa210)
checkReturnIL.Emit(OpCodes.Br, cont210)
checkReturnIL.MarkLabel(cont210)
checkReturnIL.MarkSequencePoint(doc5, 203, 1, 203, 100)
checkReturnIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
checkReturnIL.Emit(OpCodes.Ldfld, GetType(Stmt).GetField("Tokens"))
Typ = GetType(Stmt).GetField("Tokens").FieldType
...
checkReturnIL.Emit(OpCodes.Conv_I4)
Typ = GetType(System.Int32)
checkReturnIL.Emit(OpCodes.Ldc_I4, CInt(2))
Typ = GetType(System.Int32)
Dim fa211 As System.Reflection.Emit.Label = checkReturnIL.DefineLabel()
Dim tru211 As System.Reflection.Emit.Label = checkReturnIL.DefineLabel()
Dim cont211 As System.Reflection.Emit.Label = checkReturnIL.DefineLabel()
checkReturnIL.Emit(OpCodes.Bge, tru211)
checkReturnIL.Emit(OpCodes.Br, fa211)
checkReturnIL.MarkLabel(tru211)
checkReturnIL.MarkSequencePoint(doc5, 205, 1, 205, 100)
checkReturnIL.Emit(OpCodes.Newobj, GetType(Expr).GetConstructor(Type.EmptyTypes))
checkReturnIL.Emit(OpCodes.Stloc, 5)
checkReturnIL.MarkSequencePoint(doc5, 207, 1, 207, 100)
checkReturnIL.MarkLabel(label5)
checkReturnIL.MarkSequencePoint(doc5, 209, 1, 209, 100)
checkReturnIL.Emit(OpCodes.Ldloc, 3)
Typ = GetType(System.Int32)
checkReturnIL.Emit(OpCodes.Ldc_I4, CInt(1))
Typ = GetType(System.Int32)
checkReturnIL.Emit(OpCodes.Add)
checkReturnIL.Emit(OpCodes.Stloc, 3)
checkReturnIL.MarkSequencePoint(doc5, 211, 1, 211, 100)
Dim typ34(-1) As Type
checkReturnIL.Emit(OpCodes.Ldloc, 5)
Typ = GetType(Expr)
Typ03 = Typ
checkReturnIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
...
ReDim Preserve typ34(UBound(typ34) + 1)
typ34(UBound(typ34)) = Typ
checkReturnIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("AddToken", typ34))
Typ = Typ03.GetMethod("AddToken", typ34).ReturnType
If Typ.ToString() = GetType(System.Void).ToString() Then

Else
checkReturnIL.Emit(OpCodes.Pop)
End If
checkReturnIL.MarkSequencePoint(doc5, 213, 1, 213, 100)
checkReturnIL.Emit(OpCodes.Ldloc, 3)
Typ = GetType(System.Int32)
checkReturnIL.Emit(OpCodes.Ldloc, 4)
Typ = GetType(System.Int32)
Dim fa212 As System.Reflection.Emit.Label = checkReturnIL.DefineLabel()
Dim tru212 As System.Reflection.Emit.Label = checkReturnIL.DefineLabel()
Dim cont212 As System.Reflection.Emit.Label = checkReturnIL.DefineLabel()
checkReturnIL.Emit(OpCodes.Beq, tru212)
checkReturnIL.Emit(OpCodes.Br, fa212)
checkReturnIL.MarkLabel(tru212)
checkReturnIL.MarkSequencePoint(doc5, 214, 1, 214, 100)
checkReturnIL.Emit(OpCodes.Br, label6)
checkReturnIL.MarkSequencePoint(doc5, 215, 1, 215, 100)
checkReturnIL.Emit(OpCodes.Br, cont212)
checkReturnIL.MarkLabel(fa212)
checkReturnIL.MarkSequencePoint(doc5, 216, 1, 216, 100)
checkReturnIL.Emit(OpCodes.Br, label5)
checkReturnIL.MarkSequencePoint(doc5, 217, 1, 217, 100)
checkReturnIL.Emit(OpCodes.Br, cont212)
checkReturnIL.MarkLabel(cont212)
checkReturnIL.MarkSequencePoint(doc5, 219, 1, 219, 100)
checkReturnIL.MarkLabel(label6)
checkReturnIL.MarkSequencePoint(doc5, 221, 1, 221, 100)
Dim locbldr248 As LocalBuilder = checkReturnIL.DeclareLocal(asm.GetType("dylan.NET.Tokenizer.Parser.ExprOptimizer"))
locbldr248.SetLocalSymInfo("eopt")
checkReturnIL.Emit(OpCodes.Newobj, asm.GetType("dylan.NET.Tokenizer.Parser.ExprOptimizer").GetConstructor(Type.EmptyTypes))
checkReturnIL.Emit(OpCodes.Stloc, 6)
checkReturnIL.MarkSequencePoint(doc5, 222, 1, 222, 100)
Dim typ35(-1) As Type
checkReturnIL.Emit(OpCodes.Ldloc, 6)
Typ = asm.GetType("dylan.NET.Tokenizer.Parser.ExprOptimizer")
Typ03 = Typ
checkReturnIL.Emit(OpCodes.Ldloc, 5)
Typ = GetType(Expr)
ReDim Preserve typ35(UBound(typ35) + 1)
typ35(UBound(typ35)) = Typ
checkReturnIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("Optimize", typ35))
Typ = Typ03.GetMethod("Optimize", typ35).ReturnType
checkReturnIL.Emit(OpCodes.Stloc, 5)
checkReturnIL.MarkSequencePoint(doc5, 223, 1, 223, 100)
checkReturnIL.Emit(OpCodes.Ldloc, 2)
Typ = GetType(ReturnStmt)
checkReturnIL.Emit(OpCodes.Ldloc, 5)
Typ = GetType(Expr)
checkReturnIL.Emit(OpCodes.Stfld, GetType(ReturnStmt).GetField("RExp"))
checkReturnIL.MarkSequencePoint(doc5, 225, 1, 225, 100)
checkReturnIL.Emit(OpCodes.Br, cont211)
checkReturnIL.MarkLabel(fa211)
checkReturnIL.Emit(OpCodes.Br, cont211)
checkReturnIL.MarkLabel(cont211)
checkReturnIL.MarkSequencePoint(doc5, 227, 1, 227, 100)
checkReturnIL.MarkLabel(label4)
checkReturnIL.MarkSequencePoint(doc5, 229, 1, 229, 100)
checkReturnIL.Emit(OpCodes.Br, cont209)
checkReturnIL.MarkLabel(fa209)
checkReturnIL.Emit(OpCodes.Br, cont209)
checkReturnIL.MarkLabel(cont209)
checkReturnIL.MarkSequencePoint(doc5, 231, 1, 231, 100)
checkReturnIL.Emit(OpCodes.Ldloc, 2)
Typ = GetType(ReturnStmt)
checkReturnIL.MarkSequencePoint(doc5, 232, 1, 232, 100)
checkReturnIL.Emit(OpCodes.Ret)
Dim typ36(-1) As Type
ReDim Preserve typ36(UBound(typ36) + 1)
typ36(UBound(typ36)) = GetType(Stmt)
ReDim Preserve typ36(UBound(typ36) + 1)
typ36(UBound(typ36)) = GetType(System.Boolean).MakeByRefType()
Dim checkCmt As MethodBuilder = StmtOptimizer.DefineMethod("checkCmt", MethodAttributes.Public, GetType(Stmt), typ36)
...
checkCmtIL.MarkSequencePoint(doc5, 235, 1, 235, 100)
Dim locbldr249 As LocalBuilder = checkCmtIL.DeclareLocal(GetType(Token))
locbldr249.SetLocalSymInfo("tok")
...
checkCmtIL.MarkSequencePoint(doc5, 236, 1, 236, 100)
Dim locbldr250 As LocalBuilder = checkCmtIL.DeclareLocal(GetType(System.Type))
locbldr250.SetLocalSymInfo("typ")
checkCmtIL.Emit(OpCodes.Ldtoken, GetType(CommentTok))
Dim typ37 As Type() = {GetType(System.RuntimeTypeHandle)}
checkCmtIL.Emit(OpCodes.Call, GetType(System.Type).GetMethod("GetTypeFromHandle", typ37))
Typ = GetType(System.Type).GetMethod("GetTypeFromHandle", typ37).ReturnType
checkCmtIL.Emit(OpCodes.Stloc, 1)
checkCmtIL.MarkSequencePoint(doc5, 237, 1, 237, 100)
...
ReDim Preserve typ38(UBound(typ38) + 1)
typ38(UBound(typ38)) = Typ
checkCmtIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("IsInstanceOfType", typ38))
Typ = Typ03.GetMethod("IsInstanceOfType", typ38).ReturnType
checkCmtIL.Emit(OpCodes.Stobj, Typ04)
checkCmtIL.MarkSequencePoint(doc5, 238, 1, 238, 100)
Dim locbldr251 As LocalBuilder = checkCmtIL.DeclareLocal(GetType(CommentStmt))
locbldr251.SetLocalSymInfo("cmts")
checkCmtIL.Emit(OpCodes.Newobj, GetType(CommentStmt).GetConstructor(Type.EmptyTypes))
checkCmtIL.Emit(OpCodes.Stloc, 2)
checkCmtIL.MarkSequencePoint(doc5, 239, 1, 239, 100)
checkCmtIL.Emit(OpCodes.Ldarg, 2)
Typ = GetType(System.Boolean).MakeByRefType()
...
Typ = GetType(System.Boolean)
Dim fa213 As System.Reflection.Emit.Label = checkCmtIL.DefineLabel()
Dim tru213 As System.Reflection.Emit.Label = checkCmtIL.DefineLabel()
Dim cont213 As System.Reflection.Emit.Label = checkCmtIL.DefineLabel()
checkCmtIL.Emit(OpCodes.Beq, tru213)
checkCmtIL.Emit(OpCodes.Br, fa213)
checkCmtIL.MarkLabel(tru213)
checkCmtIL.MarkSequencePoint(doc5, 240, 1, 240, 100)
...
checkCmtIL.MarkSequencePoint(doc5, 241, 1, 241, 100)
checkCmtIL.Emit(OpCodes.Ldloc, 2)
Typ = GetType(CommentStmt)
checkCmtIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
...
checkCmtIL.MarkSequencePoint(doc5, 242, 1, 242, 100)
checkCmtIL.Emit(OpCodes.Br, cont213)
checkCmtIL.MarkLabel(fa213)
checkCmtIL.Emit(OpCodes.Br, cont213)
checkCmtIL.MarkLabel(cont213)
checkCmtIL.MarkSequencePoint(doc5, 243, 1, 243, 100)
checkCmtIL.Emit(OpCodes.Ldloc, 2)
Typ = GetType(CommentStmt)
checkCmtIL.MarkSequencePoint(doc5, 244, 1, 244, 100)
checkCmtIL.Emit(OpCodes.Ret)
Dim typ39(-1) As Type
ReDim Preserve typ39(UBound(typ39) + 1)
typ39(UBound(typ39)) = GetType(Stmt)
ReDim Preserve typ39(UBound(typ39) + 1)
typ39(UBound(typ39)) = GetType(System.Boolean).MakeByRefType()
Dim checkElse As MethodBuilder = StmtOptimizer.DefineMethod("checkElse", MethodAttributes.Public, GetType(Stmt), typ39)
...
checkElseIL.MarkSequencePoint(doc5, 247, 1, 247, 100)
...
Typ = GetType(System.Int32)
Dim fa214 As System.Reflection.Emit.Label = checkElseIL.DefineLabel()
Dim tru214 As System.Reflection.Emit.Label = checkElseIL.DefineLabel()
Dim cont214 As System.Reflection.Emit.Label = checkElseIL.DefineLabel()
checkElseIL.Emit(OpCodes.Blt, tru214)
checkElseIL.Emit(OpCodes.Br, fa214)
checkElseIL.MarkLabel(tru214)
checkElseIL.MarkSequencePoint(doc5, 249, 1, 249, 100)
Dim locbldr252 As LocalBuilder = checkElseIL.DeclareLocal(GetType(Token))
locbldr252.SetLocalSymInfo("tok1")
checkElseIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
checkElseIL.Emit(OpCodes.Ldfld, GetType(Stmt).GetField("Tokens"))
Typ = GetType(Stmt).GetField("Tokens").FieldType
...
checkElseIL.MarkSequencePoint(doc5, 250, 1, 250, 100)
Dim locbldr253 As LocalBuilder = checkElseIL.DeclareLocal(GetType(System.Type))
locbldr253.SetLocalSymInfo("typ1")
checkElseIL.Emit(OpCodes.Ldtoken, GetType(ElseTok))
Dim typ40 As Type() = {GetType(System.RuntimeTypeHandle)}
checkElseIL.Emit(OpCodes.Call, GetType(System.Type).GetMethod("GetTypeFromHandle", typ40))
Typ = GetType(System.Type).GetMethod("GetTypeFromHandle", typ40).ReturnType
checkElseIL.Emit(OpCodes.Stloc, 1)
checkElseIL.MarkSequencePoint(doc5, 251, 1, 251, 100)
Dim locbldr254 As LocalBuilder = checkElseIL.DeclareLocal(GetType(System.Boolean))
locbldr254.SetLocalSymInfo("b1")
Dim typ41(-1) As Type
...
ReDim Preserve typ41(UBound(typ41) + 1)
typ41(UBound(typ41)) = Typ
checkElseIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("IsInstanceOfType", typ41))
Typ = Typ03.GetMethod("IsInstanceOfType", typ41).ReturnType
checkElseIL.Emit(OpCodes.Stloc, 2)
checkElseIL.MarkSequencePoint(doc5, 253, 1, 253, 100)
...
checkElseIL.MarkSequencePoint(doc5, 255, 1, 255, 100)
Dim locbldr255 As LocalBuilder = checkElseIL.DeclareLocal(GetType(ElseStmt))
locbldr255.SetLocalSymInfo("els")
checkElseIL.Emit(OpCodes.Newobj, GetType(ElseStmt).GetConstructor(Type.EmptyTypes))
checkElseIL.Emit(OpCodes.Stloc, 3)
checkElseIL.MarkSequencePoint(doc5, 256, 1, 256, 100)
checkElseIL.Emit(OpCodes.Ldarg, 2)
Typ = GetType(System.Boolean).MakeByRefType()
...
Typ = GetType(System.Boolean)
Dim fa215 As System.Reflection.Emit.Label = checkElseIL.DefineLabel()
Dim tru215 As System.Reflection.Emit.Label = checkElseIL.DefineLabel()
Dim cont215 As System.Reflection.Emit.Label = checkElseIL.DefineLabel()
checkElseIL.Emit(OpCodes.Beq, tru215)
checkElseIL.Emit(OpCodes.Br, fa215)
checkElseIL.MarkLabel(tru215)
checkElseIL.MarkSequencePoint(doc5, 257, 1, 257, 100)
...
checkElseIL.MarkSequencePoint(doc5, 258, 1, 258, 100)
checkElseIL.Emit(OpCodes.Ldloc, 3)
Typ = GetType(ElseStmt)
checkElseIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
...
checkElseIL.MarkSequencePoint(doc5, 259, 1, 259, 100)
checkElseIL.Emit(OpCodes.Br, cont215)
checkElseIL.MarkLabel(fa215)
checkElseIL.Emit(OpCodes.Br, cont215)
checkElseIL.MarkLabel(cont215)
checkElseIL.MarkSequencePoint(doc5, 260, 1, 260, 100)
checkElseIL.Emit(OpCodes.Br, cont214)
checkElseIL.MarkLabel(fa214)
checkElseIL.Emit(OpCodes.Br, cont214)
checkElseIL.MarkLabel(cont214)
checkElseIL.MarkSequencePoint(doc5, 261, 1, 261, 100)
checkElseIL.Emit(OpCodes.Ldloc, 3)
Typ = GetType(ElseStmt)
checkElseIL.MarkSequencePoint(doc5, 262, 1, 262, 100)
checkElseIL.Emit(OpCodes.Ret)
Dim typ42(-1) As Type
ReDim Preserve typ42(UBound(typ42) + 1)
typ42(UBound(typ42)) = GetType(Stmt)
ReDim Preserve typ42(UBound(typ42) + 1)
typ42(UBound(typ42)) = GetType(System.Boolean).MakeByRefType()
Dim checkEndIf As MethodBuilder = StmtOptimizer.DefineMethod("checkEndIf", MethodAttributes.Public, GetType(Stmt), typ42)
...
checkEndIfIL.MarkSequencePoint(doc5, 265, 1, 265, 100)
...
Typ = GetType(System.Int32)
Dim fa216 As System.Reflection.Emit.Label = checkEndIfIL.DefineLabel()
Dim tru216 As System.Reflection.Emit.Label = checkEndIfIL.DefineLabel()
Dim cont216 As System.Reflection.Emit.Label = checkEndIfIL.DefineLabel()
checkEndIfIL.Emit(OpCodes.Bge, tru216)
checkEndIfIL.Emit(OpCodes.Br, fa216)
checkEndIfIL.MarkLabel(tru216)
checkEndIfIL.MarkSequencePoint(doc5, 267, 1, 267, 100)
Dim locbldr256 As LocalBuilder = checkEndIfIL.DeclareLocal(GetType(Token))
...
checkEndIfIL.MarkSequencePoint(doc5, 268, 1, 268, 100)
Dim locbldr257 As LocalBuilder = checkEndIfIL.DeclareLocal(GetType(System.Type))
...
checkEndIfIL.Emit(OpCodes.Call, GetType(System.Type).GetMethod("GetTypeFromHandle", typ43))
Typ = GetType(System.Type).GetMethod("GetTypeFromHandle", typ43).ReturnType
checkEndIfIL.Emit(OpCodes.Stloc, 1)
checkEndIfIL.MarkSequencePoint(doc5, 269, 1, 269, 100)
Dim locbldr258 As LocalBuilder = checkEndIfIL.DeclareLocal(GetType(System.Boolean))
...
ReDim Preserve typ44(UBound(typ44) + 1)
typ44(UBound(typ44)) = Typ
checkEndIfIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("IsInstanceOfType", typ44))
Typ = Typ03.GetMethod("IsInstanceOfType", typ44).ReturnType
checkEndIfIL.Emit(OpCodes.Stloc, 2)
checkEndIfIL.MarkSequencePoint(doc5, 271, 1, 271, 100)
Dim locbldr259 As LocalBuilder = checkEndIfIL.DeclareLocal(GetType(Token))
...
checkEndIfIL.MarkSequencePoint(doc5, 272, 1, 272, 100)
Dim locbldr260 As LocalBuilder = checkEndIfIL.DeclareLocal(GetType(System.Type))
...
checkEndIfIL.Emit(OpCodes.Call, GetType(System.Type).GetMethod("GetTypeFromHandle", typ45))
Typ = GetType(System.Type).GetMethod("GetTypeFromHandle", typ45).ReturnType
checkEndIfIL.Emit(OpCodes.Stloc, 4)
checkEndIfIL.MarkSequencePoint(doc5, 273, 1, 273, 100)
Dim locbldr261 As LocalBuilder = checkEndIfIL.DeclareLocal(GetType(System.Boolean))
...
ReDim Preserve typ46(UBound(typ46) + 1)
typ46(UBound(typ46)) = Typ
checkEndIfIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("IsInstanceOfType", typ46))
Typ = Typ03.GetMethod("IsInstanceOfType", typ46).ReturnType
checkEndIfIL.Emit(OpCodes.Stloc, 5)
checkEndIfIL.MarkSequencePoint(doc5, 275, 1, 275, 100)
...
checkEndIfIL.MarkSequencePoint(doc5, 277, 1, 277, 100)
Dim locbldr262 As LocalBuilder = checkEndIfIL.DeclareLocal(GetType(EndIfStmt))
locbldr262.SetLocalSymInfo("eifs")
checkEndIfIL.Emit(OpCodes.Newobj, GetType(EndIfStmt).GetConstructor(Type.EmptyTypes))
checkEndIfIL.Emit(OpCodes.Stloc, 6)
checkEndIfIL.MarkSequencePoint(doc5, 278, 1, 278, 100)
checkEndIfIL.Emit(OpCodes.Ldarg, 2)
Typ = GetType(System.Boolean).MakeByRefType()
...
Typ = GetType(System.Boolean)
Dim fa217 As System.Reflection.Emit.Label = checkEndIfIL.DefineLabel()
Dim tru217 As System.Reflection.Emit.Label = checkEndIfIL.DefineLabel()
Dim cont217 As System.Reflection.Emit.Label = checkEndIfIL.DefineLabel()
checkEndIfIL.Emit(OpCodes.Beq, tru217)
checkEndIfIL.Emit(OpCodes.Br, fa217)
checkEndIfIL.MarkLabel(tru217)
checkEndIfIL.MarkSequencePoint(doc5, 279, 1, 279, 100)
...
checkEndIfIL.MarkSequencePoint(doc5, 280, 1, 280, 100)
checkEndIfIL.Emit(OpCodes.Ldloc, 6)
Typ = GetType(EndIfStmt)
checkEndIfIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
...
checkEndIfIL.MarkSequencePoint(doc5, 281, 1, 281, 100)
checkEndIfIL.Emit(OpCodes.Br, cont217)
checkEndIfIL.MarkLabel(fa217)
checkEndIfIL.Emit(OpCodes.Br, cont217)
checkEndIfIL.MarkLabel(cont217)
checkEndIfIL.MarkSequencePoint(doc5, 282, 1, 282, 100)
checkEndIfIL.Emit(OpCodes.Br, cont216)
checkEndIfIL.MarkLabel(fa216)
checkEndIfIL.Emit(OpCodes.Br, cont216)
checkEndIfIL.MarkLabel(cont216)
checkEndIfIL.MarkSequencePoint(doc5, 283, 1, 283, 100)
checkEndIfIL.Emit(OpCodes.Ldloc, 6)
Typ = GetType(EndIfStmt)
checkEndIfIL.MarkSequencePoint(doc5, 284, 1, 284, 100)
checkEndIfIL.Emit(OpCodes.Ret)
Dim typ47(-1) As Type
ReDim Preserve typ47(UBound(typ47) + 1)
typ47(UBound(typ47)) = GetType(Stmt)
ReDim Preserve typ47(UBound(typ47) + 1)
typ47(UBound(typ47)) = GetType(System.Boolean).MakeByRefType()
Dim checkEndMtd As MethodBuilder = StmtOptimizer.DefineMethod("checkEndMtd", MethodAttributes.Public, GetType(Stmt), typ47)
...
checkEndMtdIL.MarkSequencePoint(doc5, 288, 1, 288, 100)
...
Typ = GetType(System.Int32)
Dim fa218 As System.Reflection.Emit.Label = checkEndMtdIL.DefineLabel()
Dim tru218 As System.Reflection.Emit.Label = checkEndMtdIL.DefineLabel()
Dim cont218 As System.Reflection.Emit.Label = checkEndMtdIL.DefineLabel()
checkEndMtdIL.Emit(OpCodes.Bge, tru218)
checkEndMtdIL.Emit(OpCodes.Br, fa218)
checkEndMtdIL.MarkLabel(tru218)
checkEndMtdIL.MarkSequencePoint(doc5, 290, 1, 290, 100)
Dim locbldr263 As LocalBuilder = checkEndMtdIL.DeclareLocal(GetType(Token))
locbldr263.SetLocalSymInfo("tok1")
checkEndMtdIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
checkEndMtdIL.Emit(OpCodes.Ldfld, GetType(Stmt).GetField("Tokens"))
Typ = GetType(Stmt).GetField("Tokens").FieldType
...
checkEndMtdIL.MarkSequencePoint(doc5, 291, 1, 291, 100)
Dim locbldr264 As LocalBuilder = checkEndMtdIL.DeclareLocal(GetType(System.Type))
locbldr264.SetLocalSymInfo("typ1")
checkEndMtdIL.Emit(OpCodes.Ldtoken, GetType(EndTok))
Dim typ48 As Type() = {GetType(System.RuntimeTypeHandle)}
checkEndMtdIL.Emit(OpCodes.Call, GetType(System.Type).GetMethod("GetTypeFromHandle", typ48))
Typ = GetType(System.Type).GetMethod("GetTypeFromHandle", typ48).ReturnType
checkEndMtdIL.Emit(OpCodes.Stloc, 1)
checkEndMtdIL.MarkSequencePoint(doc5, 292, 1, 292, 100)
Dim locbldr265 As LocalBuilder = checkEndMtdIL.DeclareLocal(GetType(System.Boolean))
locbldr265.SetLocalSymInfo("b1")
Dim typ49(-1) As Type
...
ReDim Preserve typ49(UBound(typ49) + 1)
typ49(UBound(typ49)) = Typ
checkEndMtdIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("IsInstanceOfType", typ49))
Typ = Typ03.GetMethod("IsInstanceOfType", typ49).ReturnType
checkEndMtdIL.Emit(OpCodes.Stloc, 2)
checkEndMtdIL.MarkSequencePoint(doc5, 294, 1, 294, 100)
Dim locbldr266 As LocalBuilder = checkEndMtdIL.DeclareLocal(GetType(Token))
locbldr266.SetLocalSymInfo("tok2")
checkEndMtdIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
checkEndMtdIL.Emit(OpCodes.Ldfld, GetType(Stmt).GetField("Tokens"))
Typ = GetType(Stmt).GetField("Tokens").FieldType
...
checkEndMtdIL.MarkSequencePoint(doc5, 295, 1, 295, 100)
Dim locbldr267 As LocalBuilder = checkEndMtdIL.DeclareLocal(GetType(System.Type))
locbldr267.SetLocalSymInfo("typ2")
checkEndMtdIL.Emit(OpCodes.Ldtoken, GetType(MethodTok))
Dim typ50 As Type() = {GetType(System.RuntimeTypeHandle)}
checkEndMtdIL.Emit(OpCodes.Call, GetType(System.Type).GetMethod("GetTypeFromHandle", typ50))
Typ = GetType(System.Type).GetMethod("GetTypeFromHandle", typ50).ReturnType
checkEndMtdIL.Emit(OpCodes.Stloc, 4)
checkEndMtdIL.MarkSequencePoint(doc5, 296, 1, 296, 100)
Dim locbldr268 As LocalBuilder = checkEndMtdIL.DeclareLocal(GetType(System.Boolean))
locbldr268.SetLocalSymInfo("b2")
Dim typ51(-1) As Type
...
ReDim Preserve typ51(UBound(typ51) + 1)
typ51(UBound(typ51)) = Typ
checkEndMtdIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("IsInstanceOfType", typ51))
Typ = Typ03.GetMethod("IsInstanceOfType", typ51).ReturnType
checkEndMtdIL.Emit(OpCodes.Stloc, 5)
checkEndMtdIL.MarkSequencePoint(doc5, 298, 1, 298, 100)
...
checkEndMtdIL.MarkSequencePoint(doc5, 300, 1, 300, 100)
Dim locbldr269 As LocalBuilder = checkEndMtdIL.DeclareLocal(GetType(EndMethodStmt))
locbldr269.SetLocalSymInfo("ems")
checkEndMtdIL.Emit(OpCodes.Newobj, GetType(EndMethodStmt).GetConstructor(Type.EmptyTypes))
checkEndMtdIL.Emit(OpCodes.Stloc, 6)
checkEndMtdIL.MarkSequencePoint(doc5, 301, 1, 301, 100)
checkEndMtdIL.Emit(OpCodes.Ldarg, 2)
Typ = GetType(System.Boolean).MakeByRefType()
...
Typ = GetType(System.Boolean)
Dim fa219 As System.Reflection.Emit.Label = checkEndMtdIL.DefineLabel()
Dim tru219 As System.Reflection.Emit.Label = checkEndMtdIL.DefineLabel()
Dim cont219 As System.Reflection.Emit.Label = checkEndMtdIL.DefineLabel()
checkEndMtdIL.Emit(OpCodes.Beq, tru219)
checkEndMtdIL.Emit(OpCodes.Br, fa219)
checkEndMtdIL.MarkLabel(tru219)
checkEndMtdIL.MarkSequencePoint(doc5, 302, 1, 302, 100)
...
checkEndMtdIL.MarkSequencePoint(doc5, 303, 1, 303, 100)
checkEndMtdIL.Emit(OpCodes.Ldloc, 6)
Typ = GetType(EndMethodStmt)
checkEndMtdIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
...
checkEndMtdIL.MarkSequencePoint(doc5, 304, 1, 304, 100)
checkEndMtdIL.Emit(OpCodes.Br, cont219)
checkEndMtdIL.MarkLabel(fa219)
checkEndMtdIL.Emit(OpCodes.Br, cont219)
checkEndMtdIL.MarkLabel(cont219)
checkEndMtdIL.MarkSequencePoint(doc5, 305, 1, 305, 100)
checkEndMtdIL.Emit(OpCodes.Br, cont218)
checkEndMtdIL.MarkLabel(fa218)
checkEndMtdIL.Emit(OpCodes.Br, cont218)
checkEndMtdIL.MarkLabel(cont218)
checkEndMtdIL.MarkSequencePoint(doc5, 306, 1, 306, 100)
checkEndMtdIL.Emit(OpCodes.Ldloc, 6)
Typ = GetType(EndMethodStmt)
checkEndMtdIL.MarkSequencePoint(doc5, 307, 1, 307, 100)
checkEndMtdIL.Emit(OpCodes.Ret)
Dim typ52(-1) As Type
ReDim Preserve typ52(UBound(typ52) + 1)
typ52(UBound(typ52)) = GetType(Stmt)
ReDim Preserve typ52(UBound(typ52) + 1)
typ52(UBound(typ52)) = GetType(System.Boolean).MakeByRefType()
Dim checkEndCls As MethodBuilder = StmtOptimizer.DefineMethod("checkEndCls", MethodAttributes.Public, GetType(Stmt), typ52)
...
checkEndClsIL.MarkSequencePoint(doc5, 310, 1, 310, 100)
...
Typ = GetType(System.Int32)
Dim fa220 As System.Reflection.Emit.Label = checkEndClsIL.DefineLabel()
Dim tru220 As System.Reflection.Emit.Label = checkEndClsIL.DefineLabel()
Dim cont220 As System.Reflection.Emit.Label = checkEndClsIL.DefineLabel()
checkEndClsIL.Emit(OpCodes.Bge, tru220)
checkEndClsIL.Emit(OpCodes.Br, fa220)
checkEndClsIL.MarkLabel(tru220)
checkEndClsIL.MarkSequencePoint(doc5, 312, 1, 312, 100)
Dim locbldr270 As LocalBuilder = checkEndClsIL.DeclareLocal(GetType(Token))
locbldr270.SetLocalSymInfo("tok1")
checkEndClsIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
checkEndClsIL.Emit(OpCodes.Ldfld, GetType(Stmt).GetField("Tokens"))
Typ = GetType(Stmt).GetField("Tokens").FieldType
...
checkEndClsIL.MarkSequencePoint(doc5, 313, 1, 313, 100)
Dim locbldr271 As LocalBuilder = checkEndClsIL.DeclareLocal(GetType(System.Type))
locbldr271.SetLocalSymInfo("typ1")
checkEndClsIL.Emit(OpCodes.Ldtoken, GetType(EndTok))
Dim typ53 As Type() = {GetType(System.RuntimeTypeHandle)}
checkEndClsIL.Emit(OpCodes.Call, GetType(System.Type).GetMethod("GetTypeFromHandle", typ53))
Typ = GetType(System.Type).GetMethod("GetTypeFromHandle", typ53).ReturnType
checkEndClsIL.Emit(OpCodes.Stloc, 1)
checkEndClsIL.MarkSequencePoint(doc5, 314, 1, 314, 100)
Dim locbldr272 As LocalBuilder = checkEndClsIL.DeclareLocal(GetType(System.Boolean))
locbldr272.SetLocalSymInfo("b1")
Dim typ54(-1) As Type
...
ReDim Preserve typ54(UBound(typ54) + 1)
typ54(UBound(typ54)) = Typ
checkEndClsIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("IsInstanceOfType", typ54))
Typ = Typ03.GetMethod("IsInstanceOfType", typ54).ReturnType
checkEndClsIL.Emit(OpCodes.Stloc, 2)
checkEndClsIL.MarkSequencePoint(doc5, 316, 1, 316, 100)
Dim locbldr273 As LocalBuilder = checkEndClsIL.DeclareLocal(GetType(Token))
locbldr273.SetLocalSymInfo("tok2")
checkEndClsIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
checkEndClsIL.Emit(OpCodes.Ldfld, GetType(Stmt).GetField("Tokens"))
Typ = GetType(Stmt).GetField("Tokens").FieldType
...
checkEndClsIL.MarkSequencePoint(doc5, 317, 1, 317, 100)
Dim locbldr274 As LocalBuilder = checkEndClsIL.DeclareLocal(GetType(System.Type))
locbldr274.SetLocalSymInfo("typ2")
checkEndClsIL.Emit(OpCodes.Ldtoken, GetType(ClassTok))
Dim typ55 As Type() = {GetType(System.RuntimeTypeHandle)}
checkEndClsIL.Emit(OpCodes.Call, GetType(System.Type).GetMethod("GetTypeFromHandle", typ55))
Typ = GetType(System.Type).GetMethod("GetTypeFromHandle", typ55).ReturnType
checkEndClsIL.Emit(OpCodes.Stloc, 4)
checkEndClsIL.MarkSequencePoint(doc5, 318, 1, 318, 100)
Dim locbldr275 As LocalBuilder = checkEndClsIL.DeclareLocal(GetType(System.Boolean))
locbldr275.SetLocalSymInfo("b2")
Dim typ56(-1) As Type
...
ReDim Preserve typ56(UBound(typ56) + 1)
typ56(UBound(typ56)) = Typ
checkEndClsIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("IsInstanceOfType", typ56))
Typ = Typ03.GetMethod("IsInstanceOfType", typ56).ReturnType
checkEndClsIL.Emit(OpCodes.Stloc, 5)
checkEndClsIL.MarkSequencePoint(doc5, 320, 1, 320, 100)
...
checkEndClsIL.MarkSequencePoint(doc5, 322, 1, 322, 100)
Dim locbldr276 As LocalBuilder = checkEndClsIL.DeclareLocal(GetType(EndClassStmt))
locbldr276.SetLocalSymInfo("ecs")
checkEndClsIL.Emit(OpCodes.Newobj, GetType(EndClassStmt).GetConstructor(Type.EmptyTypes))
checkEndClsIL.Emit(OpCodes.Stloc, 6)
checkEndClsIL.MarkSequencePoint(doc5, 323, 1, 323, 100)
checkEndClsIL.Emit(OpCodes.Ldarg, 2)
Typ = GetType(System.Boolean).MakeByRefType()
...
Typ = GetType(System.Boolean)
Dim fa221 As System.Reflection.Emit.Label = checkEndClsIL.DefineLabel()
Dim tru221 As System.Reflection.Emit.Label = checkEndClsIL.DefineLabel()
Dim cont221 As System.Reflection.Emit.Label = checkEndClsIL.DefineLabel()
checkEndClsIL.Emit(OpCodes.Beq, tru221)
checkEndClsIL.Emit(OpCodes.Br, fa221)
checkEndClsIL.MarkLabel(tru221)
checkEndClsIL.MarkSequencePoint(doc5, 324, 1, 324, 100)
...
checkEndClsIL.MarkSequencePoint(doc5, 325, 1, 325, 100)
checkEndClsIL.Emit(OpCodes.Ldloc, 6)
Typ = GetType(EndClassStmt)
checkEndClsIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
...
checkEndClsIL.MarkSequencePoint(doc5, 326, 1, 326, 100)
checkEndClsIL.Emit(OpCodes.Br, cont221)
checkEndClsIL.MarkLabel(fa221)
checkEndClsIL.Emit(OpCodes.Br, cont221)
checkEndClsIL.MarkLabel(cont221)
checkEndClsIL.MarkSequencePoint(doc5, 327, 1, 327, 100)
checkEndClsIL.Emit(OpCodes.Br, cont220)
checkEndClsIL.MarkLabel(fa220)
checkEndClsIL.Emit(OpCodes.Br, cont220)
checkEndClsIL.MarkLabel(cont220)
checkEndClsIL.MarkSequencePoint(doc5, 328, 1, 328, 100)
checkEndClsIL.Emit(OpCodes.Ldloc, 6)
Typ = GetType(EndClassStmt)
checkEndClsIL.MarkSequencePoint(doc5, 329, 1, 329, 100)
checkEndClsIL.Emit(OpCodes.Ret)
Dim typ57(-1) As Type
ReDim Preserve typ57(UBound(typ57) + 1)
typ57(UBound(typ57)) = GetType(Stmt)
ReDim Preserve typ57(UBound(typ57) + 1)
typ57(UBound(typ57)) = GetType(System.Boolean).MakeByRefType()
Dim checkAssembly As MethodBuilder = StmtOptimizer.DefineMethod("checkAssembly", MethodAttributes.Public, GetType(Stmt), typ57)
...
checkAssemblyIL.MarkSequencePoint(doc5, 332, 1, 332, 100)
Dim locbldr277 As LocalBuilder = checkAssemblyIL.DeclareLocal(GetType(Token))
locbldr277.SetLocalSymInfo("tok")
...
checkAssemblyIL.MarkSequencePoint(doc5, 333, 1, 333, 100)
Dim locbldr278 As LocalBuilder = checkAssemblyIL.DeclareLocal(GetType(System.Type))
locbldr278.SetLocalSymInfo("typ")
checkAssemblyIL.Emit(OpCodes.Ldtoken, GetType(AssemblyTok))
Dim typ58 As Type() = {GetType(System.RuntimeTypeHandle)}
checkAssemblyIL.Emit(OpCodes.Call, GetType(System.Type).GetMethod("GetTypeFromHandle", typ58))
Typ = GetType(System.Type).GetMethod("GetTypeFromHandle", typ58).ReturnType
checkAssemblyIL.Emit(OpCodes.Stloc, 1)
checkAssemblyIL.MarkSequencePoint(doc5, 334, 1, 334, 100)
...
ReDim Preserve typ59(UBound(typ59) + 1)
typ59(UBound(typ59)) = Typ
checkAssemblyIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("IsInstanceOfType", typ59))
Typ = Typ03.GetMethod("IsInstanceOfType", typ59).ReturnType
checkAssemblyIL.Emit(OpCodes.Stobj, Typ04)
checkAssemblyIL.MarkSequencePoint(doc5, 335, 1, 335, 100)
Dim locbldr279 As LocalBuilder = checkAssemblyIL.DeclareLocal(GetType(AssemblyStmt))
locbldr279.SetLocalSymInfo("asms")
...
checkAssemblyIL.MarkSequencePoint(doc5, 336, 1, 336, 100)
checkAssemblyIL.Emit(OpCodes.Ldarg, 2)
Typ = GetType(System.Boolean).MakeByRefType()
...
Typ = GetType(System.Boolean)
Dim fa222 As System.Reflection.Emit.Label = checkAssemblyIL.DefineLabel()
Dim tru222 As System.Reflection.Emit.Label = checkAssemblyIL.DefineLabel()
Dim cont222 As System.Reflection.Emit.Label = checkAssemblyIL.DefineLabel()
checkAssemblyIL.Emit(OpCodes.Beq, tru222)
checkAssemblyIL.Emit(OpCodes.Br, fa222)
checkAssemblyIL.MarkLabel(tru222)
checkAssemblyIL.MarkSequencePoint(doc5, 337, 1, 337, 100)
...
checkAssemblyIL.MarkSequencePoint(doc5, 338, 1, 338, 100)
checkAssemblyIL.Emit(OpCodes.Ldloc, 2)
Typ = GetType(AssemblyStmt)
checkAssemblyIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
...
checkAssemblyIL.MarkSequencePoint(doc5, 339, 1, 339, 100)
checkAssemblyIL.Emit(OpCodes.Ldloc, 2)
Typ = GetType(AssemblyStmt)
checkAssemblyIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
...
checkAssemblyIL.MarkSequencePoint(doc5, 340, 1, 340, 100)
checkAssemblyIL.Emit(OpCodes.Ldloc, 2)
Typ = GetType(AssemblyStmt)
checkAssemblyIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
...
checkAssemblyIL.MarkSequencePoint(doc5, 341, 1, 341, 100)
checkAssemblyIL.Emit(OpCodes.Br, cont222)
checkAssemblyIL.MarkLabel(fa222)
checkAssemblyIL.Emit(OpCodes.Br, cont222)
checkAssemblyIL.MarkLabel(cont222)
checkAssemblyIL.MarkSequencePoint(doc5, 342, 1, 342, 100)
checkAssemblyIL.Emit(OpCodes.Ldloc, 2)
Typ = GetType(AssemblyStmt)
checkAssemblyIL.MarkSequencePoint(doc5, 343, 1, 343, 100)
checkAssemblyIL.Emit(OpCodes.Ret)
Dim typ60(-1) As Type
ReDim Preserve typ60(UBound(typ60) + 1)
typ60(UBound(typ60)) = GetType(Stmt)
ReDim Preserve typ60(UBound(typ60) + 1)
typ60(UBound(typ60)) = GetType(System.Boolean).MakeByRefType()
Dim checkVer As MethodBuilder = StmtOptimizer.DefineMethod("checkVer", MethodAttributes.Public, GetType(Stmt), typ60)
...
checkVerIL.MarkSequencePoint(doc5, 346, 1, 346, 100)
Dim locbldr280 As LocalBuilder = checkVerIL.DeclareLocal(GetType(Token))
locbldr280.SetLocalSymInfo("tok")
...
checkVerIL.MarkSequencePoint(doc5, 347, 1, 347, 100)
Dim locbldr281 As LocalBuilder = checkVerIL.DeclareLocal(GetType(System.Type))
locbldr281.SetLocalSymInfo("typ")
checkVerIL.Emit(OpCodes.Ldtoken, GetType(VerTok))
Dim typ61 As Type() = {GetType(System.RuntimeTypeHandle)}
checkVerIL.Emit(OpCodes.Call, GetType(System.Type).GetMethod("GetTypeFromHandle", typ61))
Typ = GetType(System.Type).GetMethod("GetTypeFromHandle", typ61).ReturnType
checkVerIL.Emit(OpCodes.Stloc, 1)
checkVerIL.MarkSequencePoint(doc5, 348, 1, 348, 100)
...
ReDim Preserve typ62(UBound(typ62) + 1)
typ62(UBound(typ62)) = Typ
checkVerIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("IsInstanceOfType", typ62))
Typ = Typ03.GetMethod("IsInstanceOfType", typ62).ReturnType
checkVerIL.Emit(OpCodes.Stobj, Typ04)
checkVerIL.MarkSequencePoint(doc5, 349, 1, 349, 100)
Dim locbldr282 As LocalBuilder = checkVerIL.DeclareLocal(GetType(VerStmt))
locbldr282.SetLocalSymInfo("vers")
checkVerIL.Emit(OpCodes.Newobj, GetType(VerStmt).GetConstructor(Type.EmptyTypes))
checkVerIL.Emit(OpCodes.Stloc, 2)
checkVerIL.MarkSequencePoint(doc5, 350, 1, 350, 100)
checkVerIL.Emit(OpCodes.Ldarg, 2)
Typ = GetType(System.Boolean).MakeByRefType()
...
Typ = GetType(System.Boolean)
Dim fa223 As System.Reflection.Emit.Label = checkVerIL.DefineLabel()
Dim tru223 As System.Reflection.Emit.Label = checkVerIL.DefineLabel()
Dim cont223 As System.Reflection.Emit.Label = checkVerIL.DefineLabel()
checkVerIL.Emit(OpCodes.Beq, tru223)
checkVerIL.Emit(OpCodes.Br, fa223)
checkVerIL.MarkLabel(tru223)
checkVerIL.MarkSequencePoint(doc5, 351, 1, 351, 100)
...
checkVerIL.MarkSequencePoint(doc5, 352, 1, 352, 100)
checkVerIL.Emit(OpCodes.Ldloc, 2)
Typ = GetType(VerStmt)
checkVerIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
...
checkVerIL.MarkSequencePoint(doc5, 353, 1, 353, 100)
checkVerIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
checkVerIL.Emit(OpCodes.Ldfld, GetType(Stmt).GetField("Tokens"))
Typ = GetType(Stmt).GetField("Tokens").FieldType
...
Typ = Typ.GetElementType()
checkVerIL.Emit(OpCodes.Stloc, 0)
checkVerIL.MarkSequencePoint(doc5, 354, 1, 354, 100)
Dim locbldr283 As LocalBuilder = checkVerIL.DeclareLocal(GetType(System.String).MakeArrayType())
locbldr283.SetLocalSymInfo("ars")
Dim typ63(-1) As Type
checkVerIL.Emit(OpCodes.Ldloc, 0)
Typ = GetType(Token)
...
ReDim Preserve typ63(UBound(typ63) + 1)
typ63(UBound(typ63)) = Typ
checkVerIL.Emit(OpCodes.Call, GetType(Utils.ParseUtils).GetMethod("StringParser", typ63))
Typ = GetType(Utils.ParseUtils).GetMethod("StringParser", typ63).ReturnType
checkVerIL.Emit(OpCodes.Stloc, 3)
checkVerIL.MarkSequencePoint(doc5, 355, 1, 355, 100)
Dim locbldr284 As LocalBuilder = checkVerIL.DeclareLocal(GetType(System.Int32).MakeArrayType())
locbldr284.SetLocalSymInfo("ari")
checkVerIL.Emit(OpCodes.Ldc_I4, CInt(4))
Typ = GetType(System.Int32)
checkVerIL.Emit(OpCodes.Conv_U)
checkVerIL.Emit(OpCodes.Newarr, GetType(System.Int32))
checkVerIL.Emit(OpCodes.Stloc, 4)
checkVerIL.MarkSequencePoint(doc5, 356, 1, 356, 100)
...
checkVerIL.Emit(OpCodes.Call, GetType(System.Convert).GetMethod("ToInt32", typ64))
Typ = GetType(System.Convert).GetMethod("ToInt32", typ64).ReturnType
checkVerIL.Emit(OpCodes.Stelem, GetType(System.Int32).MakeArrayType().GetElementType())
checkVerIL.MarkSequencePoint(doc5, 357, 1, 357, 100)
checkVerIL.Emit(OpCodes.Ldloc, 4)
Typ = GetType(System.Int32).MakeArrayType()
Typ02 = Typ
checkVerIL.Emit(OpCodes.Ldc_I4, CInt(1))
...
checkVerIL.Emit(OpCodes.Ldelem, GetType(System.String).MakeArrayType().GetElementType())
Typ = GetType(System.String).MakeArrayType().GetElementType()
Dim typ65 As Type() = {Typ}
checkVerIL.Emit(OpCodes.Call, GetType(System.Convert).GetMethod("ToInt32", typ65))
Typ = GetType(System.Convert).GetMethod("ToInt32", typ65).ReturnType
checkVerIL.Emit(OpCodes.Stelem, GetType(System.Int32).MakeArrayType().GetElementType())
checkVerIL.MarkSequencePoint(doc5, 358, 1, 358, 100)
checkVerIL.Emit(OpCodes.Ldloc, 4)
Typ = GetType(System.Int32).MakeArrayType()
Typ02 = Typ
...
checkVerIL.Emit(OpCodes.Ldelem, GetType(System.String).MakeArrayType().GetElementType())
Typ = GetType(System.String).MakeArrayType().GetElementType()
Dim typ66 As Type() = {Typ}
checkVerIL.Emit(OpCodes.Call, GetType(System.Convert).GetMethod("ToInt32", typ66))
Typ = GetType(System.Convert).GetMethod("ToInt32", typ66).ReturnType
checkVerIL.Emit(OpCodes.Stelem, GetType(System.Int32).MakeArrayType().GetElementType())
checkVerIL.MarkSequencePoint(doc5, 359, 1, 359, 100)
checkVerIL.Emit(OpCodes.Ldloc, 4)
Typ = GetType(System.Int32).MakeArrayType()
Typ02 = Typ
...
checkVerIL.Emit(OpCodes.Ldelem, GetType(System.String).MakeArrayType().GetElementType())
Typ = GetType(System.String).MakeArrayType().GetElementType()
Dim typ67 As Type() = {Typ}
checkVerIL.Emit(OpCodes.Call, GetType(System.Convert).GetMethod("ToInt32", typ67))
Typ = GetType(System.Convert).GetMethod("ToInt32", typ67).ReturnType
checkVerIL.Emit(OpCodes.Stelem, GetType(System.Int32).MakeArrayType().GetElementType())
checkVerIL.MarkSequencePoint(doc5, 360, 1, 360, 100)
Dim locbldr285 As LocalBuilder = checkVerIL.DeclareLocal(GetType(IntLiteral).MakeArrayType())
locbldr285.SetLocalSymInfo("intla")
checkVerIL.Emit(OpCodes.Ldc_I4, CInt(4))
Typ = GetType(System.Int32)
checkVerIL.Emit(OpCodes.Conv_U)
checkVerIL.Emit(OpCodes.Newarr, GetType(IntLiteral))
checkVerIL.Emit(OpCodes.Stloc, 5)
checkVerIL.MarkSequencePoint(doc5, 361, 1, 361, 100)
Dim locbldr286 As LocalBuilder = checkVerIL.DeclareLocal(GetType(IntLiteral))
locbldr286.SetLocalSymInfo("intl")
checkVerIL.Emit(OpCodes.Ldnull)
checkVerIL.Emit(OpCodes.Stloc, 6)
checkVerIL.MarkSequencePoint(doc5, 362, 1, 362, 100)
Dim typ68(-1) As Type
checkVerIL.Emit(OpCodes.Ldloc, 3)
Typ = GetType(System.String).MakeArrayType()
Typ02 = Typ
...
ReDim Preserve typ68(UBound(typ68) + 1)
typ68(UBound(typ68)) = Typ
checkVerIL.Emit(OpCodes.Newobj, GetType(IntLiteral).GetConstructor(typ68))
checkVerIL.Emit(OpCodes.Stloc, 6)
checkVerIL.MarkSequencePoint(doc5, 363, 1, 363, 100)
...
checkVerIL.MarkSequencePoint(doc5, 364, 1, 364, 100)
checkVerIL.Emit(OpCodes.Ldloc, 6)
Typ = GetType(IntLiteral)
checkVerIL.Emit(OpCodes.Ldloc, 4)
Typ = GetType(System.Int32).MakeArrayType()
...
checkVerIL.MarkSequencePoint(doc5, 365, 1, 365, 100)
...
checkVerIL.MarkSequencePoint(doc5, 366, 1, 366, 100)
Dim typ69(-1) As Type
checkVerIL.Emit(OpCodes.Ldloc, 3)
Typ = GetType(System.String).MakeArrayType()
Typ02 = Typ
...
ReDim Preserve typ69(UBound(typ69) + 1)
typ69(UBound(typ69)) = Typ
checkVerIL.Emit(OpCodes.Newobj, GetType(IntLiteral).GetConstructor(typ69))
checkVerIL.Emit(OpCodes.Stloc, 6)
checkVerIL.MarkSequencePoint(doc5, 367, 1, 367, 100)
checkVerIL.Emit(OpCodes.Ldloc, 6)
Typ = GetType(IntLiteral)
checkVerIL.Emit(OpCodes.Ldloc, 0)
Typ = GetType(Token)
...
Typ = GetType(Token).GetField("Line").FieldType
checkVerIL.Emit(OpCodes.Stfld, GetType(IntLiteral).GetField("Line"))
checkVerIL.MarkSequencePoint(doc5, 368, 1, 368, 100)
checkVerIL.Emit(OpCodes.Ldloc, 6)
Typ = GetType(IntLiteral)
checkVerIL.Emit(OpCodes.Ldloc, 4)
Typ = GetType(System.Int32).MakeArrayType()
...
Typ = GetType(System.Int32).MakeArrayType().GetElementType()
checkVerIL.Emit(OpCodes.Stfld, GetType(IntLiteral).GetField("NumVal"))
checkVerIL.MarkSequencePoint(doc5, 369, 1, 369, 100)
checkVerIL.Emit(OpCodes.Ldloc, 5)
Typ = GetType(IntLiteral).MakeArrayType()
Typ02 = Typ
checkVerIL.Emit(OpCodes.Ldc_I4, CInt(1))
...
Typ = GetType(IntLiteral)
checkVerIL.Emit(OpCodes.Stelem, GetType(IntLiteral).MakeArrayType().GetElementType())
checkVerIL.MarkSequencePoint(doc5, 370, 1, 370, 100)
Dim typ70(-1) As Type
checkVerIL.Emit(OpCodes.Ldloc, 3)
Typ = GetType(System.String).MakeArrayType()
Typ02 = Typ
...
ReDim Preserve typ70(UBound(typ70) + 1)
typ70(UBound(typ70)) = Typ
checkVerIL.Emit(OpCodes.Newobj, GetType(IntLiteral).GetConstructor(typ70))
checkVerIL.Emit(OpCodes.Stloc, 6)
checkVerIL.MarkSequencePoint(doc5, 371, 1, 371, 100)
checkVerIL.Emit(OpCodes.Ldloc, 6)
Typ = GetType(IntLiteral)
checkVerIL.Emit(OpCodes.Ldloc, 0)
Typ = GetType(Token)
...
Typ = GetType(Token).GetField("Line").FieldType
checkVerIL.Emit(OpCodes.Stfld, GetType(IntLiteral).GetField("Line"))
checkVerIL.MarkSequencePoint(doc5, 372, 1, 372, 100)
checkVerIL.Emit(OpCodes.Ldloc, 6)
Typ = GetType(IntLiteral)
checkVerIL.Emit(OpCodes.Ldloc, 4)
Typ = GetType(System.Int32).MakeArrayType()
...
Typ = GetType(System.Int32).MakeArrayType().GetElementType()
checkVerIL.Emit(OpCodes.Stfld, GetType(IntLiteral).GetField("NumVal"))
checkVerIL.MarkSequencePoint(doc5, 373, 1, 373, 100)
checkVerIL.Emit(OpCodes.Ldloc, 5)
Typ = GetType(IntLiteral).MakeArrayType()
Typ02 = Typ
checkVerIL.Emit(OpCodes.Ldc_I4, CInt(2))
...
Typ = GetType(IntLiteral)
checkVerIL.Emit(OpCodes.Stelem, GetType(IntLiteral).MakeArrayType().GetElementType())
checkVerIL.MarkSequencePoint(doc5, 374, 1, 374, 100)
Dim typ71(-1) As Type
checkVerIL.Emit(OpCodes.Ldloc, 3)
Typ = GetType(System.String).MakeArrayType()
Typ02 = Typ
...
ReDim Preserve typ71(UBound(typ71) + 1)
typ71(UBound(typ71)) = Typ
checkVerIL.Emit(OpCodes.Newobj, GetType(IntLiteral).GetConstructor(typ71))
checkVerIL.Emit(OpCodes.Stloc, 6)
checkVerIL.MarkSequencePoint(doc5, 375, 1, 375, 100)
checkVerIL.Emit(OpCodes.Ldloc, 6)
Typ = GetType(IntLiteral)
checkVerIL.Emit(OpCodes.Ldloc, 0)
Typ = GetType(Token)
...
Typ = GetType(Token).GetField("Line").FieldType
checkVerIL.Emit(OpCodes.Stfld, GetType(IntLiteral).GetField("Line"))
checkVerIL.MarkSequencePoint(doc5, 376, 1, 376, 100)
checkVerIL.Emit(OpCodes.Ldloc, 6)
Typ = GetType(IntLiteral)
checkVerIL.Emit(OpCodes.Ldloc, 4)
Typ = GetType(System.Int32).MakeArrayType()
...
Typ = GetType(System.Int32).MakeArrayType().GetElementType()
checkVerIL.Emit(OpCodes.Stfld, GetType(IntLiteral).GetField("NumVal"))
checkVerIL.MarkSequencePoint(doc5, 377, 1, 377, 100)
checkVerIL.Emit(OpCodes.Ldloc, 5)
Typ = GetType(IntLiteral).MakeArrayType()
Typ02 = Typ
checkVerIL.Emit(OpCodes.Ldc_I4, CInt(3))
...
Typ = GetType(IntLiteral)
checkVerIL.Emit(OpCodes.Stelem, GetType(IntLiteral).MakeArrayType().GetElementType())
checkVerIL.MarkSequencePoint(doc5, 378, 1, 378, 100)
checkVerIL.Emit(OpCodes.Ldloc, 2)
Typ = GetType(VerStmt)
checkVerIL.Emit(OpCodes.Ldloc, 5)
Typ = GetType(IntLiteral).MakeArrayType()
checkVerIL.Emit(OpCodes.Stfld, GetType(VerStmt).GetField("VersionNos"))
checkVerIL.MarkSequencePoint(doc5, 379, 1, 379, 100)
checkVerIL.Emit(OpCodes.Br, cont223)
checkVerIL.MarkLabel(fa223)
checkVerIL.Emit(OpCodes.Br, cont223)
checkVerIL.MarkLabel(cont223)
checkVerIL.MarkSequencePoint(doc5, 380, 1, 380, 100)
checkVerIL.Emit(OpCodes.Ldloc, 2)
Typ = GetType(VerStmt)
checkVerIL.MarkSequencePoint(doc5, 381, 1, 381, 100)
checkVerIL.Emit(OpCodes.Ret)
Dim typ72(-1) As Type
ReDim Preserve typ72(UBound(typ72) + 1)
typ72(UBound(typ72)) = GetType(Stmt)
ReDim Preserve typ72(UBound(typ72) + 1)
typ72(UBound(typ72)) = GetType(System.Boolean).MakeByRefType()
Dim checkClass As MethodBuilder = StmtOptimizer.DefineMethod("checkClass", MethodAttributes.Public, GetType(Stmt), typ72)
...
checkClassIL.MarkSequencePoint(doc5, 384, 1, 384, 100)
Dim locbldr287 As LocalBuilder = checkClassIL.DeclareLocal(GetType(Token))
locbldr287.SetLocalSymInfo("tok")
...
checkClassIL.MarkSequencePoint(doc5, 385, 1, 385, 100)
Dim locbldr288 As LocalBuilder = checkClassIL.DeclareLocal(GetType(System.Type))
locbldr288.SetLocalSymInfo("typ")
checkClassIL.Emit(OpCodes.Ldtoken, GetType(ClassTok))
Dim typ73 As Type() = {GetType(System.RuntimeTypeHandle)}
checkClassIL.Emit(OpCodes.Call, GetType(System.Type).GetMethod("GetTypeFromHandle", typ73))
Typ = GetType(System.Type).GetMethod("GetTypeFromHandle", typ73).ReturnType
checkClassIL.Emit(OpCodes.Stloc, 1)
checkClassIL.MarkSequencePoint(doc5, 386, 1, 386, 100)
...
ReDim Preserve typ74(UBound(typ74) + 1)
typ74(UBound(typ74)) = Typ
checkClassIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("IsInstanceOfType", typ74))
Typ = Typ03.GetMethod("IsInstanceOfType", typ74).ReturnType
checkClassIL.Emit(OpCodes.Stobj, Typ04)
checkClassIL.MarkSequencePoint(doc5, 387, 1, 387, 100)
Dim locbldr289 As LocalBuilder = checkClassIL.DeclareLocal(GetType(ClassStmt))
locbldr289.SetLocalSymInfo("clss")
checkClassIL.Emit(OpCodes.Newobj, GetType(ClassStmt).GetConstructor(Type.EmptyTypes))
checkClassIL.Emit(OpCodes.Stloc, 2)
checkClassIL.MarkSequencePoint(doc5, 388, 1, 388, 100)
Dim locbldr290 As LocalBuilder = checkClassIL.DeclareLocal(GetType(Attributes.Attribute))
locbldr290.SetLocalSymInfo("att")
checkClassIL.Emit(OpCodes.Ldnull)
checkClassIL.Emit(OpCodes.Stloc, 3)
checkClassIL.MarkSequencePoint(doc5, 389, 1, 389, 100)
checkClassIL.Emit(OpCodes.Ldarg, 2)
Typ = GetType(System.Boolean).MakeByRefType()
...
Typ = GetType(System.Boolean)
Dim fa224 As System.Reflection.Emit.Label = checkClassIL.DefineLabel()
Dim tru224 As System.Reflection.Emit.Label = checkClassIL.DefineLabel()
Dim cont224 As System.Reflection.Emit.Label = checkClassIL.DefineLabel()
checkClassIL.Emit(OpCodes.Beq, tru224)
checkClassIL.Emit(OpCodes.Br, fa224)
checkClassIL.MarkLabel(tru224)
checkClassIL.MarkSequencePoint(doc5, 391, 1, 391, 100)
...
checkClassIL.MarkSequencePoint(doc5, 392, 1, 392, 100)
checkClassIL.Emit(OpCodes.Ldloc, 2)
Typ = GetType(ClassStmt)
checkClassIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
...
checkClassIL.MarkSequencePoint(doc5, 394, 1, 394, 100)
Dim label7 As System.Reflection.Emit.Label = checkClassIL.DefineLabel()
checkClassIL.MarkSequencePoint(doc5, 395, 1, 395, 100)
Dim label8 As System.Reflection.Emit.Label = checkClassIL.DefineLabel()
checkClassIL.MarkSequencePoint(doc5, 397, 1, 397, 100)
Dim locbldr291 As LocalBuilder = checkClassIL.DeclareLocal(GetType(System.Int32))
locbldr291.SetLocalSymInfo("i")
checkClassIL.Emit(OpCodes.Ldc_I4, CInt(0))
Typ = GetType(System.Int32)
checkClassIL.Emit(OpCodes.Stloc, 4)
checkClassIL.MarkSequencePoint(doc5, 398, 1, 398, 100)
Dim locbldr292 As LocalBuilder = checkClassIL.DeclareLocal(GetType(System.Int32))
...
checkClassIL.MarkSequencePoint(doc5, 399, 1, 399, 100)
Dim locbldr293 As LocalBuilder = checkClassIL.DeclareLocal(GetType(System.Boolean))
locbldr293.SetLocalSymInfo("bl")
checkClassIL.Emit(OpCodes.Ldc_I4, 0)
Typ = GetType(System.Boolean)
checkClassIL.Emit(OpCodes.Stloc, 6)
checkClassIL.MarkSequencePoint(doc5, 401, 1, 401, 100)
checkClassIL.MarkLabel(label7)
checkClassIL.MarkSequencePoint(doc5, 403, 1, 403, 100)
...
checkClassIL.Emit(OpCodes.Stloc, 4)
checkClassIL.MarkSequencePoint(doc5, 404, 1, 404, 100)
checkClassIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
checkClassIL.Emit(OpCodes.Ldfld, GetType(Stmt).GetField("Tokens"))
Typ = GetType(Stmt).GetField("Tokens").FieldType
...
Typ = Typ.GetElementType()
checkClassIL.Emit(OpCodes.Stloc, 0)
checkClassIL.MarkSequencePoint(doc5, 405, 1, 405, 100)
checkClassIL.Emit(OpCodes.Ldtoken, GetType(Attributes.Attribute))
Dim typ75 As Type() = {GetType(System.RuntimeTypeHandle)}
checkClassIL.Emit(OpCodes.Call, GetType(System.Type).GetMethod("GetTypeFromHandle", typ75))
Typ = GetType(System.Type).GetMethod("GetTypeFromHandle", typ75).ReturnType
checkClassIL.Emit(OpCodes.Stloc, 1)
checkClassIL.MarkSequencePoint(doc5, 406, 1, 406, 100)
Dim typ76(-1) As Type
checkClassIL.Emit(OpCodes.Ldloc, 1)
Typ = GetType(System.Type)
Typ03 = Typ
...
checkClassIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("IsInstanceOfType", typ76))
Typ = Typ03.GetMethod("IsInstanceOfType", typ76).ReturnType
checkClassIL.Emit(OpCodes.Stloc, 6)
checkClassIL.MarkSequencePoint(doc5, 408, 1, 408, 100)
checkClassIL.Emit(OpCodes.Ldloc, 6)
Typ = GetType(System.Boolean)
checkClassIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa225 As System.Reflection.Emit.Label = checkClassIL.DefineLabel()
Dim tru225 As System.Reflection.Emit.Label = checkClassIL.DefineLabel()
Dim cont225 As System.Reflection.Emit.Label = checkClassIL.DefineLabel()
checkClassIL.Emit(OpCodes.Beq, tru225)
checkClassIL.Emit(OpCodes.Br, fa225)
checkClassIL.MarkLabel(tru225)
checkClassIL.MarkSequencePoint(doc5, 409, 1, 409, 100)
checkClassIL.Emit(OpCodes.Ldloc, 0)
Typ = GetType(Token)
checkClassIL.Emit(OpCodes.Stloc, 3)
checkClassIL.MarkSequencePoint(doc5, 410, 1, 410, 100)
Dim typ77(-1) As Type
checkClassIL.Emit(OpCodes.Ldloc, 2)
Typ = GetType(ClassStmt)
Typ03 = Typ
...
ReDim Preserve typ77(UBound(typ77) + 1)
typ77(UBound(typ77)) = Typ
checkClassIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("AddAttr", typ77))
Typ = Typ03.GetMethod("AddAttr", typ77).ReturnType
If Typ.ToString() = GetType(System.Void).ToString() Then

Else
checkClassIL.Emit(OpCodes.Pop)
End If
checkClassIL.MarkSequencePoint(doc5, 411, 1, 411, 100)
checkClassIL.Emit(OpCodes.Br, cont225)
checkClassIL.MarkLabel(fa225)
checkClassIL.MarkSequencePoint(doc5, 413, 1, 413, 100)
Dim locbldr294 As LocalBuilder = checkClassIL.DeclareLocal(GetType(Token))
...
checkClassIL.MarkSequencePoint(doc5, 414, 1, 414, 100)
Dim locbldr295 As LocalBuilder = checkClassIL.DeclareLocal(GetType(System.Type))
locbldr295.SetLocalSymInfo("typ2")
checkClassIL.Emit(OpCodes.Ldtoken, GetType(ExtendsTok))
Dim typ78 As Type() = {GetType(System.RuntimeTypeHandle)}
checkClassIL.Emit(OpCodes.Call, GetType(System.Type).GetMethod("GetTypeFromHandle", typ78))
Typ = GetType(System.Type).GetMethod("GetTypeFromHandle", typ78).ReturnType
checkClassIL.Emit(OpCodes.Stloc, 8)
checkClassIL.MarkSequencePoint(doc5, 415, 1, 415, 100)
Dim locbldr296 As LocalBuilder = checkClassIL.DeclareLocal(GetType(System.Boolean))
...
ReDim Preserve typ79(UBound(typ79) + 1)
typ79(UBound(typ79)) = Typ
checkClassIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("IsInstanceOfType", typ79))
Typ = Typ03.GetMethod("IsInstanceOfType", typ79).ReturnType
checkClassIL.Emit(OpCodes.Stloc, 9)
checkClassIL.MarkSequencePoint(doc5, 417, 1, 417, 100)
checkClassIL.Emit(OpCodes.Ldloc, 9)
Typ = GetType(System.Boolean)
checkClassIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa226 As System.Reflection.Emit.Label = checkClassIL.DefineLabel()
Dim tru226 As System.Reflection.Emit.Label = checkClassIL.DefineLabel()
Dim cont226 As System.Reflection.Emit.Label = checkClassIL.DefineLabel()
checkClassIL.Emit(OpCodes.Beq, tru226)
checkClassIL.Emit(OpCodes.Br, fa226)
checkClassIL.MarkLabel(tru226)
checkClassIL.MarkSequencePoint(doc5, 418, 1, 418, 100)
checkClassIL.Emit(OpCodes.Ldloc, 4)
Typ = GetType(System.Int32)
checkClassIL.Emit(OpCodes.Ldc_I4, CInt(1))
Typ = GetType(System.Int32)
checkClassIL.Emit(OpCodes.Add)
checkClassIL.Emit(OpCodes.Stloc, 4)
checkClassIL.MarkSequencePoint(doc5, 419, 1, 419, 100)
checkClassIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
checkClassIL.Emit(OpCodes.Ldfld, GetType(Stmt).GetField("Tokens"))
Typ = GetType(Stmt).GetField("Tokens").FieldType
...
Typ = Typ.GetElementType()
checkClassIL.Emit(OpCodes.Stloc, 7)
checkClassIL.MarkSequencePoint(doc5, 420, 1, 420, 100)
checkClassIL.Emit(OpCodes.Ldtoken, GetType(TypeTok))
Dim typ80 As Type() = {GetType(System.RuntimeTypeHandle)}
checkClassIL.Emit(OpCodes.Call, GetType(System.Type).GetMethod("GetTypeFromHandle", typ80))
Typ = GetType(System.Type).GetMethod("GetTypeFromHandle", typ80).ReturnType
checkClassIL.Emit(OpCodes.Stloc, 8)
checkClassIL.MarkSequencePoint(doc5, 421, 1, 421, 100)
Dim typ81(-1) As Type
checkClassIL.Emit(OpCodes.Ldloc, 8)
Typ = GetType(System.Type)
Typ03 = Typ
...
ReDim Preserve typ81(UBound(typ81) + 1)
typ81(UBound(typ81)) = Typ
checkClassIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("IsInstanceOfType", typ81))
Typ = Typ03.GetMethod("IsInstanceOfType", typ81).ReturnType
checkClassIL.Emit(OpCodes.Stloc, 9)
checkClassIL.MarkSequencePoint(doc5, 423, 1, 423, 100)
checkClassIL.Emit(OpCodes.Ldloc, 9)
Typ = GetType(System.Boolean)
checkClassIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa227 As System.Reflection.Emit.Label = checkClassIL.DefineLabel()
Dim tru227 As System.Reflection.Emit.Label = checkClassIL.DefineLabel()
Dim cont227 As System.Reflection.Emit.Label = checkClassIL.DefineLabel()
checkClassIL.Emit(OpCodes.Beq, fa227)
checkClassIL.Emit(OpCodes.Br, tru227)
checkClassIL.MarkLabel(tru227)
checkClassIL.MarkSequencePoint(doc5, 424, 1, 424, 100)
Dim locbldr297 As LocalBuilder = checkClassIL.DeclareLocal(GetType(Token))
...
checkClassIL.MarkSequencePoint(doc5, 425, 1, 425, 100)
Dim locbldr298 As LocalBuilder = checkClassIL.DeclareLocal(GetType(TypeTok))
...
checkClassIL.MarkSequencePoint(doc5, 426, 1, 426, 100)
...
checkClassIL.MarkSequencePoint(doc5, 427, 1, 427, 100)
checkClassIL.Emit(OpCodes.Ldloc, 11)
Typ = GetType(TypeTok)
checkClassIL.Emit(OpCodes.Ldloc, 10)
Typ = GetType(Token)
...
checkClassIL.MarkSequencePoint(doc5, 428, 1, 428, 100)
checkClassIL.Emit(OpCodes.Ldloc, 2)
Typ = GetType(ClassStmt)
checkClassIL.Emit(OpCodes.Ldloc, 11)
Typ = GetType(TypeTok)
checkClassIL.Emit(OpCodes.Stfld, GetType(ClassStmt).GetField("InhClass"))
checkClassIL.MarkSequencePoint(doc5, 429, 1, 429, 100)
checkClassIL.Emit(OpCodes.Br, cont227)
checkClassIL.MarkLabel(fa227)
checkClassIL.MarkSequencePoint(doc5, 430, 1, 430, 100)
checkClassIL.Emit(OpCodes.Ldloc, 2)
Typ = GetType(ClassStmt)
checkClassIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
...
Typ = Typ.GetElementType()
checkClassIL.Emit(OpCodes.Stfld, GetType(ClassStmt).GetField("InhClass"))
checkClassIL.MarkSequencePoint(doc5, 431, 1, 431, 100)
checkClassIL.Emit(OpCodes.Br, cont227)
checkClassIL.MarkLabel(cont227)
checkClassIL.MarkSequencePoint(doc5, 432, 1, 432, 100)
checkClassIL.Emit(OpCodes.Br, cont226)
checkClassIL.MarkLabel(fa226)
checkClassIL.MarkSequencePoint(doc5, 433, 1, 433, 100)
checkClassIL.Emit(OpCodes.Ldloc, 2)
Typ = GetType(ClassStmt)
checkClassIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
...
checkClassIL.MarkSequencePoint(doc5, 434, 1, 434, 100)
checkClassIL.Emit(OpCodes.Br, cont226)
checkClassIL.MarkLabel(cont226)
checkClassIL.MarkSequencePoint(doc5, 436, 1, 436, 100)
checkClassIL.Emit(OpCodes.Br, cont225)
checkClassIL.MarkLabel(cont225)
checkClassIL.MarkSequencePoint(doc5, 438, 1, 438, 100)
checkClassIL.Emit(OpCodes.Ldloc, 4)
Typ = GetType(System.Int32)
checkClassIL.Emit(OpCodes.Ldloc, 5)
Typ = GetType(System.Int32)
Dim fa228 As System.Reflection.Emit.Label = checkClassIL.DefineLabel()
Dim tru228 As System.Reflection.Emit.Label = checkClassIL.DefineLabel()
Dim cont228 As System.Reflection.Emit.Label = checkClassIL.DefineLabel()
checkClassIL.Emit(OpCodes.Beq, tru228)
checkClassIL.Emit(OpCodes.Br, fa228)
checkClassIL.MarkLabel(tru228)
checkClassIL.MarkSequencePoint(doc5, 439, 1, 439, 100)
checkClassIL.Emit(OpCodes.Br, label8)
checkClassIL.MarkSequencePoint(doc5, 440, 1, 440, 100)
checkClassIL.Emit(OpCodes.Br, cont228)
checkClassIL.MarkLabel(fa228)
checkClassIL.MarkSequencePoint(doc5, 441, 1, 441, 100)
checkClassIL.Emit(OpCodes.Br, label7)
checkClassIL.MarkSequencePoint(doc5, 442, 1, 442, 100)
checkClassIL.Emit(OpCodes.Br, cont228)
checkClassIL.MarkLabel(cont228)
checkClassIL.MarkSequencePoint(doc5, 444, 1, 444, 100)
checkClassIL.MarkLabel(label8)
checkClassIL.MarkSequencePoint(doc5, 446, 1, 446, 100)
checkClassIL.Emit(OpCodes.Br, cont224)
checkClassIL.MarkLabel(fa224)
checkClassIL.Emit(OpCodes.Br, cont224)
checkClassIL.MarkLabel(cont224)
checkClassIL.MarkSequencePoint(doc5, 448, 1, 448, 100)
checkClassIL.Emit(OpCodes.Ldloc, 2)
Typ = GetType(ClassStmt)
checkClassIL.MarkSequencePoint(doc5, 449, 1, 449, 100)
...
Dim checkField As MethodBuilder = StmtOptimizer.DefineMethod("checkField", MethodAttributes.Public, GetType(Stmt), typ82)
...
Dim locbldr299 As LocalBuilder = checkFieldIL.DeclareLocal(GetType(Token))
...
checkFieldIL.MarkSequencePoint(doc5, 454, 1, 454, 100)
Dim locbldr300 As LocalBuilder = checkFieldIL.DeclareLocal(GetType(System.Type))
...
checkFieldIL.Emit(OpCodes.Call, GetType(System.Type).GetMethod("GetTypeFromHandle", typ83))
Typ = GetType(System.Type).GetMethod("GetTypeFromHandle", typ83).ReturnType
checkFieldIL.Emit(OpCodes.Stloc, 1)
checkFieldIL.MarkSequencePoint(doc5, 455, 1, 455, 100)
...
ReDim Preserve typ84(UBound(typ84) + 1)
typ84(UBound(typ84)) = Typ
checkFieldIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("IsInstanceOfType", typ84))
Typ = Typ03.GetMethod("IsInstanceOfType", typ84).ReturnType
checkFieldIL.Emit(OpCodes.Stobj, Typ04)
checkFieldIL.MarkSequencePoint(doc5, 456, 1, 456, 100)
Dim locbldr301 As LocalBuilder = checkFieldIL.DeclareLocal(GetType(FieldStmt))
locbldr301.SetLocalSymInfo("flss")
checkFieldIL.Emit(OpCodes.Newobj, GetType(FieldStmt).GetConstructor(Type.EmptyTypes))
checkFieldIL.Emit(OpCodes.Stloc, 2)
checkFieldIL.MarkSequencePoint(doc5, 457, 1, 457, 100)
Dim locbldr302 As LocalBuilder = checkFieldIL.DeclareLocal(GetType(Attributes.Attribute))
locbldr302.SetLocalSymInfo("att")
checkFieldIL.Emit(OpCodes.Ldnull)
checkFieldIL.Emit(OpCodes.Stloc, 3)
checkFieldIL.MarkSequencePoint(doc5, 459, 1, 459, 100)
checkFieldIL.Emit(OpCodes.Ldarg, 2)
Typ = GetType(System.Boolean).MakeByRefType()
...
Typ = GetType(System.Boolean)
Dim fa229 As System.Reflection.Emit.Label = checkFieldIL.DefineLabel()
Dim tru229 As System.Reflection.Emit.Label = checkFieldIL.DefineLabel()
Dim cont229 As System.Reflection.Emit.Label = checkFieldIL.DefineLabel()
checkFieldIL.Emit(OpCodes.Beq, tru229)
checkFieldIL.Emit(OpCodes.Br, fa229)
checkFieldIL.MarkLabel(tru229)
checkFieldIL.MarkSequencePoint(doc5, 461, 1, 461, 100)
Dim locbldr303 As LocalBuilder = checkFieldIL.DeclareLocal(GetType(Expr))
locbldr303.SetLocalSymInfo("tempexp")
checkFieldIL.Emit(OpCodes.Newobj, GetType(Expr).GetConstructor(Type.EmptyTypes))
checkFieldIL.Emit(OpCodes.Stloc, 4)
checkFieldIL.MarkSequencePoint(doc5, 462, 1, 462, 100)
...
checkFieldIL.MarkSequencePoint(doc5, 463, 1, 463, 100)
Dim locbldr304 As LocalBuilder = checkFieldIL.DeclareLocal(asm.GetType("dylan.NET.Tokenizer.Parser.ExprOptimizer"))
locbldr304.SetLocalSymInfo("eop")
...
ReDim Preserve typ85(UBound(typ85) + 1)
typ85(UBound(typ85)) = Typ
checkFieldIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("Optimize", typ85))
Typ = Typ03.GetMethod("Optimize", typ85).ReturnType
checkFieldIL.Emit(OpCodes.Stloc, 4)
checkFieldIL.MarkSequencePoint(doc5, 466, 1, 466, 100)
checkFieldIL.Emit(OpCodes.Ldc_I4, 0)
Typ = GetType(System.Boolean)
checkFieldIL.Emit(OpCodes.Stsfld, asm.GetType("dylan.NET.Tokenizer.Parser.ParserFlags").GetField("ProcessTTokOnly"))
checkFieldIL.MarkSequencePoint(doc5, 467, 1, 467, 100)
checkFieldIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
checkFieldIL.Emit(OpCodes.Ldloc, 4)
Typ = GetType(Expr)
...
checkFieldIL.MarkSequencePoint(doc5, 469, 1, 469, 100)
...
checkFieldIL.MarkSequencePoint(doc5, 470, 1, 470, 100)
checkFieldIL.Emit(OpCodes.Ldloc, 2)
Typ = GetType(FieldStmt)
checkFieldIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
...
checkFieldIL.MarkSequencePoint(doc5, 472, 1, 472, 100)
Dim label9 As System.Reflection.Emit.Label = checkFieldIL.DefineLabel()
checkFieldIL.MarkSequencePoint(doc5, 473, 1, 473, 100)
Dim label10 As System.Reflection.Emit.Label = checkFieldIL.DefineLabel()
checkFieldIL.MarkSequencePoint(doc5, 475, 1, 475, 100)
Dim locbldr305 As LocalBuilder = checkFieldIL.DeclareLocal(GetType(System.Int32))
locbldr305.SetLocalSymInfo("i")
checkFieldIL.Emit(OpCodes.Ldc_I4, CInt(0))
Typ = GetType(System.Int32)
checkFieldIL.Emit(OpCodes.Stloc, 6)
checkFieldIL.MarkSequencePoint(doc5, 476, 1, 476, 100)
Dim locbldr306 As LocalBuilder = checkFieldIL.DeclareLocal(GetType(System.Int32))
locbldr306.SetLocalSymInfo("len")
checkFieldIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
checkFieldIL.Emit(OpCodes.Ldfld, GetType(Stmt).GetField("Tokens"))
Typ = GetType(Stmt).GetField("Tokens").FieldType
...
checkFieldIL.MarkSequencePoint(doc5, 477, 1, 477, 100)
Dim locbldr307 As LocalBuilder = checkFieldIL.DeclareLocal(GetType(System.Boolean))
locbldr307.SetLocalSymInfo("bl")
checkFieldIL.Emit(OpCodes.Ldc_I4, 0)
Typ = GetType(System.Boolean)
checkFieldIL.Emit(OpCodes.Stloc, 8)
checkFieldIL.MarkSequencePoint(doc5, 479, 1, 479, 100)
checkFieldIL.MarkLabel(label9)
checkFieldIL.MarkSequencePoint(doc5, 481, 1, 481, 100)
...
checkFieldIL.Emit(OpCodes.Stloc, 6)
checkFieldIL.MarkSequencePoint(doc5, 482, 1, 482, 100)
checkFieldIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
checkFieldIL.Emit(OpCodes.Ldfld, GetType(Stmt).GetField("Tokens"))
Typ = GetType(Stmt).GetField("Tokens").FieldType
...
Typ = Typ.GetElementType()
checkFieldIL.Emit(OpCodes.Stloc, 0)
checkFieldIL.MarkSequencePoint(doc5, 483, 1, 483, 100)
checkFieldIL.Emit(OpCodes.Ldtoken, GetType(Attributes.Attribute))
Dim typ86 As Type() = {GetType(System.RuntimeTypeHandle)}
checkFieldIL.Emit(OpCodes.Call, GetType(System.Type).GetMethod("GetTypeFromHandle", typ86))
Typ = GetType(System.Type).GetMethod("GetTypeFromHandle", typ86).ReturnType
checkFieldIL.Emit(OpCodes.Stloc, 1)
checkFieldIL.MarkSequencePoint(doc5, 484, 1, 484, 100)
Dim typ87(-1) As Type
checkFieldIL.Emit(OpCodes.Ldloc, 1)
Typ = GetType(System.Type)
Typ03 = Typ
...
ReDim Preserve typ87(UBound(typ87) + 1)
typ87(UBound(typ87)) = Typ
checkFieldIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("IsInstanceOfType", typ87))
Typ = Typ03.GetMethod("IsInstanceOfType", typ87).ReturnType
checkFieldIL.Emit(OpCodes.Stloc, 8)
checkFieldIL.MarkSequencePoint(doc5, 486, 1, 486, 100)
checkFieldIL.Emit(OpCodes.Ldloc, 8)
Typ = GetType(System.Boolean)
checkFieldIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa230 As System.Reflection.Emit.Label = checkFieldIL.DefineLabel()
Dim tru230 As System.Reflection.Emit.Label = checkFieldIL.DefineLabel()
Dim cont230 As System.Reflection.Emit.Label = checkFieldIL.DefineLabel()
checkFieldIL.Emit(OpCodes.Beq, tru230)
checkFieldIL.Emit(OpCodes.Br, fa230)
checkFieldIL.MarkLabel(tru230)
checkFieldIL.MarkSequencePoint(doc5, 487, 1, 487, 100)
checkFieldIL.Emit(OpCodes.Ldloc, 0)
Typ = GetType(Token)
checkFieldIL.Emit(OpCodes.Stloc, 3)
checkFieldIL.MarkSequencePoint(doc5, 488, 1, 488, 100)
Dim typ88(-1) As Type
checkFieldIL.Emit(OpCodes.Ldloc, 2)
Typ = GetType(FieldStmt)
Typ03 = Typ
...
checkFieldIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("AddAttr", typ88))
...
End If
checkFieldIL.MarkSequencePoint(doc5, 489, 1, 489, 100)
checkFieldIL.Emit(OpCodes.Br, cont230)
checkFieldIL.MarkLabel(fa230)
checkFieldIL.Emit(OpCodes.Br, cont230)
checkFieldIL.MarkLabel(cont230)
checkFieldIL.MarkSequencePoint(doc5, 491, 1, 491, 100)
checkFieldIL.Emit(OpCodes.Ldloc, 6)
Typ = GetType(System.Int32)
checkFieldIL.Emit(OpCodes.Ldloc, 7)
Typ = GetType(System.Int32)
Dim fa231 As System.Reflection.Emit.Label = checkFieldIL.DefineLabel()
Dim tru231 As System.Reflection.Emit.Label = checkFieldIL.DefineLabel()
Dim cont231 As System.Reflection.Emit.Label = checkFieldIL.DefineLabel()
checkFieldIL.Emit(OpCodes.Beq, tru231)
checkFieldIL.Emit(OpCodes.Br, fa231)
checkFieldIL.MarkLabel(tru231)
checkFieldIL.MarkSequencePoint(doc5, 492, 1, 492, 100)
checkFieldIL.Emit(OpCodes.Br, label10)
checkFieldIL.MarkSequencePoint(doc5, 493, 1, 493, 100)
checkFieldIL.Emit(OpCodes.Br, cont231)
checkFieldIL.MarkLabel(fa231)
checkFieldIL.MarkSequencePoint(doc5, 494, 1, 494, 100)
checkFieldIL.Emit(OpCodes.Br, label9)
checkFieldIL.MarkSequencePoint(doc5, 495, 1, 495, 100)
checkFieldIL.Emit(OpCodes.Br, cont231)
checkFieldIL.MarkLabel(cont231)
checkFieldIL.MarkSequencePoint(doc5, 497, 1, 497, 100)
checkFieldIL.MarkLabel(label10)
checkFieldIL.MarkSequencePoint(doc5, 499, 1, 499, 100)
checkFieldIL.Emit(OpCodes.Ldloc, 6)
Typ = GetType(System.Int32)
checkFieldIL.Emit(OpCodes.Ldc_I4, CInt(1))
Typ = GetType(System.Int32)
checkFieldIL.Emit(OpCodes.Add)
checkFieldIL.Emit(OpCodes.Stloc, 6)
checkFieldIL.MarkSequencePoint(doc5, 500, 1, 500, 100)
Dim locbldr308 As LocalBuilder = checkFieldIL.DeclareLocal(GetType(Token))
locbldr308.SetLocalSymInfo("tok2")
checkFieldIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
checkFieldIL.Emit(OpCodes.Ldfld, GetType(Stmt).GetField("Tokens"))
Typ = GetType(Stmt).GetField("Tokens").FieldType
...
checkFieldIL.MarkSequencePoint(doc5, 501, 1, 501, 100)
Dim locbldr309 As LocalBuilder = checkFieldIL.DeclareLocal(GetType(System.Type))
locbldr309.SetLocalSymInfo("typ2")
checkFieldIL.Emit(OpCodes.Ldtoken, GetType(TypeTok))
Dim typ89 As Type() = {GetType(System.RuntimeTypeHandle)}
checkFieldIL.Emit(OpCodes.Call, GetType(System.Type).GetMethod("GetTypeFromHandle", typ89))
Typ = GetType(System.Type).GetMethod("GetTypeFromHandle", typ89).ReturnType
checkFieldIL.Emit(OpCodes.Stloc, 10)
checkFieldIL.MarkSequencePoint(doc5, 502, 1, 502, 100)
Dim locbldr310 As LocalBuilder = checkFieldIL.DeclareLocal(GetType(System.Boolean))
locbldr310.SetLocalSymInfo("b2")
Dim typ90(-1) As Type
...
ReDim Preserve typ90(UBound(typ90) + 1)
typ90(UBound(typ90)) = Typ
checkFieldIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("IsInstanceOfType", typ90))
Typ = Typ03.GetMethod("IsInstanceOfType", typ90).ReturnType
checkFieldIL.Emit(OpCodes.Stloc, 11)
checkFieldIL.MarkSequencePoint(doc5, 504, 1, 504, 100)
checkFieldIL.Emit(OpCodes.Ldloc, 11)
Typ = GetType(System.Boolean)
checkFieldIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa232 As System.Reflection.Emit.Label = checkFieldIL.DefineLabel()
Dim tru232 As System.Reflection.Emit.Label = checkFieldIL.DefineLabel()
Dim cont232 As System.Reflection.Emit.Label = checkFieldIL.DefineLabel()
checkFieldIL.Emit(OpCodes.Beq, fa232)
checkFieldIL.Emit(OpCodes.Br, tru232)
checkFieldIL.MarkLabel(tru232)
checkFieldIL.MarkSequencePoint(doc5, 505, 1, 505, 100)
Dim locbldr311 As LocalBuilder = checkFieldIL.DeclareLocal(GetType(Token))
locbldr311.SetLocalSymInfo("t")
checkFieldIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
checkFieldIL.Emit(OpCodes.Ldfld, GetType(Stmt).GetField("Tokens"))
Typ = GetType(Stmt).GetField("Tokens").FieldType
...
checkFieldIL.MarkSequencePoint(doc5, 506, 1, 506, 100)
Dim locbldr312 As LocalBuilder = checkFieldIL.DeclareLocal(GetType(TypeTok))
locbldr312.SetLocalSymInfo("tt")
checkFieldIL.Emit(OpCodes.Newobj, GetType(TypeTok).GetConstructor(Type.EmptyTypes))
checkFieldIL.Emit(OpCodes.Stloc, 13)
checkFieldIL.MarkSequencePoint(doc5, 507, 1, 507, 100)
...
checkFieldIL.MarkSequencePoint(doc5, 508, 1, 508, 100)
checkFieldIL.Emit(OpCodes.Ldloc, 13)
Typ = GetType(TypeTok)
checkFieldIL.Emit(OpCodes.Ldloc, 12)
Typ = GetType(Token)
...
checkFieldIL.MarkSequencePoint(doc5, 509, 1, 509, 100)
checkFieldIL.Emit(OpCodes.Ldloc, 2)
Typ = GetType(FieldStmt)
checkFieldIL.Emit(OpCodes.Ldloc, 13)
Typ = GetType(TypeTok)
checkFieldIL.Emit(OpCodes.Stfld, GetType(FieldStmt).GetField("FieldTyp"))
checkFieldIL.MarkSequencePoint(doc5, 510, 1, 510, 100)
checkFieldIL.Emit(OpCodes.Br, cont232)
checkFieldIL.MarkLabel(fa232)
checkFieldIL.MarkSequencePoint(doc5, 511, 1, 511, 100)
checkFieldIL.Emit(OpCodes.Ldloc, 2)
Typ = GetType(FieldStmt)
checkFieldIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
...
Typ = Typ.GetElementType()
checkFieldIL.Emit(OpCodes.Stfld, GetType(FieldStmt).GetField("FieldTyp"))
checkFieldIL.MarkSequencePoint(doc5, 512, 1, 512, 100)
checkFieldIL.Emit(OpCodes.Br, cont232)
checkFieldIL.MarkLabel(cont232)
checkFieldIL.MarkSequencePoint(doc5, 514, 1, 514, 100)
checkFieldIL.Emit(OpCodes.Ldloc, 6)
Typ = GetType(System.Int32)
checkFieldIL.Emit(OpCodes.Ldc_I4, CInt(1))
Typ = GetType(System.Int32)
checkFieldIL.Emit(OpCodes.Add)
checkFieldIL.Emit(OpCodes.Stloc, 6)
checkFieldIL.MarkSequencePoint(doc5, 515, 1, 515, 100)
checkFieldIL.Emit(OpCodes.Ldloc, 2)
Typ = GetType(FieldStmt)
checkFieldIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
...
checkFieldIL.MarkSequencePoint(doc5, 517, 1, 517, 100)
checkFieldIL.Emit(OpCodes.Br, cont229)
checkFieldIL.MarkLabel(fa229)
checkFieldIL.Emit(OpCodes.Br, cont229)
checkFieldIL.MarkLabel(cont229)
checkFieldIL.MarkSequencePoint(doc5, 519, 1, 519, 100)
checkFieldIL.Emit(OpCodes.Ldloc, 2)
Typ = GetType(FieldStmt)
checkFieldIL.MarkSequencePoint(doc5, 520, 1, 520, 100)
checkFieldIL.Emit(OpCodes.Ret)
Dim typ91(-1) As Type
ReDim Preserve typ91(UBound(typ91) + 1)
typ91(UBound(typ91)) = GetType(Stmt)
ReDim Preserve typ91(UBound(typ91) + 1)
typ91(UBound(typ91)) = GetType(System.Boolean).MakeByRefType()
Dim checkMethod As MethodBuilder = StmtOptimizer.DefineMethod("checkMethod", MethodAttributes.Public, GetType(Stmt), typ91)
...
Dim locbldr313 As LocalBuilder = checkMethodIL.DeclareLocal(GetType(Token))
locbldr313.SetLocalSymInfo("tok")
...
Dim locbldr314 As LocalBuilder = checkMethodIL.DeclareLocal(GetType(System.Type))
locbldr314.SetLocalSymInfo("typ")
checkMethodIL.Emit(OpCodes.Ldtoken, GetType(MethodTok))
Dim typ92 As Type() = {GetType(System.RuntimeTypeHandle)}
checkMethodIL.Emit(OpCodes.Call, GetType(System.Type).GetMethod("GetTypeFromHandle", typ92))
Typ = GetType(System.Type).GetMethod("GetTypeFromHandle", typ92).ReturnType
...
ReDim Preserve typ93(UBound(typ93) + 1)
typ93(UBound(typ93)) = Typ
checkMethodIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("IsInstanceOfType", typ93))
Typ = Typ03.GetMethod("IsInstanceOfType", typ93).ReturnType
checkMethodIL.Emit(OpCodes.Stobj, Typ04)
checkMethodIL.MarkSequencePoint(doc5, 527, 1, 527, 100)
Dim locbldr315 As LocalBuilder = checkMethodIL.DeclareLocal(GetType(MethodStmt))
locbldr315.SetLocalSymInfo("mtss")
...
Dim locbldr316 As LocalBuilder = checkMethodIL.DeclareLocal(GetType(Attributes.Attribute))
locbldr316.SetLocalSymInfo("att")
...
Dim locbldr317 As LocalBuilder = checkMethodIL.DeclareLocal(GetType(Ident))
locbldr317.SetLocalSymInfo("mn")
...
Dim locbldr318 As LocalBuilder = checkMethodIL.DeclareLocal(GetType(Expr))
locbldr318.SetLocalSymInfo("exp")
checkMethodIL.Emit(OpCodes.Ldnull)
checkMethodIL.Emit(OpCodes.Stloc, 5)
checkMethodIL.MarkSequencePoint(doc5, 531, 1, 531, 100)
Dim locbldr319 As LocalBuilder = checkMethodIL.DeclareLocal(GetType(System.Boolean))
locbldr319.SetLocalSymInfo("d")
...
Dim locbldr320 As LocalBuilder = checkMethodIL.DeclareLocal(GetType(Expr))
locbldr320.SetLocalSymInfo("tempexp")
...
Dim locbldr321 As LocalBuilder = checkMethodIL.DeclareLocal(asm.GetType("dylan.NET.Tokenizer.Parser.ExprOptimizer"))
locbldr321.SetLocalSymInfo("eop")
...
checkMethodIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("Optimize", typ94))
Typ = Typ03.GetMethod("Optimize", typ94).ReturnType
checkMethodIL.Emit(OpCodes.Stloc, 7)
checkMethodIL.MarkSequencePoint(doc5, 540, 1, 540, 100)
checkMethodIL.Emit(OpCodes.Ldc_I4, 0)
Typ = GetType(System.Boolean)
checkMethodIL.Emit(OpCodes.Stsfld, asm.GetType("dylan.NET.Tokenizer.Parser.ParserFlags").GetField("ProcessTTokOnly"))
checkMethodIL.MarkSequencePoint(doc5, 541, 1, 541, 100)
checkMethodIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
checkMethodIL.Emit(OpCodes.Ldloc, 7)
Typ = GetType(Expr)
...
checkMethodIL.MarkSequencePoint(doc5, 544, 1, 544, 100)
checkMethodIL.Emit(OpCodes.Ldloc, 2)
Typ = GetType(MethodStmt)
checkMethodIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
...
Dim label13 As System.Reflection.Emit.Label = checkMethodIL.DefineLabel()
checkMethodIL.MarkSequencePoint(doc5, 550, 1, 550, 100)
Dim locbldr322 As LocalBuilder = checkMethodIL.DeclareLocal(GetType(System.Int32))
locbldr322.SetLocalSymInfo("i")
checkMethodIL.Emit(OpCodes.Ldc_I4, CInt(0))
Typ = GetType(System.Int32)
checkMethodIL.Emit(OpCodes.Stloc, 9)
checkMethodIL.MarkSequencePoint(doc5, 551, 1, 551, 100)
Dim locbldr323 As LocalBuilder = checkMethodIL.DeclareLocal(GetType(System.Int32))
locbldr323.SetLocalSymInfo("len")
checkMethodIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
checkMethodIL.Emit(OpCodes.Ldfld, GetType(Stmt).GetField("Tokens"))
Typ = GetType(Stmt).GetField("Tokens").FieldType
...
checkMethodIL.MarkSequencePoint(doc5, 552, 1, 552, 100)
Dim locbldr324 As LocalBuilder = checkMethodIL.DeclareLocal(GetType(System.Boolean))
locbldr324.SetLocalSymInfo("bl")
checkMethodIL.Emit(OpCodes.Ldc_I4, 0)
Typ = GetType(System.Boolean)
checkMethodIL.Emit(OpCodes.Stloc, 11)
checkMethodIL.MarkSequencePoint(doc5, 555, 1, 555, 100)
...
ReDim Preserve typ97(UBound(typ97) + 1)
typ97(UBound(typ97)) = Typ
checkMethodIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("AddAttr", typ97))
Typ = Typ03.GetMethod("AddAttr", typ97).ReturnType
If Typ.ToString() = GetType(System.Void).ToString() Then
...
checkMethodIL.Emit(OpCodes.Br, label13)
checkMethodIL.MarkSequencePoint(doc5, 568, 1, 568, 100)
checkMethodIL.Emit(OpCodes.Br, cont234)
checkMethodIL.MarkLabel(cont234)
checkMethodIL.MarkSequencePoint(doc5, 570, 1, 570, 100)
checkMethodIL.Emit(OpCodes.Ldloc, 9)
Typ = GetType(System.Int32)
...
checkMethodIL.MarkSequencePoint(doc5, 578, 1, 578, 100)
checkMethodIL.MarkLabel(label13)
...
Dim locbldr325 As LocalBuilder = checkMethodIL.DeclareLocal(GetType(Token))
locbldr325.SetLocalSymInfo("tok2")
checkMethodIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
checkMethodIL.Emit(OpCodes.Ldfld, GetType(Stmt).GetField("Tokens"))
Typ = GetType(Stmt).GetField("Tokens").FieldType
...
Dim locbldr326 As LocalBuilder = checkMethodIL.DeclareLocal(GetType(System.Type))
locbldr326.SetLocalSymInfo("typ2")
checkMethodIL.MarkSequencePoint(doc5, 585, 1, 585, 100)
Dim locbldr327 As LocalBuilder = checkMethodIL.DeclareLocal(GetType(System.Boolean))
locbldr327.SetLocalSymInfo("b2")
checkMethodIL.MarkSequencePoint(doc5, 587, 1, 587, 100)
checkMethodIL.Emit(OpCodes.Ldtoken, GetType(TypeTok))
Dim typ98 As Type() = {GetType(System.RuntimeTypeHandle)}
checkMethodIL.Emit(OpCodes.Call, GetType(System.Type).GetMethod("GetTypeFromHandle", typ98))
Typ = GetType(System.Type).GetMethod("GetTypeFromHandle", typ98).ReturnType
...
ReDim Preserve typ99(UBound(typ99) + 1)
typ99(UBound(typ99)) = Typ
checkMethodIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("IsInstanceOfType", typ99))
Typ = Typ03.GetMethod("IsInstanceOfType", typ99).ReturnType
checkMethodIL.Emit(OpCodes.Stloc, 14)
checkMethodIL.MarkSequencePoint(doc5, 590, 1, 590, 100)
...
checkMethodIL.Emit(OpCodes.Beq, fa236)
checkMethodIL.Emit(OpCodes.Br, tru236)
checkMethodIL.MarkLabel(tru236)
checkMethodIL.MarkSequencePoint(doc5, 591, 1, 591, 100)
Dim locbldr328 As LocalBuilder = checkMethodIL.DeclareLocal(GetType(Token))
locbldr328.SetLocalSymInfo("t")
checkMethodIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
checkMethodIL.Emit(OpCodes.Ldfld, GetType(Stmt).GetField("Tokens"))
Typ = GetType(Stmt).GetField("Tokens").FieldType
...
Dim locbldr329 As LocalBuilder = checkMethodIL.DeclareLocal(GetType(TypeTok))
locbldr329.SetLocalSymInfo("tt")
...
checkMethodIL.MarkSequencePoint(doc5, 594, 1, 594, 100)
checkMethodIL.Emit(OpCodes.Ldloc, 16)
Typ = GetType(TypeTok)
checkMethodIL.Emit(OpCodes.Ldloc, 15)
Typ = GetType(Token)
...
checkMethodIL.MarkSequencePoint(doc5, 595, 1, 595, 100)
checkMethodIL.Emit(OpCodes.Ldloc, 2)
Typ = GetType(MethodStmt)
checkMethodIL.Emit(OpCodes.Ldloc, 16)
Typ = GetType(TypeTok)
...
Typ = Typ.GetElementType()
checkMethodIL.Emit(OpCodes.Stloc, 12)
checkMethodIL.MarkSequencePoint(doc5, 603, 1, 603, 100)
checkMethodIL.Emit(OpCodes.Ldtoken, GetType(Ident))
Dim typ100 As Type() = {GetType(System.RuntimeTypeHandle)}
checkMethodIL.Emit(OpCodes.Call, GetType(System.Type).GetMethod("GetTypeFromHandle", typ100))
Typ = GetType(System.Type).GetMethod("GetTypeFromHandle", typ100).ReturnType
checkMethodIL.Emit(OpCodes.Stloc, 13)
...
ReDim Preserve typ101(UBound(typ101) + 1)
typ101(UBound(typ101)) = Typ
checkMethodIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("IsInstanceOfType", typ101))
Typ = Typ03.GetMethod("IsInstanceOfType", typ101).ReturnType
checkMethodIL.Emit(OpCodes.Stloc, 14)
checkMethodIL.MarkSequencePoint(doc5, 605, 1, 605, 100)
checkMethodIL.Emit(OpCodes.Ldloc, 14)
Typ = GetType(System.Boolean)
checkMethodIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
...
checkMethodIL.MarkSequencePoint(doc5, 609, 1, 609, 100)
Dim label14 As System.Reflection.Emit.Label = checkMethodIL.DefineLabel()
checkMethodIL.MarkSequencePoint(doc5, 610, 1, 610, 100)
Dim label15 As System.Reflection.Emit.Label = checkMethodIL.DefineLabel()
checkMethodIL.MarkSequencePoint(doc5, 612, 1, 612, 100)
checkMethodIL.Emit(OpCodes.Ldloc, 9)
Typ = GetType(System.Int32)
checkMethodIL.Emit(OpCodes.Ldc_I4, CInt(1))
Typ = GetType(System.Int32)
checkMethodIL.Emit(OpCodes.Add)
checkMethodIL.Emit(OpCodes.Stloc, 9)
checkMethodIL.MarkSequencePoint(doc5, 613, 1, 613, 100)
checkMethodIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
checkMethodIL.Emit(OpCodes.Ldfld, GetType(Stmt).GetField("Tokens"))
Typ = GetType(Stmt).GetField("Tokens").FieldType
...
Typ = Typ.GetElementType()
checkMethodIL.Emit(OpCodes.Stloc, 12)
checkMethodIL.MarkSequencePoint(doc5, 614, 1, 614, 100)
checkMethodIL.Emit(OpCodes.Ldtoken, GetType(LParen))
Dim typ102 As Type() = {GetType(System.RuntimeTypeHandle)}
checkMethodIL.Emit(OpCodes.Call, GetType(System.Type).GetMethod("GetTypeFromHandle", typ102))
Typ = GetType(System.Type).GetMethod("GetTypeFromHandle", typ102).ReturnType
checkMethodIL.Emit(OpCodes.Stloc, 13)
checkMethodIL.MarkSequencePoint(doc5, 615, 1, 615, 100)
Dim typ103(-1) As Type
checkMethodIL.Emit(OpCodes.Ldloc, 13)
Typ = GetType(System.Type)
Typ03 = Typ
...
ReDim Preserve typ103(UBound(typ103) + 1)
typ103(UBound(typ103)) = Typ
checkMethodIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("IsInstanceOfType", typ103))
Typ = Typ03.GetMethod("IsInstanceOfType", typ103).ReturnType
checkMethodIL.Emit(OpCodes.Stloc, 14)
checkMethodIL.MarkSequencePoint(doc5, 616, 1, 616, 100)
checkMethodIL.Emit(OpCodes.Ldloc, 14)
Typ = GetType(System.Boolean)
checkMethodIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa238 As System.Reflection.Emit.Label = checkMethodIL.DefineLabel()
Dim tru238 As System.Reflection.Emit.Label = checkMethodIL.DefineLabel()
Dim cont238 As System.Reflection.Emit.Label = checkMethodIL.DefineLabel()
checkMethodIL.Emit(OpCodes.Beq, tru238)
checkMethodIL.Emit(OpCodes.Br, fa238)
checkMethodIL.MarkLabel(tru238)
checkMethodIL.MarkSequencePoint(doc5, 618, 1, 618, 100)
checkMethodIL.MarkLabel(label14)
checkMethodIL.MarkSequencePoint(doc5, 621, 1, 621, 100)
checkMethodIL.Emit(OpCodes.Ldloc, 9)
Typ = GetType(System.Int32)
checkMethodIL.Emit(OpCodes.Ldc_I4, CInt(1))
Typ = GetType(System.Int32)
checkMethodIL.Emit(OpCodes.Add)
checkMethodIL.Emit(OpCodes.Stloc, 9)
checkMethodIL.MarkSequencePoint(doc5, 623, 1, 623, 100)
checkMethodIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
checkMethodIL.Emit(OpCodes.Ldfld, GetType(Stmt).GetField("Tokens"))
Typ = GetType(Stmt).GetField("Tokens").FieldType
...
Typ = Typ.GetElementType()
checkMethodIL.Emit(OpCodes.Stloc, 12)
checkMethodIL.MarkSequencePoint(doc5, 624, 1, 624, 100)
checkMethodIL.Emit(OpCodes.Ldtoken, GetType(RParen))
Dim typ104 As Type() = {GetType(System.RuntimeTypeHandle)}
checkMethodIL.Emit(OpCodes.Call, GetType(System.Type).GetMethod("GetTypeFromHandle", typ104))
Typ = GetType(System.Type).GetMethod("GetTypeFromHandle", typ104).ReturnType
checkMethodIL.Emit(OpCodes.Stloc, 13)
checkMethodIL.MarkSequencePoint(doc5, 625, 1, 625, 100)
Dim typ105(-1) As Type
checkMethodIL.Emit(OpCodes.Ldloc, 13)
Typ = GetType(System.Type)
Typ03 = Typ
...
ReDim Preserve typ105(UBound(typ105) + 1)
typ105(UBound(typ105)) = Typ
checkMethodIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("IsInstanceOfType", typ105))
Typ = Typ03.GetMethod("IsInstanceOfType", typ105).ReturnType
checkMethodIL.Emit(OpCodes.Stloc, 14)
checkMethodIL.MarkSequencePoint(doc5, 626, 1, 626, 100)
checkMethodIL.Emit(OpCodes.Ldloc, 14)
Typ = GetType(System.Boolean)
checkMethodIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa239 As System.Reflection.Emit.Label = checkMethodIL.DefineLabel()
Dim tru239 As System.Reflection.Emit.Label = checkMethodIL.DefineLabel()
Dim cont239 As System.Reflection.Emit.Label = checkMethodIL.DefineLabel()
checkMethodIL.Emit(OpCodes.Beq, tru239)
checkMethodIL.Emit(OpCodes.Br, fa239)
checkMethodIL.MarkLabel(tru239)
checkMethodIL.MarkSequencePoint(doc5, 627, 1, 627, 100)
checkMethodIL.Emit(OpCodes.Ldloc, 6)
Typ = GetType(System.Boolean)
checkMethodIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa240 As System.Reflection.Emit.Label = checkMethodIL.DefineLabel()
Dim tru240 As System.Reflection.Emit.Label = checkMethodIL.DefineLabel()
Dim cont240 As System.Reflection.Emit.Label = checkMethodIL.DefineLabel()
checkMethodIL.Emit(OpCodes.Beq, tru240)
checkMethodIL.Emit(OpCodes.Br, fa240)
checkMethodIL.MarkLabel(tru240)
checkMethodIL.MarkSequencePoint(doc5, 628, 1, 628, 100)
Dim locbldr330 As LocalBuilder = checkMethodIL.DeclareLocal(asm.GetType("dylan.NET.Tokenizer.Parser.ExprOptimizer"))
locbldr330.SetLocalSymInfo("eopt2")
checkMethodIL.Emit(OpCodes.Newobj, asm.GetType("dylan.NET.Tokenizer.Parser.ExprOptimizer").GetConstructor(Type.EmptyTypes))
checkMethodIL.Emit(OpCodes.Stloc, 17)
checkMethodIL.MarkSequencePoint(doc5, 629, 1, 629, 100)
...
ReDim Preserve typ106(UBound(typ106) + 1)
typ106(UBound(typ106)) = Typ
checkMethodIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("checkVarAs", typ106))
Typ = Typ03.GetMethod("checkVarAs", typ106).ReturnType
checkMethodIL.Emit(OpCodes.Stloc, 5)
checkMethodIL.MarkSequencePoint(doc5, 630, 1, 630, 100)
checkMethodIL.Emit(OpCodes.Ldloc, 11)
Typ = GetType(System.Boolean)
checkMethodIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa241 As System.Reflection.Emit.Label = checkMethodIL.DefineLabel()
Dim tru241 As System.Reflection.Emit.Label = checkMethodIL.DefineLabel()
Dim cont241 As System.Reflection.Emit.Label = checkMethodIL.DefineLabel()
checkMethodIL.Emit(OpCodes.Beq, tru241)
checkMethodIL.Emit(OpCodes.Br, fa241)
checkMethodIL.MarkLabel(tru241)
checkMethodIL.MarkSequencePoint(doc5, 631, 1, 631, 100)
Dim typ107(-1) As Type
checkMethodIL.Emit(OpCodes.Ldloc, 2)
Typ = GetType(MethodStmt)
Typ03 = Typ
...
ReDim Preserve typ107(UBound(typ107) + 1)
typ107(UBound(typ107)) = Typ
checkMethodIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("AddParam", typ107))
Typ = Typ03.GetMethod("AddParam", typ107).ReturnType
If Typ.ToString() = GetType(System.Void).ToString() Then

Else
checkMethodIL.Emit(OpCodes.Pop)
End If
checkMethodIL.MarkSequencePoint(doc5, 632, 1, 632, 100)
checkMethodIL.Emit(OpCodes.Br, cont241)
checkMethodIL.MarkLabel(fa241)
checkMethodIL.Emit(OpCodes.Br, cont241)
checkMethodIL.MarkLabel(cont241)
checkMethodIL.MarkSequencePoint(doc5, 633, 1, 633, 100)
checkMethodIL.Emit(OpCodes.Br, cont240)
checkMethodIL.MarkLabel(fa240)
checkMethodIL.Emit(OpCodes.Br, cont240)
checkMethodIL.MarkLabel(cont240)
checkMethodIL.MarkSequencePoint(doc5, 634, 1, 634, 100)
checkMethodIL.Emit(OpCodes.Ldc_I4, 0)
Typ = GetType(System.Boolean)
checkMethodIL.Emit(OpCodes.Stloc, 6)
checkMethodIL.MarkSequencePoint(doc5, 635, 1, 635, 100)
checkMethodIL.Emit(OpCodes.Br, label15)
checkMethodIL.MarkSequencePoint(doc5, 636, 1, 636, 100)
checkMethodIL.Emit(OpCodes.Br, cont239)
checkMethodIL.MarkLabel(fa239)
checkMethodIL.Emit(OpCodes.Br, cont239)
checkMethodIL.MarkLabel(cont239)
checkMethodIL.MarkSequencePoint(doc5, 638, 1, 638, 100)
checkMethodIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
checkMethodIL.Emit(OpCodes.Ldfld, GetType(Stmt).GetField("Tokens"))
Typ = GetType(Stmt).GetField("Tokens").FieldType
...
Typ = Typ.GetElementType()
checkMethodIL.Emit(OpCodes.Stloc, 12)
checkMethodIL.MarkSequencePoint(doc5, 639, 1, 639, 100)
checkMethodIL.Emit(OpCodes.Ldtoken, GetType(VarTok))
Dim typ108 As Type() = {GetType(System.RuntimeTypeHandle)}
checkMethodIL.Emit(OpCodes.Call, GetType(System.Type).GetMethod("GetTypeFromHandle", typ108))
Typ = GetType(System.Type).GetMethod("GetTypeFromHandle", typ108).ReturnType
checkMethodIL.Emit(OpCodes.Stloc, 13)
checkMethodIL.MarkSequencePoint(doc5, 640, 1, 640, 100)
Dim typ109(-1) As Type
checkMethodIL.Emit(OpCodes.Ldloc, 13)
Typ = GetType(System.Type)
Typ03 = Typ
...
ReDim Preserve typ109(UBound(typ109) + 1)
typ109(UBound(typ109)) = Typ
checkMethodIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("IsInstanceOfType", typ109))
Typ = Typ03.GetMethod("IsInstanceOfType", typ109).ReturnType
checkMethodIL.Emit(OpCodes.Stloc, 14)
checkMethodIL.MarkSequencePoint(doc5, 641, 1, 641, 100)
checkMethodIL.Emit(OpCodes.Ldloc, 14)
Typ = GetType(System.Boolean)
checkMethodIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa242 As System.Reflection.Emit.Label = checkMethodIL.DefineLabel()
Dim tru242 As System.Reflection.Emit.Label = checkMethodIL.DefineLabel()
Dim cont242 As System.Reflection.Emit.Label = checkMethodIL.DefineLabel()
checkMethodIL.Emit(OpCodes.Beq, tru242)
checkMethodIL.Emit(OpCodes.Br, fa242)
checkMethodIL.MarkLabel(tru242)
checkMethodIL.MarkSequencePoint(doc5, 642, 1, 642, 100)
checkMethodIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
checkMethodIL.Emit(OpCodes.Stloc, 6)
checkMethodIL.MarkSequencePoint(doc5, 643, 1, 643, 100)
checkMethodIL.Emit(OpCodes.Newobj, GetType(Expr).GetConstructor(Type.EmptyTypes))
checkMethodIL.Emit(OpCodes.Stloc, 5)
checkMethodIL.MarkSequencePoint(doc5, 644, 1, 644, 100)
checkMethodIL.Emit(OpCodes.Br, cont242)
checkMethodIL.MarkLabel(fa242)
checkMethodIL.Emit(OpCodes.Br, cont242)
checkMethodIL.MarkLabel(cont242)
checkMethodIL.MarkSequencePoint(doc5, 646, 1, 646, 100)
checkMethodIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
checkMethodIL.Emit(OpCodes.Ldfld, GetType(Stmt).GetField("Tokens"))
Typ = GetType(Stmt).GetField("Tokens").FieldType
...
Typ = Typ.GetElementType()
checkMethodIL.Emit(OpCodes.Stloc, 12)
checkMethodIL.MarkSequencePoint(doc5, 647, 1, 647, 100)
checkMethodIL.Emit(OpCodes.Ldtoken, GetType(Comma))
Dim typ110 As Type() = {GetType(System.RuntimeTypeHandle)}
checkMethodIL.Emit(OpCodes.Call, GetType(System.Type).GetMethod("GetTypeFromHandle", typ110))
Typ = GetType(System.Type).GetMethod("GetTypeFromHandle", typ110).ReturnType
checkMethodIL.Emit(OpCodes.Stloc, 13)
checkMethodIL.MarkSequencePoint(doc5, 648, 1, 648, 100)
Dim typ111(-1) As Type
checkMethodIL.Emit(OpCodes.Ldloc, 13)
Typ = GetType(System.Type)
Typ03 = Typ
...
ReDim Preserve typ111(UBound(typ111) + 1)
typ111(UBound(typ111)) = Typ
checkMethodIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("IsInstanceOfType", typ111))
Typ = Typ03.GetMethod("IsInstanceOfType", typ111).ReturnType
checkMethodIL.Emit(OpCodes.Stloc, 14)
checkMethodIL.MarkSequencePoint(doc5, 649, 1, 649, 100)
checkMethodIL.Emit(OpCodes.Ldloc, 14)
Typ = GetType(System.Boolean)
checkMethodIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa243 As System.Reflection.Emit.Label = checkMethodIL.DefineLabel()
Dim tru243 As System.Reflection.Emit.Label = checkMethodIL.DefineLabel()
Dim cont243 As System.Reflection.Emit.Label = checkMethodIL.DefineLabel()
checkMethodIL.Emit(OpCodes.Beq, tru243)
checkMethodIL.Emit(OpCodes.Br, fa243)
checkMethodIL.MarkLabel(tru243)
checkMethodIL.MarkSequencePoint(doc5, 650, 1, 650, 100)
Dim locbldr331 As LocalBuilder = checkMethodIL.DeclareLocal(asm.GetType("dylan.NET.Tokenizer.Parser.ExprOptimizer"))
locbldr331.SetLocalSymInfo("eopt1")
checkMethodIL.Emit(OpCodes.Newobj, asm.GetType("dylan.NET.Tokenizer.Parser.ExprOptimizer").GetConstructor(Type.EmptyTypes))
checkMethodIL.Emit(OpCodes.Stloc, 18)
checkMethodIL.MarkSequencePoint(doc5, 651, 1, 651, 100)
Dim typ112(-1) As Type
...
ReDim Preserve typ112(UBound(typ112) + 1)
typ112(UBound(typ112)) = Typ
checkMethodIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("checkVarAs", typ112))
Typ = Typ03.GetMethod("checkVarAs", typ112).ReturnType
checkMethodIL.Emit(OpCodes.Stloc, 5)
checkMethodIL.MarkSequencePoint(doc5, 652, 1, 652, 100)
checkMethodIL.Emit(OpCodes.Ldloc, 11)
Typ = GetType(System.Boolean)
checkMethodIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa244 As System.Reflection.Emit.Label = checkMethodIL.DefineLabel()
Dim tru244 As System.Reflection.Emit.Label = checkMethodIL.DefineLabel()
Dim cont244 As System.Reflection.Emit.Label = checkMethodIL.DefineLabel()
checkMethodIL.Emit(OpCodes.Beq, tru244)
checkMethodIL.Emit(OpCodes.Br, fa244)
checkMethodIL.MarkLabel(tru244)
checkMethodIL.MarkSequencePoint(doc5, 653, 1, 653, 100)
Dim typ113(-1) As Type
checkMethodIL.Emit(OpCodes.Ldloc, 2)
Typ = GetType(MethodStmt)
Typ03 = Typ
...
ReDim Preserve typ113(UBound(typ113) + 1)
typ113(UBound(typ113)) = Typ
checkMethodIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("AddParam", typ113))
Typ = Typ03.GetMethod("AddParam", typ113).ReturnType
If Typ.ToString() = GetType(System.Void).ToString() Then

Else
checkMethodIL.Emit(OpCodes.Pop)
End If
checkMethodIL.MarkSequencePoint(doc5, 654, 1, 654, 100)
checkMethodIL.Emit(OpCodes.Br, cont244)
checkMethodIL.MarkLabel(fa244)
checkMethodIL.Emit(OpCodes.Br, cont244)
checkMethodIL.MarkLabel(cont244)
checkMethodIL.MarkSequencePoint(doc5, 655, 1, 655, 100)
checkMethodIL.Emit(OpCodes.Ldc_I4, 0)
Typ = GetType(System.Boolean)
checkMethodIL.Emit(OpCodes.Stloc, 6)
checkMethodIL.MarkSequencePoint(doc5, 656, 1, 656, 100)
checkMethodIL.Emit(OpCodes.Br, cont243)
checkMethodIL.MarkLabel(fa243)
checkMethodIL.Emit(OpCodes.Br, cont243)
checkMethodIL.MarkLabel(cont243)
checkMethodIL.MarkSequencePoint(doc5, 658, 1, 658, 100)
checkMethodIL.Emit(OpCodes.Ldloc, 6)
Typ = GetType(System.Boolean)
checkMethodIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa245 As System.Reflection.Emit.Label = checkMethodIL.DefineLabel()
Dim tru245 As System.Reflection.Emit.Label = checkMethodIL.DefineLabel()
Dim cont245 As System.Reflection.Emit.Label = checkMethodIL.DefineLabel()
checkMethodIL.Emit(OpCodes.Beq, tru245)
checkMethodIL.Emit(OpCodes.Br, fa245)
checkMethodIL.MarkLabel(tru245)
checkMethodIL.MarkSequencePoint(doc5, 659, 1, 659, 100)
Dim typ114(-1) As Type
checkMethodIL.Emit(OpCodes.Ldloc, 5)
Typ = GetType(Expr)
Typ03 = Typ
...
ReDim Preserve typ114(UBound(typ114) + 1)
typ114(UBound(typ114)) = Typ
checkMethodIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("AddToken", typ114))
Typ = Typ03.GetMethod("AddToken", typ114).ReturnType
If Typ.ToString() = GetType(System.Void).ToString() Then

Else
checkMethodIL.Emit(OpCodes.Pop)
End If
checkMethodIL.MarkSequencePoint(doc5, 660, 1, 660, 100)
checkMethodIL.Emit(OpCodes.Br, cont245)
checkMethodIL.MarkLabel(fa245)
checkMethodIL.Emit(OpCodes.Br, cont245)
checkMethodIL.MarkLabel(cont245)
checkMethodIL.MarkSequencePoint(doc5, 663, 1, 663, 100)
checkMethodIL.Emit(OpCodes.Ldloc, 9)
Typ = GetType(System.Int32)
checkMethodIL.Emit(OpCodes.Ldloc, 10)
Typ = GetType(System.Int32)
Dim fa246 As System.Reflection.Emit.Label = checkMethodIL.DefineLabel()
Dim tru246 As System.Reflection.Emit.Label = checkMethodIL.DefineLabel()
Dim cont246 As System.Reflection.Emit.Label = checkMethodIL.DefineLabel()
checkMethodIL.Emit(OpCodes.Beq, tru246)
checkMethodIL.Emit(OpCodes.Br, fa246)
checkMethodIL.MarkLabel(tru246)
checkMethodIL.MarkSequencePoint(doc5, 664, 1, 664, 100)
checkMethodIL.Emit(OpCodes.Br, label15)
checkMethodIL.MarkSequencePoint(doc5, 665, 1, 665, 100)
checkMethodIL.Emit(OpCodes.Br, cont246)
checkMethodIL.MarkLabel(fa246)
checkMethodIL.MarkSequencePoint(doc5, 666, 1, 666, 100)
checkMethodIL.Emit(OpCodes.Br, label14)
checkMethodIL.MarkSequencePoint(doc5, 667, 1, 667, 100)
checkMethodIL.Emit(OpCodes.Br, cont246)
checkMethodIL.MarkLabel(cont246)
checkMethodIL.MarkSequencePoint(doc5, 669, 1, 669, 100)
checkMethodIL.MarkLabel(label15)
checkMethodIL.MarkSequencePoint(doc5, 671, 1, 671, 100)
checkMethodIL.Emit(OpCodes.Br, cont238)
checkMethodIL.MarkLabel(fa238)
checkMethodIL.Emit(OpCodes.Br, cont238)
checkMethodIL.MarkLabel(cont238)
checkMethodIL.MarkSequencePoint(doc5, 673, 1, 673, 100)
checkMethodIL.Emit(OpCodes.Br, cont233)
checkMethodIL.MarkLabel(fa233)
checkMethodIL.Emit(OpCodes.Br, cont233)
checkMethodIL.MarkLabel(cont233)
checkMethodIL.MarkSequencePoint(doc5, 674, 1, 674, 100)
checkMethodIL.Emit(OpCodes.Ldloc, 2)
Typ = GetType(MethodStmt)
checkMethodIL.MarkSequencePoint(doc5, 675, 1, 675, 100)
checkMethodIL.Emit(OpCodes.Ret)
Dim typ115(-1) As Type
ReDim Preserve typ115(UBound(typ115) + 1)
typ115(UBound(typ115)) = GetType(Stmt)
ReDim Preserve typ115(UBound(typ115) + 1)
typ115(UBound(typ115)) = GetType(System.Boolean).MakeByRefType()
Dim checkMethodCall As MethodBuilder = StmtOptimizer.DefineMethod("checkMethodCall", MethodAttributes.Public, GetType(Stmt), typ115)
...
checkMethodCallIL.Emit(OpCodes.Bgt, tru247)
...
locbldr332.SetLocalSymInfo("tok")
checkMethodCallIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
checkMethodCallIL.Emit(OpCodes.Ldfld, GetType(Stmt).GetField("Tokens"))
Typ = GetType(Stmt).GetField("Tokens").FieldType
...
Dim typ116 As Type() = {GetType(System.RuntimeTypeHandle)}
checkMethodCallIL.Emit(OpCodes.Call, GetType(System.Type).GetMethod("GetTypeFromHandle", typ116))
Typ = GetType(System.Type).GetMethod("GetTypeFromHandle", typ116).ReturnType
checkMethodCallIL.Emit(OpCodes.Stloc, 1)
checkMethodCallIL.MarkSequencePoint(doc5, 682, 1, 682, 100)
Dim locbldr334 As LocalBuilder = checkMethodCallIL.DeclareLocal(GetType(Token))
locbldr334.SetLocalSymInfo("tokb")
checkMethodCallIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
checkMethodCallIL.Emit(OpCodes.Ldfld, GetType(Stmt).GetField("Tokens"))
Typ = GetType(Stmt).GetField("Tokens").FieldType
...
Dim locbldr335 As LocalBuilder = checkMethodCallIL.DeclareLocal(GetType(System.Type))
locbldr335.SetLocalSymInfo("typb")
...
Dim locbldr336 As LocalBuilder = checkMethodCallIL.DeclareLocal(GetType(System.Boolean))
locbldr336.SetLocalSymInfo("ba")
Dim typ118(-1) As Type
...
Dim locbldr337 As LocalBuilder = checkMethodCallIL.DeclareLocal(GetType(System.Boolean))
locbldr337.SetLocalSymInfo("bb")
Dim typ119(-1) As Type
...
ReDim Preserve typ119(UBound(typ119) + 1)
typ119(UBound(typ119)) = Typ
checkMethodCallIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("IsInstanceOfType", typ119))
...
Dim locbldr338 As LocalBuilder = checkMethodCallIL.DeclareLocal(GetType(MethodCallStmt))
locbldr338.SetLocalSymInfo("mtcss")
...
Dim locbldr339 As LocalBuilder = checkMethodCallIL.DeclareLocal(GetType(MethodNameTok))
locbldr339.SetLocalSymInfo("mn")
...
Dim locbldr340 As LocalBuilder = checkMethodCallIL.DeclareLocal(GetType(MethodCallTok))
locbldr340.SetLocalSymInfo("mct")
...
Dim locbldr341 As LocalBuilder = checkMethodCallIL.DeclareLocal(GetType(Ident))
locbldr341.SetLocalSymInfo("idt")
...
Dim locbldr342 As LocalBuilder = checkMethodCallIL.DeclareLocal(GetType(Expr))
locbldr342.SetLocalSymInfo("exp")
...
Dim locbldr343 As LocalBuilder = checkMethodCallIL.DeclareLocal(GetType(System.Int32))
locbldr343.SetLocalSymInfo("lvl")
checkMethodCallIL.Emit(OpCodes.Ldc_I4, CInt(1))
Typ = GetType(System.Int32)
checkMethodCallIL.Emit(OpCodes.Stloc, 11)
checkMethodCallIL.MarkSequencePoint(doc5, 695, 1, 695, 100)
Dim locbldr344 As LocalBuilder = checkMethodCallIL.DeclareLocal(GetType(System.Boolean))
locbldr344.SetLocalSymInfo("d")
...
Dim locbldr345 As LocalBuilder = checkMethodCallIL.DeclareLocal(GetType(System.Int32))
locbldr345.SetLocalSymInfo("i")
checkMethodCallIL.Emit(OpCodes.Ldc_I4, CInt(1))
Typ = GetType(System.Int32)
...
checkMethodCallIL.MarkSequencePoint(doc5, 703, 1, 703, 100)
checkMethodCallIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
checkMethodCallIL.Emit(OpCodes.Ldfld, GetType(Stmt).GetField("Tokens"))
Typ = GetType(Stmt).GetField("Tokens").FieldType
...
checkMethodCallIL.MarkSequencePoint(doc5, 705, 1, 705, 100)
checkMethodCallIL.Emit(OpCodes.Ldloc, 7)
Typ = GetType(MethodNameTok)
checkMethodCallIL.Emit(OpCodes.Ldloc, 9)
Typ = GetType(Ident)
...
Dim locbldr346 As LocalBuilder = checkMethodCallIL.DeclareLocal(GetType(Token))
locbldr346.SetLocalSymInfo("tok2")
checkMethodCallIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
checkMethodCallIL.Emit(OpCodes.Ldfld, GetType(Stmt).GetField("Tokens"))
Typ = GetType(Stmt).GetField("Tokens").FieldType
...
Dim locbldr347 As LocalBuilder = checkMethodCallIL.DeclareLocal(GetType(System.Type))
locbldr347.SetLocalSymInfo("typ2")
checkMethodCallIL.MarkSequencePoint(doc5, 709, 1, 709, 100)
Dim locbldr348 As LocalBuilder = checkMethodCallIL.DeclareLocal(GetType(System.Boolean))
locbldr348.SetLocalSymInfo("b2")
checkMethodCallIL.MarkSequencePoint(doc5, 710, 1, 710, 100)
Dim locbldr349 As LocalBuilder = checkMethodCallIL.DeclareLocal(GetType(System.Int32))
locbldr349.SetLocalSymInfo("len")
checkMethodCallIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
checkMethodCallIL.Emit(OpCodes.Ldfld, GetType(Stmt).GetField("Tokens"))
Typ = GetType(Stmt).GetField("Tokens").FieldType
...
Dim locbldr350 As LocalBuilder = checkMethodCallIL.DeclareLocal(asm.GetType("dylan.NET.Tokenizer.Parser.ExprOptimizer"))
locbldr350.SetLocalSymInfo("eopt")
...
Dim label16 As System.Reflection.Emit.Label = checkMethodCallIL.DefineLabel()
checkMethodCallIL.MarkSequencePoint(doc5, 714, 1, 714, 100)
Dim label17 As System.Reflection.Emit.Label = checkMethodCallIL.DefineLabel()
checkMethodCallIL.MarkSequencePoint(doc5, 715, 1, 715, 100)
Dim label18 As System.Reflection.Emit.Label = checkMethodCallIL.DefineLabel()
checkMethodCallIL.MarkSequencePoint(doc5, 717, 1, 717, 100)
checkMethodCallIL.MarkLabel(label16)
checkMethodCallIL.MarkSequencePoint(doc5, 720, 1, 720, 100)
checkMethodCallIL.Emit(OpCodes.Ldloc, 13)
Typ = GetType(System.Int32)
checkMethodCallIL.Emit(OpCodes.Ldc_I4, CInt(1))
Typ = GetType(System.Int32)
...
checkMethodCallIL.Emit(OpCodes.Stloc, 13)
checkMethodCallIL.MarkSequencePoint(doc5, 722, 1, 722, 100)
checkMethodCallIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
checkMethodCallIL.Emit(OpCodes.Ldfld, GetType(Stmt).GetField("Tokens"))
Typ = GetType(Stmt).GetField("Tokens").FieldType
...
Dim typ120 As Type() = {GetType(System.RuntimeTypeHandle)}
checkMethodCallIL.Emit(OpCodes.Call, GetType(System.Type).GetMethod("GetTypeFromHandle", typ120))
Typ = GetType(System.Type).GetMethod("GetTypeFromHandle", typ120).ReturnType
...
ReDim Preserve typ121(UBound(typ121) + 1)
typ121(UBound(typ121)) = Typ
checkMethodCallIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("IsInstanceOfType", typ121))
Typ = Typ03.GetMethod("IsInstanceOfType", typ121).ReturnType
...
checkMethodCallIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa249 As System.Reflection.Emit.Label = checkMethodCallIL.DefineLabel()
Dim tru249 As System.Reflection.Emit.Label = checkMethodCallIL.DefineLabel()
Dim cont249 As System.Reflection.Emit.Label = checkMethodCallIL.DefineLabel()
checkMethodCallIL.Emit(OpCodes.Beq, tru249)
checkMethodCallIL.Emit(OpCodes.Br, fa249)
checkMethodCallIL.MarkLabel(tru249)
checkMethodCallIL.MarkSequencePoint(doc5, 726, 1, 726, 100)
...
checkMethodCallIL.Emit(OpCodes.Stloc, 11)
checkMethodCallIL.MarkSequencePoint(doc5, 727, 1, 727, 100)
checkMethodCallIL.Emit(OpCodes.Ldloc, 11)
Typ = GetType(System.Int32)
checkMethodCallIL.Emit(OpCodes.Ldc_I4, CInt(0))
Typ = GetType(System.Int32)
Dim fa250 As System.Reflection.Emit.Label = checkMethodCallIL.DefineLabel()
Dim tru250 As System.Reflection.Emit.Label = checkMethodCallIL.DefineLabel()
Dim cont250 As System.Reflection.Emit.Label = checkMethodCallIL.DefineLabel()
checkMethodCallIL.Emit(OpCodes.Beq, tru250)
checkMethodCallIL.Emit(OpCodes.Br, fa250)
checkMethodCallIL.MarkLabel(tru250)
checkMethodCallIL.MarkSequencePoint(doc5, 728, 1, 728, 100)
checkMethodCallIL.Emit(OpCodes.Ldc_I4, 0)
Typ = GetType(System.Boolean)
checkMethodCallIL.Emit(OpCodes.Stloc, 12)
checkMethodCallIL.MarkSequencePoint(doc5, 729, 1, 729, 100)
Dim typ122(-1) As Type
...
ReDim Preserve typ122(UBound(typ122) + 1)
typ122(UBound(typ122)) = Typ
checkMethodCallIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("Optimize", typ122))
Typ = Typ03.GetMethod("Optimize", typ122).ReturnType
checkMethodCallIL.Emit(OpCodes.Stloc, 10)
checkMethodCallIL.MarkSequencePoint(doc5, 730, 1, 730, 100)
checkMethodCallIL.Emit(OpCodes.Ldloc, 10)
Typ = GetType(Expr)
...
checkMethodCallIL.Emit(OpCodes.Ldc_I4, CInt(0))
Typ = GetType(System.Int32)
Dim fa251 As System.Reflection.Emit.Label = checkMethodCallIL.DefineLabel()
Dim tru251 As System.Reflection.Emit.Label = checkMethodCallIL.DefineLabel()
Dim cont251 As System.Reflection.Emit.Label = checkMethodCallIL.DefineLabel()
checkMethodCallIL.Emit(OpCodes.Bgt, tru251)
checkMethodCallIL.Emit(OpCodes.Br, fa251)
checkMethodCallIL.MarkLabel(tru251)
checkMethodCallIL.MarkSequencePoint(doc5, 731, 1, 731, 100)
Dim typ123(-1) As Type
...
ReDim Preserve typ123(UBound(typ123) + 1)
typ123(UBound(typ123)) = Typ
checkMethodCallIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("AddParam", typ123))
Typ = Typ03.GetMethod("AddParam", typ123).ReturnType
If Typ.ToString() = GetType(System.Void).ToString() Then

Else
checkMethodCallIL.Emit(OpCodes.Pop)
End If
checkMethodCallIL.MarkSequencePoint(doc5, 732, 1, 732, 100)
checkMethodCallIL.Emit(OpCodes.Br, cont251)
checkMethodCallIL.MarkLabel(fa251)
checkMethodCallIL.Emit(OpCodes.Br, cont251)
checkMethodCallIL.MarkLabel(cont251)
checkMethodCallIL.MarkSequencePoint(doc5, 733, 1, 733, 100)
checkMethodCallIL.Emit(OpCodes.Br, label17)
checkMethodCallIL.MarkSequencePoint(doc5, 734, 1, 734, 100)
checkMethodCallIL.Emit(OpCodes.Br, cont250)
checkMethodCallIL.MarkLabel(fa250)
checkMethodCallIL.MarkSequencePoint(doc5, 735, 1, 735, 100)
checkMethodCallIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
checkMethodCallIL.Emit(OpCodes.Stloc, 12)
checkMethodCallIL.MarkSequencePoint(doc5, 736, 1, 736, 100)
checkMethodCallIL.Emit(OpCodes.Br, label18)
checkMethodCallIL.MarkSequencePoint(doc5, 737, 1, 737, 100)
checkMethodCallIL.Emit(OpCodes.Br, cont250)
checkMethodCallIL.MarkLabel(cont250)
checkMethodCallIL.MarkSequencePoint(doc5, 738, 1, 738, 100)
checkMethodCallIL.Emit(OpCodes.Br, label18)
checkMethodCallIL.MarkSequencePoint(doc5, 739, 1, 739, 100)
checkMethodCallIL.Emit(OpCodes.Br, cont249)
checkMethodCallIL.MarkLabel(fa249)
checkMethodCallIL.Emit(OpCodes.Br, cont249)
checkMethodCallIL.MarkLabel(cont249)
checkMethodCallIL.MarkSequencePoint(doc5, 741, 1, 741, 100)
checkMethodCallIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
checkMethodCallIL.Emit(OpCodes.Ldfld, GetType(Stmt).GetField("Tokens"))
Typ = GetType(Stmt).GetField("Tokens").FieldType
...
Typ = Typ.GetElementType()
checkMethodCallIL.Emit(OpCodes.Stloc, 14)
checkMethodCallIL.MarkSequencePoint(doc5, 742, 1, 742, 100)
checkMethodCallIL.Emit(OpCodes.Ldtoken, GetType(LParen))
Dim typ124 As Type() = {GetType(System.RuntimeTypeHandle)}
checkMethodCallIL.Emit(OpCodes.Call, GetType(System.Type).GetMethod("GetTypeFromHandle", typ124))
Typ = GetType(System.Type).GetMethod("GetTypeFromHandle", typ124).ReturnType
checkMethodCallIL.Emit(OpCodes.Stloc, 15)
checkMethodCallIL.MarkSequencePoint(doc5, 743, 1, 743, 100)
Dim typ125(-1) As Type
checkMethodCallIL.Emit(OpCodes.Ldloc, 15)
Typ = GetType(System.Type)
Typ03 = Typ
...
ReDim Preserve typ125(UBound(typ125) + 1)
typ125(UBound(typ125)) = Typ
checkMethodCallIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("IsInstanceOfType", typ125))
Typ = Typ03.GetMethod("IsInstanceOfType", typ125).ReturnType
checkMethodCallIL.Emit(OpCodes.Stloc, 16)
checkMethodCallIL.MarkSequencePoint(doc5, 744, 1, 744, 100)
checkMethodCallIL.Emit(OpCodes.Ldloc, 16)
Typ = GetType(System.Boolean)
checkMethodCallIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa252 As System.Reflection.Emit.Label = checkMethodCallIL.DefineLabel()
Dim tru252 As System.Reflection.Emit.Label = checkMethodCallIL.DefineLabel()
Dim cont252 As System.Reflection.Emit.Label = checkMethodCallIL.DefineLabel()
checkMethodCallIL.Emit(OpCodes.Beq, tru252)
checkMethodCallIL.Emit(OpCodes.Br, fa252)
checkMethodCallIL.MarkLabel(tru252)
checkMethodCallIL.MarkSequencePoint(doc5, 745, 1, 745, 100)
checkMethodCallIL.Emit(OpCodes.Ldloc, 11)
Typ = GetType(System.Int32)
checkMethodCallIL.Emit(OpCodes.Ldc_I4, CInt(1))
Typ = GetType(System.Int32)
checkMethodCallIL.Emit(OpCodes.Add)
checkMethodCallIL.Emit(OpCodes.Stloc, 11)
checkMethodCallIL.MarkSequencePoint(doc5, 746, 1, 746, 100)
checkMethodCallIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
checkMethodCallIL.Emit(OpCodes.Stloc, 12)
checkMethodCallIL.MarkSequencePoint(doc5, 747, 1, 747, 100)
checkMethodCallIL.Emit(OpCodes.Br, label18)
checkMethodCallIL.MarkSequencePoint(doc5, 748, 1, 748, 100)
checkMethodCallIL.Emit(OpCodes.Br, cont252)
checkMethodCallIL.MarkLabel(fa252)
checkMethodCallIL.Emit(OpCodes.Br, cont252)
checkMethodCallIL.MarkLabel(cont252)
checkMethodCallIL.MarkSequencePoint(doc5, 750, 1, 750, 100)
checkMethodCallIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
checkMethodCallIL.Emit(OpCodes.Ldfld, GetType(Stmt).GetField("Tokens"))
Typ = GetType(Stmt).GetField("Tokens").FieldType
...
Typ = Typ.GetElementType()
checkMethodCallIL.Emit(OpCodes.Stloc, 14)
checkMethodCallIL.MarkSequencePoint(doc5, 751, 1, 751, 100)
checkMethodCallIL.Emit(OpCodes.Ldtoken, GetType(Comma))
Dim typ126 As Type() = {GetType(System.RuntimeTypeHandle)}
checkMethodCallIL.Emit(OpCodes.Call, GetType(System.Type).GetMethod("GetTypeFromHandle", typ126))
Typ = GetType(System.Type).GetMethod("GetTypeFromHandle", typ126).ReturnType
checkMethodCallIL.Emit(OpCodes.Stloc, 15)
checkMethodCallIL.MarkSequencePoint(doc5, 752, 1, 752, 100)
Dim typ127(-1) As Type
checkMethodCallIL.Emit(OpCodes.Ldloc, 15)
Typ = GetType(System.Type)
Typ03 = Typ
...
ReDim Preserve typ127(UBound(typ127) + 1)
typ127(UBound(typ127)) = Typ
checkMethodCallIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("IsInstanceOfType", typ127))
Typ = Typ03.GetMethod("IsInstanceOfType", typ127).ReturnType
checkMethodCallIL.Emit(OpCodes.Stloc, 16)
checkMethodCallIL.MarkSequencePoint(doc5, 753, 1, 753, 100)
checkMethodCallIL.Emit(OpCodes.Ldloc, 16)
Typ = GetType(System.Boolean)
checkMethodCallIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa253 As System.Reflection.Emit.Label = checkMethodCallIL.DefineLabel()
Dim tru253 As System.Reflection.Emit.Label = checkMethodCallIL.DefineLabel()
Dim cont253 As System.Reflection.Emit.Label = checkMethodCallIL.DefineLabel()
checkMethodCallIL.Emit(OpCodes.Beq, tru253)
checkMethodCallIL.Emit(OpCodes.Br, fa253)
checkMethodCallIL.MarkLabel(tru253)
checkMethodCallIL.MarkSequencePoint(doc5, 754, 1, 754, 100)
checkMethodCallIL.Emit(OpCodes.Ldloc, 11)
Typ = GetType(System.Int32)
checkMethodCallIL.Emit(OpCodes.Ldc_I4, CInt(1))
Typ = GetType(System.Int32)
Dim fa254 As System.Reflection.Emit.Label = checkMethodCallIL.DefineLabel()
Dim tru254 As System.Reflection.Emit.Label = checkMethodCallIL.DefineLabel()
Dim cont254 As System.Reflection.Emit.Label = checkMethodCallIL.DefineLabel()
checkMethodCallIL.Emit(OpCodes.Beq, tru254)
checkMethodCallIL.Emit(OpCodes.Br, fa254)
checkMethodCallIL.MarkLabel(tru254)
checkMethodCallIL.MarkSequencePoint(doc5, 755, 1, 755, 100)
checkMethodCallIL.Emit(OpCodes.Ldc_I4, 0)
Typ = GetType(System.Boolean)
checkMethodCallIL.Emit(OpCodes.Stloc, 12)
checkMethodCallIL.MarkSequencePoint(doc5, 756, 1, 756, 100)
...
checkMethodCallIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("Optimize", typ128))
Typ = Typ03.GetMethod("Optimize", typ128).ReturnType
checkMethodCallIL.Emit(OpCodes.Stloc, 10)
checkMethodCallIL.MarkSequencePoint(doc5, 757, 1, 757, 100)
checkMethodCallIL.Emit(OpCodes.Ldloc, 10)
Typ = GetType(Expr)
checkMethodCallIL.Emit(OpCodes.Ldfld, GetType(Expr).GetField("Tokens"))
Typ = GetType(Expr).GetField("Tokens").FieldType
...
checkMethodCallIL.Emit(OpCodes.Ldc_I4, CInt(0))
Typ = GetType(System.Int32)
Dim fa255 As System.Reflection.Emit.Label = checkMethodCallIL.DefineLabel()
Dim tru255 As System.Reflection.Emit.Label = checkMethodCallIL.DefineLabel()
Dim cont255 As System.Reflection.Emit.Label = checkMethodCallIL.DefineLabel()
checkMethodCallIL.Emit(OpCodes.Bgt, tru255)
checkMethodCallIL.Emit(OpCodes.Br, fa255)
checkMethodCallIL.MarkLabel(tru255)
checkMethodCallIL.MarkSequencePoint(doc5, 758, 1, 758, 100)
Dim typ129(-1) As Type
checkMethodCallIL.Emit(OpCodes.Ldloc, 8)
Typ = GetType(MethodCallTok)
Typ03 = Typ
...
ReDim Preserve typ129(UBound(typ129) + 1)
typ129(UBound(typ129)) = Typ
checkMethodCallIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("AddParam", typ129))
Typ = Typ03.GetMethod("AddParam", typ129).ReturnType
If Typ.ToString() = GetType(System.Void).ToString() Then

Else
checkMethodCallIL.Emit(OpCodes.Pop)
End If
checkMethodCallIL.MarkSequencePoint(doc5, 759, 1, 759, 100)
checkMethodCallIL.Emit(OpCodes.Br, cont255)
checkMethodCallIL.MarkLabel(fa255)
checkMethodCallIL.Emit(OpCodes.Br, cont255)
checkMethodCallIL.MarkLabel(cont255)
checkMethodCallIL.MarkSequencePoint(doc5, 760, 1, 760, 100)
checkMethodCallIL.Emit(OpCodes.Newobj, GetType(Expr).GetConstructor(Type.EmptyTypes))
checkMethodCallIL.Emit(OpCodes.Stloc, 10)
checkMethodCallIL.MarkSequencePoint(doc5, 761, 1, 761, 100)
checkMethodCallIL.Emit(OpCodes.Br, label18)
checkMethodCallIL.MarkSequencePoint(doc5, 762, 1, 762, 100)
checkMethodCallIL.Emit(OpCodes.Br, cont254)
checkMethodCallIL.MarkLabel(fa254)
checkMethodCallIL.MarkSequencePoint(doc5, 763, 1, 763, 100)
checkMethodCallIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
checkMethodCallIL.Emit(OpCodes.Stloc, 12)
checkMethodCallIL.MarkSequencePoint(doc5, 764, 1, 764, 100)
checkMethodCallIL.Emit(OpCodes.Br, label18)
checkMethodCallIL.MarkSequencePoint(doc5, 765, 1, 765, 100)
checkMethodCallIL.Emit(OpCodes.Br, cont254)
checkMethodCallIL.MarkLabel(cont254)
checkMethodCallIL.MarkSequencePoint(doc5, 766, 1, 766, 100)
checkMethodCallIL.Emit(OpCodes.Br, cont253)
checkMethodCallIL.MarkLabel(fa253)
checkMethodCallIL.MarkSequencePoint(doc5, 767, 1, 767, 100)
checkMethodCallIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
checkMethodCallIL.Emit(OpCodes.Stloc, 12)
checkMethodCallIL.MarkSequencePoint(doc5, 768, 1, 768, 100)
checkMethodCallIL.Emit(OpCodes.Br, label18)
checkMethodCallIL.MarkSequencePoint(doc5, 769, 1, 769, 100)
checkMethodCallIL.Emit(OpCodes.Br, cont253)
checkMethodCallIL.MarkLabel(cont253)
checkMethodCallIL.MarkSequencePoint(doc5, 771, 1, 771, 100)
checkMethodCallIL.MarkLabel(label18)
checkMethodCallIL.MarkSequencePoint(doc5, 773, 1, 773, 100)
checkMethodCallIL.Emit(OpCodes.Ldloc, 12)
Typ = GetType(System.Boolean)
checkMethodCallIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa256 As System.Reflection.Emit.Label = checkMethodCallIL.DefineLabel()
Dim tru256 As System.Reflection.Emit.Label = checkMethodCallIL.DefineLabel()
Dim cont256 As System.Reflection.Emit.Label = checkMethodCallIL.DefineLabel()
checkMethodCallIL.Emit(OpCodes.Beq, tru256)
checkMethodCallIL.Emit(OpCodes.Br, fa256)
checkMethodCallIL.MarkLabel(tru256)
checkMethodCallIL.MarkSequencePoint(doc5, 774, 1, 774, 100)
Dim typ130(-1) As Type
checkMethodCallIL.Emit(OpCodes.Ldloc, 10)
Typ = GetType(Expr)
Typ03 = Typ
...
ReDim Preserve typ130(UBound(typ130) + 1)
typ130(UBound(typ130)) = Typ
checkMethodCallIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("AddToken", typ130))
Typ = Typ03.GetMethod("AddToken", typ130).ReturnType
If Typ.ToString() = GetType(System.Void).ToString() Then

Else
checkMethodCallIL.Emit(OpCodes.Pop)
End If
checkMethodCallIL.MarkSequencePoint(doc5, 775, 1, 775, 100)
checkMethodCallIL.Emit(OpCodes.Br, cont256)
checkMethodCallIL.MarkLabel(fa256)
checkMethodCallIL.Emit(OpCodes.Br, cont256)
checkMethodCallIL.MarkLabel(cont256)
checkMethodCallIL.MarkSequencePoint(doc5, 777, 1, 777, 100)
checkMethodCallIL.Emit(OpCodes.Ldloc, 13)
Typ = GetType(System.Int32)
checkMethodCallIL.Emit(OpCodes.Ldloc, 17)
Typ = GetType(System.Int32)
Dim fa257 As System.Reflection.Emit.Label = checkMethodCallIL.DefineLabel()
Dim tru257 As System.Reflection.Emit.Label = checkMethodCallIL.DefineLabel()
Dim cont257 As System.Reflection.Emit.Label = checkMethodCallIL.DefineLabel()
checkMethodCallIL.Emit(OpCodes.Beq, tru257)
checkMethodCallIL.Emit(OpCodes.Br, fa257)
checkMethodCallIL.MarkLabel(tru257)
checkMethodCallIL.MarkSequencePoint(doc5, 778, 1, 778, 100)
checkMethodCallIL.Emit(OpCodes.Br, label17)
checkMethodCallIL.MarkSequencePoint(doc5, 779, 1, 779, 100)
checkMethodCallIL.Emit(OpCodes.Br, cont257)
checkMethodCallIL.MarkLabel(fa257)
checkMethodCallIL.MarkSequencePoint(doc5, 780, 1, 780, 100)
checkMethodCallIL.Emit(OpCodes.Br, label16)
checkMethodCallIL.MarkSequencePoint(doc5, 781, 1, 781, 100)
checkMethodCallIL.Emit(OpCodes.Br, cont257)
checkMethodCallIL.MarkLabel(cont257)
checkMethodCallIL.MarkSequencePoint(doc5, 783, 1, 783, 100)
checkMethodCallIL.MarkLabel(label17)
checkMethodCallIL.MarkSequencePoint(doc5, 785, 1, 785, 100)
checkMethodCallIL.Emit(OpCodes.Ldloc, 8)
Typ = GetType(MethodCallTok)
checkMethodCallIL.Emit(OpCodes.Ldloc, 7)
Typ = GetType(MethodNameTok)
checkMethodCallIL.Emit(OpCodes.Stfld, GetType(MethodCallTok).GetField("Name"))
checkMethodCallIL.MarkSequencePoint(doc5, 786, 1, 786, 100)
checkMethodCallIL.Emit(OpCodes.Ldloc, 6)
Typ = GetType(MethodCallStmt)
checkMethodCallIL.Emit(OpCodes.Ldloc, 8)
Typ = GetType(MethodCallTok)
checkMethodCallIL.Emit(OpCodes.Stfld, GetType(MethodCallStmt).GetField("MethodToken"))
checkMethodCallIL.MarkSequencePoint(doc5, 788, 1, 788, 100)
checkMethodCallIL.Emit(OpCodes.Br, cont248)
checkMethodCallIL.MarkLabel(fa248)
checkMethodCallIL.Emit(OpCodes.Br, cont248)
checkMethodCallIL.MarkLabel(cont248)
checkMethodCallIL.MarkSequencePoint(doc5, 790, 1, 790, 100)
checkMethodCallIL.Emit(OpCodes.Br, cont247)
checkMethodCallIL.MarkLabel(fa247)
checkMethodCallIL.Emit(OpCodes.Br, cont247)
checkMethodCallIL.MarkLabel(cont247)
checkMethodCallIL.MarkSequencePoint(doc5, 791, 1, 791, 100)
checkMethodCallIL.Emit(OpCodes.Ldloc, 6)
Typ = GetType(MethodCallStmt)
checkMethodCallIL.MarkSequencePoint(doc5, 792, 1, 792, 100)
checkMethodCallIL.Emit(OpCodes.Ret)
Dim typ131(-1) As Type
ReDim Preserve typ131(UBound(typ131) + 1)
typ131(UBound(typ131)) = GetType(Stmt)
ReDim Preserve typ131(UBound(typ131) + 1)
typ131(UBound(typ131)) = GetType(System.Boolean).MakeByRefType()
Dim checkVarAs As MethodBuilder = StmtOptimizer.DefineMethod("checkVarAs", MethodAttributes.Public, GetType(Stmt), typ131)
Dim checkVarAsIL As ILGenerator = checkVarAs.GetILGenerator()
Dim checkVarAsparam01 As ParameterBuilder = checkVarAs.DefineParameter(1, ParameterAttributes.None, "stm")
Dim checkVarAsparam02 As ParameterBuilder = checkVarAs.DefineParameter(2, ParameterAttributes.None, "b")
checkVarAsIL.MarkSequencePoint(doc5, 795, 1, 795, 100)
Dim locbldr351 As LocalBuilder = checkVarAsIL.DeclareLocal(GetType(Token))
locbldr351.SetLocalSymInfo("tok")
checkVarAsIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
...
Typ = Typ.GetElementType()
checkVarAsIL.Emit(OpCodes.Stloc, 0)
checkVarAsIL.MarkSequencePoint(doc5, 796, 1, 796, 100)
Dim locbldr352 As LocalBuilder = checkVarAsIL.DeclareLocal(GetType(System.Type))
locbldr352.SetLocalSymInfo("typ")
checkVarAsIL.Emit(OpCodes.Ldtoken, GetType(VarTok))
Dim typ132 As Type() = {GetType(System.RuntimeTypeHandle)}
checkVarAsIL.Emit(OpCodes.Call, GetType(System.Type).GetMethod("GetTypeFromHandle", typ132))
Typ = GetType(System.Type).GetMethod("GetTypeFromHandle", typ132).ReturnType
checkVarAsIL.Emit(OpCodes.Stloc, 1)
checkVarAsIL.MarkSequencePoint(doc5, 797, 1, 797, 100)
checkVarAsIL.Emit(OpCodes.Ldarg, 2)
Typ = GetType(System.Boolean).MakeByRefType()
Typ04 = Typ.GetElementType()
...
checkVarAsIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("IsInstanceOfType", typ133))
Typ = Typ03.GetMethod("IsInstanceOfType", typ133).ReturnType
checkVarAsIL.Emit(OpCodes.Stobj, Typ04)
checkVarAsIL.MarkSequencePoint(doc5, 798, 1, 798, 100)
Dim locbldr353 As LocalBuilder = checkVarAsIL.DeclareLocal(GetType(VarStmt))
locbldr353.SetLocalSymInfo("vars")
checkVarAsIL.Emit(OpCodes.Newobj, GetType(VarStmt).GetConstructor(Type.EmptyTypes))
checkVarAsIL.Emit(OpCodes.Stloc, 2)
checkVarAsIL.MarkSequencePoint(doc5, 800, 1, 800, 100)
checkVarAsIL.Emit(OpCodes.Ldarg, 2)
Typ = GetType(System.Boolean).MakeByRefType()
checkVarAsIL.Emit(OpCodes.Ldobj, Typ.GetElementType())
Typ = Typ.GetElementType()
checkVarAsIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa258 As System.Reflection.Emit.Label = checkVarAsIL.DefineLabel()
Dim tru258 As System.Reflection.Emit.Label = checkVarAsIL.DefineLabel()
Dim cont258 As System.Reflection.Emit.Label = checkVarAsIL.DefineLabel()
checkVarAsIL.Emit(OpCodes.Beq, tru258)
checkVarAsIL.Emit(OpCodes.Br, fa258)
checkVarAsIL.MarkLabel(tru258)
checkVarAsIL.MarkSequencePoint(doc5, 801, 1, 801, 100)
checkVarAsIL.Emit(OpCodes.Ldloc, 2)
Typ = GetType(VarStmt)
checkVarAsIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
...
checkVarAsIL.MarkSequencePoint(doc5, 802, 1, 802, 100)
Dim locbldr354 As LocalBuilder = checkVarAsIL.DeclareLocal(GetType(Expr))
locbldr354.SetLocalSymInfo("tempexp")
checkVarAsIL.Emit(OpCodes.Newobj, GetType(Expr).GetConstructor(Type.EmptyTypes))
checkVarAsIL.Emit(OpCodes.Stloc, 3)
checkVarAsIL.MarkSequencePoint(doc5, 803, 1, 803, 100)
checkVarAsIL.Emit(OpCodes.Ldloc, 3)
Typ = GetType(Expr)
checkVarAsIL.Emit(OpCodes.Ldloc, 2)
Typ = GetType(VarStmt)
...
checkVarAsIL.MarkSequencePoint(doc5, 804, 1, 804, 100)
Dim locbldr355 As LocalBuilder = checkVarAsIL.DeclareLocal(asm.GetType("dylan.NET.Tokenizer.Parser.ExprOptimizer"))
locbldr355.SetLocalSymInfo("eop")
checkVarAsIL.Emit(OpCodes.Newobj, asm.GetType("dylan.NET.Tokenizer.Parser.ExprOptimizer").GetConstructor(Type.EmptyTypes))
checkVarAsIL.Emit(OpCodes.Stloc, 4)
checkVarAsIL.MarkSequencePoint(doc5, 805, 1, 805, 100)
Dim typ134(-1) As Type
checkVarAsIL.Emit(OpCodes.Ldloc, 4)
Typ = asm.GetType("dylan.NET.Tokenizer.Parser.ExprOptimizer")
Typ03 = Typ
...
ReDim Preserve typ134(UBound(typ134) + 1)
typ134(UBound(typ134)) = Typ
checkVarAsIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("Optimize", typ134))
Typ = Typ03.GetMethod("Optimize", typ134).ReturnType
checkVarAsIL.Emit(OpCodes.Stloc, 3)
checkVarAsIL.MarkSequencePoint(doc5, 806, 1, 806, 100)
checkVarAsIL.Emit(OpCodes.Ldloc, 2)
Typ = GetType(VarStmt)
checkVarAsIL.Emit(OpCodes.Ldloc, 3)
Typ = GetType(Expr)
...
Typ = GetType(Expr).GetField("Tokens").FieldType
checkVarAsIL.Emit(OpCodes.Stfld, GetType(VarStmt).GetField("Tokens"))
checkVarAsIL.MarkSequencePoint(doc5, 807, 1, 807, 100)
checkVarAsIL.Emit(OpCodes.Ldloc, 2)
Typ = GetType(VarStmt)
checkVarAsIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
...
checkVarAsIL.MarkSequencePoint(doc5, 808, 1, 808, 100)
checkVarAsIL.Emit(OpCodes.Ldloc, 2)
Typ = GetType(VarStmt)
checkVarAsIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
...
checkVarAsIL.MarkSequencePoint(doc5, 810, 1, 810, 100)
Dim locbldr356 As LocalBuilder = checkVarAsIL.DeclareLocal(GetType(Token))
locbldr356.SetLocalSymInfo("tok2")
checkVarAsIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
checkVarAsIL.Emit(OpCodes.Ldfld, GetType(Stmt).GetField("Tokens"))
Typ = GetType(Stmt).GetField("Tokens").FieldType
...
Typ = Typ.GetElementType()
checkVarAsIL.Emit(OpCodes.Stloc, 5)
checkVarAsIL.MarkSequencePoint(doc5, 811, 1, 811, 100)
Dim locbldr357 As LocalBuilder = checkVarAsIL.DeclareLocal(GetType(System.Type))
locbldr357.SetLocalSymInfo("typ2")
checkVarAsIL.Emit(OpCodes.Ldtoken, GetType(TypeTok))
Dim typ135 As Type() = {GetType(System.RuntimeTypeHandle)}
checkVarAsIL.Emit(OpCodes.Call, GetType(System.Type).GetMethod("GetTypeFromHandle", typ135))
Typ = GetType(System.Type).GetMethod("GetTypeFromHandle", typ135).ReturnType
checkVarAsIL.Emit(OpCodes.Stloc, 6)
checkVarAsIL.MarkSequencePoint(doc5, 812, 1, 812, 100)
Dim locbldr358 As LocalBuilder = checkVarAsIL.DeclareLocal(GetType(System.Boolean))
locbldr358.SetLocalSymInfo("b2")
Dim typ136(-1) As Type
checkVarAsIL.Emit(OpCodes.Ldloc, 6)
Typ = GetType(System.Type)
Typ03 = Typ
...
ReDim Preserve typ136(UBound(typ136) + 1)
typ136(UBound(typ136)) = Typ
checkVarAsIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("IsInstanceOfType", typ136))
Typ = Typ03.GetMethod("IsInstanceOfType", typ136).ReturnType
checkVarAsIL.Emit(OpCodes.Stloc, 7)
checkVarAsIL.MarkSequencePoint(doc5, 814, 1, 814, 100)
checkVarAsIL.Emit(OpCodes.Ldloc, 7)
Typ = GetType(System.Boolean)
checkVarAsIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa259 As System.Reflection.Emit.Label = checkVarAsIL.DefineLabel()
Dim tru259 As System.Reflection.Emit.Label = checkVarAsIL.DefineLabel()
Dim cont259 As System.Reflection.Emit.Label = checkVarAsIL.DefineLabel()
checkVarAsIL.Emit(OpCodes.Beq, fa259)
checkVarAsIL.Emit(OpCodes.Br, tru259)
checkVarAsIL.MarkLabel(tru259)
checkVarAsIL.MarkSequencePoint(doc5, 815, 1, 815, 100)
Dim locbldr359 As LocalBuilder = checkVarAsIL.DeclareLocal(GetType(Token))
locbldr359.SetLocalSymInfo("t")
checkVarAsIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
checkVarAsIL.Emit(OpCodes.Ldfld, GetType(Stmt).GetField("Tokens"))
Typ = GetType(Stmt).GetField("Tokens").FieldType
...
checkVarAsIL.MarkSequencePoint(doc5, 816, 1, 816, 100)
Dim locbldr360 As LocalBuilder = checkVarAsIL.DeclareLocal(GetType(TypeTok))
locbldr360.SetLocalSymInfo("tt")
checkVarAsIL.Emit(OpCodes.Newobj, GetType(TypeTok).GetConstructor(Type.EmptyTypes))
checkVarAsIL.Emit(OpCodes.Stloc, 9)
checkVarAsIL.MarkSequencePoint(doc5, 817, 1, 817, 100)
...
Typ = GetType(Token).GetField("Line").FieldType
checkVarAsIL.Emit(OpCodes.Stfld, GetType(TypeTok).GetField("Line"))
checkVarAsIL.MarkSequencePoint(doc5, 818, 1, 818, 100)
checkVarAsIL.Emit(OpCodes.Ldloc, 9)
Typ = GetType(TypeTok)
checkVarAsIL.Emit(OpCodes.Ldloc, 8)
Typ = GetType(Token)
...
Typ = GetType(Token).GetField("Value").FieldType
checkVarAsIL.Emit(OpCodes.Stfld, GetType(TypeTok).GetField("Value"))
checkVarAsIL.MarkSequencePoint(doc5, 819, 1, 819, 100)
checkVarAsIL.Emit(OpCodes.Ldloc, 2)
Typ = GetType(VarStmt)
checkVarAsIL.Emit(OpCodes.Ldloc, 9)
Typ = GetType(TypeTok)
checkVarAsIL.Emit(OpCodes.Stfld, GetType(VarStmt).GetField("VarTyp"))
checkVarAsIL.MarkSequencePoint(doc5, 820, 1, 820, 100)
checkVarAsIL.Emit(OpCodes.Br, cont259)
checkVarAsIL.MarkLabel(fa259)
checkVarAsIL.MarkSequencePoint(doc5, 821, 1, 821, 100)
checkVarAsIL.Emit(OpCodes.Ldloc, 2)
Typ = GetType(VarStmt)
checkVarAsIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
...
Typ = Typ.GetElementType()
checkVarAsIL.Emit(OpCodes.Stfld, GetType(VarStmt).GetField("VarTyp"))
checkVarAsIL.MarkSequencePoint(doc5, 822, 1, 822, 100)
checkVarAsIL.Emit(OpCodes.Br, cont259)
checkVarAsIL.MarkLabel(cont259)
checkVarAsIL.MarkSequencePoint(doc5, 824, 1, 824, 100)
checkVarAsIL.Emit(OpCodes.Br, cont258)
checkVarAsIL.MarkLabel(fa258)
checkVarAsIL.Emit(OpCodes.Br, cont258)
checkVarAsIL.MarkLabel(cont258)
checkVarAsIL.MarkSequencePoint(doc5, 825, 1, 825, 100)
checkVarAsIL.Emit(OpCodes.Ldloc, 2)
Typ = GetType(VarStmt)
checkVarAsIL.MarkSequencePoint(doc5, 826, 1, 826, 100)
checkVarAsIL.Emit(OpCodes.Ret)
Dim typ137(-1) As Type
ReDim Preserve typ137(UBound(typ137) + 1)
typ137(UBound(typ137)) = GetType(Stmt)
Dim AssOpt As MethodBuilder = StmtOptimizer.DefineMethod("AssOpt", MethodAttributes.Public, GetType(Stmt), typ137)
...
AssOptIL.MarkSequencePoint(doc5, 830, 1, 830, 100)
Dim locbldr361 As LocalBuilder = AssOptIL.DeclareLocal(GetType(AssignStmt))
locbldr361.SetLocalSymInfo("asss")
AssOptIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
AssOptIL.Emit(OpCodes.Stloc, 0)
AssOptIL.MarkSequencePoint(doc5, 831, 1, 831, 100)
Dim locbldr362 As LocalBuilder = AssOptIL.DeclareLocal(GetType(Expr))
locbldr362.SetLocalSymInfo("le")
...
AssOptIL.MarkSequencePoint(doc5, 832, 1, 832, 100)
Dim locbldr363 As LocalBuilder = AssOptIL.DeclareLocal(GetType(Token))
locbldr363.SetLocalSymInfo("tok")
...
AssOptIL.MarkSequencePoint(doc5, 833, 1, 833, 100)
Dim locbldr364 As LocalBuilder = AssOptIL.DeclareLocal(GetType(System.Type))
locbldr364.SetLocalSymInfo("typ")
AssOptIL.Emit(OpCodes.Ldtoken, GetType(VarTok))
Dim typ138 As Type() = {GetType(System.RuntimeTypeHandle)}
AssOptIL.Emit(OpCodes.Call, GetType(System.Type).GetMethod("GetTypeFromHandle", typ138))
Typ = GetType(System.Type).GetMethod("GetTypeFromHandle", typ138).ReturnType
AssOptIL.Emit(OpCodes.Stloc, 3)
AssOptIL.MarkSequencePoint(doc5, 834, 1, 834, 100)
Dim locbldr365 As LocalBuilder = AssOptIL.DeclareLocal(GetType(System.Boolean))
locbldr365.SetLocalSymInfo("b")
...
AssOptIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("IsInstanceOfType", typ139))
Typ = Typ03.GetMethod("IsInstanceOfType", typ139).ReturnType
AssOptIL.Emit(OpCodes.Stloc, 4)
AssOptIL.MarkSequencePoint(doc5, 835, 1, 835, 100)
Dim locbldr366 As LocalBuilder = AssOptIL.DeclareLocal(GetType(VarAsgnStmt))
locbldr366.SetLocalSymInfo("vass")
AssOptIL.Emit(OpCodes.Newobj, GetType(VarAsgnStmt).GetConstructor(Type.EmptyTypes))
AssOptIL.Emit(OpCodes.Stloc, 5)
AssOptIL.MarkSequencePoint(doc5, 836, 1, 836, 100)
AssOptIL.Emit(OpCodes.Ldloc, 4)
Typ = GetType(System.Boolean)
AssOptIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa260 As System.Reflection.Emit.Label = AssOptIL.DefineLabel()
Dim tru260 As System.Reflection.Emit.Label = AssOptIL.DefineLabel()
Dim cont260 As System.Reflection.Emit.Label = AssOptIL.DefineLabel()
AssOptIL.Emit(OpCodes.Beq, tru260)
AssOptIL.Emit(OpCodes.Br, fa260)
AssOptIL.MarkLabel(tru260)
AssOptIL.MarkSequencePoint(doc5, 837, 1, 837, 100)
...
AssOptIL.MarkSequencePoint(doc5, 838, 1, 838, 100)
AssOptIL.Emit(OpCodes.Ldloc, 5)
Typ = GetType(VarAsgnStmt)
AssOptIL.Emit(OpCodes.Ldloc, 0)
Typ = GetType(AssignStmt)
...
AssOptIL.MarkSequencePoint(doc5, 839, 1, 839, 100)
AssOptIL.Emit(OpCodes.Ldloc, 5)
Typ = GetType(VarAsgnStmt)
AssOptIL.Emit(OpCodes.Ldloc, 1)
Typ = GetType(Expr)
...
AssOptIL.MarkSequencePoint(doc5, 841, 1, 841, 100)
Dim locbldr367 As LocalBuilder = AssOptIL.DeclareLocal(GetType(Token))
locbldr367.SetLocalSymInfo("tok2")
AssOptIL.Emit(OpCodes.Ldloc, 1)
Typ = GetType(Expr)
AssOptIL.Emit(OpCodes.Ldfld, GetType(Expr).GetField("Tokens"))
Typ = GetType(Expr).GetField("Tokens").FieldType
...
AssOptIL.MarkSequencePoint(doc5, 842, 1, 842, 100)
Dim locbldr368 As LocalBuilder = AssOptIL.DeclareLocal(GetType(System.Type))
locbldr368.SetLocalSymInfo("typ2")
AssOptIL.Emit(OpCodes.Ldtoken, GetType(TypeTok))
Dim typ140 As Type() = {GetType(System.RuntimeTypeHandle)}
AssOptIL.Emit(OpCodes.Call, GetType(System.Type).GetMethod("GetTypeFromHandle", typ140))
Typ = GetType(System.Type).GetMethod("GetTypeFromHandle", typ140).ReturnType
AssOptIL.Emit(OpCodes.Stloc, 7)
AssOptIL.MarkSequencePoint(doc5, 843, 1, 843, 100)
Dim locbldr369 As LocalBuilder = AssOptIL.DeclareLocal(GetType(System.Boolean))
locbldr369.SetLocalSymInfo("b2")
Dim typ141(-1) As Type
...
ReDim Preserve typ141(UBound(typ141) + 1)
typ141(UBound(typ141)) = Typ
AssOptIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("IsInstanceOfType", typ141))
Typ = Typ03.GetMethod("IsInstanceOfType", typ141).ReturnType
AssOptIL.Emit(OpCodes.Stloc, 8)
AssOptIL.MarkSequencePoint(doc5, 845, 1, 845, 100)
AssOptIL.Emit(OpCodes.Ldloc, 8)
Typ = GetType(System.Boolean)
AssOptIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa261 As System.Reflection.Emit.Label = AssOptIL.DefineLabel()
Dim tru261 As System.Reflection.Emit.Label = AssOptIL.DefineLabel()
Dim cont261 As System.Reflection.Emit.Label = AssOptIL.DefineLabel()
AssOptIL.Emit(OpCodes.Beq, fa261)
AssOptIL.Emit(OpCodes.Br, tru261)
AssOptIL.MarkLabel(tru261)
AssOptIL.MarkSequencePoint(doc5, 846, 1, 846, 100)
Dim locbldr370 As LocalBuilder = AssOptIL.DeclareLocal(GetType(Token))
locbldr370.SetLocalSymInfo("t")
AssOptIL.Emit(OpCodes.Ldloc, 1)
Typ = GetType(Expr)
AssOptIL.Emit(OpCodes.Ldfld, GetType(Expr).GetField("Tokens"))
Typ = GetType(Expr).GetField("Tokens").FieldType
...
AssOptIL.MarkSequencePoint(doc5, 847, 1, 847, 100)
Dim locbldr371 As LocalBuilder = AssOptIL.DeclareLocal(GetType(TypeTok))
locbldr371.SetLocalSymInfo("tt")
AssOptIL.Emit(OpCodes.Newobj, GetType(TypeTok).GetConstructor(Type.EmptyTypes))
AssOptIL.Emit(OpCodes.Stloc, 10)
AssOptIL.MarkSequencePoint(doc5, 848, 1, 848, 100)
...
AssOptIL.MarkSequencePoint(doc5, 849, 1, 849, 100)
AssOptIL.Emit(OpCodes.Ldloc, 10)
Typ = GetType(TypeTok)
AssOptIL.Emit(OpCodes.Ldloc, 9)
Typ = GetType(Token)
...
AssOptIL.MarkSequencePoint(doc5, 850, 1, 850, 100)
AssOptIL.Emit(OpCodes.Ldloc, 5)
Typ = GetType(VarAsgnStmt)
AssOptIL.Emit(OpCodes.Ldloc, 10)
Typ = GetType(TypeTok)
AssOptIL.Emit(OpCodes.Stfld, GetType(VarAsgnStmt).GetField("VarTyp"))
AssOptIL.MarkSequencePoint(doc5, 851, 1, 851, 100)
AssOptIL.Emit(OpCodes.Br, cont261)
AssOptIL.MarkLabel(fa261)
AssOptIL.MarkSequencePoint(doc5, 852, 1, 852, 100)
AssOptIL.Emit(OpCodes.Ldloc, 5)
Typ = GetType(VarAsgnStmt)
AssOptIL.Emit(OpCodes.Ldloc, 1)
Typ = GetType(Expr)
...
Typ = Typ.GetElementType()
AssOptIL.Emit(OpCodes.Stfld, GetType(VarAsgnStmt).GetField("VarTyp"))
AssOptIL.MarkSequencePoint(doc5, 853, 1, 853, 100)
AssOptIL.Emit(OpCodes.Br, cont261)
AssOptIL.MarkLabel(cont261)
AssOptIL.MarkSequencePoint(doc5, 855, 1, 855, 100)
AssOptIL.Emit(OpCodes.Ldloc, 5)
Typ = GetType(VarAsgnStmt)
AssOptIL.Emit(OpCodes.Ldloc, 0)
Typ = GetType(AssignStmt)
...
AssOptIL.MarkSequencePoint(doc5, 856, 1, 856, 100)
Dim locbldr372 As LocalBuilder = AssOptIL.DeclareLocal(asm.GetType("dylan.NET.Tokenizer.Parser.ExprOptimizer"))
locbldr372.SetLocalSymInfo("eop")
...
AssOptIL.MarkSequencePoint(doc5, 857, 1, 857, 100)
AssOptIL.Emit(OpCodes.Ldloc, 5)
Typ = GetType(VarAsgnStmt)
Dim typ142(-1) As Type
...
ReDim Preserve typ142(UBound(typ142) + 1)
typ142(UBound(typ142)) = Typ
AssOptIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("Optimize", typ142))
Typ = Typ03.GetMethod("Optimize", typ142).ReturnType
AssOptIL.Emit(OpCodes.Stfld, GetType(VarAsgnStmt).GetField("RExpr"))
AssOptIL.MarkSequencePoint(doc5, 859, 1, 859, 100)
AssOptIL.Emit(OpCodes.Ldloc, 5)
Typ = GetType(VarAsgnStmt)
AssOptIL.MarkSequencePoint(doc5, 860, 1, 860, 100)
AssOptIL.Emit(OpCodes.Br, cont260)
AssOptIL.MarkLabel(fa260)
AssOptIL.MarkSequencePoint(doc5, 861, 1, 861, 100)
AssOptIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
AssOptIL.MarkSequencePoint(doc5, 862, 1, 862, 100)
AssOptIL.Emit(OpCodes.Br, cont260)
AssOptIL.MarkLabel(cont260)
AssOptIL.MarkSequencePoint(doc5, 864, 1, 864, 100)
AssOptIL.Emit(OpCodes.Ret)
Dim typ143(-1) As Type
ReDim Preserve typ143(UBound(typ143) + 1)
typ143(UBound(typ143)) = GetType(Stmt)
ReDim Preserve typ143(UBound(typ143) + 1)
typ143(UBound(typ143)) = GetType(System.Boolean).MakeByRefType()
Dim checkAssign As MethodBuilder = StmtOptimizer.DefineMethod("checkAssign", MethodAttributes.Public, GetType(Stmt), typ143)
...
checkAssignIL.MarkSequencePoint(doc5, 867, 1, 867, 100)
Dim locbldr373 As LocalBuilder = checkAssignIL.DeclareLocal(GetType(Token))
locbldr373.SetLocalSymInfo("tok")
checkAssignIL.Emit(OpCodes.Ldnull)
checkAssignIL.Emit(OpCodes.Stloc, 0)
checkAssignIL.MarkSequencePoint(doc5, 868, 1, 868, 100)
Dim locbldr374 As LocalBuilder = checkAssignIL.DeclareLocal(GetType(System.Type))
...
checkAssignIL.Emit(OpCodes.Call, GetType(System.Type).GetMethod("GetTypeFromHandle", typ144))
...
Dim locbldr375 As LocalBuilder = checkAssignIL.DeclareLocal(GetType(AssignStmt))
locbldr375.SetLocalSymInfo("asss")
...
Dim locbldr376 As LocalBuilder = checkAssignIL.DeclareLocal(GetType(System.Boolean))
locbldr376.SetLocalSymInfo("c")
checkAssignIL.Emit(OpCodes.Ldc_I4, 0)
Typ = GetType(System.Boolean)
checkAssignIL.Emit(OpCodes.Stloc, 3)
checkAssignIL.MarkSequencePoint(doc5, 871, 1, 871, 100)
Dim locbldr377 As LocalBuilder = checkAssignIL.DeclareLocal(GetType(Expr))
locbldr377.SetLocalSymInfo("re")
...
Dim locbldr378 As LocalBuilder = checkAssignIL.DeclareLocal(GetType(Expr))
locbldr378.SetLocalSymInfo("le")
checkAssignIL.Emit(OpCodes.Newobj, GetType(Expr).GetConstructor(Type.EmptyTypes))
checkAssignIL.Emit(OpCodes.Stloc, 5)
checkAssignIL.MarkSequencePoint(doc5, 873, 1, 873, 100)
Dim locbldr379 As LocalBuilder = checkAssignIL.DeclareLocal(GetType(System.Int32))
locbldr379.SetLocalSymInfo("i")
...
Dim locbldr380 As LocalBuilder = checkAssignIL.DeclareLocal(GetType(System.Int32))
locbldr380.SetLocalSymInfo("len")
...
checkAssignIL.MarkSequencePoint(doc5, 875, 1, 875, 100)
Dim locbldr381 As LocalBuilder = checkAssignIL.DeclareLocal(GetType(System.Int32))
locbldr381.SetLocalSymInfo("assind")
...
checkAssignIL.Emit(OpCodes.Stloc, 6)
checkAssignIL.MarkSequencePoint(doc5, 884, 1, 884, 100)
checkAssignIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
checkAssignIL.Emit(OpCodes.Ldfld, GetType(Stmt).GetField("Tokens"))
Typ = GetType(Stmt).GetField("Tokens").FieldType
...
ReDim Preserve typ145(UBound(typ145) + 1)
typ145(UBound(typ145)) = Typ
checkAssignIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("IsInstanceOfType", typ145))
...
Typ = GetType(System.Boolean)
Dim fa262 As System.Reflection.Emit.Label = checkAssignIL.DefineLabel()
Dim tru262 As System.Reflection.Emit.Label = checkAssignIL.DefineLabel()
Dim cont262 As System.Reflection.Emit.Label = checkAssignIL.DefineLabel()
checkAssignIL.Emit(OpCodes.Beq, tru262)
checkAssignIL.Emit(OpCodes.Br, fa262)
checkAssignIL.MarkLabel(tru262)
checkAssignIL.MarkSequencePoint(doc5, 888, 1, 888, 100)
checkAssignIL.Emit(OpCodes.Ldloc, 6)
Typ = GetType(System.Int32)
checkAssignIL.Emit(OpCodes.Stloc, 8)
checkAssignIL.MarkSequencePoint(doc5, 889, 1, 889, 100)
checkAssignIL.Emit(OpCodes.Br, label20)
checkAssignIL.MarkSequencePoint(doc5, 890, 1, 890, 100)
checkAssignIL.Emit(OpCodes.Br, cont262)
checkAssignIL.MarkLabel(fa262)
checkAssignIL.Emit(OpCodes.Br, cont262)
checkAssignIL.MarkLabel(cont262)
checkAssignIL.MarkSequencePoint(doc5, 892, 1, 892, 100)
checkAssignIL.Emit(OpCodes.Ldloc, 6)
Typ = GetType(System.Int32)
checkAssignIL.Emit(OpCodes.Ldloc, 7)
Typ = GetType(System.Int32)
Dim fa263 As System.Reflection.Emit.Label = checkAssignIL.DefineLabel()
Dim tru263 As System.Reflection.Emit.Label = checkAssignIL.DefineLabel()
Dim cont263 As System.Reflection.Emit.Label = checkAssignIL.DefineLabel()
checkAssignIL.Emit(OpCodes.Beq, tru263)
checkAssignIL.Emit(OpCodes.Br, fa263)
checkAssignIL.MarkLabel(tru263)
checkAssignIL.MarkSequencePoint(doc5, 893, 1, 893, 100)
checkAssignIL.Emit(OpCodes.Br, label20)
checkAssignIL.MarkSequencePoint(doc5, 894, 1, 894, 100)
checkAssignIL.Emit(OpCodes.Br, cont263)
checkAssignIL.MarkLabel(fa263)
checkAssignIL.MarkSequencePoint(doc5, 895, 1, 895, 100)
checkAssignIL.Emit(OpCodes.Br, label19)
checkAssignIL.MarkSequencePoint(doc5, 896, 1, 896, 100)
checkAssignIL.Emit(OpCodes.Br, cont263)
checkAssignIL.MarkLabel(cont263)
checkAssignIL.MarkSequencePoint(doc5, 898, 1, 898, 100)
checkAssignIL.MarkLabel(label20)
checkAssignIL.MarkSequencePoint(doc5, 900, 1, 900, 100)
checkAssignIL.Emit(OpCodes.Ldloc, 8)
Typ = GetType(System.Int32)
checkAssignIL.Emit(OpCodes.Ldc_I4, CInt(0))
Typ = GetType(System.Int32)
Dim fa264 As System.Reflection.Emit.Label = checkAssignIL.DefineLabel()
Dim tru264 As System.Reflection.Emit.Label = checkAssignIL.DefineLabel()
Dim cont264 As System.Reflection.Emit.Label = checkAssignIL.DefineLabel()
checkAssignIL.Emit(OpCodes.Beq, fa264)
checkAssignIL.Emit(OpCodes.Br, tru264)
checkAssignIL.MarkLabel(tru264)
checkAssignIL.MarkSequencePoint(doc5, 902, 1, 902, 100)
checkAssignIL.Emit(OpCodes.Ldc_I4, CInt(-1))
Typ = GetType(System.Int32)
checkAssignIL.Emit(OpCodes.Stloc, 6)
checkAssignIL.MarkSequencePoint(doc5, 903, 1, 903, 100)
checkAssignIL.Emit(OpCodes.Ldloc, 8)
Typ = GetType(System.Int32)
checkAssignIL.Emit(OpCodes.Ldc_I4, CInt(1))
Typ = GetType(System.Int32)
checkAssignIL.Emit(OpCodes.Sub)
checkAssignIL.Emit(OpCodes.Stloc, 7)
checkAssignIL.MarkSequencePoint(doc5, 905, 1, 905, 100)
Dim label21 As System.Reflection.Emit.Label = checkAssignIL.DefineLabel()
checkAssignIL.MarkSequencePoint(doc5, 906, 1, 906, 100)
Dim label22 As System.Reflection.Emit.Label = checkAssignIL.DefineLabel()
checkAssignIL.MarkSequencePoint(doc5, 908, 1, 908, 100)
checkAssignIL.MarkLabel(label21)
checkAssignIL.MarkSequencePoint(doc5, 910, 1, 910, 100)
checkAssignIL.Emit(OpCodes.Ldloc, 6)
Typ = GetType(System.Int32)
checkAssignIL.Emit(OpCodes.Ldc_I4, CInt(1))
Typ = GetType(System.Int32)
checkAssignIL.Emit(OpCodes.Add)
checkAssignIL.Emit(OpCodes.Stloc, 6)
checkAssignIL.MarkSequencePoint(doc5, 912, 1, 912, 100)
...
checkAssignIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("AddToken", typ146))
Typ = Typ03.GetMethod("AddToken", typ146).ReturnType
If Typ.ToString() = GetType(System.Void).ToString() Then

Else
checkAssignIL.Emit(OpCodes.Pop)
End If
checkAssignIL.MarkSequencePoint(doc5, 914, 1, 914, 100)
checkAssignIL.Emit(OpCodes.Ldloc, 6)
Typ = GetType(System.Int32)
checkAssignIL.Emit(OpCodes.Ldloc, 7)
Typ = GetType(System.Int32)
Dim fa265 As System.Reflection.Emit.Label = checkAssignIL.DefineLabel()
Dim tru265 As System.Reflection.Emit.Label = checkAssignIL.DefineLabel()
Dim cont265 As System.Reflection.Emit.Label = checkAssignIL.DefineLabel()
checkAssignIL.Emit(OpCodes.Beq, tru265)
checkAssignIL.Emit(OpCodes.Br, fa265)
checkAssignIL.MarkLabel(tru265)
checkAssignIL.MarkSequencePoint(doc5, 915, 1, 915, 100)
checkAssignIL.Emit(OpCodes.Br, label22)
checkAssignIL.MarkSequencePoint(doc5, 916, 1, 916, 100)
checkAssignIL.Emit(OpCodes.Br, cont265)
checkAssignIL.MarkLabel(fa265)
checkAssignIL.MarkSequencePoint(doc5, 917, 1, 917, 100)
checkAssignIL.Emit(OpCodes.Br, label21)
checkAssignIL.MarkSequencePoint(doc5, 918, 1, 918, 100)
checkAssignIL.Emit(OpCodes.Br, cont265)
checkAssignIL.MarkLabel(cont265)
checkAssignIL.MarkSequencePoint(doc5, 920, 1, 920, 100)
checkAssignIL.MarkLabel(label22)
checkAssignIL.MarkSequencePoint(doc5, 923, 1, 923, 100)
checkAssignIL.Emit(OpCodes.Ldloc, 8)
Typ = GetType(System.Int32)
checkAssignIL.Emit(OpCodes.Stloc, 6)
checkAssignIL.MarkSequencePoint(doc5, 924, 1, 924, 100)
checkAssignIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
checkAssignIL.Emit(OpCodes.Ldfld, GetType(Stmt).GetField("Tokens"))
Typ = GetType(Stmt).GetField("Tokens").FieldType
...
checkAssignIL.Emit(OpCodes.Sub)
checkAssignIL.Emit(OpCodes.Stloc, 7)
checkAssignIL.MarkSequencePoint(doc5, 926, 1, 926, 100)
Dim label23 As System.Reflection.Emit.Label = checkAssignIL.DefineLabel()
checkAssignIL.MarkSequencePoint(doc5, 927, 1, 927, 100)
Dim label24 As System.Reflection.Emit.Label = checkAssignIL.DefineLabel()
checkAssignIL.MarkSequencePoint(doc5, 929, 1, 929, 100)
checkAssignIL.MarkLabel(label23)
checkAssignIL.MarkSequencePoint(doc5, 931, 1, 931, 100)
checkAssignIL.Emit(OpCodes.Ldloc, 6)
Typ = GetType(System.Int32)
checkAssignIL.Emit(OpCodes.Ldc_I4, CInt(1))
Typ = GetType(System.Int32)
checkAssignIL.Emit(OpCodes.Add)
checkAssignIL.Emit(OpCodes.Stloc, 6)
checkAssignIL.MarkSequencePoint(doc5, 933, 1, 933, 100)
Dim typ147(-1) As Type
...
ReDim Preserve typ147(UBound(typ147) + 1)
typ147(UBound(typ147)) = Typ
checkAssignIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("AddToken", typ147))
Typ = Typ03.GetMethod("AddToken", typ147).ReturnType
If Typ.ToString() = GetType(System.Void).ToString() Then

Else
checkAssignIL.Emit(OpCodes.Pop)
End If
checkAssignIL.MarkSequencePoint(doc5, 935, 1, 935, 100)
checkAssignIL.Emit(OpCodes.Ldloc, 6)
Typ = GetType(System.Int32)
checkAssignIL.Emit(OpCodes.Ldloc, 7)
Typ = GetType(System.Int32)
Dim fa266 As System.Reflection.Emit.Label = checkAssignIL.DefineLabel()
Dim tru266 As System.Reflection.Emit.Label = checkAssignIL.DefineLabel()
Dim cont266 As System.Reflection.Emit.Label = checkAssignIL.DefineLabel()
checkAssignIL.Emit(OpCodes.Beq, tru266)
checkAssignIL.Emit(OpCodes.Br, fa266)
checkAssignIL.MarkLabel(tru266)
checkAssignIL.MarkSequencePoint(doc5, 936, 1, 936, 100)
checkAssignIL.Emit(OpCodes.Br, label24)
checkAssignIL.MarkSequencePoint(doc5, 937, 1, 937, 100)
checkAssignIL.Emit(OpCodes.Br, cont266)
checkAssignIL.MarkLabel(fa266)
checkAssignIL.MarkSequencePoint(doc5, 938, 1, 938, 100)
checkAssignIL.Emit(OpCodes.Br, label23)
checkAssignIL.MarkSequencePoint(doc5, 939, 1, 939, 100)
checkAssignIL.Emit(OpCodes.Br, cont266)
checkAssignIL.MarkLabel(cont266)
checkAssignIL.MarkSequencePoint(doc5, 941, 1, 941, 100)
checkAssignIL.MarkLabel(label24)
checkAssignIL.MarkSequencePoint(doc5, 943, 1, 943, 100)
Dim locbldr382 As LocalBuilder = checkAssignIL.DeclareLocal(asm.GetType("dylan.NET.Tokenizer.Parser.ExprOptimizer"))
locbldr382.SetLocalSymInfo("eop")
...
checkAssignIL.MarkSequencePoint(doc5, 944, 1, 944, 100)
Dim typ148(-1) As Type
...
ReDim Preserve typ148(UBound(typ148) + 1)
typ148(UBound(typ148)) = Typ
checkAssignIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("Optimize", typ148))
Typ = Typ03.GetMethod("Optimize", typ148).ReturnType
checkAssignIL.Emit(OpCodes.Stloc, 4)
checkAssignIL.MarkSequencePoint(doc5, 945, 1, 945, 100)
Dim typ149(-1) As Type
checkAssignIL.Emit(OpCodes.Ldloc, 9)
Typ = asm.GetType("dylan.NET.Tokenizer.Parser.ExprOptimizer")
Typ03 = Typ
...
ReDim Preserve typ149(UBound(typ149) + 1)
typ149(UBound(typ149)) = Typ
checkAssignIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("Optimize", typ149))
Typ = Typ03.GetMethod("Optimize", typ149).ReturnType
checkAssignIL.Emit(OpCodes.Stloc, 5)
checkAssignIL.MarkSequencePoint(doc5, 947, 1, 947, 100)
...
checkAssignIL.MarkSequencePoint(doc5, 948, 1, 948, 100)
checkAssignIL.Emit(OpCodes.Ldloc, 2)
Typ = GetType(AssignStmt)
checkAssignIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
...
checkAssignIL.MarkSequencePoint(doc5, 949, 1, 949, 100)
checkAssignIL.Emit(OpCodes.Ldloc, 2)
Typ = GetType(AssignStmt)
checkAssignIL.Emit(OpCodes.Ldloc, 5)
Typ = GetType(Expr)
checkAssignIL.Emit(OpCodes.Stfld, GetType(AssignStmt).GetField("LExp"))
checkAssignIL.MarkSequencePoint(doc5, 950, 1, 950, 100)
checkAssignIL.Emit(OpCodes.Ldloc, 2)
Typ = GetType(AssignStmt)
checkAssignIL.Emit(OpCodes.Ldloc, 4)
Typ = GetType(Expr)
checkAssignIL.Emit(OpCodes.Stfld, GetType(AssignStmt).GetField("RExp"))
checkAssignIL.MarkSequencePoint(doc5, 952, 1, 952, 100)
...
checkAssignIL.MarkSequencePoint(doc5, 954, 1, 954, 100)
...
checkAssignIL.Emit(OpCodes.Stloc, 2)
checkAssignIL.MarkSequencePoint(doc5, 956, 1, 956, 100)
checkAssignIL.Emit(OpCodes.Ldloc, 2)
Typ = GetType(AssignStmt)
checkAssignIL.MarkSequencePoint(doc5, 958, 1, 958, 100)
checkAssignIL.Emit(OpCodes.Br, cont264)
checkAssignIL.MarkLabel(fa264)
checkAssignIL.MarkSequencePoint(doc5, 959, 1, 959, 100)
checkAssignIL.Emit(OpCodes.Ldarg, 2)
Typ = GetType(System.Boolean).MakeByRefType()
Typ04 = Typ.GetElementType()
checkAssignIL.Emit(OpCodes.Ldc_I4, 0)
Typ = GetType(System.Boolean)
checkAssignIL.Emit(OpCodes.Stobj, Typ04)
checkAssignIL.MarkSequencePoint(doc5, 960, 1, 960, 100)
checkAssignIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
checkAssignIL.MarkSequencePoint(doc5, 962, 1, 962, 100)
checkAssignIL.Emit(OpCodes.Br, cont264)
checkAssignIL.MarkLabel(cont264)
checkAssignIL.MarkSequencePoint(doc5, 964, 1, 964, 100)
checkAssignIL.Emit(OpCodes.Ret)
Dim typ151(-1) As Type
ReDim Preserve typ151(UBound(typ151) + 1)
typ151(UBound(typ151)) = GetType(Stmt)
Dim Optimize As MethodBuilder = StmtOptimizer.DefineMethod("Optimize", MethodAttributes.Public, GetType(Stmt), typ151)
Dim OptimizeIL As ILGenerator = Optimize.GetILGenerator()
Dim Optimizeparam01 As ParameterBuilder = Optimize.DefineParameter(1, ParameterAttributes.None, "stm")
OptimizeIL.MarkSequencePoint(doc5, 970, 1, 970, 100)
Dim locbldr383 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(System.Int32))
locbldr383.SetLocalSymInfo("i")
OptimizeIL.Emit(OpCodes.Ldc_I4, CInt(-1))
Typ = GetType(System.Int32)
OptimizeIL.Emit(OpCodes.Stloc, 0)
OptimizeIL.MarkSequencePoint(doc5, 971, 1, 971, 100)
Dim locbldr384 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(System.Int32))
locbldr384.SetLocalSymInfo("len")
OptimizeIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
...
Typ = GetType(System.Int32)
OptimizeIL.Emit(OpCodes.Stloc, 1)
OptimizeIL.MarkSequencePoint(doc5, 972, 1, 972, 100)
Dim locbldr385 As LocalBuilder = OptimizeIL.DeclareLocal(asm.GetType("dylan.NET.Tokenizer.Parser.TokenOptimizer"))
locbldr385.SetLocalSymInfo("to")
OptimizeIL.Emit(OpCodes.Ldnull)
OptimizeIL.Emit(OpCodes.Stloc, 2)
OptimizeIL.MarkSequencePoint(doc5, 973, 1, 973, 100)
Dim locbldr386 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(Stmt))
locbldr386.SetLocalSymInfo("tmpstm")
OptimizeIL.Emit(OpCodes.Ldnull)
OptimizeIL.Emit(OpCodes.Stloc, 3)
OptimizeIL.MarkSequencePoint(doc5, 974, 1, 974, 100)
Dim locbldr387 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(System.Boolean))
locbldr387.SetLocalSymInfo("compb")
OptimizeIL.Emit(OpCodes.Ldc_I4, 0)
Typ = GetType(System.Boolean)
OptimizeIL.Emit(OpCodes.Stloc, 4)
...
OptimizeIL.Emit(OpCodes.Sub)
OptimizeIL.Emit(OpCodes.Stloc, 1)
OptimizeIL.MarkSequencePoint(doc5, 977, 1, 977, 100)
OptimizeIL.Emit(OpCodes.Ldc_I4, 0)
Typ = GetType(System.Boolean)
OptimizeIL.Emit(OpCodes.Stsfld, asm.GetType("dylan.NET.Tokenizer.Parser.ParserFlags").GetField("IfFlag"))
...
Typ = GetType(System.Boolean)
OptimizeIL.Emit(OpCodes.Stsfld, asm.GetType("dylan.NET.Tokenizer.Parser.ParserFlags").GetField("CmtFlag"))
OptimizeIL.MarkSequencePoint(doc5, 979, 1, 979, 100)
OptimizeIL.Emit(OpCodes.Ldc_I4, 0)
Typ = GetType(System.Boolean)
OptimizeIL.Emit(OpCodes.Stsfld, asm.GetType("dylan.NET.Tokenizer.Parser.ParserFlags").GetField("NoOptFlag"))
OptimizeIL.MarkSequencePoint(doc5, 981, 1, 981, 100)
Dim label25 As System.Reflection.Emit.Label = OptimizeIL.DefineLabel()
OptimizeIL.MarkSequencePoint(doc5, 982, 1, 982, 100)
Dim label26 As System.Reflection.Emit.Label = OptimizeIL.DefineLabel()
OptimizeIL.MarkSequencePoint(doc5, 983, 1, 983, 100)
Dim label27 As System.Reflection.Emit.Label = OptimizeIL.DefineLabel()
...
OptimizeIL.Emit(OpCodes.Blt, tru267)
OptimizeIL.Emit(OpCodes.Br, fa267)
OptimizeIL.MarkLabel(tru267)
OptimizeIL.MarkSequencePoint(doc5, 986, 1, 986, 100)
OptimizeIL.Emit(OpCodes.Br, label26)
...
OptimizeIL.MarkLabel(label25)
OptimizeIL.MarkSequencePoint(doc5, 991, 1, 991, 100)
OptimizeIL.Emit(OpCodes.Ldloc, 0)
Typ = GetType(System.Int32)
OptimizeIL.Emit(OpCodes.Ldc_I4, CInt(1))
Typ = GetType(System.Int32)
OptimizeIL.Emit(OpCodes.Add)
OptimizeIL.Emit(OpCodes.Stloc, 0)
OptimizeIL.MarkSequencePoint(doc5, 993, 1, 993, 100)
...
OptimizeIL.MarkSequencePoint(doc5, 998, 1, 998, 100)
...
OptimizeIL.Emit(OpCodes.Br, label26)
OptimizeIL.MarkSequencePoint(doc5, 1000, 1, 1000, 100)
...
ReDim Preserve typ152(UBound(typ152) + 1)
typ152(UBound(typ152)) = Typ
OptimizeIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("Optimize", typ152))
Typ = Typ03.GetMethod("Optimize", typ152).ReturnType
Typ = Typ02
OptimizeIL.Emit(OpCodes.Stelem, Typ.GetElementType())
OptimizeIL.MarkSequencePoint(doc5, 1005, 1, 1005, 100)
OptimizeIL.Emit(OpCodes.Ldloc, 0)
Typ = GetType(System.Int32)
OptimizeIL.Emit(OpCodes.Ldloc, 1)
Typ = GetType(System.Int32)
...
OptimizeIL.MarkSequencePoint(doc5, 1014, 1, 1014, 100)
OptimizeIL.Emit(OpCodes.Br, label27)
...
OptimizeIL.Emit(OpCodes.Stloc, 3)
OptimizeIL.MarkSequencePoint(doc5, 1019, 1, 1019, 100)
OptimizeIL.Emit(OpCodes.Ldloc, 4)
Typ = GetType(System.Boolean)
OptimizeIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
...
Typ = GetType(Stmt)
OptimizeIL.Emit(OpCodes.Starg, 1)
OptimizeIL.MarkSequencePoint(doc5, 1021, 1, 1021, 100)
OptimizeIL.Emit(OpCodes.Br, label27)
...
OptimizeIL.Emit(OpCodes.Stloc, 3)
OptimizeIL.MarkSequencePoint(doc5, 1026, 1, 1026, 100)
OptimizeIL.Emit(OpCodes.Ldloc, 4)
Typ = GetType(System.Boolean)
OptimizeIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
...
Typ = GetType(Stmt)
OptimizeIL.Emit(OpCodes.Starg, 1)
OptimizeIL.MarkSequencePoint(doc5, 1028, 1, 1028, 100)
OptimizeIL.Emit(OpCodes.Br, label27)
...
OptimizeIL.Emit(OpCodes.Stloc, 3)
OptimizeIL.MarkSequencePoint(doc5, 1033, 1, 1033, 100)
OptimizeIL.Emit(OpCodes.Ldloc, 4)
Typ = GetType(System.Boolean)
OptimizeIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
...
Typ = GetType(Stmt)
OptimizeIL.Emit(OpCodes.Starg, 1)
OptimizeIL.MarkSequencePoint(doc5, 1035, 1, 1035, 100)
OptimizeIL.Emit(OpCodes.Br, label27)
...
OptimizeIL.Emit(OpCodes.Stloc, 3)
OptimizeIL.MarkSequencePoint(doc5, 1040, 1, 1040, 100)
OptimizeIL.Emit(OpCodes.Ldloc, 4)
Typ = GetType(System.Boolean)
OptimizeIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
...
Typ = GetType(Stmt)
OptimizeIL.Emit(OpCodes.Starg, 1)
OptimizeIL.MarkSequencePoint(doc5, 1042, 1, 1042, 100)
OptimizeIL.Emit(OpCodes.Br, label27)
...
OptimizeIL.Emit(OpCodes.Stloc, 3)
OptimizeIL.MarkSequencePoint(doc5, 1047, 1, 1047, 100)
OptimizeIL.Emit(OpCodes.Ldloc, 4)
Typ = GetType(System.Boolean)
OptimizeIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
...
Typ = GetType(Stmt)
OptimizeIL.Emit(OpCodes.Starg, 1)
OptimizeIL.MarkSequencePoint(doc5, 1049, 1, 1049, 100)
OptimizeIL.Emit(OpCodes.Br, label27)
...
OptimizeIL.Emit(OpCodes.Stloc, 3)
OptimizeIL.MarkSequencePoint(doc5, 1054, 1, 1054, 100)
OptimizeIL.Emit(OpCodes.Ldloc, 4)
Typ = GetType(System.Boolean)
OptimizeIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
...
Typ = GetType(Stmt)
OptimizeIL.Emit(OpCodes.Starg, 1)
OptimizeIL.MarkSequencePoint(doc5, 1056, 1, 1056, 100)
OptimizeIL.Emit(OpCodes.Br, label27)
...
OptimizeIL.Emit(OpCodes.Stloc, 3)
OptimizeIL.MarkSequencePoint(doc5, 1061, 1, 1061, 100)
OptimizeIL.Emit(OpCodes.Ldloc, 4)
Typ = GetType(System.Boolean)
OptimizeIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
...
Typ = GetType(Stmt)
OptimizeIL.Emit(OpCodes.Starg, 1)
OptimizeIL.MarkSequencePoint(doc5, 1063, 1, 1063, 100)
OptimizeIL.Emit(OpCodes.Br, label27)
...
OptimizeIL.Emit(OpCodes.Stloc, 3)
OptimizeIL.MarkSequencePoint(doc5, 1068, 1, 1068, 100)
OptimizeIL.Emit(OpCodes.Ldloc, 4)
Typ = GetType(System.Boolean)
OptimizeIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
...
Typ = GetType(Stmt)
OptimizeIL.Emit(OpCodes.Starg, 1)
OptimizeIL.MarkSequencePoint(doc5, 1070, 1, 1070, 100)
OptimizeIL.Emit(OpCodes.Br, label27)
...
OptimizeIL.Emit(OpCodes.Stloc, 3)
OptimizeIL.MarkSequencePoint(doc5, 1075, 1, 1075, 100)
OptimizeIL.Emit(OpCodes.Ldloc, 4)
Typ = GetType(System.Boolean)
OptimizeIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
...
Typ = GetType(Stmt)
OptimizeIL.Emit(OpCodes.Starg, 1)
OptimizeIL.MarkSequencePoint(doc5, 1077, 1, 1077, 100)
OptimizeIL.Emit(OpCodes.Br, label27)
...
OptimizeIL.Emit(OpCodes.Stloc, 3)
OptimizeIL.MarkSequencePoint(doc5, 1082, 1, 1082, 100)
OptimizeIL.Emit(OpCodes.Ldloc, 4)
Typ = GetType(System.Boolean)
OptimizeIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
...
Typ = GetType(Stmt)
OptimizeIL.Emit(OpCodes.Starg, 1)
OptimizeIL.MarkSequencePoint(doc5, 1084, 1, 1084, 100)
OptimizeIL.Emit(OpCodes.Br, label27)
...
OptimizeIL.MarkSequencePoint(doc5, 1087, 1, 1087, 100)
OptimizeIL.Emit(OpCodes.Ldarg_0)
Dim typ163(-1) As Type
OptimizeIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
...
OptimizeIL.Emit(OpCodes.Stloc, 3)
OptimizeIL.MarkSequencePoint(doc5, 1089, 1, 1089, 100)
OptimizeIL.Emit(OpCodes.Ldloc, 4)
Typ = GetType(System.Boolean)
OptimizeIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa282 As System.Reflection.Emit.Label = OptimizeIL.DefineLabel()
Dim tru282 As System.Reflection.Emit.Label = OptimizeIL.DefineLabel()
Dim cont282 As System.Reflection.Emit.Label = OptimizeIL.DefineLabel()
OptimizeIL.Emit(OpCodes.Beq, tru282)
OptimizeIL.Emit(OpCodes.Br, fa282)
OptimizeIL.MarkLabel(tru282)
OptimizeIL.MarkSequencePoint(doc5, 1090, 1, 1090, 100)
OptimizeIL.Emit(OpCodes.Ldloc, 3)
Typ = GetType(Stmt)
OptimizeIL.Emit(OpCodes.Starg, 1)
OptimizeIL.MarkSequencePoint(doc5, 1091, 1, 1091, 100)
OptimizeIL.Emit(OpCodes.Br, label27)
OptimizeIL.MarkSequencePoint(doc5, 1092, 1, 1092, 100)
OptimizeIL.Emit(OpCodes.Br, cont282)
OptimizeIL.MarkLabel(fa282)
OptimizeIL.Emit(OpCodes.Br, cont282)
OptimizeIL.MarkLabel(cont282)
OptimizeIL.MarkSequencePoint(doc5, 1094, 1, 1094, 100)
OptimizeIL.Emit(OpCodes.Ldarg_0)
Dim typ164(-1) As Type
OptimizeIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
...
ReDim Preserve typ164(UBound(typ164) + 1)
typ164(UBound(typ164)) = Typ
OptimizeIL.Emit(OpCodes.Callvirt, checkReturn)
Typ = checkReturn.ReturnType
OptimizeIL.Emit(OpCodes.Stloc, 3)
OptimizeIL.MarkSequencePoint(doc5, 1096, 1, 1096, 100)
OptimizeIL.Emit(OpCodes.Ldloc, 4)
Typ = GetType(System.Boolean)
OptimizeIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa283 As System.Reflection.Emit.Label = OptimizeIL.DefineLabel()
Dim tru283 As System.Reflection.Emit.Label = OptimizeIL.DefineLabel()
Dim cont283 As System.Reflection.Emit.Label = OptimizeIL.DefineLabel()
OptimizeIL.Emit(OpCodes.Beq, tru283)
OptimizeIL.Emit(OpCodes.Br, fa283)
OptimizeIL.MarkLabel(tru283)
OptimizeIL.MarkSequencePoint(doc5, 1097, 1, 1097, 100)
OptimizeIL.Emit(OpCodes.Ldloc, 3)
Typ = GetType(Stmt)
OptimizeIL.Emit(OpCodes.Starg, 1)
OptimizeIL.MarkSequencePoint(doc5, 1098, 1, 1098, 100)
OptimizeIL.Emit(OpCodes.Br, label27)
OptimizeIL.MarkSequencePoint(doc5, 1099, 1, 1099, 100)
OptimizeIL.Emit(OpCodes.Br, cont283)
OptimizeIL.MarkLabel(fa283)
OptimizeIL.Emit(OpCodes.Br, cont283)
OptimizeIL.MarkLabel(cont283)
OptimizeIL.MarkSequencePoint(doc5, 1101, 1, 1101, 100)
OptimizeIL.Emit(OpCodes.Ldarg_0)
Dim typ165(-1) As Type
OptimizeIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
...
OptimizeIL.Emit(OpCodes.Stloc, 3)
OptimizeIL.MarkSequencePoint(doc5, 1103, 1, 1103, 100)
OptimizeIL.Emit(OpCodes.Ldloc, 4)
Typ = GetType(System.Boolean)
OptimizeIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa284 As System.Reflection.Emit.Label = OptimizeIL.DefineLabel()
Dim tru284 As System.Reflection.Emit.Label = OptimizeIL.DefineLabel()
Dim cont284 As System.Reflection.Emit.Label = OptimizeIL.DefineLabel()
OptimizeIL.Emit(OpCodes.Beq, tru284)
OptimizeIL.Emit(OpCodes.Br, fa284)
OptimizeIL.MarkLabel(tru284)
OptimizeIL.MarkSequencePoint(doc5, 1104, 1, 1104, 100)
OptimizeIL.Emit(OpCodes.Ldloc, 3)
Typ = GetType(Stmt)
OptimizeIL.Emit(OpCodes.Starg, 1)
OptimizeIL.MarkSequencePoint(doc5, 1105, 1, 1105, 100)
OptimizeIL.Emit(OpCodes.Br, label27)
OptimizeIL.MarkSequencePoint(doc5, 1106, 1, 1106, 100)
OptimizeIL.Emit(OpCodes.Br, cont284)
OptimizeIL.MarkLabel(fa284)
OptimizeIL.Emit(OpCodes.Br, cont284)
OptimizeIL.MarkLabel(cont284)
OptimizeIL.MarkSequencePoint(doc5, 1108, 1, 1108, 100)
OptimizeIL.Emit(OpCodes.Ldarg_0)
Dim typ166(-1) As Type
OptimizeIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
...
OptimizeIL.Emit(OpCodes.Stloc, 3)
OptimizeIL.MarkSequencePoint(doc5, 1110, 1, 1110, 100)
OptimizeIL.Emit(OpCodes.Ldloc, 4)
Typ = GetType(System.Boolean)
OptimizeIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa285 As System.Reflection.Emit.Label = OptimizeIL.DefineLabel()
Dim tru285 As System.Reflection.Emit.Label = OptimizeIL.DefineLabel()
Dim cont285 As System.Reflection.Emit.Label = OptimizeIL.DefineLabel()
OptimizeIL.Emit(OpCodes.Beq, tru285)
OptimizeIL.Emit(OpCodes.Br, fa285)
OptimizeIL.MarkLabel(tru285)
OptimizeIL.MarkSequencePoint(doc5, 1111, 1, 1111, 100)
OptimizeIL.Emit(OpCodes.Ldloc, 3)
Typ = GetType(Stmt)
OptimizeIL.Emit(OpCodes.Starg, 1)
OptimizeIL.MarkSequencePoint(doc5, 1112, 1, 1112, 100)
OptimizeIL.Emit(OpCodes.Br, label27)
OptimizeIL.MarkSequencePoint(doc5, 1113, 1, 1113, 100)
OptimizeIL.Emit(OpCodes.Br, cont285)
OptimizeIL.MarkLabel(fa285)
OptimizeIL.Emit(OpCodes.Br, cont285)
OptimizeIL.MarkLabel(cont285)
OptimizeIL.MarkSequencePoint(doc5, 1115, 1, 1115, 100)
OptimizeIL.Emit(OpCodes.Ldarg_0)
...
OptimizeIL.Emit(OpCodes.Stloc, 3)
OptimizeIL.MarkSequencePoint(doc5, 1117, 1, 1117, 100)
OptimizeIL.Emit(OpCodes.Ldloc, 4)
Typ = GetType(System.Boolean)
OptimizeIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa286 As System.Reflection.Emit.Label = OptimizeIL.DefineLabel()
Dim tru286 As System.Reflection.Emit.Label = OptimizeIL.DefineLabel()
Dim cont286 As System.Reflection.Emit.Label = OptimizeIL.DefineLabel()
OptimizeIL.Emit(OpCodes.Beq, tru286)
OptimizeIL.Emit(OpCodes.Br, fa286)
OptimizeIL.MarkLabel(tru286)
OptimizeIL.MarkSequencePoint(doc5, 1118, 1, 1118, 100)
OptimizeIL.Emit(OpCodes.Ldloc, 3)
Typ = GetType(Stmt)
OptimizeIL.Emit(OpCodes.Starg, 1)
OptimizeIL.MarkSequencePoint(doc5, 1119, 1, 1119, 100)
OptimizeIL.Emit(OpCodes.Br, label27)
OptimizeIL.MarkSequencePoint(doc5, 1120, 1, 1120, 100)
OptimizeIL.Emit(OpCodes.Br, cont286)
OptimizeIL.MarkLabel(fa286)
OptimizeIL.Emit(OpCodes.Br, cont286)
OptimizeIL.MarkLabel(cont286)
OptimizeIL.MarkSequencePoint(doc5, 1122, 1, 1122, 100)
OptimizeIL.Emit(OpCodes.Ldarg_0)
Dim typ168(-1) As Type
OptimizeIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
...
ReDim Preserve typ168(UBound(typ168) + 1)
typ168(UBound(typ168)) = Typ
OptimizeIL.Emit(OpCodes.Callvirt, checkScope)
Typ = checkScope.ReturnType
OptimizeIL.Emit(OpCodes.Stloc, 3)
OptimizeIL.MarkSequencePoint(doc5, 1124, 1, 1124, 100)
OptimizeIL.Emit(OpCodes.Ldloc, 4)
Typ = GetType(System.Boolean)
OptimizeIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa287 As System.Reflection.Emit.Label = OptimizeIL.DefineLabel()
Dim tru287 As System.Reflection.Emit.Label = OptimizeIL.DefineLabel()
Dim cont287 As System.Reflection.Emit.Label = OptimizeIL.DefineLabel()
OptimizeIL.Emit(OpCodes.Beq, tru287)
OptimizeIL.Emit(OpCodes.Br, fa287)
OptimizeIL.MarkLabel(tru287)
OptimizeIL.MarkSequencePoint(doc5, 1125, 1, 1125, 100)
OptimizeIL.Emit(OpCodes.Ldloc, 3)
Typ = GetType(Stmt)
OptimizeIL.Emit(OpCodes.Starg, 1)
OptimizeIL.MarkSequencePoint(doc5, 1126, 1, 1126, 100)
OptimizeIL.Emit(OpCodes.Br, label27)
OptimizeIL.MarkSequencePoint(doc5, 1127, 1, 1127, 100)
OptimizeIL.Emit(OpCodes.Br, cont287)
OptimizeIL.MarkLabel(fa287)
OptimizeIL.Emit(OpCodes.Br, cont287)
OptimizeIL.MarkLabel(cont287)
OptimizeIL.MarkSequencePoint(doc5, 1129, 1, 1129, 100)
OptimizeIL.Emit(OpCodes.Ldarg_0)
...
OptimizeIL.Emit(OpCodes.Stloc, 3)
OptimizeIL.MarkSequencePoint(doc5, 1131, 1, 1131, 100)
OptimizeIL.Emit(OpCodes.Ldloc, 4)
Typ = GetType(System.Boolean)
OptimizeIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa288 As System.Reflection.Emit.Label = OptimizeIL.DefineLabel()
Dim tru288 As System.Reflection.Emit.Label = OptimizeIL.DefineLabel()
Dim cont288 As System.Reflection.Emit.Label = OptimizeIL.DefineLabel()
OptimizeIL.Emit(OpCodes.Beq, tru288)
OptimizeIL.Emit(OpCodes.Br, fa288)
OptimizeIL.MarkLabel(tru288)
OptimizeIL.MarkSequencePoint(doc5, 1132, 1, 1132, 100)
OptimizeIL.Emit(OpCodes.Ldloc, 3)
Typ = GetType(Stmt)
OptimizeIL.Emit(OpCodes.Starg, 1)
OptimizeIL.MarkSequencePoint(doc5, 1133, 1, 1133, 100)
OptimizeIL.Emit(OpCodes.Br, label27)
OptimizeIL.MarkSequencePoint(doc5, 1134, 1, 1134, 100)
OptimizeIL.Emit(OpCodes.Br, cont288)
OptimizeIL.MarkLabel(fa288)
OptimizeIL.Emit(OpCodes.Br, cont288)
OptimizeIL.MarkLabel(cont288)
OptimizeIL.MarkSequencePoint(doc5, 1136, 1, 1136, 100)
OptimizeIL.Emit(OpCodes.Ldarg_0)
Dim typ170(-1) As Type
OptimizeIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
...
OptimizeIL.Emit(OpCodes.Stloc, 3)
OptimizeIL.MarkSequencePoint(doc5, 1138, 1, 1138, 100)
OptimizeIL.Emit(OpCodes.Ldloc, 4)
Typ = GetType(System.Boolean)
OptimizeIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa289 As System.Reflection.Emit.Label = OptimizeIL.DefineLabel()
Dim tru289 As System.Reflection.Emit.Label = OptimizeIL.DefineLabel()
Dim cont289 As System.Reflection.Emit.Label = OptimizeIL.DefineLabel()
OptimizeIL.Emit(OpCodes.Beq, tru289)
OptimizeIL.Emit(OpCodes.Br, fa289)
OptimizeIL.MarkLabel(tru289)
OptimizeIL.MarkSequencePoint(doc5, 1139, 1, 1139, 100)
OptimizeIL.Emit(OpCodes.Ldloc, 3)
Typ = GetType(Stmt)
OptimizeIL.Emit(OpCodes.Starg, 1)
OptimizeIL.MarkSequencePoint(doc5, 1140, 1, 1140, 100)
OptimizeIL.Emit(OpCodes.Br, label27)
OptimizeIL.MarkSequencePoint(doc5, 1141, 1, 1141, 100)
OptimizeIL.Emit(OpCodes.Br, cont289)
OptimizeIL.MarkLabel(fa289)
OptimizeIL.Emit(OpCodes.Br, cont289)
OptimizeIL.MarkLabel(cont289)
OptimizeIL.MarkSequencePoint(doc5, 1143, 1, 1143, 100)
OptimizeIL.Emit(OpCodes.Ldarg_0)
Dim typ171(-1) As Type
OptimizeIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
...
OptimizeIL.Emit(OpCodes.Stloc, 3)
OptimizeIL.MarkSequencePoint(doc5, 1145, 1, 1145, 100)
OptimizeIL.Emit(OpCodes.Ldloc, 4)
Typ = GetType(System.Boolean)
OptimizeIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa290 As System.Reflection.Emit.Label = OptimizeIL.DefineLabel()
Dim tru290 As System.Reflection.Emit.Label = OptimizeIL.DefineLabel()
Dim cont290 As System.Reflection.Emit.Label = OptimizeIL.DefineLabel()
OptimizeIL.Emit(OpCodes.Beq, tru290)
OptimizeIL.Emit(OpCodes.Br, fa290)
OptimizeIL.MarkLabel(tru290)
OptimizeIL.MarkSequencePoint(doc5, 1146, 1, 1146, 100)
OptimizeIL.Emit(OpCodes.Ldloc, 3)
Typ = GetType(Stmt)
OptimizeIL.Emit(OpCodes.Starg, 1)
OptimizeIL.MarkSequencePoint(doc5, 1147, 1, 1147, 100)
OptimizeIL.Emit(OpCodes.Br, label27)
OptimizeIL.MarkSequencePoint(doc5, 1148, 1, 1148, 100)
OptimizeIL.Emit(OpCodes.Br, cont290)
OptimizeIL.MarkLabel(fa290)
OptimizeIL.Emit(OpCodes.Br, cont290)
OptimizeIL.MarkLabel(cont290)
OptimizeIL.MarkSequencePoint(doc5, 1150, 1, 1150, 100)
OptimizeIL.Emit(OpCodes.Ldarg_0)
...
OptimizeIL.Emit(OpCodes.Stloc, 3)
OptimizeIL.MarkSequencePoint(doc5, 1152, 1, 1152, 100)
OptimizeIL.Emit(OpCodes.Ldloc, 4)
Typ = GetType(System.Boolean)
OptimizeIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa291 As System.Reflection.Emit.Label = OptimizeIL.DefineLabel()
Dim tru291 As System.Reflection.Emit.Label = OptimizeIL.DefineLabel()
Dim cont291 As System.Reflection.Emit.Label = OptimizeIL.DefineLabel()
OptimizeIL.Emit(OpCodes.Beq, tru291)
OptimizeIL.Emit(OpCodes.Br, fa291)
OptimizeIL.MarkLabel(tru291)
OptimizeIL.MarkSequencePoint(doc5, 1153, 1, 1153, 100)
OptimizeIL.Emit(OpCodes.Ldloc, 3)
Typ = GetType(Stmt)
OptimizeIL.Emit(OpCodes.Starg, 1)
OptimizeIL.MarkSequencePoint(doc5, 1154, 1, 1154, 100)
OptimizeIL.Emit(OpCodes.Br, label27)
OptimizeIL.MarkSequencePoint(doc5, 1155, 1, 1155, 100)
OptimizeIL.Emit(OpCodes.Br, cont291)
OptimizeIL.MarkLabel(fa291)
OptimizeIL.Emit(OpCodes.Br, cont291)
OptimizeIL.MarkLabel(cont291)
OptimizeIL.MarkSequencePoint(doc5, 1157, 1, 1157, 100)
OptimizeIL.Emit(OpCodes.Ldarg_0)
Dim typ173(-1) As Type
OptimizeIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
...
OptimizeIL.Emit(OpCodes.Stloc, 3)
OptimizeIL.MarkSequencePoint(doc5, 1159, 1, 1159, 100)
OptimizeIL.Emit(OpCodes.Ldloc, 4)
Typ = GetType(System.Boolean)
OptimizeIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa292 As System.Reflection.Emit.Label = OptimizeIL.DefineLabel()
Dim tru292 As System.Reflection.Emit.Label = OptimizeIL.DefineLabel()
Dim cont292 As System.Reflection.Emit.Label = OptimizeIL.DefineLabel()
OptimizeIL.Emit(OpCodes.Beq, tru292)
OptimizeIL.Emit(OpCodes.Br, fa292)
OptimizeIL.MarkLabel(tru292)
OptimizeIL.MarkSequencePoint(doc5, 1160, 1, 1160, 100)
OptimizeIL.Emit(OpCodes.Ldloc, 3)
Typ = GetType(Stmt)
OptimizeIL.Emit(OpCodes.Starg, 1)
OptimizeIL.MarkSequencePoint(doc5, 1161, 1, 1161, 100)
OptimizeIL.Emit(OpCodes.Br, label27)
OptimizeIL.MarkSequencePoint(doc5, 1162, 1, 1162, 100)
OptimizeIL.Emit(OpCodes.Br, cont292)
OptimizeIL.MarkLabel(fa292)
OptimizeIL.Emit(OpCodes.Br, cont292)
OptimizeIL.MarkLabel(cont292)
OptimizeIL.MarkSequencePoint(doc5, 1164, 1, 1164, 100)
OptimizeIL.MarkLabel(label27)
OptimizeIL.MarkSequencePoint(doc5, 1166, 1, 1166, 100)
OptimizeIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
OptimizeIL.MarkSequencePoint(doc5, 1167, 1, 1167, 100)
OptimizeIL.Emit(OpCodes.Ret)
...
Dim locbldr388 As LocalBuilder = ParseIL.DeclareLocal(GetType(System.Int32))
locbldr388.SetLocalSymInfo("i")
ParseIL.Emit(OpCodes.Ldc_I4, CInt(-1))
Typ = GetType(System.Int32)
ParseIL.Emit(OpCodes.Stloc, 0)
ParseIL.MarkSequencePoint(doc6, 13, 1, 13, 100)
Dim locbldr389 As LocalBuilder = ParseIL.DeclareLocal(asm.GetType("dylan.NET.Tokenizer.Parser.StmtOptimizer"))
locbldr389.SetLocalSymInfo("so")
ParseIL.Emit(OpCodes.Ldnull)
ParseIL.Emit(OpCodes.Stloc, 1)
ParseIL.MarkSequencePoint(doc6, 14, 1, 14, 100)
Dim locbldr390 As LocalBuilder = ParseIL.DeclareLocal(GetType(System.Int32))
locbldr390.SetLocalSymInfo("len")
...
ParseIL.Emit(OpCodes.Ldloc, 2)
Typ = GetType(System.Int32)
Dim fa293 As System.Reflection.Emit.Label = ParseIL.DefineLabel()
Dim tru293 As System.Reflection.Emit.Label = ParseIL.DefineLabel()
Dim cont293 As System.Reflection.Emit.Label = ParseIL.DefineLabel()
ParseIL.Emit(OpCodes.Beq, tru293)
ParseIL.Emit(OpCodes.Br, fa293)
ParseIL.MarkLabel(tru293)
ParseIL.MarkSequencePoint(doc6, 27, 1, 27, 100)
ParseIL.Emit(OpCodes.Br, label1)
ParseIL.MarkSequencePoint(doc6, 28, 1, 28, 100)
ParseIL.Emit(OpCodes.Br, cont293)
ParseIL.MarkLabel(fa293)
ParseIL.MarkSequencePoint(doc6, 29, 1, 29, 100)
ParseIL.Emit(OpCodes.Br, label0)
ParseIL.MarkSequencePoint(doc6, 30, 1, 30, 100)
ParseIL.Emit(OpCodes.Br, cont293)
ParseIL.MarkLabel(cont293)
