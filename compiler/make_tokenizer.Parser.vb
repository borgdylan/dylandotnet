...
Dim locbldr69 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(BooleanLiteral))
locbldr69.SetLocalSymInfo("boolit")
...
ReDim Preserve typ79(UBound(typ79) + 1)
typ79(UBound(typ79)) = Typ
OptimizeIL.Emit(OpCodes.Call, GetType(Utils.ParseUtils).GetMethod("LikeOP", typ79))
Typ = GetType(Utils.ParseUtils).GetMethod("LikeOP", typ79).ReturnType
OptimizeIL.Emit(OpCodes.Stloc, 1)
...
Dim locbldr70 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(CharLiteral))
locbldr70.SetLocalSymInfo("chrlit")
...
OptimizeIL.Emit(OpCodes.Call, GetType(System.Convert).GetMethod("ToChar", typ80))
Typ = GetType(System.Convert).GetMethod("ToChar", typ80).ReturnType
...
OptimizeIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("Trim", typ81))
Typ = Typ03.GetMethod("Trim", typ81).ReturnType
OptimizeIL.Emit(OpCodes.Stloc, 2)
...
Dim typ82 As Type() = {Typ}
OptimizeIL.Emit(OpCodes.Call, GetType(System.Convert).GetMethod("ToChar", typ82))
Typ = GetType(System.Convert).GetMethod("ToChar", typ82).ReturnType
...
ReDim Preserve typ83(UBound(typ83) + 1)
typ83(UBound(typ83)) = Typ
OptimizeIL.Emit(OpCodes.Call, GetType(String).GetMethod("Concat", typ83))
Typ = GetType(String).GetMethod("Concat", typ83).ReturnType
OptimizeIL.Emit(OpCodes.Stloc, 2)
...
Dim locbldr71 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(StringLiteral))
locbldr71.SetLocalSymInfo("strlit")
...
OptimizeIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("Trim", typ86))
Typ = Typ03.GetMethod("Trim", typ86).ReturnType
OptimizeIL.Emit(OpCodes.Stloc, 2)
...
OptimizeIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("EndsWith", typ90))
Typ = Typ03.GetMethod("EndsWith", typ90).ReturnType
OptimizeIL.Emit(OpCodes.Stloc, 1)
...
locbldr72.SetLocalSymInfo("dlit2")
...
OptimizeIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("TrimEnd", typ92))
Typ = Typ03.GetMethod("TrimEnd", typ92).ReturnType
OptimizeIL.Emit(OpCodes.Stloc, 2)
...
OptimizeIL.Emit(OpCodes.Call, GetType(System.Convert).GetMethod("ToDouble", typ93))
Typ = GetType(System.Convert).GetMethod("ToDouble", typ93).ReturnType
...
OptimizeIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("EndsWith", typ97))
Typ = Typ03.GetMethod("EndsWith", typ97).ReturnType
OptimizeIL.Emit(OpCodes.Stloc, 1)
...
Dim locbldr73 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(FloatLiteral))
locbldr73.SetLocalSymInfo("flit")
...
OptimizeIL.Emit(OpCodes.Call, GetType(System.Convert).GetMethod("ToChar", typ98))
Typ = GetType(System.Convert).GetMethod("ToChar", typ98).ReturnType
OptimizeIL.Emit(OpCodes.Stelem, GetType(System.Char).MakeArrayType().GetElementType())
...
OptimizeIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("TrimEnd", typ99))
Typ = Typ03.GetMethod("TrimEnd", typ99).ReturnType
OptimizeIL.Emit(OpCodes.Stloc, 2)
...
OptimizeIL.Emit(OpCodes.Call, GetType(System.Convert).GetMethod("ToSingle", typ100))
Typ = GetType(System.Convert).GetMethod("ToSingle", typ100).ReturnType
...
locbldr74.SetLocalSymInfo("dlit")
OptimizeIL.Emit(OpCodes.Newobj, GetType(DoubleLiteral).GetConstructor(Type.EmptyTypes))
...
locbldr75.SetLocalSymInfo("dlit3")
OptimizeIL.Emit(OpCodes.Newobj, GetType(DoubleLiteral).GetConstructor(Type.EmptyTypes))
...
OptimizeIL.Emit(OpCodes.Call, GetType(System.Convert).GetMethod("ToDouble", typ111))
Typ = GetType(System.Convert).GetMethod("ToDouble", typ111).ReturnType
OptimizeIL.Emit(OpCodes.Stfld, GetType(DoubleLiteral).GetField("NumVal"))
...
locbldr76.SetLocalSymInfo("flit2")
OptimizeIL.Emit(OpCodes.Newobj, GetType(FloatLiteral).GetConstructor(Type.EmptyTypes))
...
OptimizeIL.Emit(OpCodes.Call, GetType(System.Convert).GetMethod("ToSingle", typ118))
Typ = GetType(System.Convert).GetMethod("ToSingle", typ118).ReturnType
OptimizeIL.Emit(OpCodes.Stfld, GetType(FloatLiteral).GetField("NumVal"))
...
Dim locbldr77 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(IntLiteral))
locbldr77.SetLocalSymInfo("ilit2")
...
OptimizeIL.Emit(OpCodes.Call, GetType(System.Convert).GetMethod("ToInt32", typ125))
Typ = GetType(System.Convert).GetMethod("ToInt32", typ125).ReturnType
...
OptimizeIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("EndsWith", typ129))
Typ = Typ03.GetMethod("EndsWith", typ129).ReturnType
OptimizeIL.Emit(OpCodes.Stloc, 1)
...
Dim locbldr78 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(LongLiteral))
locbldr78.SetLocalSymInfo("llit")
...
OptimizeIL.Emit(OpCodes.Call, GetType(System.Convert).GetMethod("ToChar", typ130))
Typ = GetType(System.Convert).GetMethod("ToChar", typ130).ReturnType
OptimizeIL.Emit(OpCodes.Stelem, GetType(System.Char).MakeArrayType().GetElementType())
...
OptimizeIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("TrimEnd", typ131))
Typ = Typ03.GetMethod("TrimEnd", typ131).ReturnType
OptimizeIL.Emit(OpCodes.Stloc, 2)
...
OptimizeIL.Emit(OpCodes.Call, GetType(System.Convert).GetMethod("ToInt64", typ132))
Typ = GetType(System.Convert).GetMethod("ToInt64", typ132).ReturnType
...
Dim locbldr79 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(ShortLiteral))
locbldr79.SetLocalSymInfo("slit")
...
OptimizeIL.Emit(OpCodes.Call, GetType(System.Convert).GetMethod("ToInt16", typ139))
Typ = GetType(System.Convert).GetMethod("ToInt16", typ139).ReturnType
...
Dim locbldr80 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(SByteLiteral))
locbldr80.SetLocalSymInfo("blit")
...
OptimizeIL.Emit(OpCodes.Call, GetType(System.Convert).GetMethod("ToSByte", typ146))
Typ = GetType(System.Convert).GetMethod("ToSByte", typ146).ReturnType
...
Dim locbldr81 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(IntLiteral))
locbldr81.SetLocalSymInfo("ilit")
OptimizeIL.Emit(OpCodes.Newobj, GetType(IntLiteral).GetConstructor(Type.EmptyTypes))
...
OptimizeIL.Emit(OpCodes.Call, GetType(System.Convert).GetMethod("ToInt32", typ150))
...
Dim locbldr82 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(Ident))
locbldr82.SetLocalSymInfo("idt")
...
Dim locbldr83 As LocalBuilder = checkVarAsIL.DeclareLocal(GetType(Token))
locbldr83.SetLocalSymInfo("tok")
...
Dim locbldr84 As LocalBuilder = checkVarAsIL.DeclareLocal(GetType(System.Type))
locbldr84.SetLocalSymInfo("typ")
...
Dim locbldr85 As LocalBuilder = checkVarAsIL.DeclareLocal(GetType(VarExpr))
locbldr85.SetLocalSymInfo("vars")
...
Typ = GetType(System.Boolean)
Dim fa82 As System.Reflection.Emit.Label = checkVarAsIL.DefineLabel()
Dim tru82 As System.Reflection.Emit.Label = checkVarAsIL.DefineLabel()
Dim cont82 As System.Reflection.Emit.Label = checkVarAsIL.DefineLabel()
checkVarAsIL.Emit(OpCodes.Beq, tru82)
checkVarAsIL.Emit(OpCodes.Br, fa82)
checkVarAsIL.MarkLabel(tru82)
...
locbldr86.SetLocalSymInfo("tok2")
checkVarAsIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Expr)
checkVarAsIL.Emit(OpCodes.Ldfld, GetType(Expr).GetField("Tokens"))
Typ = GetType(Expr).GetField("Tokens").FieldType
...
locbldr87.SetLocalSymInfo("typ2")
...
Dim locbldr88 As LocalBuilder = checkVarAsIL.DeclareLocal(GetType(System.Boolean))
locbldr88.SetLocalSymInfo("b2")
Dim typ4(-1) As Type
...
checkVarAsIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa83 As System.Reflection.Emit.Label = checkVarAsIL.DefineLabel()
Dim tru83 As System.Reflection.Emit.Label = checkVarAsIL.DefineLabel()
Dim cont83 As System.Reflection.Emit.Label = checkVarAsIL.DefineLabel()
checkVarAsIL.Emit(OpCodes.Beq, fa83)
checkVarAsIL.Emit(OpCodes.Br, tru83)
checkVarAsIL.MarkLabel(tru83)
checkVarAsIL.MarkSequencePoint(doc4, 19, 1, 19, 100)
Dim locbldr89 As LocalBuilder = checkVarAsIL.DeclareLocal(GetType(Token))
locbldr89.SetLocalSymInfo("t")
checkVarAsIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Expr)
checkVarAsIL.Emit(OpCodes.Ldfld, GetType(Expr).GetField("Tokens"))
Typ = GetType(Expr).GetField("Tokens").FieldType
...
Dim locbldr90 As LocalBuilder = checkVarAsIL.DeclareLocal(GetType(TypeTok))
locbldr90.SetLocalSymInfo("tt")
...
checkVarAsIL.Emit(OpCodes.Br, cont83)
checkVarAsIL.MarkLabel(fa83)
...
checkVarAsIL.Emit(OpCodes.Br, cont83)
checkVarAsIL.MarkLabel(cont83)
checkVarAsIL.MarkSequencePoint(doc4, 28, 1, 28, 100)
checkVarAsIL.Emit(OpCodes.Br, cont82)
checkVarAsIL.MarkLabel(fa82)
checkVarAsIL.Emit(OpCodes.Br, cont82)
checkVarAsIL.MarkLabel(cont82)
...
Dim locbldr91 As LocalBuilder = procMethodCallIL.DeclareLocal(GetType(MethodNameTok))
locbldr91.SetLocalSymInfo("mn")
...
Dim locbldr92 As LocalBuilder = procMethodCallIL.DeclareLocal(GetType(MethodCallTok))
locbldr92.SetLocalSymInfo("mct")
...
Dim locbldr93 As LocalBuilder = procMethodCallIL.DeclareLocal(GetType(Ident))
locbldr93.SetLocalSymInfo("idt")
...
Dim locbldr94 As LocalBuilder = procMethodCallIL.DeclareLocal(GetType(Expr))
locbldr94.SetLocalSymInfo("ep2")
...
Dim locbldr95 As LocalBuilder = procMethodCallIL.DeclareLocal(GetType(System.Int32))
locbldr95.SetLocalSymInfo("lvl")
...
Dim locbldr96 As LocalBuilder = procMethodCallIL.DeclareLocal(GetType(System.Boolean))
locbldr96.SetLocalSymInfo("d")
...
Dim locbldr97 As LocalBuilder = procMethodCallIL.DeclareLocal(GetType(System.Int32))
locbldr97.SetLocalSymInfo("j")
...
Dim locbldr98 As LocalBuilder = procMethodCallIL.DeclareLocal(GetType(Token))
locbldr98.SetLocalSymInfo("tok2")
procMethodCallIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Expr)
procMethodCallIL.Emit(OpCodes.Ldfld, GetType(Expr).GetField("Tokens"))
Typ = GetType(Expr).GetField("Tokens").FieldType
...
Dim locbldr99 As LocalBuilder = procMethodCallIL.DeclareLocal(GetType(System.Type))
locbldr99.SetLocalSymInfo("typ2")
procMethodCallIL.MarkSequencePoint(doc4, 69, 1, 69, 100)
Dim locbldr100 As LocalBuilder = procMethodCallIL.DeclareLocal(GetType(System.Boolean))
locbldr100.SetLocalSymInfo("b2")
...
procMethodCallIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa86 As System.Reflection.Emit.Label = procMethodCallIL.DefineLabel()
Dim tru86 As System.Reflection.Emit.Label = procMethodCallIL.DefineLabel()
Dim cont86 As System.Reflection.Emit.Label = procMethodCallIL.DefineLabel()
procMethodCallIL.Emit(OpCodes.Beq, tru86)
procMethodCallIL.Emit(OpCodes.Br, fa86)
procMethodCallIL.MarkLabel(tru86)
...
procMethodCallIL.Emit(OpCodes.Br, cont86)
procMethodCallIL.MarkLabel(fa86)
procMethodCallIL.Emit(OpCodes.Br, cont86)
procMethodCallIL.MarkLabel(cont86)
...
locbldr102.SetLocalSymInfo("len")
OptimizeIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Expr)
...
locbldr103.SetLocalSymInfo("i")
OptimizeIL.Emit(OpCodes.Ldc_I4, CInt(-1))
Typ = GetType(System.Int32)
OptimizeIL.Emit(OpCodes.Stloc, 1)
OptimizeIL.MarkSequencePoint(doc4, 165, 1, 165, 100)
Dim locbldr104 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(System.Int32))
locbldr104.SetLocalSymInfo("j")
OptimizeIL.Emit(OpCodes.Ldc_I4, CInt(-1))
Typ = GetType(System.Int32)
OptimizeIL.Emit(OpCodes.Stloc, 2)
...
OptimizeIL.Emit(OpCodes.Blt, tru91)
...
Dim locbldr105 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(Token))
locbldr105.SetLocalSymInfo("tok")
OptimizeIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Expr)
OptimizeIL.Emit(OpCodes.Ldfld, GetType(Expr).GetField("Tokens"))
Typ = GetType(Expr).GetField("Tokens").FieldType
...
Dim locbldr106 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(System.Type))
locbldr106.SetLocalSymInfo("typ")
OptimizeIL.MarkSequencePoint(doc4, 183, 1, 183, 100)
Dim locbldr107 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(System.Boolean))
locbldr107.SetLocalSymInfo("b")
OptimizeIL.MarkSequencePoint(doc4, 184, 1, 184, 100)
Dim locbldr108 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(System.String))
locbldr108.SetLocalSymInfo("str")
...
OptimizeIL.Emit(OpCodes.Beq, fa93)
OptimizeIL.Emit(OpCodes.Br, tru93)
...
OptimizeIL.Emit(OpCodes.Beq, fa95)
OptimizeIL.Emit(OpCodes.Br, tru95)
OptimizeIL.MarkLabel(tru95)
OptimizeIL.MarkSequencePoint(doc4, 210, 1, 210, 100)
Dim locbldr109 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(TypeTok))
locbldr109.SetLocalSymInfo("tt1")
OptimizeIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Expr)
OptimizeIL.Emit(OpCodes.Ldfld, GetType(Expr).GetField("Tokens"))
Typ = GetType(Expr).GetField("Tokens").FieldType
...
Dim locbldr110 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(Ident))
locbldr110.SetLocalSymInfo("id1")
OptimizeIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Expr)
OptimizeIL.Emit(OpCodes.Ldfld, GetType(Expr).GetField("Tokens"))
Typ = GetType(Expr).GetField("Tokens").FieldType
...
Dim locbldr111 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(CharLiteral))
locbldr111.SetLocalSymInfo("cl1")
OptimizeIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Expr)
OptimizeIL.Emit(OpCodes.Ldfld, GetType(Expr).GetField("Tokens"))
Typ = GetType(Expr).GetField("Tokens").FieldType
...
Dim locbldr112 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(StringLiteral))
locbldr112.SetLocalSymInfo("sl1")
OptimizeIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Expr)
OptimizeIL.Emit(OpCodes.Ldfld, GetType(Expr).GetField("Tokens"))
Typ = GetType(Expr).GetField("Tokens").FieldType
...
Dim locbldr113 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(BooleanLiteral))
locbldr113.SetLocalSymInfo("bl1")
OptimizeIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Expr)
OptimizeIL.Emit(OpCodes.Ldfld, GetType(Expr).GetField("Tokens"))
Typ = GetType(Expr).GetField("Tokens").FieldType
...
Dim locbldr114 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(NumberLiteral))
locbldr114.SetLocalSymInfo("nl1")
OptimizeIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Expr)
OptimizeIL.Emit(OpCodes.Ldfld, GetType(Expr).GetField("Tokens"))
Typ = GetType(Expr).GetField("Tokens").FieldType
...
Dim locbldr115 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(MethodCallTok))
...
Dim locbldr116 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(Expr).MakeArrayType())
locbldr116.SetLocalSymInfo("prs")
OptimizeIL.Emit(OpCodes.Ldloc, 13)
Typ = GetType(MethodCallTok)
...
locbldr117.SetLocalSymInfo("ln2")
OptimizeIL.Emit(OpCodes.Ldloc, 14)
...
OptimizeIL.Emit(OpCodes.Blt, tru108)
...
OptimizeIL.Emit(OpCodes.Bgt, tru110)
...
Dim locbldr119 As LocalBuilder = checkRefasmIL.DeclareLocal(GetType(Token))
...
Dim locbldr120 As LocalBuilder = checkRefasmIL.DeclareLocal(GetType(System.Type))
...
Dim locbldr121 As LocalBuilder = checkRefasmIL.DeclareLocal(GetType(RefasmStmt))
locbldr121.SetLocalSymInfo("refasms")
...
Typ = GetType(System.Boolean)
Dim fa112 As System.Reflection.Emit.Label = checkRefasmIL.DefineLabel()
Dim tru112 As System.Reflection.Emit.Label = checkRefasmIL.DefineLabel()
Dim cont112 As System.Reflection.Emit.Label = checkRefasmIL.DefineLabel()
checkRefasmIL.Emit(OpCodes.Beq, tru112)
checkRefasmIL.Emit(OpCodes.Br, fa112)
checkRefasmIL.MarkLabel(tru112)
...
checkRefasmIL.Emit(OpCodes.Br, cont112)
checkRefasmIL.MarkLabel(fa112)
checkRefasmIL.Emit(OpCodes.Br, cont112)
checkRefasmIL.MarkLabel(cont112)
...
Dim locbldr122 As LocalBuilder = checkImportIL.DeclareLocal(GetType(Token))
...
Dim locbldr123 As LocalBuilder = checkImportIL.DeclareLocal(GetType(System.Type))
...
Dim locbldr124 As LocalBuilder = checkImportIL.DeclareLocal(GetType(ImportStmt))
locbldr124.SetLocalSymInfo("imps")
...
Typ = GetType(System.Boolean)
Dim fa113 As System.Reflection.Emit.Label = checkImportIL.DefineLabel()
Dim tru113 As System.Reflection.Emit.Label = checkImportIL.DefineLabel()
Dim cont113 As System.Reflection.Emit.Label = checkImportIL.DefineLabel()
checkImportIL.Emit(OpCodes.Beq, tru113)
checkImportIL.Emit(OpCodes.Br, fa113)
checkImportIL.MarkLabel(tru113)
...
checkImportIL.Emit(OpCodes.Br, cont113)
checkImportIL.MarkLabel(fa113)
checkImportIL.Emit(OpCodes.Br, cont113)
checkImportIL.MarkLabel(cont113)
...
Dim locbldr125 As LocalBuilder = checkLocimportIL.DeclareLocal(GetType(Token))
...
Dim locbldr126 As LocalBuilder = checkLocimportIL.DeclareLocal(GetType(System.Type))
...
Dim locbldr127 As LocalBuilder = checkLocimportIL.DeclareLocal(GetType(LocimportStmt))
locbldr127.SetLocalSymInfo("limps")
...
Typ = GetType(System.Boolean)
Dim fa114 As System.Reflection.Emit.Label = checkLocimportIL.DefineLabel()
Dim tru114 As System.Reflection.Emit.Label = checkLocimportIL.DefineLabel()
Dim cont114 As System.Reflection.Emit.Label = checkLocimportIL.DefineLabel()
checkLocimportIL.Emit(OpCodes.Beq, tru114)
checkLocimportIL.Emit(OpCodes.Br, fa114)
checkLocimportIL.MarkLabel(tru114)
...
checkLocimportIL.Emit(OpCodes.Br, cont114)
checkLocimportIL.MarkLabel(fa114)
checkLocimportIL.Emit(OpCodes.Br, cont114)
checkLocimportIL.MarkLabel(cont114)
...
Dim locbldr128 As LocalBuilder = checkCmtIL.DeclareLocal(GetType(Token))
...
Dim locbldr129 As LocalBuilder = checkCmtIL.DeclareLocal(GetType(System.Type))
...
Dim locbldr130 As LocalBuilder = checkCmtIL.DeclareLocal(GetType(CommentStmt))
locbldr130.SetLocalSymInfo("cmts")
...
Typ = GetType(System.Boolean)
Dim fa115 As System.Reflection.Emit.Label = checkCmtIL.DefineLabel()
Dim tru115 As System.Reflection.Emit.Label = checkCmtIL.DefineLabel()
Dim cont115 As System.Reflection.Emit.Label = checkCmtIL.DefineLabel()
checkCmtIL.Emit(OpCodes.Beq, tru115)
checkCmtIL.Emit(OpCodes.Br, fa115)
checkCmtIL.MarkLabel(tru115)
...
checkCmtIL.Emit(OpCodes.Br, cont115)
checkCmtIL.MarkLabel(fa115)
checkCmtIL.Emit(OpCodes.Br, cont115)
checkCmtIL.MarkLabel(cont115)
...
Typ = GetType(System.Int32)
Dim fa116 As System.Reflection.Emit.Label = checkEndMtdIL.DefineLabel()
Dim tru116 As System.Reflection.Emit.Label = checkEndMtdIL.DefineLabel()
Dim cont116 As System.Reflection.Emit.Label = checkEndMtdIL.DefineLabel()
checkEndMtdIL.Emit(OpCodes.Bge, tru116)
checkEndMtdIL.Emit(OpCodes.Br, fa116)
checkEndMtdIL.MarkLabel(tru116)
checkEndMtdIL.MarkSequencePoint(doc5, 57, 1, 57, 100)
Dim locbldr131 As LocalBuilder = checkEndMtdIL.DeclareLocal(GetType(Token))
locbldr131.SetLocalSymInfo("tok1")
checkEndMtdIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
checkEndMtdIL.Emit(OpCodes.Ldfld, GetType(Stmt).GetField("Tokens"))
Typ = GetType(Stmt).GetField("Tokens").FieldType
...
Dim locbldr132 As LocalBuilder = checkEndMtdIL.DeclareLocal(GetType(System.Type))
locbldr132.SetLocalSymInfo("typ1")
...
Dim locbldr133 As LocalBuilder = checkEndMtdIL.DeclareLocal(GetType(System.Boolean))
locbldr133.SetLocalSymInfo("b1")
Dim typ14(-1) As Type
...
Dim locbldr134 As LocalBuilder = checkEndMtdIL.DeclareLocal(GetType(Token))
...
Dim locbldr135 As LocalBuilder = checkEndMtdIL.DeclareLocal(GetType(System.Type))
...
Dim locbldr136 As LocalBuilder = checkEndMtdIL.DeclareLocal(GetType(System.Boolean))
...
Dim locbldr137 As LocalBuilder = checkEndMtdIL.DeclareLocal(GetType(EndMethodStmt))
locbldr137.SetLocalSymInfo("ems")
...
Typ = GetType(System.Boolean)
Dim fa117 As System.Reflection.Emit.Label = checkEndMtdIL.DefineLabel()
Dim tru117 As System.Reflection.Emit.Label = checkEndMtdIL.DefineLabel()
Dim cont117 As System.Reflection.Emit.Label = checkEndMtdIL.DefineLabel()
checkEndMtdIL.Emit(OpCodes.Beq, tru117)
checkEndMtdIL.Emit(OpCodes.Br, fa117)
checkEndMtdIL.MarkLabel(tru117)
...
checkEndMtdIL.Emit(OpCodes.Br, cont117)
checkEndMtdIL.MarkLabel(fa117)
checkEndMtdIL.Emit(OpCodes.Br, cont117)
checkEndMtdIL.MarkLabel(cont117)
checkEndMtdIL.MarkSequencePoint(doc5, 72, 1, 72, 100)
checkEndMtdIL.Emit(OpCodes.Br, cont116)
checkEndMtdIL.MarkLabel(fa116)
checkEndMtdIL.Emit(OpCodes.Br, cont116)
checkEndMtdIL.MarkLabel(cont116)
...
Typ = GetType(System.Int32)
Dim fa118 As System.Reflection.Emit.Label = checkEndClsIL.DefineLabel()
Dim tru118 As System.Reflection.Emit.Label = checkEndClsIL.DefineLabel()
Dim cont118 As System.Reflection.Emit.Label = checkEndClsIL.DefineLabel()
checkEndClsIL.Emit(OpCodes.Bge, tru118)
checkEndClsIL.Emit(OpCodes.Br, fa118)
checkEndClsIL.MarkLabel(tru118)
checkEndClsIL.MarkSequencePoint(doc5, 79, 1, 79, 100)
Dim locbldr138 As LocalBuilder = checkEndClsIL.DeclareLocal(GetType(Token))
locbldr138.SetLocalSymInfo("tok1")
checkEndClsIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
checkEndClsIL.Emit(OpCodes.Ldfld, GetType(Stmt).GetField("Tokens"))
Typ = GetType(Stmt).GetField("Tokens").FieldType
...
Dim locbldr139 As LocalBuilder = checkEndClsIL.DeclareLocal(GetType(System.Type))
locbldr139.SetLocalSymInfo("typ1")
...
Dim locbldr140 As LocalBuilder = checkEndClsIL.DeclareLocal(GetType(System.Boolean))
locbldr140.SetLocalSymInfo("b1")
Dim typ19(-1) As Type
...
Dim locbldr141 As LocalBuilder = checkEndClsIL.DeclareLocal(GetType(Token))
...
Dim locbldr142 As LocalBuilder = checkEndClsIL.DeclareLocal(GetType(System.Type))
...
Dim locbldr143 As LocalBuilder = checkEndClsIL.DeclareLocal(GetType(System.Boolean))
...
Dim locbldr144 As LocalBuilder = checkEndClsIL.DeclareLocal(GetType(EndClassStmt))
locbldr144.SetLocalSymInfo("ecs")
...
Typ = GetType(System.Boolean)
Dim fa119 As System.Reflection.Emit.Label = checkEndClsIL.DefineLabel()
Dim tru119 As System.Reflection.Emit.Label = checkEndClsIL.DefineLabel()
Dim cont119 As System.Reflection.Emit.Label = checkEndClsIL.DefineLabel()
checkEndClsIL.Emit(OpCodes.Beq, tru119)
checkEndClsIL.Emit(OpCodes.Br, fa119)
checkEndClsIL.MarkLabel(tru119)
...
checkEndClsIL.Emit(OpCodes.Br, cont119)
checkEndClsIL.MarkLabel(fa119)
checkEndClsIL.Emit(OpCodes.Br, cont119)
checkEndClsIL.MarkLabel(cont119)
checkEndClsIL.MarkSequencePoint(doc5, 94, 1, 94, 100)
checkEndClsIL.Emit(OpCodes.Br, cont118)
checkEndClsIL.MarkLabel(fa118)
checkEndClsIL.Emit(OpCodes.Br, cont118)
checkEndClsIL.MarkLabel(cont118)
...
Dim locbldr145 As LocalBuilder = checkAssemblyIL.DeclareLocal(GetType(Token))
...
Dim locbldr146 As LocalBuilder = checkAssemblyIL.DeclareLocal(GetType(System.Type))
...
Dim locbldr147 As LocalBuilder = checkAssemblyIL.DeclareLocal(GetType(AssemblyStmt))
locbldr147.SetLocalSymInfo("asms")
...
Typ = GetType(System.Boolean)
Dim fa120 As System.Reflection.Emit.Label = checkAssemblyIL.DefineLabel()
Dim tru120 As System.Reflection.Emit.Label = checkAssemblyIL.DefineLabel()
Dim cont120 As System.Reflection.Emit.Label = checkAssemblyIL.DefineLabel()
checkAssemblyIL.Emit(OpCodes.Beq, tru120)
checkAssemblyIL.Emit(OpCodes.Br, fa120)
checkAssemblyIL.MarkLabel(tru120)
...
checkAssemblyIL.Emit(OpCodes.Br, cont120)
checkAssemblyIL.MarkLabel(fa120)
checkAssemblyIL.Emit(OpCodes.Br, cont120)
checkAssemblyIL.MarkLabel(cont120)
...
Dim locbldr148 As LocalBuilder = checkVerIL.DeclareLocal(GetType(Token))
...
Dim locbldr149 As LocalBuilder = checkVerIL.DeclareLocal(GetType(System.Type))
...
Dim locbldr150 As LocalBuilder = checkVerIL.DeclareLocal(GetType(VerStmt))
locbldr150.SetLocalSymInfo("vers")
...
Typ = GetType(System.Boolean)
Dim fa121 As System.Reflection.Emit.Label = checkVerIL.DefineLabel()
Dim tru121 As System.Reflection.Emit.Label = checkVerIL.DefineLabel()
Dim cont121 As System.Reflection.Emit.Label = checkVerIL.DefineLabel()
checkVerIL.Emit(OpCodes.Beq, tru121)
checkVerIL.Emit(OpCodes.Br, fa121)
checkVerIL.MarkLabel(tru121)
...
Dim locbldr151 As LocalBuilder = checkVerIL.DeclareLocal(GetType(System.String).MakeArrayType())
locbldr151.SetLocalSymInfo("ars")
Dim typ28(-1) As Type
checkVerIL.Emit(OpCodes.Ldloc, 0)
Typ = GetType(Token)
...
Dim locbldr152 As LocalBuilder = checkVerIL.DeclareLocal(GetType(System.Int32).MakeArrayType())
locbldr152.SetLocalSymInfo("ari")
...
Dim locbldr153 As LocalBuilder = checkVerIL.DeclareLocal(GetType(IntLiteral).MakeArrayType())
locbldr153.SetLocalSymInfo("intla")
checkVerIL.Emit(OpCodes.Ldc_I4, CInt(4))
Typ = GetType(System.Int32)
checkVerIL.Emit(OpCodes.Conv_U)
...
Dim locbldr154 As LocalBuilder = checkVerIL.DeclareLocal(GetType(IntLiteral))
locbldr154.SetLocalSymInfo("intl")
...
checkVerIL.Emit(OpCodes.Br, cont121)
checkVerIL.MarkLabel(fa121)
checkVerIL.Emit(OpCodes.Br, cont121)
checkVerIL.MarkLabel(cont121)
...
Dim locbldr155 As LocalBuilder = checkClassIL.DeclareLocal(GetType(Token))
...
Dim locbldr156 As LocalBuilder = checkClassIL.DeclareLocal(GetType(System.Type))
...
Dim locbldr157 As LocalBuilder = checkClassIL.DeclareLocal(GetType(ClassStmt))
locbldr157.SetLocalSymInfo("clss")
...
Dim locbldr158 As LocalBuilder = checkClassIL.DeclareLocal(GetType(Attributes.Attribute))
locbldr158.SetLocalSymInfo("att")
...
Typ = GetType(System.Boolean)
Dim fa122 As System.Reflection.Emit.Label = checkClassIL.DefineLabel()
Dim tru122 As System.Reflection.Emit.Label = checkClassIL.DefineLabel()
Dim cont122 As System.Reflection.Emit.Label = checkClassIL.DefineLabel()
checkClassIL.Emit(OpCodes.Beq, tru122)
checkClassIL.Emit(OpCodes.Br, fa122)
checkClassIL.MarkLabel(tru122)
...
Dim locbldr159 As LocalBuilder = checkClassIL.DeclareLocal(GetType(System.Int32))
locbldr159.SetLocalSymInfo("i")
checkClassIL.Emit(OpCodes.Ldc_I4, CInt(0))
Typ = GetType(System.Int32)
checkClassIL.Emit(OpCodes.Stloc, 4)
checkClassIL.MarkSequencePoint(doc5, 165, 1, 165, 100)
Dim locbldr160 As LocalBuilder = checkClassIL.DeclareLocal(GetType(System.Int32))
...
Dim locbldr161 As LocalBuilder = checkClassIL.DeclareLocal(GetType(System.Boolean))
locbldr161.SetLocalSymInfo("bl")
...
checkClassIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa123 As System.Reflection.Emit.Label = checkClassIL.DefineLabel()
Dim tru123 As System.Reflection.Emit.Label = checkClassIL.DefineLabel()
Dim cont123 As System.Reflection.Emit.Label = checkClassIL.DefineLabel()
checkClassIL.Emit(OpCodes.Beq, tru123)
checkClassIL.Emit(OpCodes.Br, fa123)
checkClassIL.MarkLabel(tru123)
...
checkClassIL.Emit(OpCodes.Br, cont123)
checkClassIL.MarkLabel(fa123)
checkClassIL.MarkSequencePoint(doc5, 180, 1, 180, 100)
Dim locbldr162 As LocalBuilder = checkClassIL.DeclareLocal(GetType(Token))
...
Dim locbldr163 As LocalBuilder = checkClassIL.DeclareLocal(GetType(System.Type))
...
Dim locbldr164 As LocalBuilder = checkClassIL.DeclareLocal(GetType(System.Boolean))
...
checkClassIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa124 As System.Reflection.Emit.Label = checkClassIL.DefineLabel()
Dim tru124 As System.Reflection.Emit.Label = checkClassIL.DefineLabel()
Dim cont124 As System.Reflection.Emit.Label = checkClassIL.DefineLabel()
checkClassIL.Emit(OpCodes.Beq, tru124)
checkClassIL.Emit(OpCodes.Br, fa124)
checkClassIL.MarkLabel(tru124)
...
checkClassIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa125 As System.Reflection.Emit.Label = checkClassIL.DefineLabel()
Dim tru125 As System.Reflection.Emit.Label = checkClassIL.DefineLabel()
Dim cont125 As System.Reflection.Emit.Label = checkClassIL.DefineLabel()
checkClassIL.Emit(OpCodes.Beq, fa125)
checkClassIL.Emit(OpCodes.Br, tru125)
checkClassIL.MarkLabel(tru125)
checkClassIL.MarkSequencePoint(doc5, 191, 1, 191, 100)
Dim locbldr165 As LocalBuilder = checkClassIL.DeclareLocal(GetType(Token))
locbldr165.SetLocalSymInfo("t")
checkClassIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
checkClassIL.Emit(OpCodes.Ldfld, GetType(Stmt).GetField("Tokens"))
Typ = GetType(Stmt).GetField("Tokens").FieldType
...
Dim locbldr166 As LocalBuilder = checkClassIL.DeclareLocal(GetType(TypeTok))
locbldr166.SetLocalSymInfo("tt")
...
checkClassIL.Emit(OpCodes.Br, cont125)
checkClassIL.MarkLabel(fa125)
...
checkClassIL.Emit(OpCodes.Br, cont125)
checkClassIL.MarkLabel(cont125)
checkClassIL.MarkSequencePoint(doc5, 199, 1, 199, 100)
checkClassIL.Emit(OpCodes.Br, cont124)
checkClassIL.MarkLabel(fa124)
...
checkClassIL.Emit(OpCodes.Br, cont124)
checkClassIL.MarkLabel(cont124)
checkClassIL.MarkSequencePoint(doc5, 203, 1, 203, 100)
checkClassIL.Emit(OpCodes.Br, cont123)
checkClassIL.MarkLabel(cont123)
...
checkClassIL.Emit(OpCodes.Br, cont122)
checkClassIL.MarkLabel(fa122)
checkClassIL.Emit(OpCodes.Br, cont122)
checkClassIL.MarkLabel(cont122)
...
Dim locbldr167 As LocalBuilder = checkMethodIL.DeclareLocal(GetType(Token))
locbldr167.SetLocalSymInfo("tok")
...
Dim locbldr168 As LocalBuilder = checkMethodIL.DeclareLocal(GetType(System.Type))
...
Dim locbldr169 As LocalBuilder = checkMethodIL.DeclareLocal(GetType(MethodStmt))
locbldr169.SetLocalSymInfo("mtss")
...
Dim locbldr170 As LocalBuilder = checkMethodIL.DeclareLocal(GetType(Attributes.Attribute))
locbldr170.SetLocalSymInfo("att")
...
Dim locbldr171 As LocalBuilder = checkMethodIL.DeclareLocal(GetType(Ident))
locbldr171.SetLocalSymInfo("mn")
...
Dim locbldr172 As LocalBuilder = checkMethodIL.DeclareLocal(GetType(Expr))
locbldr172.SetLocalSymInfo("exp")
checkMethodIL.Emit(OpCodes.Ldnull)
checkMethodIL.Emit(OpCodes.Stloc, 5)
checkMethodIL.MarkSequencePoint(doc5, 226, 1, 226, 100)
Dim locbldr173 As LocalBuilder = checkMethodIL.DeclareLocal(GetType(System.Boolean))
locbldr173.SetLocalSymInfo("d")
...
Dim locbldr174 As LocalBuilder = checkMethodIL.DeclareLocal(GetType(System.Int32))
locbldr174.SetLocalSymInfo("i")
checkMethodIL.Emit(OpCodes.Ldc_I4, CInt(0))
Typ = GetType(System.Int32)
checkMethodIL.Emit(OpCodes.Stloc, 7)
checkMethodIL.MarkSequencePoint(doc5, 238, 1, 238, 100)
Dim locbldr175 As LocalBuilder = checkMethodIL.DeclareLocal(GetType(System.Int32))
...
Dim locbldr176 As LocalBuilder = checkMethodIL.DeclareLocal(GetType(System.Boolean))
...
checkMethodIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa128 As System.Reflection.Emit.Label = checkMethodIL.DefineLabel()
Dim tru128 As System.Reflection.Emit.Label = checkMethodIL.DefineLabel()
Dim cont128 As System.Reflection.Emit.Label = checkMethodIL.DefineLabel()
checkMethodIL.Emit(OpCodes.Beq, tru128)
checkMethodIL.Emit(OpCodes.Br, fa128)
checkMethodIL.MarkLabel(tru128)
...
checkMethodIL.Emit(OpCodes.Br, cont128)
checkMethodIL.MarkLabel(fa128)
...
checkMethodIL.Emit(OpCodes.Br, cont128)
checkMethodIL.MarkLabel(cont128)
checkMethodIL.MarkSequencePoint(doc5, 257, 1, 257, 100)
checkMethodIL.Emit(OpCodes.Ldloc, 7)
Typ = GetType(System.Int32)
checkMethodIL.Emit(OpCodes.Ldloc, 8)
Typ = GetType(System.Int32)
Dim fa129 As System.Reflection.Emit.Label = checkMethodIL.DefineLabel()
Dim tru129 As System.Reflection.Emit.Label = checkMethodIL.DefineLabel()
Dim cont129 As System.Reflection.Emit.Label = checkMethodIL.DefineLabel()
checkMethodIL.Emit(OpCodes.Beq, tru129)
checkMethodIL.Emit(OpCodes.Br, fa129)
checkMethodIL.MarkLabel(tru129)
...
checkMethodIL.Emit(OpCodes.Br, cont129)
checkMethodIL.MarkLabel(fa129)
...
checkMethodIL.Emit(OpCodes.Br, cont129)
checkMethodIL.MarkLabel(cont129)
...
Dim locbldr177 As LocalBuilder = checkMethodIL.DeclareLocal(GetType(Token))
...
Dim locbldr178 As LocalBuilder = checkMethodIL.DeclareLocal(GetType(System.Type))
...
checkMethodIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa130 As System.Reflection.Emit.Label = checkMethodIL.DefineLabel()
Dim tru130 As System.Reflection.Emit.Label = checkMethodIL.DefineLabel()
Dim cont130 As System.Reflection.Emit.Label = checkMethodIL.DefineLabel()
checkMethodIL.Emit(OpCodes.Beq, fa130)
checkMethodIL.Emit(OpCodes.Br, tru130)
checkMethodIL.MarkLabel(tru130)
checkMethodIL.MarkSequencePoint(doc5, 278, 1, 278, 100)
Dim locbldr180 As LocalBuilder = checkMethodIL.DeclareLocal(GetType(Token))
...
Dim locbldr181 As LocalBuilder = checkMethodIL.DeclareLocal(GetType(TypeTok))
...
checkMethodIL.Emit(OpCodes.Br, cont130)
checkMethodIL.MarkLabel(fa130)
...
checkMethodIL.Emit(OpCodes.Br, cont130)
checkMethodIL.MarkLabel(cont130)
...
checkMethodIL.Emit(OpCodes.Beq, tru134)
checkMethodIL.Emit(OpCodes.Br, fa134)
checkMethodIL.MarkLabel(tru134)
checkMethodIL.MarkSequencePoint(doc5, 315, 1, 315, 100)
Dim locbldr182 As LocalBuilder = checkMethodIL.DeclareLocal(asm.GetType("dylan.NET.Tokenizer.Parser.ExprOptimizer"))
locbldr182.SetLocalSymInfo("eopt2")
...
Dim locbldr183 As LocalBuilder = checkMethodIL.DeclareLocal(asm.GetType("dylan.NET.Tokenizer.Parser.ExprOptimizer"))
locbldr183.SetLocalSymInfo("eopt1")
checkMethodIL.Emit(OpCodes.Newobj, asm.GetType("dylan.NET.Tokenizer.Parser.ExprOptimizer").GetConstructor(Type.EmptyTypes))
...
Typ = GetType(System.Int32)
Dim fa141 As System.Reflection.Emit.Label = checkMethodCallIL.DefineLabel()
Dim tru141 As System.Reflection.Emit.Label = checkMethodCallIL.DefineLabel()
Dim cont141 As System.Reflection.Emit.Label = checkMethodCallIL.DefineLabel()
checkMethodCallIL.Emit(OpCodes.Bgt, tru141)
checkMethodCallIL.Emit(OpCodes.Br, fa141)
checkMethodCallIL.MarkLabel(tru141)
checkMethodCallIL.MarkSequencePoint(doc5, 367, 1, 367, 100)
Dim locbldr184 As LocalBuilder = checkMethodCallIL.DeclareLocal(GetType(Token))
...
Dim locbldr185 As LocalBuilder = checkMethodCallIL.DeclareLocal(GetType(System.Type))
...
Dim locbldr186 As LocalBuilder = checkMethodCallIL.DeclareLocal(GetType(Token))
locbldr186.SetLocalSymInfo("tokb")
checkMethodCallIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
checkMethodCallIL.Emit(OpCodes.Ldfld, GetType(Stmt).GetField("Tokens"))
Typ = GetType(Stmt).GetField("Tokens").FieldType
...
Dim locbldr187 As LocalBuilder = checkMethodCallIL.DeclareLocal(GetType(System.Type))
locbldr187.SetLocalSymInfo("typb")
...
Dim locbldr188 As LocalBuilder = checkMethodCallIL.DeclareLocal(GetType(System.Boolean))
locbldr188.SetLocalSymInfo("ba")
Dim typ73(-1) As Type
...
Dim locbldr189 As LocalBuilder = checkMethodCallIL.DeclareLocal(GetType(System.Boolean))
locbldr189.SetLocalSymInfo("bb")
Dim typ74(-1) As Type
...
Dim locbldr190 As LocalBuilder = checkMethodCallIL.DeclareLocal(GetType(MethodCallStmt))
locbldr190.SetLocalSymInfo("mtcss")
...
Dim locbldr191 As LocalBuilder = checkMethodCallIL.DeclareLocal(GetType(MethodNameTok))
locbldr191.SetLocalSymInfo("mn")
...
Dim locbldr192 As LocalBuilder = checkMethodCallIL.DeclareLocal(GetType(MethodCallTok))
locbldr192.SetLocalSymInfo("mct")
...
Dim locbldr193 As LocalBuilder = checkMethodCallIL.DeclareLocal(GetType(Ident))
locbldr193.SetLocalSymInfo("idt")
...
Dim locbldr194 As LocalBuilder = checkMethodCallIL.DeclareLocal(GetType(Expr))
locbldr194.SetLocalSymInfo("exp")
...
Dim locbldr195 As LocalBuilder = checkMethodCallIL.DeclareLocal(GetType(System.Int32))
locbldr195.SetLocalSymInfo("lvl")
checkMethodCallIL.Emit(OpCodes.Ldc_I4, CInt(1))
Typ = GetType(System.Int32)
checkMethodCallIL.Emit(OpCodes.Stloc, 11)
checkMethodCallIL.MarkSequencePoint(doc5, 382, 1, 382, 100)
Dim locbldr196 As LocalBuilder = checkMethodCallIL.DeclareLocal(GetType(System.Boolean))
locbldr196.SetLocalSymInfo("d")
...
Dim locbldr197 As LocalBuilder = checkMethodCallIL.DeclareLocal(GetType(System.Int32))
...
checkMethodCallIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa142 As System.Reflection.Emit.Label = checkMethodCallIL.DefineLabel()
Dim tru142 As System.Reflection.Emit.Label = checkMethodCallIL.DefineLabel()
Dim cont142 As System.Reflection.Emit.Label = checkMethodCallIL.DefineLabel()
checkMethodCallIL.Emit(OpCodes.Beq, tru142)
checkMethodCallIL.Emit(OpCodes.Br, fa142)
checkMethodCallIL.MarkLabel(tru142)
...
Dim locbldr198 As LocalBuilder = checkMethodCallIL.DeclareLocal(GetType(Token))
locbldr198.SetLocalSymInfo("tok2")
checkMethodCallIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
checkMethodCallIL.Emit(OpCodes.Ldfld, GetType(Stmt).GetField("Tokens"))
Typ = GetType(Stmt).GetField("Tokens").FieldType
...
Dim locbldr199 As LocalBuilder = checkMethodCallIL.DeclareLocal(GetType(System.Type))
locbldr199.SetLocalSymInfo("typ2")
checkMethodCallIL.MarkSequencePoint(doc5, 396, 1, 396, 100)
Dim locbldr200 As LocalBuilder = checkMethodCallIL.DeclareLocal(GetType(System.Boolean))
locbldr200.SetLocalSymInfo("b2")
...
Dim locbldr202 As LocalBuilder = checkMethodCallIL.DeclareLocal(asm.GetType("dylan.NET.Tokenizer.Parser.ExprOptimizer"))
locbldr202.SetLocalSymInfo("eopt")
...
checkMethodCallIL.MarkSequencePoint(doc5, 404, 1, 404, 100)
...
checkMethodCallIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa143 As System.Reflection.Emit.Label = checkMethodCallIL.DefineLabel()
Dim tru143 As System.Reflection.Emit.Label = checkMethodCallIL.DefineLabel()
Dim cont143 As System.Reflection.Emit.Label = checkMethodCallIL.DefineLabel()
checkMethodCallIL.Emit(OpCodes.Beq, tru143)
checkMethodCallIL.Emit(OpCodes.Br, fa143)
checkMethodCallIL.MarkLabel(tru143)
...
checkMethodCallIL.Emit(OpCodes.Ldc_I4, CInt(0))
Typ = GetType(System.Int32)
Dim fa144 As System.Reflection.Emit.Label = checkMethodCallIL.DefineLabel()
Dim tru144 As System.Reflection.Emit.Label = checkMethodCallIL.DefineLabel()
Dim cont144 As System.Reflection.Emit.Label = checkMethodCallIL.DefineLabel()
checkMethodCallIL.Emit(OpCodes.Beq, tru144)
checkMethodCallIL.Emit(OpCodes.Br, fa144)
checkMethodCallIL.MarkLabel(tru144)
...
ReDim Preserve typ77(UBound(typ77) + 1)
typ77(UBound(typ77)) = Typ
checkMethodCallIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("Optimize", typ77))
Typ = Typ03.GetMethod("Optimize", typ77).ReturnType
checkMethodCallIL.Emit(OpCodes.Stloc, 10)
...
ReDim Preserve typ78(UBound(typ78) + 1)
typ78(UBound(typ78)) = Typ
checkMethodCallIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("AddParam", typ78))
Typ = Typ03.GetMethod("AddParam", typ78).ReturnType
If Typ.ToString() = GetType(System.Void).ToString() Then
...
checkMethodCallIL.Emit(OpCodes.Br, cont144)
checkMethodCallIL.MarkLabel(fa144)
...
checkMethodCallIL.Emit(OpCodes.Br, cont144)
checkMethodCallIL.MarkLabel(cont144)
checkMethodCallIL.MarkSequencePoint(doc5, 423, 1, 423, 100)
checkMethodCallIL.Emit(OpCodes.Br, label9)
checkMethodCallIL.MarkSequencePoint(doc5, 424, 1, 424, 100)
checkMethodCallIL.Emit(OpCodes.Br, cont143)
checkMethodCallIL.MarkLabel(fa143)
checkMethodCallIL.Emit(OpCodes.Br, cont143)
checkMethodCallIL.MarkLabel(cont143)
...
checkMethodCallIL.Emit(OpCodes.Beq, tru145)
...
checkMethodCallIL.Emit(OpCodes.Call, GetType(System.Type).GetMethod("GetTypeFromHandle", typ81))
...
checkMethodCallIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("IsInstanceOfType", typ82))
...
ReDim Preserve typ83(UBound(typ83) + 1)
typ83(UBound(typ83)) = Typ
checkMethodCallIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("Optimize", typ83))
Typ = Typ03.GetMethod("Optimize", typ83).ReturnType
checkMethodCallIL.Emit(OpCodes.Stloc, 10)
...
ReDim Preserve typ84(UBound(typ84) + 1)
typ84(UBound(typ84)) = Typ
checkMethodCallIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("AddParam", typ84))
Typ = Typ03.GetMethod("AddParam", typ84).ReturnType
If Typ.ToString() = GetType(System.Void).ToString() Then
...
checkMethodCallIL.MarkSequencePoint(doc5, 449, 1, 449, 100)
...
checkMethodCallIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("AddToken", typ85))
Typ = Typ03.GetMethod("AddToken", typ85).ReturnType
If Typ.ToString() = GetType(System.Void).ToString() Then
...
checkMethodCallIL.Emit(OpCodes.Br, cont142)
checkMethodCallIL.MarkLabel(fa142)
checkMethodCallIL.Emit(OpCodes.Br, cont142)
checkMethodCallIL.MarkLabel(cont142)
checkMethodCallIL.MarkSequencePoint(doc5, 473, 1, 473, 100)
checkMethodCallIL.Emit(OpCodes.Br, cont141)
checkMethodCallIL.MarkLabel(fa141)
checkMethodCallIL.Emit(OpCodes.Br, cont141)
checkMethodCallIL.MarkLabel(cont141)
...
ReDim Preserve typ86(UBound(typ86) + 1)
typ86(UBound(typ86)) = GetType(System.Boolean).MakeByRefType()
Dim checkVarAs As MethodBuilder = StmtOptimizer.DefineMethod("checkVarAs", MethodAttributes.Public, GetType(Stmt), typ86)
Dim checkVarAsIL As ILGenerator = checkVarAs.GetILGenerator()
Dim checkVarAsparam00 As ParameterBuilder = checkVarAs.DefineParameter(0, ParameterAttributes.RetVal, "")
Dim checkVarAsparam01 As ParameterBuilder = checkVarAs.DefineParameter(1, ParameterAttributes.None, "stm")
Dim checkVarAsparam02 As ParameterBuilder = checkVarAs.DefineParameter(2, ParameterAttributes.None, "b")
...
locbldr203.SetLocalSymInfo("tok")
checkVarAsIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
...
Dim locbldr204 As LocalBuilder = checkVarAsIL.DeclareLocal(GetType(System.Type))
...
checkVarAsIL.Emit(OpCodes.Stobj, Typ04)
checkVarAsIL.MarkSequencePoint(doc5, 481, 1, 481, 100)
Dim locbldr205 As LocalBuilder = checkVarAsIL.DeclareLocal(GetType(VarStmt))
locbldr205.SetLocalSymInfo("vars")
...
checkVarAsIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa150 As System.Reflection.Emit.Label = checkVarAsIL.DefineLabel()
Dim tru150 As System.Reflection.Emit.Label = checkVarAsIL.DefineLabel()
Dim cont150 As System.Reflection.Emit.Label = checkVarAsIL.DefineLabel()
checkVarAsIL.Emit(OpCodes.Beq, tru150)
checkVarAsIL.Emit(OpCodes.Br, fa150)
checkVarAsIL.MarkLabel(tru150)
...
checkVarAsIL.MarkSequencePoint(doc5, 485, 1, 485, 100)
checkVarAsIL.Emit(OpCodes.Ldloc, 2)
Typ = GetType(VarStmt)
checkVarAsIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
...
Dim locbldr206 As LocalBuilder = checkVarAsIL.DeclareLocal(GetType(Token))
...
Dim locbldr207 As LocalBuilder = checkVarAsIL.DeclareLocal(GetType(System.Type))
locbldr207.SetLocalSymInfo("typ2")
checkVarAsIL.Emit(OpCodes.Ldtoken, GetType(TypeTok))
Dim typ89 As Type() = {GetType(System.RuntimeTypeHandle)}
checkVarAsIL.Emit(OpCodes.Call, GetType(System.Type).GetMethod("GetTypeFromHandle", typ89))
Typ = GetType(System.Type).GetMethod("GetTypeFromHandle", typ89).ReturnType
checkVarAsIL.Emit(OpCodes.Stloc, 4)
checkVarAsIL.MarkSequencePoint(doc5, 490, 1, 490, 100)
Dim locbldr208 As LocalBuilder = checkVarAsIL.DeclareLocal(GetType(System.Boolean))
...
ReDim Preserve typ90(UBound(typ90) + 1)
typ90(UBound(typ90)) = Typ
checkVarAsIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("IsInstanceOfType", typ90))
...
checkVarAsIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa151 As System.Reflection.Emit.Label = checkVarAsIL.DefineLabel()
Dim tru151 As System.Reflection.Emit.Label = checkVarAsIL.DefineLabel()
Dim cont151 As System.Reflection.Emit.Label = checkVarAsIL.DefineLabel()
checkVarAsIL.Emit(OpCodes.Beq, fa151)
checkVarAsIL.Emit(OpCodes.Br, tru151)
checkVarAsIL.MarkLabel(tru151)
...
Dim locbldr210 As LocalBuilder = checkVarAsIL.DeclareLocal(GetType(TypeTok))
...
checkVarAsIL.Emit(OpCodes.Br, cont151)
checkVarAsIL.MarkLabel(fa151)
...
checkVarAsIL.Emit(OpCodes.Br, cont151)
checkVarAsIL.MarkLabel(cont151)
checkVarAsIL.MarkSequencePoint(doc5, 502, 1, 502, 100)
checkVarAsIL.Emit(OpCodes.Br, cont150)
checkVarAsIL.MarkLabel(fa150)
checkVarAsIL.Emit(OpCodes.Br, cont150)
checkVarAsIL.MarkLabel(cont150)
...
Dim AssOpt As MethodBuilder = StmtOptimizer.DefineMethod("AssOpt", MethodAttributes.Public, GetType(Stmt), typ91)
...
Dim locbldr211 As LocalBuilder = AssOptIL.DeclareLocal(GetType(AssignStmt))
locbldr211.SetLocalSymInfo("asss")
AssOptIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
AssOptIL.Emit(OpCodes.Stloc, 0)
AssOptIL.MarkSequencePoint(doc5, 509, 1, 509, 100)
Dim locbldr212 As LocalBuilder = AssOptIL.DeclareLocal(GetType(Expr))
locbldr212.SetLocalSymInfo("le")
...
Dim locbldr213 As LocalBuilder = AssOptIL.DeclareLocal(GetType(Token))
...
Dim locbldr214 As LocalBuilder = AssOptIL.DeclareLocal(GetType(System.Type))
...
AssOptIL.MarkSequencePoint(doc5, 512, 1, 512, 100)
Dim locbldr215 As LocalBuilder = AssOptIL.DeclareLocal(GetType(System.Boolean))
...
Dim locbldr216 As LocalBuilder = AssOptIL.DeclareLocal(GetType(VarAsgnStmt))
locbldr216.SetLocalSymInfo("vass")
...
Typ = GetType(System.Boolean)
Dim fa152 As System.Reflection.Emit.Label = AssOptIL.DefineLabel()
Dim tru152 As System.Reflection.Emit.Label = AssOptIL.DefineLabel()
Dim cont152 As System.Reflection.Emit.Label = AssOptIL.DefineLabel()
AssOptIL.Emit(OpCodes.Beq, tru152)
AssOptIL.Emit(OpCodes.Br, fa152)
AssOptIL.MarkLabel(tru152)
...
AssOptIL.MarkSequencePoint(doc5, 516, 1, 516, 100)
AssOptIL.Emit(OpCodes.Ldloc, 5)
Typ = GetType(VarAsgnStmt)
AssOptIL.Emit(OpCodes.Ldloc, 0)
Typ = GetType(AssignStmt)
...
Dim locbldr217 As LocalBuilder = AssOptIL.DeclareLocal(GetType(Token))
locbldr217.SetLocalSymInfo("tok2")
AssOptIL.Emit(OpCodes.Ldloc, 1)
Typ = GetType(Expr)
AssOptIL.Emit(OpCodes.Ldfld, GetType(Expr).GetField("Tokens"))
Typ = GetType(Expr).GetField("Tokens").FieldType
...
Dim locbldr218 As LocalBuilder = AssOptIL.DeclareLocal(GetType(System.Type))
locbldr218.SetLocalSymInfo("typ2")
AssOptIL.Emit(OpCodes.Ldtoken, GetType(TypeTok))
Dim typ94 As Type() = {GetType(System.RuntimeTypeHandle)}
AssOptIL.Emit(OpCodes.Call, GetType(System.Type).GetMethod("GetTypeFromHandle", typ94))
...
Dim locbldr219 As LocalBuilder = AssOptIL.DeclareLocal(GetType(System.Boolean))
...
ReDim Preserve typ95(UBound(typ95) + 1)
typ95(UBound(typ95)) = Typ
AssOptIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("IsInstanceOfType", typ95))
...
AssOptIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa153 As System.Reflection.Emit.Label = AssOptIL.DefineLabel()
Dim tru153 As System.Reflection.Emit.Label = AssOptIL.DefineLabel()
Dim cont153 As System.Reflection.Emit.Label = AssOptIL.DefineLabel()
AssOptIL.Emit(OpCodes.Beq, fa153)
AssOptIL.Emit(OpCodes.Br, tru153)
AssOptIL.MarkLabel(tru153)
AssOptIL.MarkSequencePoint(doc5, 524, 1, 524, 100)
Dim locbldr220 As LocalBuilder = AssOptIL.DeclareLocal(GetType(Token))
locbldr220.SetLocalSymInfo("t")
AssOptIL.Emit(OpCodes.Ldloc, 1)
Typ = GetType(Expr)
AssOptIL.Emit(OpCodes.Ldfld, GetType(Expr).GetField("Tokens"))
Typ = GetType(Expr).GetField("Tokens").FieldType
...
Dim locbldr221 As LocalBuilder = AssOptIL.DeclareLocal(GetType(TypeTok))
locbldr221.SetLocalSymInfo("tt")
...
AssOptIL.Emit(OpCodes.Br, cont153)
AssOptIL.MarkLabel(fa153)
...
Dim locbldr222 As LocalBuilder = AssOptIL.DeclareLocal(asm.GetType("dylan.NET.Tokenizer.Parser.ExprOptimizer"))
locbldr222.SetLocalSymInfo("eop")
...
ReDim Preserve typ96(UBound(typ96) + 1)
typ96(UBound(typ96)) = Typ
AssOptIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("Optimize", typ96))
Typ = Typ03.GetMethod("Optimize", typ96).ReturnType
AssOptIL.Emit(OpCodes.Stfld, GetType(VarAsgnStmt).GetField("RExpr"))
AssOptIL.MarkSequencePoint(doc5, 537, 1, 537, 100)
AssOptIL.Emit(OpCodes.Ldloc, 5)
Typ = GetType(VarAsgnStmt)
AssOptIL.MarkSequencePoint(doc5, 538, 1, 538, 100)
AssOptIL.Emit(OpCodes.Br, cont152)
AssOptIL.MarkLabel(fa152)
AssOptIL.MarkSequencePoint(doc5, 539, 1, 539, 100)
AssOptIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
AssOptIL.MarkSequencePoint(doc5, 540, 1, 540, 100)
AssOptIL.Emit(OpCodes.Br, cont152)
AssOptIL.MarkLabel(cont152)
AssOptIL.MarkSequencePoint(doc5, 542, 1, 542, 100)
AssOptIL.Emit(OpCodes.Ret)
Dim typ97(-1) As Type
ReDim Preserve typ97(UBound(typ97) + 1)
typ97(UBound(typ97)) = GetType(Stmt)
ReDim Preserve typ97(UBound(typ97) + 1)
typ97(UBound(typ97)) = GetType(System.Boolean).MakeByRefType()
Dim checkAssign As MethodBuilder = StmtOptimizer.DefineMethod("checkAssign", MethodAttributes.Public, GetType(Stmt), typ97)
...
Dim locbldr223 As LocalBuilder = checkAssignIL.DeclareLocal(GetType(Token))
...
Dim locbldr224 As LocalBuilder = checkAssignIL.DeclareLocal(GetType(System.Type))
...
checkAssignIL.Emit(OpCodes.Call, GetType(System.Type).GetMethod("GetTypeFromHandle", typ98))
...
Dim locbldr225 As LocalBuilder = checkAssignIL.DeclareLocal(GetType(AssignStmt))
locbldr225.SetLocalSymInfo("asss")
...
Dim locbldr226 As LocalBuilder = checkAssignIL.DeclareLocal(GetType(System.Boolean))
locbldr226.SetLocalSymInfo("c")
checkAssignIL.Emit(OpCodes.Ldc_I4, 0)
Typ = GetType(System.Boolean)
checkAssignIL.Emit(OpCodes.Stloc, 3)
checkAssignIL.MarkSequencePoint(doc5, 549, 1, 549, 100)
Dim locbldr227 As LocalBuilder = checkAssignIL.DeclareLocal(GetType(Expr))
locbldr227.SetLocalSymInfo("re")
...
Dim locbldr228 As LocalBuilder = checkAssignIL.DeclareLocal(GetType(Expr))
locbldr228.SetLocalSymInfo("le")
checkAssignIL.Emit(OpCodes.Newobj, GetType(Expr).GetConstructor(Type.EmptyTypes))
checkAssignIL.Emit(OpCodes.Stloc, 5)
checkAssignIL.MarkSequencePoint(doc5, 551, 1, 551, 100)
Dim locbldr229 As LocalBuilder = checkAssignIL.DeclareLocal(GetType(System.Int32))
locbldr229.SetLocalSymInfo("i")
...
Dim locbldr230 As LocalBuilder = checkAssignIL.DeclareLocal(GetType(System.Int32))
...
checkAssignIL.MarkSequencePoint(doc5, 553, 1, 553, 100)
Dim locbldr231 As LocalBuilder = checkAssignIL.DeclareLocal(GetType(System.Int32))
locbldr231.SetLocalSymInfo("assind")
...
ReDim Preserve typ99(UBound(typ99) + 1)
typ99(UBound(typ99)) = Typ
checkAssignIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("IsInstanceOfType", typ99))
...
Typ = GetType(System.Boolean)
Dim fa154 As System.Reflection.Emit.Label = checkAssignIL.DefineLabel()
Dim tru154 As System.Reflection.Emit.Label = checkAssignIL.DefineLabel()
Dim cont154 As System.Reflection.Emit.Label = checkAssignIL.DefineLabel()
checkAssignIL.Emit(OpCodes.Beq, tru154)
checkAssignIL.Emit(OpCodes.Br, fa154)
checkAssignIL.MarkLabel(tru154)
...
checkAssignIL.Emit(OpCodes.Br, cont154)
checkAssignIL.MarkLabel(fa154)
checkAssignIL.Emit(OpCodes.Br, cont154)
checkAssignIL.MarkLabel(cont154)
checkAssignIL.MarkSequencePoint(doc5, 570, 1, 570, 100)
checkAssignIL.Emit(OpCodes.Ldloc, 6)
Typ = GetType(System.Int32)
checkAssignIL.Emit(OpCodes.Ldloc, 7)
Typ = GetType(System.Int32)
Dim fa155 As System.Reflection.Emit.Label = checkAssignIL.DefineLabel()
Dim tru155 As System.Reflection.Emit.Label = checkAssignIL.DefineLabel()
Dim cont155 As System.Reflection.Emit.Label = checkAssignIL.DefineLabel()
checkAssignIL.Emit(OpCodes.Beq, tru155)
checkAssignIL.Emit(OpCodes.Br, fa155)
checkAssignIL.MarkLabel(tru155)
checkAssignIL.MarkSequencePoint(doc5, 571, 1, 571, 100)
checkAssignIL.Emit(OpCodes.Br, label11)
checkAssignIL.MarkSequencePoint(doc5, 572, 1, 572, 100)
checkAssignIL.Emit(OpCodes.Br, cont155)
checkAssignIL.MarkLabel(fa155)
...
checkAssignIL.Emit(OpCodes.Br, cont155)
checkAssignIL.MarkLabel(cont155)
...
checkAssignIL.Emit(OpCodes.Ldc_I4, CInt(0))
Typ = GetType(System.Int32)
Dim fa156 As System.Reflection.Emit.Label = checkAssignIL.DefineLabel()
Dim tru156 As System.Reflection.Emit.Label = checkAssignIL.DefineLabel()
Dim cont156 As System.Reflection.Emit.Label = checkAssignIL.DefineLabel()
checkAssignIL.Emit(OpCodes.Beq, fa156)
checkAssignIL.Emit(OpCodes.Br, tru156)
checkAssignIL.MarkLabel(tru156)
...
checkAssignIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("AddToken", typ100))
Typ = Typ03.GetMethod("AddToken", typ100).ReturnType
If Typ.ToString() = GetType(System.Void).ToString() Then
...
checkAssignIL.Emit(OpCodes.Ldloc, 7)
Typ = GetType(System.Int32)
Dim fa157 As System.Reflection.Emit.Label = checkAssignIL.DefineLabel()
Dim tru157 As System.Reflection.Emit.Label = checkAssignIL.DefineLabel()
Dim cont157 As System.Reflection.Emit.Label = checkAssignIL.DefineLabel()
checkAssignIL.Emit(OpCodes.Beq, tru157)
checkAssignIL.Emit(OpCodes.Br, fa157)
checkAssignIL.MarkLabel(tru157)
...
checkAssignIL.Emit(OpCodes.Br, cont157)
checkAssignIL.MarkLabel(fa157)
...
checkAssignIL.Emit(OpCodes.Br, cont157)
checkAssignIL.MarkLabel(cont157)
...
Typ = GetType(System.Int32)
checkAssignIL.Emit(OpCodes.Stloc, 6)
checkAssignIL.MarkSequencePoint(doc5, 602, 1, 602, 100)
checkAssignIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
checkAssignIL.Emit(OpCodes.Ldfld, GetType(Stmt).GetField("Tokens"))
Typ = GetType(Stmt).GetField("Tokens").FieldType
...
checkAssignIL.Emit(OpCodes.Sub)
checkAssignIL.Emit(OpCodes.Stloc, 7)
checkAssignIL.MarkSequencePoint(doc5, 604, 1, 604, 100)
...
ReDim Preserve typ101(UBound(typ101) + 1)
typ101(UBound(typ101)) = Typ
checkAssignIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("AddToken", typ101))
Typ = Typ03.GetMethod("AddToken", typ101).ReturnType
If Typ.ToString() = GetType(System.Void).ToString() Then
...
checkAssignIL.MarkSequencePoint(doc5, 621, 1, 621, 100)
Dim locbldr232 As LocalBuilder = checkAssignIL.DeclareLocal(asm.GetType("dylan.NET.Tokenizer.Parser.ExprOptimizer"))
locbldr232.SetLocalSymInfo("eop")
...
ReDim Preserve typ102(UBound(typ102) + 1)
typ102(UBound(typ102)) = Typ
checkAssignIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("Optimize", typ102))
...
checkAssignIL.Emit(OpCodes.Stloc, 2)
checkAssignIL.MarkSequencePoint(doc5, 633, 1, 633, 100)
checkAssignIL.Emit(OpCodes.Ldloc, 2)
Typ = GetType(AssignStmt)
checkAssignIL.MarkSequencePoint(doc5, 635, 1, 635, 100)
checkAssignIL.Emit(OpCodes.Br, cont156)
checkAssignIL.MarkLabel(fa156)
...
checkAssignIL.Emit(OpCodes.Br, cont156)
checkAssignIL.MarkLabel(cont156)
...
typ104(UBound(typ104)) = GetType(Stmt)
Dim Optimize As MethodBuilder = StmtOptimizer.DefineMethod("Optimize", MethodAttributes.Public, GetType(Stmt), typ104)
Dim OptimizeIL As ILGenerator = Optimize.GetILGenerator()
Dim Optimizeparam00 As ParameterBuilder = Optimize.DefineParameter(0, ParameterAttributes.RetVal, "")
...
ReDim Preserve typ105(UBound(typ105) + 1)
typ105(UBound(typ105)) = Typ
OptimizeIL.Emit(OpCodes.Call, GetType(Console).GetMethod("WriteLine", typ105))
Typ = GetType(Console).GetMethod("WriteLine", typ105).ReturnType
If Typ.ToString() = GetType(System.Void).ToString() Then
...
Dim locbldr233 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(System.Int32))
locbldr233.SetLocalSymInfo("i")
OptimizeIL.Emit(OpCodes.Ldc_I4, CInt(-1))
Typ = GetType(System.Int32)
OptimizeIL.Emit(OpCodes.Stloc, 0)
OptimizeIL.MarkSequencePoint(doc5, 648, 1, 648, 100)
Dim locbldr234 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(System.Int32))
...
Dim locbldr235 As LocalBuilder = OptimizeIL.DeclareLocal(asm.GetType("dylan.NET.Tokenizer.Parser.TokenOptimizer"))
locbldr235.SetLocalSymInfo("to")
OptimizeIL.Emit(OpCodes.Ldnull)
OptimizeIL.Emit(OpCodes.Stloc, 2)
OptimizeIL.MarkSequencePoint(doc5, 650, 1, 650, 100)
Dim locbldr236 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(Stmt))
locbldr236.SetLocalSymInfo("tmpstm")
OptimizeIL.Emit(OpCodes.Ldnull)
OptimizeIL.Emit(OpCodes.Stloc, 3)
OptimizeIL.MarkSequencePoint(doc5, 651, 1, 651, 100)
Dim locbldr237 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(System.Boolean))
locbldr237.SetLocalSymInfo("compb")
OptimizeIL.Emit(OpCodes.Ldc_I4, 0)
Typ = GetType(System.Boolean)
OptimizeIL.Emit(OpCodes.Stloc, 4)
...
ReDim Preserve typ106(UBound(typ106) + 1)
typ106(UBound(typ106)) = Typ
OptimizeIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("Optimize", typ106))
...
OptimizeIL.Emit(OpCodes.Br, label17)
OptimizeIL.MarkSequencePoint(doc5, 684, 1, 684, 100)
...
Dim locbldr238 As LocalBuilder = ParseIL.DeclareLocal(GetType(System.Int32))
...
Dim locbldr239 As LocalBuilder = ParseIL.DeclareLocal(asm.GetType("dylan.NET.Tokenizer.Parser.StmtOptimizer"))
locbldr239.SetLocalSymInfo("so")
ParseIL.Emit(OpCodes.Ldnull)
ParseIL.Emit(OpCodes.Stloc, 1)
ParseIL.MarkSequencePoint(doc6, 6, 1, 6, 100)
Dim locbldr240 As LocalBuilder = ParseIL.DeclareLocal(GetType(System.Int32))
...
ParseIL.Emit(OpCodes.Ldloc, 2)
Typ = GetType(System.Int32)
Dim fa177 As System.Reflection.Emit.Label = ParseIL.DefineLabel()
Dim tru177 As System.Reflection.Emit.Label = ParseIL.DefineLabel()
Dim cont177 As System.Reflection.Emit.Label = ParseIL.DefineLabel()
ParseIL.Emit(OpCodes.Beq, tru177)
ParseIL.Emit(OpCodes.Br, fa177)
ParseIL.MarkLabel(tru177)
ParseIL.MarkSequencePoint(doc6, 19, 1, 19, 100)
ParseIL.Emit(OpCodes.Br, label1)
ParseIL.MarkSequencePoint(doc6, 20, 1, 20, 100)
ParseIL.Emit(OpCodes.Br, cont177)
ParseIL.MarkLabel(fa177)
ParseIL.MarkSequencePoint(doc6, 21, 1, 21, 100)
ParseIL.Emit(OpCodes.Br, label0)
ParseIL.MarkSequencePoint(doc6, 22, 1, 22, 100)
ParseIL.Emit(OpCodes.Br, cont177)
ParseIL.MarkLabel(cont177)
