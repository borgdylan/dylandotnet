...
Dim locbldr88 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(NullLiteral))
locbldr88.SetLocalSymInfo("nulllit")
...
Dim locbldr89 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(BooleanLiteral))
locbldr89.SetLocalSymInfo("boolit")
...
Dim locbldr90 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(CharLiteral))
locbldr90.SetLocalSymInfo("chrlit")
...
OptimizeIL.Emit(OpCodes.Call, GetType(System.Convert).GetMethod("ToChar", typ106))
Typ = GetType(System.Convert).GetMethod("ToChar", typ106).ReturnType
...
OptimizeIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("Trim", typ107))
Typ = Typ03.GetMethod("Trim", typ107).ReturnType
OptimizeIL.Emit(OpCodes.Stloc, 2)
...
Dim typ108 As Type() = {Typ}
OptimizeIL.Emit(OpCodes.Call, GetType(System.Convert).GetMethod("ToChar", typ108))
Typ = GetType(System.Convert).GetMethod("ToChar", typ108).ReturnType
...
ReDim Preserve typ109(UBound(typ109) + 1)
typ109(UBound(typ109)) = Typ
OptimizeIL.Emit(OpCodes.Call, GetType(String).GetMethod("Concat", typ109))
Typ = GetType(String).GetMethod("Concat", typ109).ReturnType
OptimizeIL.Emit(OpCodes.Stloc, 2)
...
Dim locbldr91 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(StringLiteral))
locbldr91.SetLocalSymInfo("strlit")
...
OptimizeIL.Emit(OpCodes.Ldsfld, GetType(Utils.Constants).GetField("quot"))
Typ = GetType(Utils.Constants).GetField("quot").FieldType
Dim typ111 As Type() = {Typ}
OptimizeIL.Emit(OpCodes.Call, GetType(System.Convert).GetMethod("ToChar", typ111))
Typ = GetType(System.Convert).GetMethod("ToChar", typ111).ReturnType
OptimizeIL.Emit(OpCodes.Stelem, GetType(System.Char).MakeArrayType().GetElementType())
...
OptimizeIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("Trim", typ112))
Typ = Typ03.GetMethod("Trim", typ112).ReturnType
OptimizeIL.Emit(OpCodes.Stloc, 2)
...
Dim locbldr92 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(DoubleLiteral))
locbldr92.SetLocalSymInfo("dlit2")
...
OptimizeIL.Emit(OpCodes.Call, GetType(System.Convert).GetMethod("ToDouble", typ119))
Typ = GetType(System.Convert).GetMethod("ToDouble", typ119).ReturnType
...
Dim locbldr93 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(FloatLiteral))
locbldr93.SetLocalSymInfo("flit")
...
OptimizeIL.Emit(OpCodes.Call, GetType(System.Convert).GetMethod("ToSingle", typ126))
Typ = GetType(System.Convert).GetMethod("ToSingle", typ126).ReturnType
...
locbldr94.SetLocalSymInfo("dlit")
OptimizeIL.Emit(OpCodes.Newobj, GetType(DoubleLiteral).GetConstructor(Type.EmptyTypes))
...
OptimizeIL.Emit(OpCodes.Ldfld, GetType(DoubleLiteral).GetField("Value"))
Typ = GetType(DoubleLiteral).GetField("Value").FieldType
Dim typ130 As Type() = {Typ}
OptimizeIL.Emit(OpCodes.Call, GetType(System.Convert).GetMethod("ToDouble", typ130))
Typ = GetType(System.Convert).GetMethod("ToDouble", typ130).ReturnType
OptimizeIL.Emit(OpCodes.Stfld, GetType(DoubleLiteral).GetField("NumVal"))
...
OptimizeIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("EndsWith", typ134))
Typ = Typ03.GetMethod("EndsWith", typ134).ReturnType
OptimizeIL.Emit(OpCodes.Stloc, 1)
...
Dim locbldr95 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(DoubleLiteral))
locbldr95.SetLocalSymInfo("dlit3")
OptimizeIL.Emit(OpCodes.Newobj, GetType(DoubleLiteral).GetConstructor(Type.EmptyTypes))
...
OptimizeIL.Emit(OpCodes.Call, GetType(System.Convert).GetMethod("ToChar", typ135))
Typ = GetType(System.Convert).GetMethod("ToChar", typ135).ReturnType
OptimizeIL.Emit(OpCodes.Stelem, GetType(System.Char).MakeArrayType().GetElementType())
...
OptimizeIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("TrimEnd", typ136))
Typ = Typ03.GetMethod("TrimEnd", typ136).ReturnType
OptimizeIL.Emit(OpCodes.Stloc, 2)
...
OptimizeIL.Emit(OpCodes.Call, GetType(System.Convert).GetMethod("ToDouble", typ137))
Typ = GetType(System.Convert).GetMethod("ToDouble", typ137).ReturnType
OptimizeIL.Emit(OpCodes.Stfld, GetType(DoubleLiteral).GetField("NumVal"))
...
OptimizeIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("EndsWith", typ141))
Typ = Typ03.GetMethod("EndsWith", typ141).ReturnType
OptimizeIL.Emit(OpCodes.Stloc, 1)
...
Dim locbldr96 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(FloatLiteral))
locbldr96.SetLocalSymInfo("flit2")
OptimizeIL.Emit(OpCodes.Newobj, GetType(FloatLiteral).GetConstructor(Type.EmptyTypes))
...
OptimizeIL.Emit(OpCodes.Call, GetType(System.Convert).GetMethod("ToChar", typ142))
Typ = GetType(System.Convert).GetMethod("ToChar", typ142).ReturnType
OptimizeIL.Emit(OpCodes.Stelem, GetType(System.Char).MakeArrayType().GetElementType())
...
OptimizeIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("TrimEnd", typ143))
Typ = Typ03.GetMethod("TrimEnd", typ143).ReturnType
OptimizeIL.Emit(OpCodes.Stloc, 2)
...
OptimizeIL.Emit(OpCodes.Call, GetType(System.Convert).GetMethod("ToSingle", typ144))
...
OptimizeIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("EndsWith", typ148))
Typ = Typ03.GetMethod("EndsWith", typ148).ReturnType
OptimizeIL.Emit(OpCodes.Stloc, 1)
...
Dim locbldr97 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(UIntLiteral))
locbldr97.SetLocalSymInfo("uilit2")
...
OptimizeIL.Emit(OpCodes.Call, GetType(System.Convert).GetMethod("ToChar", typ149))
Typ = GetType(System.Convert).GetMethod("ToChar", typ149).ReturnType
OptimizeIL.Emit(OpCodes.Stelem, GetType(System.Char).MakeArrayType().GetElementType())
...
OptimizeIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("TrimEnd", typ150))
Typ = Typ03.GetMethod("TrimEnd", typ150).ReturnType
OptimizeIL.Emit(OpCodes.Stloc, 2)
...
OptimizeIL.Emit(OpCodes.Call, GetType(Convert).GetMethod("ToUInt32", typ153))
Typ = GetType(Convert).GetMethod("ToUInt32", typ153).ReturnType
...
Dim locbldr98 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(IntPtrLiteral))
locbldr98.SetLocalSymInfo("iplit2")
...
OptimizeIL.Emit(OpCodes.Call, GetType(System.Convert).GetMethod("ToInt32", typ163))
Typ = GetType(System.Convert).GetMethod("ToInt32", typ163).ReturnType
ReDim Preserve typ162(UBound(typ162) + 1)
typ162(UBound(typ162)) = Typ
OptimizeIL.Emit(OpCodes.Newobj, GetType(IntPtr).GetConstructor(typ162))
...
ReDim Preserve typ166(UBound(typ166) + 1)
typ166(UBound(typ166)) = Typ
OptimizeIL.Emit(OpCodes.Call, GetType(Utils.ParseUtils).GetMethod("LikeOP", typ166))
Typ = GetType(Utils.ParseUtils).GetMethod("LikeOP", typ166).ReturnType
OptimizeIL.Emit(OpCodes.Stloc, 1)
...
OptimizeIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("EndsWith", typ167))
Typ = Typ03.GetMethod("EndsWith", typ167).ReturnType
OptimizeIL.Emit(OpCodes.Stloc, 1)
...
Dim locbldr99 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(IntLiteral))
locbldr99.SetLocalSymInfo("ilit2")
...
Dim typ170 As Type() = {Typ}
OptimizeIL.Emit(OpCodes.Call, GetType(System.Convert).GetMethod("ToInt32", typ170))
Typ = GetType(System.Convert).GetMethod("ToInt32", typ170).ReturnType
...
OptimizeIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("EndsWith", typ174))
Typ = Typ03.GetMethod("EndsWith", typ174).ReturnType
OptimizeIL.Emit(OpCodes.Stloc, 1)
...
Dim locbldr100 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(ULongLiteral))
locbldr100.SetLocalSymInfo("ullit")
...
OptimizeIL.Emit(OpCodes.Call, GetType(System.Convert).GetMethod("ToChar", typ175))
Typ = GetType(System.Convert).GetMethod("ToChar", typ175).ReturnType
OptimizeIL.Emit(OpCodes.Stelem, GetType(System.Char).MakeArrayType().GetElementType())
...
OptimizeIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("TrimEnd", typ176))
Typ = Typ03.GetMethod("TrimEnd", typ176).ReturnType
OptimizeIL.Emit(OpCodes.Stloc, 2)
...
OptimizeIL.Emit(OpCodes.Call, GetType(Convert).GetMethod("ToUInt64", typ179))
Typ = GetType(Convert).GetMethod("ToUInt64", typ179).ReturnType
...
Dim locbldr101 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(LongLiteral))
locbldr101.SetLocalSymInfo("llit")
...
OptimizeIL.Emit(OpCodes.Call, GetType(System.Convert).GetMethod("ToInt64", typ186))
Typ = GetType(System.Convert).GetMethod("ToInt64", typ186).ReturnType
...
OptimizeIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("EndsWith", typ190))
Typ = Typ03.GetMethod("EndsWith", typ190).ReturnType
OptimizeIL.Emit(OpCodes.Stloc, 1)
...
Dim locbldr102 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(UShortLiteral))
locbldr102.SetLocalSymInfo("uslit")
...
OptimizeIL.Emit(OpCodes.Call, GetType(System.Convert).GetMethod("ToChar", typ191))
Typ = GetType(System.Convert).GetMethod("ToChar", typ191).ReturnType
OptimizeIL.Emit(OpCodes.Stelem, GetType(System.Char).MakeArrayType().GetElementType())
...
OptimizeIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("TrimEnd", typ192))
Typ = Typ03.GetMethod("TrimEnd", typ192).ReturnType
OptimizeIL.Emit(OpCodes.Stloc, 2)
...
OptimizeIL.Emit(OpCodes.Call, GetType(Convert).GetMethod("ToUInt16", typ195))
Typ = GetType(Convert).GetMethod("ToUInt16", typ195).ReturnType
...
Dim locbldr103 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(ShortLiteral))
locbldr103.SetLocalSymInfo("slit")
...
OptimizeIL.Emit(OpCodes.Call, GetType(System.Convert).GetMethod("ToInt16", typ202))
Typ = GetType(System.Convert).GetMethod("ToInt16", typ202).ReturnType
...
OptimizeIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("EndsWith", typ206))
Typ = Typ03.GetMethod("EndsWith", typ206).ReturnType
OptimizeIL.Emit(OpCodes.Stloc, 1)
...
Dim locbldr104 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(ByteLiteral))
locbldr104.SetLocalSymInfo("ublit")
...
OptimizeIL.Emit(OpCodes.Call, GetType(System.Convert).GetMethod("ToChar", typ207))
Typ = GetType(System.Convert).GetMethod("ToChar", typ207).ReturnType
OptimizeIL.Emit(OpCodes.Stelem, GetType(System.Char).MakeArrayType().GetElementType())
...
OptimizeIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("TrimEnd", typ208))
Typ = Typ03.GetMethod("TrimEnd", typ208).ReturnType
OptimizeIL.Emit(OpCodes.Stloc, 2)
...
OptimizeIL.Emit(OpCodes.Call, GetType(Convert).GetMethod("ToByte", typ211))
Typ = GetType(Convert).GetMethod("ToByte", typ211).ReturnType
...
Dim locbldr105 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(SByteLiteral))
locbldr105.SetLocalSymInfo("blit")
...
OptimizeIL.Emit(OpCodes.Call, GetType(System.Convert).GetMethod("ToSByte", typ218))
Typ = GetType(System.Convert).GetMethod("ToSByte", typ218).ReturnType
...
locbldr106.SetLocalSymInfo("ilit")
OptimizeIL.Emit(OpCodes.Newobj, GetType(IntLiteral).GetConstructor(Type.EmptyTypes))
...
OptimizeIL.Emit(OpCodes.Ldfld, GetType(IntLiteral).GetField("Value"))
Typ = GetType(IntLiteral).GetField("Value").FieldType
Dim typ222 As Type() = {Typ}
OptimizeIL.Emit(OpCodes.Call, GetType(System.Convert).GetMethod("ToInt32", typ222))
Typ = GetType(System.Convert).GetMethod("ToInt32", typ222).ReturnType
OptimizeIL.Emit(OpCodes.Stfld, GetType(IntLiteral).GetField("NumVal"))
...
Dim locbldr107 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(Ident))
locbldr107.SetLocalSymInfo("idt")
...
Dim locbldr108 As LocalBuilder = checkVarAsIL.DeclareLocal(GetType(Token))
...
Dim locbldr109 As LocalBuilder = checkVarAsIL.DeclareLocal(GetType(System.Type))
...
Dim locbldr110 As LocalBuilder = checkVarAsIL.DeclareLocal(GetType(VarExpr))
locbldr110.SetLocalSymInfo("vars")
...
checkVarAsIL.Emit(OpCodes.Beq, tru107)
checkVarAsIL.Emit(OpCodes.Br, fa107)
...
Dim locbldr111 As LocalBuilder = checkVarAsIL.DeclareLocal(GetType(Token))
locbldr111.SetLocalSymInfo("tok2")
checkVarAsIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Expr)
checkVarAsIL.Emit(OpCodes.Ldfld, GetType(Expr).GetField("Tokens"))
Typ = GetType(Expr).GetField("Tokens").FieldType
...
Dim locbldr112 As LocalBuilder = checkVarAsIL.DeclareLocal(GetType(System.Type))
locbldr112.SetLocalSymInfo("typ2")
...
Dim locbldr113 As LocalBuilder = checkVarAsIL.DeclareLocal(GetType(System.Boolean))
locbldr113.SetLocalSymInfo("b2")
Dim typ4(-1) As Type
...
checkVarAsIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa108 As System.Reflection.Emit.Label = checkVarAsIL.DefineLabel()
Dim tru108 As System.Reflection.Emit.Label = checkVarAsIL.DefineLabel()
Dim cont108 As System.Reflection.Emit.Label = checkVarAsIL.DefineLabel()
checkVarAsIL.Emit(OpCodes.Beq, fa108)
checkVarAsIL.Emit(OpCodes.Br, tru108)
checkVarAsIL.MarkLabel(tru108)
checkVarAsIL.MarkSequencePoint(doc4, 27, 1, 27, 100)
Dim locbldr114 As LocalBuilder = checkVarAsIL.DeclareLocal(GetType(Token))
locbldr114.SetLocalSymInfo("t")
checkVarAsIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Expr)
checkVarAsIL.Emit(OpCodes.Ldfld, GetType(Expr).GetField("Tokens"))
Typ = GetType(Expr).GetField("Tokens").FieldType
...
Dim locbldr115 As LocalBuilder = checkVarAsIL.DeclareLocal(GetType(TypeTok))
locbldr115.SetLocalSymInfo("tt")
...
checkVarAsIL.Emit(OpCodes.Br, cont108)
checkVarAsIL.MarkLabel(fa108)
...
checkVarAsIL.Emit(OpCodes.Br, cont108)
checkVarAsIL.MarkLabel(cont108)
...
Dim locbldr116 As LocalBuilder = procMethodCallIL.DeclareLocal(GetType(MethodNameTok))
locbldr116.SetLocalSymInfo("mn")
...
Dim locbldr117 As LocalBuilder = procMethodCallIL.DeclareLocal(GetType(MethodCallTok))
locbldr117.SetLocalSymInfo("mct")
...
Dim locbldr118 As LocalBuilder = procMethodCallIL.DeclareLocal(GetType(Ident))
locbldr118.SetLocalSymInfo("idt")
...
Dim locbldr119 As LocalBuilder = procMethodCallIL.DeclareLocal(GetType(Expr))
locbldr119.SetLocalSymInfo("ep2")
...
Dim locbldr120 As LocalBuilder = procMethodCallIL.DeclareLocal(GetType(System.Int32))
locbldr120.SetLocalSymInfo("lvl")
...
Dim locbldr123 As LocalBuilder = procMethodCallIL.DeclareLocal(GetType(Token))
locbldr123.SetLocalSymInfo("tok2")
procMethodCallIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Expr)
procMethodCallIL.Emit(OpCodes.Ldfld, GetType(Expr).GetField("Tokens"))
Typ = GetType(Expr).GetField("Tokens").FieldType
...
Dim locbldr124 As LocalBuilder = procMethodCallIL.DeclareLocal(GetType(System.Type))
locbldr124.SetLocalSymInfo("typ2")
...
procMethodCallIL.Emit(OpCodes.Bgt, tru111)
...
Dim locbldr127 As LocalBuilder = procIdentArrayAccessIL.DeclareLocal(GetType(Ident))
locbldr127.SetLocalSymInfo("idt")
...
Dim locbldr128 As LocalBuilder = procIdentArrayAccessIL.DeclareLocal(GetType(Expr))
locbldr128.SetLocalSymInfo("ep2")
...
Dim locbldr129 As LocalBuilder = procIdentArrayAccessIL.DeclareLocal(GetType(System.Int32))
locbldr129.SetLocalSymInfo("lvl")
...
Dim locbldr132 As LocalBuilder = procIdentArrayAccessIL.DeclareLocal(GetType(Token))
locbldr132.SetLocalSymInfo("tok2")
procIdentArrayAccessIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Expr)
procIdentArrayAccessIL.Emit(OpCodes.Ldfld, GetType(Expr).GetField("Tokens"))
Typ = GetType(Expr).GetField("Tokens").FieldType
...
Dim locbldr133 As LocalBuilder = procIdentArrayAccessIL.DeclareLocal(GetType(System.Type))
locbldr133.SetLocalSymInfo("typ2")
procIdentArrayAccessIL.MarkSequencePoint(doc4, 189, 1, 189, 100)
Dim locbldr134 As LocalBuilder = procIdentArrayAccessIL.DeclareLocal(GetType(System.Boolean))
locbldr134.SetLocalSymInfo("b2")
procIdentArrayAccessIL.MarkSequencePoint(doc4, 190, 1, 190, 100)
Dim locbldr135 As LocalBuilder = procIdentArrayAccessIL.DeclareLocal(GetType(System.Int32))
locbldr135.SetLocalSymInfo("len")
procIdentArrayAccessIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Expr)
procIdentArrayAccessIL.Emit(OpCodes.Ldfld, GetType(Expr).GetField("Tokens"))
Typ = GetType(Expr).GetField("Tokens").FieldType
...
Typ = GetType(System.Int32)
Dim fa123 As System.Reflection.Emit.Label = procIdentArrayAccessIL.DefineLabel()
Dim tru123 As System.Reflection.Emit.Label = procIdentArrayAccessIL.DefineLabel()
Dim cont123 As System.Reflection.Emit.Label = procIdentArrayAccessIL.DefineLabel()
procIdentArrayAccessIL.Emit(OpCodes.Beq, tru123)
procIdentArrayAccessIL.Emit(OpCodes.Br, fa123)
procIdentArrayAccessIL.MarkLabel(tru123)
procIdentArrayAccessIL.MarkSequencePoint(doc4, 252, 1, 252, 100)
procIdentArrayAccessIL.Emit(OpCodes.Br, label4)
procIdentArrayAccessIL.MarkSequencePoint(doc4, 253, 1, 253, 100)
procIdentArrayAccessIL.Emit(OpCodes.Br, cont123)
procIdentArrayAccessIL.MarkLabel(fa123)
...
procIdentArrayAccessIL.Emit(OpCodes.Br, cont123)
procIdentArrayAccessIL.MarkLabel(cont123)
...
Dim locbldr136 As LocalBuilder = procMtdArrayAccessIL.DeclareLocal(GetType(MethodCallTok))
locbldr136.SetLocalSymInfo("mtd")
...
Dim locbldr137 As LocalBuilder = procMtdArrayAccessIL.DeclareLocal(GetType(MethodNameTok))
locbldr137.SetLocalSymInfo("idt")
procMtdArrayAccessIL.Emit(OpCodes.Ldnull)
procMtdArrayAccessIL.Emit(OpCodes.Stloc, 1)
procMtdArrayAccessIL.MarkSequencePoint(doc4, 271, 1, 271, 100)
Dim locbldr138 As LocalBuilder = procMtdArrayAccessIL.DeclareLocal(GetType(Expr))
locbldr138.SetLocalSymInfo("ep2")
...
Dim locbldr139 As LocalBuilder = procMtdArrayAccessIL.DeclareLocal(GetType(System.Int32))
locbldr139.SetLocalSymInfo("lvl")
...
Dim locbldr142 As LocalBuilder = procMtdArrayAccessIL.DeclareLocal(GetType(Token))
locbldr142.SetLocalSymInfo("tok2")
procMtdArrayAccessIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Expr)
procMtdArrayAccessIL.Emit(OpCodes.Ldfld, GetType(Expr).GetField("Tokens"))
Typ = GetType(Expr).GetField("Tokens").FieldType
...
Dim locbldr143 As LocalBuilder = procMtdArrayAccessIL.DeclareLocal(GetType(System.Type))
locbldr143.SetLocalSymInfo("typ2")
procMtdArrayAccessIL.MarkSequencePoint(doc4, 284, 1, 284, 100)
Dim locbldr144 As LocalBuilder = procMtdArrayAccessIL.DeclareLocal(GetType(System.Boolean))
locbldr144.SetLocalSymInfo("b2")
procMtdArrayAccessIL.MarkSequencePoint(doc4, 285, 1, 285, 100)
Dim locbldr145 As LocalBuilder = procMtdArrayAccessIL.DeclareLocal(GetType(System.Int32))
...
Typ = GetType(System.Int32)
Dim fa129 As System.Reflection.Emit.Label = procMtdArrayAccessIL.DefineLabel()
Dim tru129 As System.Reflection.Emit.Label = procMtdArrayAccessIL.DefineLabel()
Dim cont129 As System.Reflection.Emit.Label = procMtdArrayAccessIL.DefineLabel()
procMtdArrayAccessIL.Emit(OpCodes.Beq, tru129)
procMtdArrayAccessIL.Emit(OpCodes.Br, fa129)
procMtdArrayAccessIL.MarkLabel(tru129)
procMtdArrayAccessIL.MarkSequencePoint(doc4, 347, 1, 347, 100)
procMtdArrayAccessIL.Emit(OpCodes.Br, label7)
procMtdArrayAccessIL.MarkSequencePoint(doc4, 348, 1, 348, 100)
procMtdArrayAccessIL.Emit(OpCodes.Br, cont129)
procMtdArrayAccessIL.MarkLabel(fa129)
...
procMtdArrayAccessIL.Emit(OpCodes.Br, cont129)
procMtdArrayAccessIL.MarkLabel(cont129)
...
locbldr146.SetLocalSymInfo("len")
OptimizeIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Expr)
...
Dim locbldr148 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(System.Int32))
...
locbldr149.SetLocalSymInfo("identtrnoff")
OptimizeIL.Emit(OpCodes.Ldc_I4, 0)
Typ = GetType(System.Boolean)
OptimizeIL.Emit(OpCodes.Stloc, 3)
...
locbldr150.SetLocalSymInfo("mcbool")
OptimizeIL.Emit(OpCodes.Ldc_I4, 0)
Typ = GetType(System.Boolean)
OptimizeIL.Emit(OpCodes.Stloc, 4)
...
locbldr151.SetLocalSymInfo("mcflgc")
OptimizeIL.Emit(OpCodes.Ldc_I4, 0)
Typ = GetType(System.Boolean)
OptimizeIL.Emit(OpCodes.Stloc, 5)
...
locbldr152.SetLocalSymInfo("iflgc")
OptimizeIL.Emit(OpCodes.Ldc_I4, 0)
Typ = GetType(System.Boolean)
OptimizeIL.Emit(OpCodes.Stloc, 6)
OptimizeIL.MarkSequencePoint(doc4, 372, 1, 372, 100)
Dim locbldr153 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(System.Boolean))
locbldr153.SetLocalSymInfo("sflgc")
OptimizeIL.Emit(OpCodes.Ldc_I4, 0)
Typ = GetType(System.Boolean)
OptimizeIL.Emit(OpCodes.Stloc, 7)
OptimizeIL.MarkSequencePoint(doc4, 373, 1, 373, 100)
Dim locbldr154 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(Token))
locbldr154.SetLocalSymInfo("mctok")
OptimizeIL.Emit(OpCodes.Ldnull)
OptimizeIL.Emit(OpCodes.Stloc, 8)
OptimizeIL.MarkSequencePoint(doc4, 374, 1, 374, 100)
Dim locbldr155 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(Token))
locbldr155.SetLocalSymInfo("mctok2")
OptimizeIL.Emit(OpCodes.Ldnull)
OptimizeIL.Emit(OpCodes.Stloc, 9)
OptimizeIL.MarkSequencePoint(doc4, 375, 1, 375, 100)
Dim locbldr156 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(Ident))
locbldr156.SetLocalSymInfo("mcident")
OptimizeIL.Emit(OpCodes.Ldnull)
OptimizeIL.Emit(OpCodes.Stloc, 10)
OptimizeIL.MarkSequencePoint(doc4, 376, 1, 376, 100)
Dim locbldr157 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(MethodCallTok))
locbldr157.SetLocalSymInfo("mcmetcall")
OptimizeIL.Emit(OpCodes.Ldnull)
OptimizeIL.Emit(OpCodes.Stloc, 11)
OptimizeIL.MarkSequencePoint(doc4, 377, 1, 377, 100)
Dim locbldr158 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(MethodNameTok))
locbldr158.SetLocalSymInfo("mcmetname")
OptimizeIL.Emit(OpCodes.Ldnull)
OptimizeIL.Emit(OpCodes.Stloc, 12)
OptimizeIL.MarkSequencePoint(doc4, 378, 1, 378, 100)
Dim locbldr159 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(StringLiteral))
locbldr159.SetLocalSymInfo("mcstr")
OptimizeIL.Emit(OpCodes.Ldnull)
OptimizeIL.Emit(OpCodes.Stloc, 13)
...
locbldr160.SetLocalSymInfo("mcint")
OptimizeIL.Emit(OpCodes.Ldc_I4, CInt(0))
Typ = GetType(System.Int32)
OptimizeIL.Emit(OpCodes.Stloc, 14)
...
OptimizeIL.Emit(OpCodes.Blt, tru130)
...
Dim locbldr162 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(System.Type))
...
locbldr163.SetLocalSymInfo("b")
OptimizeIL.MarkSequencePoint(doc4, 401, 1, 401, 100)
Dim locbldr164 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(System.String))
locbldr164.SetLocalSymInfo("str")
...
OptimizeIL.Emit(OpCodes.Beq, fa133)
OptimizeIL.Emit(OpCodes.Br, tru133)
OptimizeIL.MarkLabel(tru133)
OptimizeIL.MarkSequencePoint(doc4, 415, 1, 415, 100)
Dim locbldr165 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(Token))
locbldr165.SetLocalSymInfo("tk")
OptimizeIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Expr)
OptimizeIL.Emit(OpCodes.Ldfld, GetType(Expr).GetField("Tokens"))
Typ = GetType(Expr).GetField("Tokens").FieldType
...
Dim locbldr166 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(TypeTok))
locbldr166.SetLocalSymInfo("ttk")
...
OptimizeIL.Emit(OpCodes.Beq, tru134)
OptimizeIL.Emit(OpCodes.Br, fa134)
...
OptimizeIL.Emit(OpCodes.Beq, fa135)
OptimizeIL.Emit(OpCodes.Br, tru135)
OptimizeIL.MarkLabel(tru135)
OptimizeIL.MarkSequencePoint(doc4, 440, 1, 440, 100)
Dim locbldr167 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(Token))
locbldr167.SetLocalSymInfo("tk2")
OptimizeIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Expr)
OptimizeIL.Emit(OpCodes.Ldfld, GetType(Expr).GetField("Tokens"))
Typ = GetType(Expr).GetField("Tokens").FieldType
...
locbldr168.SetLocalSymInfo("ttk2")
OptimizeIL.Emit(OpCodes.Newobj, GetType(TypeTok).GetConstructor(Type.EmptyTypes))
OptimizeIL.Emit(OpCodes.Stloc, 22)
...
OptimizeIL.Emit(OpCodes.Beq, fa138)
OptimizeIL.Emit(OpCodes.Br, tru138)
...
OptimizeIL.Emit(OpCodes.Beq, fa140)
OptimizeIL.Emit(OpCodes.Br, tru140)
OptimizeIL.MarkLabel(tru140)
OptimizeIL.MarkSequencePoint(doc4, 479, 1, 479, 100)
Dim locbldr169 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(TypeTok))
locbldr169.SetLocalSymInfo("tt1")
OptimizeIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Expr)
OptimizeIL.Emit(OpCodes.Ldfld, GetType(Expr).GetField("Tokens"))
Typ = GetType(Expr).GetField("Tokens").FieldType
...
Dim locbldr170 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(Ident))
locbldr170.SetLocalSymInfo("id1")
OptimizeIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Expr)
OptimizeIL.Emit(OpCodes.Ldfld, GetType(Expr).GetField("Tokens"))
Typ = GetType(Expr).GetField("Tokens").FieldType
...
Dim locbldr171 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(CharLiteral))
locbldr171.SetLocalSymInfo("cl1")
OptimizeIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Expr)
OptimizeIL.Emit(OpCodes.Ldfld, GetType(Expr).GetField("Tokens"))
Typ = GetType(Expr).GetField("Tokens").FieldType
...
Dim locbldr172 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(NullLiteral))
locbldr172.SetLocalSymInfo("nul1")
OptimizeIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Expr)
OptimizeIL.Emit(OpCodes.Ldfld, GetType(Expr).GetField("Tokens"))
Typ = GetType(Expr).GetField("Tokens").FieldType
...
OptimizeIL.Emit(OpCodes.Call, asm.GetType("dylan.NET.Tokenizer.Parser.ParserFlags").GetMethod("UpdateNullLit", typ70))
Typ = asm.GetType("dylan.NET.Tokenizer.Parser.ParserFlags").GetMethod("UpdateNullLit", typ70).ReturnType
Typ = Typ02
OptimizeIL.Emit(OpCodes.Stelem, Typ.GetElementType())
...
Dim locbldr173 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(StringLiteral))
locbldr173.SetLocalSymInfo("sl1")
OptimizeIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Expr)
OptimizeIL.Emit(OpCodes.Ldfld, GetType(Expr).GetField("Tokens"))
Typ = GetType(Expr).GetField("Tokens").FieldType
...
ReDim Preserve typ73(UBound(typ73) + 1)
typ73(UBound(typ73)) = Typ
OptimizeIL.Emit(OpCodes.Call, asm.GetType("dylan.NET.Tokenizer.Parser.ParserFlags").GetMethod("UpdateStringLit", typ73))
Typ = asm.GetType("dylan.NET.Tokenizer.Parser.ParserFlags").GetMethod("UpdateStringLit", typ73).ReturnType
Typ = Typ02
OptimizeIL.Emit(OpCodes.Stelem, Typ.GetElementType())
...
Dim locbldr174 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(BooleanLiteral))
locbldr174.SetLocalSymInfo("bl1")
OptimizeIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Expr)
OptimizeIL.Emit(OpCodes.Ldfld, GetType(Expr).GetField("Tokens"))
Typ = GetType(Expr).GetField("Tokens").FieldType
...
OptimizeIL.Emit(OpCodes.Call, asm.GetType("dylan.NET.Tokenizer.Parser.ParserFlags").GetMethod("UpdateBoolLit", typ76))
Typ = asm.GetType("dylan.NET.Tokenizer.Parser.ParserFlags").GetMethod("UpdateBoolLit", typ76).ReturnType
Typ = Typ02
OptimizeIL.Emit(OpCodes.Stelem, Typ.GetElementType())
...
Dim locbldr175 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(NumberLiteral))
locbldr175.SetLocalSymInfo("nl1")
OptimizeIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Expr)
OptimizeIL.Emit(OpCodes.Ldfld, GetType(Expr).GetField("Tokens"))
Typ = GetType(Expr).GetField("Tokens").FieldType
...
ReDim Preserve typ79(UBound(typ79) + 1)
typ79(UBound(typ79)) = Typ
OptimizeIL.Emit(OpCodes.Call, asm.GetType("dylan.NET.Tokenizer.Parser.ParserFlags").GetMethod("UpdateNumLit", typ79))
Typ = asm.GetType("dylan.NET.Tokenizer.Parser.ParserFlags").GetMethod("UpdateNumLit", typ79).ReturnType
Typ = Typ02
OptimizeIL.Emit(OpCodes.Stelem, Typ.GetElementType())
...
ReDim Preserve typ81(UBound(typ81) + 1)
typ81(UBound(typ81)) = Typ
OptimizeIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("IsInstanceOfType", typ81))
...
Dim locbldr176 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(MethodCallTok))
locbldr176.SetLocalSymInfo("mct")
OptimizeIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Expr)
OptimizeIL.Emit(OpCodes.Ldfld, GetType(Expr).GetField("Tokens"))
Typ = GetType(Expr).GetField("Tokens").FieldType
...
Dim locbldr177 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(Expr).MakeArrayType())
locbldr177.SetLocalSymInfo("prs")
OptimizeIL.Emit(OpCodes.Ldloc, 30)
Typ = GetType(MethodCallTok)
...
locbldr178.SetLocalSymInfo("ln2")
OptimizeIL.Emit(OpCodes.Ldloc, 31)
...
Dim locbldr179 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(System.Int32))
locbldr179.SetLocalSymInfo("i2")
OptimizeIL.Emit(OpCodes.Ldc_I4, CInt(-1))
Typ = GetType(System.Int32)
OptimizeIL.Emit(OpCodes.Stloc, 33)
...
OptimizeIL.Emit(OpCodes.Blt, tru157)
...
ReDim Preserve typ85(UBound(typ85) + 1)
typ85(UBound(typ85)) = Typ
OptimizeIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("IsInstanceOfType", typ85))
...
Dim locbldr180 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(Ident))
locbldr180.SetLocalSymInfo("aidt")
OptimizeIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Expr)
OptimizeIL.Emit(OpCodes.Ldfld, GetType(Expr).GetField("Tokens"))
Typ = GetType(Expr).GetField("Tokens").FieldType
...
Dim locbldr181 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(Expr))
locbldr181.SetLocalSymInfo("arriloc")
OptimizeIL.Emit(OpCodes.Ldloc, 34)
Typ = GetType(Ident)
...
Dim locbldr182 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(MethodCallTok))
locbldr182.SetLocalSymInfo("amtd")
OptimizeIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Expr)
OptimizeIL.Emit(OpCodes.Ldfld, GetType(Expr).GetField("Tokens"))
Typ = GetType(Expr).GetField("Tokens").FieldType
...
Dim locbldr183 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(MethodNameTok))
locbldr183.SetLocalSymInfo("amtdn")
OptimizeIL.Emit(OpCodes.Ldloc, 36)
Typ = GetType(MethodCallTok)
...
OptimizeIL.MarkSequencePoint(doc4, 675, 1, 675, 100)
OptimizeIL.Emit(OpCodes.Br, label11)
...
OptimizeIL.Emit(OpCodes.Bgt, tru162)
...
OptimizeIL.Emit(OpCodes.Bge, tru163)
...
ReDim Preserve typ91(UBound(typ91) + 1)
typ91(UBound(typ91)) = Typ
OptimizeIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("IsInstanceOfType", typ91))
...
OptimizeIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("RemToken", typ92))
Typ = Typ03.GetMethod("RemToken", typ92).ReturnType
If Typ.ToString() = GetType(System.Void).ToString() Then
...
ReDim Preserve typ93(UBound(typ93) + 1)
typ93(UBound(typ93)) = Typ
OptimizeIL.Emit(OpCodes.Call, GetType(ParseUtils).GetMethod("LikeOP", typ93))
Typ = GetType(ParseUtils).GetMethod("LikeOP", typ93).ReturnType
OptimizeIL.Emit(OpCodes.Stloc, 17)
...
ReDim Preserve typ97(UBound(typ97) + 1)
typ97(UBound(typ97)) = Typ
OptimizeIL.Emit(OpCodes.Call, GetType(ParseUtils).GetMethod("LikeOP", typ97))
Typ = GetType(ParseUtils).GetMethod("LikeOP", typ97).ReturnType
OptimizeIL.Emit(OpCodes.Stloc, 17)
...
ReDim Preserve typ99(UBound(typ99) + 1)
typ99(UBound(typ99)) = Typ
OptimizeIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("IsInstanceOfType", typ99))
...
OptimizeIL.MarkSequencePoint(doc4, 771, 1, 771, 100)
Dim typ100(-1) As Type
OptimizeIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Expr)
Typ03 = Typ
...
ReDim Preserve typ100(UBound(typ100) + 1)
typ100(UBound(typ100)) = Typ
OptimizeIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("RemToken", typ100))
Typ = Typ03.GetMethod("RemToken", typ100).ReturnType
If Typ.ToString() = GetType(System.Void).ToString() Then
...
OptimizeIL.Emit(OpCodes.Ble, tru172)
...
OptimizeIL.MarkSequencePoint(doc4, 787, 1, 787, 100)
...
Typ = GetType(System.Boolean)
OptimizeIL.Emit(OpCodes.Stsfld, asm.GetType("dylan.NET.Tokenizer.Parser.ParserFlags").GetField("StringFlag"))
OptimizeIL.MarkSequencePoint(doc4, 799, 1, 799, 100)
OptimizeIL.Emit(OpCodes.Br, label9)
...
OptimizeIL.MarkSequencePoint(doc4, 806, 1, 806, 100)
OptimizeIL.Emit(OpCodes.Ldc_I4, 0)
Typ = GetType(System.Boolean)
OptimizeIL.Emit(OpCodes.Stsfld, asm.GetType("dylan.NET.Tokenizer.Parser.ParserFlags").GetField("MetCallFlag"))
...
Dim locbldr184 As LocalBuilder = checkRefasmIL.DeclareLocal(GetType(Token))
locbldr184.SetLocalSymInfo("tok")
...
Dim locbldr185 As LocalBuilder = checkRefasmIL.DeclareLocal(GetType(System.Type))
...
Dim locbldr186 As LocalBuilder = checkRefasmIL.DeclareLocal(GetType(RefasmStmt))
locbldr186.SetLocalSymInfo("refasms")
...
Typ = GetType(System.Boolean)
Dim fa175 As System.Reflection.Emit.Label = checkRefasmIL.DefineLabel()
Dim tru175 As System.Reflection.Emit.Label = checkRefasmIL.DefineLabel()
Dim cont175 As System.Reflection.Emit.Label = checkRefasmIL.DefineLabel()
checkRefasmIL.Emit(OpCodes.Beq, tru175)
checkRefasmIL.Emit(OpCodes.Br, fa175)
checkRefasmIL.MarkLabel(tru175)
...
checkRefasmIL.Emit(OpCodes.Br, cont175)
checkRefasmIL.MarkLabel(fa175)
checkRefasmIL.Emit(OpCodes.Br, cont175)
checkRefasmIL.MarkLabel(cont175)
...
Dim locbldr187 As LocalBuilder = checkDebugIL.DeclareLocal(GetType(Token))
locbldr187.SetLocalSymInfo("tok")
...
Dim locbldr188 As LocalBuilder = checkDebugIL.DeclareLocal(GetType(System.Type))
locbldr188.SetLocalSymInfo("typ")
...
Dim locbldr189 As LocalBuilder = checkDebugIL.DeclareLocal(GetType(DebugStmt))
locbldr189.SetLocalSymInfo("dbgs")
...
Typ = GetType(System.Boolean)
Dim fa176 As System.Reflection.Emit.Label = checkDebugIL.DefineLabel()
Dim tru176 As System.Reflection.Emit.Label = checkDebugIL.DefineLabel()
Dim cont176 As System.Reflection.Emit.Label = checkDebugIL.DefineLabel()
checkDebugIL.Emit(OpCodes.Beq, tru176)
checkDebugIL.Emit(OpCodes.Br, fa176)
checkDebugIL.MarkLabel(tru176)
...
checkDebugIL.Emit(OpCodes.Br, cont176)
checkDebugIL.MarkLabel(fa176)
checkDebugIL.Emit(OpCodes.Br, cont176)
checkDebugIL.MarkLabel(cont176)
...
Dim locbldr190 As LocalBuilder = checkImportIL.DeclareLocal(GetType(Token))
...
Dim locbldr191 As LocalBuilder = checkImportIL.DeclareLocal(GetType(System.Type))
...
Dim locbldr192 As LocalBuilder = checkImportIL.DeclareLocal(GetType(ImportStmt))
locbldr192.SetLocalSymInfo("imps")
...
Typ = GetType(System.Boolean)
Dim fa177 As System.Reflection.Emit.Label = checkImportIL.DefineLabel()
Dim tru177 As System.Reflection.Emit.Label = checkImportIL.DefineLabel()
Dim cont177 As System.Reflection.Emit.Label = checkImportIL.DefineLabel()
checkImportIL.Emit(OpCodes.Beq, tru177)
checkImportIL.Emit(OpCodes.Br, fa177)
checkImportIL.MarkLabel(tru177)
...
checkImportIL.Emit(OpCodes.Br, cont177)
checkImportIL.MarkLabel(fa177)
checkImportIL.Emit(OpCodes.Br, cont177)
checkImportIL.MarkLabel(cont177)
...
Dim locbldr193 As LocalBuilder = checkLocimportIL.DeclareLocal(GetType(Token))
locbldr193.SetLocalSymInfo("tok")
...
Dim locbldr194 As LocalBuilder = checkLocimportIL.DeclareLocal(GetType(System.Type))
...
Dim locbldr195 As LocalBuilder = checkLocimportIL.DeclareLocal(GetType(LocimportStmt))
locbldr195.SetLocalSymInfo("limps")
...
Typ = GetType(System.Boolean)
Dim fa178 As System.Reflection.Emit.Label = checkLocimportIL.DefineLabel()
Dim tru178 As System.Reflection.Emit.Label = checkLocimportIL.DefineLabel()
Dim cont178 As System.Reflection.Emit.Label = checkLocimportIL.DefineLabel()
checkLocimportIL.Emit(OpCodes.Beq, tru178)
checkLocimportIL.Emit(OpCodes.Br, fa178)
checkLocimportIL.MarkLabel(tru178)
...
checkLocimportIL.Emit(OpCodes.Br, cont178)
checkLocimportIL.MarkLabel(fa178)
checkLocimportIL.Emit(OpCodes.Br, cont178)
checkLocimportIL.MarkLabel(cont178)
...
Dim locbldr196 As LocalBuilder = checkCmtIL.DeclareLocal(GetType(Token))
locbldr196.SetLocalSymInfo("tok")
...
Dim locbldr197 As LocalBuilder = checkCmtIL.DeclareLocal(GetType(System.Type))
...
Dim locbldr198 As LocalBuilder = checkCmtIL.DeclareLocal(GetType(CommentStmt))
locbldr198.SetLocalSymInfo("cmts")
...
Typ = GetType(System.Boolean)
Dim fa179 As System.Reflection.Emit.Label = checkCmtIL.DefineLabel()
Dim tru179 As System.Reflection.Emit.Label = checkCmtIL.DefineLabel()
Dim cont179 As System.Reflection.Emit.Label = checkCmtIL.DefineLabel()
checkCmtIL.Emit(OpCodes.Beq, tru179)
checkCmtIL.Emit(OpCodes.Br, fa179)
checkCmtIL.MarkLabel(tru179)
...
checkCmtIL.Emit(OpCodes.Br, cont179)
checkCmtIL.MarkLabel(fa179)
checkCmtIL.Emit(OpCodes.Br, cont179)
checkCmtIL.MarkLabel(cont179)
...
Typ = GetType(System.Int32)
Dim fa180 As System.Reflection.Emit.Label = checkEndMtdIL.DefineLabel()
Dim tru180 As System.Reflection.Emit.Label = checkEndMtdIL.DefineLabel()
Dim cont180 As System.Reflection.Emit.Label = checkEndMtdIL.DefineLabel()
checkEndMtdIL.Emit(OpCodes.Bge, tru180)
checkEndMtdIL.Emit(OpCodes.Br, fa180)
checkEndMtdIL.MarkLabel(tru180)
checkEndMtdIL.MarkSequencePoint(doc5, 80, 1, 80, 100)
Dim locbldr199 As LocalBuilder = checkEndMtdIL.DeclareLocal(GetType(Token))
locbldr199.SetLocalSymInfo("tok1")
checkEndMtdIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
checkEndMtdIL.Emit(OpCodes.Ldfld, GetType(Stmt).GetField("Tokens"))
Typ = GetType(Stmt).GetField("Tokens").FieldType
...
Dim locbldr200 As LocalBuilder = checkEndMtdIL.DeclareLocal(GetType(System.Type))
locbldr200.SetLocalSymInfo("typ1")
...
Dim locbldr201 As LocalBuilder = checkEndMtdIL.DeclareLocal(GetType(System.Boolean))
locbldr201.SetLocalSymInfo("b1")
Dim typ18(-1) As Type
...
Dim locbldr202 As LocalBuilder = checkEndMtdIL.DeclareLocal(GetType(Token))
locbldr202.SetLocalSymInfo("tok2")
checkEndMtdIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
checkEndMtdIL.Emit(OpCodes.Ldfld, GetType(Stmt).GetField("Tokens"))
Typ = GetType(Stmt).GetField("Tokens").FieldType
...
Dim locbldr203 As LocalBuilder = checkEndMtdIL.DeclareLocal(GetType(System.Type))
locbldr203.SetLocalSymInfo("typ2")
...
Dim locbldr204 As LocalBuilder = checkEndMtdIL.DeclareLocal(GetType(System.Boolean))
locbldr204.SetLocalSymInfo("b2")
Dim typ20(-1) As Type
...
Dim locbldr205 As LocalBuilder = checkEndMtdIL.DeclareLocal(GetType(EndMethodStmt))
locbldr205.SetLocalSymInfo("ems")
...
Typ = GetType(System.Boolean)
Dim fa181 As System.Reflection.Emit.Label = checkEndMtdIL.DefineLabel()
Dim tru181 As System.Reflection.Emit.Label = checkEndMtdIL.DefineLabel()
Dim cont181 As System.Reflection.Emit.Label = checkEndMtdIL.DefineLabel()
checkEndMtdIL.Emit(OpCodes.Beq, tru181)
checkEndMtdIL.Emit(OpCodes.Br, fa181)
checkEndMtdIL.MarkLabel(tru181)
...
checkEndMtdIL.Emit(OpCodes.Br, cont181)
checkEndMtdIL.MarkLabel(fa181)
checkEndMtdIL.Emit(OpCodes.Br, cont181)
checkEndMtdIL.MarkLabel(cont181)
checkEndMtdIL.MarkSequencePoint(doc5, 95, 1, 95, 100)
checkEndMtdIL.Emit(OpCodes.Br, cont180)
checkEndMtdIL.MarkLabel(fa180)
checkEndMtdIL.Emit(OpCodes.Br, cont180)
checkEndMtdIL.MarkLabel(cont180)
...
Typ = GetType(System.Int32)
Dim fa182 As System.Reflection.Emit.Label = checkEndClsIL.DefineLabel()
Dim tru182 As System.Reflection.Emit.Label = checkEndClsIL.DefineLabel()
Dim cont182 As System.Reflection.Emit.Label = checkEndClsIL.DefineLabel()
checkEndClsIL.Emit(OpCodes.Bge, tru182)
checkEndClsIL.Emit(OpCodes.Br, fa182)
checkEndClsIL.MarkLabel(tru182)
checkEndClsIL.MarkSequencePoint(doc5, 102, 1, 102, 100)
Dim locbldr206 As LocalBuilder = checkEndClsIL.DeclareLocal(GetType(Token))
locbldr206.SetLocalSymInfo("tok1")
checkEndClsIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
checkEndClsIL.Emit(OpCodes.Ldfld, GetType(Stmt).GetField("Tokens"))
Typ = GetType(Stmt).GetField("Tokens").FieldType
...
Dim locbldr207 As LocalBuilder = checkEndClsIL.DeclareLocal(GetType(System.Type))
locbldr207.SetLocalSymInfo("typ1")
...
Dim locbldr208 As LocalBuilder = checkEndClsIL.DeclareLocal(GetType(System.Boolean))
locbldr208.SetLocalSymInfo("b1")
Dim typ23(-1) As Type
...
Dim locbldr209 As LocalBuilder = checkEndClsIL.DeclareLocal(GetType(Token))
locbldr209.SetLocalSymInfo("tok2")
checkEndClsIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
checkEndClsIL.Emit(OpCodes.Ldfld, GetType(Stmt).GetField("Tokens"))
Typ = GetType(Stmt).GetField("Tokens").FieldType
...
Dim locbldr210 As LocalBuilder = checkEndClsIL.DeclareLocal(GetType(System.Type))
locbldr210.SetLocalSymInfo("typ2")
...
Dim locbldr211 As LocalBuilder = checkEndClsIL.DeclareLocal(GetType(System.Boolean))
locbldr211.SetLocalSymInfo("b2")
Dim typ25(-1) As Type
...
Dim locbldr212 As LocalBuilder = checkEndClsIL.DeclareLocal(GetType(EndClassStmt))
locbldr212.SetLocalSymInfo("ecs")
...
Typ = GetType(System.Boolean)
Dim fa183 As System.Reflection.Emit.Label = checkEndClsIL.DefineLabel()
Dim tru183 As System.Reflection.Emit.Label = checkEndClsIL.DefineLabel()
Dim cont183 As System.Reflection.Emit.Label = checkEndClsIL.DefineLabel()
checkEndClsIL.Emit(OpCodes.Beq, tru183)
checkEndClsIL.Emit(OpCodes.Br, fa183)
checkEndClsIL.MarkLabel(tru183)
...
checkEndClsIL.Emit(OpCodes.Br, cont183)
checkEndClsIL.MarkLabel(fa183)
checkEndClsIL.Emit(OpCodes.Br, cont183)
checkEndClsIL.MarkLabel(cont183)
checkEndClsIL.MarkSequencePoint(doc5, 117, 1, 117, 100)
checkEndClsIL.Emit(OpCodes.Br, cont182)
checkEndClsIL.MarkLabel(fa182)
checkEndClsIL.Emit(OpCodes.Br, cont182)
checkEndClsIL.MarkLabel(cont182)
...
Dim locbldr213 As LocalBuilder = checkAssemblyIL.DeclareLocal(GetType(Token))
...
Dim locbldr214 As LocalBuilder = checkAssemblyIL.DeclareLocal(GetType(System.Type))
...
Dim locbldr215 As LocalBuilder = checkAssemblyIL.DeclareLocal(GetType(AssemblyStmt))
locbldr215.SetLocalSymInfo("asms")
...
Typ = GetType(System.Boolean)
Dim fa184 As System.Reflection.Emit.Label = checkAssemblyIL.DefineLabel()
Dim tru184 As System.Reflection.Emit.Label = checkAssemblyIL.DefineLabel()
Dim cont184 As System.Reflection.Emit.Label = checkAssemblyIL.DefineLabel()
checkAssemblyIL.Emit(OpCodes.Beq, tru184)
checkAssemblyIL.Emit(OpCodes.Br, fa184)
checkAssemblyIL.MarkLabel(tru184)
...
checkAssemblyIL.Emit(OpCodes.Br, cont184)
checkAssemblyIL.MarkLabel(fa184)
checkAssemblyIL.Emit(OpCodes.Br, cont184)
checkAssemblyIL.MarkLabel(cont184)
...
Dim locbldr216 As LocalBuilder = checkVerIL.DeclareLocal(GetType(Token))
locbldr216.SetLocalSymInfo("tok")
...
Dim locbldr217 As LocalBuilder = checkVerIL.DeclareLocal(GetType(System.Type))
...
Dim locbldr218 As LocalBuilder = checkVerIL.DeclareLocal(GetType(VerStmt))
locbldr218.SetLocalSymInfo("vers")
...
Typ = GetType(System.Boolean)
Dim fa185 As System.Reflection.Emit.Label = checkVerIL.DefineLabel()
Dim tru185 As System.Reflection.Emit.Label = checkVerIL.DefineLabel()
Dim cont185 As System.Reflection.Emit.Label = checkVerIL.DefineLabel()
checkVerIL.Emit(OpCodes.Beq, tru185)
checkVerIL.Emit(OpCodes.Br, fa185)
checkVerIL.MarkLabel(tru185)
...
Dim locbldr219 As LocalBuilder = checkVerIL.DeclareLocal(GetType(System.String).MakeArrayType())
locbldr219.SetLocalSymInfo("ars")
Dim typ32(-1) As Type
checkVerIL.Emit(OpCodes.Ldloc, 0)
Typ = GetType(Token)
...
Dim locbldr220 As LocalBuilder = checkVerIL.DeclareLocal(GetType(System.Int32).MakeArrayType())
locbldr220.SetLocalSymInfo("ari")
...
Dim locbldr221 As LocalBuilder = checkVerIL.DeclareLocal(GetType(IntLiteral).MakeArrayType())
locbldr221.SetLocalSymInfo("intla")
checkVerIL.Emit(OpCodes.Ldc_I4, CInt(4))
Typ = GetType(System.Int32)
checkVerIL.Emit(OpCodes.Conv_U)
...
Dim locbldr222 As LocalBuilder = checkVerIL.DeclareLocal(GetType(IntLiteral))
locbldr222.SetLocalSymInfo("intl")
...
checkVerIL.Emit(OpCodes.Br, cont185)
checkVerIL.MarkLabel(fa185)
checkVerIL.Emit(OpCodes.Br, cont185)
checkVerIL.MarkLabel(cont185)
...
Dim locbldr223 As LocalBuilder = checkClassIL.DeclareLocal(GetType(Token))
locbldr223.SetLocalSymInfo("tok")
...
Dim locbldr224 As LocalBuilder = checkClassIL.DeclareLocal(GetType(System.Type))
locbldr224.SetLocalSymInfo("typ")
...
Dim locbldr225 As LocalBuilder = checkClassIL.DeclareLocal(GetType(ClassStmt))
locbldr225.SetLocalSymInfo("clss")
...
Dim locbldr226 As LocalBuilder = checkClassIL.DeclareLocal(GetType(Attributes.Attribute))
locbldr226.SetLocalSymInfo("att")
...
checkClassIL.Emit(OpCodes.Beq, tru186)
checkClassIL.Emit(OpCodes.Br, fa186)
...
Dim locbldr227 As LocalBuilder = checkClassIL.DeclareLocal(GetType(System.Int32))
locbldr227.SetLocalSymInfo("i")
checkClassIL.Emit(OpCodes.Ldc_I4, CInt(0))
Typ = GetType(System.Int32)
checkClassIL.Emit(OpCodes.Stloc, 4)
checkClassIL.MarkSequencePoint(doc5, 188, 1, 188, 100)
Dim locbldr228 As LocalBuilder = checkClassIL.DeclareLocal(GetType(System.Int32))
locbldr228.SetLocalSymInfo("len")
checkClassIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
checkClassIL.Emit(OpCodes.Ldfld, GetType(Stmt).GetField("Tokens"))
Typ = GetType(Stmt).GetField("Tokens").FieldType
...
Dim locbldr229 As LocalBuilder = checkClassIL.DeclareLocal(GetType(System.Boolean))
locbldr229.SetLocalSymInfo("bl")
...
Dim locbldr230 As LocalBuilder = checkClassIL.DeclareLocal(GetType(Token))
locbldr230.SetLocalSymInfo("tok2")
checkClassIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
checkClassIL.Emit(OpCodes.Ldfld, GetType(Stmt).GetField("Tokens"))
Typ = GetType(Stmt).GetField("Tokens").FieldType
...
Dim locbldr231 As LocalBuilder = checkClassIL.DeclareLocal(GetType(System.Type))
locbldr231.SetLocalSymInfo("typ2")
...
Dim locbldr232 As LocalBuilder = checkClassIL.DeclareLocal(GetType(System.Boolean))
locbldr232.SetLocalSymInfo("b2")
Dim typ48(-1) As Type
...
checkClassIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa188 As System.Reflection.Emit.Label = checkClassIL.DefineLabel()
Dim tru188 As System.Reflection.Emit.Label = checkClassIL.DefineLabel()
Dim cont188 As System.Reflection.Emit.Label = checkClassIL.DefineLabel()
checkClassIL.Emit(OpCodes.Beq, tru188)
checkClassIL.Emit(OpCodes.Br, fa188)
checkClassIL.MarkLabel(tru188)
...
checkClassIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa189 As System.Reflection.Emit.Label = checkClassIL.DefineLabel()
Dim tru189 As System.Reflection.Emit.Label = checkClassIL.DefineLabel()
Dim cont189 As System.Reflection.Emit.Label = checkClassIL.DefineLabel()
checkClassIL.Emit(OpCodes.Beq, fa189)
checkClassIL.Emit(OpCodes.Br, tru189)
checkClassIL.MarkLabel(tru189)
checkClassIL.MarkSequencePoint(doc5, 214, 1, 214, 100)
Dim locbldr233 As LocalBuilder = checkClassIL.DeclareLocal(GetType(Token))
locbldr233.SetLocalSymInfo("t")
checkClassIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
checkClassIL.Emit(OpCodes.Ldfld, GetType(Stmt).GetField("Tokens"))
Typ = GetType(Stmt).GetField("Tokens").FieldType
...
Dim locbldr234 As LocalBuilder = checkClassIL.DeclareLocal(GetType(TypeTok))
locbldr234.SetLocalSymInfo("tt")
...
checkClassIL.Emit(OpCodes.Br, cont189)
checkClassIL.MarkLabel(fa189)
...
checkClassIL.Emit(OpCodes.Br, cont189)
checkClassIL.MarkLabel(cont189)
checkClassIL.MarkSequencePoint(doc5, 222, 1, 222, 100)
checkClassIL.Emit(OpCodes.Br, cont188)
checkClassIL.MarkLabel(fa188)
...
checkClassIL.Emit(OpCodes.Br, cont188)
checkClassIL.MarkLabel(cont188)
...
Typ = GetType(System.Int32)
Dim fa190 As System.Reflection.Emit.Label = checkClassIL.DefineLabel()
Dim tru190 As System.Reflection.Emit.Label = checkClassIL.DefineLabel()
Dim cont190 As System.Reflection.Emit.Label = checkClassIL.DefineLabel()
checkClassIL.Emit(OpCodes.Beq, tru190)
checkClassIL.Emit(OpCodes.Br, fa190)
checkClassIL.MarkLabel(tru190)
...
checkClassIL.Emit(OpCodes.Br, cont190)
checkClassIL.MarkLabel(fa190)
...
checkClassIL.Emit(OpCodes.Br, cont190)
checkClassIL.MarkLabel(cont190)
...
Dim locbldr235 As LocalBuilder = checkFieldIL.DeclareLocal(GetType(Token))
...
Dim locbldr236 As LocalBuilder = checkFieldIL.DeclareLocal(GetType(System.Type))
...
Dim locbldr237 As LocalBuilder = checkFieldIL.DeclareLocal(GetType(FieldStmt))
locbldr237.SetLocalSymInfo("flss")
...
Dim locbldr238 As LocalBuilder = checkFieldIL.DeclareLocal(GetType(Attributes.Attribute))
locbldr238.SetLocalSymInfo("att")
...
checkFieldIL.Emit(OpCodes.Beq, tru191)
checkFieldIL.Emit(OpCodes.Br, fa191)
checkFieldIL.MarkLabel(tru191)
checkFieldIL.MarkSequencePoint(doc5, 251, 1, 251, 100)
Dim locbldr239 As LocalBuilder = checkFieldIL.DeclareLocal(GetType(Expr))
locbldr239.SetLocalSymInfo("tempexp")
...
Dim locbldr240 As LocalBuilder = checkFieldIL.DeclareLocal(asm.GetType("dylan.NET.Tokenizer.Parser.ExprOptimizer"))
locbldr240.SetLocalSymInfo("eop")
...
Dim locbldr241 As LocalBuilder = checkFieldIL.DeclareLocal(GetType(System.Int32))
locbldr241.SetLocalSymInfo("i")
checkFieldIL.Emit(OpCodes.Ldc_I4, CInt(0))
Typ = GetType(System.Int32)
checkFieldIL.Emit(OpCodes.Stloc, 6)
checkFieldIL.MarkSequencePoint(doc5, 266, 1, 266, 100)
Dim locbldr242 As LocalBuilder = checkFieldIL.DeclareLocal(GetType(System.Int32))
...
Dim locbldr243 As LocalBuilder = checkFieldIL.DeclareLocal(GetType(System.Boolean))
locbldr243.SetLocalSymInfo("bl")
checkFieldIL.Emit(OpCodes.Ldc_I4, 0)
Typ = GetType(System.Boolean)
...
checkFieldIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa192 As System.Reflection.Emit.Label = checkFieldIL.DefineLabel()
Dim tru192 As System.Reflection.Emit.Label = checkFieldIL.DefineLabel()
Dim cont192 As System.Reflection.Emit.Label = checkFieldIL.DefineLabel()
checkFieldIL.Emit(OpCodes.Beq, tru192)
checkFieldIL.Emit(OpCodes.Br, fa192)
checkFieldIL.MarkLabel(tru192)
...
checkFieldIL.Emit(OpCodes.Br, cont192)
checkFieldIL.MarkLabel(fa192)
checkFieldIL.Emit(OpCodes.Br, cont192)
checkFieldIL.MarkLabel(cont192)
checkFieldIL.MarkSequencePoint(doc5, 281, 1, 281, 100)
checkFieldIL.Emit(OpCodes.Ldloc, 6)
Typ = GetType(System.Int32)
checkFieldIL.Emit(OpCodes.Ldloc, 7)
Typ = GetType(System.Int32)
Dim fa193 As System.Reflection.Emit.Label = checkFieldIL.DefineLabel()
Dim tru193 As System.Reflection.Emit.Label = checkFieldIL.DefineLabel()
Dim cont193 As System.Reflection.Emit.Label = checkFieldIL.DefineLabel()
checkFieldIL.Emit(OpCodes.Beq, tru193)
checkFieldIL.Emit(OpCodes.Br, fa193)
checkFieldIL.MarkLabel(tru193)
...
checkFieldIL.Emit(OpCodes.Br, cont193)
checkFieldIL.MarkLabel(fa193)
...
checkFieldIL.Emit(OpCodes.Br, cont193)
checkFieldIL.MarkLabel(cont193)
...
Dim locbldr244 As LocalBuilder = checkFieldIL.DeclareLocal(GetType(Token))
...
Dim locbldr245 As LocalBuilder = checkFieldIL.DeclareLocal(GetType(System.Type))
locbldr245.SetLocalSymInfo("typ2")
...
Dim locbldr246 As LocalBuilder = checkFieldIL.DeclareLocal(GetType(System.Boolean))
locbldr246.SetLocalSymInfo("b2")
Dim typ59(-1) As Type
...
checkFieldIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa194 As System.Reflection.Emit.Label = checkFieldIL.DefineLabel()
Dim tru194 As System.Reflection.Emit.Label = checkFieldIL.DefineLabel()
Dim cont194 As System.Reflection.Emit.Label = checkFieldIL.DefineLabel()
checkFieldIL.Emit(OpCodes.Beq, fa194)
checkFieldIL.Emit(OpCodes.Br, tru194)
checkFieldIL.MarkLabel(tru194)
checkFieldIL.MarkSequencePoint(doc5, 295, 1, 295, 100)
Dim locbldr247 As LocalBuilder = checkFieldIL.DeclareLocal(GetType(Token))
locbldr247.SetLocalSymInfo("t")
checkFieldIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
checkFieldIL.Emit(OpCodes.Ldfld, GetType(Stmt).GetField("Tokens"))
Typ = GetType(Stmt).GetField("Tokens").FieldType
...
Dim locbldr248 As LocalBuilder = checkFieldIL.DeclareLocal(GetType(TypeTok))
locbldr248.SetLocalSymInfo("tt")
...
checkFieldIL.Emit(OpCodes.Br, cont194)
checkFieldIL.MarkLabel(fa194)
...
checkFieldIL.Emit(OpCodes.Br, cont194)
checkFieldIL.MarkLabel(cont194)
...
Dim locbldr249 As LocalBuilder = checkMethodIL.DeclareLocal(GetType(Token))
...
Dim locbldr250 As LocalBuilder = checkMethodIL.DeclareLocal(GetType(System.Type))
...
Dim locbldr251 As LocalBuilder = checkMethodIL.DeclareLocal(GetType(MethodStmt))
locbldr251.SetLocalSymInfo("mtss")
...
Dim locbldr252 As LocalBuilder = checkMethodIL.DeclareLocal(GetType(Attributes.Attribute))
locbldr252.SetLocalSymInfo("att")
...
Dim locbldr253 As LocalBuilder = checkMethodIL.DeclareLocal(GetType(Ident))
...
locbldr254.SetLocalSymInfo("exp")
...
Dim locbldr256 As LocalBuilder = checkMethodIL.DeclareLocal(GetType(Expr))
locbldr256.SetLocalSymInfo("tempexp")
...
Dim locbldr257 As LocalBuilder = checkMethodIL.DeclareLocal(asm.GetType("dylan.NET.Tokenizer.Parser.ExprOptimizer"))
locbldr257.SetLocalSymInfo("eop")
...
Dim locbldr258 As LocalBuilder = checkMethodIL.DeclareLocal(GetType(System.Int32))
locbldr258.SetLocalSymInfo("i")
checkMethodIL.Emit(OpCodes.Ldc_I4, CInt(0))
Typ = GetType(System.Int32)
checkMethodIL.Emit(OpCodes.Stloc, 9)
checkMethodIL.MarkSequencePoint(doc5, 341, 1, 341, 100)
Dim locbldr259 As LocalBuilder = checkMethodIL.DeclareLocal(GetType(System.Int32))
locbldr259.SetLocalSymInfo("len")
checkMethodIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
checkMethodIL.Emit(OpCodes.Ldfld, GetType(Stmt).GetField("Tokens"))
Typ = GetType(Stmt).GetField("Tokens").FieldType
...
Dim locbldr260 As LocalBuilder = checkMethodIL.DeclareLocal(GetType(System.Boolean))
locbldr260.SetLocalSymInfo("bl")
checkMethodIL.Emit(OpCodes.Ldc_I4, 0)
Typ = GetType(System.Boolean)
...
Dim locbldr261 As LocalBuilder = checkMethodIL.DeclareLocal(GetType(Token))
locbldr261.SetLocalSymInfo("tok2")
checkMethodIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
checkMethodIL.Emit(OpCodes.Ldfld, GetType(Stmt).GetField("Tokens"))
Typ = GetType(Stmt).GetField("Tokens").FieldType
...
Dim locbldr262 As LocalBuilder = checkMethodIL.DeclareLocal(GetType(System.Type))
locbldr262.SetLocalSymInfo("typ2")
checkMethodIL.MarkSequencePoint(doc5, 375, 1, 375, 100)
Dim locbldr263 As LocalBuilder = checkMethodIL.DeclareLocal(GetType(System.Boolean))
locbldr263.SetLocalSymInfo("b2")
...
checkMethodIL.Emit(OpCodes.Beq, fa198)
checkMethodIL.Emit(OpCodes.Br, tru198)
checkMethodIL.MarkLabel(tru198)
checkMethodIL.MarkSequencePoint(doc5, 381, 1, 381, 100)
Dim locbldr264 As LocalBuilder = checkMethodIL.DeclareLocal(GetType(Token))
locbldr264.SetLocalSymInfo("t")
checkMethodIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
checkMethodIL.Emit(OpCodes.Ldfld, GetType(Stmt).GetField("Tokens"))
Typ = GetType(Stmt).GetField("Tokens").FieldType
...
Dim locbldr265 As LocalBuilder = checkMethodIL.DeclareLocal(GetType(TypeTok))
locbldr265.SetLocalSymInfo("tt")
...
Dim locbldr266 As LocalBuilder = checkMethodIL.DeclareLocal(asm.GetType("dylan.NET.Tokenizer.Parser.ExprOptimizer"))
locbldr266.SetLocalSymInfo("eopt2")
checkMethodIL.Emit(OpCodes.Newobj, asm.GetType("dylan.NET.Tokenizer.Parser.ExprOptimizer").GetConstructor(Type.EmptyTypes))
...
Dim locbldr267 As LocalBuilder = checkMethodIL.DeclareLocal(asm.GetType("dylan.NET.Tokenizer.Parser.ExprOptimizer"))
locbldr267.SetLocalSymInfo("eopt1")
checkMethodIL.Emit(OpCodes.Newobj, asm.GetType("dylan.NET.Tokenizer.Parser.ExprOptimizer").GetConstructor(Type.EmptyTypes))
...
checkMethodIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa206 As System.Reflection.Emit.Label = checkMethodIL.DefineLabel()
Dim tru206 As System.Reflection.Emit.Label = checkMethodIL.DefineLabel()
Dim cont206 As System.Reflection.Emit.Label = checkMethodIL.DefineLabel()
checkMethodIL.Emit(OpCodes.Beq, tru206)
checkMethodIL.Emit(OpCodes.Br, fa206)
checkMethodIL.MarkLabel(tru206)
...
checkMethodIL.Emit(OpCodes.Br, cont206)
checkMethodIL.MarkLabel(fa206)
checkMethodIL.Emit(OpCodes.Br, cont206)
checkMethodIL.MarkLabel(cont206)
...
checkMethodIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa207 As System.Reflection.Emit.Label = checkMethodIL.DefineLabel()
Dim tru207 As System.Reflection.Emit.Label = checkMethodIL.DefineLabel()
Dim cont207 As System.Reflection.Emit.Label = checkMethodIL.DefineLabel()
checkMethodIL.Emit(OpCodes.Beq, tru207)
checkMethodIL.Emit(OpCodes.Br, fa207)
checkMethodIL.MarkLabel(tru207)
...
checkMethodIL.Emit(OpCodes.Br, cont207)
checkMethodIL.MarkLabel(fa207)
checkMethodIL.Emit(OpCodes.Br, cont207)
checkMethodIL.MarkLabel(cont207)
checkMethodIL.MarkSequencePoint(doc5, 453, 1, 453, 100)
checkMethodIL.Emit(OpCodes.Ldloc, 9)
Typ = GetType(System.Int32)
checkMethodIL.Emit(OpCodes.Ldloc, 10)
Typ = GetType(System.Int32)
Dim fa208 As System.Reflection.Emit.Label = checkMethodIL.DefineLabel()
Dim tru208 As System.Reflection.Emit.Label = checkMethodIL.DefineLabel()
Dim cont208 As System.Reflection.Emit.Label = checkMethodIL.DefineLabel()
checkMethodIL.Emit(OpCodes.Beq, tru208)
checkMethodIL.Emit(OpCodes.Br, fa208)
checkMethodIL.MarkLabel(tru208)
checkMethodIL.MarkSequencePoint(doc5, 454, 1, 454, 100)
checkMethodIL.Emit(OpCodes.Br, label8)
checkMethodIL.MarkSequencePoint(doc5, 455, 1, 455, 100)
checkMethodIL.Emit(OpCodes.Br, cont208)
checkMethodIL.MarkLabel(fa208)
...
checkMethodIL.Emit(OpCodes.Br, cont208)
checkMethodIL.MarkLabel(cont208)
...
checkMethodCallIL.Emit(OpCodes.Bgt, tru209)
...
locbldr268.SetLocalSymInfo("tok")
checkMethodCallIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
checkMethodCallIL.Emit(OpCodes.Ldfld, GetType(Stmt).GetField("Tokens"))
Typ = GetType(Stmt).GetField("Tokens").FieldType
...
locbldr269.SetLocalSymInfo("typ")
...
Dim locbldr270 As LocalBuilder = checkMethodCallIL.DeclareLocal(GetType(Token))
locbldr270.SetLocalSymInfo("tokb")
checkMethodCallIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
checkMethodCallIL.Emit(OpCodes.Ldfld, GetType(Stmt).GetField("Tokens"))
Typ = GetType(Stmt).GetField("Tokens").FieldType
...
Dim locbldr271 As LocalBuilder = checkMethodCallIL.DeclareLocal(GetType(System.Type))
locbldr271.SetLocalSymInfo("typb")
...
Dim locbldr272 As LocalBuilder = checkMethodCallIL.DeclareLocal(GetType(System.Boolean))
locbldr272.SetLocalSymInfo("ba")
Dim typ87(-1) As Type
...
Dim locbldr273 As LocalBuilder = checkMethodCallIL.DeclareLocal(GetType(System.Boolean))
locbldr273.SetLocalSymInfo("bb")
Dim typ88(-1) As Type
...
Dim locbldr274 As LocalBuilder = checkMethodCallIL.DeclareLocal(GetType(MethodCallStmt))
locbldr274.SetLocalSymInfo("mtcss")
...
Dim locbldr275 As LocalBuilder = checkMethodCallIL.DeclareLocal(GetType(MethodNameTok))
locbldr275.SetLocalSymInfo("mn")
...
Dim locbldr276 As LocalBuilder = checkMethodCallIL.DeclareLocal(GetType(MethodCallTok))
locbldr276.SetLocalSymInfo("mct")
...
Dim locbldr277 As LocalBuilder = checkMethodCallIL.DeclareLocal(GetType(Ident))
locbldr277.SetLocalSymInfo("idt")
...
Dim locbldr278 As LocalBuilder = checkMethodCallIL.DeclareLocal(GetType(Expr))
locbldr278.SetLocalSymInfo("exp")
...
locbldr279.SetLocalSymInfo("lvl")
checkMethodCallIL.Emit(OpCodes.Ldc_I4, CInt(1))
Typ = GetType(System.Int32)
checkMethodCallIL.Emit(OpCodes.Stloc, 11)
checkMethodCallIL.MarkSequencePoint(doc5, 485, 1, 485, 100)
Dim locbldr280 As LocalBuilder = checkMethodCallIL.DeclareLocal(GetType(System.Boolean))
locbldr280.SetLocalSymInfo("d")
...
Dim locbldr281 As LocalBuilder = checkMethodCallIL.DeclareLocal(GetType(System.Int32))
locbldr281.SetLocalSymInfo("i")
checkMethodCallIL.Emit(OpCodes.Ldc_I4, CInt(1))
Typ = GetType(System.Int32)
...
Dim locbldr282 As LocalBuilder = checkMethodCallIL.DeclareLocal(GetType(Token))
locbldr282.SetLocalSymInfo("tok2")
checkMethodCallIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
checkMethodCallIL.Emit(OpCodes.Ldfld, GetType(Stmt).GetField("Tokens"))
Typ = GetType(Stmt).GetField("Tokens").FieldType
...
Dim locbldr283 As LocalBuilder = checkMethodCallIL.DeclareLocal(GetType(System.Type))
locbldr283.SetLocalSymInfo("typ2")
checkMethodCallIL.MarkSequencePoint(doc5, 499, 1, 499, 100)
Dim locbldr284 As LocalBuilder = checkMethodCallIL.DeclareLocal(GetType(System.Boolean))
locbldr284.SetLocalSymInfo("b2")
checkMethodCallIL.MarkSequencePoint(doc5, 500, 1, 500, 100)
Dim locbldr285 As LocalBuilder = checkMethodCallIL.DeclareLocal(GetType(System.Int32))
locbldr285.SetLocalSymInfo("len")
checkMethodCallIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
checkMethodCallIL.Emit(OpCodes.Ldfld, GetType(Stmt).GetField("Tokens"))
Typ = GetType(Stmt).GetField("Tokens").FieldType
...
Dim locbldr286 As LocalBuilder = checkMethodCallIL.DeclareLocal(asm.GetType("dylan.NET.Tokenizer.Parser.ExprOptimizer"))
locbldr286.SetLocalSymInfo("eopt")
...
checkMethodCallIL.Emit(OpCodes.Bgt, tru213)
...
checkMethodCallIL.MarkSequencePoint(doc5, 528, 1, 528, 100)
checkMethodCallIL.Emit(OpCodes.Br, label11)
...
Typ = GetType(System.Boolean)
checkMethodCallIL.Emit(OpCodes.Stloc, 12)
checkMethodCallIL.MarkSequencePoint(doc5, 537, 1, 537, 100)
checkMethodCallIL.Emit(OpCodes.Br, label11)
...
checkMethodCallIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa215 As System.Reflection.Emit.Label = checkMethodCallIL.DefineLabel()
Dim tru215 As System.Reflection.Emit.Label = checkMethodCallIL.DefineLabel()
Dim cont215 As System.Reflection.Emit.Label = checkMethodCallIL.DefineLabel()
checkMethodCallIL.Emit(OpCodes.Beq, tru215)
checkMethodCallIL.Emit(OpCodes.Br, fa215)
checkMethodCallIL.MarkLabel(tru215)
checkMethodCallIL.MarkSequencePoint(doc5, 544, 1, 544, 100)
checkMethodCallIL.Emit(OpCodes.Ldloc, 11)
Typ = GetType(System.Int32)
checkMethodCallIL.Emit(OpCodes.Ldc_I4, CInt(1))
Typ = GetType(System.Int32)
Dim fa216 As System.Reflection.Emit.Label = checkMethodCallIL.DefineLabel()
Dim tru216 As System.Reflection.Emit.Label = checkMethodCallIL.DefineLabel()
Dim cont216 As System.Reflection.Emit.Label = checkMethodCallIL.DefineLabel()
checkMethodCallIL.Emit(OpCodes.Beq, tru216)
checkMethodCallIL.Emit(OpCodes.Br, fa216)
checkMethodCallIL.MarkLabel(tru216)
...
checkMethodCallIL.Emit(OpCodes.Ldc_I4, CInt(0))
Typ = GetType(System.Int32)
Dim fa217 As System.Reflection.Emit.Label = checkMethodCallIL.DefineLabel()
Dim tru217 As System.Reflection.Emit.Label = checkMethodCallIL.DefineLabel()
Dim cont217 As System.Reflection.Emit.Label = checkMethodCallIL.DefineLabel()
checkMethodCallIL.Emit(OpCodes.Bgt, tru217)
checkMethodCallIL.Emit(OpCodes.Br, fa217)
checkMethodCallIL.MarkLabel(tru217)
...
checkMethodCallIL.Emit(OpCodes.Br, cont217)
checkMethodCallIL.MarkLabel(fa217)
checkMethodCallIL.Emit(OpCodes.Br, cont217)
checkMethodCallIL.MarkLabel(cont217)
...
checkMethodCallIL.Emit(OpCodes.Br, cont216)
checkMethodCallIL.MarkLabel(fa216)
...
checkMethodCallIL.Emit(OpCodes.Br, cont216)
checkMethodCallIL.MarkLabel(cont216)
checkMethodCallIL.MarkSequencePoint(doc5, 556, 1, 556, 100)
checkMethodCallIL.Emit(OpCodes.Br, cont215)
checkMethodCallIL.MarkLabel(fa215)
checkMethodCallIL.MarkSequencePoint(doc5, 557, 1, 557, 100)
checkMethodCallIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
checkMethodCallIL.Emit(OpCodes.Stloc, 12)
checkMethodCallIL.MarkSequencePoint(doc5, 558, 1, 558, 100)
checkMethodCallIL.Emit(OpCodes.Br, label11)
checkMethodCallIL.MarkSequencePoint(doc5, 559, 1, 559, 100)
checkMethodCallIL.Emit(OpCodes.Br, cont215)
checkMethodCallIL.MarkLabel(cont215)
...
checkMethodCallIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa218 As System.Reflection.Emit.Label = checkMethodCallIL.DefineLabel()
Dim tru218 As System.Reflection.Emit.Label = checkMethodCallIL.DefineLabel()
Dim cont218 As System.Reflection.Emit.Label = checkMethodCallIL.DefineLabel()
checkMethodCallIL.Emit(OpCodes.Beq, tru218)
checkMethodCallIL.Emit(OpCodes.Br, fa218)
checkMethodCallIL.MarkLabel(tru218)
...
checkMethodCallIL.Emit(OpCodes.Br, cont218)
checkMethodCallIL.MarkLabel(fa218)
checkMethodCallIL.Emit(OpCodes.Br, cont218)
checkMethodCallIL.MarkLabel(cont218)
checkMethodCallIL.MarkSequencePoint(doc5, 567, 1, 567, 100)
checkMethodCallIL.Emit(OpCodes.Ldloc, 13)
Typ = GetType(System.Int32)
checkMethodCallIL.Emit(OpCodes.Ldloc, 17)
Typ = GetType(System.Int32)
Dim fa219 As System.Reflection.Emit.Label = checkMethodCallIL.DefineLabel()
Dim tru219 As System.Reflection.Emit.Label = checkMethodCallIL.DefineLabel()
Dim cont219 As System.Reflection.Emit.Label = checkMethodCallIL.DefineLabel()
checkMethodCallIL.Emit(OpCodes.Beq, tru219)
checkMethodCallIL.Emit(OpCodes.Br, fa219)
checkMethodCallIL.MarkLabel(tru219)
checkMethodCallIL.MarkSequencePoint(doc5, 568, 1, 568, 100)
checkMethodCallIL.Emit(OpCodes.Br, label10)
checkMethodCallIL.MarkSequencePoint(doc5, 569, 1, 569, 100)
checkMethodCallIL.Emit(OpCodes.Br, cont219)
checkMethodCallIL.MarkLabel(fa219)
checkMethodCallIL.MarkSequencePoint(doc5, 570, 1, 570, 100)
checkMethodCallIL.Emit(OpCodes.Br, label9)
checkMethodCallIL.MarkSequencePoint(doc5, 571, 1, 571, 100)
checkMethodCallIL.Emit(OpCodes.Br, cont219)
checkMethodCallIL.MarkLabel(cont219)
checkMethodCallIL.MarkSequencePoint(doc5, 573, 1, 573, 100)
checkMethodCallIL.MarkLabel(label10)
checkMethodCallIL.MarkSequencePoint(doc5, 575, 1, 575, 100)
checkMethodCallIL.Emit(OpCodes.Ldloc, 8)
Typ = GetType(MethodCallTok)
checkMethodCallIL.Emit(OpCodes.Ldloc, 7)
Typ = GetType(MethodNameTok)
...
checkMethodCallIL.MarkSequencePoint(doc5, 580, 1, 580, 100)
checkMethodCallIL.Emit(OpCodes.Br, cont209)
checkMethodCallIL.MarkLabel(fa209)
checkMethodCallIL.Emit(OpCodes.Br, cont209)
checkMethodCallIL.MarkLabel(cont209)
checkMethodCallIL.MarkSequencePoint(doc5, 581, 1, 581, 100)
checkMethodCallIL.Emit(OpCodes.Ldloc, 6)
Typ = GetType(MethodCallStmt)
checkMethodCallIL.MarkSequencePoint(doc5, 582, 1, 582, 100)
...
Dim checkVarAsparam01 As ParameterBuilder = checkVarAs.DefineParameter(1, ParameterAttributes.None, "stm")
Dim checkVarAsparam02 As ParameterBuilder = checkVarAs.DefineParameter(2, ParameterAttributes.None, "b")
checkVarAsIL.MarkSequencePoint(doc5, 585, 1, 585, 100)
...
Dim locbldr289 As LocalBuilder = checkVarAsIL.DeclareLocal(GetType(VarStmt))
locbldr289.SetLocalSymInfo("vars")
...
checkVarAsIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa220 As System.Reflection.Emit.Label = checkVarAsIL.DefineLabel()
Dim tru220 As System.Reflection.Emit.Label = checkVarAsIL.DefineLabel()
Dim cont220 As System.Reflection.Emit.Label = checkVarAsIL.DefineLabel()
checkVarAsIL.Emit(OpCodes.Beq, tru220)
checkVarAsIL.Emit(OpCodes.Br, fa220)
checkVarAsIL.MarkLabel(tru220)
...
Dim locbldr290 As LocalBuilder = checkVarAsIL.DeclareLocal(GetType(Expr))
locbldr290.SetLocalSymInfo("tempexp")
...
Dim locbldr291 As LocalBuilder = checkVarAsIL.DeclareLocal(asm.GetType("dylan.NET.Tokenizer.Parser.ExprOptimizer"))
locbldr291.SetLocalSymInfo("eop")
checkVarAsIL.Emit(OpCodes.Newobj, asm.GetType("dylan.NET.Tokenizer.Parser.ExprOptimizer").GetConstructor(Type.EmptyTypes))
checkVarAsIL.Emit(OpCodes.Stloc, 4)
checkVarAsIL.MarkSequencePoint(doc5, 595, 1, 595, 100)
Dim typ103(-1) As Type
checkVarAsIL.Emit(OpCodes.Ldloc, 4)
Typ = asm.GetType("dylan.NET.Tokenizer.Parser.ExprOptimizer")
Typ03 = Typ
...
Dim locbldr292 As LocalBuilder = checkVarAsIL.DeclareLocal(GetType(Token))
locbldr292.SetLocalSymInfo("tok2")
checkVarAsIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
checkVarAsIL.Emit(OpCodes.Ldfld, GetType(Stmt).GetField("Tokens"))
Typ = GetType(Stmt).GetField("Tokens").FieldType
...
Dim locbldr293 As LocalBuilder = checkVarAsIL.DeclareLocal(GetType(System.Type))
locbldr293.SetLocalSymInfo("typ2")
checkVarAsIL.Emit(OpCodes.Ldtoken, GetType(TypeTok))
...
Dim locbldr294 As LocalBuilder = checkVarAsIL.DeclareLocal(GetType(System.Boolean))
locbldr294.SetLocalSymInfo("b2")
Dim typ105(-1) As Type
checkVarAsIL.Emit(OpCodes.Ldloc, 6)
Typ = GetType(System.Type)
Typ03 = Typ
...
checkVarAsIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa221 As System.Reflection.Emit.Label = checkVarAsIL.DefineLabel()
Dim tru221 As System.Reflection.Emit.Label = checkVarAsIL.DefineLabel()
Dim cont221 As System.Reflection.Emit.Label = checkVarAsIL.DefineLabel()
checkVarAsIL.Emit(OpCodes.Beq, fa221)
checkVarAsIL.Emit(OpCodes.Br, tru221)
checkVarAsIL.MarkLabel(tru221)
checkVarAsIL.MarkSequencePoint(doc5, 605, 1, 605, 100)
Dim locbldr295 As LocalBuilder = checkVarAsIL.DeclareLocal(GetType(Token))
locbldr295.SetLocalSymInfo("t")
checkVarAsIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
checkVarAsIL.Emit(OpCodes.Ldfld, GetType(Stmt).GetField("Tokens"))
Typ = GetType(Stmt).GetField("Tokens").FieldType
...
Dim locbldr296 As LocalBuilder = checkVarAsIL.DeclareLocal(GetType(TypeTok))
locbldr296.SetLocalSymInfo("tt")
checkVarAsIL.Emit(OpCodes.Newobj, GetType(TypeTok).GetConstructor(Type.EmptyTypes))
...
Typ = GetType(Token).GetField("Value").FieldType
checkVarAsIL.Emit(OpCodes.Stfld, GetType(TypeTok).GetField("Value"))
checkVarAsIL.MarkSequencePoint(doc5, 609, 1, 609, 100)
checkVarAsIL.Emit(OpCodes.Ldloc, 2)
Typ = GetType(VarStmt)
checkVarAsIL.Emit(OpCodes.Ldloc, 9)
Typ = GetType(TypeTok)
...
checkVarAsIL.Emit(OpCodes.Br, cont221)
checkVarAsIL.MarkLabel(fa221)
...
checkVarAsIL.Emit(OpCodes.Br, cont221)
checkVarAsIL.MarkLabel(cont221)
checkVarAsIL.MarkSequencePoint(doc5, 614, 1, 614, 100)
checkVarAsIL.Emit(OpCodes.Br, cont220)
checkVarAsIL.MarkLabel(fa220)
checkVarAsIL.Emit(OpCodes.Br, cont220)
checkVarAsIL.MarkLabel(cont220)
checkVarAsIL.MarkSequencePoint(doc5, 615, 1, 615, 100)
checkVarAsIL.Emit(OpCodes.Ldloc, 2)
Typ = GetType(VarStmt)
checkVarAsIL.MarkSequencePoint(doc5, 616, 1, 616, 100)
checkVarAsIL.Emit(OpCodes.Ret)
...
Dim locbldr297 As LocalBuilder = AssOptIL.DeclareLocal(GetType(AssignStmt))
locbldr297.SetLocalSymInfo("asss")
AssOptIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
AssOptIL.Emit(OpCodes.Stloc, 0)
AssOptIL.MarkSequencePoint(doc5, 621, 1, 621, 100)
Dim locbldr298 As LocalBuilder = AssOptIL.DeclareLocal(GetType(Expr))
locbldr298.SetLocalSymInfo("le")
...
Dim locbldr299 As LocalBuilder = AssOptIL.DeclareLocal(GetType(Token))
...
Dim locbldr300 As LocalBuilder = AssOptIL.DeclareLocal(GetType(System.Type))
...
Dim locbldr301 As LocalBuilder = AssOptIL.DeclareLocal(GetType(System.Boolean))
locbldr301.SetLocalSymInfo("b")
...
Dim locbldr302 As LocalBuilder = AssOptIL.DeclareLocal(GetType(VarAsgnStmt))
locbldr302.SetLocalSymInfo("vass")
AssOptIL.Emit(OpCodes.Newobj, GetType(VarAsgnStmt).GetConstructor(Type.EmptyTypes))
AssOptIL.Emit(OpCodes.Stloc, 5)
AssOptIL.MarkSequencePoint(doc5, 626, 1, 626, 100)
AssOptIL.Emit(OpCodes.Ldloc, 4)
Typ = GetType(System.Boolean)
AssOptIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa222 As System.Reflection.Emit.Label = AssOptIL.DefineLabel()
Dim tru222 As System.Reflection.Emit.Label = AssOptIL.DefineLabel()
Dim cont222 As System.Reflection.Emit.Label = AssOptIL.DefineLabel()
AssOptIL.Emit(OpCodes.Beq, tru222)
AssOptIL.Emit(OpCodes.Br, fa222)
AssOptIL.MarkLabel(tru222)
...
Dim locbldr303 As LocalBuilder = AssOptIL.DeclareLocal(GetType(Token))
locbldr303.SetLocalSymInfo("tok2")
AssOptIL.Emit(OpCodes.Ldloc, 1)
Typ = GetType(Expr)
AssOptIL.Emit(OpCodes.Ldfld, GetType(Expr).GetField("Tokens"))
Typ = GetType(Expr).GetField("Tokens").FieldType
...
Dim locbldr304 As LocalBuilder = AssOptIL.DeclareLocal(GetType(System.Type))
locbldr304.SetLocalSymInfo("typ2")
...
Dim locbldr305 As LocalBuilder = AssOptIL.DeclareLocal(GetType(System.Boolean))
locbldr305.SetLocalSymInfo("b2")
Dim typ110(-1) As Type
...
AssOptIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa223 As System.Reflection.Emit.Label = AssOptIL.DefineLabel()
Dim tru223 As System.Reflection.Emit.Label = AssOptIL.DefineLabel()
Dim cont223 As System.Reflection.Emit.Label = AssOptIL.DefineLabel()
AssOptIL.Emit(OpCodes.Beq, fa223)
AssOptIL.Emit(OpCodes.Br, tru223)
AssOptIL.MarkLabel(tru223)
AssOptIL.MarkSequencePoint(doc5, 636, 1, 636, 100)
Dim locbldr306 As LocalBuilder = AssOptIL.DeclareLocal(GetType(Token))
locbldr306.SetLocalSymInfo("t")
AssOptIL.Emit(OpCodes.Ldloc, 1)
Typ = GetType(Expr)
AssOptIL.Emit(OpCodes.Ldfld, GetType(Expr).GetField("Tokens"))
Typ = GetType(Expr).GetField("Tokens").FieldType
...
Dim locbldr307 As LocalBuilder = AssOptIL.DeclareLocal(GetType(TypeTok))
locbldr307.SetLocalSymInfo("tt")
...
AssOptIL.MarkSequencePoint(doc5, 640, 1, 640, 100)
AssOptIL.Emit(OpCodes.Ldloc, 5)
Typ = GetType(VarAsgnStmt)
AssOptIL.Emit(OpCodes.Ldloc, 10)
Typ = GetType(TypeTok)
...
AssOptIL.Emit(OpCodes.Br, cont223)
AssOptIL.MarkLabel(fa223)
...
Dim locbldr308 As LocalBuilder = AssOptIL.DeclareLocal(asm.GetType("dylan.NET.Tokenizer.Parser.ExprOptimizer"))
locbldr308.SetLocalSymInfo("eop")
...
AssOptIL.Emit(OpCodes.Stfld, GetType(VarAsgnStmt).GetField("RExpr"))
AssOptIL.MarkSequencePoint(doc5, 649, 1, 649, 100)
AssOptIL.Emit(OpCodes.Ldloc, 5)
Typ = GetType(VarAsgnStmt)
AssOptIL.MarkSequencePoint(doc5, 650, 1, 650, 100)
AssOptIL.Emit(OpCodes.Br, cont222)
AssOptIL.MarkLabel(fa222)
AssOptIL.MarkSequencePoint(doc5, 651, 1, 651, 100)
AssOptIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
AssOptIL.MarkSequencePoint(doc5, 652, 1, 652, 100)
AssOptIL.Emit(OpCodes.Br, cont222)
AssOptIL.MarkLabel(cont222)
AssOptIL.MarkSequencePoint(doc5, 654, 1, 654, 100)
...
Dim locbldr309 As LocalBuilder = checkAssignIL.DeclareLocal(GetType(Token))
locbldr309.SetLocalSymInfo("tok")
checkAssignIL.Emit(OpCodes.Ldnull)
checkAssignIL.Emit(OpCodes.Stloc, 0)
checkAssignIL.MarkSequencePoint(doc5, 658, 1, 658, 100)
Dim locbldr310 As LocalBuilder = checkAssignIL.DeclareLocal(GetType(System.Type))
locbldr310.SetLocalSymInfo("typ")
...
Dim locbldr311 As LocalBuilder = checkAssignIL.DeclareLocal(GetType(AssignStmt))
locbldr311.SetLocalSymInfo("asss")
...
Dim locbldr312 As LocalBuilder = checkAssignIL.DeclareLocal(GetType(System.Boolean))
locbldr312.SetLocalSymInfo("c")
checkAssignIL.Emit(OpCodes.Ldc_I4, 0)
Typ = GetType(System.Boolean)
checkAssignIL.Emit(OpCodes.Stloc, 3)
checkAssignIL.MarkSequencePoint(doc5, 661, 1, 661, 100)
Dim locbldr313 As LocalBuilder = checkAssignIL.DeclareLocal(GetType(Expr))
locbldr313.SetLocalSymInfo("re")
checkAssignIL.Emit(OpCodes.Newobj, GetType(Expr).GetConstructor(Type.EmptyTypes))
checkAssignIL.Emit(OpCodes.Stloc, 4)
checkAssignIL.MarkSequencePoint(doc5, 662, 1, 662, 100)
Dim locbldr314 As LocalBuilder = checkAssignIL.DeclareLocal(GetType(Expr))
locbldr314.SetLocalSymInfo("le")
checkAssignIL.Emit(OpCodes.Newobj, GetType(Expr).GetConstructor(Type.EmptyTypes))
...
Dim locbldr316 As LocalBuilder = checkAssignIL.DeclareLocal(GetType(System.Int32))
locbldr316.SetLocalSymInfo("len")
...
checkAssignIL.MarkSequencePoint(doc5, 665, 1, 665, 100)
Dim locbldr317 As LocalBuilder = checkAssignIL.DeclareLocal(GetType(System.Int32))
locbldr317.SetLocalSymInfo("assind")
checkAssignIL.Emit(OpCodes.Ldc_I4, CInt(0))
Typ = GetType(System.Int32)
checkAssignIL.Emit(OpCodes.Stloc, 8)
checkAssignIL.MarkSequencePoint(doc5, 667, 1, 667, 100)
...
checkAssignIL.MarkSequencePoint(doc5, 672, 1, 672, 100)
...
checkAssignIL.Emit(OpCodes.Stloc, 3)
checkAssignIL.MarkSequencePoint(doc5, 677, 1, 677, 100)
checkAssignIL.Emit(OpCodes.Ldloc, 3)
Typ = GetType(System.Boolean)
checkAssignIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa224 As System.Reflection.Emit.Label = checkAssignIL.DefineLabel()
Dim tru224 As System.Reflection.Emit.Label = checkAssignIL.DefineLabel()
Dim cont224 As System.Reflection.Emit.Label = checkAssignIL.DefineLabel()
checkAssignIL.Emit(OpCodes.Beq, tru224)
checkAssignIL.Emit(OpCodes.Br, fa224)
checkAssignIL.MarkLabel(tru224)
...
checkAssignIL.Emit(OpCodes.Br, cont224)
checkAssignIL.MarkLabel(fa224)
checkAssignIL.Emit(OpCodes.Br, cont224)
checkAssignIL.MarkLabel(cont224)
checkAssignIL.MarkSequencePoint(doc5, 682, 1, 682, 100)
checkAssignIL.Emit(OpCodes.Ldloc, 6)
Typ = GetType(System.Int32)
checkAssignIL.Emit(OpCodes.Ldloc, 7)
Typ = GetType(System.Int32)
Dim fa225 As System.Reflection.Emit.Label = checkAssignIL.DefineLabel()
Dim tru225 As System.Reflection.Emit.Label = checkAssignIL.DefineLabel()
Dim cont225 As System.Reflection.Emit.Label = checkAssignIL.DefineLabel()
checkAssignIL.Emit(OpCodes.Beq, tru225)
checkAssignIL.Emit(OpCodes.Br, fa225)
checkAssignIL.MarkLabel(tru225)
checkAssignIL.MarkSequencePoint(doc5, 683, 1, 683, 100)
checkAssignIL.Emit(OpCodes.Br, label13)
checkAssignIL.MarkSequencePoint(doc5, 684, 1, 684, 100)
checkAssignIL.Emit(OpCodes.Br, cont225)
checkAssignIL.MarkLabel(fa225)
checkAssignIL.MarkSequencePoint(doc5, 685, 1, 685, 100)
checkAssignIL.Emit(OpCodes.Br, label12)
checkAssignIL.MarkSequencePoint(doc5, 686, 1, 686, 100)
checkAssignIL.Emit(OpCodes.Br, cont225)
checkAssignIL.MarkLabel(cont225)
checkAssignIL.MarkSequencePoint(doc5, 688, 1, 688, 100)
checkAssignIL.MarkLabel(label13)
checkAssignIL.MarkSequencePoint(doc5, 690, 1, 690, 100)
checkAssignIL.Emit(OpCodes.Ldloc, 8)
Typ = GetType(System.Int32)
checkAssignIL.Emit(OpCodes.Ldc_I4, CInt(0))
Typ = GetType(System.Int32)
Dim fa226 As System.Reflection.Emit.Label = checkAssignIL.DefineLabel()
Dim tru226 As System.Reflection.Emit.Label = checkAssignIL.DefineLabel()
Dim cont226 As System.Reflection.Emit.Label = checkAssignIL.DefineLabel()
checkAssignIL.Emit(OpCodes.Beq, fa226)
checkAssignIL.Emit(OpCodes.Br, tru226)
checkAssignIL.MarkLabel(tru226)
checkAssignIL.MarkSequencePoint(doc5, 692, 1, 692, 100)
checkAssignIL.Emit(OpCodes.Ldc_I4, CInt(-1))
Typ = GetType(System.Int32)
checkAssignIL.Emit(OpCodes.Stloc, 6)
checkAssignIL.MarkSequencePoint(doc5, 693, 1, 693, 100)
checkAssignIL.Emit(OpCodes.Ldloc, 8)
Typ = GetType(System.Int32)
checkAssignIL.Emit(OpCodes.Ldc_I4, CInt(1))
Typ = GetType(System.Int32)
checkAssignIL.Emit(OpCodes.Sub)
checkAssignIL.Emit(OpCodes.Stloc, 7)
checkAssignIL.MarkSequencePoint(doc5, 695, 1, 695, 100)
...
checkAssignIL.Emit(OpCodes.Ldloc, 7)
Typ = GetType(System.Int32)
Dim fa227 As System.Reflection.Emit.Label = checkAssignIL.DefineLabel()
Dim tru227 As System.Reflection.Emit.Label = checkAssignIL.DefineLabel()
Dim cont227 As System.Reflection.Emit.Label = checkAssignIL.DefineLabel()
checkAssignIL.Emit(OpCodes.Beq, tru227)
checkAssignIL.Emit(OpCodes.Br, fa227)
checkAssignIL.MarkLabel(tru227)
checkAssignIL.MarkSequencePoint(doc5, 705, 1, 705, 100)
checkAssignIL.Emit(OpCodes.Br, label15)
checkAssignIL.MarkSequencePoint(doc5, 706, 1, 706, 100)
checkAssignIL.Emit(OpCodes.Br, cont227)
checkAssignIL.MarkLabel(fa227)
checkAssignIL.MarkSequencePoint(doc5, 707, 1, 707, 100)
checkAssignIL.Emit(OpCodes.Br, label14)
checkAssignIL.MarkSequencePoint(doc5, 708, 1, 708, 100)
checkAssignIL.Emit(OpCodes.Br, cont227)
checkAssignIL.MarkLabel(cont227)
...
Typ = GetType(System.Int32)
checkAssignIL.Emit(OpCodes.Stloc, 6)
checkAssignIL.MarkSequencePoint(doc5, 714, 1, 714, 100)
checkAssignIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
checkAssignIL.Emit(OpCodes.Ldfld, GetType(Stmt).GetField("Tokens"))
Typ = GetType(Stmt).GetField("Tokens").FieldType
...
checkAssignIL.Emit(OpCodes.Sub)
checkAssignIL.Emit(OpCodes.Stloc, 7)
checkAssignIL.MarkSequencePoint(doc5, 716, 1, 716, 100)
...
checkAssignIL.Emit(OpCodes.Ldloc, 7)
Typ = GetType(System.Int32)
Dim fa228 As System.Reflection.Emit.Label = checkAssignIL.DefineLabel()
Dim tru228 As System.Reflection.Emit.Label = checkAssignIL.DefineLabel()
Dim cont228 As System.Reflection.Emit.Label = checkAssignIL.DefineLabel()
checkAssignIL.Emit(OpCodes.Beq, tru228)
checkAssignIL.Emit(OpCodes.Br, fa228)
checkAssignIL.MarkLabel(tru228)
checkAssignIL.MarkSequencePoint(doc5, 726, 1, 726, 100)
checkAssignIL.Emit(OpCodes.Br, label17)
checkAssignIL.MarkSequencePoint(doc5, 727, 1, 727, 100)
checkAssignIL.Emit(OpCodes.Br, cont228)
checkAssignIL.MarkLabel(fa228)
checkAssignIL.MarkSequencePoint(doc5, 728, 1, 728, 100)
checkAssignIL.Emit(OpCodes.Br, label16)
checkAssignIL.MarkSequencePoint(doc5, 729, 1, 729, 100)
checkAssignIL.Emit(OpCodes.Br, cont228)
checkAssignIL.MarkLabel(cont228)
...
Dim locbldr318 As LocalBuilder = checkAssignIL.DeclareLocal(asm.GetType("dylan.NET.Tokenizer.Parser.ExprOptimizer"))
locbldr318.SetLocalSymInfo("eop")
...
checkAssignIL.Emit(OpCodes.Stloc, 5)
checkAssignIL.MarkSequencePoint(doc5, 737, 1, 737, 100)
...
checkAssignIL.MarkSequencePoint(doc5, 739, 1, 739, 100)
checkAssignIL.Emit(OpCodes.Ldloc, 2)
Typ = GetType(AssignStmt)
checkAssignIL.Emit(OpCodes.Ldloc, 5)
Typ = GetType(Expr)
...
checkAssignIL.Emit(OpCodes.Br, cont226)
checkAssignIL.MarkLabel(fa226)
checkAssignIL.MarkSequencePoint(doc5, 749, 1, 749, 100)
checkAssignIL.Emit(OpCodes.Ldarg, 2)
Typ = GetType(System.Boolean).MakeByRefType()
Typ04 = Typ.GetElementType()
checkAssignIL.Emit(OpCodes.Ldc_I4, 0)
...
checkAssignIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
checkAssignIL.MarkSequencePoint(doc5, 752, 1, 752, 100)
checkAssignIL.Emit(OpCodes.Br, cont226)
checkAssignIL.MarkLabel(cont226)
checkAssignIL.MarkSequencePoint(doc5, 754, 1, 754, 100)
...
Dim locbldr319 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(System.Int32))
locbldr319.SetLocalSymInfo("i")
OptimizeIL.Emit(OpCodes.Ldc_I4, CInt(-1))
Typ = GetType(System.Int32)
OptimizeIL.Emit(OpCodes.Stloc, 0)
OptimizeIL.MarkSequencePoint(doc5, 761, 1, 761, 100)
Dim locbldr320 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(System.Int32))
locbldr320.SetLocalSymInfo("len")
OptimizeIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
...
Dim locbldr321 As LocalBuilder = OptimizeIL.DeclareLocal(asm.GetType("dylan.NET.Tokenizer.Parser.TokenOptimizer"))
locbldr321.SetLocalSymInfo("to")
OptimizeIL.Emit(OpCodes.Ldnull)
OptimizeIL.Emit(OpCodes.Stloc, 2)
OptimizeIL.MarkSequencePoint(doc5, 763, 1, 763, 100)
Dim locbldr322 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(Stmt))
locbldr322.SetLocalSymInfo("tmpstm")
OptimizeIL.Emit(OpCodes.Ldnull)
OptimizeIL.Emit(OpCodes.Stloc, 3)
OptimizeIL.MarkSequencePoint(doc5, 764, 1, 764, 100)
Dim locbldr323 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(System.Boolean))
locbldr323.SetLocalSymInfo("compb")
OptimizeIL.Emit(OpCodes.Ldc_I4, 0)
Typ = GetType(System.Boolean)
OptimizeIL.Emit(OpCodes.Stloc, 4)
...
OptimizeIL.Emit(OpCodes.Blt, tru229)
...
Typ = GetType(Stmt)
OptimizeIL.Emit(OpCodes.Starg, 1)
OptimizeIL.MarkSequencePoint(doc5, 811, 1, 811, 100)
OptimizeIL.Emit(OpCodes.Br, label20)
...
OptimizeIL.Emit(OpCodes.Stloc, 3)
OptimizeIL.MarkSequencePoint(doc5, 816, 1, 816, 100)
OptimizeIL.Emit(OpCodes.Ldloc, 4)
Typ = GetType(System.Boolean)
OptimizeIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
...
Typ = GetType(Stmt)
OptimizeIL.Emit(OpCodes.Starg, 1)
OptimizeIL.MarkSequencePoint(doc5, 818, 1, 818, 100)
OptimizeIL.Emit(OpCodes.Br, label20)
...
OptimizeIL.Emit(OpCodes.Stloc, 3)
OptimizeIL.MarkSequencePoint(doc5, 823, 1, 823, 100)
OptimizeIL.Emit(OpCodes.Ldloc, 4)
Typ = GetType(System.Boolean)
OptimizeIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
...
Typ = GetType(Stmt)
OptimizeIL.Emit(OpCodes.Starg, 1)
OptimizeIL.MarkSequencePoint(doc5, 825, 1, 825, 100)
OptimizeIL.Emit(OpCodes.Br, label20)
...
OptimizeIL.Emit(OpCodes.Stloc, 3)
OptimizeIL.MarkSequencePoint(doc5, 830, 1, 830, 100)
OptimizeIL.Emit(OpCodes.Ldloc, 4)
Typ = GetType(System.Boolean)
OptimizeIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
...
Typ = GetType(Stmt)
OptimizeIL.Emit(OpCodes.Starg, 1)
OptimizeIL.MarkSequencePoint(doc5, 832, 1, 832, 100)
OptimizeIL.Emit(OpCodes.Br, label20)
...
OptimizeIL.Emit(OpCodes.Stloc, 3)
OptimizeIL.MarkSequencePoint(doc5, 837, 1, 837, 100)
OptimizeIL.Emit(OpCodes.Ldloc, 4)
Typ = GetType(System.Boolean)
OptimizeIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
...
Typ = GetType(Stmt)
OptimizeIL.Emit(OpCodes.Starg, 1)
OptimizeIL.MarkSequencePoint(doc5, 839, 1, 839, 100)
OptimizeIL.Emit(OpCodes.Br, label20)
...
OptimizeIL.Emit(OpCodes.Stloc, 3)
OptimizeIL.MarkSequencePoint(doc5, 844, 1, 844, 100)
OptimizeIL.Emit(OpCodes.Ldloc, 4)
Typ = GetType(System.Boolean)
OptimizeIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
...
Typ = GetType(Stmt)
OptimizeIL.Emit(OpCodes.Starg, 1)
OptimizeIL.MarkSequencePoint(doc5, 846, 1, 846, 100)
OptimizeIL.Emit(OpCodes.Br, label20)
...
OptimizeIL.Emit(OpCodes.Stloc, 3)
OptimizeIL.MarkSequencePoint(doc5, 851, 1, 851, 100)
OptimizeIL.Emit(OpCodes.Ldloc, 4)
Typ = GetType(System.Boolean)
OptimizeIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
...
Typ = GetType(Stmt)
OptimizeIL.Emit(OpCodes.Starg, 1)
OptimizeIL.MarkSequencePoint(doc5, 853, 1, 853, 100)
OptimizeIL.Emit(OpCodes.Br, label20)
...
OptimizeIL.Emit(OpCodes.Stloc, 3)
OptimizeIL.MarkSequencePoint(doc5, 858, 1, 858, 100)
OptimizeIL.Emit(OpCodes.Ldloc, 4)
Typ = GetType(System.Boolean)
OptimizeIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
...
Typ = GetType(Stmt)
OptimizeIL.Emit(OpCodes.Starg, 1)
OptimizeIL.MarkSequencePoint(doc5, 860, 1, 860, 100)
OptimizeIL.Emit(OpCodes.Br, label20)
...
OptimizeIL.Emit(OpCodes.Stloc, 3)
OptimizeIL.MarkSequencePoint(doc5, 865, 1, 865, 100)
OptimizeIL.Emit(OpCodes.Ldloc, 4)
Typ = GetType(System.Boolean)
OptimizeIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
...
Typ = GetType(Stmt)
OptimizeIL.Emit(OpCodes.Starg, 1)
OptimizeIL.MarkSequencePoint(doc5, 867, 1, 867, 100)
OptimizeIL.Emit(OpCodes.Br, label20)
...
OptimizeIL.Emit(OpCodes.Stloc, 3)
OptimizeIL.MarkSequencePoint(doc5, 872, 1, 872, 100)
OptimizeIL.Emit(OpCodes.Ldloc, 4)
Typ = GetType(System.Boolean)
OptimizeIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
...
Typ = GetType(Stmt)
OptimizeIL.Emit(OpCodes.Starg, 1)
OptimizeIL.MarkSequencePoint(doc5, 874, 1, 874, 100)
OptimizeIL.Emit(OpCodes.Br, label20)
...
OptimizeIL.Emit(OpCodes.Stloc, 3)
OptimizeIL.MarkSequencePoint(doc5, 879, 1, 879, 100)
OptimizeIL.Emit(OpCodes.Ldloc, 4)
Typ = GetType(System.Boolean)
OptimizeIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa244 As System.Reflection.Emit.Label = OptimizeIL.DefineLabel()
Dim tru244 As System.Reflection.Emit.Label = OptimizeIL.DefineLabel()
Dim cont244 As System.Reflection.Emit.Label = OptimizeIL.DefineLabel()
OptimizeIL.Emit(OpCodes.Beq, tru244)
OptimizeIL.Emit(OpCodes.Br, fa244)
OptimizeIL.MarkLabel(tru244)
OptimizeIL.MarkSequencePoint(doc5, 880, 1, 880, 100)
OptimizeIL.Emit(OpCodes.Ldloc, 3)
Typ = GetType(Stmt)
OptimizeIL.Emit(OpCodes.Starg, 1)
OptimizeIL.MarkSequencePoint(doc5, 881, 1, 881, 100)
OptimizeIL.Emit(OpCodes.Br, label20)
OptimizeIL.MarkSequencePoint(doc5, 882, 1, 882, 100)
OptimizeIL.Emit(OpCodes.Br, cont244)
OptimizeIL.MarkLabel(fa244)
OptimizeIL.Emit(OpCodes.Br, cont244)
OptimizeIL.MarkLabel(cont244)
...
OptimizeIL.Emit(OpCodes.Stloc, 3)
OptimizeIL.MarkSequencePoint(doc5, 886, 1, 886, 100)
OptimizeIL.Emit(OpCodes.Ldloc, 4)
Typ = GetType(System.Boolean)
OptimizeIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa245 As System.Reflection.Emit.Label = OptimizeIL.DefineLabel()
Dim tru245 As System.Reflection.Emit.Label = OptimizeIL.DefineLabel()
Dim cont245 As System.Reflection.Emit.Label = OptimizeIL.DefineLabel()
OptimizeIL.Emit(OpCodes.Beq, tru245)
OptimizeIL.Emit(OpCodes.Br, fa245)
OptimizeIL.MarkLabel(tru245)
OptimizeIL.MarkSequencePoint(doc5, 887, 1, 887, 100)
OptimizeIL.Emit(OpCodes.Ldloc, 3)
Typ = GetType(Stmt)
OptimizeIL.Emit(OpCodes.Starg, 1)
OptimizeIL.MarkSequencePoint(doc5, 888, 1, 888, 100)
OptimizeIL.Emit(OpCodes.Br, label20)
OptimizeIL.MarkSequencePoint(doc5, 889, 1, 889, 100)
OptimizeIL.Emit(OpCodes.Br, cont245)
OptimizeIL.MarkLabel(fa245)
OptimizeIL.Emit(OpCodes.Br, cont245)
OptimizeIL.MarkLabel(cont245)
...
OptimizeIL.Emit(OpCodes.Stloc, 3)
OptimizeIL.MarkSequencePoint(doc5, 893, 1, 893, 100)
OptimizeIL.Emit(OpCodes.Ldloc, 4)
Typ = GetType(System.Boolean)
OptimizeIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa246 As System.Reflection.Emit.Label = OptimizeIL.DefineLabel()
Dim tru246 As System.Reflection.Emit.Label = OptimizeIL.DefineLabel()
Dim cont246 As System.Reflection.Emit.Label = OptimizeIL.DefineLabel()
OptimizeIL.Emit(OpCodes.Beq, tru246)
OptimizeIL.Emit(OpCodes.Br, fa246)
OptimizeIL.MarkLabel(tru246)
OptimizeIL.MarkSequencePoint(doc5, 894, 1, 894, 100)
OptimizeIL.Emit(OpCodes.Ldloc, 3)
Typ = GetType(Stmt)
OptimizeIL.Emit(OpCodes.Starg, 1)
OptimizeIL.MarkSequencePoint(doc5, 895, 1, 895, 100)
OptimizeIL.Emit(OpCodes.Br, label20)
OptimizeIL.MarkSequencePoint(doc5, 896, 1, 896, 100)
OptimizeIL.Emit(OpCodes.Br, cont246)
OptimizeIL.MarkLabel(fa246)
OptimizeIL.Emit(OpCodes.Br, cont246)
OptimizeIL.MarkLabel(cont246)
...
OptimizeIL.Emit(OpCodes.Stloc, 3)
OptimizeIL.MarkSequencePoint(doc5, 900, 1, 900, 100)
OptimizeIL.Emit(OpCodes.Ldloc, 4)
Typ = GetType(System.Boolean)
OptimizeIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa247 As System.Reflection.Emit.Label = OptimizeIL.DefineLabel()
Dim tru247 As System.Reflection.Emit.Label = OptimizeIL.DefineLabel()
Dim cont247 As System.Reflection.Emit.Label = OptimizeIL.DefineLabel()
OptimizeIL.Emit(OpCodes.Beq, tru247)
OptimizeIL.Emit(OpCodes.Br, fa247)
OptimizeIL.MarkLabel(tru247)
OptimizeIL.MarkSequencePoint(doc5, 901, 1, 901, 100)
OptimizeIL.Emit(OpCodes.Ldloc, 3)
Typ = GetType(Stmt)
OptimizeIL.Emit(OpCodes.Starg, 1)
OptimizeIL.MarkSequencePoint(doc5, 902, 1, 902, 100)
OptimizeIL.Emit(OpCodes.Br, label20)
OptimizeIL.MarkSequencePoint(doc5, 903, 1, 903, 100)
OptimizeIL.Emit(OpCodes.Br, cont247)
OptimizeIL.MarkLabel(fa247)
OptimizeIL.Emit(OpCodes.Br, cont247)
OptimizeIL.MarkLabel(cont247)
...
OptimizeIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa248 As System.Reflection.Emit.Label = OptimizeIL.DefineLabel()
Dim tru248 As System.Reflection.Emit.Label = OptimizeIL.DefineLabel()
Dim cont248 As System.Reflection.Emit.Label = OptimizeIL.DefineLabel()
OptimizeIL.Emit(OpCodes.Beq, tru248)
OptimizeIL.Emit(OpCodes.Br, fa248)
OptimizeIL.MarkLabel(tru248)
OptimizeIL.MarkSequencePoint(doc5, 908, 1, 908, 100)
OptimizeIL.Emit(OpCodes.Ldloc, 3)
Typ = GetType(Stmt)
OptimizeIL.Emit(OpCodes.Starg, 1)
OptimizeIL.MarkSequencePoint(doc5, 909, 1, 909, 100)
OptimizeIL.Emit(OpCodes.Br, label20)
OptimizeIL.MarkSequencePoint(doc5, 910, 1, 910, 100)
OptimizeIL.Emit(OpCodes.Br, cont248)
OptimizeIL.MarkLabel(fa248)
OptimizeIL.Emit(OpCodes.Br, cont248)
OptimizeIL.MarkLabel(cont248)
...
Dim locbldr325 As LocalBuilder = ParseIL.DeclareLocal(asm.GetType("dylan.NET.Tokenizer.Parser.StmtOptimizer"))
locbldr325.SetLocalSymInfo("so")
ParseIL.Emit(OpCodes.Ldnull)
ParseIL.Emit(OpCodes.Stloc, 1)
ParseIL.MarkSequencePoint(doc6, 14, 1, 14, 100)
Dim locbldr326 As LocalBuilder = ParseIL.DeclareLocal(GetType(System.Int32))
locbldr326.SetLocalSymInfo("len")
...
ParseIL.Emit(OpCodes.Ldloc, 2)
Typ = GetType(System.Int32)
Dim fa249 As System.Reflection.Emit.Label = ParseIL.DefineLabel()
Dim tru249 As System.Reflection.Emit.Label = ParseIL.DefineLabel()
Dim cont249 As System.Reflection.Emit.Label = ParseIL.DefineLabel()
ParseIL.Emit(OpCodes.Beq, tru249)
ParseIL.Emit(OpCodes.Br, fa249)
ParseIL.MarkLabel(tru249)
ParseIL.MarkSequencePoint(doc6, 27, 1, 27, 100)
ParseIL.Emit(OpCodes.Br, label1)
ParseIL.MarkSequencePoint(doc6, 28, 1, 28, 100)
ParseIL.Emit(OpCodes.Br, cont249)
ParseIL.MarkLabel(fa249)
ParseIL.MarkSequencePoint(doc6, 29, 1, 29, 100)
ParseIL.Emit(OpCodes.Br, label0)
ParseIL.MarkSequencePoint(doc6, 30, 1, 30, 100)
ParseIL.Emit(OpCodes.Br, cont249)
ParseIL.MarkLabel(cont249)
