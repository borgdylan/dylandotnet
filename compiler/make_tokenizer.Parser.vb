...
Dim DecFlag As FieldBuilder = ParserFlags.DefineField("DecFlag", GetType(System.Boolean), FieldAttributes.Public Or FieldAttributes.Static)
Dim IncFlag As FieldBuilder = ParserFlags.DefineField("IncFlag", GetType(System.Boolean), FieldAttributes.Public Or FieldAttributes.Static)
...
Dim ArrSlot As FieldBuilder = ParserFlags.DefineField("ArrSlot", GetType(System.Int32), FieldAttributes.Public Or FieldAttributes.Static)
...
ctor0IL.Emit(OpCodes.Ldc_I4, 0)
Typ = GetType(System.Boolean)
ctor0IL.Emit(OpCodes.Stsfld, DecFlag)
ctor0IL.MarkSequencePoint(doc2, 23, 1, 23, 100)
ctor0IL.Emit(OpCodes.Ldc_I4, 0)
Typ = GetType(System.Boolean)
ctor0IL.Emit(OpCodes.Stsfld, IncFlag)
...
ctor0IL.Emit(OpCodes.Newobj, GetType(TypeTok).GetConstructor(Type.EmptyTypes))
...
Dim locbldr90 As LocalBuilder = checkRefasmIL.DeclareLocal(GetType(Token))
locbldr90.SetLocalSymInfo("tok")
...
Dim locbldr91 As LocalBuilder = checkRefasmIL.DeclareLocal(GetType(System.Type))
...
Dim locbldr92 As LocalBuilder = checkRefasmIL.DeclareLocal(GetType(RefasmStmt))
locbldr92.SetLocalSymInfo("refasms")
...
Typ = GetType(System.Boolean)
Dim fa79 As System.Reflection.Emit.Label = checkRefasmIL.DefineLabel()
Dim tru79 As System.Reflection.Emit.Label = checkRefasmIL.DefineLabel()
Dim cont79 As System.Reflection.Emit.Label = checkRefasmIL.DefineLabel()
checkRefasmIL.Emit(OpCodes.Beq, tru79)
checkRefasmIL.Emit(OpCodes.Br, fa79)
checkRefasmIL.MarkLabel(tru79)
...
checkRefasmIL.Emit(OpCodes.Br, cont79)
checkRefasmIL.MarkLabel(fa79)
checkRefasmIL.Emit(OpCodes.Br, cont79)
checkRefasmIL.MarkLabel(cont79)
...
Dim locbldr93 As LocalBuilder = checkImportIL.DeclareLocal(GetType(Token))
...
Dim locbldr94 As LocalBuilder = checkImportIL.DeclareLocal(GetType(System.Type))
...
Dim locbldr95 As LocalBuilder = checkImportIL.DeclareLocal(GetType(ImportStmt))
locbldr95.SetLocalSymInfo("imps")
...
Typ = GetType(System.Boolean)
Dim fa80 As System.Reflection.Emit.Label = checkImportIL.DefineLabel()
Dim tru80 As System.Reflection.Emit.Label = checkImportIL.DefineLabel()
Dim cont80 As System.Reflection.Emit.Label = checkImportIL.DefineLabel()
checkImportIL.Emit(OpCodes.Beq, tru80)
checkImportIL.Emit(OpCodes.Br, fa80)
checkImportIL.MarkLabel(tru80)
...
checkImportIL.Emit(OpCodes.Br, cont80)
checkImportIL.MarkLabel(fa80)
checkImportIL.Emit(OpCodes.Br, cont80)
checkImportIL.MarkLabel(cont80)
...
Dim locbldr96 As LocalBuilder = checkLocimportIL.DeclareLocal(GetType(Token))
locbldr96.SetLocalSymInfo("tok")
...
Dim locbldr97 As LocalBuilder = checkLocimportIL.DeclareLocal(GetType(System.Type))
...
Dim locbldr98 As LocalBuilder = checkLocimportIL.DeclareLocal(GetType(LocimportStmt))
locbldr98.SetLocalSymInfo("limps")
...
Typ = GetType(System.Boolean)
Dim fa81 As System.Reflection.Emit.Label = checkLocimportIL.DefineLabel()
Dim tru81 As System.Reflection.Emit.Label = checkLocimportIL.DefineLabel()
Dim cont81 As System.Reflection.Emit.Label = checkLocimportIL.DefineLabel()
checkLocimportIL.Emit(OpCodes.Beq, tru81)
checkLocimportIL.Emit(OpCodes.Br, fa81)
checkLocimportIL.MarkLabel(tru81)
...
checkLocimportIL.Emit(OpCodes.Br, cont81)
checkLocimportIL.MarkLabel(fa81)
checkLocimportIL.Emit(OpCodes.Br, cont81)
checkLocimportIL.MarkLabel(cont81)
...
Dim locbldr99 As LocalBuilder = checkCmtIL.DeclareLocal(GetType(Token))
locbldr99.SetLocalSymInfo("tok")
...
Dim locbldr100 As LocalBuilder = checkCmtIL.DeclareLocal(GetType(System.Type))
...
Dim locbldr101 As LocalBuilder = checkCmtIL.DeclareLocal(GetType(CommentStmt))
locbldr101.SetLocalSymInfo("cmts")
...
Typ = GetType(System.Boolean)
Dim fa82 As System.Reflection.Emit.Label = checkCmtIL.DefineLabel()
Dim tru82 As System.Reflection.Emit.Label = checkCmtIL.DefineLabel()
Dim cont82 As System.Reflection.Emit.Label = checkCmtIL.DefineLabel()
checkCmtIL.Emit(OpCodes.Beq, tru82)
checkCmtIL.Emit(OpCodes.Br, fa82)
checkCmtIL.MarkLabel(tru82)
...
checkCmtIL.Emit(OpCodes.Br, cont82)
checkCmtIL.MarkLabel(fa82)
checkCmtIL.Emit(OpCodes.Br, cont82)
checkCmtIL.MarkLabel(cont82)
...
Typ = GetType(System.Int32)
Dim fa83 As System.Reflection.Emit.Label = checkEndMtdIL.DefineLabel()
Dim tru83 As System.Reflection.Emit.Label = checkEndMtdIL.DefineLabel()
Dim cont83 As System.Reflection.Emit.Label = checkEndMtdIL.DefineLabel()
checkEndMtdIL.Emit(OpCodes.Bge, tru83)
checkEndMtdIL.Emit(OpCodes.Br, fa83)
checkEndMtdIL.MarkLabel(tru83)
checkEndMtdIL.MarkSequencePoint(doc5, 57, 1, 57, 100)
Dim locbldr102 As LocalBuilder = checkEndMtdIL.DeclareLocal(GetType(Token))
locbldr102.SetLocalSymInfo("tok1")
checkEndMtdIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
checkEndMtdIL.Emit(OpCodes.Ldfld, GetType(Stmt).GetField("Tokens"))
Typ = GetType(Stmt).GetField("Tokens").FieldType
...
Dim locbldr103 As LocalBuilder = checkEndMtdIL.DeclareLocal(GetType(System.Type))
locbldr103.SetLocalSymInfo("typ1")
...
Dim locbldr104 As LocalBuilder = checkEndMtdIL.DeclareLocal(GetType(System.Boolean))
locbldr104.SetLocalSymInfo("b1")
Dim typ14(-1) As Type
...
Dim locbldr105 As LocalBuilder = checkEndMtdIL.DeclareLocal(GetType(Token))
locbldr105.SetLocalSymInfo("tok2")
checkEndMtdIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
checkEndMtdIL.Emit(OpCodes.Ldfld, GetType(Stmt).GetField("Tokens"))
Typ = GetType(Stmt).GetField("Tokens").FieldType
...
Dim locbldr106 As LocalBuilder = checkEndMtdIL.DeclareLocal(GetType(System.Type))
locbldr106.SetLocalSymInfo("typ2")
...
Dim locbldr107 As LocalBuilder = checkEndMtdIL.DeclareLocal(GetType(System.Boolean))
locbldr107.SetLocalSymInfo("b2")
Dim typ16(-1) As Type
...
Dim locbldr108 As LocalBuilder = checkEndMtdIL.DeclareLocal(GetType(EndMethodStmt))
locbldr108.SetLocalSymInfo("ems")
...
checkEndMtdIL.Emit(OpCodes.Beq, tru84)
...
checkEndMtdIL.Emit(OpCodes.Br, cont83)
checkEndMtdIL.MarkLabel(fa83)
checkEndMtdIL.Emit(OpCodes.Br, cont83)
checkEndMtdIL.MarkLabel(cont83)
...
Typ = GetType(System.Int32)
Dim fa85 As System.Reflection.Emit.Label = checkEndClsIL.DefineLabel()
Dim tru85 As System.Reflection.Emit.Label = checkEndClsIL.DefineLabel()
Dim cont85 As System.Reflection.Emit.Label = checkEndClsIL.DefineLabel()
checkEndClsIL.Emit(OpCodes.Bge, tru85)
checkEndClsIL.Emit(OpCodes.Br, fa85)
checkEndClsIL.MarkLabel(tru85)
checkEndClsIL.MarkSequencePoint(doc5, 79, 1, 79, 100)
Dim locbldr109 As LocalBuilder = checkEndClsIL.DeclareLocal(GetType(Token))
locbldr109.SetLocalSymInfo("tok1")
checkEndClsIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
checkEndClsIL.Emit(OpCodes.Ldfld, GetType(Stmt).GetField("Tokens"))
Typ = GetType(Stmt).GetField("Tokens").FieldType
...
Dim locbldr110 As LocalBuilder = checkEndClsIL.DeclareLocal(GetType(System.Type))
locbldr110.SetLocalSymInfo("typ1")
...
Dim locbldr111 As LocalBuilder = checkEndClsIL.DeclareLocal(GetType(System.Boolean))
locbldr111.SetLocalSymInfo("b1")
Dim typ19(-1) As Type
...
Dim locbldr112 As LocalBuilder = checkEndClsIL.DeclareLocal(GetType(Token))
...
Dim locbldr113 As LocalBuilder = checkEndClsIL.DeclareLocal(GetType(System.Type))
...
Dim locbldr114 As LocalBuilder = checkEndClsIL.DeclareLocal(GetType(System.Boolean))
...
Dim locbldr115 As LocalBuilder = checkEndClsIL.DeclareLocal(GetType(EndClassStmt))
locbldr115.SetLocalSymInfo("ecs")
...
checkEndClsIL.Emit(OpCodes.Beq, tru86)
...
checkEndClsIL.Emit(OpCodes.Br, cont85)
checkEndClsIL.MarkLabel(fa85)
checkEndClsIL.Emit(OpCodes.Br, cont85)
checkEndClsIL.MarkLabel(cont85)
...
Dim locbldr116 As LocalBuilder = checkAssemblyIL.DeclareLocal(GetType(Token))
...
Dim locbldr117 As LocalBuilder = checkAssemblyIL.DeclareLocal(GetType(System.Type))
...
Dim locbldr118 As LocalBuilder = checkAssemblyIL.DeclareLocal(GetType(AssemblyStmt))
locbldr118.SetLocalSymInfo("asms")
...
Typ = GetType(System.Boolean)
Dim fa87 As System.Reflection.Emit.Label = checkAssemblyIL.DefineLabel()
Dim tru87 As System.Reflection.Emit.Label = checkAssemblyIL.DefineLabel()
Dim cont87 As System.Reflection.Emit.Label = checkAssemblyIL.DefineLabel()
checkAssemblyIL.Emit(OpCodes.Beq, tru87)
checkAssemblyIL.Emit(OpCodes.Br, fa87)
checkAssemblyIL.MarkLabel(tru87)
...
checkAssemblyIL.Emit(OpCodes.Br, cont87)
checkAssemblyIL.MarkLabel(fa87)
checkAssemblyIL.Emit(OpCodes.Br, cont87)
checkAssemblyIL.MarkLabel(cont87)
...
Dim locbldr119 As LocalBuilder = checkVerIL.DeclareLocal(GetType(Token))
...
Dim locbldr120 As LocalBuilder = checkVerIL.DeclareLocal(GetType(System.Type))
...
Dim locbldr121 As LocalBuilder = checkVerIL.DeclareLocal(GetType(VerStmt))
locbldr121.SetLocalSymInfo("vers")
...
Typ = GetType(System.Boolean)
Dim fa88 As System.Reflection.Emit.Label = checkVerIL.DefineLabel()
Dim tru88 As System.Reflection.Emit.Label = checkVerIL.DefineLabel()
Dim cont88 As System.Reflection.Emit.Label = checkVerIL.DefineLabel()
checkVerIL.Emit(OpCodes.Beq, tru88)
checkVerIL.Emit(OpCodes.Br, fa88)
checkVerIL.MarkLabel(tru88)
...
Dim locbldr122 As LocalBuilder = checkVerIL.DeclareLocal(GetType(System.String).MakeArrayType())
locbldr122.SetLocalSymInfo("ars")
Dim typ28(-1) As Type
checkVerIL.Emit(OpCodes.Ldloc, 0)
Typ = GetType(Token)
...
Dim locbldr123 As LocalBuilder = checkVerIL.DeclareLocal(GetType(System.Int32).MakeArrayType())
locbldr123.SetLocalSymInfo("ari")
...
Dim locbldr124 As LocalBuilder = checkVerIL.DeclareLocal(GetType(IntLiteral).MakeArrayType())
locbldr124.SetLocalSymInfo("intla")
checkVerIL.Emit(OpCodes.Ldc_I4, CInt(4))
Typ = GetType(System.Int32)
checkVerIL.Emit(OpCodes.Conv_U)
...
Dim locbldr125 As LocalBuilder = checkVerIL.DeclareLocal(GetType(IntLiteral))
locbldr125.SetLocalSymInfo("intl")
...
checkVerIL.Emit(OpCodes.Br, cont88)
checkVerIL.MarkLabel(fa88)
checkVerIL.Emit(OpCodes.Br, cont88)
checkVerIL.MarkLabel(cont88)
...
Dim locbldr126 As LocalBuilder = checkClassIL.DeclareLocal(GetType(Token))
...
Dim locbldr127 As LocalBuilder = checkClassIL.DeclareLocal(GetType(System.Type))
...
Dim locbldr128 As LocalBuilder = checkClassIL.DeclareLocal(GetType(ClassStmt))
locbldr128.SetLocalSymInfo("clss")
...
Dim locbldr129 As LocalBuilder = checkClassIL.DeclareLocal(GetType(Attributes.Attribute))
locbldr129.SetLocalSymInfo("att")
...
Typ = GetType(System.Boolean)
Dim fa89 As System.Reflection.Emit.Label = checkClassIL.DefineLabel()
Dim tru89 As System.Reflection.Emit.Label = checkClassIL.DefineLabel()
Dim cont89 As System.Reflection.Emit.Label = checkClassIL.DefineLabel()
checkClassIL.Emit(OpCodes.Beq, tru89)
checkClassIL.Emit(OpCodes.Br, fa89)
checkClassIL.MarkLabel(tru89)
...
Dim locbldr130 As LocalBuilder = checkClassIL.DeclareLocal(GetType(System.Int32))
locbldr130.SetLocalSymInfo("i")
checkClassIL.Emit(OpCodes.Ldc_I4, CInt(0))
Typ = GetType(System.Int32)
checkClassIL.Emit(OpCodes.Stloc, 4)
checkClassIL.MarkSequencePoint(doc5, 165, 1, 165, 100)
Dim locbldr131 As LocalBuilder = checkClassIL.DeclareLocal(GetType(System.Int32))
...
Dim locbldr132 As LocalBuilder = checkClassIL.DeclareLocal(GetType(System.Boolean))
locbldr132.SetLocalSymInfo("bl")
...
Dim locbldr133 As LocalBuilder = checkClassIL.DeclareLocal(GetType(Token))
locbldr133.SetLocalSymInfo("tok2")
checkClassIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
checkClassIL.Emit(OpCodes.Ldfld, GetType(Stmt).GetField("Tokens"))
Typ = GetType(Stmt).GetField("Tokens").FieldType
...
Dim locbldr134 As LocalBuilder = checkClassIL.DeclareLocal(GetType(System.Type))
...
Dim locbldr135 As LocalBuilder = checkClassIL.DeclareLocal(GetType(System.Boolean))
locbldr135.SetLocalSymInfo("b2")
Dim typ44(-1) As Type
...
checkClassIL.Emit(OpCodes.Beq, fa92)
checkClassIL.Emit(OpCodes.Br, tru92)
checkClassIL.MarkLabel(tru92)
checkClassIL.MarkSequencePoint(doc5, 191, 1, 191, 100)
Dim locbldr136 As LocalBuilder = checkClassIL.DeclareLocal(GetType(Token))
locbldr136.SetLocalSymInfo("t")
checkClassIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
checkClassIL.Emit(OpCodes.Ldfld, GetType(Stmt).GetField("Tokens"))
Typ = GetType(Stmt).GetField("Tokens").FieldType
...
Dim locbldr137 As LocalBuilder = checkClassIL.DeclareLocal(GetType(TypeTok))
locbldr137.SetLocalSymInfo("tt")
...
checkClassIL.Emit(OpCodes.Beq, tru93)
checkClassIL.Emit(OpCodes.Br, fa93)
...
checkClassIL.Emit(OpCodes.Br, cont89)
checkClassIL.MarkLabel(fa89)
checkClassIL.Emit(OpCodes.Br, cont89)
checkClassIL.MarkLabel(cont89)
...
Dim locbldr138 As LocalBuilder = checkMethodIL.DeclareLocal(GetType(Token))
...
Dim locbldr139 As LocalBuilder = checkMethodIL.DeclareLocal(GetType(System.Type))
...
Dim locbldr140 As LocalBuilder = checkMethodIL.DeclareLocal(GetType(MethodStmt))
locbldr140.SetLocalSymInfo("mtss")
...
Dim locbldr141 As LocalBuilder = checkMethodIL.DeclareLocal(GetType(Attributes.Attribute))
locbldr141.SetLocalSymInfo("att")
...
Dim locbldr142 As LocalBuilder = checkMethodIL.DeclareLocal(GetType(Ident))
locbldr142.SetLocalSymInfo("mn")
...
Dim locbldr143 As LocalBuilder = checkMethodIL.DeclareLocal(GetType(Expr))
locbldr143.SetLocalSymInfo("exp")
checkMethodIL.Emit(OpCodes.Ldnull)
checkMethodIL.Emit(OpCodes.Stloc, 5)
checkMethodIL.MarkSequencePoint(doc5, 226, 1, 226, 100)
Dim locbldr144 As LocalBuilder = checkMethodIL.DeclareLocal(GetType(System.Boolean))
...
Typ = GetType(System.Boolean)
Dim fa94 As System.Reflection.Emit.Label = checkMethodIL.DefineLabel()
Dim tru94 As System.Reflection.Emit.Label = checkMethodIL.DefineLabel()
Dim cont94 As System.Reflection.Emit.Label = checkMethodIL.DefineLabel()
checkMethodIL.Emit(OpCodes.Beq, tru94)
checkMethodIL.Emit(OpCodes.Br, fa94)
checkMethodIL.MarkLabel(tru94)
...
Dim locbldr145 As LocalBuilder = checkMethodIL.DeclareLocal(GetType(System.Int32))
locbldr145.SetLocalSymInfo("i")
checkMethodIL.Emit(OpCodes.Ldc_I4, CInt(0))
Typ = GetType(System.Int32)
checkMethodIL.Emit(OpCodes.Stloc, 7)
checkMethodIL.MarkSequencePoint(doc5, 238, 1, 238, 100)
Dim locbldr146 As LocalBuilder = checkMethodIL.DeclareLocal(GetType(System.Int32))
...
Dim locbldr147 As LocalBuilder = checkMethodIL.DeclareLocal(GetType(System.Boolean))
locbldr147.SetLocalSymInfo("bl")
checkMethodIL.Emit(OpCodes.Ldc_I4, 0)
Typ = GetType(System.Boolean)
...
Dim locbldr148 As LocalBuilder = checkMethodIL.DeclareLocal(GetType(Token))
...
Dim locbldr149 As LocalBuilder = checkMethodIL.DeclareLocal(GetType(System.Type))
locbldr149.SetLocalSymInfo("typ2")
checkMethodIL.MarkSequencePoint(doc5, 272, 1, 272, 100)
Dim locbldr150 As LocalBuilder = checkMethodIL.DeclareLocal(GetType(System.Boolean))
locbldr150.SetLocalSymInfo("b2")
...
checkMethodIL.Emit(OpCodes.Beq, fa97)
checkMethodIL.Emit(OpCodes.Br, tru97)
checkMethodIL.MarkLabel(tru97)
checkMethodIL.MarkSequencePoint(doc5, 278, 1, 278, 100)
Dim locbldr151 As LocalBuilder = checkMethodIL.DeclareLocal(GetType(Token))
locbldr151.SetLocalSymInfo("t")
checkMethodIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
checkMethodIL.Emit(OpCodes.Ldfld, GetType(Stmt).GetField("Tokens"))
Typ = GetType(Stmt).GetField("Tokens").FieldType
...
Dim locbldr152 As LocalBuilder = checkMethodIL.DeclareLocal(GetType(TypeTok))
locbldr152.SetLocalSymInfo("tt")
...
checkMethodIL.Emit(OpCodes.Beq, tru98)
checkMethodIL.Emit(OpCodes.Br, fa98)
...
Dim locbldr153 As LocalBuilder = checkMethodIL.DeclareLocal(asm.GetType("dylan.NET.Tokenizer.Parser.ExprOptimizer"))
locbldr153.SetLocalSymInfo("eopt2")
...
Dim locbldr154 As LocalBuilder = checkMethodIL.DeclareLocal(asm.GetType("dylan.NET.Tokenizer.Parser.ExprOptimizer"))
locbldr154.SetLocalSymInfo("eopt1")
checkMethodIL.Emit(OpCodes.Newobj, asm.GetType("dylan.NET.Tokenizer.Parser.ExprOptimizer").GetConstructor(Type.EmptyTypes))
...
checkMethodIL.Emit(OpCodes.Br, cont94)
checkMethodIL.MarkLabel(fa94)
checkMethodIL.Emit(OpCodes.Br, cont94)
checkMethodIL.MarkLabel(cont94)
...
Typ = GetType(System.Int32)
Dim fa108 As System.Reflection.Emit.Label = checkMethodCallIL.DefineLabel()
Dim tru108 As System.Reflection.Emit.Label = checkMethodCallIL.DefineLabel()
Dim cont108 As System.Reflection.Emit.Label = checkMethodCallIL.DefineLabel()
checkMethodCallIL.Emit(OpCodes.Bgt, tru108)
checkMethodCallIL.Emit(OpCodes.Br, fa108)
checkMethodCallIL.MarkLabel(tru108)
checkMethodCallIL.MarkSequencePoint(doc5, 367, 1, 367, 100)
Dim locbldr155 As LocalBuilder = checkMethodCallIL.DeclareLocal(GetType(Token))
locbldr155.SetLocalSymInfo("tok")
checkMethodCallIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
checkMethodCallIL.Emit(OpCodes.Ldfld, GetType(Stmt).GetField("Tokens"))
Typ = GetType(Stmt).GetField("Tokens").FieldType
...
Dim locbldr156 As LocalBuilder = checkMethodCallIL.DeclareLocal(GetType(System.Type))
locbldr156.SetLocalSymInfo("typ")
...
locbldr157.SetLocalSymInfo("tokb")
checkMethodCallIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
checkMethodCallIL.Emit(OpCodes.Ldfld, GetType(Stmt).GetField("Tokens"))
Typ = GetType(Stmt).GetField("Tokens").FieldType
...
Dim locbldr159 As LocalBuilder = checkMethodCallIL.DeclareLocal(GetType(System.Boolean))
locbldr159.SetLocalSymInfo("ba")
Dim typ73(-1) As Type
...
Dim locbldr160 As LocalBuilder = checkMethodCallIL.DeclareLocal(GetType(System.Boolean))
locbldr160.SetLocalSymInfo("bb")
Dim typ74(-1) As Type
...
Dim locbldr161 As LocalBuilder = checkMethodCallIL.DeclareLocal(GetType(MethodCallStmt))
locbldr161.SetLocalSymInfo("mtcss")
...
Dim locbldr162 As LocalBuilder = checkMethodCallIL.DeclareLocal(GetType(MethodNameTok))
locbldr162.SetLocalSymInfo("mn")
...
Dim locbldr163 As LocalBuilder = checkMethodCallIL.DeclareLocal(GetType(MethodCallTok))
locbldr163.SetLocalSymInfo("mct")
...
Dim locbldr164 As LocalBuilder = checkMethodCallIL.DeclareLocal(GetType(Ident))
locbldr164.SetLocalSymInfo("idt")
...
Dim locbldr165 As LocalBuilder = checkMethodCallIL.DeclareLocal(GetType(Expr))
locbldr165.SetLocalSymInfo("exp")
...
Dim locbldr166 As LocalBuilder = checkMethodCallIL.DeclareLocal(GetType(System.Int32))
locbldr166.SetLocalSymInfo("lvl")
checkMethodCallIL.Emit(OpCodes.Ldc_I4, CInt(1))
Typ = GetType(System.Int32)
...
checkMethodCallIL.Emit(OpCodes.Beq, tru109)
...
Dim locbldr169 As LocalBuilder = checkMethodCallIL.DeclareLocal(GetType(Token))
...
Dim locbldr170 As LocalBuilder = checkMethodCallIL.DeclareLocal(GetType(System.Type))
locbldr170.SetLocalSymInfo("typ2")
checkMethodCallIL.MarkSequencePoint(doc5, 396, 1, 396, 100)
Dim locbldr171 As LocalBuilder = checkMethodCallIL.DeclareLocal(GetType(System.Boolean))
locbldr171.SetLocalSymInfo("b2")
checkMethodCallIL.MarkSequencePoint(doc5, 397, 1, 397, 100)
Dim locbldr172 As LocalBuilder = checkMethodCallIL.DeclareLocal(GetType(System.Int32))
...
checkMethodCallIL.Emit(OpCodes.Br, cont108)
checkMethodCallIL.MarkLabel(fa108)
checkMethodCallIL.Emit(OpCodes.Br, cont108)
checkMethodCallIL.MarkLabel(cont108)
...
Dim locbldr173 As LocalBuilder = checkVarAsIL.DeclareLocal(GetType(Token))
...
Dim locbldr174 As LocalBuilder = checkVarAsIL.DeclareLocal(GetType(System.Type))
...
Dim locbldr175 As LocalBuilder = checkVarAsIL.DeclareLocal(GetType(VarStmt))
locbldr175.SetLocalSymInfo("vars")
...
checkVarAsIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa117 As System.Reflection.Emit.Label = checkVarAsIL.DefineLabel()
Dim tru117 As System.Reflection.Emit.Label = checkVarAsIL.DefineLabel()
Dim cont117 As System.Reflection.Emit.Label = checkVarAsIL.DefineLabel()
checkVarAsIL.Emit(OpCodes.Beq, tru117)
checkVarAsIL.Emit(OpCodes.Br, fa117)
checkVarAsIL.MarkLabel(tru117)
...
Dim locbldr176 As LocalBuilder = checkVarAsIL.DeclareLocal(GetType(Token))
locbldr176.SetLocalSymInfo("tok2")
checkVarAsIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
checkVarAsIL.Emit(OpCodes.Ldfld, GetType(Stmt).GetField("Tokens"))
Typ = GetType(Stmt).GetField("Tokens").FieldType
...
Dim locbldr177 As LocalBuilder = checkVarAsIL.DeclareLocal(GetType(System.Type))
locbldr177.SetLocalSymInfo("typ2")
checkVarAsIL.Emit(OpCodes.Ldtoken, GetType(TypeTok))
...
Dim locbldr178 As LocalBuilder = checkVarAsIL.DeclareLocal(GetType(System.Boolean))
locbldr178.SetLocalSymInfo("b2")
Dim typ88(-1) As Type
checkVarAsIL.Emit(OpCodes.Ldloc, 4)
Typ = GetType(System.Type)
Typ03 = Typ
...
checkVarAsIL.Emit(OpCodes.Beq, fa118)
checkVarAsIL.Emit(OpCodes.Br, tru118)
checkVarAsIL.MarkLabel(tru118)
checkVarAsIL.MarkSequencePoint(doc5, 487, 1, 487, 100)
Dim locbldr179 As LocalBuilder = checkVarAsIL.DeclareLocal(GetType(Token))
locbldr179.SetLocalSymInfo("t")
checkVarAsIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
checkVarAsIL.Emit(OpCodes.Ldfld, GetType(Stmt).GetField("Tokens"))
Typ = GetType(Stmt).GetField("Tokens").FieldType
...
Dim locbldr180 As LocalBuilder = checkVarAsIL.DeclareLocal(GetType(TypeTok))
locbldr180.SetLocalSymInfo("tt")
checkVarAsIL.Emit(OpCodes.Newobj, GetType(TypeTok).GetConstructor(Type.EmptyTypes))
checkVarAsIL.Emit(OpCodes.Stloc, 7)
...
checkVarAsIL.Emit(OpCodes.Br, cont117)
checkVarAsIL.MarkLabel(fa117)
checkVarAsIL.Emit(OpCodes.Br, cont117)
checkVarAsIL.MarkLabel(cont117)
...
Dim locbldr181 As LocalBuilder = AssOptIL.DeclareLocal(GetType(AssignStmt))
locbldr181.SetLocalSymInfo("asss")
AssOptIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
AssOptIL.Emit(OpCodes.Stloc, 0)
AssOptIL.MarkSequencePoint(doc5, 503, 1, 503, 100)
Dim locbldr182 As LocalBuilder = AssOptIL.DeclareLocal(GetType(Expr))
locbldr182.SetLocalSymInfo("le")
...
Dim locbldr183 As LocalBuilder = AssOptIL.DeclareLocal(GetType(Token))
...
Dim locbldr184 As LocalBuilder = AssOptIL.DeclareLocal(GetType(System.Type))
...
Dim locbldr185 As LocalBuilder = AssOptIL.DeclareLocal(GetType(System.Boolean))
...
Dim locbldr186 As LocalBuilder = AssOptIL.DeclareLocal(GetType(VarAsgnStmt))
locbldr186.SetLocalSymInfo("vass")
...
Typ = GetType(System.Boolean)
Dim fa119 As System.Reflection.Emit.Label = AssOptIL.DefineLabel()
Dim tru119 As System.Reflection.Emit.Label = AssOptIL.DefineLabel()
Dim cont119 As System.Reflection.Emit.Label = AssOptIL.DefineLabel()
AssOptIL.Emit(OpCodes.Beq, tru119)
AssOptIL.Emit(OpCodes.Br, fa119)
AssOptIL.MarkLabel(tru119)
...
Dim locbldr187 As LocalBuilder = AssOptIL.DeclareLocal(GetType(Token))
locbldr187.SetLocalSymInfo("tok2")
AssOptIL.Emit(OpCodes.Ldloc, 1)
Typ = GetType(Expr)
AssOptIL.Emit(OpCodes.Ldfld, GetType(Expr).GetField("Tokens"))
Typ = GetType(Expr).GetField("Tokens").FieldType
...
Dim locbldr188 As LocalBuilder = AssOptIL.DeclareLocal(GetType(System.Type))
locbldr188.SetLocalSymInfo("typ2")
...
Dim locbldr189 As LocalBuilder = AssOptIL.DeclareLocal(GetType(System.Boolean))
locbldr189.SetLocalSymInfo("b2")
Dim typ93(-1) As Type
...
AssOptIL.Emit(OpCodes.Beq, fa120)
AssOptIL.Emit(OpCodes.Br, tru120)
AssOptIL.MarkLabel(tru120)
AssOptIL.MarkSequencePoint(doc5, 518, 1, 518, 100)
Dim locbldr190 As LocalBuilder = AssOptIL.DeclareLocal(GetType(Token))
locbldr190.SetLocalSymInfo("t")
AssOptIL.Emit(OpCodes.Ldloc, 1)
Typ = GetType(Expr)
AssOptIL.Emit(OpCodes.Ldfld, GetType(Expr).GetField("Tokens"))
Typ = GetType(Expr).GetField("Tokens").FieldType
...
Dim locbldr191 As LocalBuilder = AssOptIL.DeclareLocal(GetType(TypeTok))
locbldr191.SetLocalSymInfo("tt")
...
AssOptIL.Emit(OpCodes.Br, cont119)
AssOptIL.MarkLabel(fa119)
AssOptIL.MarkSequencePoint(doc5, 531, 1, 531, 100)
AssOptIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
AssOptIL.MarkSequencePoint(doc5, 532, 1, 532, 100)
AssOptIL.Emit(OpCodes.Br, cont119)
AssOptIL.MarkLabel(cont119)
AssOptIL.MarkSequencePoint(doc5, 534, 1, 534, 100)
AssOptIL.Emit(OpCodes.Ret)
Dim typ94(-1) As Type
ReDim Preserve typ94(UBound(typ94) + 1)
typ94(UBound(typ94)) = GetType(Stmt)
ReDim Preserve typ94(UBound(typ94) + 1)
typ94(UBound(typ94)) = GetType(System.Boolean).MakeByRefType()
Dim checkAssign As MethodBuilder = StmtOptimizer.DefineMethod("checkAssign", MethodAttributes.Public, GetType(Stmt), typ94)
...
checkAssignIL.MarkSequencePoint(doc5, 537, 1, 537, 100)
Dim locbldr192 As LocalBuilder = checkAssignIL.DeclareLocal(GetType(Token))
locbldr192.SetLocalSymInfo("tok")
checkAssignIL.Emit(OpCodes.Ldnull)
checkAssignIL.Emit(OpCodes.Stloc, 0)
checkAssignIL.MarkSequencePoint(doc5, 538, 1, 538, 100)
Dim locbldr193 As LocalBuilder = checkAssignIL.DeclareLocal(GetType(System.Type))
...
checkAssignIL.Emit(OpCodes.Call, GetType(System.Type).GetMethod("GetTypeFromHandle", typ95))
...
Dim locbldr194 As LocalBuilder = checkAssignIL.DeclareLocal(GetType(AssignStmt))
locbldr194.SetLocalSymInfo("asss")
...
Dim locbldr195 As LocalBuilder = checkAssignIL.DeclareLocal(GetType(System.Boolean))
locbldr195.SetLocalSymInfo("c")
checkAssignIL.Emit(OpCodes.Ldc_I4, 0)
Typ = GetType(System.Boolean)
checkAssignIL.Emit(OpCodes.Stloc, 3)
checkAssignIL.MarkSequencePoint(doc5, 541, 1, 541, 100)
Dim locbldr196 As LocalBuilder = checkAssignIL.DeclareLocal(GetType(Expr))
locbldr196.SetLocalSymInfo("re")
...
Dim locbldr197 As LocalBuilder = checkAssignIL.DeclareLocal(GetType(Expr))
locbldr197.SetLocalSymInfo("le")
checkAssignIL.Emit(OpCodes.Newobj, GetType(Expr).GetConstructor(Type.EmptyTypes))
checkAssignIL.Emit(OpCodes.Stloc, 5)
checkAssignIL.MarkSequencePoint(doc5, 543, 1, 543, 100)
Dim locbldr198 As LocalBuilder = checkAssignIL.DeclareLocal(GetType(System.Int32))
locbldr198.SetLocalSymInfo("i")
...
Dim locbldr199 As LocalBuilder = checkAssignIL.DeclareLocal(GetType(System.Int32))
...
Dim locbldr200 As LocalBuilder = checkAssignIL.DeclareLocal(GetType(System.Int32))
locbldr200.SetLocalSymInfo("assind")
...
checkAssignIL.MarkSequencePoint(doc5, 548, 1, 548, 100)
...
Typ = Typ.GetElementType()
checkAssignIL.Emit(OpCodes.Stloc, 0)
checkAssignIL.MarkSequencePoint(doc5, 555, 1, 555, 100)
Dim typ96(-1) As Type
...
checkAssignIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("IsInstanceOfType", typ96))
...
Typ = GetType(System.Boolean)
Dim fa121 As System.Reflection.Emit.Label = checkAssignIL.DefineLabel()
Dim tru121 As System.Reflection.Emit.Label = checkAssignIL.DefineLabel()
Dim cont121 As System.Reflection.Emit.Label = checkAssignIL.DefineLabel()
checkAssignIL.Emit(OpCodes.Beq, tru121)
checkAssignIL.Emit(OpCodes.Br, fa121)
checkAssignIL.MarkLabel(tru121)
checkAssignIL.MarkSequencePoint(doc5, 558, 1, 558, 100)
checkAssignIL.Emit(OpCodes.Ldloc, 6)
Typ = GetType(System.Int32)
checkAssignIL.Emit(OpCodes.Stloc, 8)
...
checkAssignIL.Emit(OpCodes.Br, cont121)
checkAssignIL.MarkLabel(fa121)
checkAssignIL.Emit(OpCodes.Br, cont121)
checkAssignIL.MarkLabel(cont121)
...
checkAssignIL.Emit(OpCodes.Beq, fa123)
checkAssignIL.Emit(OpCodes.Br, tru123)
...
checkAssignIL.MarkSequencePoint(doc5, 576, 1, 576, 100)
...
ReDim Preserve typ97(UBound(typ97) + 1)
typ97(UBound(typ97)) = Typ
checkAssignIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("AddToken", typ97))
Typ = Typ03.GetMethod("AddToken", typ97).ReturnType
If Typ.ToString() = GetType(System.Void).ToString() Then
...
checkAssignIL.Emit(OpCodes.Beq, tru124)
checkAssignIL.Emit(OpCodes.Br, fa124)
...
Typ = GetType(System.Int32)
checkAssignIL.Emit(OpCodes.Stloc, 6)
checkAssignIL.MarkSequencePoint(doc5, 594, 1, 594, 100)
checkAssignIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
checkAssignIL.Emit(OpCodes.Ldfld, GetType(Stmt).GetField("Tokens"))
Typ = GetType(Stmt).GetField("Tokens").FieldType
...
checkAssignIL.MarkSequencePoint(doc5, 597, 1, 597, 100)
...
checkAssignIL.MarkSequencePoint(doc5, 606, 1, 606, 100)
...
checkAssignIL.MarkSequencePoint(doc5, 614, 1, 614, 100)
checkAssignIL.Emit(OpCodes.Ldloc, 2)
Typ = GetType(AssignStmt)
checkAssignIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
...
checkAssignIL.MarkSequencePoint(doc5, 625, 1, 625, 100)
checkAssignIL.Emit(OpCodes.Ldarg, 2)
Typ = GetType(System.Boolean).MakeByRefType()
Typ04 = Typ.GetElementType()
checkAssignIL.Emit(OpCodes.Ldc_I4, 0)
...
Dim Optimize As MethodBuilder = StmtOptimizer.DefineMethod("Optimize", MethodAttributes.Public, GetType(Stmt), typ100)
Dim OptimizeIL As ILGenerator = Optimize.GetILGenerator()
Dim Optimizeparam00 As ParameterBuilder = Optimize.DefineParameter(0, ParameterAttributes.RetVal, "")
Dim Optimizeparam01 As ParameterBuilder = Optimize.DefineParameter(1, ParameterAttributes.None, "stm")
OptimizeIL.MarkSequencePoint(doc5, 634, 1, 634, 100)
Dim typ101(-1) As Type
OptimizeIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
...
ReDim Preserve typ101(UBound(typ101) + 1)
typ101(UBound(typ101)) = Typ
OptimizeIL.Emit(OpCodes.Call, GetType(Console).GetMethod("WriteLine", typ101))
Typ = GetType(Console).GetMethod("WriteLine", typ101).ReturnType
If Typ.ToString() = GetType(System.Void).ToString() Then
...
Typ = GetType(System.Int32)
OptimizeIL.Emit(OpCodes.Stloc, 0)
OptimizeIL.MarkSequencePoint(doc5, 637, 1, 637, 100)
...
Dim locbldr203 As LocalBuilder = OptimizeIL.DeclareLocal(asm.GetType("dylan.NET.Tokenizer.Parser.TokenOptimizer"))
locbldr203.SetLocalSymInfo("to")
OptimizeIL.Emit(OpCodes.Ldnull)
OptimizeIL.Emit(OpCodes.Stloc, 2)
OptimizeIL.MarkSequencePoint(doc5, 639, 1, 639, 100)
Dim locbldr204 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(Stmt))
locbldr204.SetLocalSymInfo("tmpstm")
OptimizeIL.Emit(OpCodes.Ldnull)
OptimizeIL.Emit(OpCodes.Stloc, 3)
OptimizeIL.MarkSequencePoint(doc5, 640, 1, 640, 100)
Dim locbldr205 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(System.Boolean))
locbldr205.SetLocalSymInfo("compb")
OptimizeIL.Emit(OpCodes.Ldc_I4, 0)
Typ = GetType(System.Boolean)
OptimizeIL.Emit(OpCodes.Stloc, 4)
...
Typ = GetType(System.Boolean)
OptimizeIL.Emit(OpCodes.Stsfld, asm.GetType("dylan.NET.Tokenizer.Parser.ParserFlags").GetField("IfFlag"))
OptimizeIL.MarkSequencePoint(doc5, 644, 1, 644, 100)
OptimizeIL.Emit(OpCodes.Ldc_I4, 0)
Typ = GetType(System.Boolean)
OptimizeIL.Emit(OpCodes.Stsfld, asm.GetType("dylan.NET.Tokenizer.Parser.ParserFlags").GetField("CmtFlag"))
...
OptimizeIL.MarkSequencePoint(doc5, 648, 1, 648, 100)
...
OptimizeIL.MarkSequencePoint(doc5, 652, 1, 652, 100)
...
ReDim Preserve typ102(UBound(typ102) + 1)
typ102(UBound(typ102)) = Typ
OptimizeIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("Optimize", typ102))
Typ = Typ03.GetMethod("Optimize", typ102).ReturnType
Typ = Typ02
...
OptimizeIL.MarkSequencePoint(doc5, 672, 1, 672, 100)
OptimizeIL.Emit(OpCodes.Br, label17)
...
OptimizeIL.MarkSequencePoint(doc5, 680, 1, 680, 100)
...
OptimizeIL.MarkSequencePoint(doc5, 693, 1, 693, 100)
OptimizeIL.Emit(OpCodes.Ldloc, 3)
Typ = GetType(Stmt)
OptimizeIL.Emit(OpCodes.Starg, 1)
...
Dim locbldr206 As LocalBuilder = ParseIL.DeclareLocal(GetType(System.Int32))
locbldr206.SetLocalSymInfo("i")
ParseIL.Emit(OpCodes.Ldc_I4, CInt(-1))
Typ = GetType(System.Int32)
ParseIL.Emit(OpCodes.Stloc, 0)
ParseIL.MarkSequencePoint(doc6, 5, 1, 5, 100)
Dim locbldr207 As LocalBuilder = ParseIL.DeclareLocal(asm.GetType("dylan.NET.Tokenizer.Parser.StmtOptimizer"))
locbldr207.SetLocalSymInfo("so")
ParseIL.Emit(OpCodes.Ldnull)
ParseIL.Emit(OpCodes.Stloc, 1)
ParseIL.MarkSequencePoint(doc6, 6, 1, 6, 100)
Dim locbldr208 As LocalBuilder = ParseIL.DeclareLocal(GetType(System.Int32))
...
ParseIL.Emit(OpCodes.Ldloc, 2)
Typ = GetType(System.Int32)
Dim fa144 As System.Reflection.Emit.Label = ParseIL.DefineLabel()
Dim tru144 As System.Reflection.Emit.Label = ParseIL.DefineLabel()
Dim cont144 As System.Reflection.Emit.Label = ParseIL.DefineLabel()
ParseIL.Emit(OpCodes.Beq, tru144)
ParseIL.Emit(OpCodes.Br, fa144)
ParseIL.MarkLabel(tru144)
ParseIL.MarkSequencePoint(doc6, 19, 1, 19, 100)
ParseIL.Emit(OpCodes.Br, label1)
ParseIL.MarkSequencePoint(doc6, 20, 1, 20, 100)
ParseIL.Emit(OpCodes.Br, cont144)
ParseIL.MarkLabel(fa144)
ParseIL.MarkSequencePoint(doc6, 21, 1, 21, 100)
ParseIL.Emit(OpCodes.Br, label0)
ParseIL.MarkSequencePoint(doc6, 22, 1, 22, 100)
ParseIL.Emit(OpCodes.Br, cont144)
ParseIL.MarkLabel(cont144)
