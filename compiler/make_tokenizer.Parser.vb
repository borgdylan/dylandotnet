...
Dim locbldr81 As LocalBuilder = checkRefasmIL.DeclareLocal(GetType(Token))
locbldr81.SetLocalSymInfo("tok")
...
Dim locbldr82 As LocalBuilder = checkRefasmIL.DeclareLocal(GetType(System.Type))
locbldr82.SetLocalSymInfo("typ")
...
Dim locbldr83 As LocalBuilder = checkRefasmIL.DeclareLocal(GetType(RefasmStmt))
locbldr83.SetLocalSymInfo("refasms")
...
Typ = GetType(System.Boolean)
Dim fa76 As System.Reflection.Emit.Label = checkRefasmIL.DefineLabel()
Dim tru76 As System.Reflection.Emit.Label = checkRefasmIL.DefineLabel()
Dim cont76 As System.Reflection.Emit.Label = checkRefasmIL.DefineLabel()
checkRefasmIL.Emit(OpCodes.Beq, tru76)
checkRefasmIL.Emit(OpCodes.Br, fa76)
checkRefasmIL.MarkLabel(tru76)
...
checkRefasmIL.Emit(OpCodes.Br, cont76)
checkRefasmIL.MarkLabel(fa76)
checkRefasmIL.Emit(OpCodes.Br, cont76)
checkRefasmIL.MarkLabel(cont76)
...
Dim locbldr84 As LocalBuilder = checkImportIL.DeclareLocal(GetType(Token))
locbldr84.SetLocalSymInfo("tok")
...
Dim locbldr85 As LocalBuilder = checkImportIL.DeclareLocal(GetType(System.Type))
locbldr85.SetLocalSymInfo("typ")
...
Dim locbldr86 As LocalBuilder = checkImportIL.DeclareLocal(GetType(ImportStmt))
locbldr86.SetLocalSymInfo("imps")
...
Typ = GetType(System.Boolean)
Dim fa77 As System.Reflection.Emit.Label = checkImportIL.DefineLabel()
Dim tru77 As System.Reflection.Emit.Label = checkImportIL.DefineLabel()
Dim cont77 As System.Reflection.Emit.Label = checkImportIL.DefineLabel()
checkImportIL.Emit(OpCodes.Beq, tru77)
checkImportIL.Emit(OpCodes.Br, fa77)
checkImportIL.MarkLabel(tru77)
...
checkImportIL.Emit(OpCodes.Br, cont77)
checkImportIL.MarkLabel(fa77)
checkImportIL.Emit(OpCodes.Br, cont77)
checkImportIL.MarkLabel(cont77)
...
Dim locbldr87 As LocalBuilder = checkLocimportIL.DeclareLocal(GetType(Token))
locbldr87.SetLocalSymInfo("tok")
...
Dim locbldr88 As LocalBuilder = checkLocimportIL.DeclareLocal(GetType(System.Type))
...
Dim locbldr89 As LocalBuilder = checkLocimportIL.DeclareLocal(GetType(LocimportStmt))
locbldr89.SetLocalSymInfo("limps")
...
Typ = GetType(System.Boolean)
Dim fa78 As System.Reflection.Emit.Label = checkLocimportIL.DefineLabel()
Dim tru78 As System.Reflection.Emit.Label = checkLocimportIL.DefineLabel()
Dim cont78 As System.Reflection.Emit.Label = checkLocimportIL.DefineLabel()
checkLocimportIL.Emit(OpCodes.Beq, tru78)
checkLocimportIL.Emit(OpCodes.Br, fa78)
checkLocimportIL.MarkLabel(tru78)
...
checkLocimportIL.Emit(OpCodes.Br, cont78)
checkLocimportIL.MarkLabel(fa78)
checkLocimportIL.Emit(OpCodes.Br, cont78)
checkLocimportIL.MarkLabel(cont78)
...
Dim locbldr90 As LocalBuilder = checkAssemblyIL.DeclareLocal(GetType(Token))
...
Dim locbldr91 As LocalBuilder = checkAssemblyIL.DeclareLocal(GetType(System.Type))
...
Dim locbldr92 As LocalBuilder = checkAssemblyIL.DeclareLocal(GetType(AssemblyStmt))
locbldr92.SetLocalSymInfo("asms")
...
Typ = GetType(System.Boolean)
Dim fa79 As System.Reflection.Emit.Label = checkAssemblyIL.DefineLabel()
Dim tru79 As System.Reflection.Emit.Label = checkAssemblyIL.DefineLabel()
Dim cont79 As System.Reflection.Emit.Label = checkAssemblyIL.DefineLabel()
checkAssemblyIL.Emit(OpCodes.Beq, tru79)
checkAssemblyIL.Emit(OpCodes.Br, fa79)
checkAssemblyIL.MarkLabel(tru79)
...
checkAssemblyIL.Emit(OpCodes.Br, cont79)
checkAssemblyIL.MarkLabel(fa79)
checkAssemblyIL.Emit(OpCodes.Br, cont79)
checkAssemblyIL.MarkLabel(cont79)
...
Dim checkVarAs As MethodBuilder = StmtOptimizer.DefineMethod("checkVarAs", MethodAttributes.Public, GetType(Stmt), typ12)
...
checkVarAsIL.MarkSequencePoint(doc4, 57, 1, 57, 100)
...
checkVarAsIL.MarkSequencePoint(doc4, 58, 1, 58, 100)
...
checkVarAsIL.Emit(OpCodes.Call, GetType(System.Type).GetMethod("GetTypeFromHandle", typ13))
Typ = GetType(System.Type).GetMethod("GetTypeFromHandle", typ13).ReturnType
checkVarAsIL.Emit(OpCodes.Stloc, 1)
checkVarAsIL.MarkSequencePoint(doc4, 59, 1, 59, 100)
...
ReDim Preserve typ14(UBound(typ14) + 1)
typ14(UBound(typ14)) = Typ
checkVarAsIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("IsInstanceOfType", typ14))
Typ = Typ03.GetMethod("IsInstanceOfType", typ14).ReturnType
checkVarAsIL.Emit(OpCodes.Stobj, Typ04)
checkVarAsIL.MarkSequencePoint(doc4, 60, 1, 60, 100)
Dim locbldr95 As LocalBuilder = checkVarAsIL.DeclareLocal(GetType(VarStmt))
...
checkVarAsIL.MarkSequencePoint(doc4, 62, 1, 62, 100)
checkVarAsIL.Emit(OpCodes.Ldarg, 2)
Typ = GetType(System.Boolean).MakeByRefType()
...
Typ = GetType(System.Boolean)
Dim fa80 As System.Reflection.Emit.Label = checkVarAsIL.DefineLabel()
Dim tru80 As System.Reflection.Emit.Label = checkVarAsIL.DefineLabel()
Dim cont80 As System.Reflection.Emit.Label = checkVarAsIL.DefineLabel()
checkVarAsIL.Emit(OpCodes.Beq, tru80)
checkVarAsIL.Emit(OpCodes.Br, fa80)
checkVarAsIL.MarkLabel(tru80)
checkVarAsIL.MarkSequencePoint(doc4, 63, 1, 63, 100)
...
checkVarAsIL.MarkSequencePoint(doc4, 64, 1, 64, 100)
checkVarAsIL.Emit(OpCodes.Ldloc, 2)
Typ = GetType(VarStmt)
checkVarAsIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
...
checkVarAsIL.MarkSequencePoint(doc4, 65, 1, 65, 100)
checkVarAsIL.Emit(OpCodes.Ldloc, 2)
Typ = GetType(VarStmt)
checkVarAsIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
...
checkVarAsIL.MarkSequencePoint(doc4, 67, 1, 67, 100)
...
checkVarAsIL.MarkSequencePoint(doc4, 68, 1, 68, 100)
...
checkVarAsIL.Emit(OpCodes.Call, GetType(System.Type).GetMethod("GetTypeFromHandle", typ15))
Typ = GetType(System.Type).GetMethod("GetTypeFromHandle", typ15).ReturnType
checkVarAsIL.Emit(OpCodes.Stloc, 4)
checkVarAsIL.MarkSequencePoint(doc4, 69, 1, 69, 100)
...
ReDim Preserve typ16(UBound(typ16) + 1)
typ16(UBound(typ16)) = Typ
checkVarAsIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("IsInstanceOfType", typ16))
Typ = Typ03.GetMethod("IsInstanceOfType", typ16).ReturnType
checkVarAsIL.Emit(OpCodes.Stloc, 5)
checkVarAsIL.MarkSequencePoint(doc4, 71, 1, 71, 100)
checkVarAsIL.Emit(OpCodes.Ldloc, 5)
Typ = GetType(System.Boolean)
checkVarAsIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa81 As System.Reflection.Emit.Label = checkVarAsIL.DefineLabel()
Dim tru81 As System.Reflection.Emit.Label = checkVarAsIL.DefineLabel()
Dim cont81 As System.Reflection.Emit.Label = checkVarAsIL.DefineLabel()
checkVarAsIL.Emit(OpCodes.Beq, fa81)
checkVarAsIL.Emit(OpCodes.Br, tru81)
checkVarAsIL.MarkLabel(tru81)
checkVarAsIL.MarkSequencePoint(doc4, 72, 1, 72, 100)
...
checkVarAsIL.MarkSequencePoint(doc4, 73, 1, 73, 100)
...
checkVarAsIL.MarkSequencePoint(doc4, 74, 1, 74, 100)
...
checkVarAsIL.MarkSequencePoint(doc4, 75, 1, 75, 100)
checkVarAsIL.Emit(OpCodes.Ldloc, 7)
Typ = GetType(TypeTok)
checkVarAsIL.Emit(OpCodes.Ldloc, 6)
Typ = GetType(Token)
...
checkVarAsIL.MarkSequencePoint(doc4, 76, 1, 76, 100)
checkVarAsIL.Emit(OpCodes.Ldloc, 2)
Typ = GetType(VarStmt)
checkVarAsIL.Emit(OpCodes.Ldloc, 7)
Typ = GetType(TypeTok)
checkVarAsIL.Emit(OpCodes.Stfld, GetType(VarStmt).GetField("VarTyp"))
checkVarAsIL.MarkSequencePoint(doc4, 77, 1, 77, 100)
checkVarAsIL.Emit(OpCodes.Br, cont81)
checkVarAsIL.MarkLabel(fa81)
checkVarAsIL.MarkSequencePoint(doc4, 78, 1, 78, 100)
checkVarAsIL.Emit(OpCodes.Ldloc, 2)
Typ = GetType(VarStmt)
checkVarAsIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
...
Typ = Typ.GetElementType()
checkVarAsIL.Emit(OpCodes.Stfld, GetType(VarStmt).GetField("VarTyp"))
checkVarAsIL.MarkSequencePoint(doc4, 79, 1, 79, 100)
checkVarAsIL.Emit(OpCodes.Br, cont81)
checkVarAsIL.MarkLabel(cont81)
checkVarAsIL.MarkSequencePoint(doc4, 81, 1, 81, 100)
checkVarAsIL.Emit(OpCodes.Br, cont80)
checkVarAsIL.MarkLabel(fa80)
checkVarAsIL.Emit(OpCodes.Br, cont80)
checkVarAsIL.MarkLabel(cont80)
checkVarAsIL.MarkSequencePoint(doc4, 82, 1, 82, 100)
checkVarAsIL.Emit(OpCodes.Ldloc, 2)
Typ = GetType(VarStmt)
checkVarAsIL.MarkSequencePoint(doc4, 83, 1, 83, 100)
checkVarAsIL.Emit(OpCodes.Ret)
Dim typ17(-1) As Type
ReDim Preserve typ17(UBound(typ17) + 1)
typ17(UBound(typ17)) = GetType(Stmt)
Dim AssOpt As MethodBuilder = StmtOptimizer.DefineMethod("AssOpt", MethodAttributes.Public, GetType(Stmt), typ17)
...
AssOptIL.MarkSequencePoint(doc4, 87, 1, 87, 100)
Dim locbldr101 As LocalBuilder = AssOptIL.DeclareLocal(GetType(AssignStmt))
locbldr101.SetLocalSymInfo("asss")
AssOptIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
AssOptIL.Emit(OpCodes.Stloc, 0)
AssOptIL.MarkSequencePoint(doc4, 88, 1, 88, 100)
Dim locbldr102 As LocalBuilder = AssOptIL.DeclareLocal(GetType(Expr))
locbldr102.SetLocalSymInfo("le")
...
AssOptIL.MarkSequencePoint(doc4, 89, 1, 89, 100)
Dim locbldr103 As LocalBuilder = AssOptIL.DeclareLocal(GetType(Token))
locbldr103.SetLocalSymInfo("tok")
...
AssOptIL.MarkSequencePoint(doc4, 90, 1, 90, 100)
Dim locbldr104 As LocalBuilder = AssOptIL.DeclareLocal(GetType(System.Type))
...
AssOptIL.Emit(OpCodes.Call, GetType(System.Type).GetMethod("GetTypeFromHandle", typ18))
Typ = GetType(System.Type).GetMethod("GetTypeFromHandle", typ18).ReturnType
AssOptIL.Emit(OpCodes.Stloc, 3)
AssOptIL.MarkSequencePoint(doc4, 91, 1, 91, 100)
Dim locbldr105 As LocalBuilder = AssOptIL.DeclareLocal(GetType(System.Boolean))
...
ReDim Preserve typ19(UBound(typ19) + 1)
typ19(UBound(typ19)) = Typ
AssOptIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("IsInstanceOfType", typ19))
Typ = Typ03.GetMethod("IsInstanceOfType", typ19).ReturnType
AssOptIL.Emit(OpCodes.Stloc, 4)
AssOptIL.MarkSequencePoint(doc4, 92, 1, 92, 100)
Dim locbldr106 As LocalBuilder = AssOptIL.DeclareLocal(GetType(VarAsgnStmt))
locbldr106.SetLocalSymInfo("vass")
AssOptIL.Emit(OpCodes.Newobj, GetType(VarAsgnStmt).GetConstructor(Type.EmptyTypes))
AssOptIL.Emit(OpCodes.Stloc, 5)
AssOptIL.MarkSequencePoint(doc4, 93, 1, 93, 100)
AssOptIL.Emit(OpCodes.Ldloc, 4)
Typ = GetType(System.Boolean)
AssOptIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa82 As System.Reflection.Emit.Label = AssOptIL.DefineLabel()
Dim tru82 As System.Reflection.Emit.Label = AssOptIL.DefineLabel()
Dim cont82 As System.Reflection.Emit.Label = AssOptIL.DefineLabel()
AssOptIL.Emit(OpCodes.Beq, tru82)
AssOptIL.Emit(OpCodes.Br, fa82)
AssOptIL.MarkLabel(tru82)
AssOptIL.MarkSequencePoint(doc4, 94, 1, 94, 100)
...
AssOptIL.MarkSequencePoint(doc4, 95, 1, 95, 100)
AssOptIL.Emit(OpCodes.Ldloc, 5)
Typ = GetType(VarAsgnStmt)
AssOptIL.Emit(OpCodes.Ldloc, 0)
Typ = GetType(AssignStmt)
...
AssOptIL.MarkSequencePoint(doc4, 96, 1, 96, 100)
AssOptIL.Emit(OpCodes.Ldloc, 5)
Typ = GetType(VarAsgnStmt)
AssOptIL.Emit(OpCodes.Ldloc, 1)
Typ = GetType(Expr)
...
AssOptIL.MarkSequencePoint(doc4, 98, 1, 98, 100)
Dim locbldr107 As LocalBuilder = AssOptIL.DeclareLocal(GetType(Token))
...
AssOptIL.MarkSequencePoint(doc4, 99, 1, 99, 100)
Dim locbldr108 As LocalBuilder = AssOptIL.DeclareLocal(GetType(System.Type))
...
AssOptIL.Emit(OpCodes.Call, GetType(System.Type).GetMethod("GetTypeFromHandle", typ20))
Typ = GetType(System.Type).GetMethod("GetTypeFromHandle", typ20).ReturnType
AssOptIL.Emit(OpCodes.Stloc, 7)
AssOptIL.MarkSequencePoint(doc4, 100, 1, 100, 100)
Dim locbldr109 As LocalBuilder = AssOptIL.DeclareLocal(GetType(System.Boolean))
...
ReDim Preserve typ21(UBound(typ21) + 1)
typ21(UBound(typ21)) = Typ
AssOptIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("IsInstanceOfType", typ21))
Typ = Typ03.GetMethod("IsInstanceOfType", typ21).ReturnType
AssOptIL.Emit(OpCodes.Stloc, 8)
AssOptIL.MarkSequencePoint(doc4, 102, 1, 102, 100)
AssOptIL.Emit(OpCodes.Ldloc, 8)
Typ = GetType(System.Boolean)
AssOptIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa83 As System.Reflection.Emit.Label = AssOptIL.DefineLabel()
Dim tru83 As System.Reflection.Emit.Label = AssOptIL.DefineLabel()
Dim cont83 As System.Reflection.Emit.Label = AssOptIL.DefineLabel()
AssOptIL.Emit(OpCodes.Beq, fa83)
AssOptIL.Emit(OpCodes.Br, tru83)
AssOptIL.MarkLabel(tru83)
AssOptIL.MarkSequencePoint(doc4, 103, 1, 103, 100)
Dim locbldr110 As LocalBuilder = AssOptIL.DeclareLocal(GetType(Token))
...
AssOptIL.MarkSequencePoint(doc4, 104, 1, 104, 100)
Dim locbldr111 As LocalBuilder = AssOptIL.DeclareLocal(GetType(TypeTok))
...
AssOptIL.MarkSequencePoint(doc4, 105, 1, 105, 100)
...
AssOptIL.MarkSequencePoint(doc4, 106, 1, 106, 100)
AssOptIL.Emit(OpCodes.Ldloc, 10)
Typ = GetType(TypeTok)
AssOptIL.Emit(OpCodes.Ldloc, 9)
Typ = GetType(Token)
...
AssOptIL.MarkSequencePoint(doc4, 107, 1, 107, 100)
AssOptIL.Emit(OpCodes.Ldloc, 5)
Typ = GetType(VarAsgnStmt)
AssOptIL.Emit(OpCodes.Ldloc, 10)
Typ = GetType(TypeTok)
AssOptIL.Emit(OpCodes.Stfld, GetType(VarAsgnStmt).GetField("VarTyp"))
AssOptIL.MarkSequencePoint(doc4, 108, 1, 108, 100)
AssOptIL.Emit(OpCodes.Br, cont83)
AssOptIL.MarkLabel(fa83)
AssOptIL.MarkSequencePoint(doc4, 109, 1, 109, 100)
AssOptIL.Emit(OpCodes.Ldloc, 5)
Typ = GetType(VarAsgnStmt)
AssOptIL.Emit(OpCodes.Ldloc, 1)
Typ = GetType(Expr)
...
Typ = Typ.GetElementType()
AssOptIL.Emit(OpCodes.Stfld, GetType(VarAsgnStmt).GetField("VarTyp"))
AssOptIL.MarkSequencePoint(doc4, 110, 1, 110, 100)
AssOptIL.Emit(OpCodes.Br, cont83)
AssOptIL.MarkLabel(cont83)
AssOptIL.MarkSequencePoint(doc4, 112, 1, 112, 100)
AssOptIL.Emit(OpCodes.Ldloc, 5)
Typ = GetType(VarAsgnStmt)
AssOptIL.Emit(OpCodes.Ldloc, 0)
Typ = GetType(AssignStmt)
...
AssOptIL.MarkSequencePoint(doc4, 114, 1, 114, 100)
AssOptIL.Emit(OpCodes.Ldloc, 5)
Typ = GetType(VarAsgnStmt)
AssOptIL.MarkSequencePoint(doc4, 115, 1, 115, 100)
AssOptIL.Emit(OpCodes.Br, cont82)
AssOptIL.MarkLabel(fa82)
AssOptIL.MarkSequencePoint(doc4, 116, 1, 116, 100)
AssOptIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
AssOptIL.MarkSequencePoint(doc4, 117, 1, 117, 100)
AssOptIL.Emit(OpCodes.Br, cont82)
AssOptIL.MarkLabel(cont82)
AssOptIL.MarkSequencePoint(doc4, 119, 1, 119, 100)
...
Dim checkAssign As MethodBuilder = StmtOptimizer.DefineMethod("checkAssign", MethodAttributes.Public, GetType(Stmt), typ22)
...
checkAssignIL.MarkSequencePoint(doc4, 122, 1, 122, 100)
Dim locbldr112 As LocalBuilder = checkAssignIL.DeclareLocal(GetType(Token))
locbldr112.SetLocalSymInfo("tok")
checkAssignIL.Emit(OpCodes.Ldnull)
checkAssignIL.Emit(OpCodes.Stloc, 0)
checkAssignIL.MarkSequencePoint(doc4, 123, 1, 123, 100)
Dim locbldr113 As LocalBuilder = checkAssignIL.DeclareLocal(GetType(System.Type))
...
checkAssignIL.Emit(OpCodes.Call, GetType(System.Type).GetMethod("GetTypeFromHandle", typ23))
Typ = GetType(System.Type).GetMethod("GetTypeFromHandle", typ23).ReturnType
checkAssignIL.Emit(OpCodes.Stloc, 1)
checkAssignIL.MarkSequencePoint(doc4, 124, 1, 124, 100)
Dim locbldr114 As LocalBuilder = checkAssignIL.DeclareLocal(GetType(AssignStmt))
...
checkAssignIL.MarkSequencePoint(doc4, 125, 1, 125, 100)
Dim locbldr115 As LocalBuilder = checkAssignIL.DeclareLocal(GetType(System.Boolean))
locbldr115.SetLocalSymInfo("c")
checkAssignIL.Emit(OpCodes.Ldc_I4, 0)
Typ = GetType(System.Boolean)
checkAssignIL.Emit(OpCodes.Stloc, 3)
checkAssignIL.MarkSequencePoint(doc4, 126, 1, 126, 100)
Dim locbldr116 As LocalBuilder = checkAssignIL.DeclareLocal(GetType(Expr))
locbldr116.SetLocalSymInfo("re")
checkAssignIL.Emit(OpCodes.Newobj, GetType(Expr).GetConstructor(Type.EmptyTypes))
checkAssignIL.Emit(OpCodes.Stloc, 4)
checkAssignIL.MarkSequencePoint(doc4, 127, 1, 127, 100)
Dim locbldr117 As LocalBuilder = checkAssignIL.DeclareLocal(GetType(Expr))
locbldr117.SetLocalSymInfo("le")
checkAssignIL.Emit(OpCodes.Newobj, GetType(Expr).GetConstructor(Type.EmptyTypes))
checkAssignIL.Emit(OpCodes.Stloc, 5)
checkAssignIL.MarkSequencePoint(doc4, 128, 1, 128, 100)
Dim locbldr118 As LocalBuilder = checkAssignIL.DeclareLocal(GetType(System.Int32))
locbldr118.SetLocalSymInfo("i")
checkAssignIL.Emit(OpCodes.Ldc_I4, CInt(-1))
Typ = GetType(System.Int32)
checkAssignIL.Emit(OpCodes.Stloc, 6)
checkAssignIL.MarkSequencePoint(doc4, 129, 1, 129, 100)
Dim locbldr119 As LocalBuilder = checkAssignIL.DeclareLocal(GetType(System.Int32))
...
checkAssignIL.MarkSequencePoint(doc4, 130, 1, 130, 100)
Dim locbldr120 As LocalBuilder = checkAssignIL.DeclareLocal(GetType(System.Int32))
locbldr120.SetLocalSymInfo("assind")
checkAssignIL.Emit(OpCodes.Ldc_I4, CInt(0))
Typ = GetType(System.Int32)
checkAssignIL.Emit(OpCodes.Stloc, 8)
checkAssignIL.MarkSequencePoint(doc4, 132, 1, 132, 100)
Dim label0 As System.Reflection.Emit.Label = checkAssignIL.DefineLabel()
checkAssignIL.MarkSequencePoint(doc4, 133, 1, 133, 100)
Dim label1 As System.Reflection.Emit.Label = checkAssignIL.DefineLabel()
checkAssignIL.MarkSequencePoint(doc4, 135, 1, 135, 100)
checkAssignIL.MarkLabel(label0)
checkAssignIL.MarkSequencePoint(doc4, 137, 1, 137, 100)
...
checkAssignIL.Emit(OpCodes.Stloc, 6)
checkAssignIL.MarkSequencePoint(doc4, 139, 1, 139, 100)
checkAssignIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
checkAssignIL.Emit(OpCodes.Ldfld, GetType(Stmt).GetField("Tokens"))
Typ = GetType(Stmt).GetField("Tokens").FieldType
...
Typ = Typ.GetElementType()
checkAssignIL.Emit(OpCodes.Stloc, 0)
checkAssignIL.MarkSequencePoint(doc4, 140, 1, 140, 100)
Dim typ24(-1) As Type
...
ReDim Preserve typ24(UBound(typ24) + 1)
typ24(UBound(typ24)) = Typ
checkAssignIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("IsInstanceOfType", typ24))
Typ = Typ03.GetMethod("IsInstanceOfType", typ24).ReturnType
checkAssignIL.Emit(OpCodes.Stloc, 3)
checkAssignIL.MarkSequencePoint(doc4, 142, 1, 142, 100)
checkAssignIL.Emit(OpCodes.Ldloc, 3)
Typ = GetType(System.Boolean)
checkAssignIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa84 As System.Reflection.Emit.Label = checkAssignIL.DefineLabel()
Dim tru84 As System.Reflection.Emit.Label = checkAssignIL.DefineLabel()
Dim cont84 As System.Reflection.Emit.Label = checkAssignIL.DefineLabel()
checkAssignIL.Emit(OpCodes.Beq, tru84)
checkAssignIL.Emit(OpCodes.Br, fa84)
checkAssignIL.MarkLabel(tru84)
checkAssignIL.MarkSequencePoint(doc4, 143, 1, 143, 100)
checkAssignIL.Emit(OpCodes.Ldloc, 6)
Typ = GetType(System.Int32)
checkAssignIL.Emit(OpCodes.Stloc, 8)
checkAssignIL.MarkSequencePoint(doc4, 144, 1, 144, 100)
checkAssignIL.Emit(OpCodes.Br, label1)
checkAssignIL.MarkSequencePoint(doc4, 145, 1, 145, 100)
checkAssignIL.Emit(OpCodes.Br, cont84)
checkAssignIL.MarkLabel(fa84)
checkAssignIL.Emit(OpCodes.Br, cont84)
checkAssignIL.MarkLabel(cont84)
checkAssignIL.MarkSequencePoint(doc4, 147, 1, 147, 100)
checkAssignIL.Emit(OpCodes.Ldloc, 6)
Typ = GetType(System.Int32)
checkAssignIL.Emit(OpCodes.Ldloc, 7)
Typ = GetType(System.Int32)
Dim fa85 As System.Reflection.Emit.Label = checkAssignIL.DefineLabel()
Dim tru85 As System.Reflection.Emit.Label = checkAssignIL.DefineLabel()
Dim cont85 As System.Reflection.Emit.Label = checkAssignIL.DefineLabel()
checkAssignIL.Emit(OpCodes.Beq, tru85)
checkAssignIL.Emit(OpCodes.Br, fa85)
checkAssignIL.MarkLabel(tru85)
checkAssignIL.MarkSequencePoint(doc4, 148, 1, 148, 100)
checkAssignIL.Emit(OpCodes.Br, label1)
checkAssignIL.MarkSequencePoint(doc4, 149, 1, 149, 100)
checkAssignIL.Emit(OpCodes.Br, cont85)
checkAssignIL.MarkLabel(fa85)
checkAssignIL.MarkSequencePoint(doc4, 150, 1, 150, 100)
checkAssignIL.Emit(OpCodes.Br, label0)
checkAssignIL.MarkSequencePoint(doc4, 151, 1, 151, 100)
checkAssignIL.Emit(OpCodes.Br, cont85)
checkAssignIL.MarkLabel(cont85)
checkAssignIL.MarkSequencePoint(doc4, 153, 1, 153, 100)
checkAssignIL.MarkLabel(label1)
checkAssignIL.MarkSequencePoint(doc4, 155, 1, 155, 100)
checkAssignIL.Emit(OpCodes.Ldloc, 8)
Typ = GetType(System.Int32)
checkAssignIL.Emit(OpCodes.Ldc_I4, CInt(0))
Typ = GetType(System.Int32)
Dim fa86 As System.Reflection.Emit.Label = checkAssignIL.DefineLabel()
Dim tru86 As System.Reflection.Emit.Label = checkAssignIL.DefineLabel()
Dim cont86 As System.Reflection.Emit.Label = checkAssignIL.DefineLabel()
checkAssignIL.Emit(OpCodes.Beq, fa86)
checkAssignIL.Emit(OpCodes.Br, tru86)
checkAssignIL.MarkLabel(tru86)
checkAssignIL.MarkSequencePoint(doc4, 157, 1, 157, 100)
checkAssignIL.Emit(OpCodes.Ldc_I4, CInt(-1))
Typ = GetType(System.Int32)
checkAssignIL.Emit(OpCodes.Stloc, 6)
checkAssignIL.MarkSequencePoint(doc4, 158, 1, 158, 100)
checkAssignIL.Emit(OpCodes.Ldloc, 8)
Typ = GetType(System.Int32)
checkAssignIL.Emit(OpCodes.Ldc_I4, CInt(1))
Typ = GetType(System.Int32)
checkAssignIL.Emit(OpCodes.Sub)
checkAssignIL.Emit(OpCodes.Stloc, 7)
checkAssignIL.MarkSequencePoint(doc4, 160, 1, 160, 100)
Dim label2 As System.Reflection.Emit.Label = checkAssignIL.DefineLabel()
checkAssignIL.MarkSequencePoint(doc4, 161, 1, 161, 100)
Dim label3 As System.Reflection.Emit.Label = checkAssignIL.DefineLabel()
checkAssignIL.MarkSequencePoint(doc4, 163, 1, 163, 100)
checkAssignIL.MarkLabel(label2)
checkAssignIL.MarkSequencePoint(doc4, 165, 1, 165, 100)
checkAssignIL.Emit(OpCodes.Ldloc, 6)
Typ = GetType(System.Int32)
checkAssignIL.Emit(OpCodes.Ldc_I4, CInt(1))
Typ = GetType(System.Int32)
checkAssignIL.Emit(OpCodes.Add)
checkAssignIL.Emit(OpCodes.Stloc, 6)
checkAssignIL.MarkSequencePoint(doc4, 167, 1, 167, 100)
Dim typ25(-1) As Type
...
ReDim Preserve typ25(UBound(typ25) + 1)
typ25(UBound(typ25)) = Typ
checkAssignIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("AddToken", typ25))
Typ = Typ03.GetMethod("AddToken", typ25).ReturnType
If Typ.ToString() = GetType(System.Void).ToString() Then

Else
checkAssignIL.Emit(OpCodes.Pop)
End If
checkAssignIL.MarkSequencePoint(doc4, 169, 1, 169, 100)
checkAssignIL.Emit(OpCodes.Ldloc, 6)
Typ = GetType(System.Int32)
checkAssignIL.Emit(OpCodes.Ldloc, 7)
Typ = GetType(System.Int32)
Dim fa87 As System.Reflection.Emit.Label = checkAssignIL.DefineLabel()
Dim tru87 As System.Reflection.Emit.Label = checkAssignIL.DefineLabel()
Dim cont87 As System.Reflection.Emit.Label = checkAssignIL.DefineLabel()
checkAssignIL.Emit(OpCodes.Beq, tru87)
checkAssignIL.Emit(OpCodes.Br, fa87)
checkAssignIL.MarkLabel(tru87)
checkAssignIL.MarkSequencePoint(doc4, 170, 1, 170, 100)
checkAssignIL.Emit(OpCodes.Br, label3)
checkAssignIL.MarkSequencePoint(doc4, 171, 1, 171, 100)
checkAssignIL.Emit(OpCodes.Br, cont87)
checkAssignIL.MarkLabel(fa87)
checkAssignIL.MarkSequencePoint(doc4, 172, 1, 172, 100)
checkAssignIL.Emit(OpCodes.Br, label2)
checkAssignIL.MarkSequencePoint(doc4, 173, 1, 173, 100)
checkAssignIL.Emit(OpCodes.Br, cont87)
checkAssignIL.MarkLabel(cont87)
checkAssignIL.MarkSequencePoint(doc4, 175, 1, 175, 100)
checkAssignIL.MarkLabel(label3)
checkAssignIL.MarkSequencePoint(doc4, 178, 1, 178, 100)
checkAssignIL.Emit(OpCodes.Ldloc, 8)
Typ = GetType(System.Int32)
checkAssignIL.Emit(OpCodes.Stloc, 6)
checkAssignIL.MarkSequencePoint(doc4, 179, 1, 179, 100)
checkAssignIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
checkAssignIL.Emit(OpCodes.Ldfld, GetType(Stmt).GetField("Tokens"))
Typ = GetType(Stmt).GetField("Tokens").FieldType
...
checkAssignIL.Emit(OpCodes.Sub)
checkAssignIL.Emit(OpCodes.Stloc, 7)
checkAssignIL.MarkSequencePoint(doc4, 181, 1, 181, 100)
Dim label4 As System.Reflection.Emit.Label = checkAssignIL.DefineLabel()
checkAssignIL.MarkSequencePoint(doc4, 182, 1, 182, 100)
Dim label5 As System.Reflection.Emit.Label = checkAssignIL.DefineLabel()
checkAssignIL.MarkSequencePoint(doc4, 184, 1, 184, 100)
checkAssignIL.MarkLabel(label4)
checkAssignIL.MarkSequencePoint(doc4, 186, 1, 186, 100)
checkAssignIL.Emit(OpCodes.Ldloc, 6)
Typ = GetType(System.Int32)
checkAssignIL.Emit(OpCodes.Ldc_I4, CInt(1))
Typ = GetType(System.Int32)
checkAssignIL.Emit(OpCodes.Add)
checkAssignIL.Emit(OpCodes.Stloc, 6)
checkAssignIL.MarkSequencePoint(doc4, 188, 1, 188, 100)
Dim typ26(-1) As Type
...
ReDim Preserve typ26(UBound(typ26) + 1)
typ26(UBound(typ26)) = Typ
checkAssignIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("AddToken", typ26))
Typ = Typ03.GetMethod("AddToken", typ26).ReturnType
If Typ.ToString() = GetType(System.Void).ToString() Then
...
checkAssignIL.Emit(OpCodes.Ldloc, 7)
Typ = GetType(System.Int32)
Dim fa88 As System.Reflection.Emit.Label = checkAssignIL.DefineLabel()
Dim tru88 As System.Reflection.Emit.Label = checkAssignIL.DefineLabel()
Dim cont88 As System.Reflection.Emit.Label = checkAssignIL.DefineLabel()
checkAssignIL.Emit(OpCodes.Beq, tru88)
checkAssignIL.Emit(OpCodes.Br, fa88)
checkAssignIL.MarkLabel(tru88)
...
checkAssignIL.Emit(OpCodes.Br, cont88)
checkAssignIL.MarkLabel(fa88)
...
checkAssignIL.Emit(OpCodes.Br, cont88)
checkAssignIL.MarkLabel(cont88)
...
checkAssignIL.MarkSequencePoint(doc4, 199, 1, 199, 100)
checkAssignIL.Emit(OpCodes.Ldloc, 2)
Typ = GetType(AssignStmt)
checkAssignIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
...
checkAssignIL.Emit(OpCodes.Ldloc, 2)
Typ = GetType(AssignStmt)
checkAssignIL.MarkSequencePoint(doc4, 209, 1, 209, 100)
checkAssignIL.Emit(OpCodes.Br, cont86)
checkAssignIL.MarkLabel(fa86)
...
checkAssignIL.Emit(OpCodes.Br, cont86)
checkAssignIL.MarkLabel(cont86)
checkAssignIL.MarkSequencePoint(doc4, 215, 1, 215, 100)
checkAssignIL.Emit(OpCodes.Ret)
Dim typ28(-1) As Type
ReDim Preserve typ28(UBound(typ28) + 1)
typ28(UBound(typ28)) = GetType(Stmt)
Dim Optimize As MethodBuilder = StmtOptimizer.DefineMethod("Optimize", MethodAttributes.Public, GetType(Stmt), typ28)
Dim OptimizeIL As ILGenerator = Optimize.GetILGenerator()
Dim Optimizeparam00 As ParameterBuilder = Optimize.DefineParameter(0, ParameterAttributes.RetVal, "")
...
ReDim Preserve typ29(UBound(typ29) + 1)
typ29(UBound(typ29)) = Typ
OptimizeIL.Emit(OpCodes.Call, GetType(Console).GetMethod("WriteLine", typ29))
...
locbldr121.SetLocalSymInfo("i")
OptimizeIL.Emit(OpCodes.Ldc_I4, CInt(-1))
Typ = GetType(System.Int32)
OptimizeIL.Emit(OpCodes.Stloc, 0)
OptimizeIL.MarkSequencePoint(doc4, 222, 1, 222, 100)
Dim locbldr122 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(System.Int32))
...
Dim locbldr123 As LocalBuilder = OptimizeIL.DeclareLocal(asm.GetType("tokenizer.Parser.TokenOptimizer"))
locbldr123.SetLocalSymInfo("to")
OptimizeIL.Emit(OpCodes.Ldnull)
OptimizeIL.Emit(OpCodes.Stloc, 2)
OptimizeIL.MarkSequencePoint(doc4, 224, 1, 224, 100)
Dim locbldr124 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(Stmt))
locbldr124.SetLocalSymInfo("tmpstm")
OptimizeIL.Emit(OpCodes.Ldnull)
OptimizeIL.Emit(OpCodes.Stloc, 3)
OptimizeIL.MarkSequencePoint(doc4, 225, 1, 225, 100)
Dim locbldr125 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(System.Boolean))
locbldr125.SetLocalSymInfo("compb")
OptimizeIL.Emit(OpCodes.Ldc_I4, 0)
Typ = GetType(System.Boolean)
OptimizeIL.Emit(OpCodes.Stloc, 4)
...
OptimizeIL.Emit(OpCodes.Blt, tru89)
...
ReDim Preserve typ30(UBound(typ30) + 1)
typ30(UBound(typ30)) = Typ
OptimizeIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("Optimize", typ30))
Typ = Typ03.GetMethod("Optimize", typ30).ReturnType
Typ = Typ02
...
Dim locbldr126 As LocalBuilder = ParseIL.DeclareLocal(GetType(System.Int32))
locbldr126.SetLocalSymInfo("i")
ParseIL.Emit(OpCodes.Ldc_I4, CInt(-1))
Typ = GetType(System.Int32)
ParseIL.Emit(OpCodes.Stloc, 0)
ParseIL.MarkSequencePoint(doc5, 5, 1, 5, 100)
Dim locbldr127 As LocalBuilder = ParseIL.DeclareLocal(asm.GetType("tokenizer.Parser.StmtOptimizer"))
locbldr127.SetLocalSymInfo("so")
ParseIL.Emit(OpCodes.Ldnull)
ParseIL.Emit(OpCodes.Stloc, 1)
ParseIL.MarkSequencePoint(doc5, 6, 1, 6, 100)
Dim locbldr128 As LocalBuilder = ParseIL.DeclareLocal(GetType(System.Int32))
...
ParseIL.Emit(OpCodes.Ldloc, 2)
Typ = GetType(System.Int32)
Dim fa100 As System.Reflection.Emit.Label = ParseIL.DefineLabel()
Dim tru100 As System.Reflection.Emit.Label = ParseIL.DefineLabel()
Dim cont100 As System.Reflection.Emit.Label = ParseIL.DefineLabel()
ParseIL.Emit(OpCodes.Beq, tru100)
ParseIL.Emit(OpCodes.Br, fa100)
ParseIL.MarkLabel(tru100)
ParseIL.MarkSequencePoint(doc5, 19, 1, 19, 100)
ParseIL.Emit(OpCodes.Br, label1)
ParseIL.MarkSequencePoint(doc5, 20, 1, 20, 100)
ParseIL.Emit(OpCodes.Br, cont100)
ParseIL.MarkLabel(fa100)
ParseIL.MarkSequencePoint(doc5, 21, 1, 21, 100)
ParseIL.Emit(OpCodes.Br, label0)
ParseIL.MarkSequencePoint(doc5, 22, 1, 22, 100)
ParseIL.Emit(OpCodes.Br, cont100)
ParseIL.MarkLabel(cont100)
