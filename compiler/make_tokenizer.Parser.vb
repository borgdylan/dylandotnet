...
checkAssemblyIL.MarkSequencePoint(doc5, 43, 1, 43, 100)
Dim locbldr99 As LocalBuilder = checkAssemblyIL.DeclareLocal(GetType(Token))
...
checkAssemblyIL.MarkSequencePoint(doc5, 44, 1, 44, 100)
Dim locbldr100 As LocalBuilder = checkAssemblyIL.DeclareLocal(GetType(System.Type))
...
checkAssemblyIL.MarkSequencePoint(doc5, 45, 1, 45, 100)
...
checkAssemblyIL.MarkSequencePoint(doc5, 46, 1, 46, 100)
Dim locbldr101 As LocalBuilder = checkAssemblyIL.DeclareLocal(GetType(AssemblyStmt))
locbldr101.SetLocalSymInfo("asms")
...
checkAssemblyIL.MarkSequencePoint(doc5, 47, 1, 47, 100)
checkAssemblyIL.Emit(OpCodes.Ldarg, 2)
Typ = GetType(System.Boolean).MakeByRefType()
...
Typ = GetType(System.Boolean)
Dim fa82 As System.Reflection.Emit.Label = checkAssemblyIL.DefineLabel()
Dim tru82 As System.Reflection.Emit.Label = checkAssemblyIL.DefineLabel()
Dim cont82 As System.Reflection.Emit.Label = checkAssemblyIL.DefineLabel()
checkAssemblyIL.Emit(OpCodes.Beq, tru82)
checkAssemblyIL.Emit(OpCodes.Br, fa82)
checkAssemblyIL.MarkLabel(tru82)
checkAssemblyIL.MarkSequencePoint(doc5, 48, 1, 48, 100)
...
checkAssemblyIL.MarkSequencePoint(doc5, 49, 1, 49, 100)
checkAssemblyIL.Emit(OpCodes.Ldloc, 2)
Typ = GetType(AssemblyStmt)
checkAssemblyIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
...
checkAssemblyIL.MarkSequencePoint(doc5, 50, 1, 50, 100)
checkAssemblyIL.Emit(OpCodes.Ldloc, 2)
Typ = GetType(AssemblyStmt)
checkAssemblyIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
...
checkAssemblyIL.MarkSequencePoint(doc5, 51, 1, 51, 100)
checkAssemblyIL.Emit(OpCodes.Ldloc, 2)
Typ = GetType(AssemblyStmt)
checkAssemblyIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
...
checkAssemblyIL.MarkSequencePoint(doc5, 52, 1, 52, 100)
checkAssemblyIL.Emit(OpCodes.Br, cont82)
checkAssemblyIL.MarkLabel(fa82)
checkAssemblyIL.Emit(OpCodes.Br, cont82)
checkAssemblyIL.MarkLabel(cont82)
checkAssemblyIL.MarkSequencePoint(doc5, 53, 1, 53, 100)
checkAssemblyIL.Emit(OpCodes.Ldloc, 2)
Typ = GetType(AssemblyStmt)
checkAssemblyIL.MarkSequencePoint(doc5, 54, 1, 54, 100)
...
checkVerIL.MarkSequencePoint(doc5, 57, 1, 57, 100)
Dim locbldr102 As LocalBuilder = checkVerIL.DeclareLocal(GetType(Token))
locbldr102.SetLocalSymInfo("tok")
...
checkVerIL.MarkSequencePoint(doc5, 58, 1, 58, 100)
Dim locbldr103 As LocalBuilder = checkVerIL.DeclareLocal(GetType(System.Type))
...
checkVerIL.MarkSequencePoint(doc5, 59, 1, 59, 100)
...
checkVerIL.MarkSequencePoint(doc5, 60, 1, 60, 100)
Dim locbldr104 As LocalBuilder = checkVerIL.DeclareLocal(GetType(VerStmt))
locbldr104.SetLocalSymInfo("vers")
checkVerIL.Emit(OpCodes.Newobj, GetType(VerStmt).GetConstructor(Type.EmptyTypes))
checkVerIL.Emit(OpCodes.Stloc, 2)
checkVerIL.MarkSequencePoint(doc5, 61, 1, 61, 100)
checkVerIL.Emit(OpCodes.Ldarg, 2)
Typ = GetType(System.Boolean).MakeByRefType()
...
Typ = GetType(System.Boolean)
Dim fa83 As System.Reflection.Emit.Label = checkVerIL.DefineLabel()
Dim tru83 As System.Reflection.Emit.Label = checkVerIL.DefineLabel()
Dim cont83 As System.Reflection.Emit.Label = checkVerIL.DefineLabel()
checkVerIL.Emit(OpCodes.Beq, tru83)
checkVerIL.Emit(OpCodes.Br, fa83)
checkVerIL.MarkLabel(tru83)
checkVerIL.MarkSequencePoint(doc5, 62, 1, 62, 100)
...
checkVerIL.MarkSequencePoint(doc5, 63, 1, 63, 100)
checkVerIL.Emit(OpCodes.Ldloc, 2)
Typ = GetType(VerStmt)
checkVerIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
...
checkVerIL.MarkSequencePoint(doc5, 64, 1, 64, 100)
checkVerIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
checkVerIL.Emit(OpCodes.Ldfld, GetType(Stmt).GetField("Tokens"))
Typ = GetType(Stmt).GetField("Tokens").FieldType
...
Typ = Typ.GetElementType()
checkVerIL.Emit(OpCodes.Stloc, 0)
checkVerIL.MarkSequencePoint(doc5, 65, 1, 65, 100)
Dim locbldr105 As LocalBuilder = checkVerIL.DeclareLocal(GetType(System.String).MakeArrayType())
locbldr105.SetLocalSymInfo("ars")
Dim typ15(-1) As Type
checkVerIL.Emit(OpCodes.Ldloc, 0)
Typ = GetType(Token)
...
checkVerIL.MarkSequencePoint(doc5, 66, 1, 66, 100)
Dim locbldr106 As LocalBuilder = checkVerIL.DeclareLocal(GetType(System.Int32).MakeArrayType())
locbldr106.SetLocalSymInfo("ari")
checkVerIL.Emit(OpCodes.Ldc_I4, CInt(4))
Typ = GetType(System.Int32)
checkVerIL.Emit(OpCodes.Conv_U)
checkVerIL.Emit(OpCodes.Newarr, GetType(System.Int32))
checkVerIL.Emit(OpCodes.Stloc, 4)
checkVerIL.MarkSequencePoint(doc5, 67, 1, 67, 100)
...
checkVerIL.MarkSequencePoint(doc5, 68, 1, 68, 100)
checkVerIL.Emit(OpCodes.Ldloc, 4)
Typ = GetType(System.Int32).MakeArrayType()
Typ02 = Typ
checkVerIL.Emit(OpCodes.Ldc_I4, CInt(1))
...
checkVerIL.Emit(OpCodes.Stelem, GetType(System.Int32).MakeArrayType().GetElementType())
checkVerIL.MarkSequencePoint(doc5, 69, 1, 69, 100)
checkVerIL.Emit(OpCodes.Ldloc, 4)
Typ = GetType(System.Int32).MakeArrayType()
Typ02 = Typ
...
checkVerIL.Emit(OpCodes.Stelem, GetType(System.Int32).MakeArrayType().GetElementType())
checkVerIL.MarkSequencePoint(doc5, 70, 1, 70, 100)
checkVerIL.Emit(OpCodes.Ldloc, 4)
Typ = GetType(System.Int32).MakeArrayType()
Typ02 = Typ
...
checkVerIL.Emit(OpCodes.Stelem, GetType(System.Int32).MakeArrayType().GetElementType())
checkVerIL.MarkSequencePoint(doc5, 71, 1, 71, 100)
Dim locbldr107 As LocalBuilder = checkVerIL.DeclareLocal(GetType(IntLiteral).MakeArrayType())
locbldr107.SetLocalSymInfo("intla")
checkVerIL.Emit(OpCodes.Ldc_I4, CInt(4))
Typ = GetType(System.Int32)
checkVerIL.Emit(OpCodes.Conv_U)
checkVerIL.Emit(OpCodes.Newarr, GetType(IntLiteral))
checkVerIL.Emit(OpCodes.Stloc, 5)
checkVerIL.MarkSequencePoint(doc5, 72, 1, 72, 100)
Dim locbldr108 As LocalBuilder = checkVerIL.DeclareLocal(GetType(IntLiteral))
locbldr108.SetLocalSymInfo("intl")
checkVerIL.Emit(OpCodes.Ldnull)
checkVerIL.Emit(OpCodes.Stloc, 6)
checkVerIL.MarkSequencePoint(doc5, 73, 1, 73, 100)
Dim typ20(-1) As Type
checkVerIL.Emit(OpCodes.Ldloc, 3)
Typ = GetType(System.String).MakeArrayType()
Typ02 = Typ
...
checkVerIL.Emit(OpCodes.Stloc, 6)
checkVerIL.MarkSequencePoint(doc5, 74, 1, 74, 100)
...
checkVerIL.MarkSequencePoint(doc5, 75, 1, 75, 100)
checkVerIL.Emit(OpCodes.Ldloc, 6)
Typ = GetType(IntLiteral)
checkVerIL.Emit(OpCodes.Ldloc, 4)
Typ = GetType(System.Int32).MakeArrayType()
...
checkVerIL.MarkSequencePoint(doc5, 76, 1, 76, 100)
...
checkVerIL.MarkSequencePoint(doc5, 77, 1, 77, 100)
Dim typ21(-1) As Type
checkVerIL.Emit(OpCodes.Ldloc, 3)
Typ = GetType(System.String).MakeArrayType()
Typ02 = Typ
...
checkVerIL.Emit(OpCodes.Stloc, 6)
checkVerIL.MarkSequencePoint(doc5, 78, 1, 78, 100)
checkVerIL.Emit(OpCodes.Ldloc, 6)
Typ = GetType(IntLiteral)
checkVerIL.Emit(OpCodes.Ldloc, 0)
Typ = GetType(Token)
...
Typ = GetType(Token).GetField("Line").FieldType
checkVerIL.Emit(OpCodes.Stfld, GetType(IntLiteral).GetField("Line"))
checkVerIL.MarkSequencePoint(doc5, 79, 1, 79, 100)
checkVerIL.Emit(OpCodes.Ldloc, 6)
Typ = GetType(IntLiteral)
checkVerIL.Emit(OpCodes.Ldloc, 4)
Typ = GetType(System.Int32).MakeArrayType()
...
Typ = GetType(System.Int32).MakeArrayType().GetElementType()
checkVerIL.Emit(OpCodes.Stfld, GetType(IntLiteral).GetField("NumVal"))
checkVerIL.MarkSequencePoint(doc5, 80, 1, 80, 100)
checkVerIL.Emit(OpCodes.Ldloc, 5)
Typ = GetType(IntLiteral).MakeArrayType()
Typ02 = Typ
checkVerIL.Emit(OpCodes.Ldc_I4, CInt(1))
...
Typ = GetType(IntLiteral)
checkVerIL.Emit(OpCodes.Stelem, GetType(IntLiteral).MakeArrayType().GetElementType())
checkVerIL.MarkSequencePoint(doc5, 81, 1, 81, 100)
Dim typ22(-1) As Type
checkVerIL.Emit(OpCodes.Ldloc, 3)
Typ = GetType(System.String).MakeArrayType()
Typ02 = Typ
...
checkVerIL.Emit(OpCodes.Stloc, 6)
checkVerIL.MarkSequencePoint(doc5, 82, 1, 82, 100)
checkVerIL.Emit(OpCodes.Ldloc, 6)
Typ = GetType(IntLiteral)
checkVerIL.Emit(OpCodes.Ldloc, 0)
Typ = GetType(Token)
...
Typ = GetType(Token).GetField("Line").FieldType
checkVerIL.Emit(OpCodes.Stfld, GetType(IntLiteral).GetField("Line"))
checkVerIL.MarkSequencePoint(doc5, 83, 1, 83, 100)
checkVerIL.Emit(OpCodes.Ldloc, 6)
Typ = GetType(IntLiteral)
checkVerIL.Emit(OpCodes.Ldloc, 4)
Typ = GetType(System.Int32).MakeArrayType()
...
Typ = GetType(System.Int32).MakeArrayType().GetElementType()
checkVerIL.Emit(OpCodes.Stfld, GetType(IntLiteral).GetField("NumVal"))
checkVerIL.MarkSequencePoint(doc5, 84, 1, 84, 100)
checkVerIL.Emit(OpCodes.Ldloc, 5)
Typ = GetType(IntLiteral).MakeArrayType()
Typ02 = Typ
checkVerIL.Emit(OpCodes.Ldc_I4, CInt(2))
...
Typ = GetType(IntLiteral)
checkVerIL.Emit(OpCodes.Stelem, GetType(IntLiteral).MakeArrayType().GetElementType())
checkVerIL.MarkSequencePoint(doc5, 85, 1, 85, 100)
Dim typ23(-1) As Type
checkVerIL.Emit(OpCodes.Ldloc, 3)
Typ = GetType(System.String).MakeArrayType()
Typ02 = Typ
...
checkVerIL.Emit(OpCodes.Stloc, 6)
checkVerIL.MarkSequencePoint(doc5, 86, 1, 86, 100)
checkVerIL.Emit(OpCodes.Ldloc, 6)
Typ = GetType(IntLiteral)
checkVerIL.Emit(OpCodes.Ldloc, 0)
Typ = GetType(Token)
...
Typ = GetType(Token).GetField("Line").FieldType
checkVerIL.Emit(OpCodes.Stfld, GetType(IntLiteral).GetField("Line"))
checkVerIL.MarkSequencePoint(doc5, 87, 1, 87, 100)
checkVerIL.Emit(OpCodes.Ldloc, 6)
Typ = GetType(IntLiteral)
checkVerIL.Emit(OpCodes.Ldloc, 4)
Typ = GetType(System.Int32).MakeArrayType()
...
Typ = GetType(System.Int32).MakeArrayType().GetElementType()
checkVerIL.Emit(OpCodes.Stfld, GetType(IntLiteral).GetField("NumVal"))
checkVerIL.MarkSequencePoint(doc5, 88, 1, 88, 100)
checkVerIL.Emit(OpCodes.Ldloc, 5)
Typ = GetType(IntLiteral).MakeArrayType()
Typ02 = Typ
checkVerIL.Emit(OpCodes.Ldc_I4, CInt(3))
...
Typ = GetType(IntLiteral)
checkVerIL.Emit(OpCodes.Stelem, GetType(IntLiteral).MakeArrayType().GetElementType())
checkVerIL.MarkSequencePoint(doc5, 89, 1, 89, 100)
checkVerIL.Emit(OpCodes.Ldloc, 2)
Typ = GetType(VerStmt)
checkVerIL.Emit(OpCodes.Ldloc, 5)
Typ = GetType(IntLiteral).MakeArrayType()
checkVerIL.Emit(OpCodes.Stfld, GetType(VerStmt).GetField("VersionNos"))
checkVerIL.MarkSequencePoint(doc5, 90, 1, 90, 100)
checkVerIL.Emit(OpCodes.Br, cont83)
checkVerIL.MarkLabel(fa83)
checkVerIL.Emit(OpCodes.Br, cont83)
checkVerIL.MarkLabel(cont83)
checkVerIL.MarkSequencePoint(doc5, 91, 1, 91, 100)
checkVerIL.Emit(OpCodes.Ldloc, 2)
Typ = GetType(VerStmt)
checkVerIL.MarkSequencePoint(doc5, 92, 1, 92, 100)
...
checkClassIL.MarkSequencePoint(doc5, 95, 1, 95, 100)
Dim locbldr109 As LocalBuilder = checkClassIL.DeclareLocal(GetType(Token))
locbldr109.SetLocalSymInfo("tok")
...
checkClassIL.MarkSequencePoint(doc5, 96, 1, 96, 100)
Dim locbldr110 As LocalBuilder = checkClassIL.DeclareLocal(GetType(System.Type))
...
checkClassIL.MarkSequencePoint(doc5, 97, 1, 97, 100)
...
checkClassIL.MarkSequencePoint(doc5, 98, 1, 98, 100)
Dim locbldr111 As LocalBuilder = checkClassIL.DeclareLocal(GetType(ClassStmt))
locbldr111.SetLocalSymInfo("clss")
checkClassIL.Emit(OpCodes.Newobj, GetType(ClassStmt).GetConstructor(Type.EmptyTypes))
checkClassIL.Emit(OpCodes.Stloc, 2)
checkClassIL.MarkSequencePoint(doc5, 99, 1, 99, 100)
Dim locbldr112 As LocalBuilder = checkClassIL.DeclareLocal(GetType(Attributes.Attribute))
locbldr112.SetLocalSymInfo("att")
checkClassIL.Emit(OpCodes.Ldnull)
checkClassIL.Emit(OpCodes.Stloc, 3)
checkClassIL.MarkSequencePoint(doc5, 100, 1, 100, 100)
checkClassIL.Emit(OpCodes.Ldarg, 2)
Typ = GetType(System.Boolean).MakeByRefType()
...
checkClassIL.MarkSequencePoint(doc5, 102, 1, 102, 100)
...
checkClassIL.MarkSequencePoint(doc5, 103, 1, 103, 100)
checkClassIL.Emit(OpCodes.Ldloc, 2)
Typ = GetType(ClassStmt)
checkClassIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
...
checkClassIL.MarkSequencePoint(doc5, 105, 1, 105, 100)
Dim label0 As System.Reflection.Emit.Label = checkClassIL.DefineLabel()
checkClassIL.MarkSequencePoint(doc5, 106, 1, 106, 100)
Dim label1 As System.Reflection.Emit.Label = checkClassIL.DefineLabel()
checkClassIL.MarkSequencePoint(doc5, 108, 1, 108, 100)
Dim locbldr113 As LocalBuilder = checkClassIL.DeclareLocal(GetType(System.Int32))
locbldr113.SetLocalSymInfo("i")
checkClassIL.Emit(OpCodes.Ldc_I4, CInt(0))
Typ = GetType(System.Int32)
checkClassIL.Emit(OpCodes.Stloc, 4)
checkClassIL.MarkSequencePoint(doc5, 109, 1, 109, 100)
Dim locbldr114 As LocalBuilder = checkClassIL.DeclareLocal(GetType(System.Int32))
locbldr114.SetLocalSymInfo("len")
checkClassIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
checkClassIL.Emit(OpCodes.Ldfld, GetType(Stmt).GetField("Tokens"))
Typ = GetType(Stmt).GetField("Tokens").FieldType
...
checkClassIL.MarkSequencePoint(doc5, 110, 1, 110, 100)
Dim locbldr115 As LocalBuilder = checkClassIL.DeclareLocal(GetType(System.Boolean))
locbldr115.SetLocalSymInfo("bl")
checkClassIL.Emit(OpCodes.Ldc_I4, 0)
Typ = GetType(System.Boolean)
checkClassIL.Emit(OpCodes.Stloc, 6)
checkClassIL.MarkSequencePoint(doc5, 112, 1, 112, 100)
checkClassIL.MarkLabel(label0)
checkClassIL.MarkSequencePoint(doc5, 114, 1, 114, 100)
...
checkClassIL.Emit(OpCodes.Stloc, 4)
checkClassIL.MarkSequencePoint(doc5, 115, 1, 115, 100)
checkClassIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
checkClassIL.Emit(OpCodes.Ldfld, GetType(Stmt).GetField("Tokens"))
Typ = GetType(Stmt).GetField("Tokens").FieldType
...
Typ = Typ.GetElementType()
checkClassIL.Emit(OpCodes.Stloc, 0)
checkClassIL.MarkSequencePoint(doc5, 116, 1, 116, 100)
...
checkClassIL.Emit(OpCodes.Stloc, 1)
checkClassIL.MarkSequencePoint(doc5, 117, 1, 117, 100)
Dim typ28(-1) As Type
checkClassIL.Emit(OpCodes.Ldloc, 1)
Typ = GetType(System.Type)
Typ03 = Typ
...
checkClassIL.Emit(OpCodes.Stloc, 6)
checkClassIL.MarkSequencePoint(doc5, 119, 1, 119, 100)
...
checkClassIL.Emit(OpCodes.Beq, tru85)
checkClassIL.Emit(OpCodes.Br, fa85)
checkClassIL.MarkLabel(tru85)
checkClassIL.MarkSequencePoint(doc5, 120, 1, 120, 100)
checkClassIL.Emit(OpCodes.Ldloc, 0)
Typ = GetType(Token)
checkClassIL.Emit(OpCodes.Stloc, 3)
checkClassIL.MarkSequencePoint(doc5, 121, 1, 121, 100)
Dim typ29(-1) As Type
checkClassIL.Emit(OpCodes.Ldloc, 2)
Typ = GetType(ClassStmt)
Typ03 = Typ
...
End If
checkClassIL.MarkSequencePoint(doc5, 122, 1, 122, 100)
checkClassIL.Emit(OpCodes.Br, cont85)
checkClassIL.MarkLabel(fa85)
checkClassIL.MarkSequencePoint(doc5, 124, 1, 124, 100)
Dim locbldr116 As LocalBuilder = checkClassIL.DeclareLocal(GetType(Token))
...
checkClassIL.MarkSequencePoint(doc5, 125, 1, 125, 100)
Dim locbldr117 As LocalBuilder = checkClassIL.DeclareLocal(GetType(System.Type))
...
checkClassIL.MarkSequencePoint(doc5, 126, 1, 126, 100)
Dim locbldr118 As LocalBuilder = checkClassIL.DeclareLocal(GetType(System.Boolean))
...
checkClassIL.MarkSequencePoint(doc5, 128, 1, 128, 100)
...
checkClassIL.MarkSequencePoint(doc5, 129, 1, 129, 100)
checkClassIL.Emit(OpCodes.Ldloc, 4)
Typ = GetType(System.Int32)
checkClassIL.Emit(OpCodes.Ldc_I4, CInt(1))
Typ = GetType(System.Int32)
checkClassIL.Emit(OpCodes.Add)
checkClassIL.Emit(OpCodes.Stloc, 4)
checkClassIL.MarkSequencePoint(doc5, 130, 1, 130, 100)
checkClassIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
checkClassIL.Emit(OpCodes.Ldfld, GetType(Stmt).GetField("Tokens"))
Typ = GetType(Stmt).GetField("Tokens").FieldType
...
Typ = Typ.GetElementType()
checkClassIL.Emit(OpCodes.Stloc, 7)
checkClassIL.MarkSequencePoint(doc5, 131, 1, 131, 100)
...
checkClassIL.Emit(OpCodes.Stloc, 8)
checkClassIL.MarkSequencePoint(doc5, 132, 1, 132, 100)
Dim typ33(-1) As Type
checkClassIL.Emit(OpCodes.Ldloc, 8)
Typ = GetType(System.Type)
Typ03 = Typ
...
checkClassIL.Emit(OpCodes.Stloc, 9)
checkClassIL.MarkSequencePoint(doc5, 134, 1, 134, 100)
checkClassIL.Emit(OpCodes.Ldloc, 9)
Typ = GetType(System.Boolean)
checkClassIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa87 As System.Reflection.Emit.Label = checkClassIL.DefineLabel()
Dim tru87 As System.Reflection.Emit.Label = checkClassIL.DefineLabel()
Dim cont87 As System.Reflection.Emit.Label = checkClassIL.DefineLabel()
checkClassIL.Emit(OpCodes.Beq, fa87)
checkClassIL.Emit(OpCodes.Br, tru87)
checkClassIL.MarkLabel(tru87)
checkClassIL.MarkSequencePoint(doc5, 135, 1, 135, 100)
Dim locbldr119 As LocalBuilder = checkClassIL.DeclareLocal(GetType(Token))
...
checkClassIL.MarkSequencePoint(doc5, 136, 1, 136, 100)
Dim locbldr120 As LocalBuilder = checkClassIL.DeclareLocal(GetType(TypeTok))
...
checkClassIL.MarkSequencePoint(doc5, 137, 1, 137, 100)
...
checkClassIL.MarkSequencePoint(doc5, 138, 1, 138, 100)
checkClassIL.Emit(OpCodes.Ldloc, 11)
Typ = GetType(TypeTok)
checkClassIL.Emit(OpCodes.Ldloc, 10)
Typ = GetType(Token)
...
checkClassIL.MarkSequencePoint(doc5, 139, 1, 139, 100)
checkClassIL.Emit(OpCodes.Ldloc, 2)
Typ = GetType(ClassStmt)
checkClassIL.Emit(OpCodes.Ldloc, 11)
Typ = GetType(TypeTok)
checkClassIL.Emit(OpCodes.Stfld, GetType(ClassStmt).GetField("InhClass"))
checkClassIL.MarkSequencePoint(doc5, 140, 1, 140, 100)
checkClassIL.Emit(OpCodes.Br, cont87)
checkClassIL.MarkLabel(fa87)
checkClassIL.MarkSequencePoint(doc5, 141, 1, 141, 100)
checkClassIL.Emit(OpCodes.Ldloc, 2)
Typ = GetType(ClassStmt)
checkClassIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
...
Typ = Typ.GetElementType()
checkClassIL.Emit(OpCodes.Stfld, GetType(ClassStmt).GetField("InhClass"))
checkClassIL.MarkSequencePoint(doc5, 142, 1, 142, 100)
checkClassIL.Emit(OpCodes.Br, cont87)
checkClassIL.MarkLabel(cont87)
checkClassIL.MarkSequencePoint(doc5, 143, 1, 143, 100)
checkClassIL.Emit(OpCodes.Br, cont86)
checkClassIL.MarkLabel(fa86)
checkClassIL.MarkSequencePoint(doc5, 144, 1, 144, 100)
checkClassIL.Emit(OpCodes.Ldloc, 2)
Typ = GetType(ClassStmt)
checkClassIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
...
checkClassIL.MarkSequencePoint(doc5, 145, 1, 145, 100)
checkClassIL.Emit(OpCodes.Br, cont86)
checkClassIL.MarkLabel(cont86)
checkClassIL.MarkSequencePoint(doc5, 147, 1, 147, 100)
checkClassIL.Emit(OpCodes.Br, cont85)
checkClassIL.MarkLabel(cont85)
checkClassIL.MarkSequencePoint(doc5, 149, 1, 149, 100)
checkClassIL.Emit(OpCodes.Ldloc, 4)
Typ = GetType(System.Int32)
checkClassIL.Emit(OpCodes.Ldloc, 5)
Typ = GetType(System.Int32)
Dim fa88 As System.Reflection.Emit.Label = checkClassIL.DefineLabel()
Dim tru88 As System.Reflection.Emit.Label = checkClassIL.DefineLabel()
Dim cont88 As System.Reflection.Emit.Label = checkClassIL.DefineLabel()
checkClassIL.Emit(OpCodes.Beq, tru88)
checkClassIL.Emit(OpCodes.Br, fa88)
checkClassIL.MarkLabel(tru88)
checkClassIL.MarkSequencePoint(doc5, 150, 1, 150, 100)
checkClassIL.Emit(OpCodes.Br, label1)
checkClassIL.MarkSequencePoint(doc5, 151, 1, 151, 100)
checkClassIL.Emit(OpCodes.Br, cont88)
checkClassIL.MarkLabel(fa88)
...
checkClassIL.Emit(OpCodes.Br, cont88)
checkClassIL.MarkLabel(cont88)
checkClassIL.MarkSequencePoint(doc5, 155, 1, 155, 100)
checkClassIL.MarkLabel(label1)
checkClassIL.MarkSequencePoint(doc5, 157, 1, 157, 100)
...
checkClassIL.Emit(OpCodes.Ldloc, 2)
Typ = GetType(ClassStmt)
checkClassIL.MarkSequencePoint(doc5, 160, 1, 160, 100)
...
checkMethodIL.MarkSequencePoint(doc5, 163, 1, 163, 100)
...
checkMethodIL.MarkSequencePoint(doc5, 164, 1, 164, 100)
...
checkMethodIL.MarkSequencePoint(doc5, 165, 1, 165, 100)
...
checkMethodIL.MarkSequencePoint(doc5, 166, 1, 166, 100)
Dim locbldr123 As LocalBuilder = checkMethodIL.DeclareLocal(GetType(MethodStmt))
locbldr123.SetLocalSymInfo("mtss")
checkMethodIL.Emit(OpCodes.Newobj, GetType(MethodStmt).GetConstructor(Type.EmptyTypes))
checkMethodIL.Emit(OpCodes.Stloc, 2)
checkMethodIL.MarkSequencePoint(doc5, 167, 1, 167, 100)
Dim locbldr124 As LocalBuilder = checkMethodIL.DeclareLocal(GetType(Attributes.Attribute))
locbldr124.SetLocalSymInfo("att")
...
checkMethodIL.MarkSequencePoint(doc5, 168, 1, 168, 100)
Dim locbldr125 As LocalBuilder = checkMethodIL.DeclareLocal(GetType(Ident))
locbldr125.SetLocalSymInfo("mn")
checkMethodIL.Emit(OpCodes.Newobj, GetType(Ident).GetConstructor(Type.EmptyTypes))
checkMethodIL.Emit(OpCodes.Stloc, 4)
checkMethodIL.MarkSequencePoint(doc5, 169, 1, 169, 100)
Dim locbldr126 As LocalBuilder = checkMethodIL.DeclareLocal(GetType(Expr))
locbldr126.SetLocalSymInfo("exp")
checkMethodIL.Emit(OpCodes.Ldnull)
checkMethodIL.Emit(OpCodes.Stloc, 5)
checkMethodIL.MarkSequencePoint(doc5, 170, 1, 170, 100)
Dim locbldr127 As LocalBuilder = checkMethodIL.DeclareLocal(GetType(System.Boolean))
locbldr127.SetLocalSymInfo("d")
checkMethodIL.Emit(OpCodes.Ldc_I4, 0)
Typ = GetType(System.Boolean)
checkMethodIL.Emit(OpCodes.Stloc, 6)
checkMethodIL.MarkSequencePoint(doc5, 172, 1, 172, 100)
checkMethodIL.Emit(OpCodes.Ldarg, 2)
Typ = GetType(System.Boolean).MakeByRefType()
...
checkMethodIL.MarkSequencePoint(doc5, 174, 1, 174, 100)
...
checkMethodIL.MarkSequencePoint(doc5, 175, 1, 175, 100)
checkMethodIL.Emit(OpCodes.Ldloc, 2)
Typ = GetType(MethodStmt)
checkMethodIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
...
checkMethodIL.MarkSequencePoint(doc5, 177, 1, 177, 100)
Dim label2 As System.Reflection.Emit.Label = checkMethodIL.DefineLabel()
checkMethodIL.MarkSequencePoint(doc5, 178, 1, 178, 100)
Dim label3 As System.Reflection.Emit.Label = checkMethodIL.DefineLabel()
checkMethodIL.MarkSequencePoint(doc5, 179, 1, 179, 100)
Dim label4 As System.Reflection.Emit.Label = checkMethodIL.DefineLabel()
checkMethodIL.MarkSequencePoint(doc5, 181, 1, 181, 100)
Dim locbldr128 As LocalBuilder = checkMethodIL.DeclareLocal(GetType(System.Int32))
locbldr128.SetLocalSymInfo("i")
checkMethodIL.Emit(OpCodes.Ldc_I4, CInt(0))
Typ = GetType(System.Int32)
checkMethodIL.Emit(OpCodes.Stloc, 7)
checkMethodIL.MarkSequencePoint(doc5, 182, 1, 182, 100)
Dim locbldr129 As LocalBuilder = checkMethodIL.DeclareLocal(GetType(System.Int32))
locbldr129.SetLocalSymInfo("len")
checkMethodIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
checkMethodIL.Emit(OpCodes.Ldfld, GetType(Stmt).GetField("Tokens"))
Typ = GetType(Stmt).GetField("Tokens").FieldType
...
checkMethodIL.MarkSequencePoint(doc5, 183, 1, 183, 100)
Dim locbldr130 As LocalBuilder = checkMethodIL.DeclareLocal(GetType(System.Boolean))
locbldr130.SetLocalSymInfo("bl")
checkMethodIL.Emit(OpCodes.Ldc_I4, 0)
Typ = GetType(System.Boolean)
checkMethodIL.Emit(OpCodes.Stloc, 9)
checkMethodIL.MarkSequencePoint(doc5, 186, 1, 186, 100)
checkMethodIL.MarkLabel(label2)
checkMethodIL.MarkSequencePoint(doc5, 188, 1, 188, 100)
...
checkMethodIL.Emit(OpCodes.Stloc, 7)
checkMethodIL.MarkSequencePoint(doc5, 189, 1, 189, 100)
checkMethodIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
checkMethodIL.Emit(OpCodes.Ldfld, GetType(Stmt).GetField("Tokens"))
Typ = GetType(Stmt).GetField("Tokens").FieldType
...
Typ = Typ.GetElementType()
checkMethodIL.Emit(OpCodes.Stloc, 0)
checkMethodIL.MarkSequencePoint(doc5, 190, 1, 190, 100)
...
checkMethodIL.Emit(OpCodes.Stloc, 1)
checkMethodIL.MarkSequencePoint(doc5, 191, 1, 191, 100)
Dim typ38(-1) As Type
checkMethodIL.Emit(OpCodes.Ldloc, 1)
Typ = GetType(System.Type)
Typ03 = Typ
...
checkMethodIL.Emit(OpCodes.Stloc, 9)
checkMethodIL.MarkSequencePoint(doc5, 193, 1, 193, 100)
...
checkMethodIL.Emit(OpCodes.Beq, tru90)
checkMethodIL.Emit(OpCodes.Br, fa90)
checkMethodIL.MarkLabel(tru90)
checkMethodIL.MarkSequencePoint(doc5, 194, 1, 194, 100)
checkMethodIL.Emit(OpCodes.Ldloc, 0)
Typ = GetType(Token)
checkMethodIL.Emit(OpCodes.Stloc, 3)
checkMethodIL.MarkSequencePoint(doc5, 195, 1, 195, 100)
Dim typ39(-1) As Type
checkMethodIL.Emit(OpCodes.Ldloc, 2)
Typ = GetType(MethodStmt)
Typ03 = Typ
...
End If
checkMethodIL.MarkSequencePoint(doc5, 196, 1, 196, 100)
checkMethodIL.Emit(OpCodes.Br, cont90)
checkMethodIL.MarkLabel(fa90)
checkMethodIL.MarkSequencePoint(doc5, 197, 1, 197, 100)
checkMethodIL.Emit(OpCodes.Ldloc, 7)
Typ = GetType(System.Int32)
checkMethodIL.Emit(OpCodes.Ldc_I4, CInt(1))
Typ = GetType(System.Int32)
checkMethodIL.Emit(OpCodes.Sub)
checkMethodIL.Emit(OpCodes.Stloc, 7)
checkMethodIL.MarkSequencePoint(doc5, 198, 1, 198, 100)
checkMethodIL.Emit(OpCodes.Br, label4)
checkMethodIL.MarkSequencePoint(doc5, 199, 1, 199, 100)
checkMethodIL.Emit(OpCodes.Br, cont90)
checkMethodIL.MarkLabel(cont90)
checkMethodIL.MarkSequencePoint(doc5, 201, 1, 201, 100)
checkMethodIL.Emit(OpCodes.Ldloc, 7)
Typ = GetType(System.Int32)
...
checkMethodIL.MarkSequencePoint(doc5, 202, 1, 202, 100)
checkMethodIL.Emit(OpCodes.Br, label3)
checkMethodIL.MarkSequencePoint(doc5, 203, 1, 203, 100)
checkMethodIL.Emit(OpCodes.Br, cont91)
checkMethodIL.MarkLabel(fa91)
checkMethodIL.MarkSequencePoint(doc5, 204, 1, 204, 100)
checkMethodIL.Emit(OpCodes.Br, label2)
checkMethodIL.MarkSequencePoint(doc5, 205, 1, 205, 100)
checkMethodIL.Emit(OpCodes.Br, cont91)
checkMethodIL.MarkLabel(cont91)
checkMethodIL.MarkSequencePoint(doc5, 207, 1, 207, 100)
checkMethodIL.MarkLabel(label3)
checkMethodIL.MarkSequencePoint(doc5, 209, 1, 209, 100)
checkMethodIL.MarkLabel(label4)
checkMethodIL.MarkSequencePoint(doc5, 212, 1, 212, 100)
checkMethodIL.Emit(OpCodes.Ldloc, 7)
Typ = GetType(System.Int32)
checkMethodIL.Emit(OpCodes.Ldc_I4, CInt(1))
Typ = GetType(System.Int32)
checkMethodIL.Emit(OpCodes.Add)
checkMethodIL.Emit(OpCodes.Stloc, 7)
checkMethodIL.MarkSequencePoint(doc5, 214, 1, 214, 100)
Dim locbldr131 As LocalBuilder = checkMethodIL.DeclareLocal(GetType(Token))
...
checkMethodIL.MarkSequencePoint(doc5, 215, 1, 215, 100)
Dim locbldr132 As LocalBuilder = checkMethodIL.DeclareLocal(GetType(System.Type))
locbldr132.SetLocalSymInfo("typ2")
checkMethodIL.MarkSequencePoint(doc5, 216, 1, 216, 100)
Dim locbldr133 As LocalBuilder = checkMethodIL.DeclareLocal(GetType(System.Boolean))
locbldr133.SetLocalSymInfo("b2")
checkMethodIL.MarkSequencePoint(doc5, 218, 1, 218, 100)
...
checkMethodIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa92 As System.Reflection.Emit.Label = checkMethodIL.DefineLabel()
Dim tru92 As System.Reflection.Emit.Label = checkMethodIL.DefineLabel()
Dim cont92 As System.Reflection.Emit.Label = checkMethodIL.DefineLabel()
checkMethodIL.Emit(OpCodes.Beq, fa92)
checkMethodIL.Emit(OpCodes.Br, tru92)
checkMethodIL.MarkLabel(tru92)
checkMethodIL.MarkSequencePoint(doc5, 222, 1, 222, 100)
Dim locbldr134 As LocalBuilder = checkMethodIL.DeclareLocal(GetType(Token))
locbldr134.SetLocalSymInfo("t")
checkMethodIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
checkMethodIL.Emit(OpCodes.Ldfld, GetType(Stmt).GetField("Tokens"))
Typ = GetType(Stmt).GetField("Tokens").FieldType
...
Dim locbldr135 As LocalBuilder = checkMethodIL.DeclareLocal(GetType(TypeTok))
...
checkMethodIL.MarkSequencePoint(doc5, 227, 1, 227, 100)
checkMethodIL.Emit(OpCodes.Br, cont92)
checkMethodIL.MarkLabel(fa92)
...
Typ = Typ.GetElementType()
checkMethodIL.Emit(OpCodes.Stfld, GetType(MethodStmt).GetField("RetTyp"))
checkMethodIL.MarkSequencePoint(doc5, 229, 1, 229, 100)
checkMethodIL.Emit(OpCodes.Br, cont92)
checkMethodIL.MarkLabel(cont92)
...
checkMethodIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa93 As System.Reflection.Emit.Label = checkMethodIL.DefineLabel()
Dim tru93 As System.Reflection.Emit.Label = checkMethodIL.DefineLabel()
Dim cont93 As System.Reflection.Emit.Label = checkMethodIL.DefineLabel()
checkMethodIL.Emit(OpCodes.Beq, tru93)
checkMethodIL.Emit(OpCodes.Br, fa93)
checkMethodIL.MarkLabel(tru93)
...
checkMethodIL.Emit(OpCodes.Br, cont93)
checkMethodIL.MarkLabel(fa93)
checkMethodIL.Emit(OpCodes.Br, cont93)
checkMethodIL.MarkLabel(cont93)
...
checkMethodIL.Emit(OpCodes.Call, GetType(System.Type).GetMethod("GetTypeFromHandle", typ44))
...
ReDim Preserve typ45(UBound(typ45) + 1)
typ45(UBound(typ45)) = Typ
checkMethodIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("IsInstanceOfType", typ45))
...
checkMethodIL.Emit(OpCodes.Call, GetType(System.Type).GetMethod("GetTypeFromHandle", typ46))
Typ = GetType(System.Type).GetMethod("GetTypeFromHandle", typ46).ReturnType
checkMethodIL.Emit(OpCodes.Stloc, 11)
checkMethodIL.MarkSequencePoint(doc5, 256, 1, 256, 100)
Dim typ47(-1) As Type
checkMethodIL.Emit(OpCodes.Ldloc, 11)
Typ = GetType(System.Type)
Typ03 = Typ
...
ReDim Preserve typ47(UBound(typ47) + 1)
typ47(UBound(typ47)) = Typ
checkMethodIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("IsInstanceOfType", typ47))
...
Dim locbldr136 As LocalBuilder = checkMethodIL.DeclareLocal(asm.GetType("dylan.NET.Tokenizer.Parser.ExprOptimizer"))
locbldr136.SetLocalSymInfo("eopt2")
...
ReDim Preserve typ48(UBound(typ48) + 1)
typ48(UBound(typ48)) = Typ
checkMethodIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("checkVarAs", typ48))
Typ = Typ03.GetMethod("checkVarAs", typ48).ReturnType
checkMethodIL.Emit(OpCodes.Stloc, 5)
...
ReDim Preserve typ49(UBound(typ49) + 1)
typ49(UBound(typ49)) = Typ
checkMethodIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("AddParam", typ49))
Typ = Typ03.GetMethod("AddParam", typ49).ReturnType
If Typ.ToString() = GetType(System.Void).ToString() Then
...
Dim locbldr137 As LocalBuilder = checkMethodIL.DeclareLocal(asm.GetType("dylan.NET.Tokenizer.Parser.ExprOptimizer"))
locbldr137.SetLocalSymInfo("eopt1")
checkMethodIL.Emit(OpCodes.Newobj, asm.GetType("dylan.NET.Tokenizer.Parser.ExprOptimizer").GetConstructor(Type.EmptyTypes))
...
ReDim Preserve typ54(UBound(typ54) + 1)
typ54(UBound(typ54)) = Typ
checkMethodIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("checkVarAs", typ54))
Typ = Typ03.GetMethod("checkVarAs", typ54).ReturnType
checkMethodIL.Emit(OpCodes.Stloc, 5)
...
checkMethodIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("AddParam", typ55))
Typ = Typ03.GetMethod("AddParam", typ55).ReturnType
If Typ.ToString() = GetType(System.Void).ToString() Then
...
ReDim Preserve typ56(UBound(typ56) + 1)
typ56(UBound(typ56)) = Typ
checkMethodIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("AddToken", typ56))
Typ = Typ03.GetMethod("AddToken", typ56).ReturnType
If Typ.ToString() = GetType(System.Void).ToString() Then
...
Dim checkVarAs As MethodBuilder = StmtOptimizer.DefineMethod("checkVarAs", MethodAttributes.Public, GetType(Stmt), typ57)
Dim checkVarAsIL As ILGenerator = checkVarAs.GetILGenerator()
Dim checkVarAsparam00 As ParameterBuilder = checkVarAs.DefineParameter(0, ParameterAttributes.RetVal, "")
Dim checkVarAsparam01 As ParameterBuilder = checkVarAs.DefineParameter(1, ParameterAttributes.None, "stm")
Dim checkVarAsparam02 As ParameterBuilder = checkVarAs.DefineParameter(2, ParameterAttributes.None, "b")
checkVarAsIL.MarkSequencePoint(doc5, 309, 1, 309, 100)
Dim locbldr138 As LocalBuilder = checkVarAsIL.DeclareLocal(GetType(Token))
...
Typ = Typ.GetElementType()
checkVarAsIL.Emit(OpCodes.Stloc, 0)
checkVarAsIL.MarkSequencePoint(doc5, 310, 1, 310, 100)
Dim locbldr139 As LocalBuilder = checkVarAsIL.DeclareLocal(GetType(System.Type))
locbldr139.SetLocalSymInfo("typ")
checkVarAsIL.Emit(OpCodes.Ldtoken, GetType(VarTok))
Dim typ58 As Type() = {GetType(System.RuntimeTypeHandle)}
checkVarAsIL.Emit(OpCodes.Call, GetType(System.Type).GetMethod("GetTypeFromHandle", typ58))
Typ = GetType(System.Type).GetMethod("GetTypeFromHandle", typ58).ReturnType
checkVarAsIL.Emit(OpCodes.Stloc, 1)
checkVarAsIL.MarkSequencePoint(doc5, 311, 1, 311, 100)
checkVarAsIL.Emit(OpCodes.Ldarg, 2)
Typ = GetType(System.Boolean).MakeByRefType()
Typ04 = Typ.GetElementType()
Dim typ59(-1) As Type
...
checkVarAsIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("IsInstanceOfType", typ59))
Typ = Typ03.GetMethod("IsInstanceOfType", typ59).ReturnType
checkVarAsIL.Emit(OpCodes.Stobj, Typ04)
checkVarAsIL.MarkSequencePoint(doc5, 312, 1, 312, 100)
Dim locbldr140 As LocalBuilder = checkVarAsIL.DeclareLocal(GetType(VarStmt))
locbldr140.SetLocalSymInfo("vars")
checkVarAsIL.Emit(OpCodes.Newobj, GetType(VarStmt).GetConstructor(Type.EmptyTypes))
checkVarAsIL.Emit(OpCodes.Stloc, 2)
checkVarAsIL.MarkSequencePoint(doc5, 314, 1, 314, 100)
checkVarAsIL.Emit(OpCodes.Ldarg, 2)
Typ = GetType(System.Boolean).MakeByRefType()
checkVarAsIL.Emit(OpCodes.Ldobj, Typ.GetElementType())
Typ = Typ.GetElementType()
...
checkVarAsIL.MarkSequencePoint(doc5, 315, 1, 315, 100)
checkVarAsIL.Emit(OpCodes.Ldloc, 2)
Typ = GetType(VarStmt)
checkVarAsIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
...
checkVarAsIL.MarkSequencePoint(doc5, 316, 1, 316, 100)
checkVarAsIL.Emit(OpCodes.Ldloc, 2)
Typ = GetType(VarStmt)
checkVarAsIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
...
checkVarAsIL.MarkSequencePoint(doc5, 317, 1, 317, 100)
checkVarAsIL.Emit(OpCodes.Ldloc, 2)
Typ = GetType(VarStmt)
checkVarAsIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
...
checkVarAsIL.MarkSequencePoint(doc5, 319, 1, 319, 100)
Dim locbldr141 As LocalBuilder = checkVarAsIL.DeclareLocal(GetType(Token))
...
Typ = Typ.GetElementType()
checkVarAsIL.Emit(OpCodes.Stloc, 3)
checkVarAsIL.MarkSequencePoint(doc5, 320, 1, 320, 100)
Dim locbldr142 As LocalBuilder = checkVarAsIL.DeclareLocal(GetType(System.Type))
locbldr142.SetLocalSymInfo("typ2")
checkVarAsIL.Emit(OpCodes.Ldtoken, GetType(TypeTok))
Dim typ60 As Type() = {GetType(System.RuntimeTypeHandle)}
checkVarAsIL.Emit(OpCodes.Call, GetType(System.Type).GetMethod("GetTypeFromHandle", typ60))
Typ = GetType(System.Type).GetMethod("GetTypeFromHandle", typ60).ReturnType
checkVarAsIL.Emit(OpCodes.Stloc, 4)
checkVarAsIL.MarkSequencePoint(doc5, 321, 1, 321, 100)
Dim locbldr143 As LocalBuilder = checkVarAsIL.DeclareLocal(GetType(System.Boolean))
...
checkVarAsIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("IsInstanceOfType", typ61))
Typ = Typ03.GetMethod("IsInstanceOfType", typ61).ReturnType
checkVarAsIL.Emit(OpCodes.Stloc, 5)
checkVarAsIL.MarkSequencePoint(doc5, 323, 1, 323, 100)
checkVarAsIL.Emit(OpCodes.Ldloc, 5)
Typ = GetType(System.Boolean)
checkVarAsIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
...
checkVarAsIL.MarkSequencePoint(doc5, 324, 1, 324, 100)
Dim locbldr144 As LocalBuilder = checkVarAsIL.DeclareLocal(GetType(Token))
...
Typ = Typ.GetElementType()
checkVarAsIL.Emit(OpCodes.Stloc, 6)
checkVarAsIL.MarkSequencePoint(doc5, 325, 1, 325, 100)
Dim locbldr145 As LocalBuilder = checkVarAsIL.DeclareLocal(GetType(TypeTok))
locbldr145.SetLocalSymInfo("tt")
checkVarAsIL.Emit(OpCodes.Newobj, GetType(TypeTok).GetConstructor(Type.EmptyTypes))
checkVarAsIL.Emit(OpCodes.Stloc, 7)
checkVarAsIL.MarkSequencePoint(doc5, 326, 1, 326, 100)
checkVarAsIL.Emit(OpCodes.Ldloc, 7)
Typ = GetType(TypeTok)
checkVarAsIL.Emit(OpCodes.Ldloc, 6)
Typ = GetType(Token)
...
Typ = GetType(Token).GetField("Line").FieldType
checkVarAsIL.Emit(OpCodes.Stfld, GetType(TypeTok).GetField("Line"))
checkVarAsIL.MarkSequencePoint(doc5, 327, 1, 327, 100)
checkVarAsIL.Emit(OpCodes.Ldloc, 7)
Typ = GetType(TypeTok)
checkVarAsIL.Emit(OpCodes.Ldloc, 6)
Typ = GetType(Token)
...
Typ = GetType(Token).GetField("Value").FieldType
checkVarAsIL.Emit(OpCodes.Stfld, GetType(TypeTok).GetField("Value"))
checkVarAsIL.MarkSequencePoint(doc5, 328, 1, 328, 100)
checkVarAsIL.Emit(OpCodes.Ldloc, 2)
Typ = GetType(VarStmt)
checkVarAsIL.Emit(OpCodes.Ldloc, 7)
Typ = GetType(TypeTok)
checkVarAsIL.Emit(OpCodes.Stfld, GetType(VarStmt).GetField("VarTyp"))
checkVarAsIL.MarkSequencePoint(doc5, 329, 1, 329, 100)
checkVarAsIL.Emit(OpCodes.Br, cont104)
checkVarAsIL.MarkLabel(fa104)
checkVarAsIL.MarkSequencePoint(doc5, 330, 1, 330, 100)
checkVarAsIL.Emit(OpCodes.Ldloc, 2)
Typ = GetType(VarStmt)
checkVarAsIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
...
Typ = Typ.GetElementType()
checkVarAsIL.Emit(OpCodes.Stfld, GetType(VarStmt).GetField("VarTyp"))
checkVarAsIL.MarkSequencePoint(doc5, 331, 1, 331, 100)
checkVarAsIL.Emit(OpCodes.Br, cont104)
checkVarAsIL.MarkLabel(cont104)
checkVarAsIL.MarkSequencePoint(doc5, 333, 1, 333, 100)
checkVarAsIL.Emit(OpCodes.Br, cont103)
checkVarAsIL.MarkLabel(fa103)
checkVarAsIL.Emit(OpCodes.Br, cont103)
checkVarAsIL.MarkLabel(cont103)
checkVarAsIL.MarkSequencePoint(doc5, 334, 1, 334, 100)
checkVarAsIL.Emit(OpCodes.Ldloc, 2)
Typ = GetType(VarStmt)
checkVarAsIL.MarkSequencePoint(doc5, 335, 1, 335, 100)
checkVarAsIL.Emit(OpCodes.Ret)
Dim typ62(-1) As Type
ReDim Preserve typ62(UBound(typ62) + 1)
typ62(UBound(typ62)) = GetType(Stmt)
Dim AssOpt As MethodBuilder = StmtOptimizer.DefineMethod("AssOpt", MethodAttributes.Public, GetType(Stmt), typ62)
...
AssOptIL.MarkSequencePoint(doc5, 339, 1, 339, 100)
Dim locbldr146 As LocalBuilder = AssOptIL.DeclareLocal(GetType(AssignStmt))
locbldr146.SetLocalSymInfo("asss")
AssOptIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
AssOptIL.Emit(OpCodes.Stloc, 0)
AssOptIL.MarkSequencePoint(doc5, 340, 1, 340, 100)
Dim locbldr147 As LocalBuilder = AssOptIL.DeclareLocal(GetType(Expr))
locbldr147.SetLocalSymInfo("le")
...
AssOptIL.MarkSequencePoint(doc5, 341, 1, 341, 100)
Dim locbldr148 As LocalBuilder = AssOptIL.DeclareLocal(GetType(Token))
...
AssOptIL.MarkSequencePoint(doc5, 342, 1, 342, 100)
Dim locbldr149 As LocalBuilder = AssOptIL.DeclareLocal(GetType(System.Type))
locbldr149.SetLocalSymInfo("typ")
AssOptIL.Emit(OpCodes.Ldtoken, GetType(VarTok))
Dim typ63 As Type() = {GetType(System.RuntimeTypeHandle)}
AssOptIL.Emit(OpCodes.Call, GetType(System.Type).GetMethod("GetTypeFromHandle", typ63))
Typ = GetType(System.Type).GetMethod("GetTypeFromHandle", typ63).ReturnType
AssOptIL.Emit(OpCodes.Stloc, 3)
AssOptIL.MarkSequencePoint(doc5, 343, 1, 343, 100)
Dim locbldr150 As LocalBuilder = AssOptIL.DeclareLocal(GetType(System.Boolean))
...
ReDim Preserve typ64(UBound(typ64) + 1)
typ64(UBound(typ64)) = Typ
AssOptIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("IsInstanceOfType", typ64))
Typ = Typ03.GetMethod("IsInstanceOfType", typ64).ReturnType
AssOptIL.Emit(OpCodes.Stloc, 4)
AssOptIL.MarkSequencePoint(doc5, 344, 1, 344, 100)
Dim locbldr151 As LocalBuilder = AssOptIL.DeclareLocal(GetType(VarAsgnStmt))
locbldr151.SetLocalSymInfo("vass")
AssOptIL.Emit(OpCodes.Newobj, GetType(VarAsgnStmt).GetConstructor(Type.EmptyTypes))
AssOptIL.Emit(OpCodes.Stloc, 5)
AssOptIL.MarkSequencePoint(doc5, 345, 1, 345, 100)
AssOptIL.Emit(OpCodes.Ldloc, 4)
Typ = GetType(System.Boolean)
AssOptIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa105 As System.Reflection.Emit.Label = AssOptIL.DefineLabel()
Dim tru105 As System.Reflection.Emit.Label = AssOptIL.DefineLabel()
Dim cont105 As System.Reflection.Emit.Label = AssOptIL.DefineLabel()
AssOptIL.Emit(OpCodes.Beq, tru105)
AssOptIL.Emit(OpCodes.Br, fa105)
AssOptIL.MarkLabel(tru105)
AssOptIL.MarkSequencePoint(doc5, 346, 1, 346, 100)
...
AssOptIL.MarkSequencePoint(doc5, 347, 1, 347, 100)
AssOptIL.Emit(OpCodes.Ldloc, 5)
Typ = GetType(VarAsgnStmt)
AssOptIL.Emit(OpCodes.Ldloc, 0)
Typ = GetType(AssignStmt)
...
AssOptIL.MarkSequencePoint(doc5, 348, 1, 348, 100)
AssOptIL.Emit(OpCodes.Ldloc, 5)
Typ = GetType(VarAsgnStmt)
AssOptIL.Emit(OpCodes.Ldloc, 1)
Typ = GetType(Expr)
...
AssOptIL.MarkSequencePoint(doc5, 350, 1, 350, 100)
Dim locbldr152 As LocalBuilder = AssOptIL.DeclareLocal(GetType(Token))
locbldr152.SetLocalSymInfo("tok2")
AssOptIL.Emit(OpCodes.Ldloc, 1)
Typ = GetType(Expr)
AssOptIL.Emit(OpCodes.Ldfld, GetType(Expr).GetField("Tokens"))
Typ = GetType(Expr).GetField("Tokens").FieldType
...
AssOptIL.MarkSequencePoint(doc5, 351, 1, 351, 100)
Dim locbldr153 As LocalBuilder = AssOptIL.DeclareLocal(GetType(System.Type))
locbldr153.SetLocalSymInfo("typ2")
AssOptIL.Emit(OpCodes.Ldtoken, GetType(TypeTok))
Dim typ65 As Type() = {GetType(System.RuntimeTypeHandle)}
AssOptIL.Emit(OpCodes.Call, GetType(System.Type).GetMethod("GetTypeFromHandle", typ65))
Typ = GetType(System.Type).GetMethod("GetTypeFromHandle", typ65).ReturnType
AssOptIL.Emit(OpCodes.Stloc, 7)
AssOptIL.MarkSequencePoint(doc5, 352, 1, 352, 100)
Dim locbldr154 As LocalBuilder = AssOptIL.DeclareLocal(GetType(System.Boolean))
locbldr154.SetLocalSymInfo("b2")
Dim typ66(-1) As Type
...
ReDim Preserve typ66(UBound(typ66) + 1)
typ66(UBound(typ66)) = Typ
AssOptIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("IsInstanceOfType", typ66))
Typ = Typ03.GetMethod("IsInstanceOfType", typ66).ReturnType
AssOptIL.Emit(OpCodes.Stloc, 8)
AssOptIL.MarkSequencePoint(doc5, 354, 1, 354, 100)
AssOptIL.Emit(OpCodes.Ldloc, 8)
Typ = GetType(System.Boolean)
AssOptIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa106 As System.Reflection.Emit.Label = AssOptIL.DefineLabel()
Dim tru106 As System.Reflection.Emit.Label = AssOptIL.DefineLabel()
Dim cont106 As System.Reflection.Emit.Label = AssOptIL.DefineLabel()
AssOptIL.Emit(OpCodes.Beq, fa106)
AssOptIL.Emit(OpCodes.Br, tru106)
AssOptIL.MarkLabel(tru106)
AssOptIL.MarkSequencePoint(doc5, 355, 1, 355, 100)
Dim locbldr155 As LocalBuilder = AssOptIL.DeclareLocal(GetType(Token))
locbldr155.SetLocalSymInfo("t")
AssOptIL.Emit(OpCodes.Ldloc, 1)
Typ = GetType(Expr)
AssOptIL.Emit(OpCodes.Ldfld, GetType(Expr).GetField("Tokens"))
Typ = GetType(Expr).GetField("Tokens").FieldType
...
AssOptIL.MarkSequencePoint(doc5, 356, 1, 356, 100)
Dim locbldr156 As LocalBuilder = AssOptIL.DeclareLocal(GetType(TypeTok))
locbldr156.SetLocalSymInfo("tt")
AssOptIL.Emit(OpCodes.Newobj, GetType(TypeTok).GetConstructor(Type.EmptyTypes))
AssOptIL.Emit(OpCodes.Stloc, 10)
AssOptIL.MarkSequencePoint(doc5, 357, 1, 357, 100)
...
AssOptIL.MarkSequencePoint(doc5, 358, 1, 358, 100)
AssOptIL.Emit(OpCodes.Ldloc, 10)
Typ = GetType(TypeTok)
AssOptIL.Emit(OpCodes.Ldloc, 9)
Typ = GetType(Token)
...
AssOptIL.MarkSequencePoint(doc5, 359, 1, 359, 100)
AssOptIL.Emit(OpCodes.Ldloc, 5)
Typ = GetType(VarAsgnStmt)
AssOptIL.Emit(OpCodes.Ldloc, 10)
Typ = GetType(TypeTok)
AssOptIL.Emit(OpCodes.Stfld, GetType(VarAsgnStmt).GetField("VarTyp"))
AssOptIL.MarkSequencePoint(doc5, 360, 1, 360, 100)
AssOptIL.Emit(OpCodes.Br, cont106)
AssOptIL.MarkLabel(fa106)
AssOptIL.MarkSequencePoint(doc5, 361, 1, 361, 100)
AssOptIL.Emit(OpCodes.Ldloc, 5)
Typ = GetType(VarAsgnStmt)
AssOptIL.Emit(OpCodes.Ldloc, 1)
Typ = GetType(Expr)
...
Typ = Typ.GetElementType()
AssOptIL.Emit(OpCodes.Stfld, GetType(VarAsgnStmt).GetField("VarTyp"))
AssOptIL.MarkSequencePoint(doc5, 362, 1, 362, 100)
AssOptIL.Emit(OpCodes.Br, cont106)
AssOptIL.MarkLabel(cont106)
AssOptIL.MarkSequencePoint(doc5, 364, 1, 364, 100)
AssOptIL.Emit(OpCodes.Ldloc, 5)
Typ = GetType(VarAsgnStmt)
AssOptIL.Emit(OpCodes.Ldloc, 0)
Typ = GetType(AssignStmt)
...
AssOptIL.MarkSequencePoint(doc5, 366, 1, 366, 100)
AssOptIL.Emit(OpCodes.Ldloc, 5)
Typ = GetType(VarAsgnStmt)
AssOptIL.MarkSequencePoint(doc5, 367, 1, 367, 100)
AssOptIL.Emit(OpCodes.Br, cont105)
AssOptIL.MarkLabel(fa105)
AssOptIL.MarkSequencePoint(doc5, 368, 1, 368, 100)
AssOptIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
AssOptIL.MarkSequencePoint(doc5, 369, 1, 369, 100)
AssOptIL.Emit(OpCodes.Br, cont105)
AssOptIL.MarkLabel(cont105)
AssOptIL.MarkSequencePoint(doc5, 371, 1, 371, 100)
AssOptIL.Emit(OpCodes.Ret)
Dim typ67(-1) As Type
ReDim Preserve typ67(UBound(typ67) + 1)
typ67(UBound(typ67)) = GetType(Stmt)
ReDim Preserve typ67(UBound(typ67) + 1)
typ67(UBound(typ67)) = GetType(System.Boolean).MakeByRefType()
Dim checkAssign As MethodBuilder = StmtOptimizer.DefineMethod("checkAssign", MethodAttributes.Public, GetType(Stmt), typ67)
...
checkAssignIL.MarkSequencePoint(doc5, 374, 1, 374, 100)
Dim locbldr157 As LocalBuilder = checkAssignIL.DeclareLocal(GetType(Token))
locbldr157.SetLocalSymInfo("tok")
checkAssignIL.Emit(OpCodes.Ldnull)
checkAssignIL.Emit(OpCodes.Stloc, 0)
checkAssignIL.MarkSequencePoint(doc5, 375, 1, 375, 100)
Dim locbldr158 As LocalBuilder = checkAssignIL.DeclareLocal(GetType(System.Type))
...
checkAssignIL.Emit(OpCodes.Call, GetType(System.Type).GetMethod("GetTypeFromHandle", typ68))
Typ = GetType(System.Type).GetMethod("GetTypeFromHandle", typ68).ReturnType
checkAssignIL.Emit(OpCodes.Stloc, 1)
checkAssignIL.MarkSequencePoint(doc5, 376, 1, 376, 100)
Dim locbldr159 As LocalBuilder = checkAssignIL.DeclareLocal(GetType(AssignStmt))
locbldr159.SetLocalSymInfo("asss")
checkAssignIL.Emit(OpCodes.Newobj, GetType(AssignStmt).GetConstructor(Type.EmptyTypes))
checkAssignIL.Emit(OpCodes.Stloc, 2)
checkAssignIL.MarkSequencePoint(doc5, 377, 1, 377, 100)
Dim locbldr160 As LocalBuilder = checkAssignIL.DeclareLocal(GetType(System.Boolean))
locbldr160.SetLocalSymInfo("c")
checkAssignIL.Emit(OpCodes.Ldc_I4, 0)
Typ = GetType(System.Boolean)
checkAssignIL.Emit(OpCodes.Stloc, 3)
checkAssignIL.MarkSequencePoint(doc5, 378, 1, 378, 100)
Dim locbldr161 As LocalBuilder = checkAssignIL.DeclareLocal(GetType(Expr))
locbldr161.SetLocalSymInfo("re")
checkAssignIL.Emit(OpCodes.Newobj, GetType(Expr).GetConstructor(Type.EmptyTypes))
checkAssignIL.Emit(OpCodes.Stloc, 4)
checkAssignIL.MarkSequencePoint(doc5, 379, 1, 379, 100)
Dim locbldr162 As LocalBuilder = checkAssignIL.DeclareLocal(GetType(Expr))
locbldr162.SetLocalSymInfo("le")
checkAssignIL.Emit(OpCodes.Newobj, GetType(Expr).GetConstructor(Type.EmptyTypes))
checkAssignIL.Emit(OpCodes.Stloc, 5)
checkAssignIL.MarkSequencePoint(doc5, 380, 1, 380, 100)
Dim locbldr163 As LocalBuilder = checkAssignIL.DeclareLocal(GetType(System.Int32))
locbldr163.SetLocalSymInfo("i")
checkAssignIL.Emit(OpCodes.Ldc_I4, CInt(-1))
Typ = GetType(System.Int32)
checkAssignIL.Emit(OpCodes.Stloc, 6)
checkAssignIL.MarkSequencePoint(doc5, 381, 1, 381, 100)
Dim locbldr164 As LocalBuilder = checkAssignIL.DeclareLocal(GetType(System.Int32))
...
checkAssignIL.MarkSequencePoint(doc5, 382, 1, 382, 100)
Dim locbldr165 As LocalBuilder = checkAssignIL.DeclareLocal(GetType(System.Int32))
locbldr165.SetLocalSymInfo("assind")
checkAssignIL.Emit(OpCodes.Ldc_I4, CInt(0))
Typ = GetType(System.Int32)
checkAssignIL.Emit(OpCodes.Stloc, 8)
checkAssignIL.MarkSequencePoint(doc5, 384, 1, 384, 100)
Dim label7 As System.Reflection.Emit.Label = checkAssignIL.DefineLabel()
checkAssignIL.MarkSequencePoint(doc5, 385, 1, 385, 100)
Dim label8 As System.Reflection.Emit.Label = checkAssignIL.DefineLabel()
checkAssignIL.MarkSequencePoint(doc5, 387, 1, 387, 100)
checkAssignIL.MarkLabel(label7)
checkAssignIL.MarkSequencePoint(doc5, 389, 1, 389, 100)
...
checkAssignIL.Emit(OpCodes.Stloc, 6)
checkAssignIL.MarkSequencePoint(doc5, 391, 1, 391, 100)
checkAssignIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
checkAssignIL.Emit(OpCodes.Ldfld, GetType(Stmt).GetField("Tokens"))
Typ = GetType(Stmt).GetField("Tokens").FieldType
...
Typ = Typ.GetElementType()
checkAssignIL.Emit(OpCodes.Stloc, 0)
checkAssignIL.MarkSequencePoint(doc5, 392, 1, 392, 100)
Dim typ69(-1) As Type
...
checkAssignIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("IsInstanceOfType", typ69))
Typ = Typ03.GetMethod("IsInstanceOfType", typ69).ReturnType
checkAssignIL.Emit(OpCodes.Stloc, 3)
checkAssignIL.MarkSequencePoint(doc5, 394, 1, 394, 100)
checkAssignIL.Emit(OpCodes.Ldloc, 3)
Typ = GetType(System.Boolean)
checkAssignIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa107 As System.Reflection.Emit.Label = checkAssignIL.DefineLabel()
Dim tru107 As System.Reflection.Emit.Label = checkAssignIL.DefineLabel()
Dim cont107 As System.Reflection.Emit.Label = checkAssignIL.DefineLabel()
checkAssignIL.Emit(OpCodes.Beq, tru107)
checkAssignIL.Emit(OpCodes.Br, fa107)
checkAssignIL.MarkLabel(tru107)
checkAssignIL.MarkSequencePoint(doc5, 395, 1, 395, 100)
checkAssignIL.Emit(OpCodes.Ldloc, 6)
Typ = GetType(System.Int32)
checkAssignIL.Emit(OpCodes.Stloc, 8)
checkAssignIL.MarkSequencePoint(doc5, 396, 1, 396, 100)
checkAssignIL.Emit(OpCodes.Br, label8)
checkAssignIL.MarkSequencePoint(doc5, 397, 1, 397, 100)
checkAssignIL.Emit(OpCodes.Br, cont107)
checkAssignIL.MarkLabel(fa107)
checkAssignIL.Emit(OpCodes.Br, cont107)
checkAssignIL.MarkLabel(cont107)
checkAssignIL.MarkSequencePoint(doc5, 399, 1, 399, 100)
checkAssignIL.Emit(OpCodes.Ldloc, 6)
Typ = GetType(System.Int32)
checkAssignIL.Emit(OpCodes.Ldloc, 7)
Typ = GetType(System.Int32)
Dim fa108 As System.Reflection.Emit.Label = checkAssignIL.DefineLabel()
Dim tru108 As System.Reflection.Emit.Label = checkAssignIL.DefineLabel()
Dim cont108 As System.Reflection.Emit.Label = checkAssignIL.DefineLabel()
checkAssignIL.Emit(OpCodes.Beq, tru108)
checkAssignIL.Emit(OpCodes.Br, fa108)
checkAssignIL.MarkLabel(tru108)
checkAssignIL.MarkSequencePoint(doc5, 400, 1, 400, 100)
checkAssignIL.Emit(OpCodes.Br, label8)
checkAssignIL.MarkSequencePoint(doc5, 401, 1, 401, 100)
checkAssignIL.Emit(OpCodes.Br, cont108)
checkAssignIL.MarkLabel(fa108)
checkAssignIL.MarkSequencePoint(doc5, 402, 1, 402, 100)
checkAssignIL.Emit(OpCodes.Br, label7)
checkAssignIL.MarkSequencePoint(doc5, 403, 1, 403, 100)
checkAssignIL.Emit(OpCodes.Br, cont108)
checkAssignIL.MarkLabel(cont108)
checkAssignIL.MarkSequencePoint(doc5, 405, 1, 405, 100)
checkAssignIL.MarkLabel(label8)
checkAssignIL.MarkSequencePoint(doc5, 407, 1, 407, 100)
checkAssignIL.Emit(OpCodes.Ldloc, 8)
Typ = GetType(System.Int32)
checkAssignIL.Emit(OpCodes.Ldc_I4, CInt(0))
Typ = GetType(System.Int32)
Dim fa109 As System.Reflection.Emit.Label = checkAssignIL.DefineLabel()
Dim tru109 As System.Reflection.Emit.Label = checkAssignIL.DefineLabel()
Dim cont109 As System.Reflection.Emit.Label = checkAssignIL.DefineLabel()
checkAssignIL.Emit(OpCodes.Beq, fa109)
checkAssignIL.Emit(OpCodes.Br, tru109)
checkAssignIL.MarkLabel(tru109)
checkAssignIL.MarkSequencePoint(doc5, 409, 1, 409, 100)
checkAssignIL.Emit(OpCodes.Ldc_I4, CInt(-1))
Typ = GetType(System.Int32)
checkAssignIL.Emit(OpCodes.Stloc, 6)
checkAssignIL.MarkSequencePoint(doc5, 410, 1, 410, 100)
checkAssignIL.Emit(OpCodes.Ldloc, 8)
Typ = GetType(System.Int32)
checkAssignIL.Emit(OpCodes.Ldc_I4, CInt(1))
Typ = GetType(System.Int32)
checkAssignIL.Emit(OpCodes.Sub)
checkAssignIL.Emit(OpCodes.Stloc, 7)
checkAssignIL.MarkSequencePoint(doc5, 412, 1, 412, 100)
Dim label9 As System.Reflection.Emit.Label = checkAssignIL.DefineLabel()
checkAssignIL.MarkSequencePoint(doc5, 413, 1, 413, 100)
Dim label10 As System.Reflection.Emit.Label = checkAssignIL.DefineLabel()
checkAssignIL.MarkSequencePoint(doc5, 415, 1, 415, 100)
checkAssignIL.MarkLabel(label9)
checkAssignIL.MarkSequencePoint(doc5, 417, 1, 417, 100)
checkAssignIL.Emit(OpCodes.Ldloc, 6)
Typ = GetType(System.Int32)
checkAssignIL.Emit(OpCodes.Ldc_I4, CInt(1))
Typ = GetType(System.Int32)
checkAssignIL.Emit(OpCodes.Add)
checkAssignIL.Emit(OpCodes.Stloc, 6)
checkAssignIL.MarkSequencePoint(doc5, 419, 1, 419, 100)
Dim typ70(-1) As Type
...
ReDim Preserve typ70(UBound(typ70) + 1)
typ70(UBound(typ70)) = Typ
checkAssignIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("AddToken", typ70))
Typ = Typ03.GetMethod("AddToken", typ70).ReturnType
If Typ.ToString() = GetType(System.Void).ToString() Then

Else
checkAssignIL.Emit(OpCodes.Pop)
End If
checkAssignIL.MarkSequencePoint(doc5, 421, 1, 421, 100)
checkAssignIL.Emit(OpCodes.Ldloc, 6)
Typ = GetType(System.Int32)
checkAssignIL.Emit(OpCodes.Ldloc, 7)
Typ = GetType(System.Int32)
Dim fa110 As System.Reflection.Emit.Label = checkAssignIL.DefineLabel()
Dim tru110 As System.Reflection.Emit.Label = checkAssignIL.DefineLabel()
Dim cont110 As System.Reflection.Emit.Label = checkAssignIL.DefineLabel()
checkAssignIL.Emit(OpCodes.Beq, tru110)
checkAssignIL.Emit(OpCodes.Br, fa110)
checkAssignIL.MarkLabel(tru110)
checkAssignIL.MarkSequencePoint(doc5, 422, 1, 422, 100)
checkAssignIL.Emit(OpCodes.Br, label10)
checkAssignIL.MarkSequencePoint(doc5, 423, 1, 423, 100)
checkAssignIL.Emit(OpCodes.Br, cont110)
checkAssignIL.MarkLabel(fa110)
checkAssignIL.MarkSequencePoint(doc5, 424, 1, 424, 100)
checkAssignIL.Emit(OpCodes.Br, label9)
checkAssignIL.MarkSequencePoint(doc5, 425, 1, 425, 100)
checkAssignIL.Emit(OpCodes.Br, cont110)
checkAssignIL.MarkLabel(cont110)
checkAssignIL.MarkSequencePoint(doc5, 427, 1, 427, 100)
...
checkAssignIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("AddToken", typ71))
...
checkAssignIL.Emit(OpCodes.Pop)
End If
checkAssignIL.MarkSequencePoint(doc5, 442, 1, 442, 100)
checkAssignIL.Emit(OpCodes.Ldloc, 6)
Typ = GetType(System.Int32)
checkAssignIL.Emit(OpCodes.Ldloc, 7)
Typ = GetType(System.Int32)
Dim fa111 As System.Reflection.Emit.Label = checkAssignIL.DefineLabel()
Dim tru111 As System.Reflection.Emit.Label = checkAssignIL.DefineLabel()
Dim cont111 As System.Reflection.Emit.Label = checkAssignIL.DefineLabel()
checkAssignIL.Emit(OpCodes.Beq, tru111)
checkAssignIL.Emit(OpCodes.Br, fa111)
checkAssignIL.MarkLabel(tru111)
checkAssignIL.MarkSequencePoint(doc5, 443, 1, 443, 100)
checkAssignIL.Emit(OpCodes.Br, label12)
checkAssignIL.MarkSequencePoint(doc5, 444, 1, 444, 100)
checkAssignIL.Emit(OpCodes.Br, cont111)
checkAssignIL.MarkLabel(fa111)
checkAssignIL.MarkSequencePoint(doc5, 445, 1, 445, 100)
checkAssignIL.Emit(OpCodes.Br, label11)
checkAssignIL.MarkSequencePoint(doc5, 446, 1, 446, 100)
checkAssignIL.Emit(OpCodes.Br, cont111)
checkAssignIL.MarkLabel(cont111)
...
checkAssignIL.Emit(OpCodes.Br, cont109)
checkAssignIL.MarkLabel(fa109)
checkAssignIL.MarkSequencePoint(doc5, 462, 1, 462, 100)
checkAssignIL.Emit(OpCodes.Ldarg, 2)
Typ = GetType(System.Boolean).MakeByRefType()
Typ04 = Typ.GetElementType()
checkAssignIL.Emit(OpCodes.Ldc_I4, 0)
...
checkAssignIL.Emit(OpCodes.Br, cont109)
checkAssignIL.MarkLabel(cont109)
checkAssignIL.MarkSequencePoint(doc5, 467, 1, 467, 100)
checkAssignIL.Emit(OpCodes.Ret)
Dim typ73(-1) As Type
ReDim Preserve typ73(UBound(typ73) + 1)
typ73(UBound(typ73)) = GetType(Stmt)
Dim Optimize As MethodBuilder = StmtOptimizer.DefineMethod("Optimize", MethodAttributes.Public, GetType(Stmt), typ73)
Dim OptimizeIL As ILGenerator = Optimize.GetILGenerator()
Dim Optimizeparam00 As ParameterBuilder = Optimize.DefineParameter(0, ParameterAttributes.RetVal, "")
Dim Optimizeparam01 As ParameterBuilder = Optimize.DefineParameter(1, ParameterAttributes.None, "stm")
OptimizeIL.MarkSequencePoint(doc5, 471, 1, 471, 100)
Dim typ74(-1) As Type
OptimizeIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
...
ReDim Preserve typ74(UBound(typ74) + 1)
typ74(UBound(typ74)) = Typ
OptimizeIL.Emit(OpCodes.Call, GetType(Console).GetMethod("WriteLine", typ74))
Typ = GetType(Console).GetMethod("WriteLine", typ74).ReturnType
If Typ.ToString() = GetType(System.Void).ToString() Then

Else
OptimizeIL.Emit(OpCodes.Pop)
End If
OptimizeIL.MarkSequencePoint(doc5, 473, 1, 473, 100)
Dim locbldr166 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(System.Int32))
locbldr166.SetLocalSymInfo("i")
OptimizeIL.Emit(OpCodes.Ldc_I4, CInt(-1))
Typ = GetType(System.Int32)
OptimizeIL.Emit(OpCodes.Stloc, 0)
OptimizeIL.MarkSequencePoint(doc5, 474, 1, 474, 100)
Dim locbldr167 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(System.Int32))
...
Typ = GetType(System.Int32)
OptimizeIL.Emit(OpCodes.Stloc, 1)
OptimizeIL.MarkSequencePoint(doc5, 475, 1, 475, 100)
Dim locbldr168 As LocalBuilder = OptimizeIL.DeclareLocal(asm.GetType("dylan.NET.Tokenizer.Parser.TokenOptimizer"))
locbldr168.SetLocalSymInfo("to")
OptimizeIL.Emit(OpCodes.Ldnull)
OptimizeIL.Emit(OpCodes.Stloc, 2)
OptimizeIL.MarkSequencePoint(doc5, 476, 1, 476, 100)
Dim locbldr169 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(Stmt))
locbldr169.SetLocalSymInfo("tmpstm")
OptimizeIL.Emit(OpCodes.Ldnull)
OptimizeIL.Emit(OpCodes.Stloc, 3)
OptimizeIL.MarkSequencePoint(doc5, 477, 1, 477, 100)
Dim locbldr170 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(System.Boolean))
locbldr170.SetLocalSymInfo("compb")
OptimizeIL.Emit(OpCodes.Ldc_I4, 0)
Typ = GetType(System.Boolean)
OptimizeIL.Emit(OpCodes.Stloc, 4)
OptimizeIL.MarkSequencePoint(doc5, 478, 1, 478, 100)
OptimizeIL.Emit(OpCodes.Ldloc, 1)
Typ = GetType(System.Int32)
OptimizeIL.Emit(OpCodes.Ldc_I4, CInt(1))
Typ = GetType(System.Int32)
...
OptimizeIL.Emit(OpCodes.Stloc, 1)
OptimizeIL.MarkSequencePoint(doc5, 480, 1, 480, 100)
OptimizeIL.Emit(OpCodes.Ldc_I4, 0)
Typ = GetType(System.Boolean)
OptimizeIL.Emit(OpCodes.Stsfld, asm.GetType("dylan.NET.Tokenizer.Parser.ParserFlags").GetField("IfFlag"))
OptimizeIL.MarkSequencePoint(doc5, 481, 1, 481, 100)
OptimizeIL.Emit(OpCodes.Ldc_I4, 0)
Typ = GetType(System.Boolean)
OptimizeIL.Emit(OpCodes.Stsfld, asm.GetType("dylan.NET.Tokenizer.Parser.ParserFlags").GetField("CmtFlag"))
OptimizeIL.MarkSequencePoint(doc5, 482, 1, 482, 100)
OptimizeIL.Emit(OpCodes.Ldc_I4, 0)
Typ = GetType(System.Boolean)
OptimizeIL.Emit(OpCodes.Stsfld, asm.GetType("dylan.NET.Tokenizer.Parser.ParserFlags").GetField("NoOptFlag"))
OptimizeIL.MarkSequencePoint(doc5, 484, 1, 484, 100)
Dim label13 As System.Reflection.Emit.Label = OptimizeIL.DefineLabel()
OptimizeIL.MarkSequencePoint(doc5, 485, 1, 485, 100)
Dim label14 As System.Reflection.Emit.Label = OptimizeIL.DefineLabel()
OptimizeIL.MarkSequencePoint(doc5, 486, 1, 486, 100)
Dim label15 As System.Reflection.Emit.Label = OptimizeIL.DefineLabel()
OptimizeIL.MarkSequencePoint(doc5, 488, 1, 488, 100)
OptimizeIL.Emit(OpCodes.Ldloc, 1)
Typ = GetType(System.Int32)
OptimizeIL.Emit(OpCodes.Ldc_I4, CInt(0))
Typ = GetType(System.Int32)
...
OptimizeIL.MarkSequencePoint(doc5, 489, 1, 489, 100)
OptimizeIL.Emit(OpCodes.Br, label14)
OptimizeIL.MarkSequencePoint(doc5, 490, 1, 490, 100)
OptimizeIL.Emit(OpCodes.Br, cont112)
OptimizeIL.MarkLabel(fa112)
OptimizeIL.Emit(OpCodes.Br, cont112)
OptimizeIL.MarkLabel(cont112)
OptimizeIL.MarkSequencePoint(doc5, 492, 1, 492, 100)
OptimizeIL.MarkLabel(label13)
OptimizeIL.MarkSequencePoint(doc5, 494, 1, 494, 100)
OptimizeIL.Emit(OpCodes.Ldloc, 0)
Typ = GetType(System.Int32)
OptimizeIL.Emit(OpCodes.Ldc_I4, CInt(1))
Typ = GetType(System.Int32)
...
OptimizeIL.Emit(OpCodes.Stloc, 0)
OptimizeIL.MarkSequencePoint(doc5, 496, 1, 496, 100)
...
OptimizeIL.MarkSequencePoint(doc5, 497, 1, 497, 100)
OptimizeIL.Emit(OpCodes.Br, label14)
OptimizeIL.MarkSequencePoint(doc5, 498, 1, 498, 100)
OptimizeIL.Emit(OpCodes.Br, cont113)
OptimizeIL.MarkLabel(fa113)
OptimizeIL.Emit(OpCodes.Br, cont113)
OptimizeIL.MarkLabel(cont113)
OptimizeIL.MarkSequencePoint(doc5, 501, 1, 501, 100)
...
ReDim Preserve typ75(UBound(typ75) + 1)
typ75(UBound(typ75)) = Typ
OptimizeIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("Optimize", typ75))
Typ = Typ03.GetMethod("Optimize", typ75).ReturnType
Typ = Typ02
OptimizeIL.Emit(OpCodes.Stelem, Typ.GetElementType())
OptimizeIL.MarkSequencePoint(doc5, 508, 1, 508, 100)
OptimizeIL.Emit(OpCodes.Ldloc, 0)
Typ = GetType(System.Int32)
OptimizeIL.Emit(OpCodes.Ldloc, 1)
Typ = GetType(System.Int32)
...
OptimizeIL.MarkSequencePoint(doc5, 509, 1, 509, 100)
OptimizeIL.Emit(OpCodes.Br, label14)
OptimizeIL.MarkSequencePoint(doc5, 510, 1, 510, 100)
OptimizeIL.Emit(OpCodes.Br, cont115)
OptimizeIL.MarkLabel(fa115)
OptimizeIL.MarkSequencePoint(doc5, 511, 1, 511, 100)
OptimizeIL.Emit(OpCodes.Br, label13)
OptimizeIL.MarkSequencePoint(doc5, 512, 1, 512, 100)
OptimizeIL.Emit(OpCodes.Br, cont115)
OptimizeIL.MarkLabel(cont115)
OptimizeIL.MarkSequencePoint(doc5, 514, 1, 514, 100)
OptimizeIL.MarkLabel(label14)
OptimizeIL.MarkSequencePoint(doc5, 516, 1, 516, 100)
OptimizeIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
OptimizeIL.Emit(OpCodes.Ldfld, GetType(Stmt).GetField("Tokens"))
Typ = GetType(Stmt).GetField("Tokens").FieldType
...
OptimizeIL.MarkSequencePoint(doc5, 517, 1, 517, 100)
OptimizeIL.Emit(OpCodes.Br, label15)
OptimizeIL.MarkSequencePoint(doc5, 518, 1, 518, 100)
OptimizeIL.Emit(OpCodes.Br, cont116)
OptimizeIL.MarkLabel(fa116)
OptimizeIL.Emit(OpCodes.Br, cont116)
OptimizeIL.MarkLabel(cont116)
OptimizeIL.MarkSequencePoint(doc5, 520, 1, 520, 100)
...
OptimizeIL.Emit(OpCodes.Stloc, 3)
OptimizeIL.MarkSequencePoint(doc5, 522, 1, 522, 100)
OptimizeIL.Emit(OpCodes.Ldloc, 4)
Typ = GetType(System.Boolean)
OptimizeIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
...
OptimizeIL.MarkSequencePoint(doc5, 523, 1, 523, 100)
OptimizeIL.Emit(OpCodes.Ldloc, 3)
Typ = GetType(Stmt)
OptimizeIL.Emit(OpCodes.Starg, 1)
OptimizeIL.MarkSequencePoint(doc5, 524, 1, 524, 100)
OptimizeIL.Emit(OpCodes.Br, label15)
OptimizeIL.MarkSequencePoint(doc5, 525, 1, 525, 100)
...
OptimizeIL.Emit(OpCodes.Br, label15)
OptimizeIL.MarkSequencePoint(doc5, 539, 1, 539, 100)
...
OptimizeIL.Emit(OpCodes.Stloc, 3)
OptimizeIL.MarkSequencePoint(doc5, 543, 1, 543, 100)
OptimizeIL.Emit(OpCodes.Ldloc, 4)
Typ = GetType(System.Boolean)
OptimizeIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
...
OptimizeIL.MarkSequencePoint(doc5, 551, 1, 551, 100)
OptimizeIL.Emit(OpCodes.Ldloc, 3)
Typ = GetType(Stmt)
OptimizeIL.Emit(OpCodes.Starg, 1)
...
OptimizeIL.MarkSequencePoint(doc5, 555, 1, 555, 100)
OptimizeIL.Emit(OpCodes.Ldarg_0)
Dim typ81(-1) As Type
OptimizeIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
...
OptimizeIL.Emit(OpCodes.Br, label15)
OptimizeIL.MarkSequencePoint(doc5, 560, 1, 560, 100)
...
OptimizeIL.MarkSequencePoint(doc5, 569, 1, 569, 100)
OptimizeIL.Emit(OpCodes.Ldarg_0)
Dim typ83(-1) As Type
OptimizeIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
...
OptimizeIL.Emit(OpCodes.Stloc, 3)
OptimizeIL.MarkSequencePoint(doc5, 571, 1, 571, 100)
OptimizeIL.Emit(OpCodes.Ldloc, 4)
Typ = GetType(System.Boolean)
OptimizeIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
...
OptimizeIL.MarkSequencePoint(doc5, 582, 1, 582, 100)
OptimizeIL.Emit(OpCodes.Br, label15)
...
Dim locbldr171 As LocalBuilder = ParseIL.DeclareLocal(GetType(System.Int32))
...
Dim locbldr172 As LocalBuilder = ParseIL.DeclareLocal(asm.GetType("dylan.NET.Tokenizer.Parser.StmtOptimizer"))
locbldr172.SetLocalSymInfo("so")
ParseIL.Emit(OpCodes.Ldnull)
ParseIL.Emit(OpCodes.Stloc, 1)
ParseIL.MarkSequencePoint(doc6, 6, 1, 6, 100)
Dim locbldr173 As LocalBuilder = ParseIL.DeclareLocal(GetType(System.Int32))
...
ParseIL.Emit(OpCodes.Ldloc, 2)
Typ = GetType(System.Int32)
Dim fa126 As System.Reflection.Emit.Label = ParseIL.DefineLabel()
Dim tru126 As System.Reflection.Emit.Label = ParseIL.DefineLabel()
Dim cont126 As System.Reflection.Emit.Label = ParseIL.DefineLabel()
ParseIL.Emit(OpCodes.Beq, tru126)
ParseIL.Emit(OpCodes.Br, fa126)
ParseIL.MarkLabel(tru126)
ParseIL.MarkSequencePoint(doc6, 19, 1, 19, 100)
ParseIL.Emit(OpCodes.Br, label1)
ParseIL.MarkSequencePoint(doc6, 20, 1, 20, 100)
ParseIL.Emit(OpCodes.Br, cont126)
ParseIL.MarkLabel(fa126)
ParseIL.MarkSequencePoint(doc6, 21, 1, 21, 100)
ParseIL.Emit(OpCodes.Br, label0)
ParseIL.MarkSequencePoint(doc6, 22, 1, 22, 100)
ParseIL.Emit(OpCodes.Br, cont126)
ParseIL.MarkLabel(cont126)
