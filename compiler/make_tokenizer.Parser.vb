...
ReDim Preserve typ74(UBound(typ74) + 1)
typ74(UBound(typ74)) = Typ
OptimizeIL.Emit(OpCodes.Call, GetType(dnu.ParseUtils).GetMethod("LikeOP", typ74))
Typ = GetType(dnu.ParseUtils).GetMethod("LikeOP", typ74).ReturnType
OptimizeIL.Emit(OpCodes.Stloc, 1)
...
ReDim Preserve typ75(UBound(typ75) + 1)
typ75(UBound(typ75)) = Typ
OptimizeIL.Emit(OpCodes.Call, GetType(dnu.ParseUtils).GetMethod("LikeOP", typ75))
Typ = GetType(dnu.ParseUtils).GetMethod("LikeOP", typ75).ReturnType
OptimizeIL.Emit(OpCodes.Stloc, 1)
...
ReDim Preserve typ80(UBound(typ80) + 1)
typ80(UBound(typ80)) = Typ
OptimizeIL.Emit(OpCodes.Call, GetType(dnu.ParseUtils).GetMethod("LikeOP", typ80))
Typ = GetType(dnu.ParseUtils).GetMethod("LikeOP", typ80).ReturnType
OptimizeIL.Emit(OpCodes.Stloc, 1)
...
ReDim Preserve typ84(UBound(typ84) + 1)
typ84(UBound(typ84)) = Typ
OptimizeIL.Emit(OpCodes.Call, GetType(dnu.ParseUtils).GetMethod("LikeOP", typ84))
Typ = GetType(dnu.ParseUtils).GetMethod("LikeOP", typ84).ReturnType
OptimizeIL.Emit(OpCodes.Stloc, 1)
...
ReDim Preserve typ85(UBound(typ85) + 1)
typ85(UBound(typ85)) = Typ
OptimizeIL.Emit(OpCodes.Call, GetType(dnu.ParseUtils).GetMethod("LikeOP", typ85))
Typ = GetType(dnu.ParseUtils).GetMethod("LikeOP", typ85).ReturnType
OptimizeIL.Emit(OpCodes.Stloc, 1)
...
ReDim Preserve typ91(UBound(typ91) + 1)
typ91(UBound(typ91)) = Typ
OptimizeIL.Emit(OpCodes.Call, GetType(dnu.ParseUtils).GetMethod("LikeOP", typ91))
Typ = GetType(dnu.ParseUtils).GetMethod("LikeOP", typ91).ReturnType
OptimizeIL.Emit(OpCodes.Stloc, 1)
...
ReDim Preserve typ92(UBound(typ92) + 1)
typ92(UBound(typ92)) = Typ
OptimizeIL.Emit(OpCodes.Call, GetType(dnu.ParseUtils).GetMethod("LikeOP", typ92))
Typ = GetType(dnu.ParseUtils).GetMethod("LikeOP", typ92).ReturnType
OptimizeIL.Emit(OpCodes.Stloc, 1)
...
ReDim Preserve typ98(UBound(typ98) + 1)
typ98(UBound(typ98)) = Typ
OptimizeIL.Emit(OpCodes.Call, GetType(dnu.ParseUtils).GetMethod("LikeOP", typ98))
Typ = GetType(dnu.ParseUtils).GetMethod("LikeOP", typ98).ReturnType
OptimizeIL.Emit(OpCodes.Stloc, 1)
...
ReDim Preserve typ102(UBound(typ102) + 1)
typ102(UBound(typ102)) = Typ
OptimizeIL.Emit(OpCodes.Call, GetType(dnu.ParseUtils).GetMethod("LikeOP", typ102))
Typ = GetType(dnu.ParseUtils).GetMethod("LikeOP", typ102).ReturnType
OptimizeIL.Emit(OpCodes.Stloc, 1)
...
ReDim Preserve typ103(UBound(typ103) + 1)
typ103(UBound(typ103)) = Typ
OptimizeIL.Emit(OpCodes.Call, GetType(dnu.ParseUtils).GetMethod("LikeOP", typ103))
Typ = GetType(dnu.ParseUtils).GetMethod("LikeOP", typ103).ReturnType
OptimizeIL.Emit(OpCodes.Stloc, 1)
...
ReDim Preserve typ109(UBound(typ109) + 1)
typ109(UBound(typ109)) = Typ
OptimizeIL.Emit(OpCodes.Call, GetType(dnu.ParseUtils).GetMethod("LikeOP", typ109))
Typ = GetType(dnu.ParseUtils).GetMethod("LikeOP", typ109).ReturnType
OptimizeIL.Emit(OpCodes.Stloc, 1)
...
ReDim Preserve typ110(UBound(typ110) + 1)
typ110(UBound(typ110)) = Typ
OptimizeIL.Emit(OpCodes.Call, GetType(dnu.ParseUtils).GetMethod("LikeOP", typ110))
Typ = GetType(dnu.ParseUtils).GetMethod("LikeOP", typ110).ReturnType
OptimizeIL.Emit(OpCodes.Stloc, 1)
...
ReDim Preserve typ116(UBound(typ116) + 1)
typ116(UBound(typ116)) = Typ
OptimizeIL.Emit(OpCodes.Call, GetType(dnu.ParseUtils).GetMethod("LikeOP", typ116))
Typ = GetType(dnu.ParseUtils).GetMethod("LikeOP", typ116).ReturnType
OptimizeIL.Emit(OpCodes.Stloc, 1)
...
ReDim Preserve typ117(UBound(typ117) + 1)
typ117(UBound(typ117)) = Typ
OptimizeIL.Emit(OpCodes.Call, GetType(dnu.ParseUtils).GetMethod("LikeOP", typ117))
Typ = GetType(dnu.ParseUtils).GetMethod("LikeOP", typ117).ReturnType
OptimizeIL.Emit(OpCodes.Stloc, 1)
...
ReDim Preserve typ123(UBound(typ123) + 1)
typ123(UBound(typ123)) = Typ
OptimizeIL.Emit(OpCodes.Call, GetType(dnu.ParseUtils).GetMethod("LikeOP", typ123))
Typ = GetType(dnu.ParseUtils).GetMethod("LikeOP", typ123).ReturnType
OptimizeIL.Emit(OpCodes.Stloc, 1)
...
ReDim Preserve typ124(UBound(typ124) + 1)
typ124(UBound(typ124)) = Typ
OptimizeIL.Emit(OpCodes.Call, GetType(dnu.ParseUtils).GetMethod("LikeOP", typ124))
Typ = GetType(dnu.ParseUtils).GetMethod("LikeOP", typ124).ReturnType
OptimizeIL.Emit(OpCodes.Stloc, 1)
...
ReDim Preserve typ130(UBound(typ130) + 1)
typ130(UBound(typ130)) = Typ
OptimizeIL.Emit(OpCodes.Call, GetType(dnu.ParseUtils).GetMethod("LikeOP", typ130))
Typ = GetType(dnu.ParseUtils).GetMethod("LikeOP", typ130).ReturnType
OptimizeIL.Emit(OpCodes.Stloc, 1)
...
ReDim Preserve typ131(UBound(typ131) + 1)
typ131(UBound(typ131)) = Typ
OptimizeIL.Emit(OpCodes.Call, GetType(dnu.ParseUtils).GetMethod("LikeOP", typ131))
Typ = GetType(dnu.ParseUtils).GetMethod("LikeOP", typ131).ReturnType
OptimizeIL.Emit(OpCodes.Stloc, 1)
...
ReDim Preserve typ137(UBound(typ137) + 1)
typ137(UBound(typ137)) = Typ
OptimizeIL.Emit(OpCodes.Call, GetType(dnu.ParseUtils).GetMethod("LikeOP", typ137))
Typ = GetType(dnu.ParseUtils).GetMethod("LikeOP", typ137).ReturnType
OptimizeIL.Emit(OpCodes.Stloc, 1)
...
ReDim Preserve typ138(UBound(typ138) + 1)
typ138(UBound(typ138)) = Typ
OptimizeIL.Emit(OpCodes.Call, GetType(dnu.ParseUtils).GetMethod("LikeOP", typ138))
Typ = GetType(dnu.ParseUtils).GetMethod("LikeOP", typ138).ReturnType
OptimizeIL.Emit(OpCodes.Stloc, 1)
...
ReDim Preserve typ144(UBound(typ144) + 1)
typ144(UBound(typ144)) = Typ
OptimizeIL.Emit(OpCodes.Call, GetType(dnu.ParseUtils).GetMethod("LikeOP", typ144))
Typ = GetType(dnu.ParseUtils).GetMethod("LikeOP", typ144).ReturnType
OptimizeIL.Emit(OpCodes.Stloc, 1)
...
ReDim Preserve typ147(UBound(typ147) + 1)
typ147(UBound(typ147)) = Typ
OptimizeIL.Emit(OpCodes.Call, GetType(dnu.ParseUtils).GetMethod("LikeOP", typ147))
Typ = GetType(dnu.ParseUtils).GetMethod("LikeOP", typ147).ReturnType
OptimizeIL.Emit(OpCodes.Stloc, 1)
...
ReDim Preserve typ148(UBound(typ148) + 1)
typ148(UBound(typ148)) = Typ
OptimizeIL.Emit(OpCodes.Call, GetType(dnu.ParseUtils).GetMethod("LikeOP", typ148))
Typ = GetType(dnu.ParseUtils).GetMethod("LikeOP", typ148).ReturnType
OptimizeIL.Emit(OpCodes.Stloc, 1)
...
Dim checkClass As MethodBuilder = StmtOptimizer.DefineMethod("checkClass", MethodAttributes.Public, GetType(Stmt), typ12)
...
checkClassIL.MarkSequencePoint(doc4, 57, 1, 57, 100)
Dim locbldr94 As LocalBuilder = checkClassIL.DeclareLocal(GetType(Token))
...
checkClassIL.MarkSequencePoint(doc4, 58, 1, 58, 100)
Dim locbldr95 As LocalBuilder = checkClassIL.DeclareLocal(GetType(System.Type))
...
checkClassIL.Emit(OpCodes.Call, GetType(System.Type).GetMethod("GetTypeFromHandle", typ13))
Typ = GetType(System.Type).GetMethod("GetTypeFromHandle", typ13).ReturnType
checkClassIL.Emit(OpCodes.Stloc, 1)
checkClassIL.MarkSequencePoint(doc4, 59, 1, 59, 100)
...
ReDim Preserve typ14(UBound(typ14) + 1)
typ14(UBound(typ14)) = Typ
checkClassIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("IsInstanceOfType", typ14))
Typ = Typ03.GetMethod("IsInstanceOfType", typ14).ReturnType
checkClassIL.Emit(OpCodes.Stobj, Typ04)
checkClassIL.MarkSequencePoint(doc4, 60, 1, 60, 100)
Dim locbldr96 As LocalBuilder = checkClassIL.DeclareLocal(GetType(ClassStmt))
locbldr96.SetLocalSymInfo("clss")
checkClassIL.Emit(OpCodes.Newobj, GetType(ClassStmt).GetConstructor(Type.EmptyTypes))
checkClassIL.Emit(OpCodes.Stloc, 2)
checkClassIL.MarkSequencePoint(doc4, 61, 1, 61, 100)
Dim locbldr97 As LocalBuilder = checkClassIL.DeclareLocal(GetType(Attributes.Attribute))
locbldr97.SetLocalSymInfo("att")
checkClassIL.Emit(OpCodes.Ldnull)
checkClassIL.Emit(OpCodes.Stloc, 3)
checkClassIL.MarkSequencePoint(doc4, 62, 1, 62, 100)
checkClassIL.Emit(OpCodes.Ldarg, 2)
Typ = GetType(System.Boolean).MakeByRefType()
...
Typ = GetType(System.Boolean)
Dim fa81 As System.Reflection.Emit.Label = checkClassIL.DefineLabel()
Dim tru81 As System.Reflection.Emit.Label = checkClassIL.DefineLabel()
Dim cont81 As System.Reflection.Emit.Label = checkClassIL.DefineLabel()
checkClassIL.Emit(OpCodes.Beq, tru81)
checkClassIL.Emit(OpCodes.Br, fa81)
checkClassIL.MarkLabel(tru81)
checkClassIL.MarkSequencePoint(doc4, 64, 1, 64, 100)
...
checkClassIL.MarkSequencePoint(doc4, 65, 1, 65, 100)
checkClassIL.Emit(OpCodes.Ldloc, 2)
Typ = GetType(ClassStmt)
checkClassIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
...
checkClassIL.MarkSequencePoint(doc4, 67, 1, 67, 100)
Dim label0 As System.Reflection.Emit.Label = checkClassIL.DefineLabel()
checkClassIL.MarkSequencePoint(doc4, 68, 1, 68, 100)
Dim label1 As System.Reflection.Emit.Label = checkClassIL.DefineLabel()
checkClassIL.MarkSequencePoint(doc4, 70, 1, 70, 100)
Dim locbldr98 As LocalBuilder = checkClassIL.DeclareLocal(GetType(System.Int32))
locbldr98.SetLocalSymInfo("i")
checkClassIL.Emit(OpCodes.Ldc_I4, CInt(0))
Typ = GetType(System.Int32)
checkClassIL.Emit(OpCodes.Stloc, 4)
checkClassIL.MarkSequencePoint(doc4, 71, 1, 71, 100)
Dim locbldr99 As LocalBuilder = checkClassIL.DeclareLocal(GetType(System.Int32))
...
checkClassIL.MarkSequencePoint(doc4, 72, 1, 72, 100)
Dim locbldr100 As LocalBuilder = checkClassIL.DeclareLocal(GetType(System.Boolean))
locbldr100.SetLocalSymInfo("bl")
checkClassIL.Emit(OpCodes.Ldc_I4, 0)
Typ = GetType(System.Boolean)
checkClassIL.Emit(OpCodes.Stloc, 6)
checkClassIL.MarkSequencePoint(doc4, 74, 1, 74, 100)
checkClassIL.MarkLabel(label0)
checkClassIL.MarkSequencePoint(doc4, 76, 1, 76, 100)
...
checkClassIL.Emit(OpCodes.Stloc, 4)
checkClassIL.MarkSequencePoint(doc4, 77, 1, 77, 100)
checkClassIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
checkClassIL.Emit(OpCodes.Ldfld, GetType(Stmt).GetField("Tokens"))
Typ = GetType(Stmt).GetField("Tokens").FieldType
...
ReDim Preserve typ16(UBound(typ16) + 1)
typ16(UBound(typ16)) = Typ
checkClassIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("IsInstanceOfType", typ16))
Typ = Typ03.GetMethod("IsInstanceOfType", typ16).ReturnType
checkClassIL.Emit(OpCodes.Stloc, 6)
checkClassIL.MarkSequencePoint(doc4, 81, 1, 81, 100)
...
checkClassIL.MarkSequencePoint(doc4, 82, 1, 82, 100)
checkClassIL.Emit(OpCodes.Ldloc, 0)
Typ = GetType(Token)
checkClassIL.Emit(OpCodes.Stloc, 3)
checkClassIL.MarkSequencePoint(doc4, 83, 1, 83, 100)
Dim typ17(-1) As Type
checkClassIL.Emit(OpCodes.Ldloc, 2)
Typ = GetType(ClassStmt)
Typ03 = Typ
...
ReDim Preserve typ17(UBound(typ17) + 1)
typ17(UBound(typ17)) = Typ
checkClassIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("AddAttr", typ17))
Typ = Typ03.GetMethod("AddAttr", typ17).ReturnType
If Typ.ToString() = GetType(System.Void).ToString() Then

Else
checkClassIL.Emit(OpCodes.Pop)
End If
checkClassIL.MarkSequencePoint(doc4, 84, 1, 84, 100)
checkClassIL.Emit(OpCodes.Br, cont82)
checkClassIL.MarkLabel(fa82)
checkClassIL.MarkSequencePoint(doc4, 86, 1, 86, 100)
...
checkClassIL.MarkSequencePoint(doc4, 87, 1, 87, 100)
...
checkClassIL.Emit(OpCodes.Call, GetType(System.Type).GetMethod("GetTypeFromHandle", typ18))
Typ = GetType(System.Type).GetMethod("GetTypeFromHandle", typ18).ReturnType
checkClassIL.Emit(OpCodes.Stloc, 8)
checkClassIL.MarkSequencePoint(doc4, 88, 1, 88, 100)
Dim locbldr103 As LocalBuilder = checkClassIL.DeclareLocal(GetType(System.Boolean))
...
ReDim Preserve typ19(UBound(typ19) + 1)
typ19(UBound(typ19)) = Typ
checkClassIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("IsInstanceOfType", typ19))
Typ = Typ03.GetMethod("IsInstanceOfType", typ19).ReturnType
checkClassIL.Emit(OpCodes.Stloc, 9)
checkClassIL.MarkSequencePoint(doc4, 90, 1, 90, 100)
...
checkClassIL.MarkSequencePoint(doc4, 91, 1, 91, 100)
checkClassIL.Emit(OpCodes.Ldloc, 4)
Typ = GetType(System.Int32)
checkClassIL.Emit(OpCodes.Ldc_I4, CInt(1))
Typ = GetType(System.Int32)
checkClassIL.Emit(OpCodes.Add)
checkClassIL.Emit(OpCodes.Stloc, 4)
checkClassIL.MarkSequencePoint(doc4, 92, 1, 92, 100)
checkClassIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
checkClassIL.Emit(OpCodes.Ldfld, GetType(Stmt).GetField("Tokens"))
Typ = GetType(Stmt).GetField("Tokens").FieldType
...
Typ = Typ.GetElementType()
checkClassIL.Emit(OpCodes.Stloc, 7)
checkClassIL.MarkSequencePoint(doc4, 93, 1, 93, 100)
checkClassIL.Emit(OpCodes.Ldtoken, GetType(TypeTok))
Dim typ20 As Type() = {GetType(System.RuntimeTypeHandle)}
checkClassIL.Emit(OpCodes.Call, GetType(System.Type).GetMethod("GetTypeFromHandle", typ20))
Typ = GetType(System.Type).GetMethod("GetTypeFromHandle", typ20).ReturnType
checkClassIL.Emit(OpCodes.Stloc, 8)
checkClassIL.MarkSequencePoint(doc4, 94, 1, 94, 100)
Dim typ21(-1) As Type
checkClassIL.Emit(OpCodes.Ldloc, 8)
Typ = GetType(System.Type)
Typ03 = Typ
...
ReDim Preserve typ21(UBound(typ21) + 1)
typ21(UBound(typ21)) = Typ
checkClassIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("IsInstanceOfType", typ21))
...
checkClassIL.Emit(OpCodes.Beq, fa84)
checkClassIL.Emit(OpCodes.Br, tru84)
checkClassIL.MarkLabel(tru84)
checkClassIL.MarkSequencePoint(doc4, 97, 1, 97, 100)
Dim locbldr104 As LocalBuilder = checkClassIL.DeclareLocal(GetType(Token))
locbldr104.SetLocalSymInfo("t")
checkClassIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
checkClassIL.Emit(OpCodes.Ldfld, GetType(Stmt).GetField("Tokens"))
Typ = GetType(Stmt).GetField("Tokens").FieldType
...
Dim locbldr105 As LocalBuilder = checkClassIL.DeclareLocal(GetType(TypeTok))
locbldr105.SetLocalSymInfo("tt")
...
checkClassIL.MarkSequencePoint(doc4, 101, 1, 101, 100)
checkClassIL.Emit(OpCodes.Ldloc, 2)
Typ = GetType(ClassStmt)
checkClassIL.Emit(OpCodes.Ldloc, 11)
Typ = GetType(TypeTok)
...
Typ = Typ.GetElementType()
checkClassIL.Emit(OpCodes.Stfld, GetType(ClassStmt).GetField("InhClass"))
checkClassIL.MarkSequencePoint(doc4, 104, 1, 104, 100)
checkClassIL.Emit(OpCodes.Br, cont84)
...
checkClassIL.MarkSequencePoint(doc4, 113, 1, 113, 100)
...
checkClassIL.Emit(OpCodes.Br, cont81)
checkClassIL.MarkLabel(fa81)
checkClassIL.Emit(OpCodes.Br, cont81)
checkClassIL.MarkLabel(cont81)
...
Dim checkVarAs As MethodBuilder = StmtOptimizer.DefineMethod("checkVarAs", MethodAttributes.Public, GetType(Stmt), typ22)
...
checkVarAsIL.MarkSequencePoint(doc4, 125, 1, 125, 100)
...
checkVarAsIL.MarkSequencePoint(doc4, 126, 1, 126, 100)
...
checkVarAsIL.Emit(OpCodes.Call, GetType(System.Type).GetMethod("GetTypeFromHandle", typ23))
Typ = GetType(System.Type).GetMethod("GetTypeFromHandle", typ23).ReturnType
checkVarAsIL.Emit(OpCodes.Stloc, 1)
checkVarAsIL.MarkSequencePoint(doc4, 127, 1, 127, 100)
...
ReDim Preserve typ24(UBound(typ24) + 1)
typ24(UBound(typ24)) = Typ
checkVarAsIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("IsInstanceOfType", typ24))
Typ = Typ03.GetMethod("IsInstanceOfType", typ24).ReturnType
checkVarAsIL.Emit(OpCodes.Stobj, Typ04)
checkVarAsIL.MarkSequencePoint(doc4, 128, 1, 128, 100)
Dim locbldr108 As LocalBuilder = checkVarAsIL.DeclareLocal(GetType(VarStmt))
...
checkVarAsIL.MarkSequencePoint(doc4, 130, 1, 130, 100)
checkVarAsIL.Emit(OpCodes.Ldarg, 2)
Typ = GetType(System.Boolean).MakeByRefType()
...
checkVarAsIL.Emit(OpCodes.Beq, tru86)
checkVarAsIL.Emit(OpCodes.Br, fa86)
checkVarAsIL.MarkLabel(tru86)
checkVarAsIL.MarkSequencePoint(doc4, 131, 1, 131, 100)
...
checkVarAsIL.MarkSequencePoint(doc4, 132, 1, 132, 100)
checkVarAsIL.Emit(OpCodes.Ldloc, 2)
Typ = GetType(VarStmt)
checkVarAsIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
...
checkVarAsIL.MarkSequencePoint(doc4, 133, 1, 133, 100)
checkVarAsIL.Emit(OpCodes.Ldloc, 2)
Typ = GetType(VarStmt)
checkVarAsIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
...
checkVarAsIL.MarkSequencePoint(doc4, 135, 1, 135, 100)
...
checkVarAsIL.MarkSequencePoint(doc4, 136, 1, 136, 100)
...
checkVarAsIL.Emit(OpCodes.Call, GetType(System.Type).GetMethod("GetTypeFromHandle", typ25))
Typ = GetType(System.Type).GetMethod("GetTypeFromHandle", typ25).ReturnType
checkVarAsIL.Emit(OpCodes.Stloc, 4)
checkVarAsIL.MarkSequencePoint(doc4, 137, 1, 137, 100)
...
ReDim Preserve typ26(UBound(typ26) + 1)
typ26(UBound(typ26)) = Typ
checkVarAsIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("IsInstanceOfType", typ26))
Typ = Typ03.GetMethod("IsInstanceOfType", typ26).ReturnType
checkVarAsIL.Emit(OpCodes.Stloc, 5)
checkVarAsIL.MarkSequencePoint(doc4, 139, 1, 139, 100)
...
checkVarAsIL.Emit(OpCodes.Beq, fa87)
checkVarAsIL.Emit(OpCodes.Br, tru87)
checkVarAsIL.MarkLabel(tru87)
checkVarAsIL.MarkSequencePoint(doc4, 140, 1, 140, 100)
...
checkVarAsIL.MarkSequencePoint(doc4, 141, 1, 141, 100)
...
checkVarAsIL.MarkSequencePoint(doc4, 142, 1, 142, 100)
...
checkVarAsIL.MarkSequencePoint(doc4, 143, 1, 143, 100)
checkVarAsIL.Emit(OpCodes.Ldloc, 7)
Typ = GetType(TypeTok)
checkVarAsIL.Emit(OpCodes.Ldloc, 6)
Typ = GetType(Token)
...
checkVarAsIL.MarkSequencePoint(doc4, 144, 1, 144, 100)
checkVarAsIL.Emit(OpCodes.Ldloc, 2)
Typ = GetType(VarStmt)
checkVarAsIL.Emit(OpCodes.Ldloc, 7)
Typ = GetType(TypeTok)
checkVarAsIL.Emit(OpCodes.Stfld, GetType(VarStmt).GetField("VarTyp"))
checkVarAsIL.MarkSequencePoint(doc4, 145, 1, 145, 100)
checkVarAsIL.Emit(OpCodes.Br, cont87)
checkVarAsIL.MarkLabel(fa87)
checkVarAsIL.MarkSequencePoint(doc4, 146, 1, 146, 100)
checkVarAsIL.Emit(OpCodes.Ldloc, 2)
Typ = GetType(VarStmt)
checkVarAsIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
...
Typ = Typ.GetElementType()
checkVarAsIL.Emit(OpCodes.Stfld, GetType(VarStmt).GetField("VarTyp"))
checkVarAsIL.MarkSequencePoint(doc4, 147, 1, 147, 100)
checkVarAsIL.Emit(OpCodes.Br, cont87)
checkVarAsIL.MarkLabel(cont87)
checkVarAsIL.MarkSequencePoint(doc4, 149, 1, 149, 100)
checkVarAsIL.Emit(OpCodes.Br, cont86)
checkVarAsIL.MarkLabel(fa86)
checkVarAsIL.Emit(OpCodes.Br, cont86)
checkVarAsIL.MarkLabel(cont86)
checkVarAsIL.MarkSequencePoint(doc4, 150, 1, 150, 100)
checkVarAsIL.Emit(OpCodes.Ldloc, 2)
Typ = GetType(VarStmt)
checkVarAsIL.MarkSequencePoint(doc4, 151, 1, 151, 100)
checkVarAsIL.Emit(OpCodes.Ret)
Dim typ27(-1) As Type
ReDim Preserve typ27(UBound(typ27) + 1)
typ27(UBound(typ27)) = GetType(Stmt)
Dim AssOpt As MethodBuilder = StmtOptimizer.DefineMethod("AssOpt", MethodAttributes.Public, GetType(Stmt), typ27)
...
AssOptIL.MarkSequencePoint(doc4, 155, 1, 155, 100)
Dim locbldr114 As LocalBuilder = AssOptIL.DeclareLocal(GetType(AssignStmt))
locbldr114.SetLocalSymInfo("asss")
AssOptIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
AssOptIL.Emit(OpCodes.Stloc, 0)
AssOptIL.MarkSequencePoint(doc4, 156, 1, 156, 100)
Dim locbldr115 As LocalBuilder = AssOptIL.DeclareLocal(GetType(Expr))
locbldr115.SetLocalSymInfo("le")
...
AssOptIL.MarkSequencePoint(doc4, 157, 1, 157, 100)
Dim locbldr116 As LocalBuilder = AssOptIL.DeclareLocal(GetType(Token))
...
AssOptIL.MarkSequencePoint(doc4, 158, 1, 158, 100)
Dim locbldr117 As LocalBuilder = AssOptIL.DeclareLocal(GetType(System.Type))
...
AssOptIL.Emit(OpCodes.Call, GetType(System.Type).GetMethod("GetTypeFromHandle", typ28))
Typ = GetType(System.Type).GetMethod("GetTypeFromHandle", typ28).ReturnType
AssOptIL.Emit(OpCodes.Stloc, 3)
AssOptIL.MarkSequencePoint(doc4, 159, 1, 159, 100)
Dim locbldr118 As LocalBuilder = AssOptIL.DeclareLocal(GetType(System.Boolean))
...
ReDim Preserve typ29(UBound(typ29) + 1)
typ29(UBound(typ29)) = Typ
AssOptIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("IsInstanceOfType", typ29))
Typ = Typ03.GetMethod("IsInstanceOfType", typ29).ReturnType
AssOptIL.Emit(OpCodes.Stloc, 4)
AssOptIL.MarkSequencePoint(doc4, 160, 1, 160, 100)
Dim locbldr119 As LocalBuilder = AssOptIL.DeclareLocal(GetType(VarAsgnStmt))
locbldr119.SetLocalSymInfo("vass")
AssOptIL.Emit(OpCodes.Newobj, GetType(VarAsgnStmt).GetConstructor(Type.EmptyTypes))
AssOptIL.Emit(OpCodes.Stloc, 5)
AssOptIL.MarkSequencePoint(doc4, 161, 1, 161, 100)
AssOptIL.Emit(OpCodes.Ldloc, 4)
Typ = GetType(System.Boolean)
AssOptIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa88 As System.Reflection.Emit.Label = AssOptIL.DefineLabel()
Dim tru88 As System.Reflection.Emit.Label = AssOptIL.DefineLabel()
Dim cont88 As System.Reflection.Emit.Label = AssOptIL.DefineLabel()
AssOptIL.Emit(OpCodes.Beq, tru88)
AssOptIL.Emit(OpCodes.Br, fa88)
AssOptIL.MarkLabel(tru88)
AssOptIL.MarkSequencePoint(doc4, 162, 1, 162, 100)
...
AssOptIL.MarkSequencePoint(doc4, 163, 1, 163, 100)
AssOptIL.Emit(OpCodes.Ldloc, 5)
Typ = GetType(VarAsgnStmt)
AssOptIL.Emit(OpCodes.Ldloc, 0)
Typ = GetType(AssignStmt)
...
AssOptIL.MarkSequencePoint(doc4, 164, 1, 164, 100)
AssOptIL.Emit(OpCodes.Ldloc, 5)
Typ = GetType(VarAsgnStmt)
AssOptIL.Emit(OpCodes.Ldloc, 1)
Typ = GetType(Expr)
...
AssOptIL.MarkSequencePoint(doc4, 166, 1, 166, 100)
Dim locbldr120 As LocalBuilder = AssOptIL.DeclareLocal(GetType(Token))
...
AssOptIL.MarkSequencePoint(doc4, 167, 1, 167, 100)
Dim locbldr121 As LocalBuilder = AssOptIL.DeclareLocal(GetType(System.Type))
...
AssOptIL.Emit(OpCodes.Call, GetType(System.Type).GetMethod("GetTypeFromHandle", typ30))
Typ = GetType(System.Type).GetMethod("GetTypeFromHandle", typ30).ReturnType
AssOptIL.Emit(OpCodes.Stloc, 7)
AssOptIL.MarkSequencePoint(doc4, 168, 1, 168, 100)
Dim locbldr122 As LocalBuilder = AssOptIL.DeclareLocal(GetType(System.Boolean))
...
ReDim Preserve typ31(UBound(typ31) + 1)
typ31(UBound(typ31)) = Typ
AssOptIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("IsInstanceOfType", typ31))
Typ = Typ03.GetMethod("IsInstanceOfType", typ31).ReturnType
AssOptIL.Emit(OpCodes.Stloc, 8)
AssOptIL.MarkSequencePoint(doc4, 170, 1, 170, 100)
...
AssOptIL.Emit(OpCodes.Beq, fa89)
AssOptIL.Emit(OpCodes.Br, tru89)
AssOptIL.MarkLabel(tru89)
AssOptIL.MarkSequencePoint(doc4, 171, 1, 171, 100)
Dim locbldr123 As LocalBuilder = AssOptIL.DeclareLocal(GetType(Token))
locbldr123.SetLocalSymInfo("t")
AssOptIL.Emit(OpCodes.Ldloc, 1)
Typ = GetType(Expr)
AssOptIL.Emit(OpCodes.Ldfld, GetType(Expr).GetField("Tokens"))
Typ = GetType(Expr).GetField("Tokens").FieldType
...
AssOptIL.MarkSequencePoint(doc4, 172, 1, 172, 100)
Dim locbldr124 As LocalBuilder = AssOptIL.DeclareLocal(GetType(TypeTok))
locbldr124.SetLocalSymInfo("tt")
AssOptIL.Emit(OpCodes.Newobj, GetType(TypeTok).GetConstructor(Type.EmptyTypes))
AssOptIL.Emit(OpCodes.Stloc, 10)
AssOptIL.MarkSequencePoint(doc4, 173, 1, 173, 100)
...
AssOptIL.MarkSequencePoint(doc4, 174, 1, 174, 100)
AssOptIL.Emit(OpCodes.Ldloc, 10)
Typ = GetType(TypeTok)
AssOptIL.Emit(OpCodes.Ldloc, 9)
Typ = GetType(Token)
...
AssOptIL.MarkSequencePoint(doc4, 175, 1, 175, 100)
AssOptIL.Emit(OpCodes.Ldloc, 5)
Typ = GetType(VarAsgnStmt)
AssOptIL.Emit(OpCodes.Ldloc, 10)
Typ = GetType(TypeTok)
AssOptIL.Emit(OpCodes.Stfld, GetType(VarAsgnStmt).GetField("VarTyp"))
AssOptIL.MarkSequencePoint(doc4, 176, 1, 176, 100)
AssOptIL.Emit(OpCodes.Br, cont89)
AssOptIL.MarkLabel(fa89)
AssOptIL.MarkSequencePoint(doc4, 177, 1, 177, 100)
AssOptIL.Emit(OpCodes.Ldloc, 5)
Typ = GetType(VarAsgnStmt)
AssOptIL.Emit(OpCodes.Ldloc, 1)
Typ = GetType(Expr)
...
Typ = Typ.GetElementType()
AssOptIL.Emit(OpCodes.Stfld, GetType(VarAsgnStmt).GetField("VarTyp"))
AssOptIL.MarkSequencePoint(doc4, 178, 1, 178, 100)
AssOptIL.Emit(OpCodes.Br, cont89)
AssOptIL.MarkLabel(cont89)
AssOptIL.MarkSequencePoint(doc4, 180, 1, 180, 100)
AssOptIL.Emit(OpCodes.Ldloc, 5)
Typ = GetType(VarAsgnStmt)
AssOptIL.Emit(OpCodes.Ldloc, 0)
Typ = GetType(AssignStmt)
...
AssOptIL.MarkSequencePoint(doc4, 182, 1, 182, 100)
AssOptIL.Emit(OpCodes.Ldloc, 5)
Typ = GetType(VarAsgnStmt)
AssOptIL.MarkSequencePoint(doc4, 183, 1, 183, 100)
AssOptIL.Emit(OpCodes.Br, cont88)
AssOptIL.MarkLabel(fa88)
AssOptIL.MarkSequencePoint(doc4, 184, 1, 184, 100)
AssOptIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
AssOptIL.MarkSequencePoint(doc4, 185, 1, 185, 100)
AssOptIL.Emit(OpCodes.Br, cont88)
AssOptIL.MarkLabel(cont88)
AssOptIL.MarkSequencePoint(doc4, 187, 1, 187, 100)
AssOptIL.Emit(OpCodes.Ret)
Dim typ32(-1) As Type
ReDim Preserve typ32(UBound(typ32) + 1)
typ32(UBound(typ32)) = GetType(Stmt)
ReDim Preserve typ32(UBound(typ32) + 1)
typ32(UBound(typ32)) = GetType(System.Boolean).MakeByRefType()
Dim checkAssign As MethodBuilder = StmtOptimizer.DefineMethod("checkAssign", MethodAttributes.Public, GetType(Stmt), typ32)
...
checkAssignIL.MarkSequencePoint(doc4, 190, 1, 190, 100)
Dim locbldr125 As LocalBuilder = checkAssignIL.DeclareLocal(GetType(Token))
locbldr125.SetLocalSymInfo("tok")
checkAssignIL.Emit(OpCodes.Ldnull)
checkAssignIL.Emit(OpCodes.Stloc, 0)
checkAssignIL.MarkSequencePoint(doc4, 191, 1, 191, 100)
Dim locbldr126 As LocalBuilder = checkAssignIL.DeclareLocal(GetType(System.Type))
...
checkAssignIL.Emit(OpCodes.Call, GetType(System.Type).GetMethod("GetTypeFromHandle", typ33))
Typ = GetType(System.Type).GetMethod("GetTypeFromHandle", typ33).ReturnType
checkAssignIL.Emit(OpCodes.Stloc, 1)
checkAssignIL.MarkSequencePoint(doc4, 192, 1, 192, 100)
Dim locbldr127 As LocalBuilder = checkAssignIL.DeclareLocal(GetType(AssignStmt))
locbldr127.SetLocalSymInfo("asss")
checkAssignIL.Emit(OpCodes.Newobj, GetType(AssignStmt).GetConstructor(Type.EmptyTypes))
checkAssignIL.Emit(OpCodes.Stloc, 2)
checkAssignIL.MarkSequencePoint(doc4, 193, 1, 193, 100)
Dim locbldr128 As LocalBuilder = checkAssignIL.DeclareLocal(GetType(System.Boolean))
locbldr128.SetLocalSymInfo("c")
checkAssignIL.Emit(OpCodes.Ldc_I4, 0)
Typ = GetType(System.Boolean)
checkAssignIL.Emit(OpCodes.Stloc, 3)
checkAssignIL.MarkSequencePoint(doc4, 194, 1, 194, 100)
Dim locbldr129 As LocalBuilder = checkAssignIL.DeclareLocal(GetType(Expr))
locbldr129.SetLocalSymInfo("re")
checkAssignIL.Emit(OpCodes.Newobj, GetType(Expr).GetConstructor(Type.EmptyTypes))
checkAssignIL.Emit(OpCodes.Stloc, 4)
checkAssignIL.MarkSequencePoint(doc4, 195, 1, 195, 100)
Dim locbldr130 As LocalBuilder = checkAssignIL.DeclareLocal(GetType(Expr))
locbldr130.SetLocalSymInfo("le")
checkAssignIL.Emit(OpCodes.Newobj, GetType(Expr).GetConstructor(Type.EmptyTypes))
checkAssignIL.Emit(OpCodes.Stloc, 5)
checkAssignIL.MarkSequencePoint(doc4, 196, 1, 196, 100)
Dim locbldr131 As LocalBuilder = checkAssignIL.DeclareLocal(GetType(System.Int32))
locbldr131.SetLocalSymInfo("i")
checkAssignIL.Emit(OpCodes.Ldc_I4, CInt(-1))
Typ = GetType(System.Int32)
checkAssignIL.Emit(OpCodes.Stloc, 6)
checkAssignIL.MarkSequencePoint(doc4, 197, 1, 197, 100)
Dim locbldr132 As LocalBuilder = checkAssignIL.DeclareLocal(GetType(System.Int32))
...
checkAssignIL.MarkSequencePoint(doc4, 198, 1, 198, 100)
Dim locbldr133 As LocalBuilder = checkAssignIL.DeclareLocal(GetType(System.Int32))
locbldr133.SetLocalSymInfo("assind")
checkAssignIL.Emit(OpCodes.Ldc_I4, CInt(0))
Typ = GetType(System.Int32)
checkAssignIL.Emit(OpCodes.Stloc, 8)
checkAssignIL.MarkSequencePoint(doc4, 200, 1, 200, 100)
Dim label2 As System.Reflection.Emit.Label = checkAssignIL.DefineLabel()
checkAssignIL.MarkSequencePoint(doc4, 201, 1, 201, 100)
Dim label3 As System.Reflection.Emit.Label = checkAssignIL.DefineLabel()
checkAssignIL.MarkSequencePoint(doc4, 203, 1, 203, 100)
checkAssignIL.MarkLabel(label2)
checkAssignIL.MarkSequencePoint(doc4, 205, 1, 205, 100)
...
checkAssignIL.Emit(OpCodes.Stloc, 6)
checkAssignIL.MarkSequencePoint(doc4, 207, 1, 207, 100)
checkAssignIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
checkAssignIL.Emit(OpCodes.Ldfld, GetType(Stmt).GetField("Tokens"))
Typ = GetType(Stmt).GetField("Tokens").FieldType
...
Typ = Typ.GetElementType()
checkAssignIL.Emit(OpCodes.Stloc, 0)
checkAssignIL.MarkSequencePoint(doc4, 208, 1, 208, 100)
Dim typ34(-1) As Type
...
ReDim Preserve typ34(UBound(typ34) + 1)
typ34(UBound(typ34)) = Typ
checkAssignIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("IsInstanceOfType", typ34))
Typ = Typ03.GetMethod("IsInstanceOfType", typ34).ReturnType
checkAssignIL.Emit(OpCodes.Stloc, 3)
checkAssignIL.MarkSequencePoint(doc4, 210, 1, 210, 100)
checkAssignIL.Emit(OpCodes.Ldloc, 3)
Typ = GetType(System.Boolean)
checkAssignIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa90 As System.Reflection.Emit.Label = checkAssignIL.DefineLabel()
Dim tru90 As System.Reflection.Emit.Label = checkAssignIL.DefineLabel()
Dim cont90 As System.Reflection.Emit.Label = checkAssignIL.DefineLabel()
checkAssignIL.Emit(OpCodes.Beq, tru90)
checkAssignIL.Emit(OpCodes.Br, fa90)
checkAssignIL.MarkLabel(tru90)
checkAssignIL.MarkSequencePoint(doc4, 211, 1, 211, 100)
checkAssignIL.Emit(OpCodes.Ldloc, 6)
Typ = GetType(System.Int32)
checkAssignIL.Emit(OpCodes.Stloc, 8)
checkAssignIL.MarkSequencePoint(doc4, 212, 1, 212, 100)
checkAssignIL.Emit(OpCodes.Br, label3)
checkAssignIL.MarkSequencePoint(doc4, 213, 1, 213, 100)
checkAssignIL.Emit(OpCodes.Br, cont90)
checkAssignIL.MarkLabel(fa90)
checkAssignIL.Emit(OpCodes.Br, cont90)
checkAssignIL.MarkLabel(cont90)
checkAssignIL.MarkSequencePoint(doc4, 215, 1, 215, 100)
checkAssignIL.Emit(OpCodes.Ldloc, 6)
Typ = GetType(System.Int32)
...
checkAssignIL.MarkSequencePoint(doc4, 216, 1, 216, 100)
checkAssignIL.Emit(OpCodes.Br, label3)
checkAssignIL.MarkSequencePoint(doc4, 217, 1, 217, 100)
checkAssignIL.Emit(OpCodes.Br, cont91)
checkAssignIL.MarkLabel(fa91)
checkAssignIL.MarkSequencePoint(doc4, 218, 1, 218, 100)
checkAssignIL.Emit(OpCodes.Br, label2)
checkAssignIL.MarkSequencePoint(doc4, 219, 1, 219, 100)
checkAssignIL.Emit(OpCodes.Br, cont91)
checkAssignIL.MarkLabel(cont91)
checkAssignIL.MarkSequencePoint(doc4, 221, 1, 221, 100)
checkAssignIL.MarkLabel(label3)
checkAssignIL.MarkSequencePoint(doc4, 223, 1, 223, 100)
...
checkAssignIL.Emit(OpCodes.Beq, fa92)
checkAssignIL.Emit(OpCodes.Br, tru92)
checkAssignIL.MarkLabel(tru92)
checkAssignIL.MarkSequencePoint(doc4, 225, 1, 225, 100)
checkAssignIL.Emit(OpCodes.Ldc_I4, CInt(-1))
Typ = GetType(System.Int32)
checkAssignIL.Emit(OpCodes.Stloc, 6)
checkAssignIL.MarkSequencePoint(doc4, 226, 1, 226, 100)
checkAssignIL.Emit(OpCodes.Ldloc, 8)
Typ = GetType(System.Int32)
checkAssignIL.Emit(OpCodes.Ldc_I4, CInt(1))
Typ = GetType(System.Int32)
...
ReDim Preserve typ35(UBound(typ35) + 1)
typ35(UBound(typ35)) = Typ
checkAssignIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("AddToken", typ35))
Typ = Typ03.GetMethod("AddToken", typ35).ReturnType
If Typ.ToString() = GetType(System.Void).ToString() Then

Else
checkAssignIL.Emit(OpCodes.Pop)
End If
checkAssignIL.MarkSequencePoint(doc4, 237, 1, 237, 100)
checkAssignIL.Emit(OpCodes.Ldloc, 6)
Typ = GetType(System.Int32)
checkAssignIL.Emit(OpCodes.Ldloc, 7)
Typ = GetType(System.Int32)
...
checkAssignIL.Emit(OpCodes.Beq, tru93)
checkAssignIL.Emit(OpCodes.Br, fa93)
...
checkAssignIL.MarkSequencePoint(doc4, 240, 1, 240, 100)
...
Typ = GetType(System.Int32)
checkAssignIL.Emit(OpCodes.Stloc, 6)
checkAssignIL.MarkSequencePoint(doc4, 247, 1, 247, 100)
checkAssignIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
checkAssignIL.Emit(OpCodes.Ldfld, GetType(Stmt).GetField("Tokens"))
Typ = GetType(Stmt).GetField("Tokens").FieldType
...
checkAssignIL.MarkSequencePoint(doc4, 252, 1, 252, 100)
...
ReDim Preserve typ36(UBound(typ36) + 1)
typ36(UBound(typ36)) = Typ
checkAssignIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("AddToken", typ36))
Typ = Typ03.GetMethod("AddToken", typ36).ReturnType
If Typ.ToString() = GetType(System.Void).ToString() Then

Else
checkAssignIL.Emit(OpCodes.Pop)
End If
checkAssignIL.MarkSequencePoint(doc4, 258, 1, 258, 100)
checkAssignIL.Emit(OpCodes.Ldloc, 6)
Typ = GetType(System.Int32)
checkAssignIL.Emit(OpCodes.Ldloc, 7)
Typ = GetType(System.Int32)
...
checkAssignIL.MarkSequencePoint(doc4, 260, 1, 260, 100)
...
checkAssignIL.MarkSequencePoint(doc4, 262, 1, 262, 100)
checkAssignIL.Emit(OpCodes.Br, cont94)
...
checkAssignIL.MarkSequencePoint(doc4, 268, 1, 268, 100)
checkAssignIL.Emit(OpCodes.Ldloc, 2)
Typ = GetType(AssignStmt)
checkAssignIL.Emit(OpCodes.Ldloc, 5)
Typ = GetType(Expr)
...
checkAssignIL.MarkSequencePoint(doc4, 283, 1, 283, 100)
checkAssignIL.Emit(OpCodes.Ret)
Dim typ38(-1) As Type
ReDim Preserve typ38(UBound(typ38) + 1)
typ38(UBound(typ38)) = GetType(Stmt)
Dim Optimize As MethodBuilder = StmtOptimizer.DefineMethod("Optimize", MethodAttributes.Public, GetType(Stmt), typ38)
Dim OptimizeIL As ILGenerator = Optimize.GetILGenerator()
Dim Optimizeparam00 As ParameterBuilder = Optimize.DefineParameter(0, ParameterAttributes.RetVal, "")
...
ReDim Preserve typ39(UBound(typ39) + 1)
typ39(UBound(typ39)) = Typ
OptimizeIL.Emit(OpCodes.Call, GetType(Console).GetMethod("WriteLine", typ39))
Typ = GetType(Console).GetMethod("WriteLine", typ39).ReturnType
If Typ.ToString() = GetType(System.Void).ToString() Then
...
Dim locbldr134 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(System.Int32))
locbldr134.SetLocalSymInfo("i")
OptimizeIL.Emit(OpCodes.Ldc_I4, CInt(-1))
Typ = GetType(System.Int32)
OptimizeIL.Emit(OpCodes.Stloc, 0)
...
Dim locbldr136 As LocalBuilder = OptimizeIL.DeclareLocal(asm.GetType("tokenizer.Parser.TokenOptimizer"))
locbldr136.SetLocalSymInfo("to")
OptimizeIL.Emit(OpCodes.Ldnull)
OptimizeIL.Emit(OpCodes.Stloc, 2)
OptimizeIL.MarkSequencePoint(doc4, 292, 1, 292, 100)
Dim locbldr137 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(Stmt))
locbldr137.SetLocalSymInfo("tmpstm")
OptimizeIL.Emit(OpCodes.Ldnull)
OptimizeIL.Emit(OpCodes.Stloc, 3)
OptimizeIL.MarkSequencePoint(doc4, 293, 1, 293, 100)
Dim locbldr138 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(System.Boolean))
locbldr138.SetLocalSymInfo("compb")
OptimizeIL.Emit(OpCodes.Ldc_I4, 0)
Typ = GetType(System.Boolean)
OptimizeIL.Emit(OpCodes.Stloc, 4)
...
ReDim Preserve typ40(UBound(typ40) + 1)
typ40(UBound(typ40)) = Typ
OptimizeIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("Optimize", typ40))
Typ = Typ03.GetMethod("Optimize", typ40).ReturnType
Typ = Typ02
...
OptimizeIL.Emit(OpCodes.Br, label10)
OptimizeIL.MarkSequencePoint(doc4, 341, 1, 341, 100)
...
OptimizeIL.Emit(OpCodes.Stloc, 3)
OptimizeIL.MarkSequencePoint(doc4, 380, 1, 380, 100)
OptimizeIL.Emit(OpCodes.Ldloc, 4)
Typ = GetType(System.Boolean)
OptimizeIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
...
Dim locbldr139 As LocalBuilder = ParseIL.DeclareLocal(GetType(System.Int32))
locbldr139.SetLocalSymInfo("i")
ParseIL.Emit(OpCodes.Ldc_I4, CInt(-1))
Typ = GetType(System.Int32)
ParseIL.Emit(OpCodes.Stloc, 0)
ParseIL.MarkSequencePoint(doc5, 5, 1, 5, 100)
Dim locbldr140 As LocalBuilder = ParseIL.DeclareLocal(asm.GetType("tokenizer.Parser.StmtOptimizer"))
locbldr140.SetLocalSymInfo("so")
ParseIL.Emit(OpCodes.Ldnull)
ParseIL.Emit(OpCodes.Stloc, 1)
ParseIL.MarkSequencePoint(doc5, 6, 1, 6, 100)
Dim locbldr141 As LocalBuilder = ParseIL.DeclareLocal(GetType(System.Int32))
...
ParseIL.Emit(OpCodes.Ldloc, 2)
Typ = GetType(System.Int32)
Dim fa107 As System.Reflection.Emit.Label = ParseIL.DefineLabel()
Dim tru107 As System.Reflection.Emit.Label = ParseIL.DefineLabel()
Dim cont107 As System.Reflection.Emit.Label = ParseIL.DefineLabel()
ParseIL.Emit(OpCodes.Beq, tru107)
ParseIL.Emit(OpCodes.Br, fa107)
ParseIL.MarkLabel(tru107)
ParseIL.MarkSequencePoint(doc5, 19, 1, 19, 100)
ParseIL.Emit(OpCodes.Br, label1)
ParseIL.MarkSequencePoint(doc5, 20, 1, 20, 100)
ParseIL.Emit(OpCodes.Br, cont107)
ParseIL.MarkLabel(fa107)
ParseIL.MarkSequencePoint(doc5, 21, 1, 21, 100)
ParseIL.Emit(OpCodes.Br, label0)
ParseIL.MarkSequencePoint(doc5, 22, 1, 22, 100)
ParseIL.Emit(OpCodes.Br, cont107)
ParseIL.MarkLabel(cont107)
