...
locbldr48.SetLocalSymInfo("oftk")
...
Dim locbldr58 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(PrivateAttr))
locbldr58.SetLocalSymInfo("privattr")
...
Dim locbldr59 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(PublicAttr))
locbldr59.SetLocalSymInfo("pubattr")
...
Dim locbldr60 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(InitOnlyAttr))
locbldr60.SetLocalSymInfo("initoattr")
...
Dim locbldr61 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(StaticAttr))
locbldr61.SetLocalSymInfo("statattr")
...
Dim locbldr62 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(AutoLayoutAttr))
locbldr62.SetLocalSymInfo("autattr")
...
Dim locbldr63 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(AutoClassAttr))
locbldr63.SetLocalSymInfo("autcattr")
...
Dim locbldr64 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(AnsiClassAttr))
locbldr64.SetLocalSymInfo("ansattr")
...
Dim locbldr65 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(BeforeFieldInitAttr))
locbldr65.SetLocalSymInfo("bfiattr")
...
Dim locbldr66 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(StringTok))
locbldr66.SetLocalSymInfo("strtok")
...
Dim locbldr67 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(VoidTok))
locbldr67.SetLocalSymInfo("voidtok")
...
Dim locbldr68 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(DecimalTok))
locbldr68.SetLocalSymInfo("decitok")
...
Dim locbldr69 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(IntegerTok))
locbldr69.SetLocalSymInfo("inttok")
...
Dim locbldr70 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(IntPtrTok))
locbldr70.SetLocalSymInfo("intptok")
...
Dim locbldr71 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(UIntegerTok))
locbldr71.SetLocalSymInfo("uinttok")
...
Dim locbldr72 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(DoubleTok))
locbldr72.SetLocalSymInfo("dbltok")
...
Dim locbldr73 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(BooleanTok))
locbldr73.SetLocalSymInfo("booltok")
...
Dim locbldr74 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(CharTok))
locbldr74.SetLocalSymInfo("chrtok")
...
Dim locbldr75 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(SingleTok))
locbldr75.SetLocalSymInfo("sngtok")
...
Dim locbldr76 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(SByteTok))
locbldr76.SetLocalSymInfo("sbytok")
...
Dim locbldr77 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(ShortTok))
locbldr77.SetLocalSymInfo("shtok")
...
Dim locbldr78 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(LongTok))
locbldr78.SetLocalSymInfo("lngtok")
...
Dim locbldr79 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(ObjectTok))
locbldr79.SetLocalSymInfo("objtok")
...
ReDim Preserve typ89(UBound(typ89) + 1)
typ89(UBound(typ89)) = Typ
OptimizeIL.Emit(OpCodes.Call, GetType(Utils.ParseUtils).GetMethod("LikeOP", typ89))
Typ = GetType(Utils.ParseUtils).GetMethod("LikeOP", typ89).ReturnType
OptimizeIL.Emit(OpCodes.Stloc, 1)
...
Dim locbldr80 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(commentTok))
locbldr80.SetLocalSymInfo("comtok")
...
Dim locbldr81 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(BooleanLiteral))
locbldr81.SetLocalSymInfo("boolit")
...
ReDim Preserve typ94(UBound(typ94) + 1)
typ94(UBound(typ94)) = Typ
OptimizeIL.Emit(OpCodes.Call, GetType(Utils.ParseUtils).GetMethod("LikeOP", typ94))
Typ = GetType(Utils.ParseUtils).GetMethod("LikeOP", typ94).ReturnType
OptimizeIL.Emit(OpCodes.Stloc, 1)
...
Dim locbldr82 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(CharLiteral))
locbldr82.SetLocalSymInfo("chrlit")
...
OptimizeIL.Emit(OpCodes.Ldstr, "'")
Typ = GetType(System.String)
Dim typ95 As Type() = {Typ}
OptimizeIL.Emit(OpCodes.Call, GetType(System.Convert).GetMethod("ToChar", typ95))
Typ = GetType(System.Convert).GetMethod("ToChar", typ95).ReturnType
...
OptimizeIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("Trim", typ96))
Typ = Typ03.GetMethod("Trim", typ96).ReturnType
OptimizeIL.Emit(OpCodes.Stloc, 2)
...
Dim typ97 As Type() = {Typ}
OptimizeIL.Emit(OpCodes.Call, GetType(System.Convert).GetMethod("ToChar", typ97))
Typ = GetType(System.Convert).GetMethod("ToChar", typ97).ReturnType
...
ReDim Preserve typ98(UBound(typ98) + 1)
typ98(UBound(typ98)) = Typ
OptimizeIL.Emit(OpCodes.Call, GetType(String).GetMethod("Concat", typ98))
...
Dim locbldr83 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(StringLiteral))
locbldr83.SetLocalSymInfo("strlit")
...
OptimizeIL.Emit(OpCodes.Call, GetType(System.Convert).GetMethod("ToChar", typ100))
Typ = GetType(System.Convert).GetMethod("ToChar", typ100).ReturnType
OptimizeIL.Emit(OpCodes.Stelem, GetType(System.Char).MakeArrayType().GetElementType())
...
OptimizeIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("Trim", typ101))
Typ = Typ03.GetMethod("Trim", typ101).ReturnType
OptimizeIL.Emit(OpCodes.Stloc, 2)
...
OptimizeIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("EndsWith", typ105))
Typ = Typ03.GetMethod("EndsWith", typ105).ReturnType
OptimizeIL.Emit(OpCodes.Stloc, 1)
...
Dim locbldr84 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(DoubleLiteral))
locbldr84.SetLocalSymInfo("dlit2")
...
OptimizeIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("TrimEnd", typ107))
Typ = Typ03.GetMethod("TrimEnd", typ107).ReturnType
OptimizeIL.Emit(OpCodes.Stloc, 2)
...
OptimizeIL.Emit(OpCodes.Call, GetType(System.Convert).GetMethod("ToDouble", typ108))
Typ = GetType(System.Convert).GetMethod("ToDouble", typ108).ReturnType
...
Dim locbldr85 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(FloatLiteral))
locbldr85.SetLocalSymInfo("flit")
...
OptimizeIL.Emit(OpCodes.Call, GetType(System.Convert).GetMethod("ToSingle", typ115))
Typ = GetType(System.Convert).GetMethod("ToSingle", typ115).ReturnType
...
Dim locbldr86 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(DoubleLiteral))
locbldr86.SetLocalSymInfo("dlit")
OptimizeIL.Emit(OpCodes.Newobj, GetType(DoubleLiteral).GetConstructor(Type.EmptyTypes))
...
Dim locbldr87 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(DoubleLiteral))
locbldr87.SetLocalSymInfo("dlit3")
OptimizeIL.Emit(OpCodes.Newobj, GetType(DoubleLiteral).GetConstructor(Type.EmptyTypes))
...
Dim locbldr88 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(FloatLiteral))
locbldr88.SetLocalSymInfo("flit2")
OptimizeIL.Emit(OpCodes.Newobj, GetType(FloatLiteral).GetConstructor(Type.EmptyTypes))
...
OptimizeIL.Emit(OpCodes.Call, GetType(System.Convert).GetMethod("ToSingle", typ133))
Typ = GetType(System.Convert).GetMethod("ToSingle", typ133).ReturnType
OptimizeIL.Emit(OpCodes.Stfld, GetType(FloatLiteral).GetField("NumVal"))
...
Dim locbldr89 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(UIntLiteral))
locbldr89.SetLocalSymInfo("uilit2")
...
OptimizeIL.Emit(OpCodes.Call, GetType(Convert).GetMethod("ToUInt32", typ142))
Typ = GetType(Convert).GetMethod("ToUInt32", typ142).ReturnType
...
Dim locbldr90 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(IntPtrLiteral))
locbldr90.SetLocalSymInfo("iplit2")
...
OptimizeIL.Emit(OpCodes.Call, GetType(System.Convert).GetMethod("ToInt32", typ152))
...
OptimizeIL.Emit(OpCodes.Newobj, GetType(IntPtr).GetConstructor(typ151))
...
Dim locbldr91 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(IntLiteral))
locbldr91.SetLocalSymInfo("ilit2")
...
Dim locbldr92 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(LongLiteral))
locbldr92.SetLocalSymInfo("llit")
...
OptimizeIL.Emit(OpCodes.Call, GetType(System.Convert).GetMethod("ToInt64", typ166))
Typ = GetType(System.Convert).GetMethod("ToInt64", typ166).ReturnType
...
Dim locbldr93 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(ShortLiteral))
locbldr93.SetLocalSymInfo("slit")
...
OptimizeIL.Emit(OpCodes.Call, GetType(System.Convert).GetMethod("ToInt16", typ173))
Typ = GetType(System.Convert).GetMethod("ToInt16", typ173).ReturnType
...
OptimizeIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("EndsWith", typ177))
Typ = Typ03.GetMethod("EndsWith", typ177).ReturnType
OptimizeIL.Emit(OpCodes.Stloc, 1)
...
Dim locbldr94 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(SByteLiteral))
locbldr94.SetLocalSymInfo("blit")
...
OptimizeIL.Emit(OpCodes.Call, GetType(System.Convert).GetMethod("ToChar", typ178))
Typ = GetType(System.Convert).GetMethod("ToChar", typ178).ReturnType
OptimizeIL.Emit(OpCodes.Stelem, GetType(System.Char).MakeArrayType().GetElementType())
...
OptimizeIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("TrimEnd", typ179))
Typ = Typ03.GetMethod("TrimEnd", typ179).ReturnType
OptimizeIL.Emit(OpCodes.Stloc, 2)
...
OptimizeIL.Emit(OpCodes.Call, GetType(System.Convert).GetMethod("ToSByte", typ180))
Typ = GetType(System.Convert).GetMethod("ToSByte", typ180).ReturnType
...
locbldr95.SetLocalSymInfo("ilit")
OptimizeIL.Emit(OpCodes.Newobj, GetType(IntLiteral).GetConstructor(Type.EmptyTypes))
...
OptimizeIL.Emit(OpCodes.Call, GetType(System.Convert).GetMethod("ToInt32", typ184))
Typ = GetType(System.Convert).GetMethod("ToInt32", typ184).ReturnType
OptimizeIL.Emit(OpCodes.Stfld, GetType(IntLiteral).GetField("NumVal"))
...
Dim locbldr96 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(Ident))
...
Dim locbldr97 As LocalBuilder = checkVarAsIL.DeclareLocal(GetType(Token))
locbldr97.SetLocalSymInfo("tok")
...
Dim locbldr98 As LocalBuilder = checkVarAsIL.DeclareLocal(GetType(System.Type))
...
Dim locbldr99 As LocalBuilder = checkVarAsIL.DeclareLocal(GetType(VarExpr))
locbldr99.SetLocalSymInfo("vars")
...
Typ = GetType(System.Boolean)
Dim fa96 As System.Reflection.Emit.Label = checkVarAsIL.DefineLabel()
Dim tru96 As System.Reflection.Emit.Label = checkVarAsIL.DefineLabel()
Dim cont96 As System.Reflection.Emit.Label = checkVarAsIL.DefineLabel()
checkVarAsIL.Emit(OpCodes.Beq, tru96)
checkVarAsIL.Emit(OpCodes.Br, fa96)
checkVarAsIL.MarkLabel(tru96)
...
Dim locbldr100 As LocalBuilder = checkVarAsIL.DeclareLocal(GetType(Token))
locbldr100.SetLocalSymInfo("tok2")
checkVarAsIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Expr)
checkVarAsIL.Emit(OpCodes.Ldfld, GetType(Expr).GetField("Tokens"))
Typ = GetType(Expr).GetField("Tokens").FieldType
...
Dim locbldr101 As LocalBuilder = checkVarAsIL.DeclareLocal(GetType(System.Type))
locbldr101.SetLocalSymInfo("typ2")
...
Dim locbldr102 As LocalBuilder = checkVarAsIL.DeclareLocal(GetType(System.Boolean))
locbldr102.SetLocalSymInfo("b2")
Dim typ4(-1) As Type
...
checkVarAsIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa97 As System.Reflection.Emit.Label = checkVarAsIL.DefineLabel()
Dim tru97 As System.Reflection.Emit.Label = checkVarAsIL.DefineLabel()
Dim cont97 As System.Reflection.Emit.Label = checkVarAsIL.DefineLabel()
checkVarAsIL.Emit(OpCodes.Beq, fa97)
checkVarAsIL.Emit(OpCodes.Br, tru97)
checkVarAsIL.MarkLabel(tru97)
checkVarAsIL.MarkSequencePoint(doc4, 19, 1, 19, 100)
Dim locbldr103 As LocalBuilder = checkVarAsIL.DeclareLocal(GetType(Token))
locbldr103.SetLocalSymInfo("t")
checkVarAsIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Expr)
checkVarAsIL.Emit(OpCodes.Ldfld, GetType(Expr).GetField("Tokens"))
Typ = GetType(Expr).GetField("Tokens").FieldType
...
Dim locbldr104 As LocalBuilder = checkVarAsIL.DeclareLocal(GetType(TypeTok))
locbldr104.SetLocalSymInfo("tt")
...
checkVarAsIL.Emit(OpCodes.Br, cont97)
checkVarAsIL.MarkLabel(fa97)
...
checkVarAsIL.Emit(OpCodes.Br, cont97)
checkVarAsIL.MarkLabel(cont97)
checkVarAsIL.MarkSequencePoint(doc4, 28, 1, 28, 100)
checkVarAsIL.Emit(OpCodes.Br, cont96)
checkVarAsIL.MarkLabel(fa96)
checkVarAsIL.Emit(OpCodes.Br, cont96)
checkVarAsIL.MarkLabel(cont96)
...
Dim locbldr105 As LocalBuilder = procMethodCallIL.DeclareLocal(GetType(MethodNameTok))
locbldr105.SetLocalSymInfo("mn")
...
Dim locbldr106 As LocalBuilder = procMethodCallIL.DeclareLocal(GetType(MethodCallTok))
locbldr106.SetLocalSymInfo("mct")
...
Dim locbldr107 As LocalBuilder = procMethodCallIL.DeclareLocal(GetType(Ident))
...
Dim locbldr108 As LocalBuilder = procMethodCallIL.DeclareLocal(GetType(Expr))
locbldr108.SetLocalSymInfo("ep2")
...
Dim locbldr109 As LocalBuilder = procMethodCallIL.DeclareLocal(GetType(System.Int32))
locbldr109.SetLocalSymInfo("lvl")
...
Dim locbldr110 As LocalBuilder = procMethodCallIL.DeclareLocal(GetType(System.Boolean))
locbldr110.SetLocalSymInfo("d")
...
Dim locbldr111 As LocalBuilder = procMethodCallIL.DeclareLocal(GetType(System.Int32))
locbldr111.SetLocalSymInfo("j")
...
Dim locbldr112 As LocalBuilder = procMethodCallIL.DeclareLocal(GetType(Token))
locbldr112.SetLocalSymInfo("tok2")
procMethodCallIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Expr)
procMethodCallIL.Emit(OpCodes.Ldfld, GetType(Expr).GetField("Tokens"))
Typ = GetType(Expr).GetField("Tokens").FieldType
...
Dim locbldr113 As LocalBuilder = procMethodCallIL.DeclareLocal(GetType(System.Type))
locbldr113.SetLocalSymInfo("typ2")
procMethodCallIL.MarkSequencePoint(doc4, 69, 1, 69, 100)
Dim locbldr114 As LocalBuilder = procMethodCallIL.DeclareLocal(GetType(System.Boolean))
locbldr114.SetLocalSymInfo("b2")
procMethodCallIL.MarkSequencePoint(doc4, 70, 1, 70, 100)
Dim locbldr115 As LocalBuilder = procMethodCallIL.DeclareLocal(GetType(System.Int32))
locbldr115.SetLocalSymInfo("len")
procMethodCallIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Expr)
procMethodCallIL.Emit(OpCodes.Ldfld, GetType(Expr).GetField("Tokens"))
Typ = GetType(Expr).GetField("Tokens").FieldType
...
procMethodCallIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa98 As System.Reflection.Emit.Label = procMethodCallIL.DefineLabel()
Dim tru98 As System.Reflection.Emit.Label = procMethodCallIL.DefineLabel()
Dim cont98 As System.Reflection.Emit.Label = procMethodCallIL.DefineLabel()
procMethodCallIL.Emit(OpCodes.Beq, tru98)
procMethodCallIL.Emit(OpCodes.Br, fa98)
procMethodCallIL.MarkLabel(tru98)
...
procMethodCallIL.Emit(OpCodes.Ldc_I4, CInt(0))
Typ = GetType(System.Int32)
Dim fa99 As System.Reflection.Emit.Label = procMethodCallIL.DefineLabel()
Dim tru99 As System.Reflection.Emit.Label = procMethodCallIL.DefineLabel()
Dim cont99 As System.Reflection.Emit.Label = procMethodCallIL.DefineLabel()
procMethodCallIL.Emit(OpCodes.Beq, tru99)
procMethodCallIL.Emit(OpCodes.Br, fa99)
procMethodCallIL.MarkLabel(tru99)
...
procMethodCallIL.Emit(OpCodes.Br, cont99)
procMethodCallIL.MarkLabel(fa99)
...
procMethodCallIL.Emit(OpCodes.Br, cont99)
procMethodCallIL.MarkLabel(cont99)
procMethodCallIL.MarkSequencePoint(doc4, 101, 1, 101, 100)
procMethodCallIL.Emit(OpCodes.Br, label2)
procMethodCallIL.MarkSequencePoint(doc4, 102, 1, 102, 100)
procMethodCallIL.Emit(OpCodes.Br, cont98)
procMethodCallIL.MarkLabel(fa98)
procMethodCallIL.Emit(OpCodes.Br, cont98)
procMethodCallIL.MarkLabel(cont98)
...
procMethodCallIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa100 As System.Reflection.Emit.Label = procMethodCallIL.DefineLabel()
Dim tru100 As System.Reflection.Emit.Label = procMethodCallIL.DefineLabel()
Dim cont100 As System.Reflection.Emit.Label = procMethodCallIL.DefineLabel()
procMethodCallIL.Emit(OpCodes.Beq, tru100)
procMethodCallIL.Emit(OpCodes.Br, fa100)
procMethodCallIL.MarkLabel(tru100)
...
procMethodCallIL.Emit(OpCodes.Br, cont100)
procMethodCallIL.MarkLabel(fa100)
procMethodCallIL.Emit(OpCodes.Br, cont100)
procMethodCallIL.MarkLabel(cont100)
...
procMethodCallIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa101 As System.Reflection.Emit.Label = procMethodCallIL.DefineLabel()
Dim tru101 As System.Reflection.Emit.Label = procMethodCallIL.DefineLabel()
Dim cont101 As System.Reflection.Emit.Label = procMethodCallIL.DefineLabel()
procMethodCallIL.Emit(OpCodes.Beq, tru101)
procMethodCallIL.Emit(OpCodes.Br, fa101)
procMethodCallIL.MarkLabel(tru101)
procMethodCallIL.MarkSequencePoint(doc4, 120, 1, 120, 100)
procMethodCallIL.Emit(OpCodes.Ldloc, 4)
Typ = GetType(System.Int32)
procMethodCallIL.Emit(OpCodes.Ldc_I4, CInt(1))
Typ = GetType(System.Int32)
Dim fa102 As System.Reflection.Emit.Label = procMethodCallIL.DefineLabel()
Dim tru102 As System.Reflection.Emit.Label = procMethodCallIL.DefineLabel()
Dim cont102 As System.Reflection.Emit.Label = procMethodCallIL.DefineLabel()
procMethodCallIL.Emit(OpCodes.Beq, tru102)
procMethodCallIL.Emit(OpCodes.Br, fa102)
procMethodCallIL.MarkLabel(tru102)
...
procMethodCallIL.Emit(OpCodes.Br, cont102)
procMethodCallIL.MarkLabel(fa102)
...
procMethodCallIL.Emit(OpCodes.Br, cont102)
procMethodCallIL.MarkLabel(cont102)
procMethodCallIL.MarkSequencePoint(doc4, 132, 1, 132, 100)
procMethodCallIL.Emit(OpCodes.Br, cont101)
procMethodCallIL.MarkLabel(fa101)
...
procMethodCallIL.Emit(OpCodes.Br, cont101)
procMethodCallIL.MarkLabel(cont101)
...
procMethodCallIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa103 As System.Reflection.Emit.Label = procMethodCallIL.DefineLabel()
Dim tru103 As System.Reflection.Emit.Label = procMethodCallIL.DefineLabel()
Dim cont103 As System.Reflection.Emit.Label = procMethodCallIL.DefineLabel()
procMethodCallIL.Emit(OpCodes.Beq, tru103)
procMethodCallIL.Emit(OpCodes.Br, fa103)
procMethodCallIL.MarkLabel(tru103)
...
procMethodCallIL.Emit(OpCodes.Br, cont103)
procMethodCallIL.MarkLabel(fa103)
procMethodCallIL.Emit(OpCodes.Br, cont103)
procMethodCallIL.MarkLabel(cont103)
procMethodCallIL.MarkSequencePoint(doc4, 146, 1, 146, 100)
procMethodCallIL.Emit(OpCodes.Ldarg, 2)
Typ = GetType(System.Int32)
procMethodCallIL.Emit(OpCodes.Ldloc, 10)
Typ = GetType(System.Int32)
Dim fa104 As System.Reflection.Emit.Label = procMethodCallIL.DefineLabel()
Dim tru104 As System.Reflection.Emit.Label = procMethodCallIL.DefineLabel()
Dim cont104 As System.Reflection.Emit.Label = procMethodCallIL.DefineLabel()
procMethodCallIL.Emit(OpCodes.Beq, tru104)
procMethodCallIL.Emit(OpCodes.Br, fa104)
procMethodCallIL.MarkLabel(tru104)
procMethodCallIL.MarkSequencePoint(doc4, 147, 1, 147, 100)
procMethodCallIL.Emit(OpCodes.Br, label1)
procMethodCallIL.MarkSequencePoint(doc4, 148, 1, 148, 100)
procMethodCallIL.Emit(OpCodes.Br, cont104)
procMethodCallIL.MarkLabel(fa104)
...
procMethodCallIL.Emit(OpCodes.Br, cont104)
procMethodCallIL.MarkLabel(cont104)
...
Dim locbldr116 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(System.Int32))
...
Dim locbldr117 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(System.Int32))
locbldr117.SetLocalSymInfo("i")
OptimizeIL.Emit(OpCodes.Ldc_I4, CInt(-1))
Typ = GetType(System.Int32)
OptimizeIL.Emit(OpCodes.Stloc, 1)
OptimizeIL.MarkSequencePoint(doc4, 165, 1, 165, 100)
Dim locbldr118 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(System.Int32))
...
OptimizeIL.Emit(OpCodes.Blt, tru105)
...
Dim locbldr119 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(Token))
locbldr119.SetLocalSymInfo("tok")
OptimizeIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Expr)
OptimizeIL.Emit(OpCodes.Ldfld, GetType(Expr).GetField("Tokens"))
Typ = GetType(Expr).GetField("Tokens").FieldType
...
Dim locbldr120 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(System.Type))
locbldr120.SetLocalSymInfo("typ")
OptimizeIL.MarkSequencePoint(doc4, 183, 1, 183, 100)
Dim locbldr121 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(System.Boolean))
locbldr121.SetLocalSymInfo("b")
OptimizeIL.MarkSequencePoint(doc4, 184, 1, 184, 100)
Dim locbldr122 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(System.String))
locbldr122.SetLocalSymInfo("str")
...
OptimizeIL.Emit(OpCodes.Beq, fa107)
OptimizeIL.Emit(OpCodes.Br, tru107)
OptimizeIL.MarkLabel(tru107)
OptimizeIL.MarkSequencePoint(doc4, 198, 1, 198, 100)
Dim locbldr123 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(Token))
locbldr123.SetLocalSymInfo("tk")
OptimizeIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Expr)
OptimizeIL.Emit(OpCodes.Ldfld, GetType(Expr).GetField("Tokens"))
Typ = GetType(Expr).GetField("Tokens").FieldType
...
Dim locbldr124 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(TypeTok))
locbldr124.SetLocalSymInfo("ttk")
...
OptimizeIL.Emit(OpCodes.Beq, fa109)
OptimizeIL.Emit(OpCodes.Br, tru109)
OptimizeIL.MarkLabel(tru109)
OptimizeIL.MarkSequencePoint(doc4, 223, 1, 223, 100)
Dim locbldr125 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(Token))
locbldr125.SetLocalSymInfo("tk2")
OptimizeIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Expr)
OptimizeIL.Emit(OpCodes.Ldfld, GetType(Expr).GetField("Tokens"))
Typ = GetType(Expr).GetField("Tokens").FieldType
...
Dim locbldr126 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(TypeTok))
locbldr126.SetLocalSymInfo("ttk2")
OptimizeIL.Emit(OpCodes.Newobj, GetType(TypeTok).GetConstructor(Type.EmptyTypes))
OptimizeIL.Emit(OpCodes.Stloc, 10)
...
OptimizeIL.Emit(OpCodes.Beq, fa112)
OptimizeIL.Emit(OpCodes.Br, tru112)
...
Dim locbldr127 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(TypeTok))
locbldr127.SetLocalSymInfo("tt1")
OptimizeIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Expr)
OptimizeIL.Emit(OpCodes.Ldfld, GetType(Expr).GetField("Tokens"))
Typ = GetType(Expr).GetField("Tokens").FieldType
...
OptimizeIL.Emit(OpCodes.Beq, tru116)
OptimizeIL.Emit(OpCodes.Br, fa116)
OptimizeIL.MarkLabel(tru116)
OptimizeIL.MarkSequencePoint(doc4, 278, 1, 278, 100)
Dim locbldr128 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(Ident))
locbldr128.SetLocalSymInfo("id1")
OptimizeIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Expr)
OptimizeIL.Emit(OpCodes.Ldfld, GetType(Expr).GetField("Tokens"))
Typ = GetType(Expr).GetField("Tokens").FieldType
...
Dim locbldr129 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(CharLiteral))
locbldr129.SetLocalSymInfo("cl1")
OptimizeIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Expr)
OptimizeIL.Emit(OpCodes.Ldfld, GetType(Expr).GetField("Tokens"))
Typ = GetType(Expr).GetField("Tokens").FieldType
...
OptimizeIL.Emit(OpCodes.Beq, tru119)
OptimizeIL.Emit(OpCodes.Br, fa119)
...
Dim locbldr130 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(StringLiteral))
locbldr130.SetLocalSymInfo("sl1")
OptimizeIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Expr)
OptimizeIL.Emit(OpCodes.Ldfld, GetType(Expr).GetField("Tokens"))
Typ = GetType(Expr).GetField("Tokens").FieldType
...
OptimizeIL.Emit(OpCodes.Beq, tru121)
OptimizeIL.Emit(OpCodes.Br, fa121)
...
Dim locbldr131 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(BooleanLiteral))
locbldr131.SetLocalSymInfo("bl1")
OptimizeIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Expr)
OptimizeIL.Emit(OpCodes.Ldfld, GetType(Expr).GetField("Tokens"))
Typ = GetType(Expr).GetField("Tokens").FieldType
...
Dim locbldr132 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(NumberLiteral))
locbldr132.SetLocalSymInfo("nl1")
OptimizeIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Expr)
OptimizeIL.Emit(OpCodes.Ldfld, GetType(Expr).GetField("Tokens"))
Typ = GetType(Expr).GetField("Tokens").FieldType
...
Dim locbldr133 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(MethodCallTok))
locbldr133.SetLocalSymInfo("mct")
OptimizeIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Expr)
OptimizeIL.Emit(OpCodes.Ldfld, GetType(Expr).GetField("Tokens"))
Typ = GetType(Expr).GetField("Tokens").FieldType
...
Dim locbldr134 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(Expr).MakeArrayType())
locbldr134.SetLocalSymInfo("prs")
OptimizeIL.Emit(OpCodes.Ldloc, 17)
Typ = GetType(MethodCallTok)
...
Dim locbldr135 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(System.Int32))
locbldr135.SetLocalSymInfo("ln2")
OptimizeIL.Emit(OpCodes.Ldloc, 18)
...
Dim locbldr136 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(System.Int32))
locbldr136.SetLocalSymInfo("i2")
OptimizeIL.Emit(OpCodes.Ldc_I4, CInt(-1))
Typ = GetType(System.Int32)
OptimizeIL.Emit(OpCodes.Stloc, 20)
...
OptimizeIL.Emit(OpCodes.Blt, tru127)
...
OptimizeIL.Emit(OpCodes.Bgt, tru129)
...
Dim locbldr137 As LocalBuilder = checkRefasmIL.DeclareLocal(GetType(Token))
locbldr137.SetLocalSymInfo("tok")
...
Dim locbldr138 As LocalBuilder = checkRefasmIL.DeclareLocal(GetType(System.Type))
locbldr138.SetLocalSymInfo("typ")
...
Dim locbldr139 As LocalBuilder = checkRefasmIL.DeclareLocal(GetType(RefasmStmt))
locbldr139.SetLocalSymInfo("refasms")
...
Typ = GetType(System.Boolean)
Dim fa131 As System.Reflection.Emit.Label = checkRefasmIL.DefineLabel()
Dim tru131 As System.Reflection.Emit.Label = checkRefasmIL.DefineLabel()
Dim cont131 As System.Reflection.Emit.Label = checkRefasmIL.DefineLabel()
checkRefasmIL.Emit(OpCodes.Beq, tru131)
checkRefasmIL.Emit(OpCodes.Br, fa131)
checkRefasmIL.MarkLabel(tru131)
...
checkRefasmIL.Emit(OpCodes.Br, cont131)
checkRefasmIL.MarkLabel(fa131)
checkRefasmIL.Emit(OpCodes.Br, cont131)
checkRefasmIL.MarkLabel(cont131)
...
Dim locbldr140 As LocalBuilder = checkDebugIL.DeclareLocal(GetType(Token))
locbldr140.SetLocalSymInfo("tok")
...
Dim locbldr141 As LocalBuilder = checkDebugIL.DeclareLocal(GetType(System.Type))
...
Dim locbldr142 As LocalBuilder = checkDebugIL.DeclareLocal(GetType(DebugStmt))
locbldr142.SetLocalSymInfo("dbgs")
...
Typ = GetType(System.Boolean)
Dim fa132 As System.Reflection.Emit.Label = checkDebugIL.DefineLabel()
Dim tru132 As System.Reflection.Emit.Label = checkDebugIL.DefineLabel()
Dim cont132 As System.Reflection.Emit.Label = checkDebugIL.DefineLabel()
checkDebugIL.Emit(OpCodes.Beq, tru132)
checkDebugIL.Emit(OpCodes.Br, fa132)
checkDebugIL.MarkLabel(tru132)
...
checkDebugIL.Emit(OpCodes.Br, cont132)
checkDebugIL.MarkLabel(fa132)
checkDebugIL.Emit(OpCodes.Br, cont132)
checkDebugIL.MarkLabel(cont132)
...
Dim locbldr143 As LocalBuilder = checkImportIL.DeclareLocal(GetType(Token))
locbldr143.SetLocalSymInfo("tok")
...
Dim locbldr144 As LocalBuilder = checkImportIL.DeclareLocal(GetType(System.Type))
...
Dim locbldr145 As LocalBuilder = checkImportIL.DeclareLocal(GetType(ImportStmt))
locbldr145.SetLocalSymInfo("imps")
...
Typ = GetType(System.Boolean)
Dim fa133 As System.Reflection.Emit.Label = checkImportIL.DefineLabel()
Dim tru133 As System.Reflection.Emit.Label = checkImportIL.DefineLabel()
Dim cont133 As System.Reflection.Emit.Label = checkImportIL.DefineLabel()
checkImportIL.Emit(OpCodes.Beq, tru133)
checkImportIL.Emit(OpCodes.Br, fa133)
checkImportIL.MarkLabel(tru133)
...
checkImportIL.Emit(OpCodes.Br, cont133)
checkImportIL.MarkLabel(fa133)
checkImportIL.Emit(OpCodes.Br, cont133)
checkImportIL.MarkLabel(cont133)
...
Dim locbldr146 As LocalBuilder = checkLocimportIL.DeclareLocal(GetType(Token))
...
Dim locbldr147 As LocalBuilder = checkLocimportIL.DeclareLocal(GetType(System.Type))
...
Dim locbldr148 As LocalBuilder = checkLocimportIL.DeclareLocal(GetType(LocimportStmt))
locbldr148.SetLocalSymInfo("limps")
...
Typ = GetType(System.Boolean)
Dim fa134 As System.Reflection.Emit.Label = checkLocimportIL.DefineLabel()
Dim tru134 As System.Reflection.Emit.Label = checkLocimportIL.DefineLabel()
Dim cont134 As System.Reflection.Emit.Label = checkLocimportIL.DefineLabel()
checkLocimportIL.Emit(OpCodes.Beq, tru134)
checkLocimportIL.Emit(OpCodes.Br, fa134)
checkLocimportIL.MarkLabel(tru134)
...
checkLocimportIL.Emit(OpCodes.Br, cont134)
checkLocimportIL.MarkLabel(fa134)
checkLocimportIL.Emit(OpCodes.Br, cont134)
checkLocimportIL.MarkLabel(cont134)
...
Dim locbldr149 As LocalBuilder = checkCmtIL.DeclareLocal(GetType(Token))
locbldr149.SetLocalSymInfo("tok")
...
Dim locbldr150 As LocalBuilder = checkCmtIL.DeclareLocal(GetType(System.Type))
...
Dim locbldr151 As LocalBuilder = checkCmtIL.DeclareLocal(GetType(CommentStmt))
locbldr151.SetLocalSymInfo("cmts")
...
Typ = GetType(System.Boolean)
Dim fa135 As System.Reflection.Emit.Label = checkCmtIL.DefineLabel()
Dim tru135 As System.Reflection.Emit.Label = checkCmtIL.DefineLabel()
Dim cont135 As System.Reflection.Emit.Label = checkCmtIL.DefineLabel()
checkCmtIL.Emit(OpCodes.Beq, tru135)
checkCmtIL.Emit(OpCodes.Br, fa135)
checkCmtIL.MarkLabel(tru135)
...
checkCmtIL.Emit(OpCodes.Br, cont135)
checkCmtIL.MarkLabel(fa135)
checkCmtIL.Emit(OpCodes.Br, cont135)
checkCmtIL.MarkLabel(cont135)
...
Typ = GetType(System.Int32)
Dim fa136 As System.Reflection.Emit.Label = checkEndMtdIL.DefineLabel()
Dim tru136 As System.Reflection.Emit.Label = checkEndMtdIL.DefineLabel()
Dim cont136 As System.Reflection.Emit.Label = checkEndMtdIL.DefineLabel()
checkEndMtdIL.Emit(OpCodes.Bge, tru136)
checkEndMtdIL.Emit(OpCodes.Br, fa136)
checkEndMtdIL.MarkLabel(tru136)
checkEndMtdIL.MarkSequencePoint(doc5, 72, 1, 72, 100)
Dim locbldr152 As LocalBuilder = checkEndMtdIL.DeclareLocal(GetType(Token))
locbldr152.SetLocalSymInfo("tok1")
checkEndMtdIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
checkEndMtdIL.Emit(OpCodes.Ldfld, GetType(Stmt).GetField("Tokens"))
Typ = GetType(Stmt).GetField("Tokens").FieldType
...
Dim locbldr153 As LocalBuilder = checkEndMtdIL.DeclareLocal(GetType(System.Type))
locbldr153.SetLocalSymInfo("typ1")
...
Dim locbldr154 As LocalBuilder = checkEndMtdIL.DeclareLocal(GetType(System.Boolean))
locbldr154.SetLocalSymInfo("b1")
Dim typ18(-1) As Type
...
Dim locbldr155 As LocalBuilder = checkEndMtdIL.DeclareLocal(GetType(Token))
locbldr155.SetLocalSymInfo("tok2")
checkEndMtdIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
checkEndMtdIL.Emit(OpCodes.Ldfld, GetType(Stmt).GetField("Tokens"))
Typ = GetType(Stmt).GetField("Tokens").FieldType
...
Dim locbldr156 As LocalBuilder = checkEndMtdIL.DeclareLocal(GetType(System.Type))
locbldr156.SetLocalSymInfo("typ2")
...
Dim locbldr157 As LocalBuilder = checkEndMtdIL.DeclareLocal(GetType(System.Boolean))
locbldr157.SetLocalSymInfo("b2")
Dim typ20(-1) As Type
...
Dim locbldr158 As LocalBuilder = checkEndMtdIL.DeclareLocal(GetType(EndMethodStmt))
locbldr158.SetLocalSymInfo("ems")
...
Typ = GetType(System.Boolean)
Dim fa137 As System.Reflection.Emit.Label = checkEndMtdIL.DefineLabel()
Dim tru137 As System.Reflection.Emit.Label = checkEndMtdIL.DefineLabel()
Dim cont137 As System.Reflection.Emit.Label = checkEndMtdIL.DefineLabel()
checkEndMtdIL.Emit(OpCodes.Beq, tru137)
checkEndMtdIL.Emit(OpCodes.Br, fa137)
checkEndMtdIL.MarkLabel(tru137)
...
checkEndMtdIL.Emit(OpCodes.Br, cont137)
checkEndMtdIL.MarkLabel(fa137)
checkEndMtdIL.Emit(OpCodes.Br, cont137)
checkEndMtdIL.MarkLabel(cont137)
checkEndMtdIL.MarkSequencePoint(doc5, 87, 1, 87, 100)
checkEndMtdIL.Emit(OpCodes.Br, cont136)
checkEndMtdIL.MarkLabel(fa136)
checkEndMtdIL.Emit(OpCodes.Br, cont136)
checkEndMtdIL.MarkLabel(cont136)
...
Typ = GetType(System.Int32)
Dim fa138 As System.Reflection.Emit.Label = checkEndClsIL.DefineLabel()
Dim tru138 As System.Reflection.Emit.Label = checkEndClsIL.DefineLabel()
Dim cont138 As System.Reflection.Emit.Label = checkEndClsIL.DefineLabel()
checkEndClsIL.Emit(OpCodes.Bge, tru138)
checkEndClsIL.Emit(OpCodes.Br, fa138)
checkEndClsIL.MarkLabel(tru138)
checkEndClsIL.MarkSequencePoint(doc5, 94, 1, 94, 100)
Dim locbldr159 As LocalBuilder = checkEndClsIL.DeclareLocal(GetType(Token))
...
Dim locbldr160 As LocalBuilder = checkEndClsIL.DeclareLocal(GetType(System.Type))
...
Dim locbldr161 As LocalBuilder = checkEndClsIL.DeclareLocal(GetType(System.Boolean))
...
Dim locbldr162 As LocalBuilder = checkEndClsIL.DeclareLocal(GetType(Token))
...
Dim locbldr163 As LocalBuilder = checkEndClsIL.DeclareLocal(GetType(System.Type))
...
Dim locbldr164 As LocalBuilder = checkEndClsIL.DeclareLocal(GetType(System.Boolean))
...
Dim locbldr165 As LocalBuilder = checkEndClsIL.DeclareLocal(GetType(EndClassStmt))
locbldr165.SetLocalSymInfo("ecs")
...
Typ = GetType(System.Boolean)
Dim fa139 As System.Reflection.Emit.Label = checkEndClsIL.DefineLabel()
Dim tru139 As System.Reflection.Emit.Label = checkEndClsIL.DefineLabel()
Dim cont139 As System.Reflection.Emit.Label = checkEndClsIL.DefineLabel()
checkEndClsIL.Emit(OpCodes.Beq, tru139)
checkEndClsIL.Emit(OpCodes.Br, fa139)
checkEndClsIL.MarkLabel(tru139)
...
checkEndClsIL.Emit(OpCodes.Br, cont139)
checkEndClsIL.MarkLabel(fa139)
checkEndClsIL.Emit(OpCodes.Br, cont139)
checkEndClsIL.MarkLabel(cont139)
checkEndClsIL.MarkSequencePoint(doc5, 109, 1, 109, 100)
checkEndClsIL.Emit(OpCodes.Br, cont138)
checkEndClsIL.MarkLabel(fa138)
checkEndClsIL.Emit(OpCodes.Br, cont138)
checkEndClsIL.MarkLabel(cont138)
...
Dim locbldr166 As LocalBuilder = checkAssemblyIL.DeclareLocal(GetType(Token))
locbldr166.SetLocalSymInfo("tok")
...
Dim locbldr167 As LocalBuilder = checkAssemblyIL.DeclareLocal(GetType(System.Type))
...
Dim locbldr168 As LocalBuilder = checkAssemblyIL.DeclareLocal(GetType(AssemblyStmt))
locbldr168.SetLocalSymInfo("asms")
...
Typ = GetType(System.Boolean)
Dim fa140 As System.Reflection.Emit.Label = checkAssemblyIL.DefineLabel()
Dim tru140 As System.Reflection.Emit.Label = checkAssemblyIL.DefineLabel()
Dim cont140 As System.Reflection.Emit.Label = checkAssemblyIL.DefineLabel()
checkAssemblyIL.Emit(OpCodes.Beq, tru140)
checkAssemblyIL.Emit(OpCodes.Br, fa140)
checkAssemblyIL.MarkLabel(tru140)
...
checkAssemblyIL.Emit(OpCodes.Br, cont140)
checkAssemblyIL.MarkLabel(fa140)
checkAssemblyIL.Emit(OpCodes.Br, cont140)
checkAssemblyIL.MarkLabel(cont140)
...
Dim locbldr169 As LocalBuilder = checkVerIL.DeclareLocal(GetType(Token))
locbldr169.SetLocalSymInfo("tok")
...
Dim locbldr170 As LocalBuilder = checkVerIL.DeclareLocal(GetType(System.Type))
locbldr170.SetLocalSymInfo("typ")
...
Dim locbldr171 As LocalBuilder = checkVerIL.DeclareLocal(GetType(VerStmt))
locbldr171.SetLocalSymInfo("vers")
...
Typ = GetType(System.Boolean)
Dim fa141 As System.Reflection.Emit.Label = checkVerIL.DefineLabel()
Dim tru141 As System.Reflection.Emit.Label = checkVerIL.DefineLabel()
Dim cont141 As System.Reflection.Emit.Label = checkVerIL.DefineLabel()
checkVerIL.Emit(OpCodes.Beq, tru141)
checkVerIL.Emit(OpCodes.Br, fa141)
checkVerIL.MarkLabel(tru141)
...
Dim locbldr172 As LocalBuilder = checkVerIL.DeclareLocal(GetType(System.String).MakeArrayType())
locbldr172.SetLocalSymInfo("ars")
Dim typ32(-1) As Type
checkVerIL.Emit(OpCodes.Ldloc, 0)
Typ = GetType(Token)
...
Dim locbldr173 As LocalBuilder = checkVerIL.DeclareLocal(GetType(System.Int32).MakeArrayType())
locbldr173.SetLocalSymInfo("ari")
...
Dim locbldr174 As LocalBuilder = checkVerIL.DeclareLocal(GetType(IntLiteral).MakeArrayType())
locbldr174.SetLocalSymInfo("intla")
checkVerIL.Emit(OpCodes.Ldc_I4, CInt(4))
Typ = GetType(System.Int32)
checkVerIL.Emit(OpCodes.Conv_U)
...
Dim locbldr175 As LocalBuilder = checkVerIL.DeclareLocal(GetType(IntLiteral))
locbldr175.SetLocalSymInfo("intl")
...
checkVerIL.Emit(OpCodes.Br, cont141)
checkVerIL.MarkLabel(fa141)
checkVerIL.Emit(OpCodes.Br, cont141)
checkVerIL.MarkLabel(cont141)
...
Dim locbldr176 As LocalBuilder = checkClassIL.DeclareLocal(GetType(Token))
...
Dim locbldr177 As LocalBuilder = checkClassIL.DeclareLocal(GetType(System.Type))
...
Dim locbldr178 As LocalBuilder = checkClassIL.DeclareLocal(GetType(ClassStmt))
locbldr178.SetLocalSymInfo("clss")
...
Dim locbldr179 As LocalBuilder = checkClassIL.DeclareLocal(GetType(Attributes.Attribute))
locbldr179.SetLocalSymInfo("att")
...
Typ = GetType(System.Boolean)
Dim fa142 As System.Reflection.Emit.Label = checkClassIL.DefineLabel()
Dim tru142 As System.Reflection.Emit.Label = checkClassIL.DefineLabel()
Dim cont142 As System.Reflection.Emit.Label = checkClassIL.DefineLabel()
checkClassIL.Emit(OpCodes.Beq, tru142)
checkClassIL.Emit(OpCodes.Br, fa142)
checkClassIL.MarkLabel(tru142)
...
Dim locbldr180 As LocalBuilder = checkClassIL.DeclareLocal(GetType(System.Int32))
locbldr180.SetLocalSymInfo("i")
checkClassIL.Emit(OpCodes.Ldc_I4, CInt(0))
Typ = GetType(System.Int32)
checkClassIL.Emit(OpCodes.Stloc, 4)
checkClassIL.MarkSequencePoint(doc5, 180, 1, 180, 100)
Dim locbldr181 As LocalBuilder = checkClassIL.DeclareLocal(GetType(System.Int32))
...
Dim locbldr182 As LocalBuilder = checkClassIL.DeclareLocal(GetType(System.Boolean))
...
checkClassIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa143 As System.Reflection.Emit.Label = checkClassIL.DefineLabel()
Dim tru143 As System.Reflection.Emit.Label = checkClassIL.DefineLabel()
Dim cont143 As System.Reflection.Emit.Label = checkClassIL.DefineLabel()
checkClassIL.Emit(OpCodes.Beq, tru143)
checkClassIL.Emit(OpCodes.Br, fa143)
checkClassIL.MarkLabel(tru143)
...
checkClassIL.Emit(OpCodes.Br, cont143)
checkClassIL.MarkLabel(fa143)
...
Dim locbldr185 As LocalBuilder = checkClassIL.DeclareLocal(GetType(System.Boolean))
...
checkClassIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa144 As System.Reflection.Emit.Label = checkClassIL.DefineLabel()
Dim tru144 As System.Reflection.Emit.Label = checkClassIL.DefineLabel()
Dim cont144 As System.Reflection.Emit.Label = checkClassIL.DefineLabel()
checkClassIL.Emit(OpCodes.Beq, tru144)
checkClassIL.Emit(OpCodes.Br, fa144)
checkClassIL.MarkLabel(tru144)
...
checkClassIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa145 As System.Reflection.Emit.Label = checkClassIL.DefineLabel()
Dim tru145 As System.Reflection.Emit.Label = checkClassIL.DefineLabel()
Dim cont145 As System.Reflection.Emit.Label = checkClassIL.DefineLabel()
checkClassIL.Emit(OpCodes.Beq, fa145)
checkClassIL.Emit(OpCodes.Br, tru145)
checkClassIL.MarkLabel(tru145)
checkClassIL.MarkSequencePoint(doc5, 206, 1, 206, 100)
Dim locbldr186 As LocalBuilder = checkClassIL.DeclareLocal(GetType(Token))
...
Dim locbldr187 As LocalBuilder = checkClassIL.DeclareLocal(GetType(TypeTok))
...
checkClassIL.Emit(OpCodes.Br, cont145)
checkClassIL.MarkLabel(fa145)
...
checkClassIL.Emit(OpCodes.Br, cont145)
checkClassIL.MarkLabel(cont145)
checkClassIL.MarkSequencePoint(doc5, 214, 1, 214, 100)
checkClassIL.Emit(OpCodes.Br, cont144)
checkClassIL.MarkLabel(fa144)
...
checkClassIL.Emit(OpCodes.Br, cont144)
checkClassIL.MarkLabel(cont144)
checkClassIL.MarkSequencePoint(doc5, 218, 1, 218, 100)
checkClassIL.Emit(OpCodes.Br, cont143)
checkClassIL.MarkLabel(cont143)
checkClassIL.MarkSequencePoint(doc5, 220, 1, 220, 100)
checkClassIL.Emit(OpCodes.Ldloc, 4)
Typ = GetType(System.Int32)
checkClassIL.Emit(OpCodes.Ldloc, 5)
Typ = GetType(System.Int32)
Dim fa146 As System.Reflection.Emit.Label = checkClassIL.DefineLabel()
Dim tru146 As System.Reflection.Emit.Label = checkClassIL.DefineLabel()
Dim cont146 As System.Reflection.Emit.Label = checkClassIL.DefineLabel()
checkClassIL.Emit(OpCodes.Beq, tru146)
checkClassIL.Emit(OpCodes.Br, fa146)
checkClassIL.MarkLabel(tru146)
...
checkClassIL.Emit(OpCodes.Br, cont146)
checkClassIL.MarkLabel(fa146)
...
checkClassIL.Emit(OpCodes.Br, cont146)
checkClassIL.MarkLabel(cont146)
...
checkClassIL.Emit(OpCodes.Br, cont142)
checkClassIL.MarkLabel(fa142)
checkClassIL.Emit(OpCodes.Br, cont142)
checkClassIL.MarkLabel(cont142)
...
Dim locbldr188 As LocalBuilder = checkFieldIL.DeclareLocal(GetType(Token))
...
Dim locbldr189 As LocalBuilder = checkFieldIL.DeclareLocal(GetType(System.Type))
...
Dim locbldr190 As LocalBuilder = checkFieldIL.DeclareLocal(GetType(FieldStmt))
locbldr190.SetLocalSymInfo("flss")
...
Dim locbldr191 As LocalBuilder = checkFieldIL.DeclareLocal(GetType(Attributes.Attribute))
locbldr191.SetLocalSymInfo("att")
...
Typ = GetType(System.Boolean)
Dim fa147 As System.Reflection.Emit.Label = checkFieldIL.DefineLabel()
Dim tru147 As System.Reflection.Emit.Label = checkFieldIL.DefineLabel()
Dim cont147 As System.Reflection.Emit.Label = checkFieldIL.DefineLabel()
checkFieldIL.Emit(OpCodes.Beq, tru147)
checkFieldIL.Emit(OpCodes.Br, fa147)
checkFieldIL.MarkLabel(tru147)
checkFieldIL.MarkSequencePoint(doc5, 243, 1, 243, 100)
Dim locbldr192 As LocalBuilder = checkFieldIL.DeclareLocal(GetType(Expr))
locbldr192.SetLocalSymInfo("tempexp")
...
Dim locbldr193 As LocalBuilder = checkFieldIL.DeclareLocal(asm.GetType("dylan.NET.Tokenizer.Parser.ExprOptimizer"))
locbldr193.SetLocalSymInfo("eop")
...
Dim locbldr194 As LocalBuilder = checkFieldIL.DeclareLocal(GetType(System.Int32))
locbldr194.SetLocalSymInfo("i")
checkFieldIL.Emit(OpCodes.Ldc_I4, CInt(0))
Typ = GetType(System.Int32)
checkFieldIL.Emit(OpCodes.Stloc, 6)
checkFieldIL.MarkSequencePoint(doc5, 258, 1, 258, 100)
Dim locbldr195 As LocalBuilder = checkFieldIL.DeclareLocal(GetType(System.Int32))
locbldr195.SetLocalSymInfo("len")
checkFieldIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
checkFieldIL.Emit(OpCodes.Ldfld, GetType(Stmt).GetField("Tokens"))
Typ = GetType(Stmt).GetField("Tokens").FieldType
...
Dim locbldr196 As LocalBuilder = checkFieldIL.DeclareLocal(GetType(System.Boolean))
locbldr196.SetLocalSymInfo("bl")
checkFieldIL.Emit(OpCodes.Ldc_I4, 0)
Typ = GetType(System.Boolean)
...
checkFieldIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa148 As System.Reflection.Emit.Label = checkFieldIL.DefineLabel()
Dim tru148 As System.Reflection.Emit.Label = checkFieldIL.DefineLabel()
Dim cont148 As System.Reflection.Emit.Label = checkFieldIL.DefineLabel()
checkFieldIL.Emit(OpCodes.Beq, tru148)
checkFieldIL.Emit(OpCodes.Br, fa148)
checkFieldIL.MarkLabel(tru148)
...
checkFieldIL.Emit(OpCodes.Br, cont148)
checkFieldIL.MarkLabel(fa148)
checkFieldIL.Emit(OpCodes.Br, cont148)
checkFieldIL.MarkLabel(cont148)
checkFieldIL.MarkSequencePoint(doc5, 273, 1, 273, 100)
checkFieldIL.Emit(OpCodes.Ldloc, 6)
Typ = GetType(System.Int32)
checkFieldIL.Emit(OpCodes.Ldloc, 7)
Typ = GetType(System.Int32)
Dim fa149 As System.Reflection.Emit.Label = checkFieldIL.DefineLabel()
Dim tru149 As System.Reflection.Emit.Label = checkFieldIL.DefineLabel()
Dim cont149 As System.Reflection.Emit.Label = checkFieldIL.DefineLabel()
checkFieldIL.Emit(OpCodes.Beq, tru149)
checkFieldIL.Emit(OpCodes.Br, fa149)
checkFieldIL.MarkLabel(tru149)
...
checkFieldIL.Emit(OpCodes.Br, cont149)
checkFieldIL.MarkLabel(fa149)
...
checkFieldIL.Emit(OpCodes.Br, cont149)
checkFieldIL.MarkLabel(cont149)
...
Dim locbldr197 As LocalBuilder = checkFieldIL.DeclareLocal(GetType(Token))
...
Dim locbldr198 As LocalBuilder = checkFieldIL.DeclareLocal(GetType(System.Type))
...
Dim locbldr199 As LocalBuilder = checkFieldIL.DeclareLocal(GetType(System.Boolean))
...
checkFieldIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa150 As System.Reflection.Emit.Label = checkFieldIL.DefineLabel()
Dim tru150 As System.Reflection.Emit.Label = checkFieldIL.DefineLabel()
Dim cont150 As System.Reflection.Emit.Label = checkFieldIL.DefineLabel()
checkFieldIL.Emit(OpCodes.Beq, fa150)
checkFieldIL.Emit(OpCodes.Br, tru150)
checkFieldIL.MarkLabel(tru150)
checkFieldIL.MarkSequencePoint(doc5, 287, 1, 287, 100)
Dim locbldr200 As LocalBuilder = checkFieldIL.DeclareLocal(GetType(Token))
locbldr200.SetLocalSymInfo("t")
checkFieldIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
checkFieldIL.Emit(OpCodes.Ldfld, GetType(Stmt).GetField("Tokens"))
Typ = GetType(Stmt).GetField("Tokens").FieldType
...
Dim locbldr201 As LocalBuilder = checkFieldIL.DeclareLocal(GetType(TypeTok))
locbldr201.SetLocalSymInfo("tt")
...
checkFieldIL.Emit(OpCodes.Br, cont150)
checkFieldIL.MarkLabel(fa150)
...
checkFieldIL.Emit(OpCodes.Br, cont150)
checkFieldIL.MarkLabel(cont150)
...
checkFieldIL.Emit(OpCodes.Br, cont147)
checkFieldIL.MarkLabel(fa147)
checkFieldIL.Emit(OpCodes.Br, cont147)
checkFieldIL.MarkLabel(cont147)
...
Dim locbldr202 As LocalBuilder = checkMethodIL.DeclareLocal(GetType(Token))
locbldr202.SetLocalSymInfo("tok")
...
Dim locbldr203 As LocalBuilder = checkMethodIL.DeclareLocal(GetType(System.Type))
locbldr203.SetLocalSymInfo("typ")
...
Dim locbldr204 As LocalBuilder = checkMethodIL.DeclareLocal(GetType(MethodStmt))
locbldr204.SetLocalSymInfo("mtss")
...
Dim locbldr205 As LocalBuilder = checkMethodIL.DeclareLocal(GetType(Attributes.Attribute))
locbldr205.SetLocalSymInfo("att")
...
Dim locbldr206 As LocalBuilder = checkMethodIL.DeclareLocal(GetType(Ident))
locbldr206.SetLocalSymInfo("mn")
...
Dim locbldr207 As LocalBuilder = checkMethodIL.DeclareLocal(GetType(Expr))
locbldr207.SetLocalSymInfo("exp")
checkMethodIL.Emit(OpCodes.Ldnull)
checkMethodIL.Emit(OpCodes.Stloc, 5)
checkMethodIL.MarkSequencePoint(doc5, 313, 1, 313, 100)
Dim locbldr208 As LocalBuilder = checkMethodIL.DeclareLocal(GetType(System.Boolean))
locbldr208.SetLocalSymInfo("d")
...
Typ = GetType(System.Boolean)
Dim fa151 As System.Reflection.Emit.Label = checkMethodIL.DefineLabel()
Dim tru151 As System.Reflection.Emit.Label = checkMethodIL.DefineLabel()
Dim cont151 As System.Reflection.Emit.Label = checkMethodIL.DefineLabel()
checkMethodIL.Emit(OpCodes.Beq, tru151)
checkMethodIL.Emit(OpCodes.Br, fa151)
checkMethodIL.MarkLabel(tru151)
checkMethodIL.MarkSequencePoint(doc5, 317, 1, 317, 100)
Dim locbldr209 As LocalBuilder = checkMethodIL.DeclareLocal(GetType(Expr))
locbldr209.SetLocalSymInfo("tempexp")
...
Dim locbldr210 As LocalBuilder = checkMethodIL.DeclareLocal(asm.GetType("dylan.NET.Tokenizer.Parser.ExprOptimizer"))
locbldr210.SetLocalSymInfo("eop")
...
Dim locbldr211 As LocalBuilder = checkMethodIL.DeclareLocal(GetType(System.Int32))
locbldr211.SetLocalSymInfo("i")
checkMethodIL.Emit(OpCodes.Ldc_I4, CInt(0))
Typ = GetType(System.Int32)
checkMethodIL.Emit(OpCodes.Stloc, 9)
checkMethodIL.MarkSequencePoint(doc5, 333, 1, 333, 100)
Dim locbldr212 As LocalBuilder = checkMethodIL.DeclareLocal(GetType(System.Int32))
...
Dim locbldr213 As LocalBuilder = checkMethodIL.DeclareLocal(GetType(System.Boolean))
...
checkMethodIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa152 As System.Reflection.Emit.Label = checkMethodIL.DefineLabel()
Dim tru152 As System.Reflection.Emit.Label = checkMethodIL.DefineLabel()
Dim cont152 As System.Reflection.Emit.Label = checkMethodIL.DefineLabel()
checkMethodIL.Emit(OpCodes.Beq, tru152)
checkMethodIL.Emit(OpCodes.Br, fa152)
checkMethodIL.MarkLabel(tru152)
...
checkMethodIL.Emit(OpCodes.Br, cont152)
checkMethodIL.MarkLabel(fa152)
...
checkMethodIL.Emit(OpCodes.Br, cont152)
checkMethodIL.MarkLabel(cont152)
checkMethodIL.MarkSequencePoint(doc5, 352, 1, 352, 100)
checkMethodIL.Emit(OpCodes.Ldloc, 9)
Typ = GetType(System.Int32)
checkMethodIL.Emit(OpCodes.Ldloc, 10)
Typ = GetType(System.Int32)
Dim fa153 As System.Reflection.Emit.Label = checkMethodIL.DefineLabel()
Dim tru153 As System.Reflection.Emit.Label = checkMethodIL.DefineLabel()
Dim cont153 As System.Reflection.Emit.Label = checkMethodIL.DefineLabel()
checkMethodIL.Emit(OpCodes.Beq, tru153)
checkMethodIL.Emit(OpCodes.Br, fa153)
checkMethodIL.MarkLabel(tru153)
...
checkMethodIL.Emit(OpCodes.Br, cont153)
checkMethodIL.MarkLabel(fa153)
...
checkMethodIL.Emit(OpCodes.Br, cont153)
checkMethodIL.MarkLabel(cont153)
...
Dim locbldr214 As LocalBuilder = checkMethodIL.DeclareLocal(GetType(Token))
...
Dim locbldr215 As LocalBuilder = checkMethodIL.DeclareLocal(GetType(System.Type))
locbldr215.SetLocalSymInfo("typ2")
checkMethodIL.MarkSequencePoint(doc5, 367, 1, 367, 100)
Dim locbldr216 As LocalBuilder = checkMethodIL.DeclareLocal(GetType(System.Boolean))
...
checkMethodIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa154 As System.Reflection.Emit.Label = checkMethodIL.DefineLabel()
Dim tru154 As System.Reflection.Emit.Label = checkMethodIL.DefineLabel()
Dim cont154 As System.Reflection.Emit.Label = checkMethodIL.DefineLabel()
checkMethodIL.Emit(OpCodes.Beq, fa154)
checkMethodIL.Emit(OpCodes.Br, tru154)
checkMethodIL.MarkLabel(tru154)
checkMethodIL.MarkSequencePoint(doc5, 373, 1, 373, 100)
Dim locbldr217 As LocalBuilder = checkMethodIL.DeclareLocal(GetType(Token))
...
Dim locbldr218 As LocalBuilder = checkMethodIL.DeclareLocal(GetType(TypeTok))
...
checkMethodIL.Emit(OpCodes.Br, cont154)
checkMethodIL.MarkLabel(fa154)
...
checkMethodIL.Emit(OpCodes.Br, cont154)
checkMethodIL.MarkLabel(cont154)
...
checkMethodIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa155 As System.Reflection.Emit.Label = checkMethodIL.DefineLabel()
Dim tru155 As System.Reflection.Emit.Label = checkMethodIL.DefineLabel()
Dim cont155 As System.Reflection.Emit.Label = checkMethodIL.DefineLabel()
checkMethodIL.Emit(OpCodes.Beq, tru155)
checkMethodIL.Emit(OpCodes.Br, fa155)
checkMethodIL.MarkLabel(tru155)
...
checkMethodIL.Emit(OpCodes.Br, cont155)
checkMethodIL.MarkLabel(fa155)
checkMethodIL.Emit(OpCodes.Br, cont155)
checkMethodIL.MarkLabel(cont155)
...
checkMethodIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa156 As System.Reflection.Emit.Label = checkMethodIL.DefineLabel()
Dim tru156 As System.Reflection.Emit.Label = checkMethodIL.DefineLabel()
Dim cont156 As System.Reflection.Emit.Label = checkMethodIL.DefineLabel()
checkMethodIL.Emit(OpCodes.Beq, tru156)
checkMethodIL.Emit(OpCodes.Br, fa156)
checkMethodIL.MarkLabel(tru156)
...
checkMethodIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa157 As System.Reflection.Emit.Label = checkMethodIL.DefineLabel()
Dim tru157 As System.Reflection.Emit.Label = checkMethodIL.DefineLabel()
Dim cont157 As System.Reflection.Emit.Label = checkMethodIL.DefineLabel()
checkMethodIL.Emit(OpCodes.Beq, tru157)
checkMethodIL.Emit(OpCodes.Br, fa157)
checkMethodIL.MarkLabel(tru157)
...
Dim locbldr219 As LocalBuilder = checkMethodIL.DeclareLocal(asm.GetType("dylan.NET.Tokenizer.Parser.ExprOptimizer"))
locbldr219.SetLocalSymInfo("eopt2")
checkMethodIL.Emit(OpCodes.Newobj, asm.GetType("dylan.NET.Tokenizer.Parser.ExprOptimizer").GetConstructor(Type.EmptyTypes))
...
checkMethodIL.Emit(OpCodes.Br, cont157)
checkMethodIL.MarkLabel(fa157)
checkMethodIL.Emit(OpCodes.Br, cont157)
checkMethodIL.MarkLabel(cont157)
...
checkMethodIL.Emit(OpCodes.Beq, tru161)
checkMethodIL.Emit(OpCodes.Br, fa161)
checkMethodIL.MarkLabel(tru161)
checkMethodIL.MarkSequencePoint(doc5, 432, 1, 432, 100)
Dim locbldr220 As LocalBuilder = checkMethodIL.DeclareLocal(asm.GetType("dylan.NET.Tokenizer.Parser.ExprOptimizer"))
locbldr220.SetLocalSymInfo("eopt1")
checkMethodIL.Emit(OpCodes.Newobj, asm.GetType("dylan.NET.Tokenizer.Parser.ExprOptimizer").GetConstructor(Type.EmptyTypes))
...
checkMethodIL.Emit(OpCodes.Br, cont156)
checkMethodIL.MarkLabel(fa156)
checkMethodIL.Emit(OpCodes.Br, cont156)
checkMethodIL.MarkLabel(cont156)
checkMethodIL.MarkSequencePoint(doc5, 455, 1, 455, 100)
checkMethodIL.Emit(OpCodes.Br, cont151)
checkMethodIL.MarkLabel(fa151)
checkMethodIL.Emit(OpCodes.Br, cont151)
checkMethodIL.MarkLabel(cont151)
...
Typ = GetType(System.Int32)
Dim fa165 As System.Reflection.Emit.Label = checkMethodCallIL.DefineLabel()
Dim tru165 As System.Reflection.Emit.Label = checkMethodCallIL.DefineLabel()
Dim cont165 As System.Reflection.Emit.Label = checkMethodCallIL.DefineLabel()
checkMethodCallIL.Emit(OpCodes.Bgt, tru165)
checkMethodCallIL.Emit(OpCodes.Br, fa165)
checkMethodCallIL.MarkLabel(tru165)
checkMethodCallIL.MarkSequencePoint(doc5, 462, 1, 462, 100)
Dim locbldr221 As LocalBuilder = checkMethodCallIL.DeclareLocal(GetType(Token))
...
Dim locbldr222 As LocalBuilder = checkMethodCallIL.DeclareLocal(GetType(System.Type))
...
Dim locbldr223 As LocalBuilder = checkMethodCallIL.DeclareLocal(GetType(Token))
locbldr223.SetLocalSymInfo("tokb")
checkMethodCallIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
checkMethodCallIL.Emit(OpCodes.Ldfld, GetType(Stmt).GetField("Tokens"))
Typ = GetType(Stmt).GetField("Tokens").FieldType
...
Dim locbldr224 As LocalBuilder = checkMethodCallIL.DeclareLocal(GetType(System.Type))
locbldr224.SetLocalSymInfo("typb")
...
Dim locbldr225 As LocalBuilder = checkMethodCallIL.DeclareLocal(GetType(System.Boolean))
locbldr225.SetLocalSymInfo("ba")
Dim typ87(-1) As Type
...
Dim locbldr226 As LocalBuilder = checkMethodCallIL.DeclareLocal(GetType(System.Boolean))
locbldr226.SetLocalSymInfo("bb")
Dim typ88(-1) As Type
...
Dim locbldr227 As LocalBuilder = checkMethodCallIL.DeclareLocal(GetType(MethodCallStmt))
locbldr227.SetLocalSymInfo("mtcss")
...
Dim locbldr228 As LocalBuilder = checkMethodCallIL.DeclareLocal(GetType(MethodNameTok))
locbldr228.SetLocalSymInfo("mn")
...
Dim locbldr229 As LocalBuilder = checkMethodCallIL.DeclareLocal(GetType(MethodCallTok))
locbldr229.SetLocalSymInfo("mct")
...
Dim locbldr230 As LocalBuilder = checkMethodCallIL.DeclareLocal(GetType(Ident))
...
Dim locbldr231 As LocalBuilder = checkMethodCallIL.DeclareLocal(GetType(Expr))
locbldr231.SetLocalSymInfo("exp")
...
Dim locbldr232 As LocalBuilder = checkMethodCallIL.DeclareLocal(GetType(System.Int32))
locbldr232.SetLocalSymInfo("lvl")
checkMethodCallIL.Emit(OpCodes.Ldc_I4, CInt(1))
Typ = GetType(System.Int32)
...
Dim locbldr234 As LocalBuilder = checkMethodCallIL.DeclareLocal(GetType(System.Int32))
...
checkMethodCallIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa166 As System.Reflection.Emit.Label = checkMethodCallIL.DefineLabel()
Dim tru166 As System.Reflection.Emit.Label = checkMethodCallIL.DefineLabel()
Dim cont166 As System.Reflection.Emit.Label = checkMethodCallIL.DefineLabel()
checkMethodCallIL.Emit(OpCodes.Beq, tru166)
checkMethodCallIL.Emit(OpCodes.Br, fa166)
checkMethodCallIL.MarkLabel(tru166)
...
Dim locbldr235 As LocalBuilder = checkMethodCallIL.DeclareLocal(GetType(Token))
...
Dim locbldr236 As LocalBuilder = checkMethodCallIL.DeclareLocal(GetType(System.Type))
locbldr236.SetLocalSymInfo("typ2")
checkMethodCallIL.MarkSequencePoint(doc5, 491, 1, 491, 100)
Dim locbldr237 As LocalBuilder = checkMethodCallIL.DeclareLocal(GetType(System.Boolean))
locbldr237.SetLocalSymInfo("b2")
checkMethodCallIL.MarkSequencePoint(doc5, 492, 1, 492, 100)
Dim locbldr238 As LocalBuilder = checkMethodCallIL.DeclareLocal(GetType(System.Int32))
locbldr238.SetLocalSymInfo("len")
checkMethodCallIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
checkMethodCallIL.Emit(OpCodes.Ldfld, GetType(Stmt).GetField("Tokens"))
Typ = GetType(Stmt).GetField("Tokens").FieldType
...
Dim locbldr239 As LocalBuilder = checkMethodCallIL.DeclareLocal(asm.GetType("dylan.NET.Tokenizer.Parser.ExprOptimizer"))
locbldr239.SetLocalSymInfo("eopt")
...
checkMethodCallIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa167 As System.Reflection.Emit.Label = checkMethodCallIL.DefineLabel()
Dim tru167 As System.Reflection.Emit.Label = checkMethodCallIL.DefineLabel()
Dim cont167 As System.Reflection.Emit.Label = checkMethodCallIL.DefineLabel()
checkMethodCallIL.Emit(OpCodes.Beq, tru167)
checkMethodCallIL.Emit(OpCodes.Br, fa167)
checkMethodCallIL.MarkLabel(tru167)
...
checkMethodCallIL.Emit(OpCodes.Ldc_I4, CInt(0))
Typ = GetType(System.Int32)
Dim fa168 As System.Reflection.Emit.Label = checkMethodCallIL.DefineLabel()
Dim tru168 As System.Reflection.Emit.Label = checkMethodCallIL.DefineLabel()
Dim cont168 As System.Reflection.Emit.Label = checkMethodCallIL.DefineLabel()
checkMethodCallIL.Emit(OpCodes.Beq, tru168)
checkMethodCallIL.Emit(OpCodes.Br, fa168)
checkMethodCallIL.MarkLabel(tru168)
...
checkMethodCallIL.Emit(OpCodes.Br, cont168)
checkMethodCallIL.MarkLabel(fa168)
...
checkMethodCallIL.Emit(OpCodes.Br, cont168)
checkMethodCallIL.MarkLabel(cont168)
checkMethodCallIL.MarkSequencePoint(doc5, 518, 1, 518, 100)
checkMethodCallIL.Emit(OpCodes.Br, label11)
checkMethodCallIL.MarkSequencePoint(doc5, 519, 1, 519, 100)
checkMethodCallIL.Emit(OpCodes.Br, cont167)
checkMethodCallIL.MarkLabel(fa167)
checkMethodCallIL.Emit(OpCodes.Br, cont167)
checkMethodCallIL.MarkLabel(cont167)
...
checkMethodCallIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa169 As System.Reflection.Emit.Label = checkMethodCallIL.DefineLabel()
Dim tru169 As System.Reflection.Emit.Label = checkMethodCallIL.DefineLabel()
Dim cont169 As System.Reflection.Emit.Label = checkMethodCallIL.DefineLabel()
checkMethodCallIL.Emit(OpCodes.Beq, tru169)
checkMethodCallIL.Emit(OpCodes.Br, fa169)
checkMethodCallIL.MarkLabel(tru169)
...
checkMethodCallIL.Emit(OpCodes.Br, cont169)
checkMethodCallIL.MarkLabel(fa169)
checkMethodCallIL.Emit(OpCodes.Br, cont169)
checkMethodCallIL.MarkLabel(cont169)
...
checkMethodCallIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa170 As System.Reflection.Emit.Label = checkMethodCallIL.DefineLabel()
Dim tru170 As System.Reflection.Emit.Label = checkMethodCallIL.DefineLabel()
Dim cont170 As System.Reflection.Emit.Label = checkMethodCallIL.DefineLabel()
checkMethodCallIL.Emit(OpCodes.Beq, tru170)
checkMethodCallIL.Emit(OpCodes.Br, fa170)
checkMethodCallIL.MarkLabel(tru170)
checkMethodCallIL.MarkSequencePoint(doc5, 534, 1, 534, 100)
checkMethodCallIL.Emit(OpCodes.Ldloc, 11)
Typ = GetType(System.Int32)
checkMethodCallIL.Emit(OpCodes.Ldc_I4, CInt(1))
Typ = GetType(System.Int32)
Dim fa171 As System.Reflection.Emit.Label = checkMethodCallIL.DefineLabel()
Dim tru171 As System.Reflection.Emit.Label = checkMethodCallIL.DefineLabel()
Dim cont171 As System.Reflection.Emit.Label = checkMethodCallIL.DefineLabel()
checkMethodCallIL.Emit(OpCodes.Beq, tru171)
checkMethodCallIL.Emit(OpCodes.Br, fa171)
checkMethodCallIL.MarkLabel(tru171)
...
checkMethodCallIL.Emit(OpCodes.Br, cont171)
checkMethodCallIL.MarkLabel(fa171)
...
checkMethodCallIL.Emit(OpCodes.Br, cont171)
checkMethodCallIL.MarkLabel(cont171)
checkMethodCallIL.MarkSequencePoint(doc5, 544, 1, 544, 100)
checkMethodCallIL.Emit(OpCodes.Br, cont170)
checkMethodCallIL.MarkLabel(fa170)
...
checkMethodCallIL.Emit(OpCodes.Br, cont170)
checkMethodCallIL.MarkLabel(cont170)
...
checkMethodCallIL.Emit(OpCodes.Beq, tru172)
...
checkMethodCallIL.Emit(OpCodes.Br, cont166)
checkMethodCallIL.MarkLabel(fa166)
checkMethodCallIL.Emit(OpCodes.Br, cont166)
checkMethodCallIL.MarkLabel(cont166)
checkMethodCallIL.MarkSequencePoint(doc5, 568, 1, 568, 100)
checkMethodCallIL.Emit(OpCodes.Br, cont165)
checkMethodCallIL.MarkLabel(fa165)
checkMethodCallIL.Emit(OpCodes.Br, cont165)
checkMethodCallIL.MarkLabel(cont165)
...
Dim locbldr240 As LocalBuilder = checkVarAsIL.DeclareLocal(GetType(Token))
locbldr240.SetLocalSymInfo("tok")
checkVarAsIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
...
Dim locbldr241 As LocalBuilder = checkVarAsIL.DeclareLocal(GetType(System.Type))
locbldr241.SetLocalSymInfo("typ")
checkVarAsIL.Emit(OpCodes.Ldtoken, GetType(VarTok))
...
Dim locbldr242 As LocalBuilder = checkVarAsIL.DeclareLocal(GetType(VarStmt))
locbldr242.SetLocalSymInfo("vars")
...
checkVarAsIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa174 As System.Reflection.Emit.Label = checkVarAsIL.DefineLabel()
Dim tru174 As System.Reflection.Emit.Label = checkVarAsIL.DefineLabel()
Dim cont174 As System.Reflection.Emit.Label = checkVarAsIL.DefineLabel()
checkVarAsIL.Emit(OpCodes.Beq, tru174)
checkVarAsIL.Emit(OpCodes.Br, fa174)
checkVarAsIL.MarkLabel(tru174)
...
Dim locbldr243 As LocalBuilder = checkVarAsIL.DeclareLocal(GetType(Expr))
locbldr243.SetLocalSymInfo("tempexp")
...
Dim locbldr244 As LocalBuilder = checkVarAsIL.DeclareLocal(asm.GetType("dylan.NET.Tokenizer.Parser.ExprOptimizer"))
locbldr244.SetLocalSymInfo("eop")
...
Dim locbldr245 As LocalBuilder = checkVarAsIL.DeclareLocal(GetType(Token))
...
Dim locbldr246 As LocalBuilder = checkVarAsIL.DeclareLocal(GetType(System.Type))
...
Dim locbldr247 As LocalBuilder = checkVarAsIL.DeclareLocal(GetType(System.Boolean))
...
checkVarAsIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa175 As System.Reflection.Emit.Label = checkVarAsIL.DefineLabel()
Dim tru175 As System.Reflection.Emit.Label = checkVarAsIL.DefineLabel()
Dim cont175 As System.Reflection.Emit.Label = checkVarAsIL.DefineLabel()
checkVarAsIL.Emit(OpCodes.Beq, fa175)
checkVarAsIL.Emit(OpCodes.Br, tru175)
checkVarAsIL.MarkLabel(tru175)
checkVarAsIL.MarkSequencePoint(doc5, 593, 1, 593, 100)
Dim locbldr248 As LocalBuilder = checkVarAsIL.DeclareLocal(GetType(Token))
...
Dim locbldr249 As LocalBuilder = checkVarAsIL.DeclareLocal(GetType(TypeTok))
...
checkVarAsIL.Emit(OpCodes.Br, cont175)
checkVarAsIL.MarkLabel(fa175)
...
checkVarAsIL.Emit(OpCodes.Br, cont175)
checkVarAsIL.MarkLabel(cont175)
checkVarAsIL.MarkSequencePoint(doc5, 602, 1, 602, 100)
checkVarAsIL.Emit(OpCodes.Br, cont174)
checkVarAsIL.MarkLabel(fa174)
checkVarAsIL.Emit(OpCodes.Br, cont174)
checkVarAsIL.MarkLabel(cont174)
...
Dim locbldr250 As LocalBuilder = AssOptIL.DeclareLocal(GetType(AssignStmt))
locbldr250.SetLocalSymInfo("asss")
AssOptIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
AssOptIL.Emit(OpCodes.Stloc, 0)
AssOptIL.MarkSequencePoint(doc5, 609, 1, 609, 100)
Dim locbldr251 As LocalBuilder = AssOptIL.DeclareLocal(GetType(Expr))
locbldr251.SetLocalSymInfo("le")
...
Dim locbldr252 As LocalBuilder = AssOptIL.DeclareLocal(GetType(Token))
...
Dim locbldr253 As LocalBuilder = AssOptIL.DeclareLocal(GetType(System.Type))
...
Dim locbldr254 As LocalBuilder = AssOptIL.DeclareLocal(GetType(System.Boolean))
locbldr254.SetLocalSymInfo("b")
...
Dim locbldr255 As LocalBuilder = AssOptIL.DeclareLocal(GetType(VarAsgnStmt))
locbldr255.SetLocalSymInfo("vass")
...
Typ = GetType(System.Boolean)
Dim fa176 As System.Reflection.Emit.Label = AssOptIL.DefineLabel()
Dim tru176 As System.Reflection.Emit.Label = AssOptIL.DefineLabel()
Dim cont176 As System.Reflection.Emit.Label = AssOptIL.DefineLabel()
AssOptIL.Emit(OpCodes.Beq, tru176)
AssOptIL.Emit(OpCodes.Br, fa176)
AssOptIL.MarkLabel(tru176)
...
Dim locbldr256 As LocalBuilder = AssOptIL.DeclareLocal(GetType(Token))
...
Dim locbldr257 As LocalBuilder = AssOptIL.DeclareLocal(GetType(System.Type))
...
Dim locbldr258 As LocalBuilder = AssOptIL.DeclareLocal(GetType(System.Boolean))
...
AssOptIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa177 As System.Reflection.Emit.Label = AssOptIL.DefineLabel()
Dim tru177 As System.Reflection.Emit.Label = AssOptIL.DefineLabel()
Dim cont177 As System.Reflection.Emit.Label = AssOptIL.DefineLabel()
AssOptIL.Emit(OpCodes.Beq, fa177)
AssOptIL.Emit(OpCodes.Br, tru177)
AssOptIL.MarkLabel(tru177)
...
Dim locbldr260 As LocalBuilder = AssOptIL.DeclareLocal(GetType(TypeTok))
...
AssOptIL.Emit(OpCodes.Br, cont177)
AssOptIL.MarkLabel(fa177)
...
Dim locbldr261 As LocalBuilder = AssOptIL.DeclareLocal(asm.GetType("dylan.NET.Tokenizer.Parser.ExprOptimizer"))
locbldr261.SetLocalSymInfo("eop")
...
Dim locbldr262 As LocalBuilder = checkAssignIL.DeclareLocal(GetType(Token))
locbldr262.SetLocalSymInfo("tok")
checkAssignIL.Emit(OpCodes.Ldnull)
checkAssignIL.Emit(OpCodes.Stloc, 0)
checkAssignIL.MarkSequencePoint(doc5, 646, 1, 646, 100)
Dim locbldr263 As LocalBuilder = checkAssignIL.DeclareLocal(GetType(System.Type))
...
Dim locbldr264 As LocalBuilder = checkAssignIL.DeclareLocal(GetType(AssignStmt))
locbldr264.SetLocalSymInfo("asss")
...
Dim locbldr265 As LocalBuilder = checkAssignIL.DeclareLocal(GetType(System.Boolean))
locbldr265.SetLocalSymInfo("c")
checkAssignIL.Emit(OpCodes.Ldc_I4, 0)
Typ = GetType(System.Boolean)
checkAssignIL.Emit(OpCodes.Stloc, 3)
checkAssignIL.MarkSequencePoint(doc5, 649, 1, 649, 100)
Dim locbldr266 As LocalBuilder = checkAssignIL.DeclareLocal(GetType(Expr))
locbldr266.SetLocalSymInfo("re")
...
Dim locbldr267 As LocalBuilder = checkAssignIL.DeclareLocal(GetType(Expr))
locbldr267.SetLocalSymInfo("le")
checkAssignIL.Emit(OpCodes.Newobj, GetType(Expr).GetConstructor(Type.EmptyTypes))
checkAssignIL.Emit(OpCodes.Stloc, 5)
checkAssignIL.MarkSequencePoint(doc5, 651, 1, 651, 100)
Dim locbldr268 As LocalBuilder = checkAssignIL.DeclareLocal(GetType(System.Int32))
locbldr268.SetLocalSymInfo("i")
...
Dim locbldr269 As LocalBuilder = checkAssignIL.DeclareLocal(GetType(System.Int32))
...
Dim locbldr270 As LocalBuilder = checkAssignIL.DeclareLocal(GetType(System.Int32))
locbldr270.SetLocalSymInfo("assind")
...
Typ = GetType(System.Boolean)
Dim fa178 As System.Reflection.Emit.Label = checkAssignIL.DefineLabel()
Dim tru178 As System.Reflection.Emit.Label = checkAssignIL.DefineLabel()
Dim cont178 As System.Reflection.Emit.Label = checkAssignIL.DefineLabel()
checkAssignIL.Emit(OpCodes.Beq, tru178)
checkAssignIL.Emit(OpCodes.Br, fa178)
checkAssignIL.MarkLabel(tru178)
...
checkAssignIL.Emit(OpCodes.Br, cont178)
checkAssignIL.MarkLabel(fa178)
checkAssignIL.Emit(OpCodes.Br, cont178)
checkAssignIL.MarkLabel(cont178)
checkAssignIL.MarkSequencePoint(doc5, 670, 1, 670, 100)
checkAssignIL.Emit(OpCodes.Ldloc, 6)
Typ = GetType(System.Int32)
checkAssignIL.Emit(OpCodes.Ldloc, 7)
Typ = GetType(System.Int32)
Dim fa179 As System.Reflection.Emit.Label = checkAssignIL.DefineLabel()
Dim tru179 As System.Reflection.Emit.Label = checkAssignIL.DefineLabel()
Dim cont179 As System.Reflection.Emit.Label = checkAssignIL.DefineLabel()
checkAssignIL.Emit(OpCodes.Beq, tru179)
checkAssignIL.Emit(OpCodes.Br, fa179)
checkAssignIL.MarkLabel(tru179)
checkAssignIL.MarkSequencePoint(doc5, 671, 1, 671, 100)
checkAssignIL.Emit(OpCodes.Br, label13)
checkAssignIL.MarkSequencePoint(doc5, 672, 1, 672, 100)
checkAssignIL.Emit(OpCodes.Br, cont179)
checkAssignIL.MarkLabel(fa179)
...
checkAssignIL.Emit(OpCodes.Br, cont179)
checkAssignIL.MarkLabel(cont179)
...
checkAssignIL.Emit(OpCodes.Ldc_I4, CInt(0))
Typ = GetType(System.Int32)
Dim fa180 As System.Reflection.Emit.Label = checkAssignIL.DefineLabel()
Dim tru180 As System.Reflection.Emit.Label = checkAssignIL.DefineLabel()
Dim cont180 As System.Reflection.Emit.Label = checkAssignIL.DefineLabel()
checkAssignIL.Emit(OpCodes.Beq, fa180)
checkAssignIL.Emit(OpCodes.Br, tru180)
checkAssignIL.MarkLabel(tru180)
...
checkAssignIL.Emit(OpCodes.Ldloc, 7)
Typ = GetType(System.Int32)
Dim fa181 As System.Reflection.Emit.Label = checkAssignIL.DefineLabel()
Dim tru181 As System.Reflection.Emit.Label = checkAssignIL.DefineLabel()
Dim cont181 As System.Reflection.Emit.Label = checkAssignIL.DefineLabel()
checkAssignIL.Emit(OpCodes.Beq, tru181)
checkAssignIL.Emit(OpCodes.Br, fa181)
checkAssignIL.MarkLabel(tru181)
...
checkAssignIL.Emit(OpCodes.Br, cont181)
checkAssignIL.MarkLabel(fa181)
...
checkAssignIL.Emit(OpCodes.Br, cont181)
checkAssignIL.MarkLabel(cont181)
...
checkAssignIL.Emit(OpCodes.Ldloc, 7)
Typ = GetType(System.Int32)
Dim fa182 As System.Reflection.Emit.Label = checkAssignIL.DefineLabel()
Dim tru182 As System.Reflection.Emit.Label = checkAssignIL.DefineLabel()
Dim cont182 As System.Reflection.Emit.Label = checkAssignIL.DefineLabel()
checkAssignIL.Emit(OpCodes.Beq, tru182)
checkAssignIL.Emit(OpCodes.Br, fa182)
checkAssignIL.MarkLabel(tru182)
...
checkAssignIL.Emit(OpCodes.Br, cont182)
checkAssignIL.MarkLabel(fa182)
...
checkAssignIL.Emit(OpCodes.Br, cont182)
checkAssignIL.MarkLabel(cont182)
...
Dim locbldr271 As LocalBuilder = checkAssignIL.DeclareLocal(asm.GetType("dylan.NET.Tokenizer.Parser.ExprOptimizer"))
locbldr271.SetLocalSymInfo("eop")
...
checkAssignIL.Emit(OpCodes.Br, cont180)
checkAssignIL.MarkLabel(fa180)
...
checkAssignIL.Emit(OpCodes.Br, cont180)
checkAssignIL.MarkLabel(cont180)
...
Dim locbldr272 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(System.Int32))
locbldr272.SetLocalSymInfo("i")
OptimizeIL.Emit(OpCodes.Ldc_I4, CInt(-1))
Typ = GetType(System.Int32)
OptimizeIL.Emit(OpCodes.Stloc, 0)
OptimizeIL.MarkSequencePoint(doc5, 749, 1, 749, 100)
Dim locbldr273 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(System.Int32))
locbldr273.SetLocalSymInfo("len")
OptimizeIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
...
Dim locbldr274 As LocalBuilder = OptimizeIL.DeclareLocal(asm.GetType("dylan.NET.Tokenizer.Parser.TokenOptimizer"))
locbldr274.SetLocalSymInfo("to")
OptimizeIL.Emit(OpCodes.Ldnull)
OptimizeIL.Emit(OpCodes.Stloc, 2)
OptimizeIL.MarkSequencePoint(doc5, 751, 1, 751, 100)
Dim locbldr275 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(Stmt))
locbldr275.SetLocalSymInfo("tmpstm")
OptimizeIL.Emit(OpCodes.Ldnull)
OptimizeIL.Emit(OpCodes.Stloc, 3)
OptimizeIL.MarkSequencePoint(doc5, 752, 1, 752, 100)
Dim locbldr276 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(System.Boolean))
locbldr276.SetLocalSymInfo("compb")
OptimizeIL.Emit(OpCodes.Ldc_I4, 0)
Typ = GetType(System.Boolean)
OptimizeIL.Emit(OpCodes.Stloc, 4)
...
OptimizeIL.Emit(OpCodes.Blt, tru183)
...
Dim locbldr277 As LocalBuilder = ParseIL.DeclareLocal(GetType(System.Int32))
...
Dim locbldr278 As LocalBuilder = ParseIL.DeclareLocal(asm.GetType("dylan.NET.Tokenizer.Parser.StmtOptimizer"))
locbldr278.SetLocalSymInfo("so")
ParseIL.Emit(OpCodes.Ldnull)
ParseIL.Emit(OpCodes.Stloc, 1)
ParseIL.MarkSequencePoint(doc6, 6, 1, 6, 100)
Dim locbldr279 As LocalBuilder = ParseIL.DeclareLocal(GetType(System.Int32))
locbldr279.SetLocalSymInfo("len")
...
ParseIL.Emit(OpCodes.Ldloc, 2)
Typ = GetType(System.Int32)
Dim fa203 As System.Reflection.Emit.Label = ParseIL.DefineLabel()
Dim tru203 As System.Reflection.Emit.Label = ParseIL.DefineLabel()
Dim cont203 As System.Reflection.Emit.Label = ParseIL.DefineLabel()
ParseIL.Emit(OpCodes.Beq, tru203)
ParseIL.Emit(OpCodes.Br, fa203)
ParseIL.MarkLabel(tru203)
ParseIL.MarkSequencePoint(doc6, 19, 1, 19, 100)
ParseIL.Emit(OpCodes.Br, label1)
ParseIL.MarkSequencePoint(doc6, 20, 1, 20, 100)
ParseIL.Emit(OpCodes.Br, cont203)
ParseIL.MarkLabel(fa203)
ParseIL.MarkSequencePoint(doc6, 21, 1, 21, 100)
ParseIL.Emit(OpCodes.Br, label0)
ParseIL.MarkSequencePoint(doc6, 22, 1, 22, 100)
ParseIL.Emit(OpCodes.Br, cont203)
ParseIL.MarkLabel(cont203)
