...
Dim locbldr46 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(RefasmTok))
locbldr46.SetLocalSymInfo("ratk")
...
Dim locbldr47 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(DebugTok))
locbldr47.SetLocalSymInfo("dgtk")
...
Dim locbldr48 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(ImportTok))
locbldr48.SetLocalSymInfo("imptk")
...
Dim locbldr49 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(LocimportTok))
locbldr49.SetLocalSymInfo("limptk")
...
Dim locbldr50 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(AssemblyTok))
locbldr50.SetLocalSymInfo("asmtk")
...
Dim locbldr51 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(VerTok))
locbldr51.SetLocalSymInfo("vertk")
...
Dim locbldr52 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(OnTok))
locbldr52.SetLocalSymInfo("ontk")
...
Dim locbldr53 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(OffTok))
locbldr53.SetLocalSymInfo("offtk")
...
Dim locbldr54 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(ExeTok))
locbldr54.SetLocalSymInfo("extk")
...
Dim locbldr55 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(DllTok))
locbldr55.SetLocalSymInfo("dltk")
...
Dim locbldr56 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(FieldTok))
locbldr56.SetLocalSymInfo("fltk")
...
Dim locbldr57 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(ClassTok))
locbldr57.SetLocalSymInfo("cltk")
...
Dim locbldr58 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(ExtendsTok))
locbldr58.SetLocalSymInfo("exttk")
...
Dim locbldr59 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(MethodTok))
locbldr59.SetLocalSymInfo("mettk")
...
Dim locbldr60 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(EndTok))
locbldr60.SetLocalSymInfo("entk")
...
Dim locbldr61 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(VarTok))
locbldr61.SetLocalSymInfo("vrtk")
...
Dim locbldr62 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(AsTok))
locbldr62.SetLocalSymInfo("astk")
...
Dim locbldr63 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(OfTok))
locbldr63.SetLocalSymInfo("oftk")
...
Dim locbldr64 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(PrivateAttr))
locbldr64.SetLocalSymInfo("privattr")
...
Dim locbldr65 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(PublicAttr))
locbldr65.SetLocalSymInfo("pubattr")
...
Dim locbldr66 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(InitOnlyAttr))
locbldr66.SetLocalSymInfo("initoattr")
...
Dim locbldr67 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(StaticAttr))
locbldr67.SetLocalSymInfo("statattr")
...
Dim locbldr68 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(AutoLayoutAttr))
locbldr68.SetLocalSymInfo("autattr")
...
Dim locbldr69 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(AutoClassAttr))
locbldr69.SetLocalSymInfo("autcattr")
...
Dim locbldr70 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(AnsiClassAttr))
locbldr70.SetLocalSymInfo("ansattr")
...
Dim locbldr71 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(BeforeFieldInitAttr))
locbldr71.SetLocalSymInfo("bfiattr")
...
Dim locbldr72 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(StringTok))
locbldr72.SetLocalSymInfo("strtok")
...
Dim locbldr73 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(VoidTok))
locbldr73.SetLocalSymInfo("voidtok")
...
Dim locbldr74 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(DecimalTok))
locbldr74.SetLocalSymInfo("decitok")
...
Dim locbldr75 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(IntegerTok))
locbldr75.SetLocalSymInfo("inttok")
...
Dim locbldr76 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(IntPtrTok))
locbldr76.SetLocalSymInfo("intptok")
...
Dim locbldr77 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(UIntegerTok))
locbldr77.SetLocalSymInfo("uinttok")
...
Dim locbldr78 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(DoubleTok))
locbldr78.SetLocalSymInfo("dbltok")
...
Dim locbldr79 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(BooleanTok))
locbldr79.SetLocalSymInfo("booltok")
...
Dim locbldr80 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(CharTok))
locbldr80.SetLocalSymInfo("chrtok")
...
Dim locbldr81 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(SingleTok))
locbldr81.SetLocalSymInfo("sngtok")
...
Dim locbldr82 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(SByteTok))
locbldr82.SetLocalSymInfo("sbytok")
...
Dim locbldr83 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(ByteTok))
locbldr83.SetLocalSymInfo("byttok")
...
Dim locbldr84 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(ShortTok))
locbldr84.SetLocalSymInfo("shtok")
...
Dim locbldr85 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(UShortTok))
locbldr85.SetLocalSymInfo("ushtok")
...
Dim locbldr86 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(LongTok))
locbldr86.SetLocalSymInfo("lngtok")
...
Dim locbldr87 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(ULongTok))
locbldr87.SetLocalSymInfo("ulngtok")
...
Dim locbldr88 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(ObjectTok))
locbldr88.SetLocalSymInfo("objtok")
...
Dim locbldr89 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(commentTok))
locbldr89.SetLocalSymInfo("comtok")
...
Dim locbldr90 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(NullLiteral))
locbldr90.SetLocalSymInfo("nulllit")
...
Dim locbldr91 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(BooleanLiteral))
locbldr91.SetLocalSymInfo("boolit")
...
Dim locbldr92 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(CharLiteral))
locbldr92.SetLocalSymInfo("chrlit")
...
OptimizeIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("Trim", typ109))
Typ = Typ03.GetMethod("Trim", typ109).ReturnType
OptimizeIL.Emit(OpCodes.Stloc, 2)
...
ReDim Preserve typ111(UBound(typ111) + 1)
typ111(UBound(typ111)) = Typ
OptimizeIL.Emit(OpCodes.Call, GetType(String).GetMethod("Concat", typ111))
Typ = GetType(String).GetMethod("Concat", typ111).ReturnType
OptimizeIL.Emit(OpCodes.Stloc, 2)
...
Dim locbldr93 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(StringLiteral))
locbldr93.SetLocalSymInfo("strlit")
...
locbldr94.SetLocalSymInfo("dlit2")
...
OptimizeIL.Emit(OpCodes.Call, GetType(System.Convert).GetMethod("ToDouble", typ121))
Typ = GetType(System.Convert).GetMethod("ToDouble", typ121).ReturnType
...
locbldr95.SetLocalSymInfo("flit")
...
OptimizeIL.Emit(OpCodes.Call, GetType(System.Convert).GetMethod("ToSingle", typ128))
...
locbldr96.SetLocalSymInfo("dlit")
OptimizeIL.Emit(OpCodes.Newobj, GetType(DoubleLiteral).GetConstructor(Type.EmptyTypes))
...
OptimizeIL.Emit(OpCodes.Call, GetType(System.Convert).GetMethod("ToDouble", typ132))
Typ = GetType(System.Convert).GetMethod("ToDouble", typ132).ReturnType
OptimizeIL.Emit(OpCodes.Stfld, GetType(DoubleLiteral).GetField("NumVal"))
...
OptimizeIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("EndsWith", typ136))
Typ = Typ03.GetMethod("EndsWith", typ136).ReturnType
OptimizeIL.Emit(OpCodes.Stloc, 1)
...
Dim locbldr97 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(DoubleLiteral))
locbldr97.SetLocalSymInfo("dlit3")
OptimizeIL.Emit(OpCodes.Newobj, GetType(DoubleLiteral).GetConstructor(Type.EmptyTypes))
...
OptimizeIL.Emit(OpCodes.Call, GetType(System.Convert).GetMethod("ToChar", typ137))
...
OptimizeIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("TrimEnd", typ138))
Typ = Typ03.GetMethod("TrimEnd", typ138).ReturnType
OptimizeIL.Emit(OpCodes.Stloc, 2)
...
Dim locbldr98 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(FloatLiteral))
locbldr98.SetLocalSymInfo("flit2")
OptimizeIL.Emit(OpCodes.Newobj, GetType(FloatLiteral).GetConstructor(Type.EmptyTypes))
...
OptimizeIL.Emit(OpCodes.Call, GetType(System.Convert).GetMethod("ToSingle", typ146))
Typ = GetType(System.Convert).GetMethod("ToSingle", typ146).ReturnType
OptimizeIL.Emit(OpCodes.Stfld, GetType(FloatLiteral).GetField("NumVal"))
...
Dim locbldr99 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(UIntLiteral))
locbldr99.SetLocalSymInfo("uilit2")
...
OptimizeIL.Emit(OpCodes.Call, GetType(System.Convert).GetMethod("ToChar", typ153))
...
OptimizeIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("TrimEnd", typ154))
Typ = Typ03.GetMethod("TrimEnd", typ154).ReturnType
OptimizeIL.Emit(OpCodes.Stloc, 2)
...
OptimizeIL.Emit(OpCodes.Call, GetType(Convert).GetMethod("ToUInt32", typ155))
Typ = GetType(Convert).GetMethod("ToUInt32", typ155).ReturnType
...
ReDim Preserve typ157(UBound(typ157) + 1)
typ157(UBound(typ157)) = Typ
OptimizeIL.Emit(OpCodes.Call, GetType(Utils.ParseUtils).GetMethod("LikeOP", typ157))
Typ = GetType(Utils.ParseUtils).GetMethod("LikeOP", typ157).ReturnType
OptimizeIL.Emit(OpCodes.Stloc, 1)
...
ReDim Preserve typ158(UBound(typ158) + 1)
typ158(UBound(typ158)) = Typ
OptimizeIL.Emit(OpCodes.Call, GetType(Utils.ParseUtils).GetMethod("LikeOP", typ158))
Typ = GetType(Utils.ParseUtils).GetMethod("LikeOP", typ158).ReturnType
OptimizeIL.Emit(OpCodes.Stloc, 1)
...
OptimizeIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("EndsWith", typ159))
Typ = Typ03.GetMethod("EndsWith", typ159).ReturnType
OptimizeIL.Emit(OpCodes.Stloc, 1)
...
Dim locbldr100 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(IntPtrLiteral))
locbldr100.SetLocalSymInfo("iplit2")
...
OptimizeIL.Emit(OpCodes.Call, GetType(System.Convert).GetMethod("ToChar", typ162))
Typ = GetType(System.Convert).GetMethod("ToChar", typ162).ReturnType
OptimizeIL.Emit(OpCodes.Stelem, GetType(System.Char).MakeArrayType().GetElementType())
...
OptimizeIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("TrimEnd", typ163))
Typ = Typ03.GetMethod("TrimEnd", typ163).ReturnType
OptimizeIL.Emit(OpCodes.Stloc, 2)
...
OptimizeIL.Emit(OpCodes.Call, GetType(System.Convert).GetMethod("ToInt32", typ165))
Typ = GetType(System.Convert).GetMethod("ToInt32", typ165).ReturnType
ReDim Preserve typ164(UBound(typ164) + 1)
typ164(UBound(typ164)) = Typ
OptimizeIL.Emit(OpCodes.Newobj, GetType(IntPtr).GetConstructor(typ164))
...
OptimizeIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("EndsWith", typ169))
Typ = Typ03.GetMethod("EndsWith", typ169).ReturnType
OptimizeIL.Emit(OpCodes.Stloc, 1)
...
Dim locbldr101 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(IntLiteral))
locbldr101.SetLocalSymInfo("ilit2")
...
OptimizeIL.Emit(OpCodes.Call, GetType(System.Convert).GetMethod("ToChar", typ170))
Typ = GetType(System.Convert).GetMethod("ToChar", typ170).ReturnType
OptimizeIL.Emit(OpCodes.Stelem, GetType(System.Char).MakeArrayType().GetElementType())
...
OptimizeIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("TrimEnd", typ171))
Typ = Typ03.GetMethod("TrimEnd", typ171).ReturnType
OptimizeIL.Emit(OpCodes.Stloc, 2)
...
Dim locbldr102 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(ULongLiteral))
locbldr102.SetLocalSymInfo("ullit")
...
OptimizeIL.Emit(OpCodes.Call, GetType(System.Convert).GetMethod("ToChar", typ179))
Typ = GetType(System.Convert).GetMethod("ToChar", typ179).ReturnType
OptimizeIL.Emit(OpCodes.Stelem, GetType(System.Char).MakeArrayType().GetElementType())
...
OptimizeIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("TrimEnd", typ180))
Typ = Typ03.GetMethod("TrimEnd", typ180).ReturnType
OptimizeIL.Emit(OpCodes.Stloc, 2)
...
OptimizeIL.Emit(OpCodes.Call, GetType(Convert).GetMethod("ToUInt64", typ181))
Typ = GetType(Convert).GetMethod("ToUInt64", typ181).ReturnType
...
OptimizeIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("EndsWith", typ185))
Typ = Typ03.GetMethod("EndsWith", typ185).ReturnType
OptimizeIL.Emit(OpCodes.Stloc, 1)
...
Dim locbldr103 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(LongLiteral))
locbldr103.SetLocalSymInfo("llit")
...
OptimizeIL.Emit(OpCodes.Call, GetType(System.Convert).GetMethod("ToInt64", typ188))
Typ = GetType(System.Convert).GetMethod("ToInt64", typ188).ReturnType
...
Dim locbldr104 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(UShortLiteral))
locbldr104.SetLocalSymInfo("uslit")
...
OptimizeIL.Emit(OpCodes.Call, GetType(System.Convert).GetMethod("ToChar", typ195))
Typ = GetType(System.Convert).GetMethod("ToChar", typ195).ReturnType
OptimizeIL.Emit(OpCodes.Stelem, GetType(System.Char).MakeArrayType().GetElementType())
...
OptimizeIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("TrimEnd", typ196))
Typ = Typ03.GetMethod("TrimEnd", typ196).ReturnType
OptimizeIL.Emit(OpCodes.Stloc, 2)
...
OptimizeIL.Emit(OpCodes.Call, GetType(Convert).GetMethod("ToUInt16", typ197))
Typ = GetType(Convert).GetMethod("ToUInt16", typ197).ReturnType
...
OptimizeIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("EndsWith", typ201))
Typ = Typ03.GetMethod("EndsWith", typ201).ReturnType
OptimizeIL.Emit(OpCodes.Stloc, 1)
...
Dim locbldr105 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(ShortLiteral))
locbldr105.SetLocalSymInfo("slit")
...
Dim typ204 As Type() = {Typ}
OptimizeIL.Emit(OpCodes.Call, GetType(System.Convert).GetMethod("ToInt16", typ204))
Typ = GetType(System.Convert).GetMethod("ToInt16", typ204).ReturnType
...
Dim locbldr106 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(ByteLiteral))
locbldr106.SetLocalSymInfo("ublit")
...
OptimizeIL.Emit(OpCodes.Call, GetType(System.Convert).GetMethod("ToChar", typ211))
Typ = GetType(System.Convert).GetMethod("ToChar", typ211).ReturnType
OptimizeIL.Emit(OpCodes.Stelem, GetType(System.Char).MakeArrayType().GetElementType())
...
OptimizeIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("TrimEnd", typ212))
Typ = Typ03.GetMethod("TrimEnd", typ212).ReturnType
OptimizeIL.Emit(OpCodes.Stloc, 2)
...
OptimizeIL.Emit(OpCodes.Call, GetType(Convert).GetMethod("ToByte", typ213))
Typ = GetType(Convert).GetMethod("ToByte", typ213).ReturnType
...
OptimizeIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("EndsWith", typ217))
Typ = Typ03.GetMethod("EndsWith", typ217).ReturnType
OptimizeIL.Emit(OpCodes.Stloc, 1)
...
Dim locbldr107 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(SByteLiteral))
locbldr107.SetLocalSymInfo("blit")
...
OptimizeIL.Emit(OpCodes.Call, GetType(System.Convert).GetMethod("ToSByte", typ220))
Typ = GetType(System.Convert).GetMethod("ToSByte", typ220).ReturnType
...
Dim locbldr108 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(IntLiteral))
locbldr108.SetLocalSymInfo("ilit")
OptimizeIL.Emit(OpCodes.Newobj, GetType(IntLiteral).GetConstructor(Type.EmptyTypes))
...
OptimizeIL.Emit(OpCodes.Call, GetType(System.Convert).GetMethod("ToInt32", typ224))
Typ = GetType(System.Convert).GetMethod("ToInt32", typ224).ReturnType
OptimizeIL.Emit(OpCodes.Stfld, GetType(IntLiteral).GetField("NumVal"))
...
Dim locbldr109 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(Ident))
locbldr109.SetLocalSymInfo("idt")
...
locbldr110.SetLocalSymInfo("tok")
...
Dim locbldr112 As LocalBuilder = checkVarAsIL.DeclareLocal(GetType(VarExpr))
locbldr112.SetLocalSymInfo("vars")
...
Typ = GetType(System.Boolean)
Dim fa109 As System.Reflection.Emit.Label = checkVarAsIL.DefineLabel()
Dim tru109 As System.Reflection.Emit.Label = checkVarAsIL.DefineLabel()
Dim cont109 As System.Reflection.Emit.Label = checkVarAsIL.DefineLabel()
checkVarAsIL.Emit(OpCodes.Beq, tru109)
checkVarAsIL.Emit(OpCodes.Br, fa109)
checkVarAsIL.MarkLabel(tru109)
...
locbldr113.SetLocalSymInfo("tok2")
checkVarAsIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Expr)
checkVarAsIL.Emit(OpCodes.Ldfld, GetType(Expr).GetField("Tokens"))
Typ = GetType(Expr).GetField("Tokens").FieldType
...
Dim locbldr114 As LocalBuilder = checkVarAsIL.DeclareLocal(GetType(System.Type))
locbldr114.SetLocalSymInfo("typ2")
...
Dim locbldr115 As LocalBuilder = checkVarAsIL.DeclareLocal(GetType(System.Boolean))
locbldr115.SetLocalSymInfo("b2")
Dim typ4(-1) As Type
...
checkVarAsIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa110 As System.Reflection.Emit.Label = checkVarAsIL.DefineLabel()
Dim tru110 As System.Reflection.Emit.Label = checkVarAsIL.DefineLabel()
Dim cont110 As System.Reflection.Emit.Label = checkVarAsIL.DefineLabel()
checkVarAsIL.Emit(OpCodes.Beq, fa110)
checkVarAsIL.Emit(OpCodes.Br, tru110)
checkVarAsIL.MarkLabel(tru110)
checkVarAsIL.MarkSequencePoint(doc4, 27, 1, 27, 100)
Dim locbldr116 As LocalBuilder = checkVarAsIL.DeclareLocal(GetType(Token))
locbldr116.SetLocalSymInfo("t")
checkVarAsIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Expr)
checkVarAsIL.Emit(OpCodes.Ldfld, GetType(Expr).GetField("Tokens"))
Typ = GetType(Expr).GetField("Tokens").FieldType
...
Dim locbldr117 As LocalBuilder = checkVarAsIL.DeclareLocal(GetType(TypeTok))
locbldr117.SetLocalSymInfo("tt")
...
checkVarAsIL.Emit(OpCodes.Br, cont110)
checkVarAsIL.MarkLabel(fa110)
...
checkVarAsIL.Emit(OpCodes.Br, cont110)
checkVarAsIL.MarkLabel(cont110)
checkVarAsIL.MarkSequencePoint(doc4, 36, 1, 36, 100)
checkVarAsIL.Emit(OpCodes.Br, cont109)
checkVarAsIL.MarkLabel(fa109)
checkVarAsIL.Emit(OpCodes.Br, cont109)
checkVarAsIL.MarkLabel(cont109)
...
Dim locbldr118 As LocalBuilder = procMethodCallIL.DeclareLocal(GetType(MethodNameTok))
locbldr118.SetLocalSymInfo("mn")
...
Dim locbldr119 As LocalBuilder = procMethodCallIL.DeclareLocal(GetType(MethodCallTok))
locbldr119.SetLocalSymInfo("mct")
...
Dim locbldr120 As LocalBuilder = procMethodCallIL.DeclareLocal(GetType(Ident))
locbldr120.SetLocalSymInfo("idt")
...
Dim locbldr121 As LocalBuilder = procMethodCallIL.DeclareLocal(GetType(Expr))
locbldr121.SetLocalSymInfo("ep2")
...
locbldr122.SetLocalSymInfo("lvl")
...
Dim locbldr125 As LocalBuilder = procMethodCallIL.DeclareLocal(GetType(Token))
locbldr125.SetLocalSymInfo("tok2")
procMethodCallIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Expr)
procMethodCallIL.Emit(OpCodes.Ldfld, GetType(Expr).GetField("Tokens"))
Typ = GetType(Expr).GetField("Tokens").FieldType
...
Dim locbldr126 As LocalBuilder = procMethodCallIL.DeclareLocal(GetType(System.Type))
locbldr126.SetLocalSymInfo("typ2")
procMethodCallIL.MarkSequencePoint(doc4, 77, 1, 77, 100)
Dim locbldr127 As LocalBuilder = procMethodCallIL.DeclareLocal(GetType(System.Boolean))
locbldr127.SetLocalSymInfo("b2")
...
procMethodCallIL.Emit(OpCodes.Bgt, tru113)
...
procMethodCallIL.Emit(OpCodes.Bgt, tru117)
...
Dim locbldr129 As LocalBuilder = procIdentArrayAccessIL.DeclareLocal(GetType(Ident))
locbldr129.SetLocalSymInfo("idt")
...
Dim locbldr130 As LocalBuilder = procIdentArrayAccessIL.DeclareLocal(GetType(Expr))
locbldr130.SetLocalSymInfo("ep2")
...
locbldr131.SetLocalSymInfo("lvl")
...
Dim locbldr134 As LocalBuilder = procIdentArrayAccessIL.DeclareLocal(GetType(Token))
locbldr134.SetLocalSymInfo("tok2")
procIdentArrayAccessIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Expr)
procIdentArrayAccessIL.Emit(OpCodes.Ldfld, GetType(Expr).GetField("Tokens"))
Typ = GetType(Expr).GetField("Tokens").FieldType
...
Dim locbldr135 As LocalBuilder = procIdentArrayAccessIL.DeclareLocal(GetType(System.Type))
locbldr135.SetLocalSymInfo("typ2")
procIdentArrayAccessIL.MarkSequencePoint(doc4, 189, 1, 189, 100)
Dim locbldr136 As LocalBuilder = procIdentArrayAccessIL.DeclareLocal(GetType(System.Boolean))
locbldr136.SetLocalSymInfo("b2")
procIdentArrayAccessIL.MarkSequencePoint(doc4, 190, 1, 190, 100)
Dim locbldr137 As LocalBuilder = procIdentArrayAccessIL.DeclareLocal(GetType(System.Int32))
...
procIdentArrayAccessIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa124 As System.Reflection.Emit.Label = procIdentArrayAccessIL.DefineLabel()
Dim tru124 As System.Reflection.Emit.Label = procIdentArrayAccessIL.DefineLabel()
Dim cont124 As System.Reflection.Emit.Label = procIdentArrayAccessIL.DefineLabel()
procIdentArrayAccessIL.Emit(OpCodes.Beq, tru124)
procIdentArrayAccessIL.Emit(OpCodes.Br, fa124)
procIdentArrayAccessIL.MarkLabel(tru124)
...
procIdentArrayAccessIL.Emit(OpCodes.Br, cont124)
procIdentArrayAccessIL.MarkLabel(fa124)
procIdentArrayAccessIL.Emit(OpCodes.Br, cont124)
procIdentArrayAccessIL.MarkLabel(cont124)
procIdentArrayAccessIL.MarkSequencePoint(doc4, 251, 1, 251, 100)
procIdentArrayAccessIL.Emit(OpCodes.Ldarg, 2)
Typ = GetType(System.Int32)
procIdentArrayAccessIL.Emit(OpCodes.Ldloc, 8)
Typ = GetType(System.Int32)
Dim fa125 As System.Reflection.Emit.Label = procIdentArrayAccessIL.DefineLabel()
Dim tru125 As System.Reflection.Emit.Label = procIdentArrayAccessIL.DefineLabel()
Dim cont125 As System.Reflection.Emit.Label = procIdentArrayAccessIL.DefineLabel()
procIdentArrayAccessIL.Emit(OpCodes.Beq, tru125)
procIdentArrayAccessIL.Emit(OpCodes.Br, fa125)
procIdentArrayAccessIL.MarkLabel(tru125)
procIdentArrayAccessIL.MarkSequencePoint(doc4, 252, 1, 252, 100)
procIdentArrayAccessIL.Emit(OpCodes.Br, label4)
procIdentArrayAccessIL.MarkSequencePoint(doc4, 253, 1, 253, 100)
procIdentArrayAccessIL.Emit(OpCodes.Br, cont125)
procIdentArrayAccessIL.MarkLabel(fa125)
...
procIdentArrayAccessIL.Emit(OpCodes.Br, cont125)
procIdentArrayAccessIL.MarkLabel(cont125)
...
Dim locbldr138 As LocalBuilder = procMtdArrayAccessIL.DeclareLocal(GetType(MethodCallTok))
locbldr138.SetLocalSymInfo("mtd")
...
Dim locbldr139 As LocalBuilder = procMtdArrayAccessIL.DeclareLocal(GetType(MethodNameTok))
locbldr139.SetLocalSymInfo("idt")
procMtdArrayAccessIL.Emit(OpCodes.Ldnull)
procMtdArrayAccessIL.Emit(OpCodes.Stloc, 1)
procMtdArrayAccessIL.MarkSequencePoint(doc4, 271, 1, 271, 100)
Dim locbldr140 As LocalBuilder = procMtdArrayAccessIL.DeclareLocal(GetType(Expr))
locbldr140.SetLocalSymInfo("ep2")
...
locbldr141.SetLocalSymInfo("lvl")
...
Dim locbldr144 As LocalBuilder = procMtdArrayAccessIL.DeclareLocal(GetType(Token))
locbldr144.SetLocalSymInfo("tok2")
procMtdArrayAccessIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Expr)
procMtdArrayAccessIL.Emit(OpCodes.Ldfld, GetType(Expr).GetField("Tokens"))
Typ = GetType(Expr).GetField("Tokens").FieldType
...
Dim locbldr145 As LocalBuilder = procMtdArrayAccessIL.DeclareLocal(GetType(System.Type))
locbldr145.SetLocalSymInfo("typ2")
procMtdArrayAccessIL.MarkSequencePoint(doc4, 284, 1, 284, 100)
Dim locbldr146 As LocalBuilder = procMtdArrayAccessIL.DeclareLocal(GetType(System.Boolean))
locbldr146.SetLocalSymInfo("b2")
procMtdArrayAccessIL.MarkSequencePoint(doc4, 285, 1, 285, 100)
Dim locbldr147 As LocalBuilder = procMtdArrayAccessIL.DeclareLocal(GetType(System.Int32))
...
procMtdArrayAccessIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa130 As System.Reflection.Emit.Label = procMtdArrayAccessIL.DefineLabel()
Dim tru130 As System.Reflection.Emit.Label = procMtdArrayAccessIL.DefineLabel()
Dim cont130 As System.Reflection.Emit.Label = procMtdArrayAccessIL.DefineLabel()
procMtdArrayAccessIL.Emit(OpCodes.Beq, tru130)
procMtdArrayAccessIL.Emit(OpCodes.Br, fa130)
procMtdArrayAccessIL.MarkLabel(tru130)
...
procMtdArrayAccessIL.Emit(OpCodes.Br, cont130)
procMtdArrayAccessIL.MarkLabel(fa130)
procMtdArrayAccessIL.Emit(OpCodes.Br, cont130)
procMtdArrayAccessIL.MarkLabel(cont130)
procMtdArrayAccessIL.MarkSequencePoint(doc4, 346, 1, 346, 100)
procMtdArrayAccessIL.Emit(OpCodes.Ldarg, 2)
Typ = GetType(System.Int32)
procMtdArrayAccessIL.Emit(OpCodes.Ldloc, 9)
Typ = GetType(System.Int32)
Dim fa131 As System.Reflection.Emit.Label = procMtdArrayAccessIL.DefineLabel()
Dim tru131 As System.Reflection.Emit.Label = procMtdArrayAccessIL.DefineLabel()
Dim cont131 As System.Reflection.Emit.Label = procMtdArrayAccessIL.DefineLabel()
procMtdArrayAccessIL.Emit(OpCodes.Beq, tru131)
procMtdArrayAccessIL.Emit(OpCodes.Br, fa131)
procMtdArrayAccessIL.MarkLabel(tru131)
procMtdArrayAccessIL.MarkSequencePoint(doc4, 347, 1, 347, 100)
procMtdArrayAccessIL.Emit(OpCodes.Br, label7)
procMtdArrayAccessIL.MarkSequencePoint(doc4, 348, 1, 348, 100)
procMtdArrayAccessIL.Emit(OpCodes.Br, cont131)
procMtdArrayAccessIL.MarkLabel(fa131)
...
procMtdArrayAccessIL.Emit(OpCodes.Br, cont131)
procMtdArrayAccessIL.MarkLabel(cont131)
...
Dim locbldr149 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(System.Int32))
locbldr149.SetLocalSymInfo("i")
OptimizeIL.Emit(OpCodes.Ldc_I4, CInt(-1))
Typ = GetType(System.Int32)
OptimizeIL.Emit(OpCodes.Stloc, 1)
OptimizeIL.MarkSequencePoint(doc4, 367, 1, 367, 100)
Dim locbldr150 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(System.Int32))
locbldr150.SetLocalSymInfo("j")
OptimizeIL.Emit(OpCodes.Ldc_I4, CInt(-1))
Typ = GetType(System.Int32)
OptimizeIL.Emit(OpCodes.Stloc, 2)
...
locbldr151.SetLocalSymInfo("identtrnoff")
OptimizeIL.Emit(OpCodes.Ldc_I4, 0)
Typ = GetType(System.Boolean)
OptimizeIL.Emit(OpCodes.Stloc, 3)
...
locbldr152.SetLocalSymInfo("mcbool")
OptimizeIL.Emit(OpCodes.Ldc_I4, 0)
Typ = GetType(System.Boolean)
OptimizeIL.Emit(OpCodes.Stloc, 4)
...
locbldr153.SetLocalSymInfo("mcflgc")
OptimizeIL.Emit(OpCodes.Ldc_I4, 0)
Typ = GetType(System.Boolean)
OptimizeIL.Emit(OpCodes.Stloc, 5)
OptimizeIL.MarkSequencePoint(doc4, 371, 1, 371, 100)
Dim locbldr154 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(System.Boolean))
locbldr154.SetLocalSymInfo("iflgc")
OptimizeIL.Emit(OpCodes.Ldc_I4, 0)
Typ = GetType(System.Boolean)
OptimizeIL.Emit(OpCodes.Stloc, 6)
OptimizeIL.MarkSequencePoint(doc4, 372, 1, 372, 100)
Dim locbldr155 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(System.Boolean))
locbldr155.SetLocalSymInfo("sflgc")
OptimizeIL.Emit(OpCodes.Ldc_I4, 0)
Typ = GetType(System.Boolean)
OptimizeIL.Emit(OpCodes.Stloc, 7)
OptimizeIL.MarkSequencePoint(doc4, 373, 1, 373, 100)
Dim locbldr156 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(Token))
locbldr156.SetLocalSymInfo("mctok")
...
locbldr157.SetLocalSymInfo("mctok2")
OptimizeIL.Emit(OpCodes.Ldnull)
OptimizeIL.Emit(OpCodes.Stloc, 9)
OptimizeIL.MarkSequencePoint(doc4, 375, 1, 375, 100)
Dim locbldr158 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(Ident))
locbldr158.SetLocalSymInfo("mcident")
OptimizeIL.Emit(OpCodes.Ldnull)
OptimizeIL.Emit(OpCodes.Stloc, 10)
OptimizeIL.MarkSequencePoint(doc4, 376, 1, 376, 100)
Dim locbldr159 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(MethodCallTok))
locbldr159.SetLocalSymInfo("mcmetcall")
OptimizeIL.Emit(OpCodes.Ldnull)
OptimizeIL.Emit(OpCodes.Stloc, 11)
OptimizeIL.MarkSequencePoint(doc4, 377, 1, 377, 100)
Dim locbldr160 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(MethodNameTok))
locbldr160.SetLocalSymInfo("mcmetname")
OptimizeIL.Emit(OpCodes.Ldnull)
OptimizeIL.Emit(OpCodes.Stloc, 12)
OptimizeIL.MarkSequencePoint(doc4, 378, 1, 378, 100)
Dim locbldr161 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(StringLiteral))
locbldr161.SetLocalSymInfo("mcstr")
OptimizeIL.Emit(OpCodes.Ldnull)
OptimizeIL.Emit(OpCodes.Stloc, 13)
...
locbldr162.SetLocalSymInfo("mcint")
OptimizeIL.Emit(OpCodes.Ldc_I4, CInt(0))
Typ = GetType(System.Int32)
OptimizeIL.Emit(OpCodes.Stloc, 14)
...
OptimizeIL.Emit(OpCodes.Blt, tru132)
...
locbldr163.SetLocalSymInfo("tok")
OptimizeIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Expr)
OptimizeIL.Emit(OpCodes.Ldfld, GetType(Expr).GetField("Tokens"))
Typ = GetType(Expr).GetField("Tokens").FieldType
...
Dim locbldr164 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(System.Type))
...
Dim locbldr166 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(System.String))
locbldr166.SetLocalSymInfo("str")
...
locbldr168.SetLocalSymInfo("ttk")
...
locbldr169.SetLocalSymInfo("tk2")
OptimizeIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Expr)
OptimizeIL.Emit(OpCodes.Ldfld, GetType(Expr).GetField("Tokens"))
Typ = GetType(Expr).GetField("Tokens").FieldType
...
locbldr170.SetLocalSymInfo("ttk2")
OptimizeIL.Emit(OpCodes.Newobj, GetType(TypeTok).GetConstructor(Type.EmptyTypes))
OptimizeIL.Emit(OpCodes.Stloc, 22)
...
OptimizeIL.Emit(OpCodes.Beq, fa142)
OptimizeIL.Emit(OpCodes.Br, tru142)
OptimizeIL.MarkLabel(tru142)
OptimizeIL.MarkSequencePoint(doc4, 479, 1, 479, 100)
Dim locbldr171 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(TypeTok))
locbldr171.SetLocalSymInfo("tt1")
OptimizeIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Expr)
OptimizeIL.Emit(OpCodes.Ldfld, GetType(Expr).GetField("Tokens"))
Typ = GetType(Expr).GetField("Tokens").FieldType
...
Dim locbldr172 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(Ident))
locbldr172.SetLocalSymInfo("id1")
OptimizeIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Expr)
OptimizeIL.Emit(OpCodes.Ldfld, GetType(Expr).GetField("Tokens"))
Typ = GetType(Expr).GetField("Tokens").FieldType
...
Dim locbldr173 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(CharLiteral))
locbldr173.SetLocalSymInfo("cl1")
OptimizeIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Expr)
OptimizeIL.Emit(OpCodes.Ldfld, GetType(Expr).GetField("Tokens"))
Typ = GetType(Expr).GetField("Tokens").FieldType
...
Dim locbldr174 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(NullLiteral))
locbldr174.SetLocalSymInfo("nul1")
OptimizeIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Expr)
OptimizeIL.Emit(OpCodes.Ldfld, GetType(Expr).GetField("Tokens"))
Typ = GetType(Expr).GetField("Tokens").FieldType
...
Dim locbldr175 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(StringLiteral))
locbldr175.SetLocalSymInfo("sl1")
OptimizeIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Expr)
OptimizeIL.Emit(OpCodes.Ldfld, GetType(Expr).GetField("Tokens"))
Typ = GetType(Expr).GetField("Tokens").FieldType
...
Dim locbldr176 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(BooleanLiteral))
locbldr176.SetLocalSymInfo("bl1")
OptimizeIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Expr)
OptimizeIL.Emit(OpCodes.Ldfld, GetType(Expr).GetField("Tokens"))
Typ = GetType(Expr).GetField("Tokens").FieldType
...
Dim locbldr177 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(NumberLiteral))
locbldr177.SetLocalSymInfo("nl1")
OptimizeIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Expr)
OptimizeIL.Emit(OpCodes.Ldfld, GetType(Expr).GetField("Tokens"))
Typ = GetType(Expr).GetField("Tokens").FieldType
...
locbldr178.SetLocalSymInfo("mct")
OptimizeIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Expr)
OptimizeIL.Emit(OpCodes.Ldfld, GetType(Expr).GetField("Tokens"))
Typ = GetType(Expr).GetField("Tokens").FieldType
...
Dim locbldr179 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(Expr).MakeArrayType())
locbldr179.SetLocalSymInfo("prs")
OptimizeIL.Emit(OpCodes.Ldloc, 30)
Typ = GetType(MethodCallTok)
...
Dim locbldr180 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(System.Int32))
locbldr180.SetLocalSymInfo("ln2")
OptimizeIL.Emit(OpCodes.Ldloc, 31)
...
OptimizeIL.Emit(OpCodes.Blt, tru159)
...
Dim locbldr182 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(Ident))
locbldr182.SetLocalSymInfo("aidt")
OptimizeIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Expr)
OptimizeIL.Emit(OpCodes.Ldfld, GetType(Expr).GetField("Tokens"))
Typ = GetType(Expr).GetField("Tokens").FieldType
...
Dim locbldr183 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(Expr))
locbldr183.SetLocalSymInfo("arriloc")
OptimizeIL.Emit(OpCodes.Ldloc, 34)
Typ = GetType(Ident)
...
Dim locbldr184 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(MethodCallTok))
locbldr184.SetLocalSymInfo("amtd")
OptimizeIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Expr)
OptimizeIL.Emit(OpCodes.Ldfld, GetType(Expr).GetField("Tokens"))
Typ = GetType(Expr).GetField("Tokens").FieldType
...
Dim locbldr185 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(MethodNameTok))
locbldr185.SetLocalSymInfo("amtdn")
OptimizeIL.Emit(OpCodes.Ldloc, 36)
Typ = GetType(MethodCallTok)
...
OptimizeIL.Emit(OpCodes.Bgt, tru164)
...
OptimizeIL.Emit(OpCodes.Bge, tru165)
...
OptimizeIL.Emit(OpCodes.Ble, tru174)
...
Dim locbldr186 As LocalBuilder = checkRefasmIL.DeclareLocal(GetType(Token))
locbldr186.SetLocalSymInfo("tok")
...
Dim locbldr187 As LocalBuilder = checkRefasmIL.DeclareLocal(GetType(System.Type))
...
Dim locbldr188 As LocalBuilder = checkRefasmIL.DeclareLocal(GetType(RefasmStmt))
locbldr188.SetLocalSymInfo("refasms")
...
Typ = GetType(System.Boolean)
Dim fa177 As System.Reflection.Emit.Label = checkRefasmIL.DefineLabel()
Dim tru177 As System.Reflection.Emit.Label = checkRefasmIL.DefineLabel()
Dim cont177 As System.Reflection.Emit.Label = checkRefasmIL.DefineLabel()
checkRefasmIL.Emit(OpCodes.Beq, tru177)
checkRefasmIL.Emit(OpCodes.Br, fa177)
checkRefasmIL.MarkLabel(tru177)
...
checkRefasmIL.Emit(OpCodes.Br, cont177)
checkRefasmIL.MarkLabel(fa177)
checkRefasmIL.Emit(OpCodes.Br, cont177)
checkRefasmIL.MarkLabel(cont177)
...
Dim locbldr189 As LocalBuilder = checkIfIL.DeclareLocal(GetType(Token))
locbldr189.SetLocalSymInfo("tok")
...
Dim locbldr190 As LocalBuilder = checkIfIL.DeclareLocal(GetType(System.Type))
locbldr190.SetLocalSymInfo("typ")
...
Dim locbldr191 As LocalBuilder = checkIfIL.DeclareLocal(GetType(IfStmt))
locbldr191.SetLocalSymInfo("ifs")
...
Dim locbldr192 As LocalBuilder = checkIfIL.DeclareLocal(GetType(Expr))
locbldr192.SetLocalSymInfo("exp")
...
Typ = GetType(System.Boolean)
Dim fa178 As System.Reflection.Emit.Label = checkIfIL.DefineLabel()
Dim tru178 As System.Reflection.Emit.Label = checkIfIL.DefineLabel()
Dim cont178 As System.Reflection.Emit.Label = checkIfIL.DefineLabel()
checkIfIL.Emit(OpCodes.Beq, tru178)
checkIfIL.Emit(OpCodes.Br, fa178)
checkIfIL.MarkLabel(tru178)
...
Dim locbldr193 As LocalBuilder = checkIfIL.DeclareLocal(GetType(System.Int32))
locbldr193.SetLocalSymInfo("i")
checkIfIL.Emit(OpCodes.Ldc_I4, CInt(0))
Typ = GetType(System.Int32)
checkIfIL.Emit(OpCodes.Stloc, 4)
checkIfIL.MarkSequencePoint(doc5, 37, 1, 37, 100)
Dim locbldr194 As LocalBuilder = checkIfIL.DeclareLocal(GetType(System.Int32))
locbldr194.SetLocalSymInfo("len")
checkIfIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
checkIfIL.Emit(OpCodes.Ldfld, GetType(Stmt).GetField("Tokens"))
Typ = GetType(Stmt).GetField("Tokens").FieldType
...
Dim locbldr195 As LocalBuilder = checkIfIL.DeclareLocal(GetType(System.Boolean))
...
checkIfIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa179 As System.Reflection.Emit.Label = checkIfIL.DefineLabel()
Dim tru179 As System.Reflection.Emit.Label = checkIfIL.DefineLabel()
Dim cont179 As System.Reflection.Emit.Label = checkIfIL.DefineLabel()
checkIfIL.Emit(OpCodes.Beq, tru179)
checkIfIL.Emit(OpCodes.Br, fa179)
checkIfIL.MarkLabel(tru179)
checkIfIL.MarkSequencePoint(doc5, 53, 1, 53, 100)
checkIfIL.Emit(OpCodes.Br, label0)
checkIfIL.MarkSequencePoint(doc5, 54, 1, 54, 100)
checkIfIL.Emit(OpCodes.Br, cont179)
checkIfIL.MarkLabel(fa179)
...
checkIfIL.Emit(OpCodes.Br, cont179)
checkIfIL.MarkLabel(cont179)
checkIfIL.MarkSequencePoint(doc5, 58, 1, 58, 100)
checkIfIL.Emit(OpCodes.Ldloc, 4)
Typ = GetType(System.Int32)
checkIfIL.Emit(OpCodes.Ldloc, 5)
Typ = GetType(System.Int32)
Dim fa180 As System.Reflection.Emit.Label = checkIfIL.DefineLabel()
Dim tru180 As System.Reflection.Emit.Label = checkIfIL.DefineLabel()
Dim cont180 As System.Reflection.Emit.Label = checkIfIL.DefineLabel()
checkIfIL.Emit(OpCodes.Beq, tru180)
checkIfIL.Emit(OpCodes.Br, fa180)
checkIfIL.MarkLabel(tru180)
checkIfIL.MarkSequencePoint(doc5, 59, 1, 59, 100)
checkIfIL.Emit(OpCodes.Br, label0)
checkIfIL.MarkSequencePoint(doc5, 60, 1, 60, 100)
checkIfIL.Emit(OpCodes.Br, cont180)
checkIfIL.MarkLabel(fa180)
checkIfIL.MarkSequencePoint(doc5, 61, 1, 61, 100)
checkIfIL.Emit(OpCodes.Br, label1)
checkIfIL.MarkSequencePoint(doc5, 62, 1, 62, 100)
checkIfIL.Emit(OpCodes.Br, cont180)
checkIfIL.MarkLabel(cont180)
checkIfIL.MarkSequencePoint(doc5, 64, 1, 64, 100)
checkIfIL.MarkLabel(label0)
checkIfIL.MarkSequencePoint(doc5, 66, 1, 66, 100)
Dim locbldr196 As LocalBuilder = checkIfIL.DeclareLocal(asm.GetType("dylan.NET.Tokenizer.Parser.ExprOptimizer"))
locbldr196.SetLocalSymInfo("eop")
...
checkIfIL.Emit(OpCodes.Br, cont178)
checkIfIL.MarkLabel(fa178)
checkIfIL.Emit(OpCodes.Br, cont178)
checkIfIL.MarkLabel(cont178)
...
Dim locbldr197 As LocalBuilder = checkElseIfIL.DeclareLocal(GetType(Token))
...
Dim locbldr198 As LocalBuilder = checkElseIfIL.DeclareLocal(GetType(System.Type))
...
Dim locbldr199 As LocalBuilder = checkElseIfIL.DeclareLocal(GetType(ElseIfStmt))
locbldr199.SetLocalSymInfo("ifs")
...
Dim locbldr200 As LocalBuilder = checkElseIfIL.DeclareLocal(GetType(Expr))
...
Typ = GetType(System.Boolean)
Dim fa181 As System.Reflection.Emit.Label = checkElseIfIL.DefineLabel()
Dim tru181 As System.Reflection.Emit.Label = checkElseIfIL.DefineLabel()
Dim cont181 As System.Reflection.Emit.Label = checkElseIfIL.DefineLabel()
checkElseIfIL.Emit(OpCodes.Beq, tru181)
checkElseIfIL.Emit(OpCodes.Br, fa181)
checkElseIfIL.MarkLabel(tru181)
...
Dim locbldr201 As LocalBuilder = checkElseIfIL.DeclareLocal(GetType(System.Int32))
locbldr201.SetLocalSymInfo("i")
checkElseIfIL.Emit(OpCodes.Ldc_I4, CInt(0))
Typ = GetType(System.Int32)
checkElseIfIL.Emit(OpCodes.Stloc, 4)
checkElseIfIL.MarkSequencePoint(doc5, 88, 1, 88, 100)
Dim locbldr202 As LocalBuilder = checkElseIfIL.DeclareLocal(GetType(System.Int32))
...
Dim locbldr203 As LocalBuilder = checkElseIfIL.DeclareLocal(GetType(System.Boolean))
locbldr203.SetLocalSymInfo("b2")
...
checkElseIfIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa182 As System.Reflection.Emit.Label = checkElseIfIL.DefineLabel()
Dim tru182 As System.Reflection.Emit.Label = checkElseIfIL.DefineLabel()
Dim cont182 As System.Reflection.Emit.Label = checkElseIfIL.DefineLabel()
checkElseIfIL.Emit(OpCodes.Beq, tru182)
checkElseIfIL.Emit(OpCodes.Br, fa182)
checkElseIfIL.MarkLabel(tru182)
...
checkElseIfIL.Emit(OpCodes.Br, cont182)
checkElseIfIL.MarkLabel(fa182)
...
checkElseIfIL.Emit(OpCodes.Br, cont182)
checkElseIfIL.MarkLabel(cont182)
checkElseIfIL.MarkSequencePoint(doc5, 109, 1, 109, 100)
checkElseIfIL.Emit(OpCodes.Ldloc, 4)
Typ = GetType(System.Int32)
checkElseIfIL.Emit(OpCodes.Ldloc, 5)
Typ = GetType(System.Int32)
Dim fa183 As System.Reflection.Emit.Label = checkElseIfIL.DefineLabel()
Dim tru183 As System.Reflection.Emit.Label = checkElseIfIL.DefineLabel()
Dim cont183 As System.Reflection.Emit.Label = checkElseIfIL.DefineLabel()
checkElseIfIL.Emit(OpCodes.Beq, tru183)
checkElseIfIL.Emit(OpCodes.Br, fa183)
checkElseIfIL.MarkLabel(tru183)
checkElseIfIL.MarkSequencePoint(doc5, 110, 1, 110, 100)
checkElseIfIL.Emit(OpCodes.Br, label2)
checkElseIfIL.MarkSequencePoint(doc5, 111, 1, 111, 100)
checkElseIfIL.Emit(OpCodes.Br, cont183)
checkElseIfIL.MarkLabel(fa183)
...
checkElseIfIL.Emit(OpCodes.Br, cont183)
checkElseIfIL.MarkLabel(cont183)
...
Dim locbldr204 As LocalBuilder = checkElseIfIL.DeclareLocal(asm.GetType("dylan.NET.Tokenizer.Parser.ExprOptimizer"))
locbldr204.SetLocalSymInfo("eop")
...
checkElseIfIL.Emit(OpCodes.Br, cont181)
checkElseIfIL.MarkLabel(fa181)
checkElseIfIL.Emit(OpCodes.Br, cont181)
checkElseIfIL.MarkLabel(cont181)
...
Dim locbldr205 As LocalBuilder = checkDebugIL.DeclareLocal(GetType(Token))
locbldr205.SetLocalSymInfo("tok")
...
Dim locbldr206 As LocalBuilder = checkDebugIL.DeclareLocal(GetType(System.Type))
locbldr206.SetLocalSymInfo("typ")
...
Dim locbldr207 As LocalBuilder = checkDebugIL.DeclareLocal(GetType(DebugStmt))
locbldr207.SetLocalSymInfo("dbgs")
...
Typ = GetType(System.Boolean)
Dim fa184 As System.Reflection.Emit.Label = checkDebugIL.DefineLabel()
Dim tru184 As System.Reflection.Emit.Label = checkDebugIL.DefineLabel()
Dim cont184 As System.Reflection.Emit.Label = checkDebugIL.DefineLabel()
checkDebugIL.Emit(OpCodes.Beq, tru184)
checkDebugIL.Emit(OpCodes.Br, fa184)
checkDebugIL.MarkLabel(tru184)
...
checkDebugIL.Emit(OpCodes.Br, cont184)
checkDebugIL.MarkLabel(fa184)
checkDebugIL.Emit(OpCodes.Br, cont184)
checkDebugIL.MarkLabel(cont184)
...
Dim locbldr208 As LocalBuilder = checkImportIL.DeclareLocal(GetType(Token))
...
Dim locbldr209 As LocalBuilder = checkImportIL.DeclareLocal(GetType(System.Type))
...
Dim locbldr210 As LocalBuilder = checkImportIL.DeclareLocal(GetType(ImportStmt))
locbldr210.SetLocalSymInfo("imps")
...
Typ = GetType(System.Boolean)
Dim fa185 As System.Reflection.Emit.Label = checkImportIL.DefineLabel()
Dim tru185 As System.Reflection.Emit.Label = checkImportIL.DefineLabel()
Dim cont185 As System.Reflection.Emit.Label = checkImportIL.DefineLabel()
checkImportIL.Emit(OpCodes.Beq, tru185)
checkImportIL.Emit(OpCodes.Br, fa185)
checkImportIL.MarkLabel(tru185)
...
checkImportIL.Emit(OpCodes.Br, cont185)
checkImportIL.MarkLabel(fa185)
checkImportIL.Emit(OpCodes.Br, cont185)
checkImportIL.MarkLabel(cont185)
...
Dim locbldr211 As LocalBuilder = checkLocimportIL.DeclareLocal(GetType(Token))
...
Dim locbldr212 As LocalBuilder = checkLocimportIL.DeclareLocal(GetType(System.Type))
...
Dim locbldr213 As LocalBuilder = checkLocimportIL.DeclareLocal(GetType(LocimportStmt))
locbldr213.SetLocalSymInfo("limps")
...
Typ = GetType(System.Boolean)
Dim fa186 As System.Reflection.Emit.Label = checkLocimportIL.DefineLabel()
Dim tru186 As System.Reflection.Emit.Label = checkLocimportIL.DefineLabel()
Dim cont186 As System.Reflection.Emit.Label = checkLocimportIL.DefineLabel()
checkLocimportIL.Emit(OpCodes.Beq, tru186)
checkLocimportIL.Emit(OpCodes.Br, fa186)
checkLocimportIL.MarkLabel(tru186)
...
checkLocimportIL.Emit(OpCodes.Br, cont186)
checkLocimportIL.MarkLabel(fa186)
checkLocimportIL.Emit(OpCodes.Br, cont186)
checkLocimportIL.MarkLabel(cont186)
...
Dim locbldr214 As LocalBuilder = checkCmtIL.DeclareLocal(GetType(Token))
...
Dim locbldr215 As LocalBuilder = checkCmtIL.DeclareLocal(GetType(System.Type))
...
Dim locbldr216 As LocalBuilder = checkCmtIL.DeclareLocal(GetType(CommentStmt))
locbldr216.SetLocalSymInfo("cmts")
...
Typ = GetType(System.Boolean)
Dim fa187 As System.Reflection.Emit.Label = checkCmtIL.DefineLabel()
Dim tru187 As System.Reflection.Emit.Label = checkCmtIL.DefineLabel()
Dim cont187 As System.Reflection.Emit.Label = checkCmtIL.DefineLabel()
checkCmtIL.Emit(OpCodes.Beq, tru187)
checkCmtIL.Emit(OpCodes.Br, fa187)
checkCmtIL.MarkLabel(tru187)
...
checkCmtIL.Emit(OpCodes.Br, cont187)
checkCmtIL.MarkLabel(fa187)
checkCmtIL.Emit(OpCodes.Br, cont187)
checkCmtIL.MarkLabel(cont187)
...
Typ = GetType(System.Int32)
Dim fa188 As System.Reflection.Emit.Label = checkElseIL.DefineLabel()
Dim tru188 As System.Reflection.Emit.Label = checkElseIL.DefineLabel()
Dim cont188 As System.Reflection.Emit.Label = checkElseIL.DefineLabel()
checkElseIL.Emit(OpCodes.Blt, tru188)
checkElseIL.Emit(OpCodes.Br, fa188)
checkElseIL.MarkLabel(tru188)
checkElseIL.MarkSequencePoint(doc5, 182, 1, 182, 100)
Dim locbldr217 As LocalBuilder = checkElseIL.DeclareLocal(GetType(Token))
locbldr217.SetLocalSymInfo("tok1")
checkElseIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
checkElseIL.Emit(OpCodes.Ldfld, GetType(Stmt).GetField("Tokens"))
Typ = GetType(Stmt).GetField("Tokens").FieldType
...
Dim locbldr218 As LocalBuilder = checkElseIL.DeclareLocal(GetType(System.Type))
locbldr218.SetLocalSymInfo("typ1")
...
Dim locbldr219 As LocalBuilder = checkElseIL.DeclareLocal(GetType(System.Boolean))
locbldr219.SetLocalSymInfo("b1")
Dim typ32(-1) As Type
...
Dim locbldr220 As LocalBuilder = checkElseIL.DeclareLocal(GetType(ElseStmt))
locbldr220.SetLocalSymInfo("els")
...
Typ = GetType(System.Boolean)
Dim fa189 As System.Reflection.Emit.Label = checkElseIL.DefineLabel()
Dim tru189 As System.Reflection.Emit.Label = checkElseIL.DefineLabel()
Dim cont189 As System.Reflection.Emit.Label = checkElseIL.DefineLabel()
checkElseIL.Emit(OpCodes.Beq, tru189)
checkElseIL.Emit(OpCodes.Br, fa189)
checkElseIL.MarkLabel(tru189)
...
checkElseIL.Emit(OpCodes.Br, cont189)
checkElseIL.MarkLabel(fa189)
checkElseIL.Emit(OpCodes.Br, cont189)
checkElseIL.MarkLabel(cont189)
checkElseIL.MarkSequencePoint(doc5, 193, 1, 193, 100)
checkElseIL.Emit(OpCodes.Br, cont188)
checkElseIL.MarkLabel(fa188)
checkElseIL.Emit(OpCodes.Br, cont188)
checkElseIL.MarkLabel(cont188)
...
Typ = GetType(System.Int32)
Dim fa190 As System.Reflection.Emit.Label = checkEndIfIL.DefineLabel()
Dim tru190 As System.Reflection.Emit.Label = checkEndIfIL.DefineLabel()
Dim cont190 As System.Reflection.Emit.Label = checkEndIfIL.DefineLabel()
checkEndIfIL.Emit(OpCodes.Bge, tru190)
checkEndIfIL.Emit(OpCodes.Br, fa190)
checkEndIfIL.MarkLabel(tru190)
checkEndIfIL.MarkSequencePoint(doc5, 200, 1, 200, 100)
Dim locbldr221 As LocalBuilder = checkEndIfIL.DeclareLocal(GetType(Token))
locbldr221.SetLocalSymInfo("tok1")
checkEndIfIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
checkEndIfIL.Emit(OpCodes.Ldfld, GetType(Stmt).GetField("Tokens"))
Typ = GetType(Stmt).GetField("Tokens").FieldType
...
Dim locbldr222 As LocalBuilder = checkEndIfIL.DeclareLocal(GetType(System.Type))
locbldr222.SetLocalSymInfo("typ1")
...
Dim locbldr223 As LocalBuilder = checkEndIfIL.DeclareLocal(GetType(System.Boolean))
locbldr223.SetLocalSymInfo("b1")
Dim typ35(-1) As Type
...
Dim locbldr224 As LocalBuilder = checkEndIfIL.DeclareLocal(GetType(Token))
locbldr224.SetLocalSymInfo("tok2")
checkEndIfIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
checkEndIfIL.Emit(OpCodes.Ldfld, GetType(Stmt).GetField("Tokens"))
Typ = GetType(Stmt).GetField("Tokens").FieldType
...
Dim locbldr225 As LocalBuilder = checkEndIfIL.DeclareLocal(GetType(System.Type))
locbldr225.SetLocalSymInfo("typ2")
...
Dim locbldr226 As LocalBuilder = checkEndIfIL.DeclareLocal(GetType(System.Boolean))
locbldr226.SetLocalSymInfo("b2")
Dim typ37(-1) As Type
...
Dim locbldr227 As LocalBuilder = checkEndIfIL.DeclareLocal(GetType(EndIfStmt))
locbldr227.SetLocalSymInfo("eifs")
...
Typ = GetType(System.Boolean)
Dim fa191 As System.Reflection.Emit.Label = checkEndIfIL.DefineLabel()
Dim tru191 As System.Reflection.Emit.Label = checkEndIfIL.DefineLabel()
Dim cont191 As System.Reflection.Emit.Label = checkEndIfIL.DefineLabel()
checkEndIfIL.Emit(OpCodes.Beq, tru191)
checkEndIfIL.Emit(OpCodes.Br, fa191)
checkEndIfIL.MarkLabel(tru191)
...
checkEndIfIL.Emit(OpCodes.Br, cont191)
checkEndIfIL.MarkLabel(fa191)
checkEndIfIL.Emit(OpCodes.Br, cont191)
checkEndIfIL.MarkLabel(cont191)
checkEndIfIL.MarkSequencePoint(doc5, 215, 1, 215, 100)
checkEndIfIL.Emit(OpCodes.Br, cont190)
checkEndIfIL.MarkLabel(fa190)
checkEndIfIL.Emit(OpCodes.Br, cont190)
checkEndIfIL.MarkLabel(cont190)
...
Typ = GetType(System.Int32)
Dim fa192 As System.Reflection.Emit.Label = checkEndMtdIL.DefineLabel()
Dim tru192 As System.Reflection.Emit.Label = checkEndMtdIL.DefineLabel()
Dim cont192 As System.Reflection.Emit.Label = checkEndMtdIL.DefineLabel()
checkEndMtdIL.Emit(OpCodes.Bge, tru192)
checkEndMtdIL.Emit(OpCodes.Br, fa192)
checkEndMtdIL.MarkLabel(tru192)
checkEndMtdIL.MarkSequencePoint(doc5, 223, 1, 223, 100)
Dim locbldr228 As LocalBuilder = checkEndMtdIL.DeclareLocal(GetType(Token))
locbldr228.SetLocalSymInfo("tok1")
checkEndMtdIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
checkEndMtdIL.Emit(OpCodes.Ldfld, GetType(Stmt).GetField("Tokens"))
Typ = GetType(Stmt).GetField("Tokens").FieldType
...
Dim locbldr229 As LocalBuilder = checkEndMtdIL.DeclareLocal(GetType(System.Type))
locbldr229.SetLocalSymInfo("typ1")
...
Dim locbldr230 As LocalBuilder = checkEndMtdIL.DeclareLocal(GetType(System.Boolean))
locbldr230.SetLocalSymInfo("b1")
Dim typ40(-1) As Type
...
Dim locbldr231 As LocalBuilder = checkEndMtdIL.DeclareLocal(GetType(Token))
locbldr231.SetLocalSymInfo("tok2")
checkEndMtdIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
checkEndMtdIL.Emit(OpCodes.Ldfld, GetType(Stmt).GetField("Tokens"))
Typ = GetType(Stmt).GetField("Tokens").FieldType
...
Dim locbldr232 As LocalBuilder = checkEndMtdIL.DeclareLocal(GetType(System.Type))
locbldr232.SetLocalSymInfo("typ2")
...
Dim locbldr233 As LocalBuilder = checkEndMtdIL.DeclareLocal(GetType(System.Boolean))
locbldr233.SetLocalSymInfo("b2")
Dim typ42(-1) As Type
...
Dim locbldr234 As LocalBuilder = checkEndMtdIL.DeclareLocal(GetType(EndMethodStmt))
locbldr234.SetLocalSymInfo("ems")
...
Typ = GetType(System.Boolean)
Dim fa193 As System.Reflection.Emit.Label = checkEndMtdIL.DefineLabel()
Dim tru193 As System.Reflection.Emit.Label = checkEndMtdIL.DefineLabel()
Dim cont193 As System.Reflection.Emit.Label = checkEndMtdIL.DefineLabel()
checkEndMtdIL.Emit(OpCodes.Beq, tru193)
checkEndMtdIL.Emit(OpCodes.Br, fa193)
checkEndMtdIL.MarkLabel(tru193)
...
checkEndMtdIL.Emit(OpCodes.Br, cont193)
checkEndMtdIL.MarkLabel(fa193)
checkEndMtdIL.Emit(OpCodes.Br, cont193)
checkEndMtdIL.MarkLabel(cont193)
checkEndMtdIL.MarkSequencePoint(doc5, 238, 1, 238, 100)
checkEndMtdIL.Emit(OpCodes.Br, cont192)
checkEndMtdIL.MarkLabel(fa192)
checkEndMtdIL.Emit(OpCodes.Br, cont192)
checkEndMtdIL.MarkLabel(cont192)
...
Typ = GetType(System.Int32)
Dim fa194 As System.Reflection.Emit.Label = checkEndClsIL.DefineLabel()
Dim tru194 As System.Reflection.Emit.Label = checkEndClsIL.DefineLabel()
Dim cont194 As System.Reflection.Emit.Label = checkEndClsIL.DefineLabel()
checkEndClsIL.Emit(OpCodes.Bge, tru194)
checkEndClsIL.Emit(OpCodes.Br, fa194)
checkEndClsIL.MarkLabel(tru194)
checkEndClsIL.MarkSequencePoint(doc5, 245, 1, 245, 100)
Dim locbldr235 As LocalBuilder = checkEndClsIL.DeclareLocal(GetType(Token))
locbldr235.SetLocalSymInfo("tok1")
checkEndClsIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
checkEndClsIL.Emit(OpCodes.Ldfld, GetType(Stmt).GetField("Tokens"))
Typ = GetType(Stmt).GetField("Tokens").FieldType
...
Dim locbldr236 As LocalBuilder = checkEndClsIL.DeclareLocal(GetType(System.Type))
locbldr236.SetLocalSymInfo("typ1")
...
Dim locbldr237 As LocalBuilder = checkEndClsIL.DeclareLocal(GetType(System.Boolean))
locbldr237.SetLocalSymInfo("b1")
Dim typ45(-1) As Type
...
Dim locbldr238 As LocalBuilder = checkEndClsIL.DeclareLocal(GetType(Token))
locbldr238.SetLocalSymInfo("tok2")
checkEndClsIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
checkEndClsIL.Emit(OpCodes.Ldfld, GetType(Stmt).GetField("Tokens"))
Typ = GetType(Stmt).GetField("Tokens").FieldType
...
Dim locbldr239 As LocalBuilder = checkEndClsIL.DeclareLocal(GetType(System.Type))
locbldr239.SetLocalSymInfo("typ2")
...
Dim locbldr240 As LocalBuilder = checkEndClsIL.DeclareLocal(GetType(System.Boolean))
locbldr240.SetLocalSymInfo("b2")
Dim typ47(-1) As Type
...
Dim locbldr241 As LocalBuilder = checkEndClsIL.DeclareLocal(GetType(EndClassStmt))
locbldr241.SetLocalSymInfo("ecs")
...
Typ = GetType(System.Boolean)
Dim fa195 As System.Reflection.Emit.Label = checkEndClsIL.DefineLabel()
Dim tru195 As System.Reflection.Emit.Label = checkEndClsIL.DefineLabel()
Dim cont195 As System.Reflection.Emit.Label = checkEndClsIL.DefineLabel()
checkEndClsIL.Emit(OpCodes.Beq, tru195)
checkEndClsIL.Emit(OpCodes.Br, fa195)
checkEndClsIL.MarkLabel(tru195)
...
checkEndClsIL.Emit(OpCodes.Br, cont195)
checkEndClsIL.MarkLabel(fa195)
checkEndClsIL.Emit(OpCodes.Br, cont195)
checkEndClsIL.MarkLabel(cont195)
checkEndClsIL.MarkSequencePoint(doc5, 260, 1, 260, 100)
checkEndClsIL.Emit(OpCodes.Br, cont194)
checkEndClsIL.MarkLabel(fa194)
checkEndClsIL.Emit(OpCodes.Br, cont194)
checkEndClsIL.MarkLabel(cont194)
...
Dim locbldr242 As LocalBuilder = checkAssemblyIL.DeclareLocal(GetType(Token))
...
Dim locbldr243 As LocalBuilder = checkAssemblyIL.DeclareLocal(GetType(System.Type))
...
Dim locbldr244 As LocalBuilder = checkAssemblyIL.DeclareLocal(GetType(AssemblyStmt))
locbldr244.SetLocalSymInfo("asms")
...
Typ = GetType(System.Boolean)
Dim fa196 As System.Reflection.Emit.Label = checkAssemblyIL.DefineLabel()
Dim tru196 As System.Reflection.Emit.Label = checkAssemblyIL.DefineLabel()
Dim cont196 As System.Reflection.Emit.Label = checkAssemblyIL.DefineLabel()
checkAssemblyIL.Emit(OpCodes.Beq, tru196)
checkAssemblyIL.Emit(OpCodes.Br, fa196)
checkAssemblyIL.MarkLabel(tru196)
...
checkAssemblyIL.Emit(OpCodes.Br, cont196)
checkAssemblyIL.MarkLabel(fa196)
checkAssemblyIL.Emit(OpCodes.Br, cont196)
checkAssemblyIL.MarkLabel(cont196)
...
Dim locbldr245 As LocalBuilder = checkVerIL.DeclareLocal(GetType(Token))
locbldr245.SetLocalSymInfo("tok")
...
Dim locbldr246 As LocalBuilder = checkVerIL.DeclareLocal(GetType(System.Type))
locbldr246.SetLocalSymInfo("typ")
...
Dim locbldr247 As LocalBuilder = checkVerIL.DeclareLocal(GetType(VerStmt))
locbldr247.SetLocalSymInfo("vers")
...
Typ = GetType(System.Boolean)
Dim fa197 As System.Reflection.Emit.Label = checkVerIL.DefineLabel()
Dim tru197 As System.Reflection.Emit.Label = checkVerIL.DefineLabel()
Dim cont197 As System.Reflection.Emit.Label = checkVerIL.DefineLabel()
checkVerIL.Emit(OpCodes.Beq, tru197)
checkVerIL.Emit(OpCodes.Br, fa197)
checkVerIL.MarkLabel(tru197)
...
Dim locbldr248 As LocalBuilder = checkVerIL.DeclareLocal(GetType(System.String).MakeArrayType())
locbldr248.SetLocalSymInfo("ars")
Dim typ54(-1) As Type
checkVerIL.Emit(OpCodes.Ldloc, 0)
Typ = GetType(Token)
...
Dim locbldr249 As LocalBuilder = checkVerIL.DeclareLocal(GetType(System.Int32).MakeArrayType())
locbldr249.SetLocalSymInfo("ari")
...
Dim locbldr250 As LocalBuilder = checkVerIL.DeclareLocal(GetType(IntLiteral).MakeArrayType())
locbldr250.SetLocalSymInfo("intla")
checkVerIL.Emit(OpCodes.Ldc_I4, CInt(4))
Typ = GetType(System.Int32)
checkVerIL.Emit(OpCodes.Conv_U)
...
Dim locbldr251 As LocalBuilder = checkVerIL.DeclareLocal(GetType(IntLiteral))
locbldr251.SetLocalSymInfo("intl")
...
checkVerIL.Emit(OpCodes.Br, cont197)
checkVerIL.MarkLabel(fa197)
checkVerIL.Emit(OpCodes.Br, cont197)
checkVerIL.MarkLabel(cont197)
...
Dim locbldr252 As LocalBuilder = checkClassIL.DeclareLocal(GetType(Token))
...
Dim locbldr253 As LocalBuilder = checkClassIL.DeclareLocal(GetType(System.Type))
...
Dim locbldr254 As LocalBuilder = checkClassIL.DeclareLocal(GetType(ClassStmt))
locbldr254.SetLocalSymInfo("clss")
...
Dim locbldr255 As LocalBuilder = checkClassIL.DeclareLocal(GetType(Attributes.Attribute))
locbldr255.SetLocalSymInfo("att")
...
Typ = GetType(System.Boolean)
Dim fa198 As System.Reflection.Emit.Label = checkClassIL.DefineLabel()
Dim tru198 As System.Reflection.Emit.Label = checkClassIL.DefineLabel()
Dim cont198 As System.Reflection.Emit.Label = checkClassIL.DefineLabel()
checkClassIL.Emit(OpCodes.Beq, tru198)
checkClassIL.Emit(OpCodes.Br, fa198)
checkClassIL.MarkLabel(tru198)
...
Dim locbldr256 As LocalBuilder = checkClassIL.DeclareLocal(GetType(System.Int32))
locbldr256.SetLocalSymInfo("i")
checkClassIL.Emit(OpCodes.Ldc_I4, CInt(0))
Typ = GetType(System.Int32)
checkClassIL.Emit(OpCodes.Stloc, 4)
checkClassIL.MarkSequencePoint(doc5, 331, 1, 331, 100)
Dim locbldr257 As LocalBuilder = checkClassIL.DeclareLocal(GetType(System.Int32))
...
Dim locbldr258 As LocalBuilder = checkClassIL.DeclareLocal(GetType(System.Boolean))
...
checkClassIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa199 As System.Reflection.Emit.Label = checkClassIL.DefineLabel()
Dim tru199 As System.Reflection.Emit.Label = checkClassIL.DefineLabel()
Dim cont199 As System.Reflection.Emit.Label = checkClassIL.DefineLabel()
checkClassIL.Emit(OpCodes.Beq, tru199)
checkClassIL.Emit(OpCodes.Br, fa199)
checkClassIL.MarkLabel(tru199)
...
checkClassIL.Emit(OpCodes.Br, cont199)
checkClassIL.MarkLabel(fa199)
checkClassIL.MarkSequencePoint(doc5, 346, 1, 346, 100)
Dim locbldr259 As LocalBuilder = checkClassIL.DeclareLocal(GetType(Token))
...
Dim locbldr260 As LocalBuilder = checkClassIL.DeclareLocal(GetType(System.Type))
...
Dim locbldr261 As LocalBuilder = checkClassIL.DeclareLocal(GetType(System.Boolean))
...
checkClassIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa200 As System.Reflection.Emit.Label = checkClassIL.DefineLabel()
Dim tru200 As System.Reflection.Emit.Label = checkClassIL.DefineLabel()
Dim cont200 As System.Reflection.Emit.Label = checkClassIL.DefineLabel()
checkClassIL.Emit(OpCodes.Beq, tru200)
checkClassIL.Emit(OpCodes.Br, fa200)
checkClassIL.MarkLabel(tru200)
...
checkClassIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa201 As System.Reflection.Emit.Label = checkClassIL.DefineLabel()
Dim tru201 As System.Reflection.Emit.Label = checkClassIL.DefineLabel()
Dim cont201 As System.Reflection.Emit.Label = checkClassIL.DefineLabel()
checkClassIL.Emit(OpCodes.Beq, fa201)
checkClassIL.Emit(OpCodes.Br, tru201)
checkClassIL.MarkLabel(tru201)
checkClassIL.MarkSequencePoint(doc5, 357, 1, 357, 100)
Dim locbldr262 As LocalBuilder = checkClassIL.DeclareLocal(GetType(Token))
...
Dim locbldr263 As LocalBuilder = checkClassIL.DeclareLocal(GetType(TypeTok))
...
checkClassIL.Emit(OpCodes.Br, cont201)
checkClassIL.MarkLabel(fa201)
...
checkClassIL.Emit(OpCodes.Br, cont201)
checkClassIL.MarkLabel(cont201)
checkClassIL.MarkSequencePoint(doc5, 365, 1, 365, 100)
checkClassIL.Emit(OpCodes.Br, cont200)
checkClassIL.MarkLabel(fa200)
...
checkClassIL.Emit(OpCodes.Br, cont200)
checkClassIL.MarkLabel(cont200)
checkClassIL.MarkSequencePoint(doc5, 369, 1, 369, 100)
checkClassIL.Emit(OpCodes.Br, cont199)
checkClassIL.MarkLabel(cont199)
checkClassIL.MarkSequencePoint(doc5, 371, 1, 371, 100)
checkClassIL.Emit(OpCodes.Ldloc, 4)
Typ = GetType(System.Int32)
checkClassIL.Emit(OpCodes.Ldloc, 5)
Typ = GetType(System.Int32)
Dim fa202 As System.Reflection.Emit.Label = checkClassIL.DefineLabel()
Dim tru202 As System.Reflection.Emit.Label = checkClassIL.DefineLabel()
Dim cont202 As System.Reflection.Emit.Label = checkClassIL.DefineLabel()
checkClassIL.Emit(OpCodes.Beq, tru202)
checkClassIL.Emit(OpCodes.Br, fa202)
checkClassIL.MarkLabel(tru202)
...
checkClassIL.Emit(OpCodes.Br, cont202)
checkClassIL.MarkLabel(fa202)
...
checkClassIL.Emit(OpCodes.Br, cont202)
checkClassIL.MarkLabel(cont202)
...
checkClassIL.Emit(OpCodes.Br, cont198)
checkClassIL.MarkLabel(fa198)
checkClassIL.Emit(OpCodes.Br, cont198)
checkClassIL.MarkLabel(cont198)
...
Dim locbldr264 As LocalBuilder = checkFieldIL.DeclareLocal(GetType(Token))
locbldr264.SetLocalSymInfo("tok")
...
Dim locbldr265 As LocalBuilder = checkFieldIL.DeclareLocal(GetType(System.Type))
locbldr265.SetLocalSymInfo("typ")
...
Dim locbldr266 As LocalBuilder = checkFieldIL.DeclareLocal(GetType(FieldStmt))
locbldr266.SetLocalSymInfo("flss")
...
Dim locbldr267 As LocalBuilder = checkFieldIL.DeclareLocal(GetType(Attributes.Attribute))
locbldr267.SetLocalSymInfo("att")
...
Typ = GetType(System.Boolean)
Dim fa203 As System.Reflection.Emit.Label = checkFieldIL.DefineLabel()
Dim tru203 As System.Reflection.Emit.Label = checkFieldIL.DefineLabel()
Dim cont203 As System.Reflection.Emit.Label = checkFieldIL.DefineLabel()
checkFieldIL.Emit(OpCodes.Beq, tru203)
checkFieldIL.Emit(OpCodes.Br, fa203)
checkFieldIL.MarkLabel(tru203)
checkFieldIL.MarkSequencePoint(doc5, 394, 1, 394, 100)
Dim locbldr268 As LocalBuilder = checkFieldIL.DeclareLocal(GetType(Expr))
locbldr268.SetLocalSymInfo("tempexp")
...
Dim locbldr269 As LocalBuilder = checkFieldIL.DeclareLocal(asm.GetType("dylan.NET.Tokenizer.Parser.ExprOptimizer"))
locbldr269.SetLocalSymInfo("eop")
...
Dim locbldr270 As LocalBuilder = checkFieldIL.DeclareLocal(GetType(System.Int32))
locbldr270.SetLocalSymInfo("i")
checkFieldIL.Emit(OpCodes.Ldc_I4, CInt(0))
Typ = GetType(System.Int32)
checkFieldIL.Emit(OpCodes.Stloc, 6)
checkFieldIL.MarkSequencePoint(doc5, 409, 1, 409, 100)
Dim locbldr271 As LocalBuilder = checkFieldIL.DeclareLocal(GetType(System.Int32))
...
Dim locbldr272 As LocalBuilder = checkFieldIL.DeclareLocal(GetType(System.Boolean))
locbldr272.SetLocalSymInfo("bl")
checkFieldIL.Emit(OpCodes.Ldc_I4, 0)
Typ = GetType(System.Boolean)
...
checkFieldIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa204 As System.Reflection.Emit.Label = checkFieldIL.DefineLabel()
Dim tru204 As System.Reflection.Emit.Label = checkFieldIL.DefineLabel()
Dim cont204 As System.Reflection.Emit.Label = checkFieldIL.DefineLabel()
checkFieldIL.Emit(OpCodes.Beq, tru204)
checkFieldIL.Emit(OpCodes.Br, fa204)
checkFieldIL.MarkLabel(tru204)
...
checkFieldIL.Emit(OpCodes.Br, cont204)
checkFieldIL.MarkLabel(fa204)
checkFieldIL.Emit(OpCodes.Br, cont204)
checkFieldIL.MarkLabel(cont204)
checkFieldIL.MarkSequencePoint(doc5, 424, 1, 424, 100)
checkFieldIL.Emit(OpCodes.Ldloc, 6)
Typ = GetType(System.Int32)
checkFieldIL.Emit(OpCodes.Ldloc, 7)
Typ = GetType(System.Int32)
Dim fa205 As System.Reflection.Emit.Label = checkFieldIL.DefineLabel()
Dim tru205 As System.Reflection.Emit.Label = checkFieldIL.DefineLabel()
Dim cont205 As System.Reflection.Emit.Label = checkFieldIL.DefineLabel()
checkFieldIL.Emit(OpCodes.Beq, tru205)
checkFieldIL.Emit(OpCodes.Br, fa205)
checkFieldIL.MarkLabel(tru205)
...
checkFieldIL.Emit(OpCodes.Br, cont205)
checkFieldIL.MarkLabel(fa205)
...
checkFieldIL.Emit(OpCodes.Br, cont205)
checkFieldIL.MarkLabel(cont205)
...
Dim locbldr273 As LocalBuilder = checkFieldIL.DeclareLocal(GetType(Token))
...
Dim locbldr274 As LocalBuilder = checkFieldIL.DeclareLocal(GetType(System.Type))
...
Dim locbldr275 As LocalBuilder = checkFieldIL.DeclareLocal(GetType(System.Boolean))
...
checkFieldIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa206 As System.Reflection.Emit.Label = checkFieldIL.DefineLabel()
Dim tru206 As System.Reflection.Emit.Label = checkFieldIL.DefineLabel()
Dim cont206 As System.Reflection.Emit.Label = checkFieldIL.DefineLabel()
checkFieldIL.Emit(OpCodes.Beq, fa206)
checkFieldIL.Emit(OpCodes.Br, tru206)
checkFieldIL.MarkLabel(tru206)
checkFieldIL.MarkSequencePoint(doc5, 438, 1, 438, 100)
Dim locbldr276 As LocalBuilder = checkFieldIL.DeclareLocal(GetType(Token))
locbldr276.SetLocalSymInfo("t")
checkFieldIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
checkFieldIL.Emit(OpCodes.Ldfld, GetType(Stmt).GetField("Tokens"))
Typ = GetType(Stmt).GetField("Tokens").FieldType
...
Dim locbldr277 As LocalBuilder = checkFieldIL.DeclareLocal(GetType(TypeTok))
locbldr277.SetLocalSymInfo("tt")
...
checkFieldIL.Emit(OpCodes.Br, cont206)
checkFieldIL.MarkLabel(fa206)
...
checkFieldIL.Emit(OpCodes.Br, cont206)
checkFieldIL.MarkLabel(cont206)
...
checkFieldIL.Emit(OpCodes.Br, cont203)
checkFieldIL.MarkLabel(fa203)
checkFieldIL.Emit(OpCodes.Br, cont203)
checkFieldIL.MarkLabel(cont203)
...
Dim locbldr278 As LocalBuilder = checkMethodIL.DeclareLocal(GetType(Token))
locbldr278.SetLocalSymInfo("tok")
...
Dim locbldr279 As LocalBuilder = checkMethodIL.DeclareLocal(GetType(System.Type))
locbldr279.SetLocalSymInfo("typ")
...
Dim locbldr280 As LocalBuilder = checkMethodIL.DeclareLocal(GetType(MethodStmt))
locbldr280.SetLocalSymInfo("mtss")
...
Dim locbldr281 As LocalBuilder = checkMethodIL.DeclareLocal(GetType(Attributes.Attribute))
locbldr281.SetLocalSymInfo("att")
...
Dim locbldr282 As LocalBuilder = checkMethodIL.DeclareLocal(GetType(Ident))
locbldr282.SetLocalSymInfo("mn")
...
Dim locbldr283 As LocalBuilder = checkMethodIL.DeclareLocal(GetType(Expr))
locbldr283.SetLocalSymInfo("exp")
checkMethodIL.Emit(OpCodes.Ldnull)
checkMethodIL.Emit(OpCodes.Stloc, 5)
checkMethodIL.MarkSequencePoint(doc5, 464, 1, 464, 100)
Dim locbldr284 As LocalBuilder = checkMethodIL.DeclareLocal(GetType(System.Boolean))
locbldr284.SetLocalSymInfo("d")
...
Dim locbldr285 As LocalBuilder = checkMethodIL.DeclareLocal(GetType(Expr))
...
Dim locbldr286 As LocalBuilder = checkMethodIL.DeclareLocal(asm.GetType("dylan.NET.Tokenizer.Parser.ExprOptimizer"))
...
Dim locbldr287 As LocalBuilder = checkMethodIL.DeclareLocal(GetType(System.Int32))
locbldr287.SetLocalSymInfo("i")
checkMethodIL.Emit(OpCodes.Ldc_I4, CInt(0))
Typ = GetType(System.Int32)
checkMethodIL.Emit(OpCodes.Stloc, 9)
checkMethodIL.MarkSequencePoint(doc5, 484, 1, 484, 100)
Dim locbldr288 As LocalBuilder = checkMethodIL.DeclareLocal(GetType(System.Int32))
locbldr288.SetLocalSymInfo("len")
checkMethodIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
checkMethodIL.Emit(OpCodes.Ldfld, GetType(Stmt).GetField("Tokens"))
Typ = GetType(Stmt).GetField("Tokens").FieldType
...
Dim locbldr289 As LocalBuilder = checkMethodIL.DeclareLocal(GetType(System.Boolean))
locbldr289.SetLocalSymInfo("bl")
checkMethodIL.Emit(OpCodes.Ldc_I4, 0)
Typ = GetType(System.Boolean)
...
Typ = GetType(System.Int32)
Dim fa209 As System.Reflection.Emit.Label = checkMethodIL.DefineLabel()
Dim tru209 As System.Reflection.Emit.Label = checkMethodIL.DefineLabel()
Dim cont209 As System.Reflection.Emit.Label = checkMethodIL.DefineLabel()
checkMethodIL.Emit(OpCodes.Beq, tru209)
checkMethodIL.Emit(OpCodes.Br, fa209)
checkMethodIL.MarkLabel(tru209)
...
checkMethodIL.Emit(OpCodes.Br, cont209)
checkMethodIL.MarkLabel(fa209)
...
checkMethodIL.Emit(OpCodes.Br, cont209)
checkMethodIL.MarkLabel(cont209)
...
Dim locbldr290 As LocalBuilder = checkMethodIL.DeclareLocal(GetType(Token))
...
Dim locbldr291 As LocalBuilder = checkMethodIL.DeclareLocal(GetType(System.Type))
locbldr291.SetLocalSymInfo("typ2")
checkMethodIL.MarkSequencePoint(doc5, 518, 1, 518, 100)
Dim locbldr292 As LocalBuilder = checkMethodIL.DeclareLocal(GetType(System.Boolean))
...
checkMethodIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa210 As System.Reflection.Emit.Label = checkMethodIL.DefineLabel()
Dim tru210 As System.Reflection.Emit.Label = checkMethodIL.DefineLabel()
Dim cont210 As System.Reflection.Emit.Label = checkMethodIL.DefineLabel()
checkMethodIL.Emit(OpCodes.Beq, fa210)
checkMethodIL.Emit(OpCodes.Br, tru210)
checkMethodIL.MarkLabel(tru210)
checkMethodIL.MarkSequencePoint(doc5, 524, 1, 524, 100)
Dim locbldr293 As LocalBuilder = checkMethodIL.DeclareLocal(GetType(Token))
...
Dim locbldr294 As LocalBuilder = checkMethodIL.DeclareLocal(GetType(TypeTok))
...
checkMethodIL.Emit(OpCodes.Br, cont210)
checkMethodIL.MarkLabel(fa210)
...
checkMethodIL.Emit(OpCodes.Br, cont210)
checkMethodIL.MarkLabel(cont210)
...
checkMethodIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa211 As System.Reflection.Emit.Label = checkMethodIL.DefineLabel()
Dim tru211 As System.Reflection.Emit.Label = checkMethodIL.DefineLabel()
Dim cont211 As System.Reflection.Emit.Label = checkMethodIL.DefineLabel()
checkMethodIL.Emit(OpCodes.Beq, tru211)
checkMethodIL.Emit(OpCodes.Br, fa211)
checkMethodIL.MarkLabel(tru211)
...
checkMethodIL.Emit(OpCodes.Br, cont211)
checkMethodIL.MarkLabel(fa211)
checkMethodIL.Emit(OpCodes.Br, cont211)
checkMethodIL.MarkLabel(cont211)
...
checkMethodIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa212 As System.Reflection.Emit.Label = checkMethodIL.DefineLabel()
Dim tru212 As System.Reflection.Emit.Label = checkMethodIL.DefineLabel()
Dim cont212 As System.Reflection.Emit.Label = checkMethodIL.DefineLabel()
checkMethodIL.Emit(OpCodes.Beq, tru212)
checkMethodIL.Emit(OpCodes.Br, fa212)
checkMethodIL.MarkLabel(tru212)
...
checkMethodIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa213 As System.Reflection.Emit.Label = checkMethodIL.DefineLabel()
Dim tru213 As System.Reflection.Emit.Label = checkMethodIL.DefineLabel()
Dim cont213 As System.Reflection.Emit.Label = checkMethodIL.DefineLabel()
checkMethodIL.Emit(OpCodes.Beq, tru213)
checkMethodIL.Emit(OpCodes.Br, fa213)
checkMethodIL.MarkLabel(tru213)
checkMethodIL.MarkSequencePoint(doc5, 560, 1, 560, 100)
checkMethodIL.Emit(OpCodes.Ldloc, 6)
Typ = GetType(System.Boolean)
checkMethodIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa214 As System.Reflection.Emit.Label = checkMethodIL.DefineLabel()
Dim tru214 As System.Reflection.Emit.Label = checkMethodIL.DefineLabel()
Dim cont214 As System.Reflection.Emit.Label = checkMethodIL.DefineLabel()
checkMethodIL.Emit(OpCodes.Beq, tru214)
checkMethodIL.Emit(OpCodes.Br, fa214)
checkMethodIL.MarkLabel(tru214)
checkMethodIL.MarkSequencePoint(doc5, 561, 1, 561, 100)
Dim locbldr295 As LocalBuilder = checkMethodIL.DeclareLocal(asm.GetType("dylan.NET.Tokenizer.Parser.ExprOptimizer"))
locbldr295.SetLocalSymInfo("eopt2")
checkMethodIL.Emit(OpCodes.Newobj, asm.GetType("dylan.NET.Tokenizer.Parser.ExprOptimizer").GetConstructor(Type.EmptyTypes))
...
checkMethodIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa215 As System.Reflection.Emit.Label = checkMethodIL.DefineLabel()
Dim tru215 As System.Reflection.Emit.Label = checkMethodIL.DefineLabel()
Dim cont215 As System.Reflection.Emit.Label = checkMethodIL.DefineLabel()
checkMethodIL.Emit(OpCodes.Beq, tru215)
checkMethodIL.Emit(OpCodes.Br, fa215)
checkMethodIL.MarkLabel(tru215)
...
checkMethodIL.Emit(OpCodes.Br, cont215)
checkMethodIL.MarkLabel(fa215)
checkMethodIL.Emit(OpCodes.Br, cont215)
checkMethodIL.MarkLabel(cont215)
checkMethodIL.MarkSequencePoint(doc5, 566, 1, 566, 100)
checkMethodIL.Emit(OpCodes.Br, cont214)
checkMethodIL.MarkLabel(fa214)
checkMethodIL.Emit(OpCodes.Br, cont214)
checkMethodIL.MarkLabel(cont214)
...
checkMethodIL.Emit(OpCodes.Br, cont213)
checkMethodIL.MarkLabel(fa213)
checkMethodIL.Emit(OpCodes.Br, cont213)
checkMethodIL.MarkLabel(cont213)
...
checkMethodIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa216 As System.Reflection.Emit.Label = checkMethodIL.DefineLabel()
Dim tru216 As System.Reflection.Emit.Label = checkMethodIL.DefineLabel()
Dim cont216 As System.Reflection.Emit.Label = checkMethodIL.DefineLabel()
checkMethodIL.Emit(OpCodes.Beq, tru216)
checkMethodIL.Emit(OpCodes.Br, fa216)
checkMethodIL.MarkLabel(tru216)
...
checkMethodIL.Emit(OpCodes.Br, cont216)
checkMethodIL.MarkLabel(fa216)
checkMethodIL.Emit(OpCodes.Br, cont216)
checkMethodIL.MarkLabel(cont216)
...
checkMethodIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa217 As System.Reflection.Emit.Label = checkMethodIL.DefineLabel()
Dim tru217 As System.Reflection.Emit.Label = checkMethodIL.DefineLabel()
Dim cont217 As System.Reflection.Emit.Label = checkMethodIL.DefineLabel()
checkMethodIL.Emit(OpCodes.Beq, tru217)
checkMethodIL.Emit(OpCodes.Br, fa217)
checkMethodIL.MarkLabel(tru217)
checkMethodIL.MarkSequencePoint(doc5, 583, 1, 583, 100)
Dim locbldr296 As LocalBuilder = checkMethodIL.DeclareLocal(asm.GetType("dylan.NET.Tokenizer.Parser.ExprOptimizer"))
locbldr296.SetLocalSymInfo("eopt1")
checkMethodIL.Emit(OpCodes.Newobj, asm.GetType("dylan.NET.Tokenizer.Parser.ExprOptimizer").GetConstructor(Type.EmptyTypes))
...
checkMethodIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa218 As System.Reflection.Emit.Label = checkMethodIL.DefineLabel()
Dim tru218 As System.Reflection.Emit.Label = checkMethodIL.DefineLabel()
Dim cont218 As System.Reflection.Emit.Label = checkMethodIL.DefineLabel()
checkMethodIL.Emit(OpCodes.Beq, tru218)
checkMethodIL.Emit(OpCodes.Br, fa218)
checkMethodIL.MarkLabel(tru218)
...
checkMethodIL.Emit(OpCodes.Br, cont218)
checkMethodIL.MarkLabel(fa218)
checkMethodIL.Emit(OpCodes.Br, cont218)
checkMethodIL.MarkLabel(cont218)
checkMethodIL.MarkSequencePoint(doc5, 588, 1, 588, 100)
checkMethodIL.Emit(OpCodes.Ldc_I4, 0)
Typ = GetType(System.Boolean)
checkMethodIL.Emit(OpCodes.Stloc, 6)
checkMethodIL.MarkSequencePoint(doc5, 589, 1, 589, 100)
checkMethodIL.Emit(OpCodes.Br, cont217)
checkMethodIL.MarkLabel(fa217)
checkMethodIL.Emit(OpCodes.Br, cont217)
checkMethodIL.MarkLabel(cont217)
checkMethodIL.MarkSequencePoint(doc5, 591, 1, 591, 100)
checkMethodIL.Emit(OpCodes.Ldloc, 6)
Typ = GetType(System.Boolean)
checkMethodIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa219 As System.Reflection.Emit.Label = checkMethodIL.DefineLabel()
Dim tru219 As System.Reflection.Emit.Label = checkMethodIL.DefineLabel()
Dim cont219 As System.Reflection.Emit.Label = checkMethodIL.DefineLabel()
checkMethodIL.Emit(OpCodes.Beq, tru219)
checkMethodIL.Emit(OpCodes.Br, fa219)
checkMethodIL.MarkLabel(tru219)
...
checkMethodIL.Emit(OpCodes.Br, cont219)
checkMethodIL.MarkLabel(fa219)
checkMethodIL.Emit(OpCodes.Br, cont219)
checkMethodIL.MarkLabel(cont219)
checkMethodIL.MarkSequencePoint(doc5, 596, 1, 596, 100)
checkMethodIL.Emit(OpCodes.Ldloc, 9)
Typ = GetType(System.Int32)
checkMethodIL.Emit(OpCodes.Ldloc, 10)
Typ = GetType(System.Int32)
Dim fa220 As System.Reflection.Emit.Label = checkMethodIL.DefineLabel()
Dim tru220 As System.Reflection.Emit.Label = checkMethodIL.DefineLabel()
Dim cont220 As System.Reflection.Emit.Label = checkMethodIL.DefineLabel()
checkMethodIL.Emit(OpCodes.Beq, tru220)
checkMethodIL.Emit(OpCodes.Br, fa220)
checkMethodIL.MarkLabel(tru220)
checkMethodIL.MarkSequencePoint(doc5, 597, 1, 597, 100)
checkMethodIL.Emit(OpCodes.Br, label12)
checkMethodIL.MarkSequencePoint(doc5, 598, 1, 598, 100)
checkMethodIL.Emit(OpCodes.Br, cont220)
checkMethodIL.MarkLabel(fa220)
...
checkMethodIL.Emit(OpCodes.Br, cont220)
checkMethodIL.MarkLabel(cont220)
...
checkMethodIL.Emit(OpCodes.Br, cont212)
checkMethodIL.MarkLabel(fa212)
checkMethodIL.Emit(OpCodes.Br, cont212)
checkMethodIL.MarkLabel(cont212)
...
Typ = GetType(System.Int32)
Dim fa221 As System.Reflection.Emit.Label = checkMethodCallIL.DefineLabel()
Dim tru221 As System.Reflection.Emit.Label = checkMethodCallIL.DefineLabel()
Dim cont221 As System.Reflection.Emit.Label = checkMethodCallIL.DefineLabel()
checkMethodCallIL.Emit(OpCodes.Bgt, tru221)
checkMethodCallIL.Emit(OpCodes.Br, fa221)
checkMethodCallIL.MarkLabel(tru221)
checkMethodCallIL.MarkSequencePoint(doc5, 613, 1, 613, 100)
Dim locbldr297 As LocalBuilder = checkMethodCallIL.DeclareLocal(GetType(Token))
...
Dim locbldr298 As LocalBuilder = checkMethodCallIL.DeclareLocal(GetType(System.Type))
...
Dim locbldr299 As LocalBuilder = checkMethodCallIL.DeclareLocal(GetType(Token))
locbldr299.SetLocalSymInfo("tokb")
checkMethodCallIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
checkMethodCallIL.Emit(OpCodes.Ldfld, GetType(Stmt).GetField("Tokens"))
Typ = GetType(Stmt).GetField("Tokens").FieldType
...
Dim locbldr300 As LocalBuilder = checkMethodCallIL.DeclareLocal(GetType(System.Type))
locbldr300.SetLocalSymInfo("typb")
...
Dim locbldr301 As LocalBuilder = checkMethodCallIL.DeclareLocal(GetType(System.Boolean))
locbldr301.SetLocalSymInfo("ba")
Dim typ109(-1) As Type
...
Dim locbldr302 As LocalBuilder = checkMethodCallIL.DeclareLocal(GetType(System.Boolean))
locbldr302.SetLocalSymInfo("bb")
...
Dim locbldr303 As LocalBuilder = checkMethodCallIL.DeclareLocal(GetType(MethodCallStmt))
locbldr303.SetLocalSymInfo("mtcss")
...
Dim locbldr304 As LocalBuilder = checkMethodCallIL.DeclareLocal(GetType(MethodNameTok))
locbldr304.SetLocalSymInfo("mn")
...
Dim locbldr305 As LocalBuilder = checkMethodCallIL.DeclareLocal(GetType(MethodCallTok))
locbldr305.SetLocalSymInfo("mct")
...
Dim locbldr306 As LocalBuilder = checkMethodCallIL.DeclareLocal(GetType(Ident))
locbldr306.SetLocalSymInfo("idt")
...
Dim locbldr307 As LocalBuilder = checkMethodCallIL.DeclareLocal(GetType(Expr))
locbldr307.SetLocalSymInfo("exp")
...
Dim locbldr308 As LocalBuilder = checkMethodCallIL.DeclareLocal(GetType(System.Int32))
locbldr308.SetLocalSymInfo("lvl")
checkMethodCallIL.Emit(OpCodes.Ldc_I4, CInt(1))
Typ = GetType(System.Int32)
checkMethodCallIL.Emit(OpCodes.Stloc, 11)
checkMethodCallIL.MarkSequencePoint(doc5, 628, 1, 628, 100)
Dim locbldr309 As LocalBuilder = checkMethodCallIL.DeclareLocal(GetType(System.Boolean))
locbldr309.SetLocalSymInfo("d")
...
Dim locbldr310 As LocalBuilder = checkMethodCallIL.DeclareLocal(GetType(System.Int32))
...
checkMethodCallIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa222 As System.Reflection.Emit.Label = checkMethodCallIL.DefineLabel()
Dim tru222 As System.Reflection.Emit.Label = checkMethodCallIL.DefineLabel()
Dim cont222 As System.Reflection.Emit.Label = checkMethodCallIL.DefineLabel()
checkMethodCallIL.Emit(OpCodes.Beq, tru222)
checkMethodCallIL.Emit(OpCodes.Br, fa222)
checkMethodCallIL.MarkLabel(tru222)
...
Dim locbldr311 As LocalBuilder = checkMethodCallIL.DeclareLocal(GetType(Token))
...
Dim locbldr312 As LocalBuilder = checkMethodCallIL.DeclareLocal(GetType(System.Type))
locbldr312.SetLocalSymInfo("typ2")
checkMethodCallIL.MarkSequencePoint(doc5, 642, 1, 642, 100)
Dim locbldr313 As LocalBuilder = checkMethodCallIL.DeclareLocal(GetType(System.Boolean))
locbldr313.SetLocalSymInfo("b2")
checkMethodCallIL.MarkSequencePoint(doc5, 643, 1, 643, 100)
Dim locbldr314 As LocalBuilder = checkMethodCallIL.DeclareLocal(GetType(System.Int32))
...
Dim locbldr315 As LocalBuilder = checkMethodCallIL.DeclareLocal(asm.GetType("dylan.NET.Tokenizer.Parser.ExprOptimizer"))
locbldr315.SetLocalSymInfo("eopt")
...
checkMethodCallIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa223 As System.Reflection.Emit.Label = checkMethodCallIL.DefineLabel()
Dim tru223 As System.Reflection.Emit.Label = checkMethodCallIL.DefineLabel()
Dim cont223 As System.Reflection.Emit.Label = checkMethodCallIL.DefineLabel()
checkMethodCallIL.Emit(OpCodes.Beq, tru223)
checkMethodCallIL.Emit(OpCodes.Br, fa223)
checkMethodCallIL.MarkLabel(tru223)
...
checkMethodCallIL.Emit(OpCodes.Ldc_I4, CInt(0))
Typ = GetType(System.Int32)
Dim fa224 As System.Reflection.Emit.Label = checkMethodCallIL.DefineLabel()
Dim tru224 As System.Reflection.Emit.Label = checkMethodCallIL.DefineLabel()
Dim cont224 As System.Reflection.Emit.Label = checkMethodCallIL.DefineLabel()
checkMethodCallIL.Emit(OpCodes.Beq, tru224)
checkMethodCallIL.Emit(OpCodes.Br, fa224)
checkMethodCallIL.MarkLabel(tru224)
...
checkMethodCallIL.Emit(OpCodes.Ldc_I4, CInt(0))
Typ = GetType(System.Int32)
Dim fa225 As System.Reflection.Emit.Label = checkMethodCallIL.DefineLabel()
Dim tru225 As System.Reflection.Emit.Label = checkMethodCallIL.DefineLabel()
Dim cont225 As System.Reflection.Emit.Label = checkMethodCallIL.DefineLabel()
checkMethodCallIL.Emit(OpCodes.Bgt, tru225)
checkMethodCallIL.Emit(OpCodes.Br, fa225)
checkMethodCallIL.MarkLabel(tru225)
...
checkMethodCallIL.Emit(OpCodes.Br, cont225)
checkMethodCallIL.MarkLabel(fa225)
checkMethodCallIL.Emit(OpCodes.Br, cont225)
checkMethodCallIL.MarkLabel(cont225)
...
checkMethodCallIL.Emit(OpCodes.Br, cont224)
checkMethodCallIL.MarkLabel(fa224)
...
checkMethodCallIL.Emit(OpCodes.Br, cont224)
checkMethodCallIL.MarkLabel(cont224)
checkMethodCallIL.MarkSequencePoint(doc5, 671, 1, 671, 100)
checkMethodCallIL.Emit(OpCodes.Br, label15)
checkMethodCallIL.MarkSequencePoint(doc5, 672, 1, 672, 100)
checkMethodCallIL.Emit(OpCodes.Br, cont223)
checkMethodCallIL.MarkLabel(fa223)
checkMethodCallIL.Emit(OpCodes.Br, cont223)
checkMethodCallIL.MarkLabel(cont223)
...
checkMethodCallIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa226 As System.Reflection.Emit.Label = checkMethodCallIL.DefineLabel()
Dim tru226 As System.Reflection.Emit.Label = checkMethodCallIL.DefineLabel()
Dim cont226 As System.Reflection.Emit.Label = checkMethodCallIL.DefineLabel()
checkMethodCallIL.Emit(OpCodes.Beq, tru226)
checkMethodCallIL.Emit(OpCodes.Br, fa226)
checkMethodCallIL.MarkLabel(tru226)
...
checkMethodCallIL.Emit(OpCodes.Br, cont226)
checkMethodCallIL.MarkLabel(fa226)
checkMethodCallIL.Emit(OpCodes.Br, cont226)
checkMethodCallIL.MarkLabel(cont226)
...
checkMethodCallIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa227 As System.Reflection.Emit.Label = checkMethodCallIL.DefineLabel()
Dim tru227 As System.Reflection.Emit.Label = checkMethodCallIL.DefineLabel()
Dim cont227 As System.Reflection.Emit.Label = checkMethodCallIL.DefineLabel()
checkMethodCallIL.Emit(OpCodes.Beq, tru227)
checkMethodCallIL.Emit(OpCodes.Br, fa227)
checkMethodCallIL.MarkLabel(tru227)
checkMethodCallIL.MarkSequencePoint(doc5, 687, 1, 687, 100)
checkMethodCallIL.Emit(OpCodes.Ldloc, 11)
Typ = GetType(System.Int32)
checkMethodCallIL.Emit(OpCodes.Ldc_I4, CInt(1))
Typ = GetType(System.Int32)
Dim fa228 As System.Reflection.Emit.Label = checkMethodCallIL.DefineLabel()
Dim tru228 As System.Reflection.Emit.Label = checkMethodCallIL.DefineLabel()
Dim cont228 As System.Reflection.Emit.Label = checkMethodCallIL.DefineLabel()
checkMethodCallIL.Emit(OpCodes.Beq, tru228)
checkMethodCallIL.Emit(OpCodes.Br, fa228)
checkMethodCallIL.MarkLabel(tru228)
...
checkMethodCallIL.Emit(OpCodes.Ldc_I4, CInt(0))
Typ = GetType(System.Int32)
Dim fa229 As System.Reflection.Emit.Label = checkMethodCallIL.DefineLabel()
Dim tru229 As System.Reflection.Emit.Label = checkMethodCallIL.DefineLabel()
Dim cont229 As System.Reflection.Emit.Label = checkMethodCallIL.DefineLabel()
checkMethodCallIL.Emit(OpCodes.Bgt, tru229)
checkMethodCallIL.Emit(OpCodes.Br, fa229)
checkMethodCallIL.MarkLabel(tru229)
...
checkMethodCallIL.Emit(OpCodes.Br, cont229)
checkMethodCallIL.MarkLabel(fa229)
checkMethodCallIL.Emit(OpCodes.Br, cont229)
checkMethodCallIL.MarkLabel(cont229)
...
checkMethodCallIL.Emit(OpCodes.Br, cont228)
checkMethodCallIL.MarkLabel(fa228)
...
checkMethodCallIL.Emit(OpCodes.Br, cont228)
checkMethodCallIL.MarkLabel(cont228)
checkMethodCallIL.MarkSequencePoint(doc5, 699, 1, 699, 100)
checkMethodCallIL.Emit(OpCodes.Br, cont227)
checkMethodCallIL.MarkLabel(fa227)
...
checkMethodCallIL.Emit(OpCodes.Br, cont227)
checkMethodCallIL.MarkLabel(cont227)
...
checkMethodCallIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa230 As System.Reflection.Emit.Label = checkMethodCallIL.DefineLabel()
Dim tru230 As System.Reflection.Emit.Label = checkMethodCallIL.DefineLabel()
Dim cont230 As System.Reflection.Emit.Label = checkMethodCallIL.DefineLabel()
checkMethodCallIL.Emit(OpCodes.Beq, tru230)
checkMethodCallIL.Emit(OpCodes.Br, fa230)
checkMethodCallIL.MarkLabel(tru230)
...
checkMethodCallIL.Emit(OpCodes.Br, cont230)
checkMethodCallIL.MarkLabel(fa230)
checkMethodCallIL.Emit(OpCodes.Br, cont230)
checkMethodCallIL.MarkLabel(cont230)
checkMethodCallIL.MarkSequencePoint(doc5, 710, 1, 710, 100)
checkMethodCallIL.Emit(OpCodes.Ldloc, 13)
Typ = GetType(System.Int32)
checkMethodCallIL.Emit(OpCodes.Ldloc, 17)
Typ = GetType(System.Int32)
Dim fa231 As System.Reflection.Emit.Label = checkMethodCallIL.DefineLabel()
Dim tru231 As System.Reflection.Emit.Label = checkMethodCallIL.DefineLabel()
Dim cont231 As System.Reflection.Emit.Label = checkMethodCallIL.DefineLabel()
checkMethodCallIL.Emit(OpCodes.Beq, tru231)
checkMethodCallIL.Emit(OpCodes.Br, fa231)
checkMethodCallIL.MarkLabel(tru231)
checkMethodCallIL.MarkSequencePoint(doc5, 711, 1, 711, 100)
checkMethodCallIL.Emit(OpCodes.Br, label14)
checkMethodCallIL.MarkSequencePoint(doc5, 712, 1, 712, 100)
checkMethodCallIL.Emit(OpCodes.Br, cont231)
checkMethodCallIL.MarkLabel(fa231)
...
checkMethodCallIL.Emit(OpCodes.Br, cont231)
checkMethodCallIL.MarkLabel(cont231)
...
checkMethodCallIL.Emit(OpCodes.Br, cont222)
checkMethodCallIL.MarkLabel(fa222)
checkMethodCallIL.Emit(OpCodes.Br, cont222)
checkMethodCallIL.MarkLabel(cont222)
checkMethodCallIL.MarkSequencePoint(doc5, 723, 1, 723, 100)
checkMethodCallIL.Emit(OpCodes.Br, cont221)
checkMethodCallIL.MarkLabel(fa221)
checkMethodCallIL.Emit(OpCodes.Br, cont221)
checkMethodCallIL.MarkLabel(cont221)
...
Dim locbldr316 As LocalBuilder = checkVarAsIL.DeclareLocal(GetType(Token))
locbldr316.SetLocalSymInfo("tok")
checkVarAsIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
...
Dim locbldr317 As LocalBuilder = checkVarAsIL.DeclareLocal(GetType(System.Type))
locbldr317.SetLocalSymInfo("typ")
checkVarAsIL.Emit(OpCodes.Ldtoken, GetType(VarTok))
...
Dim locbldr318 As LocalBuilder = checkVarAsIL.DeclareLocal(GetType(VarStmt))
locbldr318.SetLocalSymInfo("vars")
...
checkVarAsIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa232 As System.Reflection.Emit.Label = checkVarAsIL.DefineLabel()
Dim tru232 As System.Reflection.Emit.Label = checkVarAsIL.DefineLabel()
Dim cont232 As System.Reflection.Emit.Label = checkVarAsIL.DefineLabel()
checkVarAsIL.Emit(OpCodes.Beq, tru232)
checkVarAsIL.Emit(OpCodes.Br, fa232)
checkVarAsIL.MarkLabel(tru232)
...
Dim locbldr319 As LocalBuilder = checkVarAsIL.DeclareLocal(GetType(Expr))
...
Dim locbldr320 As LocalBuilder = checkVarAsIL.DeclareLocal(asm.GetType("dylan.NET.Tokenizer.Parser.ExprOptimizer"))
...
Dim locbldr321 As LocalBuilder = checkVarAsIL.DeclareLocal(GetType(Token))
locbldr321.SetLocalSymInfo("tok2")
checkVarAsIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
checkVarAsIL.Emit(OpCodes.Ldfld, GetType(Stmt).GetField("Tokens"))
Typ = GetType(Stmt).GetField("Tokens").FieldType
...
Dim locbldr322 As LocalBuilder = checkVarAsIL.DeclareLocal(GetType(System.Type))
locbldr322.SetLocalSymInfo("typ2")
checkVarAsIL.Emit(OpCodes.Ldtoken, GetType(TypeTok))
...
Dim locbldr323 As LocalBuilder = checkVarAsIL.DeclareLocal(GetType(System.Boolean))
locbldr323.SetLocalSymInfo("b2")
Dim typ127(-1) As Type
checkVarAsIL.Emit(OpCodes.Ldloc, 6)
Typ = GetType(System.Type)
Typ03 = Typ
...
checkVarAsIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa233 As System.Reflection.Emit.Label = checkVarAsIL.DefineLabel()
Dim tru233 As System.Reflection.Emit.Label = checkVarAsIL.DefineLabel()
Dim cont233 As System.Reflection.Emit.Label = checkVarAsIL.DefineLabel()
checkVarAsIL.Emit(OpCodes.Beq, fa233)
checkVarAsIL.Emit(OpCodes.Br, tru233)
checkVarAsIL.MarkLabel(tru233)
checkVarAsIL.MarkSequencePoint(doc5, 748, 1, 748, 100)
Dim locbldr324 As LocalBuilder = checkVarAsIL.DeclareLocal(GetType(Token))
locbldr324.SetLocalSymInfo("t")
checkVarAsIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
checkVarAsIL.Emit(OpCodes.Ldfld, GetType(Stmt).GetField("Tokens"))
Typ = GetType(Stmt).GetField("Tokens").FieldType
...
Dim locbldr325 As LocalBuilder = checkVarAsIL.DeclareLocal(GetType(TypeTok))
locbldr325.SetLocalSymInfo("tt")
checkVarAsIL.Emit(OpCodes.Newobj, GetType(TypeTok).GetConstructor(Type.EmptyTypes))
...
checkVarAsIL.Emit(OpCodes.Br, cont233)
checkVarAsIL.MarkLabel(fa233)
...
checkVarAsIL.Emit(OpCodes.Br, cont233)
checkVarAsIL.MarkLabel(cont233)
checkVarAsIL.MarkSequencePoint(doc5, 757, 1, 757, 100)
checkVarAsIL.Emit(OpCodes.Br, cont232)
checkVarAsIL.MarkLabel(fa232)
checkVarAsIL.Emit(OpCodes.Br, cont232)
checkVarAsIL.MarkLabel(cont232)
...
Dim locbldr326 As LocalBuilder = AssOptIL.DeclareLocal(GetType(AssignStmt))
locbldr326.SetLocalSymInfo("asss")
AssOptIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
AssOptIL.Emit(OpCodes.Stloc, 0)
AssOptIL.MarkSequencePoint(doc5, 764, 1, 764, 100)
Dim locbldr327 As LocalBuilder = AssOptIL.DeclareLocal(GetType(Expr))
locbldr327.SetLocalSymInfo("le")
...
Dim locbldr328 As LocalBuilder = AssOptIL.DeclareLocal(GetType(Token))
locbldr328.SetLocalSymInfo("tok")
...
Dim locbldr329 As LocalBuilder = AssOptIL.DeclareLocal(GetType(System.Type))
locbldr329.SetLocalSymInfo("typ")
...
Dim locbldr330 As LocalBuilder = AssOptIL.DeclareLocal(GetType(System.Boolean))
locbldr330.SetLocalSymInfo("b")
Dim typ130(-1) As Type
...
Dim locbldr331 As LocalBuilder = AssOptIL.DeclareLocal(GetType(VarAsgnStmt))
locbldr331.SetLocalSymInfo("vass")
...
Typ = GetType(System.Boolean)
Dim fa234 As System.Reflection.Emit.Label = AssOptIL.DefineLabel()
Dim tru234 As System.Reflection.Emit.Label = AssOptIL.DefineLabel()
Dim cont234 As System.Reflection.Emit.Label = AssOptIL.DefineLabel()
AssOptIL.Emit(OpCodes.Beq, tru234)
AssOptIL.Emit(OpCodes.Br, fa234)
AssOptIL.MarkLabel(tru234)
...
Dim locbldr332 As LocalBuilder = AssOptIL.DeclareLocal(GetType(Token))
...
Dim locbldr333 As LocalBuilder = AssOptIL.DeclareLocal(GetType(System.Type))
...
Dim locbldr334 As LocalBuilder = AssOptIL.DeclareLocal(GetType(System.Boolean))
...
AssOptIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa235 As System.Reflection.Emit.Label = AssOptIL.DefineLabel()
Dim tru235 As System.Reflection.Emit.Label = AssOptIL.DefineLabel()
Dim cont235 As System.Reflection.Emit.Label = AssOptIL.DefineLabel()
AssOptIL.Emit(OpCodes.Beq, fa235)
AssOptIL.Emit(OpCodes.Br, tru235)
AssOptIL.MarkLabel(tru235)
AssOptIL.MarkSequencePoint(doc5, 779, 1, 779, 100)
Dim locbldr335 As LocalBuilder = AssOptIL.DeclareLocal(GetType(Token))
locbldr335.SetLocalSymInfo("t")
AssOptIL.Emit(OpCodes.Ldloc, 1)
Typ = GetType(Expr)
AssOptIL.Emit(OpCodes.Ldfld, GetType(Expr).GetField("Tokens"))
Typ = GetType(Expr).GetField("Tokens").FieldType
...
Dim locbldr336 As LocalBuilder = AssOptIL.DeclareLocal(GetType(TypeTok))
locbldr336.SetLocalSymInfo("tt")
...
AssOptIL.Emit(OpCodes.Br, cont235)
AssOptIL.MarkLabel(fa235)
...
Dim locbldr337 As LocalBuilder = AssOptIL.DeclareLocal(asm.GetType("dylan.NET.Tokenizer.Parser.ExprOptimizer"))
locbldr337.SetLocalSymInfo("eop")
...
Dim locbldr338 As LocalBuilder = checkAssignIL.DeclareLocal(GetType(Token))
locbldr338.SetLocalSymInfo("tok")
checkAssignIL.Emit(OpCodes.Ldnull)
checkAssignIL.Emit(OpCodes.Stloc, 0)
checkAssignIL.MarkSequencePoint(doc5, 801, 1, 801, 100)
Dim locbldr339 As LocalBuilder = checkAssignIL.DeclareLocal(GetType(System.Type))
locbldr339.SetLocalSymInfo("typ")
...
Dim locbldr340 As LocalBuilder = checkAssignIL.DeclareLocal(GetType(AssignStmt))
locbldr340.SetLocalSymInfo("asss")
...
Dim locbldr341 As LocalBuilder = checkAssignIL.DeclareLocal(GetType(System.Boolean))
locbldr341.SetLocalSymInfo("c")
checkAssignIL.Emit(OpCodes.Ldc_I4, 0)
Typ = GetType(System.Boolean)
checkAssignIL.Emit(OpCodes.Stloc, 3)
checkAssignIL.MarkSequencePoint(doc5, 804, 1, 804, 100)
Dim locbldr342 As LocalBuilder = checkAssignIL.DeclareLocal(GetType(Expr))
locbldr342.SetLocalSymInfo("re")
...
Dim locbldr343 As LocalBuilder = checkAssignIL.DeclareLocal(GetType(Expr))
locbldr343.SetLocalSymInfo("le")
checkAssignIL.Emit(OpCodes.Newobj, GetType(Expr).GetConstructor(Type.EmptyTypes))
checkAssignIL.Emit(OpCodes.Stloc, 5)
checkAssignIL.MarkSequencePoint(doc5, 806, 1, 806, 100)
Dim locbldr344 As LocalBuilder = checkAssignIL.DeclareLocal(GetType(System.Int32))
...
Dim locbldr345 As LocalBuilder = checkAssignIL.DeclareLocal(GetType(System.Int32))
locbldr345.SetLocalSymInfo("len")
...
Dim locbldr346 As LocalBuilder = checkAssignIL.DeclareLocal(GetType(System.Int32))
locbldr346.SetLocalSymInfo("assind")
...
Typ = GetType(System.Boolean)
Dim fa236 As System.Reflection.Emit.Label = checkAssignIL.DefineLabel()
Dim tru236 As System.Reflection.Emit.Label = checkAssignIL.DefineLabel()
Dim cont236 As System.Reflection.Emit.Label = checkAssignIL.DefineLabel()
checkAssignIL.Emit(OpCodes.Beq, tru236)
checkAssignIL.Emit(OpCodes.Br, fa236)
checkAssignIL.MarkLabel(tru236)
...
checkAssignIL.Emit(OpCodes.Br, cont236)
checkAssignIL.MarkLabel(fa236)
checkAssignIL.Emit(OpCodes.Br, cont236)
checkAssignIL.MarkLabel(cont236)
checkAssignIL.MarkSequencePoint(doc5, 825, 1, 825, 100)
checkAssignIL.Emit(OpCodes.Ldloc, 6)
Typ = GetType(System.Int32)
checkAssignIL.Emit(OpCodes.Ldloc, 7)
Typ = GetType(System.Int32)
Dim fa237 As System.Reflection.Emit.Label = checkAssignIL.DefineLabel()
Dim tru237 As System.Reflection.Emit.Label = checkAssignIL.DefineLabel()
Dim cont237 As System.Reflection.Emit.Label = checkAssignIL.DefineLabel()
checkAssignIL.Emit(OpCodes.Beq, tru237)
checkAssignIL.Emit(OpCodes.Br, fa237)
checkAssignIL.MarkLabel(tru237)
checkAssignIL.MarkSequencePoint(doc5, 826, 1, 826, 100)
checkAssignIL.Emit(OpCodes.Br, label17)
checkAssignIL.MarkSequencePoint(doc5, 827, 1, 827, 100)
checkAssignIL.Emit(OpCodes.Br, cont237)
checkAssignIL.MarkLabel(fa237)
...
checkAssignIL.Emit(OpCodes.Br, cont237)
checkAssignIL.MarkLabel(cont237)
...
checkAssignIL.Emit(OpCodes.Ldc_I4, CInt(0))
Typ = GetType(System.Int32)
Dim fa238 As System.Reflection.Emit.Label = checkAssignIL.DefineLabel()
Dim tru238 As System.Reflection.Emit.Label = checkAssignIL.DefineLabel()
Dim cont238 As System.Reflection.Emit.Label = checkAssignIL.DefineLabel()
checkAssignIL.Emit(OpCodes.Beq, fa238)
checkAssignIL.Emit(OpCodes.Br, tru238)
checkAssignIL.MarkLabel(tru238)
...
checkAssignIL.Emit(OpCodes.Ldloc, 7)
Typ = GetType(System.Int32)
Dim fa239 As System.Reflection.Emit.Label = checkAssignIL.DefineLabel()
Dim tru239 As System.Reflection.Emit.Label = checkAssignIL.DefineLabel()
Dim cont239 As System.Reflection.Emit.Label = checkAssignIL.DefineLabel()
checkAssignIL.Emit(OpCodes.Beq, tru239)
checkAssignIL.Emit(OpCodes.Br, fa239)
checkAssignIL.MarkLabel(tru239)
...
checkAssignIL.Emit(OpCodes.Br, cont239)
checkAssignIL.MarkLabel(fa239)
...
checkAssignIL.Emit(OpCodes.Br, cont239)
checkAssignIL.MarkLabel(cont239)
...
checkAssignIL.Emit(OpCodes.Ldloc, 7)
Typ = GetType(System.Int32)
Dim fa240 As System.Reflection.Emit.Label = checkAssignIL.DefineLabel()
Dim tru240 As System.Reflection.Emit.Label = checkAssignIL.DefineLabel()
Dim cont240 As System.Reflection.Emit.Label = checkAssignIL.DefineLabel()
checkAssignIL.Emit(OpCodes.Beq, tru240)
checkAssignIL.Emit(OpCodes.Br, fa240)
checkAssignIL.MarkLabel(tru240)
...
checkAssignIL.Emit(OpCodes.Br, cont240)
checkAssignIL.MarkLabel(fa240)
...
checkAssignIL.Emit(OpCodes.Br, cont240)
checkAssignIL.MarkLabel(cont240)
...
Dim locbldr347 As LocalBuilder = checkAssignIL.DeclareLocal(asm.GetType("dylan.NET.Tokenizer.Parser.ExprOptimizer"))
locbldr347.SetLocalSymInfo("eop")
...
checkAssignIL.Emit(OpCodes.Br, cont238)
checkAssignIL.MarkLabel(fa238)
...
checkAssignIL.Emit(OpCodes.Br, cont238)
checkAssignIL.MarkLabel(cont238)
...
Dim locbldr348 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(System.Int32))
locbldr348.SetLocalSymInfo("i")
OptimizeIL.Emit(OpCodes.Ldc_I4, CInt(-1))
Typ = GetType(System.Int32)
OptimizeIL.Emit(OpCodes.Stloc, 0)
OptimizeIL.MarkSequencePoint(doc5, 904, 1, 904, 100)
Dim locbldr349 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(System.Int32))
...
Dim locbldr350 As LocalBuilder = OptimizeIL.DeclareLocal(asm.GetType("dylan.NET.Tokenizer.Parser.TokenOptimizer"))
locbldr350.SetLocalSymInfo("to")
OptimizeIL.Emit(OpCodes.Ldnull)
OptimizeIL.Emit(OpCodes.Stloc, 2)
OptimizeIL.MarkSequencePoint(doc5, 906, 1, 906, 100)
Dim locbldr351 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(Stmt))
locbldr351.SetLocalSymInfo("tmpstm")
OptimizeIL.Emit(OpCodes.Ldnull)
OptimizeIL.Emit(OpCodes.Stloc, 3)
OptimizeIL.MarkSequencePoint(doc5, 907, 1, 907, 100)
Dim locbldr352 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(System.Boolean))
locbldr352.SetLocalSymInfo("compb")
OptimizeIL.Emit(OpCodes.Ldc_I4, 0)
Typ = GetType(System.Boolean)
OptimizeIL.Emit(OpCodes.Stloc, 4)
...
OptimizeIL.Emit(OpCodes.Blt, tru241)
...
OptimizeIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa249 As System.Reflection.Emit.Label = OptimizeIL.DefineLabel()
Dim tru249 As System.Reflection.Emit.Label = OptimizeIL.DefineLabel()
Dim cont249 As System.Reflection.Emit.Label = OptimizeIL.DefineLabel()
OptimizeIL.Emit(OpCodes.Beq, tru249)
OptimizeIL.Emit(OpCodes.Br, fa249)
OptimizeIL.MarkLabel(tru249)
...
OptimizeIL.Emit(OpCodes.Br, cont249)
OptimizeIL.MarkLabel(fa249)
OptimizeIL.Emit(OpCodes.Br, cont249)
OptimizeIL.MarkLabel(cont249)
...
OptimizeIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa250 As System.Reflection.Emit.Label = OptimizeIL.DefineLabel()
Dim tru250 As System.Reflection.Emit.Label = OptimizeIL.DefineLabel()
Dim cont250 As System.Reflection.Emit.Label = OptimizeIL.DefineLabel()
OptimizeIL.Emit(OpCodes.Beq, tru250)
OptimizeIL.Emit(OpCodes.Br, fa250)
OptimizeIL.MarkLabel(tru250)
...
OptimizeIL.Emit(OpCodes.Br, cont250)
OptimizeIL.MarkLabel(fa250)
OptimizeIL.Emit(OpCodes.Br, cont250)
OptimizeIL.MarkLabel(cont250)
...
OptimizeIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa251 As System.Reflection.Emit.Label = OptimizeIL.DefineLabel()
Dim tru251 As System.Reflection.Emit.Label = OptimizeIL.DefineLabel()
Dim cont251 As System.Reflection.Emit.Label = OptimizeIL.DefineLabel()
OptimizeIL.Emit(OpCodes.Beq, tru251)
OptimizeIL.Emit(OpCodes.Br, fa251)
OptimizeIL.MarkLabel(tru251)
...
OptimizeIL.Emit(OpCodes.Br, cont251)
OptimizeIL.MarkLabel(fa251)
OptimizeIL.Emit(OpCodes.Br, cont251)
OptimizeIL.MarkLabel(cont251)
...
OptimizeIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa252 As System.Reflection.Emit.Label = OptimizeIL.DefineLabel()
Dim tru252 As System.Reflection.Emit.Label = OptimizeIL.DefineLabel()
Dim cont252 As System.Reflection.Emit.Label = OptimizeIL.DefineLabel()
OptimizeIL.Emit(OpCodes.Beq, tru252)
OptimizeIL.Emit(OpCodes.Br, fa252)
OptimizeIL.MarkLabel(tru252)
...
OptimizeIL.Emit(OpCodes.Br, cont252)
OptimizeIL.MarkLabel(fa252)
OptimizeIL.Emit(OpCodes.Br, cont252)
OptimizeIL.MarkLabel(cont252)
...
OptimizeIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa253 As System.Reflection.Emit.Label = OptimizeIL.DefineLabel()
Dim tru253 As System.Reflection.Emit.Label = OptimizeIL.DefineLabel()
Dim cont253 As System.Reflection.Emit.Label = OptimizeIL.DefineLabel()
OptimizeIL.Emit(OpCodes.Beq, tru253)
OptimizeIL.Emit(OpCodes.Br, fa253)
OptimizeIL.MarkLabel(tru253)
...
OptimizeIL.Emit(OpCodes.Br, cont253)
OptimizeIL.MarkLabel(fa253)
OptimizeIL.Emit(OpCodes.Br, cont253)
OptimizeIL.MarkLabel(cont253)
...
OptimizeIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa254 As System.Reflection.Emit.Label = OptimizeIL.DefineLabel()
Dim tru254 As System.Reflection.Emit.Label = OptimizeIL.DefineLabel()
Dim cont254 As System.Reflection.Emit.Label = OptimizeIL.DefineLabel()
OptimizeIL.Emit(OpCodes.Beq, tru254)
OptimizeIL.Emit(OpCodes.Br, fa254)
OptimizeIL.MarkLabel(tru254)
...
OptimizeIL.Emit(OpCodes.Br, cont254)
OptimizeIL.MarkLabel(fa254)
OptimizeIL.Emit(OpCodes.Br, cont254)
OptimizeIL.MarkLabel(cont254)
...
OptimizeIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa255 As System.Reflection.Emit.Label = OptimizeIL.DefineLabel()
Dim tru255 As System.Reflection.Emit.Label = OptimizeIL.DefineLabel()
Dim cont255 As System.Reflection.Emit.Label = OptimizeIL.DefineLabel()
OptimizeIL.Emit(OpCodes.Beq, tru255)
OptimizeIL.Emit(OpCodes.Br, fa255)
OptimizeIL.MarkLabel(tru255)
...
OptimizeIL.Emit(OpCodes.Br, cont255)
OptimizeIL.MarkLabel(fa255)
OptimizeIL.Emit(OpCodes.Br, cont255)
OptimizeIL.MarkLabel(cont255)
...
OptimizeIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa256 As System.Reflection.Emit.Label = OptimizeIL.DefineLabel()
Dim tru256 As System.Reflection.Emit.Label = OptimizeIL.DefineLabel()
Dim cont256 As System.Reflection.Emit.Label = OptimizeIL.DefineLabel()
OptimizeIL.Emit(OpCodes.Beq, tru256)
OptimizeIL.Emit(OpCodes.Br, fa256)
OptimizeIL.MarkLabel(tru256)
...
OptimizeIL.Emit(OpCodes.Br, cont256)
OptimizeIL.MarkLabel(fa256)
OptimizeIL.Emit(OpCodes.Br, cont256)
OptimizeIL.MarkLabel(cont256)
...
OptimizeIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa257 As System.Reflection.Emit.Label = OptimizeIL.DefineLabel()
Dim tru257 As System.Reflection.Emit.Label = OptimizeIL.DefineLabel()
Dim cont257 As System.Reflection.Emit.Label = OptimizeIL.DefineLabel()
OptimizeIL.Emit(OpCodes.Beq, tru257)
OptimizeIL.Emit(OpCodes.Br, fa257)
OptimizeIL.MarkLabel(tru257)
...
OptimizeIL.Emit(OpCodes.Br, cont257)
OptimizeIL.MarkLabel(fa257)
OptimizeIL.Emit(OpCodes.Br, cont257)
OptimizeIL.MarkLabel(cont257)
...
OptimizeIL.Emit(OpCodes.Beq, tru258)
...
Dim locbldr353 As LocalBuilder = ParseIL.DeclareLocal(GetType(System.Int32))
locbldr353.SetLocalSymInfo("i")
ParseIL.Emit(OpCodes.Ldc_I4, CInt(-1))
Typ = GetType(System.Int32)
ParseIL.Emit(OpCodes.Stloc, 0)
ParseIL.MarkSequencePoint(doc6, 13, 1, 13, 100)
Dim locbldr354 As LocalBuilder = ParseIL.DeclareLocal(asm.GetType("dylan.NET.Tokenizer.Parser.StmtOptimizer"))
locbldr354.SetLocalSymInfo("so")
ParseIL.Emit(OpCodes.Ldnull)
ParseIL.Emit(OpCodes.Stloc, 1)
ParseIL.MarkSequencePoint(doc6, 14, 1, 14, 100)
Dim locbldr355 As LocalBuilder = ParseIL.DeclareLocal(GetType(System.Int32))
locbldr355.SetLocalSymInfo("len")
...
ParseIL.Emit(OpCodes.Ldloc, 2)
Typ = GetType(System.Int32)
Dim fa265 As System.Reflection.Emit.Label = ParseIL.DefineLabel()
Dim tru265 As System.Reflection.Emit.Label = ParseIL.DefineLabel()
Dim cont265 As System.Reflection.Emit.Label = ParseIL.DefineLabel()
ParseIL.Emit(OpCodes.Beq, tru265)
ParseIL.Emit(OpCodes.Br, fa265)
ParseIL.MarkLabel(tru265)
ParseIL.MarkSequencePoint(doc6, 27, 1, 27, 100)
ParseIL.Emit(OpCodes.Br, label1)
ParseIL.MarkSequencePoint(doc6, 28, 1, 28, 100)
ParseIL.Emit(OpCodes.Br, cont265)
ParseIL.MarkLabel(fa265)
ParseIL.MarkSequencePoint(doc6, 29, 1, 29, 100)
ParseIL.Emit(OpCodes.Br, label0)
ParseIL.MarkSequencePoint(doc6, 30, 1, 30, 100)
ParseIL.Emit(OpCodes.Br, cont265)
ParseIL.MarkLabel(cont265)
