...
Dim locbldr30 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(LRSParen))
locbldr30.SetLocalSymInfo("lrspar")
...
Dim locbldr31 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(Ampersand))
locbldr31.SetLocalSymInfo("ampsig")
...
Dim locbldr32 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(LSParen))
locbldr32.SetLocalSymInfo("lspar")
...
Dim locbldr33 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(RSParen))
locbldr33.SetLocalSymInfo("rspar")
...
Dim locbldr34 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(Pipe))
locbldr34.SetLocalSymInfo("pip")
...
Dim locbldr35 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(Comma))
locbldr35.SetLocalSymInfo("com")
...
Dim locbldr36 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(DollarSign))
locbldr36.SetLocalSymInfo("ds")
...
Dim locbldr37 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(IfTok))
locbldr37.SetLocalSymInfo("iftk")
...
Dim locbldr38 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(ThenTok))
locbldr38.SetLocalSymInfo("thentk")
...
Dim locbldr39 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(RefasmTok))
locbldr39.SetLocalSymInfo("ratk")
...
Dim locbldr40 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(DebugTok))
locbldr40.SetLocalSymInfo("dgtk")
...
Dim locbldr41 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(ImportTok))
locbldr41.SetLocalSymInfo("imptk")
...
Dim locbldr42 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(LocimportTok))
locbldr42.SetLocalSymInfo("limptk")
...
Dim locbldr43 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(AssemblyTok))
locbldr43.SetLocalSymInfo("asmtk")
...
Dim locbldr44 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(VerTok))
locbldr44.SetLocalSymInfo("vertk")
...
Dim locbldr45 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(OnTok))
locbldr45.SetLocalSymInfo("ontk")
...
Dim locbldr46 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(OffTok))
locbldr46.SetLocalSymInfo("oftk")
...
Dim locbldr47 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(ExeTok))
locbldr47.SetLocalSymInfo("extk")
...
Dim locbldr48 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(DllTok))
locbldr48.SetLocalSymInfo("dltk")
...
Dim locbldr49 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(FieldTok))
locbldr49.SetLocalSymInfo("fltk")
...
Dim locbldr50 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(ClassTok))
locbldr50.SetLocalSymInfo("cltk")
...
Dim locbldr51 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(ExtendsTok))
locbldr51.SetLocalSymInfo("exttk")
...
Dim locbldr52 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(MethodTok))
locbldr52.SetLocalSymInfo("mettk")
...
Dim locbldr53 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(EndTok))
locbldr53.SetLocalSymInfo("entk")
...
Dim locbldr54 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(VarTok))
locbldr54.SetLocalSymInfo("vrtk")
...
Dim locbldr55 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(AsTok))
locbldr55.SetLocalSymInfo("astk")
...
Dim locbldr56 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(PrivateAttr))
locbldr56.SetLocalSymInfo("privattr")
...
Dim locbldr57 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(PublicAttr))
locbldr57.SetLocalSymInfo("pubattr")
...
Dim locbldr58 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(InitOnlyAttr))
locbldr58.SetLocalSymInfo("initoattr")
...
Dim locbldr59 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(StaticAttr))
locbldr59.SetLocalSymInfo("statattr")
...
Dim locbldr60 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(AutoLayoutAttr))
locbldr60.SetLocalSymInfo("autattr")
...
Dim locbldr61 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(AutoClassAttr))
locbldr61.SetLocalSymInfo("autcattr")
...
Dim locbldr62 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(AnsiClassAttr))
locbldr62.SetLocalSymInfo("ansattr")
...
Dim locbldr63 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(BeforeFieldInitAttr))
locbldr63.SetLocalSymInfo("bfiattr")
...
Dim locbldr64 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(StringTok))
locbldr64.SetLocalSymInfo("strtok")
...
Dim locbldr65 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(VoidTok))
locbldr65.SetLocalSymInfo("voidtok")
...
Dim locbldr66 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(DecimalTok))
locbldr66.SetLocalSymInfo("decitok")
...
Dim locbldr67 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(IntegerTok))
locbldr67.SetLocalSymInfo("inttok")
...
Dim locbldr68 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(DoubleTok))
locbldr68.SetLocalSymInfo("dbltok")
...
Dim locbldr69 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(BooleanTok))
locbldr69.SetLocalSymInfo("booltok")
...
Dim locbldr70 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(CharTok))
locbldr70.SetLocalSymInfo("chrtok")
...
Dim locbldr71 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(SingleTok))
locbldr71.SetLocalSymInfo("sngtok")
...
Dim locbldr72 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(SByteTok))
locbldr72.SetLocalSymInfo("sbytok")
...
Dim locbldr73 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(ShortTok))
locbldr73.SetLocalSymInfo("shtok")
...
Dim locbldr74 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(LongTok))
locbldr74.SetLocalSymInfo("lngtok")
...
Dim locbldr75 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(ObjectTok))
locbldr75.SetLocalSymInfo("objtok")
...
Dim locbldr76 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(commentTok))
locbldr76.SetLocalSymInfo("comtok")
...
Dim locbldr77 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(BooleanLiteral))
locbldr77.SetLocalSymInfo("boolit")
...
ReDim Preserve typ88(UBound(typ88) + 1)
typ88(UBound(typ88)) = Typ
OptimizeIL.Emit(OpCodes.Call, GetType(Utils.ParseUtils).GetMethod("LikeOP", typ88))
Typ = GetType(Utils.ParseUtils).GetMethod("LikeOP", typ88).ReturnType
OptimizeIL.Emit(OpCodes.Stloc, 1)
...
Dim locbldr78 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(CharLiteral))
locbldr78.SetLocalSymInfo("chrlit")
...
OptimizeIL.Emit(OpCodes.Call, GetType(System.Convert).GetMethod("ToChar", typ89))
Typ = GetType(System.Convert).GetMethod("ToChar", typ89).ReturnType
...
OptimizeIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("Trim", typ90))
Typ = Typ03.GetMethod("Trim", typ90).ReturnType
OptimizeIL.Emit(OpCodes.Stloc, 2)
...
ReDim Preserve typ92(UBound(typ92) + 1)
typ92(UBound(typ92)) = Typ
OptimizeIL.Emit(OpCodes.Call, GetType(String).GetMethod("Concat", typ92))
...
ReDim Preserve typ93(UBound(typ93) + 1)
typ93(UBound(typ93)) = Typ
OptimizeIL.Emit(OpCodes.Call, GetType(Utils.ParseUtils).GetMethod("LikeOP", typ93))
Typ = GetType(Utils.ParseUtils).GetMethod("LikeOP", typ93).ReturnType
OptimizeIL.Emit(OpCodes.Stloc, 1)
...
Dim locbldr79 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(StringLiteral))
locbldr79.SetLocalSymInfo("strlit")
...
OptimizeIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("Trim", typ95))
Typ = Typ03.GetMethod("Trim", typ95).ReturnType
OptimizeIL.Emit(OpCodes.Stloc, 2)
...
OptimizeIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("EndsWith", typ99))
Typ = Typ03.GetMethod("EndsWith", typ99).ReturnType
OptimizeIL.Emit(OpCodes.Stloc, 1)
...
Dim locbldr80 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(DoubleLiteral))
locbldr80.SetLocalSymInfo("dlit2")
...
OptimizeIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("TrimEnd", typ101))
Typ = Typ03.GetMethod("TrimEnd", typ101).ReturnType
OptimizeIL.Emit(OpCodes.Stloc, 2)
...
OptimizeIL.Emit(OpCodes.Call, GetType(System.Convert).GetMethod("ToDouble", typ102))
Typ = GetType(System.Convert).GetMethod("ToDouble", typ102).ReturnType
...
OptimizeIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("EndsWith", typ106))
Typ = Typ03.GetMethod("EndsWith", typ106).ReturnType
OptimizeIL.Emit(OpCodes.Stloc, 1)
...
Dim locbldr81 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(FloatLiteral))
locbldr81.SetLocalSymInfo("flit")
...
OptimizeIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("TrimEnd", typ108))
Typ = Typ03.GetMethod("TrimEnd", typ108).ReturnType
OptimizeIL.Emit(OpCodes.Stloc, 2)
...
OptimizeIL.Emit(OpCodes.Call, GetType(System.Convert).GetMethod("ToSingle", typ109))
Typ = GetType(System.Convert).GetMethod("ToSingle", typ109).ReturnType
...
locbldr82.SetLocalSymInfo("dlit")
OptimizeIL.Emit(OpCodes.Newobj, GetType(DoubleLiteral).GetConstructor(Type.EmptyTypes))
...
OptimizeIL.Emit(OpCodes.Call, GetType(System.Convert).GetMethod("ToDouble", typ113))
Typ = GetType(System.Convert).GetMethod("ToDouble", typ113).ReturnType
OptimizeIL.Emit(OpCodes.Stfld, GetType(DoubleLiteral).GetField("NumVal"))
...
OptimizeIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("EndsWith", typ117))
Typ = Typ03.GetMethod("EndsWith", typ117).ReturnType
OptimizeIL.Emit(OpCodes.Stloc, 1)
...
Dim locbldr83 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(DoubleLiteral))
locbldr83.SetLocalSymInfo("dlit3")
OptimizeIL.Emit(OpCodes.Newobj, GetType(DoubleLiteral).GetConstructor(Type.EmptyTypes))
...
OptimizeIL.Emit(OpCodes.Call, GetType(System.Convert).GetMethod("ToChar", typ118))
Typ = GetType(System.Convert).GetMethod("ToChar", typ118).ReturnType
OptimizeIL.Emit(OpCodes.Stelem, GetType(System.Char).MakeArrayType().GetElementType())
...
OptimizeIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("TrimEnd", typ119))
Typ = Typ03.GetMethod("TrimEnd", typ119).ReturnType
OptimizeIL.Emit(OpCodes.Stloc, 2)
...
OptimizeIL.Emit(OpCodes.Call, GetType(System.Convert).GetMethod("ToDouble", typ120))
Typ = GetType(System.Convert).GetMethod("ToDouble", typ120).ReturnType
OptimizeIL.Emit(OpCodes.Stfld, GetType(DoubleLiteral).GetField("NumVal"))
...
Dim locbldr84 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(FloatLiteral))
locbldr84.SetLocalSymInfo("flit2")
OptimizeIL.Emit(OpCodes.Newobj, GetType(FloatLiteral).GetConstructor(Type.EmptyTypes))
...
OptimizeIL.Emit(OpCodes.Call, GetType(System.Convert).GetMethod("ToSingle", typ127))
Typ = GetType(System.Convert).GetMethod("ToSingle", typ127).ReturnType
OptimizeIL.Emit(OpCodes.Stfld, GetType(FloatLiteral).GetField("NumVal"))
...
Dim locbldr85 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(IntLiteral))
locbldr85.SetLocalSymInfo("ilit2")
...
OptimizeIL.Emit(OpCodes.Call, GetType(System.Convert).GetMethod("ToInt32", typ134))
Typ = GetType(System.Convert).GetMethod("ToInt32", typ134).ReturnType
...
OptimizeIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("EndsWith", typ138))
Typ = Typ03.GetMethod("EndsWith", typ138).ReturnType
OptimizeIL.Emit(OpCodes.Stloc, 1)
...
Dim locbldr86 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(LongLiteral))
locbldr86.SetLocalSymInfo("llit")
...
OptimizeIL.Emit(OpCodes.Call, GetType(System.Convert).GetMethod("ToChar", typ139))
Typ = GetType(System.Convert).GetMethod("ToChar", typ139).ReturnType
OptimizeIL.Emit(OpCodes.Stelem, GetType(System.Char).MakeArrayType().GetElementType())
...
OptimizeIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("TrimEnd", typ140))
Typ = Typ03.GetMethod("TrimEnd", typ140).ReturnType
OptimizeIL.Emit(OpCodes.Stloc, 2)
...
OptimizeIL.Emit(OpCodes.Call, GetType(System.Convert).GetMethod("ToInt64", typ141))
...
OptimizeIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("EndsWith", typ145))
Typ = Typ03.GetMethod("EndsWith", typ145).ReturnType
OptimizeIL.Emit(OpCodes.Stloc, 1)
...
Dim locbldr87 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(ShortLiteral))
locbldr87.SetLocalSymInfo("slit")
...
OptimizeIL.Emit(OpCodes.Call, GetType(System.Convert).GetMethod("ToChar", typ146))
Typ = GetType(System.Convert).GetMethod("ToChar", typ146).ReturnType
OptimizeIL.Emit(OpCodes.Stelem, GetType(System.Char).MakeArrayType().GetElementType())
...
OptimizeIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("TrimEnd", typ147))
Typ = Typ03.GetMethod("TrimEnd", typ147).ReturnType
OptimizeIL.Emit(OpCodes.Stloc, 2)
...
OptimizeIL.Emit(OpCodes.Call, GetType(System.Convert).GetMethod("ToInt16", typ148))
Typ = GetType(System.Convert).GetMethod("ToInt16", typ148).ReturnType
...
OptimizeIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("EndsWith", typ152))
Typ = Typ03.GetMethod("EndsWith", typ152).ReturnType
OptimizeIL.Emit(OpCodes.Stloc, 1)
...
Dim locbldr88 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(SByteLiteral))
locbldr88.SetLocalSymInfo("blit")
...
OptimizeIL.Emit(OpCodes.Call, GetType(System.Convert).GetMethod("ToSByte", typ155))
Typ = GetType(System.Convert).GetMethod("ToSByte", typ155).ReturnType
...
Dim locbldr89 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(IntLiteral))
locbldr89.SetLocalSymInfo("ilit")
OptimizeIL.Emit(OpCodes.Newobj, GetType(IntLiteral).GetConstructor(Type.EmptyTypes))
...
Dim locbldr90 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(Ident))
locbldr90.SetLocalSymInfo("idt")
...
Dim locbldr91 As LocalBuilder = checkVarAsIL.DeclareLocal(GetType(Token))
...
Dim locbldr92 As LocalBuilder = checkVarAsIL.DeclareLocal(GetType(System.Type))
...
Dim locbldr93 As LocalBuilder = checkVarAsIL.DeclareLocal(GetType(VarExpr))
locbldr93.SetLocalSymInfo("vars")
...
Typ = GetType(System.Boolean)
Dim fa90 As System.Reflection.Emit.Label = checkVarAsIL.DefineLabel()
Dim tru90 As System.Reflection.Emit.Label = checkVarAsIL.DefineLabel()
Dim cont90 As System.Reflection.Emit.Label = checkVarAsIL.DefineLabel()
checkVarAsIL.Emit(OpCodes.Beq, tru90)
checkVarAsIL.Emit(OpCodes.Br, fa90)
checkVarAsIL.MarkLabel(tru90)
...
Dim locbldr94 As LocalBuilder = checkVarAsIL.DeclareLocal(GetType(Token))
locbldr94.SetLocalSymInfo("tok2")
checkVarAsIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Expr)
checkVarAsIL.Emit(OpCodes.Ldfld, GetType(Expr).GetField("Tokens"))
Typ = GetType(Expr).GetField("Tokens").FieldType
...
Dim locbldr95 As LocalBuilder = checkVarAsIL.DeclareLocal(GetType(System.Type))
locbldr95.SetLocalSymInfo("typ2")
...
Dim locbldr96 As LocalBuilder = checkVarAsIL.DeclareLocal(GetType(System.Boolean))
locbldr96.SetLocalSymInfo("b2")
Dim typ4(-1) As Type
...
checkVarAsIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa91 As System.Reflection.Emit.Label = checkVarAsIL.DefineLabel()
Dim tru91 As System.Reflection.Emit.Label = checkVarAsIL.DefineLabel()
Dim cont91 As System.Reflection.Emit.Label = checkVarAsIL.DefineLabel()
checkVarAsIL.Emit(OpCodes.Beq, fa91)
checkVarAsIL.Emit(OpCodes.Br, tru91)
checkVarAsIL.MarkLabel(tru91)
checkVarAsIL.MarkSequencePoint(doc4, 19, 1, 19, 100)
Dim locbldr97 As LocalBuilder = checkVarAsIL.DeclareLocal(GetType(Token))
locbldr97.SetLocalSymInfo("t")
checkVarAsIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Expr)
checkVarAsIL.Emit(OpCodes.Ldfld, GetType(Expr).GetField("Tokens"))
Typ = GetType(Expr).GetField("Tokens").FieldType
...
Dim locbldr98 As LocalBuilder = checkVarAsIL.DeclareLocal(GetType(TypeTok))
locbldr98.SetLocalSymInfo("tt")
...
checkVarAsIL.Emit(OpCodes.Br, cont91)
checkVarAsIL.MarkLabel(fa91)
...
checkVarAsIL.Emit(OpCodes.Br, cont91)
checkVarAsIL.MarkLabel(cont91)
checkVarAsIL.MarkSequencePoint(doc4, 28, 1, 28, 100)
checkVarAsIL.Emit(OpCodes.Br, cont90)
checkVarAsIL.MarkLabel(fa90)
checkVarAsIL.Emit(OpCodes.Br, cont90)
checkVarAsIL.MarkLabel(cont90)
...
Dim locbldr99 As LocalBuilder = procMethodCallIL.DeclareLocal(GetType(MethodNameTok))
locbldr99.SetLocalSymInfo("mn")
...
Dim locbldr100 As LocalBuilder = procMethodCallIL.DeclareLocal(GetType(MethodCallTok))
locbldr100.SetLocalSymInfo("mct")
...
Dim locbldr101 As LocalBuilder = procMethodCallIL.DeclareLocal(GetType(Ident))
locbldr101.SetLocalSymInfo("idt")
...
Dim locbldr102 As LocalBuilder = procMethodCallIL.DeclareLocal(GetType(Expr))
locbldr102.SetLocalSymInfo("ep2")
...
Dim locbldr103 As LocalBuilder = procMethodCallIL.DeclareLocal(GetType(System.Int32))
locbldr103.SetLocalSymInfo("lvl")
...
Dim locbldr104 As LocalBuilder = procMethodCallIL.DeclareLocal(GetType(System.Boolean))
locbldr104.SetLocalSymInfo("d")
...
Dim locbldr106 As LocalBuilder = procMethodCallIL.DeclareLocal(GetType(Token))
locbldr106.SetLocalSymInfo("tok2")
procMethodCallIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Expr)
procMethodCallIL.Emit(OpCodes.Ldfld, GetType(Expr).GetField("Tokens"))
Typ = GetType(Expr).GetField("Tokens").FieldType
...
Dim locbldr107 As LocalBuilder = procMethodCallIL.DeclareLocal(GetType(System.Type))
locbldr107.SetLocalSymInfo("typ2")
procMethodCallIL.MarkSequencePoint(doc4, 69, 1, 69, 100)
Dim locbldr108 As LocalBuilder = procMethodCallIL.DeclareLocal(GetType(System.Boolean))
locbldr108.SetLocalSymInfo("b2")
...
locbldr109.SetLocalSymInfo("len")
procMethodCallIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Expr)
procMethodCallIL.Emit(OpCodes.Ldfld, GetType(Expr).GetField("Tokens"))
Typ = GetType(Expr).GetField("Tokens").FieldType
...
Dim locbldr110 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(System.Int32))
...
Dim locbldr111 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(System.Int32))
...
OptimizeIL.Emit(OpCodes.Blt, tru99)
...
Dim locbldr113 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(Token))
...
Dim locbldr114 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(System.Type))
locbldr114.SetLocalSymInfo("typ")
OptimizeIL.MarkSequencePoint(doc4, 183, 1, 183, 100)
Dim locbldr115 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(System.Boolean))
locbldr115.SetLocalSymInfo("b")
OptimizeIL.MarkSequencePoint(doc4, 184, 1, 184, 100)
Dim locbldr116 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(System.String))
...
OptimizeIL.Emit(OpCodes.Beq, fa101)
OptimizeIL.Emit(OpCodes.Br, tru101)
OptimizeIL.MarkLabel(tru101)
OptimizeIL.MarkSequencePoint(doc4, 198, 1, 198, 100)
Dim locbldr117 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(Token))
locbldr117.SetLocalSymInfo("tk")
OptimizeIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Expr)
OptimizeIL.Emit(OpCodes.Ldfld, GetType(Expr).GetField("Tokens"))
Typ = GetType(Expr).GetField("Tokens").FieldType
...
Dim locbldr118 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(TypeTok))
locbldr118.SetLocalSymInfo("ttk")
...
locbldr119.SetLocalSymInfo("tk2")
OptimizeIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Expr)
OptimizeIL.Emit(OpCodes.Ldfld, GetType(Expr).GetField("Tokens"))
Typ = GetType(Expr).GetField("Tokens").FieldType
...
locbldr120.SetLocalSymInfo("ttk2")
OptimizeIL.Emit(OpCodes.Newobj, GetType(TypeTok).GetConstructor(Type.EmptyTypes))
OptimizeIL.Emit(OpCodes.Stloc, 10)
...
OptimizeIL.Emit(OpCodes.Beq, fa106)
OptimizeIL.Emit(OpCodes.Br, tru106)
...
Dim locbldr121 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(TypeTok))
locbldr121.SetLocalSymInfo("tt1")
OptimizeIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Expr)
OptimizeIL.Emit(OpCodes.Ldfld, GetType(Expr).GetField("Tokens"))
Typ = GetType(Expr).GetField("Tokens").FieldType
...
Dim locbldr122 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(Ident))
locbldr122.SetLocalSymInfo("id1")
OptimizeIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Expr)
OptimizeIL.Emit(OpCodes.Ldfld, GetType(Expr).GetField("Tokens"))
Typ = GetType(Expr).GetField("Tokens").FieldType
...
Dim locbldr123 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(CharLiteral))
locbldr123.SetLocalSymInfo("cl1")
OptimizeIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Expr)
OptimizeIL.Emit(OpCodes.Ldfld, GetType(Expr).GetField("Tokens"))
Typ = GetType(Expr).GetField("Tokens").FieldType
...
Dim locbldr124 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(StringLiteral))
locbldr124.SetLocalSymInfo("sl1")
OptimizeIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Expr)
OptimizeIL.Emit(OpCodes.Ldfld, GetType(Expr).GetField("Tokens"))
Typ = GetType(Expr).GetField("Tokens").FieldType
...
Dim locbldr125 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(BooleanLiteral))
locbldr125.SetLocalSymInfo("bl1")
OptimizeIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Expr)
OptimizeIL.Emit(OpCodes.Ldfld, GetType(Expr).GetField("Tokens"))
Typ = GetType(Expr).GetField("Tokens").FieldType
...
Dim locbldr126 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(NumberLiteral))
locbldr126.SetLocalSymInfo("nl1")
OptimizeIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Expr)
OptimizeIL.Emit(OpCodes.Ldfld, GetType(Expr).GetField("Tokens"))
Typ = GetType(Expr).GetField("Tokens").FieldType
...
Dim locbldr127 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(MethodCallTok))
locbldr127.SetLocalSymInfo("mct")
OptimizeIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Expr)
OptimizeIL.Emit(OpCodes.Ldfld, GetType(Expr).GetField("Tokens"))
Typ = GetType(Expr).GetField("Tokens").FieldType
...
Dim locbldr128 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(Expr).MakeArrayType())
locbldr128.SetLocalSymInfo("prs")
OptimizeIL.Emit(OpCodes.Ldloc, 17)
Typ = GetType(MethodCallTok)
...
Dim locbldr129 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(System.Int32))
locbldr129.SetLocalSymInfo("ln2")
OptimizeIL.Emit(OpCodes.Ldloc, 18)
...
Dim locbldr130 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(System.Int32))
locbldr130.SetLocalSymInfo("i2")
OptimizeIL.Emit(OpCodes.Ldc_I4, CInt(-1))
Typ = GetType(System.Int32)
OptimizeIL.Emit(OpCodes.Stloc, 20)
...
OptimizeIL.Emit(OpCodes.Blt, tru121)
...
OptimizeIL.Emit(OpCodes.Bgt, tru123)
...
Dim locbldr131 As LocalBuilder = checkRefasmIL.DeclareLocal(GetType(Token))
...
Dim locbldr132 As LocalBuilder = checkRefasmIL.DeclareLocal(GetType(System.Type))
...
Dim locbldr133 As LocalBuilder = checkRefasmIL.DeclareLocal(GetType(RefasmStmt))
locbldr133.SetLocalSymInfo("refasms")
...
Typ = GetType(System.Boolean)
Dim fa125 As System.Reflection.Emit.Label = checkRefasmIL.DefineLabel()
Dim tru125 As System.Reflection.Emit.Label = checkRefasmIL.DefineLabel()
Dim cont125 As System.Reflection.Emit.Label = checkRefasmIL.DefineLabel()
checkRefasmIL.Emit(OpCodes.Beq, tru125)
checkRefasmIL.Emit(OpCodes.Br, fa125)
checkRefasmIL.MarkLabel(tru125)
...
checkRefasmIL.Emit(OpCodes.Br, cont125)
checkRefasmIL.MarkLabel(fa125)
checkRefasmIL.Emit(OpCodes.Br, cont125)
checkRefasmIL.MarkLabel(cont125)
...
Dim locbldr134 As LocalBuilder = checkDebugIL.DeclareLocal(GetType(Token))
...
Dim locbldr135 As LocalBuilder = checkDebugIL.DeclareLocal(GetType(System.Type))
...
Dim locbldr136 As LocalBuilder = checkDebugIL.DeclareLocal(GetType(DebugStmt))
locbldr136.SetLocalSymInfo("dbgs")
...
Typ = GetType(System.Boolean)
Dim fa126 As System.Reflection.Emit.Label = checkDebugIL.DefineLabel()
Dim tru126 As System.Reflection.Emit.Label = checkDebugIL.DefineLabel()
Dim cont126 As System.Reflection.Emit.Label = checkDebugIL.DefineLabel()
checkDebugIL.Emit(OpCodes.Beq, tru126)
checkDebugIL.Emit(OpCodes.Br, fa126)
checkDebugIL.MarkLabel(tru126)
...
checkDebugIL.Emit(OpCodes.Br, cont126)
checkDebugIL.MarkLabel(fa126)
checkDebugIL.Emit(OpCodes.Br, cont126)
checkDebugIL.MarkLabel(cont126)
...
Dim locbldr137 As LocalBuilder = checkImportIL.DeclareLocal(GetType(Token))
...
Dim locbldr138 As LocalBuilder = checkImportIL.DeclareLocal(GetType(System.Type))
...
Dim locbldr139 As LocalBuilder = checkImportIL.DeclareLocal(GetType(ImportStmt))
locbldr139.SetLocalSymInfo("imps")
...
Typ = GetType(System.Boolean)
Dim fa127 As System.Reflection.Emit.Label = checkImportIL.DefineLabel()
Dim tru127 As System.Reflection.Emit.Label = checkImportIL.DefineLabel()
Dim cont127 As System.Reflection.Emit.Label = checkImportIL.DefineLabel()
checkImportIL.Emit(OpCodes.Beq, tru127)
checkImportIL.Emit(OpCodes.Br, fa127)
checkImportIL.MarkLabel(tru127)
...
checkImportIL.Emit(OpCodes.Br, cont127)
checkImportIL.MarkLabel(fa127)
checkImportIL.Emit(OpCodes.Br, cont127)
checkImportIL.MarkLabel(cont127)
...
Dim locbldr140 As LocalBuilder = checkLocimportIL.DeclareLocal(GetType(Token))
...
Dim locbldr141 As LocalBuilder = checkLocimportIL.DeclareLocal(GetType(System.Type))
...
Dim locbldr142 As LocalBuilder = checkLocimportIL.DeclareLocal(GetType(LocimportStmt))
locbldr142.SetLocalSymInfo("limps")
...
Typ = GetType(System.Boolean)
Dim fa128 As System.Reflection.Emit.Label = checkLocimportIL.DefineLabel()
Dim tru128 As System.Reflection.Emit.Label = checkLocimportIL.DefineLabel()
Dim cont128 As System.Reflection.Emit.Label = checkLocimportIL.DefineLabel()
checkLocimportIL.Emit(OpCodes.Beq, tru128)
checkLocimportIL.Emit(OpCodes.Br, fa128)
checkLocimportIL.MarkLabel(tru128)
...
checkLocimportIL.Emit(OpCodes.Br, cont128)
checkLocimportIL.MarkLabel(fa128)
checkLocimportIL.Emit(OpCodes.Br, cont128)
checkLocimportIL.MarkLabel(cont128)
...
Dim locbldr143 As LocalBuilder = checkCmtIL.DeclareLocal(GetType(Token))
...
Dim locbldr144 As LocalBuilder = checkCmtIL.DeclareLocal(GetType(System.Type))
...
Dim locbldr145 As LocalBuilder = checkCmtIL.DeclareLocal(GetType(CommentStmt))
locbldr145.SetLocalSymInfo("cmts")
...
Typ = GetType(System.Boolean)
Dim fa129 As System.Reflection.Emit.Label = checkCmtIL.DefineLabel()
Dim tru129 As System.Reflection.Emit.Label = checkCmtIL.DefineLabel()
Dim cont129 As System.Reflection.Emit.Label = checkCmtIL.DefineLabel()
checkCmtIL.Emit(OpCodes.Beq, tru129)
checkCmtIL.Emit(OpCodes.Br, fa129)
checkCmtIL.MarkLabel(tru129)
...
checkCmtIL.Emit(OpCodes.Br, cont129)
checkCmtIL.MarkLabel(fa129)
checkCmtIL.Emit(OpCodes.Br, cont129)
checkCmtIL.MarkLabel(cont129)
...
Typ = GetType(System.Int32)
Dim fa130 As System.Reflection.Emit.Label = checkEndMtdIL.DefineLabel()
Dim tru130 As System.Reflection.Emit.Label = checkEndMtdIL.DefineLabel()
Dim cont130 As System.Reflection.Emit.Label = checkEndMtdIL.DefineLabel()
checkEndMtdIL.Emit(OpCodes.Bge, tru130)
checkEndMtdIL.Emit(OpCodes.Br, fa130)
checkEndMtdIL.MarkLabel(tru130)
checkEndMtdIL.MarkSequencePoint(doc5, 72, 1, 72, 100)
Dim locbldr146 As LocalBuilder = checkEndMtdIL.DeclareLocal(GetType(Token))
locbldr146.SetLocalSymInfo("tok1")
checkEndMtdIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
checkEndMtdIL.Emit(OpCodes.Ldfld, GetType(Stmt).GetField("Tokens"))
Typ = GetType(Stmt).GetField("Tokens").FieldType
...
Dim locbldr147 As LocalBuilder = checkEndMtdIL.DeclareLocal(GetType(System.Type))
locbldr147.SetLocalSymInfo("typ1")
...
Dim locbldr148 As LocalBuilder = checkEndMtdIL.DeclareLocal(GetType(System.Boolean))
locbldr148.SetLocalSymInfo("b1")
Dim typ18(-1) As Type
...
Dim locbldr149 As LocalBuilder = checkEndMtdIL.DeclareLocal(GetType(Token))
...
Dim locbldr150 As LocalBuilder = checkEndMtdIL.DeclareLocal(GetType(System.Type))
...
Dim locbldr151 As LocalBuilder = checkEndMtdIL.DeclareLocal(GetType(System.Boolean))
...
Dim locbldr152 As LocalBuilder = checkEndMtdIL.DeclareLocal(GetType(EndMethodStmt))
locbldr152.SetLocalSymInfo("ems")
...
Typ = GetType(System.Boolean)
Dim fa131 As System.Reflection.Emit.Label = checkEndMtdIL.DefineLabel()
Dim tru131 As System.Reflection.Emit.Label = checkEndMtdIL.DefineLabel()
Dim cont131 As System.Reflection.Emit.Label = checkEndMtdIL.DefineLabel()
checkEndMtdIL.Emit(OpCodes.Beq, tru131)
checkEndMtdIL.Emit(OpCodes.Br, fa131)
checkEndMtdIL.MarkLabel(tru131)
...
checkEndMtdIL.Emit(OpCodes.Br, cont131)
checkEndMtdIL.MarkLabel(fa131)
checkEndMtdIL.Emit(OpCodes.Br, cont131)
checkEndMtdIL.MarkLabel(cont131)
checkEndMtdIL.MarkSequencePoint(doc5, 87, 1, 87, 100)
checkEndMtdIL.Emit(OpCodes.Br, cont130)
checkEndMtdIL.MarkLabel(fa130)
checkEndMtdIL.Emit(OpCodes.Br, cont130)
checkEndMtdIL.MarkLabel(cont130)
...
Typ = GetType(System.Int32)
Dim fa132 As System.Reflection.Emit.Label = checkEndClsIL.DefineLabel()
Dim tru132 As System.Reflection.Emit.Label = checkEndClsIL.DefineLabel()
Dim cont132 As System.Reflection.Emit.Label = checkEndClsIL.DefineLabel()
checkEndClsIL.Emit(OpCodes.Bge, tru132)
checkEndClsIL.Emit(OpCodes.Br, fa132)
checkEndClsIL.MarkLabel(tru132)
checkEndClsIL.MarkSequencePoint(doc5, 94, 1, 94, 100)
Dim locbldr153 As LocalBuilder = checkEndClsIL.DeclareLocal(GetType(Token))
locbldr153.SetLocalSymInfo("tok1")
checkEndClsIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
checkEndClsIL.Emit(OpCodes.Ldfld, GetType(Stmt).GetField("Tokens"))
Typ = GetType(Stmt).GetField("Tokens").FieldType
...
Dim locbldr154 As LocalBuilder = checkEndClsIL.DeclareLocal(GetType(System.Type))
locbldr154.SetLocalSymInfo("typ1")
...
Dim locbldr155 As LocalBuilder = checkEndClsIL.DeclareLocal(GetType(System.Boolean))
locbldr155.SetLocalSymInfo("b1")
Dim typ23(-1) As Type
...
Dim locbldr156 As LocalBuilder = checkEndClsIL.DeclareLocal(GetType(Token))
...
Dim locbldr157 As LocalBuilder = checkEndClsIL.DeclareLocal(GetType(System.Type))
...
Dim locbldr158 As LocalBuilder = checkEndClsIL.DeclareLocal(GetType(System.Boolean))
...
Dim locbldr159 As LocalBuilder = checkEndClsIL.DeclareLocal(GetType(EndClassStmt))
locbldr159.SetLocalSymInfo("ecs")
...
Typ = GetType(System.Boolean)
Dim fa133 As System.Reflection.Emit.Label = checkEndClsIL.DefineLabel()
Dim tru133 As System.Reflection.Emit.Label = checkEndClsIL.DefineLabel()
Dim cont133 As System.Reflection.Emit.Label = checkEndClsIL.DefineLabel()
checkEndClsIL.Emit(OpCodes.Beq, tru133)
checkEndClsIL.Emit(OpCodes.Br, fa133)
checkEndClsIL.MarkLabel(tru133)
...
checkEndClsIL.Emit(OpCodes.Br, cont133)
checkEndClsIL.MarkLabel(fa133)
checkEndClsIL.Emit(OpCodes.Br, cont133)
checkEndClsIL.MarkLabel(cont133)
checkEndClsIL.MarkSequencePoint(doc5, 109, 1, 109, 100)
checkEndClsIL.Emit(OpCodes.Br, cont132)
checkEndClsIL.MarkLabel(fa132)
checkEndClsIL.Emit(OpCodes.Br, cont132)
checkEndClsIL.MarkLabel(cont132)
...
Dim locbldr160 As LocalBuilder = checkAssemblyIL.DeclareLocal(GetType(Token))
...
Dim locbldr161 As LocalBuilder = checkAssemblyIL.DeclareLocal(GetType(System.Type))
...
Dim locbldr162 As LocalBuilder = checkAssemblyIL.DeclareLocal(GetType(AssemblyStmt))
locbldr162.SetLocalSymInfo("asms")
...
Typ = GetType(System.Boolean)
Dim fa134 As System.Reflection.Emit.Label = checkAssemblyIL.DefineLabel()
Dim tru134 As System.Reflection.Emit.Label = checkAssemblyIL.DefineLabel()
Dim cont134 As System.Reflection.Emit.Label = checkAssemblyIL.DefineLabel()
checkAssemblyIL.Emit(OpCodes.Beq, tru134)
checkAssemblyIL.Emit(OpCodes.Br, fa134)
checkAssemblyIL.MarkLabel(tru134)
...
checkAssemblyIL.Emit(OpCodes.Br, cont134)
checkAssemblyIL.MarkLabel(fa134)
checkAssemblyIL.Emit(OpCodes.Br, cont134)
checkAssemblyIL.MarkLabel(cont134)
...
Dim locbldr163 As LocalBuilder = checkVerIL.DeclareLocal(GetType(Token))
...
Dim locbldr164 As LocalBuilder = checkVerIL.DeclareLocal(GetType(System.Type))
...
Dim locbldr165 As LocalBuilder = checkVerIL.DeclareLocal(GetType(VerStmt))
locbldr165.SetLocalSymInfo("vers")
...
Typ = GetType(System.Boolean)
Dim fa135 As System.Reflection.Emit.Label = checkVerIL.DefineLabel()
Dim tru135 As System.Reflection.Emit.Label = checkVerIL.DefineLabel()
Dim cont135 As System.Reflection.Emit.Label = checkVerIL.DefineLabel()
checkVerIL.Emit(OpCodes.Beq, tru135)
checkVerIL.Emit(OpCodes.Br, fa135)
checkVerIL.MarkLabel(tru135)
...
Dim locbldr166 As LocalBuilder = checkVerIL.DeclareLocal(GetType(System.String).MakeArrayType())
locbldr166.SetLocalSymInfo("ars")
Dim typ32(-1) As Type
checkVerIL.Emit(OpCodes.Ldloc, 0)
Typ = GetType(Token)
...
Dim locbldr167 As LocalBuilder = checkVerIL.DeclareLocal(GetType(System.Int32).MakeArrayType())
locbldr167.SetLocalSymInfo("ari")
...
Dim locbldr168 As LocalBuilder = checkVerIL.DeclareLocal(GetType(IntLiteral).MakeArrayType())
locbldr168.SetLocalSymInfo("intla")
checkVerIL.Emit(OpCodes.Ldc_I4, CInt(4))
Typ = GetType(System.Int32)
checkVerIL.Emit(OpCodes.Conv_U)
...
Dim locbldr169 As LocalBuilder = checkVerIL.DeclareLocal(GetType(IntLiteral))
locbldr169.SetLocalSymInfo("intl")
...
checkVerIL.Emit(OpCodes.Br, cont135)
checkVerIL.MarkLabel(fa135)
checkVerIL.Emit(OpCodes.Br, cont135)
checkVerIL.MarkLabel(cont135)
...
Dim locbldr170 As LocalBuilder = checkClassIL.DeclareLocal(GetType(Token))
...
Dim locbldr171 As LocalBuilder = checkClassIL.DeclareLocal(GetType(System.Type))
locbldr171.SetLocalSymInfo("typ")
...
Dim locbldr172 As LocalBuilder = checkClassIL.DeclareLocal(GetType(ClassStmt))
locbldr172.SetLocalSymInfo("clss")
...
Dim locbldr173 As LocalBuilder = checkClassIL.DeclareLocal(GetType(Attributes.Attribute))
locbldr173.SetLocalSymInfo("att")
...
Typ = GetType(System.Boolean)
Dim fa136 As System.Reflection.Emit.Label = checkClassIL.DefineLabel()
Dim tru136 As System.Reflection.Emit.Label = checkClassIL.DefineLabel()
Dim cont136 As System.Reflection.Emit.Label = checkClassIL.DefineLabel()
checkClassIL.Emit(OpCodes.Beq, tru136)
checkClassIL.Emit(OpCodes.Br, fa136)
checkClassIL.MarkLabel(tru136)
...
Dim locbldr174 As LocalBuilder = checkClassIL.DeclareLocal(GetType(System.Int32))
locbldr174.SetLocalSymInfo("i")
checkClassIL.Emit(OpCodes.Ldc_I4, CInt(0))
Typ = GetType(System.Int32)
checkClassIL.Emit(OpCodes.Stloc, 4)
checkClassIL.MarkSequencePoint(doc5, 180, 1, 180, 100)
Dim locbldr175 As LocalBuilder = checkClassIL.DeclareLocal(GetType(System.Int32))
...
Dim locbldr176 As LocalBuilder = checkClassIL.DeclareLocal(GetType(System.Boolean))
locbldr176.SetLocalSymInfo("bl")
...
checkClassIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa137 As System.Reflection.Emit.Label = checkClassIL.DefineLabel()
Dim tru137 As System.Reflection.Emit.Label = checkClassIL.DefineLabel()
Dim cont137 As System.Reflection.Emit.Label = checkClassIL.DefineLabel()
checkClassIL.Emit(OpCodes.Beq, tru137)
checkClassIL.Emit(OpCodes.Br, fa137)
checkClassIL.MarkLabel(tru137)
...
checkClassIL.Emit(OpCodes.Br, cont137)
checkClassIL.MarkLabel(fa137)
checkClassIL.MarkSequencePoint(doc5, 195, 1, 195, 100)
Dim locbldr177 As LocalBuilder = checkClassIL.DeclareLocal(GetType(Token))
locbldr177.SetLocalSymInfo("tok2")
checkClassIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
checkClassIL.Emit(OpCodes.Ldfld, GetType(Stmt).GetField("Tokens"))
Typ = GetType(Stmt).GetField("Tokens").FieldType
...
Dim locbldr178 As LocalBuilder = checkClassIL.DeclareLocal(GetType(System.Type))
locbldr178.SetLocalSymInfo("typ2")
...
Dim locbldr179 As LocalBuilder = checkClassIL.DeclareLocal(GetType(System.Boolean))
locbldr179.SetLocalSymInfo("b2")
Dim typ48(-1) As Type
...
checkClassIL.Emit(OpCodes.Beq, fa139)
checkClassIL.Emit(OpCodes.Br, tru139)
checkClassIL.MarkLabel(tru139)
checkClassIL.MarkSequencePoint(doc5, 206, 1, 206, 100)
Dim locbldr180 As LocalBuilder = checkClassIL.DeclareLocal(GetType(Token))
locbldr180.SetLocalSymInfo("t")
checkClassIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
checkClassIL.Emit(OpCodes.Ldfld, GetType(Stmt).GetField("Tokens"))
Typ = GetType(Stmt).GetField("Tokens").FieldType
...
Dim locbldr181 As LocalBuilder = checkClassIL.DeclareLocal(GetType(TypeTok))
locbldr181.SetLocalSymInfo("tt")
...
checkClassIL.Emit(OpCodes.Br, cont137)
checkClassIL.MarkLabel(cont137)
...
checkClassIL.Emit(OpCodes.Br, cont136)
checkClassIL.MarkLabel(fa136)
checkClassIL.Emit(OpCodes.Br, cont136)
checkClassIL.MarkLabel(cont136)
...
Dim locbldr182 As LocalBuilder = checkFieldIL.DeclareLocal(GetType(Token))
...
Dim locbldr183 As LocalBuilder = checkFieldIL.DeclareLocal(GetType(System.Type))
...
Dim locbldr184 As LocalBuilder = checkFieldIL.DeclareLocal(GetType(FieldStmt))
...
Dim locbldr185 As LocalBuilder = checkFieldIL.DeclareLocal(GetType(Attributes.Attribute))
locbldr185.SetLocalSymInfo("att")
...
Typ = GetType(System.Boolean)
Dim fa141 As System.Reflection.Emit.Label = checkFieldIL.DefineLabel()
Dim tru141 As System.Reflection.Emit.Label = checkFieldIL.DefineLabel()
Dim cont141 As System.Reflection.Emit.Label = checkFieldIL.DefineLabel()
checkFieldIL.Emit(OpCodes.Beq, tru141)
checkFieldIL.Emit(OpCodes.Br, fa141)
checkFieldIL.MarkLabel(tru141)
checkFieldIL.MarkSequencePoint(doc5, 243, 1, 243, 100)
Dim locbldr186 As LocalBuilder = checkFieldIL.DeclareLocal(GetType(Expr))
locbldr186.SetLocalSymInfo("tempexp")
...
Dim locbldr187 As LocalBuilder = checkFieldIL.DeclareLocal(asm.GetType("dylan.NET.Tokenizer.Parser.ExprOptimizer"))
locbldr187.SetLocalSymInfo("eop")
...
Dim locbldr188 As LocalBuilder = checkFieldIL.DeclareLocal(GetType(System.Int32))
locbldr188.SetLocalSymInfo("i")
checkFieldIL.Emit(OpCodes.Ldc_I4, CInt(0))
Typ = GetType(System.Int32)
checkFieldIL.Emit(OpCodes.Stloc, 6)
checkFieldIL.MarkSequencePoint(doc5, 258, 1, 258, 100)
Dim locbldr189 As LocalBuilder = checkFieldIL.DeclareLocal(GetType(System.Int32))
locbldr189.SetLocalSymInfo("len")
checkFieldIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
checkFieldIL.Emit(OpCodes.Ldfld, GetType(Stmt).GetField("Tokens"))
Typ = GetType(Stmt).GetField("Tokens").FieldType
...
Dim locbldr190 As LocalBuilder = checkFieldIL.DeclareLocal(GetType(System.Boolean))
locbldr190.SetLocalSymInfo("bl")
checkFieldIL.Emit(OpCodes.Ldc_I4, 0)
Typ = GetType(System.Boolean)
...
checkFieldIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa142 As System.Reflection.Emit.Label = checkFieldIL.DefineLabel()
Dim tru142 As System.Reflection.Emit.Label = checkFieldIL.DefineLabel()
Dim cont142 As System.Reflection.Emit.Label = checkFieldIL.DefineLabel()
checkFieldIL.Emit(OpCodes.Beq, tru142)
checkFieldIL.Emit(OpCodes.Br, fa142)
checkFieldIL.MarkLabel(tru142)
...
checkFieldIL.Emit(OpCodes.Br, cont142)
checkFieldIL.MarkLabel(fa142)
checkFieldIL.Emit(OpCodes.Br, cont142)
checkFieldIL.MarkLabel(cont142)
...
Dim locbldr191 As LocalBuilder = checkFieldIL.DeclareLocal(GetType(Token))
locbldr191.SetLocalSymInfo("tok2")
checkFieldIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
checkFieldIL.Emit(OpCodes.Ldfld, GetType(Stmt).GetField("Tokens"))
Typ = GetType(Stmt).GetField("Tokens").FieldType
...
Dim locbldr192 As LocalBuilder = checkFieldIL.DeclareLocal(GetType(System.Type))
locbldr192.SetLocalSymInfo("typ2")
...
Dim locbldr193 As LocalBuilder = checkFieldIL.DeclareLocal(GetType(System.Boolean))
locbldr193.SetLocalSymInfo("b2")
Dim typ59(-1) As Type
...
checkFieldIL.Emit(OpCodes.Beq, fa144)
checkFieldIL.Emit(OpCodes.Br, tru144)
checkFieldIL.MarkLabel(tru144)
checkFieldIL.MarkSequencePoint(doc5, 287, 1, 287, 100)
Dim locbldr194 As LocalBuilder = checkFieldIL.DeclareLocal(GetType(Token))
locbldr194.SetLocalSymInfo("t")
checkFieldIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
checkFieldIL.Emit(OpCodes.Ldfld, GetType(Stmt).GetField("Tokens"))
Typ = GetType(Stmt).GetField("Tokens").FieldType
...
Dim locbldr195 As LocalBuilder = checkFieldIL.DeclareLocal(GetType(TypeTok))
locbldr195.SetLocalSymInfo("tt")
...
checkFieldIL.Emit(OpCodes.Br, cont141)
checkFieldIL.MarkLabel(fa141)
checkFieldIL.Emit(OpCodes.Br, cont141)
checkFieldIL.MarkLabel(cont141)
...
Dim locbldr196 As LocalBuilder = checkMethodIL.DeclareLocal(GetType(Token))
...
Dim locbldr197 As LocalBuilder = checkMethodIL.DeclareLocal(GetType(System.Type))
...
Dim locbldr198 As LocalBuilder = checkMethodIL.DeclareLocal(GetType(MethodStmt))
locbldr198.SetLocalSymInfo("mtss")
...
Dim locbldr199 As LocalBuilder = checkMethodIL.DeclareLocal(GetType(Attributes.Attribute))
locbldr199.SetLocalSymInfo("att")
...
Dim locbldr200 As LocalBuilder = checkMethodIL.DeclareLocal(GetType(Ident))
locbldr200.SetLocalSymInfo("mn")
...
Dim locbldr201 As LocalBuilder = checkMethodIL.DeclareLocal(GetType(Expr))
locbldr201.SetLocalSymInfo("exp")
checkMethodIL.Emit(OpCodes.Ldnull)
checkMethodIL.Emit(OpCodes.Stloc, 5)
checkMethodIL.MarkSequencePoint(doc5, 313, 1, 313, 100)
Dim locbldr202 As LocalBuilder = checkMethodIL.DeclareLocal(GetType(System.Boolean))
...
Typ = GetType(System.Boolean)
Dim fa145 As System.Reflection.Emit.Label = checkMethodIL.DefineLabel()
Dim tru145 As System.Reflection.Emit.Label = checkMethodIL.DefineLabel()
Dim cont145 As System.Reflection.Emit.Label = checkMethodIL.DefineLabel()
checkMethodIL.Emit(OpCodes.Beq, tru145)
checkMethodIL.Emit(OpCodes.Br, fa145)
checkMethodIL.MarkLabel(tru145)
checkMethodIL.MarkSequencePoint(doc5, 317, 1, 317, 100)
Dim locbldr203 As LocalBuilder = checkMethodIL.DeclareLocal(GetType(Expr))
locbldr203.SetLocalSymInfo("tempexp")
...
Dim locbldr204 As LocalBuilder = checkMethodIL.DeclareLocal(asm.GetType("dylan.NET.Tokenizer.Parser.ExprOptimizer"))
...
Dim locbldr205 As LocalBuilder = checkMethodIL.DeclareLocal(GetType(System.Int32))
locbldr205.SetLocalSymInfo("i")
checkMethodIL.Emit(OpCodes.Ldc_I4, CInt(0))
Typ = GetType(System.Int32)
checkMethodIL.Emit(OpCodes.Stloc, 9)
checkMethodIL.MarkSequencePoint(doc5, 333, 1, 333, 100)
Dim locbldr206 As LocalBuilder = checkMethodIL.DeclareLocal(GetType(System.Int32))
locbldr206.SetLocalSymInfo("len")
checkMethodIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
checkMethodIL.Emit(OpCodes.Ldfld, GetType(Stmt).GetField("Tokens"))
Typ = GetType(Stmt).GetField("Tokens").FieldType
...
Dim locbldr207 As LocalBuilder = checkMethodIL.DeclareLocal(GetType(System.Boolean))
locbldr207.SetLocalSymInfo("bl")
checkMethodIL.Emit(OpCodes.Ldc_I4, 0)
Typ = GetType(System.Boolean)
...
checkMethodIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa146 As System.Reflection.Emit.Label = checkMethodIL.DefineLabel()
Dim tru146 As System.Reflection.Emit.Label = checkMethodIL.DefineLabel()
Dim cont146 As System.Reflection.Emit.Label = checkMethodIL.DefineLabel()
checkMethodIL.Emit(OpCodes.Beq, tru146)
checkMethodIL.Emit(OpCodes.Br, fa146)
checkMethodIL.MarkLabel(tru146)
...
checkMethodIL.Emit(OpCodes.Br, cont146)
checkMethodIL.MarkLabel(fa146)
...
checkMethodIL.Emit(OpCodes.Br, cont146)
checkMethodIL.MarkLabel(cont146)
...
Dim locbldr208 As LocalBuilder = checkMethodIL.DeclareLocal(GetType(Token))
locbldr208.SetLocalSymInfo("tok2")
checkMethodIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
checkMethodIL.Emit(OpCodes.Ldfld, GetType(Stmt).GetField("Tokens"))
Typ = GetType(Stmt).GetField("Tokens").FieldType
...
Dim locbldr209 As LocalBuilder = checkMethodIL.DeclareLocal(GetType(System.Type))
locbldr209.SetLocalSymInfo("typ2")
checkMethodIL.MarkSequencePoint(doc5, 367, 1, 367, 100)
Dim locbldr210 As LocalBuilder = checkMethodIL.DeclareLocal(GetType(System.Boolean))
locbldr210.SetLocalSymInfo("b2")
...
checkMethodIL.Emit(OpCodes.Beq, fa148)
checkMethodIL.Emit(OpCodes.Br, tru148)
checkMethodIL.MarkLabel(tru148)
checkMethodIL.MarkSequencePoint(doc5, 373, 1, 373, 100)
Dim locbldr211 As LocalBuilder = checkMethodIL.DeclareLocal(GetType(Token))
locbldr211.SetLocalSymInfo("t")
checkMethodIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
checkMethodIL.Emit(OpCodes.Ldfld, GetType(Stmt).GetField("Tokens"))
Typ = GetType(Stmt).GetField("Tokens").FieldType
...
Dim locbldr212 As LocalBuilder = checkMethodIL.DeclareLocal(GetType(TypeTok))
locbldr212.SetLocalSymInfo("tt")
...
checkMethodIL.Emit(OpCodes.Beq, tru150)
checkMethodIL.Emit(OpCodes.Br, fa150)
...
Dim locbldr213 As LocalBuilder = checkMethodIL.DeclareLocal(asm.GetType("dylan.NET.Tokenizer.Parser.ExprOptimizer"))
locbldr213.SetLocalSymInfo("eopt2")
checkMethodIL.Emit(OpCodes.Newobj, asm.GetType("dylan.NET.Tokenizer.Parser.ExprOptimizer").GetConstructor(Type.EmptyTypes))
...
Dim locbldr214 As LocalBuilder = checkMethodIL.DeclareLocal(asm.GetType("dylan.NET.Tokenizer.Parser.ExprOptimizer"))
locbldr214.SetLocalSymInfo("eopt1")
checkMethodIL.Emit(OpCodes.Newobj, asm.GetType("dylan.NET.Tokenizer.Parser.ExprOptimizer").GetConstructor(Type.EmptyTypes))
...
checkMethodIL.Emit(OpCodes.Br, cont145)
checkMethodIL.MarkLabel(fa145)
checkMethodIL.Emit(OpCodes.Br, cont145)
checkMethodIL.MarkLabel(cont145)
...
Typ = GetType(System.Int32)
Dim fa159 As System.Reflection.Emit.Label = checkMethodCallIL.DefineLabel()
Dim tru159 As System.Reflection.Emit.Label = checkMethodCallIL.DefineLabel()
Dim cont159 As System.Reflection.Emit.Label = checkMethodCallIL.DefineLabel()
checkMethodCallIL.Emit(OpCodes.Bgt, tru159)
checkMethodCallIL.Emit(OpCodes.Br, fa159)
checkMethodCallIL.MarkLabel(tru159)
checkMethodCallIL.MarkSequencePoint(doc5, 462, 1, 462, 100)
Dim locbldr215 As LocalBuilder = checkMethodCallIL.DeclareLocal(GetType(Token))
locbldr215.SetLocalSymInfo("tok")
checkMethodCallIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
checkMethodCallIL.Emit(OpCodes.Ldfld, GetType(Stmt).GetField("Tokens"))
Typ = GetType(Stmt).GetField("Tokens").FieldType
...
Dim locbldr216 As LocalBuilder = checkMethodCallIL.DeclareLocal(GetType(System.Type))
...
locbldr217.SetLocalSymInfo("tokb")
checkMethodCallIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
checkMethodCallIL.Emit(OpCodes.Ldfld, GetType(Stmt).GetField("Tokens"))
Typ = GetType(Stmt).GetField("Tokens").FieldType
...
locbldr218.SetLocalSymInfo("typb")
...
Dim locbldr219 As LocalBuilder = checkMethodCallIL.DeclareLocal(GetType(System.Boolean))
locbldr219.SetLocalSymInfo("ba")
Dim typ87(-1) As Type
...
Dim locbldr220 As LocalBuilder = checkMethodCallIL.DeclareLocal(GetType(System.Boolean))
locbldr220.SetLocalSymInfo("bb")
Dim typ88(-1) As Type
...
Dim locbldr221 As LocalBuilder = checkMethodCallIL.DeclareLocal(GetType(MethodCallStmt))
locbldr221.SetLocalSymInfo("mtcss")
...
Dim locbldr222 As LocalBuilder = checkMethodCallIL.DeclareLocal(GetType(MethodNameTok))
locbldr222.SetLocalSymInfo("mn")
...
Dim locbldr223 As LocalBuilder = checkMethodCallIL.DeclareLocal(GetType(MethodCallTok))
locbldr223.SetLocalSymInfo("mct")
...
Dim locbldr224 As LocalBuilder = checkMethodCallIL.DeclareLocal(GetType(Ident))
locbldr224.SetLocalSymInfo("idt")
...
Dim locbldr225 As LocalBuilder = checkMethodCallIL.DeclareLocal(GetType(Expr))
...
Dim locbldr226 As LocalBuilder = checkMethodCallIL.DeclareLocal(GetType(System.Int32))
locbldr226.SetLocalSymInfo("lvl")
checkMethodCallIL.Emit(OpCodes.Ldc_I4, CInt(1))
Typ = GetType(System.Int32)
checkMethodCallIL.Emit(OpCodes.Stloc, 11)
checkMethodCallIL.MarkSequencePoint(doc5, 477, 1, 477, 100)
Dim locbldr227 As LocalBuilder = checkMethodCallIL.DeclareLocal(GetType(System.Boolean))
locbldr227.SetLocalSymInfo("d")
...
checkMethodCallIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa160 As System.Reflection.Emit.Label = checkMethodCallIL.DefineLabel()
Dim tru160 As System.Reflection.Emit.Label = checkMethodCallIL.DefineLabel()
Dim cont160 As System.Reflection.Emit.Label = checkMethodCallIL.DefineLabel()
checkMethodCallIL.Emit(OpCodes.Beq, tru160)
checkMethodCallIL.Emit(OpCodes.Br, fa160)
checkMethodCallIL.MarkLabel(tru160)
...
Dim locbldr229 As LocalBuilder = checkMethodCallIL.DeclareLocal(GetType(Token))
locbldr229.SetLocalSymInfo("tok2")
checkMethodCallIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
checkMethodCallIL.Emit(OpCodes.Ldfld, GetType(Stmt).GetField("Tokens"))
Typ = GetType(Stmt).GetField("Tokens").FieldType
...
Dim locbldr230 As LocalBuilder = checkMethodCallIL.DeclareLocal(GetType(System.Type))
locbldr230.SetLocalSymInfo("typ2")
checkMethodCallIL.MarkSequencePoint(doc5, 491, 1, 491, 100)
Dim locbldr231 As LocalBuilder = checkMethodCallIL.DeclareLocal(GetType(System.Boolean))
locbldr231.SetLocalSymInfo("b2")
...
Dim locbldr233 As LocalBuilder = checkMethodCallIL.DeclareLocal(asm.GetType("dylan.NET.Tokenizer.Parser.ExprOptimizer"))
locbldr233.SetLocalSymInfo("eopt")
...
checkMethodCallIL.Emit(OpCodes.Beq, tru161)
...
checkMethodCallIL.Emit(OpCodes.Br, cont160)
checkMethodCallIL.MarkLabel(fa160)
checkMethodCallIL.Emit(OpCodes.Br, cont160)
checkMethodCallIL.MarkLabel(cont160)
checkMethodCallIL.MarkSequencePoint(doc5, 568, 1, 568, 100)
checkMethodCallIL.Emit(OpCodes.Br, cont159)
checkMethodCallIL.MarkLabel(fa159)
checkMethodCallIL.Emit(OpCodes.Br, cont159)
checkMethodCallIL.MarkLabel(cont159)
...
Dim locbldr234 As LocalBuilder = checkVarAsIL.DeclareLocal(GetType(Token))
...
Dim locbldr235 As LocalBuilder = checkVarAsIL.DeclareLocal(GetType(System.Type))
locbldr235.SetLocalSymInfo("typ")
checkVarAsIL.Emit(OpCodes.Ldtoken, GetType(VarTok))
...
Dim locbldr236 As LocalBuilder = checkVarAsIL.DeclareLocal(GetType(VarStmt))
locbldr236.SetLocalSymInfo("vars")
...
checkVarAsIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa168 As System.Reflection.Emit.Label = checkVarAsIL.DefineLabel()
Dim tru168 As System.Reflection.Emit.Label = checkVarAsIL.DefineLabel()
Dim cont168 As System.Reflection.Emit.Label = checkVarAsIL.DefineLabel()
checkVarAsIL.Emit(OpCodes.Beq, tru168)
checkVarAsIL.Emit(OpCodes.Br, fa168)
checkVarAsIL.MarkLabel(tru168)
...
Dim locbldr237 As LocalBuilder = checkVarAsIL.DeclareLocal(GetType(Expr))
...
Dim locbldr238 As LocalBuilder = checkVarAsIL.DeclareLocal(asm.GetType("dylan.NET.Tokenizer.Parser.ExprOptimizer"))
...
Dim locbldr239 As LocalBuilder = checkVarAsIL.DeclareLocal(GetType(Token))
...
Dim locbldr240 As LocalBuilder = checkVarAsIL.DeclareLocal(GetType(System.Type))
...
Dim locbldr241 As LocalBuilder = checkVarAsIL.DeclareLocal(GetType(System.Boolean))
...
checkVarAsIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa169 As System.Reflection.Emit.Label = checkVarAsIL.DefineLabel()
Dim tru169 As System.Reflection.Emit.Label = checkVarAsIL.DefineLabel()
Dim cont169 As System.Reflection.Emit.Label = checkVarAsIL.DefineLabel()
checkVarAsIL.Emit(OpCodes.Beq, fa169)
checkVarAsIL.Emit(OpCodes.Br, tru169)
checkVarAsIL.MarkLabel(tru169)
checkVarAsIL.MarkSequencePoint(doc5, 593, 1, 593, 100)
Dim locbldr242 As LocalBuilder = checkVarAsIL.DeclareLocal(GetType(Token))
...
Dim locbldr243 As LocalBuilder = checkVarAsIL.DeclareLocal(GetType(TypeTok))
...
checkVarAsIL.Emit(OpCodes.Br, cont169)
checkVarAsIL.MarkLabel(fa169)
...
checkVarAsIL.Emit(OpCodes.Br, cont169)
checkVarAsIL.MarkLabel(cont169)
checkVarAsIL.MarkSequencePoint(doc5, 602, 1, 602, 100)
checkVarAsIL.Emit(OpCodes.Br, cont168)
checkVarAsIL.MarkLabel(fa168)
checkVarAsIL.Emit(OpCodes.Br, cont168)
checkVarAsIL.MarkLabel(cont168)
...
Dim locbldr244 As LocalBuilder = AssOptIL.DeclareLocal(GetType(AssignStmt))
locbldr244.SetLocalSymInfo("asss")
AssOptIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
AssOptIL.Emit(OpCodes.Stloc, 0)
AssOptIL.MarkSequencePoint(doc5, 609, 1, 609, 100)
Dim locbldr245 As LocalBuilder = AssOptIL.DeclareLocal(GetType(Expr))
locbldr245.SetLocalSymInfo("le")
...
Dim locbldr246 As LocalBuilder = AssOptIL.DeclareLocal(GetType(Token))
...
Dim locbldr247 As LocalBuilder = AssOptIL.DeclareLocal(GetType(System.Type))
...
Dim locbldr248 As LocalBuilder = AssOptIL.DeclareLocal(GetType(System.Boolean))
locbldr248.SetLocalSymInfo("b")
Dim typ108(-1) As Type
...
Dim locbldr249 As LocalBuilder = AssOptIL.DeclareLocal(GetType(VarAsgnStmt))
locbldr249.SetLocalSymInfo("vass")
...
Typ = GetType(System.Boolean)
Dim fa170 As System.Reflection.Emit.Label = AssOptIL.DefineLabel()
Dim tru170 As System.Reflection.Emit.Label = AssOptIL.DefineLabel()
Dim cont170 As System.Reflection.Emit.Label = AssOptIL.DefineLabel()
AssOptIL.Emit(OpCodes.Beq, tru170)
AssOptIL.Emit(OpCodes.Br, fa170)
AssOptIL.MarkLabel(tru170)
...
Dim locbldr250 As LocalBuilder = AssOptIL.DeclareLocal(GetType(Token))
locbldr250.SetLocalSymInfo("tok2")
AssOptIL.Emit(OpCodes.Ldloc, 1)
Typ = GetType(Expr)
AssOptIL.Emit(OpCodes.Ldfld, GetType(Expr).GetField("Tokens"))
Typ = GetType(Expr).GetField("Tokens").FieldType
...
Dim locbldr251 As LocalBuilder = AssOptIL.DeclareLocal(GetType(System.Type))
locbldr251.SetLocalSymInfo("typ2")
...
Dim locbldr252 As LocalBuilder = AssOptIL.DeclareLocal(GetType(System.Boolean))
locbldr252.SetLocalSymInfo("b2")
Dim typ110(-1) As Type
...
AssOptIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa171 As System.Reflection.Emit.Label = AssOptIL.DefineLabel()
Dim tru171 As System.Reflection.Emit.Label = AssOptIL.DefineLabel()
Dim cont171 As System.Reflection.Emit.Label = AssOptIL.DefineLabel()
AssOptIL.Emit(OpCodes.Beq, fa171)
AssOptIL.Emit(OpCodes.Br, tru171)
AssOptIL.MarkLabel(tru171)
AssOptIL.MarkSequencePoint(doc5, 624, 1, 624, 100)
Dim locbldr253 As LocalBuilder = AssOptIL.DeclareLocal(GetType(Token))
locbldr253.SetLocalSymInfo("t")
AssOptIL.Emit(OpCodes.Ldloc, 1)
Typ = GetType(Expr)
AssOptIL.Emit(OpCodes.Ldfld, GetType(Expr).GetField("Tokens"))
Typ = GetType(Expr).GetField("Tokens").FieldType
...
Dim locbldr254 As LocalBuilder = AssOptIL.DeclareLocal(GetType(TypeTok))
locbldr254.SetLocalSymInfo("tt")
...
AssOptIL.Emit(OpCodes.Br, cont171)
AssOptIL.MarkLabel(fa171)
...
Dim locbldr255 As LocalBuilder = AssOptIL.DeclareLocal(asm.GetType("dylan.NET.Tokenizer.Parser.ExprOptimizer"))
...
Dim locbldr256 As LocalBuilder = checkAssignIL.DeclareLocal(GetType(Token))
locbldr256.SetLocalSymInfo("tok")
checkAssignIL.Emit(OpCodes.Ldnull)
checkAssignIL.Emit(OpCodes.Stloc, 0)
checkAssignIL.MarkSequencePoint(doc5, 646, 1, 646, 100)
Dim locbldr257 As LocalBuilder = checkAssignIL.DeclareLocal(GetType(System.Type))
locbldr257.SetLocalSymInfo("typ")
...
Dim locbldr258 As LocalBuilder = checkAssignIL.DeclareLocal(GetType(AssignStmt))
locbldr258.SetLocalSymInfo("asss")
...
Dim locbldr259 As LocalBuilder = checkAssignIL.DeclareLocal(GetType(System.Boolean))
locbldr259.SetLocalSymInfo("c")
checkAssignIL.Emit(OpCodes.Ldc_I4, 0)
Typ = GetType(System.Boolean)
checkAssignIL.Emit(OpCodes.Stloc, 3)
checkAssignIL.MarkSequencePoint(doc5, 649, 1, 649, 100)
Dim locbldr260 As LocalBuilder = checkAssignIL.DeclareLocal(GetType(Expr))
locbldr260.SetLocalSymInfo("re")
...
Dim locbldr261 As LocalBuilder = checkAssignIL.DeclareLocal(GetType(Expr))
locbldr261.SetLocalSymInfo("le")
checkAssignIL.Emit(OpCodes.Newobj, GetType(Expr).GetConstructor(Type.EmptyTypes))
checkAssignIL.Emit(OpCodes.Stloc, 5)
checkAssignIL.MarkSequencePoint(doc5, 651, 1, 651, 100)
Dim locbldr262 As LocalBuilder = checkAssignIL.DeclareLocal(GetType(System.Int32))
locbldr262.SetLocalSymInfo("i")
...
Dim locbldr263 As LocalBuilder = checkAssignIL.DeclareLocal(GetType(System.Int32))
locbldr263.SetLocalSymInfo("len")
...
locbldr264.SetLocalSymInfo("assind")
...
Typ = GetType(System.Boolean)
Dim fa172 As System.Reflection.Emit.Label = checkAssignIL.DefineLabel()
Dim tru172 As System.Reflection.Emit.Label = checkAssignIL.DefineLabel()
Dim cont172 As System.Reflection.Emit.Label = checkAssignIL.DefineLabel()
checkAssignIL.Emit(OpCodes.Beq, tru172)
checkAssignIL.Emit(OpCodes.Br, fa172)
checkAssignIL.MarkLabel(tru172)
...
checkAssignIL.Emit(OpCodes.Br, cont172)
checkAssignIL.MarkLabel(fa172)
checkAssignIL.Emit(OpCodes.Br, cont172)
checkAssignIL.MarkLabel(cont172)
checkAssignIL.MarkSequencePoint(doc5, 670, 1, 670, 100)
checkAssignIL.Emit(OpCodes.Ldloc, 6)
Typ = GetType(System.Int32)
checkAssignIL.Emit(OpCodes.Ldloc, 7)
Typ = GetType(System.Int32)
Dim fa173 As System.Reflection.Emit.Label = checkAssignIL.DefineLabel()
Dim tru173 As System.Reflection.Emit.Label = checkAssignIL.DefineLabel()
Dim cont173 As System.Reflection.Emit.Label = checkAssignIL.DefineLabel()
checkAssignIL.Emit(OpCodes.Beq, tru173)
checkAssignIL.Emit(OpCodes.Br, fa173)
checkAssignIL.MarkLabel(tru173)
checkAssignIL.MarkSequencePoint(doc5, 671, 1, 671, 100)
checkAssignIL.Emit(OpCodes.Br, label13)
checkAssignIL.MarkSequencePoint(doc5, 672, 1, 672, 100)
checkAssignIL.Emit(OpCodes.Br, cont173)
checkAssignIL.MarkLabel(fa173)
...
checkAssignIL.Emit(OpCodes.Br, cont173)
checkAssignIL.MarkLabel(cont173)
...
checkAssignIL.Emit(OpCodes.Beq, fa174)
checkAssignIL.Emit(OpCodes.Br, tru174)
...
checkAssignIL.Emit(OpCodes.Beq, tru176)
checkAssignIL.Emit(OpCodes.Br, fa176)
...
Dim locbldr265 As LocalBuilder = checkAssignIL.DeclareLocal(asm.GetType("dylan.NET.Tokenizer.Parser.ExprOptimizer"))
locbldr265.SetLocalSymInfo("eop")
...
Dim locbldr266 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(System.Int32))
locbldr266.SetLocalSymInfo("i")
OptimizeIL.Emit(OpCodes.Ldc_I4, CInt(-1))
Typ = GetType(System.Int32)
OptimizeIL.Emit(OpCodes.Stloc, 0)
OptimizeIL.MarkSequencePoint(doc5, 749, 1, 749, 100)
Dim locbldr267 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(System.Int32))
locbldr267.SetLocalSymInfo("len")
OptimizeIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
...
Dim locbldr268 As LocalBuilder = OptimizeIL.DeclareLocal(asm.GetType("dylan.NET.Tokenizer.Parser.TokenOptimizer"))
locbldr268.SetLocalSymInfo("to")
OptimizeIL.Emit(OpCodes.Ldnull)
OptimizeIL.Emit(OpCodes.Stloc, 2)
OptimizeIL.MarkSequencePoint(doc5, 751, 1, 751, 100)
Dim locbldr269 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(Stmt))
locbldr269.SetLocalSymInfo("tmpstm")
OptimizeIL.Emit(OpCodes.Ldnull)
OptimizeIL.Emit(OpCodes.Stloc, 3)
OptimizeIL.MarkSequencePoint(doc5, 752, 1, 752, 100)
Dim locbldr270 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(System.Boolean))
locbldr270.SetLocalSymInfo("compb")
OptimizeIL.Emit(OpCodes.Ldc_I4, 0)
Typ = GetType(System.Boolean)
OptimizeIL.Emit(OpCodes.Stloc, 4)
...
OptimizeIL.Emit(OpCodes.Blt, tru177)
...
Dim locbldr271 As LocalBuilder = ParseIL.DeclareLocal(GetType(System.Int32))
locbldr271.SetLocalSymInfo("i")
ParseIL.Emit(OpCodes.Ldc_I4, CInt(-1))
Typ = GetType(System.Int32)
ParseIL.Emit(OpCodes.Stloc, 0)
ParseIL.MarkSequencePoint(doc6, 5, 1, 5, 100)
Dim locbldr272 As LocalBuilder = ParseIL.DeclareLocal(asm.GetType("dylan.NET.Tokenizer.Parser.StmtOptimizer"))
locbldr272.SetLocalSymInfo("so")
...
ParseIL.Emit(OpCodes.Ldloc, 2)
Typ = GetType(System.Int32)
Dim fa197 As System.Reflection.Emit.Label = ParseIL.DefineLabel()
Dim tru197 As System.Reflection.Emit.Label = ParseIL.DefineLabel()
Dim cont197 As System.Reflection.Emit.Label = ParseIL.DefineLabel()
ParseIL.Emit(OpCodes.Beq, tru197)
ParseIL.Emit(OpCodes.Br, fa197)
ParseIL.MarkLabel(tru197)
ParseIL.MarkSequencePoint(doc6, 19, 1, 19, 100)
ParseIL.Emit(OpCodes.Br, label1)
ParseIL.MarkSequencePoint(doc6, 20, 1, 20, 100)
ParseIL.Emit(OpCodes.Br, cont197)
ParseIL.MarkLabel(fa197)
ParseIL.MarkSequencePoint(doc6, 21, 1, 21, 100)
ParseIL.Emit(OpCodes.Br, label0)
ParseIL.MarkSequencePoint(doc6, 22, 1, 22, 100)
ParseIL.Emit(OpCodes.Br, cont197)
ParseIL.MarkLabel(cont197)
