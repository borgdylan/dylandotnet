...
Dim locbldr70 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(DoubleTok))
locbldr70.SetLocalSymInfo("dbltok")
...
Dim locbldr71 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(BooleanTok))
locbldr71.SetLocalSymInfo("booltok")
...
Dim locbldr72 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(CharTok))
locbldr72.SetLocalSymInfo("chrtok")
...
Dim locbldr73 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(SingleTok))
locbldr73.SetLocalSymInfo("sngtok")
...
Dim locbldr74 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(SByteTok))
locbldr74.SetLocalSymInfo("sbytok")
...
Dim locbldr75 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(ShortTok))
locbldr75.SetLocalSymInfo("shtok")
...
Dim locbldr76 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(LongTok))
locbldr76.SetLocalSymInfo("lngtok")
...
Dim locbldr77 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(ObjectTok))
locbldr77.SetLocalSymInfo("objtok")
...
Dim locbldr78 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(commentTok))
locbldr78.SetLocalSymInfo("comtok")
...
Dim locbldr79 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(BooleanLiteral))
locbldr79.SetLocalSymInfo("boolit")
...
Dim locbldr80 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(CharLiteral))
locbldr80.SetLocalSymInfo("chrlit")
...
OptimizeIL.Emit(OpCodes.Ldstr, "'")
Typ = GetType(System.String)
Dim typ91 As Type() = {Typ}
OptimizeIL.Emit(OpCodes.Call, GetType(System.Convert).GetMethod("ToChar", typ91))
Typ = GetType(System.Convert).GetMethod("ToChar", typ91).ReturnType
...
OptimizeIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("Trim", typ92))
Typ = Typ03.GetMethod("Trim", typ92).ReturnType
OptimizeIL.Emit(OpCodes.Stloc, 2)
...
Dim typ93 As Type() = {Typ}
OptimizeIL.Emit(OpCodes.Call, GetType(System.Convert).GetMethod("ToChar", typ93))
Typ = GetType(System.Convert).GetMethod("ToChar", typ93).ReturnType
...
ReDim Preserve typ94(UBound(typ94) + 1)
typ94(UBound(typ94)) = Typ
OptimizeIL.Emit(OpCodes.Call, GetType(String).GetMethod("Concat", typ94))
...
ReDim Preserve typ95(UBound(typ95) + 1)
typ95(UBound(typ95)) = Typ
OptimizeIL.Emit(OpCodes.Call, GetType(Utils.ParseUtils).GetMethod("LikeOP", typ95))
Typ = GetType(Utils.ParseUtils).GetMethod("LikeOP", typ95).ReturnType
OptimizeIL.Emit(OpCodes.Stloc, 1)
...
Dim locbldr81 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(StringLiteral))
locbldr81.SetLocalSymInfo("strlit")
...
OptimizeIL.Emit(OpCodes.Call, GetType(System.Convert).GetMethod("ToChar", typ96))
Typ = GetType(System.Convert).GetMethod("ToChar", typ96).ReturnType
OptimizeIL.Emit(OpCodes.Stelem, GetType(System.Char).MakeArrayType().GetElementType())
...
OptimizeIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("Trim", typ97))
Typ = Typ03.GetMethod("Trim", typ97).ReturnType
OptimizeIL.Emit(OpCodes.Stloc, 2)
...
ReDim Preserve typ100(UBound(typ100) + 1)
typ100(UBound(typ100)) = Typ
OptimizeIL.Emit(OpCodes.Call, GetType(Utils.ParseUtils).GetMethod("LikeOP", typ100))
Typ = GetType(Utils.ParseUtils).GetMethod("LikeOP", typ100).ReturnType
OptimizeIL.Emit(OpCodes.Stloc, 1)
...
OptimizeIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("EndsWith", typ101))
Typ = Typ03.GetMethod("EndsWith", typ101).ReturnType
OptimizeIL.Emit(OpCodes.Stloc, 1)
...
Dim locbldr82 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(DoubleLiteral))
locbldr82.SetLocalSymInfo("dlit2")
...
OptimizeIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("TrimEnd", typ103))
Typ = Typ03.GetMethod("TrimEnd", typ103).ReturnType
OptimizeIL.Emit(OpCodes.Stloc, 2)
...
OptimizeIL.Emit(OpCodes.Call, GetType(System.Convert).GetMethod("ToDouble", typ104))
Typ = GetType(System.Convert).GetMethod("ToDouble", typ104).ReturnType
...
OptimizeIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("EndsWith", typ108))
Typ = Typ03.GetMethod("EndsWith", typ108).ReturnType
OptimizeIL.Emit(OpCodes.Stloc, 1)
...
Dim locbldr83 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(FloatLiteral))
locbldr83.SetLocalSymInfo("flit")
...
OptimizeIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("TrimEnd", typ110))
Typ = Typ03.GetMethod("TrimEnd", typ110).ReturnType
OptimizeIL.Emit(OpCodes.Stloc, 2)
...
OptimizeIL.Emit(OpCodes.Call, GetType(System.Convert).GetMethod("ToSingle", typ111))
Typ = GetType(System.Convert).GetMethod("ToSingle", typ111).ReturnType
...
locbldr84.SetLocalSymInfo("dlit")
OptimizeIL.Emit(OpCodes.Newobj, GetType(DoubleLiteral).GetConstructor(Type.EmptyTypes))
...
Dim locbldr85 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(DoubleLiteral))
locbldr85.SetLocalSymInfo("dlit3")
OptimizeIL.Emit(OpCodes.Newobj, GetType(DoubleLiteral).GetConstructor(Type.EmptyTypes))
...
OptimizeIL.Emit(OpCodes.Call, GetType(System.Convert).GetMethod("ToDouble", typ122))
Typ = GetType(System.Convert).GetMethod("ToDouble", typ122).ReturnType
OptimizeIL.Emit(OpCodes.Stfld, GetType(DoubleLiteral).GetField("NumVal"))
...
OptimizeIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("EndsWith", typ126))
Typ = Typ03.GetMethod("EndsWith", typ126).ReturnType
OptimizeIL.Emit(OpCodes.Stloc, 1)
...
Dim locbldr86 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(FloatLiteral))
locbldr86.SetLocalSymInfo("flit2")
OptimizeIL.Emit(OpCodes.Newobj, GetType(FloatLiteral).GetConstructor(Type.EmptyTypes))
...
OptimizeIL.Emit(OpCodes.Call, GetType(System.Convert).GetMethod("ToChar", typ127))
Typ = GetType(System.Convert).GetMethod("ToChar", typ127).ReturnType
OptimizeIL.Emit(OpCodes.Stelem, GetType(System.Char).MakeArrayType().GetElementType())
...
OptimizeIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("TrimEnd", typ128))
Typ = Typ03.GetMethod("TrimEnd", typ128).ReturnType
OptimizeIL.Emit(OpCodes.Stloc, 2)
...
OptimizeIL.Emit(OpCodes.Call, GetType(System.Convert).GetMethod("ToSingle", typ129))
Typ = GetType(System.Convert).GetMethod("ToSingle", typ129).ReturnType
OptimizeIL.Emit(OpCodes.Stfld, GetType(FloatLiteral).GetField("NumVal"))
...
Dim locbldr87 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(IntLiteral))
locbldr87.SetLocalSymInfo("ilit2")
...
OptimizeIL.Emit(OpCodes.Call, GetType(System.Convert).GetMethod("ToInt32", typ136))
Typ = GetType(System.Convert).GetMethod("ToInt32", typ136).ReturnType
...
Dim locbldr88 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(LongLiteral))
locbldr88.SetLocalSymInfo("llit")
...
OptimizeIL.Emit(OpCodes.Call, GetType(System.Convert).GetMethod("ToInt64", typ143))
Typ = GetType(System.Convert).GetMethod("ToInt64", typ143).ReturnType
...
Dim locbldr89 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(ShortLiteral))
locbldr89.SetLocalSymInfo("slit")
...
OptimizeIL.Emit(OpCodes.Call, GetType(System.Convert).GetMethod("ToInt16", typ150))
Typ = GetType(System.Convert).GetMethod("ToInt16", typ150).ReturnType
...
OptimizeIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("EndsWith", typ154))
Typ = Typ03.GetMethod("EndsWith", typ154).ReturnType
OptimizeIL.Emit(OpCodes.Stloc, 1)
...
Dim locbldr90 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(SByteLiteral))
locbldr90.SetLocalSymInfo("blit")
...
OptimizeIL.Emit(OpCodes.Ldstr, "b")
Typ = GetType(System.String)
Dim typ155 As Type() = {Typ}
OptimizeIL.Emit(OpCodes.Call, GetType(System.Convert).GetMethod("ToChar", typ155))
Typ = GetType(System.Convert).GetMethod("ToChar", typ155).ReturnType
OptimizeIL.Emit(OpCodes.Stelem, GetType(System.Char).MakeArrayType().GetElementType())
...
OptimizeIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("TrimEnd", typ156))
Typ = Typ03.GetMethod("TrimEnd", typ156).ReturnType
OptimizeIL.Emit(OpCodes.Stloc, 2)
...
OptimizeIL.Emit(OpCodes.Call, GetType(System.Convert).GetMethod("ToSByte", typ157))
Typ = GetType(System.Convert).GetMethod("ToSByte", typ157).ReturnType
...
locbldr91.SetLocalSymInfo("ilit")
OptimizeIL.Emit(OpCodes.Newobj, GetType(IntLiteral).GetConstructor(Type.EmptyTypes))
...
Dim locbldr92 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(Ident))
locbldr92.SetLocalSymInfo("idt")
...
Dim locbldr93 As LocalBuilder = checkVarAsIL.DeclareLocal(GetType(Token))
locbldr93.SetLocalSymInfo("tok")
...
Dim locbldr94 As LocalBuilder = checkVarAsIL.DeclareLocal(GetType(System.Type))
...
Dim locbldr95 As LocalBuilder = checkVarAsIL.DeclareLocal(GetType(VarExpr))
locbldr95.SetLocalSymInfo("vars")
...
Dim locbldr96 As LocalBuilder = checkVarAsIL.DeclareLocal(GetType(Token))
locbldr96.SetLocalSymInfo("tok2")
checkVarAsIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Expr)
checkVarAsIL.Emit(OpCodes.Ldfld, GetType(Expr).GetField("Tokens"))
Typ = GetType(Expr).GetField("Tokens").FieldType
...
Dim locbldr97 As LocalBuilder = checkVarAsIL.DeclareLocal(GetType(System.Type))
locbldr97.SetLocalSymInfo("typ2")
...
Dim locbldr98 As LocalBuilder = checkVarAsIL.DeclareLocal(GetType(System.Boolean))
locbldr98.SetLocalSymInfo("b2")
Dim typ4(-1) As Type
...
Dim locbldr99 As LocalBuilder = checkVarAsIL.DeclareLocal(GetType(Token))
locbldr99.SetLocalSymInfo("t")
checkVarAsIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Expr)
checkVarAsIL.Emit(OpCodes.Ldfld, GetType(Expr).GetField("Tokens"))
Typ = GetType(Expr).GetField("Tokens").FieldType
...
Dim locbldr100 As LocalBuilder = checkVarAsIL.DeclareLocal(GetType(TypeTok))
locbldr100.SetLocalSymInfo("tt")
...
Dim locbldr101 As LocalBuilder = procMethodCallIL.DeclareLocal(GetType(MethodNameTok))
locbldr101.SetLocalSymInfo("mn")
...
Dim locbldr102 As LocalBuilder = procMethodCallIL.DeclareLocal(GetType(MethodCallTok))
locbldr102.SetLocalSymInfo("mct")
...
Dim locbldr103 As LocalBuilder = procMethodCallIL.DeclareLocal(GetType(Ident))
...
Dim locbldr104 As LocalBuilder = procMethodCallIL.DeclareLocal(GetType(Expr))
locbldr104.SetLocalSymInfo("ep2")
...
Dim locbldr105 As LocalBuilder = procMethodCallIL.DeclareLocal(GetType(System.Int32))
locbldr105.SetLocalSymInfo("lvl")
...
Dim locbldr106 As LocalBuilder = procMethodCallIL.DeclareLocal(GetType(System.Boolean))
locbldr106.SetLocalSymInfo("d")
...
Dim locbldr107 As LocalBuilder = procMethodCallIL.DeclareLocal(GetType(System.Int32))
...
Dim locbldr108 As LocalBuilder = procMethodCallIL.DeclareLocal(GetType(Token))
...
Dim locbldr109 As LocalBuilder = procMethodCallIL.DeclareLocal(GetType(System.Type))
...
procMethodCallIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa94 As System.Reflection.Emit.Label = procMethodCallIL.DefineLabel()
Dim tru94 As System.Reflection.Emit.Label = procMethodCallIL.DefineLabel()
Dim cont94 As System.Reflection.Emit.Label = procMethodCallIL.DefineLabel()
procMethodCallIL.Emit(OpCodes.Beq, tru94)
procMethodCallIL.Emit(OpCodes.Br, fa94)
procMethodCallIL.MarkLabel(tru94)
...
procMethodCallIL.Emit(OpCodes.Ldc_I4, CInt(0))
Typ = GetType(System.Int32)
Dim fa95 As System.Reflection.Emit.Label = procMethodCallIL.DefineLabel()
Dim tru95 As System.Reflection.Emit.Label = procMethodCallIL.DefineLabel()
Dim cont95 As System.Reflection.Emit.Label = procMethodCallIL.DefineLabel()
procMethodCallIL.Emit(OpCodes.Beq, tru95)
procMethodCallIL.Emit(OpCodes.Br, fa95)
procMethodCallIL.MarkLabel(tru95)
...
procMethodCallIL.Emit(OpCodes.Br, cont95)
procMethodCallIL.MarkLabel(fa95)
...
procMethodCallIL.Emit(OpCodes.Br, cont95)
procMethodCallIL.MarkLabel(cont95)
procMethodCallIL.MarkSequencePoint(doc4, 101, 1, 101, 100)
procMethodCallIL.Emit(OpCodes.Br, label2)
procMethodCallIL.MarkSequencePoint(doc4, 102, 1, 102, 100)
procMethodCallIL.Emit(OpCodes.Br, cont94)
procMethodCallIL.MarkLabel(fa94)
procMethodCallIL.Emit(OpCodes.Br, cont94)
procMethodCallIL.MarkLabel(cont94)
...
procMethodCallIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa96 As System.Reflection.Emit.Label = procMethodCallIL.DefineLabel()
Dim tru96 As System.Reflection.Emit.Label = procMethodCallIL.DefineLabel()
Dim cont96 As System.Reflection.Emit.Label = procMethodCallIL.DefineLabel()
procMethodCallIL.Emit(OpCodes.Beq, tru96)
procMethodCallIL.Emit(OpCodes.Br, fa96)
procMethodCallIL.MarkLabel(tru96)
...
procMethodCallIL.Emit(OpCodes.Br, cont96)
procMethodCallIL.MarkLabel(fa96)
procMethodCallIL.Emit(OpCodes.Br, cont96)
procMethodCallIL.MarkLabel(cont96)
...
procMethodCallIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa97 As System.Reflection.Emit.Label = procMethodCallIL.DefineLabel()
Dim tru97 As System.Reflection.Emit.Label = procMethodCallIL.DefineLabel()
Dim cont97 As System.Reflection.Emit.Label = procMethodCallIL.DefineLabel()
procMethodCallIL.Emit(OpCodes.Beq, tru97)
procMethodCallIL.Emit(OpCodes.Br, fa97)
procMethodCallIL.MarkLabel(tru97)
...
procMethodCallIL.Emit(OpCodes.Br, cont97)
procMethodCallIL.MarkLabel(fa97)
...
procMethodCallIL.Emit(OpCodes.Br, cont97)
procMethodCallIL.MarkLabel(cont97)
...
Dim locbldr112 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(System.Int32))
...
Dim locbldr113 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(System.Int32))
locbldr113.SetLocalSymInfo("i")
OptimizeIL.Emit(OpCodes.Ldc_I4, CInt(-1))
Typ = GetType(System.Int32)
OptimizeIL.Emit(OpCodes.Stloc, 1)
OptimizeIL.MarkSequencePoint(doc4, 165, 1, 165, 100)
Dim locbldr114 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(System.Int32))
locbldr114.SetLocalSymInfo("j")
OptimizeIL.Emit(OpCodes.Ldc_I4, CInt(-1))
Typ = GetType(System.Int32)
OptimizeIL.Emit(OpCodes.Stloc, 2)
...
Dim locbldr115 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(Token))
...
Dim locbldr116 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(System.Type))
locbldr116.SetLocalSymInfo("typ")
OptimizeIL.MarkSequencePoint(doc4, 183, 1, 183, 100)
Dim locbldr117 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(System.Boolean))
locbldr117.SetLocalSymInfo("b")
OptimizeIL.MarkSequencePoint(doc4, 184, 1, 184, 100)
Dim locbldr118 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(System.String))
...
OptimizeIL.Emit(OpCodes.Beq, fa103)
OptimizeIL.Emit(OpCodes.Br, tru103)
...
Dim locbldr120 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(TypeTok))
locbldr120.SetLocalSymInfo("ttk")
...
OptimizeIL.Emit(OpCodes.Beq, fa105)
OptimizeIL.Emit(OpCodes.Br, tru105)
OptimizeIL.MarkLabel(tru105)
OptimizeIL.MarkSequencePoint(doc4, 223, 1, 223, 100)
Dim locbldr121 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(Token))
locbldr121.SetLocalSymInfo("tk2")
OptimizeIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Expr)
OptimizeIL.Emit(OpCodes.Ldfld, GetType(Expr).GetField("Tokens"))
Typ = GetType(Expr).GetField("Tokens").FieldType
...
Dim locbldr122 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(TypeTok))
locbldr122.SetLocalSymInfo("ttk2")
OptimizeIL.Emit(OpCodes.Newobj, GetType(TypeTok).GetConstructor(Type.EmptyTypes))
OptimizeIL.Emit(OpCodes.Stloc, 10)
...
OptimizeIL.Emit(OpCodes.Beq, fa108)
OptimizeIL.Emit(OpCodes.Br, tru108)
...
OptimizeIL.Emit(OpCodes.Beq, fa110)
OptimizeIL.Emit(OpCodes.Br, tru110)
OptimizeIL.MarkLabel(tru110)
OptimizeIL.MarkSequencePoint(doc4, 262, 1, 262, 100)
Dim locbldr123 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(TypeTok))
locbldr123.SetLocalSymInfo("tt1")
OptimizeIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Expr)
OptimizeIL.Emit(OpCodes.Ldfld, GetType(Expr).GetField("Tokens"))
Typ = GetType(Expr).GetField("Tokens").FieldType
...
Dim locbldr124 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(Ident))
locbldr124.SetLocalSymInfo("id1")
OptimizeIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Expr)
OptimizeIL.Emit(OpCodes.Ldfld, GetType(Expr).GetField("Tokens"))
Typ = GetType(Expr).GetField("Tokens").FieldType
...
Dim locbldr125 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(CharLiteral))
locbldr125.SetLocalSymInfo("cl1")
OptimizeIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Expr)
OptimizeIL.Emit(OpCodes.Ldfld, GetType(Expr).GetField("Tokens"))
Typ = GetType(Expr).GetField("Tokens").FieldType
...
Dim locbldr126 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(StringLiteral))
locbldr126.SetLocalSymInfo("sl1")
OptimizeIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Expr)
OptimizeIL.Emit(OpCodes.Ldfld, GetType(Expr).GetField("Tokens"))
Typ = GetType(Expr).GetField("Tokens").FieldType
...
Dim locbldr127 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(BooleanLiteral))
locbldr127.SetLocalSymInfo("bl1")
OptimizeIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Expr)
OptimizeIL.Emit(OpCodes.Ldfld, GetType(Expr).GetField("Tokens"))
Typ = GetType(Expr).GetField("Tokens").FieldType
...
Dim locbldr128 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(NumberLiteral))
locbldr128.SetLocalSymInfo("nl1")
OptimizeIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Expr)
OptimizeIL.Emit(OpCodes.Ldfld, GetType(Expr).GetField("Tokens"))
Typ = GetType(Expr).GetField("Tokens").FieldType
...
Dim locbldr129 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(MethodCallTok))
locbldr129.SetLocalSymInfo("mct")
OptimizeIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Expr)
OptimizeIL.Emit(OpCodes.Ldfld, GetType(Expr).GetField("Tokens"))
Typ = GetType(Expr).GetField("Tokens").FieldType
...
Dim locbldr130 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(Expr).MakeArrayType())
locbldr130.SetLocalSymInfo("prs")
OptimizeIL.Emit(OpCodes.Ldloc, 17)
Typ = GetType(MethodCallTok)
...
Dim locbldr131 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(System.Int32))
locbldr131.SetLocalSymInfo("ln2")
OptimizeIL.Emit(OpCodes.Ldloc, 18)
...
Dim locbldr132 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(System.Int32))
locbldr132.SetLocalSymInfo("i2")
OptimizeIL.Emit(OpCodes.Ldc_I4, CInt(-1))
Typ = GetType(System.Int32)
OptimizeIL.Emit(OpCodes.Stloc, 20)
...
OptimizeIL.Emit(OpCodes.Blt, tru123)
...
OptimizeIL.Emit(OpCodes.Bgt, tru125)
...
Dim locbldr133 As LocalBuilder = checkRefasmIL.DeclareLocal(GetType(Token))
locbldr133.SetLocalSymInfo("tok")
...
Dim locbldr134 As LocalBuilder = checkRefasmIL.DeclareLocal(GetType(System.Type))
locbldr134.SetLocalSymInfo("typ")
...
Dim locbldr135 As LocalBuilder = checkRefasmIL.DeclareLocal(GetType(RefasmStmt))
locbldr135.SetLocalSymInfo("refasms")
...
Typ = GetType(System.Boolean)
Dim fa127 As System.Reflection.Emit.Label = checkRefasmIL.DefineLabel()
Dim tru127 As System.Reflection.Emit.Label = checkRefasmIL.DefineLabel()
Dim cont127 As System.Reflection.Emit.Label = checkRefasmIL.DefineLabel()
checkRefasmIL.Emit(OpCodes.Beq, tru127)
checkRefasmIL.Emit(OpCodes.Br, fa127)
checkRefasmIL.MarkLabel(tru127)
...
checkRefasmIL.Emit(OpCodes.Br, cont127)
checkRefasmIL.MarkLabel(fa127)
checkRefasmIL.Emit(OpCodes.Br, cont127)
checkRefasmIL.MarkLabel(cont127)
...
Dim locbldr136 As LocalBuilder = checkDebugIL.DeclareLocal(GetType(Token))
...
Dim locbldr137 As LocalBuilder = checkDebugIL.DeclareLocal(GetType(System.Type))
...
Dim locbldr138 As LocalBuilder = checkDebugIL.DeclareLocal(GetType(DebugStmt))
...
Typ = GetType(System.Boolean)
Dim fa128 As System.Reflection.Emit.Label = checkDebugIL.DefineLabel()
Dim tru128 As System.Reflection.Emit.Label = checkDebugIL.DefineLabel()
Dim cont128 As System.Reflection.Emit.Label = checkDebugIL.DefineLabel()
checkDebugIL.Emit(OpCodes.Beq, tru128)
checkDebugIL.Emit(OpCodes.Br, fa128)
checkDebugIL.MarkLabel(tru128)
...
checkDebugIL.Emit(OpCodes.Br, cont128)
checkDebugIL.MarkLabel(fa128)
checkDebugIL.Emit(OpCodes.Br, cont128)
checkDebugIL.MarkLabel(cont128)
...
Dim locbldr139 As LocalBuilder = checkImportIL.DeclareLocal(GetType(Token))
...
Dim locbldr140 As LocalBuilder = checkImportIL.DeclareLocal(GetType(System.Type))
...
Dim locbldr141 As LocalBuilder = checkImportIL.DeclareLocal(GetType(ImportStmt))
locbldr141.SetLocalSymInfo("imps")
...
Typ = GetType(System.Boolean)
Dim fa129 As System.Reflection.Emit.Label = checkImportIL.DefineLabel()
Dim tru129 As System.Reflection.Emit.Label = checkImportIL.DefineLabel()
Dim cont129 As System.Reflection.Emit.Label = checkImportIL.DefineLabel()
checkImportIL.Emit(OpCodes.Beq, tru129)
checkImportIL.Emit(OpCodes.Br, fa129)
checkImportIL.MarkLabel(tru129)
...
checkImportIL.Emit(OpCodes.Br, cont129)
checkImportIL.MarkLabel(fa129)
checkImportIL.Emit(OpCodes.Br, cont129)
checkImportIL.MarkLabel(cont129)
...
Dim locbldr142 As LocalBuilder = checkLocimportIL.DeclareLocal(GetType(Token))
locbldr142.SetLocalSymInfo("tok")
...
Dim locbldr143 As LocalBuilder = checkLocimportIL.DeclareLocal(GetType(System.Type))
locbldr143.SetLocalSymInfo("typ")
...
Dim locbldr144 As LocalBuilder = checkLocimportIL.DeclareLocal(GetType(LocimportStmt))
locbldr144.SetLocalSymInfo("limps")
...
Typ = GetType(System.Boolean)
Dim fa130 As System.Reflection.Emit.Label = checkLocimportIL.DefineLabel()
Dim tru130 As System.Reflection.Emit.Label = checkLocimportIL.DefineLabel()
Dim cont130 As System.Reflection.Emit.Label = checkLocimportIL.DefineLabel()
checkLocimportIL.Emit(OpCodes.Beq, tru130)
checkLocimportIL.Emit(OpCodes.Br, fa130)
checkLocimportIL.MarkLabel(tru130)
...
checkLocimportIL.Emit(OpCodes.Br, cont130)
checkLocimportIL.MarkLabel(fa130)
checkLocimportIL.Emit(OpCodes.Br, cont130)
checkLocimportIL.MarkLabel(cont130)
...
Dim locbldr145 As LocalBuilder = checkCmtIL.DeclareLocal(GetType(Token))
...
Dim locbldr146 As LocalBuilder = checkCmtIL.DeclareLocal(GetType(System.Type))
...
Dim locbldr147 As LocalBuilder = checkCmtIL.DeclareLocal(GetType(CommentStmt))
locbldr147.SetLocalSymInfo("cmts")
...
Typ = GetType(System.Boolean)
Dim fa131 As System.Reflection.Emit.Label = checkCmtIL.DefineLabel()
Dim tru131 As System.Reflection.Emit.Label = checkCmtIL.DefineLabel()
Dim cont131 As System.Reflection.Emit.Label = checkCmtIL.DefineLabel()
checkCmtIL.Emit(OpCodes.Beq, tru131)
checkCmtIL.Emit(OpCodes.Br, fa131)
checkCmtIL.MarkLabel(tru131)
...
checkCmtIL.Emit(OpCodes.Br, cont131)
checkCmtIL.MarkLabel(fa131)
checkCmtIL.Emit(OpCodes.Br, cont131)
checkCmtIL.MarkLabel(cont131)
...
Typ = GetType(System.Int32)
Dim fa132 As System.Reflection.Emit.Label = checkEndMtdIL.DefineLabel()
Dim tru132 As System.Reflection.Emit.Label = checkEndMtdIL.DefineLabel()
Dim cont132 As System.Reflection.Emit.Label = checkEndMtdIL.DefineLabel()
checkEndMtdIL.Emit(OpCodes.Bge, tru132)
checkEndMtdIL.Emit(OpCodes.Br, fa132)
checkEndMtdIL.MarkLabel(tru132)
checkEndMtdIL.MarkSequencePoint(doc5, 72, 1, 72, 100)
Dim locbldr148 As LocalBuilder = checkEndMtdIL.DeclareLocal(GetType(Token))
locbldr148.SetLocalSymInfo("tok1")
checkEndMtdIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
checkEndMtdIL.Emit(OpCodes.Ldfld, GetType(Stmt).GetField("Tokens"))
Typ = GetType(Stmt).GetField("Tokens").FieldType
...
Dim locbldr149 As LocalBuilder = checkEndMtdIL.DeclareLocal(GetType(System.Type))
locbldr149.SetLocalSymInfo("typ1")
...
Dim locbldr150 As LocalBuilder = checkEndMtdIL.DeclareLocal(GetType(System.Boolean))
locbldr150.SetLocalSymInfo("b1")
Dim typ18(-1) As Type
...
Dim locbldr151 As LocalBuilder = checkEndMtdIL.DeclareLocal(GetType(Token))
locbldr151.SetLocalSymInfo("tok2")
checkEndMtdIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
checkEndMtdIL.Emit(OpCodes.Ldfld, GetType(Stmt).GetField("Tokens"))
Typ = GetType(Stmt).GetField("Tokens").FieldType
...
Dim locbldr152 As LocalBuilder = checkEndMtdIL.DeclareLocal(GetType(System.Type))
locbldr152.SetLocalSymInfo("typ2")
...
Dim locbldr153 As LocalBuilder = checkEndMtdIL.DeclareLocal(GetType(System.Boolean))
locbldr153.SetLocalSymInfo("b2")
Dim typ20(-1) As Type
...
Dim locbldr154 As LocalBuilder = checkEndMtdIL.DeclareLocal(GetType(EndMethodStmt))
locbldr154.SetLocalSymInfo("ems")
...
Typ = GetType(System.Boolean)
Dim fa133 As System.Reflection.Emit.Label = checkEndMtdIL.DefineLabel()
Dim tru133 As System.Reflection.Emit.Label = checkEndMtdIL.DefineLabel()
Dim cont133 As System.Reflection.Emit.Label = checkEndMtdIL.DefineLabel()
checkEndMtdIL.Emit(OpCodes.Beq, tru133)
checkEndMtdIL.Emit(OpCodes.Br, fa133)
checkEndMtdIL.MarkLabel(tru133)
...
checkEndMtdIL.Emit(OpCodes.Br, cont133)
checkEndMtdIL.MarkLabel(fa133)
checkEndMtdIL.Emit(OpCodes.Br, cont133)
checkEndMtdIL.MarkLabel(cont133)
checkEndMtdIL.MarkSequencePoint(doc5, 87, 1, 87, 100)
checkEndMtdIL.Emit(OpCodes.Br, cont132)
checkEndMtdIL.MarkLabel(fa132)
checkEndMtdIL.Emit(OpCodes.Br, cont132)
checkEndMtdIL.MarkLabel(cont132)
...
Typ = GetType(System.Int32)
Dim fa134 As System.Reflection.Emit.Label = checkEndClsIL.DefineLabel()
Dim tru134 As System.Reflection.Emit.Label = checkEndClsIL.DefineLabel()
Dim cont134 As System.Reflection.Emit.Label = checkEndClsIL.DefineLabel()
checkEndClsIL.Emit(OpCodes.Bge, tru134)
checkEndClsIL.Emit(OpCodes.Br, fa134)
checkEndClsIL.MarkLabel(tru134)
checkEndClsIL.MarkSequencePoint(doc5, 94, 1, 94, 100)
Dim locbldr155 As LocalBuilder = checkEndClsIL.DeclareLocal(GetType(Token))
locbldr155.SetLocalSymInfo("tok1")
checkEndClsIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
checkEndClsIL.Emit(OpCodes.Ldfld, GetType(Stmt).GetField("Tokens"))
Typ = GetType(Stmt).GetField("Tokens").FieldType
...
Dim locbldr156 As LocalBuilder = checkEndClsIL.DeclareLocal(GetType(System.Type))
locbldr156.SetLocalSymInfo("typ1")
...
Dim locbldr157 As LocalBuilder = checkEndClsIL.DeclareLocal(GetType(System.Boolean))
locbldr157.SetLocalSymInfo("b1")
Dim typ23(-1) As Type
...
Dim locbldr158 As LocalBuilder = checkEndClsIL.DeclareLocal(GetType(Token))
locbldr158.SetLocalSymInfo("tok2")
checkEndClsIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
checkEndClsIL.Emit(OpCodes.Ldfld, GetType(Stmt).GetField("Tokens"))
Typ = GetType(Stmt).GetField("Tokens").FieldType
...
Dim locbldr159 As LocalBuilder = checkEndClsIL.DeclareLocal(GetType(System.Type))
locbldr159.SetLocalSymInfo("typ2")
...
Dim locbldr160 As LocalBuilder = checkEndClsIL.DeclareLocal(GetType(System.Boolean))
locbldr160.SetLocalSymInfo("b2")
Dim typ25(-1) As Type
...
Dim locbldr161 As LocalBuilder = checkEndClsIL.DeclareLocal(GetType(EndClassStmt))
locbldr161.SetLocalSymInfo("ecs")
...
Typ = GetType(System.Boolean)
Dim fa135 As System.Reflection.Emit.Label = checkEndClsIL.DefineLabel()
Dim tru135 As System.Reflection.Emit.Label = checkEndClsIL.DefineLabel()
Dim cont135 As System.Reflection.Emit.Label = checkEndClsIL.DefineLabel()
checkEndClsIL.Emit(OpCodes.Beq, tru135)
checkEndClsIL.Emit(OpCodes.Br, fa135)
checkEndClsIL.MarkLabel(tru135)
...
checkEndClsIL.Emit(OpCodes.Br, cont135)
checkEndClsIL.MarkLabel(fa135)
checkEndClsIL.Emit(OpCodes.Br, cont135)
checkEndClsIL.MarkLabel(cont135)
checkEndClsIL.MarkSequencePoint(doc5, 109, 1, 109, 100)
checkEndClsIL.Emit(OpCodes.Br, cont134)
checkEndClsIL.MarkLabel(fa134)
checkEndClsIL.Emit(OpCodes.Br, cont134)
checkEndClsIL.MarkLabel(cont134)
...
Dim locbldr162 As LocalBuilder = checkAssemblyIL.DeclareLocal(GetType(Token))
locbldr162.SetLocalSymInfo("tok")
...
Dim locbldr163 As LocalBuilder = checkAssemblyIL.DeclareLocal(GetType(System.Type))
...
Dim locbldr164 As LocalBuilder = checkAssemblyIL.DeclareLocal(GetType(AssemblyStmt))
locbldr164.SetLocalSymInfo("asms")
...
Typ = GetType(System.Boolean)
Dim fa136 As System.Reflection.Emit.Label = checkAssemblyIL.DefineLabel()
Dim tru136 As System.Reflection.Emit.Label = checkAssemblyIL.DefineLabel()
Dim cont136 As System.Reflection.Emit.Label = checkAssemblyIL.DefineLabel()
checkAssemblyIL.Emit(OpCodes.Beq, tru136)
checkAssemblyIL.Emit(OpCodes.Br, fa136)
checkAssemblyIL.MarkLabel(tru136)
...
checkAssemblyIL.Emit(OpCodes.Br, cont136)
checkAssemblyIL.MarkLabel(fa136)
checkAssemblyIL.Emit(OpCodes.Br, cont136)
checkAssemblyIL.MarkLabel(cont136)
...
Dim locbldr165 As LocalBuilder = checkVerIL.DeclareLocal(GetType(Token))
locbldr165.SetLocalSymInfo("tok")
...
Dim locbldr166 As LocalBuilder = checkVerIL.DeclareLocal(GetType(System.Type))
...
Dim locbldr167 As LocalBuilder = checkVerIL.DeclareLocal(GetType(VerStmt))
locbldr167.SetLocalSymInfo("vers")
...
Typ = GetType(System.Boolean)
Dim fa137 As System.Reflection.Emit.Label = checkVerIL.DefineLabel()
Dim tru137 As System.Reflection.Emit.Label = checkVerIL.DefineLabel()
Dim cont137 As System.Reflection.Emit.Label = checkVerIL.DefineLabel()
checkVerIL.Emit(OpCodes.Beq, tru137)
checkVerIL.Emit(OpCodes.Br, fa137)
checkVerIL.MarkLabel(tru137)
...
Dim locbldr168 As LocalBuilder = checkVerIL.DeclareLocal(GetType(System.String).MakeArrayType())
locbldr168.SetLocalSymInfo("ars")
Dim typ32(-1) As Type
checkVerIL.Emit(OpCodes.Ldloc, 0)
Typ = GetType(Token)
...
Dim locbldr169 As LocalBuilder = checkVerIL.DeclareLocal(GetType(System.Int32).MakeArrayType())
locbldr169.SetLocalSymInfo("ari")
...
Dim locbldr170 As LocalBuilder = checkVerIL.DeclareLocal(GetType(IntLiteral).MakeArrayType())
locbldr170.SetLocalSymInfo("intla")
checkVerIL.Emit(OpCodes.Ldc_I4, CInt(4))
Typ = GetType(System.Int32)
checkVerIL.Emit(OpCodes.Conv_U)
...
Dim locbldr171 As LocalBuilder = checkVerIL.DeclareLocal(GetType(IntLiteral))
locbldr171.SetLocalSymInfo("intl")
...
checkVerIL.Emit(OpCodes.Br, cont137)
checkVerIL.MarkLabel(fa137)
checkVerIL.Emit(OpCodes.Br, cont137)
checkVerIL.MarkLabel(cont137)
...
Dim locbldr172 As LocalBuilder = checkClassIL.DeclareLocal(GetType(Token))
...
Dim locbldr173 As LocalBuilder = checkClassIL.DeclareLocal(GetType(System.Type))
...
Dim locbldr174 As LocalBuilder = checkClassIL.DeclareLocal(GetType(ClassStmt))
locbldr174.SetLocalSymInfo("clss")
...
Dim locbldr175 As LocalBuilder = checkClassIL.DeclareLocal(GetType(Attributes.Attribute))
locbldr175.SetLocalSymInfo("att")
...
Typ = GetType(System.Boolean)
Dim fa138 As System.Reflection.Emit.Label = checkClassIL.DefineLabel()
Dim tru138 As System.Reflection.Emit.Label = checkClassIL.DefineLabel()
Dim cont138 As System.Reflection.Emit.Label = checkClassIL.DefineLabel()
checkClassIL.Emit(OpCodes.Beq, tru138)
checkClassIL.Emit(OpCodes.Br, fa138)
checkClassIL.MarkLabel(tru138)
...
Dim locbldr176 As LocalBuilder = checkClassIL.DeclareLocal(GetType(System.Int32))
locbldr176.SetLocalSymInfo("i")
checkClassIL.Emit(OpCodes.Ldc_I4, CInt(0))
Typ = GetType(System.Int32)
checkClassIL.Emit(OpCodes.Stloc, 4)
checkClassIL.MarkSequencePoint(doc5, 180, 1, 180, 100)
Dim locbldr177 As LocalBuilder = checkClassIL.DeclareLocal(GetType(System.Int32))
...
Dim locbldr178 As LocalBuilder = checkClassIL.DeclareLocal(GetType(System.Boolean))
locbldr178.SetLocalSymInfo("bl")
...
checkClassIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa139 As System.Reflection.Emit.Label = checkClassIL.DefineLabel()
Dim tru139 As System.Reflection.Emit.Label = checkClassIL.DefineLabel()
Dim cont139 As System.Reflection.Emit.Label = checkClassIL.DefineLabel()
checkClassIL.Emit(OpCodes.Beq, tru139)
checkClassIL.Emit(OpCodes.Br, fa139)
checkClassIL.MarkLabel(tru139)
...
checkClassIL.Emit(OpCodes.Br, cont139)
checkClassIL.MarkLabel(fa139)
checkClassIL.MarkSequencePoint(doc5, 195, 1, 195, 100)
Dim locbldr179 As LocalBuilder = checkClassIL.DeclareLocal(GetType(Token))
locbldr179.SetLocalSymInfo("tok2")
checkClassIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
checkClassIL.Emit(OpCodes.Ldfld, GetType(Stmt).GetField("Tokens"))
Typ = GetType(Stmt).GetField("Tokens").FieldType
...
Dim locbldr180 As LocalBuilder = checkClassIL.DeclareLocal(GetType(System.Type))
locbldr180.SetLocalSymInfo("typ2")
...
Dim locbldr181 As LocalBuilder = checkClassIL.DeclareLocal(GetType(System.Boolean))
locbldr181.SetLocalSymInfo("b2")
Dim typ48(-1) As Type
...
checkClassIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa140 As System.Reflection.Emit.Label = checkClassIL.DefineLabel()
Dim tru140 As System.Reflection.Emit.Label = checkClassIL.DefineLabel()
Dim cont140 As System.Reflection.Emit.Label = checkClassIL.DefineLabel()
checkClassIL.Emit(OpCodes.Beq, tru140)
checkClassIL.Emit(OpCodes.Br, fa140)
checkClassIL.MarkLabel(tru140)
...
checkClassIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa141 As System.Reflection.Emit.Label = checkClassIL.DefineLabel()
Dim tru141 As System.Reflection.Emit.Label = checkClassIL.DefineLabel()
Dim cont141 As System.Reflection.Emit.Label = checkClassIL.DefineLabel()
checkClassIL.Emit(OpCodes.Beq, fa141)
checkClassIL.Emit(OpCodes.Br, tru141)
checkClassIL.MarkLabel(tru141)
checkClassIL.MarkSequencePoint(doc5, 206, 1, 206, 100)
Dim locbldr182 As LocalBuilder = checkClassIL.DeclareLocal(GetType(Token))
locbldr182.SetLocalSymInfo("t")
checkClassIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
checkClassIL.Emit(OpCodes.Ldfld, GetType(Stmt).GetField("Tokens"))
Typ = GetType(Stmt).GetField("Tokens").FieldType
...
Dim locbldr183 As LocalBuilder = checkClassIL.DeclareLocal(GetType(TypeTok))
locbldr183.SetLocalSymInfo("tt")
...
checkClassIL.Emit(OpCodes.Br, cont141)
checkClassIL.MarkLabel(fa141)
...
checkClassIL.Emit(OpCodes.Br, cont141)
checkClassIL.MarkLabel(cont141)
checkClassIL.MarkSequencePoint(doc5, 214, 1, 214, 100)
checkClassIL.Emit(OpCodes.Br, cont140)
checkClassIL.MarkLabel(fa140)
...
checkClassIL.Emit(OpCodes.Br, cont140)
checkClassIL.MarkLabel(cont140)
checkClassIL.MarkSequencePoint(doc5, 218, 1, 218, 100)
checkClassIL.Emit(OpCodes.Br, cont139)
checkClassIL.MarkLabel(cont139)
...
checkClassIL.Emit(OpCodes.Br, cont138)
checkClassIL.MarkLabel(fa138)
checkClassIL.Emit(OpCodes.Br, cont138)
checkClassIL.MarkLabel(cont138)
...
Dim locbldr184 As LocalBuilder = checkFieldIL.DeclareLocal(GetType(Token))
...
Dim locbldr185 As LocalBuilder = checkFieldIL.DeclareLocal(GetType(System.Type))
...
Dim locbldr186 As LocalBuilder = checkFieldIL.DeclareLocal(GetType(FieldStmt))
locbldr186.SetLocalSymInfo("flss")
...
Dim locbldr187 As LocalBuilder = checkFieldIL.DeclareLocal(GetType(Attributes.Attribute))
locbldr187.SetLocalSymInfo("att")
...
Typ = GetType(System.Boolean)
Dim fa143 As System.Reflection.Emit.Label = checkFieldIL.DefineLabel()
Dim tru143 As System.Reflection.Emit.Label = checkFieldIL.DefineLabel()
Dim cont143 As System.Reflection.Emit.Label = checkFieldIL.DefineLabel()
checkFieldIL.Emit(OpCodes.Beq, tru143)
checkFieldIL.Emit(OpCodes.Br, fa143)
checkFieldIL.MarkLabel(tru143)
checkFieldIL.MarkSequencePoint(doc5, 243, 1, 243, 100)
Dim locbldr188 As LocalBuilder = checkFieldIL.DeclareLocal(GetType(Expr))
locbldr188.SetLocalSymInfo("tempexp")
...
Dim locbldr189 As LocalBuilder = checkFieldIL.DeclareLocal(asm.GetType("dylan.NET.Tokenizer.Parser.ExprOptimizer"))
locbldr189.SetLocalSymInfo("eop")
...
Dim locbldr190 As LocalBuilder = checkFieldIL.DeclareLocal(GetType(System.Int32))
locbldr190.SetLocalSymInfo("i")
checkFieldIL.Emit(OpCodes.Ldc_I4, CInt(0))
Typ = GetType(System.Int32)
checkFieldIL.Emit(OpCodes.Stloc, 6)
checkFieldIL.MarkSequencePoint(doc5, 258, 1, 258, 100)
Dim locbldr191 As LocalBuilder = checkFieldIL.DeclareLocal(GetType(System.Int32))
...
Dim locbldr192 As LocalBuilder = checkFieldIL.DeclareLocal(GetType(System.Boolean))
locbldr192.SetLocalSymInfo("bl")
checkFieldIL.Emit(OpCodes.Ldc_I4, 0)
Typ = GetType(System.Boolean)
...
checkFieldIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa144 As System.Reflection.Emit.Label = checkFieldIL.DefineLabel()
Dim tru144 As System.Reflection.Emit.Label = checkFieldIL.DefineLabel()
Dim cont144 As System.Reflection.Emit.Label = checkFieldIL.DefineLabel()
checkFieldIL.Emit(OpCodes.Beq, tru144)
checkFieldIL.Emit(OpCodes.Br, fa144)
checkFieldIL.MarkLabel(tru144)
...
checkFieldIL.Emit(OpCodes.Br, cont144)
checkFieldIL.MarkLabel(fa144)
checkFieldIL.Emit(OpCodes.Br, cont144)
checkFieldIL.MarkLabel(cont144)
checkFieldIL.MarkSequencePoint(doc5, 273, 1, 273, 100)
checkFieldIL.Emit(OpCodes.Ldloc, 6)
Typ = GetType(System.Int32)
checkFieldIL.Emit(OpCodes.Ldloc, 7)
Typ = GetType(System.Int32)
Dim fa145 As System.Reflection.Emit.Label = checkFieldIL.DefineLabel()
Dim tru145 As System.Reflection.Emit.Label = checkFieldIL.DefineLabel()
Dim cont145 As System.Reflection.Emit.Label = checkFieldIL.DefineLabel()
checkFieldIL.Emit(OpCodes.Beq, tru145)
checkFieldIL.Emit(OpCodes.Br, fa145)
checkFieldIL.MarkLabel(tru145)
...
checkFieldIL.Emit(OpCodes.Br, cont145)
checkFieldIL.MarkLabel(fa145)
...
checkFieldIL.Emit(OpCodes.Br, cont145)
checkFieldIL.MarkLabel(cont145)
...
Dim locbldr193 As LocalBuilder = checkFieldIL.DeclareLocal(GetType(Token))
...
Dim locbldr194 As LocalBuilder = checkFieldIL.DeclareLocal(GetType(System.Type))
...
Dim locbldr195 As LocalBuilder = checkFieldIL.DeclareLocal(GetType(System.Boolean))
...
checkFieldIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa146 As System.Reflection.Emit.Label = checkFieldIL.DefineLabel()
Dim tru146 As System.Reflection.Emit.Label = checkFieldIL.DefineLabel()
Dim cont146 As System.Reflection.Emit.Label = checkFieldIL.DefineLabel()
checkFieldIL.Emit(OpCodes.Beq, fa146)
checkFieldIL.Emit(OpCodes.Br, tru146)
checkFieldIL.MarkLabel(tru146)
checkFieldIL.MarkSequencePoint(doc5, 287, 1, 287, 100)
Dim locbldr196 As LocalBuilder = checkFieldIL.DeclareLocal(GetType(Token))
locbldr196.SetLocalSymInfo("t")
checkFieldIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
checkFieldIL.Emit(OpCodes.Ldfld, GetType(Stmt).GetField("Tokens"))
Typ = GetType(Stmt).GetField("Tokens").FieldType
...
Dim locbldr197 As LocalBuilder = checkFieldIL.DeclareLocal(GetType(TypeTok))
locbldr197.SetLocalSymInfo("tt")
...
checkFieldIL.Emit(OpCodes.Br, cont146)
checkFieldIL.MarkLabel(fa146)
...
checkFieldIL.Emit(OpCodes.Br, cont146)
checkFieldIL.MarkLabel(cont146)
...
checkFieldIL.Emit(OpCodes.Br, cont143)
checkFieldIL.MarkLabel(fa143)
checkFieldIL.Emit(OpCodes.Br, cont143)
checkFieldIL.MarkLabel(cont143)
...
Dim locbldr198 As LocalBuilder = checkMethodIL.DeclareLocal(GetType(Token))
locbldr198.SetLocalSymInfo("tok")
...
Dim locbldr199 As LocalBuilder = checkMethodIL.DeclareLocal(GetType(System.Type))
locbldr199.SetLocalSymInfo("typ")
...
Dim locbldr200 As LocalBuilder = checkMethodIL.DeclareLocal(GetType(MethodStmt))
locbldr200.SetLocalSymInfo("mtss")
...
Dim locbldr201 As LocalBuilder = checkMethodIL.DeclareLocal(GetType(Attributes.Attribute))
locbldr201.SetLocalSymInfo("att")
...
Dim locbldr202 As LocalBuilder = checkMethodIL.DeclareLocal(GetType(Ident))
locbldr202.SetLocalSymInfo("mn")
...
Dim locbldr203 As LocalBuilder = checkMethodIL.DeclareLocal(GetType(Expr))
locbldr203.SetLocalSymInfo("exp")
checkMethodIL.Emit(OpCodes.Ldnull)
checkMethodIL.Emit(OpCodes.Stloc, 5)
checkMethodIL.MarkSequencePoint(doc5, 313, 1, 313, 100)
Dim locbldr204 As LocalBuilder = checkMethodIL.DeclareLocal(GetType(System.Boolean))
locbldr204.SetLocalSymInfo("d")
...
Typ = GetType(System.Boolean)
Dim fa147 As System.Reflection.Emit.Label = checkMethodIL.DefineLabel()
Dim tru147 As System.Reflection.Emit.Label = checkMethodIL.DefineLabel()
Dim cont147 As System.Reflection.Emit.Label = checkMethodIL.DefineLabel()
checkMethodIL.Emit(OpCodes.Beq, tru147)
checkMethodIL.Emit(OpCodes.Br, fa147)
checkMethodIL.MarkLabel(tru147)
checkMethodIL.MarkSequencePoint(doc5, 317, 1, 317, 100)
Dim locbldr205 As LocalBuilder = checkMethodIL.DeclareLocal(GetType(Expr))
locbldr205.SetLocalSymInfo("tempexp")
...
Dim locbldr206 As LocalBuilder = checkMethodIL.DeclareLocal(asm.GetType("dylan.NET.Tokenizer.Parser.ExprOptimizer"))
locbldr206.SetLocalSymInfo("eop")
...
Dim locbldr207 As LocalBuilder = checkMethodIL.DeclareLocal(GetType(System.Int32))
locbldr207.SetLocalSymInfo("i")
checkMethodIL.Emit(OpCodes.Ldc_I4, CInt(0))
Typ = GetType(System.Int32)
checkMethodIL.Emit(OpCodes.Stloc, 9)
checkMethodIL.MarkSequencePoint(doc5, 333, 1, 333, 100)
Dim locbldr208 As LocalBuilder = checkMethodIL.DeclareLocal(GetType(System.Int32))
locbldr208.SetLocalSymInfo("len")
checkMethodIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
checkMethodIL.Emit(OpCodes.Ldfld, GetType(Stmt).GetField("Tokens"))
Typ = GetType(Stmt).GetField("Tokens").FieldType
...
Dim locbldr209 As LocalBuilder = checkMethodIL.DeclareLocal(GetType(System.Boolean))
locbldr209.SetLocalSymInfo("bl")
checkMethodIL.Emit(OpCodes.Ldc_I4, 0)
Typ = GetType(System.Boolean)
...
checkMethodIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa148 As System.Reflection.Emit.Label = checkMethodIL.DefineLabel()
Dim tru148 As System.Reflection.Emit.Label = checkMethodIL.DefineLabel()
Dim cont148 As System.Reflection.Emit.Label = checkMethodIL.DefineLabel()
checkMethodIL.Emit(OpCodes.Beq, tru148)
checkMethodIL.Emit(OpCodes.Br, fa148)
checkMethodIL.MarkLabel(tru148)
...
checkMethodIL.Emit(OpCodes.Br, cont148)
checkMethodIL.MarkLabel(fa148)
...
checkMethodIL.Emit(OpCodes.Br, cont148)
checkMethodIL.MarkLabel(cont148)
checkMethodIL.MarkSequencePoint(doc5, 352, 1, 352, 100)
checkMethodIL.Emit(OpCodes.Ldloc, 9)
Typ = GetType(System.Int32)
checkMethodIL.Emit(OpCodes.Ldloc, 10)
Typ = GetType(System.Int32)
Dim fa149 As System.Reflection.Emit.Label = checkMethodIL.DefineLabel()
Dim tru149 As System.Reflection.Emit.Label = checkMethodIL.DefineLabel()
Dim cont149 As System.Reflection.Emit.Label = checkMethodIL.DefineLabel()
checkMethodIL.Emit(OpCodes.Beq, tru149)
checkMethodIL.Emit(OpCodes.Br, fa149)
checkMethodIL.MarkLabel(tru149)
...
checkMethodIL.Emit(OpCodes.Br, cont149)
checkMethodIL.MarkLabel(fa149)
...
checkMethodIL.Emit(OpCodes.Br, cont149)
checkMethodIL.MarkLabel(cont149)
...
Dim locbldr210 As LocalBuilder = checkMethodIL.DeclareLocal(GetType(Token))
locbldr210.SetLocalSymInfo("tok2")
checkMethodIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
checkMethodIL.Emit(OpCodes.Ldfld, GetType(Stmt).GetField("Tokens"))
Typ = GetType(Stmt).GetField("Tokens").FieldType
...
Dim locbldr211 As LocalBuilder = checkMethodIL.DeclareLocal(GetType(System.Type))
locbldr211.SetLocalSymInfo("typ2")
checkMethodIL.MarkSequencePoint(doc5, 367, 1, 367, 100)
Dim locbldr212 As LocalBuilder = checkMethodIL.DeclareLocal(GetType(System.Boolean))
locbldr212.SetLocalSymInfo("b2")
...
checkMethodIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa150 As System.Reflection.Emit.Label = checkMethodIL.DefineLabel()
Dim tru150 As System.Reflection.Emit.Label = checkMethodIL.DefineLabel()
Dim cont150 As System.Reflection.Emit.Label = checkMethodIL.DefineLabel()
checkMethodIL.Emit(OpCodes.Beq, fa150)
checkMethodIL.Emit(OpCodes.Br, tru150)
checkMethodIL.MarkLabel(tru150)
checkMethodIL.MarkSequencePoint(doc5, 373, 1, 373, 100)
Dim locbldr213 As LocalBuilder = checkMethodIL.DeclareLocal(GetType(Token))
locbldr213.SetLocalSymInfo("t")
checkMethodIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
checkMethodIL.Emit(OpCodes.Ldfld, GetType(Stmt).GetField("Tokens"))
Typ = GetType(Stmt).GetField("Tokens").FieldType
...
Dim locbldr214 As LocalBuilder = checkMethodIL.DeclareLocal(GetType(TypeTok))
locbldr214.SetLocalSymInfo("tt")
...
checkMethodIL.Emit(OpCodes.Br, cont150)
checkMethodIL.MarkLabel(fa150)
...
checkMethodIL.Emit(OpCodes.Br, cont150)
checkMethodIL.MarkLabel(cont150)
...
checkMethodIL.Emit(OpCodes.Beq, tru154)
checkMethodIL.Emit(OpCodes.Br, fa154)
checkMethodIL.MarkLabel(tru154)
checkMethodIL.MarkSequencePoint(doc5, 410, 1, 410, 100)
Dim locbldr215 As LocalBuilder = checkMethodIL.DeclareLocal(asm.GetType("dylan.NET.Tokenizer.Parser.ExprOptimizer"))
locbldr215.SetLocalSymInfo("eopt2")
checkMethodIL.Emit(OpCodes.Newobj, asm.GetType("dylan.NET.Tokenizer.Parser.ExprOptimizer").GetConstructor(Type.EmptyTypes))
...
Dim locbldr216 As LocalBuilder = checkMethodIL.DeclareLocal(asm.GetType("dylan.NET.Tokenizer.Parser.ExprOptimizer"))
locbldr216.SetLocalSymInfo("eopt1")
checkMethodIL.Emit(OpCodes.Newobj, asm.GetType("dylan.NET.Tokenizer.Parser.ExprOptimizer").GetConstructor(Type.EmptyTypes))
...
checkMethodIL.Emit(OpCodes.Br, cont147)
checkMethodIL.MarkLabel(fa147)
checkMethodIL.Emit(OpCodes.Br, cont147)
checkMethodIL.MarkLabel(cont147)
...
Typ = GetType(System.Int32)
Dim fa161 As System.Reflection.Emit.Label = checkMethodCallIL.DefineLabel()
Dim tru161 As System.Reflection.Emit.Label = checkMethodCallIL.DefineLabel()
Dim cont161 As System.Reflection.Emit.Label = checkMethodCallIL.DefineLabel()
checkMethodCallIL.Emit(OpCodes.Bgt, tru161)
checkMethodCallIL.Emit(OpCodes.Br, fa161)
checkMethodCallIL.MarkLabel(tru161)
checkMethodCallIL.MarkSequencePoint(doc5, 462, 1, 462, 100)
Dim locbldr217 As LocalBuilder = checkMethodCallIL.DeclareLocal(GetType(Token))
locbldr217.SetLocalSymInfo("tok")
checkMethodCallIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
checkMethodCallIL.Emit(OpCodes.Ldfld, GetType(Stmt).GetField("Tokens"))
Typ = GetType(Stmt).GetField("Tokens").FieldType
...
Dim locbldr218 As LocalBuilder = checkMethodCallIL.DeclareLocal(GetType(System.Type))
locbldr218.SetLocalSymInfo("typ")
...
Dim locbldr219 As LocalBuilder = checkMethodCallIL.DeclareLocal(GetType(Token))
locbldr219.SetLocalSymInfo("tokb")
checkMethodCallIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
checkMethodCallIL.Emit(OpCodes.Ldfld, GetType(Stmt).GetField("Tokens"))
Typ = GetType(Stmt).GetField("Tokens").FieldType
...
Dim locbldr220 As LocalBuilder = checkMethodCallIL.DeclareLocal(GetType(System.Type))
locbldr220.SetLocalSymInfo("typb")
...
Dim locbldr221 As LocalBuilder = checkMethodCallIL.DeclareLocal(GetType(System.Boolean))
locbldr221.SetLocalSymInfo("ba")
Dim typ87(-1) As Type
...
Dim locbldr222 As LocalBuilder = checkMethodCallIL.DeclareLocal(GetType(System.Boolean))
locbldr222.SetLocalSymInfo("bb")
Dim typ88(-1) As Type
...
Dim locbldr223 As LocalBuilder = checkMethodCallIL.DeclareLocal(GetType(MethodCallStmt))
locbldr223.SetLocalSymInfo("mtcss")
...
Dim locbldr224 As LocalBuilder = checkMethodCallIL.DeclareLocal(GetType(MethodNameTok))
locbldr224.SetLocalSymInfo("mn")
...
Dim locbldr225 As LocalBuilder = checkMethodCallIL.DeclareLocal(GetType(MethodCallTok))
locbldr225.SetLocalSymInfo("mct")
...
Dim locbldr226 As LocalBuilder = checkMethodCallIL.DeclareLocal(GetType(Ident))
locbldr226.SetLocalSymInfo("idt")
...
Dim locbldr227 As LocalBuilder = checkMethodCallIL.DeclareLocal(GetType(Expr))
locbldr227.SetLocalSymInfo("exp")
...
Dim locbldr228 As LocalBuilder = checkMethodCallIL.DeclareLocal(GetType(System.Int32))
locbldr228.SetLocalSymInfo("lvl")
checkMethodCallIL.Emit(OpCodes.Ldc_I4, CInt(1))
Typ = GetType(System.Int32)
checkMethodCallIL.Emit(OpCodes.Stloc, 11)
checkMethodCallIL.MarkSequencePoint(doc5, 477, 1, 477, 100)
Dim locbldr229 As LocalBuilder = checkMethodCallIL.DeclareLocal(GetType(System.Boolean))
locbldr229.SetLocalSymInfo("d")
...
Dim locbldr230 As LocalBuilder = checkMethodCallIL.DeclareLocal(GetType(System.Int32))
...
checkMethodCallIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa162 As System.Reflection.Emit.Label = checkMethodCallIL.DefineLabel()
Dim tru162 As System.Reflection.Emit.Label = checkMethodCallIL.DefineLabel()
Dim cont162 As System.Reflection.Emit.Label = checkMethodCallIL.DefineLabel()
checkMethodCallIL.Emit(OpCodes.Beq, tru162)
checkMethodCallIL.Emit(OpCodes.Br, fa162)
checkMethodCallIL.MarkLabel(tru162)
...
Dim locbldr231 As LocalBuilder = checkMethodCallIL.DeclareLocal(GetType(Token))
...
Dim locbldr232 As LocalBuilder = checkMethodCallIL.DeclareLocal(GetType(System.Type))
...
locbldr234.SetLocalSymInfo("len")
checkMethodCallIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
checkMethodCallIL.Emit(OpCodes.Ldfld, GetType(Stmt).GetField("Tokens"))
Typ = GetType(Stmt).GetField("Tokens").FieldType
...
Dim locbldr235 As LocalBuilder = checkMethodCallIL.DeclareLocal(asm.GetType("dylan.NET.Tokenizer.Parser.ExprOptimizer"))
locbldr235.SetLocalSymInfo("eopt")
...
checkMethodCallIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa163 As System.Reflection.Emit.Label = checkMethodCallIL.DefineLabel()
Dim tru163 As System.Reflection.Emit.Label = checkMethodCallIL.DefineLabel()
Dim cont163 As System.Reflection.Emit.Label = checkMethodCallIL.DefineLabel()
checkMethodCallIL.Emit(OpCodes.Beq, tru163)
checkMethodCallIL.Emit(OpCodes.Br, fa163)
checkMethodCallIL.MarkLabel(tru163)
...
checkMethodCallIL.Emit(OpCodes.Ldc_I4, CInt(0))
Typ = GetType(System.Int32)
Dim fa164 As System.Reflection.Emit.Label = checkMethodCallIL.DefineLabel()
Dim tru164 As System.Reflection.Emit.Label = checkMethodCallIL.DefineLabel()
Dim cont164 As System.Reflection.Emit.Label = checkMethodCallIL.DefineLabel()
checkMethodCallIL.Emit(OpCodes.Beq, tru164)
checkMethodCallIL.Emit(OpCodes.Br, fa164)
checkMethodCallIL.MarkLabel(tru164)
...
checkMethodCallIL.Emit(OpCodes.Br, cont164)
checkMethodCallIL.MarkLabel(fa164)
...
checkMethodCallIL.Emit(OpCodes.Br, cont164)
checkMethodCallIL.MarkLabel(cont164)
checkMethodCallIL.MarkSequencePoint(doc5, 518, 1, 518, 100)
checkMethodCallIL.Emit(OpCodes.Br, label11)
checkMethodCallIL.MarkSequencePoint(doc5, 519, 1, 519, 100)
checkMethodCallIL.Emit(OpCodes.Br, cont163)
checkMethodCallIL.MarkLabel(fa163)
checkMethodCallIL.Emit(OpCodes.Br, cont163)
checkMethodCallIL.MarkLabel(cont163)
...
checkMethodCallIL.Emit(OpCodes.Beq, tru165)
...
checkMethodCallIL.Emit(OpCodes.Br, cont162)
checkMethodCallIL.MarkLabel(fa162)
checkMethodCallIL.Emit(OpCodes.Br, cont162)
checkMethodCallIL.MarkLabel(cont162)
checkMethodCallIL.MarkSequencePoint(doc5, 568, 1, 568, 100)
checkMethodCallIL.Emit(OpCodes.Br, cont161)
checkMethodCallIL.MarkLabel(fa161)
checkMethodCallIL.Emit(OpCodes.Br, cont161)
checkMethodCallIL.MarkLabel(cont161)
...
Dim locbldr236 As LocalBuilder = checkVarAsIL.DeclareLocal(GetType(Token))
...
Dim locbldr237 As LocalBuilder = checkVarAsIL.DeclareLocal(GetType(System.Type))
...
Dim locbldr238 As LocalBuilder = checkVarAsIL.DeclareLocal(GetType(VarStmt))
locbldr238.SetLocalSymInfo("vars")
...
checkVarAsIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa170 As System.Reflection.Emit.Label = checkVarAsIL.DefineLabel()
Dim tru170 As System.Reflection.Emit.Label = checkVarAsIL.DefineLabel()
Dim cont170 As System.Reflection.Emit.Label = checkVarAsIL.DefineLabel()
checkVarAsIL.Emit(OpCodes.Beq, tru170)
checkVarAsIL.Emit(OpCodes.Br, fa170)
checkVarAsIL.MarkLabel(tru170)
...
Dim locbldr239 As LocalBuilder = checkVarAsIL.DeclareLocal(GetType(Expr))
...
Dim locbldr240 As LocalBuilder = checkVarAsIL.DeclareLocal(asm.GetType("dylan.NET.Tokenizer.Parser.ExprOptimizer"))
...
Dim locbldr241 As LocalBuilder = checkVarAsIL.DeclareLocal(GetType(Token))
...
Dim locbldr242 As LocalBuilder = checkVarAsIL.DeclareLocal(GetType(System.Type))
...
Dim locbldr243 As LocalBuilder = checkVarAsIL.DeclareLocal(GetType(System.Boolean))
...
checkVarAsIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa171 As System.Reflection.Emit.Label = checkVarAsIL.DefineLabel()
Dim tru171 As System.Reflection.Emit.Label = checkVarAsIL.DefineLabel()
Dim cont171 As System.Reflection.Emit.Label = checkVarAsIL.DefineLabel()
checkVarAsIL.Emit(OpCodes.Beq, fa171)
checkVarAsIL.Emit(OpCodes.Br, tru171)
checkVarAsIL.MarkLabel(tru171)
checkVarAsIL.MarkSequencePoint(doc5, 593, 1, 593, 100)
Dim locbldr244 As LocalBuilder = checkVarAsIL.DeclareLocal(GetType(Token))
...
Dim locbldr245 As LocalBuilder = checkVarAsIL.DeclareLocal(GetType(TypeTok))
...
checkVarAsIL.Emit(OpCodes.Br, cont171)
checkVarAsIL.MarkLabel(fa171)
...
checkVarAsIL.Emit(OpCodes.Br, cont171)
checkVarAsIL.MarkLabel(cont171)
checkVarAsIL.MarkSequencePoint(doc5, 602, 1, 602, 100)
checkVarAsIL.Emit(OpCodes.Br, cont170)
checkVarAsIL.MarkLabel(fa170)
checkVarAsIL.Emit(OpCodes.Br, cont170)
checkVarAsIL.MarkLabel(cont170)
...
Dim locbldr246 As LocalBuilder = AssOptIL.DeclareLocal(GetType(AssignStmt))
locbldr246.SetLocalSymInfo("asss")
AssOptIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
AssOptIL.Emit(OpCodes.Stloc, 0)
AssOptIL.MarkSequencePoint(doc5, 609, 1, 609, 100)
Dim locbldr247 As LocalBuilder = AssOptIL.DeclareLocal(GetType(Expr))
locbldr247.SetLocalSymInfo("le")
...
Dim locbldr248 As LocalBuilder = AssOptIL.DeclareLocal(GetType(Token))
...
Dim locbldr249 As LocalBuilder = AssOptIL.DeclareLocal(GetType(System.Type))
...
Dim locbldr250 As LocalBuilder = AssOptIL.DeclareLocal(GetType(System.Boolean))
locbldr250.SetLocalSymInfo("b")
Dim typ108(-1) As Type
...
Dim locbldr251 As LocalBuilder = AssOptIL.DeclareLocal(GetType(VarAsgnStmt))
locbldr251.SetLocalSymInfo("vass")
...
Typ = GetType(System.Boolean)
Dim fa172 As System.Reflection.Emit.Label = AssOptIL.DefineLabel()
Dim tru172 As System.Reflection.Emit.Label = AssOptIL.DefineLabel()
Dim cont172 As System.Reflection.Emit.Label = AssOptIL.DefineLabel()
AssOptIL.Emit(OpCodes.Beq, tru172)
AssOptIL.Emit(OpCodes.Br, fa172)
AssOptIL.MarkLabel(tru172)
...
AssOptIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa173 As System.Reflection.Emit.Label = AssOptIL.DefineLabel()
Dim tru173 As System.Reflection.Emit.Label = AssOptIL.DefineLabel()
Dim cont173 As System.Reflection.Emit.Label = AssOptIL.DefineLabel()
AssOptIL.Emit(OpCodes.Beq, fa173)
AssOptIL.Emit(OpCodes.Br, tru173)
AssOptIL.MarkLabel(tru173)
AssOptIL.MarkSequencePoint(doc5, 624, 1, 624, 100)
Dim locbldr255 As LocalBuilder = AssOptIL.DeclareLocal(GetType(Token))
...
Dim locbldr256 As LocalBuilder = AssOptIL.DeclareLocal(GetType(TypeTok))
...
AssOptIL.Emit(OpCodes.Br, cont173)
AssOptIL.MarkLabel(fa173)
...
Dim locbldr257 As LocalBuilder = AssOptIL.DeclareLocal(asm.GetType("dylan.NET.Tokenizer.Parser.ExprOptimizer"))
...
Dim locbldr258 As LocalBuilder = checkAssignIL.DeclareLocal(GetType(Token))
locbldr258.SetLocalSymInfo("tok")
checkAssignIL.Emit(OpCodes.Ldnull)
checkAssignIL.Emit(OpCodes.Stloc, 0)
checkAssignIL.MarkSequencePoint(doc5, 646, 1, 646, 100)
Dim locbldr259 As LocalBuilder = checkAssignIL.DeclareLocal(GetType(System.Type))
locbldr259.SetLocalSymInfo("typ")
...
Dim locbldr260 As LocalBuilder = checkAssignIL.DeclareLocal(GetType(AssignStmt))
locbldr260.SetLocalSymInfo("asss")
...
Dim locbldr261 As LocalBuilder = checkAssignIL.DeclareLocal(GetType(System.Boolean))
locbldr261.SetLocalSymInfo("c")
checkAssignIL.Emit(OpCodes.Ldc_I4, 0)
Typ = GetType(System.Boolean)
checkAssignIL.Emit(OpCodes.Stloc, 3)
checkAssignIL.MarkSequencePoint(doc5, 649, 1, 649, 100)
Dim locbldr262 As LocalBuilder = checkAssignIL.DeclareLocal(GetType(Expr))
locbldr262.SetLocalSymInfo("re")
...
Dim locbldr263 As LocalBuilder = checkAssignIL.DeclareLocal(GetType(Expr))
locbldr263.SetLocalSymInfo("le")
checkAssignIL.Emit(OpCodes.Newobj, GetType(Expr).GetConstructor(Type.EmptyTypes))
checkAssignIL.Emit(OpCodes.Stloc, 5)
checkAssignIL.MarkSequencePoint(doc5, 651, 1, 651, 100)
Dim locbldr264 As LocalBuilder = checkAssignIL.DeclareLocal(GetType(System.Int32))
locbldr264.SetLocalSymInfo("i")
...
Dim locbldr265 As LocalBuilder = checkAssignIL.DeclareLocal(GetType(System.Int32))
locbldr265.SetLocalSymInfo("len")
...
Dim locbldr266 As LocalBuilder = checkAssignIL.DeclareLocal(GetType(System.Int32))
locbldr266.SetLocalSymInfo("assind")
...
Typ = GetType(System.Boolean)
Dim fa174 As System.Reflection.Emit.Label = checkAssignIL.DefineLabel()
Dim tru174 As System.Reflection.Emit.Label = checkAssignIL.DefineLabel()
Dim cont174 As System.Reflection.Emit.Label = checkAssignIL.DefineLabel()
checkAssignIL.Emit(OpCodes.Beq, tru174)
checkAssignIL.Emit(OpCodes.Br, fa174)
checkAssignIL.MarkLabel(tru174)
...
checkAssignIL.Emit(OpCodes.Br, cont174)
checkAssignIL.MarkLabel(fa174)
checkAssignIL.Emit(OpCodes.Br, cont174)
checkAssignIL.MarkLabel(cont174)
checkAssignIL.MarkSequencePoint(doc5, 670, 1, 670, 100)
checkAssignIL.Emit(OpCodes.Ldloc, 6)
Typ = GetType(System.Int32)
checkAssignIL.Emit(OpCodes.Ldloc, 7)
Typ = GetType(System.Int32)
Dim fa175 As System.Reflection.Emit.Label = checkAssignIL.DefineLabel()
Dim tru175 As System.Reflection.Emit.Label = checkAssignIL.DefineLabel()
Dim cont175 As System.Reflection.Emit.Label = checkAssignIL.DefineLabel()
checkAssignIL.Emit(OpCodes.Beq, tru175)
checkAssignIL.Emit(OpCodes.Br, fa175)
checkAssignIL.MarkLabel(tru175)
checkAssignIL.MarkSequencePoint(doc5, 671, 1, 671, 100)
checkAssignIL.Emit(OpCodes.Br, label13)
checkAssignIL.MarkSequencePoint(doc5, 672, 1, 672, 100)
checkAssignIL.Emit(OpCodes.Br, cont175)
checkAssignIL.MarkLabel(fa175)
...
checkAssignIL.Emit(OpCodes.Br, cont175)
checkAssignIL.MarkLabel(cont175)
...
checkAssignIL.Emit(OpCodes.Ldc_I4, CInt(0))
Typ = GetType(System.Int32)
Dim fa176 As System.Reflection.Emit.Label = checkAssignIL.DefineLabel()
Dim tru176 As System.Reflection.Emit.Label = checkAssignIL.DefineLabel()
Dim cont176 As System.Reflection.Emit.Label = checkAssignIL.DefineLabel()
checkAssignIL.Emit(OpCodes.Beq, fa176)
checkAssignIL.Emit(OpCodes.Br, tru176)
checkAssignIL.MarkLabel(tru176)
...
checkAssignIL.Emit(OpCodes.Ldloc, 7)
Typ = GetType(System.Int32)
Dim fa177 As System.Reflection.Emit.Label = checkAssignIL.DefineLabel()
Dim tru177 As System.Reflection.Emit.Label = checkAssignIL.DefineLabel()
Dim cont177 As System.Reflection.Emit.Label = checkAssignIL.DefineLabel()
checkAssignIL.Emit(OpCodes.Beq, tru177)
checkAssignIL.Emit(OpCodes.Br, fa177)
checkAssignIL.MarkLabel(tru177)
...
checkAssignIL.Emit(OpCodes.Br, cont177)
checkAssignIL.MarkLabel(fa177)
...
checkAssignIL.Emit(OpCodes.Br, cont177)
checkAssignIL.MarkLabel(cont177)
...
Dim locbldr267 As LocalBuilder = checkAssignIL.DeclareLocal(asm.GetType("dylan.NET.Tokenizer.Parser.ExprOptimizer"))
locbldr267.SetLocalSymInfo("eop")
...
checkAssignIL.Emit(OpCodes.Br, cont176)
checkAssignIL.MarkLabel(fa176)
...
checkAssignIL.Emit(OpCodes.Br, cont176)
checkAssignIL.MarkLabel(cont176)
...
Dim locbldr268 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(System.Int32))
locbldr268.SetLocalSymInfo("i")
OptimizeIL.Emit(OpCodes.Ldc_I4, CInt(-1))
Typ = GetType(System.Int32)
OptimizeIL.Emit(OpCodes.Stloc, 0)
OptimizeIL.MarkSequencePoint(doc5, 749, 1, 749, 100)
Dim locbldr269 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(System.Int32))
...
Dim locbldr270 As LocalBuilder = OptimizeIL.DeclareLocal(asm.GetType("dylan.NET.Tokenizer.Parser.TokenOptimizer"))
locbldr270.SetLocalSymInfo("to")
OptimizeIL.Emit(OpCodes.Ldnull)
OptimizeIL.Emit(OpCodes.Stloc, 2)
OptimizeIL.MarkSequencePoint(doc5, 751, 1, 751, 100)
Dim locbldr271 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(Stmt))
locbldr271.SetLocalSymInfo("tmpstm")
OptimizeIL.Emit(OpCodes.Ldnull)
OptimizeIL.Emit(OpCodes.Stloc, 3)
OptimizeIL.MarkSequencePoint(doc5, 752, 1, 752, 100)
Dim locbldr272 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(System.Boolean))
locbldr272.SetLocalSymInfo("compb")
OptimizeIL.Emit(OpCodes.Ldc_I4, 0)
Typ = GetType(System.Boolean)
OptimizeIL.Emit(OpCodes.Stloc, 4)
...
Dim locbldr273 As LocalBuilder = ParseIL.DeclareLocal(GetType(System.Int32))
locbldr273.SetLocalSymInfo("i")
ParseIL.Emit(OpCodes.Ldc_I4, CInt(-1))
Typ = GetType(System.Int32)
ParseIL.Emit(OpCodes.Stloc, 0)
ParseIL.MarkSequencePoint(doc6, 5, 1, 5, 100)
Dim locbldr274 As LocalBuilder = ParseIL.DeclareLocal(asm.GetType("dylan.NET.Tokenizer.Parser.StmtOptimizer"))
locbldr274.SetLocalSymInfo("so")
ParseIL.Emit(OpCodes.Ldnull)
ParseIL.Emit(OpCodes.Stloc, 1)
ParseIL.MarkSequencePoint(doc6, 6, 1, 6, 100)
Dim locbldr275 As LocalBuilder = ParseIL.DeclareLocal(GetType(System.Int32))
locbldr275.SetLocalSymInfo("len")
...
ParseIL.Emit(OpCodes.Ldloc, 2)
Typ = GetType(System.Int32)
Dim fa199 As System.Reflection.Emit.Label = ParseIL.DefineLabel()
Dim tru199 As System.Reflection.Emit.Label = ParseIL.DefineLabel()
Dim cont199 As System.Reflection.Emit.Label = ParseIL.DefineLabel()
ParseIL.Emit(OpCodes.Beq, tru199)
ParseIL.Emit(OpCodes.Br, fa199)
ParseIL.MarkLabel(tru199)
ParseIL.MarkSequencePoint(doc6, 19, 1, 19, 100)
ParseIL.Emit(OpCodes.Br, label1)
ParseIL.MarkSequencePoint(doc6, 20, 1, 20, 100)
ParseIL.Emit(OpCodes.Br, cont199)
ParseIL.MarkLabel(fa199)
ParseIL.MarkSequencePoint(doc6, 21, 1, 21, 100)
ParseIL.Emit(OpCodes.Br, label0)
ParseIL.MarkSequencePoint(doc6, 22, 1, 22, 100)
ParseIL.Emit(OpCodes.Br, cont199)
ParseIL.MarkLabel(cont199)
