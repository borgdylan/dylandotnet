...
Dim checkVarAs As MethodBuilder = StmtOptimizer.DefineMethod("checkVarAs", MethodAttributes.Public, GetType(Stmt), typ34)
...
checkVarAsIL.MarkSequencePoint(doc4, 163, 1, 163, 100)
...
checkVarAsIL.MarkSequencePoint(doc4, 164, 1, 164, 100)
...
checkVarAsIL.Emit(OpCodes.Call, GetType(System.Type).GetMethod("GetTypeFromHandle", typ35))
Typ = GetType(System.Type).GetMethod("GetTypeFromHandle", typ35).ReturnType
checkVarAsIL.Emit(OpCodes.Stloc, 1)
checkVarAsIL.MarkSequencePoint(doc4, 165, 1, 165, 100)
...
ReDim Preserve typ36(UBound(typ36) + 1)
typ36(UBound(typ36)) = Typ
checkVarAsIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("IsInstanceOfType", typ36))
Typ = Typ03.GetMethod("IsInstanceOfType", typ36).ReturnType
checkVarAsIL.Emit(OpCodes.Stobj, Typ04)
checkVarAsIL.MarkSequencePoint(doc4, 166, 1, 166, 100)
Dim locbldr115 As LocalBuilder = checkVarAsIL.DeclareLocal(GetType(VarStmt))
...
checkVarAsIL.MarkSequencePoint(doc4, 168, 1, 168, 100)
checkVarAsIL.Emit(OpCodes.Ldarg, 2)
Typ = GetType(System.Boolean).MakeByRefType()
...
Typ = GetType(System.Boolean)
Dim fa87 As System.Reflection.Emit.Label = checkVarAsIL.DefineLabel()
Dim tru87 As System.Reflection.Emit.Label = checkVarAsIL.DefineLabel()
Dim cont87 As System.Reflection.Emit.Label = checkVarAsIL.DefineLabel()
checkVarAsIL.Emit(OpCodes.Beq, tru87)
checkVarAsIL.Emit(OpCodes.Br, fa87)
checkVarAsIL.MarkLabel(tru87)
checkVarAsIL.MarkSequencePoint(doc4, 169, 1, 169, 100)
...
checkVarAsIL.MarkSequencePoint(doc4, 170, 1, 170, 100)
checkVarAsIL.Emit(OpCodes.Ldloc, 2)
Typ = GetType(VarStmt)
checkVarAsIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
...
checkVarAsIL.MarkSequencePoint(doc4, 171, 1, 171, 100)
checkVarAsIL.Emit(OpCodes.Ldloc, 2)
Typ = GetType(VarStmt)
checkVarAsIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
...
checkVarAsIL.MarkSequencePoint(doc4, 173, 1, 173, 100)
...
checkVarAsIL.MarkSequencePoint(doc4, 174, 1, 174, 100)
...
checkVarAsIL.Emit(OpCodes.Call, GetType(System.Type).GetMethod("GetTypeFromHandle", typ37))
Typ = GetType(System.Type).GetMethod("GetTypeFromHandle", typ37).ReturnType
checkVarAsIL.Emit(OpCodes.Stloc, 4)
checkVarAsIL.MarkSequencePoint(doc4, 175, 1, 175, 100)
...
ReDim Preserve typ38(UBound(typ38) + 1)
typ38(UBound(typ38)) = Typ
checkVarAsIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("IsInstanceOfType", typ38))
Typ = Typ03.GetMethod("IsInstanceOfType", typ38).ReturnType
checkVarAsIL.Emit(OpCodes.Stloc, 5)
checkVarAsIL.MarkSequencePoint(doc4, 177, 1, 177, 100)
...
checkVarAsIL.Emit(OpCodes.Beq, fa88)
checkVarAsIL.Emit(OpCodes.Br, tru88)
checkVarAsIL.MarkLabel(tru88)
checkVarAsIL.MarkSequencePoint(doc4, 178, 1, 178, 100)
...
checkVarAsIL.MarkSequencePoint(doc4, 179, 1, 179, 100)
...
checkVarAsIL.MarkSequencePoint(doc4, 180, 1, 180, 100)
...
checkVarAsIL.MarkSequencePoint(doc4, 181, 1, 181, 100)
checkVarAsIL.Emit(OpCodes.Ldloc, 7)
Typ = GetType(TypeTok)
checkVarAsIL.Emit(OpCodes.Ldloc, 6)
Typ = GetType(Token)
...
checkVarAsIL.MarkSequencePoint(doc4, 182, 1, 182, 100)
checkVarAsIL.Emit(OpCodes.Ldloc, 2)
Typ = GetType(VarStmt)
checkVarAsIL.Emit(OpCodes.Ldloc, 7)
Typ = GetType(TypeTok)
checkVarAsIL.Emit(OpCodes.Stfld, GetType(VarStmt).GetField("VarTyp"))
checkVarAsIL.MarkSequencePoint(doc4, 183, 1, 183, 100)
checkVarAsIL.Emit(OpCodes.Br, cont88)
checkVarAsIL.MarkLabel(fa88)
checkVarAsIL.MarkSequencePoint(doc4, 184, 1, 184, 100)
checkVarAsIL.Emit(OpCodes.Ldloc, 2)
Typ = GetType(VarStmt)
checkVarAsIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
...
Typ = Typ.GetElementType()
checkVarAsIL.Emit(OpCodes.Stfld, GetType(VarStmt).GetField("VarTyp"))
checkVarAsIL.MarkSequencePoint(doc4, 185, 1, 185, 100)
checkVarAsIL.Emit(OpCodes.Br, cont88)
checkVarAsIL.MarkLabel(cont88)
checkVarAsIL.MarkSequencePoint(doc4, 187, 1, 187, 100)
checkVarAsIL.Emit(OpCodes.Br, cont87)
checkVarAsIL.MarkLabel(fa87)
checkVarAsIL.Emit(OpCodes.Br, cont87)
checkVarAsIL.MarkLabel(cont87)
checkVarAsIL.MarkSequencePoint(doc4, 188, 1, 188, 100)
checkVarAsIL.Emit(OpCodes.Ldloc, 2)
Typ = GetType(VarStmt)
checkVarAsIL.MarkSequencePoint(doc4, 189, 1, 189, 100)
checkVarAsIL.Emit(OpCodes.Ret)
Dim typ39(-1) As Type
ReDim Preserve typ39(UBound(typ39) + 1)
typ39(UBound(typ39)) = GetType(Stmt)
Dim AssOpt As MethodBuilder = StmtOptimizer.DefineMethod("AssOpt", MethodAttributes.Public, GetType(Stmt), typ39)
...
AssOptIL.MarkSequencePoint(doc4, 193, 1, 193, 100)
Dim locbldr121 As LocalBuilder = AssOptIL.DeclareLocal(GetType(AssignStmt))
locbldr121.SetLocalSymInfo("asss")
AssOptIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
AssOptIL.Emit(OpCodes.Stloc, 0)
AssOptIL.MarkSequencePoint(doc4, 194, 1, 194, 100)
Dim locbldr122 As LocalBuilder = AssOptIL.DeclareLocal(GetType(Expr))
locbldr122.SetLocalSymInfo("le")
...
AssOptIL.MarkSequencePoint(doc4, 195, 1, 195, 100)
Dim locbldr123 As LocalBuilder = AssOptIL.DeclareLocal(GetType(Token))
...
AssOptIL.MarkSequencePoint(doc4, 196, 1, 196, 100)
Dim locbldr124 As LocalBuilder = AssOptIL.DeclareLocal(GetType(System.Type))
...
AssOptIL.Emit(OpCodes.Call, GetType(System.Type).GetMethod("GetTypeFromHandle", typ40))
Typ = GetType(System.Type).GetMethod("GetTypeFromHandle", typ40).ReturnType
AssOptIL.Emit(OpCodes.Stloc, 3)
AssOptIL.MarkSequencePoint(doc4, 197, 1, 197, 100)
Dim locbldr125 As LocalBuilder = AssOptIL.DeclareLocal(GetType(System.Boolean))
locbldr125.SetLocalSymInfo("b")
Dim typ41(-1) As Type
...
ReDim Preserve typ41(UBound(typ41) + 1)
typ41(UBound(typ41)) = Typ
AssOptIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("IsInstanceOfType", typ41))
Typ = Typ03.GetMethod("IsInstanceOfType", typ41).ReturnType
AssOptIL.Emit(OpCodes.Stloc, 4)
AssOptIL.MarkSequencePoint(doc4, 198, 1, 198, 100)
Dim locbldr126 As LocalBuilder = AssOptIL.DeclareLocal(GetType(VarAsgnStmt))
locbldr126.SetLocalSymInfo("vass")
AssOptIL.Emit(OpCodes.Newobj, GetType(VarAsgnStmt).GetConstructor(Type.EmptyTypes))
AssOptIL.Emit(OpCodes.Stloc, 5)
AssOptIL.MarkSequencePoint(doc4, 199, 1, 199, 100)
AssOptIL.Emit(OpCodes.Ldloc, 4)
Typ = GetType(System.Boolean)
AssOptIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa89 As System.Reflection.Emit.Label = AssOptIL.DefineLabel()
Dim tru89 As System.Reflection.Emit.Label = AssOptIL.DefineLabel()
Dim cont89 As System.Reflection.Emit.Label = AssOptIL.DefineLabel()
AssOptIL.Emit(OpCodes.Beq, tru89)
AssOptIL.Emit(OpCodes.Br, fa89)
AssOptIL.MarkLabel(tru89)
AssOptIL.MarkSequencePoint(doc4, 200, 1, 200, 100)
...
AssOptIL.MarkSequencePoint(doc4, 201, 1, 201, 100)
AssOptIL.Emit(OpCodes.Ldloc, 5)
Typ = GetType(VarAsgnStmt)
AssOptIL.Emit(OpCodes.Ldloc, 0)
Typ = GetType(AssignStmt)
...
AssOptIL.MarkSequencePoint(doc4, 202, 1, 202, 100)
AssOptIL.Emit(OpCodes.Ldloc, 5)
Typ = GetType(VarAsgnStmt)
AssOptIL.Emit(OpCodes.Ldloc, 1)
Typ = GetType(Expr)
...
AssOptIL.MarkSequencePoint(doc4, 204, 1, 204, 100)
Dim locbldr127 As LocalBuilder = AssOptIL.DeclareLocal(GetType(Token))
...
AssOptIL.MarkSequencePoint(doc4, 205, 1, 205, 100)
Dim locbldr128 As LocalBuilder = AssOptIL.DeclareLocal(GetType(System.Type))
...
AssOptIL.Emit(OpCodes.Call, GetType(System.Type).GetMethod("GetTypeFromHandle", typ42))
Typ = GetType(System.Type).GetMethod("GetTypeFromHandle", typ42).ReturnType
AssOptIL.Emit(OpCodes.Stloc, 7)
AssOptIL.MarkSequencePoint(doc4, 206, 1, 206, 100)
Dim locbldr129 As LocalBuilder = AssOptIL.DeclareLocal(GetType(System.Boolean))
...
ReDim Preserve typ43(UBound(typ43) + 1)
typ43(UBound(typ43)) = Typ
AssOptIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("IsInstanceOfType", typ43))
Typ = Typ03.GetMethod("IsInstanceOfType", typ43).ReturnType
AssOptIL.Emit(OpCodes.Stloc, 8)
AssOptIL.MarkSequencePoint(doc4, 208, 1, 208, 100)
AssOptIL.Emit(OpCodes.Ldloc, 8)
Typ = GetType(System.Boolean)
AssOptIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa90 As System.Reflection.Emit.Label = AssOptIL.DefineLabel()
Dim tru90 As System.Reflection.Emit.Label = AssOptIL.DefineLabel()
Dim cont90 As System.Reflection.Emit.Label = AssOptIL.DefineLabel()
AssOptIL.Emit(OpCodes.Beq, fa90)
AssOptIL.Emit(OpCodes.Br, tru90)
AssOptIL.MarkLabel(tru90)
AssOptIL.MarkSequencePoint(doc4, 209, 1, 209, 100)
Dim locbldr130 As LocalBuilder = AssOptIL.DeclareLocal(GetType(Token))
locbldr130.SetLocalSymInfo("t")
AssOptIL.Emit(OpCodes.Ldloc, 1)
Typ = GetType(Expr)
AssOptIL.Emit(OpCodes.Ldfld, GetType(Expr).GetField("Tokens"))
Typ = GetType(Expr).GetField("Tokens").FieldType
...
AssOptIL.MarkSequencePoint(doc4, 210, 1, 210, 100)
Dim locbldr131 As LocalBuilder = AssOptIL.DeclareLocal(GetType(TypeTok))
locbldr131.SetLocalSymInfo("tt")
AssOptIL.Emit(OpCodes.Newobj, GetType(TypeTok).GetConstructor(Type.EmptyTypes))
AssOptIL.Emit(OpCodes.Stloc, 10)
AssOptIL.MarkSequencePoint(doc4, 211, 1, 211, 100)
...
AssOptIL.MarkSequencePoint(doc4, 212, 1, 212, 100)
AssOptIL.Emit(OpCodes.Ldloc, 10)
Typ = GetType(TypeTok)
AssOptIL.Emit(OpCodes.Ldloc, 9)
Typ = GetType(Token)
...
AssOptIL.MarkSequencePoint(doc4, 213, 1, 213, 100)
AssOptIL.Emit(OpCodes.Ldloc, 5)
Typ = GetType(VarAsgnStmt)
AssOptIL.Emit(OpCodes.Ldloc, 10)
Typ = GetType(TypeTok)
AssOptIL.Emit(OpCodes.Stfld, GetType(VarAsgnStmt).GetField("VarTyp"))
AssOptIL.MarkSequencePoint(doc4, 214, 1, 214, 100)
AssOptIL.Emit(OpCodes.Br, cont90)
AssOptIL.MarkLabel(fa90)
AssOptIL.MarkSequencePoint(doc4, 215, 1, 215, 100)
AssOptIL.Emit(OpCodes.Ldloc, 5)
Typ = GetType(VarAsgnStmt)
AssOptIL.Emit(OpCodes.Ldloc, 1)
Typ = GetType(Expr)
...
Typ = Typ.GetElementType()
AssOptIL.Emit(OpCodes.Stfld, GetType(VarAsgnStmt).GetField("VarTyp"))
AssOptIL.MarkSequencePoint(doc4, 216, 1, 216, 100)
AssOptIL.Emit(OpCodes.Br, cont90)
AssOptIL.MarkLabel(cont90)
AssOptIL.MarkSequencePoint(doc4, 218, 1, 218, 100)
AssOptIL.Emit(OpCodes.Ldloc, 5)
Typ = GetType(VarAsgnStmt)
AssOptIL.Emit(OpCodes.Ldloc, 0)
Typ = GetType(AssignStmt)
...
AssOptIL.MarkSequencePoint(doc4, 220, 1, 220, 100)
AssOptIL.Emit(OpCodes.Ldloc, 5)
Typ = GetType(VarAsgnStmt)
AssOptIL.MarkSequencePoint(doc4, 221, 1, 221, 100)
AssOptIL.Emit(OpCodes.Br, cont89)
AssOptIL.MarkLabel(fa89)
AssOptIL.MarkSequencePoint(doc4, 222, 1, 222, 100)
AssOptIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
AssOptIL.MarkSequencePoint(doc4, 223, 1, 223, 100)
AssOptIL.Emit(OpCodes.Br, cont89)
AssOptIL.MarkLabel(cont89)
AssOptIL.MarkSequencePoint(doc4, 225, 1, 225, 100)
...
Dim checkAssign As MethodBuilder = StmtOptimizer.DefineMethod("checkAssign", MethodAttributes.Public, GetType(Stmt), typ44)
...
checkAssignIL.MarkSequencePoint(doc4, 228, 1, 228, 100)
Dim locbldr132 As LocalBuilder = checkAssignIL.DeclareLocal(GetType(Token))
locbldr132.SetLocalSymInfo("tok")
checkAssignIL.Emit(OpCodes.Ldnull)
checkAssignIL.Emit(OpCodes.Stloc, 0)
checkAssignIL.MarkSequencePoint(doc4, 229, 1, 229, 100)
Dim locbldr133 As LocalBuilder = checkAssignIL.DeclareLocal(GetType(System.Type))
...
checkAssignIL.Emit(OpCodes.Call, GetType(System.Type).GetMethod("GetTypeFromHandle", typ45))
Typ = GetType(System.Type).GetMethod("GetTypeFromHandle", typ45).ReturnType
checkAssignIL.Emit(OpCodes.Stloc, 1)
checkAssignIL.MarkSequencePoint(doc4, 230, 1, 230, 100)
Dim locbldr134 As LocalBuilder = checkAssignIL.DeclareLocal(GetType(AssignStmt))
...
checkAssignIL.MarkSequencePoint(doc4, 231, 1, 231, 100)
Dim locbldr135 As LocalBuilder = checkAssignIL.DeclareLocal(GetType(System.Boolean))
locbldr135.SetLocalSymInfo("c")
checkAssignIL.Emit(OpCodes.Ldc_I4, 0)
Typ = GetType(System.Boolean)
checkAssignIL.Emit(OpCodes.Stloc, 3)
checkAssignIL.MarkSequencePoint(doc4, 232, 1, 232, 100)
Dim locbldr136 As LocalBuilder = checkAssignIL.DeclareLocal(GetType(Expr))
locbldr136.SetLocalSymInfo("re")
checkAssignIL.Emit(OpCodes.Newobj, GetType(Expr).GetConstructor(Type.EmptyTypes))
checkAssignIL.Emit(OpCodes.Stloc, 4)
checkAssignIL.MarkSequencePoint(doc4, 233, 1, 233, 100)
Dim locbldr137 As LocalBuilder = checkAssignIL.DeclareLocal(GetType(Expr))
locbldr137.SetLocalSymInfo("le")
checkAssignIL.Emit(OpCodes.Newobj, GetType(Expr).GetConstructor(Type.EmptyTypes))
checkAssignIL.Emit(OpCodes.Stloc, 5)
checkAssignIL.MarkSequencePoint(doc4, 234, 1, 234, 100)
Dim locbldr138 As LocalBuilder = checkAssignIL.DeclareLocal(GetType(System.Int32))
locbldr138.SetLocalSymInfo("i")
checkAssignIL.Emit(OpCodes.Ldc_I4, CInt(-1))
Typ = GetType(System.Int32)
checkAssignIL.Emit(OpCodes.Stloc, 6)
checkAssignIL.MarkSequencePoint(doc4, 235, 1, 235, 100)
Dim locbldr139 As LocalBuilder = checkAssignIL.DeclareLocal(GetType(System.Int32))
...
checkAssignIL.MarkSequencePoint(doc4, 236, 1, 236, 100)
Dim locbldr140 As LocalBuilder = checkAssignIL.DeclareLocal(GetType(System.Int32))
locbldr140.SetLocalSymInfo("assind")
checkAssignIL.Emit(OpCodes.Ldc_I4, CInt(0))
Typ = GetType(System.Int32)
checkAssignIL.Emit(OpCodes.Stloc, 8)
checkAssignIL.MarkSequencePoint(doc4, 238, 1, 238, 100)
Dim label2 As System.Reflection.Emit.Label = checkAssignIL.DefineLabel()
checkAssignIL.MarkSequencePoint(doc4, 239, 1, 239, 100)
Dim label3 As System.Reflection.Emit.Label = checkAssignIL.DefineLabel()
checkAssignIL.MarkSequencePoint(doc4, 241, 1, 241, 100)
checkAssignIL.MarkLabel(label2)
checkAssignIL.MarkSequencePoint(doc4, 243, 1, 243, 100)
...
checkAssignIL.Emit(OpCodes.Stloc, 6)
checkAssignIL.MarkSequencePoint(doc4, 245, 1, 245, 100)
checkAssignIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
checkAssignIL.Emit(OpCodes.Ldfld, GetType(Stmt).GetField("Tokens"))
Typ = GetType(Stmt).GetField("Tokens").FieldType
...
Typ = Typ.GetElementType()
checkAssignIL.Emit(OpCodes.Stloc, 0)
checkAssignIL.MarkSequencePoint(doc4, 246, 1, 246, 100)
Dim typ46(-1) As Type
...
ReDim Preserve typ46(UBound(typ46) + 1)
typ46(UBound(typ46)) = Typ
checkAssignIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("IsInstanceOfType", typ46))
Typ = Typ03.GetMethod("IsInstanceOfType", typ46).ReturnType
checkAssignIL.Emit(OpCodes.Stloc, 3)
checkAssignIL.MarkSequencePoint(doc4, 248, 1, 248, 100)
checkAssignIL.Emit(OpCodes.Ldloc, 3)
Typ = GetType(System.Boolean)
checkAssignIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa91 As System.Reflection.Emit.Label = checkAssignIL.DefineLabel()
Dim tru91 As System.Reflection.Emit.Label = checkAssignIL.DefineLabel()
Dim cont91 As System.Reflection.Emit.Label = checkAssignIL.DefineLabel()
checkAssignIL.Emit(OpCodes.Beq, tru91)
checkAssignIL.Emit(OpCodes.Br, fa91)
checkAssignIL.MarkLabel(tru91)
checkAssignIL.MarkSequencePoint(doc4, 249, 1, 249, 100)
checkAssignIL.Emit(OpCodes.Ldloc, 6)
Typ = GetType(System.Int32)
checkAssignIL.Emit(OpCodes.Stloc, 8)
checkAssignIL.MarkSequencePoint(doc4, 250, 1, 250, 100)
checkAssignIL.Emit(OpCodes.Br, label3)
checkAssignIL.MarkSequencePoint(doc4, 251, 1, 251, 100)
checkAssignIL.Emit(OpCodes.Br, cont91)
checkAssignIL.MarkLabel(fa91)
checkAssignIL.Emit(OpCodes.Br, cont91)
checkAssignIL.MarkLabel(cont91)
checkAssignIL.MarkSequencePoint(doc4, 253, 1, 253, 100)
checkAssignIL.Emit(OpCodes.Ldloc, 6)
Typ = GetType(System.Int32)
checkAssignIL.Emit(OpCodes.Ldloc, 7)
Typ = GetType(System.Int32)
Dim fa92 As System.Reflection.Emit.Label = checkAssignIL.DefineLabel()
Dim tru92 As System.Reflection.Emit.Label = checkAssignIL.DefineLabel()
Dim cont92 As System.Reflection.Emit.Label = checkAssignIL.DefineLabel()
checkAssignIL.Emit(OpCodes.Beq, tru92)
checkAssignIL.Emit(OpCodes.Br, fa92)
checkAssignIL.MarkLabel(tru92)
checkAssignIL.MarkSequencePoint(doc4, 254, 1, 254, 100)
checkAssignIL.Emit(OpCodes.Br, label3)
checkAssignIL.MarkSequencePoint(doc4, 255, 1, 255, 100)
checkAssignIL.Emit(OpCodes.Br, cont92)
checkAssignIL.MarkLabel(fa92)
checkAssignIL.MarkSequencePoint(doc4, 256, 1, 256, 100)
checkAssignIL.Emit(OpCodes.Br, label2)
checkAssignIL.MarkSequencePoint(doc4, 257, 1, 257, 100)
checkAssignIL.Emit(OpCodes.Br, cont92)
checkAssignIL.MarkLabel(cont92)
checkAssignIL.MarkSequencePoint(doc4, 259, 1, 259, 100)
checkAssignIL.MarkLabel(label3)
checkAssignIL.MarkSequencePoint(doc4, 261, 1, 261, 100)
checkAssignIL.Emit(OpCodes.Ldloc, 8)
Typ = GetType(System.Int32)
checkAssignIL.Emit(OpCodes.Ldc_I4, CInt(0))
Typ = GetType(System.Int32)
Dim fa93 As System.Reflection.Emit.Label = checkAssignIL.DefineLabel()
Dim tru93 As System.Reflection.Emit.Label = checkAssignIL.DefineLabel()
Dim cont93 As System.Reflection.Emit.Label = checkAssignIL.DefineLabel()
checkAssignIL.Emit(OpCodes.Beq, fa93)
checkAssignIL.Emit(OpCodes.Br, tru93)
checkAssignIL.MarkLabel(tru93)
checkAssignIL.MarkSequencePoint(doc4, 263, 1, 263, 100)
checkAssignIL.Emit(OpCodes.Ldc_I4, CInt(-1))
Typ = GetType(System.Int32)
checkAssignIL.Emit(OpCodes.Stloc, 6)
checkAssignIL.MarkSequencePoint(doc4, 264, 1, 264, 100)
checkAssignIL.Emit(OpCodes.Ldloc, 8)
Typ = GetType(System.Int32)
checkAssignIL.Emit(OpCodes.Ldc_I4, CInt(1))
Typ = GetType(System.Int32)
checkAssignIL.Emit(OpCodes.Sub)
checkAssignIL.Emit(OpCodes.Stloc, 7)
checkAssignIL.MarkSequencePoint(doc4, 266, 1, 266, 100)
Dim label4 As System.Reflection.Emit.Label = checkAssignIL.DefineLabel()
checkAssignIL.MarkSequencePoint(doc4, 267, 1, 267, 100)
Dim label5 As System.Reflection.Emit.Label = checkAssignIL.DefineLabel()
checkAssignIL.MarkSequencePoint(doc4, 269, 1, 269, 100)
checkAssignIL.MarkLabel(label4)
checkAssignIL.MarkSequencePoint(doc4, 271, 1, 271, 100)
checkAssignIL.Emit(OpCodes.Ldloc, 6)
Typ = GetType(System.Int32)
checkAssignIL.Emit(OpCodes.Ldc_I4, CInt(1))
Typ = GetType(System.Int32)
checkAssignIL.Emit(OpCodes.Add)
checkAssignIL.Emit(OpCodes.Stloc, 6)
checkAssignIL.MarkSequencePoint(doc4, 273, 1, 273, 100)
Dim typ47(-1) As Type
...
ReDim Preserve typ47(UBound(typ47) + 1)
typ47(UBound(typ47)) = Typ
checkAssignIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("AddToken", typ47))
Typ = Typ03.GetMethod("AddToken", typ47).ReturnType
If Typ.ToString() = GetType(System.Void).ToString() Then

Else
checkAssignIL.Emit(OpCodes.Pop)
End If
checkAssignIL.MarkSequencePoint(doc4, 275, 1, 275, 100)
checkAssignIL.Emit(OpCodes.Ldloc, 6)
Typ = GetType(System.Int32)
checkAssignIL.Emit(OpCodes.Ldloc, 7)
Typ = GetType(System.Int32)
Dim fa94 As System.Reflection.Emit.Label = checkAssignIL.DefineLabel()
Dim tru94 As System.Reflection.Emit.Label = checkAssignIL.DefineLabel()
Dim cont94 As System.Reflection.Emit.Label = checkAssignIL.DefineLabel()
checkAssignIL.Emit(OpCodes.Beq, tru94)
checkAssignIL.Emit(OpCodes.Br, fa94)
checkAssignIL.MarkLabel(tru94)
checkAssignIL.MarkSequencePoint(doc4, 276, 1, 276, 100)
checkAssignIL.Emit(OpCodes.Br, label5)
checkAssignIL.MarkSequencePoint(doc4, 277, 1, 277, 100)
checkAssignIL.Emit(OpCodes.Br, cont94)
checkAssignIL.MarkLabel(fa94)
checkAssignIL.MarkSequencePoint(doc4, 278, 1, 278, 100)
checkAssignIL.Emit(OpCodes.Br, label4)
checkAssignIL.MarkSequencePoint(doc4, 279, 1, 279, 100)
checkAssignIL.Emit(OpCodes.Br, cont94)
checkAssignIL.MarkLabel(cont94)
checkAssignIL.MarkSequencePoint(doc4, 281, 1, 281, 100)
checkAssignIL.MarkLabel(label5)
checkAssignIL.MarkSequencePoint(doc4, 284, 1, 284, 100)
checkAssignIL.Emit(OpCodes.Ldloc, 8)
Typ = GetType(System.Int32)
checkAssignIL.Emit(OpCodes.Stloc, 6)
checkAssignIL.MarkSequencePoint(doc4, 285, 1, 285, 100)
checkAssignIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
checkAssignIL.Emit(OpCodes.Ldfld, GetType(Stmt).GetField("Tokens"))
Typ = GetType(Stmt).GetField("Tokens").FieldType
...
checkAssignIL.Emit(OpCodes.Sub)
checkAssignIL.Emit(OpCodes.Stloc, 7)
checkAssignIL.MarkSequencePoint(doc4, 287, 1, 287, 100)
Dim label6 As System.Reflection.Emit.Label = checkAssignIL.DefineLabel()
checkAssignIL.MarkSequencePoint(doc4, 288, 1, 288, 100)
Dim label7 As System.Reflection.Emit.Label = checkAssignIL.DefineLabel()
checkAssignIL.MarkSequencePoint(doc4, 290, 1, 290, 100)
checkAssignIL.MarkLabel(label6)
checkAssignIL.MarkSequencePoint(doc4, 292, 1, 292, 100)
checkAssignIL.Emit(OpCodes.Ldloc, 6)
Typ = GetType(System.Int32)
checkAssignIL.Emit(OpCodes.Ldc_I4, CInt(1))
Typ = GetType(System.Int32)
checkAssignIL.Emit(OpCodes.Add)
checkAssignIL.Emit(OpCodes.Stloc, 6)
checkAssignIL.MarkSequencePoint(doc4, 294, 1, 294, 100)
Dim typ48(-1) As Type
...
ReDim Preserve typ48(UBound(typ48) + 1)
typ48(UBound(typ48)) = Typ
checkAssignIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("AddToken", typ48))
Typ = Typ03.GetMethod("AddToken", typ48).ReturnType
If Typ.ToString() = GetType(System.Void).ToString() Then

Else
checkAssignIL.Emit(OpCodes.Pop)
End If
checkAssignIL.MarkSequencePoint(doc4, 296, 1, 296, 100)
checkAssignIL.Emit(OpCodes.Ldloc, 6)
Typ = GetType(System.Int32)
checkAssignIL.Emit(OpCodes.Ldloc, 7)
Typ = GetType(System.Int32)
Dim fa95 As System.Reflection.Emit.Label = checkAssignIL.DefineLabel()
Dim tru95 As System.Reflection.Emit.Label = checkAssignIL.DefineLabel()
Dim cont95 As System.Reflection.Emit.Label = checkAssignIL.DefineLabel()
checkAssignIL.Emit(OpCodes.Beq, tru95)
checkAssignIL.Emit(OpCodes.Br, fa95)
checkAssignIL.MarkLabel(tru95)
checkAssignIL.MarkSequencePoint(doc4, 297, 1, 297, 100)
checkAssignIL.Emit(OpCodes.Br, label7)
checkAssignIL.MarkSequencePoint(doc4, 298, 1, 298, 100)
checkAssignIL.Emit(OpCodes.Br, cont95)
checkAssignIL.MarkLabel(fa95)
checkAssignIL.MarkSequencePoint(doc4, 299, 1, 299, 100)
checkAssignIL.Emit(OpCodes.Br, label6)
checkAssignIL.MarkSequencePoint(doc4, 300, 1, 300, 100)
checkAssignIL.Emit(OpCodes.Br, cont95)
checkAssignIL.MarkLabel(cont95)
checkAssignIL.MarkSequencePoint(doc4, 302, 1, 302, 100)
checkAssignIL.MarkLabel(label7)
checkAssignIL.MarkSequencePoint(doc4, 304, 1, 304, 100)
...
checkAssignIL.MarkSequencePoint(doc4, 305, 1, 305, 100)
checkAssignIL.Emit(OpCodes.Ldloc, 2)
Typ = GetType(AssignStmt)
checkAssignIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
...
checkAssignIL.MarkSequencePoint(doc4, 306, 1, 306, 100)
checkAssignIL.Emit(OpCodes.Ldloc, 2)
Typ = GetType(AssignStmt)
checkAssignIL.Emit(OpCodes.Ldloc, 5)
Typ = GetType(Expr)
checkAssignIL.Emit(OpCodes.Stfld, GetType(AssignStmt).GetField("LExp"))
checkAssignIL.MarkSequencePoint(doc4, 307, 1, 307, 100)
checkAssignIL.Emit(OpCodes.Ldloc, 2)
Typ = GetType(AssignStmt)
checkAssignIL.Emit(OpCodes.Ldloc, 4)
Typ = GetType(Expr)
...
checkAssignIL.Emit(OpCodes.Br, cont93)
checkAssignIL.MarkLabel(fa93)
...
Typ = GetType(System.Boolean)
checkAssignIL.Emit(OpCodes.Stobj, Typ04)
checkAssignIL.MarkSequencePoint(doc4, 317, 1, 317, 100)
checkAssignIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
checkAssignIL.MarkSequencePoint(doc4, 319, 1, 319, 100)
checkAssignIL.Emit(OpCodes.Br, cont93)
checkAssignIL.MarkLabel(cont93)
checkAssignIL.MarkSequencePoint(doc4, 321, 1, 321, 100)
checkAssignIL.Emit(OpCodes.Ret)
Dim typ50(-1) As Type
ReDim Preserve typ50(UBound(typ50) + 1)
typ50(UBound(typ50)) = GetType(Stmt)
Dim Optimize As MethodBuilder = StmtOptimizer.DefineMethod("Optimize", MethodAttributes.Public, GetType(Stmt), typ50)
Dim OptimizeIL As ILGenerator = Optimize.GetILGenerator()
Dim Optimizeparam00 As ParameterBuilder = Optimize.DefineParameter(0, ParameterAttributes.RetVal, "")
...
ReDim Preserve typ51(UBound(typ51) + 1)
typ51(UBound(typ51)) = Typ
OptimizeIL.Emit(OpCodes.Call, GetType(Console).GetMethod("WriteLine", typ51))
Typ = GetType(Console).GetMethod("WriteLine", typ51).ReturnType
If Typ.ToString() = GetType(System.Void).ToString() Then
...
Dim locbldr141 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(System.Int32))
locbldr141.SetLocalSymInfo("i")
OptimizeIL.Emit(OpCodes.Ldc_I4, CInt(-1))
Typ = GetType(System.Int32)
OptimizeIL.Emit(OpCodes.Stloc, 0)
...
Dim locbldr143 As LocalBuilder = OptimizeIL.DeclareLocal(asm.GetType("dylan.NET.Tokenizer.Parser.TokenOptimizer"))
locbldr143.SetLocalSymInfo("to")
OptimizeIL.Emit(OpCodes.Ldnull)
OptimizeIL.Emit(OpCodes.Stloc, 2)
OptimizeIL.MarkSequencePoint(doc4, 330, 1, 330, 100)
Dim locbldr144 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(Stmt))
locbldr144.SetLocalSymInfo("tmpstm")
OptimizeIL.Emit(OpCodes.Ldnull)
OptimizeIL.Emit(OpCodes.Stloc, 3)
...
locbldr145.SetLocalSymInfo("compb")
OptimizeIL.Emit(OpCodes.Ldc_I4, 0)
Typ = GetType(System.Boolean)
OptimizeIL.Emit(OpCodes.Stloc, 4)
...
Dim label8 As System.Reflection.Emit.Label = OptimizeIL.DefineLabel()
...
OptimizeIL.Emit(OpCodes.Blt, tru96)
...
OptimizeIL.MarkLabel(label8)
OptimizeIL.MarkSequencePoint(doc4, 348, 1, 348, 100)
OptimizeIL.Emit(OpCodes.Ldloc, 0)
Typ = GetType(System.Int32)
OptimizeIL.Emit(OpCodes.Ldc_I4, CInt(1))
Typ = GetType(System.Int32)
...
OptimizeIL.Emit(OpCodes.Br, label9)
OptimizeIL.MarkSequencePoint(doc4, 352, 1, 352, 100)
...
OptimizeIL.MarkSequencePoint(doc4, 356, 1, 356, 100)
OptimizeIL.Emit(OpCodes.Br, label9)
...
ReDim Preserve typ52(UBound(typ52) + 1)
typ52(UBound(typ52)) = Typ
OptimizeIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("Optimize", typ52))
Typ = Typ03.GetMethod("Optimize", typ52).ReturnType
Typ = Typ02
...
Dim locbldr146 As LocalBuilder = ParseIL.DeclareLocal(GetType(System.Int32))
...
Dim locbldr147 As LocalBuilder = ParseIL.DeclareLocal(asm.GetType("dylan.NET.Tokenizer.Parser.StmtOptimizer"))
locbldr147.SetLocalSymInfo("so")
ParseIL.Emit(OpCodes.Ldnull)
ParseIL.Emit(OpCodes.Stloc, 1)
ParseIL.MarkSequencePoint(doc5, 6, 1, 6, 100)
Dim locbldr148 As LocalBuilder = ParseIL.DeclareLocal(GetType(System.Int32))
...
ParseIL.Emit(OpCodes.Ldloc, 2)
Typ = GetType(System.Int32)
Dim fa109 As System.Reflection.Emit.Label = ParseIL.DefineLabel()
Dim tru109 As System.Reflection.Emit.Label = ParseIL.DefineLabel()
Dim cont109 As System.Reflection.Emit.Label = ParseIL.DefineLabel()
ParseIL.Emit(OpCodes.Beq, tru109)
ParseIL.Emit(OpCodes.Br, fa109)
ParseIL.MarkLabel(tru109)
ParseIL.MarkSequencePoint(doc5, 19, 1, 19, 100)
ParseIL.Emit(OpCodes.Br, label1)
ParseIL.MarkSequencePoint(doc5, 20, 1, 20, 100)
ParseIL.Emit(OpCodes.Br, cont109)
ParseIL.MarkLabel(fa109)
ParseIL.MarkSequencePoint(doc5, 21, 1, 21, 100)
ParseIL.Emit(OpCodes.Br, label0)
ParseIL.MarkSequencePoint(doc5, 22, 1, 22, 100)
ParseIL.Emit(OpCodes.Br, cont109)
ParseIL.MarkLabel(cont109)
