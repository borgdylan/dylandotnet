...
UpdateCharLitIL.MarkSequencePoint(doc2, 81, 1, 81, 100)
...
UpdateStringLitIL.MarkSequencePoint(doc2, 88, 1, 88, 100)
...
UpdateBoolLitIL.MarkSequencePoint(doc2, 95, 1, 95, 100)
...
UpdateNumLitIL.MarkSequencePoint(doc2, 103, 1, 103, 100)
...
Dim locbldr17 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(NegOp))
locbldr17.SetLocalSymInfo("negop")
...
Dim locbldr18 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(NotOp))
locbldr18.SetLocalSymInfo("notop")
...
Dim locbldr19 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(NeqOp))
locbldr19.SetLocalSymInfo("neqop")
...
locbldr20.SetLocalSymInfo("neqop2")
OptimizeIL.Emit(OpCodes.Newobj, GetType(NeqOp).GetConstructor(Type.EmptyTypes))
...
OptimizeIL.MarkSequencePoint(doc3, 181, 1, 181, 100)
Dim typ16(-1) As Type
OptimizeIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Token)
OptimizeIL.Emit(OpCodes.Ldfld, GetType(Token).GetField("Value"))
...
Dim locbldr21 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(GeOp))
locbldr21.SetLocalSymInfo("geop")
...
OptimizeIL.MarkSequencePoint(doc3, 191, 1, 191, 100)
Dim typ17(-1) As Type
OptimizeIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Token)
OptimizeIL.Emit(OpCodes.Ldfld, GetType(Token).GetField("Value"))
...
Dim locbldr22 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(LeOp))
locbldr22.SetLocalSymInfo("leop")
...
Dim locbldr23 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(GtOp))
locbldr23.SetLocalSymInfo("gtop")
...
Dim locbldr24 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(LtOp))
locbldr24.SetLocalSymInfo("ltop")
...
Dim locbldr25 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(AndOp))
locbldr25.SetLocalSymInfo("andop")
...
Dim locbldr26 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(OrOp))
locbldr26.SetLocalSymInfo("orop")
...
Dim locbldr27 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(NandOp))
locbldr27.SetLocalSymInfo("nandop")
...
Dim locbldr28 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(NorOp))
locbldr28.SetLocalSymInfo("norop")
...
Dim locbldr29 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(XorOp))
locbldr29.SetLocalSymInfo("xorop")
...
Dim locbldr30 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(LParen))
locbldr30.SetLocalSymInfo("lpar")
...
OptimizeIL.MarkSequencePoint(doc3, 283, 1, 283, 100)
Dim typ26(-1) As Type
OptimizeIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Token)
OptimizeIL.Emit(OpCodes.Ldfld, GetType(Token).GetField("Value"))
...
Dim locbldr31 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(RParen))
locbldr31.SetLocalSymInfo("rpar")
...
OptimizeIL.MarkSequencePoint(doc3, 293, 1, 293, 100)
Dim typ27(-1) As Type
OptimizeIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Token)
OptimizeIL.Emit(OpCodes.Ldfld, GetType(Token).GetField("Value"))
...
Dim locbldr32 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(LRSParen))
locbldr32.SetLocalSymInfo("lrspar")
...
OptimizeIL.MarkSequencePoint(doc3, 303, 1, 303, 100)
Dim typ28(-1) As Type
OptimizeIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Token)
OptimizeIL.Emit(OpCodes.Ldfld, GetType(Token).GetField("Value"))
...
Dim locbldr33 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(Ampersand))
locbldr33.SetLocalSymInfo("ampsig")
...
OptimizeIL.MarkSequencePoint(doc3, 313, 1, 313, 100)
Dim typ29(-1) As Type
OptimizeIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Token)
OptimizeIL.Emit(OpCodes.Ldfld, GetType(Token).GetField("Value"))
...
Dim locbldr34 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(LSParen))
locbldr34.SetLocalSymInfo("lspar")
...
Dim locbldr35 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(RSParen))
locbldr35.SetLocalSymInfo("rspar")
...
Dim locbldr36 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(Pipe))
locbldr36.SetLocalSymInfo("pip")
...
Dim locbldr37 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(Comma))
locbldr37.SetLocalSymInfo("com")
...
Dim locbldr38 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(DollarSign))
locbldr38.SetLocalSymInfo("ds")
...
Dim locbldr39 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(IfTok))
locbldr39.SetLocalSymInfo("iftk")
...
Dim locbldr40 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(ThenTok))
locbldr40.SetLocalSymInfo("thentk")
...
Dim locbldr41 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(RefasmTok))
locbldr41.SetLocalSymInfo("ratk")
...
Dim locbldr42 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(DebugTok))
locbldr42.SetLocalSymInfo("dgtk")
...
Dim locbldr43 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(ImportTok))
locbldr43.SetLocalSymInfo("imptk")
...
Dim locbldr44 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(LocimportTok))
locbldr44.SetLocalSymInfo("limptk")
...
Dim locbldr45 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(AssemblyTok))
locbldr45.SetLocalSymInfo("asmtk")
...
Dim locbldr46 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(VerTok))
locbldr46.SetLocalSymInfo("vertk")
...
Dim locbldr47 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(OnTok))
locbldr47.SetLocalSymInfo("ontk")
...
Dim locbldr48 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(OffTok))
locbldr48.SetLocalSymInfo("offtk")
...
Dim locbldr49 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(ExeTok))
locbldr49.SetLocalSymInfo("extk")
...
Dim locbldr50 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(DllTok))
locbldr50.SetLocalSymInfo("dltk")
...
Dim locbldr51 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(FieldTok))
locbldr51.SetLocalSymInfo("fltk")
...
Dim locbldr52 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(ClassTok))
locbldr52.SetLocalSymInfo("cltk")
...
Dim locbldr53 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(ExtendsTok))
locbldr53.SetLocalSymInfo("exttk")
...
Dim locbldr54 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(MethodTok))
locbldr54.SetLocalSymInfo("mettk")
...
Dim locbldr55 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(EndTok))
locbldr55.SetLocalSymInfo("entk")
...
Dim locbldr56 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(VarTok))
locbldr56.SetLocalSymInfo("vrtk")
...
Dim locbldr57 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(AsTok))
locbldr57.SetLocalSymInfo("astk")
...
Dim locbldr58 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(OfTok))
locbldr58.SetLocalSymInfo("oftk")
...
Dim locbldr59 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(PrivateAttr))
locbldr59.SetLocalSymInfo("privattr")
...
Dim locbldr60 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(PublicAttr))
locbldr60.SetLocalSymInfo("pubattr")
...
Dim locbldr61 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(InitOnlyAttr))
locbldr61.SetLocalSymInfo("initoattr")
...
Dim locbldr62 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(StaticAttr))
locbldr62.SetLocalSymInfo("statattr")
...
Dim locbldr63 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(AutoLayoutAttr))
locbldr63.SetLocalSymInfo("autattr")
...
Dim locbldr64 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(AutoClassAttr))
locbldr64.SetLocalSymInfo("autcattr")
...
Dim locbldr65 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(AnsiClassAttr))
locbldr65.SetLocalSymInfo("ansattr")
...
Dim locbldr66 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(BeforeFieldInitAttr))
locbldr66.SetLocalSymInfo("bfiattr")
...
Dim locbldr67 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(StringTok))
locbldr67.SetLocalSymInfo("strtok")
...
Dim locbldr68 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(VoidTok))
locbldr68.SetLocalSymInfo("voidtok")
...
Dim locbldr69 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(DecimalTok))
locbldr69.SetLocalSymInfo("decitok")
...
Dim locbldr70 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(IntegerTok))
locbldr70.SetLocalSymInfo("inttok")
...
Dim locbldr71 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(IntPtrTok))
locbldr71.SetLocalSymInfo("intptok")
...
Dim locbldr72 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(UIntegerTok))
locbldr72.SetLocalSymInfo("uinttok")
...
Dim locbldr73 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(DoubleTok))
locbldr73.SetLocalSymInfo("dbltok")
...
Dim locbldr74 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(BooleanTok))
locbldr74.SetLocalSymInfo("booltok")
...
Dim locbldr75 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(CharTok))
locbldr75.SetLocalSymInfo("chrtok")
...
Dim locbldr76 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(SingleTok))
locbldr76.SetLocalSymInfo("sngtok")
...
Dim locbldr77 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(SByteTok))
locbldr77.SetLocalSymInfo("sbytok")
...
Dim locbldr78 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(ByteTok))
locbldr78.SetLocalSymInfo("byttok")
...
Dim locbldr79 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(ShortTok))
locbldr79.SetLocalSymInfo("shtok")
...
Dim locbldr80 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(UShortTok))
locbldr80.SetLocalSymInfo("ushtok")
...
Dim locbldr81 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(LongTok))
locbldr81.SetLocalSymInfo("lngtok")
...
Dim locbldr82 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(ULongTok))
locbldr82.SetLocalSymInfo("ulngtok")
...
Dim locbldr83 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(ObjectTok))
locbldr83.SetLocalSymInfo("objtok")
...
ReDim Preserve typ96(UBound(typ96) + 1)
typ96(UBound(typ96)) = Typ
OptimizeIL.Emit(OpCodes.Call, GetType(Utils.ParseUtils).GetMethod("LikeOP", typ96))
Typ = GetType(Utils.ParseUtils).GetMethod("LikeOP", typ96).ReturnType
OptimizeIL.Emit(OpCodes.Stloc, 1)
...
Dim locbldr84 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(commentTok))
locbldr84.SetLocalSymInfo("comtok")
...
Dim locbldr85 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(BooleanLiteral))
locbldr85.SetLocalSymInfo("boolit")
...
Dim locbldr86 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(CharLiteral))
locbldr86.SetLocalSymInfo("chrlit")
...
OptimizeIL.Emit(OpCodes.Ldstr, "'")
Typ = GetType(System.String)
Dim typ102 As Type() = {Typ}
OptimizeIL.Emit(OpCodes.Call, GetType(System.Convert).GetMethod("ToChar", typ102))
Typ = GetType(System.Convert).GetMethod("ToChar", typ102).ReturnType
...
OptimizeIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("Trim", typ103))
Typ = Typ03.GetMethod("Trim", typ103).ReturnType
OptimizeIL.Emit(OpCodes.Stloc, 2)
...
OptimizeIL.Emit(OpCodes.Call, GetType(System.Convert).GetMethod("ToChar", typ104))
Typ = GetType(System.Convert).GetMethod("ToChar", typ104).ReturnType
...
ReDim Preserve typ105(UBound(typ105) + 1)
typ105(UBound(typ105)) = Typ
OptimizeIL.Emit(OpCodes.Call, GetType(String).GetMethod("Concat", typ105))
Typ = GetType(String).GetMethod("Concat", typ105).ReturnType
OptimizeIL.Emit(OpCodes.Stloc, 2)
...
Dim locbldr87 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(StringLiteral))
locbldr87.SetLocalSymInfo("strlit")
...
OptimizeIL.Emit(OpCodes.Call, GetType(System.Convert).GetMethod("ToChar", typ107))
Typ = GetType(System.Convert).GetMethod("ToChar", typ107).ReturnType
OptimizeIL.Emit(OpCodes.Stelem, GetType(System.Char).MakeArrayType().GetElementType())
...
OptimizeIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("Trim", typ108))
Typ = Typ03.GetMethod("Trim", typ108).ReturnType
OptimizeIL.Emit(OpCodes.Stloc, 2)
...
ReDim Preserve typ111(UBound(typ111) + 1)
typ111(UBound(typ111)) = Typ
OptimizeIL.Emit(OpCodes.Call, GetType(Utils.ParseUtils).GetMethod("LikeOP", typ111))
Typ = GetType(Utils.ParseUtils).GetMethod("LikeOP", typ111).ReturnType
OptimizeIL.Emit(OpCodes.Stloc, 1)
...
OptimizeIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("EndsWith", typ112))
Typ = Typ03.GetMethod("EndsWith", typ112).ReturnType
OptimizeIL.Emit(OpCodes.Stloc, 1)
...
Dim locbldr88 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(DoubleLiteral))
locbldr88.SetLocalSymInfo("dlit2")
...
OptimizeIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("TrimEnd", typ114))
Typ = Typ03.GetMethod("TrimEnd", typ114).ReturnType
OptimizeIL.Emit(OpCodes.Stloc, 2)
...
OptimizeIL.Emit(OpCodes.Call, GetType(System.Convert).GetMethod("ToDouble", typ115))
Typ = GetType(System.Convert).GetMethod("ToDouble", typ115).ReturnType
...
OptimizeIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("EndsWith", typ119))
Typ = Typ03.GetMethod("EndsWith", typ119).ReturnType
OptimizeIL.Emit(OpCodes.Stloc, 1)
...
Dim locbldr89 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(FloatLiteral))
locbldr89.SetLocalSymInfo("flit")
...
OptimizeIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("TrimEnd", typ121))
Typ = Typ03.GetMethod("TrimEnd", typ121).ReturnType
OptimizeIL.Emit(OpCodes.Stloc, 2)
...
OptimizeIL.Emit(OpCodes.Call, GetType(System.Convert).GetMethod("ToSingle", typ122))
Typ = GetType(System.Convert).GetMethod("ToSingle", typ122).ReturnType
...
Dim locbldr90 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(DoubleLiteral))
locbldr90.SetLocalSymInfo("dlit")
OptimizeIL.Emit(OpCodes.Newobj, GetType(DoubleLiteral).GetConstructor(Type.EmptyTypes))
...
OptimizeIL.Emit(OpCodes.Call, GetType(System.Convert).GetMethod("ToDouble", typ126))
Typ = GetType(System.Convert).GetMethod("ToDouble", typ126).ReturnType
OptimizeIL.Emit(OpCodes.Stfld, GetType(DoubleLiteral).GetField("NumVal"))
...
Dim locbldr91 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(DoubleLiteral))
locbldr91.SetLocalSymInfo("dlit3")
OptimizeIL.Emit(OpCodes.Newobj, GetType(DoubleLiteral).GetConstructor(Type.EmptyTypes))
...
OptimizeIL.Emit(OpCodes.Call, GetType(System.Convert).GetMethod("ToDouble", typ133))
Typ = GetType(System.Convert).GetMethod("ToDouble", typ133).ReturnType
OptimizeIL.Emit(OpCodes.Stfld, GetType(DoubleLiteral).GetField("NumVal"))
...
Dim locbldr92 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(FloatLiteral))
locbldr92.SetLocalSymInfo("flit2")
OptimizeIL.Emit(OpCodes.Newobj, GetType(FloatLiteral).GetConstructor(Type.EmptyTypes))
...
OptimizeIL.Emit(OpCodes.Call, GetType(System.Convert).GetMethod("ToSingle", typ140))
Typ = GetType(System.Convert).GetMethod("ToSingle", typ140).ReturnType
OptimizeIL.Emit(OpCodes.Stfld, GetType(FloatLiteral).GetField("NumVal"))
...
OptimizeIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("EndsWith", typ144))
Typ = Typ03.GetMethod("EndsWith", typ144).ReturnType
OptimizeIL.Emit(OpCodes.Stloc, 1)
...
Dim locbldr93 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(UIntLiteral))
locbldr93.SetLocalSymInfo("uilit2")
...
OptimizeIL.Emit(OpCodes.Call, GetType(System.Convert).GetMethod("ToChar", typ145))
Typ = GetType(System.Convert).GetMethod("ToChar", typ145).ReturnType
OptimizeIL.Emit(OpCodes.Stelem, GetType(System.Char).MakeArrayType().GetElementType())
...
OptimizeIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("TrimEnd", typ146))
Typ = Typ03.GetMethod("TrimEnd", typ146).ReturnType
OptimizeIL.Emit(OpCodes.Stloc, 2)
...
OptimizeIL.Emit(OpCodes.Call, GetType(Convert).GetMethod("ToUInt32", typ149))
Typ = GetType(Convert).GetMethod("ToUInt32", typ149).ReturnType
...
Dim locbldr94 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(IntPtrLiteral))
locbldr94.SetLocalSymInfo("iplit2")
...
OptimizeIL.Emit(OpCodes.Call, GetType(System.Convert).GetMethod("ToInt32", typ159))
Typ = GetType(System.Convert).GetMethod("ToInt32", typ159).ReturnType
ReDim Preserve typ158(UBound(typ158) + 1)
typ158(UBound(typ158)) = Typ
OptimizeIL.Emit(OpCodes.Newobj, GetType(IntPtr).GetConstructor(typ158))
...
OptimizeIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("EndsWith", typ163))
Typ = Typ03.GetMethod("EndsWith", typ163).ReturnType
OptimizeIL.Emit(OpCodes.Stloc, 1)
...
Dim locbldr95 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(IntLiteral))
locbldr95.SetLocalSymInfo("ilit2")
...
OptimizeIL.Emit(OpCodes.Ldstr, "i")
Typ = GetType(System.String)
Dim typ164 As Type() = {Typ}
OptimizeIL.Emit(OpCodes.Call, GetType(System.Convert).GetMethod("ToChar", typ164))
Typ = GetType(System.Convert).GetMethod("ToChar", typ164).ReturnType
OptimizeIL.Emit(OpCodes.Stelem, GetType(System.Char).MakeArrayType().GetElementType())
...
OptimizeIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("TrimEnd", typ165))
Typ = Typ03.GetMethod("TrimEnd", typ165).ReturnType
OptimizeIL.Emit(OpCodes.Stloc, 2)
...
OptimizeIL.Emit(OpCodes.Call, GetType(System.Convert).GetMethod("ToInt32", typ166))
Typ = GetType(System.Convert).GetMethod("ToInt32", typ166).ReturnType
...
ReDim Preserve typ167(UBound(typ167) + 1)
typ167(UBound(typ167)) = Typ
OptimizeIL.Emit(OpCodes.Call, GetType(Utils.ParseUtils).GetMethod("LikeOP", typ167))
...
ReDim Preserve typ168(UBound(typ168) + 1)
typ168(UBound(typ168)) = Typ
OptimizeIL.Emit(OpCodes.Call, GetType(Utils.ParseUtils).GetMethod("LikeOP", typ168))
Typ = GetType(Utils.ParseUtils).GetMethod("LikeOP", typ168).ReturnType
OptimizeIL.Emit(OpCodes.Stloc, 1)
...
OptimizeIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("EndsWith", typ170))
Typ = Typ03.GetMethod("EndsWith", typ170).ReturnType
OptimizeIL.Emit(OpCodes.Stloc, 1)
...
Dim locbldr96 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(ULongLiteral))
locbldr96.SetLocalSymInfo("ullit")
...
OptimizeIL.Emit(OpCodes.Call, GetType(System.Convert).GetMethod("ToChar", typ171))
Typ = GetType(System.Convert).GetMethod("ToChar", typ171).ReturnType
OptimizeIL.Emit(OpCodes.Stelem, GetType(System.Char).MakeArrayType().GetElementType())
...
OptimizeIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("TrimEnd", typ172))
Typ = Typ03.GetMethod("TrimEnd", typ172).ReturnType
OptimizeIL.Emit(OpCodes.Stloc, 2)
...
OptimizeIL.Emit(OpCodes.Call, GetType(Convert).GetMethod("ToUInt64", typ175))
Typ = GetType(Convert).GetMethod("ToUInt64", typ175).ReturnType
...
Dim locbldr97 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(LongLiteral))
locbldr97.SetLocalSymInfo("llit")
...
OptimizeIL.Emit(OpCodes.Call, GetType(System.Convert).GetMethod("ToInt64", typ182))
Typ = GetType(System.Convert).GetMethod("ToInt64", typ182).ReturnType
...
ReDim Preserve typ183(UBound(typ183) + 1)
typ183(UBound(typ183)) = Typ
OptimizeIL.Emit(OpCodes.Call, GetType(Utils.ParseUtils).GetMethod("LikeOP", typ183))
Typ = GetType(Utils.ParseUtils).GetMethod("LikeOP", typ183).ReturnType
OptimizeIL.Emit(OpCodes.Stloc, 1)
...
ReDim Preserve typ184(UBound(typ184) + 1)
typ184(UBound(typ184)) = Typ
OptimizeIL.Emit(OpCodes.Call, GetType(Utils.ParseUtils).GetMethod("LikeOP", typ184))
Typ = GetType(Utils.ParseUtils).GetMethod("LikeOP", typ184).ReturnType
OptimizeIL.Emit(OpCodes.Stloc, 1)
...
OptimizeIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("EndsWith", typ186))
Typ = Typ03.GetMethod("EndsWith", typ186).ReturnType
OptimizeIL.Emit(OpCodes.Stloc, 1)
...
Dim locbldr98 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(UShortLiteral))
locbldr98.SetLocalSymInfo("uslit")
...
Typ = GetType(System.String)
Dim typ187 As Type() = {Typ}
OptimizeIL.Emit(OpCodes.Call, GetType(System.Convert).GetMethod("ToChar", typ187))
Typ = GetType(System.Convert).GetMethod("ToChar", typ187).ReturnType
OptimizeIL.Emit(OpCodes.Stelem, GetType(System.Char).MakeArrayType().GetElementType())
...
OptimizeIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("TrimEnd", typ188))
Typ = Typ03.GetMethod("TrimEnd", typ188).ReturnType
OptimizeIL.Emit(OpCodes.Stloc, 2)
...
OptimizeIL.Emit(OpCodes.Call, GetType(Convert).GetMethod("ToUInt16", typ191))
Typ = GetType(Convert).GetMethod("ToUInt16", typ191).ReturnType
...
Dim locbldr99 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(ShortLiteral))
locbldr99.SetLocalSymInfo("slit")
...
OptimizeIL.Emit(OpCodes.Call, GetType(System.Convert).GetMethod("ToInt16", typ198))
Typ = GetType(System.Convert).GetMethod("ToInt16", typ198).ReturnType
...
ReDim Preserve typ199(UBound(typ199) + 1)
typ199(UBound(typ199)) = Typ
OptimizeIL.Emit(OpCodes.Call, GetType(Utils.ParseUtils).GetMethod("LikeOP", typ199))
Typ = GetType(Utils.ParseUtils).GetMethod("LikeOP", typ199).ReturnType
OptimizeIL.Emit(OpCodes.Stloc, 1)
...
ReDim Preserve typ200(UBound(typ200) + 1)
typ200(UBound(typ200)) = Typ
OptimizeIL.Emit(OpCodes.Call, GetType(Utils.ParseUtils).GetMethod("LikeOP", typ200))
Typ = GetType(Utils.ParseUtils).GetMethod("LikeOP", typ200).ReturnType
OptimizeIL.Emit(OpCodes.Stloc, 1)
...
OptimizeIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("EndsWith", typ202))
Typ = Typ03.GetMethod("EndsWith", typ202).ReturnType
OptimizeIL.Emit(OpCodes.Stloc, 1)
...
Dim locbldr100 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(ByteLiteral))
locbldr100.SetLocalSymInfo("ublit")
...
Typ = GetType(System.String)
Dim typ203 As Type() = {Typ}
OptimizeIL.Emit(OpCodes.Call, GetType(System.Convert).GetMethod("ToChar", typ203))
Typ = GetType(System.Convert).GetMethod("ToChar", typ203).ReturnType
OptimizeIL.Emit(OpCodes.Stelem, GetType(System.Char).MakeArrayType().GetElementType())
...
OptimizeIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("TrimEnd", typ204))
Typ = Typ03.GetMethod("TrimEnd", typ204).ReturnType
OptimizeIL.Emit(OpCodes.Stloc, 2)
...
OptimizeIL.Emit(OpCodes.Call, GetType(Convert).GetMethod("ToByte", typ207))
Typ = GetType(Convert).GetMethod("ToByte", typ207).ReturnType
...
Dim locbldr101 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(SByteLiteral))
locbldr101.SetLocalSymInfo("blit")
...
OptimizeIL.Emit(OpCodes.Call, GetType(System.Convert).GetMethod("ToSByte", typ214))
Typ = GetType(System.Convert).GetMethod("ToSByte", typ214).ReturnType
...
ReDim Preserve typ215(UBound(typ215) + 1)
typ215(UBound(typ215)) = Typ
OptimizeIL.Emit(OpCodes.Call, GetType(Utils.ParseUtils).GetMethod("LikeOP", typ215))
Typ = GetType(Utils.ParseUtils).GetMethod("LikeOP", typ215).ReturnType
OptimizeIL.Emit(OpCodes.Stloc, 1)
...
ReDim Preserve typ216(UBound(typ216) + 1)
typ216(UBound(typ216)) = Typ
OptimizeIL.Emit(OpCodes.Call, GetType(Utils.ParseUtils).GetMethod("LikeOP", typ216))
Typ = GetType(Utils.ParseUtils).GetMethod("LikeOP", typ216).ReturnType
OptimizeIL.Emit(OpCodes.Stloc, 1)
...
Dim locbldr102 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(IntLiteral))
locbldr102.SetLocalSymInfo("ilit")
OptimizeIL.Emit(OpCodes.Newobj, GetType(IntLiteral).GetConstructor(Type.EmptyTypes))
...
OptimizeIL.Emit(OpCodes.Call, GetType(System.Convert).GetMethod("ToInt32", typ218))
Typ = GetType(System.Convert).GetMethod("ToInt32", typ218).ReturnType
OptimizeIL.Emit(OpCodes.Stfld, GetType(IntLiteral).GetField("NumVal"))
...
Dim locbldr103 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(Ident))
locbldr103.SetLocalSymInfo("idt")
...
Dim locbldr104 As LocalBuilder = checkVarAsIL.DeclareLocal(GetType(Token))
locbldr104.SetLocalSymInfo("tok")
...
Dim locbldr105 As LocalBuilder = checkVarAsIL.DeclareLocal(GetType(System.Type))
locbldr105.SetLocalSymInfo("typ")
...
Dim locbldr106 As LocalBuilder = checkVarAsIL.DeclareLocal(GetType(VarExpr))
locbldr106.SetLocalSymInfo("vars")
...
Typ = GetType(System.Boolean)
Dim fa103 As System.Reflection.Emit.Label = checkVarAsIL.DefineLabel()
Dim tru103 As System.Reflection.Emit.Label = checkVarAsIL.DefineLabel()
Dim cont103 As System.Reflection.Emit.Label = checkVarAsIL.DefineLabel()
checkVarAsIL.Emit(OpCodes.Beq, tru103)
checkVarAsIL.Emit(OpCodes.Br, fa103)
checkVarAsIL.MarkLabel(tru103)
...
Dim locbldr107 As LocalBuilder = checkVarAsIL.DeclareLocal(GetType(Token))
locbldr107.SetLocalSymInfo("tok2")
checkVarAsIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Expr)
checkVarAsIL.Emit(OpCodes.Ldfld, GetType(Expr).GetField("Tokens"))
Typ = GetType(Expr).GetField("Tokens").FieldType
...
Dim locbldr108 As LocalBuilder = checkVarAsIL.DeclareLocal(GetType(System.Type))
locbldr108.SetLocalSymInfo("typ2")
...
Dim locbldr109 As LocalBuilder = checkVarAsIL.DeclareLocal(GetType(System.Boolean))
locbldr109.SetLocalSymInfo("b2")
Dim typ4(-1) As Type
...
checkVarAsIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa104 As System.Reflection.Emit.Label = checkVarAsIL.DefineLabel()
Dim tru104 As System.Reflection.Emit.Label = checkVarAsIL.DefineLabel()
Dim cont104 As System.Reflection.Emit.Label = checkVarAsIL.DefineLabel()
checkVarAsIL.Emit(OpCodes.Beq, fa104)
checkVarAsIL.Emit(OpCodes.Br, tru104)
checkVarAsIL.MarkLabel(tru104)
checkVarAsIL.MarkSequencePoint(doc4, 27, 1, 27, 100)
Dim locbldr110 As LocalBuilder = checkVarAsIL.DeclareLocal(GetType(Token))
locbldr110.SetLocalSymInfo("t")
checkVarAsIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Expr)
checkVarAsIL.Emit(OpCodes.Ldfld, GetType(Expr).GetField("Tokens"))
Typ = GetType(Expr).GetField("Tokens").FieldType
...
Dim locbldr111 As LocalBuilder = checkVarAsIL.DeclareLocal(GetType(TypeTok))
locbldr111.SetLocalSymInfo("tt")
...
checkVarAsIL.Emit(OpCodes.Br, cont104)
checkVarAsIL.MarkLabel(fa104)
...
checkVarAsIL.Emit(OpCodes.Br, cont104)
checkVarAsIL.MarkLabel(cont104)
checkVarAsIL.MarkSequencePoint(doc4, 36, 1, 36, 100)
checkVarAsIL.Emit(OpCodes.Br, cont103)
checkVarAsIL.MarkLabel(fa103)
checkVarAsIL.Emit(OpCodes.Br, cont103)
checkVarAsIL.MarkLabel(cont103)
...
Dim locbldr112 As LocalBuilder = procMethodCallIL.DeclareLocal(GetType(MethodNameTok))
locbldr112.SetLocalSymInfo("mn")
...
Dim locbldr113 As LocalBuilder = procMethodCallIL.DeclareLocal(GetType(MethodCallTok))
locbldr113.SetLocalSymInfo("mct")
...
Dim locbldr114 As LocalBuilder = procMethodCallIL.DeclareLocal(GetType(Ident))
...
Dim locbldr115 As LocalBuilder = procMethodCallIL.DeclareLocal(GetType(Expr))
locbldr115.SetLocalSymInfo("ep2")
...
Dim locbldr116 As LocalBuilder = procMethodCallIL.DeclareLocal(GetType(System.Int32))
locbldr116.SetLocalSymInfo("lvl")
...
Dim locbldr117 As LocalBuilder = procMethodCallIL.DeclareLocal(GetType(System.Boolean))
locbldr117.SetLocalSymInfo("d")
...
Dim locbldr118 As LocalBuilder = procMethodCallIL.DeclareLocal(GetType(System.Int32))
locbldr118.SetLocalSymInfo("j")
...
Dim locbldr119 As LocalBuilder = procMethodCallIL.DeclareLocal(GetType(Token))
...
Dim locbldr120 As LocalBuilder = procMethodCallIL.DeclareLocal(GetType(System.Type))
locbldr120.SetLocalSymInfo("typ2")
procMethodCallIL.MarkSequencePoint(doc4, 77, 1, 77, 100)
Dim locbldr121 As LocalBuilder = procMethodCallIL.DeclareLocal(GetType(System.Boolean))
locbldr121.SetLocalSymInfo("b2")
procMethodCallIL.MarkSequencePoint(doc4, 78, 1, 78, 100)
Dim locbldr122 As LocalBuilder = procMethodCallIL.DeclareLocal(GetType(System.Int32))
...
procMethodCallIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa105 As System.Reflection.Emit.Label = procMethodCallIL.DefineLabel()
Dim tru105 As System.Reflection.Emit.Label = procMethodCallIL.DefineLabel()
Dim cont105 As System.Reflection.Emit.Label = procMethodCallIL.DefineLabel()
procMethodCallIL.Emit(OpCodes.Beq, tru105)
procMethodCallIL.Emit(OpCodes.Br, fa105)
procMethodCallIL.MarkLabel(tru105)
...
procMethodCallIL.Emit(OpCodes.Ldc_I4, CInt(0))
Typ = GetType(System.Int32)
Dim fa106 As System.Reflection.Emit.Label = procMethodCallIL.DefineLabel()
Dim tru106 As System.Reflection.Emit.Label = procMethodCallIL.DefineLabel()
Dim cont106 As System.Reflection.Emit.Label = procMethodCallIL.DefineLabel()
procMethodCallIL.Emit(OpCodes.Beq, tru106)
procMethodCallIL.Emit(OpCodes.Br, fa106)
procMethodCallIL.MarkLabel(tru106)
...
procMethodCallIL.Emit(OpCodes.Ldc_I4, CInt(0))
Typ = GetType(System.Int32)
Dim fa107 As System.Reflection.Emit.Label = procMethodCallIL.DefineLabel()
Dim tru107 As System.Reflection.Emit.Label = procMethodCallIL.DefineLabel()
Dim cont107 As System.Reflection.Emit.Label = procMethodCallIL.DefineLabel()
procMethodCallIL.Emit(OpCodes.Beq, fa107)
procMethodCallIL.Emit(OpCodes.Br, tru107)
procMethodCallIL.MarkLabel(tru107)
...
procMethodCallIL.Emit(OpCodes.Br, cont107)
procMethodCallIL.MarkLabel(fa107)
procMethodCallIL.Emit(OpCodes.Br, cont107)
procMethodCallIL.MarkLabel(cont107)
...
procMethodCallIL.Emit(OpCodes.Br, cont106)
procMethodCallIL.MarkLabel(fa106)
...
procMethodCallIL.Emit(OpCodes.Br, cont106)
procMethodCallIL.MarkLabel(cont106)
procMethodCallIL.MarkSequencePoint(doc4, 111, 1, 111, 100)
procMethodCallIL.Emit(OpCodes.Br, label2)
procMethodCallIL.MarkSequencePoint(doc4, 112, 1, 112, 100)
procMethodCallIL.Emit(OpCodes.Br, cont105)
procMethodCallIL.MarkLabel(fa105)
procMethodCallIL.Emit(OpCodes.Br, cont105)
procMethodCallIL.MarkLabel(cont105)
...
procMethodCallIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa108 As System.Reflection.Emit.Label = procMethodCallIL.DefineLabel()
Dim tru108 As System.Reflection.Emit.Label = procMethodCallIL.DefineLabel()
Dim cont108 As System.Reflection.Emit.Label = procMethodCallIL.DefineLabel()
procMethodCallIL.Emit(OpCodes.Beq, tru108)
procMethodCallIL.Emit(OpCodes.Br, fa108)
procMethodCallIL.MarkLabel(tru108)
...
procMethodCallIL.Emit(OpCodes.Br, cont108)
procMethodCallIL.MarkLabel(fa108)
procMethodCallIL.Emit(OpCodes.Br, cont108)
procMethodCallIL.MarkLabel(cont108)
...
procMethodCallIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa109 As System.Reflection.Emit.Label = procMethodCallIL.DefineLabel()
Dim tru109 As System.Reflection.Emit.Label = procMethodCallIL.DefineLabel()
Dim cont109 As System.Reflection.Emit.Label = procMethodCallIL.DefineLabel()
procMethodCallIL.Emit(OpCodes.Beq, tru109)
procMethodCallIL.Emit(OpCodes.Br, fa109)
procMethodCallIL.MarkLabel(tru109)
procMethodCallIL.MarkSequencePoint(doc4, 130, 1, 130, 100)
procMethodCallIL.Emit(OpCodes.Ldloc, 4)
Typ = GetType(System.Int32)
procMethodCallIL.Emit(OpCodes.Ldc_I4, CInt(1))
Typ = GetType(System.Int32)
Dim fa110 As System.Reflection.Emit.Label = procMethodCallIL.DefineLabel()
Dim tru110 As System.Reflection.Emit.Label = procMethodCallIL.DefineLabel()
Dim cont110 As System.Reflection.Emit.Label = procMethodCallIL.DefineLabel()
procMethodCallIL.Emit(OpCodes.Beq, tru110)
procMethodCallIL.Emit(OpCodes.Br, fa110)
procMethodCallIL.MarkLabel(tru110)
...
procMethodCallIL.Emit(OpCodes.Ldc_I4, CInt(0))
Typ = GetType(System.Int32)
Dim fa111 As System.Reflection.Emit.Label = procMethodCallIL.DefineLabel()
Dim tru111 As System.Reflection.Emit.Label = procMethodCallIL.DefineLabel()
Dim cont111 As System.Reflection.Emit.Label = procMethodCallIL.DefineLabel()
procMethodCallIL.Emit(OpCodes.Beq, fa111)
procMethodCallIL.Emit(OpCodes.Br, tru111)
procMethodCallIL.MarkLabel(tru111)
...
procMethodCallIL.Emit(OpCodes.Br, cont111)
procMethodCallIL.MarkLabel(fa111)
procMethodCallIL.Emit(OpCodes.Br, cont111)
procMethodCallIL.MarkLabel(cont111)
...
procMethodCallIL.Emit(OpCodes.Br, cont110)
procMethodCallIL.MarkLabel(fa110)
...
procMethodCallIL.Emit(OpCodes.Br, cont110)
procMethodCallIL.MarkLabel(cont110)
procMethodCallIL.MarkSequencePoint(doc4, 144, 1, 144, 100)
procMethodCallIL.Emit(OpCodes.Br, cont109)
procMethodCallIL.MarkLabel(fa109)
...
procMethodCallIL.Emit(OpCodes.Br, cont109)
procMethodCallIL.MarkLabel(cont109)
...
procMethodCallIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa112 As System.Reflection.Emit.Label = procMethodCallIL.DefineLabel()
Dim tru112 As System.Reflection.Emit.Label = procMethodCallIL.DefineLabel()
Dim cont112 As System.Reflection.Emit.Label = procMethodCallIL.DefineLabel()
procMethodCallIL.Emit(OpCodes.Beq, tru112)
procMethodCallIL.Emit(OpCodes.Br, fa112)
procMethodCallIL.MarkLabel(tru112)
...
procMethodCallIL.Emit(OpCodes.Br, cont112)
procMethodCallIL.MarkLabel(fa112)
procMethodCallIL.Emit(OpCodes.Br, cont112)
procMethodCallIL.MarkLabel(cont112)
...
Dim procIdentArrayAccess As MethodBuilder = ExprOptimizer.DefineMethod("procIdentArrayAccess", MethodAttributes.Public, GetType(Expr), typ21)
...
procIdentArrayAccessIL.MarkSequencePoint(doc4, 176, 1, 176, 100)
Dim locbldr123 As LocalBuilder = procIdentArrayAccessIL.DeclareLocal(GetType(Ident))
locbldr123.SetLocalSymInfo("idt")
procIdentArrayAccessIL.Emit(OpCodes.Ldnull)
procIdentArrayAccessIL.Emit(OpCodes.Stloc, 0)
procIdentArrayAccessIL.MarkSequencePoint(doc4, 177, 1, 177, 100)
Dim locbldr124 As LocalBuilder = procIdentArrayAccessIL.DeclareLocal(GetType(Expr))
locbldr124.SetLocalSymInfo("ep2")
...
procIdentArrayAccessIL.MarkSequencePoint(doc4, 178, 1, 178, 100)
Dim locbldr125 As LocalBuilder = procIdentArrayAccessIL.DeclareLocal(GetType(System.Int32))
locbldr125.SetLocalSymInfo("lvl")
procIdentArrayAccessIL.Emit(OpCodes.Ldc_I4, CInt(1))
Typ = GetType(System.Int32)
procIdentArrayAccessIL.Emit(OpCodes.Stloc, 2)
procIdentArrayAccessIL.MarkSequencePoint(doc4, 179, 1, 179, 100)
Dim locbldr126 As LocalBuilder = procIdentArrayAccessIL.DeclareLocal(GetType(System.Boolean))
locbldr126.SetLocalSymInfo("d")
procIdentArrayAccessIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
procIdentArrayAccessIL.Emit(OpCodes.Stloc, 3)
procIdentArrayAccessIL.MarkSequencePoint(doc4, 180, 1, 180, 100)
Dim locbldr127 As LocalBuilder = procIdentArrayAccessIL.DeclareLocal(GetType(System.Int32))
locbldr127.SetLocalSymInfo("j")
procIdentArrayAccessIL.Emit(OpCodes.Ldc_I4, CInt(0))
Typ = GetType(System.Int32)
procIdentArrayAccessIL.Emit(OpCodes.Stloc, 4)
procIdentArrayAccessIL.MarkSequencePoint(doc4, 182, 1, 182, 100)
...
procIdentArrayAccessIL.MarkSequencePoint(doc4, 183, 1, 183, 100)
...
Typ = Typ.GetElementType()
procIdentArrayAccessIL.Emit(OpCodes.Stloc, 0)
procIdentArrayAccessIL.MarkSequencePoint(doc4, 184, 1, 184, 100)
procIdentArrayAccessIL.Emit(OpCodes.Ldarg, 2)
Typ = GetType(System.Int32)
procIdentArrayAccessIL.Emit(OpCodes.Stloc, 4)
procIdentArrayAccessIL.MarkSequencePoint(doc4, 185, 1, 185, 100)
procIdentArrayAccessIL.Emit(OpCodes.Ldarg, 2)
Typ = GetType(System.Int32)
procIdentArrayAccessIL.Emit(OpCodes.Ldc_I4, CInt(1))
Typ = GetType(System.Int32)
...
procIdentArrayAccessIL.Emit(OpCodes.Starg, 2)
procIdentArrayAccessIL.MarkSequencePoint(doc4, 187, 1, 187, 100)
Dim locbldr128 As LocalBuilder = procIdentArrayAccessIL.DeclareLocal(GetType(Token))
locbldr128.SetLocalSymInfo("tok2")
procIdentArrayAccessIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Expr)
procIdentArrayAccessIL.Emit(OpCodes.Ldfld, GetType(Expr).GetField("Tokens"))
Typ = GetType(Expr).GetField("Tokens").FieldType
...
procIdentArrayAccessIL.MarkSequencePoint(doc4, 188, 1, 188, 100)
Dim locbldr129 As LocalBuilder = procIdentArrayAccessIL.DeclareLocal(GetType(System.Type))
locbldr129.SetLocalSymInfo("typ2")
procIdentArrayAccessIL.MarkSequencePoint(doc4, 189, 1, 189, 100)
Dim locbldr130 As LocalBuilder = procIdentArrayAccessIL.DeclareLocal(GetType(System.Boolean))
locbldr130.SetLocalSymInfo("b2")
procIdentArrayAccessIL.MarkSequencePoint(doc4, 190, 1, 190, 100)
Dim locbldr131 As LocalBuilder = procIdentArrayAccessIL.DeclareLocal(GetType(System.Int32))
...
procIdentArrayAccessIL.MarkSequencePoint(doc4, 192, 1, 192, 100)
Dim typ22(-1) As Type
procIdentArrayAccessIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Expr)
Typ03 = Typ
...
ReDim Preserve typ22(UBound(typ22) + 1)
typ22(UBound(typ22)) = Typ
procIdentArrayAccessIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("RemToken", typ22))
...
End If
procIdentArrayAccessIL.MarkSequencePoint(doc4, 193, 1, 193, 100)
procIdentArrayAccessIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Expr)
procIdentArrayAccessIL.Emit(OpCodes.Ldfld, GetType(Expr).GetField("Tokens"))
Typ = GetType(Expr).GetField("Tokens").FieldType
...
procIdentArrayAccessIL.Emit(OpCodes.Sub)
procIdentArrayAccessIL.Emit(OpCodes.Stloc, 8)
procIdentArrayAccessIL.MarkSequencePoint(doc4, 194, 1, 194, 100)
procIdentArrayAccessIL.Emit(OpCodes.Ldarg, 2)
Typ = GetType(System.Int32)
procIdentArrayAccessIL.Emit(OpCodes.Ldc_I4, CInt(1))
Typ = GetType(System.Int32)
procIdentArrayAccessIL.Emit(OpCodes.Sub)
procIdentArrayAccessIL.Emit(OpCodes.Starg, 2)
procIdentArrayAccessIL.MarkSequencePoint(doc4, 196, 1, 196, 100)
Dim label3 As System.Reflection.Emit.Label = procIdentArrayAccessIL.DefineLabel()
procIdentArrayAccessIL.MarkSequencePoint(doc4, 197, 1, 197, 100)
Dim label4 As System.Reflection.Emit.Label = procIdentArrayAccessIL.DefineLabel()
procIdentArrayAccessIL.MarkSequencePoint(doc4, 198, 1, 198, 100)
Dim label5 As System.Reflection.Emit.Label = procIdentArrayAccessIL.DefineLabel()
procIdentArrayAccessIL.MarkSequencePoint(doc4, 200, 1, 200, 100)
procIdentArrayAccessIL.MarkLabel(label3)
procIdentArrayAccessIL.MarkSequencePoint(doc4, 203, 1, 203, 100)
procIdentArrayAccessIL.Emit(OpCodes.Ldarg, 2)
Typ = GetType(System.Int32)
procIdentArrayAccessIL.Emit(OpCodes.Ldc_I4, CInt(1))
Typ = GetType(System.Int32)
procIdentArrayAccessIL.Emit(OpCodes.Add)
procIdentArrayAccessIL.Emit(OpCodes.Starg, 2)
procIdentArrayAccessIL.MarkSequencePoint(doc4, 205, 1, 205, 100)
procIdentArrayAccessIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Expr)
procIdentArrayAccessIL.Emit(OpCodes.Ldfld, GetType(Expr).GetField("Tokens"))
Typ = GetType(Expr).GetField("Tokens").FieldType
...
ReDim Preserve typ24(UBound(typ24) + 1)
typ24(UBound(typ24)) = Typ
procIdentArrayAccessIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("IsInstanceOfType", typ24))
Typ = Typ03.GetMethod("IsInstanceOfType", typ24).ReturnType
procIdentArrayAccessIL.Emit(OpCodes.Stloc, 7)
procIdentArrayAccessIL.MarkSequencePoint(doc4, 208, 1, 208, 100)
procIdentArrayAccessIL.Emit(OpCodes.Ldloc, 7)
Typ = GetType(System.Boolean)
procIdentArrayAccessIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa114 As System.Reflection.Emit.Label = procIdentArrayAccessIL.DefineLabel()
Dim tru114 As System.Reflection.Emit.Label = procIdentArrayAccessIL.DefineLabel()
Dim cont114 As System.Reflection.Emit.Label = procIdentArrayAccessIL.DefineLabel()
procIdentArrayAccessIL.Emit(OpCodes.Beq, tru114)
procIdentArrayAccessIL.Emit(OpCodes.Br, fa114)
procIdentArrayAccessIL.MarkLabel(tru114)
procIdentArrayAccessIL.MarkSequencePoint(doc4, 209, 1, 209, 100)
...
procIdentArrayAccessIL.Emit(OpCodes.Sub)
procIdentArrayAccessIL.Emit(OpCodes.Stloc, 2)
procIdentArrayAccessIL.MarkSequencePoint(doc4, 210, 1, 210, 100)
procIdentArrayAccessIL.Emit(OpCodes.Ldloc, 2)
Typ = GetType(System.Int32)
procIdentArrayAccessIL.Emit(OpCodes.Ldc_I4, CInt(0))
Typ = GetType(System.Int32)
Dim fa115 As System.Reflection.Emit.Label = procIdentArrayAccessIL.DefineLabel()
Dim tru115 As System.Reflection.Emit.Label = procIdentArrayAccessIL.DefineLabel()
Dim cont115 As System.Reflection.Emit.Label = procIdentArrayAccessIL.DefineLabel()
procIdentArrayAccessIL.Emit(OpCodes.Beq, tru115)
procIdentArrayAccessIL.Emit(OpCodes.Br, fa115)
procIdentArrayAccessIL.MarkLabel(tru115)
procIdentArrayAccessIL.MarkSequencePoint(doc4, 211, 1, 211, 100)
procIdentArrayAccessIL.Emit(OpCodes.Ldc_I4, 0)
Typ = GetType(System.Boolean)
procIdentArrayAccessIL.Emit(OpCodes.Stloc, 3)
procIdentArrayAccessIL.MarkSequencePoint(doc4, 213, 1, 213, 100)
Dim typ25(-1) As Type
procIdentArrayAccessIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Expr)
Typ03 = Typ
...
ReDim Preserve typ25(UBound(typ25) + 1)
typ25(UBound(typ25)) = Typ
procIdentArrayAccessIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("RemToken", typ25))
Typ = Typ03.GetMethod("RemToken", typ25).ReturnType
If Typ.ToString() = GetType(System.Void).ToString() Then

Else
procIdentArrayAccessIL.Emit(OpCodes.Pop)
End If
procIdentArrayAccessIL.MarkSequencePoint(doc4, 214, 1, 214, 100)
procIdentArrayAccessIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Expr)
procIdentArrayAccessIL.Emit(OpCodes.Ldfld, GetType(Expr).GetField("Tokens"))
Typ = GetType(Expr).GetField("Tokens").FieldType
...
procIdentArrayAccessIL.Emit(OpCodes.Sub)
procIdentArrayAccessIL.Emit(OpCodes.Stloc, 8)
procIdentArrayAccessIL.MarkSequencePoint(doc4, 215, 1, 215, 100)
procIdentArrayAccessIL.Emit(OpCodes.Ldarg, 2)
Typ = GetType(System.Int32)
procIdentArrayAccessIL.Emit(OpCodes.Ldc_I4, CInt(1))
Typ = GetType(System.Int32)
procIdentArrayAccessIL.Emit(OpCodes.Sub)
procIdentArrayAccessIL.Emit(OpCodes.Starg, 2)
procIdentArrayAccessIL.MarkSequencePoint(doc4, 216, 1, 216, 100)
procIdentArrayAccessIL.Emit(OpCodes.Br, label4)
procIdentArrayAccessIL.MarkSequencePoint(doc4, 217, 1, 217, 100)
procIdentArrayAccessIL.Emit(OpCodes.Br, cont115)
procIdentArrayAccessIL.MarkLabel(fa115)
procIdentArrayAccessIL.MarkSequencePoint(doc4, 218, 1, 218, 100)
procIdentArrayAccessIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
procIdentArrayAccessIL.Emit(OpCodes.Stloc, 3)
procIdentArrayAccessIL.MarkSequencePoint(doc4, 219, 1, 219, 100)
procIdentArrayAccessIL.Emit(OpCodes.Br, label5)
procIdentArrayAccessIL.MarkSequencePoint(doc4, 220, 1, 220, 100)
procIdentArrayAccessIL.Emit(OpCodes.Br, cont115)
procIdentArrayAccessIL.MarkLabel(cont115)
procIdentArrayAccessIL.MarkSequencePoint(doc4, 221, 1, 221, 100)
procIdentArrayAccessIL.Emit(OpCodes.Br, label5)
procIdentArrayAccessIL.MarkSequencePoint(doc4, 222, 1, 222, 100)
procIdentArrayAccessIL.Emit(OpCodes.Br, cont114)
procIdentArrayAccessIL.MarkLabel(fa114)
procIdentArrayAccessIL.Emit(OpCodes.Br, cont114)
procIdentArrayAccessIL.MarkLabel(cont114)
procIdentArrayAccessIL.MarkSequencePoint(doc4, 224, 1, 224, 100)
procIdentArrayAccessIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Expr)
procIdentArrayAccessIL.Emit(OpCodes.Ldfld, GetType(Expr).GetField("Tokens"))
Typ = GetType(Expr).GetField("Tokens").FieldType
...
Typ = Typ.GetElementType()
procIdentArrayAccessIL.Emit(OpCodes.Stloc, 5)
procIdentArrayAccessIL.MarkSequencePoint(doc4, 225, 1, 225, 100)
procIdentArrayAccessIL.Emit(OpCodes.Ldtoken, GetType(LSParen))
Dim typ26 As Type() = {GetType(System.RuntimeTypeHandle)}
procIdentArrayAccessIL.Emit(OpCodes.Call, GetType(System.Type).GetMethod("GetTypeFromHandle", typ26))
Typ = GetType(System.Type).GetMethod("GetTypeFromHandle", typ26).ReturnType
procIdentArrayAccessIL.Emit(OpCodes.Stloc, 6)
procIdentArrayAccessIL.MarkSequencePoint(doc4, 226, 1, 226, 100)
Dim typ27(-1) As Type
procIdentArrayAccessIL.Emit(OpCodes.Ldloc, 6)
Typ = GetType(System.Type)
Typ03 = Typ
...
ReDim Preserve typ27(UBound(typ27) + 1)
typ27(UBound(typ27)) = Typ
procIdentArrayAccessIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("IsInstanceOfType", typ27))
Typ = Typ03.GetMethod("IsInstanceOfType", typ27).ReturnType
procIdentArrayAccessIL.Emit(OpCodes.Stloc, 7)
procIdentArrayAccessIL.MarkSequencePoint(doc4, 227, 1, 227, 100)
procIdentArrayAccessIL.Emit(OpCodes.Ldloc, 7)
Typ = GetType(System.Boolean)
procIdentArrayAccessIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa116 As System.Reflection.Emit.Label = procIdentArrayAccessIL.DefineLabel()
Dim tru116 As System.Reflection.Emit.Label = procIdentArrayAccessIL.DefineLabel()
Dim cont116 As System.Reflection.Emit.Label = procIdentArrayAccessIL.DefineLabel()
procIdentArrayAccessIL.Emit(OpCodes.Beq, tru116)
procIdentArrayAccessIL.Emit(OpCodes.Br, fa116)
procIdentArrayAccessIL.MarkLabel(tru116)
procIdentArrayAccessIL.MarkSequencePoint(doc4, 228, 1, 228, 100)
procIdentArrayAccessIL.Emit(OpCodes.Ldloc, 2)
Typ = GetType(System.Int32)
procIdentArrayAccessIL.Emit(OpCodes.Ldc_I4, CInt(1))
Typ = GetType(System.Int32)
procIdentArrayAccessIL.Emit(OpCodes.Add)
procIdentArrayAccessIL.Emit(OpCodes.Stloc, 2)
procIdentArrayAccessIL.MarkSequencePoint(doc4, 229, 1, 229, 100)
procIdentArrayAccessIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
procIdentArrayAccessIL.Emit(OpCodes.Stloc, 3)
procIdentArrayAccessIL.MarkSequencePoint(doc4, 230, 1, 230, 100)
procIdentArrayAccessIL.Emit(OpCodes.Br, label5)
procIdentArrayAccessIL.MarkSequencePoint(doc4, 231, 1, 231, 100)
procIdentArrayAccessIL.Emit(OpCodes.Br, cont116)
procIdentArrayAccessIL.MarkLabel(fa116)
procIdentArrayAccessIL.Emit(OpCodes.Br, cont116)
procIdentArrayAccessIL.MarkLabel(cont116)
procIdentArrayAccessIL.MarkSequencePoint(doc4, 233, 1, 233, 100)
procIdentArrayAccessIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Expr)
procIdentArrayAccessIL.Emit(OpCodes.Ldfld, GetType(Expr).GetField("Tokens"))
Typ = GetType(Expr).GetField("Tokens").FieldType
...
Typ = Typ.GetElementType()
procIdentArrayAccessIL.Emit(OpCodes.Stloc, 5)
procIdentArrayAccessIL.MarkSequencePoint(doc4, 234, 1, 234, 100)
procIdentArrayAccessIL.Emit(OpCodes.Ldtoken, GetType(Comma))
Dim typ28 As Type() = {GetType(System.RuntimeTypeHandle)}
procIdentArrayAccessIL.Emit(OpCodes.Call, GetType(System.Type).GetMethod("GetTypeFromHandle", typ28))
Typ = GetType(System.Type).GetMethod("GetTypeFromHandle", typ28).ReturnType
procIdentArrayAccessIL.Emit(OpCodes.Stloc, 6)
procIdentArrayAccessIL.MarkSequencePoint(doc4, 235, 1, 235, 100)
Dim typ29(-1) As Type
procIdentArrayAccessIL.Emit(OpCodes.Ldloc, 6)
Typ = GetType(System.Type)
Typ03 = Typ
...
ReDim Preserve typ29(UBound(typ29) + 1)
typ29(UBound(typ29)) = Typ
procIdentArrayAccessIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("IsInstanceOfType", typ29))
Typ = Typ03.GetMethod("IsInstanceOfType", typ29).ReturnType
procIdentArrayAccessIL.Emit(OpCodes.Stloc, 7)
procIdentArrayAccessIL.MarkSequencePoint(doc4, 236, 1, 236, 100)
procIdentArrayAccessIL.Emit(OpCodes.Ldloc, 7)
Typ = GetType(System.Boolean)
procIdentArrayAccessIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa117 As System.Reflection.Emit.Label = procIdentArrayAccessIL.DefineLabel()
Dim tru117 As System.Reflection.Emit.Label = procIdentArrayAccessIL.DefineLabel()
Dim cont117 As System.Reflection.Emit.Label = procIdentArrayAccessIL.DefineLabel()
procIdentArrayAccessIL.Emit(OpCodes.Beq, tru117)
procIdentArrayAccessIL.Emit(OpCodes.Br, fa117)
procIdentArrayAccessIL.MarkLabel(tru117)
procIdentArrayAccessIL.MarkSequencePoint(doc4, 237, 1, 237, 100)
procIdentArrayAccessIL.Emit(OpCodes.Br, cont117)
procIdentArrayAccessIL.MarkLabel(fa117)
procIdentArrayAccessIL.MarkSequencePoint(doc4, 238, 1, 238, 100)
procIdentArrayAccessIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
procIdentArrayAccessIL.Emit(OpCodes.Stloc, 3)
procIdentArrayAccessIL.MarkSequencePoint(doc4, 239, 1, 239, 100)
procIdentArrayAccessIL.Emit(OpCodes.Br, label5)
procIdentArrayAccessIL.MarkSequencePoint(doc4, 240, 1, 240, 100)
procIdentArrayAccessIL.Emit(OpCodes.Br, cont117)
procIdentArrayAccessIL.MarkLabel(cont117)
procIdentArrayAccessIL.MarkSequencePoint(doc4, 242, 1, 242, 100)
procIdentArrayAccessIL.MarkLabel(label5)
procIdentArrayAccessIL.MarkSequencePoint(doc4, 244, 1, 244, 100)
procIdentArrayAccessIL.Emit(OpCodes.Ldloc, 3)
Typ = GetType(System.Boolean)
procIdentArrayAccessIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa118 As System.Reflection.Emit.Label = procIdentArrayAccessIL.DefineLabel()
Dim tru118 As System.Reflection.Emit.Label = procIdentArrayAccessIL.DefineLabel()
Dim cont118 As System.Reflection.Emit.Label = procIdentArrayAccessIL.DefineLabel()
procIdentArrayAccessIL.Emit(OpCodes.Beq, tru118)
procIdentArrayAccessIL.Emit(OpCodes.Br, fa118)
procIdentArrayAccessIL.MarkLabel(tru118)
procIdentArrayAccessIL.MarkSequencePoint(doc4, 245, 1, 245, 100)
Dim typ30(-1) As Type
...
ReDim Preserve typ30(UBound(typ30) + 1)
typ30(UBound(typ30)) = Typ
procIdentArrayAccessIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("AddToken", typ30))
Typ = Typ03.GetMethod("AddToken", typ30).ReturnType
If Typ.ToString() = GetType(System.Void).ToString() Then

Else
procIdentArrayAccessIL.Emit(OpCodes.Pop)
End If
procIdentArrayAccessIL.MarkSequencePoint(doc4, 246, 1, 246, 100)
Dim typ31(-1) As Type
procIdentArrayAccessIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Expr)
Typ03 = Typ
...
ReDim Preserve typ31(UBound(typ31) + 1)
typ31(UBound(typ31)) = Typ
procIdentArrayAccessIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("RemToken", typ31))
Typ = Typ03.GetMethod("RemToken", typ31).ReturnType
If Typ.ToString() = GetType(System.Void).ToString() Then

Else
procIdentArrayAccessIL.Emit(OpCodes.Pop)
End If
procIdentArrayAccessIL.MarkSequencePoint(doc4, 247, 1, 247, 100)
procIdentArrayAccessIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Expr)
procIdentArrayAccessIL.Emit(OpCodes.Ldfld, GetType(Expr).GetField("Tokens"))
Typ = GetType(Expr).GetField("Tokens").FieldType
...
procIdentArrayAccessIL.Emit(OpCodes.Sub)
procIdentArrayAccessIL.Emit(OpCodes.Stloc, 8)
procIdentArrayAccessIL.MarkSequencePoint(doc4, 248, 1, 248, 100)
procIdentArrayAccessIL.Emit(OpCodes.Ldarg, 2)
Typ = GetType(System.Int32)
procIdentArrayAccessIL.Emit(OpCodes.Ldc_I4, CInt(1))
Typ = GetType(System.Int32)
procIdentArrayAccessIL.Emit(OpCodes.Sub)
procIdentArrayAccessIL.Emit(OpCodes.Starg, 2)
procIdentArrayAccessIL.MarkSequencePoint(doc4, 249, 1, 249, 100)
procIdentArrayAccessIL.Emit(OpCodes.Br, cont118)
procIdentArrayAccessIL.MarkLabel(fa118)
procIdentArrayAccessIL.Emit(OpCodes.Br, cont118)
procIdentArrayAccessIL.MarkLabel(cont118)
procIdentArrayAccessIL.MarkSequencePoint(doc4, 251, 1, 251, 100)
procIdentArrayAccessIL.Emit(OpCodes.Ldarg, 2)
Typ = GetType(System.Int32)
procIdentArrayAccessIL.Emit(OpCodes.Ldloc, 8)
Typ = GetType(System.Int32)
Dim fa119 As System.Reflection.Emit.Label = procIdentArrayAccessIL.DefineLabel()
Dim tru119 As System.Reflection.Emit.Label = procIdentArrayAccessIL.DefineLabel()
Dim cont119 As System.Reflection.Emit.Label = procIdentArrayAccessIL.DefineLabel()
procIdentArrayAccessIL.Emit(OpCodes.Beq, tru119)
procIdentArrayAccessIL.Emit(OpCodes.Br, fa119)
procIdentArrayAccessIL.MarkLabel(tru119)
procIdentArrayAccessIL.MarkSequencePoint(doc4, 252, 1, 252, 100)
procIdentArrayAccessIL.Emit(OpCodes.Br, label4)
procIdentArrayAccessIL.MarkSequencePoint(doc4, 253, 1, 253, 100)
procIdentArrayAccessIL.Emit(OpCodes.Br, cont119)
procIdentArrayAccessIL.MarkLabel(fa119)
procIdentArrayAccessIL.MarkSequencePoint(doc4, 254, 1, 254, 100)
procIdentArrayAccessIL.Emit(OpCodes.Br, label3)
procIdentArrayAccessIL.MarkSequencePoint(doc4, 255, 1, 255, 100)
procIdentArrayAccessIL.Emit(OpCodes.Br, cont119)
procIdentArrayAccessIL.MarkLabel(cont119)
procIdentArrayAccessIL.MarkSequencePoint(doc4, 257, 1, 257, 100)
procIdentArrayAccessIL.MarkLabel(label4)
procIdentArrayAccessIL.MarkSequencePoint(doc4, 259, 1, 259, 100)
procIdentArrayAccessIL.Emit(OpCodes.Ldloc, 0)
Typ = GetType(Ident)
procIdentArrayAccessIL.Emit(OpCodes.Ldloc, 1)
Typ = GetType(Expr)
procIdentArrayAccessIL.Emit(OpCodes.Stfld, GetType(Ident).GetField("ArrLoc"))
procIdentArrayAccessIL.MarkSequencePoint(doc4, 260, 1, 260, 100)
procIdentArrayAccessIL.Emit(OpCodes.Ldloc, 0)
Typ = GetType(Ident)
procIdentArrayAccessIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
procIdentArrayAccessIL.Emit(OpCodes.Stfld, GetType(Ident).GetField("IsArr"))
procIdentArrayAccessIL.MarkSequencePoint(doc4, 261, 1, 261, 100)
procIdentArrayAccessIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Expr)
procIdentArrayAccessIL.Emit(OpCodes.Ldfld, GetType(Expr).GetField("Tokens"))
Typ = GetType(Expr).GetField("Tokens").FieldType
...
procIdentArrayAccessIL.MarkSequencePoint(doc4, 263, 1, 263, 100)
procIdentArrayAccessIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Expr)
procIdentArrayAccessIL.MarkSequencePoint(doc4, 265, 1, 265, 100)
procIdentArrayAccessIL.Emit(OpCodes.Ret)
Dim typ32(-1) As Type
ReDim Preserve typ32(UBound(typ32) + 1)
typ32(UBound(typ32)) = GetType(Expr)
ReDim Preserve typ32(UBound(typ32) + 1)
typ32(UBound(typ32)) = GetType(System.Int32)
Dim procMtdArrayAccess As MethodBuilder = ExprOptimizer.DefineMethod("procMtdArrayAccess", MethodAttributes.Public, GetType(Expr), typ32)
...
procMtdArrayAccessIL.MarkSequencePoint(doc4, 269, 1, 269, 100)
Dim locbldr132 As LocalBuilder = procMtdArrayAccessIL.DeclareLocal(GetType(MethodCallTok))
locbldr132.SetLocalSymInfo("mtd")
procMtdArrayAccessIL.Emit(OpCodes.Ldnull)
procMtdArrayAccessIL.Emit(OpCodes.Stloc, 0)
procMtdArrayAccessIL.MarkSequencePoint(doc4, 270, 1, 270, 100)
Dim locbldr133 As LocalBuilder = procMtdArrayAccessIL.DeclareLocal(GetType(MethodNameTok))
locbldr133.SetLocalSymInfo("idt")
procMtdArrayAccessIL.Emit(OpCodes.Ldnull)
procMtdArrayAccessIL.Emit(OpCodes.Stloc, 1)
procMtdArrayAccessIL.MarkSequencePoint(doc4, 271, 1, 271, 100)
Dim locbldr134 As LocalBuilder = procMtdArrayAccessIL.DeclareLocal(GetType(Expr))
locbldr134.SetLocalSymInfo("ep2")
...
procMtdArrayAccessIL.MarkSequencePoint(doc4, 272, 1, 272, 100)
Dim locbldr135 As LocalBuilder = procMtdArrayAccessIL.DeclareLocal(GetType(System.Int32))
locbldr135.SetLocalSymInfo("lvl")
procMtdArrayAccessIL.Emit(OpCodes.Ldc_I4, CInt(1))
Typ = GetType(System.Int32)
procMtdArrayAccessIL.Emit(OpCodes.Stloc, 3)
procMtdArrayAccessIL.MarkSequencePoint(doc4, 273, 1, 273, 100)
Dim locbldr136 As LocalBuilder = procMtdArrayAccessIL.DeclareLocal(GetType(System.Boolean))
locbldr136.SetLocalSymInfo("d")
procMtdArrayAccessIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
procMtdArrayAccessIL.Emit(OpCodes.Stloc, 4)
procMtdArrayAccessIL.MarkSequencePoint(doc4, 274, 1, 274, 100)
Dim locbldr137 As LocalBuilder = procMtdArrayAccessIL.DeclareLocal(GetType(System.Int32))
locbldr137.SetLocalSymInfo("j")
procMtdArrayAccessIL.Emit(OpCodes.Ldc_I4, CInt(0))
Typ = GetType(System.Int32)
procMtdArrayAccessIL.Emit(OpCodes.Stloc, 5)
procMtdArrayAccessIL.MarkSequencePoint(doc4, 276, 1, 276, 100)
...
procMtdArrayAccessIL.MarkSequencePoint(doc4, 277, 1, 277, 100)
...
Typ = Typ.GetElementType()
procMtdArrayAccessIL.Emit(OpCodes.Stloc, 0)
procMtdArrayAccessIL.MarkSequencePoint(doc4, 278, 1, 278, 100)
...
procMtdArrayAccessIL.Emit(OpCodes.Stloc, 1)
procMtdArrayAccessIL.MarkSequencePoint(doc4, 279, 1, 279, 100)
procMtdArrayAccessIL.Emit(OpCodes.Ldarg, 2)
Typ = GetType(System.Int32)
procMtdArrayAccessIL.Emit(OpCodes.Stloc, 5)
procMtdArrayAccessIL.MarkSequencePoint(doc4, 280, 1, 280, 100)
procMtdArrayAccessIL.Emit(OpCodes.Ldarg, 2)
Typ = GetType(System.Int32)
procMtdArrayAccessIL.Emit(OpCodes.Ldc_I4, CInt(1))
Typ = GetType(System.Int32)
...
procMtdArrayAccessIL.Emit(OpCodes.Starg, 2)
procMtdArrayAccessIL.MarkSequencePoint(doc4, 282, 1, 282, 100)
Dim locbldr138 As LocalBuilder = procMtdArrayAccessIL.DeclareLocal(GetType(Token))
locbldr138.SetLocalSymInfo("tok2")
procMtdArrayAccessIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Expr)
procMtdArrayAccessIL.Emit(OpCodes.Ldfld, GetType(Expr).GetField("Tokens"))
Typ = GetType(Expr).GetField("Tokens").FieldType
...
procMtdArrayAccessIL.MarkSequencePoint(doc4, 283, 1, 283, 100)
Dim locbldr139 As LocalBuilder = procMtdArrayAccessIL.DeclareLocal(GetType(System.Type))
locbldr139.SetLocalSymInfo("typ2")
procMtdArrayAccessIL.MarkSequencePoint(doc4, 284, 1, 284, 100)
Dim locbldr140 As LocalBuilder = procMtdArrayAccessIL.DeclareLocal(GetType(System.Boolean))
locbldr140.SetLocalSymInfo("b2")
procMtdArrayAccessIL.MarkSequencePoint(doc4, 285, 1, 285, 100)
Dim locbldr141 As LocalBuilder = procMtdArrayAccessIL.DeclareLocal(GetType(System.Int32))
locbldr141.SetLocalSymInfo("len")
procMtdArrayAccessIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Expr)
procMtdArrayAccessIL.Emit(OpCodes.Ldfld, GetType(Expr).GetField("Tokens"))
Typ = GetType(Expr).GetField("Tokens").FieldType
...
procMtdArrayAccessIL.MarkSequencePoint(doc4, 287, 1, 287, 100)
Dim typ33(-1) As Type
procMtdArrayAccessIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Expr)
Typ03 = Typ
...
ReDim Preserve typ33(UBound(typ33) + 1)
typ33(UBound(typ33)) = Typ
procMtdArrayAccessIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("RemToken", typ33))
Typ = Typ03.GetMethod("RemToken", typ33).ReturnType
If Typ.ToString() = GetType(System.Void).ToString() Then

Else
procMtdArrayAccessIL.Emit(OpCodes.Pop)
End If
procMtdArrayAccessIL.MarkSequencePoint(doc4, 288, 1, 288, 100)
procMtdArrayAccessIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Expr)
procMtdArrayAccessIL.Emit(OpCodes.Ldfld, GetType(Expr).GetField("Tokens"))
Typ = GetType(Expr).GetField("Tokens").FieldType
...
procMtdArrayAccessIL.Emit(OpCodes.Sub)
procMtdArrayAccessIL.Emit(OpCodes.Stloc, 9)
procMtdArrayAccessIL.MarkSequencePoint(doc4, 289, 1, 289, 100)
procMtdArrayAccessIL.Emit(OpCodes.Ldarg, 2)
Typ = GetType(System.Int32)
procMtdArrayAccessIL.Emit(OpCodes.Ldc_I4, CInt(1))
Typ = GetType(System.Int32)
procMtdArrayAccessIL.Emit(OpCodes.Sub)
procMtdArrayAccessIL.Emit(OpCodes.Starg, 2)
procMtdArrayAccessIL.MarkSequencePoint(doc4, 291, 1, 291, 100)
Dim label6 As System.Reflection.Emit.Label = procMtdArrayAccessIL.DefineLabel()
procMtdArrayAccessIL.MarkSequencePoint(doc4, 292, 1, 292, 100)
Dim label7 As System.Reflection.Emit.Label = procMtdArrayAccessIL.DefineLabel()
procMtdArrayAccessIL.MarkSequencePoint(doc4, 293, 1, 293, 100)
Dim label8 As System.Reflection.Emit.Label = procMtdArrayAccessIL.DefineLabel()
procMtdArrayAccessIL.MarkSequencePoint(doc4, 295, 1, 295, 100)
procMtdArrayAccessIL.MarkLabel(label6)
procMtdArrayAccessIL.MarkSequencePoint(doc4, 298, 1, 298, 100)
procMtdArrayAccessIL.Emit(OpCodes.Ldarg, 2)
Typ = GetType(System.Int32)
procMtdArrayAccessIL.Emit(OpCodes.Ldc_I4, CInt(1))
Typ = GetType(System.Int32)
procMtdArrayAccessIL.Emit(OpCodes.Add)
procMtdArrayAccessIL.Emit(OpCodes.Starg, 2)
procMtdArrayAccessIL.MarkSequencePoint(doc4, 300, 1, 300, 100)
procMtdArrayAccessIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Expr)
procMtdArrayAccessIL.Emit(OpCodes.Ldfld, GetType(Expr).GetField("Tokens"))
Typ = GetType(Expr).GetField("Tokens").FieldType
...
ReDim Preserve typ35(UBound(typ35) + 1)
typ35(UBound(typ35)) = Typ
procMtdArrayAccessIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("IsInstanceOfType", typ35))
Typ = Typ03.GetMethod("IsInstanceOfType", typ35).ReturnType
procMtdArrayAccessIL.Emit(OpCodes.Stloc, 8)
procMtdArrayAccessIL.MarkSequencePoint(doc4, 303, 1, 303, 100)
procMtdArrayAccessIL.Emit(OpCodes.Ldloc, 8)
Typ = GetType(System.Boolean)
procMtdArrayAccessIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa120 As System.Reflection.Emit.Label = procMtdArrayAccessIL.DefineLabel()
Dim tru120 As System.Reflection.Emit.Label = procMtdArrayAccessIL.DefineLabel()
Dim cont120 As System.Reflection.Emit.Label = procMtdArrayAccessIL.DefineLabel()
procMtdArrayAccessIL.Emit(OpCodes.Beq, tru120)
procMtdArrayAccessIL.Emit(OpCodes.Br, fa120)
procMtdArrayAccessIL.MarkLabel(tru120)
procMtdArrayAccessIL.MarkSequencePoint(doc4, 304, 1, 304, 100)
...
procMtdArrayAccessIL.Emit(OpCodes.Sub)
procMtdArrayAccessIL.Emit(OpCodes.Stloc, 3)
procMtdArrayAccessIL.MarkSequencePoint(doc4, 305, 1, 305, 100)
procMtdArrayAccessIL.Emit(OpCodes.Ldloc, 3)
Typ = GetType(System.Int32)
procMtdArrayAccessIL.Emit(OpCodes.Ldc_I4, CInt(0))
Typ = GetType(System.Int32)
Dim fa121 As System.Reflection.Emit.Label = procMtdArrayAccessIL.DefineLabel()
Dim tru121 As System.Reflection.Emit.Label = procMtdArrayAccessIL.DefineLabel()
Dim cont121 As System.Reflection.Emit.Label = procMtdArrayAccessIL.DefineLabel()
procMtdArrayAccessIL.Emit(OpCodes.Beq, tru121)
procMtdArrayAccessIL.Emit(OpCodes.Br, fa121)
procMtdArrayAccessIL.MarkLabel(tru121)
procMtdArrayAccessIL.MarkSequencePoint(doc4, 306, 1, 306, 100)
procMtdArrayAccessIL.Emit(OpCodes.Ldc_I4, 0)
Typ = GetType(System.Boolean)
procMtdArrayAccessIL.Emit(OpCodes.Stloc, 4)
procMtdArrayAccessIL.MarkSequencePoint(doc4, 308, 1, 308, 100)
Dim typ36(-1) As Type
procMtdArrayAccessIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Expr)
Typ03 = Typ
...
ReDim Preserve typ36(UBound(typ36) + 1)
typ36(UBound(typ36)) = Typ
procMtdArrayAccessIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("RemToken", typ36))
...
procMtdArrayAccessIL.Emit(OpCodes.Pop)
End If
procMtdArrayAccessIL.MarkSequencePoint(doc4, 309, 1, 309, 100)
procMtdArrayAccessIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Expr)
procMtdArrayAccessIL.Emit(OpCodes.Ldfld, GetType(Expr).GetField("Tokens"))
Typ = GetType(Expr).GetField("Tokens").FieldType
...
procMtdArrayAccessIL.Emit(OpCodes.Sub)
procMtdArrayAccessIL.Emit(OpCodes.Stloc, 9)
procMtdArrayAccessIL.MarkSequencePoint(doc4, 310, 1, 310, 100)
procMtdArrayAccessIL.Emit(OpCodes.Ldarg, 2)
Typ = GetType(System.Int32)
procMtdArrayAccessIL.Emit(OpCodes.Ldc_I4, CInt(1))
Typ = GetType(System.Int32)
procMtdArrayAccessIL.Emit(OpCodes.Sub)
procMtdArrayAccessIL.Emit(OpCodes.Starg, 2)
procMtdArrayAccessIL.MarkSequencePoint(doc4, 311, 1, 311, 100)
procMtdArrayAccessIL.Emit(OpCodes.Br, label7)
procMtdArrayAccessIL.MarkSequencePoint(doc4, 312, 1, 312, 100)
procMtdArrayAccessIL.Emit(OpCodes.Br, cont121)
procMtdArrayAccessIL.MarkLabel(fa121)
procMtdArrayAccessIL.MarkSequencePoint(doc4, 313, 1, 313, 100)
procMtdArrayAccessIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
procMtdArrayAccessIL.Emit(OpCodes.Stloc, 4)
procMtdArrayAccessIL.MarkSequencePoint(doc4, 314, 1, 314, 100)
procMtdArrayAccessIL.Emit(OpCodes.Br, label8)
procMtdArrayAccessIL.MarkSequencePoint(doc4, 315, 1, 315, 100)
procMtdArrayAccessIL.Emit(OpCodes.Br, cont121)
procMtdArrayAccessIL.MarkLabel(cont121)
procMtdArrayAccessIL.MarkSequencePoint(doc4, 316, 1, 316, 100)
procMtdArrayAccessIL.Emit(OpCodes.Br, label8)
procMtdArrayAccessIL.MarkSequencePoint(doc4, 317, 1, 317, 100)
procMtdArrayAccessIL.Emit(OpCodes.Br, cont120)
procMtdArrayAccessIL.MarkLabel(fa120)
procMtdArrayAccessIL.Emit(OpCodes.Br, cont120)
procMtdArrayAccessIL.MarkLabel(cont120)
procMtdArrayAccessIL.MarkSequencePoint(doc4, 319, 1, 319, 100)
procMtdArrayAccessIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Expr)
procMtdArrayAccessIL.Emit(OpCodes.Ldfld, GetType(Expr).GetField("Tokens"))
Typ = GetType(Expr).GetField("Tokens").FieldType
...
Typ = Typ.GetElementType()
procMtdArrayAccessIL.Emit(OpCodes.Stloc, 6)
procMtdArrayAccessIL.MarkSequencePoint(doc4, 320, 1, 320, 100)
procMtdArrayAccessIL.Emit(OpCodes.Ldtoken, GetType(LSParen))
Dim typ37 As Type() = {GetType(System.RuntimeTypeHandle)}
procMtdArrayAccessIL.Emit(OpCodes.Call, GetType(System.Type).GetMethod("GetTypeFromHandle", typ37))
Typ = GetType(System.Type).GetMethod("GetTypeFromHandle", typ37).ReturnType
procMtdArrayAccessIL.Emit(OpCodes.Stloc, 7)
procMtdArrayAccessIL.MarkSequencePoint(doc4, 321, 1, 321, 100)
Dim typ38(-1) As Type
procMtdArrayAccessIL.Emit(OpCodes.Ldloc, 7)
Typ = GetType(System.Type)
Typ03 = Typ
...
ReDim Preserve typ38(UBound(typ38) + 1)
typ38(UBound(typ38)) = Typ
procMtdArrayAccessIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("IsInstanceOfType", typ38))
Typ = Typ03.GetMethod("IsInstanceOfType", typ38).ReturnType
procMtdArrayAccessIL.Emit(OpCodes.Stloc, 8)
procMtdArrayAccessIL.MarkSequencePoint(doc4, 322, 1, 322, 100)
procMtdArrayAccessIL.Emit(OpCodes.Ldloc, 8)
Typ = GetType(System.Boolean)
procMtdArrayAccessIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa122 As System.Reflection.Emit.Label = procMtdArrayAccessIL.DefineLabel()
Dim tru122 As System.Reflection.Emit.Label = procMtdArrayAccessIL.DefineLabel()
Dim cont122 As System.Reflection.Emit.Label = procMtdArrayAccessIL.DefineLabel()
procMtdArrayAccessIL.Emit(OpCodes.Beq, tru122)
procMtdArrayAccessIL.Emit(OpCodes.Br, fa122)
procMtdArrayAccessIL.MarkLabel(tru122)
procMtdArrayAccessIL.MarkSequencePoint(doc4, 323, 1, 323, 100)
procMtdArrayAccessIL.Emit(OpCodes.Ldloc, 3)
Typ = GetType(System.Int32)
procMtdArrayAccessIL.Emit(OpCodes.Ldc_I4, CInt(1))
Typ = GetType(System.Int32)
procMtdArrayAccessIL.Emit(OpCodes.Add)
procMtdArrayAccessIL.Emit(OpCodes.Stloc, 3)
procMtdArrayAccessIL.MarkSequencePoint(doc4, 324, 1, 324, 100)
procMtdArrayAccessIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
procMtdArrayAccessIL.Emit(OpCodes.Stloc, 4)
procMtdArrayAccessIL.MarkSequencePoint(doc4, 325, 1, 325, 100)
procMtdArrayAccessIL.Emit(OpCodes.Br, label8)
procMtdArrayAccessIL.MarkSequencePoint(doc4, 326, 1, 326, 100)
procMtdArrayAccessIL.Emit(OpCodes.Br, cont122)
procMtdArrayAccessIL.MarkLabel(fa122)
procMtdArrayAccessIL.Emit(OpCodes.Br, cont122)
procMtdArrayAccessIL.MarkLabel(cont122)
procMtdArrayAccessIL.MarkSequencePoint(doc4, 328, 1, 328, 100)
procMtdArrayAccessIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Expr)
procMtdArrayAccessIL.Emit(OpCodes.Ldfld, GetType(Expr).GetField("Tokens"))
Typ = GetType(Expr).GetField("Tokens").FieldType
...
Typ = Typ.GetElementType()
procMtdArrayAccessIL.Emit(OpCodes.Stloc, 6)
procMtdArrayAccessIL.MarkSequencePoint(doc4, 329, 1, 329, 100)
procMtdArrayAccessIL.Emit(OpCodes.Ldtoken, GetType(Comma))
Dim typ39 As Type() = {GetType(System.RuntimeTypeHandle)}
procMtdArrayAccessIL.Emit(OpCodes.Call, GetType(System.Type).GetMethod("GetTypeFromHandle", typ39))
Typ = GetType(System.Type).GetMethod("GetTypeFromHandle", typ39).ReturnType
procMtdArrayAccessIL.Emit(OpCodes.Stloc, 7)
procMtdArrayAccessIL.MarkSequencePoint(doc4, 330, 1, 330, 100)
Dim typ40(-1) As Type
procMtdArrayAccessIL.Emit(OpCodes.Ldloc, 7)
Typ = GetType(System.Type)
Typ03 = Typ
...
ReDim Preserve typ40(UBound(typ40) + 1)
typ40(UBound(typ40)) = Typ
procMtdArrayAccessIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("IsInstanceOfType", typ40))
Typ = Typ03.GetMethod("IsInstanceOfType", typ40).ReturnType
procMtdArrayAccessIL.Emit(OpCodes.Stloc, 8)
procMtdArrayAccessIL.MarkSequencePoint(doc4, 331, 1, 331, 100)
procMtdArrayAccessIL.Emit(OpCodes.Ldloc, 8)
Typ = GetType(System.Boolean)
procMtdArrayAccessIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa123 As System.Reflection.Emit.Label = procMtdArrayAccessIL.DefineLabel()
Dim tru123 As System.Reflection.Emit.Label = procMtdArrayAccessIL.DefineLabel()
Dim cont123 As System.Reflection.Emit.Label = procMtdArrayAccessIL.DefineLabel()
procMtdArrayAccessIL.Emit(OpCodes.Beq, tru123)
procMtdArrayAccessIL.Emit(OpCodes.Br, fa123)
procMtdArrayAccessIL.MarkLabel(tru123)
procMtdArrayAccessIL.MarkSequencePoint(doc4, 332, 1, 332, 100)
procMtdArrayAccessIL.Emit(OpCodes.Br, cont123)
procMtdArrayAccessIL.MarkLabel(fa123)
procMtdArrayAccessIL.MarkSequencePoint(doc4, 333, 1, 333, 100)
procMtdArrayAccessIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
procMtdArrayAccessIL.Emit(OpCodes.Stloc, 4)
procMtdArrayAccessIL.MarkSequencePoint(doc4, 334, 1, 334, 100)
procMtdArrayAccessIL.Emit(OpCodes.Br, label8)
procMtdArrayAccessIL.MarkSequencePoint(doc4, 335, 1, 335, 100)
procMtdArrayAccessIL.Emit(OpCodes.Br, cont123)
procMtdArrayAccessIL.MarkLabel(cont123)
procMtdArrayAccessIL.MarkSequencePoint(doc4, 337, 1, 337, 100)
procMtdArrayAccessIL.MarkLabel(label8)
procMtdArrayAccessIL.MarkSequencePoint(doc4, 339, 1, 339, 100)
procMtdArrayAccessIL.Emit(OpCodes.Ldloc, 4)
Typ = GetType(System.Boolean)
procMtdArrayAccessIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa124 As System.Reflection.Emit.Label = procMtdArrayAccessIL.DefineLabel()
Dim tru124 As System.Reflection.Emit.Label = procMtdArrayAccessIL.DefineLabel()
Dim cont124 As System.Reflection.Emit.Label = procMtdArrayAccessIL.DefineLabel()
procMtdArrayAccessIL.Emit(OpCodes.Beq, tru124)
procMtdArrayAccessIL.Emit(OpCodes.Br, fa124)
procMtdArrayAccessIL.MarkLabel(tru124)
procMtdArrayAccessIL.MarkSequencePoint(doc4, 340, 1, 340, 100)
Dim typ41(-1) As Type
...
ReDim Preserve typ41(UBound(typ41) + 1)
typ41(UBound(typ41)) = Typ
procMtdArrayAccessIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("AddToken", typ41))
Typ = Typ03.GetMethod("AddToken", typ41).ReturnType
If Typ.ToString() = GetType(System.Void).ToString() Then

Else
procMtdArrayAccessIL.Emit(OpCodes.Pop)
End If
procMtdArrayAccessIL.MarkSequencePoint(doc4, 341, 1, 341, 100)
Dim typ42(-1) As Type
procMtdArrayAccessIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Expr)
Typ03 = Typ
...
ReDim Preserve typ42(UBound(typ42) + 1)
typ42(UBound(typ42)) = Typ
procMtdArrayAccessIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("RemToken", typ42))
Typ = Typ03.GetMethod("RemToken", typ42).ReturnType
If Typ.ToString() = GetType(System.Void).ToString() Then

Else
procMtdArrayAccessIL.Emit(OpCodes.Pop)
End If
procMtdArrayAccessIL.MarkSequencePoint(doc4, 342, 1, 342, 100)
procMtdArrayAccessIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Expr)
procMtdArrayAccessIL.Emit(OpCodes.Ldfld, GetType(Expr).GetField("Tokens"))
Typ = GetType(Expr).GetField("Tokens").FieldType
...
procMtdArrayAccessIL.Emit(OpCodes.Sub)
procMtdArrayAccessIL.Emit(OpCodes.Stloc, 9)
procMtdArrayAccessIL.MarkSequencePoint(doc4, 343, 1, 343, 100)
procMtdArrayAccessIL.Emit(OpCodes.Ldarg, 2)
Typ = GetType(System.Int32)
procMtdArrayAccessIL.Emit(OpCodes.Ldc_I4, CInt(1))
Typ = GetType(System.Int32)
procMtdArrayAccessIL.Emit(OpCodes.Sub)
procMtdArrayAccessIL.Emit(OpCodes.Starg, 2)
procMtdArrayAccessIL.MarkSequencePoint(doc4, 344, 1, 344, 100)
procMtdArrayAccessIL.Emit(OpCodes.Br, cont124)
procMtdArrayAccessIL.MarkLabel(fa124)
procMtdArrayAccessIL.Emit(OpCodes.Br, cont124)
procMtdArrayAccessIL.MarkLabel(cont124)
procMtdArrayAccessIL.MarkSequencePoint(doc4, 346, 1, 346, 100)
procMtdArrayAccessIL.Emit(OpCodes.Ldarg, 2)
Typ = GetType(System.Int32)
procMtdArrayAccessIL.Emit(OpCodes.Ldloc, 9)
Typ = GetType(System.Int32)
Dim fa125 As System.Reflection.Emit.Label = procMtdArrayAccessIL.DefineLabel()
Dim tru125 As System.Reflection.Emit.Label = procMtdArrayAccessIL.DefineLabel()
Dim cont125 As System.Reflection.Emit.Label = procMtdArrayAccessIL.DefineLabel()
procMtdArrayAccessIL.Emit(OpCodes.Beq, tru125)
procMtdArrayAccessIL.Emit(OpCodes.Br, fa125)
procMtdArrayAccessIL.MarkLabel(tru125)
procMtdArrayAccessIL.MarkSequencePoint(doc4, 347, 1, 347, 100)
procMtdArrayAccessIL.Emit(OpCodes.Br, label7)
procMtdArrayAccessIL.MarkSequencePoint(doc4, 348, 1, 348, 100)
procMtdArrayAccessIL.Emit(OpCodes.Br, cont125)
procMtdArrayAccessIL.MarkLabel(fa125)
procMtdArrayAccessIL.MarkSequencePoint(doc4, 349, 1, 349, 100)
procMtdArrayAccessIL.Emit(OpCodes.Br, label6)
procMtdArrayAccessIL.MarkSequencePoint(doc4, 350, 1, 350, 100)
procMtdArrayAccessIL.Emit(OpCodes.Br, cont125)
procMtdArrayAccessIL.MarkLabel(cont125)
procMtdArrayAccessIL.MarkSequencePoint(doc4, 352, 1, 352, 100)
procMtdArrayAccessIL.MarkLabel(label7)
procMtdArrayAccessIL.MarkSequencePoint(doc4, 354, 1, 354, 100)
procMtdArrayAccessIL.Emit(OpCodes.Ldloc, 1)
Typ = GetType(MethodNameTok)
procMtdArrayAccessIL.Emit(OpCodes.Ldloc, 2)
Typ = GetType(Expr)
procMtdArrayAccessIL.Emit(OpCodes.Stfld, GetType(MethodNameTok).GetField("ArrLoc"))
procMtdArrayAccessIL.MarkSequencePoint(doc4, 355, 1, 355, 100)
procMtdArrayAccessIL.Emit(OpCodes.Ldloc, 1)
Typ = GetType(MethodNameTok)
procMtdArrayAccessIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
procMtdArrayAccessIL.Emit(OpCodes.Stfld, GetType(MethodNameTok).GetField("IsArr"))
procMtdArrayAccessIL.MarkSequencePoint(doc4, 356, 1, 356, 100)
procMtdArrayAccessIL.Emit(OpCodes.Ldloc, 0)
Typ = GetType(MethodCallTok)
procMtdArrayAccessIL.Emit(OpCodes.Ldloc, 1)
Typ = GetType(MethodNameTok)
procMtdArrayAccessIL.Emit(OpCodes.Stfld, GetType(MethodCallTok).GetField("Name"))
procMtdArrayAccessIL.MarkSequencePoint(doc4, 357, 1, 357, 100)
procMtdArrayAccessIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Expr)
procMtdArrayAccessIL.Emit(OpCodes.Ldfld, GetType(Expr).GetField("Tokens"))
Typ = GetType(Expr).GetField("Tokens").FieldType
...
procMtdArrayAccessIL.MarkSequencePoint(doc4, 359, 1, 359, 100)
procMtdArrayAccessIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Expr)
procMtdArrayAccessIL.MarkSequencePoint(doc4, 361, 1, 361, 100)
procMtdArrayAccessIL.Emit(OpCodes.Ret)
Dim typ43(-1) As Type
ReDim Preserve typ43(UBound(typ43) + 1)
typ43(UBound(typ43)) = GetType(Expr)
Dim Optimize As MethodBuilder = ExprOptimizer.DefineMethod("Optimize", MethodAttributes.Public, GetType(Expr), typ43)
Dim OptimizeIL As ILGenerator = Optimize.GetILGenerator()
Dim Optimizeparam01 As ParameterBuilder = Optimize.DefineParameter(1, ParameterAttributes.None, "exp")
OptimizeIL.MarkSequencePoint(doc4, 365, 1, 365, 100)
Dim locbldr142 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(System.Int32))
...
OptimizeIL.Emit(OpCodes.Stloc, 0)
OptimizeIL.MarkSequencePoint(doc4, 366, 1, 366, 100)
Dim locbldr143 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(System.Int32))
locbldr143.SetLocalSymInfo("i")
OptimizeIL.Emit(OpCodes.Ldc_I4, CInt(-1))
Typ = GetType(System.Int32)
OptimizeIL.Emit(OpCodes.Stloc, 1)
OptimizeIL.MarkSequencePoint(doc4, 367, 1, 367, 100)
Dim locbldr144 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(System.Int32))
locbldr144.SetLocalSymInfo("j")
OptimizeIL.Emit(OpCodes.Ldc_I4, CInt(-1))
Typ = GetType(System.Int32)
OptimizeIL.Emit(OpCodes.Stloc, 2)
OptimizeIL.MarkSequencePoint(doc4, 368, 1, 368, 100)
Dim locbldr145 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(System.Boolean))
locbldr145.SetLocalSymInfo("identtrnoff")
OptimizeIL.Emit(OpCodes.Ldc_I4, 0)
Typ = GetType(System.Boolean)
OptimizeIL.Emit(OpCodes.Stloc, 3)
OptimizeIL.MarkSequencePoint(doc4, 369, 1, 369, 100)
Dim locbldr146 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(System.Boolean))
locbldr146.SetLocalSymInfo("mcbool")
OptimizeIL.Emit(OpCodes.Ldc_I4, 0)
Typ = GetType(System.Boolean)
OptimizeIL.Emit(OpCodes.Stloc, 4)
OptimizeIL.MarkSequencePoint(doc4, 370, 1, 370, 100)
Dim locbldr147 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(System.Boolean))
locbldr147.SetLocalSymInfo("mcflgc")
OptimizeIL.Emit(OpCodes.Ldc_I4, 0)
Typ = GetType(System.Boolean)
OptimizeIL.Emit(OpCodes.Stloc, 5)
OptimizeIL.MarkSequencePoint(doc4, 371, 1, 371, 100)
Dim locbldr148 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(System.Boolean))
locbldr148.SetLocalSymInfo("iflgc")
OptimizeIL.Emit(OpCodes.Ldc_I4, 0)
Typ = GetType(System.Boolean)
OptimizeIL.Emit(OpCodes.Stloc, 6)
OptimizeIL.MarkSequencePoint(doc4, 372, 1, 372, 100)
Dim locbldr149 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(System.Boolean))
locbldr149.SetLocalSymInfo("sflgc")
OptimizeIL.Emit(OpCodes.Ldc_I4, 0)
Typ = GetType(System.Boolean)
OptimizeIL.Emit(OpCodes.Stloc, 7)
OptimizeIL.MarkSequencePoint(doc4, 373, 1, 373, 100)
Dim locbldr150 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(Token))
locbldr150.SetLocalSymInfo("mctok")
OptimizeIL.Emit(OpCodes.Ldnull)
OptimizeIL.Emit(OpCodes.Stloc, 8)
OptimizeIL.MarkSequencePoint(doc4, 374, 1, 374, 100)
Dim locbldr151 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(Token))
locbldr151.SetLocalSymInfo("mctok2")
OptimizeIL.Emit(OpCodes.Ldnull)
OptimizeIL.Emit(OpCodes.Stloc, 9)
OptimizeIL.MarkSequencePoint(doc4, 375, 1, 375, 100)
Dim locbldr152 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(Ident))
locbldr152.SetLocalSymInfo("mcident")
OptimizeIL.Emit(OpCodes.Ldnull)
OptimizeIL.Emit(OpCodes.Stloc, 10)
OptimizeIL.MarkSequencePoint(doc4, 376, 1, 376, 100)
Dim locbldr153 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(MethodCallTok))
locbldr153.SetLocalSymInfo("mcmetcall")
OptimizeIL.Emit(OpCodes.Ldnull)
OptimizeIL.Emit(OpCodes.Stloc, 11)
OptimizeIL.MarkSequencePoint(doc4, 377, 1, 377, 100)
Dim locbldr154 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(MethodNameTok))
locbldr154.SetLocalSymInfo("mcmetname")
OptimizeIL.Emit(OpCodes.Ldnull)
OptimizeIL.Emit(OpCodes.Stloc, 12)
OptimizeIL.MarkSequencePoint(doc4, 378, 1, 378, 100)
Dim locbldr155 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(StringLiteral))
locbldr155.SetLocalSymInfo("mcstr")
OptimizeIL.Emit(OpCodes.Ldnull)
OptimizeIL.Emit(OpCodes.Stloc, 13)
OptimizeIL.MarkSequencePoint(doc4, 379, 1, 379, 100)
Dim locbldr156 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(System.Int32))
locbldr156.SetLocalSymInfo("mcint")
OptimizeIL.Emit(OpCodes.Ldc_I4, CInt(0))
Typ = GetType(System.Int32)
OptimizeIL.Emit(OpCodes.Stloc, 14)
OptimizeIL.MarkSequencePoint(doc4, 382, 1, 382, 100)
Dim label9 As System.Reflection.Emit.Label = OptimizeIL.DefineLabel()
OptimizeIL.MarkSequencePoint(doc4, 383, 1, 383, 100)
Dim label10 As System.Reflection.Emit.Label = OptimizeIL.DefineLabel()
OptimizeIL.MarkSequencePoint(doc4, 386, 1, 386, 100)
OptimizeIL.Emit(OpCodes.Ldloc, 0)
Typ = GetType(System.Int32)
OptimizeIL.Emit(OpCodes.Ldc_I4, CInt(0))
Typ = GetType(System.Int32)
Dim fa126 As System.Reflection.Emit.Label = OptimizeIL.DefineLabel()
Dim tru126 As System.Reflection.Emit.Label = OptimizeIL.DefineLabel()
Dim cont126 As System.Reflection.Emit.Label = OptimizeIL.DefineLabel()
OptimizeIL.Emit(OpCodes.Blt, tru126)
OptimizeIL.Emit(OpCodes.Br, fa126)
OptimizeIL.MarkLabel(tru126)
OptimizeIL.MarkSequencePoint(doc4, 387, 1, 387, 100)
OptimizeIL.Emit(OpCodes.Br, label10)
OptimizeIL.MarkSequencePoint(doc4, 388, 1, 388, 100)
OptimizeIL.Emit(OpCodes.Br, cont126)
OptimizeIL.MarkLabel(fa126)
OptimizeIL.Emit(OpCodes.Br, cont126)
OptimizeIL.MarkLabel(cont126)
OptimizeIL.MarkSequencePoint(doc4, 390, 1, 390, 100)
OptimizeIL.MarkLabel(label9)
OptimizeIL.MarkSequencePoint(doc4, 392, 1, 392, 100)
...
OptimizeIL.Emit(OpCodes.Ldc_I4, 0)
Typ = GetType(System.Boolean)
Dim fa127 As System.Reflection.Emit.Label = OptimizeIL.DefineLabel()
Dim tru127 As System.Reflection.Emit.Label = OptimizeIL.DefineLabel()
Dim cont127 As System.Reflection.Emit.Label = OptimizeIL.DefineLabel()
OptimizeIL.Emit(OpCodes.Beq, tru127)
OptimizeIL.Emit(OpCodes.Br, fa127)
OptimizeIL.MarkLabel(tru127)
OptimizeIL.MarkSequencePoint(doc4, 394, 1, 394, 100)
OptimizeIL.Emit(OpCodes.Ldloc, 1)
Typ = GetType(System.Int32)
OptimizeIL.Emit(OpCodes.Ldc_I4, CInt(1))
Typ = GetType(System.Int32)
...
OptimizeIL.Emit(OpCodes.Stloc, 1)
OptimizeIL.MarkSequencePoint(doc4, 396, 1, 396, 100)
Dim label11 As System.Reflection.Emit.Label = OptimizeIL.DefineLabel()
OptimizeIL.MarkSequencePoint(doc4, 398, 1, 398, 100)
Dim locbldr157 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(Token))
locbldr157.SetLocalSymInfo("tok")
OptimizeIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Expr)
OptimizeIL.Emit(OpCodes.Ldfld, GetType(Expr).GetField("Tokens"))
Typ = GetType(Expr).GetField("Tokens").FieldType
...
Typ = Typ.GetElementType()
OptimizeIL.Emit(OpCodes.Stloc, 15)
OptimizeIL.MarkSequencePoint(doc4, 399, 1, 399, 100)
Dim locbldr158 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(System.Type))
locbldr158.SetLocalSymInfo("typ")
OptimizeIL.MarkSequencePoint(doc4, 400, 1, 400, 100)
Dim locbldr159 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(System.Boolean))
locbldr159.SetLocalSymInfo("b")
OptimizeIL.MarkSequencePoint(doc4, 401, 1, 401, 100)
Dim locbldr160 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(System.String))
locbldr160.SetLocalSymInfo("str")
OptimizeIL.MarkSequencePoint(doc4, 403, 1, 403, 100)
OptimizeIL.Emit(OpCodes.Ldtoken, GetType(LRSParen))
Dim typ44 As Type() = {GetType(System.RuntimeTypeHandle)}
OptimizeIL.Emit(OpCodes.Call, GetType(System.Type).GetMethod("GetTypeFromHandle", typ44))
Typ = GetType(System.Type).GetMethod("GetTypeFromHandle", typ44).ReturnType
OptimizeIL.Emit(OpCodes.Stloc, 16)
OptimizeIL.MarkSequencePoint(doc4, 404, 1, 404, 100)
Dim typ45(-1) As Type
OptimizeIL.Emit(OpCodes.Ldloc, 16)
Typ = GetType(System.Type)
Typ03 = Typ
...
ReDim Preserve typ45(UBound(typ45) + 1)
typ45(UBound(typ45)) = Typ
OptimizeIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("IsInstanceOfType", typ45))
Typ = Typ03.GetMethod("IsInstanceOfType", typ45).ReturnType
OptimizeIL.Emit(OpCodes.Stloc, 17)
OptimizeIL.MarkSequencePoint(doc4, 406, 1, 406, 100)
OptimizeIL.Emit(OpCodes.Ldloc, 17)
Typ = GetType(System.Boolean)
OptimizeIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa128 As System.Reflection.Emit.Label = OptimizeIL.DefineLabel()
Dim tru128 As System.Reflection.Emit.Label = OptimizeIL.DefineLabel()
Dim cont128 As System.Reflection.Emit.Label = OptimizeIL.DefineLabel()
OptimizeIL.Emit(OpCodes.Beq, tru128)
OptimizeIL.Emit(OpCodes.Br, fa128)
OptimizeIL.MarkLabel(tru128)
...
OptimizeIL.Emit(OpCodes.Call, GetType(System.Type).GetMethod("GetTypeFromHandle", typ46))
...
ReDim Preserve typ47(UBound(typ47) + 1)
typ47(UBound(typ47)) = Typ
OptimizeIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("RemToken", typ47))
...
ReDim Preserve typ48(UBound(typ48) + 1)
typ48(UBound(typ48)) = Typ
OptimizeIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("IsInstanceOfType", typ48))
...
OptimizeIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa129 As System.Reflection.Emit.Label = OptimizeIL.DefineLabel()
Dim tru129 As System.Reflection.Emit.Label = OptimizeIL.DefineLabel()
Dim cont129 As System.Reflection.Emit.Label = OptimizeIL.DefineLabel()
OptimizeIL.Emit(OpCodes.Beq, fa129)
OptimizeIL.Emit(OpCodes.Br, tru129)
OptimizeIL.MarkLabel(tru129)
OptimizeIL.MarkSequencePoint(doc4, 415, 1, 415, 100)
Dim locbldr161 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(Token))
locbldr161.SetLocalSymInfo("tk")
OptimizeIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Expr)
OptimizeIL.Emit(OpCodes.Ldfld, GetType(Expr).GetField("Tokens"))
Typ = GetType(Expr).GetField("Tokens").FieldType
...
Dim locbldr162 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(TypeTok))
locbldr162.SetLocalSymInfo("ttk")
OptimizeIL.Emit(OpCodes.Newobj, GetType(TypeTok).GetConstructor(Type.EmptyTypes))
OptimizeIL.Emit(OpCodes.Stloc, 20)
OptimizeIL.MarkSequencePoint(doc4, 417, 1, 417, 100)
OptimizeIL.Emit(OpCodes.Ldloc, 20)
Typ = GetType(TypeTok)
OptimizeIL.Emit(OpCodes.Ldloc, 19)
Typ = GetType(Token)
...
OptimizeIL.Emit(OpCodes.Br, cont129)
OptimizeIL.MarkLabel(fa129)
OptimizeIL.MarkSequencePoint(doc4, 421, 1, 421, 100)
OptimizeIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Expr)
OptimizeIL.Emit(OpCodes.Ldfld, GetType(Expr).GetField("Tokens"))
Typ = GetType(Expr).GetField("Tokens").FieldType
...
OptimizeIL.MarkSequencePoint(doc4, 425, 1, 425, 100)
OptimizeIL.Emit(OpCodes.Br, label11)
OptimizeIL.MarkSequencePoint(doc4, 426, 1, 426, 100)
OptimizeIL.Emit(OpCodes.Br, cont128)
OptimizeIL.MarkLabel(fa128)
OptimizeIL.Emit(OpCodes.Br, cont128)
OptimizeIL.MarkLabel(cont128)
...
OptimizeIL.Emit(OpCodes.Call, GetType(System.Type).GetMethod("GetTypeFromHandle", typ49))
Typ = GetType(System.Type).GetMethod("GetTypeFromHandle", typ49).ReturnType
OptimizeIL.Emit(OpCodes.Stloc, 16)
OptimizeIL.MarkSequencePoint(doc4, 429, 1, 429, 100)
Dim typ50(-1) As Type
OptimizeIL.Emit(OpCodes.Ldloc, 16)
Typ = GetType(System.Type)
Typ03 = Typ
...
ReDim Preserve typ50(UBound(typ50) + 1)
typ50(UBound(typ50)) = Typ
OptimizeIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("IsInstanceOfType", typ50))
...
OptimizeIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa130 As System.Reflection.Emit.Label = OptimizeIL.DefineLabel()
Dim tru130 As System.Reflection.Emit.Label = OptimizeIL.DefineLabel()
Dim cont130 As System.Reflection.Emit.Label = OptimizeIL.DefineLabel()
OptimizeIL.Emit(OpCodes.Beq, tru130)
OptimizeIL.Emit(OpCodes.Br, fa130)
OptimizeIL.MarkLabel(tru130)
OptimizeIL.MarkSequencePoint(doc4, 432, 1, 432, 100)
OptimizeIL.Emit(OpCodes.Ldtoken, GetType(TypeTok))
Dim typ51 As Type() = {GetType(System.RuntimeTypeHandle)}
OptimizeIL.Emit(OpCodes.Call, GetType(System.Type).GetMethod("GetTypeFromHandle", typ51))
Typ = GetType(System.Type).GetMethod("GetTypeFromHandle", typ51).ReturnType
OptimizeIL.Emit(OpCodes.Stloc, 16)
OptimizeIL.MarkSequencePoint(doc4, 433, 1, 433, 100)
Dim typ52(-1) As Type
OptimizeIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Expr)
Typ03 = Typ
...
ReDim Preserve typ52(UBound(typ52) + 1)
typ52(UBound(typ52)) = Typ
OptimizeIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("RemToken", typ52))
...
OptimizeIL.Emit(OpCodes.Pop)
End If
OptimizeIL.MarkSequencePoint(doc4, 434, 1, 434, 100)
OptimizeIL.Emit(OpCodes.Ldloc, 1)
Typ = GetType(System.Int32)
OptimizeIL.Emit(OpCodes.Ldc_I4, CInt(1))
Typ = GetType(System.Int32)
...
ReDim Preserve typ53(UBound(typ53) + 1)
typ53(UBound(typ53)) = Typ
OptimizeIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("IsInstanceOfType", typ53))
...
OptimizeIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa131 As System.Reflection.Emit.Label = OptimizeIL.DefineLabel()
Dim tru131 As System.Reflection.Emit.Label = OptimizeIL.DefineLabel()
Dim cont131 As System.Reflection.Emit.Label = OptimizeIL.DefineLabel()
OptimizeIL.Emit(OpCodes.Beq, fa131)
OptimizeIL.Emit(OpCodes.Br, tru131)
OptimizeIL.MarkLabel(tru131)
OptimizeIL.MarkSequencePoint(doc4, 440, 1, 440, 100)
Dim locbldr163 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(Token))
locbldr163.SetLocalSymInfo("tk2")
OptimizeIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Expr)
OptimizeIL.Emit(OpCodes.Ldfld, GetType(Expr).GetField("Tokens"))
Typ = GetType(Expr).GetField("Tokens").FieldType
...
Typ = Typ.GetElementType()
OptimizeIL.Emit(OpCodes.Stloc, 21)
OptimizeIL.MarkSequencePoint(doc4, 441, 1, 441, 100)
Dim locbldr164 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(TypeTok))
locbldr164.SetLocalSymInfo("ttk2")
OptimizeIL.Emit(OpCodes.Newobj, GetType(TypeTok).GetConstructor(Type.EmptyTypes))
OptimizeIL.Emit(OpCodes.Stloc, 22)
...
OptimizeIL.Emit(OpCodes.Br, cont131)
OptimizeIL.MarkLabel(fa131)
...
Typ = Typ.GetElementType()
OptimizeIL.Emit(OpCodes.Stloc, 22)
OptimizeIL.MarkSequencePoint(doc4, 447, 1, 447, 100)
OptimizeIL.Emit(OpCodes.Ldloc, 22)
Typ = GetType(TypeTok)
OptimizeIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
...
OptimizeIL.Emit(OpCodes.Br, cont131)
OptimizeIL.MarkLabel(cont131)
OptimizeIL.MarkSequencePoint(doc4, 449, 1, 449, 100)
OptimizeIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Expr)
OptimizeIL.Emit(OpCodes.Ldfld, GetType(Expr).GetField("Tokens"))
Typ = GetType(Expr).GetField("Tokens").FieldType
...
OptimizeIL.Emit(OpCodes.Br, cont130)
OptimizeIL.MarkLabel(fa130)
OptimizeIL.Emit(OpCodes.Br, cont130)
OptimizeIL.MarkLabel(cont130)
OptimizeIL.MarkSequencePoint(doc4, 453, 1, 453, 100)
...
OptimizeIL.Emit(OpCodes.Ldc_I4, 0)
Typ = GetType(System.Boolean)
Dim fa132 As System.Reflection.Emit.Label = OptimizeIL.DefineLabel()
Dim tru132 As System.Reflection.Emit.Label = OptimizeIL.DefineLabel()
Dim cont132 As System.Reflection.Emit.Label = OptimizeIL.DefineLabel()
OptimizeIL.Emit(OpCodes.Beq, tru132)
OptimizeIL.Emit(OpCodes.Br, fa132)
OptimizeIL.MarkLabel(tru132)
OptimizeIL.MarkSequencePoint(doc4, 455, 1, 455, 100)
OptimizeIL.Emit(OpCodes.Ldtoken, GetType(DollarSign))
Dim typ54 As Type() = {GetType(System.RuntimeTypeHandle)}
OptimizeIL.Emit(OpCodes.Call, GetType(System.Type).GetMethod("GetTypeFromHandle", typ54))
...
ReDim Preserve typ55(UBound(typ55) + 1)
typ55(UBound(typ55)) = Typ
OptimizeIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("IsInstanceOfType", typ55))
...
OptimizeIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa133 As System.Reflection.Emit.Label = OptimizeIL.DefineLabel()
Dim tru133 As System.Reflection.Emit.Label = OptimizeIL.DefineLabel()
Dim cont133 As System.Reflection.Emit.Label = OptimizeIL.DefineLabel()
OptimizeIL.Emit(OpCodes.Beq, tru133)
OptimizeIL.Emit(OpCodes.Br, fa133)
OptimizeIL.MarkLabel(tru133)
...
OptimizeIL.MarkSequencePoint(doc4, 460, 1, 460, 100)
OptimizeIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
...
OptimizeIL.Emit(OpCodes.Ldc_I4, 0)
Typ = GetType(System.Boolean)
Dim fa134 As System.Reflection.Emit.Label = OptimizeIL.DefineLabel()
Dim tru134 As System.Reflection.Emit.Label = OptimizeIL.DefineLabel()
Dim cont134 As System.Reflection.Emit.Label = OptimizeIL.DefineLabel()
OptimizeIL.Emit(OpCodes.Beq, fa134)
OptimizeIL.Emit(OpCodes.Br, tru134)
OptimizeIL.MarkLabel(tru134)
OptimizeIL.MarkSequencePoint(doc4, 462, 1, 462, 100)
OptimizeIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
...
ReDim Preserve typ56(UBound(typ56) + 1)
typ56(UBound(typ56)) = Typ
OptimizeIL.Emit(OpCodes.Call, GetType(String).GetMethod("Concat", typ56))
...
Typ = GetType(System.String)
OptimizeIL.Emit(OpCodes.Stsfld, asm.GetType("dylan.NET.Tokenizer.Parser.ParserFlags").GetField("OrdOp"))
OptimizeIL.MarkSequencePoint(doc4, 467, 1, 467, 100)
OptimizeIL.Emit(OpCodes.Br, cont134)
OptimizeIL.MarkLabel(fa134)
OptimizeIL.Emit(OpCodes.Br, cont134)
OptimizeIL.MarkLabel(cont134)
...
ReDim Preserve typ58(UBound(typ58) + 1)
typ58(UBound(typ58)) = Typ
OptimizeIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("RemToken", typ58))
Typ = Typ03.GetMethod("RemToken", typ58).ReturnType
If Typ.ToString() = GetType(System.Void).ToString() Then

Else
OptimizeIL.Emit(OpCodes.Pop)
End If
OptimizeIL.MarkSequencePoint(doc4, 469, 1, 469, 100)
OptimizeIL.Emit(OpCodes.Ldloc, 1)
Typ = GetType(System.Int32)
OptimizeIL.Emit(OpCodes.Ldc_I4, CInt(1))
Typ = GetType(System.Int32)
...
OptimizeIL.Emit(OpCodes.Br, cont133)
OptimizeIL.MarkLabel(fa133)
OptimizeIL.Emit(OpCodes.Br, cont133)
OptimizeIL.MarkLabel(cont133)
OptimizeIL.MarkSequencePoint(doc4, 474, 1, 474, 100)
OptimizeIL.Emit(OpCodes.Ldtoken, GetType(TypeTok))
...
ReDim Preserve typ60(UBound(typ60) + 1)
typ60(UBound(typ60)) = Typ
OptimizeIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("IsInstanceOfType", typ60))
...
OptimizeIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa135 As System.Reflection.Emit.Label = OptimizeIL.DefineLabel()
Dim tru135 As System.Reflection.Emit.Label = OptimizeIL.DefineLabel()
Dim cont135 As System.Reflection.Emit.Label = OptimizeIL.DefineLabel()
OptimizeIL.Emit(OpCodes.Beq, tru135)
OptimizeIL.Emit(OpCodes.Br, fa135)
OptimizeIL.MarkLabel(tru135)
OptimizeIL.MarkSequencePoint(doc4, 478, 1, 478, 100)
OptimizeIL.Emit(OpCodes.Ldsfld, asm.GetType("dylan.NET.Tokenizer.Parser.ParserFlags").GetField("DurConvFlag"))
Typ = asm.GetType("dylan.NET.Tokenizer.Parser.ParserFlags").GetField("DurConvFlag").FieldType
OptimizeIL.Emit(OpCodes.Ldc_I4, 0)
Typ = GetType(System.Boolean)
Dim fa136 As System.Reflection.Emit.Label = OptimizeIL.DefineLabel()
Dim tru136 As System.Reflection.Emit.Label = OptimizeIL.DefineLabel()
Dim cont136 As System.Reflection.Emit.Label = OptimizeIL.DefineLabel()
OptimizeIL.Emit(OpCodes.Beq, fa136)
OptimizeIL.Emit(OpCodes.Br, tru136)
OptimizeIL.MarkLabel(tru136)
OptimizeIL.MarkSequencePoint(doc4, 479, 1, 479, 100)
Dim locbldr165 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(TypeTok))
locbldr165.SetLocalSymInfo("tt1")
OptimizeIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Expr)
OptimizeIL.Emit(OpCodes.Ldfld, GetType(Expr).GetField("Tokens"))
Typ = GetType(Expr).GetField("Tokens").FieldType
...
OptimizeIL.Emit(OpCodes.Br, cont136)
OptimizeIL.MarkLabel(fa136)
OptimizeIL.MarkSequencePoint(doc4, 485, 1, 485, 100)
OptimizeIL.Emit(OpCodes.Br, cont136)
OptimizeIL.MarkLabel(cont136)
OptimizeIL.MarkSequencePoint(doc4, 486, 1, 486, 100)
OptimizeIL.Emit(OpCodes.Br, label11)
OptimizeIL.MarkSequencePoint(doc4, 487, 1, 487, 100)
OptimizeIL.Emit(OpCodes.Br, cont135)
OptimizeIL.MarkLabel(fa135)
OptimizeIL.Emit(OpCodes.Br, cont135)
OptimizeIL.MarkLabel(cont135)
...
OptimizeIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("IsInstanceOfType", typ63))
...
OptimizeIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa137 As System.Reflection.Emit.Label = OptimizeIL.DefineLabel()
Dim tru137 As System.Reflection.Emit.Label = OptimizeIL.DefineLabel()
Dim cont137 As System.Reflection.Emit.Label = OptimizeIL.DefineLabel()
OptimizeIL.Emit(OpCodes.Beq, tru137)
OptimizeIL.Emit(OpCodes.Br, fa137)
OptimizeIL.MarkLabel(tru137)
...
OptimizeIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa138 As System.Reflection.Emit.Label = OptimizeIL.DefineLabel()
Dim tru138 As System.Reflection.Emit.Label = OptimizeIL.DefineLabel()
Dim cont138 As System.Reflection.Emit.Label = OptimizeIL.DefineLabel()
OptimizeIL.Emit(OpCodes.Beq, tru138)
OptimizeIL.Emit(OpCodes.Br, fa138)
OptimizeIL.MarkLabel(tru138)
OptimizeIL.MarkSequencePoint(doc4, 495, 1, 495, 100)
OptimizeIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
OptimizeIL.Emit(OpCodes.Stloc, 4)
OptimizeIL.MarkSequencePoint(doc4, 496, 1, 496, 100)
OptimizeIL.Emit(OpCodes.Br, cont138)
OptimizeIL.MarkLabel(fa138)
OptimizeIL.Emit(OpCodes.Br, cont138)
OptimizeIL.MarkLabel(cont138)
OptimizeIL.MarkSequencePoint(doc4, 497, 1, 497, 100)
OptimizeIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
...
OptimizeIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa139 As System.Reflection.Emit.Label = OptimizeIL.DefineLabel()
Dim tru139 As System.Reflection.Emit.Label = OptimizeIL.DefineLabel()
Dim cont139 As System.Reflection.Emit.Label = OptimizeIL.DefineLabel()
OptimizeIL.Emit(OpCodes.Beq, tru139)
OptimizeIL.Emit(OpCodes.Br, fa139)
OptimizeIL.MarkLabel(tru139)
OptimizeIL.MarkSequencePoint(doc4, 499, 1, 499, 100)
Dim locbldr166 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(Ident))
locbldr166.SetLocalSymInfo("id1")
OptimizeIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Expr)
OptimizeIL.Emit(OpCodes.Ldfld, GetType(Expr).GetField("Tokens"))
Typ = GetType(Expr).GetField("Tokens").FieldType
...
ReDim Preserve typ64(UBound(typ64) + 1)
typ64(UBound(typ64)) = Typ
OptimizeIL.Emit(OpCodes.Call, asm.GetType("dylan.NET.Tokenizer.Parser.ParserFlags").GetMethod("UpdateIdent", typ64))
Typ = asm.GetType("dylan.NET.Tokenizer.Parser.ParserFlags").GetMethod("UpdateIdent", typ64).ReturnType
Typ = Typ02
OptimizeIL.Emit(OpCodes.Stelem, Typ.GetElementType())
...
OptimizeIL.Emit(OpCodes.Br, cont139)
OptimizeIL.MarkLabel(fa139)
OptimizeIL.Emit(OpCodes.Br, cont139)
OptimizeIL.MarkLabel(cont139)
OptimizeIL.MarkSequencePoint(doc4, 504, 1, 504, 100)
OptimizeIL.Emit(OpCodes.Br, label11)
OptimizeIL.MarkSequencePoint(doc4, 505, 1, 505, 100)
OptimizeIL.Emit(OpCodes.Br, cont137)
OptimizeIL.MarkLabel(fa137)
OptimizeIL.Emit(OpCodes.Br, cont137)
OptimizeIL.MarkLabel(cont137)
...
ReDim Preserve typ66(UBound(typ66) + 1)
typ66(UBound(typ66)) = Typ
OptimizeIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("IsInstanceOfType", typ66))
...
OptimizeIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa140 As System.Reflection.Emit.Label = OptimizeIL.DefineLabel()
Dim tru140 As System.Reflection.Emit.Label = OptimizeIL.DefineLabel()
Dim cont140 As System.Reflection.Emit.Label = OptimizeIL.DefineLabel()
OptimizeIL.Emit(OpCodes.Beq, tru140)
OptimizeIL.Emit(OpCodes.Br, fa140)
OptimizeIL.MarkLabel(tru140)
OptimizeIL.MarkSequencePoint(doc4, 511, 1, 511, 100)
OptimizeIL.Emit(OpCodes.Ldsfld, asm.GetType("dylan.NET.Tokenizer.Parser.ParserFlags").GetField("isChanged"))
Typ = asm.GetType("dylan.NET.Tokenizer.Parser.ParserFlags").GetField("isChanged").FieldType
OptimizeIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa141 As System.Reflection.Emit.Label = OptimizeIL.DefineLabel()
Dim tru141 As System.Reflection.Emit.Label = OptimizeIL.DefineLabel()
Dim cont141 As System.Reflection.Emit.Label = OptimizeIL.DefineLabel()
OptimizeIL.Emit(OpCodes.Beq, tru141)
OptimizeIL.Emit(OpCodes.Br, fa141)
OptimizeIL.MarkLabel(tru141)
OptimizeIL.MarkSequencePoint(doc4, 512, 1, 512, 100)
Dim locbldr167 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(CharLiteral))
locbldr167.SetLocalSymInfo("cl1")
OptimizeIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Expr)
OptimizeIL.Emit(OpCodes.Ldfld, GetType(Expr).GetField("Tokens"))
Typ = GetType(Expr).GetField("Tokens").FieldType
...
OptimizeIL.Emit(OpCodes.Call, asm.GetType("dylan.NET.Tokenizer.Parser.ParserFlags").GetMethod("UpdateCharLit", typ67))
Typ = asm.GetType("dylan.NET.Tokenizer.Parser.ParserFlags").GetMethod("UpdateCharLit", typ67).ReturnType
Typ = Typ02
OptimizeIL.Emit(OpCodes.Stelem, Typ.GetElementType())
...
OptimizeIL.Emit(OpCodes.Br, cont141)
OptimizeIL.MarkLabel(fa141)
OptimizeIL.Emit(OpCodes.Br, cont141)
OptimizeIL.MarkLabel(cont141)
OptimizeIL.MarkSequencePoint(doc4, 517, 1, 517, 100)
OptimizeIL.Emit(OpCodes.Br, label11)
OptimizeIL.MarkSequencePoint(doc4, 518, 1, 518, 100)
OptimizeIL.Emit(OpCodes.Br, cont140)
OptimizeIL.MarkLabel(fa140)
OptimizeIL.Emit(OpCodes.Br, cont140)
OptimizeIL.MarkLabel(cont140)
...
OptimizeIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa142 As System.Reflection.Emit.Label = OptimizeIL.DefineLabel()
Dim tru142 As System.Reflection.Emit.Label = OptimizeIL.DefineLabel()
Dim cont142 As System.Reflection.Emit.Label = OptimizeIL.DefineLabel()
OptimizeIL.Emit(OpCodes.Beq, tru142)
OptimizeIL.Emit(OpCodes.Br, fa142)
OptimizeIL.MarkLabel(tru142)
...
OptimizeIL.Emit(OpCodes.Beq, tru143)
OptimizeIL.Emit(OpCodes.Br, fa143)
OptimizeIL.MarkLabel(tru143)
OptimizeIL.MarkSequencePoint(doc4, 526, 1, 526, 100)
Dim locbldr168 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(StringLiteral))
locbldr168.SetLocalSymInfo("sl1")
OptimizeIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Expr)
OptimizeIL.Emit(OpCodes.Ldfld, GetType(Expr).GetField("Tokens"))
Typ = GetType(Expr).GetField("Tokens").FieldType
...
ReDim Preserve typ70(UBound(typ70) + 1)
typ70(UBound(typ70)) = Typ
OptimizeIL.Emit(OpCodes.Call, asm.GetType("dylan.NET.Tokenizer.Parser.ParserFlags").GetMethod("UpdateStringLit", typ70))
Typ = asm.GetType("dylan.NET.Tokenizer.Parser.ParserFlags").GetMethod("UpdateStringLit", typ70).ReturnType
Typ = Typ02
OptimizeIL.Emit(OpCodes.Stelem, Typ.GetElementType())
...
OptimizeIL.Emit(OpCodes.Pop)
End If
OptimizeIL.MarkSequencePoint(doc4, 529, 1, 529, 100)
OptimizeIL.Emit(OpCodes.Ldloc, 1)
Typ = GetType(System.Int32)
OptimizeIL.Emit(OpCodes.Stloc, 2)
...
OptimizeIL.Emit(OpCodes.Br, cont142)
OptimizeIL.MarkLabel(fa142)
OptimizeIL.Emit(OpCodes.Br, cont142)
OptimizeIL.MarkLabel(cont142)
...
ReDim Preserve typ72(UBound(typ72) + 1)
typ72(UBound(typ72)) = Typ
OptimizeIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("IsInstanceOfType", typ72))
...
Dim locbldr169 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(BooleanLiteral))
locbldr169.SetLocalSymInfo("bl1")
OptimizeIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Expr)
OptimizeIL.Emit(OpCodes.Ldfld, GetType(Expr).GetField("Tokens"))
Typ = GetType(Expr).GetField("Tokens").FieldType
...
OptimizeIL.Emit(OpCodes.Call, asm.GetType("dylan.NET.Tokenizer.Parser.ParserFlags").GetMethod("UpdateBoolLit", typ73))
Typ = asm.GetType("dylan.NET.Tokenizer.Parser.ParserFlags").GetMethod("UpdateBoolLit", typ73).ReturnType
Typ = Typ02
OptimizeIL.Emit(OpCodes.Stelem, Typ.GetElementType())
...
Typ = GetType(System.Int32)
OptimizeIL.Emit(OpCodes.Stloc, 2)
OptimizeIL.MarkSequencePoint(doc4, 543, 1, 543, 100)
...
OptimizeIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("IsInstanceOfType", typ75))
...
OptimizeIL.Emit(OpCodes.Beq, tru146)
...
Dim locbldr170 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(NumberLiteral))
locbldr170.SetLocalSymInfo("nl1")
OptimizeIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Expr)
OptimizeIL.Emit(OpCodes.Ldfld, GetType(Expr).GetField("Tokens"))
Typ = GetType(Expr).GetField("Tokens").FieldType
...
ReDim Preserve typ76(UBound(typ76) + 1)
typ76(UBound(typ76)) = Typ
OptimizeIL.Emit(OpCodes.Call, asm.GetType("dylan.NET.Tokenizer.Parser.ParserFlags").GetMethod("UpdateNumLit", typ76))
Typ = asm.GetType("dylan.NET.Tokenizer.Parser.ParserFlags").GetMethod("UpdateNumLit", typ76).ReturnType
Typ = Typ02
OptimizeIL.Emit(OpCodes.Stelem, Typ.GetElementType())
OptimizeIL.MarkSequencePoint(doc4, 554, 1, 554, 100)
OptimizeIL.Emit(OpCodes.Call, asm.GetType("dylan.NET.Tokenizer.Parser.ParserFlags").GetMethod("SetUnaryFalse", Type.EmptyTypes))
Typ = asm.GetType("dylan.NET.Tokenizer.Parser.ParserFlags").GetMethod("SetUnaryFalse", Type.EmptyTypes).ReturnType
If Typ.ToString() = GetType(System.Void).ToString() Then
...
ReDim Preserve typ78(UBound(typ78) + 1)
typ78(UBound(typ78)) = Typ
OptimizeIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("IsInstanceOfType", typ78))
...
OptimizeIL.Emit(OpCodes.Or)
OptimizeIL.Emit(OpCodes.Stloc, 17)
OptimizeIL.MarkSequencePoint(doc4, 568, 1, 568, 100)
OptimizeIL.Emit(OpCodes.Ldloc, 17)
Typ = GetType(System.Boolean)
OptimizeIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
...
Typ = GetType(System.Boolean)
OptimizeIL.Emit(OpCodes.Stloc, 4)
OptimizeIL.MarkSequencePoint(doc4, 570, 1, 570, 100)
...
OptimizeIL.Emit(OpCodes.Starg, 1)
OptimizeIL.MarkSequencePoint(doc4, 573, 1, 573, 100)
OptimizeIL.Emit(OpCodes.Ldloc, 1)
Typ = GetType(System.Int32)
OptimizeIL.Emit(OpCodes.Ldc_I4, CInt(1))
Typ = GetType(System.Int32)
...
Dim locbldr171 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(MethodCallTok))
locbldr171.SetLocalSymInfo("mct")
OptimizeIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Expr)
OptimizeIL.Emit(OpCodes.Ldfld, GetType(Expr).GetField("Tokens"))
Typ = GetType(Expr).GetField("Tokens").FieldType
...
Dim locbldr172 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(Expr).MakeArrayType())
locbldr172.SetLocalSymInfo("prs")
OptimizeIL.Emit(OpCodes.Ldloc, 29)
Typ = GetType(MethodCallTok)
...
Dim locbldr173 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(System.Int32))
locbldr173.SetLocalSymInfo("ln2")
OptimizeIL.Emit(OpCodes.Ldloc, 30)
...
Dim locbldr174 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(System.Int32))
locbldr174.SetLocalSymInfo("i2")
OptimizeIL.Emit(OpCodes.Ldc_I4, CInt(-1))
Typ = GetType(System.Int32)
OptimizeIL.Emit(OpCodes.Stloc, 32)
...
OptimizeIL.Emit(OpCodes.Blt, tru151)
OptimizeIL.Emit(OpCodes.Br, fa151)
OptimizeIL.MarkLabel(tru151)
OptimizeIL.MarkSequencePoint(doc4, 589, 1, 589, 100)
...
OptimizeIL.MarkSequencePoint(doc4, 592, 1, 592, 100)
...
OptimizeIL.MarkSequencePoint(doc4, 607, 1, 607, 100)
...
Typ = GetType(System.Type).GetMethod("GetTypeFromHandle", typ81).ReturnType
OptimizeIL.Emit(OpCodes.Stloc, 16)
OptimizeIL.MarkSequencePoint(doc4, 622, 1, 622, 100)
Dim typ82(-1) As Type
OptimizeIL.Emit(OpCodes.Ldloc, 16)
Typ = GetType(System.Type)
Typ03 = Typ
...
ReDim Preserve typ82(UBound(typ82) + 1)
typ82(UBound(typ82)) = Typ
OptimizeIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("IsInstanceOfType", typ82))
...
OptimizeIL.MarkSequencePoint(doc4, 625, 1, 625, 100)
OptimizeIL.Emit(OpCodes.Ldsfld, asm.GetType("dylan.NET.Tokenizer.Parser.ParserFlags").GetField("IdentFlag"))
Typ = asm.GetType("dylan.NET.Tokenizer.Parser.ParserFlags").GetField("IdentFlag").FieldType
OptimizeIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
...
Dim locbldr175 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(Ident))
locbldr175.SetLocalSymInfo("aidt")
OptimizeIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Expr)
OptimizeIL.Emit(OpCodes.Ldfld, GetType(Expr).GetField("Tokens"))
Typ = GetType(Expr).GetField("Tokens").FieldType
...
Dim locbldr176 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(Expr))
locbldr176.SetLocalSymInfo("arriloc")
OptimizeIL.Emit(OpCodes.Ldloc, 33)
Typ = GetType(Ident)
...
Typ = Optimize.ReturnType
OptimizeIL.Emit(OpCodes.Stloc, 34)
OptimizeIL.MarkSequencePoint(doc4, 635, 1, 635, 100)
...
OptimizeIL.MarkSequencePoint(doc4, 638, 1, 638, 100)
OptimizeIL.Emit(OpCodes.Ldc_I4, 0)
Typ = GetType(System.Boolean)
OptimizeIL.Emit(OpCodes.Stsfld, asm.GetType("dylan.NET.Tokenizer.Parser.ParserFlags").GetField("MetCallFlag"))
...
Dim locbldr177 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(MethodCallTok))
locbldr177.SetLocalSymInfo("amtd")
OptimizeIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Expr)
OptimizeIL.Emit(OpCodes.Ldfld, GetType(Expr).GetField("Tokens"))
Typ = GetType(Expr).GetField("Tokens").FieldType
...
Typ = Typ.GetElementType()
OptimizeIL.Emit(OpCodes.Stloc, 35)
OptimizeIL.MarkSequencePoint(doc4, 648, 1, 648, 100)
Dim locbldr178 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(MethodNameTok))
locbldr178.SetLocalSymInfo("amtdn")
OptimizeIL.Emit(OpCodes.Ldloc, 35)
Typ = GetType(MethodCallTok)
...
Typ = GetType(System.Boolean)
OptimizeIL.Emit(OpCodes.Stsfld, asm.GetType("dylan.NET.Tokenizer.Parser.ParserFlags").GetField("MetCallFlag"))
OptimizeIL.MarkSequencePoint(doc4, 651, 1, 651, 100)
OptimizeIL.Emit(OpCodes.Ldc_I4, 0)
Typ = GetType(System.Boolean)
OptimizeIL.Emit(OpCodes.Stsfld, asm.GetType("dylan.NET.Tokenizer.Parser.ParserFlags").GetField("IdentFlag"))
...
OptimizeIL.MarkSequencePoint(doc4, 662, 1, 662, 100)
OptimizeIL.Emit(OpCodes.Br, label11)
...
OptimizeIL.MarkSequencePoint(doc4, 665, 1, 665, 100)
OptimizeIL.Emit(OpCodes.Ldloc, 1)
Typ = GetType(System.Int32)
OptimizeIL.Emit(OpCodes.Ldloc, 2)
Typ = GetType(System.Int32)
...
OptimizeIL.Emit(OpCodes.Bgt, tru156)
...
OptimizeIL.Emit(OpCodes.Br, cont132)
OptimizeIL.MarkLabel(fa132)
OptimizeIL.Emit(OpCodes.Br, cont132)
OptimizeIL.MarkLabel(cont132)
OptimizeIL.MarkSequencePoint(doc4, 676, 1, 676, 100)
OptimizeIL.MarkLabel(label11)
OptimizeIL.MarkSequencePoint(doc4, 678, 1, 678, 100)
OptimizeIL.Emit(OpCodes.Ldloc, 1)
Typ = GetType(System.Int32)
OptimizeIL.Emit(OpCodes.Ldloc, 0)
Typ = GetType(System.Int32)
...
OptimizeIL.Emit(OpCodes.Bge, tru157)
...
OptimizeIL.Emit(OpCodes.Br, label9)
...
OptimizeIL.Emit(OpCodes.Br, cont127)
OptimizeIL.MarkLabel(fa127)
OptimizeIL.MarkSequencePoint(doc4, 688, 1, 688, 100)
OptimizeIL.Emit(OpCodes.Ldloc, 1)
Typ = GetType(System.Int32)
OptimizeIL.Emit(OpCodes.Ldc_I4, CInt(1))
Typ = GetType(System.Int32)
OptimizeIL.Emit(OpCodes.Sub)
OptimizeIL.Emit(OpCodes.Stloc, 1)
OptimizeIL.MarkSequencePoint(doc4, 691, 1, 691, 100)
Dim label14 As System.Reflection.Emit.Label = OptimizeIL.DefineLabel()
OptimizeIL.MarkSequencePoint(doc4, 693, 1, 693, 100)
OptimizeIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Expr)
OptimizeIL.Emit(OpCodes.Ldfld, GetType(Expr).GetField("Tokens"))
Typ = GetType(Expr).GetField("Tokens").FieldType
...
Typ = GetType(System.Type).GetMethod("GetTypeFromHandle", typ87).ReturnType
OptimizeIL.Emit(OpCodes.Stloc, 16)
OptimizeIL.MarkSequencePoint(doc4, 696, 1, 696, 100)
Dim typ88(-1) As Type
OptimizeIL.Emit(OpCodes.Ldloc, 16)
Typ = GetType(System.Type)
Typ03 = Typ
...
ReDim Preserve typ88(UBound(typ88) + 1)
typ88(UBound(typ88)) = Typ
OptimizeIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("IsInstanceOfType", typ88))
Typ = Typ03.GetMethod("IsInstanceOfType", typ88).ReturnType
OptimizeIL.Emit(OpCodes.Stloc, 17)
OptimizeIL.MarkSequencePoint(doc4, 698, 1, 698, 100)
OptimizeIL.Emit(OpCodes.Ldloc, 17)
Typ = GetType(System.Boolean)
OptimizeIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
...
OptimizeIL.Emit(OpCodes.Or)
OptimizeIL.Emit(OpCodes.Stloc, 17)
OptimizeIL.MarkSequencePoint(doc4, 701, 1, 701, 100)
OptimizeIL.Emit(OpCodes.Ldloc, 17)
Typ = GetType(System.Boolean)
OptimizeIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
...
OptimizeIL.MarkSequencePoint(doc4, 708, 1, 708, 100)
Dim typ89(-1) As Type
OptimizeIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Expr)
Typ03 = Typ
...
OptimizeIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("RemToken", typ89))
Typ = Typ03.GetMethod("RemToken", typ89).ReturnType
If Typ.ToString() = GetType(System.Void).ToString() Then
...
OptimizeIL.MarkSequencePoint(doc4, 711, 1, 711, 100)
OptimizeIL.Emit(OpCodes.Ldloc, 10)
Typ = GetType(Ident)
...
ReDim Preserve typ90(UBound(typ90) + 1)
typ90(UBound(typ90)) = Typ
OptimizeIL.Emit(OpCodes.Call, GetType(ParseUtils).GetMethod("LikeOP", typ90))
Typ = GetType(ParseUtils).GetMethod("LikeOP", typ90).ReturnType
OptimizeIL.Emit(OpCodes.Stloc, 17)
...
Typ = GetType(System.Boolean)
OptimizeIL.Emit(OpCodes.Stsfld, asm.GetType("dylan.NET.Tokenizer.Parser.ParserFlags").GetField("IdentFlag"))
OptimizeIL.MarkSequencePoint(doc4, 715, 1, 715, 100)
...
OptimizeIL.MarkSequencePoint(doc4, 719, 1, 719, 100)
...
OptimizeIL.MarkSequencePoint(doc4, 723, 1, 723, 100)
OptimizeIL.Emit(OpCodes.Ldloc, 8)
Typ = GetType(Token)
OptimizeIL.Emit(OpCodes.Stloc, 11)
...
OptimizeIL.MarkSequencePoint(doc4, 727, 1, 727, 100)
OptimizeIL.Emit(OpCodes.Ldc_I4, 0)
Typ = GetType(System.Boolean)
OptimizeIL.Emit(OpCodes.Stsfld, asm.GetType("dylan.NET.Tokenizer.Parser.ParserFlags").GetField("MetCallFlag"))
...
OptimizeIL.MarkSequencePoint(doc4, 733, 1, 733, 100)
Dim typ93(-1) As Type
OptimizeIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Expr)
Typ03 = Typ
...
OptimizeIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("RemToken", typ93))
Typ = Typ03.GetMethod("RemToken", typ93).ReturnType
If Typ.ToString() = GetType(System.Void).ToString() Then
...
OptimizeIL.MarkSequencePoint(doc4, 735, 1, 735, 100)
OptimizeIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Expr)
OptimizeIL.Emit(OpCodes.Ldfld, GetType(Expr).GetField("Tokens"))
Typ = GetType(Expr).GetField("Tokens").FieldType
...
OptimizeIL.MarkSequencePoint(doc4, 737, 1, 737, 100)
OptimizeIL.Emit(OpCodes.Ldloc, 12)
Typ = GetType(MethodNameTok)
...
ReDim Preserve typ94(UBound(typ94) + 1)
typ94(UBound(typ94)) = Typ
OptimizeIL.Emit(OpCodes.Call, GetType(ParseUtils).GetMethod("LikeOP", typ94))
Typ = GetType(ParseUtils).GetMethod("LikeOP", typ94).ReturnType
OptimizeIL.Emit(OpCodes.Stloc, 17)
...
OptimizeIL.MarkSequencePoint(doc4, 740, 1, 740, 100)
OptimizeIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
OptimizeIL.Emit(OpCodes.Stsfld, asm.GetType("dylan.NET.Tokenizer.Parser.ParserFlags").GetField("MetCallFlag"))
...
OptimizeIL.Emit(OpCodes.Br, label14)
OptimizeIL.MarkSequencePoint(doc4, 743, 1, 743, 100)
OptimizeIL.Emit(OpCodes.Br, cont161)
OptimizeIL.MarkLabel(fa161)
OptimizeIL.Emit(OpCodes.Br, cont161)
OptimizeIL.MarkLabel(cont161)
OptimizeIL.MarkSequencePoint(doc4, 745, 1, 745, 100)
OptimizeIL.Emit(OpCodes.Ldtoken, GetType(StringLiteral))
Dim typ95 As Type() = {GetType(System.RuntimeTypeHandle)}
OptimizeIL.Emit(OpCodes.Call, GetType(System.Type).GetMethod("GetTypeFromHandle", typ95))
Typ = GetType(System.Type).GetMethod("GetTypeFromHandle", typ95).ReturnType
...
ReDim Preserve typ96(UBound(typ96) + 1)
typ96(UBound(typ96)) = Typ
OptimizeIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("IsInstanceOfType", typ96))
Typ = Typ03.GetMethod("IsInstanceOfType", typ96).ReturnType
OptimizeIL.Emit(OpCodes.Stloc, 17)
OptimizeIL.MarkSequencePoint(doc4, 748, 1, 748, 100)
OptimizeIL.Emit(OpCodes.Ldloc, 17)
Typ = GetType(System.Boolean)
OptimizeIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
...
Typ = GetType(Token)
OptimizeIL.Emit(OpCodes.Stloc, 13)
OptimizeIL.MarkSequencePoint(doc4, 750, 1, 750, 100)
OptimizeIL.Emit(OpCodes.Ldsfld, asm.GetType("dylan.NET.Tokenizer.Parser.ParserFlags").GetField("MetCallFlag"))
Typ = asm.GetType("dylan.NET.Tokenizer.Parser.ParserFlags").GetField("MetCallFlag").FieldType
OptimizeIL.Emit(OpCodes.Ldsfld, asm.GetType("dylan.NET.Tokenizer.Parser.ParserFlags").GetField("IdentFlag"))
Typ = asm.GetType("dylan.NET.Tokenizer.Parser.ParserFlags").GetField("IdentFlag").FieldType
...
Typ = GetType(System.Boolean)
OptimizeIL.Emit(OpCodes.Stsfld, asm.GetType("dylan.NET.Tokenizer.Parser.ParserFlags").GetField("MetCallFlag"))
OptimizeIL.MarkSequencePoint(doc4, 753, 1, 753, 100)
OptimizeIL.Emit(OpCodes.Ldc_I4, 0)
Typ = GetType(System.Boolean)
OptimizeIL.Emit(OpCodes.Stsfld, asm.GetType("dylan.NET.Tokenizer.Parser.ParserFlags").GetField("IdentFlag"))
...
ReDim Preserve typ97(UBound(typ97) + 1)
typ97(UBound(typ97)) = Typ
OptimizeIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("RemToken", typ97))
Typ = Typ03.GetMethod("RemToken", typ97).ReturnType
If Typ.ToString() = GetType(System.Void).ToString() Then
...
Typ = Typ02
OptimizeIL.Emit(OpCodes.Stelem, Typ.GetElementType())
OptimizeIL.MarkSequencePoint(doc4, 760, 1, 760, 100)
...
OptimizeIL.MarkSequencePoint(doc4, 764, 1, 764, 100)
...
OptimizeIL.Emit(OpCodes.Ble, tru166)
OptimizeIL.Emit(OpCodes.Br, fa166)
OptimizeIL.MarkLabel(tru166)
OptimizeIL.MarkSequencePoint(doc4, 767, 1, 767, 100)
OptimizeIL.Emit(OpCodes.Br, label10)
OptimizeIL.MarkSequencePoint(doc4, 768, 1, 768, 100)
...
OptimizeIL.Emit(OpCodes.Br, cont127)
OptimizeIL.MarkLabel(cont127)
OptimizeIL.MarkSequencePoint(doc4, 774, 1, 774, 100)
OptimizeIL.MarkLabel(label10)
...
Typ = GetType(System.Boolean)
OptimizeIL.Emit(OpCodes.Stsfld, asm.GetType("dylan.NET.Tokenizer.Parser.ParserFlags").GetField("MetCallFlag"))
OptimizeIL.MarkSequencePoint(doc4, 783, 1, 783, 100)
OptimizeIL.Emit(OpCodes.Ldc_I4, 0)
Typ = GetType(System.Boolean)
OptimizeIL.Emit(OpCodes.Stsfld, asm.GetType("dylan.NET.Tokenizer.Parser.ParserFlags").GetField("IdentFlag"))
...
Typ = GetType(System.Boolean)
OptimizeIL.Emit(OpCodes.Stsfld, asm.GetType("dylan.NET.Tokenizer.Parser.ParserFlags").GetField("MetChainFlag"))
OptimizeIL.MarkSequencePoint(doc4, 791, 1, 791, 100)
OptimizeIL.Emit(OpCodes.Br, cont167)
...
Typ = GetType(System.Boolean)
OptimizeIL.Emit(OpCodes.Stsfld, asm.GetType("dylan.NET.Tokenizer.Parser.ParserFlags").GetField("IdentFlag"))
OptimizeIL.MarkSequencePoint(doc4, 795, 1, 795, 100)
OptimizeIL.Emit(OpCodes.Ldc_I4, 0)
Typ = GetType(System.Boolean)
OptimizeIL.Emit(OpCodes.Stsfld, asm.GetType("dylan.NET.Tokenizer.Parser.ParserFlags").GetField("StringFlag"))
...
Dim locbldr179 As LocalBuilder = checkRefasmIL.DeclareLocal(GetType(Token))
...
Dim locbldr180 As LocalBuilder = checkRefasmIL.DeclareLocal(GetType(System.Type))
...
Dim locbldr181 As LocalBuilder = checkRefasmIL.DeclareLocal(GetType(RefasmStmt))
locbldr181.SetLocalSymInfo("refasms")
...
Typ = GetType(System.Boolean)
Dim fa169 As System.Reflection.Emit.Label = checkRefasmIL.DefineLabel()
Dim tru169 As System.Reflection.Emit.Label = checkRefasmIL.DefineLabel()
Dim cont169 As System.Reflection.Emit.Label = checkRefasmIL.DefineLabel()
checkRefasmIL.Emit(OpCodes.Beq, tru169)
checkRefasmIL.Emit(OpCodes.Br, fa169)
checkRefasmIL.MarkLabel(tru169)
...
checkRefasmIL.Emit(OpCodes.Br, cont169)
checkRefasmIL.MarkLabel(fa169)
checkRefasmIL.Emit(OpCodes.Br, cont169)
checkRefasmIL.MarkLabel(cont169)
...
Dim locbldr182 As LocalBuilder = checkDebugIL.DeclareLocal(GetType(Token))
...
Dim locbldr183 As LocalBuilder = checkDebugIL.DeclareLocal(GetType(System.Type))
...
Dim locbldr184 As LocalBuilder = checkDebugIL.DeclareLocal(GetType(DebugStmt))
locbldr184.SetLocalSymInfo("dbgs")
checkDebugIL.Emit(OpCodes.Newobj, GetType(DebugStmt).GetConstructor(Type.EmptyTypes))
checkDebugIL.Emit(OpCodes.Stloc, 2)
checkDebugIL.MarkSequencePoint(doc5, 29, 1, 29, 100)
checkDebugIL.Emit(OpCodes.Ldarg, 2)
Typ = GetType(System.Boolean).MakeByRefType()
...
Typ = GetType(System.Boolean)
Dim fa170 As System.Reflection.Emit.Label = checkDebugIL.DefineLabel()
Dim tru170 As System.Reflection.Emit.Label = checkDebugIL.DefineLabel()
Dim cont170 As System.Reflection.Emit.Label = checkDebugIL.DefineLabel()
checkDebugIL.Emit(OpCodes.Beq, tru170)
checkDebugIL.Emit(OpCodes.Br, fa170)
checkDebugIL.MarkLabel(tru170)
checkDebugIL.MarkSequencePoint(doc5, 30, 1, 30, 100)
...
checkDebugIL.MarkSequencePoint(doc5, 31, 1, 31, 100)
checkDebugIL.Emit(OpCodes.Ldloc, 2)
Typ = GetType(DebugStmt)
checkDebugIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
...
checkDebugIL.MarkSequencePoint(doc5, 32, 1, 32, 100)
checkDebugIL.Emit(OpCodes.Ldloc, 2)
Typ = GetType(DebugStmt)
checkDebugIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
...
checkDebugIL.MarkSequencePoint(doc5, 33, 1, 33, 100)
checkDebugIL.Emit(OpCodes.Ldloc, 2)
Typ = GetType(DebugStmt)
Typ03 = Typ
...
End If
checkDebugIL.MarkSequencePoint(doc5, 34, 1, 34, 100)
checkDebugIL.Emit(OpCodes.Br, cont170)
checkDebugIL.MarkLabel(fa170)
checkDebugIL.Emit(OpCodes.Br, cont170)
checkDebugIL.MarkLabel(cont170)
checkDebugIL.MarkSequencePoint(doc5, 35, 1, 35, 100)
checkDebugIL.Emit(OpCodes.Ldloc, 2)
Typ = GetType(DebugStmt)
checkDebugIL.MarkSequencePoint(doc5, 36, 1, 36, 100)
...
Dim locbldr185 As LocalBuilder = checkImportIL.DeclareLocal(GetType(Token))
locbldr185.SetLocalSymInfo("tok")
...
Dim locbldr186 As LocalBuilder = checkImportIL.DeclareLocal(GetType(System.Type))
locbldr186.SetLocalSymInfo("typ")
...
checkImportIL.MarkSequencePoint(doc5, 43, 1, 43, 100)
Dim locbldr187 As LocalBuilder = checkImportIL.DeclareLocal(GetType(ImportStmt))
locbldr187.SetLocalSymInfo("imps")
checkImportIL.Emit(OpCodes.Newobj, GetType(ImportStmt).GetConstructor(Type.EmptyTypes))
checkImportIL.Emit(OpCodes.Stloc, 2)
checkImportIL.MarkSequencePoint(doc5, 44, 1, 44, 100)
checkImportIL.Emit(OpCodes.Ldarg, 2)
Typ = GetType(System.Boolean).MakeByRefType()
...
Typ = GetType(System.Boolean)
Dim fa171 As System.Reflection.Emit.Label = checkImportIL.DefineLabel()
Dim tru171 As System.Reflection.Emit.Label = checkImportIL.DefineLabel()
Dim cont171 As System.Reflection.Emit.Label = checkImportIL.DefineLabel()
checkImportIL.Emit(OpCodes.Beq, tru171)
checkImportIL.Emit(OpCodes.Br, fa171)
checkImportIL.MarkLabel(tru171)
checkImportIL.MarkSequencePoint(doc5, 45, 1, 45, 100)
...
checkImportIL.MarkSequencePoint(doc5, 46, 1, 46, 100)
checkImportIL.Emit(OpCodes.Ldloc, 2)
Typ = GetType(ImportStmt)
checkImportIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
...
checkImportIL.MarkSequencePoint(doc5, 47, 1, 47, 100)
checkImportIL.Emit(OpCodes.Ldloc, 2)
Typ = GetType(ImportStmt)
checkImportIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
...
checkImportIL.MarkSequencePoint(doc5, 48, 1, 48, 100)
checkImportIL.Emit(OpCodes.Br, cont171)
checkImportIL.MarkLabel(fa171)
checkImportIL.Emit(OpCodes.Br, cont171)
checkImportIL.MarkLabel(cont171)
checkImportIL.MarkSequencePoint(doc5, 49, 1, 49, 100)
checkImportIL.Emit(OpCodes.Ldloc, 2)
Typ = GetType(ImportStmt)
checkImportIL.MarkSequencePoint(doc5, 50, 1, 50, 100)
...
Dim locbldr188 As LocalBuilder = checkLocimportIL.DeclareLocal(GetType(Token))
locbldr188.SetLocalSymInfo("tok")
...
Dim locbldr189 As LocalBuilder = checkLocimportIL.DeclareLocal(GetType(System.Type))
locbldr189.SetLocalSymInfo("typ")
...
checkLocimportIL.MarkSequencePoint(doc5, 56, 1, 56, 100)
Dim locbldr190 As LocalBuilder = checkLocimportIL.DeclareLocal(GetType(LocimportStmt))
locbldr190.SetLocalSymInfo("limps")
...
checkLocimportIL.MarkSequencePoint(doc5, 57, 1, 57, 100)
checkLocimportIL.Emit(OpCodes.Ldarg, 2)
Typ = GetType(System.Boolean).MakeByRefType()
...
Typ = GetType(System.Boolean)
Dim fa172 As System.Reflection.Emit.Label = checkLocimportIL.DefineLabel()
Dim tru172 As System.Reflection.Emit.Label = checkLocimportIL.DefineLabel()
Dim cont172 As System.Reflection.Emit.Label = checkLocimportIL.DefineLabel()
checkLocimportIL.Emit(OpCodes.Beq, tru172)
checkLocimportIL.Emit(OpCodes.Br, fa172)
checkLocimportIL.MarkLabel(tru172)
checkLocimportIL.MarkSequencePoint(doc5, 58, 1, 58, 100)
...
checkLocimportIL.MarkSequencePoint(doc5, 59, 1, 59, 100)
checkLocimportIL.Emit(OpCodes.Ldloc, 2)
Typ = GetType(LocimportStmt)
checkLocimportIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
...
checkLocimportIL.MarkSequencePoint(doc5, 60, 1, 60, 100)
checkLocimportIL.Emit(OpCodes.Ldloc, 2)
Typ = GetType(LocimportStmt)
checkLocimportIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
...
checkLocimportIL.MarkSequencePoint(doc5, 61, 1, 61, 100)
checkLocimportIL.Emit(OpCodes.Br, cont172)
checkLocimportIL.MarkLabel(fa172)
checkLocimportIL.Emit(OpCodes.Br, cont172)
checkLocimportIL.MarkLabel(cont172)
checkLocimportIL.MarkSequencePoint(doc5, 62, 1, 62, 100)
checkLocimportIL.Emit(OpCodes.Ldloc, 2)
Typ = GetType(LocimportStmt)
checkLocimportIL.MarkSequencePoint(doc5, 63, 1, 63, 100)
...
Dim locbldr191 As LocalBuilder = checkCmtIL.DeclareLocal(GetType(Token))
...
Dim locbldr192 As LocalBuilder = checkCmtIL.DeclareLocal(GetType(System.Type))
...
checkCmtIL.MarkSequencePoint(doc5, 68, 1, 68, 100)
...
checkCmtIL.MarkSequencePoint(doc5, 69, 1, 69, 100)
Dim locbldr193 As LocalBuilder = checkCmtIL.DeclareLocal(GetType(CommentStmt))
locbldr193.SetLocalSymInfo("cmts")
checkCmtIL.Emit(OpCodes.Newobj, GetType(CommentStmt).GetConstructor(Type.EmptyTypes))
checkCmtIL.Emit(OpCodes.Stloc, 2)
checkCmtIL.MarkSequencePoint(doc5, 70, 1, 70, 100)
checkCmtIL.Emit(OpCodes.Ldarg, 2)
Typ = GetType(System.Boolean).MakeByRefType()
...
Typ = GetType(System.Boolean)
Dim fa173 As System.Reflection.Emit.Label = checkCmtIL.DefineLabel()
Dim tru173 As System.Reflection.Emit.Label = checkCmtIL.DefineLabel()
Dim cont173 As System.Reflection.Emit.Label = checkCmtIL.DefineLabel()
checkCmtIL.Emit(OpCodes.Beq, tru173)
checkCmtIL.Emit(OpCodes.Br, fa173)
checkCmtIL.MarkLabel(tru173)
checkCmtIL.MarkSequencePoint(doc5, 71, 1, 71, 100)
...
checkCmtIL.MarkSequencePoint(doc5, 72, 1, 72, 100)
checkCmtIL.Emit(OpCodes.Ldloc, 2)
Typ = GetType(CommentStmt)
checkCmtIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
...
checkCmtIL.MarkSequencePoint(doc5, 73, 1, 73, 100)
checkCmtIL.Emit(OpCodes.Br, cont173)
checkCmtIL.MarkLabel(fa173)
checkCmtIL.Emit(OpCodes.Br, cont173)
checkCmtIL.MarkLabel(cont173)
checkCmtIL.MarkSequencePoint(doc5, 74, 1, 74, 100)
checkCmtIL.Emit(OpCodes.Ldloc, 2)
Typ = GetType(CommentStmt)
checkCmtIL.MarkSequencePoint(doc5, 75, 1, 75, 100)
...
Typ = GetType(System.Int32)
Dim fa174 As System.Reflection.Emit.Label = checkEndMtdIL.DefineLabel()
Dim tru174 As System.Reflection.Emit.Label = checkEndMtdIL.DefineLabel()
Dim cont174 As System.Reflection.Emit.Label = checkEndMtdIL.DefineLabel()
checkEndMtdIL.Emit(OpCodes.Bge, tru174)
checkEndMtdIL.Emit(OpCodes.Br, fa174)
checkEndMtdIL.MarkLabel(tru174)
checkEndMtdIL.MarkSequencePoint(doc5, 80, 1, 80, 100)
Dim locbldr194 As LocalBuilder = checkEndMtdIL.DeclareLocal(GetType(Token))
locbldr194.SetLocalSymInfo("tok1")
checkEndMtdIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
checkEndMtdIL.Emit(OpCodes.Ldfld, GetType(Stmt).GetField("Tokens"))
Typ = GetType(Stmt).GetField("Tokens").FieldType
...
checkEndMtdIL.MarkSequencePoint(doc5, 81, 1, 81, 100)
Dim locbldr195 As LocalBuilder = checkEndMtdIL.DeclareLocal(GetType(System.Type))
locbldr195.SetLocalSymInfo("typ1")
...
Dim locbldr196 As LocalBuilder = checkEndMtdIL.DeclareLocal(GetType(System.Boolean))
locbldr196.SetLocalSymInfo("b1")
Dim typ18(-1) As Type
...
Dim locbldr197 As LocalBuilder = checkEndMtdIL.DeclareLocal(GetType(Token))
locbldr197.SetLocalSymInfo("tok2")
checkEndMtdIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
checkEndMtdIL.Emit(OpCodes.Ldfld, GetType(Stmt).GetField("Tokens"))
Typ = GetType(Stmt).GetField("Tokens").FieldType
...
Dim locbldr198 As LocalBuilder = checkEndMtdIL.DeclareLocal(GetType(System.Type))
locbldr198.SetLocalSymInfo("typ2")
...
Dim locbldr199 As LocalBuilder = checkEndMtdIL.DeclareLocal(GetType(System.Boolean))
locbldr199.SetLocalSymInfo("b2")
Dim typ20(-1) As Type
...
checkEndMtdIL.MarkSequencePoint(doc5, 90, 1, 90, 100)
Dim locbldr200 As LocalBuilder = checkEndMtdIL.DeclareLocal(GetType(EndMethodStmt))
locbldr200.SetLocalSymInfo("ems")
checkEndMtdIL.Emit(OpCodes.Newobj, GetType(EndMethodStmt).GetConstructor(Type.EmptyTypes))
checkEndMtdIL.Emit(OpCodes.Stloc, 6)
checkEndMtdIL.MarkSequencePoint(doc5, 91, 1, 91, 100)
checkEndMtdIL.Emit(OpCodes.Ldarg, 2)
Typ = GetType(System.Boolean).MakeByRefType()
...
Typ = GetType(System.Boolean)
Dim fa175 As System.Reflection.Emit.Label = checkEndMtdIL.DefineLabel()
Dim tru175 As System.Reflection.Emit.Label = checkEndMtdIL.DefineLabel()
Dim cont175 As System.Reflection.Emit.Label = checkEndMtdIL.DefineLabel()
checkEndMtdIL.Emit(OpCodes.Beq, tru175)
checkEndMtdIL.Emit(OpCodes.Br, fa175)
checkEndMtdIL.MarkLabel(tru175)
checkEndMtdIL.MarkSequencePoint(doc5, 92, 1, 92, 100)
...
checkEndMtdIL.MarkSequencePoint(doc5, 93, 1, 93, 100)
checkEndMtdIL.Emit(OpCodes.Ldloc, 6)
Typ = GetType(EndMethodStmt)
checkEndMtdIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
...
checkEndMtdIL.MarkSequencePoint(doc5, 94, 1, 94, 100)
checkEndMtdIL.Emit(OpCodes.Br, cont175)
checkEndMtdIL.MarkLabel(fa175)
checkEndMtdIL.Emit(OpCodes.Br, cont175)
checkEndMtdIL.MarkLabel(cont175)
checkEndMtdIL.MarkSequencePoint(doc5, 95, 1, 95, 100)
checkEndMtdIL.Emit(OpCodes.Br, cont174)
checkEndMtdIL.MarkLabel(fa174)
checkEndMtdIL.Emit(OpCodes.Br, cont174)
checkEndMtdIL.MarkLabel(cont174)
checkEndMtdIL.MarkSequencePoint(doc5, 96, 1, 96, 100)
checkEndMtdIL.Emit(OpCodes.Ldloc, 6)
Typ = GetType(EndMethodStmt)
checkEndMtdIL.MarkSequencePoint(doc5, 97, 1, 97, 100)
...
Typ = GetType(System.Int32)
Dim fa176 As System.Reflection.Emit.Label = checkEndClsIL.DefineLabel()
Dim tru176 As System.Reflection.Emit.Label = checkEndClsIL.DefineLabel()
Dim cont176 As System.Reflection.Emit.Label = checkEndClsIL.DefineLabel()
checkEndClsIL.Emit(OpCodes.Bge, tru176)
checkEndClsIL.Emit(OpCodes.Br, fa176)
checkEndClsIL.MarkLabel(tru176)
checkEndClsIL.MarkSequencePoint(doc5, 102, 1, 102, 100)
Dim locbldr201 As LocalBuilder = checkEndClsIL.DeclareLocal(GetType(Token))
locbldr201.SetLocalSymInfo("tok1")
checkEndClsIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
checkEndClsIL.Emit(OpCodes.Ldfld, GetType(Stmt).GetField("Tokens"))
Typ = GetType(Stmt).GetField("Tokens").FieldType
...
checkEndClsIL.MarkSequencePoint(doc5, 103, 1, 103, 100)
Dim locbldr202 As LocalBuilder = checkEndClsIL.DeclareLocal(GetType(System.Type))
locbldr202.SetLocalSymInfo("typ1")
...
Dim locbldr203 As LocalBuilder = checkEndClsIL.DeclareLocal(GetType(System.Boolean))
locbldr203.SetLocalSymInfo("b1")
Dim typ23(-1) As Type
...
Dim locbldr204 As LocalBuilder = checkEndClsIL.DeclareLocal(GetType(Token))
...
Dim locbldr205 As LocalBuilder = checkEndClsIL.DeclareLocal(GetType(System.Type))
...
Dim locbldr206 As LocalBuilder = checkEndClsIL.DeclareLocal(GetType(System.Boolean))
...
checkEndClsIL.MarkSequencePoint(doc5, 112, 1, 112, 100)
Dim locbldr207 As LocalBuilder = checkEndClsIL.DeclareLocal(GetType(EndClassStmt))
locbldr207.SetLocalSymInfo("ecs")
checkEndClsIL.Emit(OpCodes.Newobj, GetType(EndClassStmt).GetConstructor(Type.EmptyTypes))
checkEndClsIL.Emit(OpCodes.Stloc, 6)
checkEndClsIL.MarkSequencePoint(doc5, 113, 1, 113, 100)
checkEndClsIL.Emit(OpCodes.Ldarg, 2)
Typ = GetType(System.Boolean).MakeByRefType()
...
Typ = GetType(System.Boolean)
Dim fa177 As System.Reflection.Emit.Label = checkEndClsIL.DefineLabel()
Dim tru177 As System.Reflection.Emit.Label = checkEndClsIL.DefineLabel()
Dim cont177 As System.Reflection.Emit.Label = checkEndClsIL.DefineLabel()
checkEndClsIL.Emit(OpCodes.Beq, tru177)
checkEndClsIL.Emit(OpCodes.Br, fa177)
checkEndClsIL.MarkLabel(tru177)
checkEndClsIL.MarkSequencePoint(doc5, 114, 1, 114, 100)
...
checkEndClsIL.MarkSequencePoint(doc5, 115, 1, 115, 100)
checkEndClsIL.Emit(OpCodes.Ldloc, 6)
Typ = GetType(EndClassStmt)
checkEndClsIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
...
checkEndClsIL.MarkSequencePoint(doc5, 116, 1, 116, 100)
checkEndClsIL.Emit(OpCodes.Br, cont177)
checkEndClsIL.MarkLabel(fa177)
checkEndClsIL.Emit(OpCodes.Br, cont177)
checkEndClsIL.MarkLabel(cont177)
checkEndClsIL.MarkSequencePoint(doc5, 117, 1, 117, 100)
checkEndClsIL.Emit(OpCodes.Br, cont176)
checkEndClsIL.MarkLabel(fa176)
checkEndClsIL.Emit(OpCodes.Br, cont176)
checkEndClsIL.MarkLabel(cont176)
checkEndClsIL.MarkSequencePoint(doc5, 118, 1, 118, 100)
checkEndClsIL.Emit(OpCodes.Ldloc, 6)
Typ = GetType(EndClassStmt)
checkEndClsIL.MarkSequencePoint(doc5, 119, 1, 119, 100)
...
Dim locbldr208 As LocalBuilder = checkAssemblyIL.DeclareLocal(GetType(Token))
locbldr208.SetLocalSymInfo("tok")
...
Dim locbldr209 As LocalBuilder = checkAssemblyIL.DeclareLocal(GetType(System.Type))
locbldr209.SetLocalSymInfo("typ")
...
Dim locbldr210 As LocalBuilder = checkAssemblyIL.DeclareLocal(GetType(AssemblyStmt))
locbldr210.SetLocalSymInfo("asms")
...
checkAssemblyIL.MarkSequencePoint(doc5, 126, 1, 126, 100)
checkAssemblyIL.Emit(OpCodes.Ldarg, 2)
Typ = GetType(System.Boolean).MakeByRefType()
...
Typ = GetType(System.Boolean)
Dim fa178 As System.Reflection.Emit.Label = checkAssemblyIL.DefineLabel()
Dim tru178 As System.Reflection.Emit.Label = checkAssemblyIL.DefineLabel()
Dim cont178 As System.Reflection.Emit.Label = checkAssemblyIL.DefineLabel()
checkAssemblyIL.Emit(OpCodes.Beq, tru178)
checkAssemblyIL.Emit(OpCodes.Br, fa178)
checkAssemblyIL.MarkLabel(tru178)
checkAssemblyIL.MarkSequencePoint(doc5, 127, 1, 127, 100)
...
checkAssemblyIL.MarkSequencePoint(doc5, 128, 1, 128, 100)
checkAssemblyIL.Emit(OpCodes.Ldloc, 2)
Typ = GetType(AssemblyStmt)
checkAssemblyIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
...
checkAssemblyIL.MarkSequencePoint(doc5, 129, 1, 129, 100)
checkAssemblyIL.Emit(OpCodes.Ldloc, 2)
Typ = GetType(AssemblyStmt)
checkAssemblyIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
...
checkAssemblyIL.MarkSequencePoint(doc5, 130, 1, 130, 100)
checkAssemblyIL.Emit(OpCodes.Ldloc, 2)
Typ = GetType(AssemblyStmt)
checkAssemblyIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
...
checkAssemblyIL.MarkSequencePoint(doc5, 131, 1, 131, 100)
checkAssemblyIL.Emit(OpCodes.Br, cont178)
checkAssemblyIL.MarkLabel(fa178)
checkAssemblyIL.Emit(OpCodes.Br, cont178)
checkAssemblyIL.MarkLabel(cont178)
checkAssemblyIL.MarkSequencePoint(doc5, 132, 1, 132, 100)
checkAssemblyIL.Emit(OpCodes.Ldloc, 2)
Typ = GetType(AssemblyStmt)
checkAssemblyIL.MarkSequencePoint(doc5, 133, 1, 133, 100)
...
Dim locbldr211 As LocalBuilder = checkVerIL.DeclareLocal(GetType(Token))
...
Dim locbldr212 As LocalBuilder = checkVerIL.DeclareLocal(GetType(System.Type))
...
Dim locbldr213 As LocalBuilder = checkVerIL.DeclareLocal(GetType(VerStmt))
locbldr213.SetLocalSymInfo("vers")
...
Typ = GetType(System.Boolean)
Dim fa179 As System.Reflection.Emit.Label = checkVerIL.DefineLabel()
Dim tru179 As System.Reflection.Emit.Label = checkVerIL.DefineLabel()
Dim cont179 As System.Reflection.Emit.Label = checkVerIL.DefineLabel()
checkVerIL.Emit(OpCodes.Beq, tru179)
checkVerIL.Emit(OpCodes.Br, fa179)
checkVerIL.MarkLabel(tru179)
...
Dim locbldr214 As LocalBuilder = checkVerIL.DeclareLocal(GetType(System.String).MakeArrayType())
locbldr214.SetLocalSymInfo("ars")
Dim typ32(-1) As Type
checkVerIL.Emit(OpCodes.Ldloc, 0)
Typ = GetType(Token)
...
Dim locbldr215 As LocalBuilder = checkVerIL.DeclareLocal(GetType(System.Int32).MakeArrayType())
locbldr215.SetLocalSymInfo("ari")
...
Dim locbldr216 As LocalBuilder = checkVerIL.DeclareLocal(GetType(IntLiteral).MakeArrayType())
locbldr216.SetLocalSymInfo("intla")
checkVerIL.Emit(OpCodes.Ldc_I4, CInt(4))
Typ = GetType(System.Int32)
checkVerIL.Emit(OpCodes.Conv_U)
...
Dim locbldr217 As LocalBuilder = checkVerIL.DeclareLocal(GetType(IntLiteral))
locbldr217.SetLocalSymInfo("intl")
...
Typ = GetType(IntLiteral)
checkVerIL.Emit(OpCodes.Stelem, GetType(IntLiteral).MakeArrayType().GetElementType())
checkVerIL.MarkSequencePoint(doc5, 164, 1, 164, 100)
Dim typ40(-1) As Type
checkVerIL.Emit(OpCodes.Ldloc, 3)
Typ = GetType(System.String).MakeArrayType()
Typ02 = Typ
...
checkVerIL.Emit(OpCodes.Stloc, 6)
checkVerIL.MarkSequencePoint(doc5, 165, 1, 165, 100)
checkVerIL.Emit(OpCodes.Ldloc, 6)
Typ = GetType(IntLiteral)
checkVerIL.Emit(OpCodes.Ldloc, 0)
Typ = GetType(Token)
...
Typ = GetType(Token).GetField("Line").FieldType
checkVerIL.Emit(OpCodes.Stfld, GetType(IntLiteral).GetField("Line"))
checkVerIL.MarkSequencePoint(doc5, 166, 1, 166, 100)
checkVerIL.Emit(OpCodes.Ldloc, 6)
Typ = GetType(IntLiteral)
checkVerIL.Emit(OpCodes.Ldloc, 4)
Typ = GetType(System.Int32).MakeArrayType()
...
Typ = GetType(System.Int32).MakeArrayType().GetElementType()
checkVerIL.Emit(OpCodes.Stfld, GetType(IntLiteral).GetField("NumVal"))
checkVerIL.MarkSequencePoint(doc5, 167, 1, 167, 100)
checkVerIL.Emit(OpCodes.Ldloc, 5)
Typ = GetType(IntLiteral).MakeArrayType()
Typ02 = Typ
checkVerIL.Emit(OpCodes.Ldc_I4, CInt(3))
...
Typ = GetType(IntLiteral)
checkVerIL.Emit(OpCodes.Stelem, GetType(IntLiteral).MakeArrayType().GetElementType())
checkVerIL.MarkSequencePoint(doc5, 168, 1, 168, 100)
checkVerIL.Emit(OpCodes.Ldloc, 2)
Typ = GetType(VerStmt)
checkVerIL.Emit(OpCodes.Ldloc, 5)
Typ = GetType(IntLiteral).MakeArrayType()
checkVerIL.Emit(OpCodes.Stfld, GetType(VerStmt).GetField("VersionNos"))
checkVerIL.MarkSequencePoint(doc5, 169, 1, 169, 100)
checkVerIL.Emit(OpCodes.Br, cont179)
checkVerIL.MarkLabel(fa179)
checkVerIL.Emit(OpCodes.Br, cont179)
checkVerIL.MarkLabel(cont179)
checkVerIL.MarkSequencePoint(doc5, 170, 1, 170, 100)
checkVerIL.Emit(OpCodes.Ldloc, 2)
Typ = GetType(VerStmt)
checkVerIL.MarkSequencePoint(doc5, 171, 1, 171, 100)
...
Dim locbldr218 As LocalBuilder = checkClassIL.DeclareLocal(GetType(Token))
...
checkClassIL.MarkSequencePoint(doc5, 175, 1, 175, 100)
Dim locbldr219 As LocalBuilder = checkClassIL.DeclareLocal(GetType(System.Type))
...
Dim locbldr220 As LocalBuilder = checkClassIL.DeclareLocal(GetType(ClassStmt))
locbldr220.SetLocalSymInfo("clss")
checkClassIL.Emit(OpCodes.Newobj, GetType(ClassStmt).GetConstructor(Type.EmptyTypes))
checkClassIL.Emit(OpCodes.Stloc, 2)
checkClassIL.MarkSequencePoint(doc5, 178, 1, 178, 100)
Dim locbldr221 As LocalBuilder = checkClassIL.DeclareLocal(GetType(Attributes.Attribute))
locbldr221.SetLocalSymInfo("att")
...
Typ = GetType(System.Boolean)
Dim fa180 As System.Reflection.Emit.Label = checkClassIL.DefineLabel()
Dim tru180 As System.Reflection.Emit.Label = checkClassIL.DefineLabel()
Dim cont180 As System.Reflection.Emit.Label = checkClassIL.DefineLabel()
checkClassIL.Emit(OpCodes.Beq, tru180)
checkClassIL.Emit(OpCodes.Br, fa180)
checkClassIL.MarkLabel(tru180)
...
checkClassIL.MarkSequencePoint(doc5, 182, 1, 182, 100)
checkClassIL.Emit(OpCodes.Ldloc, 2)
Typ = GetType(ClassStmt)
checkClassIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
...
checkClassIL.MarkSequencePoint(doc5, 184, 1, 184, 100)
...
Dim locbldr222 As LocalBuilder = checkClassIL.DeclareLocal(GetType(System.Int32))
locbldr222.SetLocalSymInfo("i")
checkClassIL.Emit(OpCodes.Ldc_I4, CInt(0))
Typ = GetType(System.Int32)
checkClassIL.Emit(OpCodes.Stloc, 4)
checkClassIL.MarkSequencePoint(doc5, 188, 1, 188, 100)
Dim locbldr223 As LocalBuilder = checkClassIL.DeclareLocal(GetType(System.Int32))
...
checkClassIL.MarkSequencePoint(doc5, 189, 1, 189, 100)
Dim locbldr224 As LocalBuilder = checkClassIL.DeclareLocal(GetType(System.Boolean))
locbldr224.SetLocalSymInfo("bl")
...
checkClassIL.Emit(OpCodes.Stloc, 4)
checkClassIL.MarkSequencePoint(doc5, 194, 1, 194, 100)
checkClassIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
checkClassIL.Emit(OpCodes.Ldfld, GetType(Stmt).GetField("Tokens"))
Typ = GetType(Stmt).GetField("Tokens").FieldType
...
Typ = Typ03.GetMethod("IsInstanceOfType", typ45).ReturnType
checkClassIL.Emit(OpCodes.Stloc, 6)
checkClassIL.MarkSequencePoint(doc5, 198, 1, 198, 100)
checkClassIL.Emit(OpCodes.Ldloc, 6)
Typ = GetType(System.Boolean)
checkClassIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa181 As System.Reflection.Emit.Label = checkClassIL.DefineLabel()
Dim tru181 As System.Reflection.Emit.Label = checkClassIL.DefineLabel()
Dim cont181 As System.Reflection.Emit.Label = checkClassIL.DefineLabel()
checkClassIL.Emit(OpCodes.Beq, tru181)
checkClassIL.Emit(OpCodes.Br, fa181)
checkClassIL.MarkLabel(tru181)
...
checkClassIL.Emit(OpCodes.Br, cont181)
checkClassIL.MarkLabel(fa181)
checkClassIL.MarkSequencePoint(doc5, 203, 1, 203, 100)
Dim locbldr225 As LocalBuilder = checkClassIL.DeclareLocal(GetType(Token))
locbldr225.SetLocalSymInfo("tok2")
checkClassIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
checkClassIL.Emit(OpCodes.Ldfld, GetType(Stmt).GetField("Tokens"))
Typ = GetType(Stmt).GetField("Tokens").FieldType
...
checkClassIL.MarkSequencePoint(doc5, 204, 1, 204, 100)
Dim locbldr226 As LocalBuilder = checkClassIL.DeclareLocal(GetType(System.Type))
locbldr226.SetLocalSymInfo("typ2")
...
Dim locbldr227 As LocalBuilder = checkClassIL.DeclareLocal(GetType(System.Boolean))
...
checkClassIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa182 As System.Reflection.Emit.Label = checkClassIL.DefineLabel()
Dim tru182 As System.Reflection.Emit.Label = checkClassIL.DefineLabel()
Dim cont182 As System.Reflection.Emit.Label = checkClassIL.DefineLabel()
checkClassIL.Emit(OpCodes.Beq, tru182)
checkClassIL.Emit(OpCodes.Br, fa182)
checkClassIL.MarkLabel(tru182)
...
checkClassIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa183 As System.Reflection.Emit.Label = checkClassIL.DefineLabel()
Dim tru183 As System.Reflection.Emit.Label = checkClassIL.DefineLabel()
Dim cont183 As System.Reflection.Emit.Label = checkClassIL.DefineLabel()
checkClassIL.Emit(OpCodes.Beq, fa183)
checkClassIL.Emit(OpCodes.Br, tru183)
checkClassIL.MarkLabel(tru183)
checkClassIL.MarkSequencePoint(doc5, 214, 1, 214, 100)
Dim locbldr228 As LocalBuilder = checkClassIL.DeclareLocal(GetType(Token))
locbldr228.SetLocalSymInfo("t")
checkClassIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
checkClassIL.Emit(OpCodes.Ldfld, GetType(Stmt).GetField("Tokens"))
Typ = GetType(Stmt).GetField("Tokens").FieldType
...
Dim locbldr229 As LocalBuilder = checkClassIL.DeclareLocal(GetType(TypeTok))
locbldr229.SetLocalSymInfo("tt")
...
checkClassIL.MarkSequencePoint(doc5, 217, 1, 217, 100)
checkClassIL.Emit(OpCodes.Ldloc, 11)
Typ = GetType(TypeTok)
checkClassIL.Emit(OpCodes.Ldloc, 10)
Typ = GetType(Token)
...
checkClassIL.MarkSequencePoint(doc5, 219, 1, 219, 100)
checkClassIL.Emit(OpCodes.Br, cont183)
checkClassIL.MarkLabel(fa183)
...
checkClassIL.Emit(OpCodes.Br, cont183)
checkClassIL.MarkLabel(cont183)
checkClassIL.MarkSequencePoint(doc5, 222, 1, 222, 100)
checkClassIL.Emit(OpCodes.Br, cont182)
checkClassIL.MarkLabel(fa182)
...
checkClassIL.Emit(OpCodes.Br, cont182)
checkClassIL.MarkLabel(cont182)
checkClassIL.MarkSequencePoint(doc5, 226, 1, 226, 100)
checkClassIL.Emit(OpCodes.Br, cont181)
checkClassIL.MarkLabel(cont181)
checkClassIL.MarkSequencePoint(doc5, 228, 1, 228, 100)
checkClassIL.Emit(OpCodes.Ldloc, 4)
Typ = GetType(System.Int32)
checkClassIL.Emit(OpCodes.Ldloc, 5)
Typ = GetType(System.Int32)
Dim fa184 As System.Reflection.Emit.Label = checkClassIL.DefineLabel()
Dim tru184 As System.Reflection.Emit.Label = checkClassIL.DefineLabel()
Dim cont184 As System.Reflection.Emit.Label = checkClassIL.DefineLabel()
checkClassIL.Emit(OpCodes.Beq, tru184)
checkClassIL.Emit(OpCodes.Br, fa184)
checkClassIL.MarkLabel(tru184)
checkClassIL.MarkSequencePoint(doc5, 229, 1, 229, 100)
checkClassIL.Emit(OpCodes.Br, label1)
checkClassIL.MarkSequencePoint(doc5, 230, 1, 230, 100)
checkClassIL.Emit(OpCodes.Br, cont184)
checkClassIL.MarkLabel(fa184)
checkClassIL.MarkSequencePoint(doc5, 231, 1, 231, 100)
checkClassIL.Emit(OpCodes.Br, label0)
checkClassIL.MarkSequencePoint(doc5, 232, 1, 232, 100)
checkClassIL.Emit(OpCodes.Br, cont184)
checkClassIL.MarkLabel(cont184)
checkClassIL.MarkSequencePoint(doc5, 234, 1, 234, 100)
checkClassIL.MarkLabel(label1)
checkClassIL.MarkSequencePoint(doc5, 236, 1, 236, 100)
checkClassIL.Emit(OpCodes.Br, cont180)
checkClassIL.MarkLabel(fa180)
checkClassIL.Emit(OpCodes.Br, cont180)
checkClassIL.MarkLabel(cont180)
checkClassIL.MarkSequencePoint(doc5, 238, 1, 238, 100)
checkClassIL.Emit(OpCodes.Ldloc, 2)
Typ = GetType(ClassStmt)
checkClassIL.MarkSequencePoint(doc5, 239, 1, 239, 100)
...
Dim checkField As MethodBuilder = StmtOptimizer.DefineMethod("checkField", MethodAttributes.Public, GetType(Stmt), typ51)
...
checkFieldIL.MarkSequencePoint(doc5, 243, 1, 243, 100)
Dim locbldr230 As LocalBuilder = checkFieldIL.DeclareLocal(GetType(Token))
...
checkFieldIL.MarkSequencePoint(doc5, 244, 1, 244, 100)
Dim locbldr231 As LocalBuilder = checkFieldIL.DeclareLocal(GetType(System.Type))
...
checkFieldIL.Emit(OpCodes.Call, GetType(System.Type).GetMethod("GetTypeFromHandle", typ52))
Typ = GetType(System.Type).GetMethod("GetTypeFromHandle", typ52).ReturnType
checkFieldIL.Emit(OpCodes.Stloc, 1)
checkFieldIL.MarkSequencePoint(doc5, 245, 1, 245, 100)
...
ReDim Preserve typ53(UBound(typ53) + 1)
typ53(UBound(typ53)) = Typ
checkFieldIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("IsInstanceOfType", typ53))
Typ = Typ03.GetMethod("IsInstanceOfType", typ53).ReturnType
checkFieldIL.Emit(OpCodes.Stobj, Typ04)
checkFieldIL.MarkSequencePoint(doc5, 246, 1, 246, 100)
Dim locbldr232 As LocalBuilder = checkFieldIL.DeclareLocal(GetType(FieldStmt))
locbldr232.SetLocalSymInfo("flss")
checkFieldIL.Emit(OpCodes.Newobj, GetType(FieldStmt).GetConstructor(Type.EmptyTypes))
checkFieldIL.Emit(OpCodes.Stloc, 2)
checkFieldIL.MarkSequencePoint(doc5, 247, 1, 247, 100)
Dim locbldr233 As LocalBuilder = checkFieldIL.DeclareLocal(GetType(Attributes.Attribute))
locbldr233.SetLocalSymInfo("att")
checkFieldIL.Emit(OpCodes.Ldnull)
checkFieldIL.Emit(OpCodes.Stloc, 3)
checkFieldIL.MarkSequencePoint(doc5, 249, 1, 249, 100)
checkFieldIL.Emit(OpCodes.Ldarg, 2)
Typ = GetType(System.Boolean).MakeByRefType()
...
Typ = GetType(System.Boolean)
Dim fa185 As System.Reflection.Emit.Label = checkFieldIL.DefineLabel()
Dim tru185 As System.Reflection.Emit.Label = checkFieldIL.DefineLabel()
Dim cont185 As System.Reflection.Emit.Label = checkFieldIL.DefineLabel()
checkFieldIL.Emit(OpCodes.Beq, tru185)
checkFieldIL.Emit(OpCodes.Br, fa185)
checkFieldIL.MarkLabel(tru185)
checkFieldIL.MarkSequencePoint(doc5, 251, 1, 251, 100)
Dim locbldr234 As LocalBuilder = checkFieldIL.DeclareLocal(GetType(Expr))
locbldr234.SetLocalSymInfo("tempexp")
checkFieldIL.Emit(OpCodes.Newobj, GetType(Expr).GetConstructor(Type.EmptyTypes))
checkFieldIL.Emit(OpCodes.Stloc, 4)
checkFieldIL.MarkSequencePoint(doc5, 252, 1, 252, 100)
...
checkFieldIL.MarkSequencePoint(doc5, 253, 1, 253, 100)
Dim locbldr235 As LocalBuilder = checkFieldIL.DeclareLocal(asm.GetType("dylan.NET.Tokenizer.Parser.ExprOptimizer"))
locbldr235.SetLocalSymInfo("eop")
...
ReDim Preserve typ54(UBound(typ54) + 1)
typ54(UBound(typ54)) = Typ
checkFieldIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("Optimize", typ54))
Typ = Typ03.GetMethod("Optimize", typ54).ReturnType
checkFieldIL.Emit(OpCodes.Stloc, 4)
checkFieldIL.MarkSequencePoint(doc5, 256, 1, 256, 100)
checkFieldIL.Emit(OpCodes.Ldc_I4, 0)
Typ = GetType(System.Boolean)
checkFieldIL.Emit(OpCodes.Stsfld, asm.GetType("dylan.NET.Tokenizer.Parser.ParserFlags").GetField("ProcessTTokOnly"))
checkFieldIL.MarkSequencePoint(doc5, 257, 1, 257, 100)
checkFieldIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
checkFieldIL.Emit(OpCodes.Ldloc, 4)
Typ = GetType(Expr)
...
checkFieldIL.MarkSequencePoint(doc5, 259, 1, 259, 100)
...
checkFieldIL.MarkSequencePoint(doc5, 260, 1, 260, 100)
checkFieldIL.Emit(OpCodes.Ldloc, 2)
Typ = GetType(FieldStmt)
checkFieldIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
...
checkFieldIL.MarkSequencePoint(doc5, 262, 1, 262, 100)
Dim label2 As System.Reflection.Emit.Label = checkFieldIL.DefineLabel()
checkFieldIL.MarkSequencePoint(doc5, 263, 1, 263, 100)
Dim label3 As System.Reflection.Emit.Label = checkFieldIL.DefineLabel()
checkFieldIL.MarkSequencePoint(doc5, 265, 1, 265, 100)
Dim locbldr236 As LocalBuilder = checkFieldIL.DeclareLocal(GetType(System.Int32))
locbldr236.SetLocalSymInfo("i")
checkFieldIL.Emit(OpCodes.Ldc_I4, CInt(0))
Typ = GetType(System.Int32)
checkFieldIL.Emit(OpCodes.Stloc, 6)
checkFieldIL.MarkSequencePoint(doc5, 266, 1, 266, 100)
Dim locbldr237 As LocalBuilder = checkFieldIL.DeclareLocal(GetType(System.Int32))
...
checkFieldIL.MarkSequencePoint(doc5, 267, 1, 267, 100)
Dim locbldr238 As LocalBuilder = checkFieldIL.DeclareLocal(GetType(System.Boolean))
locbldr238.SetLocalSymInfo("bl")
checkFieldIL.Emit(OpCodes.Ldc_I4, 0)
Typ = GetType(System.Boolean)
checkFieldIL.Emit(OpCodes.Stloc, 8)
checkFieldIL.MarkSequencePoint(doc5, 269, 1, 269, 100)
checkFieldIL.MarkLabel(label2)
checkFieldIL.MarkSequencePoint(doc5, 271, 1, 271, 100)
...
checkFieldIL.Emit(OpCodes.Stloc, 6)
checkFieldIL.MarkSequencePoint(doc5, 272, 1, 272, 100)
checkFieldIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
checkFieldIL.Emit(OpCodes.Ldfld, GetType(Stmt).GetField("Tokens"))
Typ = GetType(Stmt).GetField("Tokens").FieldType
...
Typ = Typ.GetElementType()
checkFieldIL.Emit(OpCodes.Stloc, 0)
checkFieldIL.MarkSequencePoint(doc5, 273, 1, 273, 100)
checkFieldIL.Emit(OpCodes.Ldtoken, GetType(Attributes.Attribute))
Dim typ55 As Type() = {GetType(System.RuntimeTypeHandle)}
checkFieldIL.Emit(OpCodes.Call, GetType(System.Type).GetMethod("GetTypeFromHandle", typ55))
Typ = GetType(System.Type).GetMethod("GetTypeFromHandle", typ55).ReturnType
checkFieldIL.Emit(OpCodes.Stloc, 1)
checkFieldIL.MarkSequencePoint(doc5, 274, 1, 274, 100)
Dim typ56(-1) As Type
checkFieldIL.Emit(OpCodes.Ldloc, 1)
Typ = GetType(System.Type)
Typ03 = Typ
...
ReDim Preserve typ56(UBound(typ56) + 1)
typ56(UBound(typ56)) = Typ
checkFieldIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("IsInstanceOfType", typ56))
Typ = Typ03.GetMethod("IsInstanceOfType", typ56).ReturnType
checkFieldIL.Emit(OpCodes.Stloc, 8)
checkFieldIL.MarkSequencePoint(doc5, 276, 1, 276, 100)
checkFieldIL.Emit(OpCodes.Ldloc, 8)
Typ = GetType(System.Boolean)
checkFieldIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa186 As System.Reflection.Emit.Label = checkFieldIL.DefineLabel()
Dim tru186 As System.Reflection.Emit.Label = checkFieldIL.DefineLabel()
Dim cont186 As System.Reflection.Emit.Label = checkFieldIL.DefineLabel()
checkFieldIL.Emit(OpCodes.Beq, tru186)
checkFieldIL.Emit(OpCodes.Br, fa186)
checkFieldIL.MarkLabel(tru186)
checkFieldIL.MarkSequencePoint(doc5, 277, 1, 277, 100)
checkFieldIL.Emit(OpCodes.Ldloc, 0)
Typ = GetType(Token)
checkFieldIL.Emit(OpCodes.Stloc, 3)
checkFieldIL.MarkSequencePoint(doc5, 278, 1, 278, 100)
Dim typ57(-1) As Type
checkFieldIL.Emit(OpCodes.Ldloc, 2)
Typ = GetType(FieldStmt)
Typ03 = Typ
...
ReDim Preserve typ57(UBound(typ57) + 1)
typ57(UBound(typ57)) = Typ
checkFieldIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("AddAttr", typ57))
Typ = Typ03.GetMethod("AddAttr", typ57).ReturnType
If Typ.ToString() = GetType(System.Void).ToString() Then

Else
checkFieldIL.Emit(OpCodes.Pop)
End If
checkFieldIL.MarkSequencePoint(doc5, 279, 1, 279, 100)
checkFieldIL.Emit(OpCodes.Br, cont186)
checkFieldIL.MarkLabel(fa186)
checkFieldIL.Emit(OpCodes.Br, cont186)
checkFieldIL.MarkLabel(cont186)
checkFieldIL.MarkSequencePoint(doc5, 281, 1, 281, 100)
checkFieldIL.Emit(OpCodes.Ldloc, 6)
Typ = GetType(System.Int32)
checkFieldIL.Emit(OpCodes.Ldloc, 7)
Typ = GetType(System.Int32)
Dim fa187 As System.Reflection.Emit.Label = checkFieldIL.DefineLabel()
Dim tru187 As System.Reflection.Emit.Label = checkFieldIL.DefineLabel()
Dim cont187 As System.Reflection.Emit.Label = checkFieldIL.DefineLabel()
checkFieldIL.Emit(OpCodes.Beq, tru187)
checkFieldIL.Emit(OpCodes.Br, fa187)
checkFieldIL.MarkLabel(tru187)
checkFieldIL.MarkSequencePoint(doc5, 282, 1, 282, 100)
checkFieldIL.Emit(OpCodes.Br, label3)
checkFieldIL.MarkSequencePoint(doc5, 283, 1, 283, 100)
checkFieldIL.Emit(OpCodes.Br, cont187)
checkFieldIL.MarkLabel(fa187)
checkFieldIL.MarkSequencePoint(doc5, 284, 1, 284, 100)
checkFieldIL.Emit(OpCodes.Br, label2)
checkFieldIL.MarkSequencePoint(doc5, 285, 1, 285, 100)
checkFieldIL.Emit(OpCodes.Br, cont187)
checkFieldIL.MarkLabel(cont187)
checkFieldIL.MarkSequencePoint(doc5, 287, 1, 287, 100)
checkFieldIL.MarkLabel(label3)
checkFieldIL.MarkSequencePoint(doc5, 289, 1, 289, 100)
checkFieldIL.Emit(OpCodes.Ldloc, 6)
Typ = GetType(System.Int32)
checkFieldIL.Emit(OpCodes.Ldc_I4, CInt(1))
Typ = GetType(System.Int32)
checkFieldIL.Emit(OpCodes.Add)
checkFieldIL.Emit(OpCodes.Stloc, 6)
checkFieldIL.MarkSequencePoint(doc5, 290, 1, 290, 100)
Dim locbldr239 As LocalBuilder = checkFieldIL.DeclareLocal(GetType(Token))
locbldr239.SetLocalSymInfo("tok2")
checkFieldIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
checkFieldIL.Emit(OpCodes.Ldfld, GetType(Stmt).GetField("Tokens"))
Typ = GetType(Stmt).GetField("Tokens").FieldType
...
checkFieldIL.MarkSequencePoint(doc5, 291, 1, 291, 100)
Dim locbldr240 As LocalBuilder = checkFieldIL.DeclareLocal(GetType(System.Type))
locbldr240.SetLocalSymInfo("typ2")
checkFieldIL.Emit(OpCodes.Ldtoken, GetType(TypeTok))
Dim typ58 As Type() = {GetType(System.RuntimeTypeHandle)}
checkFieldIL.Emit(OpCodes.Call, GetType(System.Type).GetMethod("GetTypeFromHandle", typ58))
Typ = GetType(System.Type).GetMethod("GetTypeFromHandle", typ58).ReturnType
checkFieldIL.Emit(OpCodes.Stloc, 10)
checkFieldIL.MarkSequencePoint(doc5, 292, 1, 292, 100)
Dim locbldr241 As LocalBuilder = checkFieldIL.DeclareLocal(GetType(System.Boolean))
locbldr241.SetLocalSymInfo("b2")
Dim typ59(-1) As Type
...
ReDim Preserve typ59(UBound(typ59) + 1)
typ59(UBound(typ59)) = Typ
checkFieldIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("IsInstanceOfType", typ59))
Typ = Typ03.GetMethod("IsInstanceOfType", typ59).ReturnType
checkFieldIL.Emit(OpCodes.Stloc, 11)
checkFieldIL.MarkSequencePoint(doc5, 294, 1, 294, 100)
checkFieldIL.Emit(OpCodes.Ldloc, 11)
Typ = GetType(System.Boolean)
checkFieldIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa188 As System.Reflection.Emit.Label = checkFieldIL.DefineLabel()
Dim tru188 As System.Reflection.Emit.Label = checkFieldIL.DefineLabel()
Dim cont188 As System.Reflection.Emit.Label = checkFieldIL.DefineLabel()
checkFieldIL.Emit(OpCodes.Beq, fa188)
checkFieldIL.Emit(OpCodes.Br, tru188)
checkFieldIL.MarkLabel(tru188)
checkFieldIL.MarkSequencePoint(doc5, 295, 1, 295, 100)
Dim locbldr242 As LocalBuilder = checkFieldIL.DeclareLocal(GetType(Token))
locbldr242.SetLocalSymInfo("t")
checkFieldIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
checkFieldIL.Emit(OpCodes.Ldfld, GetType(Stmt).GetField("Tokens"))
Typ = GetType(Stmt).GetField("Tokens").FieldType
...
checkFieldIL.MarkSequencePoint(doc5, 296, 1, 296, 100)
Dim locbldr243 As LocalBuilder = checkFieldIL.DeclareLocal(GetType(TypeTok))
locbldr243.SetLocalSymInfo("tt")
checkFieldIL.Emit(OpCodes.Newobj, GetType(TypeTok).GetConstructor(Type.EmptyTypes))
checkFieldIL.Emit(OpCodes.Stloc, 13)
checkFieldIL.MarkSequencePoint(doc5, 297, 1, 297, 100)
...
checkFieldIL.MarkSequencePoint(doc5, 298, 1, 298, 100)
checkFieldIL.Emit(OpCodes.Ldloc, 13)
Typ = GetType(TypeTok)
checkFieldIL.Emit(OpCodes.Ldloc, 12)
Typ = GetType(Token)
...
checkFieldIL.MarkSequencePoint(doc5, 299, 1, 299, 100)
checkFieldIL.Emit(OpCodes.Ldloc, 2)
Typ = GetType(FieldStmt)
checkFieldIL.Emit(OpCodes.Ldloc, 13)
Typ = GetType(TypeTok)
checkFieldIL.Emit(OpCodes.Stfld, GetType(FieldStmt).GetField("FieldTyp"))
checkFieldIL.MarkSequencePoint(doc5, 300, 1, 300, 100)
checkFieldIL.Emit(OpCodes.Br, cont188)
checkFieldIL.MarkLabel(fa188)
checkFieldIL.MarkSequencePoint(doc5, 301, 1, 301, 100)
checkFieldIL.Emit(OpCodes.Ldloc, 2)
Typ = GetType(FieldStmt)
checkFieldIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
...
Typ = Typ.GetElementType()
checkFieldIL.Emit(OpCodes.Stfld, GetType(FieldStmt).GetField("FieldTyp"))
checkFieldIL.MarkSequencePoint(doc5, 302, 1, 302, 100)
checkFieldIL.Emit(OpCodes.Br, cont188)
checkFieldIL.MarkLabel(cont188)
checkFieldIL.MarkSequencePoint(doc5, 304, 1, 304, 100)
checkFieldIL.Emit(OpCodes.Ldloc, 6)
Typ = GetType(System.Int32)
checkFieldIL.Emit(OpCodes.Ldc_I4, CInt(1))
Typ = GetType(System.Int32)
checkFieldIL.Emit(OpCodes.Add)
checkFieldIL.Emit(OpCodes.Stloc, 6)
checkFieldIL.MarkSequencePoint(doc5, 305, 1, 305, 100)
checkFieldIL.Emit(OpCodes.Ldloc, 2)
Typ = GetType(FieldStmt)
checkFieldIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
...
checkFieldIL.MarkSequencePoint(doc5, 307, 1, 307, 100)
checkFieldIL.Emit(OpCodes.Br, cont185)
checkFieldIL.MarkLabel(fa185)
checkFieldIL.Emit(OpCodes.Br, cont185)
checkFieldIL.MarkLabel(cont185)
checkFieldIL.MarkSequencePoint(doc5, 309, 1, 309, 100)
checkFieldIL.Emit(OpCodes.Ldloc, 2)
Typ = GetType(FieldStmt)
checkFieldIL.MarkSequencePoint(doc5, 310, 1, 310, 100)
...
Dim checkMethod As MethodBuilder = StmtOptimizer.DefineMethod("checkMethod", MethodAttributes.Public, GetType(Stmt), typ60)
...
Dim locbldr244 As LocalBuilder = checkMethodIL.DeclareLocal(GetType(Token))
locbldr244.SetLocalSymInfo("tok")
...
Dim locbldr245 As LocalBuilder = checkMethodIL.DeclareLocal(GetType(System.Type))
...
Dim locbldr246 As LocalBuilder = checkMethodIL.DeclareLocal(GetType(MethodStmt))
locbldr246.SetLocalSymInfo("mtss")
...
Dim locbldr247 As LocalBuilder = checkMethodIL.DeclareLocal(GetType(Attributes.Attribute))
locbldr247.SetLocalSymInfo("att")
...
checkMethodIL.MarkSequencePoint(doc5, 319, 1, 319, 100)
Dim locbldr248 As LocalBuilder = checkMethodIL.DeclareLocal(GetType(Ident))
locbldr248.SetLocalSymInfo("mn")
...
Dim locbldr249 As LocalBuilder = checkMethodIL.DeclareLocal(GetType(Expr))
locbldr249.SetLocalSymInfo("exp")
checkMethodIL.Emit(OpCodes.Ldnull)
checkMethodIL.Emit(OpCodes.Stloc, 5)
checkMethodIL.MarkSequencePoint(doc5, 321, 1, 321, 100)
Dim locbldr250 As LocalBuilder = checkMethodIL.DeclareLocal(GetType(System.Boolean))
locbldr250.SetLocalSymInfo("d")
...
Typ = GetType(System.Boolean)
Dim fa189 As System.Reflection.Emit.Label = checkMethodIL.DefineLabel()
Dim tru189 As System.Reflection.Emit.Label = checkMethodIL.DefineLabel()
Dim cont189 As System.Reflection.Emit.Label = checkMethodIL.DefineLabel()
checkMethodIL.Emit(OpCodes.Beq, tru189)
checkMethodIL.Emit(OpCodes.Br, fa189)
checkMethodIL.MarkLabel(tru189)
checkMethodIL.MarkSequencePoint(doc5, 325, 1, 325, 100)
Dim locbldr251 As LocalBuilder = checkMethodIL.DeclareLocal(GetType(Expr))
locbldr251.SetLocalSymInfo("tempexp")
...
Dim locbldr252 As LocalBuilder = checkMethodIL.DeclareLocal(asm.GetType("dylan.NET.Tokenizer.Parser.ExprOptimizer"))
locbldr252.SetLocalSymInfo("eop")
...
ReDim Preserve typ63(UBound(typ63) + 1)
typ63(UBound(typ63)) = Typ
checkMethodIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("Optimize", typ63))
Typ = Typ03.GetMethod("Optimize", typ63).ReturnType
checkMethodIL.Emit(OpCodes.Stloc, 7)
...
Dim locbldr253 As LocalBuilder = checkMethodIL.DeclareLocal(GetType(System.Int32))
locbldr253.SetLocalSymInfo("i")
checkMethodIL.Emit(OpCodes.Ldc_I4, CInt(0))
Typ = GetType(System.Int32)
checkMethodIL.Emit(OpCodes.Stloc, 9)
checkMethodIL.MarkSequencePoint(doc5, 341, 1, 341, 100)
Dim locbldr254 As LocalBuilder = checkMethodIL.DeclareLocal(GetType(System.Int32))
...
Dim locbldr255 As LocalBuilder = checkMethodIL.DeclareLocal(GetType(System.Boolean))
locbldr255.SetLocalSymInfo("bl")
checkMethodIL.Emit(OpCodes.Ldc_I4, 0)
Typ = GetType(System.Boolean)
checkMethodIL.Emit(OpCodes.Stloc, 11)
checkMethodIL.MarkSequencePoint(doc5, 345, 1, 345, 100)
checkMethodIL.MarkLabel(label4)
checkMethodIL.MarkSequencePoint(doc5, 347, 1, 347, 100)
...
checkMethodIL.Emit(OpCodes.Call, GetType(System.Type).GetMethod("GetTypeFromHandle", typ64))
...
checkMethodIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("IsInstanceOfType", typ65))
...
checkMethodIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa190 As System.Reflection.Emit.Label = checkMethodIL.DefineLabel()
Dim tru190 As System.Reflection.Emit.Label = checkMethodIL.DefineLabel()
Dim cont190 As System.Reflection.Emit.Label = checkMethodIL.DefineLabel()
checkMethodIL.Emit(OpCodes.Beq, tru190)
checkMethodIL.Emit(OpCodes.Br, fa190)
checkMethodIL.MarkLabel(tru190)
...
ReDim Preserve typ66(UBound(typ66) + 1)
typ66(UBound(typ66)) = Typ
checkMethodIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("AddAttr", typ66))
Typ = Typ03.GetMethod("AddAttr", typ66).ReturnType
If Typ.ToString() = GetType(System.Void).ToString() Then
...
checkMethodIL.Emit(OpCodes.Br, cont190)
checkMethodIL.MarkLabel(fa190)
...
checkMethodIL.Emit(OpCodes.Br, cont190)
checkMethodIL.MarkLabel(cont190)
checkMethodIL.MarkSequencePoint(doc5, 360, 1, 360, 100)
checkMethodIL.Emit(OpCodes.Ldloc, 9)
Typ = GetType(System.Int32)
checkMethodIL.Emit(OpCodes.Ldloc, 10)
Typ = GetType(System.Int32)
Dim fa191 As System.Reflection.Emit.Label = checkMethodIL.DefineLabel()
Dim tru191 As System.Reflection.Emit.Label = checkMethodIL.DefineLabel()
Dim cont191 As System.Reflection.Emit.Label = checkMethodIL.DefineLabel()
checkMethodIL.Emit(OpCodes.Beq, tru191)
checkMethodIL.Emit(OpCodes.Br, fa191)
checkMethodIL.MarkLabel(tru191)
...
checkMethodIL.Emit(OpCodes.Br, cont191)
checkMethodIL.MarkLabel(fa191)
checkMethodIL.MarkSequencePoint(doc5, 363, 1, 363, 100)
checkMethodIL.Emit(OpCodes.Br, label4)
checkMethodIL.MarkSequencePoint(doc5, 364, 1, 364, 100)
checkMethodIL.Emit(OpCodes.Br, cont191)
checkMethodIL.MarkLabel(cont191)
...
Dim locbldr256 As LocalBuilder = checkMethodIL.DeclareLocal(GetType(Token))
locbldr256.SetLocalSymInfo("tok2")
checkMethodIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
checkMethodIL.Emit(OpCodes.Ldfld, GetType(Stmt).GetField("Tokens"))
Typ = GetType(Stmt).GetField("Tokens").FieldType
...
checkMethodIL.MarkSequencePoint(doc5, 374, 1, 374, 100)
Dim locbldr257 As LocalBuilder = checkMethodIL.DeclareLocal(GetType(System.Type))
locbldr257.SetLocalSymInfo("typ2")
checkMethodIL.MarkSequencePoint(doc5, 375, 1, 375, 100)
Dim locbldr258 As LocalBuilder = checkMethodIL.DeclareLocal(GetType(System.Boolean))
...
checkMethodIL.MarkSequencePoint(doc5, 378, 1, 378, 100)
Dim typ68(-1) As Type
...
checkMethodIL.MarkSequencePoint(doc5, 380, 1, 380, 100)
checkMethodIL.Emit(OpCodes.Ldloc, 14)
Typ = GetType(System.Boolean)
checkMethodIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa192 As System.Reflection.Emit.Label = checkMethodIL.DefineLabel()
Dim tru192 As System.Reflection.Emit.Label = checkMethodIL.DefineLabel()
Dim cont192 As System.Reflection.Emit.Label = checkMethodIL.DefineLabel()
checkMethodIL.Emit(OpCodes.Beq, fa192)
checkMethodIL.Emit(OpCodes.Br, tru192)
checkMethodIL.MarkLabel(tru192)
checkMethodIL.MarkSequencePoint(doc5, 381, 1, 381, 100)
Dim locbldr259 As LocalBuilder = checkMethodIL.DeclareLocal(GetType(Token))
locbldr259.SetLocalSymInfo("t")
checkMethodIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
checkMethodIL.Emit(OpCodes.Ldfld, GetType(Stmt).GetField("Tokens"))
Typ = GetType(Stmt).GetField("Tokens").FieldType
...
checkMethodIL.MarkSequencePoint(doc5, 382, 1, 382, 100)
Dim locbldr260 As LocalBuilder = checkMethodIL.DeclareLocal(GetType(TypeTok))
locbldr260.SetLocalSymInfo("tt")
checkMethodIL.Emit(OpCodes.Newobj, GetType(TypeTok).GetConstructor(Type.EmptyTypes))
checkMethodIL.Emit(OpCodes.Stloc, 16)
checkMethodIL.MarkSequencePoint(doc5, 383, 1, 383, 100)
...
checkMethodIL.MarkSequencePoint(doc5, 384, 1, 384, 100)
checkMethodIL.Emit(OpCodes.Ldloc, 16)
Typ = GetType(TypeTok)
checkMethodIL.Emit(OpCodes.Ldloc, 15)
Typ = GetType(Token)
...
checkMethodIL.MarkSequencePoint(doc5, 385, 1, 385, 100)
checkMethodIL.Emit(OpCodes.Ldloc, 2)
Typ = GetType(MethodStmt)
checkMethodIL.Emit(OpCodes.Ldloc, 16)
Typ = GetType(TypeTok)
checkMethodIL.Emit(OpCodes.Stfld, GetType(MethodStmt).GetField("RetTyp"))
checkMethodIL.MarkSequencePoint(doc5, 386, 1, 386, 100)
checkMethodIL.Emit(OpCodes.Br, cont192)
checkMethodIL.MarkLabel(fa192)
checkMethodIL.MarkSequencePoint(doc5, 387, 1, 387, 100)
checkMethodIL.Emit(OpCodes.Ldloc, 2)
Typ = GetType(MethodStmt)
checkMethodIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
...
Typ = Typ.GetElementType()
checkMethodIL.Emit(OpCodes.Stfld, GetType(MethodStmt).GetField("RetTyp"))
checkMethodIL.MarkSequencePoint(doc5, 388, 1, 388, 100)
checkMethodIL.Emit(OpCodes.Br, cont192)
checkMethodIL.MarkLabel(cont192)
checkMethodIL.MarkSequencePoint(doc5, 390, 1, 390, 100)
checkMethodIL.Emit(OpCodes.Ldloc, 9)
Typ = GetType(System.Int32)
checkMethodIL.Emit(OpCodes.Ldc_I4, CInt(1))
Typ = GetType(System.Int32)
checkMethodIL.Emit(OpCodes.Add)
checkMethodIL.Emit(OpCodes.Stloc, 9)
checkMethodIL.MarkSequencePoint(doc5, 392, 1, 392, 100)
checkMethodIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
checkMethodIL.Emit(OpCodes.Ldfld, GetType(Stmt).GetField("Tokens"))
Typ = GetType(Stmt).GetField("Tokens").FieldType
...
Typ = Typ.GetElementType()
checkMethodIL.Emit(OpCodes.Stloc, 12)
checkMethodIL.MarkSequencePoint(doc5, 393, 1, 393, 100)
...
Typ = GetType(System.Type).GetMethod("GetTypeFromHandle", typ69).ReturnType
checkMethodIL.Emit(OpCodes.Stloc, 13)
checkMethodIL.MarkSequencePoint(doc5, 394, 1, 394, 100)
Dim typ70(-1) As Type
checkMethodIL.Emit(OpCodes.Ldloc, 13)
Typ = GetType(System.Type)
Typ03 = Typ
...
checkMethodIL.Emit(OpCodes.Stloc, 14)
checkMethodIL.MarkSequencePoint(doc5, 395, 1, 395, 100)
checkMethodIL.Emit(OpCodes.Ldloc, 14)
Typ = GetType(System.Boolean)
checkMethodIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa193 As System.Reflection.Emit.Label = checkMethodIL.DefineLabel()
Dim tru193 As System.Reflection.Emit.Label = checkMethodIL.DefineLabel()
Dim cont193 As System.Reflection.Emit.Label = checkMethodIL.DefineLabel()
checkMethodIL.Emit(OpCodes.Beq, tru193)
checkMethodIL.Emit(OpCodes.Br, fa193)
checkMethodIL.MarkLabel(tru193)
checkMethodIL.MarkSequencePoint(doc5, 396, 1, 396, 100)
checkMethodIL.Emit(OpCodes.Ldloc, 2)
Typ = GetType(MethodStmt)
checkMethodIL.Emit(OpCodes.Ldloc, 12)
Typ = GetType(Token)
checkMethodIL.Emit(OpCodes.Stfld, GetType(MethodStmt).GetField("MethodName"))
checkMethodIL.MarkSequencePoint(doc5, 397, 1, 397, 100)
checkMethodIL.Emit(OpCodes.Br, cont193)
checkMethodIL.MarkLabel(fa193)
checkMethodIL.Emit(OpCodes.Br, cont193)
checkMethodIL.MarkLabel(cont193)
checkMethodIL.MarkSequencePoint(doc5, 399, 1, 399, 100)
Dim label7 As System.Reflection.Emit.Label = checkMethodIL.DefineLabel()
checkMethodIL.MarkSequencePoint(doc5, 400, 1, 400, 100)
Dim label8 As System.Reflection.Emit.Label = checkMethodIL.DefineLabel()
checkMethodIL.MarkSequencePoint(doc5, 402, 1, 402, 100)
checkMethodIL.Emit(OpCodes.Ldloc, 9)
Typ = GetType(System.Int32)
checkMethodIL.Emit(OpCodes.Ldc_I4, CInt(1))
Typ = GetType(System.Int32)
checkMethodIL.Emit(OpCodes.Add)
checkMethodIL.Emit(OpCodes.Stloc, 9)
checkMethodIL.MarkSequencePoint(doc5, 403, 1, 403, 100)
checkMethodIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
checkMethodIL.Emit(OpCodes.Ldfld, GetType(Stmt).GetField("Tokens"))
Typ = GetType(Stmt).GetField("Tokens").FieldType
...
Typ = Typ.GetElementType()
checkMethodIL.Emit(OpCodes.Stloc, 12)
checkMethodIL.MarkSequencePoint(doc5, 404, 1, 404, 100)
checkMethodIL.Emit(OpCodes.Ldtoken, GetType(LParen))
Dim typ71 As Type() = {GetType(System.RuntimeTypeHandle)}
checkMethodIL.Emit(OpCodes.Call, GetType(System.Type).GetMethod("GetTypeFromHandle", typ71))
Typ = GetType(System.Type).GetMethod("GetTypeFromHandle", typ71).ReturnType
checkMethodIL.Emit(OpCodes.Stloc, 13)
checkMethodIL.MarkSequencePoint(doc5, 405, 1, 405, 100)
Dim typ72(-1) As Type
checkMethodIL.Emit(OpCodes.Ldloc, 13)
Typ = GetType(System.Type)
Typ03 = Typ
...
ReDim Preserve typ72(UBound(typ72) + 1)
typ72(UBound(typ72)) = Typ
checkMethodIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("IsInstanceOfType", typ72))
Typ = Typ03.GetMethod("IsInstanceOfType", typ72).ReturnType
checkMethodIL.Emit(OpCodes.Stloc, 14)
checkMethodIL.MarkSequencePoint(doc5, 406, 1, 406, 100)
checkMethodIL.Emit(OpCodes.Ldloc, 14)
Typ = GetType(System.Boolean)
checkMethodIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa194 As System.Reflection.Emit.Label = checkMethodIL.DefineLabel()
Dim tru194 As System.Reflection.Emit.Label = checkMethodIL.DefineLabel()
Dim cont194 As System.Reflection.Emit.Label = checkMethodIL.DefineLabel()
checkMethodIL.Emit(OpCodes.Beq, tru194)
checkMethodIL.Emit(OpCodes.Br, fa194)
checkMethodIL.MarkLabel(tru194)
checkMethodIL.MarkSequencePoint(doc5, 408, 1, 408, 100)
checkMethodIL.MarkLabel(label7)
checkMethodIL.MarkSequencePoint(doc5, 411, 1, 411, 100)
checkMethodIL.Emit(OpCodes.Ldloc, 9)
Typ = GetType(System.Int32)
checkMethodIL.Emit(OpCodes.Ldc_I4, CInt(1))
Typ = GetType(System.Int32)
checkMethodIL.Emit(OpCodes.Add)
checkMethodIL.Emit(OpCodes.Stloc, 9)
checkMethodIL.MarkSequencePoint(doc5, 413, 1, 413, 100)
checkMethodIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
checkMethodIL.Emit(OpCodes.Ldfld, GetType(Stmt).GetField("Tokens"))
Typ = GetType(Stmt).GetField("Tokens").FieldType
...
Typ = Typ.GetElementType()
checkMethodIL.Emit(OpCodes.Stloc, 12)
checkMethodIL.MarkSequencePoint(doc5, 414, 1, 414, 100)
checkMethodIL.Emit(OpCodes.Ldtoken, GetType(RParen))
Dim typ73 As Type() = {GetType(System.RuntimeTypeHandle)}
checkMethodIL.Emit(OpCodes.Call, GetType(System.Type).GetMethod("GetTypeFromHandle", typ73))
Typ = GetType(System.Type).GetMethod("GetTypeFromHandle", typ73).ReturnType
checkMethodIL.Emit(OpCodes.Stloc, 13)
checkMethodIL.MarkSequencePoint(doc5, 415, 1, 415, 100)
Dim typ74(-1) As Type
checkMethodIL.Emit(OpCodes.Ldloc, 13)
Typ = GetType(System.Type)
Typ03 = Typ
...
ReDim Preserve typ74(UBound(typ74) + 1)
typ74(UBound(typ74)) = Typ
checkMethodIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("IsInstanceOfType", typ74))
Typ = Typ03.GetMethod("IsInstanceOfType", typ74).ReturnType
checkMethodIL.Emit(OpCodes.Stloc, 14)
checkMethodIL.MarkSequencePoint(doc5, 416, 1, 416, 100)
checkMethodIL.Emit(OpCodes.Ldloc, 14)
Typ = GetType(System.Boolean)
checkMethodIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa195 As System.Reflection.Emit.Label = checkMethodIL.DefineLabel()
Dim tru195 As System.Reflection.Emit.Label = checkMethodIL.DefineLabel()
Dim cont195 As System.Reflection.Emit.Label = checkMethodIL.DefineLabel()
checkMethodIL.Emit(OpCodes.Beq, tru195)
checkMethodIL.Emit(OpCodes.Br, fa195)
checkMethodIL.MarkLabel(tru195)
checkMethodIL.MarkSequencePoint(doc5, 417, 1, 417, 100)
checkMethodIL.Emit(OpCodes.Ldloc, 6)
Typ = GetType(System.Boolean)
checkMethodIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa196 As System.Reflection.Emit.Label = checkMethodIL.DefineLabel()
Dim tru196 As System.Reflection.Emit.Label = checkMethodIL.DefineLabel()
Dim cont196 As System.Reflection.Emit.Label = checkMethodIL.DefineLabel()
checkMethodIL.Emit(OpCodes.Beq, tru196)
checkMethodIL.Emit(OpCodes.Br, fa196)
checkMethodIL.MarkLabel(tru196)
checkMethodIL.MarkSequencePoint(doc5, 418, 1, 418, 100)
Dim locbldr261 As LocalBuilder = checkMethodIL.DeclareLocal(asm.GetType("dylan.NET.Tokenizer.Parser.ExprOptimizer"))
locbldr261.SetLocalSymInfo("eopt2")
checkMethodIL.Emit(OpCodes.Newobj, asm.GetType("dylan.NET.Tokenizer.Parser.ExprOptimizer").GetConstructor(Type.EmptyTypes))
checkMethodIL.Emit(OpCodes.Stloc, 17)
checkMethodIL.MarkSequencePoint(doc5, 419, 1, 419, 100)
Dim typ75(-1) As Type
...
ReDim Preserve typ75(UBound(typ75) + 1)
typ75(UBound(typ75)) = Typ
checkMethodIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("checkVarAs", typ75))
Typ = Typ03.GetMethod("checkVarAs", typ75).ReturnType
checkMethodIL.Emit(OpCodes.Stloc, 5)
checkMethodIL.MarkSequencePoint(doc5, 420, 1, 420, 100)
checkMethodIL.Emit(OpCodes.Ldloc, 11)
Typ = GetType(System.Boolean)
checkMethodIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa197 As System.Reflection.Emit.Label = checkMethodIL.DefineLabel()
Dim tru197 As System.Reflection.Emit.Label = checkMethodIL.DefineLabel()
Dim cont197 As System.Reflection.Emit.Label = checkMethodIL.DefineLabel()
checkMethodIL.Emit(OpCodes.Beq, tru197)
checkMethodIL.Emit(OpCodes.Br, fa197)
checkMethodIL.MarkLabel(tru197)
checkMethodIL.MarkSequencePoint(doc5, 421, 1, 421, 100)
Dim typ76(-1) As Type
checkMethodIL.Emit(OpCodes.Ldloc, 2)
Typ = GetType(MethodStmt)
Typ03 = Typ
...
ReDim Preserve typ76(UBound(typ76) + 1)
typ76(UBound(typ76)) = Typ
checkMethodIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("AddParam", typ76))
Typ = Typ03.GetMethod("AddParam", typ76).ReturnType
If Typ.ToString() = GetType(System.Void).ToString() Then

Else
checkMethodIL.Emit(OpCodes.Pop)
End If
checkMethodIL.MarkSequencePoint(doc5, 422, 1, 422, 100)
checkMethodIL.Emit(OpCodes.Br, cont197)
checkMethodIL.MarkLabel(fa197)
checkMethodIL.Emit(OpCodes.Br, cont197)
checkMethodIL.MarkLabel(cont197)
checkMethodIL.MarkSequencePoint(doc5, 423, 1, 423, 100)
checkMethodIL.Emit(OpCodes.Br, cont196)
checkMethodIL.MarkLabel(fa196)
checkMethodIL.Emit(OpCodes.Br, cont196)
checkMethodIL.MarkLabel(cont196)
checkMethodIL.MarkSequencePoint(doc5, 424, 1, 424, 100)
checkMethodIL.Emit(OpCodes.Ldc_I4, 0)
Typ = GetType(System.Boolean)
checkMethodIL.Emit(OpCodes.Stloc, 6)
checkMethodIL.MarkSequencePoint(doc5, 425, 1, 425, 100)
checkMethodIL.Emit(OpCodes.Br, label8)
checkMethodIL.MarkSequencePoint(doc5, 426, 1, 426, 100)
checkMethodIL.Emit(OpCodes.Br, cont195)
checkMethodIL.MarkLabel(fa195)
checkMethodIL.Emit(OpCodes.Br, cont195)
checkMethodIL.MarkLabel(cont195)
checkMethodIL.MarkSequencePoint(doc5, 428, 1, 428, 100)
checkMethodIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
checkMethodIL.Emit(OpCodes.Ldfld, GetType(Stmt).GetField("Tokens"))
Typ = GetType(Stmt).GetField("Tokens").FieldType
...
Typ = Typ.GetElementType()
checkMethodIL.Emit(OpCodes.Stloc, 12)
checkMethodIL.MarkSequencePoint(doc5, 429, 1, 429, 100)
checkMethodIL.Emit(OpCodes.Ldtoken, GetType(VarTok))
Dim typ77 As Type() = {GetType(System.RuntimeTypeHandle)}
checkMethodIL.Emit(OpCodes.Call, GetType(System.Type).GetMethod("GetTypeFromHandle", typ77))
Typ = GetType(System.Type).GetMethod("GetTypeFromHandle", typ77).ReturnType
checkMethodIL.Emit(OpCodes.Stloc, 13)
checkMethodIL.MarkSequencePoint(doc5, 430, 1, 430, 100)
Dim typ78(-1) As Type
checkMethodIL.Emit(OpCodes.Ldloc, 13)
Typ = GetType(System.Type)
Typ03 = Typ
...
ReDim Preserve typ78(UBound(typ78) + 1)
typ78(UBound(typ78)) = Typ
checkMethodIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("IsInstanceOfType", typ78))
Typ = Typ03.GetMethod("IsInstanceOfType", typ78).ReturnType
checkMethodIL.Emit(OpCodes.Stloc, 14)
checkMethodIL.MarkSequencePoint(doc5, 431, 1, 431, 100)
checkMethodIL.Emit(OpCodes.Ldloc, 14)
Typ = GetType(System.Boolean)
checkMethodIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa198 As System.Reflection.Emit.Label = checkMethodIL.DefineLabel()
Dim tru198 As System.Reflection.Emit.Label = checkMethodIL.DefineLabel()
Dim cont198 As System.Reflection.Emit.Label = checkMethodIL.DefineLabel()
checkMethodIL.Emit(OpCodes.Beq, tru198)
checkMethodIL.Emit(OpCodes.Br, fa198)
checkMethodIL.MarkLabel(tru198)
checkMethodIL.MarkSequencePoint(doc5, 432, 1, 432, 100)
checkMethodIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
checkMethodIL.Emit(OpCodes.Stloc, 6)
checkMethodIL.MarkSequencePoint(doc5, 433, 1, 433, 100)
checkMethodIL.Emit(OpCodes.Newobj, GetType(Expr).GetConstructor(Type.EmptyTypes))
checkMethodIL.Emit(OpCodes.Stloc, 5)
checkMethodIL.MarkSequencePoint(doc5, 434, 1, 434, 100)
checkMethodIL.Emit(OpCodes.Br, cont198)
checkMethodIL.MarkLabel(fa198)
checkMethodIL.Emit(OpCodes.Br, cont198)
checkMethodIL.MarkLabel(cont198)
checkMethodIL.MarkSequencePoint(doc5, 436, 1, 436, 100)
checkMethodIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
checkMethodIL.Emit(OpCodes.Ldfld, GetType(Stmt).GetField("Tokens"))
Typ = GetType(Stmt).GetField("Tokens").FieldType
...
Typ = Typ.GetElementType()
checkMethodIL.Emit(OpCodes.Stloc, 12)
checkMethodIL.MarkSequencePoint(doc5, 437, 1, 437, 100)
checkMethodIL.Emit(OpCodes.Ldtoken, GetType(Comma))
Dim typ79 As Type() = {GetType(System.RuntimeTypeHandle)}
checkMethodIL.Emit(OpCodes.Call, GetType(System.Type).GetMethod("GetTypeFromHandle", typ79))
Typ = GetType(System.Type).GetMethod("GetTypeFromHandle", typ79).ReturnType
checkMethodIL.Emit(OpCodes.Stloc, 13)
checkMethodIL.MarkSequencePoint(doc5, 438, 1, 438, 100)
Dim typ80(-1) As Type
checkMethodIL.Emit(OpCodes.Ldloc, 13)
Typ = GetType(System.Type)
Typ03 = Typ
...
ReDim Preserve typ80(UBound(typ80) + 1)
typ80(UBound(typ80)) = Typ
checkMethodIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("IsInstanceOfType", typ80))
Typ = Typ03.GetMethod("IsInstanceOfType", typ80).ReturnType
checkMethodIL.Emit(OpCodes.Stloc, 14)
checkMethodIL.MarkSequencePoint(doc5, 439, 1, 439, 100)
checkMethodIL.Emit(OpCodes.Ldloc, 14)
Typ = GetType(System.Boolean)
checkMethodIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa199 As System.Reflection.Emit.Label = checkMethodIL.DefineLabel()
Dim tru199 As System.Reflection.Emit.Label = checkMethodIL.DefineLabel()
Dim cont199 As System.Reflection.Emit.Label = checkMethodIL.DefineLabel()
checkMethodIL.Emit(OpCodes.Beq, tru199)
checkMethodIL.Emit(OpCodes.Br, fa199)
checkMethodIL.MarkLabel(tru199)
checkMethodIL.MarkSequencePoint(doc5, 440, 1, 440, 100)
Dim locbldr262 As LocalBuilder = checkMethodIL.DeclareLocal(asm.GetType("dylan.NET.Tokenizer.Parser.ExprOptimizer"))
locbldr262.SetLocalSymInfo("eopt1")
checkMethodIL.Emit(OpCodes.Newobj, asm.GetType("dylan.NET.Tokenizer.Parser.ExprOptimizer").GetConstructor(Type.EmptyTypes))
checkMethodIL.Emit(OpCodes.Stloc, 18)
checkMethodIL.MarkSequencePoint(doc5, 441, 1, 441, 100)
Dim typ81(-1) As Type
...
ReDim Preserve typ81(UBound(typ81) + 1)
typ81(UBound(typ81)) = Typ
checkMethodIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("checkVarAs", typ81))
Typ = Typ03.GetMethod("checkVarAs", typ81).ReturnType
checkMethodIL.Emit(OpCodes.Stloc, 5)
checkMethodIL.MarkSequencePoint(doc5, 442, 1, 442, 100)
checkMethodIL.Emit(OpCodes.Ldloc, 11)
Typ = GetType(System.Boolean)
checkMethodIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa200 As System.Reflection.Emit.Label = checkMethodIL.DefineLabel()
Dim tru200 As System.Reflection.Emit.Label = checkMethodIL.DefineLabel()
Dim cont200 As System.Reflection.Emit.Label = checkMethodIL.DefineLabel()
checkMethodIL.Emit(OpCodes.Beq, tru200)
checkMethodIL.Emit(OpCodes.Br, fa200)
checkMethodIL.MarkLabel(tru200)
checkMethodIL.MarkSequencePoint(doc5, 443, 1, 443, 100)
Dim typ82(-1) As Type
checkMethodIL.Emit(OpCodes.Ldloc, 2)
Typ = GetType(MethodStmt)
Typ03 = Typ
...
ReDim Preserve typ82(UBound(typ82) + 1)
typ82(UBound(typ82)) = Typ
checkMethodIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("AddParam", typ82))
...
checkMethodIL.Emit(OpCodes.Pop)
End If
checkMethodIL.MarkSequencePoint(doc5, 444, 1, 444, 100)
checkMethodIL.Emit(OpCodes.Br, cont200)
checkMethodIL.MarkLabel(fa200)
checkMethodIL.Emit(OpCodes.Br, cont200)
checkMethodIL.MarkLabel(cont200)
checkMethodIL.MarkSequencePoint(doc5, 445, 1, 445, 100)
checkMethodIL.Emit(OpCodes.Ldc_I4, 0)
Typ = GetType(System.Boolean)
checkMethodIL.Emit(OpCodes.Stloc, 6)
checkMethodIL.MarkSequencePoint(doc5, 446, 1, 446, 100)
checkMethodIL.Emit(OpCodes.Br, cont199)
checkMethodIL.MarkLabel(fa199)
checkMethodIL.Emit(OpCodes.Br, cont199)
checkMethodIL.MarkLabel(cont199)
checkMethodIL.MarkSequencePoint(doc5, 448, 1, 448, 100)
checkMethodIL.Emit(OpCodes.Ldloc, 6)
Typ = GetType(System.Boolean)
checkMethodIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa201 As System.Reflection.Emit.Label = checkMethodIL.DefineLabel()
Dim tru201 As System.Reflection.Emit.Label = checkMethodIL.DefineLabel()
Dim cont201 As System.Reflection.Emit.Label = checkMethodIL.DefineLabel()
checkMethodIL.Emit(OpCodes.Beq, tru201)
checkMethodIL.Emit(OpCodes.Br, fa201)
checkMethodIL.MarkLabel(tru201)
checkMethodIL.MarkSequencePoint(doc5, 449, 1, 449, 100)
Dim typ83(-1) As Type
checkMethodIL.Emit(OpCodes.Ldloc, 5)
Typ = GetType(Expr)
Typ03 = Typ
...
ReDim Preserve typ83(UBound(typ83) + 1)
typ83(UBound(typ83)) = Typ
checkMethodIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("AddToken", typ83))
Typ = Typ03.GetMethod("AddToken", typ83).ReturnType
If Typ.ToString() = GetType(System.Void).ToString() Then

Else
checkMethodIL.Emit(OpCodes.Pop)
End If
checkMethodIL.MarkSequencePoint(doc5, 450, 1, 450, 100)
checkMethodIL.Emit(OpCodes.Br, cont201)
checkMethodIL.MarkLabel(fa201)
checkMethodIL.Emit(OpCodes.Br, cont201)
checkMethodIL.MarkLabel(cont201)
checkMethodIL.MarkSequencePoint(doc5, 453, 1, 453, 100)
checkMethodIL.Emit(OpCodes.Ldloc, 9)
Typ = GetType(System.Int32)
checkMethodIL.Emit(OpCodes.Ldloc, 10)
Typ = GetType(System.Int32)
Dim fa202 As System.Reflection.Emit.Label = checkMethodIL.DefineLabel()
Dim tru202 As System.Reflection.Emit.Label = checkMethodIL.DefineLabel()
Dim cont202 As System.Reflection.Emit.Label = checkMethodIL.DefineLabel()
checkMethodIL.Emit(OpCodes.Beq, tru202)
checkMethodIL.Emit(OpCodes.Br, fa202)
checkMethodIL.MarkLabel(tru202)
checkMethodIL.MarkSequencePoint(doc5, 454, 1, 454, 100)
checkMethodIL.Emit(OpCodes.Br, label8)
checkMethodIL.MarkSequencePoint(doc5, 455, 1, 455, 100)
checkMethodIL.Emit(OpCodes.Br, cont202)
checkMethodIL.MarkLabel(fa202)
checkMethodIL.MarkSequencePoint(doc5, 456, 1, 456, 100)
checkMethodIL.Emit(OpCodes.Br, label7)
checkMethodIL.MarkSequencePoint(doc5, 457, 1, 457, 100)
checkMethodIL.Emit(OpCodes.Br, cont202)
checkMethodIL.MarkLabel(cont202)
...
checkMethodIL.Emit(OpCodes.Br, cont194)
checkMethodIL.MarkLabel(fa194)
checkMethodIL.Emit(OpCodes.Br, cont194)
checkMethodIL.MarkLabel(cont194)
checkMethodIL.MarkSequencePoint(doc5, 463, 1, 463, 100)
checkMethodIL.Emit(OpCodes.Br, cont189)
checkMethodIL.MarkLabel(fa189)
checkMethodIL.Emit(OpCodes.Br, cont189)
checkMethodIL.MarkLabel(cont189)
checkMethodIL.MarkSequencePoint(doc5, 464, 1, 464, 100)
checkMethodIL.Emit(OpCodes.Ldloc, 2)
Typ = GetType(MethodStmt)
checkMethodIL.MarkSequencePoint(doc5, 465, 1, 465, 100)
checkMethodIL.Emit(OpCodes.Ret)
Dim typ84(-1) As Type
ReDim Preserve typ84(UBound(typ84) + 1)
typ84(UBound(typ84)) = GetType(Stmt)
ReDim Preserve typ84(UBound(typ84) + 1)
typ84(UBound(typ84)) = GetType(System.Boolean).MakeByRefType()
Dim checkMethodCall As MethodBuilder = StmtOptimizer.DefineMethod("checkMethodCall", MethodAttributes.Public, GetType(Stmt), typ84)
...
Typ = GetType(System.Int32)
Dim fa203 As System.Reflection.Emit.Label = checkMethodCallIL.DefineLabel()
Dim tru203 As System.Reflection.Emit.Label = checkMethodCallIL.DefineLabel()
Dim cont203 As System.Reflection.Emit.Label = checkMethodCallIL.DefineLabel()
checkMethodCallIL.Emit(OpCodes.Bgt, tru203)
checkMethodCallIL.Emit(OpCodes.Br, fa203)
checkMethodCallIL.MarkLabel(tru203)
checkMethodCallIL.MarkSequencePoint(doc5, 470, 1, 470, 100)
Dim locbldr263 As LocalBuilder = checkMethodCallIL.DeclareLocal(GetType(Token))
...
Dim locbldr264 As LocalBuilder = checkMethodCallIL.DeclareLocal(GetType(System.Type))
...
Dim locbldr265 As LocalBuilder = checkMethodCallIL.DeclareLocal(GetType(Token))
locbldr265.SetLocalSymInfo("tokb")
checkMethodCallIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
checkMethodCallIL.Emit(OpCodes.Ldfld, GetType(Stmt).GetField("Tokens"))
Typ = GetType(Stmt).GetField("Tokens").FieldType
...
Dim locbldr266 As LocalBuilder = checkMethodCallIL.DeclareLocal(GetType(System.Type))
locbldr266.SetLocalSymInfo("typb")
checkMethodCallIL.Emit(OpCodes.Ldtoken, GetType(LParen))
Dim typ86 As Type() = {GetType(System.RuntimeTypeHandle)}
checkMethodCallIL.Emit(OpCodes.Call, GetType(System.Type).GetMethod("GetTypeFromHandle", typ86))
Typ = GetType(System.Type).GetMethod("GetTypeFromHandle", typ86).ReturnType
checkMethodCallIL.Emit(OpCodes.Stloc, 3)
checkMethodCallIL.MarkSequencePoint(doc5, 474, 1, 474, 100)
Dim locbldr267 As LocalBuilder = checkMethodCallIL.DeclareLocal(GetType(System.Boolean))
locbldr267.SetLocalSymInfo("ba")
Dim typ87(-1) As Type
...
checkMethodCallIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("IsInstanceOfType", typ87))
...
Dim locbldr268 As LocalBuilder = checkMethodCallIL.DeclareLocal(GetType(System.Boolean))
locbldr268.SetLocalSymInfo("bb")
Dim typ88(-1) As Type
...
ReDim Preserve typ88(UBound(typ88) + 1)
typ88(UBound(typ88)) = Typ
checkMethodCallIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("IsInstanceOfType", typ88))
Typ = Typ03.GetMethod("IsInstanceOfType", typ88).ReturnType
...
Dim locbldr269 As LocalBuilder = checkMethodCallIL.DeclareLocal(GetType(MethodCallStmt))
locbldr269.SetLocalSymInfo("mtcss")
...
checkMethodCallIL.MarkSequencePoint(doc5, 480, 1, 480, 100)
Dim locbldr270 As LocalBuilder = checkMethodCallIL.DeclareLocal(GetType(MethodNameTok))
locbldr270.SetLocalSymInfo("mn")
...
Dim locbldr271 As LocalBuilder = checkMethodCallIL.DeclareLocal(GetType(MethodCallTok))
locbldr271.SetLocalSymInfo("mct")
...
checkMethodCallIL.MarkSequencePoint(doc5, 482, 1, 482, 100)
Dim locbldr272 As LocalBuilder = checkMethodCallIL.DeclareLocal(GetType(Ident))
locbldr272.SetLocalSymInfo("idt")
...
Dim locbldr273 As LocalBuilder = checkMethodCallIL.DeclareLocal(GetType(Expr))
locbldr273.SetLocalSymInfo("exp")
...
Dim locbldr274 As LocalBuilder = checkMethodCallIL.DeclareLocal(GetType(System.Int32))
locbldr274.SetLocalSymInfo("lvl")
checkMethodCallIL.Emit(OpCodes.Ldc_I4, CInt(1))
Typ = GetType(System.Int32)
checkMethodCallIL.Emit(OpCodes.Stloc, 11)
checkMethodCallIL.MarkSequencePoint(doc5, 485, 1, 485, 100)
Dim locbldr275 As LocalBuilder = checkMethodCallIL.DeclareLocal(GetType(System.Boolean))
locbldr275.SetLocalSymInfo("d")
...
Dim locbldr276 As LocalBuilder = checkMethodCallIL.DeclareLocal(GetType(System.Int32))
locbldr276.SetLocalSymInfo("i")
checkMethodCallIL.Emit(OpCodes.Ldc_I4, CInt(1))
Typ = GetType(System.Int32)
...
checkMethodCallIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa204 As System.Reflection.Emit.Label = checkMethodCallIL.DefineLabel()
Dim tru204 As System.Reflection.Emit.Label = checkMethodCallIL.DefineLabel()
Dim cont204 As System.Reflection.Emit.Label = checkMethodCallIL.DefineLabel()
checkMethodCallIL.Emit(OpCodes.Beq, tru204)
checkMethodCallIL.Emit(OpCodes.Br, fa204)
checkMethodCallIL.MarkLabel(tru204)
...
checkMethodCallIL.MarkSequencePoint(doc5, 491, 1, 491, 100)
checkMethodCallIL.Emit(OpCodes.Ldloc, 6)
Typ = GetType(MethodCallStmt)
checkMethodCallIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
...
checkMethodCallIL.MarkSequencePoint(doc5, 493, 1, 493, 100)
checkMethodCallIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
checkMethodCallIL.Emit(OpCodes.Ldfld, GetType(Stmt).GetField("Tokens"))
Typ = GetType(Stmt).GetField("Tokens").FieldType
...
Typ = Typ.GetElementType()
checkMethodCallIL.Emit(OpCodes.Stloc, 9)
checkMethodCallIL.MarkSequencePoint(doc5, 494, 1, 494, 100)
...
checkMethodCallIL.MarkSequencePoint(doc5, 495, 1, 495, 100)
checkMethodCallIL.Emit(OpCodes.Ldloc, 7)
Typ = GetType(MethodNameTok)
checkMethodCallIL.Emit(OpCodes.Ldloc, 9)
Typ = GetType(Ident)
...
checkMethodCallIL.MarkSequencePoint(doc5, 497, 1, 497, 100)
Dim locbldr277 As LocalBuilder = checkMethodCallIL.DeclareLocal(GetType(Token))
locbldr277.SetLocalSymInfo("tok2")
checkMethodCallIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
checkMethodCallIL.Emit(OpCodes.Ldfld, GetType(Stmt).GetField("Tokens"))
Typ = GetType(Stmt).GetField("Tokens").FieldType
...
checkMethodCallIL.MarkSequencePoint(doc5, 498, 1, 498, 100)
Dim locbldr278 As LocalBuilder = checkMethodCallIL.DeclareLocal(GetType(System.Type))
locbldr278.SetLocalSymInfo("typ2")
checkMethodCallIL.MarkSequencePoint(doc5, 499, 1, 499, 100)
Dim locbldr279 As LocalBuilder = checkMethodCallIL.DeclareLocal(GetType(System.Boolean))
locbldr279.SetLocalSymInfo("b2")
checkMethodCallIL.MarkSequencePoint(doc5, 500, 1, 500, 100)
Dim locbldr280 As LocalBuilder = checkMethodCallIL.DeclareLocal(GetType(System.Int32))
locbldr280.SetLocalSymInfo("len")
checkMethodCallIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
checkMethodCallIL.Emit(OpCodes.Ldfld, GetType(Stmt).GetField("Tokens"))
Typ = GetType(Stmt).GetField("Tokens").FieldType
...
checkMethodCallIL.MarkSequencePoint(doc5, 501, 1, 501, 100)
Dim locbldr281 As LocalBuilder = checkMethodCallIL.DeclareLocal(asm.GetType("dylan.NET.Tokenizer.Parser.ExprOptimizer"))
locbldr281.SetLocalSymInfo("eopt")
...
checkMethodCallIL.MarkSequencePoint(doc5, 503, 1, 503, 100)
Dim label9 As System.Reflection.Emit.Label = checkMethodCallIL.DefineLabel()
checkMethodCallIL.MarkSequencePoint(doc5, 504, 1, 504, 100)
Dim label10 As System.Reflection.Emit.Label = checkMethodCallIL.DefineLabel()
checkMethodCallIL.MarkSequencePoint(doc5, 505, 1, 505, 100)
Dim label11 As System.Reflection.Emit.Label = checkMethodCallIL.DefineLabel()
checkMethodCallIL.MarkSequencePoint(doc5, 507, 1, 507, 100)
checkMethodCallIL.MarkLabel(label9)
checkMethodCallIL.MarkSequencePoint(doc5, 510, 1, 510, 100)
checkMethodCallIL.Emit(OpCodes.Ldloc, 13)
Typ = GetType(System.Int32)
checkMethodCallIL.Emit(OpCodes.Ldc_I4, CInt(1))
Typ = GetType(System.Int32)
...
checkMethodCallIL.Emit(OpCodes.Stloc, 13)
checkMethodCallIL.MarkSequencePoint(doc5, 512, 1, 512, 100)
checkMethodCallIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
checkMethodCallIL.Emit(OpCodes.Ldfld, GetType(Stmt).GetField("Tokens"))
Typ = GetType(Stmt).GetField("Tokens").FieldType
...
Typ = Typ.GetElementType()
checkMethodCallIL.Emit(OpCodes.Stloc, 14)
checkMethodCallIL.MarkSequencePoint(doc5, 513, 1, 513, 100)
checkMethodCallIL.Emit(OpCodes.Ldtoken, GetType(RParen))
Dim typ89 As Type() = {GetType(System.RuntimeTypeHandle)}
checkMethodCallIL.Emit(OpCodes.Call, GetType(System.Type).GetMethod("GetTypeFromHandle", typ89))
Typ = GetType(System.Type).GetMethod("GetTypeFromHandle", typ89).ReturnType
checkMethodCallIL.Emit(OpCodes.Stloc, 15)
checkMethodCallIL.MarkSequencePoint(doc5, 514, 1, 514, 100)
Dim typ90(-1) As Type
...
ReDim Preserve typ90(UBound(typ90) + 1)
typ90(UBound(typ90)) = Typ
checkMethodCallIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("IsInstanceOfType", typ90))
Typ = Typ03.GetMethod("IsInstanceOfType", typ90).ReturnType
checkMethodCallIL.Emit(OpCodes.Stloc, 16)
checkMethodCallIL.MarkSequencePoint(doc5, 515, 1, 515, 100)
checkMethodCallIL.Emit(OpCodes.Ldloc, 16)
Typ = GetType(System.Boolean)
checkMethodCallIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa205 As System.Reflection.Emit.Label = checkMethodCallIL.DefineLabel()
Dim tru205 As System.Reflection.Emit.Label = checkMethodCallIL.DefineLabel()
Dim cont205 As System.Reflection.Emit.Label = checkMethodCallIL.DefineLabel()
checkMethodCallIL.Emit(OpCodes.Beq, tru205)
checkMethodCallIL.Emit(OpCodes.Br, fa205)
checkMethodCallIL.MarkLabel(tru205)
checkMethodCallIL.MarkSequencePoint(doc5, 516, 1, 516, 100)
...
checkMethodCallIL.Emit(OpCodes.Stloc, 11)
checkMethodCallIL.MarkSequencePoint(doc5, 517, 1, 517, 100)
checkMethodCallIL.Emit(OpCodes.Ldloc, 11)
Typ = GetType(System.Int32)
checkMethodCallIL.Emit(OpCodes.Ldc_I4, CInt(0))
Typ = GetType(System.Int32)
Dim fa206 As System.Reflection.Emit.Label = checkMethodCallIL.DefineLabel()
Dim tru206 As System.Reflection.Emit.Label = checkMethodCallIL.DefineLabel()
Dim cont206 As System.Reflection.Emit.Label = checkMethodCallIL.DefineLabel()
checkMethodCallIL.Emit(OpCodes.Beq, tru206)
checkMethodCallIL.Emit(OpCodes.Br, fa206)
checkMethodCallIL.MarkLabel(tru206)
checkMethodCallIL.MarkSequencePoint(doc5, 518, 1, 518, 100)
checkMethodCallIL.Emit(OpCodes.Ldc_I4, 0)
Typ = GetType(System.Boolean)
checkMethodCallIL.Emit(OpCodes.Stloc, 12)
checkMethodCallIL.MarkSequencePoint(doc5, 519, 1, 519, 100)
Dim typ91(-1) As Type
...
checkMethodCallIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("Optimize", typ91))
Typ = Typ03.GetMethod("Optimize", typ91).ReturnType
checkMethodCallIL.Emit(OpCodes.Stloc, 10)
checkMethodCallIL.MarkSequencePoint(doc5, 520, 1, 520, 100)
Dim typ92(-1) As Type
...
ReDim Preserve typ92(UBound(typ92) + 1)
typ92(UBound(typ92)) = Typ
checkMethodCallIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("AddParam", typ92))
Typ = Typ03.GetMethod("AddParam", typ92).ReturnType
If Typ.ToString() = GetType(System.Void).ToString() Then

Else
checkMethodCallIL.Emit(OpCodes.Pop)
End If
checkMethodCallIL.MarkSequencePoint(doc5, 521, 1, 521, 100)
checkMethodCallIL.Emit(OpCodes.Br, label10)
checkMethodCallIL.MarkSequencePoint(doc5, 522, 1, 522, 100)
checkMethodCallIL.Emit(OpCodes.Br, cont206)
checkMethodCallIL.MarkLabel(fa206)
checkMethodCallIL.MarkSequencePoint(doc5, 523, 1, 523, 100)
checkMethodCallIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
checkMethodCallIL.Emit(OpCodes.Stloc, 12)
checkMethodCallIL.MarkSequencePoint(doc5, 524, 1, 524, 100)
checkMethodCallIL.Emit(OpCodes.Br, label11)
checkMethodCallIL.MarkSequencePoint(doc5, 525, 1, 525, 100)
checkMethodCallIL.Emit(OpCodes.Br, cont206)
checkMethodCallIL.MarkLabel(cont206)
checkMethodCallIL.MarkSequencePoint(doc5, 526, 1, 526, 100)
checkMethodCallIL.Emit(OpCodes.Br, label11)
checkMethodCallIL.MarkSequencePoint(doc5, 527, 1, 527, 100)
checkMethodCallIL.Emit(OpCodes.Br, cont205)
checkMethodCallIL.MarkLabel(fa205)
checkMethodCallIL.Emit(OpCodes.Br, cont205)
checkMethodCallIL.MarkLabel(cont205)
checkMethodCallIL.MarkSequencePoint(doc5, 529, 1, 529, 100)
checkMethodCallIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
checkMethodCallIL.Emit(OpCodes.Ldfld, GetType(Stmt).GetField("Tokens"))
Typ = GetType(Stmt).GetField("Tokens").FieldType
...
Typ = Typ.GetElementType()
checkMethodCallIL.Emit(OpCodes.Stloc, 14)
checkMethodCallIL.MarkSequencePoint(doc5, 530, 1, 530, 100)
checkMethodCallIL.Emit(OpCodes.Ldtoken, GetType(LParen))
Dim typ93 As Type() = {GetType(System.RuntimeTypeHandle)}
checkMethodCallIL.Emit(OpCodes.Call, GetType(System.Type).GetMethod("GetTypeFromHandle", typ93))
Typ = GetType(System.Type).GetMethod("GetTypeFromHandle", typ93).ReturnType
checkMethodCallIL.Emit(OpCodes.Stloc, 15)
checkMethodCallIL.MarkSequencePoint(doc5, 531, 1, 531, 100)
Dim typ94(-1) As Type
checkMethodCallIL.Emit(OpCodes.Ldloc, 15)
Typ = GetType(System.Type)
Typ03 = Typ
...
ReDim Preserve typ94(UBound(typ94) + 1)
typ94(UBound(typ94)) = Typ
checkMethodCallIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("IsInstanceOfType", typ94))
Typ = Typ03.GetMethod("IsInstanceOfType", typ94).ReturnType
checkMethodCallIL.Emit(OpCodes.Stloc, 16)
checkMethodCallIL.MarkSequencePoint(doc5, 532, 1, 532, 100)
checkMethodCallIL.Emit(OpCodes.Ldloc, 16)
Typ = GetType(System.Boolean)
checkMethodCallIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa207 As System.Reflection.Emit.Label = checkMethodCallIL.DefineLabel()
Dim tru207 As System.Reflection.Emit.Label = checkMethodCallIL.DefineLabel()
Dim cont207 As System.Reflection.Emit.Label = checkMethodCallIL.DefineLabel()
checkMethodCallIL.Emit(OpCodes.Beq, tru207)
checkMethodCallIL.Emit(OpCodes.Br, fa207)
checkMethodCallIL.MarkLabel(tru207)
checkMethodCallIL.MarkSequencePoint(doc5, 533, 1, 533, 100)
checkMethodCallIL.Emit(OpCodes.Ldloc, 11)
Typ = GetType(System.Int32)
checkMethodCallIL.Emit(OpCodes.Ldc_I4, CInt(1))
Typ = GetType(System.Int32)
checkMethodCallIL.Emit(OpCodes.Add)
checkMethodCallIL.Emit(OpCodes.Stloc, 11)
checkMethodCallIL.MarkSequencePoint(doc5, 534, 1, 534, 100)
checkMethodCallIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
checkMethodCallIL.Emit(OpCodes.Stloc, 12)
checkMethodCallIL.MarkSequencePoint(doc5, 535, 1, 535, 100)
checkMethodCallIL.Emit(OpCodes.Br, label11)
checkMethodCallIL.MarkSequencePoint(doc5, 536, 1, 536, 100)
checkMethodCallIL.Emit(OpCodes.Br, cont207)
checkMethodCallIL.MarkLabel(fa207)
checkMethodCallIL.Emit(OpCodes.Br, cont207)
checkMethodCallIL.MarkLabel(cont207)
checkMethodCallIL.MarkSequencePoint(doc5, 538, 1, 538, 100)
checkMethodCallIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
checkMethodCallIL.Emit(OpCodes.Ldfld, GetType(Stmt).GetField("Tokens"))
Typ = GetType(Stmt).GetField("Tokens").FieldType
...
Typ = Typ.GetElementType()
checkMethodCallIL.Emit(OpCodes.Stloc, 14)
checkMethodCallIL.MarkSequencePoint(doc5, 539, 1, 539, 100)
checkMethodCallIL.Emit(OpCodes.Ldtoken, GetType(Comma))
Dim typ95 As Type() = {GetType(System.RuntimeTypeHandle)}
checkMethodCallIL.Emit(OpCodes.Call, GetType(System.Type).GetMethod("GetTypeFromHandle", typ95))
Typ = GetType(System.Type).GetMethod("GetTypeFromHandle", typ95).ReturnType
checkMethodCallIL.Emit(OpCodes.Stloc, 15)
checkMethodCallIL.MarkSequencePoint(doc5, 540, 1, 540, 100)
Dim typ96(-1) As Type
checkMethodCallIL.Emit(OpCodes.Ldloc, 15)
Typ = GetType(System.Type)
Typ03 = Typ
...
ReDim Preserve typ96(UBound(typ96) + 1)
typ96(UBound(typ96)) = Typ
checkMethodCallIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("IsInstanceOfType", typ96))
Typ = Typ03.GetMethod("IsInstanceOfType", typ96).ReturnType
checkMethodCallIL.Emit(OpCodes.Stloc, 16)
checkMethodCallIL.MarkSequencePoint(doc5, 541, 1, 541, 100)
checkMethodCallIL.Emit(OpCodes.Ldloc, 16)
Typ = GetType(System.Boolean)
checkMethodCallIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa208 As System.Reflection.Emit.Label = checkMethodCallIL.DefineLabel()
Dim tru208 As System.Reflection.Emit.Label = checkMethodCallIL.DefineLabel()
Dim cont208 As System.Reflection.Emit.Label = checkMethodCallIL.DefineLabel()
checkMethodCallIL.Emit(OpCodes.Beq, tru208)
checkMethodCallIL.Emit(OpCodes.Br, fa208)
checkMethodCallIL.MarkLabel(tru208)
checkMethodCallIL.MarkSequencePoint(doc5, 542, 1, 542, 100)
checkMethodCallIL.Emit(OpCodes.Ldloc, 11)
Typ = GetType(System.Int32)
checkMethodCallIL.Emit(OpCodes.Ldc_I4, CInt(1))
Typ = GetType(System.Int32)
Dim fa209 As System.Reflection.Emit.Label = checkMethodCallIL.DefineLabel()
Dim tru209 As System.Reflection.Emit.Label = checkMethodCallIL.DefineLabel()
Dim cont209 As System.Reflection.Emit.Label = checkMethodCallIL.DefineLabel()
checkMethodCallIL.Emit(OpCodes.Beq, tru209)
checkMethodCallIL.Emit(OpCodes.Br, fa209)
checkMethodCallIL.MarkLabel(tru209)
checkMethodCallIL.MarkSequencePoint(doc5, 543, 1, 543, 100)
checkMethodCallIL.Emit(OpCodes.Ldc_I4, 0)
Typ = GetType(System.Boolean)
checkMethodCallIL.Emit(OpCodes.Stloc, 12)
checkMethodCallIL.MarkSequencePoint(doc5, 544, 1, 544, 100)
Dim typ97(-1) As Type
checkMethodCallIL.Emit(OpCodes.Ldloc, 18)
Typ = asm.GetType("dylan.NET.Tokenizer.Parser.ExprOptimizer")
Typ03 = Typ
...
ReDim Preserve typ97(UBound(typ97) + 1)
typ97(UBound(typ97)) = Typ
checkMethodCallIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("Optimize", typ97))
Typ = Typ03.GetMethod("Optimize", typ97).ReturnType
checkMethodCallIL.Emit(OpCodes.Stloc, 10)
checkMethodCallIL.MarkSequencePoint(doc5, 545, 1, 545, 100)
Dim typ98(-1) As Type
checkMethodCallIL.Emit(OpCodes.Ldloc, 8)
Typ = GetType(MethodCallTok)
Typ03 = Typ
...
ReDim Preserve typ98(UBound(typ98) + 1)
typ98(UBound(typ98)) = Typ
checkMethodCallIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("AddParam", typ98))
...
checkMethodCallIL.Emit(OpCodes.Pop)
End If
checkMethodCallIL.MarkSequencePoint(doc5, 546, 1, 546, 100)
checkMethodCallIL.Emit(OpCodes.Newobj, GetType(Expr).GetConstructor(Type.EmptyTypes))
checkMethodCallIL.Emit(OpCodes.Stloc, 10)
checkMethodCallIL.MarkSequencePoint(doc5, 547, 1, 547, 100)
checkMethodCallIL.Emit(OpCodes.Br, label11)
checkMethodCallIL.MarkSequencePoint(doc5, 548, 1, 548, 100)
checkMethodCallIL.Emit(OpCodes.Br, cont209)
checkMethodCallIL.MarkLabel(fa209)
checkMethodCallIL.MarkSequencePoint(doc5, 549, 1, 549, 100)
checkMethodCallIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
checkMethodCallIL.Emit(OpCodes.Stloc, 12)
checkMethodCallIL.MarkSequencePoint(doc5, 550, 1, 550, 100)
checkMethodCallIL.Emit(OpCodes.Br, label11)
checkMethodCallIL.MarkSequencePoint(doc5, 551, 1, 551, 100)
checkMethodCallIL.Emit(OpCodes.Br, cont209)
checkMethodCallIL.MarkLabel(cont209)
checkMethodCallIL.MarkSequencePoint(doc5, 552, 1, 552, 100)
checkMethodCallIL.Emit(OpCodes.Br, cont208)
checkMethodCallIL.MarkLabel(fa208)
checkMethodCallIL.MarkSequencePoint(doc5, 553, 1, 553, 100)
checkMethodCallIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
checkMethodCallIL.Emit(OpCodes.Stloc, 12)
checkMethodCallIL.MarkSequencePoint(doc5, 554, 1, 554, 100)
checkMethodCallIL.Emit(OpCodes.Br, label11)
checkMethodCallIL.MarkSequencePoint(doc5, 555, 1, 555, 100)
checkMethodCallIL.Emit(OpCodes.Br, cont208)
checkMethodCallIL.MarkLabel(cont208)
checkMethodCallIL.MarkSequencePoint(doc5, 557, 1, 557, 100)
checkMethodCallIL.MarkLabel(label11)
checkMethodCallIL.MarkSequencePoint(doc5, 559, 1, 559, 100)
checkMethodCallIL.Emit(OpCodes.Ldloc, 12)
Typ = GetType(System.Boolean)
checkMethodCallIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa210 As System.Reflection.Emit.Label = checkMethodCallIL.DefineLabel()
Dim tru210 As System.Reflection.Emit.Label = checkMethodCallIL.DefineLabel()
Dim cont210 As System.Reflection.Emit.Label = checkMethodCallIL.DefineLabel()
checkMethodCallIL.Emit(OpCodes.Beq, tru210)
checkMethodCallIL.Emit(OpCodes.Br, fa210)
checkMethodCallIL.MarkLabel(tru210)
checkMethodCallIL.MarkSequencePoint(doc5, 560, 1, 560, 100)
Dim typ99(-1) As Type
checkMethodCallIL.Emit(OpCodes.Ldloc, 10)
Typ = GetType(Expr)
Typ03 = Typ
...
ReDim Preserve typ99(UBound(typ99) + 1)
typ99(UBound(typ99)) = Typ
checkMethodCallIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("AddToken", typ99))
Typ = Typ03.GetMethod("AddToken", typ99).ReturnType
If Typ.ToString() = GetType(System.Void).ToString() Then

Else
checkMethodCallIL.Emit(OpCodes.Pop)
End If
checkMethodCallIL.MarkSequencePoint(doc5, 561, 1, 561, 100)
checkMethodCallIL.Emit(OpCodes.Br, cont210)
checkMethodCallIL.MarkLabel(fa210)
checkMethodCallIL.Emit(OpCodes.Br, cont210)
checkMethodCallIL.MarkLabel(cont210)
checkMethodCallIL.MarkSequencePoint(doc5, 563, 1, 563, 100)
checkMethodCallIL.Emit(OpCodes.Ldloc, 13)
Typ = GetType(System.Int32)
checkMethodCallIL.Emit(OpCodes.Ldloc, 17)
Typ = GetType(System.Int32)
Dim fa211 As System.Reflection.Emit.Label = checkMethodCallIL.DefineLabel()
Dim tru211 As System.Reflection.Emit.Label = checkMethodCallIL.DefineLabel()
Dim cont211 As System.Reflection.Emit.Label = checkMethodCallIL.DefineLabel()
checkMethodCallIL.Emit(OpCodes.Beq, tru211)
checkMethodCallIL.Emit(OpCodes.Br, fa211)
checkMethodCallIL.MarkLabel(tru211)
checkMethodCallIL.MarkSequencePoint(doc5, 564, 1, 564, 100)
checkMethodCallIL.Emit(OpCodes.Br, label10)
checkMethodCallIL.MarkSequencePoint(doc5, 565, 1, 565, 100)
checkMethodCallIL.Emit(OpCodes.Br, cont211)
checkMethodCallIL.MarkLabel(fa211)
checkMethodCallIL.MarkSequencePoint(doc5, 566, 1, 566, 100)
checkMethodCallIL.Emit(OpCodes.Br, label9)
checkMethodCallIL.MarkSequencePoint(doc5, 567, 1, 567, 100)
checkMethodCallIL.Emit(OpCodes.Br, cont211)
checkMethodCallIL.MarkLabel(cont211)
checkMethodCallIL.MarkSequencePoint(doc5, 569, 1, 569, 100)
checkMethodCallIL.MarkLabel(label10)
checkMethodCallIL.MarkSequencePoint(doc5, 571, 1, 571, 100)
checkMethodCallIL.Emit(OpCodes.Ldloc, 8)
Typ = GetType(MethodCallTok)
checkMethodCallIL.Emit(OpCodes.Ldloc, 7)
Typ = GetType(MethodNameTok)
checkMethodCallIL.Emit(OpCodes.Stfld, GetType(MethodCallTok).GetField("Name"))
checkMethodCallIL.MarkSequencePoint(doc5, 572, 1, 572, 100)
checkMethodCallIL.Emit(OpCodes.Ldloc, 6)
Typ = GetType(MethodCallStmt)
checkMethodCallIL.Emit(OpCodes.Ldloc, 8)
Typ = GetType(MethodCallTok)
checkMethodCallIL.Emit(OpCodes.Stfld, GetType(MethodCallStmt).GetField("MethodToken"))
checkMethodCallIL.MarkSequencePoint(doc5, 574, 1, 574, 100)
checkMethodCallIL.Emit(OpCodes.Br, cont204)
checkMethodCallIL.MarkLabel(fa204)
checkMethodCallIL.Emit(OpCodes.Br, cont204)
checkMethodCallIL.MarkLabel(cont204)
checkMethodCallIL.MarkSequencePoint(doc5, 576, 1, 576, 100)
checkMethodCallIL.Emit(OpCodes.Br, cont203)
checkMethodCallIL.MarkLabel(fa203)
checkMethodCallIL.Emit(OpCodes.Br, cont203)
checkMethodCallIL.MarkLabel(cont203)
checkMethodCallIL.MarkSequencePoint(doc5, 577, 1, 577, 100)
checkMethodCallIL.Emit(OpCodes.Ldloc, 6)
Typ = GetType(MethodCallStmt)
checkMethodCallIL.MarkSequencePoint(doc5, 578, 1, 578, 100)
checkMethodCallIL.Emit(OpCodes.Ret)
Dim typ100(-1) As Type
ReDim Preserve typ100(UBound(typ100) + 1)
typ100(UBound(typ100)) = GetType(Stmt)
ReDim Preserve typ100(UBound(typ100) + 1)
typ100(UBound(typ100)) = GetType(System.Boolean).MakeByRefType()
Dim checkVarAs As MethodBuilder = StmtOptimizer.DefineMethod("checkVarAs", MethodAttributes.Public, GetType(Stmt), typ100)
Dim checkVarAsIL As ILGenerator = checkVarAs.GetILGenerator()
Dim checkVarAsparam01 As ParameterBuilder = checkVarAs.DefineParameter(1, ParameterAttributes.None, "stm")
Dim checkVarAsparam02 As ParameterBuilder = checkVarAs.DefineParameter(2, ParameterAttributes.None, "b")
checkVarAsIL.MarkSequencePoint(doc5, 581, 1, 581, 100)
Dim locbldr282 As LocalBuilder = checkVarAsIL.DeclareLocal(GetType(Token))
locbldr282.SetLocalSymInfo("tok")
checkVarAsIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
...
Typ = Typ.GetElementType()
checkVarAsIL.Emit(OpCodes.Stloc, 0)
checkVarAsIL.MarkSequencePoint(doc5, 582, 1, 582, 100)
Dim locbldr283 As LocalBuilder = checkVarAsIL.DeclareLocal(GetType(System.Type))
locbldr283.SetLocalSymInfo("typ")
checkVarAsIL.Emit(OpCodes.Ldtoken, GetType(VarTok))
Dim typ101 As Type() = {GetType(System.RuntimeTypeHandle)}
checkVarAsIL.Emit(OpCodes.Call, GetType(System.Type).GetMethod("GetTypeFromHandle", typ101))
Typ = GetType(System.Type).GetMethod("GetTypeFromHandle", typ101).ReturnType
checkVarAsIL.Emit(OpCodes.Stloc, 1)
checkVarAsIL.MarkSequencePoint(doc5, 583, 1, 583, 100)
checkVarAsIL.Emit(OpCodes.Ldarg, 2)
Typ = GetType(System.Boolean).MakeByRefType()
Typ04 = Typ.GetElementType()
...
checkVarAsIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("IsInstanceOfType", typ102))
Typ = Typ03.GetMethod("IsInstanceOfType", typ102).ReturnType
checkVarAsIL.Emit(OpCodes.Stobj, Typ04)
checkVarAsIL.MarkSequencePoint(doc5, 584, 1, 584, 100)
Dim locbldr284 As LocalBuilder = checkVarAsIL.DeclareLocal(GetType(VarStmt))
locbldr284.SetLocalSymInfo("vars")
checkVarAsIL.Emit(OpCodes.Newobj, GetType(VarStmt).GetConstructor(Type.EmptyTypes))
checkVarAsIL.Emit(OpCodes.Stloc, 2)
checkVarAsIL.MarkSequencePoint(doc5, 586, 1, 586, 100)
checkVarAsIL.Emit(OpCodes.Ldarg, 2)
Typ = GetType(System.Boolean).MakeByRefType()
checkVarAsIL.Emit(OpCodes.Ldobj, Typ.GetElementType())
Typ = Typ.GetElementType()
checkVarAsIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa212 As System.Reflection.Emit.Label = checkVarAsIL.DefineLabel()
Dim tru212 As System.Reflection.Emit.Label = checkVarAsIL.DefineLabel()
Dim cont212 As System.Reflection.Emit.Label = checkVarAsIL.DefineLabel()
checkVarAsIL.Emit(OpCodes.Beq, tru212)
checkVarAsIL.Emit(OpCodes.Br, fa212)
checkVarAsIL.MarkLabel(tru212)
checkVarAsIL.MarkSequencePoint(doc5, 587, 1, 587, 100)
checkVarAsIL.Emit(OpCodes.Ldloc, 2)
Typ = GetType(VarStmt)
checkVarAsIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
...
checkVarAsIL.MarkSequencePoint(doc5, 588, 1, 588, 100)
Dim locbldr285 As LocalBuilder = checkVarAsIL.DeclareLocal(GetType(Expr))
locbldr285.SetLocalSymInfo("tempexp")
checkVarAsIL.Emit(OpCodes.Newobj, GetType(Expr).GetConstructor(Type.EmptyTypes))
checkVarAsIL.Emit(OpCodes.Stloc, 3)
checkVarAsIL.MarkSequencePoint(doc5, 589, 1, 589, 100)
checkVarAsIL.Emit(OpCodes.Ldloc, 3)
Typ = GetType(Expr)
checkVarAsIL.Emit(OpCodes.Ldloc, 2)
Typ = GetType(VarStmt)
...
checkVarAsIL.MarkSequencePoint(doc5, 590, 1, 590, 100)
Dim locbldr286 As LocalBuilder = checkVarAsIL.DeclareLocal(asm.GetType("dylan.NET.Tokenizer.Parser.ExprOptimizer"))
locbldr286.SetLocalSymInfo("eop")
checkVarAsIL.Emit(OpCodes.Newobj, asm.GetType("dylan.NET.Tokenizer.Parser.ExprOptimizer").GetConstructor(Type.EmptyTypes))
checkVarAsIL.Emit(OpCodes.Stloc, 4)
checkVarAsIL.MarkSequencePoint(doc5, 591, 1, 591, 100)
Dim typ103(-1) As Type
checkVarAsIL.Emit(OpCodes.Ldloc, 4)
Typ = asm.GetType("dylan.NET.Tokenizer.Parser.ExprOptimizer")
Typ03 = Typ
...
ReDim Preserve typ103(UBound(typ103) + 1)
typ103(UBound(typ103)) = Typ
checkVarAsIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("Optimize", typ103))
Typ = Typ03.GetMethod("Optimize", typ103).ReturnType
checkVarAsIL.Emit(OpCodes.Stloc, 3)
checkVarAsIL.MarkSequencePoint(doc5, 592, 1, 592, 100)
checkVarAsIL.Emit(OpCodes.Ldloc, 2)
Typ = GetType(VarStmt)
checkVarAsIL.Emit(OpCodes.Ldloc, 3)
Typ = GetType(Expr)
...
Typ = GetType(Expr).GetField("Tokens").FieldType
checkVarAsIL.Emit(OpCodes.Stfld, GetType(VarStmt).GetField("Tokens"))
checkVarAsIL.MarkSequencePoint(doc5, 593, 1, 593, 100)
checkVarAsIL.Emit(OpCodes.Ldloc, 2)
Typ = GetType(VarStmt)
checkVarAsIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
...
checkVarAsIL.MarkSequencePoint(doc5, 594, 1, 594, 100)
checkVarAsIL.Emit(OpCodes.Ldloc, 2)
Typ = GetType(VarStmt)
checkVarAsIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
...
checkVarAsIL.MarkSequencePoint(doc5, 596, 1, 596, 100)
Dim locbldr287 As LocalBuilder = checkVarAsIL.DeclareLocal(GetType(Token))
locbldr287.SetLocalSymInfo("tok2")
checkVarAsIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
checkVarAsIL.Emit(OpCodes.Ldfld, GetType(Stmt).GetField("Tokens"))
Typ = GetType(Stmt).GetField("Tokens").FieldType
...
Typ = Typ.GetElementType()
checkVarAsIL.Emit(OpCodes.Stloc, 5)
checkVarAsIL.MarkSequencePoint(doc5, 597, 1, 597, 100)
Dim locbldr288 As LocalBuilder = checkVarAsIL.DeclareLocal(GetType(System.Type))
locbldr288.SetLocalSymInfo("typ2")
checkVarAsIL.Emit(OpCodes.Ldtoken, GetType(TypeTok))
Dim typ104 As Type() = {GetType(System.RuntimeTypeHandle)}
checkVarAsIL.Emit(OpCodes.Call, GetType(System.Type).GetMethod("GetTypeFromHandle", typ104))
Typ = GetType(System.Type).GetMethod("GetTypeFromHandle", typ104).ReturnType
checkVarAsIL.Emit(OpCodes.Stloc, 6)
checkVarAsIL.MarkSequencePoint(doc5, 598, 1, 598, 100)
Dim locbldr289 As LocalBuilder = checkVarAsIL.DeclareLocal(GetType(System.Boolean))
locbldr289.SetLocalSymInfo("b2")
Dim typ105(-1) As Type
checkVarAsIL.Emit(OpCodes.Ldloc, 6)
Typ = GetType(System.Type)
Typ03 = Typ
...
ReDim Preserve typ105(UBound(typ105) + 1)
typ105(UBound(typ105)) = Typ
checkVarAsIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("IsInstanceOfType", typ105))
Typ = Typ03.GetMethod("IsInstanceOfType", typ105).ReturnType
checkVarAsIL.Emit(OpCodes.Stloc, 7)
checkVarAsIL.MarkSequencePoint(doc5, 600, 1, 600, 100)
checkVarAsIL.Emit(OpCodes.Ldloc, 7)
Typ = GetType(System.Boolean)
checkVarAsIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa213 As System.Reflection.Emit.Label = checkVarAsIL.DefineLabel()
Dim tru213 As System.Reflection.Emit.Label = checkVarAsIL.DefineLabel()
Dim cont213 As System.Reflection.Emit.Label = checkVarAsIL.DefineLabel()
checkVarAsIL.Emit(OpCodes.Beq, fa213)
checkVarAsIL.Emit(OpCodes.Br, tru213)
checkVarAsIL.MarkLabel(tru213)
checkVarAsIL.MarkSequencePoint(doc5, 601, 1, 601, 100)
Dim locbldr290 As LocalBuilder = checkVarAsIL.DeclareLocal(GetType(Token))
locbldr290.SetLocalSymInfo("t")
checkVarAsIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
checkVarAsIL.Emit(OpCodes.Ldfld, GetType(Stmt).GetField("Tokens"))
Typ = GetType(Stmt).GetField("Tokens").FieldType
...
checkVarAsIL.MarkSequencePoint(doc5, 602, 1, 602, 100)
Dim locbldr291 As LocalBuilder = checkVarAsIL.DeclareLocal(GetType(TypeTok))
locbldr291.SetLocalSymInfo("tt")
checkVarAsIL.Emit(OpCodes.Newobj, GetType(TypeTok).GetConstructor(Type.EmptyTypes))
checkVarAsIL.Emit(OpCodes.Stloc, 9)
checkVarAsIL.MarkSequencePoint(doc5, 603, 1, 603, 100)
...
Typ = GetType(Token).GetField("Line").FieldType
checkVarAsIL.Emit(OpCodes.Stfld, GetType(TypeTok).GetField("Line"))
checkVarAsIL.MarkSequencePoint(doc5, 604, 1, 604, 100)
checkVarAsIL.Emit(OpCodes.Ldloc, 9)
Typ = GetType(TypeTok)
checkVarAsIL.Emit(OpCodes.Ldloc, 8)
Typ = GetType(Token)
...
Typ = GetType(Token).GetField("Value").FieldType
checkVarAsIL.Emit(OpCodes.Stfld, GetType(TypeTok).GetField("Value"))
checkVarAsIL.MarkSequencePoint(doc5, 605, 1, 605, 100)
checkVarAsIL.Emit(OpCodes.Ldloc, 2)
Typ = GetType(VarStmt)
checkVarAsIL.Emit(OpCodes.Ldloc, 9)
Typ = GetType(TypeTok)
checkVarAsIL.Emit(OpCodes.Stfld, GetType(VarStmt).GetField("VarTyp"))
checkVarAsIL.MarkSequencePoint(doc5, 606, 1, 606, 100)
checkVarAsIL.Emit(OpCodes.Br, cont213)
checkVarAsIL.MarkLabel(fa213)
checkVarAsIL.MarkSequencePoint(doc5, 607, 1, 607, 100)
checkVarAsIL.Emit(OpCodes.Ldloc, 2)
Typ = GetType(VarStmt)
checkVarAsIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
...
Typ = Typ.GetElementType()
checkVarAsIL.Emit(OpCodes.Stfld, GetType(VarStmt).GetField("VarTyp"))
checkVarAsIL.MarkSequencePoint(doc5, 608, 1, 608, 100)
checkVarAsIL.Emit(OpCodes.Br, cont213)
checkVarAsIL.MarkLabel(cont213)
checkVarAsIL.MarkSequencePoint(doc5, 610, 1, 610, 100)
checkVarAsIL.Emit(OpCodes.Br, cont212)
checkVarAsIL.MarkLabel(fa212)
checkVarAsIL.Emit(OpCodes.Br, cont212)
checkVarAsIL.MarkLabel(cont212)
checkVarAsIL.MarkSequencePoint(doc5, 611, 1, 611, 100)
checkVarAsIL.Emit(OpCodes.Ldloc, 2)
Typ = GetType(VarStmt)
checkVarAsIL.MarkSequencePoint(doc5, 612, 1, 612, 100)
checkVarAsIL.Emit(OpCodes.Ret)
Dim typ106(-1) As Type
ReDim Preserve typ106(UBound(typ106) + 1)
typ106(UBound(typ106)) = GetType(Stmt)
Dim AssOpt As MethodBuilder = StmtOptimizer.DefineMethod("AssOpt", MethodAttributes.Public, GetType(Stmt), typ106)
...
AssOptIL.MarkSequencePoint(doc5, 616, 1, 616, 100)
Dim locbldr292 As LocalBuilder = AssOptIL.DeclareLocal(GetType(AssignStmt))
locbldr292.SetLocalSymInfo("asss")
AssOptIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
AssOptIL.Emit(OpCodes.Stloc, 0)
AssOptIL.MarkSequencePoint(doc5, 617, 1, 617, 100)
Dim locbldr293 As LocalBuilder = AssOptIL.DeclareLocal(GetType(Expr))
locbldr293.SetLocalSymInfo("le")
...
AssOptIL.MarkSequencePoint(doc5, 618, 1, 618, 100)
Dim locbldr294 As LocalBuilder = AssOptIL.DeclareLocal(GetType(Token))
locbldr294.SetLocalSymInfo("tok")
...
AssOptIL.MarkSequencePoint(doc5, 619, 1, 619, 100)
Dim locbldr295 As LocalBuilder = AssOptIL.DeclareLocal(GetType(System.Type))
locbldr295.SetLocalSymInfo("typ")
AssOptIL.Emit(OpCodes.Ldtoken, GetType(VarTok))
Dim typ107 As Type() = {GetType(System.RuntimeTypeHandle)}
AssOptIL.Emit(OpCodes.Call, GetType(System.Type).GetMethod("GetTypeFromHandle", typ107))
Typ = GetType(System.Type).GetMethod("GetTypeFromHandle", typ107).ReturnType
AssOptIL.Emit(OpCodes.Stloc, 3)
AssOptIL.MarkSequencePoint(doc5, 620, 1, 620, 100)
Dim locbldr296 As LocalBuilder = AssOptIL.DeclareLocal(GetType(System.Boolean))
locbldr296.SetLocalSymInfo("b")
Dim typ108(-1) As Type
...
ReDim Preserve typ108(UBound(typ108) + 1)
typ108(UBound(typ108)) = Typ
AssOptIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("IsInstanceOfType", typ108))
Typ = Typ03.GetMethod("IsInstanceOfType", typ108).ReturnType
AssOptIL.Emit(OpCodes.Stloc, 4)
AssOptIL.MarkSequencePoint(doc5, 621, 1, 621, 100)
Dim locbldr297 As LocalBuilder = AssOptIL.DeclareLocal(GetType(VarAsgnStmt))
locbldr297.SetLocalSymInfo("vass")
AssOptIL.Emit(OpCodes.Newobj, GetType(VarAsgnStmt).GetConstructor(Type.EmptyTypes))
AssOptIL.Emit(OpCodes.Stloc, 5)
AssOptIL.MarkSequencePoint(doc5, 622, 1, 622, 100)
AssOptIL.Emit(OpCodes.Ldloc, 4)
Typ = GetType(System.Boolean)
AssOptIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa214 As System.Reflection.Emit.Label = AssOptIL.DefineLabel()
Dim tru214 As System.Reflection.Emit.Label = AssOptIL.DefineLabel()
Dim cont214 As System.Reflection.Emit.Label = AssOptIL.DefineLabel()
AssOptIL.Emit(OpCodes.Beq, tru214)
AssOptIL.Emit(OpCodes.Br, fa214)
AssOptIL.MarkLabel(tru214)
AssOptIL.MarkSequencePoint(doc5, 623, 1, 623, 100)
...
AssOptIL.MarkSequencePoint(doc5, 624, 1, 624, 100)
AssOptIL.Emit(OpCodes.Ldloc, 5)
Typ = GetType(VarAsgnStmt)
AssOptIL.Emit(OpCodes.Ldloc, 0)
Typ = GetType(AssignStmt)
...
AssOptIL.MarkSequencePoint(doc5, 625, 1, 625, 100)
AssOptIL.Emit(OpCodes.Ldloc, 5)
Typ = GetType(VarAsgnStmt)
AssOptIL.Emit(OpCodes.Ldloc, 1)
Typ = GetType(Expr)
...
AssOptIL.MarkSequencePoint(doc5, 627, 1, 627, 100)
Dim locbldr298 As LocalBuilder = AssOptIL.DeclareLocal(GetType(Token))
locbldr298.SetLocalSymInfo("tok2")
AssOptIL.Emit(OpCodes.Ldloc, 1)
Typ = GetType(Expr)
AssOptIL.Emit(OpCodes.Ldfld, GetType(Expr).GetField("Tokens"))
Typ = GetType(Expr).GetField("Tokens").FieldType
...
AssOptIL.MarkSequencePoint(doc5, 628, 1, 628, 100)
Dim locbldr299 As LocalBuilder = AssOptIL.DeclareLocal(GetType(System.Type))
locbldr299.SetLocalSymInfo("typ2")
AssOptIL.Emit(OpCodes.Ldtoken, GetType(TypeTok))
Dim typ109 As Type() = {GetType(System.RuntimeTypeHandle)}
AssOptIL.Emit(OpCodes.Call, GetType(System.Type).GetMethod("GetTypeFromHandle", typ109))
Typ = GetType(System.Type).GetMethod("GetTypeFromHandle", typ109).ReturnType
AssOptIL.Emit(OpCodes.Stloc, 7)
AssOptIL.MarkSequencePoint(doc5, 629, 1, 629, 100)
Dim locbldr300 As LocalBuilder = AssOptIL.DeclareLocal(GetType(System.Boolean))
locbldr300.SetLocalSymInfo("b2")
Dim typ110(-1) As Type
...
ReDim Preserve typ110(UBound(typ110) + 1)
typ110(UBound(typ110)) = Typ
AssOptIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("IsInstanceOfType", typ110))
Typ = Typ03.GetMethod("IsInstanceOfType", typ110).ReturnType
AssOptIL.Emit(OpCodes.Stloc, 8)
AssOptIL.MarkSequencePoint(doc5, 631, 1, 631, 100)
AssOptIL.Emit(OpCodes.Ldloc, 8)
Typ = GetType(System.Boolean)
AssOptIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa215 As System.Reflection.Emit.Label = AssOptIL.DefineLabel()
Dim tru215 As System.Reflection.Emit.Label = AssOptIL.DefineLabel()
Dim cont215 As System.Reflection.Emit.Label = AssOptIL.DefineLabel()
AssOptIL.Emit(OpCodes.Beq, fa215)
AssOptIL.Emit(OpCodes.Br, tru215)
AssOptIL.MarkLabel(tru215)
AssOptIL.MarkSequencePoint(doc5, 632, 1, 632, 100)
Dim locbldr301 As LocalBuilder = AssOptIL.DeclareLocal(GetType(Token))
locbldr301.SetLocalSymInfo("t")
AssOptIL.Emit(OpCodes.Ldloc, 1)
Typ = GetType(Expr)
AssOptIL.Emit(OpCodes.Ldfld, GetType(Expr).GetField("Tokens"))
Typ = GetType(Expr).GetField("Tokens").FieldType
...
AssOptIL.MarkSequencePoint(doc5, 633, 1, 633, 100)
Dim locbldr302 As LocalBuilder = AssOptIL.DeclareLocal(GetType(TypeTok))
locbldr302.SetLocalSymInfo("tt")
AssOptIL.Emit(OpCodes.Newobj, GetType(TypeTok).GetConstructor(Type.EmptyTypes))
AssOptIL.Emit(OpCodes.Stloc, 10)
AssOptIL.MarkSequencePoint(doc5, 634, 1, 634, 100)
...
AssOptIL.MarkSequencePoint(doc5, 635, 1, 635, 100)
AssOptIL.Emit(OpCodes.Ldloc, 10)
Typ = GetType(TypeTok)
AssOptIL.Emit(OpCodes.Ldloc, 9)
Typ = GetType(Token)
...
AssOptIL.MarkSequencePoint(doc5, 636, 1, 636, 100)
AssOptIL.Emit(OpCodes.Ldloc, 5)
Typ = GetType(VarAsgnStmt)
AssOptIL.Emit(OpCodes.Ldloc, 10)
Typ = GetType(TypeTok)
AssOptIL.Emit(OpCodes.Stfld, GetType(VarAsgnStmt).GetField("VarTyp"))
AssOptIL.MarkSequencePoint(doc5, 637, 1, 637, 100)
AssOptIL.Emit(OpCodes.Br, cont215)
AssOptIL.MarkLabel(fa215)
AssOptIL.MarkSequencePoint(doc5, 638, 1, 638, 100)
AssOptIL.Emit(OpCodes.Ldloc, 5)
Typ = GetType(VarAsgnStmt)
AssOptIL.Emit(OpCodes.Ldloc, 1)
Typ = GetType(Expr)
...
Typ = Typ.GetElementType()
AssOptIL.Emit(OpCodes.Stfld, GetType(VarAsgnStmt).GetField("VarTyp"))
AssOptIL.MarkSequencePoint(doc5, 639, 1, 639, 100)
AssOptIL.Emit(OpCodes.Br, cont215)
AssOptIL.MarkLabel(cont215)
AssOptIL.MarkSequencePoint(doc5, 641, 1, 641, 100)
AssOptIL.Emit(OpCodes.Ldloc, 5)
Typ = GetType(VarAsgnStmt)
AssOptIL.Emit(OpCodes.Ldloc, 0)
Typ = GetType(AssignStmt)
...
AssOptIL.MarkSequencePoint(doc5, 642, 1, 642, 100)
Dim locbldr303 As LocalBuilder = AssOptIL.DeclareLocal(asm.GetType("dylan.NET.Tokenizer.Parser.ExprOptimizer"))
...
AssOptIL.MarkSequencePoint(doc5, 643, 1, 643, 100)
AssOptIL.Emit(OpCodes.Ldloc, 5)
Typ = GetType(VarAsgnStmt)
Dim typ111(-1) As Type
...
ReDim Preserve typ111(UBound(typ111) + 1)
typ111(UBound(typ111)) = Typ
AssOptIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("Optimize", typ111))
Typ = Typ03.GetMethod("Optimize", typ111).ReturnType
AssOptIL.Emit(OpCodes.Stfld, GetType(VarAsgnStmt).GetField("RExpr"))
AssOptIL.MarkSequencePoint(doc5, 645, 1, 645, 100)
AssOptIL.Emit(OpCodes.Ldloc, 5)
Typ = GetType(VarAsgnStmt)
AssOptIL.MarkSequencePoint(doc5, 646, 1, 646, 100)
AssOptIL.Emit(OpCodes.Br, cont214)
AssOptIL.MarkLabel(fa214)
AssOptIL.MarkSequencePoint(doc5, 647, 1, 647, 100)
AssOptIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
AssOptIL.MarkSequencePoint(doc5, 648, 1, 648, 100)
AssOptIL.Emit(OpCodes.Br, cont214)
AssOptIL.MarkLabel(cont214)
AssOptIL.MarkSequencePoint(doc5, 650, 1, 650, 100)
AssOptIL.Emit(OpCodes.Ret)
Dim typ112(-1) As Type
ReDim Preserve typ112(UBound(typ112) + 1)
typ112(UBound(typ112)) = GetType(Stmt)
ReDim Preserve typ112(UBound(typ112) + 1)
typ112(UBound(typ112)) = GetType(System.Boolean).MakeByRefType()
Dim checkAssign As MethodBuilder = StmtOptimizer.DefineMethod("checkAssign", MethodAttributes.Public, GetType(Stmt), typ112)
...
checkAssignIL.MarkSequencePoint(doc5, 653, 1, 653, 100)
Dim locbldr304 As LocalBuilder = checkAssignIL.DeclareLocal(GetType(Token))
locbldr304.SetLocalSymInfo("tok")
checkAssignIL.Emit(OpCodes.Ldnull)
checkAssignIL.Emit(OpCodes.Stloc, 0)
checkAssignIL.MarkSequencePoint(doc5, 654, 1, 654, 100)
Dim locbldr305 As LocalBuilder = checkAssignIL.DeclareLocal(GetType(System.Type))
locbldr305.SetLocalSymInfo("typ")
checkAssignIL.Emit(OpCodes.Ldtoken, GetType(AssignOp))
Dim typ113 As Type() = {GetType(System.RuntimeTypeHandle)}
checkAssignIL.Emit(OpCodes.Call, GetType(System.Type).GetMethod("GetTypeFromHandle", typ113))
Typ = GetType(System.Type).GetMethod("GetTypeFromHandle", typ113).ReturnType
checkAssignIL.Emit(OpCodes.Stloc, 1)
checkAssignIL.MarkSequencePoint(doc5, 655, 1, 655, 100)
Dim locbldr306 As LocalBuilder = checkAssignIL.DeclareLocal(GetType(AssignStmt))
locbldr306.SetLocalSymInfo("asss")
...
Dim locbldr307 As LocalBuilder = checkAssignIL.DeclareLocal(GetType(System.Boolean))
locbldr307.SetLocalSymInfo("c")
checkAssignIL.Emit(OpCodes.Ldc_I4, 0)
Typ = GetType(System.Boolean)
checkAssignIL.Emit(OpCodes.Stloc, 3)
checkAssignIL.MarkSequencePoint(doc5, 657, 1, 657, 100)
Dim locbldr308 As LocalBuilder = checkAssignIL.DeclareLocal(GetType(Expr))
locbldr308.SetLocalSymInfo("re")
checkAssignIL.Emit(OpCodes.Newobj, GetType(Expr).GetConstructor(Type.EmptyTypes))
checkAssignIL.Emit(OpCodes.Stloc, 4)
checkAssignIL.MarkSequencePoint(doc5, 658, 1, 658, 100)
Dim locbldr309 As LocalBuilder = checkAssignIL.DeclareLocal(GetType(Expr))
locbldr309.SetLocalSymInfo("le")
checkAssignIL.Emit(OpCodes.Newobj, GetType(Expr).GetConstructor(Type.EmptyTypes))
checkAssignIL.Emit(OpCodes.Stloc, 5)
checkAssignIL.MarkSequencePoint(doc5, 659, 1, 659, 100)
Dim locbldr310 As LocalBuilder = checkAssignIL.DeclareLocal(GetType(System.Int32))
locbldr310.SetLocalSymInfo("i")
checkAssignIL.Emit(OpCodes.Ldc_I4, CInt(-1))
Typ = GetType(System.Int32)
checkAssignIL.Emit(OpCodes.Stloc, 6)
checkAssignIL.MarkSequencePoint(doc5, 660, 1, 660, 100)
Dim locbldr311 As LocalBuilder = checkAssignIL.DeclareLocal(GetType(System.Int32))
locbldr311.SetLocalSymInfo("len")
...
checkAssignIL.MarkSequencePoint(doc5, 661, 1, 661, 100)
Dim locbldr312 As LocalBuilder = checkAssignIL.DeclareLocal(GetType(System.Int32))
locbldr312.SetLocalSymInfo("assind")
checkAssignIL.Emit(OpCodes.Ldc_I4, CInt(0))
Typ = GetType(System.Int32)
checkAssignIL.Emit(OpCodes.Stloc, 8)
checkAssignIL.MarkSequencePoint(doc5, 663, 1, 663, 100)
Dim label12 As System.Reflection.Emit.Label = checkAssignIL.DefineLabel()
checkAssignIL.MarkSequencePoint(doc5, 664, 1, 664, 100)
Dim label13 As System.Reflection.Emit.Label = checkAssignIL.DefineLabel()
checkAssignIL.MarkSequencePoint(doc5, 666, 1, 666, 100)
checkAssignIL.MarkLabel(label12)
checkAssignIL.MarkSequencePoint(doc5, 668, 1, 668, 100)
...
checkAssignIL.Emit(OpCodes.Stloc, 6)
checkAssignIL.MarkSequencePoint(doc5, 670, 1, 670, 100)
checkAssignIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
checkAssignIL.Emit(OpCodes.Ldfld, GetType(Stmt).GetField("Tokens"))
Typ = GetType(Stmt).GetField("Tokens").FieldType
...
Typ = Typ.GetElementType()
checkAssignIL.Emit(OpCodes.Stloc, 0)
checkAssignIL.MarkSequencePoint(doc5, 671, 1, 671, 100)
Dim typ114(-1) As Type
...
ReDim Preserve typ114(UBound(typ114) + 1)
typ114(UBound(typ114)) = Typ
checkAssignIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("IsInstanceOfType", typ114))
Typ = Typ03.GetMethod("IsInstanceOfType", typ114).ReturnType
checkAssignIL.Emit(OpCodes.Stloc, 3)
checkAssignIL.MarkSequencePoint(doc5, 673, 1, 673, 100)
checkAssignIL.Emit(OpCodes.Ldloc, 3)
Typ = GetType(System.Boolean)
checkAssignIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa216 As System.Reflection.Emit.Label = checkAssignIL.DefineLabel()
Dim tru216 As System.Reflection.Emit.Label = checkAssignIL.DefineLabel()
Dim cont216 As System.Reflection.Emit.Label = checkAssignIL.DefineLabel()
checkAssignIL.Emit(OpCodes.Beq, tru216)
checkAssignIL.Emit(OpCodes.Br, fa216)
checkAssignIL.MarkLabel(tru216)
checkAssignIL.MarkSequencePoint(doc5, 674, 1, 674, 100)
checkAssignIL.Emit(OpCodes.Ldloc, 6)
Typ = GetType(System.Int32)
checkAssignIL.Emit(OpCodes.Stloc, 8)
checkAssignIL.MarkSequencePoint(doc5, 675, 1, 675, 100)
checkAssignIL.Emit(OpCodes.Br, label13)
checkAssignIL.MarkSequencePoint(doc5, 676, 1, 676, 100)
checkAssignIL.Emit(OpCodes.Br, cont216)
checkAssignIL.MarkLabel(fa216)
checkAssignIL.Emit(OpCodes.Br, cont216)
checkAssignIL.MarkLabel(cont216)
checkAssignIL.MarkSequencePoint(doc5, 678, 1, 678, 100)
checkAssignIL.Emit(OpCodes.Ldloc, 6)
Typ = GetType(System.Int32)
checkAssignIL.Emit(OpCodes.Ldloc, 7)
Typ = GetType(System.Int32)
Dim fa217 As System.Reflection.Emit.Label = checkAssignIL.DefineLabel()
Dim tru217 As System.Reflection.Emit.Label = checkAssignIL.DefineLabel()
Dim cont217 As System.Reflection.Emit.Label = checkAssignIL.DefineLabel()
checkAssignIL.Emit(OpCodes.Beq, tru217)
checkAssignIL.Emit(OpCodes.Br, fa217)
checkAssignIL.MarkLabel(tru217)
checkAssignIL.MarkSequencePoint(doc5, 679, 1, 679, 100)
checkAssignIL.Emit(OpCodes.Br, label13)
checkAssignIL.MarkSequencePoint(doc5, 680, 1, 680, 100)
checkAssignIL.Emit(OpCodes.Br, cont217)
checkAssignIL.MarkLabel(fa217)
checkAssignIL.MarkSequencePoint(doc5, 681, 1, 681, 100)
checkAssignIL.Emit(OpCodes.Br, label12)
checkAssignIL.MarkSequencePoint(doc5, 682, 1, 682, 100)
checkAssignIL.Emit(OpCodes.Br, cont217)
checkAssignIL.MarkLabel(cont217)
checkAssignIL.MarkSequencePoint(doc5, 684, 1, 684, 100)
checkAssignIL.MarkLabel(label13)
checkAssignIL.MarkSequencePoint(doc5, 686, 1, 686, 100)
checkAssignIL.Emit(OpCodes.Ldloc, 8)
Typ = GetType(System.Int32)
checkAssignIL.Emit(OpCodes.Ldc_I4, CInt(0))
Typ = GetType(System.Int32)
Dim fa218 As System.Reflection.Emit.Label = checkAssignIL.DefineLabel()
Dim tru218 As System.Reflection.Emit.Label = checkAssignIL.DefineLabel()
Dim cont218 As System.Reflection.Emit.Label = checkAssignIL.DefineLabel()
checkAssignIL.Emit(OpCodes.Beq, fa218)
checkAssignIL.Emit(OpCodes.Br, tru218)
checkAssignIL.MarkLabel(tru218)
checkAssignIL.MarkSequencePoint(doc5, 688, 1, 688, 100)
checkAssignIL.Emit(OpCodes.Ldc_I4, CInt(-1))
Typ = GetType(System.Int32)
checkAssignIL.Emit(OpCodes.Stloc, 6)
checkAssignIL.MarkSequencePoint(doc5, 689, 1, 689, 100)
checkAssignIL.Emit(OpCodes.Ldloc, 8)
Typ = GetType(System.Int32)
checkAssignIL.Emit(OpCodes.Ldc_I4, CInt(1))
Typ = GetType(System.Int32)
checkAssignIL.Emit(OpCodes.Sub)
checkAssignIL.Emit(OpCodes.Stloc, 7)
checkAssignIL.MarkSequencePoint(doc5, 691, 1, 691, 100)
Dim label14 As System.Reflection.Emit.Label = checkAssignIL.DefineLabel()
checkAssignIL.MarkSequencePoint(doc5, 692, 1, 692, 100)
Dim label15 As System.Reflection.Emit.Label = checkAssignIL.DefineLabel()
checkAssignIL.MarkSequencePoint(doc5, 694, 1, 694, 100)
checkAssignIL.MarkLabel(label14)
checkAssignIL.MarkSequencePoint(doc5, 696, 1, 696, 100)
checkAssignIL.Emit(OpCodes.Ldloc, 6)
Typ = GetType(System.Int32)
checkAssignIL.Emit(OpCodes.Ldc_I4, CInt(1))
Typ = GetType(System.Int32)
checkAssignIL.Emit(OpCodes.Add)
checkAssignIL.Emit(OpCodes.Stloc, 6)
checkAssignIL.MarkSequencePoint(doc5, 698, 1, 698, 100)
...
checkAssignIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("AddToken", typ115))
Typ = Typ03.GetMethod("AddToken", typ115).ReturnType
If Typ.ToString() = GetType(System.Void).ToString() Then

Else
checkAssignIL.Emit(OpCodes.Pop)
End If
checkAssignIL.MarkSequencePoint(doc5, 700, 1, 700, 100)
checkAssignIL.Emit(OpCodes.Ldloc, 6)
Typ = GetType(System.Int32)
checkAssignIL.Emit(OpCodes.Ldloc, 7)
Typ = GetType(System.Int32)
Dim fa219 As System.Reflection.Emit.Label = checkAssignIL.DefineLabel()
Dim tru219 As System.Reflection.Emit.Label = checkAssignIL.DefineLabel()
Dim cont219 As System.Reflection.Emit.Label = checkAssignIL.DefineLabel()
checkAssignIL.Emit(OpCodes.Beq, tru219)
checkAssignIL.Emit(OpCodes.Br, fa219)
checkAssignIL.MarkLabel(tru219)
checkAssignIL.MarkSequencePoint(doc5, 701, 1, 701, 100)
checkAssignIL.Emit(OpCodes.Br, label15)
checkAssignIL.MarkSequencePoint(doc5, 702, 1, 702, 100)
checkAssignIL.Emit(OpCodes.Br, cont219)
checkAssignIL.MarkLabel(fa219)
checkAssignIL.MarkSequencePoint(doc5, 703, 1, 703, 100)
checkAssignIL.Emit(OpCodes.Br, label14)
checkAssignIL.MarkSequencePoint(doc5, 704, 1, 704, 100)
checkAssignIL.Emit(OpCodes.Br, cont219)
checkAssignIL.MarkLabel(cont219)
checkAssignIL.MarkSequencePoint(doc5, 706, 1, 706, 100)
checkAssignIL.MarkLabel(label15)
checkAssignIL.MarkSequencePoint(doc5, 709, 1, 709, 100)
checkAssignIL.Emit(OpCodes.Ldloc, 8)
Typ = GetType(System.Int32)
checkAssignIL.Emit(OpCodes.Stloc, 6)
checkAssignIL.MarkSequencePoint(doc5, 710, 1, 710, 100)
checkAssignIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
checkAssignIL.Emit(OpCodes.Ldfld, GetType(Stmt).GetField("Tokens"))
Typ = GetType(Stmt).GetField("Tokens").FieldType
...
checkAssignIL.Emit(OpCodes.Sub)
checkAssignIL.Emit(OpCodes.Stloc, 7)
checkAssignIL.MarkSequencePoint(doc5, 712, 1, 712, 100)
Dim label16 As System.Reflection.Emit.Label = checkAssignIL.DefineLabel()
checkAssignIL.MarkSequencePoint(doc5, 713, 1, 713, 100)
Dim label17 As System.Reflection.Emit.Label = checkAssignIL.DefineLabel()
checkAssignIL.MarkSequencePoint(doc5, 715, 1, 715, 100)
checkAssignIL.MarkLabel(label16)
checkAssignIL.MarkSequencePoint(doc5, 717, 1, 717, 100)
checkAssignIL.Emit(OpCodes.Ldloc, 6)
Typ = GetType(System.Int32)
checkAssignIL.Emit(OpCodes.Ldc_I4, CInt(1))
Typ = GetType(System.Int32)
checkAssignIL.Emit(OpCodes.Add)
checkAssignIL.Emit(OpCodes.Stloc, 6)
checkAssignIL.MarkSequencePoint(doc5, 719, 1, 719, 100)
Dim typ116(-1) As Type
...
ReDim Preserve typ116(UBound(typ116) + 1)
typ116(UBound(typ116)) = Typ
checkAssignIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("AddToken", typ116))
...
checkAssignIL.Emit(OpCodes.Pop)
End If
checkAssignIL.MarkSequencePoint(doc5, 721, 1, 721, 100)
checkAssignIL.Emit(OpCodes.Ldloc, 6)
Typ = GetType(System.Int32)
checkAssignIL.Emit(OpCodes.Ldloc, 7)
Typ = GetType(System.Int32)
Dim fa220 As System.Reflection.Emit.Label = checkAssignIL.DefineLabel()
Dim tru220 As System.Reflection.Emit.Label = checkAssignIL.DefineLabel()
Dim cont220 As System.Reflection.Emit.Label = checkAssignIL.DefineLabel()
checkAssignIL.Emit(OpCodes.Beq, tru220)
checkAssignIL.Emit(OpCodes.Br, fa220)
checkAssignIL.MarkLabel(tru220)
checkAssignIL.MarkSequencePoint(doc5, 722, 1, 722, 100)
checkAssignIL.Emit(OpCodes.Br, label17)
checkAssignIL.MarkSequencePoint(doc5, 723, 1, 723, 100)
checkAssignIL.Emit(OpCodes.Br, cont220)
checkAssignIL.MarkLabel(fa220)
checkAssignIL.MarkSequencePoint(doc5, 724, 1, 724, 100)
checkAssignIL.Emit(OpCodes.Br, label16)
checkAssignIL.MarkSequencePoint(doc5, 725, 1, 725, 100)
checkAssignIL.Emit(OpCodes.Br, cont220)
checkAssignIL.MarkLabel(cont220)
checkAssignIL.MarkSequencePoint(doc5, 727, 1, 727, 100)
checkAssignIL.MarkLabel(label17)
checkAssignIL.MarkSequencePoint(doc5, 729, 1, 729, 100)
Dim locbldr313 As LocalBuilder = checkAssignIL.DeclareLocal(asm.GetType("dylan.NET.Tokenizer.Parser.ExprOptimizer"))
locbldr313.SetLocalSymInfo("eop")
...
checkAssignIL.MarkSequencePoint(doc5, 730, 1, 730, 100)
Dim typ117(-1) As Type
...
ReDim Preserve typ117(UBound(typ117) + 1)
typ117(UBound(typ117)) = Typ
checkAssignIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("Optimize", typ117))
Typ = Typ03.GetMethod("Optimize", typ117).ReturnType
checkAssignIL.Emit(OpCodes.Stloc, 4)
checkAssignIL.MarkSequencePoint(doc5, 731, 1, 731, 100)
Dim typ118(-1) As Type
checkAssignIL.Emit(OpCodes.Ldloc, 9)
Typ = asm.GetType("dylan.NET.Tokenizer.Parser.ExprOptimizer")
Typ03 = Typ
...
ReDim Preserve typ118(UBound(typ118) + 1)
typ118(UBound(typ118)) = Typ
checkAssignIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("Optimize", typ118))
Typ = Typ03.GetMethod("Optimize", typ118).ReturnType
checkAssignIL.Emit(OpCodes.Stloc, 5)
checkAssignIL.MarkSequencePoint(doc5, 733, 1, 733, 100)
...
checkAssignIL.MarkSequencePoint(doc5, 734, 1, 734, 100)
checkAssignIL.Emit(OpCodes.Ldloc, 2)
Typ = GetType(AssignStmt)
checkAssignIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
...
checkAssignIL.MarkSequencePoint(doc5, 735, 1, 735, 100)
checkAssignIL.Emit(OpCodes.Ldloc, 2)
Typ = GetType(AssignStmt)
checkAssignIL.Emit(OpCodes.Ldloc, 5)
Typ = GetType(Expr)
checkAssignIL.Emit(OpCodes.Stfld, GetType(AssignStmt).GetField("LExp"))
checkAssignIL.MarkSequencePoint(doc5, 736, 1, 736, 100)
checkAssignIL.Emit(OpCodes.Ldloc, 2)
Typ = GetType(AssignStmt)
checkAssignIL.Emit(OpCodes.Ldloc, 4)
Typ = GetType(Expr)
checkAssignIL.Emit(OpCodes.Stfld, GetType(AssignStmt).GetField("RExp"))
checkAssignIL.MarkSequencePoint(doc5, 738, 1, 738, 100)
...
checkAssignIL.MarkSequencePoint(doc5, 740, 1, 740, 100)
...
checkAssignIL.Emit(OpCodes.Stloc, 2)
checkAssignIL.MarkSequencePoint(doc5, 742, 1, 742, 100)
checkAssignIL.Emit(OpCodes.Ldloc, 2)
Typ = GetType(AssignStmt)
checkAssignIL.MarkSequencePoint(doc5, 744, 1, 744, 100)
checkAssignIL.Emit(OpCodes.Br, cont218)
checkAssignIL.MarkLabel(fa218)
checkAssignIL.MarkSequencePoint(doc5, 745, 1, 745, 100)
checkAssignIL.Emit(OpCodes.Ldarg, 2)
Typ = GetType(System.Boolean).MakeByRefType()
Typ04 = Typ.GetElementType()
checkAssignIL.Emit(OpCodes.Ldc_I4, 0)
Typ = GetType(System.Boolean)
checkAssignIL.Emit(OpCodes.Stobj, Typ04)
checkAssignIL.MarkSequencePoint(doc5, 746, 1, 746, 100)
checkAssignIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
checkAssignIL.MarkSequencePoint(doc5, 748, 1, 748, 100)
checkAssignIL.Emit(OpCodes.Br, cont218)
checkAssignIL.MarkLabel(cont218)
checkAssignIL.MarkSequencePoint(doc5, 750, 1, 750, 100)
checkAssignIL.Emit(OpCodes.Ret)
Dim typ120(-1) As Type
ReDim Preserve typ120(UBound(typ120) + 1)
typ120(UBound(typ120)) = GetType(Stmt)
Dim Optimize As MethodBuilder = StmtOptimizer.DefineMethod("Optimize", MethodAttributes.Public, GetType(Stmt), typ120)
Dim OptimizeIL As ILGenerator = Optimize.GetILGenerator()
...
Dim locbldr314 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(System.Int32))
locbldr314.SetLocalSymInfo("i")
OptimizeIL.Emit(OpCodes.Ldc_I4, CInt(-1))
Typ = GetType(System.Int32)
OptimizeIL.Emit(OpCodes.Stloc, 0)
OptimizeIL.MarkSequencePoint(doc5, 757, 1, 757, 100)
Dim locbldr315 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(System.Int32))
locbldr315.SetLocalSymInfo("len")
OptimizeIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
...
Dim locbldr316 As LocalBuilder = OptimizeIL.DeclareLocal(asm.GetType("dylan.NET.Tokenizer.Parser.TokenOptimizer"))
locbldr316.SetLocalSymInfo("to")
OptimizeIL.Emit(OpCodes.Ldnull)
OptimizeIL.Emit(OpCodes.Stloc, 2)
OptimizeIL.MarkSequencePoint(doc5, 759, 1, 759, 100)
Dim locbldr317 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(Stmt))
locbldr317.SetLocalSymInfo("tmpstm")
OptimizeIL.Emit(OpCodes.Ldnull)
OptimizeIL.Emit(OpCodes.Stloc, 3)
OptimizeIL.MarkSequencePoint(doc5, 760, 1, 760, 100)
Dim locbldr318 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(System.Boolean))
locbldr318.SetLocalSymInfo("compb")
OptimizeIL.Emit(OpCodes.Ldc_I4, 0)
Typ = GetType(System.Boolean)
OptimizeIL.Emit(OpCodes.Stloc, 4)
...
Typ = GetType(System.Boolean)
OptimizeIL.Emit(OpCodes.Stsfld, asm.GetType("dylan.NET.Tokenizer.Parser.ParserFlags").GetField("IfFlag"))
OptimizeIL.MarkSequencePoint(doc5, 764, 1, 764, 100)
OptimizeIL.Emit(OpCodes.Ldc_I4, 0)
Typ = GetType(System.Boolean)
OptimizeIL.Emit(OpCodes.Stsfld, asm.GetType("dylan.NET.Tokenizer.Parser.ParserFlags").GetField("CmtFlag"))
...
Dim label20 As System.Reflection.Emit.Label = OptimizeIL.DefineLabel()
OptimizeIL.MarkSequencePoint(doc5, 771, 1, 771, 100)
OptimizeIL.Emit(OpCodes.Ldloc, 1)
Typ = GetType(System.Int32)
OptimizeIL.Emit(OpCodes.Ldc_I4, CInt(0))
Typ = GetType(System.Int32)
Dim fa221 As System.Reflection.Emit.Label = OptimizeIL.DefineLabel()
Dim tru221 As System.Reflection.Emit.Label = OptimizeIL.DefineLabel()
Dim cont221 As System.Reflection.Emit.Label = OptimizeIL.DefineLabel()
OptimizeIL.Emit(OpCodes.Blt, tru221)
OptimizeIL.Emit(OpCodes.Br, fa221)
OptimizeIL.MarkLabel(tru221)
OptimizeIL.MarkSequencePoint(doc5, 772, 1, 772, 100)
OptimizeIL.Emit(OpCodes.Br, label19)
OptimizeIL.MarkSequencePoint(doc5, 773, 1, 773, 100)
OptimizeIL.Emit(OpCodes.Br, cont221)
OptimizeIL.MarkLabel(fa221)
OptimizeIL.Emit(OpCodes.Br, cont221)
OptimizeIL.MarkLabel(cont221)
...
OptimizeIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa222 As System.Reflection.Emit.Label = OptimizeIL.DefineLabel()
Dim tru222 As System.Reflection.Emit.Label = OptimizeIL.DefineLabel()
Dim cont222 As System.Reflection.Emit.Label = OptimizeIL.DefineLabel()
OptimizeIL.Emit(OpCodes.Beq, tru222)
OptimizeIL.Emit(OpCodes.Br, fa222)
OptimizeIL.MarkLabel(tru222)
OptimizeIL.MarkSequencePoint(doc5, 780, 1, 780, 100)
OptimizeIL.Emit(OpCodes.Br, label19)
OptimizeIL.MarkSequencePoint(doc5, 781, 1, 781, 100)
OptimizeIL.Emit(OpCodes.Br, cont222)
OptimizeIL.MarkLabel(fa222)
OptimizeIL.Emit(OpCodes.Br, cont222)
OptimizeIL.MarkLabel(cont222)
...
OptimizeIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa223 As System.Reflection.Emit.Label = OptimizeIL.DefineLabel()
Dim tru223 As System.Reflection.Emit.Label = OptimizeIL.DefineLabel()
Dim cont223 As System.Reflection.Emit.Label = OptimizeIL.DefineLabel()
OptimizeIL.Emit(OpCodes.Beq, tru223)
OptimizeIL.Emit(OpCodes.Br, fa223)
OptimizeIL.MarkLabel(tru223)
OptimizeIL.MarkSequencePoint(doc5, 785, 1, 785, 100)
OptimizeIL.Emit(OpCodes.Br, label19)
OptimizeIL.MarkSequencePoint(doc5, 786, 1, 786, 100)
OptimizeIL.Emit(OpCodes.Br, cont223)
OptimizeIL.MarkLabel(fa223)
OptimizeIL.Emit(OpCodes.Br, cont223)
OptimizeIL.MarkLabel(cont223)
...
ReDim Preserve typ121(UBound(typ121) + 1)
typ121(UBound(typ121)) = Typ
OptimizeIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("Optimize", typ121))
Typ = Typ03.GetMethod("Optimize", typ121).ReturnType
Typ = Typ02
OptimizeIL.Emit(OpCodes.Stelem, Typ.GetElementType())
...
OptimizeIL.Emit(OpCodes.Ldloc, 1)
Typ = GetType(System.Int32)
Dim fa224 As System.Reflection.Emit.Label = OptimizeIL.DefineLabel()
Dim tru224 As System.Reflection.Emit.Label = OptimizeIL.DefineLabel()
Dim cont224 As System.Reflection.Emit.Label = OptimizeIL.DefineLabel()
OptimizeIL.Emit(OpCodes.Beq, tru224)
OptimizeIL.Emit(OpCodes.Br, fa224)
OptimizeIL.MarkLabel(tru224)
OptimizeIL.MarkSequencePoint(doc5, 792, 1, 792, 100)
OptimizeIL.Emit(OpCodes.Br, label19)
OptimizeIL.MarkSequencePoint(doc5, 793, 1, 793, 100)
OptimizeIL.Emit(OpCodes.Br, cont224)
OptimizeIL.MarkLabel(fa224)
OptimizeIL.MarkSequencePoint(doc5, 794, 1, 794, 100)
OptimizeIL.Emit(OpCodes.Br, label18)
OptimizeIL.MarkSequencePoint(doc5, 795, 1, 795, 100)
OptimizeIL.Emit(OpCodes.Br, cont224)
OptimizeIL.MarkLabel(cont224)
OptimizeIL.MarkSequencePoint(doc5, 797, 1, 797, 100)
OptimizeIL.MarkLabel(label19)
OptimizeIL.MarkSequencePoint(doc5, 799, 1, 799, 100)
OptimizeIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
OptimizeIL.Emit(OpCodes.Ldfld, GetType(Stmt).GetField("Tokens"))
Typ = GetType(Stmt).GetField("Tokens").FieldType
...
OptimizeIL.Emit(OpCodes.Ldc_I4, CInt(0))
Typ = GetType(System.Int32)
Dim fa225 As System.Reflection.Emit.Label = OptimizeIL.DefineLabel()
Dim tru225 As System.Reflection.Emit.Label = OptimizeIL.DefineLabel()
Dim cont225 As System.Reflection.Emit.Label = OptimizeIL.DefineLabel()
OptimizeIL.Emit(OpCodes.Beq, tru225)
OptimizeIL.Emit(OpCodes.Br, fa225)
OptimizeIL.MarkLabel(tru225)
OptimizeIL.MarkSequencePoint(doc5, 800, 1, 800, 100)
OptimizeIL.Emit(OpCodes.Br, label20)
OptimizeIL.MarkSequencePoint(doc5, 801, 1, 801, 100)
OptimizeIL.Emit(OpCodes.Br, cont225)
OptimizeIL.MarkLabel(fa225)
OptimizeIL.Emit(OpCodes.Br, cont225)
OptimizeIL.MarkLabel(cont225)
...
OptimizeIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa226 As System.Reflection.Emit.Label = OptimizeIL.DefineLabel()
Dim tru226 As System.Reflection.Emit.Label = OptimizeIL.DefineLabel()
Dim cont226 As System.Reflection.Emit.Label = OptimizeIL.DefineLabel()
OptimizeIL.Emit(OpCodes.Beq, tru226)
OptimizeIL.Emit(OpCodes.Br, fa226)
OptimizeIL.MarkLabel(tru226)
OptimizeIL.MarkSequencePoint(doc5, 806, 1, 806, 100)
OptimizeIL.Emit(OpCodes.Ldloc, 3)
Typ = GetType(Stmt)
OptimizeIL.Emit(OpCodes.Starg, 1)
OptimizeIL.MarkSequencePoint(doc5, 807, 1, 807, 100)
OptimizeIL.Emit(OpCodes.Br, label20)
OptimizeIL.MarkSequencePoint(doc5, 808, 1, 808, 100)
OptimizeIL.Emit(OpCodes.Br, cont226)
OptimizeIL.MarkLabel(fa226)
OptimizeIL.Emit(OpCodes.Br, cont226)
OptimizeIL.MarkLabel(cont226)
...
OptimizeIL.Emit(OpCodes.Stloc, 3)
OptimizeIL.MarkSequencePoint(doc5, 812, 1, 812, 100)
OptimizeIL.Emit(OpCodes.Ldloc, 4)
Typ = GetType(System.Boolean)
OptimizeIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa227 As System.Reflection.Emit.Label = OptimizeIL.DefineLabel()
Dim tru227 As System.Reflection.Emit.Label = OptimizeIL.DefineLabel()
Dim cont227 As System.Reflection.Emit.Label = OptimizeIL.DefineLabel()
OptimizeIL.Emit(OpCodes.Beq, tru227)
OptimizeIL.Emit(OpCodes.Br, fa227)
OptimizeIL.MarkLabel(tru227)
OptimizeIL.MarkSequencePoint(doc5, 813, 1, 813, 100)
OptimizeIL.Emit(OpCodes.Ldloc, 3)
Typ = GetType(Stmt)
OptimizeIL.Emit(OpCodes.Starg, 1)
OptimizeIL.MarkSequencePoint(doc5, 814, 1, 814, 100)
OptimizeIL.Emit(OpCodes.Br, label20)
OptimizeIL.MarkSequencePoint(doc5, 815, 1, 815, 100)
OptimizeIL.Emit(OpCodes.Br, cont227)
OptimizeIL.MarkLabel(fa227)
OptimizeIL.Emit(OpCodes.Br, cont227)
OptimizeIL.MarkLabel(cont227)
OptimizeIL.MarkSequencePoint(doc5, 817, 1, 817, 100)
OptimizeIL.Emit(OpCodes.Ldarg_0)
Dim typ124(-1) As Type
OptimizeIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
...
OptimizeIL.Emit(OpCodes.Stloc, 3)
OptimizeIL.MarkSequencePoint(doc5, 819, 1, 819, 100)
OptimizeIL.Emit(OpCodes.Ldloc, 4)
Typ = GetType(System.Boolean)
OptimizeIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa228 As System.Reflection.Emit.Label = OptimizeIL.DefineLabel()
Dim tru228 As System.Reflection.Emit.Label = OptimizeIL.DefineLabel()
Dim cont228 As System.Reflection.Emit.Label = OptimizeIL.DefineLabel()
OptimizeIL.Emit(OpCodes.Beq, tru228)
OptimizeIL.Emit(OpCodes.Br, fa228)
OptimizeIL.MarkLabel(tru228)
OptimizeIL.MarkSequencePoint(doc5, 820, 1, 820, 100)
OptimizeIL.Emit(OpCodes.Ldloc, 3)
Typ = GetType(Stmt)
OptimizeIL.Emit(OpCodes.Starg, 1)
OptimizeIL.MarkSequencePoint(doc5, 821, 1, 821, 100)
OptimizeIL.Emit(OpCodes.Br, label20)
OptimizeIL.MarkSequencePoint(doc5, 822, 1, 822, 100)
OptimizeIL.Emit(OpCodes.Br, cont228)
OptimizeIL.MarkLabel(fa228)
OptimizeIL.Emit(OpCodes.Br, cont228)
OptimizeIL.MarkLabel(cont228)
OptimizeIL.MarkSequencePoint(doc5, 824, 1, 824, 100)
OptimizeIL.Emit(OpCodes.Ldarg_0)
Dim typ125(-1) As Type
OptimizeIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
...
OptimizeIL.Emit(OpCodes.Stloc, 3)
OptimizeIL.MarkSequencePoint(doc5, 826, 1, 826, 100)
OptimizeIL.Emit(OpCodes.Ldloc, 4)
Typ = GetType(System.Boolean)
OptimizeIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa229 As System.Reflection.Emit.Label = OptimizeIL.DefineLabel()
Dim tru229 As System.Reflection.Emit.Label = OptimizeIL.DefineLabel()
Dim cont229 As System.Reflection.Emit.Label = OptimizeIL.DefineLabel()
OptimizeIL.Emit(OpCodes.Beq, tru229)
OptimizeIL.Emit(OpCodes.Br, fa229)
OptimizeIL.MarkLabel(tru229)
OptimizeIL.MarkSequencePoint(doc5, 827, 1, 827, 100)
OptimizeIL.Emit(OpCodes.Ldloc, 3)
Typ = GetType(Stmt)
OptimizeIL.Emit(OpCodes.Starg, 1)
OptimizeIL.MarkSequencePoint(doc5, 828, 1, 828, 100)
OptimizeIL.Emit(OpCodes.Br, label20)
OptimizeIL.MarkSequencePoint(doc5, 829, 1, 829, 100)
OptimizeIL.Emit(OpCodes.Br, cont229)
OptimizeIL.MarkLabel(fa229)
OptimizeIL.Emit(OpCodes.Br, cont229)
OptimizeIL.MarkLabel(cont229)
OptimizeIL.MarkSequencePoint(doc5, 831, 1, 831, 100)
OptimizeIL.Emit(OpCodes.Ldarg_0)
...
OptimizeIL.Emit(OpCodes.Stloc, 3)
OptimizeIL.MarkSequencePoint(doc5, 833, 1, 833, 100)
OptimizeIL.Emit(OpCodes.Ldloc, 4)
Typ = GetType(System.Boolean)
OptimizeIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa230 As System.Reflection.Emit.Label = OptimizeIL.DefineLabel()
Dim tru230 As System.Reflection.Emit.Label = OptimizeIL.DefineLabel()
Dim cont230 As System.Reflection.Emit.Label = OptimizeIL.DefineLabel()
OptimizeIL.Emit(OpCodes.Beq, tru230)
OptimizeIL.Emit(OpCodes.Br, fa230)
OptimizeIL.MarkLabel(tru230)
OptimizeIL.MarkSequencePoint(doc5, 834, 1, 834, 100)
OptimizeIL.Emit(OpCodes.Ldloc, 3)
Typ = GetType(Stmt)
OptimizeIL.Emit(OpCodes.Starg, 1)
OptimizeIL.MarkSequencePoint(doc5, 835, 1, 835, 100)
OptimizeIL.Emit(OpCodes.Br, label20)
OptimizeIL.MarkSequencePoint(doc5, 836, 1, 836, 100)
OptimizeIL.Emit(OpCodes.Br, cont230)
OptimizeIL.MarkLabel(fa230)
OptimizeIL.Emit(OpCodes.Br, cont230)
OptimizeIL.MarkLabel(cont230)
OptimizeIL.MarkSequencePoint(doc5, 838, 1, 838, 100)
OptimizeIL.Emit(OpCodes.Ldarg_0)
Dim typ127(-1) As Type
OptimizeIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
...
OptimizeIL.Emit(OpCodes.Stloc, 3)
OptimizeIL.MarkSequencePoint(doc5, 840, 1, 840, 100)
OptimizeIL.Emit(OpCodes.Ldloc, 4)
Typ = GetType(System.Boolean)
OptimizeIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa231 As System.Reflection.Emit.Label = OptimizeIL.DefineLabel()
Dim tru231 As System.Reflection.Emit.Label = OptimizeIL.DefineLabel()
Dim cont231 As System.Reflection.Emit.Label = OptimizeIL.DefineLabel()
OptimizeIL.Emit(OpCodes.Beq, tru231)
OptimizeIL.Emit(OpCodes.Br, fa231)
OptimizeIL.MarkLabel(tru231)
OptimizeIL.MarkSequencePoint(doc5, 841, 1, 841, 100)
OptimizeIL.Emit(OpCodes.Ldloc, 3)
Typ = GetType(Stmt)
OptimizeIL.Emit(OpCodes.Starg, 1)
OptimizeIL.MarkSequencePoint(doc5, 842, 1, 842, 100)
OptimizeIL.Emit(OpCodes.Br, label20)
OptimizeIL.MarkSequencePoint(doc5, 843, 1, 843, 100)
OptimizeIL.Emit(OpCodes.Br, cont231)
OptimizeIL.MarkLabel(fa231)
OptimizeIL.Emit(OpCodes.Br, cont231)
OptimizeIL.MarkLabel(cont231)
OptimizeIL.MarkSequencePoint(doc5, 845, 1, 845, 100)
OptimizeIL.Emit(OpCodes.Ldarg_0)
Dim typ128(-1) As Type
OptimizeIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
...
OptimizeIL.Emit(OpCodes.Stloc, 3)
OptimizeIL.MarkSequencePoint(doc5, 847, 1, 847, 100)
OptimizeIL.Emit(OpCodes.Ldloc, 4)
Typ = GetType(System.Boolean)
OptimizeIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa232 As System.Reflection.Emit.Label = OptimizeIL.DefineLabel()
Dim tru232 As System.Reflection.Emit.Label = OptimizeIL.DefineLabel()
Dim cont232 As System.Reflection.Emit.Label = OptimizeIL.DefineLabel()
OptimizeIL.Emit(OpCodes.Beq, tru232)
OptimizeIL.Emit(OpCodes.Br, fa232)
OptimizeIL.MarkLabel(tru232)
OptimizeIL.MarkSequencePoint(doc5, 848, 1, 848, 100)
OptimizeIL.Emit(OpCodes.Ldloc, 3)
Typ = GetType(Stmt)
OptimizeIL.Emit(OpCodes.Starg, 1)
OptimizeIL.MarkSequencePoint(doc5, 849, 1, 849, 100)
OptimizeIL.Emit(OpCodes.Br, label20)
OptimizeIL.MarkSequencePoint(doc5, 850, 1, 850, 100)
OptimizeIL.Emit(OpCodes.Br, cont232)
OptimizeIL.MarkLabel(fa232)
OptimizeIL.Emit(OpCodes.Br, cont232)
OptimizeIL.MarkLabel(cont232)
OptimizeIL.MarkSequencePoint(doc5, 852, 1, 852, 100)
OptimizeIL.Emit(OpCodes.Ldarg_0)
Dim typ129(-1) As Type
OptimizeIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
...
OptimizeIL.Emit(OpCodes.Stloc, 3)
OptimizeIL.MarkSequencePoint(doc5, 854, 1, 854, 100)
OptimizeIL.Emit(OpCodes.Ldloc, 4)
Typ = GetType(System.Boolean)
OptimizeIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa233 As System.Reflection.Emit.Label = OptimizeIL.DefineLabel()
Dim tru233 As System.Reflection.Emit.Label = OptimizeIL.DefineLabel()
Dim cont233 As System.Reflection.Emit.Label = OptimizeIL.DefineLabel()
OptimizeIL.Emit(OpCodes.Beq, tru233)
OptimizeIL.Emit(OpCodes.Br, fa233)
OptimizeIL.MarkLabel(tru233)
OptimizeIL.MarkSequencePoint(doc5, 855, 1, 855, 100)
OptimizeIL.Emit(OpCodes.Ldloc, 3)
Typ = GetType(Stmt)
OptimizeIL.Emit(OpCodes.Starg, 1)
OptimizeIL.MarkSequencePoint(doc5, 856, 1, 856, 100)
OptimizeIL.Emit(OpCodes.Br, label20)
OptimizeIL.MarkSequencePoint(doc5, 857, 1, 857, 100)
OptimizeIL.Emit(OpCodes.Br, cont233)
OptimizeIL.MarkLabel(fa233)
OptimizeIL.Emit(OpCodes.Br, cont233)
OptimizeIL.MarkLabel(cont233)
OptimizeIL.MarkSequencePoint(doc5, 859, 1, 859, 100)
OptimizeIL.Emit(OpCodes.Ldarg_0)
Dim typ130(-1) As Type
OptimizeIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
...
OptimizeIL.Emit(OpCodes.Stloc, 3)
OptimizeIL.MarkSequencePoint(doc5, 861, 1, 861, 100)
OptimizeIL.Emit(OpCodes.Ldloc, 4)
Typ = GetType(System.Boolean)
OptimizeIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa234 As System.Reflection.Emit.Label = OptimizeIL.DefineLabel()
Dim tru234 As System.Reflection.Emit.Label = OptimizeIL.DefineLabel()
Dim cont234 As System.Reflection.Emit.Label = OptimizeIL.DefineLabel()
OptimizeIL.Emit(OpCodes.Beq, tru234)
OptimizeIL.Emit(OpCodes.Br, fa234)
OptimizeIL.MarkLabel(tru234)
OptimizeIL.MarkSequencePoint(doc5, 862, 1, 862, 100)
OptimizeIL.Emit(OpCodes.Ldloc, 3)
Typ = GetType(Stmt)
OptimizeIL.Emit(OpCodes.Starg, 1)
OptimizeIL.MarkSequencePoint(doc5, 863, 1, 863, 100)
OptimizeIL.Emit(OpCodes.Br, label20)
OptimizeIL.MarkSequencePoint(doc5, 864, 1, 864, 100)
OptimizeIL.Emit(OpCodes.Br, cont234)
OptimizeIL.MarkLabel(fa234)
OptimizeIL.Emit(OpCodes.Br, cont234)
OptimizeIL.MarkLabel(cont234)
OptimizeIL.MarkSequencePoint(doc5, 866, 1, 866, 100)
OptimizeIL.Emit(OpCodes.Ldarg_0)
...
OptimizeIL.Emit(OpCodes.Stloc, 3)
OptimizeIL.MarkSequencePoint(doc5, 868, 1, 868, 100)
OptimizeIL.Emit(OpCodes.Ldloc, 4)
Typ = GetType(System.Boolean)
OptimizeIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa235 As System.Reflection.Emit.Label = OptimizeIL.DefineLabel()
Dim tru235 As System.Reflection.Emit.Label = OptimizeIL.DefineLabel()
Dim cont235 As System.Reflection.Emit.Label = OptimizeIL.DefineLabel()
OptimizeIL.Emit(OpCodes.Beq, tru235)
OptimizeIL.Emit(OpCodes.Br, fa235)
OptimizeIL.MarkLabel(tru235)
OptimizeIL.MarkSequencePoint(doc5, 869, 1, 869, 100)
OptimizeIL.Emit(OpCodes.Ldloc, 3)
Typ = GetType(Stmt)
OptimizeIL.Emit(OpCodes.Starg, 1)
OptimizeIL.MarkSequencePoint(doc5, 870, 1, 870, 100)
OptimizeIL.Emit(OpCodes.Br, label20)
OptimizeIL.MarkSequencePoint(doc5, 871, 1, 871, 100)
OptimizeIL.Emit(OpCodes.Br, cont235)
OptimizeIL.MarkLabel(fa235)
OptimizeIL.Emit(OpCodes.Br, cont235)
OptimizeIL.MarkLabel(cont235)
OptimizeIL.MarkSequencePoint(doc5, 873, 1, 873, 100)
OptimizeIL.Emit(OpCodes.Ldarg_0)
Dim typ132(-1) As Type
OptimizeIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
...
OptimizeIL.Emit(OpCodes.Stloc, 3)
OptimizeIL.MarkSequencePoint(doc5, 875, 1, 875, 100)
OptimizeIL.Emit(OpCodes.Ldloc, 4)
Typ = GetType(System.Boolean)
OptimizeIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa236 As System.Reflection.Emit.Label = OptimizeIL.DefineLabel()
Dim tru236 As System.Reflection.Emit.Label = OptimizeIL.DefineLabel()
Dim cont236 As System.Reflection.Emit.Label = OptimizeIL.DefineLabel()
OptimizeIL.Emit(OpCodes.Beq, tru236)
OptimizeIL.Emit(OpCodes.Br, fa236)
OptimizeIL.MarkLabel(tru236)
OptimizeIL.MarkSequencePoint(doc5, 876, 1, 876, 100)
OptimizeIL.Emit(OpCodes.Ldloc, 3)
Typ = GetType(Stmt)
OptimizeIL.Emit(OpCodes.Starg, 1)
OptimizeIL.MarkSequencePoint(doc5, 877, 1, 877, 100)
OptimizeIL.Emit(OpCodes.Br, label20)
OptimizeIL.MarkSequencePoint(doc5, 878, 1, 878, 100)
OptimizeIL.Emit(OpCodes.Br, cont236)
OptimizeIL.MarkLabel(fa236)
OptimizeIL.Emit(OpCodes.Br, cont236)
OptimizeIL.MarkLabel(cont236)
OptimizeIL.MarkSequencePoint(doc5, 880, 1, 880, 100)
OptimizeIL.Emit(OpCodes.Ldarg_0)
...
OptimizeIL.Emit(OpCodes.Stloc, 3)
OptimizeIL.MarkSequencePoint(doc5, 882, 1, 882, 100)
OptimizeIL.Emit(OpCodes.Ldloc, 4)
Typ = GetType(System.Boolean)
OptimizeIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa237 As System.Reflection.Emit.Label = OptimizeIL.DefineLabel()
Dim tru237 As System.Reflection.Emit.Label = OptimizeIL.DefineLabel()
Dim cont237 As System.Reflection.Emit.Label = OptimizeIL.DefineLabel()
OptimizeIL.Emit(OpCodes.Beq, tru237)
OptimizeIL.Emit(OpCodes.Br, fa237)
OptimizeIL.MarkLabel(tru237)
OptimizeIL.MarkSequencePoint(doc5, 883, 1, 883, 100)
OptimizeIL.Emit(OpCodes.Ldloc, 3)
Typ = GetType(Stmt)
OptimizeIL.Emit(OpCodes.Starg, 1)
OptimizeIL.MarkSequencePoint(doc5, 884, 1, 884, 100)
OptimizeIL.Emit(OpCodes.Br, label20)
OptimizeIL.MarkSequencePoint(doc5, 885, 1, 885, 100)
OptimizeIL.Emit(OpCodes.Br, cont237)
OptimizeIL.MarkLabel(fa237)
OptimizeIL.Emit(OpCodes.Br, cont237)
OptimizeIL.MarkLabel(cont237)
OptimizeIL.MarkSequencePoint(doc5, 887, 1, 887, 100)
OptimizeIL.Emit(OpCodes.Ldarg_0)
Dim typ134(-1) As Type
OptimizeIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
...
OptimizeIL.Emit(OpCodes.Stloc, 3)
OptimizeIL.MarkSequencePoint(doc5, 889, 1, 889, 100)
OptimizeIL.Emit(OpCodes.Ldloc, 4)
Typ = GetType(System.Boolean)
OptimizeIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa238 As System.Reflection.Emit.Label = OptimizeIL.DefineLabel()
Dim tru238 As System.Reflection.Emit.Label = OptimizeIL.DefineLabel()
Dim cont238 As System.Reflection.Emit.Label = OptimizeIL.DefineLabel()
OptimizeIL.Emit(OpCodes.Beq, tru238)
OptimizeIL.Emit(OpCodes.Br, fa238)
OptimizeIL.MarkLabel(tru238)
OptimizeIL.MarkSequencePoint(doc5, 890, 1, 890, 100)
OptimizeIL.Emit(OpCodes.Ldloc, 3)
Typ = GetType(Stmt)
OptimizeIL.Emit(OpCodes.Starg, 1)
OptimizeIL.MarkSequencePoint(doc5, 891, 1, 891, 100)
OptimizeIL.Emit(OpCodes.Br, label20)
OptimizeIL.MarkSequencePoint(doc5, 892, 1, 892, 100)
OptimizeIL.Emit(OpCodes.Br, cont238)
OptimizeIL.MarkLabel(fa238)
OptimizeIL.Emit(OpCodes.Br, cont238)
OptimizeIL.MarkLabel(cont238)
OptimizeIL.MarkSequencePoint(doc5, 894, 1, 894, 100)
OptimizeIL.Emit(OpCodes.Ldarg_0)
Dim typ135(-1) As Type
OptimizeIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
...
OptimizeIL.Emit(OpCodes.Stloc, 3)
OptimizeIL.MarkSequencePoint(doc5, 896, 1, 896, 100)
OptimizeIL.Emit(OpCodes.Ldloc, 4)
Typ = GetType(System.Boolean)
OptimizeIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa239 As System.Reflection.Emit.Label = OptimizeIL.DefineLabel()
Dim tru239 As System.Reflection.Emit.Label = OptimizeIL.DefineLabel()
Dim cont239 As System.Reflection.Emit.Label = OptimizeIL.DefineLabel()
OptimizeIL.Emit(OpCodes.Beq, tru239)
OptimizeIL.Emit(OpCodes.Br, fa239)
OptimizeIL.MarkLabel(tru239)
OptimizeIL.MarkSequencePoint(doc5, 897, 1, 897, 100)
OptimizeIL.Emit(OpCodes.Ldloc, 3)
Typ = GetType(Stmt)
OptimizeIL.Emit(OpCodes.Starg, 1)
OptimizeIL.MarkSequencePoint(doc5, 898, 1, 898, 100)
OptimizeIL.Emit(OpCodes.Br, label20)
OptimizeIL.MarkSequencePoint(doc5, 899, 1, 899, 100)
OptimizeIL.Emit(OpCodes.Br, cont239)
OptimizeIL.MarkLabel(fa239)
OptimizeIL.Emit(OpCodes.Br, cont239)
OptimizeIL.MarkLabel(cont239)
OptimizeIL.MarkSequencePoint(doc5, 901, 1, 901, 100)
OptimizeIL.Emit(OpCodes.Ldarg_0)
Dim typ136(-1) As Type
OptimizeIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
...
OptimizeIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa240 As System.Reflection.Emit.Label = OptimizeIL.DefineLabel()
Dim tru240 As System.Reflection.Emit.Label = OptimizeIL.DefineLabel()
Dim cont240 As System.Reflection.Emit.Label = OptimizeIL.DefineLabel()
OptimizeIL.Emit(OpCodes.Beq, tru240)
OptimizeIL.Emit(OpCodes.Br, fa240)
OptimizeIL.MarkLabel(tru240)
...
OptimizeIL.Emit(OpCodes.Br, cont240)
OptimizeIL.MarkLabel(fa240)
OptimizeIL.Emit(OpCodes.Br, cont240)
OptimizeIL.MarkLabel(cont240)
OptimizeIL.MarkSequencePoint(doc5, 908, 1, 908, 100)
OptimizeIL.MarkLabel(label20)
...
Dim locbldr319 As LocalBuilder = ParseIL.DeclareLocal(GetType(System.Int32))
locbldr319.SetLocalSymInfo("i")
ParseIL.Emit(OpCodes.Ldc_I4, CInt(-1))
Typ = GetType(System.Int32)
ParseIL.Emit(OpCodes.Stloc, 0)
ParseIL.MarkSequencePoint(doc6, 13, 1, 13, 100)
Dim locbldr320 As LocalBuilder = ParseIL.DeclareLocal(asm.GetType("dylan.NET.Tokenizer.Parser.StmtOptimizer"))
locbldr320.SetLocalSymInfo("so")
ParseIL.Emit(OpCodes.Ldnull)
ParseIL.Emit(OpCodes.Stloc, 1)
ParseIL.MarkSequencePoint(doc6, 14, 1, 14, 100)
Dim locbldr321 As LocalBuilder = ParseIL.DeclareLocal(GetType(System.Int32))
locbldr321.SetLocalSymInfo("len")
...
ParseIL.Emit(OpCodes.Ldloc, 2)
Typ = GetType(System.Int32)
Dim fa241 As System.Reflection.Emit.Label = ParseIL.DefineLabel()
Dim tru241 As System.Reflection.Emit.Label = ParseIL.DefineLabel()
Dim cont241 As System.Reflection.Emit.Label = ParseIL.DefineLabel()
ParseIL.Emit(OpCodes.Beq, tru241)
ParseIL.Emit(OpCodes.Br, fa241)
ParseIL.MarkLabel(tru241)
ParseIL.MarkSequencePoint(doc6, 27, 1, 27, 100)
ParseIL.Emit(OpCodes.Br, label1)
ParseIL.MarkSequencePoint(doc6, 28, 1, 28, 100)
ParseIL.Emit(OpCodes.Br, cont241)
ParseIL.MarkLabel(fa241)
ParseIL.MarkSequencePoint(doc6, 29, 1, 29, 100)
ParseIL.Emit(OpCodes.Br, label0)
ParseIL.MarkSequencePoint(doc6, 30, 1, 30, 100)
ParseIL.Emit(OpCodes.Br, cont241)
ParseIL.MarkLabel(cont241)
