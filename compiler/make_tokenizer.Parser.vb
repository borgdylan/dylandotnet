...
Dim locbldr70 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(SpecialNameAttr))
locbldr70.SetLocalSymInfo("spnattr")
...
Dim locbldr71 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(AutoLayoutAttr))
locbldr71.SetLocalSymInfo("autattr")
...
Dim locbldr72 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(AutoClassAttr))
locbldr72.SetLocalSymInfo("autcattr")
...
Dim locbldr73 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(AnsiClassAttr))
locbldr73.SetLocalSymInfo("ansattr")
...
Dim locbldr74 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(BeforeFieldInitAttr))
locbldr74.SetLocalSymInfo("bfiattr")
...
Dim locbldr75 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(StringTok))
locbldr75.SetLocalSymInfo("strtok")
...
Dim locbldr76 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(VoidTok))
locbldr76.SetLocalSymInfo("voidtok")
...
Dim locbldr77 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(DecimalTok))
locbldr77.SetLocalSymInfo("decitok")
...
Dim locbldr78 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(IntegerTok))
locbldr78.SetLocalSymInfo("inttok")
...
Dim locbldr79 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(IntPtrTok))
locbldr79.SetLocalSymInfo("intptok")
...
Dim locbldr80 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(UIntegerTok))
locbldr80.SetLocalSymInfo("uinttok")
...
Dim locbldr81 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(DoubleTok))
locbldr81.SetLocalSymInfo("dbltok")
...
Dim locbldr82 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(BooleanTok))
locbldr82.SetLocalSymInfo("booltok")
...
Dim locbldr83 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(CharTok))
locbldr83.SetLocalSymInfo("chrtok")
...
Dim locbldr84 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(SingleTok))
locbldr84.SetLocalSymInfo("sngtok")
...
Dim locbldr85 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(SByteTok))
locbldr85.SetLocalSymInfo("sbytok")
...
Dim locbldr86 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(ByteTok))
locbldr86.SetLocalSymInfo("byttok")
...
Dim locbldr87 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(ShortTok))
locbldr87.SetLocalSymInfo("shtok")
...
Dim locbldr88 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(UShortTok))
locbldr88.SetLocalSymInfo("ushtok")
...
Dim locbldr89 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(LongTok))
locbldr89.SetLocalSymInfo("lngtok")
...
Dim locbldr90 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(ULongTok))
locbldr90.SetLocalSymInfo("ulngtok")
...
Dim locbldr91 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(ObjectTok))
locbldr91.SetLocalSymInfo("objtok")
...
Dim locbldr92 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(commentTok))
locbldr92.SetLocalSymInfo("comtok")
...
Dim locbldr93 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(NullLiteral))
locbldr93.SetLocalSymInfo("nulllit")
...
Dim locbldr94 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(BooleanLiteral))
locbldr94.SetLocalSymInfo("boolit")
...
Dim locbldr95 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(CharLiteral))
locbldr95.SetLocalSymInfo("chrlit")
...
ReDim Preserve typ115(UBound(typ115) + 1)
typ115(UBound(typ115)) = Typ
OptimizeIL.Emit(OpCodes.Call, GetType(String).GetMethod("Concat", typ115))
Typ = GetType(String).GetMethod("Concat", typ115).ReturnType
OptimizeIL.Emit(OpCodes.Stloc, 2)
...
Dim locbldr96 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(StringLiteral))
locbldr96.SetLocalSymInfo("strlit")
...
OptimizeIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("Trim", typ118))
Typ = Typ03.GetMethod("Trim", typ118).ReturnType
OptimizeIL.Emit(OpCodes.Stloc, 2)
...
locbldr97.SetLocalSymInfo("dlit2")
...
OptimizeIL.Emit(OpCodes.Call, GetType(System.Convert).GetMethod("ToDouble", typ125))
Typ = GetType(System.Convert).GetMethod("ToDouble", typ125).ReturnType
...
locbldr98.SetLocalSymInfo("flit")
...
OptimizeIL.Emit(OpCodes.Call, GetType(System.Convert).GetMethod("ToSingle", typ132))
Typ = GetType(System.Convert).GetMethod("ToSingle", typ132).ReturnType
...
locbldr99.SetLocalSymInfo("dlit")
OptimizeIL.Emit(OpCodes.Newobj, GetType(DoubleLiteral).GetConstructor(Type.EmptyTypes))
...
locbldr100.SetLocalSymInfo("dlit3")
OptimizeIL.Emit(OpCodes.Newobj, GetType(DoubleLiteral).GetConstructor(Type.EmptyTypes))
...
OptimizeIL.Emit(OpCodes.Call, GetType(System.Convert).GetMethod("ToDouble", typ143))
Typ = GetType(System.Convert).GetMethod("ToDouble", typ143).ReturnType
OptimizeIL.Emit(OpCodes.Stfld, GetType(DoubleLiteral).GetField("NumVal"))
...
locbldr101.SetLocalSymInfo("flit2")
OptimizeIL.Emit(OpCodes.Newobj, GetType(FloatLiteral).GetConstructor(Type.EmptyTypes))
...
OptimizeIL.Emit(OpCodes.Call, GetType(System.Convert).GetMethod("ToSingle", typ150))
Typ = GetType(System.Convert).GetMethod("ToSingle", typ150).ReturnType
OptimizeIL.Emit(OpCodes.Stfld, GetType(FloatLiteral).GetField("NumVal"))
...
Dim locbldr102 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(UIntLiteral))
locbldr102.SetLocalSymInfo("uilit2")
...
OptimizeIL.Emit(OpCodes.Call, GetType(Convert).GetMethod("ToUInt32", typ159))
Typ = GetType(Convert).GetMethod("ToUInt32", typ159).ReturnType
...
Dim locbldr103 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(IntPtrLiteral))
locbldr103.SetLocalSymInfo("iplit2")
...
OptimizeIL.Emit(OpCodes.Newobj, GetType(IntPtr).GetConstructor(typ168))
...
locbldr104.SetLocalSymInfo("ilit2")
...
OptimizeIL.Emit(OpCodes.Call, GetType(System.Convert).GetMethod("ToInt32", typ176))
Typ = GetType(System.Convert).GetMethod("ToInt32", typ176).ReturnType
...
OptimizeIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("EndsWith", typ180))
Typ = Typ03.GetMethod("EndsWith", typ180).ReturnType
OptimizeIL.Emit(OpCodes.Stloc, 1)
...
Dim locbldr105 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(ULongLiteral))
locbldr105.SetLocalSymInfo("ullit")
...
Typ = GetType(System.String)
Dim typ181 As Type() = {Typ}
OptimizeIL.Emit(OpCodes.Call, GetType(System.Convert).GetMethod("ToChar", typ181))
Typ = GetType(System.Convert).GetMethod("ToChar", typ181).ReturnType
OptimizeIL.Emit(OpCodes.Stelem, GetType(System.Char).MakeArrayType().GetElementType())
...
OptimizeIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("TrimEnd", typ182))
Typ = Typ03.GetMethod("TrimEnd", typ182).ReturnType
OptimizeIL.Emit(OpCodes.Stloc, 2)
...
OptimizeIL.Emit(OpCodes.Call, GetType(Convert).GetMethod("ToUInt64", typ185))
Typ = GetType(Convert).GetMethod("ToUInt64", typ185).ReturnType
...
Dim locbldr106 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(LongLiteral))
locbldr106.SetLocalSymInfo("llit")
...
OptimizeIL.Emit(OpCodes.Call, GetType(System.Convert).GetMethod("ToInt64", typ192))
Typ = GetType(System.Convert).GetMethod("ToInt64", typ192).ReturnType
...
OptimizeIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("EndsWith", typ196))
Typ = Typ03.GetMethod("EndsWith", typ196).ReturnType
OptimizeIL.Emit(OpCodes.Stloc, 1)
...
Dim locbldr107 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(UShortLiteral))
locbldr107.SetLocalSymInfo("uslit")
...
Typ = GetType(System.String)
Dim typ197 As Type() = {Typ}
OptimizeIL.Emit(OpCodes.Call, GetType(System.Convert).GetMethod("ToChar", typ197))
Typ = GetType(System.Convert).GetMethod("ToChar", typ197).ReturnType
OptimizeIL.Emit(OpCodes.Stelem, GetType(System.Char).MakeArrayType().GetElementType())
...
OptimizeIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("TrimEnd", typ198))
Typ = Typ03.GetMethod("TrimEnd", typ198).ReturnType
OptimizeIL.Emit(OpCodes.Stloc, 2)
...
OptimizeIL.Emit(OpCodes.Call, GetType(Convert).GetMethod("ToUInt16", typ201))
Typ = GetType(Convert).GetMethod("ToUInt16", typ201).ReturnType
...
Dim locbldr108 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(ShortLiteral))
locbldr108.SetLocalSymInfo("slit")
...
OptimizeIL.Emit(OpCodes.Call, GetType(System.Convert).GetMethod("ToInt16", typ208))
Typ = GetType(System.Convert).GetMethod("ToInt16", typ208).ReturnType
...
OptimizeIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("EndsWith", typ212))
Typ = Typ03.GetMethod("EndsWith", typ212).ReturnType
OptimizeIL.Emit(OpCodes.Stloc, 1)
...
Dim locbldr109 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(ByteLiteral))
locbldr109.SetLocalSymInfo("ublit")
...
Typ = GetType(System.String)
Dim typ213 As Type() = {Typ}
OptimizeIL.Emit(OpCodes.Call, GetType(System.Convert).GetMethod("ToChar", typ213))
Typ = GetType(System.Convert).GetMethod("ToChar", typ213).ReturnType
OptimizeIL.Emit(OpCodes.Stelem, GetType(System.Char).MakeArrayType().GetElementType())
...
OptimizeIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("TrimEnd", typ214))
Typ = Typ03.GetMethod("TrimEnd", typ214).ReturnType
OptimizeIL.Emit(OpCodes.Stloc, 2)
...
OptimizeIL.Emit(OpCodes.Call, GetType(Convert).GetMethod("ToByte", typ217))
Typ = GetType(Convert).GetMethod("ToByte", typ217).ReturnType
...
OptimizeIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("EndsWith", typ221))
Typ = Typ03.GetMethod("EndsWith", typ221).ReturnType
OptimizeIL.Emit(OpCodes.Stloc, 1)
...
Dim locbldr110 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(SByteLiteral))
locbldr110.SetLocalSymInfo("blit")
...
OptimizeIL.Emit(OpCodes.Call, GetType(System.Convert).GetMethod("ToChar", typ222))
Typ = GetType(System.Convert).GetMethod("ToChar", typ222).ReturnType
OptimizeIL.Emit(OpCodes.Stelem, GetType(System.Char).MakeArrayType().GetElementType())
...
OptimizeIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("TrimEnd", typ223))
Typ = Typ03.GetMethod("TrimEnd", typ223).ReturnType
OptimizeIL.Emit(OpCodes.Stloc, 2)
...
OptimizeIL.Emit(OpCodes.Call, GetType(System.Convert).GetMethod("ToSByte", typ224))
Typ = GetType(System.Convert).GetMethod("ToSByte", typ224).ReturnType
...
Dim locbldr111 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(IntLiteral))
locbldr111.SetLocalSymInfo("ilit")
OptimizeIL.Emit(OpCodes.Newobj, GetType(IntLiteral).GetConstructor(Type.EmptyTypes))
...
OptimizeIL.Emit(OpCodes.Ldfld, GetType(IntLiteral).GetField("Value"))
Typ = GetType(IntLiteral).GetField("Value").FieldType
Dim typ228 As Type() = {Typ}
OptimizeIL.Emit(OpCodes.Call, GetType(System.Convert).GetMethod("ToInt32", typ228))
Typ = GetType(System.Convert).GetMethod("ToInt32", typ228).ReturnType
OptimizeIL.Emit(OpCodes.Stfld, GetType(IntLiteral).GetField("NumVal"))
...
Dim locbldr112 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(Ident))
locbldr112.SetLocalSymInfo("idt")
...
Dim locbldr115 As LocalBuilder = checkVarAsIL.DeclareLocal(GetType(VarExpr))
locbldr115.SetLocalSymInfo("vars")
...
checkVarAsIL.Emit(OpCodes.Beq, tru112)
checkVarAsIL.Emit(OpCodes.Br, fa112)
...
locbldr116.SetLocalSymInfo("tok2")
checkVarAsIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Expr)
checkVarAsIL.Emit(OpCodes.Ldfld, GetType(Expr).GetField("Tokens"))
Typ = GetType(Expr).GetField("Tokens").FieldType
...
locbldr117.SetLocalSymInfo("typ2")
...
Dim locbldr118 As LocalBuilder = checkVarAsIL.DeclareLocal(GetType(System.Boolean))
locbldr118.SetLocalSymInfo("b2")
Dim typ4(-1) As Type
...
checkVarAsIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa113 As System.Reflection.Emit.Label = checkVarAsIL.DefineLabel()
Dim tru113 As System.Reflection.Emit.Label = checkVarAsIL.DefineLabel()
Dim cont113 As System.Reflection.Emit.Label = checkVarAsIL.DefineLabel()
checkVarAsIL.Emit(OpCodes.Beq, fa113)
checkVarAsIL.Emit(OpCodes.Br, tru113)
checkVarAsIL.MarkLabel(tru113)
checkVarAsIL.MarkSequencePoint(doc4, 27, 1, 27, 100)
Dim locbldr119 As LocalBuilder = checkVarAsIL.DeclareLocal(GetType(Token))
locbldr119.SetLocalSymInfo("t")
checkVarAsIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Expr)
checkVarAsIL.Emit(OpCodes.Ldfld, GetType(Expr).GetField("Tokens"))
Typ = GetType(Expr).GetField("Tokens").FieldType
...
Dim locbldr120 As LocalBuilder = checkVarAsIL.DeclareLocal(GetType(TypeTok))
locbldr120.SetLocalSymInfo("tt")
...
checkVarAsIL.Emit(OpCodes.Br, cont113)
checkVarAsIL.MarkLabel(fa113)
...
checkVarAsIL.Emit(OpCodes.Br, cont113)
checkVarAsIL.MarkLabel(cont113)
...
Dim locbldr121 As LocalBuilder = procMethodCallIL.DeclareLocal(GetType(MethodNameTok))
locbldr121.SetLocalSymInfo("mn")
...
Dim locbldr122 As LocalBuilder = procMethodCallIL.DeclareLocal(GetType(MethodCallTok))
locbldr122.SetLocalSymInfo("mct")
...
Dim locbldr123 As LocalBuilder = procMethodCallIL.DeclareLocal(GetType(Ident))
...
Dim locbldr124 As LocalBuilder = procMethodCallIL.DeclareLocal(GetType(Expr))
...
Dim locbldr126 As LocalBuilder = procMethodCallIL.DeclareLocal(GetType(System.Boolean))
...
Dim locbldr128 As LocalBuilder = procMethodCallIL.DeclareLocal(GetType(Token))
...
Dim locbldr129 As LocalBuilder = procMethodCallIL.DeclareLocal(GetType(System.Type))
locbldr129.SetLocalSymInfo("typ2")
procMethodCallIL.MarkSequencePoint(doc4, 77, 1, 77, 100)
Dim locbldr130 As LocalBuilder = procMethodCallIL.DeclareLocal(GetType(System.Boolean))
locbldr130.SetLocalSymInfo("b2")
procMethodCallIL.MarkSequencePoint(doc4, 78, 1, 78, 100)
Dim locbldr131 As LocalBuilder = procMethodCallIL.DeclareLocal(GetType(System.Int32))
...
procMethodCallIL.Emit(OpCodes.Bgt, tru116)
...
procMethodCallIL.Emit(OpCodes.Bgt, tru120)
...
Dim locbldr132 As LocalBuilder = procNewCallIL.DeclareLocal(GetType(NewCallTok))
locbldr132.SetLocalSymInfo("nct")
...
Dim locbldr133 As LocalBuilder = procNewCallIL.DeclareLocal(GetType(TypeTok))
locbldr133.SetLocalSymInfo("tt")
procNewCallIL.MarkSequencePoint(doc4, 178, 1, 178, 100)
Dim locbldr134 As LocalBuilder = procNewCallIL.DeclareLocal(GetType(Expr))
...
Dim locbldr135 As LocalBuilder = procNewCallIL.DeclareLocal(GetType(System.Int32))
...
Dim locbldr136 As LocalBuilder = procNewCallIL.DeclareLocal(GetType(System.Boolean))
...
Dim locbldr138 As LocalBuilder = procNewCallIL.DeclareLocal(GetType(Token))
...
Dim locbldr139 As LocalBuilder = procNewCallIL.DeclareLocal(GetType(System.Type))
locbldr139.SetLocalSymInfo("typ2")
procNewCallIL.MarkSequencePoint(doc4, 190, 1, 190, 100)
Dim locbldr140 As LocalBuilder = procNewCallIL.DeclareLocal(GetType(System.Boolean))
locbldr140.SetLocalSymInfo("b2")
procNewCallIL.MarkSequencePoint(doc4, 191, 1, 191, 100)
Dim locbldr141 As LocalBuilder = procNewCallIL.DeclareLocal(GetType(System.Int32))
...
procNewCallIL.Emit(OpCodes.Beq, tru124)
...
procNewCallIL.Emit(OpCodes.Bgt, tru125)
...
procNewCallIL.Emit(OpCodes.Bgt, tru129)
...
Dim locbldr142 As LocalBuilder = procIdentArrayAccessIL.DeclareLocal(GetType(Ident))
locbldr142.SetLocalSymInfo("idt")
...
Dim locbldr143 As LocalBuilder = procIdentArrayAccessIL.DeclareLocal(GetType(Expr))
locbldr143.SetLocalSymInfo("ep2")
...
Dim locbldr144 As LocalBuilder = procIdentArrayAccessIL.DeclareLocal(GetType(System.Int32))
locbldr144.SetLocalSymInfo("lvl")
...
Dim locbldr145 As LocalBuilder = procIdentArrayAccessIL.DeclareLocal(GetType(System.Boolean))
locbldr145.SetLocalSymInfo("d")
...
Dim locbldr147 As LocalBuilder = procIdentArrayAccessIL.DeclareLocal(GetType(Token))
...
Dim locbldr148 As LocalBuilder = procIdentArrayAccessIL.DeclareLocal(GetType(System.Type))
locbldr148.SetLocalSymInfo("typ2")
procIdentArrayAccessIL.MarkSequencePoint(doc4, 301, 1, 301, 100)
Dim locbldr149 As LocalBuilder = procIdentArrayAccessIL.DeclareLocal(GetType(System.Boolean))
locbldr149.SetLocalSymInfo("b2")
procIdentArrayAccessIL.MarkSequencePoint(doc4, 302, 1, 302, 100)
Dim locbldr150 As LocalBuilder = procIdentArrayAccessIL.DeclareLocal(GetType(System.Int32))
...
Dim locbldr151 As LocalBuilder = procMtdArrayAccessIL.DeclareLocal(GetType(MethodCallTok))
locbldr151.SetLocalSymInfo("mtd")
...
Dim locbldr152 As LocalBuilder = procMtdArrayAccessIL.DeclareLocal(GetType(MethodNameTok))
locbldr152.SetLocalSymInfo("idt")
procMtdArrayAccessIL.Emit(OpCodes.Ldnull)
procMtdArrayAccessIL.Emit(OpCodes.Stloc, 1)
procMtdArrayAccessIL.MarkSequencePoint(doc4, 383, 1, 383, 100)
Dim locbldr153 As LocalBuilder = procMtdArrayAccessIL.DeclareLocal(GetType(Expr))
locbldr153.SetLocalSymInfo("ep2")
...
Dim locbldr154 As LocalBuilder = procMtdArrayAccessIL.DeclareLocal(GetType(System.Int32))
locbldr154.SetLocalSymInfo("lvl")
...
Dim locbldr155 As LocalBuilder = procMtdArrayAccessIL.DeclareLocal(GetType(System.Boolean))
locbldr155.SetLocalSymInfo("d")
...
Dim locbldr157 As LocalBuilder = procMtdArrayAccessIL.DeclareLocal(GetType(Token))
...
Dim locbldr158 As LocalBuilder = procMtdArrayAccessIL.DeclareLocal(GetType(System.Type))
locbldr158.SetLocalSymInfo("typ2")
procMtdArrayAccessIL.MarkSequencePoint(doc4, 396, 1, 396, 100)
Dim locbldr159 As LocalBuilder = procMtdArrayAccessIL.DeclareLocal(GetType(System.Boolean))
locbldr159.SetLocalSymInfo("b2")
procMtdArrayAccessIL.MarkSequencePoint(doc4, 397, 1, 397, 100)
Dim locbldr160 As LocalBuilder = procMtdArrayAccessIL.DeclareLocal(GetType(System.Int32))
...
locbldr164.SetLocalSymInfo("identtrnoff")
OptimizeIL.Emit(OpCodes.Ldc_I4, 0)
Typ = GetType(System.Boolean)
OptimizeIL.Emit(OpCodes.Stloc, 3)
...
locbldr165.SetLocalSymInfo("mcbool")
OptimizeIL.Emit(OpCodes.Ldc_I4, 0)
Typ = GetType(System.Boolean)
OptimizeIL.Emit(OpCodes.Stloc, 4)
...
locbldr166.SetLocalSymInfo("mcflgc")
OptimizeIL.Emit(OpCodes.Ldc_I4, 0)
Typ = GetType(System.Boolean)
OptimizeIL.Emit(OpCodes.Stloc, 5)
...
locbldr167.SetLocalSymInfo("iflgc")
OptimizeIL.Emit(OpCodes.Ldc_I4, 0)
Typ = GetType(System.Boolean)
OptimizeIL.Emit(OpCodes.Stloc, 6)
...
locbldr176.SetLocalSymInfo("mcmetcall")
OptimizeIL.Emit(OpCodes.Ldnull)
OptimizeIL.Emit(OpCodes.Stloc, 15)
OptimizeIL.MarkSequencePoint(doc4, 493, 1, 493, 100)
Dim locbldr177 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(MethodNameTok))
locbldr177.SetLocalSymInfo("mcmetname")
OptimizeIL.Emit(OpCodes.Ldnull)
OptimizeIL.Emit(OpCodes.Stloc, 16)
OptimizeIL.MarkSequencePoint(doc4, 494, 1, 494, 100)
Dim locbldr178 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(StringLiteral))
locbldr178.SetLocalSymInfo("mcstr")
OptimizeIL.Emit(OpCodes.Ldnull)
OptimizeIL.Emit(OpCodes.Stloc, 17)
...
locbldr179.SetLocalSymInfo("mcint")
OptimizeIL.Emit(OpCodes.Ldc_I4, CInt(0))
Typ = GetType(System.Int32)
OptimizeIL.Emit(OpCodes.Stloc, 18)
...
OptimizeIL.Emit(OpCodes.Blt, tru144)
...
Dim locbldr180 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(Token))
...
Dim locbldr181 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(System.Type))
locbldr181.SetLocalSymInfo("typ")
OptimizeIL.MarkSequencePoint(doc4, 516, 1, 516, 100)
Dim locbldr182 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(System.Boolean))
locbldr182.SetLocalSymInfo("b")
OptimizeIL.MarkSequencePoint(doc4, 517, 1, 517, 100)
Dim locbldr183 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(System.String))
locbldr183.SetLocalSymInfo("str")
...
OptimizeIL.Emit(OpCodes.Beq, fa147)
OptimizeIL.Emit(OpCodes.Br, tru147)
OptimizeIL.MarkLabel(tru147)
OptimizeIL.MarkSequencePoint(doc4, 531, 1, 531, 100)
Dim locbldr184 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(Token))
locbldr184.SetLocalSymInfo("tk")
OptimizeIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Expr)
OptimizeIL.Emit(OpCodes.Ldfld, GetType(Expr).GetField("Tokens"))
Typ = GetType(Expr).GetField("Tokens").FieldType
...
Dim locbldr185 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(TypeTok))
locbldr185.SetLocalSymInfo("ttk")
...
locbldr186.SetLocalSymInfo("tk2")
OptimizeIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Expr)
OptimizeIL.Emit(OpCodes.Ldfld, GetType(Expr).GetField("Tokens"))
Typ = GetType(Expr).GetField("Tokens").FieldType
...
locbldr187.SetLocalSymInfo("ttk2")
OptimizeIL.Emit(OpCodes.Newobj, GetType(TypeTok).GetConstructor(Type.EmptyTypes))
OptimizeIL.Emit(OpCodes.Stloc, 26)
...
locbldr188.SetLocalSymInfo("tt1")
OptimizeIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Expr)
OptimizeIL.Emit(OpCodes.Ldfld, GetType(Expr).GetField("Tokens"))
Typ = GetType(Expr).GetField("Tokens").FieldType
...
Dim locbldr189 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(Ident))
locbldr189.SetLocalSymInfo("id1")
OptimizeIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Expr)
OptimizeIL.Emit(OpCodes.Ldfld, GetType(Expr).GetField("Tokens"))
Typ = GetType(Expr).GetField("Tokens").FieldType
...
Dim locbldr190 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(CharLiteral))
locbldr190.SetLocalSymInfo("cl1")
OptimizeIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Expr)
OptimizeIL.Emit(OpCodes.Ldfld, GetType(Expr).GetField("Tokens"))
Typ = GetType(Expr).GetField("Tokens").FieldType
...
Dim locbldr191 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(NullLiteral))
locbldr191.SetLocalSymInfo("nul1")
OptimizeIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Expr)
OptimizeIL.Emit(OpCodes.Ldfld, GetType(Expr).GetField("Tokens"))
Typ = GetType(Expr).GetField("Tokens").FieldType
...
Dim locbldr192 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(StringLiteral))
locbldr192.SetLocalSymInfo("sl1")
OptimizeIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Expr)
OptimizeIL.Emit(OpCodes.Ldfld, GetType(Expr).GetField("Tokens"))
Typ = GetType(Expr).GetField("Tokens").FieldType
...
Dim locbldr193 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(BooleanLiteral))
locbldr193.SetLocalSymInfo("bl1")
OptimizeIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Expr)
OptimizeIL.Emit(OpCodes.Ldfld, GetType(Expr).GetField("Tokens"))
Typ = GetType(Expr).GetField("Tokens").FieldType
...
Dim locbldr194 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(NumberLiteral))
locbldr194.SetLocalSymInfo("nl1")
OptimizeIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Expr)
OptimizeIL.Emit(OpCodes.Ldfld, GetType(Expr).GetField("Tokens"))
Typ = GetType(Expr).GetField("Tokens").FieldType
...
OptimizeIL.Emit(OpCodes.Beq, fa169)
OptimizeIL.Emit(OpCodes.Br, tru169)
...
Dim locbldr195 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(NewCallTok))
locbldr195.SetLocalSymInfo("nctoken")
OptimizeIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Expr)
OptimizeIL.Emit(OpCodes.Ldfld, GetType(Expr).GetField("Tokens"))
Typ = GetType(Expr).GetField("Tokens").FieldType
...
Dim locbldr196 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(Expr).MakeArrayType())
locbldr196.SetLocalSymInfo("ncprs")
OptimizeIL.Emit(OpCodes.Ldloc, 34)
Typ = GetType(NewCallTok)
...
locbldr197.SetLocalSymInfo("ncln2")
OptimizeIL.Emit(OpCodes.Ldloc, 35)
...
Dim locbldr198 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(System.Int32))
locbldr198.SetLocalSymInfo("nci2")
OptimizeIL.Emit(OpCodes.Ldc_I4, CInt(-1))
Typ = GetType(System.Int32)
OptimizeIL.Emit(OpCodes.Stloc, 37)
...
OptimizeIL.Emit(OpCodes.Blt, tru170)
...
OptimizeIL.Emit(OpCodes.Beq, fa173)
OptimizeIL.Emit(OpCodes.Br, tru173)
...
Dim locbldr199 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(GettypeCallTok))
locbldr199.SetLocalSymInfo("gtctoken")
...
Dim locbldr200 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(MethodCallTok))
locbldr200.SetLocalSymInfo("mct")
OptimizeIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Expr)
OptimizeIL.Emit(OpCodes.Ldfld, GetType(Expr).GetField("Tokens"))
Typ = GetType(Expr).GetField("Tokens").FieldType
...
Dim locbldr201 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(Expr).MakeArrayType())
locbldr201.SetLocalSymInfo("prs")
OptimizeIL.Emit(OpCodes.Ldloc, 39)
Typ = GetType(MethodCallTok)
...
locbldr202.SetLocalSymInfo("ln2")
OptimizeIL.Emit(OpCodes.Ldloc, 40)
Typ = GetType(Expr).MakeArrayType()
OptimizeIL.Emit(OpCodes.Ldlen)
OptimizeIL.Emit(OpCodes.Conv_I4)
...
Dim locbldr203 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(System.Int32))
locbldr203.SetLocalSymInfo("i2")
OptimizeIL.Emit(OpCodes.Ldc_I4, CInt(-1))
Typ = GetType(System.Int32)
OptimizeIL.Emit(OpCodes.Stloc, 42)
...
Dim locbldr204 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(Ident))
locbldr204.SetLocalSymInfo("aidt")
OptimizeIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Expr)
OptimizeIL.Emit(OpCodes.Ldfld, GetType(Expr).GetField("Tokens"))
Typ = GetType(Expr).GetField("Tokens").FieldType
...
Dim locbldr205 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(Expr))
locbldr205.SetLocalSymInfo("arriloc")
OptimizeIL.Emit(OpCodes.Ldloc, 43)
Typ = GetType(Ident)
...
Dim locbldr206 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(MethodCallTok))
locbldr206.SetLocalSymInfo("amtd")
OptimizeIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Expr)
OptimizeIL.Emit(OpCodes.Ldfld, GetType(Expr).GetField("Tokens"))
Typ = GetType(Expr).GetField("Tokens").FieldType
...
Dim locbldr207 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(MethodNameTok))
locbldr207.SetLocalSymInfo("amtdn")
OptimizeIL.Emit(OpCodes.Ldloc, 45)
Typ = GetType(MethodCallTok)
...
OptimizeIL.Emit(OpCodes.Bgt, tru182)
...
OptimizeIL.Emit(OpCodes.Bge, tru183)
...
OptimizeIL.Emit(OpCodes.Ble, tru192)
...
Dim locbldr208 As LocalBuilder = checkRefasmIL.DeclareLocal(GetType(Token))
...
Dim locbldr209 As LocalBuilder = checkRefasmIL.DeclareLocal(GetType(System.Type))
...
Dim locbldr210 As LocalBuilder = checkRefasmIL.DeclareLocal(GetType(RefasmStmt))
locbldr210.SetLocalSymInfo("refasms")
...
Typ = GetType(System.Boolean)
Dim fa195 As System.Reflection.Emit.Label = checkRefasmIL.DefineLabel()
Dim tru195 As System.Reflection.Emit.Label = checkRefasmIL.DefineLabel()
Dim cont195 As System.Reflection.Emit.Label = checkRefasmIL.DefineLabel()
checkRefasmIL.Emit(OpCodes.Beq, tru195)
checkRefasmIL.Emit(OpCodes.Br, fa195)
checkRefasmIL.MarkLabel(tru195)
...
checkRefasmIL.Emit(OpCodes.Br, cont195)
checkRefasmIL.MarkLabel(fa195)
checkRefasmIL.Emit(OpCodes.Br, cont195)
checkRefasmIL.MarkLabel(cont195)
...
Dim locbldr211 As LocalBuilder = checkIfIL.DeclareLocal(GetType(Token))
...
Dim locbldr212 As LocalBuilder = checkIfIL.DeclareLocal(GetType(System.Type))
...
Dim locbldr213 As LocalBuilder = checkIfIL.DeclareLocal(GetType(IfStmt))
locbldr213.SetLocalSymInfo("ifs")
...
Dim locbldr214 As LocalBuilder = checkIfIL.DeclareLocal(GetType(Expr))
...
Dim locbldr216 As LocalBuilder = checkIfIL.DeclareLocal(GetType(System.Int32))
locbldr216.SetLocalSymInfo("len")
checkIfIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
checkIfIL.Emit(OpCodes.Ldfld, GetType(Stmt).GetField("Tokens"))
Typ = GetType(Stmt).GetField("Tokens").FieldType
...
Dim locbldr217 As LocalBuilder = checkIfIL.DeclareLocal(GetType(System.Boolean))
locbldr217.SetLocalSymInfo("b2")
...
Dim locbldr218 As LocalBuilder = checkIfIL.DeclareLocal(asm.GetType("dylan.NET.Tokenizer.Parser.ExprOptimizer"))
locbldr218.SetLocalSymInfo("eop")
...
Dim locbldr219 As LocalBuilder = checkElseIfIL.DeclareLocal(GetType(Token))
...
Dim locbldr220 As LocalBuilder = checkElseIfIL.DeclareLocal(GetType(System.Type))
...
Dim locbldr221 As LocalBuilder = checkElseIfIL.DeclareLocal(GetType(ElseIfStmt))
locbldr221.SetLocalSymInfo("ifs")
...
Dim locbldr222 As LocalBuilder = checkElseIfIL.DeclareLocal(GetType(Expr))
locbldr222.SetLocalSymInfo("exp")
...
Dim locbldr224 As LocalBuilder = checkElseIfIL.DeclareLocal(GetType(System.Int32))
...
Dim locbldr225 As LocalBuilder = checkElseIfIL.DeclareLocal(GetType(System.Boolean))
...
Dim locbldr226 As LocalBuilder = checkElseIfIL.DeclareLocal(asm.GetType("dylan.NET.Tokenizer.Parser.ExprOptimizer"))
locbldr226.SetLocalSymInfo("eop")
...
Dim locbldr227 As LocalBuilder = checkDebugIL.DeclareLocal(GetType(Token))
locbldr227.SetLocalSymInfo("tok")
...
Dim locbldr228 As LocalBuilder = checkDebugIL.DeclareLocal(GetType(System.Type))
...
Dim locbldr229 As LocalBuilder = checkDebugIL.DeclareLocal(GetType(DebugStmt))
locbldr229.SetLocalSymInfo("dbgs")
...
Typ = GetType(System.Boolean)
Dim fa202 As System.Reflection.Emit.Label = checkDebugIL.DefineLabel()
Dim tru202 As System.Reflection.Emit.Label = checkDebugIL.DefineLabel()
Dim cont202 As System.Reflection.Emit.Label = checkDebugIL.DefineLabel()
checkDebugIL.Emit(OpCodes.Beq, tru202)
checkDebugIL.Emit(OpCodes.Br, fa202)
checkDebugIL.MarkLabel(tru202)
...
checkDebugIL.Emit(OpCodes.Br, cont202)
checkDebugIL.MarkLabel(fa202)
checkDebugIL.Emit(OpCodes.Br, cont202)
checkDebugIL.MarkLabel(cont202)
...
Dim locbldr230 As LocalBuilder = checkImportIL.DeclareLocal(GetType(Token))
...
Dim locbldr231 As LocalBuilder = checkImportIL.DeclareLocal(GetType(System.Type))
...
Dim locbldr232 As LocalBuilder = checkImportIL.DeclareLocal(GetType(ImportStmt))
locbldr232.SetLocalSymInfo("imps")
...
Typ = GetType(System.Boolean)
Dim fa203 As System.Reflection.Emit.Label = checkImportIL.DefineLabel()
Dim tru203 As System.Reflection.Emit.Label = checkImportIL.DefineLabel()
Dim cont203 As System.Reflection.Emit.Label = checkImportIL.DefineLabel()
checkImportIL.Emit(OpCodes.Beq, tru203)
checkImportIL.Emit(OpCodes.Br, fa203)
checkImportIL.MarkLabel(tru203)
...
checkImportIL.Emit(OpCodes.Br, cont203)
checkImportIL.MarkLabel(fa203)
checkImportIL.Emit(OpCodes.Br, cont203)
checkImportIL.MarkLabel(cont203)
...
Dim locbldr233 As LocalBuilder = checkLocimportIL.DeclareLocal(GetType(Token))
...
Dim locbldr234 As LocalBuilder = checkLocimportIL.DeclareLocal(GetType(System.Type))
...
Dim locbldr235 As LocalBuilder = checkLocimportIL.DeclareLocal(GetType(LocimportStmt))
locbldr235.SetLocalSymInfo("limps")
...
Typ = GetType(System.Boolean)
Dim fa204 As System.Reflection.Emit.Label = checkLocimportIL.DefineLabel()
Dim tru204 As System.Reflection.Emit.Label = checkLocimportIL.DefineLabel()
Dim cont204 As System.Reflection.Emit.Label = checkLocimportIL.DefineLabel()
checkLocimportIL.Emit(OpCodes.Beq, tru204)
checkLocimportIL.Emit(OpCodes.Br, fa204)
checkLocimportIL.MarkLabel(tru204)
...
checkLocimportIL.Emit(OpCodes.Br, cont204)
checkLocimportIL.MarkLabel(fa204)
checkLocimportIL.Emit(OpCodes.Br, cont204)
checkLocimportIL.MarkLabel(cont204)
...
Dim locbldr236 As LocalBuilder = checkCmtIL.DeclareLocal(GetType(Token))
...
Dim locbldr237 As LocalBuilder = checkCmtIL.DeclareLocal(GetType(System.Type))
...
Dim locbldr238 As LocalBuilder = checkCmtIL.DeclareLocal(GetType(CommentStmt))
locbldr238.SetLocalSymInfo("cmts")
...
Typ = GetType(System.Boolean)
Dim fa205 As System.Reflection.Emit.Label = checkCmtIL.DefineLabel()
Dim tru205 As System.Reflection.Emit.Label = checkCmtIL.DefineLabel()
Dim cont205 As System.Reflection.Emit.Label = checkCmtIL.DefineLabel()
checkCmtIL.Emit(OpCodes.Beq, tru205)
checkCmtIL.Emit(OpCodes.Br, fa205)
checkCmtIL.MarkLabel(tru205)
...
checkCmtIL.Emit(OpCodes.Br, cont205)
checkCmtIL.MarkLabel(fa205)
checkCmtIL.Emit(OpCodes.Br, cont205)
checkCmtIL.MarkLabel(cont205)
...
checkElseIL.Emit(OpCodes.Blt, tru206)
checkElseIL.Emit(OpCodes.Br, fa206)
checkElseIL.MarkLabel(tru206)
checkElseIL.MarkSequencePoint(doc5, 182, 1, 182, 100)
Dim locbldr239 As LocalBuilder = checkElseIL.DeclareLocal(GetType(Token))
locbldr239.SetLocalSymInfo("tok1")
checkElseIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
checkElseIL.Emit(OpCodes.Ldfld, GetType(Stmt).GetField("Tokens"))
Typ = GetType(Stmt).GetField("Tokens").FieldType
...
Dim locbldr240 As LocalBuilder = checkElseIL.DeclareLocal(GetType(System.Type))
locbldr240.SetLocalSymInfo("typ1")
...
Dim locbldr241 As LocalBuilder = checkElseIL.DeclareLocal(GetType(System.Boolean))
locbldr241.SetLocalSymInfo("b1")
Dim typ32(-1) As Type
...
Dim locbldr242 As LocalBuilder = checkElseIL.DeclareLocal(GetType(ElseStmt))
locbldr242.SetLocalSymInfo("els")
...
Typ = GetType(System.Boolean)
Dim fa207 As System.Reflection.Emit.Label = checkElseIL.DefineLabel()
Dim tru207 As System.Reflection.Emit.Label = checkElseIL.DefineLabel()
Dim cont207 As System.Reflection.Emit.Label = checkElseIL.DefineLabel()
checkElseIL.Emit(OpCodes.Beq, tru207)
checkElseIL.Emit(OpCodes.Br, fa207)
checkElseIL.MarkLabel(tru207)
...
checkElseIL.Emit(OpCodes.Br, cont207)
checkElseIL.MarkLabel(fa207)
checkElseIL.Emit(OpCodes.Br, cont207)
checkElseIL.MarkLabel(cont207)
...
checkEndIfIL.Emit(OpCodes.Bge, tru208)
checkEndIfIL.Emit(OpCodes.Br, fa208)
checkEndIfIL.MarkLabel(tru208)
checkEndIfIL.MarkSequencePoint(doc5, 200, 1, 200, 100)
Dim locbldr243 As LocalBuilder = checkEndIfIL.DeclareLocal(GetType(Token))
locbldr243.SetLocalSymInfo("tok1")
checkEndIfIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
checkEndIfIL.Emit(OpCodes.Ldfld, GetType(Stmt).GetField("Tokens"))
Typ = GetType(Stmt).GetField("Tokens").FieldType
...
Dim locbldr244 As LocalBuilder = checkEndIfIL.DeclareLocal(GetType(System.Type))
locbldr244.SetLocalSymInfo("typ1")
...
Dim locbldr245 As LocalBuilder = checkEndIfIL.DeclareLocal(GetType(System.Boolean))
locbldr245.SetLocalSymInfo("b1")
Dim typ35(-1) As Type
...
Dim locbldr246 As LocalBuilder = checkEndIfIL.DeclareLocal(GetType(Token))
locbldr246.SetLocalSymInfo("tok2")
checkEndIfIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
checkEndIfIL.Emit(OpCodes.Ldfld, GetType(Stmt).GetField("Tokens"))
Typ = GetType(Stmt).GetField("Tokens").FieldType
...
Dim locbldr247 As LocalBuilder = checkEndIfIL.DeclareLocal(GetType(System.Type))
locbldr247.SetLocalSymInfo("typ2")
...
Dim locbldr248 As LocalBuilder = checkEndIfIL.DeclareLocal(GetType(System.Boolean))
locbldr248.SetLocalSymInfo("b2")
Dim typ37(-1) As Type
...
Dim locbldr249 As LocalBuilder = checkEndIfIL.DeclareLocal(GetType(EndIfStmt))
locbldr249.SetLocalSymInfo("eifs")
...
Typ = GetType(System.Boolean)
Dim fa209 As System.Reflection.Emit.Label = checkEndIfIL.DefineLabel()
Dim tru209 As System.Reflection.Emit.Label = checkEndIfIL.DefineLabel()
Dim cont209 As System.Reflection.Emit.Label = checkEndIfIL.DefineLabel()
checkEndIfIL.Emit(OpCodes.Beq, tru209)
checkEndIfIL.Emit(OpCodes.Br, fa209)
checkEndIfIL.MarkLabel(tru209)
...
checkEndIfIL.Emit(OpCodes.Br, cont209)
checkEndIfIL.MarkLabel(fa209)
checkEndIfIL.Emit(OpCodes.Br, cont209)
checkEndIfIL.MarkLabel(cont209)
...
checkEndMtdIL.Emit(OpCodes.Bge, tru210)
checkEndMtdIL.Emit(OpCodes.Br, fa210)
checkEndMtdIL.MarkLabel(tru210)
checkEndMtdIL.MarkSequencePoint(doc5, 223, 1, 223, 100)
Dim locbldr250 As LocalBuilder = checkEndMtdIL.DeclareLocal(GetType(Token))
locbldr250.SetLocalSymInfo("tok1")
checkEndMtdIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
checkEndMtdIL.Emit(OpCodes.Ldfld, GetType(Stmt).GetField("Tokens"))
Typ = GetType(Stmt).GetField("Tokens").FieldType
...
Dim locbldr251 As LocalBuilder = checkEndMtdIL.DeclareLocal(GetType(System.Type))
locbldr251.SetLocalSymInfo("typ1")
...
Dim locbldr252 As LocalBuilder = checkEndMtdIL.DeclareLocal(GetType(System.Boolean))
locbldr252.SetLocalSymInfo("b1")
Dim typ40(-1) As Type
...
Dim locbldr253 As LocalBuilder = checkEndMtdIL.DeclareLocal(GetType(Token))
locbldr253.SetLocalSymInfo("tok2")
checkEndMtdIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
checkEndMtdIL.Emit(OpCodes.Ldfld, GetType(Stmt).GetField("Tokens"))
Typ = GetType(Stmt).GetField("Tokens").FieldType
...
Dim locbldr254 As LocalBuilder = checkEndMtdIL.DeclareLocal(GetType(System.Type))
locbldr254.SetLocalSymInfo("typ2")
...
Dim locbldr255 As LocalBuilder = checkEndMtdIL.DeclareLocal(GetType(System.Boolean))
locbldr255.SetLocalSymInfo("b2")
Dim typ42(-1) As Type
...
Dim locbldr256 As LocalBuilder = checkEndMtdIL.DeclareLocal(GetType(EndMethodStmt))
locbldr256.SetLocalSymInfo("ems")
...
Typ = GetType(System.Boolean)
Dim fa211 As System.Reflection.Emit.Label = checkEndMtdIL.DefineLabel()
Dim tru211 As System.Reflection.Emit.Label = checkEndMtdIL.DefineLabel()
Dim cont211 As System.Reflection.Emit.Label = checkEndMtdIL.DefineLabel()
checkEndMtdIL.Emit(OpCodes.Beq, tru211)
checkEndMtdIL.Emit(OpCodes.Br, fa211)
checkEndMtdIL.MarkLabel(tru211)
...
checkEndMtdIL.Emit(OpCodes.Br, cont211)
checkEndMtdIL.MarkLabel(fa211)
checkEndMtdIL.Emit(OpCodes.Br, cont211)
checkEndMtdIL.MarkLabel(cont211)
...
checkEndClsIL.Emit(OpCodes.Bge, tru212)
checkEndClsIL.Emit(OpCodes.Br, fa212)
checkEndClsIL.MarkLabel(tru212)
checkEndClsIL.MarkSequencePoint(doc5, 245, 1, 245, 100)
Dim locbldr257 As LocalBuilder = checkEndClsIL.DeclareLocal(GetType(Token))
locbldr257.SetLocalSymInfo("tok1")
checkEndClsIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
checkEndClsIL.Emit(OpCodes.Ldfld, GetType(Stmt).GetField("Tokens"))
Typ = GetType(Stmt).GetField("Tokens").FieldType
...
Dim locbldr258 As LocalBuilder = checkEndClsIL.DeclareLocal(GetType(System.Type))
locbldr258.SetLocalSymInfo("typ1")
...
Dim locbldr259 As LocalBuilder = checkEndClsIL.DeclareLocal(GetType(System.Boolean))
locbldr259.SetLocalSymInfo("b1")
Dim typ45(-1) As Type
...
Dim locbldr260 As LocalBuilder = checkEndClsIL.DeclareLocal(GetType(Token))
locbldr260.SetLocalSymInfo("tok2")
checkEndClsIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
checkEndClsIL.Emit(OpCodes.Ldfld, GetType(Stmt).GetField("Tokens"))
Typ = GetType(Stmt).GetField("Tokens").FieldType
...
Dim locbldr261 As LocalBuilder = checkEndClsIL.DeclareLocal(GetType(System.Type))
locbldr261.SetLocalSymInfo("typ2")
...
Dim locbldr262 As LocalBuilder = checkEndClsIL.DeclareLocal(GetType(System.Boolean))
locbldr262.SetLocalSymInfo("b2")
Dim typ47(-1) As Type
...
Dim locbldr263 As LocalBuilder = checkEndClsIL.DeclareLocal(GetType(EndClassStmt))
locbldr263.SetLocalSymInfo("ecs")
...
Typ = GetType(System.Boolean)
Dim fa213 As System.Reflection.Emit.Label = checkEndClsIL.DefineLabel()
Dim tru213 As System.Reflection.Emit.Label = checkEndClsIL.DefineLabel()
Dim cont213 As System.Reflection.Emit.Label = checkEndClsIL.DefineLabel()
checkEndClsIL.Emit(OpCodes.Beq, tru213)
checkEndClsIL.Emit(OpCodes.Br, fa213)
checkEndClsIL.MarkLabel(tru213)
...
checkEndClsIL.Emit(OpCodes.Br, cont213)
checkEndClsIL.MarkLabel(fa213)
checkEndClsIL.Emit(OpCodes.Br, cont213)
checkEndClsIL.MarkLabel(cont213)
...
Dim locbldr264 As LocalBuilder = checkAssemblyIL.DeclareLocal(GetType(Token))
...
Dim locbldr265 As LocalBuilder = checkAssemblyIL.DeclareLocal(GetType(System.Type))
...
Dim locbldr266 As LocalBuilder = checkAssemblyIL.DeclareLocal(GetType(AssemblyStmt))
locbldr266.SetLocalSymInfo("asms")
...
Typ = GetType(System.Boolean)
Dim fa214 As System.Reflection.Emit.Label = checkAssemblyIL.DefineLabel()
Dim tru214 As System.Reflection.Emit.Label = checkAssemblyIL.DefineLabel()
Dim cont214 As System.Reflection.Emit.Label = checkAssemblyIL.DefineLabel()
checkAssemblyIL.Emit(OpCodes.Beq, tru214)
checkAssemblyIL.Emit(OpCodes.Br, fa214)
checkAssemblyIL.MarkLabel(tru214)
...
checkAssemblyIL.Emit(OpCodes.Br, cont214)
checkAssemblyIL.MarkLabel(fa214)
checkAssemblyIL.Emit(OpCodes.Br, cont214)
checkAssemblyIL.MarkLabel(cont214)
...
Dim locbldr267 As LocalBuilder = checkVerIL.DeclareLocal(GetType(Token))
locbldr267.SetLocalSymInfo("tok")
...
Dim locbldr268 As LocalBuilder = checkVerIL.DeclareLocal(GetType(System.Type))
...
Dim locbldr269 As LocalBuilder = checkVerIL.DeclareLocal(GetType(VerStmt))
locbldr269.SetLocalSymInfo("vers")
...
Typ = GetType(System.Boolean)
Dim fa215 As System.Reflection.Emit.Label = checkVerIL.DefineLabel()
Dim tru215 As System.Reflection.Emit.Label = checkVerIL.DefineLabel()
Dim cont215 As System.Reflection.Emit.Label = checkVerIL.DefineLabel()
checkVerIL.Emit(OpCodes.Beq, tru215)
checkVerIL.Emit(OpCodes.Br, fa215)
checkVerIL.MarkLabel(tru215)
...
Dim locbldr270 As LocalBuilder = checkVerIL.DeclareLocal(GetType(System.String).MakeArrayType())
locbldr270.SetLocalSymInfo("ars")
Dim typ54(-1) As Type
checkVerIL.Emit(OpCodes.Ldloc, 0)
Typ = GetType(Token)
...
Dim locbldr271 As LocalBuilder = checkVerIL.DeclareLocal(GetType(System.Int32).MakeArrayType())
locbldr271.SetLocalSymInfo("ari")
...
Dim locbldr272 As LocalBuilder = checkVerIL.DeclareLocal(GetType(IntLiteral).MakeArrayType())
locbldr272.SetLocalSymInfo("intla")
checkVerIL.Emit(OpCodes.Ldc_I4, CInt(4))
Typ = GetType(System.Int32)
checkVerIL.Emit(OpCodes.Conv_U)
...
Dim locbldr273 As LocalBuilder = checkVerIL.DeclareLocal(GetType(IntLiteral))
locbldr273.SetLocalSymInfo("intl")
...
checkVerIL.Emit(OpCodes.Br, cont215)
checkVerIL.MarkLabel(fa215)
checkVerIL.Emit(OpCodes.Br, cont215)
checkVerIL.MarkLabel(cont215)
...
Dim locbldr274 As LocalBuilder = checkClassIL.DeclareLocal(GetType(Token))
...
Dim locbldr275 As LocalBuilder = checkClassIL.DeclareLocal(GetType(System.Type))
locbldr275.SetLocalSymInfo("typ")
...
Dim locbldr276 As LocalBuilder = checkClassIL.DeclareLocal(GetType(ClassStmt))
locbldr276.SetLocalSymInfo("clss")
...
Dim locbldr277 As LocalBuilder = checkClassIL.DeclareLocal(GetType(Attributes.Attribute))
locbldr277.SetLocalSymInfo("att")
...
Dim locbldr279 As LocalBuilder = checkClassIL.DeclareLocal(GetType(System.Int32))
...
Dim locbldr280 As LocalBuilder = checkClassIL.DeclareLocal(GetType(System.Boolean))
locbldr280.SetLocalSymInfo("bl")
...
Dim locbldr281 As LocalBuilder = checkClassIL.DeclareLocal(GetType(Token))
locbldr281.SetLocalSymInfo("tok2")
checkClassIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
checkClassIL.Emit(OpCodes.Ldfld, GetType(Stmt).GetField("Tokens"))
Typ = GetType(Stmt).GetField("Tokens").FieldType
...
Dim locbldr282 As LocalBuilder = checkClassIL.DeclareLocal(GetType(System.Type))
locbldr282.SetLocalSymInfo("typ2")
...
Dim locbldr283 As LocalBuilder = checkClassIL.DeclareLocal(GetType(System.Boolean))
locbldr283.SetLocalSymInfo("b2")
Dim typ70(-1) As Type
...
checkClassIL.Emit(OpCodes.Beq, tru218)
checkClassIL.Emit(OpCodes.Br, fa218)
...
checkClassIL.Emit(OpCodes.Beq, fa219)
checkClassIL.Emit(OpCodes.Br, tru219)
checkClassIL.MarkLabel(tru219)
checkClassIL.MarkSequencePoint(doc5, 357, 1, 357, 100)
Dim locbldr284 As LocalBuilder = checkClassIL.DeclareLocal(GetType(Token))
locbldr284.SetLocalSymInfo("t")
checkClassIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
checkClassIL.Emit(OpCodes.Ldfld, GetType(Stmt).GetField("Tokens"))
Typ = GetType(Stmt).GetField("Tokens").FieldType
...
Dim locbldr285 As LocalBuilder = checkClassIL.DeclareLocal(GetType(TypeTok))
locbldr285.SetLocalSymInfo("tt")
...
Typ = GetType(System.Int32)
Dim fa220 As System.Reflection.Emit.Label = checkClassIL.DefineLabel()
Dim tru220 As System.Reflection.Emit.Label = checkClassIL.DefineLabel()
Dim cont220 As System.Reflection.Emit.Label = checkClassIL.DefineLabel()
checkClassIL.Emit(OpCodes.Beq, tru220)
checkClassIL.Emit(OpCodes.Br, fa220)
checkClassIL.MarkLabel(tru220)
...
checkClassIL.Emit(OpCodes.Br, cont220)
checkClassIL.MarkLabel(fa220)
...
checkClassIL.Emit(OpCodes.Br, cont220)
checkClassIL.MarkLabel(cont220)
...
Dim locbldr286 As LocalBuilder = checkFieldIL.DeclareLocal(GetType(Token))
...
Dim locbldr287 As LocalBuilder = checkFieldIL.DeclareLocal(GetType(System.Type))
...
Dim locbldr288 As LocalBuilder = checkFieldIL.DeclareLocal(GetType(FieldStmt))
locbldr288.SetLocalSymInfo("flss")
...
Dim locbldr289 As LocalBuilder = checkFieldIL.DeclareLocal(GetType(Attributes.Attribute))
...
Dim locbldr290 As LocalBuilder = checkFieldIL.DeclareLocal(GetType(Expr))
...
Dim locbldr291 As LocalBuilder = checkFieldIL.DeclareLocal(asm.GetType("dylan.NET.Tokenizer.Parser.ExprOptimizer"))
...
locbldr292.SetLocalSymInfo("i")
checkFieldIL.Emit(OpCodes.Ldc_I4, CInt(0))
Typ = GetType(System.Int32)
checkFieldIL.Emit(OpCodes.Stloc, 6)
checkFieldIL.MarkSequencePoint(doc5, 409, 1, 409, 100)
Dim locbldr293 As LocalBuilder = checkFieldIL.DeclareLocal(GetType(System.Int32))
locbldr293.SetLocalSymInfo("len")
checkFieldIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
checkFieldIL.Emit(OpCodes.Ldfld, GetType(Stmt).GetField("Tokens"))
Typ = GetType(Stmt).GetField("Tokens").FieldType
...
Dim locbldr294 As LocalBuilder = checkFieldIL.DeclareLocal(GetType(System.Boolean))
locbldr294.SetLocalSymInfo("bl")
checkFieldIL.Emit(OpCodes.Ldc_I4, 0)
Typ = GetType(System.Boolean)
...
checkFieldIL.Emit(OpCodes.Beq, tru223)
checkFieldIL.Emit(OpCodes.Br, fa223)
...
Dim locbldr295 As LocalBuilder = checkFieldIL.DeclareLocal(GetType(Token))
locbldr295.SetLocalSymInfo("tok2")
checkFieldIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
checkFieldIL.Emit(OpCodes.Ldfld, GetType(Stmt).GetField("Tokens"))
Typ = GetType(Stmt).GetField("Tokens").FieldType
...
Dim locbldr296 As LocalBuilder = checkFieldIL.DeclareLocal(GetType(System.Type))
locbldr296.SetLocalSymInfo("typ2")
...
Dim locbldr297 As LocalBuilder = checkFieldIL.DeclareLocal(GetType(System.Boolean))
locbldr297.SetLocalSymInfo("b2")
Dim typ81(-1) As Type
...
checkFieldIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa224 As System.Reflection.Emit.Label = checkFieldIL.DefineLabel()
Dim tru224 As System.Reflection.Emit.Label = checkFieldIL.DefineLabel()
Dim cont224 As System.Reflection.Emit.Label = checkFieldIL.DefineLabel()
checkFieldIL.Emit(OpCodes.Beq, fa224)
checkFieldIL.Emit(OpCodes.Br, tru224)
checkFieldIL.MarkLabel(tru224)
checkFieldIL.MarkSequencePoint(doc5, 438, 1, 438, 100)
Dim locbldr298 As LocalBuilder = checkFieldIL.DeclareLocal(GetType(Token))
locbldr298.SetLocalSymInfo("t")
checkFieldIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
checkFieldIL.Emit(OpCodes.Ldfld, GetType(Stmt).GetField("Tokens"))
Typ = GetType(Stmt).GetField("Tokens").FieldType
...
Dim locbldr299 As LocalBuilder = checkFieldIL.DeclareLocal(GetType(TypeTok))
locbldr299.SetLocalSymInfo("tt")
...
checkFieldIL.Emit(OpCodes.Br, cont224)
checkFieldIL.MarkLabel(fa224)
...
checkFieldIL.Emit(OpCodes.Br, cont224)
checkFieldIL.MarkLabel(cont224)
...
Dim locbldr300 As LocalBuilder = checkMethodIL.DeclareLocal(GetType(Token))
locbldr300.SetLocalSymInfo("tok")
...
Dim locbldr301 As LocalBuilder = checkMethodIL.DeclareLocal(GetType(System.Type))
locbldr301.SetLocalSymInfo("typ")
...
Dim locbldr302 As LocalBuilder = checkMethodIL.DeclareLocal(GetType(MethodStmt))
locbldr302.SetLocalSymInfo("mtss")
...
Dim locbldr303 As LocalBuilder = checkMethodIL.DeclareLocal(GetType(Attributes.Attribute))
locbldr303.SetLocalSymInfo("att")
...
Dim locbldr304 As LocalBuilder = checkMethodIL.DeclareLocal(GetType(Ident))
...
Dim locbldr305 As LocalBuilder = checkMethodIL.DeclareLocal(GetType(Expr))
locbldr305.SetLocalSymInfo("exp")
checkMethodIL.Emit(OpCodes.Ldnull)
checkMethodIL.Emit(OpCodes.Stloc, 5)
checkMethodIL.MarkSequencePoint(doc5, 464, 1, 464, 100)
Dim locbldr306 As LocalBuilder = checkMethodIL.DeclareLocal(GetType(System.Boolean))
locbldr306.SetLocalSymInfo("d")
...
Dim locbldr307 As LocalBuilder = checkMethodIL.DeclareLocal(GetType(Expr))
locbldr307.SetLocalSymInfo("tempexp")
...
Dim locbldr308 As LocalBuilder = checkMethodIL.DeclareLocal(asm.GetType("dylan.NET.Tokenizer.Parser.ExprOptimizer"))
...
locbldr309.SetLocalSymInfo("i")
checkMethodIL.Emit(OpCodes.Ldc_I4, CInt(0))
Typ = GetType(System.Int32)
checkMethodIL.Emit(OpCodes.Stloc, 9)
checkMethodIL.MarkSequencePoint(doc5, 484, 1, 484, 100)
Dim locbldr310 As LocalBuilder = checkMethodIL.DeclareLocal(GetType(System.Int32))
...
Dim locbldr311 As LocalBuilder = checkMethodIL.DeclareLocal(GetType(System.Boolean))
locbldr311.SetLocalSymInfo("bl")
checkMethodIL.Emit(OpCodes.Ldc_I4, 0)
Typ = GetType(System.Boolean)
...
checkMethodIL.Emit(OpCodes.Beq, tru227)
checkMethodIL.Emit(OpCodes.Br, fa227)
...
locbldr312.SetLocalSymInfo("tok2")
checkMethodIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
checkMethodIL.Emit(OpCodes.Ldfld, GetType(Stmt).GetField("Tokens"))
Typ = GetType(Stmt).GetField("Tokens").FieldType
...
locbldr313.SetLocalSymInfo("typ2")
checkMethodIL.MarkSequencePoint(doc5, 518, 1, 518, 100)
Dim locbldr314 As LocalBuilder = checkMethodIL.DeclareLocal(GetType(System.Boolean))
locbldr314.SetLocalSymInfo("b2")
...
checkMethodIL.Emit(OpCodes.Beq, fa228)
checkMethodIL.Emit(OpCodes.Br, tru228)
checkMethodIL.MarkLabel(tru228)
checkMethodIL.MarkSequencePoint(doc5, 524, 1, 524, 100)
Dim locbldr315 As LocalBuilder = checkMethodIL.DeclareLocal(GetType(Token))
locbldr315.SetLocalSymInfo("t")
checkMethodIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
checkMethodIL.Emit(OpCodes.Ldfld, GetType(Stmt).GetField("Tokens"))
Typ = GetType(Stmt).GetField("Tokens").FieldType
...
Dim locbldr316 As LocalBuilder = checkMethodIL.DeclareLocal(GetType(TypeTok))
locbldr316.SetLocalSymInfo("tt")
...
locbldr317.SetLocalSymInfo("eopt2")
checkMethodIL.Emit(OpCodes.Newobj, asm.GetType("dylan.NET.Tokenizer.Parser.ExprOptimizer").GetConstructor(Type.EmptyTypes))
...
Dim locbldr318 As LocalBuilder = checkMethodIL.DeclareLocal(asm.GetType("dylan.NET.Tokenizer.Parser.ExprOptimizer"))
locbldr318.SetLocalSymInfo("eopt1")
checkMethodIL.Emit(OpCodes.Newobj, asm.GetType("dylan.NET.Tokenizer.Parser.ExprOptimizer").GetConstructor(Type.EmptyTypes))
...
checkMethodCallIL.Emit(OpCodes.Bgt, tru239)
...
Dim locbldr319 As LocalBuilder = checkMethodCallIL.DeclareLocal(GetType(Token))
locbldr319.SetLocalSymInfo("tok")
checkMethodCallIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
checkMethodCallIL.Emit(OpCodes.Ldfld, GetType(Stmt).GetField("Tokens"))
Typ = GetType(Stmt).GetField("Tokens").FieldType
...
Dim locbldr320 As LocalBuilder = checkMethodCallIL.DeclareLocal(GetType(System.Type))
locbldr320.SetLocalSymInfo("typ")
...
Dim locbldr321 As LocalBuilder = checkMethodCallIL.DeclareLocal(GetType(Token))
locbldr321.SetLocalSymInfo("tokb")
checkMethodCallIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
checkMethodCallIL.Emit(OpCodes.Ldfld, GetType(Stmt).GetField("Tokens"))
Typ = GetType(Stmt).GetField("Tokens").FieldType
...
Dim locbldr322 As LocalBuilder = checkMethodCallIL.DeclareLocal(GetType(System.Type))
locbldr322.SetLocalSymInfo("typb")
...
Dim locbldr324 As LocalBuilder = checkMethodCallIL.DeclareLocal(GetType(System.Boolean))
locbldr324.SetLocalSymInfo("bb")
Dim typ110(-1) As Type
...
Dim locbldr325 As LocalBuilder = checkMethodCallIL.DeclareLocal(GetType(MethodCallStmt))
locbldr325.SetLocalSymInfo("mtcss")
...
Dim locbldr326 As LocalBuilder = checkMethodCallIL.DeclareLocal(GetType(MethodNameTok))
locbldr326.SetLocalSymInfo("mn")
...
Dim locbldr327 As LocalBuilder = checkMethodCallIL.DeclareLocal(GetType(MethodCallTok))
locbldr327.SetLocalSymInfo("mct")
...
Dim locbldr328 As LocalBuilder = checkMethodCallIL.DeclareLocal(GetType(Ident))
locbldr328.SetLocalSymInfo("idt")
...
Dim locbldr329 As LocalBuilder = checkMethodCallIL.DeclareLocal(GetType(Expr))
locbldr329.SetLocalSymInfo("exp")
...
Dim locbldr330 As LocalBuilder = checkMethodCallIL.DeclareLocal(GetType(System.Int32))
locbldr330.SetLocalSymInfo("lvl")
checkMethodCallIL.Emit(OpCodes.Ldc_I4, CInt(1))
Typ = GetType(System.Int32)
checkMethodCallIL.Emit(OpCodes.Stloc, 11)
checkMethodCallIL.MarkSequencePoint(doc5, 628, 1, 628, 100)
Dim locbldr331 As LocalBuilder = checkMethodCallIL.DeclareLocal(GetType(System.Boolean))
locbldr331.SetLocalSymInfo("d")
...
Dim locbldr332 As LocalBuilder = checkMethodCallIL.DeclareLocal(GetType(System.Int32))
locbldr332.SetLocalSymInfo("i")
checkMethodCallIL.Emit(OpCodes.Ldc_I4, CInt(1))
Typ = GetType(System.Int32)
...
locbldr333.SetLocalSymInfo("tok2")
checkMethodCallIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
checkMethodCallIL.Emit(OpCodes.Ldfld, GetType(Stmt).GetField("Tokens"))
Typ = GetType(Stmt).GetField("Tokens").FieldType
...
locbldr334.SetLocalSymInfo("typ2")
...
locbldr335.SetLocalSymInfo("b2")
checkMethodCallIL.MarkSequencePoint(doc5, 643, 1, 643, 100)
Dim locbldr336 As LocalBuilder = checkMethodCallIL.DeclareLocal(GetType(System.Int32))
locbldr336.SetLocalSymInfo("len")
checkMethodCallIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
checkMethodCallIL.Emit(OpCodes.Ldfld, GetType(Stmt).GetField("Tokens"))
Typ = GetType(Stmt).GetField("Tokens").FieldType
...
Dim locbldr337 As LocalBuilder = checkMethodCallIL.DeclareLocal(asm.GetType("dylan.NET.Tokenizer.Parser.ExprOptimizer"))
locbldr337.SetLocalSymInfo("eopt")
...
checkMethodCallIL.Emit(OpCodes.Beq, tru242)
...
checkMethodCallIL.Emit(OpCodes.Bgt, tru243)
...
checkMethodCallIL.Emit(OpCodes.Beq, tru246)
...
Dim locbldr338 As LocalBuilder = checkVarAsIL.DeclareLocal(GetType(Token))
...
Dim locbldr339 As LocalBuilder = checkVarAsIL.DeclareLocal(GetType(System.Type))
...
Dim locbldr340 As LocalBuilder = checkVarAsIL.DeclareLocal(GetType(VarStmt))
locbldr340.SetLocalSymInfo("vars")
...
checkVarAsIL.Emit(OpCodes.Beq, tru250)
checkVarAsIL.Emit(OpCodes.Br, fa250)
...
Dim locbldr341 As LocalBuilder = checkVarAsIL.DeclareLocal(GetType(Expr))
locbldr341.SetLocalSymInfo("tempexp")
...
Dim locbldr342 As LocalBuilder = checkVarAsIL.DeclareLocal(asm.GetType("dylan.NET.Tokenizer.Parser.ExprOptimizer"))
locbldr342.SetLocalSymInfo("eop")
...
Dim locbldr343 As LocalBuilder = checkVarAsIL.DeclareLocal(GetType(Token))
locbldr343.SetLocalSymInfo("tok2")
checkVarAsIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
checkVarAsIL.Emit(OpCodes.Ldfld, GetType(Stmt).GetField("Tokens"))
Typ = GetType(Stmt).GetField("Tokens").FieldType
...
Dim locbldr344 As LocalBuilder = checkVarAsIL.DeclareLocal(GetType(System.Type))
locbldr344.SetLocalSymInfo("typ2")
checkVarAsIL.Emit(OpCodes.Ldtoken, GetType(TypeTok))
...
Dim locbldr345 As LocalBuilder = checkVarAsIL.DeclareLocal(GetType(System.Boolean))
locbldr345.SetLocalSymInfo("b2")
Dim typ127(-1) As Type
checkVarAsIL.Emit(OpCodes.Ldloc, 6)
Typ = GetType(System.Type)
Typ03 = Typ
...
checkVarAsIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa251 As System.Reflection.Emit.Label = checkVarAsIL.DefineLabel()
Dim tru251 As System.Reflection.Emit.Label = checkVarAsIL.DefineLabel()
Dim cont251 As System.Reflection.Emit.Label = checkVarAsIL.DefineLabel()
checkVarAsIL.Emit(OpCodes.Beq, fa251)
checkVarAsIL.Emit(OpCodes.Br, tru251)
checkVarAsIL.MarkLabel(tru251)
checkVarAsIL.MarkSequencePoint(doc5, 748, 1, 748, 100)
Dim locbldr346 As LocalBuilder = checkVarAsIL.DeclareLocal(GetType(Token))
locbldr346.SetLocalSymInfo("t")
checkVarAsIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
checkVarAsIL.Emit(OpCodes.Ldfld, GetType(Stmt).GetField("Tokens"))
Typ = GetType(Stmt).GetField("Tokens").FieldType
...
Dim locbldr347 As LocalBuilder = checkVarAsIL.DeclareLocal(GetType(TypeTok))
locbldr347.SetLocalSymInfo("tt")
checkVarAsIL.Emit(OpCodes.Newobj, GetType(TypeTok).GetConstructor(Type.EmptyTypes))
...
checkVarAsIL.Emit(OpCodes.Br, cont251)
checkVarAsIL.MarkLabel(fa251)
...
checkVarAsIL.Emit(OpCodes.Br, cont251)
checkVarAsIL.MarkLabel(cont251)
...
Dim locbldr348 As LocalBuilder = AssOptIL.DeclareLocal(GetType(AssignStmt))
locbldr348.SetLocalSymInfo("asss")
AssOptIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
AssOptIL.Emit(OpCodes.Stloc, 0)
AssOptIL.MarkSequencePoint(doc5, 764, 1, 764, 100)
Dim locbldr349 As LocalBuilder = AssOptIL.DeclareLocal(GetType(Expr))
locbldr349.SetLocalSymInfo("le")
...
Dim locbldr350 As LocalBuilder = AssOptIL.DeclareLocal(GetType(Token))
...
Dim locbldr351 As LocalBuilder = AssOptIL.DeclareLocal(GetType(System.Type))
...
Dim locbldr352 As LocalBuilder = AssOptIL.DeclareLocal(GetType(System.Boolean))
locbldr352.SetLocalSymInfo("b")
...
Dim locbldr353 As LocalBuilder = AssOptIL.DeclareLocal(GetType(VarAsgnStmt))
locbldr353.SetLocalSymInfo("vass")
...
AssOptIL.Emit(OpCodes.Beq, tru252)
AssOptIL.Emit(OpCodes.Br, fa252)
...
Dim locbldr354 As LocalBuilder = AssOptIL.DeclareLocal(GetType(Token))
locbldr354.SetLocalSymInfo("tok2")
AssOptIL.Emit(OpCodes.Ldloc, 1)
Typ = GetType(Expr)
AssOptIL.Emit(OpCodes.Ldfld, GetType(Expr).GetField("Tokens"))
Typ = GetType(Expr).GetField("Tokens").FieldType
...
Dim locbldr355 As LocalBuilder = AssOptIL.DeclareLocal(GetType(System.Type))
locbldr355.SetLocalSymInfo("typ2")
...
Dim locbldr356 As LocalBuilder = AssOptIL.DeclareLocal(GetType(System.Boolean))
locbldr356.SetLocalSymInfo("b2")
...
AssOptIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa253 As System.Reflection.Emit.Label = AssOptIL.DefineLabel()
Dim tru253 As System.Reflection.Emit.Label = AssOptIL.DefineLabel()
Dim cont253 As System.Reflection.Emit.Label = AssOptIL.DefineLabel()
AssOptIL.Emit(OpCodes.Beq, fa253)
AssOptIL.Emit(OpCodes.Br, tru253)
AssOptIL.MarkLabel(tru253)
AssOptIL.MarkSequencePoint(doc5, 779, 1, 779, 100)
Dim locbldr357 As LocalBuilder = AssOptIL.DeclareLocal(GetType(Token))
locbldr357.SetLocalSymInfo("t")
AssOptIL.Emit(OpCodes.Ldloc, 1)
Typ = GetType(Expr)
AssOptIL.Emit(OpCodes.Ldfld, GetType(Expr).GetField("Tokens"))
Typ = GetType(Expr).GetField("Tokens").FieldType
...
Dim locbldr358 As LocalBuilder = AssOptIL.DeclareLocal(GetType(TypeTok))
locbldr358.SetLocalSymInfo("tt")
...
AssOptIL.Emit(OpCodes.Br, cont253)
AssOptIL.MarkLabel(fa253)
...
Dim locbldr359 As LocalBuilder = AssOptIL.DeclareLocal(asm.GetType("dylan.NET.Tokenizer.Parser.ExprOptimizer"))
locbldr359.SetLocalSymInfo("eop")
...
Dim locbldr360 As LocalBuilder = checkAssignIL.DeclareLocal(GetType(Token))
locbldr360.SetLocalSymInfo("tok")
checkAssignIL.Emit(OpCodes.Ldnull)
checkAssignIL.Emit(OpCodes.Stloc, 0)
checkAssignIL.MarkSequencePoint(doc5, 801, 1, 801, 100)
Dim locbldr361 As LocalBuilder = checkAssignIL.DeclareLocal(GetType(System.Type))
locbldr361.SetLocalSymInfo("typ")
...
Dim locbldr362 As LocalBuilder = checkAssignIL.DeclareLocal(GetType(AssignStmt))
locbldr362.SetLocalSymInfo("asss")
...
Dim locbldr363 As LocalBuilder = checkAssignIL.DeclareLocal(GetType(System.Boolean))
locbldr363.SetLocalSymInfo("c")
...
Dim locbldr365 As LocalBuilder = checkAssignIL.DeclareLocal(GetType(Expr))
locbldr365.SetLocalSymInfo("le")
checkAssignIL.Emit(OpCodes.Newobj, GetType(Expr).GetConstructor(Type.EmptyTypes))
...
locbldr367.SetLocalSymInfo("len")
...
Dim locbldr368 As LocalBuilder = checkAssignIL.DeclareLocal(GetType(System.Int32))
locbldr368.SetLocalSymInfo("assind")
...
checkAssignIL.Emit(OpCodes.Beq, tru255)
checkAssignIL.Emit(OpCodes.Br, fa255)
...
checkAssignIL.Emit(OpCodes.Beq, fa256)
checkAssignIL.Emit(OpCodes.Br, tru256)
...
checkAssignIL.Emit(OpCodes.Ldloc, 7)
Typ = GetType(System.Int32)
Dim fa258 As System.Reflection.Emit.Label = checkAssignIL.DefineLabel()
Dim tru258 As System.Reflection.Emit.Label = checkAssignIL.DefineLabel()
Dim cont258 As System.Reflection.Emit.Label = checkAssignIL.DefineLabel()
checkAssignIL.Emit(OpCodes.Beq, tru258)
checkAssignIL.Emit(OpCodes.Br, fa258)
checkAssignIL.MarkLabel(tru258)
...
checkAssignIL.Emit(OpCodes.Br, cont258)
checkAssignIL.MarkLabel(fa258)
...
checkAssignIL.Emit(OpCodes.Br, cont258)
checkAssignIL.MarkLabel(cont258)
...
Dim locbldr369 As LocalBuilder = checkAssignIL.DeclareLocal(asm.GetType("dylan.NET.Tokenizer.Parser.ExprOptimizer"))
locbldr369.SetLocalSymInfo("eop")
...
locbldr370.SetLocalSymInfo("i")
OptimizeIL.Emit(OpCodes.Ldc_I4, CInt(-1))
Typ = GetType(System.Int32)
OptimizeIL.Emit(OpCodes.Stloc, 0)
OptimizeIL.MarkSequencePoint(doc5, 904, 1, 904, 100)
Dim locbldr371 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(System.Int32))
locbldr371.SetLocalSymInfo("len")
OptimizeIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
...
Dim locbldr372 As LocalBuilder = OptimizeIL.DeclareLocal(asm.GetType("dylan.NET.Tokenizer.Parser.TokenOptimizer"))
locbldr372.SetLocalSymInfo("to")
OptimizeIL.Emit(OpCodes.Ldnull)
OptimizeIL.Emit(OpCodes.Stloc, 2)
OptimizeIL.MarkSequencePoint(doc5, 906, 1, 906, 100)
Dim locbldr373 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(Stmt))
locbldr373.SetLocalSymInfo("tmpstm")
OptimizeIL.Emit(OpCodes.Ldnull)
OptimizeIL.Emit(OpCodes.Stloc, 3)
OptimizeIL.MarkSequencePoint(doc5, 907, 1, 907, 100)
Dim locbldr374 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(System.Boolean))
locbldr374.SetLocalSymInfo("compb")
OptimizeIL.Emit(OpCodes.Ldc_I4, 0)
Typ = GetType(System.Boolean)
OptimizeIL.Emit(OpCodes.Stloc, 4)
...
OptimizeIL.Emit(OpCodes.Blt, tru259)
...
Dim locbldr375 As LocalBuilder = ParseIL.DeclareLocal(GetType(System.Int32))
locbldr375.SetLocalSymInfo("i")
ParseIL.Emit(OpCodes.Ldc_I4, CInt(-1))
Typ = GetType(System.Int32)
ParseIL.Emit(OpCodes.Stloc, 0)
ParseIL.MarkSequencePoint(doc6, 13, 1, 13, 100)
Dim locbldr376 As LocalBuilder = ParseIL.DeclareLocal(asm.GetType("dylan.NET.Tokenizer.Parser.StmtOptimizer"))
locbldr376.SetLocalSymInfo("so")
ParseIL.Emit(OpCodes.Ldnull)
ParseIL.Emit(OpCodes.Stloc, 1)
ParseIL.MarkSequencePoint(doc6, 14, 1, 14, 100)
Dim locbldr377 As LocalBuilder = ParseIL.DeclareLocal(GetType(System.Int32))
locbldr377.SetLocalSymInfo("len")
...
ParseIL.Emit(OpCodes.Ldloc, 2)
Typ = GetType(System.Int32)
Dim fa283 As System.Reflection.Emit.Label = ParseIL.DefineLabel()
Dim tru283 As System.Reflection.Emit.Label = ParseIL.DefineLabel()
Dim cont283 As System.Reflection.Emit.Label = ParseIL.DefineLabel()
ParseIL.Emit(OpCodes.Beq, tru283)
ParseIL.Emit(OpCodes.Br, fa283)
ParseIL.MarkLabel(tru283)
ParseIL.MarkSequencePoint(doc6, 27, 1, 27, 100)
ParseIL.Emit(OpCodes.Br, label1)
ParseIL.MarkSequencePoint(doc6, 28, 1, 28, 100)
ParseIL.Emit(OpCodes.Br, cont283)
ParseIL.MarkLabel(fa283)
ParseIL.MarkSequencePoint(doc6, 29, 1, 29, 100)
ParseIL.Emit(OpCodes.Br, label0)
ParseIL.MarkSequencePoint(doc6, 30, 1, 30, 100)
ParseIL.Emit(OpCodes.Br, cont283)
ParseIL.MarkLabel(cont283)
