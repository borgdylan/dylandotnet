...
Dim checkVarAs As MethodBuilder = StmtOptimizer.DefineMethod("checkVarAs", MethodAttributes.Public, GetType(Stmt), typ70)
Dim checkVarAsIL As ILGenerator = checkVarAs.GetILGenerator()
Dim checkVarAsparam00 As ParameterBuilder = checkVarAs.DefineParameter(0, ParameterAttributes.RetVal, "")
Dim checkVarAsparam01 As ParameterBuilder = checkVarAs.DefineParameter(1, ParameterAttributes.None, "stm")
Dim checkVarAsparam02 As ParameterBuilder = checkVarAs.DefineParameter(2, ParameterAttributes.None, "b")
checkVarAsIL.MarkSequencePoint(doc5, 365, 1, 365, 100)
Dim locbldr155 As LocalBuilder = checkVarAsIL.DeclareLocal(GetType(Token))
...
Typ = Typ.GetElementType()
checkVarAsIL.Emit(OpCodes.Stloc, 0)
checkVarAsIL.MarkSequencePoint(doc5, 366, 1, 366, 100)
Dim locbldr156 As LocalBuilder = checkVarAsIL.DeclareLocal(GetType(System.Type))
locbldr156.SetLocalSymInfo("typ")
checkVarAsIL.Emit(OpCodes.Ldtoken, GetType(VarTok))
Dim typ71 As Type() = {GetType(System.RuntimeTypeHandle)}
checkVarAsIL.Emit(OpCodes.Call, GetType(System.Type).GetMethod("GetTypeFromHandle", typ71))
Typ = GetType(System.Type).GetMethod("GetTypeFromHandle", typ71).ReturnType
checkVarAsIL.Emit(OpCodes.Stloc, 1)
checkVarAsIL.MarkSequencePoint(doc5, 367, 1, 367, 100)
checkVarAsIL.Emit(OpCodes.Ldarg, 2)
Typ = GetType(System.Boolean).MakeByRefType()
Typ04 = Typ.GetElementType()
Dim typ72(-1) As Type
...
ReDim Preserve typ72(UBound(typ72) + 1)
typ72(UBound(typ72)) = Typ
checkVarAsIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("IsInstanceOfType", typ72))
Typ = Typ03.GetMethod("IsInstanceOfType", typ72).ReturnType
checkVarAsIL.Emit(OpCodes.Stobj, Typ04)
checkVarAsIL.MarkSequencePoint(doc5, 368, 1, 368, 100)
Dim locbldr157 As LocalBuilder = checkVarAsIL.DeclareLocal(GetType(VarStmt))
locbldr157.SetLocalSymInfo("vars")
checkVarAsIL.Emit(OpCodes.Newobj, GetType(VarStmt).GetConstructor(Type.EmptyTypes))
checkVarAsIL.Emit(OpCodes.Stloc, 2)
checkVarAsIL.MarkSequencePoint(doc5, 370, 1, 370, 100)
checkVarAsIL.Emit(OpCodes.Ldarg, 2)
Typ = GetType(System.Boolean).MakeByRefType()
checkVarAsIL.Emit(OpCodes.Ldobj, Typ.GetElementType())
Typ = Typ.GetElementType()
...
checkVarAsIL.Emit(OpCodes.Beq, tru108)
checkVarAsIL.Emit(OpCodes.Br, fa108)
checkVarAsIL.MarkLabel(tru108)
checkVarAsIL.MarkSequencePoint(doc5, 371, 1, 371, 100)
checkVarAsIL.Emit(OpCodes.Ldloc, 2)
Typ = GetType(VarStmt)
checkVarAsIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
...
checkVarAsIL.MarkSequencePoint(doc5, 372, 1, 372, 100)
checkVarAsIL.Emit(OpCodes.Ldloc, 2)
Typ = GetType(VarStmt)
checkVarAsIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
...
checkVarAsIL.MarkSequencePoint(doc5, 373, 1, 373, 100)
checkVarAsIL.Emit(OpCodes.Ldloc, 2)
Typ = GetType(VarStmt)
checkVarAsIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
...
checkVarAsIL.MarkSequencePoint(doc5, 375, 1, 375, 100)
Dim locbldr158 As LocalBuilder = checkVarAsIL.DeclareLocal(GetType(Token))
...
Typ = Typ.GetElementType()
checkVarAsIL.Emit(OpCodes.Stloc, 3)
checkVarAsIL.MarkSequencePoint(doc5, 376, 1, 376, 100)
Dim locbldr159 As LocalBuilder = checkVarAsIL.DeclareLocal(GetType(System.Type))
locbldr159.SetLocalSymInfo("typ2")
checkVarAsIL.Emit(OpCodes.Ldtoken, GetType(TypeTok))
Dim typ73 As Type() = {GetType(System.RuntimeTypeHandle)}
checkVarAsIL.Emit(OpCodes.Call, GetType(System.Type).GetMethod("GetTypeFromHandle", typ73))
Typ = GetType(System.Type).GetMethod("GetTypeFromHandle", typ73).ReturnType
checkVarAsIL.Emit(OpCodes.Stloc, 4)
checkVarAsIL.MarkSequencePoint(doc5, 377, 1, 377, 100)
Dim locbldr160 As LocalBuilder = checkVarAsIL.DeclareLocal(GetType(System.Boolean))
...
ReDim Preserve typ74(UBound(typ74) + 1)
typ74(UBound(typ74)) = Typ
checkVarAsIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("IsInstanceOfType", typ74))
Typ = Typ03.GetMethod("IsInstanceOfType", typ74).ReturnType
checkVarAsIL.Emit(OpCodes.Stloc, 5)
checkVarAsIL.MarkSequencePoint(doc5, 379, 1, 379, 100)
checkVarAsIL.Emit(OpCodes.Ldloc, 5)
Typ = GetType(System.Boolean)
checkVarAsIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
...
checkVarAsIL.Emit(OpCodes.Beq, fa109)
checkVarAsIL.Emit(OpCodes.Br, tru109)
checkVarAsIL.MarkLabel(tru109)
checkVarAsIL.MarkSequencePoint(doc5, 380, 1, 380, 100)
Dim locbldr161 As LocalBuilder = checkVarAsIL.DeclareLocal(GetType(Token))
locbldr161.SetLocalSymInfo("t")
checkVarAsIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
checkVarAsIL.Emit(OpCodes.Ldfld, GetType(Stmt).GetField("Tokens"))
Typ = GetType(Stmt).GetField("Tokens").FieldType
...
Typ = Typ.GetElementType()
checkVarAsIL.Emit(OpCodes.Stloc, 6)
checkVarAsIL.MarkSequencePoint(doc5, 381, 1, 381, 100)
Dim locbldr162 As LocalBuilder = checkVarAsIL.DeclareLocal(GetType(TypeTok))
locbldr162.SetLocalSymInfo("tt")
checkVarAsIL.Emit(OpCodes.Newobj, GetType(TypeTok).GetConstructor(Type.EmptyTypes))
checkVarAsIL.Emit(OpCodes.Stloc, 7)
checkVarAsIL.MarkSequencePoint(doc5, 382, 1, 382, 100)
checkVarAsIL.Emit(OpCodes.Ldloc, 7)
Typ = GetType(TypeTok)
checkVarAsIL.Emit(OpCodes.Ldloc, 6)
Typ = GetType(Token)
...
Typ = GetType(Token).GetField("Line").FieldType
checkVarAsIL.Emit(OpCodes.Stfld, GetType(TypeTok).GetField("Line"))
checkVarAsIL.MarkSequencePoint(doc5, 383, 1, 383, 100)
checkVarAsIL.Emit(OpCodes.Ldloc, 7)
Typ = GetType(TypeTok)
checkVarAsIL.Emit(OpCodes.Ldloc, 6)
Typ = GetType(Token)
...
Typ = GetType(Token).GetField("Value").FieldType
checkVarAsIL.Emit(OpCodes.Stfld, GetType(TypeTok).GetField("Value"))
checkVarAsIL.MarkSequencePoint(doc5, 384, 1, 384, 100)
checkVarAsIL.Emit(OpCodes.Ldloc, 2)
Typ = GetType(VarStmt)
checkVarAsIL.Emit(OpCodes.Ldloc, 7)
Typ = GetType(TypeTok)
checkVarAsIL.Emit(OpCodes.Stfld, GetType(VarStmt).GetField("VarTyp"))
checkVarAsIL.MarkSequencePoint(doc5, 385, 1, 385, 100)
checkVarAsIL.Emit(OpCodes.Br, cont109)
checkVarAsIL.MarkLabel(fa109)
checkVarAsIL.MarkSequencePoint(doc5, 386, 1, 386, 100)
checkVarAsIL.Emit(OpCodes.Ldloc, 2)
Typ = GetType(VarStmt)
checkVarAsIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
...
Typ = Typ.GetElementType()
checkVarAsIL.Emit(OpCodes.Stfld, GetType(VarStmt).GetField("VarTyp"))
checkVarAsIL.MarkSequencePoint(doc5, 387, 1, 387, 100)
checkVarAsIL.Emit(OpCodes.Br, cont109)
checkVarAsIL.MarkLabel(cont109)
checkVarAsIL.MarkSequencePoint(doc5, 389, 1, 389, 100)
checkVarAsIL.Emit(OpCodes.Br, cont108)
checkVarAsIL.MarkLabel(fa108)
checkVarAsIL.Emit(OpCodes.Br, cont108)
checkVarAsIL.MarkLabel(cont108)
checkVarAsIL.MarkSequencePoint(doc5, 390, 1, 390, 100)
checkVarAsIL.Emit(OpCodes.Ldloc, 2)
Typ = GetType(VarStmt)
checkVarAsIL.MarkSequencePoint(doc5, 391, 1, 391, 100)
checkVarAsIL.Emit(OpCodes.Ret)
Dim typ75(-1) As Type
ReDim Preserve typ75(UBound(typ75) + 1)
typ75(UBound(typ75)) = GetType(Stmt)
Dim AssOpt As MethodBuilder = StmtOptimizer.DefineMethod("AssOpt", MethodAttributes.Public, GetType(Stmt), typ75)
...
AssOptIL.MarkSequencePoint(doc5, 395, 1, 395, 100)
Dim locbldr163 As LocalBuilder = AssOptIL.DeclareLocal(GetType(AssignStmt))
locbldr163.SetLocalSymInfo("asss")
AssOptIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
AssOptIL.Emit(OpCodes.Stloc, 0)
AssOptIL.MarkSequencePoint(doc5, 396, 1, 396, 100)
Dim locbldr164 As LocalBuilder = AssOptIL.DeclareLocal(GetType(Expr))
locbldr164.SetLocalSymInfo("le")
...
AssOptIL.MarkSequencePoint(doc5, 397, 1, 397, 100)
Dim locbldr165 As LocalBuilder = AssOptIL.DeclareLocal(GetType(Token))
...
AssOptIL.MarkSequencePoint(doc5, 398, 1, 398, 100)
Dim locbldr166 As LocalBuilder = AssOptIL.DeclareLocal(GetType(System.Type))
...
AssOptIL.Emit(OpCodes.Call, GetType(System.Type).GetMethod("GetTypeFromHandle", typ76))
Typ = GetType(System.Type).GetMethod("GetTypeFromHandle", typ76).ReturnType
AssOptIL.Emit(OpCodes.Stloc, 3)
AssOptIL.MarkSequencePoint(doc5, 399, 1, 399, 100)
Dim locbldr167 As LocalBuilder = AssOptIL.DeclareLocal(GetType(System.Boolean))
locbldr167.SetLocalSymInfo("b")
Dim typ77(-1) As Type
...
ReDim Preserve typ77(UBound(typ77) + 1)
typ77(UBound(typ77)) = Typ
AssOptIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("IsInstanceOfType", typ77))
Typ = Typ03.GetMethod("IsInstanceOfType", typ77).ReturnType
AssOptIL.Emit(OpCodes.Stloc, 4)
AssOptIL.MarkSequencePoint(doc5, 400, 1, 400, 100)
Dim locbldr168 As LocalBuilder = AssOptIL.DeclareLocal(GetType(VarAsgnStmt))
locbldr168.SetLocalSymInfo("vass")
AssOptIL.Emit(OpCodes.Newobj, GetType(VarAsgnStmt).GetConstructor(Type.EmptyTypes))
AssOptIL.Emit(OpCodes.Stloc, 5)
AssOptIL.MarkSequencePoint(doc5, 401, 1, 401, 100)
AssOptIL.Emit(OpCodes.Ldloc, 4)
Typ = GetType(System.Boolean)
AssOptIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa110 As System.Reflection.Emit.Label = AssOptIL.DefineLabel()
Dim tru110 As System.Reflection.Emit.Label = AssOptIL.DefineLabel()
Dim cont110 As System.Reflection.Emit.Label = AssOptIL.DefineLabel()
AssOptIL.Emit(OpCodes.Beq, tru110)
AssOptIL.Emit(OpCodes.Br, fa110)
AssOptIL.MarkLabel(tru110)
AssOptIL.MarkSequencePoint(doc5, 402, 1, 402, 100)
...
AssOptIL.MarkSequencePoint(doc5, 403, 1, 403, 100)
AssOptIL.Emit(OpCodes.Ldloc, 5)
Typ = GetType(VarAsgnStmt)
AssOptIL.Emit(OpCodes.Ldloc, 0)
Typ = GetType(AssignStmt)
...
AssOptIL.MarkSequencePoint(doc5, 404, 1, 404, 100)
AssOptIL.Emit(OpCodes.Ldloc, 5)
Typ = GetType(VarAsgnStmt)
AssOptIL.Emit(OpCodes.Ldloc, 1)
Typ = GetType(Expr)
...
AssOptIL.MarkSequencePoint(doc5, 406, 1, 406, 100)
Dim locbldr169 As LocalBuilder = AssOptIL.DeclareLocal(GetType(Token))
...
AssOptIL.MarkSequencePoint(doc5, 407, 1, 407, 100)
Dim locbldr170 As LocalBuilder = AssOptIL.DeclareLocal(GetType(System.Type))
...
AssOptIL.Emit(OpCodes.Call, GetType(System.Type).GetMethod("GetTypeFromHandle", typ78))
Typ = GetType(System.Type).GetMethod("GetTypeFromHandle", typ78).ReturnType
AssOptIL.Emit(OpCodes.Stloc, 7)
AssOptIL.MarkSequencePoint(doc5, 408, 1, 408, 100)
Dim locbldr171 As LocalBuilder = AssOptIL.DeclareLocal(GetType(System.Boolean))
...
ReDim Preserve typ79(UBound(typ79) + 1)
typ79(UBound(typ79)) = Typ
AssOptIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("IsInstanceOfType", typ79))
Typ = Typ03.GetMethod("IsInstanceOfType", typ79).ReturnType
AssOptIL.Emit(OpCodes.Stloc, 8)
AssOptIL.MarkSequencePoint(doc5, 410, 1, 410, 100)
AssOptIL.Emit(OpCodes.Ldloc, 8)
Typ = GetType(System.Boolean)
AssOptIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa111 As System.Reflection.Emit.Label = AssOptIL.DefineLabel()
Dim tru111 As System.Reflection.Emit.Label = AssOptIL.DefineLabel()
Dim cont111 As System.Reflection.Emit.Label = AssOptIL.DefineLabel()
AssOptIL.Emit(OpCodes.Beq, fa111)
AssOptIL.Emit(OpCodes.Br, tru111)
AssOptIL.MarkLabel(tru111)
AssOptIL.MarkSequencePoint(doc5, 411, 1, 411, 100)
Dim locbldr172 As LocalBuilder = AssOptIL.DeclareLocal(GetType(Token))
locbldr172.SetLocalSymInfo("t")
AssOptIL.Emit(OpCodes.Ldloc, 1)
Typ = GetType(Expr)
AssOptIL.Emit(OpCodes.Ldfld, GetType(Expr).GetField("Tokens"))
Typ = GetType(Expr).GetField("Tokens").FieldType
...
AssOptIL.MarkSequencePoint(doc5, 412, 1, 412, 100)
Dim locbldr173 As LocalBuilder = AssOptIL.DeclareLocal(GetType(TypeTok))
locbldr173.SetLocalSymInfo("tt")
AssOptIL.Emit(OpCodes.Newobj, GetType(TypeTok).GetConstructor(Type.EmptyTypes))
AssOptIL.Emit(OpCodes.Stloc, 10)
AssOptIL.MarkSequencePoint(doc5, 413, 1, 413, 100)
...
AssOptIL.MarkSequencePoint(doc5, 414, 1, 414, 100)
AssOptIL.Emit(OpCodes.Ldloc, 10)
Typ = GetType(TypeTok)
AssOptIL.Emit(OpCodes.Ldloc, 9)
Typ = GetType(Token)
...
AssOptIL.MarkSequencePoint(doc5, 415, 1, 415, 100)
AssOptIL.Emit(OpCodes.Ldloc, 5)
Typ = GetType(VarAsgnStmt)
AssOptIL.Emit(OpCodes.Ldloc, 10)
Typ = GetType(TypeTok)
AssOptIL.Emit(OpCodes.Stfld, GetType(VarAsgnStmt).GetField("VarTyp"))
AssOptIL.MarkSequencePoint(doc5, 416, 1, 416, 100)
AssOptIL.Emit(OpCodes.Br, cont111)
AssOptIL.MarkLabel(fa111)
AssOptIL.MarkSequencePoint(doc5, 417, 1, 417, 100)
AssOptIL.Emit(OpCodes.Ldloc, 5)
Typ = GetType(VarAsgnStmt)
AssOptIL.Emit(OpCodes.Ldloc, 1)
Typ = GetType(Expr)
...
Typ = Typ.GetElementType()
AssOptIL.Emit(OpCodes.Stfld, GetType(VarAsgnStmt).GetField("VarTyp"))
AssOptIL.MarkSequencePoint(doc5, 418, 1, 418, 100)
AssOptIL.Emit(OpCodes.Br, cont111)
AssOptIL.MarkLabel(cont111)
AssOptIL.MarkSequencePoint(doc5, 420, 1, 420, 100)
AssOptIL.Emit(OpCodes.Ldloc, 5)
Typ = GetType(VarAsgnStmt)
AssOptIL.Emit(OpCodes.Ldloc, 0)
Typ = GetType(AssignStmt)
...
AssOptIL.MarkSequencePoint(doc5, 422, 1, 422, 100)
AssOptIL.Emit(OpCodes.Ldloc, 5)
Typ = GetType(VarAsgnStmt)
AssOptIL.MarkSequencePoint(doc5, 423, 1, 423, 100)
AssOptIL.Emit(OpCodes.Br, cont110)
AssOptIL.MarkLabel(fa110)
AssOptIL.MarkSequencePoint(doc5, 424, 1, 424, 100)
AssOptIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
AssOptIL.MarkSequencePoint(doc5, 425, 1, 425, 100)
AssOptIL.Emit(OpCodes.Br, cont110)
AssOptIL.MarkLabel(cont110)
AssOptIL.MarkSequencePoint(doc5, 427, 1, 427, 100)
AssOptIL.Emit(OpCodes.Ret)
Dim typ80(-1) As Type
ReDim Preserve typ80(UBound(typ80) + 1)
typ80(UBound(typ80)) = GetType(Stmt)
ReDim Preserve typ80(UBound(typ80) + 1)
typ80(UBound(typ80)) = GetType(System.Boolean).MakeByRefType()
Dim checkAssign As MethodBuilder = StmtOptimizer.DefineMethod("checkAssign", MethodAttributes.Public, GetType(Stmt), typ80)
...
checkAssignIL.MarkSequencePoint(doc5, 430, 1, 430, 100)
Dim locbldr174 As LocalBuilder = checkAssignIL.DeclareLocal(GetType(Token))
locbldr174.SetLocalSymInfo("tok")
checkAssignIL.Emit(OpCodes.Ldnull)
checkAssignIL.Emit(OpCodes.Stloc, 0)
checkAssignIL.MarkSequencePoint(doc5, 431, 1, 431, 100)
Dim locbldr175 As LocalBuilder = checkAssignIL.DeclareLocal(GetType(System.Type))
...
checkAssignIL.Emit(OpCodes.Call, GetType(System.Type).GetMethod("GetTypeFromHandle", typ81))
Typ = GetType(System.Type).GetMethod("GetTypeFromHandle", typ81).ReturnType
checkAssignIL.Emit(OpCodes.Stloc, 1)
checkAssignIL.MarkSequencePoint(doc5, 432, 1, 432, 100)
Dim locbldr176 As LocalBuilder = checkAssignIL.DeclareLocal(GetType(AssignStmt))
locbldr176.SetLocalSymInfo("asss")
checkAssignIL.Emit(OpCodes.Newobj, GetType(AssignStmt).GetConstructor(Type.EmptyTypes))
checkAssignIL.Emit(OpCodes.Stloc, 2)
checkAssignIL.MarkSequencePoint(doc5, 433, 1, 433, 100)
Dim locbldr177 As LocalBuilder = checkAssignIL.DeclareLocal(GetType(System.Boolean))
locbldr177.SetLocalSymInfo("c")
checkAssignIL.Emit(OpCodes.Ldc_I4, 0)
Typ = GetType(System.Boolean)
checkAssignIL.Emit(OpCodes.Stloc, 3)
checkAssignIL.MarkSequencePoint(doc5, 434, 1, 434, 100)
Dim locbldr178 As LocalBuilder = checkAssignIL.DeclareLocal(GetType(Expr))
locbldr178.SetLocalSymInfo("re")
checkAssignIL.Emit(OpCodes.Newobj, GetType(Expr).GetConstructor(Type.EmptyTypes))
checkAssignIL.Emit(OpCodes.Stloc, 4)
checkAssignIL.MarkSequencePoint(doc5, 435, 1, 435, 100)
Dim locbldr179 As LocalBuilder = checkAssignIL.DeclareLocal(GetType(Expr))
locbldr179.SetLocalSymInfo("le")
checkAssignIL.Emit(OpCodes.Newobj, GetType(Expr).GetConstructor(Type.EmptyTypes))
checkAssignIL.Emit(OpCodes.Stloc, 5)
checkAssignIL.MarkSequencePoint(doc5, 436, 1, 436, 100)
Dim locbldr180 As LocalBuilder = checkAssignIL.DeclareLocal(GetType(System.Int32))
locbldr180.SetLocalSymInfo("i")
checkAssignIL.Emit(OpCodes.Ldc_I4, CInt(-1))
Typ = GetType(System.Int32)
checkAssignIL.Emit(OpCodes.Stloc, 6)
checkAssignIL.MarkSequencePoint(doc5, 437, 1, 437, 100)
Dim locbldr181 As LocalBuilder = checkAssignIL.DeclareLocal(GetType(System.Int32))
...
checkAssignIL.MarkSequencePoint(doc5, 438, 1, 438, 100)
Dim locbldr182 As LocalBuilder = checkAssignIL.DeclareLocal(GetType(System.Int32))
locbldr182.SetLocalSymInfo("assind")
checkAssignIL.Emit(OpCodes.Ldc_I4, CInt(0))
Typ = GetType(System.Int32)
checkAssignIL.Emit(OpCodes.Stloc, 8)
checkAssignIL.MarkSequencePoint(doc5, 440, 1, 440, 100)
Dim label7 As System.Reflection.Emit.Label = checkAssignIL.DefineLabel()
checkAssignIL.MarkSequencePoint(doc5, 441, 1, 441, 100)
Dim label8 As System.Reflection.Emit.Label = checkAssignIL.DefineLabel()
checkAssignIL.MarkSequencePoint(doc5, 443, 1, 443, 100)
checkAssignIL.MarkLabel(label7)
checkAssignIL.MarkSequencePoint(doc5, 445, 1, 445, 100)
...
checkAssignIL.Emit(OpCodes.Stloc, 6)
checkAssignIL.MarkSequencePoint(doc5, 447, 1, 447, 100)
checkAssignIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
checkAssignIL.Emit(OpCodes.Ldfld, GetType(Stmt).GetField("Tokens"))
Typ = GetType(Stmt).GetField("Tokens").FieldType
...
Typ = Typ.GetElementType()
checkAssignIL.Emit(OpCodes.Stloc, 0)
checkAssignIL.MarkSequencePoint(doc5, 448, 1, 448, 100)
Dim typ82(-1) As Type
...
ReDim Preserve typ82(UBound(typ82) + 1)
typ82(UBound(typ82)) = Typ
checkAssignIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("IsInstanceOfType", typ82))
Typ = Typ03.GetMethod("IsInstanceOfType", typ82).ReturnType
checkAssignIL.Emit(OpCodes.Stloc, 3)
checkAssignIL.MarkSequencePoint(doc5, 450, 1, 450, 100)
checkAssignIL.Emit(OpCodes.Ldloc, 3)
Typ = GetType(System.Boolean)
checkAssignIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa112 As System.Reflection.Emit.Label = checkAssignIL.DefineLabel()
Dim tru112 As System.Reflection.Emit.Label = checkAssignIL.DefineLabel()
Dim cont112 As System.Reflection.Emit.Label = checkAssignIL.DefineLabel()
checkAssignIL.Emit(OpCodes.Beq, tru112)
checkAssignIL.Emit(OpCodes.Br, fa112)
checkAssignIL.MarkLabel(tru112)
checkAssignIL.MarkSequencePoint(doc5, 451, 1, 451, 100)
checkAssignIL.Emit(OpCodes.Ldloc, 6)
Typ = GetType(System.Int32)
checkAssignIL.Emit(OpCodes.Stloc, 8)
checkAssignIL.MarkSequencePoint(doc5, 452, 1, 452, 100)
checkAssignIL.Emit(OpCodes.Br, label8)
checkAssignIL.MarkSequencePoint(doc5, 453, 1, 453, 100)
checkAssignIL.Emit(OpCodes.Br, cont112)
checkAssignIL.MarkLabel(fa112)
checkAssignIL.Emit(OpCodes.Br, cont112)
checkAssignIL.MarkLabel(cont112)
checkAssignIL.MarkSequencePoint(doc5, 455, 1, 455, 100)
checkAssignIL.Emit(OpCodes.Ldloc, 6)
Typ = GetType(System.Int32)
checkAssignIL.Emit(OpCodes.Ldloc, 7)
Typ = GetType(System.Int32)
Dim fa113 As System.Reflection.Emit.Label = checkAssignIL.DefineLabel()
Dim tru113 As System.Reflection.Emit.Label = checkAssignIL.DefineLabel()
Dim cont113 As System.Reflection.Emit.Label = checkAssignIL.DefineLabel()
checkAssignIL.Emit(OpCodes.Beq, tru113)
checkAssignIL.Emit(OpCodes.Br, fa113)
checkAssignIL.MarkLabel(tru113)
checkAssignIL.MarkSequencePoint(doc5, 456, 1, 456, 100)
checkAssignIL.Emit(OpCodes.Br, label8)
checkAssignIL.MarkSequencePoint(doc5, 457, 1, 457, 100)
checkAssignIL.Emit(OpCodes.Br, cont113)
checkAssignIL.MarkLabel(fa113)
checkAssignIL.MarkSequencePoint(doc5, 458, 1, 458, 100)
checkAssignIL.Emit(OpCodes.Br, label7)
checkAssignIL.MarkSequencePoint(doc5, 459, 1, 459, 100)
checkAssignIL.Emit(OpCodes.Br, cont113)
checkAssignIL.MarkLabel(cont113)
checkAssignIL.MarkSequencePoint(doc5, 461, 1, 461, 100)
checkAssignIL.MarkLabel(label8)
checkAssignIL.MarkSequencePoint(doc5, 463, 1, 463, 100)
checkAssignIL.Emit(OpCodes.Ldloc, 8)
Typ = GetType(System.Int32)
checkAssignIL.Emit(OpCodes.Ldc_I4, CInt(0))
Typ = GetType(System.Int32)
Dim fa114 As System.Reflection.Emit.Label = checkAssignIL.DefineLabel()
Dim tru114 As System.Reflection.Emit.Label = checkAssignIL.DefineLabel()
Dim cont114 As System.Reflection.Emit.Label = checkAssignIL.DefineLabel()
checkAssignIL.Emit(OpCodes.Beq, fa114)
checkAssignIL.Emit(OpCodes.Br, tru114)
checkAssignIL.MarkLabel(tru114)
checkAssignIL.MarkSequencePoint(doc5, 465, 1, 465, 100)
checkAssignIL.Emit(OpCodes.Ldc_I4, CInt(-1))
Typ = GetType(System.Int32)
checkAssignIL.Emit(OpCodes.Stloc, 6)
checkAssignIL.MarkSequencePoint(doc5, 466, 1, 466, 100)
checkAssignIL.Emit(OpCodes.Ldloc, 8)
Typ = GetType(System.Int32)
checkAssignIL.Emit(OpCodes.Ldc_I4, CInt(1))
Typ = GetType(System.Int32)
checkAssignIL.Emit(OpCodes.Sub)
checkAssignIL.Emit(OpCodes.Stloc, 7)
checkAssignIL.MarkSequencePoint(doc5, 468, 1, 468, 100)
Dim label9 As System.Reflection.Emit.Label = checkAssignIL.DefineLabel()
checkAssignIL.MarkSequencePoint(doc5, 469, 1, 469, 100)
Dim label10 As System.Reflection.Emit.Label = checkAssignIL.DefineLabel()
checkAssignIL.MarkSequencePoint(doc5, 471, 1, 471, 100)
checkAssignIL.MarkLabel(label9)
checkAssignIL.MarkSequencePoint(doc5, 473, 1, 473, 100)
checkAssignIL.Emit(OpCodes.Ldloc, 6)
Typ = GetType(System.Int32)
checkAssignIL.Emit(OpCodes.Ldc_I4, CInt(1))
Typ = GetType(System.Int32)
checkAssignIL.Emit(OpCodes.Add)
checkAssignIL.Emit(OpCodes.Stloc, 6)
checkAssignIL.MarkSequencePoint(doc5, 475, 1, 475, 100)
Dim typ83(-1) As Type
...
ReDim Preserve typ83(UBound(typ83) + 1)
typ83(UBound(typ83)) = Typ
checkAssignIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("AddToken", typ83))
...
End If
checkAssignIL.MarkSequencePoint(doc5, 477, 1, 477, 100)
checkAssignIL.Emit(OpCodes.Ldloc, 6)
Typ = GetType(System.Int32)
checkAssignIL.Emit(OpCodes.Ldloc, 7)
Typ = GetType(System.Int32)
Dim fa115 As System.Reflection.Emit.Label = checkAssignIL.DefineLabel()
Dim tru115 As System.Reflection.Emit.Label = checkAssignIL.DefineLabel()
Dim cont115 As System.Reflection.Emit.Label = checkAssignIL.DefineLabel()
checkAssignIL.Emit(OpCodes.Beq, tru115)
checkAssignIL.Emit(OpCodes.Br, fa115)
checkAssignIL.MarkLabel(tru115)
checkAssignIL.MarkSequencePoint(doc5, 478, 1, 478, 100)
checkAssignIL.Emit(OpCodes.Br, label10)
checkAssignIL.MarkSequencePoint(doc5, 479, 1, 479, 100)
checkAssignIL.Emit(OpCodes.Br, cont115)
checkAssignIL.MarkLabel(fa115)
checkAssignIL.MarkSequencePoint(doc5, 480, 1, 480, 100)
checkAssignIL.Emit(OpCodes.Br, label9)
checkAssignIL.MarkSequencePoint(doc5, 481, 1, 481, 100)
checkAssignIL.Emit(OpCodes.Br, cont115)
checkAssignIL.MarkLabel(cont115)
checkAssignIL.MarkSequencePoint(doc5, 483, 1, 483, 100)
checkAssignIL.MarkLabel(label10)
checkAssignIL.MarkSequencePoint(doc5, 486, 1, 486, 100)
checkAssignIL.Emit(OpCodes.Ldloc, 8)
Typ = GetType(System.Int32)
checkAssignIL.Emit(OpCodes.Stloc, 6)
checkAssignIL.MarkSequencePoint(doc5, 487, 1, 487, 100)
checkAssignIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
checkAssignIL.Emit(OpCodes.Ldfld, GetType(Stmt).GetField("Tokens"))
Typ = GetType(Stmt).GetField("Tokens").FieldType
...
checkAssignIL.Emit(OpCodes.Sub)
checkAssignIL.Emit(OpCodes.Stloc, 7)
checkAssignIL.MarkSequencePoint(doc5, 489, 1, 489, 100)
Dim label11 As System.Reflection.Emit.Label = checkAssignIL.DefineLabel()
checkAssignIL.MarkSequencePoint(doc5, 490, 1, 490, 100)
Dim label12 As System.Reflection.Emit.Label = checkAssignIL.DefineLabel()
checkAssignIL.MarkSequencePoint(doc5, 492, 1, 492, 100)
checkAssignIL.MarkLabel(label11)
checkAssignIL.MarkSequencePoint(doc5, 494, 1, 494, 100)
checkAssignIL.Emit(OpCodes.Ldloc, 6)
Typ = GetType(System.Int32)
checkAssignIL.Emit(OpCodes.Ldc_I4, CInt(1))
Typ = GetType(System.Int32)
checkAssignIL.Emit(OpCodes.Add)
checkAssignIL.Emit(OpCodes.Stloc, 6)
checkAssignIL.MarkSequencePoint(doc5, 496, 1, 496, 100)
Dim typ84(-1) As Type
...
ReDim Preserve typ84(UBound(typ84) + 1)
typ84(UBound(typ84)) = Typ
checkAssignIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("AddToken", typ84))
Typ = Typ03.GetMethod("AddToken", typ84).ReturnType
If Typ.ToString() = GetType(System.Void).ToString() Then

Else
checkAssignIL.Emit(OpCodes.Pop)
End If
checkAssignIL.MarkSequencePoint(doc5, 498, 1, 498, 100)
checkAssignIL.Emit(OpCodes.Ldloc, 6)
Typ = GetType(System.Int32)
checkAssignIL.Emit(OpCodes.Ldloc, 7)
Typ = GetType(System.Int32)
Dim fa116 As System.Reflection.Emit.Label = checkAssignIL.DefineLabel()
Dim tru116 As System.Reflection.Emit.Label = checkAssignIL.DefineLabel()
Dim cont116 As System.Reflection.Emit.Label = checkAssignIL.DefineLabel()
checkAssignIL.Emit(OpCodes.Beq, tru116)
checkAssignIL.Emit(OpCodes.Br, fa116)
checkAssignIL.MarkLabel(tru116)
checkAssignIL.MarkSequencePoint(doc5, 499, 1, 499, 100)
checkAssignIL.Emit(OpCodes.Br, label12)
checkAssignIL.MarkSequencePoint(doc5, 500, 1, 500, 100)
checkAssignIL.Emit(OpCodes.Br, cont116)
checkAssignIL.MarkLabel(fa116)
checkAssignIL.MarkSequencePoint(doc5, 501, 1, 501, 100)
checkAssignIL.Emit(OpCodes.Br, label11)
checkAssignIL.MarkSequencePoint(doc5, 502, 1, 502, 100)
checkAssignIL.Emit(OpCodes.Br, cont116)
checkAssignIL.MarkLabel(cont116)
checkAssignIL.MarkSequencePoint(doc5, 504, 1, 504, 100)
checkAssignIL.MarkLabel(label12)
checkAssignIL.MarkSequencePoint(doc5, 506, 1, 506, 100)
...
checkAssignIL.MarkSequencePoint(doc5, 507, 1, 507, 100)
checkAssignIL.Emit(OpCodes.Ldloc, 2)
Typ = GetType(AssignStmt)
checkAssignIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
...
checkAssignIL.MarkSequencePoint(doc5, 508, 1, 508, 100)
checkAssignIL.Emit(OpCodes.Ldloc, 2)
Typ = GetType(AssignStmt)
checkAssignIL.Emit(OpCodes.Ldloc, 5)
Typ = GetType(Expr)
checkAssignIL.Emit(OpCodes.Stfld, GetType(AssignStmt).GetField("LExp"))
checkAssignIL.MarkSequencePoint(doc5, 509, 1, 509, 100)
checkAssignIL.Emit(OpCodes.Ldloc, 2)
Typ = GetType(AssignStmt)
checkAssignIL.Emit(OpCodes.Ldloc, 4)
Typ = GetType(Expr)
checkAssignIL.Emit(OpCodes.Stfld, GetType(AssignStmt).GetField("RExp"))
checkAssignIL.MarkSequencePoint(doc5, 511, 1, 511, 100)
...
checkAssignIL.MarkSequencePoint(doc5, 513, 1, 513, 100)
...
checkAssignIL.Emit(OpCodes.Stloc, 2)
checkAssignIL.MarkSequencePoint(doc5, 515, 1, 515, 100)
checkAssignIL.Emit(OpCodes.Ldloc, 2)
Typ = GetType(AssignStmt)
checkAssignIL.MarkSequencePoint(doc5, 517, 1, 517, 100)
checkAssignIL.Emit(OpCodes.Br, cont114)
checkAssignIL.MarkLabel(fa114)
checkAssignIL.MarkSequencePoint(doc5, 518, 1, 518, 100)
checkAssignIL.Emit(OpCodes.Ldarg, 2)
Typ = GetType(System.Boolean).MakeByRefType()
Typ04 = Typ.GetElementType()
checkAssignIL.Emit(OpCodes.Ldc_I4, 0)
Typ = GetType(System.Boolean)
checkAssignIL.Emit(OpCodes.Stobj, Typ04)
checkAssignIL.MarkSequencePoint(doc5, 519, 1, 519, 100)
checkAssignIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
checkAssignIL.MarkSequencePoint(doc5, 521, 1, 521, 100)
checkAssignIL.Emit(OpCodes.Br, cont114)
checkAssignIL.MarkLabel(cont114)
checkAssignIL.MarkSequencePoint(doc5, 523, 1, 523, 100)
checkAssignIL.Emit(OpCodes.Ret)
Dim typ86(-1) As Type
ReDim Preserve typ86(UBound(typ86) + 1)
typ86(UBound(typ86)) = GetType(Stmt)
Dim Optimize As MethodBuilder = StmtOptimizer.DefineMethod("Optimize", MethodAttributes.Public, GetType(Stmt), typ86)
Dim OptimizeIL As ILGenerator = Optimize.GetILGenerator()
Dim Optimizeparam00 As ParameterBuilder = Optimize.DefineParameter(0, ParameterAttributes.RetVal, "")
Dim Optimizeparam01 As ParameterBuilder = Optimize.DefineParameter(1, ParameterAttributes.None, "stm")
OptimizeIL.MarkSequencePoint(doc5, 527, 1, 527, 100)
Dim typ87(-1) As Type
OptimizeIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
...
OptimizeIL.Emit(OpCodes.Call, GetType(Console).GetMethod("WriteLine", typ87))
Typ = GetType(Console).GetMethod("WriteLine", typ87).ReturnType
If Typ.ToString() = GetType(System.Void).ToString() Then

Else
OptimizeIL.Emit(OpCodes.Pop)
End If
OptimizeIL.MarkSequencePoint(doc5, 529, 1, 529, 100)
Dim locbldr183 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(System.Int32))
locbldr183.SetLocalSymInfo("i")
OptimizeIL.Emit(OpCodes.Ldc_I4, CInt(-1))
Typ = GetType(System.Int32)
OptimizeIL.Emit(OpCodes.Stloc, 0)
OptimizeIL.MarkSequencePoint(doc5, 530, 1, 530, 100)
Dim locbldr184 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(System.Int32))
...
Typ = GetType(System.Int32)
OptimizeIL.Emit(OpCodes.Stloc, 1)
OptimizeIL.MarkSequencePoint(doc5, 531, 1, 531, 100)
Dim locbldr185 As LocalBuilder = OptimizeIL.DeclareLocal(asm.GetType("dylan.NET.Tokenizer.Parser.TokenOptimizer"))
locbldr185.SetLocalSymInfo("to")
OptimizeIL.Emit(OpCodes.Ldnull)
OptimizeIL.Emit(OpCodes.Stloc, 2)
OptimizeIL.MarkSequencePoint(doc5, 532, 1, 532, 100)
Dim locbldr186 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(Stmt))
locbldr186.SetLocalSymInfo("tmpstm")
OptimizeIL.Emit(OpCodes.Ldnull)
OptimizeIL.Emit(OpCodes.Stloc, 3)
OptimizeIL.MarkSequencePoint(doc5, 533, 1, 533, 100)
Dim locbldr187 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(System.Boolean))
locbldr187.SetLocalSymInfo("compb")
OptimizeIL.Emit(OpCodes.Ldc_I4, 0)
Typ = GetType(System.Boolean)
OptimizeIL.Emit(OpCodes.Stloc, 4)
OptimizeIL.MarkSequencePoint(doc5, 534, 1, 534, 100)
OptimizeIL.Emit(OpCodes.Ldloc, 1)
Typ = GetType(System.Int32)
OptimizeIL.Emit(OpCodes.Ldc_I4, CInt(1))
Typ = GetType(System.Int32)
...
OptimizeIL.Emit(OpCodes.Stloc, 1)
OptimizeIL.MarkSequencePoint(doc5, 536, 1, 536, 100)
OptimizeIL.Emit(OpCodes.Ldc_I4, 0)
Typ = GetType(System.Boolean)
OptimizeIL.Emit(OpCodes.Stsfld, asm.GetType("dylan.NET.Tokenizer.Parser.ParserFlags").GetField("IfFlag"))
OptimizeIL.MarkSequencePoint(doc5, 537, 1, 537, 100)
OptimizeIL.Emit(OpCodes.Ldc_I4, 0)
Typ = GetType(System.Boolean)
OptimizeIL.Emit(OpCodes.Stsfld, asm.GetType("dylan.NET.Tokenizer.Parser.ParserFlags").GetField("CmtFlag"))
OptimizeIL.MarkSequencePoint(doc5, 538, 1, 538, 100)
OptimizeIL.Emit(OpCodes.Ldc_I4, 0)
Typ = GetType(System.Boolean)
OptimizeIL.Emit(OpCodes.Stsfld, asm.GetType("dylan.NET.Tokenizer.Parser.ParserFlags").GetField("NoOptFlag"))
OptimizeIL.MarkSequencePoint(doc5, 540, 1, 540, 100)
Dim label13 As System.Reflection.Emit.Label = OptimizeIL.DefineLabel()
OptimizeIL.MarkSequencePoint(doc5, 541, 1, 541, 100)
Dim label14 As System.Reflection.Emit.Label = OptimizeIL.DefineLabel()
OptimizeIL.MarkSequencePoint(doc5, 542, 1, 542, 100)
Dim label15 As System.Reflection.Emit.Label = OptimizeIL.DefineLabel()
OptimizeIL.MarkSequencePoint(doc5, 544, 1, 544, 100)
OptimizeIL.Emit(OpCodes.Ldloc, 1)
Typ = GetType(System.Int32)
OptimizeIL.Emit(OpCodes.Ldc_I4, CInt(0))
Typ = GetType(System.Int32)
...
OptimizeIL.Emit(OpCodes.Blt, tru117)
OptimizeIL.Emit(OpCodes.Br, fa117)
OptimizeIL.MarkLabel(tru117)
OptimizeIL.MarkSequencePoint(doc5, 545, 1, 545, 100)
OptimizeIL.Emit(OpCodes.Br, label14)
OptimizeIL.MarkSequencePoint(doc5, 546, 1, 546, 100)
OptimizeIL.Emit(OpCodes.Br, cont117)
OptimizeIL.MarkLabel(fa117)
OptimizeIL.Emit(OpCodes.Br, cont117)
OptimizeIL.MarkLabel(cont117)
OptimizeIL.MarkSequencePoint(doc5, 548, 1, 548, 100)
OptimizeIL.MarkLabel(label13)
OptimizeIL.MarkSequencePoint(doc5, 550, 1, 550, 100)
OptimizeIL.Emit(OpCodes.Ldloc, 0)
Typ = GetType(System.Int32)
OptimizeIL.Emit(OpCodes.Ldc_I4, CInt(1))
Typ = GetType(System.Int32)
...
OptimizeIL.Emit(OpCodes.Stloc, 0)
OptimizeIL.MarkSequencePoint(doc5, 552, 1, 552, 100)
...
OptimizeIL.MarkSequencePoint(doc5, 553, 1, 553, 100)
OptimizeIL.Emit(OpCodes.Br, label14)
OptimizeIL.MarkSequencePoint(doc5, 554, 1, 554, 100)
OptimizeIL.Emit(OpCodes.Br, cont118)
OptimizeIL.MarkLabel(fa118)
OptimizeIL.Emit(OpCodes.Br, cont118)
OptimizeIL.MarkLabel(cont118)
OptimizeIL.MarkSequencePoint(doc5, 557, 1, 557, 100)
...
ReDim Preserve typ88(UBound(typ88) + 1)
typ88(UBound(typ88)) = Typ
OptimizeIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("Optimize", typ88))
Typ = Typ03.GetMethod("Optimize", typ88).ReturnType
Typ = Typ02
OptimizeIL.Emit(OpCodes.Stelem, Typ.GetElementType())
OptimizeIL.MarkSequencePoint(doc5, 564, 1, 564, 100)
OptimizeIL.Emit(OpCodes.Ldloc, 0)
Typ = GetType(System.Int32)
OptimizeIL.Emit(OpCodes.Ldloc, 1)
Typ = GetType(System.Int32)
...
OptimizeIL.MarkSequencePoint(doc5, 565, 1, 565, 100)
OptimizeIL.Emit(OpCodes.Br, label14)
OptimizeIL.MarkSequencePoint(doc5, 566, 1, 566, 100)
OptimizeIL.Emit(OpCodes.Br, cont120)
OptimizeIL.MarkLabel(fa120)
OptimizeIL.MarkSequencePoint(doc5, 567, 1, 567, 100)
OptimizeIL.Emit(OpCodes.Br, label13)
OptimizeIL.MarkSequencePoint(doc5, 568, 1, 568, 100)
OptimizeIL.Emit(OpCodes.Br, cont120)
OptimizeIL.MarkLabel(cont120)
OptimizeIL.MarkSequencePoint(doc5, 570, 1, 570, 100)
OptimizeIL.MarkLabel(label14)
OptimizeIL.MarkSequencePoint(doc5, 572, 1, 572, 100)
OptimizeIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
OptimizeIL.Emit(OpCodes.Ldfld, GetType(Stmt).GetField("Tokens"))
Typ = GetType(Stmt).GetField("Tokens").FieldType
...
OptimizeIL.MarkSequencePoint(doc5, 573, 1, 573, 100)
OptimizeIL.Emit(OpCodes.Br, label15)
OptimizeIL.MarkSequencePoint(doc5, 574, 1, 574, 100)
OptimizeIL.Emit(OpCodes.Br, cont121)
OptimizeIL.MarkLabel(fa121)
OptimizeIL.Emit(OpCodes.Br, cont121)
OptimizeIL.MarkLabel(cont121)
OptimizeIL.MarkSequencePoint(doc5, 576, 1, 576, 100)
...
OptimizeIL.Emit(OpCodes.Stloc, 3)
OptimizeIL.MarkSequencePoint(doc5, 578, 1, 578, 100)
OptimizeIL.Emit(OpCodes.Ldloc, 4)
Typ = GetType(System.Boolean)
OptimizeIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
...
OptimizeIL.MarkSequencePoint(doc5, 579, 1, 579, 100)
OptimizeIL.Emit(OpCodes.Ldloc, 3)
Typ = GetType(Stmt)
OptimizeIL.Emit(OpCodes.Starg, 1)
OptimizeIL.MarkSequencePoint(doc5, 580, 1, 580, 100)
OptimizeIL.Emit(OpCodes.Br, label15)
OptimizeIL.MarkSequencePoint(doc5, 581, 1, 581, 100)
OptimizeIL.Emit(OpCodes.Br, cont122)
OptimizeIL.MarkLabel(fa122)
OptimizeIL.Emit(OpCodes.Br, cont122)
OptimizeIL.MarkLabel(cont122)
OptimizeIL.MarkSequencePoint(doc5, 583, 1, 583, 100)
OptimizeIL.Emit(OpCodes.Ldarg_0)
Dim typ90(-1) As Type
OptimizeIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
...
OptimizeIL.Emit(OpCodes.Stloc, 3)
OptimizeIL.MarkSequencePoint(doc5, 585, 1, 585, 100)
OptimizeIL.Emit(OpCodes.Ldloc, 4)
Typ = GetType(System.Boolean)
OptimizeIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
...
OptimizeIL.MarkSequencePoint(doc5, 586, 1, 586, 100)
OptimizeIL.Emit(OpCodes.Ldloc, 3)
Typ = GetType(Stmt)
OptimizeIL.Emit(OpCodes.Starg, 1)
OptimizeIL.MarkSequencePoint(doc5, 587, 1, 587, 100)
OptimizeIL.Emit(OpCodes.Br, label15)
OptimizeIL.MarkSequencePoint(doc5, 588, 1, 588, 100)
OptimizeIL.Emit(OpCodes.Br, cont123)
OptimizeIL.MarkLabel(fa123)
OptimizeIL.Emit(OpCodes.Br, cont123)
OptimizeIL.MarkLabel(cont123)
OptimizeIL.MarkSequencePoint(doc5, 590, 1, 590, 100)
OptimizeIL.Emit(OpCodes.Ldarg_0)
Dim typ91(-1) As Type
OptimizeIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
...
OptimizeIL.Emit(OpCodes.Stloc, 3)
OptimizeIL.MarkSequencePoint(doc5, 592, 1, 592, 100)
OptimizeIL.Emit(OpCodes.Ldloc, 4)
Typ = GetType(System.Boolean)
OptimizeIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
...
OptimizeIL.MarkSequencePoint(doc5, 593, 1, 593, 100)
OptimizeIL.Emit(OpCodes.Ldloc, 3)
Typ = GetType(Stmt)
OptimizeIL.Emit(OpCodes.Starg, 1)
OptimizeIL.MarkSequencePoint(doc5, 594, 1, 594, 100)
OptimizeIL.Emit(OpCodes.Br, label15)
OptimizeIL.MarkSequencePoint(doc5, 595, 1, 595, 100)
OptimizeIL.Emit(OpCodes.Br, cont124)
OptimizeIL.MarkLabel(fa124)
OptimizeIL.Emit(OpCodes.Br, cont124)
OptimizeIL.MarkLabel(cont124)
OptimizeIL.MarkSequencePoint(doc5, 597, 1, 597, 100)
OptimizeIL.Emit(OpCodes.Ldarg_0)
Dim typ92(-1) As Type
OptimizeIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
...
OptimizeIL.Emit(OpCodes.Stloc, 3)
OptimizeIL.MarkSequencePoint(doc5, 599, 1, 599, 100)
OptimizeIL.Emit(OpCodes.Ldloc, 4)
Typ = GetType(System.Boolean)
OptimizeIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
...
OptimizeIL.MarkSequencePoint(doc5, 600, 1, 600, 100)
OptimizeIL.Emit(OpCodes.Ldloc, 3)
Typ = GetType(Stmt)
OptimizeIL.Emit(OpCodes.Starg, 1)
OptimizeIL.MarkSequencePoint(doc5, 601, 1, 601, 100)
OptimizeIL.Emit(OpCodes.Br, label15)
OptimizeIL.MarkSequencePoint(doc5, 602, 1, 602, 100)
OptimizeIL.Emit(OpCodes.Br, cont125)
OptimizeIL.MarkLabel(fa125)
OptimizeIL.Emit(OpCodes.Br, cont125)
OptimizeIL.MarkLabel(cont125)
OptimizeIL.MarkSequencePoint(doc5, 604, 1, 604, 100)
OptimizeIL.Emit(OpCodes.Ldarg_0)
Dim typ93(-1) As Type
OptimizeIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
...
OptimizeIL.Emit(OpCodes.Stloc, 3)
OptimizeIL.MarkSequencePoint(doc5, 606, 1, 606, 100)
OptimizeIL.Emit(OpCodes.Ldloc, 4)
Typ = GetType(System.Boolean)
OptimizeIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
...
OptimizeIL.MarkSequencePoint(doc5, 607, 1, 607, 100)
OptimizeIL.Emit(OpCodes.Ldloc, 3)
Typ = GetType(Stmt)
OptimizeIL.Emit(OpCodes.Starg, 1)
OptimizeIL.MarkSequencePoint(doc5, 608, 1, 608, 100)
OptimizeIL.Emit(OpCodes.Br, label15)
OptimizeIL.MarkSequencePoint(doc5, 609, 1, 609, 100)
OptimizeIL.Emit(OpCodes.Br, cont126)
OptimizeIL.MarkLabel(fa126)
OptimizeIL.Emit(OpCodes.Br, cont126)
OptimizeIL.MarkLabel(cont126)
OptimizeIL.MarkSequencePoint(doc5, 611, 1, 611, 100)
OptimizeIL.Emit(OpCodes.Ldarg_0)
Dim typ94(-1) As Type
OptimizeIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
...
OptimizeIL.Emit(OpCodes.Stloc, 3)
OptimizeIL.MarkSequencePoint(doc5, 613, 1, 613, 100)
OptimizeIL.Emit(OpCodes.Ldloc, 4)
Typ = GetType(System.Boolean)
OptimizeIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
...
OptimizeIL.MarkSequencePoint(doc5, 614, 1, 614, 100)
OptimizeIL.Emit(OpCodes.Ldloc, 3)
Typ = GetType(Stmt)
OptimizeIL.Emit(OpCodes.Starg, 1)
OptimizeIL.MarkSequencePoint(doc5, 615, 1, 615, 100)
OptimizeIL.Emit(OpCodes.Br, label15)
OptimizeIL.MarkSequencePoint(doc5, 616, 1, 616, 100)
OptimizeIL.Emit(OpCodes.Br, cont127)
OptimizeIL.MarkLabel(fa127)
OptimizeIL.Emit(OpCodes.Br, cont127)
OptimizeIL.MarkLabel(cont127)
OptimizeIL.MarkSequencePoint(doc5, 618, 1, 618, 100)
OptimizeIL.Emit(OpCodes.Ldarg_0)
Dim typ95(-1) As Type
OptimizeIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
...
OptimizeIL.Emit(OpCodes.Stloc, 3)
OptimizeIL.MarkSequencePoint(doc5, 620, 1, 620, 100)
OptimizeIL.Emit(OpCodes.Ldloc, 4)
Typ = GetType(System.Boolean)
OptimizeIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
...
OptimizeIL.MarkSequencePoint(doc5, 621, 1, 621, 100)
OptimizeIL.Emit(OpCodes.Ldloc, 3)
Typ = GetType(Stmt)
OptimizeIL.Emit(OpCodes.Starg, 1)
OptimizeIL.MarkSequencePoint(doc5, 622, 1, 622, 100)
OptimizeIL.Emit(OpCodes.Br, label15)
OptimizeIL.MarkSequencePoint(doc5, 623, 1, 623, 100)
OptimizeIL.Emit(OpCodes.Br, cont128)
OptimizeIL.MarkLabel(fa128)
OptimizeIL.Emit(OpCodes.Br, cont128)
OptimizeIL.MarkLabel(cont128)
OptimizeIL.MarkSequencePoint(doc5, 625, 1, 625, 100)
OptimizeIL.Emit(OpCodes.Ldarg_0)
Dim typ96(-1) As Type
OptimizeIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
...
OptimizeIL.Emit(OpCodes.Stloc, 3)
OptimizeIL.MarkSequencePoint(doc5, 627, 1, 627, 100)
OptimizeIL.Emit(OpCodes.Ldloc, 4)
Typ = GetType(System.Boolean)
OptimizeIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
...
OptimizeIL.MarkSequencePoint(doc5, 628, 1, 628, 100)
OptimizeIL.Emit(OpCodes.Ldloc, 3)
Typ = GetType(Stmt)
OptimizeIL.Emit(OpCodes.Starg, 1)
OptimizeIL.MarkSequencePoint(doc5, 629, 1, 629, 100)
OptimizeIL.Emit(OpCodes.Br, label15)
OptimizeIL.MarkSequencePoint(doc5, 630, 1, 630, 100)
OptimizeIL.Emit(OpCodes.Br, cont129)
OptimizeIL.MarkLabel(fa129)
OptimizeIL.Emit(OpCodes.Br, cont129)
OptimizeIL.MarkLabel(cont129)
OptimizeIL.MarkSequencePoint(doc5, 632, 1, 632, 100)
OptimizeIL.Emit(OpCodes.Ldarg_0)
Dim typ97(-1) As Type
OptimizeIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
...
OptimizeIL.MarkSequencePoint(doc5, 635, 1, 635, 100)
OptimizeIL.Emit(OpCodes.Ldloc, 3)
Typ = GetType(Stmt)
OptimizeIL.Emit(OpCodes.Starg, 1)
...
OptimizeIL.MarkSequencePoint(doc5, 656, 1, 656, 100)
OptimizeIL.Emit(OpCodes.Ldloc, 3)
Typ = GetType(Stmt)
OptimizeIL.Emit(OpCodes.Starg, 1)
OptimizeIL.MarkSequencePoint(doc5, 657, 1, 657, 100)
OptimizeIL.Emit(OpCodes.Br, label15)
OptimizeIL.MarkSequencePoint(doc5, 658, 1, 658, 100)
...
Dim locbldr188 As LocalBuilder = ParseIL.DeclareLocal(GetType(System.Int32))
...
Dim locbldr189 As LocalBuilder = ParseIL.DeclareLocal(asm.GetType("dylan.NET.Tokenizer.Parser.StmtOptimizer"))
locbldr189.SetLocalSymInfo("so")
ParseIL.Emit(OpCodes.Ldnull)
ParseIL.Emit(OpCodes.Stloc, 1)
ParseIL.MarkSequencePoint(doc6, 6, 1, 6, 100)
Dim locbldr190 As LocalBuilder = ParseIL.DeclareLocal(GetType(System.Int32))
locbldr190.SetLocalSymInfo("len")
...
ParseIL.Emit(OpCodes.Ldloc, 2)
Typ = GetType(System.Int32)
Dim fa134 As System.Reflection.Emit.Label = ParseIL.DefineLabel()
Dim tru134 As System.Reflection.Emit.Label = ParseIL.DefineLabel()
Dim cont134 As System.Reflection.Emit.Label = ParseIL.DefineLabel()
ParseIL.Emit(OpCodes.Beq, tru134)
ParseIL.Emit(OpCodes.Br, fa134)
ParseIL.MarkLabel(tru134)
ParseIL.MarkSequencePoint(doc6, 19, 1, 19, 100)
ParseIL.Emit(OpCodes.Br, label1)
ParseIL.MarkSequencePoint(doc6, 20, 1, 20, 100)
ParseIL.Emit(OpCodes.Br, cont134)
ParseIL.MarkLabel(fa134)
ParseIL.MarkSequencePoint(doc6, 21, 1, 21, 100)
ParseIL.Emit(OpCodes.Br, label0)
ParseIL.MarkSequencePoint(doc6, 22, 1, 22, 100)
ParseIL.Emit(OpCodes.Br, cont134)
ParseIL.MarkLabel(cont134)
