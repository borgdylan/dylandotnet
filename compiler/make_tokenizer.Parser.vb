...
Dim locbldr58 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(StaticAttr))
locbldr58.SetLocalSymInfo("statattr")
...
Dim locbldr59 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(AutoLayoutAttr))
locbldr59.SetLocalSymInfo("autattr")
...
Dim locbldr60 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(AutoClassAttr))
locbldr60.SetLocalSymInfo("autcattr")
...
Dim locbldr61 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(AnsiClassAttr))
locbldr61.SetLocalSymInfo("ansattr")
...
Dim locbldr62 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(BeforeFieldInitAttr))
locbldr62.SetLocalSymInfo("bfiattr")
...
Dim locbldr63 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(StringTok))
locbldr63.SetLocalSymInfo("strtok")
...
Dim locbldr64 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(VoidTok))
locbldr64.SetLocalSymInfo("voidtok")
...
Dim locbldr65 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(IntegerTok))
locbldr65.SetLocalSymInfo("inttok")
...
Dim locbldr66 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(DoubleTok))
locbldr66.SetLocalSymInfo("dbltok")
...
Dim locbldr67 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(BooleanTok))
locbldr67.SetLocalSymInfo("booltok")
...
Dim locbldr68 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(CharTok))
locbldr68.SetLocalSymInfo("chrtok")
...
Dim locbldr69 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(SingleTok))
locbldr69.SetLocalSymInfo("sngtok")
...
Dim locbldr70 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(SByteTok))
locbldr70.SetLocalSymInfo("sbytok")
...
Dim locbldr71 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(ShortTok))
locbldr71.SetLocalSymInfo("shtok")
...
Dim locbldr72 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(LongTok))
locbldr72.SetLocalSymInfo("lngtok")
...
Dim locbldr73 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(ObjectTok))
locbldr73.SetLocalSymInfo("objtok")
...
Dim locbldr74 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(commentTok))
locbldr74.SetLocalSymInfo("comtok")
...
Dim locbldr75 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(BooleanLiteral))
locbldr75.SetLocalSymInfo("boolit")
...
Dim locbldr76 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(CharLiteral))
locbldr76.SetLocalSymInfo("chrlit")
...
OptimizeIL.Emit(OpCodes.Ldstr, "'")
Typ = GetType(System.String)
Dim typ86 As Type() = {Typ}
OptimizeIL.Emit(OpCodes.Call, GetType(System.Convert).GetMethod("ToChar", typ86))
Typ = GetType(System.Convert).GetMethod("ToChar", typ86).ReturnType
...
OptimizeIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("Trim", typ87))
Typ = Typ03.GetMethod("Trim", typ87).ReturnType
OptimizeIL.Emit(OpCodes.Stloc, 2)
...
ReDim Preserve typ89(UBound(typ89) + 1)
typ89(UBound(typ89)) = Typ
OptimizeIL.Emit(OpCodes.Call, GetType(String).GetMethod("Concat", typ89))
...
Dim locbldr77 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(StringLiteral))
locbldr77.SetLocalSymInfo("strlit")
...
OptimizeIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("EndsWith", typ96))
Typ = Typ03.GetMethod("EndsWith", typ96).ReturnType
OptimizeIL.Emit(OpCodes.Stloc, 1)
...
locbldr78.SetLocalSymInfo("dlit2")
...
OptimizeIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("TrimEnd", typ98))
Typ = Typ03.GetMethod("TrimEnd", typ98).ReturnType
OptimizeIL.Emit(OpCodes.Stloc, 2)
...
Dim typ99 As Type() = {Typ}
OptimizeIL.Emit(OpCodes.Call, GetType(System.Convert).GetMethod("ToDouble", typ99))
Typ = GetType(System.Convert).GetMethod("ToDouble", typ99).ReturnType
...
OptimizeIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("EndsWith", typ103))
Typ = Typ03.GetMethod("EndsWith", typ103).ReturnType
OptimizeIL.Emit(OpCodes.Stloc, 1)
...
locbldr79.SetLocalSymInfo("flit")
...
OptimizeIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("TrimEnd", typ105))
Typ = Typ03.GetMethod("TrimEnd", typ105).ReturnType
OptimizeIL.Emit(OpCodes.Stloc, 2)
...
OptimizeIL.Emit(OpCodes.Call, GetType(System.Convert).GetMethod("ToSingle", typ106))
Typ = GetType(System.Convert).GetMethod("ToSingle", typ106).ReturnType
...
locbldr80.SetLocalSymInfo("dlit")
OptimizeIL.Emit(OpCodes.Newobj, GetType(DoubleLiteral).GetConstructor(Type.EmptyTypes))
...
OptimizeIL.Emit(OpCodes.Call, GetType(System.Convert).GetMethod("ToDouble", typ110))
Typ = GetType(System.Convert).GetMethod("ToDouble", typ110).ReturnType
OptimizeIL.Emit(OpCodes.Stfld, GetType(DoubleLiteral).GetField("NumVal"))
...
Dim locbldr81 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(DoubleLiteral))
locbldr81.SetLocalSymInfo("dlit3")
OptimizeIL.Emit(OpCodes.Newobj, GetType(DoubleLiteral).GetConstructor(Type.EmptyTypes))
...
Dim locbldr82 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(FloatLiteral))
locbldr82.SetLocalSymInfo("flit2")
OptimizeIL.Emit(OpCodes.Newobj, GetType(FloatLiteral).GetConstructor(Type.EmptyTypes))
...
Dim locbldr83 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(IntLiteral))
locbldr83.SetLocalSymInfo("ilit2")
...
OptimizeIL.Emit(OpCodes.Call, GetType(System.Convert).GetMethod("ToInt32", typ131))
Typ = GetType(System.Convert).GetMethod("ToInt32", typ131).ReturnType
...
OptimizeIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("EndsWith", typ135))
Typ = Typ03.GetMethod("EndsWith", typ135).ReturnType
OptimizeIL.Emit(OpCodes.Stloc, 1)
...
Dim locbldr84 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(LongLiteral))
locbldr84.SetLocalSymInfo("llit")
...
OptimizeIL.Emit(OpCodes.Call, GetType(System.Convert).GetMethod("ToChar", typ136))
Typ = GetType(System.Convert).GetMethod("ToChar", typ136).ReturnType
OptimizeIL.Emit(OpCodes.Stelem, GetType(System.Char).MakeArrayType().GetElementType())
...
OptimizeIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("TrimEnd", typ137))
Typ = Typ03.GetMethod("TrimEnd", typ137).ReturnType
OptimizeIL.Emit(OpCodes.Stloc, 2)
...
OptimizeIL.Emit(OpCodes.Call, GetType(System.Convert).GetMethod("ToInt64", typ138))
Typ = GetType(System.Convert).GetMethod("ToInt64", typ138).ReturnType
...
Dim locbldr85 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(ShortLiteral))
locbldr85.SetLocalSymInfo("slit")
...
OptimizeIL.Emit(OpCodes.Call, GetType(System.Convert).GetMethod("ToInt16", typ145))
Typ = GetType(System.Convert).GetMethod("ToInt16", typ145).ReturnType
...
Dim locbldr86 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(SByteLiteral))
locbldr86.SetLocalSymInfo("blit")
...
OptimizeIL.Emit(OpCodes.Call, GetType(System.Convert).GetMethod("ToSByte", typ152))
Typ = GetType(System.Convert).GetMethod("ToSByte", typ152).ReturnType
...
locbldr87.SetLocalSymInfo("ilit")
OptimizeIL.Emit(OpCodes.Newobj, GetType(IntLiteral).GetConstructor(Type.EmptyTypes))
...
OptimizeIL.Emit(OpCodes.Call, GetType(System.Convert).GetMethod("ToInt32", typ156))
...
Dim locbldr88 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(Ident))
locbldr88.SetLocalSymInfo("idt")
...
Dim locbldr91 As LocalBuilder = checkVarAsIL.DeclareLocal(GetType(VarExpr))
locbldr91.SetLocalSymInfo("vars")
...
Typ = GetType(System.Boolean)
Dim fa88 As System.Reflection.Emit.Label = checkVarAsIL.DefineLabel()
Dim tru88 As System.Reflection.Emit.Label = checkVarAsIL.DefineLabel()
Dim cont88 As System.Reflection.Emit.Label = checkVarAsIL.DefineLabel()
checkVarAsIL.Emit(OpCodes.Beq, tru88)
checkVarAsIL.Emit(OpCodes.Br, fa88)
checkVarAsIL.MarkLabel(tru88)
...
locbldr92.SetLocalSymInfo("tok2")
checkVarAsIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Expr)
checkVarAsIL.Emit(OpCodes.Ldfld, GetType(Expr).GetField("Tokens"))
Typ = GetType(Expr).GetField("Tokens").FieldType
...
Dim locbldr93 As LocalBuilder = checkVarAsIL.DeclareLocal(GetType(System.Type))
locbldr93.SetLocalSymInfo("typ2")
...
Dim locbldr94 As LocalBuilder = checkVarAsIL.DeclareLocal(GetType(System.Boolean))
locbldr94.SetLocalSymInfo("b2")
Dim typ4(-1) As Type
...
checkVarAsIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa89 As System.Reflection.Emit.Label = checkVarAsIL.DefineLabel()
Dim tru89 As System.Reflection.Emit.Label = checkVarAsIL.DefineLabel()
Dim cont89 As System.Reflection.Emit.Label = checkVarAsIL.DefineLabel()
checkVarAsIL.Emit(OpCodes.Beq, fa89)
checkVarAsIL.Emit(OpCodes.Br, tru89)
checkVarAsIL.MarkLabel(tru89)
checkVarAsIL.MarkSequencePoint(doc4, 19, 1, 19, 100)
Dim locbldr95 As LocalBuilder = checkVarAsIL.DeclareLocal(GetType(Token))
locbldr95.SetLocalSymInfo("t")
checkVarAsIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Expr)
checkVarAsIL.Emit(OpCodes.Ldfld, GetType(Expr).GetField("Tokens"))
Typ = GetType(Expr).GetField("Tokens").FieldType
...
Dim locbldr96 As LocalBuilder = checkVarAsIL.DeclareLocal(GetType(TypeTok))
locbldr96.SetLocalSymInfo("tt")
...
checkVarAsIL.Emit(OpCodes.Br, cont89)
checkVarAsIL.MarkLabel(fa89)
...
checkVarAsIL.Emit(OpCodes.Br, cont89)
checkVarAsIL.MarkLabel(cont89)
checkVarAsIL.MarkSequencePoint(doc4, 28, 1, 28, 100)
checkVarAsIL.Emit(OpCodes.Br, cont88)
checkVarAsIL.MarkLabel(fa88)
checkVarAsIL.Emit(OpCodes.Br, cont88)
checkVarAsIL.MarkLabel(cont88)
...
Dim locbldr97 As LocalBuilder = procMethodCallIL.DeclareLocal(GetType(MethodNameTok))
locbldr97.SetLocalSymInfo("mn")
...
Dim locbldr98 As LocalBuilder = procMethodCallIL.DeclareLocal(GetType(MethodCallTok))
locbldr98.SetLocalSymInfo("mct")
...
Dim locbldr99 As LocalBuilder = procMethodCallIL.DeclareLocal(GetType(Ident))
locbldr99.SetLocalSymInfo("idt")
...
Dim locbldr100 As LocalBuilder = procMethodCallIL.DeclareLocal(GetType(Expr))
locbldr100.SetLocalSymInfo("ep2")
...
Dim locbldr101 As LocalBuilder = procMethodCallIL.DeclareLocal(GetType(System.Int32))
locbldr101.SetLocalSymInfo("lvl")
...
Dim locbldr102 As LocalBuilder = procMethodCallIL.DeclareLocal(GetType(System.Boolean))
locbldr102.SetLocalSymInfo("d")
...
Dim locbldr104 As LocalBuilder = procMethodCallIL.DeclareLocal(GetType(Token))
locbldr104.SetLocalSymInfo("tok2")
procMethodCallIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Expr)
procMethodCallIL.Emit(OpCodes.Ldfld, GetType(Expr).GetField("Tokens"))
Typ = GetType(Expr).GetField("Tokens").FieldType
...
Dim locbldr105 As LocalBuilder = procMethodCallIL.DeclareLocal(GetType(System.Type))
locbldr105.SetLocalSymInfo("typ2")
...
locbldr107.SetLocalSymInfo("len")
procMethodCallIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Expr)
procMethodCallIL.Emit(OpCodes.Ldfld, GetType(Expr).GetField("Tokens"))
Typ = GetType(Expr).GetField("Tokens").FieldType
...
Dim locbldr108 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(System.Int32))
...
Dim locbldr109 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(System.Int32))
...
OptimizeIL.Emit(OpCodes.Blt, tru97)
...
Dim locbldr111 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(Token))
locbldr111.SetLocalSymInfo("tok")
OptimizeIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Expr)
OptimizeIL.Emit(OpCodes.Ldfld, GetType(Expr).GetField("Tokens"))
Typ = GetType(Expr).GetField("Tokens").FieldType
...
Dim locbldr112 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(System.Type))
locbldr112.SetLocalSymInfo("typ")
OptimizeIL.MarkSequencePoint(doc4, 183, 1, 183, 100)
Dim locbldr113 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(System.Boolean))
locbldr113.SetLocalSymInfo("b")
OptimizeIL.MarkSequencePoint(doc4, 184, 1, 184, 100)
Dim locbldr114 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(System.String))
locbldr114.SetLocalSymInfo("str")
...
OptimizeIL.Emit(OpCodes.Beq, fa99)
OptimizeIL.Emit(OpCodes.Br, tru99)
...
Dim locbldr116 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(TypeTok))
locbldr116.SetLocalSymInfo("ttk")
...
locbldr117.SetLocalSymInfo("tk2")
OptimizeIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Expr)
OptimizeIL.Emit(OpCodes.Ldfld, GetType(Expr).GetField("Tokens"))
Typ = GetType(Expr).GetField("Tokens").FieldType
...
locbldr118.SetLocalSymInfo("ttk2")
OptimizeIL.Emit(OpCodes.Newobj, GetType(TypeTok).GetConstructor(Type.EmptyTypes))
OptimizeIL.Emit(OpCodes.Stloc, 10)
...
OptimizeIL.Emit(OpCodes.Beq, fa104)
OptimizeIL.Emit(OpCodes.Br, tru104)
...
Dim locbldr119 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(TypeTok))
locbldr119.SetLocalSymInfo("tt1")
OptimizeIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Expr)
OptimizeIL.Emit(OpCodes.Ldfld, GetType(Expr).GetField("Tokens"))
Typ = GetType(Expr).GetField("Tokens").FieldType
...
Dim locbldr120 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(Ident))
locbldr120.SetLocalSymInfo("id1")
OptimizeIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Expr)
OptimizeIL.Emit(OpCodes.Ldfld, GetType(Expr).GetField("Tokens"))
Typ = GetType(Expr).GetField("Tokens").FieldType
...
Dim locbldr121 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(CharLiteral))
locbldr121.SetLocalSymInfo("cl1")
OptimizeIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Expr)
OptimizeIL.Emit(OpCodes.Ldfld, GetType(Expr).GetField("Tokens"))
Typ = GetType(Expr).GetField("Tokens").FieldType
...
Dim locbldr122 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(StringLiteral))
locbldr122.SetLocalSymInfo("sl1")
OptimizeIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Expr)
OptimizeIL.Emit(OpCodes.Ldfld, GetType(Expr).GetField("Tokens"))
Typ = GetType(Expr).GetField("Tokens").FieldType
...
Dim locbldr123 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(BooleanLiteral))
locbldr123.SetLocalSymInfo("bl1")
OptimizeIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Expr)
OptimizeIL.Emit(OpCodes.Ldfld, GetType(Expr).GetField("Tokens"))
Typ = GetType(Expr).GetField("Tokens").FieldType
...
Dim locbldr124 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(NumberLiteral))
locbldr124.SetLocalSymInfo("nl1")
OptimizeIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Expr)
OptimizeIL.Emit(OpCodes.Ldfld, GetType(Expr).GetField("Tokens"))
Typ = GetType(Expr).GetField("Tokens").FieldType
...
Dim locbldr125 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(MethodCallTok))
...
Dim locbldr126 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(Expr).MakeArrayType())
locbldr126.SetLocalSymInfo("prs")
OptimizeIL.Emit(OpCodes.Ldloc, 17)
Typ = GetType(MethodCallTok)
...
Dim locbldr127 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(System.Int32))
locbldr127.SetLocalSymInfo("ln2")
OptimizeIL.Emit(OpCodes.Ldloc, 18)
...
Dim locbldr128 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(System.Int32))
locbldr128.SetLocalSymInfo("i2")
OptimizeIL.Emit(OpCodes.Ldc_I4, CInt(-1))
Typ = GetType(System.Int32)
OptimizeIL.Emit(OpCodes.Stloc, 20)
...
OptimizeIL.Emit(OpCodes.Blt, tru119)
...
OptimizeIL.Emit(OpCodes.Bgt, tru121)
...
Dim locbldr129 As LocalBuilder = checkRefasmIL.DeclareLocal(GetType(Token))
locbldr129.SetLocalSymInfo("tok")
...
Dim locbldr130 As LocalBuilder = checkRefasmIL.DeclareLocal(GetType(System.Type))
locbldr130.SetLocalSymInfo("typ")
...
Dim locbldr131 As LocalBuilder = checkRefasmIL.DeclareLocal(GetType(RefasmStmt))
locbldr131.SetLocalSymInfo("refasms")
...
Typ = GetType(System.Boolean)
Dim fa123 As System.Reflection.Emit.Label = checkRefasmIL.DefineLabel()
Dim tru123 As System.Reflection.Emit.Label = checkRefasmIL.DefineLabel()
Dim cont123 As System.Reflection.Emit.Label = checkRefasmIL.DefineLabel()
checkRefasmIL.Emit(OpCodes.Beq, tru123)
checkRefasmIL.Emit(OpCodes.Br, fa123)
checkRefasmIL.MarkLabel(tru123)
...
checkRefasmIL.Emit(OpCodes.Br, cont123)
checkRefasmIL.MarkLabel(fa123)
checkRefasmIL.Emit(OpCodes.Br, cont123)
checkRefasmIL.MarkLabel(cont123)
...
Dim locbldr132 As LocalBuilder = checkDebugIL.DeclareLocal(GetType(Token))
locbldr132.SetLocalSymInfo("tok")
...
Dim locbldr133 As LocalBuilder = checkDebugIL.DeclareLocal(GetType(System.Type))
...
Dim locbldr134 As LocalBuilder = checkDebugIL.DeclareLocal(GetType(DebugStmt))
locbldr134.SetLocalSymInfo("dbgs")
...
Typ = GetType(System.Boolean)
Dim fa124 As System.Reflection.Emit.Label = checkDebugIL.DefineLabel()
Dim tru124 As System.Reflection.Emit.Label = checkDebugIL.DefineLabel()
Dim cont124 As System.Reflection.Emit.Label = checkDebugIL.DefineLabel()
checkDebugIL.Emit(OpCodes.Beq, tru124)
checkDebugIL.Emit(OpCodes.Br, fa124)
checkDebugIL.MarkLabel(tru124)
...
checkDebugIL.Emit(OpCodes.Br, cont124)
checkDebugIL.MarkLabel(fa124)
checkDebugIL.Emit(OpCodes.Br, cont124)
checkDebugIL.MarkLabel(cont124)
...
Dim locbldr135 As LocalBuilder = checkImportIL.DeclareLocal(GetType(Token))
...
Dim locbldr136 As LocalBuilder = checkImportIL.DeclareLocal(GetType(System.Type))
...
Dim locbldr137 As LocalBuilder = checkImportIL.DeclareLocal(GetType(ImportStmt))
locbldr137.SetLocalSymInfo("imps")
...
Typ = GetType(System.Boolean)
Dim fa125 As System.Reflection.Emit.Label = checkImportIL.DefineLabel()
Dim tru125 As System.Reflection.Emit.Label = checkImportIL.DefineLabel()
Dim cont125 As System.Reflection.Emit.Label = checkImportIL.DefineLabel()
checkImportIL.Emit(OpCodes.Beq, tru125)
checkImportIL.Emit(OpCodes.Br, fa125)
checkImportIL.MarkLabel(tru125)
...
checkImportIL.Emit(OpCodes.Br, cont125)
checkImportIL.MarkLabel(fa125)
checkImportIL.Emit(OpCodes.Br, cont125)
checkImportIL.MarkLabel(cont125)
...
Dim locbldr138 As LocalBuilder = checkLocimportIL.DeclareLocal(GetType(Token))
locbldr138.SetLocalSymInfo("tok")
...
Dim locbldr139 As LocalBuilder = checkLocimportIL.DeclareLocal(GetType(System.Type))
locbldr139.SetLocalSymInfo("typ")
...
Dim locbldr140 As LocalBuilder = checkLocimportIL.DeclareLocal(GetType(LocimportStmt))
locbldr140.SetLocalSymInfo("limps")
...
Typ = GetType(System.Boolean)
Dim fa126 As System.Reflection.Emit.Label = checkLocimportIL.DefineLabel()
Dim tru126 As System.Reflection.Emit.Label = checkLocimportIL.DefineLabel()
Dim cont126 As System.Reflection.Emit.Label = checkLocimportIL.DefineLabel()
checkLocimportIL.Emit(OpCodes.Beq, tru126)
checkLocimportIL.Emit(OpCodes.Br, fa126)
checkLocimportIL.MarkLabel(tru126)
...
checkLocimportIL.Emit(OpCodes.Br, cont126)
checkLocimportIL.MarkLabel(fa126)
checkLocimportIL.Emit(OpCodes.Br, cont126)
checkLocimportIL.MarkLabel(cont126)
...
Dim locbldr141 As LocalBuilder = checkCmtIL.DeclareLocal(GetType(Token))
locbldr141.SetLocalSymInfo("tok")
...
Dim locbldr142 As LocalBuilder = checkCmtIL.DeclareLocal(GetType(System.Type))
locbldr142.SetLocalSymInfo("typ")
...
Dim locbldr143 As LocalBuilder = checkCmtIL.DeclareLocal(GetType(CommentStmt))
locbldr143.SetLocalSymInfo("cmts")
...
Typ = GetType(System.Boolean)
Dim fa127 As System.Reflection.Emit.Label = checkCmtIL.DefineLabel()
Dim tru127 As System.Reflection.Emit.Label = checkCmtIL.DefineLabel()
Dim cont127 As System.Reflection.Emit.Label = checkCmtIL.DefineLabel()
checkCmtIL.Emit(OpCodes.Beq, tru127)
checkCmtIL.Emit(OpCodes.Br, fa127)
checkCmtIL.MarkLabel(tru127)
...
checkCmtIL.Emit(OpCodes.Br, cont127)
checkCmtIL.MarkLabel(fa127)
checkCmtIL.Emit(OpCodes.Br, cont127)
checkCmtIL.MarkLabel(cont127)
...
Typ = GetType(System.Int32)
Dim fa128 As System.Reflection.Emit.Label = checkEndMtdIL.DefineLabel()
Dim tru128 As System.Reflection.Emit.Label = checkEndMtdIL.DefineLabel()
Dim cont128 As System.Reflection.Emit.Label = checkEndMtdIL.DefineLabel()
checkEndMtdIL.Emit(OpCodes.Bge, tru128)
checkEndMtdIL.Emit(OpCodes.Br, fa128)
checkEndMtdIL.MarkLabel(tru128)
checkEndMtdIL.MarkSequencePoint(doc5, 72, 1, 72, 100)
Dim locbldr144 As LocalBuilder = checkEndMtdIL.DeclareLocal(GetType(Token))
...
Dim locbldr145 As LocalBuilder = checkEndMtdIL.DeclareLocal(GetType(System.Type))
...
Dim locbldr146 As LocalBuilder = checkEndMtdIL.DeclareLocal(GetType(System.Boolean))
...
Dim locbldr147 As LocalBuilder = checkEndMtdIL.DeclareLocal(GetType(Token))
...
Dim locbldr148 As LocalBuilder = checkEndMtdIL.DeclareLocal(GetType(System.Type))
...
Dim locbldr149 As LocalBuilder = checkEndMtdIL.DeclareLocal(GetType(System.Boolean))
...
Dim locbldr150 As LocalBuilder = checkEndMtdIL.DeclareLocal(GetType(EndMethodStmt))
locbldr150.SetLocalSymInfo("ems")
...
Typ = GetType(System.Boolean)
Dim fa129 As System.Reflection.Emit.Label = checkEndMtdIL.DefineLabel()
Dim tru129 As System.Reflection.Emit.Label = checkEndMtdIL.DefineLabel()
Dim cont129 As System.Reflection.Emit.Label = checkEndMtdIL.DefineLabel()
checkEndMtdIL.Emit(OpCodes.Beq, tru129)
checkEndMtdIL.Emit(OpCodes.Br, fa129)
checkEndMtdIL.MarkLabel(tru129)
...
checkEndMtdIL.Emit(OpCodes.Br, cont129)
checkEndMtdIL.MarkLabel(fa129)
checkEndMtdIL.Emit(OpCodes.Br, cont129)
checkEndMtdIL.MarkLabel(cont129)
checkEndMtdIL.MarkSequencePoint(doc5, 87, 1, 87, 100)
checkEndMtdIL.Emit(OpCodes.Br, cont128)
checkEndMtdIL.MarkLabel(fa128)
checkEndMtdIL.Emit(OpCodes.Br, cont128)
checkEndMtdIL.MarkLabel(cont128)
...
Typ = GetType(System.Int32)
Dim fa130 As System.Reflection.Emit.Label = checkEndClsIL.DefineLabel()
Dim tru130 As System.Reflection.Emit.Label = checkEndClsIL.DefineLabel()
Dim cont130 As System.Reflection.Emit.Label = checkEndClsIL.DefineLabel()
checkEndClsIL.Emit(OpCodes.Bge, tru130)
checkEndClsIL.Emit(OpCodes.Br, fa130)
checkEndClsIL.MarkLabel(tru130)
checkEndClsIL.MarkSequencePoint(doc5, 94, 1, 94, 100)
Dim locbldr151 As LocalBuilder = checkEndClsIL.DeclareLocal(GetType(Token))
locbldr151.SetLocalSymInfo("tok1")
checkEndClsIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
checkEndClsIL.Emit(OpCodes.Ldfld, GetType(Stmt).GetField("Tokens"))
Typ = GetType(Stmt).GetField("Tokens").FieldType
...
Dim locbldr152 As LocalBuilder = checkEndClsIL.DeclareLocal(GetType(System.Type))
locbldr152.SetLocalSymInfo("typ1")
...
Dim locbldr153 As LocalBuilder = checkEndClsIL.DeclareLocal(GetType(System.Boolean))
locbldr153.SetLocalSymInfo("b1")
Dim typ23(-1) As Type
...
Dim locbldr154 As LocalBuilder = checkEndClsIL.DeclareLocal(GetType(Token))
locbldr154.SetLocalSymInfo("tok2")
checkEndClsIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
checkEndClsIL.Emit(OpCodes.Ldfld, GetType(Stmt).GetField("Tokens"))
Typ = GetType(Stmt).GetField("Tokens").FieldType
...
Dim locbldr155 As LocalBuilder = checkEndClsIL.DeclareLocal(GetType(System.Type))
locbldr155.SetLocalSymInfo("typ2")
...
Dim locbldr156 As LocalBuilder = checkEndClsIL.DeclareLocal(GetType(System.Boolean))
locbldr156.SetLocalSymInfo("b2")
Dim typ25(-1) As Type
...
Dim locbldr157 As LocalBuilder = checkEndClsIL.DeclareLocal(GetType(EndClassStmt))
locbldr157.SetLocalSymInfo("ecs")
...
Typ = GetType(System.Boolean)
Dim fa131 As System.Reflection.Emit.Label = checkEndClsIL.DefineLabel()
Dim tru131 As System.Reflection.Emit.Label = checkEndClsIL.DefineLabel()
Dim cont131 As System.Reflection.Emit.Label = checkEndClsIL.DefineLabel()
checkEndClsIL.Emit(OpCodes.Beq, tru131)
checkEndClsIL.Emit(OpCodes.Br, fa131)
checkEndClsIL.MarkLabel(tru131)
...
checkEndClsIL.Emit(OpCodes.Br, cont131)
checkEndClsIL.MarkLabel(fa131)
checkEndClsIL.Emit(OpCodes.Br, cont131)
checkEndClsIL.MarkLabel(cont131)
checkEndClsIL.MarkSequencePoint(doc5, 109, 1, 109, 100)
checkEndClsIL.Emit(OpCodes.Br, cont130)
checkEndClsIL.MarkLabel(fa130)
checkEndClsIL.Emit(OpCodes.Br, cont130)
checkEndClsIL.MarkLabel(cont130)
...
Dim locbldr158 As LocalBuilder = checkAssemblyIL.DeclareLocal(GetType(Token))
locbldr158.SetLocalSymInfo("tok")
...
Dim locbldr159 As LocalBuilder = checkAssemblyIL.DeclareLocal(GetType(System.Type))
...
Dim locbldr160 As LocalBuilder = checkAssemblyIL.DeclareLocal(GetType(AssemblyStmt))
locbldr160.SetLocalSymInfo("asms")
...
Typ = GetType(System.Boolean)
Dim fa132 As System.Reflection.Emit.Label = checkAssemblyIL.DefineLabel()
Dim tru132 As System.Reflection.Emit.Label = checkAssemblyIL.DefineLabel()
Dim cont132 As System.Reflection.Emit.Label = checkAssemblyIL.DefineLabel()
checkAssemblyIL.Emit(OpCodes.Beq, tru132)
checkAssemblyIL.Emit(OpCodes.Br, fa132)
checkAssemblyIL.MarkLabel(tru132)
...
checkAssemblyIL.Emit(OpCodes.Br, cont132)
checkAssemblyIL.MarkLabel(fa132)
checkAssemblyIL.Emit(OpCodes.Br, cont132)
checkAssemblyIL.MarkLabel(cont132)
...
Dim locbldr161 As LocalBuilder = checkVerIL.DeclareLocal(GetType(Token))
...
Dim locbldr162 As LocalBuilder = checkVerIL.DeclareLocal(GetType(System.Type))
...
Dim locbldr163 As LocalBuilder = checkVerIL.DeclareLocal(GetType(VerStmt))
locbldr163.SetLocalSymInfo("vers")
...
Typ = GetType(System.Boolean)
Dim fa133 As System.Reflection.Emit.Label = checkVerIL.DefineLabel()
Dim tru133 As System.Reflection.Emit.Label = checkVerIL.DefineLabel()
Dim cont133 As System.Reflection.Emit.Label = checkVerIL.DefineLabel()
checkVerIL.Emit(OpCodes.Beq, tru133)
checkVerIL.Emit(OpCodes.Br, fa133)
checkVerIL.MarkLabel(tru133)
...
Dim locbldr164 As LocalBuilder = checkVerIL.DeclareLocal(GetType(System.String).MakeArrayType())
locbldr164.SetLocalSymInfo("ars")
Dim typ32(-1) As Type
checkVerIL.Emit(OpCodes.Ldloc, 0)
Typ = GetType(Token)
...
Dim locbldr165 As LocalBuilder = checkVerIL.DeclareLocal(GetType(System.Int32).MakeArrayType())
locbldr165.SetLocalSymInfo("ari")
...
Dim locbldr166 As LocalBuilder = checkVerIL.DeclareLocal(GetType(IntLiteral).MakeArrayType())
locbldr166.SetLocalSymInfo("intla")
checkVerIL.Emit(OpCodes.Ldc_I4, CInt(4))
Typ = GetType(System.Int32)
checkVerIL.Emit(OpCodes.Conv_U)
...
Dim locbldr167 As LocalBuilder = checkVerIL.DeclareLocal(GetType(IntLiteral))
locbldr167.SetLocalSymInfo("intl")
...
checkVerIL.Emit(OpCodes.Br, cont133)
checkVerIL.MarkLabel(fa133)
checkVerIL.Emit(OpCodes.Br, cont133)
checkVerIL.MarkLabel(cont133)
...
Dim locbldr170 As LocalBuilder = checkClassIL.DeclareLocal(GetType(ClassStmt))
locbldr170.SetLocalSymInfo("clss")
...
Dim locbldr171 As LocalBuilder = checkClassIL.DeclareLocal(GetType(Attributes.Attribute))
locbldr171.SetLocalSymInfo("att")
...
Typ = GetType(System.Boolean)
Dim fa134 As System.Reflection.Emit.Label = checkClassIL.DefineLabel()
Dim tru134 As System.Reflection.Emit.Label = checkClassIL.DefineLabel()
Dim cont134 As System.Reflection.Emit.Label = checkClassIL.DefineLabel()
checkClassIL.Emit(OpCodes.Beq, tru134)
checkClassIL.Emit(OpCodes.Br, fa134)
checkClassIL.MarkLabel(tru134)
...
Dim locbldr172 As LocalBuilder = checkClassIL.DeclareLocal(GetType(System.Int32))
locbldr172.SetLocalSymInfo("i")
checkClassIL.Emit(OpCodes.Ldc_I4, CInt(0))
Typ = GetType(System.Int32)
checkClassIL.Emit(OpCodes.Stloc, 4)
checkClassIL.MarkSequencePoint(doc5, 180, 1, 180, 100)
Dim locbldr173 As LocalBuilder = checkClassIL.DeclareLocal(GetType(System.Int32))
...
Dim locbldr174 As LocalBuilder = checkClassIL.DeclareLocal(GetType(System.Boolean))
locbldr174.SetLocalSymInfo("bl")
...
checkClassIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa135 As System.Reflection.Emit.Label = checkClassIL.DefineLabel()
Dim tru135 As System.Reflection.Emit.Label = checkClassIL.DefineLabel()
Dim cont135 As System.Reflection.Emit.Label = checkClassIL.DefineLabel()
checkClassIL.Emit(OpCodes.Beq, tru135)
checkClassIL.Emit(OpCodes.Br, fa135)
checkClassIL.MarkLabel(tru135)
...
checkClassIL.Emit(OpCodes.Br, cont135)
checkClassIL.MarkLabel(fa135)
checkClassIL.MarkSequencePoint(doc5, 195, 1, 195, 100)
Dim locbldr175 As LocalBuilder = checkClassIL.DeclareLocal(GetType(Token))
locbldr175.SetLocalSymInfo("tok2")
checkClassIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
checkClassIL.Emit(OpCodes.Ldfld, GetType(Stmt).GetField("Tokens"))
Typ = GetType(Stmt).GetField("Tokens").FieldType
...
Dim locbldr176 As LocalBuilder = checkClassIL.DeclareLocal(GetType(System.Type))
locbldr176.SetLocalSymInfo("typ2")
...
Dim locbldr177 As LocalBuilder = checkClassIL.DeclareLocal(GetType(System.Boolean))
locbldr177.SetLocalSymInfo("b2")
Dim typ48(-1) As Type
...
checkClassIL.Emit(OpCodes.Beq, fa137)
checkClassIL.Emit(OpCodes.Br, tru137)
checkClassIL.MarkLabel(tru137)
checkClassIL.MarkSequencePoint(doc5, 206, 1, 206, 100)
Dim locbldr178 As LocalBuilder = checkClassIL.DeclareLocal(GetType(Token))
locbldr178.SetLocalSymInfo("t")
checkClassIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
checkClassIL.Emit(OpCodes.Ldfld, GetType(Stmt).GetField("Tokens"))
Typ = GetType(Stmt).GetField("Tokens").FieldType
...
Dim locbldr179 As LocalBuilder = checkClassIL.DeclareLocal(GetType(TypeTok))
locbldr179.SetLocalSymInfo("tt")
...
checkClassIL.Emit(OpCodes.Br, cont135)
checkClassIL.MarkLabel(cont135)
...
checkClassIL.Emit(OpCodes.Br, cont134)
checkClassIL.MarkLabel(fa134)
checkClassIL.Emit(OpCodes.Br, cont134)
checkClassIL.MarkLabel(cont134)
...
Dim checkFieldparam00 As ParameterBuilder = checkField.DefineParameter(0, ParameterAttributes.RetVal, "")
...
Dim locbldr180 As LocalBuilder = checkFieldIL.DeclareLocal(GetType(Token))
...
Dim locbldr181 As LocalBuilder = checkFieldIL.DeclareLocal(GetType(System.Type))
...
Dim locbldr182 As LocalBuilder = checkFieldIL.DeclareLocal(GetType(FieldStmt))
locbldr182.SetLocalSymInfo("flss")
...
Dim locbldr183 As LocalBuilder = checkFieldIL.DeclareLocal(GetType(Attributes.Attribute))
locbldr183.SetLocalSymInfo("att")
...
Typ = GetType(System.Boolean)
Dim fa139 As System.Reflection.Emit.Label = checkFieldIL.DefineLabel()
Dim tru139 As System.Reflection.Emit.Label = checkFieldIL.DefineLabel()
Dim cont139 As System.Reflection.Emit.Label = checkFieldIL.DefineLabel()
checkFieldIL.Emit(OpCodes.Beq, tru139)
checkFieldIL.Emit(OpCodes.Br, fa139)
checkFieldIL.MarkLabel(tru139)
checkFieldIL.MarkSequencePoint(doc5, 243, 1, 243, 100)
Dim locbldr184 As LocalBuilder = checkFieldIL.DeclareLocal(GetType(Expr))
locbldr184.SetLocalSymInfo("tempexp")
...
Dim locbldr185 As LocalBuilder = checkFieldIL.DeclareLocal(asm.GetType("dylan.NET.Tokenizer.Parser.ExprOptimizer"))
locbldr185.SetLocalSymInfo("eop")
...
Dim locbldr186 As LocalBuilder = checkFieldIL.DeclareLocal(GetType(System.Int32))
locbldr186.SetLocalSymInfo("i")
checkFieldIL.Emit(OpCodes.Ldc_I4, CInt(0))
Typ = GetType(System.Int32)
checkFieldIL.Emit(OpCodes.Stloc, 6)
checkFieldIL.MarkSequencePoint(doc5, 258, 1, 258, 100)
Dim locbldr187 As LocalBuilder = checkFieldIL.DeclareLocal(GetType(System.Int32))
locbldr187.SetLocalSymInfo("len")
checkFieldIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
checkFieldIL.Emit(OpCodes.Ldfld, GetType(Stmt).GetField("Tokens"))
Typ = GetType(Stmt).GetField("Tokens").FieldType
...
Dim locbldr188 As LocalBuilder = checkFieldIL.DeclareLocal(GetType(System.Boolean))
locbldr188.SetLocalSymInfo("bl")
checkFieldIL.Emit(OpCodes.Ldc_I4, 0)
Typ = GetType(System.Boolean)
...
checkFieldIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa140 As System.Reflection.Emit.Label = checkFieldIL.DefineLabel()
Dim tru140 As System.Reflection.Emit.Label = checkFieldIL.DefineLabel()
Dim cont140 As System.Reflection.Emit.Label = checkFieldIL.DefineLabel()
checkFieldIL.Emit(OpCodes.Beq, tru140)
checkFieldIL.Emit(OpCodes.Br, fa140)
checkFieldIL.MarkLabel(tru140)
...
checkFieldIL.Emit(OpCodes.Br, cont140)
checkFieldIL.MarkLabel(fa140)
checkFieldIL.Emit(OpCodes.Br, cont140)
checkFieldIL.MarkLabel(cont140)
...
Dim locbldr189 As LocalBuilder = checkFieldIL.DeclareLocal(GetType(Token))
locbldr189.SetLocalSymInfo("tok2")
checkFieldIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
checkFieldIL.Emit(OpCodes.Ldfld, GetType(Stmt).GetField("Tokens"))
Typ = GetType(Stmt).GetField("Tokens").FieldType
...
Dim locbldr190 As LocalBuilder = checkFieldIL.DeclareLocal(GetType(System.Type))
locbldr190.SetLocalSymInfo("typ2")
...
Dim locbldr191 As LocalBuilder = checkFieldIL.DeclareLocal(GetType(System.Boolean))
locbldr191.SetLocalSymInfo("b2")
Dim typ59(-1) As Type
...
checkFieldIL.Emit(OpCodes.Beq, fa142)
checkFieldIL.Emit(OpCodes.Br, tru142)
checkFieldIL.MarkLabel(tru142)
checkFieldIL.MarkSequencePoint(doc5, 287, 1, 287, 100)
Dim locbldr192 As LocalBuilder = checkFieldIL.DeclareLocal(GetType(Token))
locbldr192.SetLocalSymInfo("t")
checkFieldIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
checkFieldIL.Emit(OpCodes.Ldfld, GetType(Stmt).GetField("Tokens"))
Typ = GetType(Stmt).GetField("Tokens").FieldType
...
Dim locbldr193 As LocalBuilder = checkFieldIL.DeclareLocal(GetType(TypeTok))
locbldr193.SetLocalSymInfo("tt")
...
checkFieldIL.Emit(OpCodes.Br, cont139)
checkFieldIL.MarkLabel(fa139)
checkFieldIL.Emit(OpCodes.Br, cont139)
checkFieldIL.MarkLabel(cont139)
...
Dim locbldr194 As LocalBuilder = checkMethodIL.DeclareLocal(GetType(Token))
...
Dim locbldr195 As LocalBuilder = checkMethodIL.DeclareLocal(GetType(System.Type))
...
Dim locbldr196 As LocalBuilder = checkMethodIL.DeclareLocal(GetType(MethodStmt))
locbldr196.SetLocalSymInfo("mtss")
...
Dim locbldr197 As LocalBuilder = checkMethodIL.DeclareLocal(GetType(Attributes.Attribute))
locbldr197.SetLocalSymInfo("att")
...
Dim locbldr198 As LocalBuilder = checkMethodIL.DeclareLocal(GetType(Ident))
locbldr198.SetLocalSymInfo("mn")
...
Dim locbldr199 As LocalBuilder = checkMethodIL.DeclareLocal(GetType(Expr))
locbldr199.SetLocalSymInfo("exp")
checkMethodIL.Emit(OpCodes.Ldnull)
checkMethodIL.Emit(OpCodes.Stloc, 5)
checkMethodIL.MarkSequencePoint(doc5, 313, 1, 313, 100)
Dim locbldr200 As LocalBuilder = checkMethodIL.DeclareLocal(GetType(System.Boolean))
locbldr200.SetLocalSymInfo("d")
...
locbldr201.SetLocalSymInfo("tempexp")
...
Dim locbldr202 As LocalBuilder = checkMethodIL.DeclareLocal(asm.GetType("dylan.NET.Tokenizer.Parser.ExprOptimizer"))
locbldr202.SetLocalSymInfo("eop")
...
Dim locbldr203 As LocalBuilder = checkMethodIL.DeclareLocal(GetType(System.Int32))
locbldr203.SetLocalSymInfo("i")
checkMethodIL.Emit(OpCodes.Ldc_I4, CInt(0))
Typ = GetType(System.Int32)
checkMethodIL.Emit(OpCodes.Stloc, 9)
checkMethodIL.MarkSequencePoint(doc5, 333, 1, 333, 100)
Dim locbldr204 As LocalBuilder = checkMethodIL.DeclareLocal(GetType(System.Int32))
...
Dim locbldr205 As LocalBuilder = checkMethodIL.DeclareLocal(GetType(System.Boolean))
locbldr205.SetLocalSymInfo("bl")
checkMethodIL.Emit(OpCodes.Ldc_I4, 0)
Typ = GetType(System.Boolean)
...
Dim locbldr206 As LocalBuilder = checkMethodIL.DeclareLocal(GetType(Token))
...
Dim locbldr207 As LocalBuilder = checkMethodIL.DeclareLocal(GetType(System.Type))
...
checkMethodIL.Emit(OpCodes.Beq, fa146)
checkMethodIL.Emit(OpCodes.Br, tru146)
...
Dim locbldr210 As LocalBuilder = checkMethodIL.DeclareLocal(GetType(TypeTok))
locbldr210.SetLocalSymInfo("tt")
...
Dim locbldr211 As LocalBuilder = checkMethodIL.DeclareLocal(asm.GetType("dylan.NET.Tokenizer.Parser.ExprOptimizer"))
locbldr211.SetLocalSymInfo("eopt2")
checkMethodIL.Emit(OpCodes.Newobj, asm.GetType("dylan.NET.Tokenizer.Parser.ExprOptimizer").GetConstructor(Type.EmptyTypes))
...
Dim locbldr212 As LocalBuilder = checkMethodIL.DeclareLocal(asm.GetType("dylan.NET.Tokenizer.Parser.ExprOptimizer"))
locbldr212.SetLocalSymInfo("eopt1")
checkMethodIL.Emit(OpCodes.Newobj, asm.GetType("dylan.NET.Tokenizer.Parser.ExprOptimizer").GetConstructor(Type.EmptyTypes))
...
Typ = GetType(System.Int32)
Dim fa157 As System.Reflection.Emit.Label = checkMethodCallIL.DefineLabel()
Dim tru157 As System.Reflection.Emit.Label = checkMethodCallIL.DefineLabel()
Dim cont157 As System.Reflection.Emit.Label = checkMethodCallIL.DefineLabel()
checkMethodCallIL.Emit(OpCodes.Bgt, tru157)
checkMethodCallIL.Emit(OpCodes.Br, fa157)
checkMethodCallIL.MarkLabel(tru157)
checkMethodCallIL.MarkSequencePoint(doc5, 462, 1, 462, 100)
Dim locbldr213 As LocalBuilder = checkMethodCallIL.DeclareLocal(GetType(Token))
...
Dim locbldr214 As LocalBuilder = checkMethodCallIL.DeclareLocal(GetType(System.Type))
...
locbldr215.SetLocalSymInfo("tokb")
checkMethodCallIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
checkMethodCallIL.Emit(OpCodes.Ldfld, GetType(Stmt).GetField("Tokens"))
Typ = GetType(Stmt).GetField("Tokens").FieldType
...
locbldr216.SetLocalSymInfo("typb")
...
Dim locbldr217 As LocalBuilder = checkMethodCallIL.DeclareLocal(GetType(System.Boolean))
locbldr217.SetLocalSymInfo("ba")
Dim typ87(-1) As Type
...
Dim locbldr218 As LocalBuilder = checkMethodCallIL.DeclareLocal(GetType(System.Boolean))
locbldr218.SetLocalSymInfo("bb")
Dim typ88(-1) As Type
...
Dim locbldr219 As LocalBuilder = checkMethodCallIL.DeclareLocal(GetType(MethodCallStmt))
locbldr219.SetLocalSymInfo("mtcss")
...
Dim locbldr220 As LocalBuilder = checkMethodCallIL.DeclareLocal(GetType(MethodNameTok))
locbldr220.SetLocalSymInfo("mn")
...
Dim locbldr221 As LocalBuilder = checkMethodCallIL.DeclareLocal(GetType(MethodCallTok))
locbldr221.SetLocalSymInfo("mct")
...
Dim locbldr222 As LocalBuilder = checkMethodCallIL.DeclareLocal(GetType(Ident))
locbldr222.SetLocalSymInfo("idt")
...
Dim locbldr223 As LocalBuilder = checkMethodCallIL.DeclareLocal(GetType(Expr))
locbldr223.SetLocalSymInfo("exp")
...
Dim locbldr224 As LocalBuilder = checkMethodCallIL.DeclareLocal(GetType(System.Int32))
locbldr224.SetLocalSymInfo("lvl")
checkMethodCallIL.Emit(OpCodes.Ldc_I4, CInt(1))
Typ = GetType(System.Int32)
...
checkMethodCallIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa158 As System.Reflection.Emit.Label = checkMethodCallIL.DefineLabel()
Dim tru158 As System.Reflection.Emit.Label = checkMethodCallIL.DefineLabel()
Dim cont158 As System.Reflection.Emit.Label = checkMethodCallIL.DefineLabel()
checkMethodCallIL.Emit(OpCodes.Beq, tru158)
checkMethodCallIL.Emit(OpCodes.Br, fa158)
checkMethodCallIL.MarkLabel(tru158)
...
Dim locbldr227 As LocalBuilder = checkMethodCallIL.DeclareLocal(GetType(Token))
...
Dim locbldr228 As LocalBuilder = checkMethodCallIL.DeclareLocal(GetType(System.Type))
...
locbldr230.SetLocalSymInfo("len")
checkMethodCallIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
checkMethodCallIL.Emit(OpCodes.Ldfld, GetType(Stmt).GetField("Tokens"))
Typ = GetType(Stmt).GetField("Tokens").FieldType
...
Dim locbldr231 As LocalBuilder = checkMethodCallIL.DeclareLocal(asm.GetType("dylan.NET.Tokenizer.Parser.ExprOptimizer"))
locbldr231.SetLocalSymInfo("eopt")
...
checkMethodCallIL.Emit(OpCodes.Beq, tru159)
...
checkMethodCallIL.Emit(OpCodes.Br, cont158)
checkMethodCallIL.MarkLabel(fa158)
checkMethodCallIL.Emit(OpCodes.Br, cont158)
checkMethodCallIL.MarkLabel(cont158)
checkMethodCallIL.MarkSequencePoint(doc5, 568, 1, 568, 100)
checkMethodCallIL.Emit(OpCodes.Br, cont157)
checkMethodCallIL.MarkLabel(fa157)
checkMethodCallIL.Emit(OpCodes.Br, cont157)
checkMethodCallIL.MarkLabel(cont157)
...
Dim locbldr232 As LocalBuilder = checkVarAsIL.DeclareLocal(GetType(Token))
...
Dim locbldr233 As LocalBuilder = checkVarAsIL.DeclareLocal(GetType(System.Type))
...
Dim locbldr234 As LocalBuilder = checkVarAsIL.DeclareLocal(GetType(VarStmt))
locbldr234.SetLocalSymInfo("vars")
...
checkVarAsIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa166 As System.Reflection.Emit.Label = checkVarAsIL.DefineLabel()
Dim tru166 As System.Reflection.Emit.Label = checkVarAsIL.DefineLabel()
Dim cont166 As System.Reflection.Emit.Label = checkVarAsIL.DefineLabel()
checkVarAsIL.Emit(OpCodes.Beq, tru166)
checkVarAsIL.Emit(OpCodes.Br, fa166)
checkVarAsIL.MarkLabel(tru166)
...
Dim locbldr235 As LocalBuilder = checkVarAsIL.DeclareLocal(GetType(Expr))
locbldr235.SetLocalSymInfo("tempexp")
...
Dim locbldr236 As LocalBuilder = checkVarAsIL.DeclareLocal(asm.GetType("dylan.NET.Tokenizer.Parser.ExprOptimizer"))
locbldr236.SetLocalSymInfo("eop")
...
Dim locbldr237 As LocalBuilder = checkVarAsIL.DeclareLocal(GetType(Token))
locbldr237.SetLocalSymInfo("tok2")
checkVarAsIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
checkVarAsIL.Emit(OpCodes.Ldfld, GetType(Stmt).GetField("Tokens"))
Typ = GetType(Stmt).GetField("Tokens").FieldType
...
Dim locbldr238 As LocalBuilder = checkVarAsIL.DeclareLocal(GetType(System.Type))
locbldr238.SetLocalSymInfo("typ2")
checkVarAsIL.Emit(OpCodes.Ldtoken, GetType(TypeTok))
...
Dim locbldr239 As LocalBuilder = checkVarAsIL.DeclareLocal(GetType(System.Boolean))
locbldr239.SetLocalSymInfo("b2")
Dim typ105(-1) As Type
checkVarAsIL.Emit(OpCodes.Ldloc, 6)
Typ = GetType(System.Type)
Typ03 = Typ
...
checkVarAsIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa167 As System.Reflection.Emit.Label = checkVarAsIL.DefineLabel()
Dim tru167 As System.Reflection.Emit.Label = checkVarAsIL.DefineLabel()
Dim cont167 As System.Reflection.Emit.Label = checkVarAsIL.DefineLabel()
checkVarAsIL.Emit(OpCodes.Beq, fa167)
checkVarAsIL.Emit(OpCodes.Br, tru167)
checkVarAsIL.MarkLabel(tru167)
checkVarAsIL.MarkSequencePoint(doc5, 593, 1, 593, 100)
Dim locbldr240 As LocalBuilder = checkVarAsIL.DeclareLocal(GetType(Token))
locbldr240.SetLocalSymInfo("t")
checkVarAsIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
checkVarAsIL.Emit(OpCodes.Ldfld, GetType(Stmt).GetField("Tokens"))
Typ = GetType(Stmt).GetField("Tokens").FieldType
...
Dim locbldr241 As LocalBuilder = checkVarAsIL.DeclareLocal(GetType(TypeTok))
locbldr241.SetLocalSymInfo("tt")
checkVarAsIL.Emit(OpCodes.Newobj, GetType(TypeTok).GetConstructor(Type.EmptyTypes))
...
checkVarAsIL.Emit(OpCodes.Br, cont167)
checkVarAsIL.MarkLabel(fa167)
...
checkVarAsIL.Emit(OpCodes.Br, cont167)
checkVarAsIL.MarkLabel(cont167)
checkVarAsIL.MarkSequencePoint(doc5, 602, 1, 602, 100)
checkVarAsIL.Emit(OpCodes.Br, cont166)
checkVarAsIL.MarkLabel(fa166)
checkVarAsIL.Emit(OpCodes.Br, cont166)
checkVarAsIL.MarkLabel(cont166)
...
Dim locbldr242 As LocalBuilder = AssOptIL.DeclareLocal(GetType(AssignStmt))
locbldr242.SetLocalSymInfo("asss")
AssOptIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
AssOptIL.Emit(OpCodes.Stloc, 0)
AssOptIL.MarkSequencePoint(doc5, 609, 1, 609, 100)
Dim locbldr243 As LocalBuilder = AssOptIL.DeclareLocal(GetType(Expr))
locbldr243.SetLocalSymInfo("le")
...
Dim locbldr244 As LocalBuilder = AssOptIL.DeclareLocal(GetType(Token))
...
Dim locbldr245 As LocalBuilder = AssOptIL.DeclareLocal(GetType(System.Type))
...
Dim locbldr246 As LocalBuilder = AssOptIL.DeclareLocal(GetType(System.Boolean))
...
Dim locbldr247 As LocalBuilder = AssOptIL.DeclareLocal(GetType(VarAsgnStmt))
locbldr247.SetLocalSymInfo("vass")
...
Typ = GetType(System.Boolean)
Dim fa168 As System.Reflection.Emit.Label = AssOptIL.DefineLabel()
Dim tru168 As System.Reflection.Emit.Label = AssOptIL.DefineLabel()
Dim cont168 As System.Reflection.Emit.Label = AssOptIL.DefineLabel()
AssOptIL.Emit(OpCodes.Beq, tru168)
AssOptIL.Emit(OpCodes.Br, fa168)
AssOptIL.MarkLabel(tru168)
...
locbldr248.SetLocalSymInfo("tok2")
AssOptIL.Emit(OpCodes.Ldloc, 1)
Typ = GetType(Expr)
AssOptIL.Emit(OpCodes.Ldfld, GetType(Expr).GetField("Tokens"))
Typ = GetType(Expr).GetField("Tokens").FieldType
...
locbldr249.SetLocalSymInfo("typ2")
...
AssOptIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa169 As System.Reflection.Emit.Label = AssOptIL.DefineLabel()
Dim tru169 As System.Reflection.Emit.Label = AssOptIL.DefineLabel()
Dim cont169 As System.Reflection.Emit.Label = AssOptIL.DefineLabel()
AssOptIL.Emit(OpCodes.Beq, fa169)
AssOptIL.Emit(OpCodes.Br, tru169)
AssOptIL.MarkLabel(tru169)
AssOptIL.MarkSequencePoint(doc5, 624, 1, 624, 100)
Dim locbldr251 As LocalBuilder = AssOptIL.DeclareLocal(GetType(Token))
locbldr251.SetLocalSymInfo("t")
AssOptIL.Emit(OpCodes.Ldloc, 1)
Typ = GetType(Expr)
AssOptIL.Emit(OpCodes.Ldfld, GetType(Expr).GetField("Tokens"))
Typ = GetType(Expr).GetField("Tokens").FieldType
...
Dim locbldr252 As LocalBuilder = AssOptIL.DeclareLocal(GetType(TypeTok))
locbldr252.SetLocalSymInfo("tt")
...
AssOptIL.Emit(OpCodes.Br, cont169)
AssOptIL.MarkLabel(fa169)
...
Dim locbldr253 As LocalBuilder = AssOptIL.DeclareLocal(asm.GetType("dylan.NET.Tokenizer.Parser.ExprOptimizer"))
locbldr253.SetLocalSymInfo("eop")
...
Dim locbldr254 As LocalBuilder = checkAssignIL.DeclareLocal(GetType(Token))
locbldr254.SetLocalSymInfo("tok")
checkAssignIL.Emit(OpCodes.Ldnull)
checkAssignIL.Emit(OpCodes.Stloc, 0)
checkAssignIL.MarkSequencePoint(doc5, 646, 1, 646, 100)
Dim locbldr255 As LocalBuilder = checkAssignIL.DeclareLocal(GetType(System.Type))
locbldr255.SetLocalSymInfo("typ")
...
Dim locbldr256 As LocalBuilder = checkAssignIL.DeclareLocal(GetType(AssignStmt))
locbldr256.SetLocalSymInfo("asss")
...
Dim locbldr257 As LocalBuilder = checkAssignIL.DeclareLocal(GetType(System.Boolean))
locbldr257.SetLocalSymInfo("c")
checkAssignIL.Emit(OpCodes.Ldc_I4, 0)
Typ = GetType(System.Boolean)
checkAssignIL.Emit(OpCodes.Stloc, 3)
checkAssignIL.MarkSequencePoint(doc5, 649, 1, 649, 100)
Dim locbldr258 As LocalBuilder = checkAssignIL.DeclareLocal(GetType(Expr))
locbldr258.SetLocalSymInfo("re")
...
Dim locbldr259 As LocalBuilder = checkAssignIL.DeclareLocal(GetType(Expr))
locbldr259.SetLocalSymInfo("le")
checkAssignIL.Emit(OpCodes.Newobj, GetType(Expr).GetConstructor(Type.EmptyTypes))
checkAssignIL.Emit(OpCodes.Stloc, 5)
checkAssignIL.MarkSequencePoint(doc5, 651, 1, 651, 100)
Dim locbldr260 As LocalBuilder = checkAssignIL.DeclareLocal(GetType(System.Int32))
locbldr260.SetLocalSymInfo("i")
...
Dim locbldr261 As LocalBuilder = checkAssignIL.DeclareLocal(GetType(System.Int32))
...
locbldr262.SetLocalSymInfo("assind")
...
Typ = GetType(System.Boolean)
Dim fa170 As System.Reflection.Emit.Label = checkAssignIL.DefineLabel()
Dim tru170 As System.Reflection.Emit.Label = checkAssignIL.DefineLabel()
Dim cont170 As System.Reflection.Emit.Label = checkAssignIL.DefineLabel()
checkAssignIL.Emit(OpCodes.Beq, tru170)
checkAssignIL.Emit(OpCodes.Br, fa170)
checkAssignIL.MarkLabel(tru170)
...
checkAssignIL.Emit(OpCodes.Br, cont170)
checkAssignIL.MarkLabel(fa170)
checkAssignIL.Emit(OpCodes.Br, cont170)
checkAssignIL.MarkLabel(cont170)
checkAssignIL.MarkSequencePoint(doc5, 670, 1, 670, 100)
checkAssignIL.Emit(OpCodes.Ldloc, 6)
Typ = GetType(System.Int32)
checkAssignIL.Emit(OpCodes.Ldloc, 7)
Typ = GetType(System.Int32)
Dim fa171 As System.Reflection.Emit.Label = checkAssignIL.DefineLabel()
Dim tru171 As System.Reflection.Emit.Label = checkAssignIL.DefineLabel()
Dim cont171 As System.Reflection.Emit.Label = checkAssignIL.DefineLabel()
checkAssignIL.Emit(OpCodes.Beq, tru171)
checkAssignIL.Emit(OpCodes.Br, fa171)
checkAssignIL.MarkLabel(tru171)
checkAssignIL.MarkSequencePoint(doc5, 671, 1, 671, 100)
checkAssignIL.Emit(OpCodes.Br, label13)
checkAssignIL.MarkSequencePoint(doc5, 672, 1, 672, 100)
checkAssignIL.Emit(OpCodes.Br, cont171)
checkAssignIL.MarkLabel(fa171)
...
checkAssignIL.Emit(OpCodes.Br, cont171)
checkAssignIL.MarkLabel(cont171)
...
checkAssignIL.Emit(OpCodes.Beq, fa172)
checkAssignIL.Emit(OpCodes.Br, tru172)
...
Dim locbldr263 As LocalBuilder = checkAssignIL.DeclareLocal(asm.GetType("dylan.NET.Tokenizer.Parser.ExprOptimizer"))
locbldr263.SetLocalSymInfo("eop")
...
Dim locbldr264 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(System.Int32))
locbldr264.SetLocalSymInfo("i")
OptimizeIL.Emit(OpCodes.Ldc_I4, CInt(-1))
Typ = GetType(System.Int32)
OptimizeIL.Emit(OpCodes.Stloc, 0)
OptimizeIL.MarkSequencePoint(doc5, 749, 1, 749, 100)
Dim locbldr265 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(System.Int32))
...
Dim locbldr266 As LocalBuilder = OptimizeIL.DeclareLocal(asm.GetType("dylan.NET.Tokenizer.Parser.TokenOptimizer"))
locbldr266.SetLocalSymInfo("to")
OptimizeIL.Emit(OpCodes.Ldnull)
OptimizeIL.Emit(OpCodes.Stloc, 2)
OptimizeIL.MarkSequencePoint(doc5, 751, 1, 751, 100)
Dim locbldr267 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(Stmt))
locbldr267.SetLocalSymInfo("tmpstm")
OptimizeIL.Emit(OpCodes.Ldnull)
OptimizeIL.Emit(OpCodes.Stloc, 3)
OptimizeIL.MarkSequencePoint(doc5, 752, 1, 752, 100)
Dim locbldr268 As LocalBuilder = OptimizeIL.DeclareLocal(GetType(System.Boolean))
locbldr268.SetLocalSymInfo("compb")
OptimizeIL.Emit(OpCodes.Ldc_I4, 0)
Typ = GetType(System.Boolean)
OptimizeIL.Emit(OpCodes.Stloc, 4)
...
OptimizeIL.Emit(OpCodes.Blt, tru175)
...
Dim locbldr269 As LocalBuilder = ParseIL.DeclareLocal(GetType(System.Int32))
locbldr269.SetLocalSymInfo("i")
ParseIL.Emit(OpCodes.Ldc_I4, CInt(-1))
Typ = GetType(System.Int32)
ParseIL.Emit(OpCodes.Stloc, 0)
ParseIL.MarkSequencePoint(doc6, 5, 1, 5, 100)
Dim locbldr270 As LocalBuilder = ParseIL.DeclareLocal(asm.GetType("dylan.NET.Tokenizer.Parser.StmtOptimizer"))
locbldr270.SetLocalSymInfo("so")
...
ParseIL.Emit(OpCodes.Ldloc, 2)
Typ = GetType(System.Int32)
Dim fa195 As System.Reflection.Emit.Label = ParseIL.DefineLabel()
Dim tru195 As System.Reflection.Emit.Label = ParseIL.DefineLabel()
Dim cont195 As System.Reflection.Emit.Label = ParseIL.DefineLabel()
ParseIL.Emit(OpCodes.Beq, tru195)
ParseIL.Emit(OpCodes.Br, fa195)
ParseIL.MarkLabel(tru195)
ParseIL.MarkSequencePoint(doc6, 19, 1, 19, 100)
ParseIL.Emit(OpCodes.Br, label1)
ParseIL.MarkSequencePoint(doc6, 20, 1, 20, 100)
ParseIL.Emit(OpCodes.Br, cont195)
ParseIL.MarkLabel(fa195)
ParseIL.MarkSequencePoint(doc6, 21, 1, 21, 100)
ParseIL.Emit(OpCodes.Br, label0)
ParseIL.MarkSequencePoint(doc6, 22, 1, 22, 100)
ParseIL.Emit(OpCodes.Br, cont195)
ParseIL.MarkLabel(cont195)
