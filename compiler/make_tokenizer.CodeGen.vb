...
Dim locbldr43 As LocalBuilder = EmitMSILIL.DeclareLocal(GetType(System.Int32))
...
Dim locbldr44 As LocalBuilder = EmitMSILIL.DeclareLocal(GetType(System.Int32))
...
Dim locbldr45 As LocalBuilder = EmitMSILIL.DeclareLocal(GetType(Stmt))
locbldr45.SetLocalSymInfo("stm")
EmitMSILIL.Emit(OpCodes.Ldnull)
EmitMSILIL.Emit(OpCodes.Stloc, 2)
EmitMSILIL.MarkSequencePoint(doc7, 8, 1, 8, 100)
Dim locbldr46 As LocalBuilder = EmitMSILIL.DeclareLocal(GetType(System.Type))
locbldr46.SetLocalSymInfo("typ")
EmitMSILIL.MarkSequencePoint(doc7, 9, 1, 9, 100)
Dim locbldr47 As LocalBuilder = EmitMSILIL.DeclareLocal(GetType(System.Boolean))
locbldr47.SetLocalSymInfo("b")
...
Typ = GetType(System.Boolean)
Dim fa179 As System.Reflection.Emit.Label = EmitMSILIL.DefineLabel()
Dim tru179 As System.Reflection.Emit.Label = EmitMSILIL.DefineLabel()
Dim cont179 As System.Reflection.Emit.Label = EmitMSILIL.DefineLabel()
EmitMSILIL.Emit(OpCodes.Beq, tru179)
EmitMSILIL.Emit(OpCodes.Br, fa179)
EmitMSILIL.MarkLabel(tru179)
EmitMSILIL.MarkSequencePoint(doc7, 23, 1, 23, 100)
EmitMSILIL.Emit(OpCodes.Br, cont179)
EmitMSILIL.MarkLabel(fa179)
EmitMSILIL.MarkSequencePoint(doc7, 25, 1, 25, 100)
Dim locbldr48 As LocalBuilder = EmitMSILIL.DeclareLocal(asm.GetType("dylan.NET.Tokenizer.CodeGen.StmtReader"))
locbldr48.SetLocalSymInfo("sr")
...
EmitMSILIL.Emit(OpCodes.Br, cont179)
EmitMSILIL.MarkLabel(cont179)
EmitMSILIL.MarkSequencePoint(doc7, 30, 1, 30, 100)
EmitMSILIL.Emit(OpCodes.Ldloc, 0)
Typ = GetType(System.Int32)
EmitMSILIL.Emit(OpCodes.Ldloc, 1)
Typ = GetType(System.Int32)
Dim fa180 As System.Reflection.Emit.Label = EmitMSILIL.DefineLabel()
Dim tru180 As System.Reflection.Emit.Label = EmitMSILIL.DefineLabel()
Dim cont180 As System.Reflection.Emit.Label = EmitMSILIL.DefineLabel()
EmitMSILIL.Emit(OpCodes.Beq, tru180)
EmitMSILIL.Emit(OpCodes.Br, fa180)
EmitMSILIL.MarkLabel(tru180)
...
EmitMSILIL.Emit(OpCodes.Br, cont180)
EmitMSILIL.MarkLabel(fa180)
