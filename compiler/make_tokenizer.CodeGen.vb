...
ASTEmitIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("IsInstanceOfType", typ60))
...
Dim locbldr147 As LocalBuilder = ASTEmitIL.DeclareLocal(GetType(Literal))
locbldr147.SetLocalSymInfo("lit")
ASTEmitIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Token)
...
ASTEmitIL.Emit(OpCodes.Call, asm.GetType("dylan.NET.Tokenizer.CodeGen.Helpers").GetMethod("CommitEvalTTok", typ62))
...
Dim typ63(-1) As Type
ReDim Preserve typ63(UBound(typ63) + 1)
typ63(UBound(typ63)) = GetType(Expr)
Dim Evaluate As MethodBuilder = Evaluator.DefineMethod("Evaluate", MethodAttributes.Public, GetType(System.Void), typ63)
...
EvaluateIL.MarkSequencePoint(doc10, 320, 1, 320, 100)
Dim locbldr148 As LocalBuilder = EvaluateIL.DeclareLocal(GetType(System.Int32))
...
EvaluateIL.MarkSequencePoint(doc10, 322, 1, 322, 100)
Dim locbldr149 As LocalBuilder = EvaluateIL.DeclareLocal(GetType(Expr))
locbldr149.SetLocalSymInfo("rpnexp")
EvaluateIL.MarkSequencePoint(doc10, 324, 1, 324, 100)
EvaluateIL.Emit(OpCodes.Ldloc, 0)
Typ = GetType(System.Int32)
EvaluateIL.Emit(OpCodes.Ldc_I4, CInt(1))
Typ = GetType(System.Int32)
Dim fa106 As System.Reflection.Emit.Label = EvaluateIL.DefineLabel()
Dim tru106 As System.Reflection.Emit.Label = EvaluateIL.DefineLabel()
Dim cont106 As System.Reflection.Emit.Label = EvaluateIL.DefineLabel()
EvaluateIL.Emit(OpCodes.Beq, tru106)
EvaluateIL.Emit(OpCodes.Br, fa106)
EvaluateIL.MarkLabel(tru106)
EvaluateIL.MarkSequencePoint(doc10, 325, 1, 325, 100)
EvaluateIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Expr)
EvaluateIL.Emit(OpCodes.Stloc, 1)
EvaluateIL.MarkSequencePoint(doc10, 326, 1, 326, 100)
EvaluateIL.Emit(OpCodes.Br, cont106)
EvaluateIL.MarkLabel(fa106)
EvaluateIL.MarkSequencePoint(doc10, 327, 1, 327, 100)
EvaluateIL.Emit(OpCodes.Ldloc, 0)
Typ = GetType(System.Int32)
EvaluateIL.Emit(OpCodes.Ldc_I4, CInt(3))
Typ = GetType(System.Int32)
Dim fa107 As System.Reflection.Emit.Label = EvaluateIL.DefineLabel()
Dim tru107 As System.Reflection.Emit.Label = EvaluateIL.DefineLabel()
Dim cont107 As System.Reflection.Emit.Label = EvaluateIL.DefineLabel()
EvaluateIL.Emit(OpCodes.Bge, tru107)
EvaluateIL.Emit(OpCodes.Br, fa107)
EvaluateIL.MarkLabel(tru107)
EvaluateIL.MarkSequencePoint(doc10, 328, 1, 328, 100)
...
EvaluateIL.Emit(OpCodes.Stloc, 1)
EvaluateIL.MarkSequencePoint(doc10, 329, 1, 329, 100)
EvaluateIL.Emit(OpCodes.Br, cont107)
EvaluateIL.MarkLabel(fa107)
EvaluateIL.Emit(OpCodes.Br, cont107)
EvaluateIL.MarkLabel(cont107)
EvaluateIL.MarkSequencePoint(doc10, 330, 1, 330, 100)
EvaluateIL.Emit(OpCodes.Br, cont106)
EvaluateIL.MarkLabel(cont106)
EvaluateIL.MarkSequencePoint(doc10, 332, 1, 332, 100)
Dim locbldr150 As LocalBuilder = EvaluateIL.DeclareLocal(GetType(Token))
locbldr150.SetLocalSymInfo("asttok")
EvaluateIL.Emit(OpCodes.Ldarg_0)
Dim typ65(-1) As Type
...
EvaluateIL.MarkSequencePoint(doc10, 333, 1, 333, 100)
EvaluateIL.Emit(OpCodes.Ldarg_0)
Dim typ66(-1) As Type
...
End If
EvaluateIL.MarkSequencePoint(doc10, 334, 1, 334, 100)
EvaluateIL.Emit(OpCodes.Ldarg_0)
Dim typ67(-1) As Type
EvaluateIL.Emit(OpCodes.Ldloc, 2)
Typ = GetType(Token)
...
EvaluateIL.Emit(OpCodes.Pop)
End If
EvaluateIL.MarkSequencePoint(doc10, 336, 1, 336, 100)
...
Dim locbldr151 As LocalBuilder = ReadIL.DeclareLocal(GetType(System.Type))
locbldr151.SetLocalSymInfo("typ")
ReadIL.MarkSequencePoint(doc11, 14, 1, 14, 100)
Dim locbldr152 As LocalBuilder = ReadIL.DeclareLocal(GetType(System.Boolean))
locbldr152.SetLocalSymInfo("b")
...
Dim locbldr153 As LocalBuilder = ReadIL.DeclareLocal(GetType(RefasmStmt))
locbldr153.SetLocalSymInfo("rastm")
ReadIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
ReadIL.Emit(OpCodes.Stloc, 2)
ReadIL.MarkSequencePoint(doc11, 23, 1, 23, 100)
Dim locbldr154 As LocalBuilder = ReadIL.DeclareLocal(GetType(Token))
locbldr154.SetLocalSymInfo("ap")
...
Dim locbldr155 As LocalBuilder = ReadIL.DeclareLocal(GetType(System.String))
locbldr155.SetLocalSymInfo("tmpstr")
Dim typ3(-1) As Type
...
Dim locbldr156 As LocalBuilder = ReadIL.DeclareLocal(GetType(System.Boolean))
locbldr156.SetLocalSymInfo("compb")
Dim typ4(-1) As Type
...
Dim locbldr157 As LocalBuilder = ReadIL.DeclareLocal(GetType(System.Char).MakeArrayType())
locbldr157.SetLocalSymInfo("tmpchrarr")
...
Dim locbldr158 As LocalBuilder = ReadIL.DeclareLocal(GetType(Assembly))
locbldr158.SetLocalSymInfo("asm")
Dim typ7(-1) As Type
ReadIL.Emit(OpCodes.Ldloc, 3)
Typ = GetType(Token)
ReadIL.Emit(OpCodes.Ldfld, GetType(Token).GetField("Value"))
...
Dim locbldr159 As LocalBuilder = ReadIL.DeclareLocal(GetType(ImportStmt))
locbldr159.SetLocalSymInfo("istm")
ReadIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
ReadIL.Emit(OpCodes.Stloc, 8)
ReadIL.MarkSequencePoint(doc11, 48, 1, 48, 100)
Dim locbldr160 As LocalBuilder = ReadIL.DeclareLocal(GetType(Token))
locbldr160.SetLocalSymInfo("ina")
...
Dim locbldr161 As LocalBuilder = ReadIL.DeclareLocal(GetType(LocimportStmt))
locbldr161.SetLocalSymInfo("listm")
ReadIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
ReadIL.Emit(OpCodes.Stloc, 10)
ReadIL.MarkSequencePoint(doc11, 73, 1, 73, 100)
Dim locbldr162 As LocalBuilder = ReadIL.DeclareLocal(GetType(Token))
locbldr162.SetLocalSymInfo("lina")
...
Dim locbldr163 As LocalBuilder = ReadIL.DeclareLocal(GetType(AssemblyStmt))
locbldr163.SetLocalSymInfo("asms")
ReadIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
ReadIL.Emit(OpCodes.Stloc, 12)
ReadIL.MarkSequencePoint(doc11, 99, 1, 99, 100)
Dim locbldr164 As LocalBuilder = ReadIL.DeclareLocal(GetType(Ident))
locbldr164.SetLocalSymInfo("asmn")
...
Dim locbldr165 As LocalBuilder = ReadIL.DeclareLocal(GetType(Token))
locbldr165.SetLocalSymInfo("asmm")
ReadIL.Emit(OpCodes.Ldloc, 12)
Typ = GetType(AssemblyStmt)
...
Dim locbldr166 As LocalBuilder = ReadIL.DeclareLocal(GetType(VerStmt))
locbldr166.SetLocalSymInfo("asmv")
ReadIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
ReadIL.Emit(OpCodes.Stloc, 15)
ReadIL.MarkSequencePoint(doc11, 118, 1, 118, 100)
Dim locbldr167 As LocalBuilder = ReadIL.DeclareLocal(GetType(IntLiteral).MakeArrayType())
locbldr167.SetLocalSymInfo("vns")
...
Dim locbldr168 As LocalBuilder = ReadIL.DeclareLocal(GetType(IntLiteral))
locbldr168.SetLocalSymInfo("vne")
ReadIL.MarkSequencePoint(doc11, 120, 1, 120, 100)
Dim locbldr169 As LocalBuilder = ReadIL.DeclareLocal(GetType(System.Int32).MakeArrayType())
locbldr169.SetLocalSymInfo("vernos")
...
Dim locbldr170 As LocalBuilder = ReadIL.DeclareLocal(GetType(Version))
locbldr170.SetLocalSymInfo("asmver")
Dim typ36(-1) As Type
ReadIL.Emit(OpCodes.Ldloc, 18)
Typ = GetType(System.Int32).MakeArrayType()
Typ02 = Typ
...
Dim locbldr171 As LocalBuilder = ReadIL.DeclareLocal(GetType(AssemblyName))
locbldr171.SetLocalSymInfo("asmnm")
...
Dim locbldr172 As LocalBuilder = ReadIL.DeclareLocal(GetType(AppDomain))
locbldr172.SetLocalSymInfo("cad")
...
Dim locbldr173 As LocalBuilder = ReadIL.DeclareLocal(GetType(AssemblyBuilderAccess))
locbldr173.SetLocalSymInfo("aasv")
ReadIL.Emit(OpCodes.Ldc_I4, CInt(2))
Typ = GetType(System.Int32)
ReadIL.Emit(OpCodes.Stloc, 22)
ReadIL.MarkSequencePoint(doc11, 135, 1, 135, 100)
Dim locbldr174 As LocalBuilder = ReadIL.DeclareLocal(GetType(System.String))
locbldr174.SetLocalSymInfo("curd")
...
Dim locbldr175 As LocalBuilder = ReadIL.DeclareLocal(GetType(System.String))
locbldr175.SetLocalSymInfo("asmnme")
ReadIL.Emit(OpCodes.Ldloc, 20)
Typ = GetType(AssemblyName)
Typ03 = Typ
...
Dim locbldr176 As LocalBuilder = ReadIL.DeclareLocal(GetType(AssemblyBuilder))
locbldr176.SetLocalSymInfo("ab")
...
Dim locbldr177 As LocalBuilder = ReadIL.DeclareLocal(GetType(ModuleBuilder))
locbldr177.SetLocalSymInfo("mdlbldbg")
...
Dim locbldr178 As LocalBuilder = ReadIL.DeclareLocal(GetType(System.Type))
locbldr178.SetLocalSymInfo("dtyp")
...
Dim locbldr179 As LocalBuilder = ReadIL.DeclareLocal(GetType(DebuggableAttribute.DebuggingModes))
locbldr179.SetLocalSymInfo("debugattr")
ReadIL.Emit(OpCodes.Ldc_I4, CInt(1))
Typ = GetType(System.Int32)
...
Dim locbldr180 As LocalBuilder = ReadIL.DeclareLocal(GetType(System.Object))
locbldr180.SetLocalSymInfo("oattr")
...
Dim locbldr181 As LocalBuilder = ReadIL.DeclareLocal(GetType(System.Type))
locbldr181.SetLocalSymInfo("dattyp")
...
Dim locbldr182 As LocalBuilder = ReadIL.DeclareLocal(GetType(System.Type).MakeArrayType())
locbldr182.SetLocalSymInfo("tarr")
ReadIL.Emit(OpCodes.Ldc_I4, CInt(1))
Typ = GetType(System.Int32)
ReadIL.Emit(OpCodes.Conv_U)
...
Dim locbldr183 As LocalBuilder = ReadIL.DeclareLocal(GetType(ConstructorInfo))
locbldr183.SetLocalSymInfo("dctor")
Dim typ45(-1) As Type
...
Dim locbldr184 As LocalBuilder = ReadIL.DeclareLocal(GetType(System.Object).MakeArrayType())
locbldr184.SetLocalSymInfo("oarr")
ReadIL.Emit(OpCodes.Ldc_I4, CInt(1))
Typ = GetType(System.Int32)
ReadIL.Emit(OpCodes.Conv_U)
...
Dim locbldr185 As LocalBuilder = ReadIL.DeclareLocal(GetType(CustomAttributeBuilder))
locbldr185.SetLocalSymInfo("dbuilder")
Dim typ46(-1) As Type
...
Dim locbldr186 As LocalBuilder = ReadIL.DeclareLocal(GetType(DebugStmt))
...
Dim locbldr187 As LocalBuilder = ReadIL.DeclareLocal(GetType(ClassStmt))
locbldr187.SetLocalSymInfo("clss")
ReadIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
...
Dim locbldr188 As LocalBuilder = ReadIL.DeclareLocal(GetType(Attributes.Attribute).MakeArrayType())
locbldr188.SetLocalSymInfo("attrs")
...
Dim locbldr189 As LocalBuilder = ReadIL.DeclareLocal(GetType(TypeAttributes))
locbldr189.SetLocalSymInfo("ta")
Dim typ53(-1) As Type
...
locbldr190.SetLocalSymInfo("clssnam")
ReadIL.Emit(OpCodes.Ldloc, 36)
Typ = GetType(ClassStmt)
...
Dim locbldr191 As LocalBuilder = ReadIL.DeclareLocal(GetType(System.String))
locbldr191.SetLocalSymInfo("clsnamstr")
...
Dim locbldr192 As LocalBuilder = ReadIL.DeclareLocal(GetType(TypeTok))
locbldr192.SetLocalSymInfo("inhclstok")
ReadIL.Emit(OpCodes.Ldloc, 36)
Typ = GetType(ClassStmt)
...
Dim locbldr193 As LocalBuilder = ReadIL.DeclareLocal(GetType(System.Type))
locbldr193.SetLocalSymInfo("inhtyp")
ReadIL.Emit(OpCodes.Ldnull)
ReadIL.Emit(OpCodes.Stloc, 42)
ReadIL.MarkSequencePoint(doc11, 198, 1, 198, 100)
Dim locbldr194 As LocalBuilder = ReadIL.DeclareLocal(GetType(System.Type))
locbldr194.SetLocalSymInfo("reft")
...
Dim locbldr195 As LocalBuilder = ReadIL.DeclareLocal(GetType(System.Int32))
locbldr195.SetLocalSymInfo("cmp")
Dim typ54(-1) As Type
ReadIL.Emit(OpCodes.Ldloc, 41)
Typ = GetType(TypeTok)
...
Dim locbldr196 As LocalBuilder = ReadIL.DeclareLocal(GetType(ModuleBuilder))
locbldr196.SetLocalSymInfo("mdlbld")
ReadIL.Emit(OpCodes.Ldsfld, GetType(AsmFactory).GetField("MdlB"))
Typ = GetType(AsmFactory).GetField("MdlB").FieldType
...
Dim locbldr197 As LocalBuilder = ReadIL.DeclareLocal(GetType(TypeBuilder))
locbldr197.SetLocalSymInfo("ctb2")
...
Dim locbldr198 As LocalBuilder = ReadIL.DeclareLocal(GetType(FieldStmt))
locbldr198.SetLocalSymInfo("flss")
ReadIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
ReadIL.Emit(OpCodes.Stloc, 47)
ReadIL.MarkSequencePoint(doc11, 236, 1, 236, 100)
Dim locbldr199 As LocalBuilder = ReadIL.DeclareLocal(GetType(Attributes.Attribute).MakeArrayType())
locbldr199.SetLocalSymInfo("fattrs")
...
Dim locbldr200 As LocalBuilder = ReadIL.DeclareLocal(GetType(FieldAttributes))
locbldr200.SetLocalSymInfo("fa")
Dim typ66(-1) As Type
...
Dim locbldr201 As LocalBuilder = ReadIL.DeclareLocal(GetType(Ident))
locbldr201.SetLocalSymInfo("flssnam")
ReadIL.Emit(OpCodes.Ldloc, 47)
Typ = GetType(FieldStmt)
...
Dim locbldr202 As LocalBuilder = ReadIL.DeclareLocal(GetType(System.String))
locbldr202.SetLocalSymInfo("flsnamstr")
...
Dim locbldr203 As LocalBuilder = ReadIL.DeclareLocal(GetType(TypeTok))
locbldr203.SetLocalSymInfo("ftyptok")
ReadIL.Emit(OpCodes.Ldloc, 47)
Typ = GetType(FieldStmt)
...
locbldr204.SetLocalSymInfo("ftyp")
ReadIL.Emit(OpCodes.Ldnull)
...
Dim locbldr205 As LocalBuilder = ReadIL.DeclareLocal(GetType(TypeBuilder))
locbldr205.SetLocalSymInfo("typb2")
ReadIL.Emit(OpCodes.Ldsfld, GetType(AsmFactory).GetField("CurnTypB"))
Typ = GetType(AsmFactory).GetField("CurnTypB").FieldType
...
Dim locbldr206 As LocalBuilder = ReadIL.DeclareLocal(GetType(MethodStmt))
locbldr206.SetLocalSymInfo("mtss")
ReadIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
...
Dim locbldr207 As LocalBuilder = ReadIL.DeclareLocal(GetType(Attributes.Attribute).MakeArrayType())
locbldr207.SetLocalSymInfo("mattrs")
...
Dim locbldr208 As LocalBuilder = ReadIL.DeclareLocal(GetType(MethodAttributes))
locbldr208.SetLocalSymInfo("ma")
Dim typ77(-1) As Type
...
Dim locbldr209 As LocalBuilder = ReadIL.DeclareLocal(GetType(Ident))
locbldr209.SetLocalSymInfo("mtssnam")
ReadIL.Emit(OpCodes.Ldloc, 55)
Typ = GetType(MethodStmt)
...
Dim locbldr210 As LocalBuilder = ReadIL.DeclareLocal(GetType(System.String))
locbldr210.SetLocalSymInfo("mtssnamstr")
...
Dim locbldr211 As LocalBuilder = ReadIL.DeclareLocal(GetType(Expr).MakeArrayType())
locbldr211.SetLocalSymInfo("paramarr")
ReadIL.Emit(OpCodes.Ldloc, 55)
Typ = GetType(MethodStmt)
...
Dim locbldr212 As LocalBuilder = ReadIL.DeclareLocal(GetType(System.Int32))
locbldr212.SetLocalSymInfo("paramlen")
...
Dim locbldr213 As LocalBuilder = ReadIL.DeclareLocal(GetType(TypeTok))
locbldr213.SetLocalSymInfo("rettyptok")
ReadIL.Emit(OpCodes.Ldloc, 55)
Typ = GetType(MethodStmt)
...
Dim locbldr214 As LocalBuilder = ReadIL.DeclareLocal(GetType(System.Type))
locbldr214.SetLocalSymInfo("rettyp")
ReadIL.Emit(OpCodes.Ldnull)
...
Dim locbldr215 As LocalBuilder = ReadIL.DeclareLocal(GetType(TypeBuilder))
locbldr215.SetLocalSymInfo("typb")
ReadIL.Emit(OpCodes.Ldsfld, GetType(AsmFactory).GetField("CurnTypB"))
Typ = GetType(AsmFactory).GetField("CurnTypB").FieldType
...
locbldr216.SetLocalSymInfo("isconstr")
Dim typ80(-1) As Type
...
Dim locbldr217 As LocalBuilder = ReadIL.DeclareLocal(GetType(CallingConventions))
locbldr217.SetLocalSymInfo("stdcallconv")
ReadIL.Emit(OpCodes.Ldc_I4, CInt(1))
Typ = GetType(System.Int32)
...
Dim locbldr218 As LocalBuilder = ReadIL.DeclareLocal(GetType(System.Int32))
locbldr218.SetLocalSymInfo("mnamcomp")
Dim typ95(-1) As Type
...
Dim locbldr219 As LocalBuilder = ReadIL.DeclareLocal(GetType(System.Int32))
locbldr219.SetLocalSymInfo("amodecomp")
Dim typ96(-1) As Type
ReadIL.Emit(OpCodes.Ldsfld, GetType(AsmFactory).GetField("AsmMode"))
Typ = GetType(AsmFactory).GetField("AsmMode").FieldType
...
Dim locbldr220 As LocalBuilder = ReadIL.DeclareLocal(GetType(Ident))
locbldr220.SetLocalSymInfo("vnam")
ReadIL.MarkSequencePoint(doc11, 399, 1, 399, 100)
Dim locbldr221 As LocalBuilder = ReadIL.DeclareLocal(GetType(TypeTok))
locbldr221.SetLocalSymInfo("vtyptok")
ReadIL.MarkSequencePoint(doc11, 400, 1, 400, 100)
Dim locbldr222 As LocalBuilder = ReadIL.DeclareLocal(GetType(System.Type))
locbldr222.SetLocalSymInfo("vtyp")
ReadIL.Emit(OpCodes.Ldnull)
ReadIL.Emit(OpCodes.Stloc, 71)
ReadIL.MarkSequencePoint(doc11, 401, 1, 401, 100)
Dim locbldr223 As LocalBuilder = ReadIL.DeclareLocal(asm.GetType("dylan.NET.Tokenizer.CodeGen.Evaluator"))
locbldr223.SetLocalSymInfo("eval")
ReadIL.Emit(OpCodes.Ldnull)
...
Dim locbldr224 As LocalBuilder = ReadIL.DeclareLocal(GetType(VarStmt))
locbldr224.SetLocalSymInfo("curv")
ReadIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
...
Dim locbldr225 As LocalBuilder = ReadIL.DeclareLocal(GetType(VarAsgnStmt))
locbldr225.SetLocalSymInfo("curva")
ReadIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
...
Dim locbldr226 As LocalBuilder = ReadIL.DeclareLocal(GetType(AssignStmt))
locbldr226.SetLocalSymInfo("asgnstm")
ReadIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
...
Dim locbldr227 As LocalBuilder = EmitMSILIL.DeclareLocal(GetType(System.Int32))
...
Dim locbldr228 As LocalBuilder = EmitMSILIL.DeclareLocal(GetType(System.Int32))
...
Dim locbldr229 As LocalBuilder = EmitMSILIL.DeclareLocal(GetType(Stmt))
locbldr229.SetLocalSymInfo("stm")
EmitMSILIL.Emit(OpCodes.Ldnull)
EmitMSILIL.Emit(OpCodes.Stloc, 2)
EmitMSILIL.MarkSequencePoint(doc12, 16, 1, 16, 100)
Dim locbldr230 As LocalBuilder = EmitMSILIL.DeclareLocal(GetType(System.Type))
locbldr230.SetLocalSymInfo("typ")
EmitMSILIL.MarkSequencePoint(doc12, 17, 1, 17, 100)
Dim locbldr231 As LocalBuilder = EmitMSILIL.DeclareLocal(GetType(System.Boolean))
locbldr231.SetLocalSymInfo("b")
...
Typ = GetType(System.Boolean)
Dim fa143 As System.Reflection.Emit.Label = EmitMSILIL.DefineLabel()
Dim tru143 As System.Reflection.Emit.Label = EmitMSILIL.DefineLabel()
Dim cont143 As System.Reflection.Emit.Label = EmitMSILIL.DefineLabel()
EmitMSILIL.Emit(OpCodes.Beq, tru143)
EmitMSILIL.Emit(OpCodes.Br, fa143)
EmitMSILIL.MarkLabel(tru143)
EmitMSILIL.MarkSequencePoint(doc12, 31, 1, 31, 100)
EmitMSILIL.Emit(OpCodes.Br, cont143)
EmitMSILIL.MarkLabel(fa143)
EmitMSILIL.MarkSequencePoint(doc12, 33, 1, 33, 100)
Dim locbldr232 As LocalBuilder = EmitMSILIL.DeclareLocal(asm.GetType("dylan.NET.Tokenizer.CodeGen.StmtReader"))
locbldr232.SetLocalSymInfo("sr")
...
EmitMSILIL.Emit(OpCodes.Br, cont143)
EmitMSILIL.MarkLabel(cont143)
EmitMSILIL.MarkSequencePoint(doc12, 38, 1, 38, 100)
EmitMSILIL.Emit(OpCodes.Ldloc, 0)
Typ = GetType(System.Int32)
EmitMSILIL.Emit(OpCodes.Ldloc, 1)
Typ = GetType(System.Int32)
Dim fa144 As System.Reflection.Emit.Label = EmitMSILIL.DefineLabel()
Dim tru144 As System.Reflection.Emit.Label = EmitMSILIL.DefineLabel()
Dim cont144 As System.Reflection.Emit.Label = EmitMSILIL.DefineLabel()
EmitMSILIL.Emit(OpCodes.Beq, tru144)
EmitMSILIL.Emit(OpCodes.Br, fa144)
EmitMSILIL.MarkLabel(tru144)
...
Dim locbldr233 As LocalBuilder = EmitMSILIL.DeclareLocal(GetType(AssemblyBuilder))
locbldr233.SetLocalSymInfo("ab")
...
EmitMSILIL.Emit(OpCodes.Br, cont144)
EmitMSILIL.MarkLabel(fa144)
