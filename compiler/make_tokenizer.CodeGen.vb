...
Dim locbldr147 As LocalBuilder = ASTEmitIL.DeclareLocal(GetType(StringLiteral))
locbldr147.SetLocalSymInfo("slit")
ASTEmitIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Token)
...
ReDim Preserve typ63(UBound(typ63) + 1)
typ63(UBound(typ63)) = Typ
ASTEmitIL.Emit(OpCodes.Call, asm.GetType("dylan.NET.Tokenizer.CodeGen.Helpers").GetMethod("CommitEvalTTok", typ63))
Typ = asm.GetType("dylan.NET.Tokenizer.CodeGen.Helpers").GetMethod("CommitEvalTTok", typ63).ReturnType
ASTEmitIL.Emit(OpCodes.Stsfld, GetType(AsmFactory).GetField("Type02"))
...
Dim locbldr148 As LocalBuilder = ASTEmitIL.DeclareLocal(GetType(Literal))
locbldr148.SetLocalSymInfo("lit")
ASTEmitIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Token)
...
Dim locbldr149 As LocalBuilder = ASTEmitIL.DeclareLocal(GetType(System.Type))
locbldr149.SetLocalSymInfo("mcparenttyp")
ASTEmitIL.MarkSequencePoint(doc10, 334, 1, 334, 100)
Dim locbldr150 As LocalBuilder = ASTEmitIL.DeclareLocal(GetType(MethodCallTok))
locbldr150.SetLocalSymInfo("mctok")
ASTEmitIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Token)
ASTEmitIL.Emit(OpCodes.Stloc, 10)
ASTEmitIL.MarkSequencePoint(doc10, 335, 1, 335, 100)
Dim locbldr151 As LocalBuilder = ASTEmitIL.DeclareLocal(GetType(MethodNameTok))
locbldr151.SetLocalSymInfo("mntok")
...
Dim locbldr152 As LocalBuilder = ASTEmitIL.DeclareLocal(GetType(System.String))
locbldr152.SetLocalSymInfo("mnstr")
ASTEmitIL.Emit(OpCodes.Ldstr, "")
Typ = GetType(System.String)
ASTEmitIL.Emit(OpCodes.Stloc, 12)
ASTEmitIL.MarkSequencePoint(doc10, 337, 1, 337, 100)
Dim locbldr153 As LocalBuilder = ASTEmitIL.DeclareLocal(GetType(System.String).MakeArrayType())
locbldr153.SetLocalSymInfo("mnstrarr")
ASTEmitIL.MarkSequencePoint(doc10, 338, 1, 338, 100)
Dim locbldr154 As LocalBuilder = ASTEmitIL.DeclareLocal(GetType(Expr).MakeArrayType())
locbldr154.SetLocalSymInfo("mcparams")
ASTEmitIL.MarkSequencePoint(doc10, 339, 1, 339, 100)
Dim locbldr155 As LocalBuilder = ASTEmitIL.DeclareLocal(GetType(System.Type).MakeArrayType())
locbldr155.SetLocalSymInfo("typarr1")
...
Dim locbldr156 As LocalBuilder = ASTEmitIL.DeclareLocal(GetType(System.Type).MakeArrayType())
locbldr156.SetLocalSymInfo("typarr2")
...
locbldr157.SetLocalSymInfo("paramlen")
...
locbldr158.SetLocalSymInfo("i")
ASTEmitIL.Emit(OpCodes.Ldc_I4, CInt(-1))
Typ = GetType(System.Int32)
ASTEmitIL.Emit(OpCodes.Stloc, 18)
ASTEmitIL.MarkSequencePoint(doc10, 343, 1, 343, 100)
Dim locbldr159 As LocalBuilder = ASTEmitIL.DeclareLocal(GetType(Expr))
locbldr159.SetLocalSymInfo("curexpr")
ASTEmitIL.MarkSequencePoint(doc10, 344, 1, 344, 100)
Dim locbldr160 As LocalBuilder = ASTEmitIL.DeclareLocal(GetType(Expr))
locbldr160.SetLocalSymInfo("rpnparam")
ASTEmitIL.MarkSequencePoint(doc10, 345, 1, 345, 100)
Dim locbldr161 As LocalBuilder = ASTEmitIL.DeclareLocal(GetType(Token))
locbldr161.SetLocalSymInfo("astparam")
ASTEmitIL.MarkSequencePoint(doc10, 346, 1, 346, 100)
Dim locbldr162 As LocalBuilder = ASTEmitIL.DeclareLocal(GetType(MethodInfo))
locbldr162.SetLocalSymInfo("mcmetinf")
...
ASTEmitIL.Emit(OpCodes.Beq, tru110)
ASTEmitIL.Emit(OpCodes.Br, fa110)
...
ReDim Preserve typ70(UBound(typ70) + 1)
typ70(UBound(typ70)) = Typ
ASTEmitIL.Emit(OpCodes.Call, GetType(ParseUtils).GetMethod("StringParser", typ70))
Typ = GetType(ParseUtils).GetMethod("StringParser", typ70).ReturnType
...
ASTEmitIL.MarkSequencePoint(doc10, 358, 1, 358, 100)
...
ASTEmitIL.Emit(OpCodes.Bge, tru113)
...
ASTEmitIL.Emit(OpCodes.Call, GetType(AsmFactory).GetMethod("AddTyp", typ74))
Typ = GetType(AsmFactory).GetMethod("AddTyp", typ74).ReturnType
If Typ.ToString() = GetType(System.Void).ToString() Then
...
ReDim Preserve typ75(UBound(typ75) + 1)
typ75(UBound(typ75)) = Typ
ASTEmitIL.Emit(OpCodes.Call, GetType(Loader).GetMethod("LoadMethod", typ75))
Typ = GetType(Loader).GetMethod("LoadMethod", typ75).ReturnType
...
typ78(UBound(typ78)) = GetType(Expr)
Dim Evaluate As MethodBuilder = Evaluator.DefineMethod("Evaluate", MethodAttributes.Public, GetType(System.Void), typ78)
...
EvaluateIL.MarkSequencePoint(doc10, 413, 1, 413, 100)
Dim locbldr163 As LocalBuilder = EvaluateIL.DeclareLocal(GetType(System.Int32))
...
EvaluateIL.MarkSequencePoint(doc10, 415, 1, 415, 100)
Dim locbldr164 As LocalBuilder = EvaluateIL.DeclareLocal(GetType(Expr))
locbldr164.SetLocalSymInfo("rpnexp")
EvaluateIL.MarkSequencePoint(doc10, 417, 1, 417, 100)
EvaluateIL.Emit(OpCodes.Ldloc, 0)
Typ = GetType(System.Int32)
EvaluateIL.Emit(OpCodes.Ldc_I4, CInt(1))
Typ = GetType(System.Int32)
Dim fa115 As System.Reflection.Emit.Label = EvaluateIL.DefineLabel()
Dim tru115 As System.Reflection.Emit.Label = EvaluateIL.DefineLabel()
Dim cont115 As System.Reflection.Emit.Label = EvaluateIL.DefineLabel()
EvaluateIL.Emit(OpCodes.Beq, tru115)
EvaluateIL.Emit(OpCodes.Br, fa115)
EvaluateIL.MarkLabel(tru115)
EvaluateIL.MarkSequencePoint(doc10, 418, 1, 418, 100)
EvaluateIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Expr)
EvaluateIL.Emit(OpCodes.Stloc, 1)
EvaluateIL.MarkSequencePoint(doc10, 419, 1, 419, 100)
EvaluateIL.Emit(OpCodes.Br, cont115)
EvaluateIL.MarkLabel(fa115)
EvaluateIL.MarkSequencePoint(doc10, 420, 1, 420, 100)
EvaluateIL.Emit(OpCodes.Ldloc, 0)
Typ = GetType(System.Int32)
EvaluateIL.Emit(OpCodes.Ldc_I4, CInt(3))
Typ = GetType(System.Int32)
Dim fa116 As System.Reflection.Emit.Label = EvaluateIL.DefineLabel()
Dim tru116 As System.Reflection.Emit.Label = EvaluateIL.DefineLabel()
Dim cont116 As System.Reflection.Emit.Label = EvaluateIL.DefineLabel()
EvaluateIL.Emit(OpCodes.Bge, tru116)
EvaluateIL.Emit(OpCodes.Br, fa116)
EvaluateIL.MarkLabel(tru116)
EvaluateIL.MarkSequencePoint(doc10, 421, 1, 421, 100)
...
Typ = ConvToRPN.ReturnType
EvaluateIL.Emit(OpCodes.Stloc, 1)
EvaluateIL.MarkSequencePoint(doc10, 422, 1, 422, 100)
EvaluateIL.Emit(OpCodes.Br, cont116)
EvaluateIL.MarkLabel(fa116)
EvaluateIL.Emit(OpCodes.Br, cont116)
EvaluateIL.MarkLabel(cont116)
EvaluateIL.MarkSequencePoint(doc10, 423, 1, 423, 100)
EvaluateIL.Emit(OpCodes.Br, cont115)
EvaluateIL.MarkLabel(cont115)
EvaluateIL.MarkSequencePoint(doc10, 425, 1, 425, 100)
Dim locbldr165 As LocalBuilder = EvaluateIL.DeclareLocal(GetType(Token))
locbldr165.SetLocalSymInfo("asttok")
EvaluateIL.Emit(OpCodes.Ldarg_0)
Dim typ80(-1) As Type
...
EvaluateIL.MarkSequencePoint(doc10, 426, 1, 426, 100)
EvaluateIL.Emit(OpCodes.Ldarg_0)
Dim typ81(-1) As Type
...
End If
EvaluateIL.MarkSequencePoint(doc10, 427, 1, 427, 100)
EvaluateIL.Emit(OpCodes.Ldarg_0)
Dim typ82(-1) As Type
EvaluateIL.Emit(OpCodes.Ldloc, 2)
Typ = GetType(Token)
...
EvaluateIL.Emit(OpCodes.Pop)
End If
EvaluateIL.MarkSequencePoint(doc10, 429, 1, 429, 100)
...
Dim locbldr167 As LocalBuilder = ReadIL.DeclareLocal(GetType(System.Boolean))
...
Dim locbldr168 As LocalBuilder = ReadIL.DeclareLocal(GetType(RefasmStmt))
locbldr168.SetLocalSymInfo("rastm")
ReadIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
ReadIL.Emit(OpCodes.Stloc, 2)
ReadIL.MarkSequencePoint(doc11, 23, 1, 23, 100)
Dim locbldr169 As LocalBuilder = ReadIL.DeclareLocal(GetType(Token))
locbldr169.SetLocalSymInfo("ap")
...
Dim locbldr170 As LocalBuilder = ReadIL.DeclareLocal(GetType(System.String))
locbldr170.SetLocalSymInfo("tmpstr")
Dim typ3(-1) As Type
...
Dim locbldr171 As LocalBuilder = ReadIL.DeclareLocal(GetType(System.Boolean))
locbldr171.SetLocalSymInfo("compb")
Dim typ4(-1) As Type
...
Dim locbldr172 As LocalBuilder = ReadIL.DeclareLocal(GetType(System.Char).MakeArrayType())
locbldr172.SetLocalSymInfo("tmpchrarr")
...
Dim locbldr173 As LocalBuilder = ReadIL.DeclareLocal(GetType(Assembly))
locbldr173.SetLocalSymInfo("asm")
Dim typ7(-1) As Type
ReadIL.Emit(OpCodes.Ldloc, 3)
Typ = GetType(Token)
ReadIL.Emit(OpCodes.Ldfld, GetType(Token).GetField("Value"))
...
Dim locbldr174 As LocalBuilder = ReadIL.DeclareLocal(GetType(ImportStmt))
locbldr174.SetLocalSymInfo("istm")
ReadIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
ReadIL.Emit(OpCodes.Stloc, 8)
ReadIL.MarkSequencePoint(doc11, 48, 1, 48, 100)
Dim locbldr175 As LocalBuilder = ReadIL.DeclareLocal(GetType(Token))
locbldr175.SetLocalSymInfo("ina")
...
Dim locbldr176 As LocalBuilder = ReadIL.DeclareLocal(GetType(LocimportStmt))
locbldr176.SetLocalSymInfo("listm")
ReadIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
ReadIL.Emit(OpCodes.Stloc, 10)
ReadIL.MarkSequencePoint(doc11, 73, 1, 73, 100)
Dim locbldr177 As LocalBuilder = ReadIL.DeclareLocal(GetType(Token))
locbldr177.SetLocalSymInfo("lina")
...
Dim locbldr178 As LocalBuilder = ReadIL.DeclareLocal(GetType(AssemblyStmt))
locbldr178.SetLocalSymInfo("asms")
ReadIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
ReadIL.Emit(OpCodes.Stloc, 12)
ReadIL.MarkSequencePoint(doc11, 99, 1, 99, 100)
Dim locbldr179 As LocalBuilder = ReadIL.DeclareLocal(GetType(Ident))
locbldr179.SetLocalSymInfo("asmn")
...
locbldr180.SetLocalSymInfo("asmm")
ReadIL.Emit(OpCodes.Ldloc, 12)
Typ = GetType(AssemblyStmt)
...
Dim locbldr181 As LocalBuilder = ReadIL.DeclareLocal(GetType(VerStmt))
locbldr181.SetLocalSymInfo("asmv")
ReadIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
ReadIL.Emit(OpCodes.Stloc, 15)
ReadIL.MarkSequencePoint(doc11, 118, 1, 118, 100)
Dim locbldr182 As LocalBuilder = ReadIL.DeclareLocal(GetType(IntLiteral).MakeArrayType())
locbldr182.SetLocalSymInfo("vns")
...
Dim locbldr183 As LocalBuilder = ReadIL.DeclareLocal(GetType(IntLiteral))
locbldr183.SetLocalSymInfo("vne")
ReadIL.MarkSequencePoint(doc11, 120, 1, 120, 100)
Dim locbldr184 As LocalBuilder = ReadIL.DeclareLocal(GetType(System.Int32).MakeArrayType())
locbldr184.SetLocalSymInfo("vernos")
...
Dim locbldr185 As LocalBuilder = ReadIL.DeclareLocal(GetType(Version))
locbldr185.SetLocalSymInfo("asmver")
Dim typ36(-1) As Type
ReadIL.Emit(OpCodes.Ldloc, 18)
Typ = GetType(System.Int32).MakeArrayType()
Typ02 = Typ
...
Dim locbldr186 As LocalBuilder = ReadIL.DeclareLocal(GetType(AssemblyName))
locbldr186.SetLocalSymInfo("asmnm")
...
Dim locbldr187 As LocalBuilder = ReadIL.DeclareLocal(GetType(AppDomain))
locbldr187.SetLocalSymInfo("cad")
...
Dim locbldr188 As LocalBuilder = ReadIL.DeclareLocal(GetType(AssemblyBuilderAccess))
locbldr188.SetLocalSymInfo("aasv")
ReadIL.Emit(OpCodes.Ldc_I4, CInt(2))
Typ = GetType(System.Int32)
ReadIL.Emit(OpCodes.Stloc, 22)
ReadIL.MarkSequencePoint(doc11, 135, 1, 135, 100)
Dim locbldr189 As LocalBuilder = ReadIL.DeclareLocal(GetType(System.String))
locbldr189.SetLocalSymInfo("curd")
...
Dim locbldr190 As LocalBuilder = ReadIL.DeclareLocal(GetType(System.String))
locbldr190.SetLocalSymInfo("asmnme")
ReadIL.Emit(OpCodes.Ldloc, 20)
Typ = GetType(AssemblyName)
Typ03 = Typ
...
Dim locbldr191 As LocalBuilder = ReadIL.DeclareLocal(GetType(AssemblyBuilder))
locbldr191.SetLocalSymInfo("ab")
...
Dim locbldr192 As LocalBuilder = ReadIL.DeclareLocal(GetType(ModuleBuilder))
locbldr192.SetLocalSymInfo("mdlbldbg")
...
locbldr193.SetLocalSymInfo("dtyp")
...
Dim locbldr194 As LocalBuilder = ReadIL.DeclareLocal(GetType(DebuggableAttribute.DebuggingModes))
locbldr194.SetLocalSymInfo("debugattr")
ReadIL.Emit(OpCodes.Ldc_I4, CInt(1))
Typ = GetType(System.Int32)
...
Dim locbldr195 As LocalBuilder = ReadIL.DeclareLocal(GetType(System.Object))
locbldr195.SetLocalSymInfo("oattr")
...
Dim locbldr196 As LocalBuilder = ReadIL.DeclareLocal(GetType(System.Type))
locbldr196.SetLocalSymInfo("dattyp")
...
Dim locbldr197 As LocalBuilder = ReadIL.DeclareLocal(GetType(System.Type).MakeArrayType())
locbldr197.SetLocalSymInfo("tarr")
ReadIL.Emit(OpCodes.Ldc_I4, CInt(1))
Typ = GetType(System.Int32)
ReadIL.Emit(OpCodes.Conv_U)
...
Dim locbldr198 As LocalBuilder = ReadIL.DeclareLocal(GetType(ConstructorInfo))
locbldr198.SetLocalSymInfo("dctor")
Dim typ45(-1) As Type
...
Dim locbldr199 As LocalBuilder = ReadIL.DeclareLocal(GetType(System.Object).MakeArrayType())
locbldr199.SetLocalSymInfo("oarr")
ReadIL.Emit(OpCodes.Ldc_I4, CInt(1))
Typ = GetType(System.Int32)
ReadIL.Emit(OpCodes.Conv_U)
...
Dim locbldr200 As LocalBuilder = ReadIL.DeclareLocal(GetType(CustomAttributeBuilder))
locbldr200.SetLocalSymInfo("dbuilder")
Dim typ46(-1) As Type
...
Dim locbldr201 As LocalBuilder = ReadIL.DeclareLocal(GetType(DebugStmt))
locbldr201.SetLocalSymInfo("dbgs")
ReadIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
...
Dim locbldr202 As LocalBuilder = ReadIL.DeclareLocal(GetType(ClassStmt))
locbldr202.SetLocalSymInfo("clss")
ReadIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
...
Dim locbldr203 As LocalBuilder = ReadIL.DeclareLocal(GetType(Attributes.Attribute).MakeArrayType())
locbldr203.SetLocalSymInfo("attrs")
...
Dim locbldr204 As LocalBuilder = ReadIL.DeclareLocal(GetType(TypeAttributes))
locbldr204.SetLocalSymInfo("ta")
Dim typ53(-1) As Type
...
Dim locbldr205 As LocalBuilder = ReadIL.DeclareLocal(GetType(Ident))
locbldr205.SetLocalSymInfo("clssnam")
ReadIL.Emit(OpCodes.Ldloc, 36)
Typ = GetType(ClassStmt)
...
Dim locbldr206 As LocalBuilder = ReadIL.DeclareLocal(GetType(System.String))
locbldr206.SetLocalSymInfo("clsnamstr")
...
locbldr207.SetLocalSymInfo("inhclstok")
ReadIL.Emit(OpCodes.Ldloc, 36)
Typ = GetType(ClassStmt)
...
locbldr208.SetLocalSymInfo("inhtyp")
ReadIL.Emit(OpCodes.Ldnull)
ReadIL.Emit(OpCodes.Stloc, 42)
ReadIL.MarkSequencePoint(doc11, 198, 1, 198, 100)
Dim locbldr209 As LocalBuilder = ReadIL.DeclareLocal(GetType(System.Type))
locbldr209.SetLocalSymInfo("reft")
...
locbldr210.SetLocalSymInfo("cmp")
Dim typ54(-1) As Type
ReadIL.Emit(OpCodes.Ldloc, 41)
Typ = GetType(TypeTok)
...
Dim locbldr211 As LocalBuilder = ReadIL.DeclareLocal(GetType(ModuleBuilder))
locbldr211.SetLocalSymInfo("mdlbld")
ReadIL.Emit(OpCodes.Ldsfld, GetType(AsmFactory).GetField("MdlB"))
Typ = GetType(AsmFactory).GetField("MdlB").FieldType
...
Dim locbldr212 As LocalBuilder = ReadIL.DeclareLocal(GetType(TypeBuilder))
locbldr212.SetLocalSymInfo("ctb2")
...
Dim locbldr213 As LocalBuilder = ReadIL.DeclareLocal(GetType(FieldStmt))
locbldr213.SetLocalSymInfo("flss")
ReadIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
...
locbldr214.SetLocalSymInfo("fattrs")
...
Dim locbldr215 As LocalBuilder = ReadIL.DeclareLocal(GetType(FieldAttributes))
locbldr215.SetLocalSymInfo("fa")
Dim typ66(-1) As Type
...
locbldr216.SetLocalSymInfo("flssnam")
ReadIL.Emit(OpCodes.Ldloc, 47)
Typ = GetType(FieldStmt)
...
locbldr217.SetLocalSymInfo("flsnamstr")
...
locbldr218.SetLocalSymInfo("ftyptok")
ReadIL.Emit(OpCodes.Ldloc, 47)
Typ = GetType(FieldStmt)
...
locbldr219.SetLocalSymInfo("ftyp")
ReadIL.Emit(OpCodes.Ldnull)
...
Dim locbldr220 As LocalBuilder = ReadIL.DeclareLocal(GetType(TypeBuilder))
locbldr220.SetLocalSymInfo("typb2")
ReadIL.Emit(OpCodes.Ldsfld, GetType(AsmFactory).GetField("CurnTypB"))
Typ = GetType(AsmFactory).GetField("CurnTypB").FieldType
...
Dim locbldr221 As LocalBuilder = ReadIL.DeclareLocal(GetType(MethodStmt))
locbldr221.SetLocalSymInfo("mtss")
ReadIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
...
Dim locbldr222 As LocalBuilder = ReadIL.DeclareLocal(GetType(Attributes.Attribute).MakeArrayType())
locbldr222.SetLocalSymInfo("mattrs")
...
Dim locbldr223 As LocalBuilder = ReadIL.DeclareLocal(GetType(MethodAttributes))
locbldr223.SetLocalSymInfo("ma")
Dim typ77(-1) As Type
...
Dim locbldr224 As LocalBuilder = ReadIL.DeclareLocal(GetType(Ident))
locbldr224.SetLocalSymInfo("mtssnam")
ReadIL.Emit(OpCodes.Ldloc, 55)
Typ = GetType(MethodStmt)
...
Dim locbldr225 As LocalBuilder = ReadIL.DeclareLocal(GetType(System.String))
locbldr225.SetLocalSymInfo("mtssnamstr")
...
Dim locbldr226 As LocalBuilder = ReadIL.DeclareLocal(GetType(Expr).MakeArrayType())
locbldr226.SetLocalSymInfo("paramarr")
ReadIL.Emit(OpCodes.Ldloc, 55)
Typ = GetType(MethodStmt)
...
Dim locbldr227 As LocalBuilder = ReadIL.DeclareLocal(GetType(System.Int32))
locbldr227.SetLocalSymInfo("paramlen")
...
Dim locbldr228 As LocalBuilder = ReadIL.DeclareLocal(GetType(TypeTok))
locbldr228.SetLocalSymInfo("rettyptok")
ReadIL.Emit(OpCodes.Ldloc, 55)
Typ = GetType(MethodStmt)
...
Dim locbldr229 As LocalBuilder = ReadIL.DeclareLocal(GetType(System.Type))
locbldr229.SetLocalSymInfo("rettyp")
ReadIL.Emit(OpCodes.Ldnull)
...
Dim locbldr230 As LocalBuilder = ReadIL.DeclareLocal(GetType(TypeBuilder))
locbldr230.SetLocalSymInfo("typb")
ReadIL.Emit(OpCodes.Ldsfld, GetType(AsmFactory).GetField("CurnTypB"))
Typ = GetType(AsmFactory).GetField("CurnTypB").FieldType
ReadIL.Emit(OpCodes.Stloc, 64)
ReadIL.MarkSequencePoint(doc11, 336, 1, 336, 100)
Dim locbldr231 As LocalBuilder = ReadIL.DeclareLocal(GetType(System.Boolean))
locbldr231.SetLocalSymInfo("isconstr")
Dim typ80(-1) As Type
...
Dim locbldr232 As LocalBuilder = ReadIL.DeclareLocal(GetType(CallingConventions))
locbldr232.SetLocalSymInfo("stdcallconv")
ReadIL.Emit(OpCodes.Ldc_I4, CInt(1))
Typ = GetType(System.Int32)
...
Dim locbldr233 As LocalBuilder = ReadIL.DeclareLocal(GetType(System.Int32))
locbldr233.SetLocalSymInfo("mnamcomp")
Dim typ95(-1) As Type
...
Dim locbldr234 As LocalBuilder = ReadIL.DeclareLocal(GetType(System.Int32))
locbldr234.SetLocalSymInfo("amodecomp")
Dim typ96(-1) As Type
ReadIL.Emit(OpCodes.Ldsfld, GetType(AsmFactory).GetField("AsmMode"))
Typ = GetType(AsmFactory).GetField("AsmMode").FieldType
...
locbldr235.SetLocalSymInfo("vnam")
ReadIL.MarkSequencePoint(doc11, 399, 1, 399, 100)
Dim locbldr236 As LocalBuilder = ReadIL.DeclareLocal(GetType(TypeTok))
locbldr236.SetLocalSymInfo("vtyptok")
ReadIL.MarkSequencePoint(doc11, 400, 1, 400, 100)
Dim locbldr237 As LocalBuilder = ReadIL.DeclareLocal(GetType(System.Type))
locbldr237.SetLocalSymInfo("vtyp")
ReadIL.Emit(OpCodes.Ldnull)
ReadIL.Emit(OpCodes.Stloc, 71)
ReadIL.MarkSequencePoint(doc11, 401, 1, 401, 100)
Dim locbldr238 As LocalBuilder = ReadIL.DeclareLocal(asm.GetType("dylan.NET.Tokenizer.CodeGen.Evaluator"))
locbldr238.SetLocalSymInfo("eval")
ReadIL.Emit(OpCodes.Ldnull)
...
Dim locbldr239 As LocalBuilder = ReadIL.DeclareLocal(GetType(VarStmt))
locbldr239.SetLocalSymInfo("curv")
ReadIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
...
Dim locbldr240 As LocalBuilder = ReadIL.DeclareLocal(GetType(VarAsgnStmt))
locbldr240.SetLocalSymInfo("curva")
ReadIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
...
Dim locbldr241 As LocalBuilder = ReadIL.DeclareLocal(GetType(AssignStmt))
locbldr241.SetLocalSymInfo("asgnstm")
ReadIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
...
Dim locbldr242 As LocalBuilder = EmitMSILIL.DeclareLocal(GetType(System.Int32))
...
Dim locbldr243 As LocalBuilder = EmitMSILIL.DeclareLocal(GetType(System.Int32))
...
Dim locbldr244 As LocalBuilder = EmitMSILIL.DeclareLocal(GetType(Stmt))
locbldr244.SetLocalSymInfo("stm")
EmitMSILIL.Emit(OpCodes.Ldnull)
EmitMSILIL.Emit(OpCodes.Stloc, 2)
EmitMSILIL.MarkSequencePoint(doc12, 16, 1, 16, 100)
Dim locbldr245 As LocalBuilder = EmitMSILIL.DeclareLocal(GetType(System.Type))
locbldr245.SetLocalSymInfo("typ")
EmitMSILIL.MarkSequencePoint(doc12, 17, 1, 17, 100)
Dim locbldr246 As LocalBuilder = EmitMSILIL.DeclareLocal(GetType(System.Boolean))
...
Typ = GetType(System.Boolean)
Dim fa152 As System.Reflection.Emit.Label = EmitMSILIL.DefineLabel()
Dim tru152 As System.Reflection.Emit.Label = EmitMSILIL.DefineLabel()
Dim cont152 As System.Reflection.Emit.Label = EmitMSILIL.DefineLabel()
EmitMSILIL.Emit(OpCodes.Beq, tru152)
EmitMSILIL.Emit(OpCodes.Br, fa152)
EmitMSILIL.MarkLabel(tru152)
EmitMSILIL.MarkSequencePoint(doc12, 31, 1, 31, 100)
EmitMSILIL.Emit(OpCodes.Br, cont152)
EmitMSILIL.MarkLabel(fa152)
EmitMSILIL.MarkSequencePoint(doc12, 33, 1, 33, 100)
Dim locbldr247 As LocalBuilder = EmitMSILIL.DeclareLocal(asm.GetType("dylan.NET.Tokenizer.CodeGen.StmtReader"))
locbldr247.SetLocalSymInfo("sr")
...
EmitMSILIL.Emit(OpCodes.Br, cont152)
EmitMSILIL.MarkLabel(cont152)
EmitMSILIL.MarkSequencePoint(doc12, 38, 1, 38, 100)
EmitMSILIL.Emit(OpCodes.Ldloc, 0)
Typ = GetType(System.Int32)
EmitMSILIL.Emit(OpCodes.Ldloc, 1)
Typ = GetType(System.Int32)
Dim fa153 As System.Reflection.Emit.Label = EmitMSILIL.DefineLabel()
Dim tru153 As System.Reflection.Emit.Label = EmitMSILIL.DefineLabel()
Dim cont153 As System.Reflection.Emit.Label = EmitMSILIL.DefineLabel()
EmitMSILIL.Emit(OpCodes.Beq, tru153)
EmitMSILIL.Emit(OpCodes.Br, fa153)
EmitMSILIL.MarkLabel(tru153)
...
Dim locbldr248 As LocalBuilder = EmitMSILIL.DeclareLocal(GetType(AssemblyBuilder))
locbldr248.SetLocalSymInfo("ab")
...
EmitMSILIL.Emit(OpCodes.Br, cont153)
EmitMSILIL.MarkLabel(fa153)
