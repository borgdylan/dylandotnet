...
AddAsmIL.MarkSequencePoint(doc3, 15, 1, 15, 100)
...
AddAsmIL.MarkSequencePoint(doc3, 16, 1, 16, 100)
...
AddAsmIL.MarkSequencePoint(doc3, 17, 1, 17, 100)
...
AddAsmIL.MarkSequencePoint(doc3, 18, 1, 18, 100)
...
AddAsmIL.MarkSequencePoint(doc3, 20, 1, 20, 100)
...
AddAsmIL.MarkSequencePoint(doc3, 22, 1, 22, 100)
Dim label0 As System.Reflection.Emit.Label = AddAsmIL.DefineLabel()
AddAsmIL.MarkSequencePoint(doc3, 23, 1, 23, 100)
Dim label1 As System.Reflection.Emit.Label = AddAsmIL.DefineLabel()
AddAsmIL.MarkSequencePoint(doc3, 25, 1, 25, 100)
AddAsmIL.MarkLabel(label0)
AddAsmIL.MarkSequencePoint(doc3, 27, 1, 27, 100)
...
AddAsmIL.Emit(OpCodes.Add)
AddAsmIL.Emit(OpCodes.Stloc, 3)
AddAsmIL.MarkSequencePoint(doc3, 29, 1, 29, 100)
AddAsmIL.Emit(OpCodes.Ldloc, 0)
Typ = GetType(System.Int32)
...
AddAsmIL.MarkSequencePoint(doc3, 31, 1, 31, 100)
...
AddAsmIL.MarkSequencePoint(doc3, 33, 1, 33, 100)
AddAsmIL.Emit(OpCodes.Br, cont155)
AddAsmIL.MarkLabel(fa155)
AddAsmIL.Emit(OpCodes.Br, cont155)
AddAsmIL.MarkLabel(cont155)
AddAsmIL.MarkSequencePoint(doc3, 35, 1, 35, 100)
AddAsmIL.Emit(OpCodes.Ldloc, 3)
Typ = GetType(System.Int32)
...
AddAsmIL.MarkSequencePoint(doc3, 36, 1, 36, 100)
AddAsmIL.Emit(OpCodes.Br, label1)
AddAsmIL.MarkSequencePoint(doc3, 37, 1, 37, 100)
AddAsmIL.Emit(OpCodes.Br, cont156)
AddAsmIL.MarkLabel(fa156)
AddAsmIL.MarkSequencePoint(doc3, 38, 1, 38, 100)
AddAsmIL.Emit(OpCodes.Ldloc, 2)
Typ = GetType(System.Int32)
AddAsmIL.Emit(OpCodes.Ldc_I4, CInt(-1))
Typ = GetType(System.Int32)
...
AddAsmIL.MarkSequencePoint(doc3, 39, 1, 39, 100)
AddAsmIL.Emit(OpCodes.Br, label0)
AddAsmIL.MarkSequencePoint(doc3, 40, 1, 40, 100)
AddAsmIL.Emit(OpCodes.Br, cont157)
AddAsmIL.MarkLabel(fa157)
AddAsmIL.MarkSequencePoint(doc3, 41, 1, 41, 100)
AddAsmIL.Emit(OpCodes.Br, label1)
AddAsmIL.MarkSequencePoint(doc3, 42, 1, 42, 100)
AddAsmIL.Emit(OpCodes.Br, cont157)
AddAsmIL.MarkLabel(cont157)
AddAsmIL.MarkSequencePoint(doc3, 43, 1, 43, 100)
AddAsmIL.Emit(OpCodes.Br, cont156)
AddAsmIL.MarkLabel(cont156)
AddAsmIL.MarkSequencePoint(doc3, 45, 1, 45, 100)
AddAsmIL.MarkLabel(label1)
AddAsmIL.MarkSequencePoint(doc3, 47, 1, 47, 100)
AddAsmIL.Emit(OpCodes.Ldloc, 4)
Typ = GetType(Assembly).MakeArrayType()
Typ02 = Typ
AddAsmIL.Emit(OpCodes.Ldloc, 0)
...
AddAsmIL.Emit(OpCodes.Stelem, GetType(Assembly).MakeArrayType().GetElementType())
AddAsmIL.MarkSequencePoint(doc3, 49, 1, 49, 100)
AddAsmIL.Emit(OpCodes.Ldloc, 4)
Typ = GetType(Assembly).MakeArrayType()
AddAsmIL.Emit(OpCodes.Stsfld, Asms)
AddAsmIL.MarkSequencePoint(doc3, 51, 1, 51, 100)
...
addelemIL.MarkSequencePoint(doc3, 55, 1, 55, 100)
...
addelemIL.MarkSequencePoint(doc3, 56, 1, 56, 100)
...
addelemIL.MarkSequencePoint(doc3, 57, 1, 57, 100)
...
addelemIL.MarkSequencePoint(doc3, 58, 1, 58, 100)
...
addelemIL.MarkSequencePoint(doc3, 60, 1, 60, 100)
...
addelemIL.MarkSequencePoint(doc3, 62, 1, 62, 100)
Dim label2 As System.Reflection.Emit.Label = addelemIL.DefineLabel()
addelemIL.MarkSequencePoint(doc3, 63, 1, 63, 100)
Dim label3 As System.Reflection.Emit.Label = addelemIL.DefineLabel()
addelemIL.MarkSequencePoint(doc3, 65, 1, 65, 100)
addelemIL.MarkLabel(label2)
addelemIL.MarkSequencePoint(doc3, 67, 1, 67, 100)
...
addelemIL.Emit(OpCodes.Add)
addelemIL.Emit(OpCodes.Stloc, 3)
addelemIL.MarkSequencePoint(doc3, 69, 1, 69, 100)
addelemIL.Emit(OpCodes.Ldloc, 0)
Typ = GetType(System.Int32)
...
addelemIL.MarkSequencePoint(doc3, 71, 1, 71, 100)
...
addelemIL.MarkSequencePoint(doc3, 73, 1, 73, 100)
addelemIL.Emit(OpCodes.Br, cont158)
addelemIL.MarkLabel(fa158)
addelemIL.Emit(OpCodes.Br, cont158)
addelemIL.MarkLabel(cont158)
addelemIL.MarkSequencePoint(doc3, 75, 1, 75, 100)
addelemIL.Emit(OpCodes.Ldloc, 3)
Typ = GetType(System.Int32)
...
addelemIL.MarkSequencePoint(doc3, 76, 1, 76, 100)
addelemIL.Emit(OpCodes.Br, label3)
addelemIL.MarkSequencePoint(doc3, 77, 1, 77, 100)
addelemIL.Emit(OpCodes.Br, cont159)
addelemIL.MarkLabel(fa159)
addelemIL.MarkSequencePoint(doc3, 78, 1, 78, 100)
addelemIL.Emit(OpCodes.Ldloc, 2)
Typ = GetType(System.Int32)
addelemIL.Emit(OpCodes.Ldc_I4, CInt(-1))
Typ = GetType(System.Int32)
...
addelemIL.MarkSequencePoint(doc3, 79, 1, 79, 100)
addelemIL.Emit(OpCodes.Br, label2)
addelemIL.MarkSequencePoint(doc3, 80, 1, 80, 100)
addelemIL.Emit(OpCodes.Br, cont160)
addelemIL.MarkLabel(fa160)
addelemIL.MarkSequencePoint(doc3, 81, 1, 81, 100)
addelemIL.Emit(OpCodes.Br, label3)
addelemIL.MarkSequencePoint(doc3, 82, 1, 82, 100)
addelemIL.Emit(OpCodes.Br, cont160)
addelemIL.MarkLabel(cont160)
addelemIL.MarkSequencePoint(doc3, 83, 1, 83, 100)
addelemIL.Emit(OpCodes.Br, cont159)
addelemIL.MarkLabel(cont159)
addelemIL.MarkSequencePoint(doc3, 85, 1, 85, 100)
addelemIL.MarkLabel(label3)
addelemIL.MarkSequencePoint(doc3, 87, 1, 87, 100)
addelemIL.Emit(OpCodes.Ldloc, 4)
Typ = GetType(System.String).MakeArrayType()
Typ02 = Typ
addelemIL.Emit(OpCodes.Ldloc, 0)
...
Typ = GetType(System.String)
addelemIL.Emit(OpCodes.Stelem, GetType(System.String).MakeArrayType().GetElementType())
addelemIL.MarkSequencePoint(doc3, 89, 1, 89, 100)
addelemIL.Emit(OpCodes.Ldloc, 4)
Typ = GetType(System.String).MakeArrayType()
addelemIL.MarkSequencePoint(doc3, 91, 1, 91, 100)
...
AddImpIL.MarkSequencePoint(doc3, 94, 1, 94, 100)
Dim typ3(-1) As Type
...
AddImpIL.MarkSequencePoint(doc3, 95, 1, 95, 100)
...
AddLocImpIL.MarkSequencePoint(doc3, 98, 1, 98, 100)
Dim typ5(-1) As Type
...
AddLocImpIL.MarkSequencePoint(doc3, 99, 1, 99, 100)
...
Dim locbldr12 As LocalBuilder = ReadIL.DeclareLocal(GetType(System.Type))
locbldr12.SetLocalSymInfo("typ")
ReadIL.MarkSequencePoint(doc4, 6, 1, 6, 100)
Dim locbldr13 As LocalBuilder = ReadIL.DeclareLocal(GetType(System.Boolean))
...
Dim locbldr14 As LocalBuilder = ReadIL.DeclareLocal(GetType(RefasmStmt))
locbldr14.SetLocalSymInfo("rastm")
ReadIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
ReadIL.Emit(OpCodes.Stloc, 2)
ReadIL.MarkSequencePoint(doc4, 15, 1, 15, 100)
Dim locbldr15 As LocalBuilder = ReadIL.DeclareLocal(GetType(Token))
locbldr15.SetLocalSymInfo("ap")
...
Dim locbldr16 As LocalBuilder = ReadIL.DeclareLocal(GetType(System.String))
locbldr16.SetLocalSymInfo("tmpstr")
Dim typ3(-1) As Type
...
Dim locbldr17 As LocalBuilder = ReadIL.DeclareLocal(GetType(System.Boolean))
locbldr17.SetLocalSymInfo("compb")
Dim typ4(-1) As Type
...
Dim locbldr18 As LocalBuilder = ReadIL.DeclareLocal(GetType(System.Char).MakeArrayType())
locbldr18.SetLocalSymInfo("tmpchrarr")
...
Dim locbldr19 As LocalBuilder = ReadIL.DeclareLocal(GetType(Assembly))
locbldr19.SetLocalSymInfo("asm")
Dim typ7(-1) As Type
ReadIL.Emit(OpCodes.Ldloc, 3)
Typ = GetType(Token)
ReadIL.Emit(OpCodes.Ldfld, GetType(Token).GetField("Value"))
...
Dim locbldr20 As LocalBuilder = EmitMSILIL.DeclareLocal(GetType(System.Int32))
...
Dim locbldr21 As LocalBuilder = EmitMSILIL.DeclareLocal(GetType(System.Int32))
...
Dim locbldr22 As LocalBuilder = EmitMSILIL.DeclareLocal(GetType(Stmt))
locbldr22.SetLocalSymInfo("stm")
EmitMSILIL.Emit(OpCodes.Ldnull)
EmitMSILIL.Emit(OpCodes.Stloc, 2)
EmitMSILIL.MarkSequencePoint(doc5, 8, 1, 8, 100)
Dim locbldr23 As LocalBuilder = EmitMSILIL.DeclareLocal(GetType(System.Type))
locbldr23.SetLocalSymInfo("typ")
EmitMSILIL.MarkSequencePoint(doc5, 9, 1, 9, 100)
Dim locbldr24 As LocalBuilder = EmitMSILIL.DeclareLocal(GetType(System.Boolean))
locbldr24.SetLocalSymInfo("b")
...
Typ = GetType(System.Boolean)
Dim fa163 As System.Reflection.Emit.Label = EmitMSILIL.DefineLabel()
Dim tru163 As System.Reflection.Emit.Label = EmitMSILIL.DefineLabel()
Dim cont163 As System.Reflection.Emit.Label = EmitMSILIL.DefineLabel()
EmitMSILIL.Emit(OpCodes.Beq, tru163)
EmitMSILIL.Emit(OpCodes.Br, fa163)
EmitMSILIL.MarkLabel(tru163)
EmitMSILIL.MarkSequencePoint(doc5, 23, 1, 23, 100)
EmitMSILIL.Emit(OpCodes.Br, cont163)
EmitMSILIL.MarkLabel(fa163)
EmitMSILIL.MarkSequencePoint(doc5, 25, 1, 25, 100)
Dim locbldr25 As LocalBuilder = EmitMSILIL.DeclareLocal(asm.GetType("dylan.NET.Tokenizer.CodeGen.StmtReader"))
...
doc3 = mdl.DefineDocument("E:\Code\dylannet\compiler\importer.txt", Guid.Empty, Guid.Empty, Guid.Empty)
