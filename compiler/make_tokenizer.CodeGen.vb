...
ProcessClassAttrsIL.Emit(OpCodes.Stloc, 4)
ProcessClassAttrsIL.MarkSequencePoint(doc3, 41, 1, 41, 100)
ProcessClassAttrsIL.Emit(OpCodes.Ldloc, 4)
Typ = GetType(System.Boolean)
ProcessClassAttrsIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
...
ProcessClassAttrsIL.MarkSequencePoint(doc3, 44, 1, 44, 100)
ProcessClassAttrsIL.Emit(OpCodes.Ldloc, 7)
Typ = GetType(System.Boolean)
ProcessClassAttrsIL.Emit(OpCodes.Ldloc, 7)
Typ = GetType(System.Boolean)
...
ProcessClassAttrsIL.Emit(OpCodes.Stloc, 4)
ProcessClassAttrsIL.MarkSequencePoint(doc3, 55, 1, 55, 100)
ProcessClassAttrsIL.Emit(OpCodes.Ldloc, 4)
Typ = GetType(System.Boolean)
ProcessClassAttrsIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
...
ProcessClassAttrsIL.MarkSequencePoint(doc3, 58, 1, 58, 100)
ProcessClassAttrsIL.Emit(OpCodes.Ldloc, 7)
Typ = GetType(System.Boolean)
ProcessClassAttrsIL.Emit(OpCodes.Ldloc, 7)
Typ = GetType(System.Boolean)
...
ProcessClassAttrsIL.MarkSequencePoint(doc3, 69, 1, 69, 100)
...
ProcessClassAttrsIL.MarkSequencePoint(doc3, 71, 1, 71, 100)
...
ProcessClassAttrsIL.MarkSequencePoint(doc3, 78, 1, 78, 100)
ProcessClassAttrsIL.Emit(OpCodes.Ldloc, 0)
Typ = GetType(TypeAttributes)
...
ReadIL.Emit(OpCodes.Call, GetType(System.Type).GetMethod("GetTypeFromHandle", typ36))
...
ReDim Preserve typ37(UBound(typ37) + 1)
typ37(UBound(typ37)) = Typ
ReadIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("IsInstanceOfType", typ37))
...
ReDim Preserve typ38(UBound(typ38) + 1)
typ38(UBound(typ38)) = Typ
ReadIL.Emit(OpCodes.Call, asm.GetType("dylan.NET.Tokenizer.CodeGen.Helpers").GetMethod("ProcessClassAttrs", typ38))
Typ = asm.GetType("dylan.NET.Tokenizer.CodeGen.Helpers").GetMethod("ProcessClassAttrs", typ38).ReturnType
...
ReadIL.MarkSequencePoint(doc4, 145, 1, 145, 100)
...
ReDim Preserve typ39(UBound(typ39) + 1)
typ39(UBound(typ39)) = Typ
ReadIL.Emit(OpCodes.Call, GetType(String).GetMethod("Compare", typ39))
...
ReadIL.MarkSequencePoint(doc4, 151, 1, 151, 100)
ReadIL.Emit(OpCodes.Ldtoken, GetType(System.Object))
Dim typ40 As Type() = {GetType(System.RuntimeTypeHandle)}
ReadIL.Emit(OpCodes.Call, GetType(System.Type).GetMethod("GetTypeFromHandle", typ40))
...
ReDim Preserve typ41(UBound(typ41) + 1)
typ41(UBound(typ41)) = Typ
ReadIL.Emit(OpCodes.Call, GetType(Loader).GetMethod("LoadClass", typ41))
Typ = GetType(Loader).GetMethod("LoadClass", typ41).ReturnType
ReadIL.Emit(OpCodes.Stloc, 33)
ReadIL.MarkSequencePoint(doc4, 154, 1, 154, 100)
ReadIL.Emit(OpCodes.Br, cont173)
ReadIL.MarkLabel(cont173)
ReadIL.MarkSequencePoint(doc4, 155, 1, 155, 100)
...
ReadIL.MarkSequencePoint(doc4, 159, 1, 159, 100)
...
ReDim Preserve typ42(UBound(typ42) + 1)
typ42(UBound(typ42)) = Typ
ReadIL.Emit(OpCodes.Call, GetType(String).GetMethod("Concat", typ42))
...
ReDim Preserve typ43(UBound(typ43) + 1)
typ43(UBound(typ43)) = Typ
ReadIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("DefineType", typ43))
Typ = Typ03.GetMethod("DefineType", typ43).ReturnType
...
Dim locbldr47 As LocalBuilder = EmitMSILIL.DeclareLocal(GetType(System.Int32))
locbldr47.SetLocalSymInfo("i")
...
Dim locbldr49 As LocalBuilder = EmitMSILIL.DeclareLocal(GetType(Stmt))
locbldr49.SetLocalSymInfo("stm")
EmitMSILIL.Emit(OpCodes.Ldnull)
EmitMSILIL.Emit(OpCodes.Stloc, 2)
EmitMSILIL.MarkSequencePoint(doc5, 8, 1, 8, 100)
Dim locbldr50 As LocalBuilder = EmitMSILIL.DeclareLocal(GetType(System.Type))
locbldr50.SetLocalSymInfo("typ")
EmitMSILIL.MarkSequencePoint(doc5, 9, 1, 9, 100)
Dim locbldr51 As LocalBuilder = EmitMSILIL.DeclareLocal(GetType(System.Boolean))
...
Typ = GetType(System.Boolean)
Dim fa175 As System.Reflection.Emit.Label = EmitMSILIL.DefineLabel()
Dim tru175 As System.Reflection.Emit.Label = EmitMSILIL.DefineLabel()
Dim cont175 As System.Reflection.Emit.Label = EmitMSILIL.DefineLabel()
EmitMSILIL.Emit(OpCodes.Beq, tru175)
EmitMSILIL.Emit(OpCodes.Br, fa175)
EmitMSILIL.MarkLabel(tru175)
EmitMSILIL.MarkSequencePoint(doc5, 23, 1, 23, 100)
EmitMSILIL.Emit(OpCodes.Br, cont175)
EmitMSILIL.MarkLabel(fa175)
EmitMSILIL.MarkSequencePoint(doc5, 25, 1, 25, 100)
Dim locbldr52 As LocalBuilder = EmitMSILIL.DeclareLocal(asm.GetType("dylan.NET.Tokenizer.CodeGen.StmtReader"))
locbldr52.SetLocalSymInfo("sr")
...
EmitMSILIL.Emit(OpCodes.Br, cont175)
EmitMSILIL.MarkLabel(cont175)
EmitMSILIL.MarkSequencePoint(doc5, 30, 1, 30, 100)
EmitMSILIL.Emit(OpCodes.Ldloc, 0)
Typ = GetType(System.Int32)
EmitMSILIL.Emit(OpCodes.Ldloc, 1)
Typ = GetType(System.Int32)
Dim fa176 As System.Reflection.Emit.Label = EmitMSILIL.DefineLabel()
Dim tru176 As System.Reflection.Emit.Label = EmitMSILIL.DefineLabel()
Dim cont176 As System.Reflection.Emit.Label = EmitMSILIL.DefineLabel()
EmitMSILIL.Emit(OpCodes.Beq, tru176)
EmitMSILIL.Emit(OpCodes.Br, fa176)
EmitMSILIL.MarkLabel(tru176)
EmitMSILIL.MarkSequencePoint(doc5, 32, 1, 32, 100)
Dim locbldr53 As LocalBuilder = EmitMSILIL.DeclareLocal(GetType(AssemblyBuilder))
locbldr53.SetLocalSymInfo("ab")
...
EmitMSILIL.Emit(OpCodes.Br, cont176)
EmitMSILIL.MarkLabel(fa176)
