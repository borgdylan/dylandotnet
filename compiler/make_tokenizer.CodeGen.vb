...
Dim ProcessClassAttrsparam00 As ParameterBuilder = ProcessClassAttrs.DefineParameter(0, ParameterAttributes.RetVal, "")
Dim ProcessClassAttrsparam01 As ParameterBuilder = ProcessClassAttrs.DefineParameter(1, ParameterAttributes.None, "attrs")
ProcessClassAttrsIL.MarkSequencePoint(doc3, 4, 1, 4, 100)
Dim locbldr2 As LocalBuilder = ProcessClassAttrsIL.DeclareLocal(GetType(TypeAttributes))
locbldr2.SetLocalSymInfo("ta")
ProcessClassAttrsIL.MarkSequencePoint(doc3, 5, 1, 5, 100)
Dim locbldr3 As LocalBuilder = ProcessClassAttrsIL.DeclareLocal(GetType(TypeAttributes))
locbldr3.SetLocalSymInfo("temp")
ProcessClassAttrsIL.MarkSequencePoint(doc3, 7, 1, 7, 100)
Dim label0 As System.Reflection.Emit.Label = ProcessClassAttrsIL.DefineLabel()
ProcessClassAttrsIL.MarkSequencePoint(doc3, 8, 1, 8, 100)
Dim label1 As System.Reflection.Emit.Label = ProcessClassAttrsIL.DefineLabel()
ProcessClassAttrsIL.MarkSequencePoint(doc3, 9, 1, 9, 100)
Dim label2 As System.Reflection.Emit.Label = ProcessClassAttrsIL.DefineLabel()
ProcessClassAttrsIL.MarkSequencePoint(doc3, 11, 1, 11, 100)
Dim locbldr4 As LocalBuilder = ProcessClassAttrsIL.DeclareLocal(GetType(System.Int32))
locbldr4.SetLocalSymInfo("len")
...
ProcessClassAttrsIL.MarkSequencePoint(doc3, 12, 1, 12, 100)
Dim locbldr5 As LocalBuilder = ProcessClassAttrsIL.DeclareLocal(GetType(System.Int32))
locbldr5.SetLocalSymInfo("i")
ProcessClassAttrsIL.Emit(OpCodes.Ldc_I4, CInt(-1))
Typ = GetType(System.Int32)
ProcessClassAttrsIL.Emit(OpCodes.Stloc, 3)
ProcessClassAttrsIL.MarkSequencePoint(doc3, 13, 1, 13, 100)
Dim locbldr6 As LocalBuilder = ProcessClassAttrsIL.DeclareLocal(GetType(System.Boolean))
locbldr6.SetLocalSymInfo("b")
ProcessClassAttrsIL.Emit(OpCodes.Ldc_I4, 0)
Typ = GetType(System.Boolean)
ProcessClassAttrsIL.Emit(OpCodes.Stloc, 4)
ProcessClassAttrsIL.MarkSequencePoint(doc3, 14, 1, 14, 100)
Dim locbldr7 As LocalBuilder = ProcessClassAttrsIL.DeclareLocal(GetType(System.Type))
locbldr7.SetLocalSymInfo("typ")
ProcessClassAttrsIL.MarkSequencePoint(doc3, 15, 1, 15, 100)
Dim locbldr8 As LocalBuilder = ProcessClassAttrsIL.DeclareLocal(GetType(Attributes.Attribute))
locbldr8.SetLocalSymInfo("curattr")
ProcessClassAttrsIL.Emit(OpCodes.Ldnull)
ProcessClassAttrsIL.Emit(OpCodes.Stloc, 6)
ProcessClassAttrsIL.MarkSequencePoint(doc3, 16, 1, 16, 100)
Dim locbldr9 As LocalBuilder = ProcessClassAttrsIL.DeclareLocal(GetType(System.Boolean))
locbldr9.SetLocalSymInfo("fir")
ProcessClassAttrsIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
ProcessClassAttrsIL.Emit(OpCodes.Stloc, 7)
ProcessClassAttrsIL.MarkSequencePoint(doc3, 18, 1, 18, 100)
ProcessClassAttrsIL.MarkLabel(label0)
ProcessClassAttrsIL.MarkSequencePoint(doc3, 20, 1, 20, 100)
...
ProcessClassAttrsIL.Emit(OpCodes.Stloc, 3)
ProcessClassAttrsIL.MarkSequencePoint(doc3, 22, 1, 22, 100)
ProcessClassAttrsIL.Emit(OpCodes.Ldarg, 0)
Typ = GetType(Attributes.Attribute).MakeArrayType()
Typ02 = Typ
ProcessClassAttrsIL.Emit(OpCodes.Ldloc, 3)
...
ProcessClassAttrsIL.Emit(OpCodes.Stloc, 6)
ProcessClassAttrsIL.MarkSequencePoint(doc3, 24, 1, 24, 100)
...
ProcessClassAttrsIL.MarkSequencePoint(doc3, 25, 1, 25, 100)
Dim typ2(-1) As Type
...
ProcessClassAttrsIL.Emit(OpCodes.Stloc, 4)
ProcessClassAttrsIL.MarkSequencePoint(doc3, 27, 1, 27, 100)
ProcessClassAttrsIL.Emit(OpCodes.Ldloc, 4)
Typ = GetType(System.Boolean)
ProcessClassAttrsIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa155 As System.Reflection.Emit.Label = ProcessClassAttrsIL.DefineLabel()
Dim tru155 As System.Reflection.Emit.Label = ProcessClassAttrsIL.DefineLabel()
Dim cont155 As System.Reflection.Emit.Label = ProcessClassAttrsIL.DefineLabel()
ProcessClassAttrsIL.Emit(OpCodes.Beq, tru155)
ProcessClassAttrsIL.Emit(OpCodes.Br, fa155)
ProcessClassAttrsIL.MarkLabel(tru155)
ProcessClassAttrsIL.MarkSequencePoint(doc3, 28, 1, 28, 100)
...
ProcessClassAttrsIL.Emit(OpCodes.Ldc_I4, 0)
Typ = GetType(System.Boolean)
Dim fa156 As System.Reflection.Emit.Label = ProcessClassAttrsIL.DefineLabel()
Dim tru156 As System.Reflection.Emit.Label = ProcessClassAttrsIL.DefineLabel()
Dim cont156 As System.Reflection.Emit.Label = ProcessClassAttrsIL.DefineLabel()
ProcessClassAttrsIL.Emit(OpCodes.Beq, tru156)
ProcessClassAttrsIL.Emit(OpCodes.Br, fa156)
ProcessClassAttrsIL.MarkLabel(tru156)
ProcessClassAttrsIL.MarkSequencePoint(doc3, 29, 1, 29, 100)
ProcessClassAttrsIL.Emit(OpCodes.Ldc_I4, CInt(1))
Typ = GetType(System.Int32)
ProcessClassAttrsIL.Emit(OpCodes.Stloc, 1)
ProcessClassAttrsIL.MarkSequencePoint(doc3, 30, 1, 30, 100)
ProcessClassAttrsIL.Emit(OpCodes.Br, cont156)
ProcessClassAttrsIL.MarkLabel(fa156)
ProcessClassAttrsIL.MarkSequencePoint(doc3, 31, 1, 31, 100)
ProcessClassAttrsIL.Emit(OpCodes.Ldc_I4, CInt(2))
Typ = GetType(System.Int32)
ProcessClassAttrsIL.Emit(OpCodes.Stloc, 1)
ProcessClassAttrsIL.MarkSequencePoint(doc3, 32, 1, 32, 100)
ProcessClassAttrsIL.Emit(OpCodes.Br, cont156)
ProcessClassAttrsIL.MarkLabel(cont156)
ProcessClassAttrsIL.MarkSequencePoint(doc3, 33, 1, 33, 100)
ProcessClassAttrsIL.Emit(OpCodes.Ldloc, 7)
Typ = GetType(System.Boolean)
ProcessClassAttrsIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa157 As System.Reflection.Emit.Label = ProcessClassAttrsIL.DefineLabel()
Dim tru157 As System.Reflection.Emit.Label = ProcessClassAttrsIL.DefineLabel()
Dim cont157 As System.Reflection.Emit.Label = ProcessClassAttrsIL.DefineLabel()
ProcessClassAttrsIL.Emit(OpCodes.Beq, tru157)
ProcessClassAttrsIL.Emit(OpCodes.Br, fa157)
ProcessClassAttrsIL.MarkLabel(tru157)
ProcessClassAttrsIL.MarkSequencePoint(doc3, 34, 1, 34, 100)
ProcessClassAttrsIL.Emit(OpCodes.Ldloc, 7)
Typ = GetType(System.Boolean)
ProcessClassAttrsIL.Emit(OpCodes.Ldloc, 7)
Typ = GetType(System.Boolean)
...
ProcessClassAttrsIL.Emit(OpCodes.Stloc, 7)
ProcessClassAttrsIL.MarkSequencePoint(doc3, 35, 1, 35, 100)
ProcessClassAttrsIL.Emit(OpCodes.Ldloc, 1)
Typ = GetType(TypeAttributes)
ProcessClassAttrsIL.Emit(OpCodes.Stloc, 0)
ProcessClassAttrsIL.MarkSequencePoint(doc3, 36, 1, 36, 100)
ProcessClassAttrsIL.Emit(OpCodes.Br, cont157)
ProcessClassAttrsIL.MarkLabel(fa157)
ProcessClassAttrsIL.MarkSequencePoint(doc3, 37, 1, 37, 100)
ProcessClassAttrsIL.Emit(OpCodes.Ldloc, 1)
Typ = GetType(TypeAttributes)
...
ProcessClassAttrsIL.Emit(OpCodes.Stloc, 0)
ProcessClassAttrsIL.MarkSequencePoint(doc3, 38, 1, 38, 100)
ProcessClassAttrsIL.Emit(OpCodes.Br, cont157)
ProcessClassAttrsIL.MarkLabel(cont157)
ProcessClassAttrsIL.MarkSequencePoint(doc3, 39, 1, 39, 100)
ProcessClassAttrsIL.Emit(OpCodes.Br, label2)
ProcessClassAttrsIL.MarkSequencePoint(doc3, 40, 1, 40, 100)
ProcessClassAttrsIL.Emit(OpCodes.Br, cont155)
ProcessClassAttrsIL.MarkLabel(fa155)
ProcessClassAttrsIL.Emit(OpCodes.Br, cont155)
ProcessClassAttrsIL.MarkLabel(cont155)
ProcessClassAttrsIL.MarkSequencePoint(doc3, 42, 1, 42, 100)
...
ProcessClassAttrsIL.Emit(OpCodes.Stloc, 5)
ProcessClassAttrsIL.MarkSequencePoint(doc3, 43, 1, 43, 100)
Dim typ4(-1) As Type
ProcessClassAttrsIL.Emit(OpCodes.Ldloc, 5)
Typ = GetType(System.Type)
Typ03 = Typ
...
ProcessClassAttrsIL.Emit(OpCodes.Stloc, 4)
ProcessClassAttrsIL.MarkSequencePoint(doc3, 45, 1, 45, 100)
ProcessClassAttrsIL.Emit(OpCodes.Ldloc, 4)
Typ = GetType(System.Boolean)
ProcessClassAttrsIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa158 As System.Reflection.Emit.Label = ProcessClassAttrsIL.DefineLabel()
Dim tru158 As System.Reflection.Emit.Label = ProcessClassAttrsIL.DefineLabel()
Dim cont158 As System.Reflection.Emit.Label = ProcessClassAttrsIL.DefineLabel()
ProcessClassAttrsIL.Emit(OpCodes.Beq, tru158)
ProcessClassAttrsIL.Emit(OpCodes.Br, fa158)
ProcessClassAttrsIL.MarkLabel(tru158)
ProcessClassAttrsIL.MarkSequencePoint(doc3, 46, 1, 46, 100)
ProcessClassAttrsIL.Emit(OpCodes.Ldc_I4, CInt(0))
Typ = GetType(System.Int32)
ProcessClassAttrsIL.Emit(OpCodes.Stloc, 1)
ProcessClassAttrsIL.MarkSequencePoint(doc3, 47, 1, 47, 100)
ProcessClassAttrsIL.Emit(OpCodes.Ldloc, 7)
Typ = GetType(System.Boolean)
ProcessClassAttrsIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa159 As System.Reflection.Emit.Label = ProcessClassAttrsIL.DefineLabel()
Dim tru159 As System.Reflection.Emit.Label = ProcessClassAttrsIL.DefineLabel()
Dim cont159 As System.Reflection.Emit.Label = ProcessClassAttrsIL.DefineLabel()
ProcessClassAttrsIL.Emit(OpCodes.Beq, tru159)
ProcessClassAttrsIL.Emit(OpCodes.Br, fa159)
ProcessClassAttrsIL.MarkLabel(tru159)
ProcessClassAttrsIL.MarkSequencePoint(doc3, 48, 1, 48, 100)
ProcessClassAttrsIL.Emit(OpCodes.Ldloc, 7)
Typ = GetType(System.Boolean)
ProcessClassAttrsIL.Emit(OpCodes.Ldloc, 7)
Typ = GetType(System.Boolean)
...
ProcessClassAttrsIL.Emit(OpCodes.Not)
ProcessClassAttrsIL.Emit(OpCodes.Stloc, 7)
ProcessClassAttrsIL.MarkSequencePoint(doc3, 49, 1, 49, 100)
ProcessClassAttrsIL.Emit(OpCodes.Ldloc, 1)
Typ = GetType(TypeAttributes)
ProcessClassAttrsIL.Emit(OpCodes.Stloc, 0)
ProcessClassAttrsIL.MarkSequencePoint(doc3, 50, 1, 50, 100)
ProcessClassAttrsIL.Emit(OpCodes.Br, cont159)
ProcessClassAttrsIL.MarkLabel(fa159)
ProcessClassAttrsIL.MarkSequencePoint(doc3, 51, 1, 51, 100)
ProcessClassAttrsIL.Emit(OpCodes.Ldloc, 1)
Typ = GetType(TypeAttributes)
ProcessClassAttrsIL.Emit(OpCodes.Ldloc, 0)
Typ = GetType(TypeAttributes)
ProcessClassAttrsIL.Emit(OpCodes.Or)
ProcessClassAttrsIL.Emit(OpCodes.Stloc, 0)
ProcessClassAttrsIL.MarkSequencePoint(doc3, 52, 1, 52, 100)
ProcessClassAttrsIL.Emit(OpCodes.Br, cont159)
ProcessClassAttrsIL.MarkLabel(cont159)
ProcessClassAttrsIL.MarkSequencePoint(doc3, 53, 1, 53, 100)
ProcessClassAttrsIL.Emit(OpCodes.Br, label2)
ProcessClassAttrsIL.MarkSequencePoint(doc3, 54, 1, 54, 100)
ProcessClassAttrsIL.Emit(OpCodes.Br, cont158)
ProcessClassAttrsIL.MarkLabel(fa158)
ProcessClassAttrsIL.Emit(OpCodes.Br, cont158)
ProcessClassAttrsIL.MarkLabel(cont158)
ProcessClassAttrsIL.MarkSequencePoint(doc3, 56, 1, 56, 100)
...
ProcessClassAttrsIL.Emit(OpCodes.Stloc, 5)
ProcessClassAttrsIL.MarkSequencePoint(doc3, 57, 1, 57, 100)
Dim typ6(-1) As Type
ProcessClassAttrsIL.Emit(OpCodes.Ldloc, 5)
Typ = GetType(System.Type)
Typ03 = Typ
...
ProcessClassAttrsIL.Emit(OpCodes.Stloc, 4)
ProcessClassAttrsIL.MarkSequencePoint(doc3, 59, 1, 59, 100)
ProcessClassAttrsIL.Emit(OpCodes.Ldloc, 4)
Typ = GetType(System.Boolean)
ProcessClassAttrsIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa160 As System.Reflection.Emit.Label = ProcessClassAttrsIL.DefineLabel()
Dim tru160 As System.Reflection.Emit.Label = ProcessClassAttrsIL.DefineLabel()
Dim cont160 As System.Reflection.Emit.Label = ProcessClassAttrsIL.DefineLabel()
ProcessClassAttrsIL.Emit(OpCodes.Beq, tru160)
ProcessClassAttrsIL.Emit(OpCodes.Br, fa160)
ProcessClassAttrsIL.MarkLabel(tru160)
ProcessClassAttrsIL.MarkSequencePoint(doc3, 60, 1, 60, 100)
ProcessClassAttrsIL.Emit(OpCodes.Ldc_I4, CInt(0))
Typ = GetType(System.Int32)
ProcessClassAttrsIL.Emit(OpCodes.Stloc, 1)
ProcessClassAttrsIL.MarkSequencePoint(doc3, 61, 1, 61, 100)
ProcessClassAttrsIL.Emit(OpCodes.Ldloc, 7)
Typ = GetType(System.Boolean)
ProcessClassAttrsIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa161 As System.Reflection.Emit.Label = ProcessClassAttrsIL.DefineLabel()
Dim tru161 As System.Reflection.Emit.Label = ProcessClassAttrsIL.DefineLabel()
Dim cont161 As System.Reflection.Emit.Label = ProcessClassAttrsIL.DefineLabel()
ProcessClassAttrsIL.Emit(OpCodes.Beq, tru161)
ProcessClassAttrsIL.Emit(OpCodes.Br, fa161)
ProcessClassAttrsIL.MarkLabel(tru161)
ProcessClassAttrsIL.MarkSequencePoint(doc3, 62, 1, 62, 100)
ProcessClassAttrsIL.Emit(OpCodes.Ldloc, 7)
Typ = GetType(System.Boolean)
ProcessClassAttrsIL.Emit(OpCodes.Ldloc, 7)
Typ = GetType(System.Boolean)
...
ProcessClassAttrsIL.Emit(OpCodes.Not)
ProcessClassAttrsIL.Emit(OpCodes.Stloc, 7)
ProcessClassAttrsIL.MarkSequencePoint(doc3, 63, 1, 63, 100)
ProcessClassAttrsIL.Emit(OpCodes.Ldloc, 1)
Typ = GetType(TypeAttributes)
ProcessClassAttrsIL.Emit(OpCodes.Stloc, 0)
ProcessClassAttrsIL.MarkSequencePoint(doc3, 64, 1, 64, 100)
ProcessClassAttrsIL.Emit(OpCodes.Br, cont161)
ProcessClassAttrsIL.MarkLabel(fa161)
ProcessClassAttrsIL.MarkSequencePoint(doc3, 65, 1, 65, 100)
ProcessClassAttrsIL.Emit(OpCodes.Ldloc, 1)
Typ = GetType(TypeAttributes)
ProcessClassAttrsIL.Emit(OpCodes.Ldloc, 0)
Typ = GetType(TypeAttributes)
ProcessClassAttrsIL.Emit(OpCodes.Or)
ProcessClassAttrsIL.Emit(OpCodes.Stloc, 0)
ProcessClassAttrsIL.MarkSequencePoint(doc3, 66, 1, 66, 100)
ProcessClassAttrsIL.Emit(OpCodes.Br, cont161)
ProcessClassAttrsIL.MarkLabel(cont161)
ProcessClassAttrsIL.MarkSequencePoint(doc3, 67, 1, 67, 100)
ProcessClassAttrsIL.Emit(OpCodes.Br, label2)
ProcessClassAttrsIL.MarkSequencePoint(doc3, 68, 1, 68, 100)
ProcessClassAttrsIL.Emit(OpCodes.Br, cont160)
ProcessClassAttrsIL.MarkLabel(fa160)
ProcessClassAttrsIL.Emit(OpCodes.Br, cont160)
ProcessClassAttrsIL.MarkLabel(cont160)
ProcessClassAttrsIL.MarkSequencePoint(doc3, 70, 1, 70, 100)
ProcessClassAttrsIL.MarkLabel(label2)
ProcessClassAttrsIL.MarkSequencePoint(doc3, 72, 1, 72, 100)
ProcessClassAttrsIL.Emit(OpCodes.Ldloc, 3)
Typ = GetType(System.Int32)
ProcessClassAttrsIL.Emit(OpCodes.Ldloc, 2)
Typ = GetType(System.Int32)
Dim fa162 As System.Reflection.Emit.Label = ProcessClassAttrsIL.DefineLabel()
Dim tru162 As System.Reflection.Emit.Label = ProcessClassAttrsIL.DefineLabel()
Dim cont162 As System.Reflection.Emit.Label = ProcessClassAttrsIL.DefineLabel()
ProcessClassAttrsIL.Emit(OpCodes.Beq, tru162)
ProcessClassAttrsIL.Emit(OpCodes.Br, fa162)
ProcessClassAttrsIL.MarkLabel(tru162)
ProcessClassAttrsIL.MarkSequencePoint(doc3, 73, 1, 73, 100)
ProcessClassAttrsIL.Emit(OpCodes.Br, label1)
ProcessClassAttrsIL.MarkSequencePoint(doc3, 74, 1, 74, 100)
ProcessClassAttrsIL.Emit(OpCodes.Br, cont162)
ProcessClassAttrsIL.MarkLabel(fa162)
ProcessClassAttrsIL.MarkSequencePoint(doc3, 75, 1, 75, 100)
ProcessClassAttrsIL.Emit(OpCodes.Br, label0)
ProcessClassAttrsIL.MarkSequencePoint(doc3, 76, 1, 76, 100)
ProcessClassAttrsIL.Emit(OpCodes.Br, cont162)
ProcessClassAttrsIL.MarkLabel(cont162)
ProcessClassAttrsIL.MarkSequencePoint(doc3, 79, 1, 79, 100)
ProcessClassAttrsIL.MarkLabel(label1)
ProcessClassAttrsIL.MarkSequencePoint(doc3, 82, 1, 82, 100)
ProcessClassAttrsIL.Emit(OpCodes.Ldloc, 0)
Typ = GetType(TypeAttributes)
ProcessClassAttrsIL.MarkSequencePoint(doc3, 83, 1, 83, 100)
...
Dim locbldr10 As LocalBuilder = ReadIL.DeclareLocal(GetType(System.Type))
locbldr10.SetLocalSymInfo("typ")
ReadIL.MarkSequencePoint(doc4, 6, 1, 6, 100)
Dim locbldr11 As LocalBuilder = ReadIL.DeclareLocal(GetType(System.Boolean))
locbldr11.SetLocalSymInfo("b")
...
Dim locbldr12 As LocalBuilder = ReadIL.DeclareLocal(GetType(RefasmStmt))
locbldr12.SetLocalSymInfo("rastm")
ReadIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
...
Dim locbldr14 As LocalBuilder = ReadIL.DeclareLocal(GetType(System.String))
locbldr14.SetLocalSymInfo("tmpstr")
Dim typ3(-1) As Type
...
Dim locbldr15 As LocalBuilder = ReadIL.DeclareLocal(GetType(System.Boolean))
locbldr15.SetLocalSymInfo("compb")
Dim typ4(-1) As Type
...
Dim locbldr16 As LocalBuilder = ReadIL.DeclareLocal(GetType(System.Char).MakeArrayType())
locbldr16.SetLocalSymInfo("tmpchrarr")
...
Dim locbldr17 As LocalBuilder = ReadIL.DeclareLocal(GetType(Assembly))
locbldr17.SetLocalSymInfo("asm")
Dim typ7(-1) As Type
ReadIL.Emit(OpCodes.Ldloc, 3)
Typ = GetType(Token)
ReadIL.Emit(OpCodes.Ldfld, GetType(Token).GetField("Value"))
...
ReadIL.Emit(OpCodes.Pop)
End If
ReadIL.MarkSequencePoint(doc4, 32, 1, 32, 100)
...
ReadIL.MarkSequencePoint(doc4, 35, 1, 35, 100)
...
ReadIL.MarkSequencePoint(doc4, 39, 1, 39, 100)
Dim locbldr18 As LocalBuilder = ReadIL.DeclareLocal(GetType(ImportStmt))
locbldr18.SetLocalSymInfo("istm")
ReadIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
ReadIL.Emit(OpCodes.Stloc, 8)
ReadIL.MarkSequencePoint(doc4, 40, 1, 40, 100)
Dim locbldr19 As LocalBuilder = ReadIL.DeclareLocal(GetType(Token))
locbldr19.SetLocalSymInfo("ina")
...
ReadIL.MarkSequencePoint(doc4, 42, 1, 42, 100)
Dim typ13(-1) As Type
ReadIL.Emit(OpCodes.Ldsfld, GetType(Utils.Constants).GetField("quot"))
Typ = GetType(Utils.Constants).GetField("quot").FieldType
ReDim Preserve typ13(UBound(typ13) + 1)
...
ReadIL.Emit(OpCodes.Stloc, 4)
ReadIL.MarkSequencePoint(doc4, 50, 1, 50, 100)
ReadIL.Emit(OpCodes.Ldloc, 9)
Typ = GetType(Token)
ReadIL.Emit(OpCodes.Ldloc, 4)
Typ = GetType(System.String)
...
ReadIL.Emit(OpCodes.Pop)
End If
ReadIL.MarkSequencePoint(doc4, 54, 1, 54, 100)
Dim typ18(-1) As Type
ReadIL.Emit(OpCodes.Ldloc, 9)
Typ = GetType(Token)
ReadIL.Emit(OpCodes.Ldfld, GetType(Token).GetField("Value"))
...
ReadIL.Emit(OpCodes.Pop)
End If
ReadIL.MarkSequencePoint(doc4, 57, 1, 57, 100)
ReadIL.Emit(OpCodes.Br, label0)
...
ReadIL.Emit(OpCodes.Stloc, 0)
ReadIL.MarkSequencePoint(doc4, 61, 1, 61, 100)
Dim typ21(-1) As Type
ReadIL.Emit(OpCodes.Ldloc, 0)
Typ = GetType(System.Type)
Typ03 = Typ
...
ReadIL.MarkSequencePoint(doc4, 64, 1, 64, 100)
Dim locbldr20 As LocalBuilder = ReadIL.DeclareLocal(GetType(LocimportStmt))
locbldr20.SetLocalSymInfo("listm")
ReadIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
ReadIL.Emit(OpCodes.Stloc, 10)
ReadIL.MarkSequencePoint(doc4, 65, 1, 65, 100)
Dim locbldr21 As LocalBuilder = ReadIL.DeclareLocal(GetType(Token))
locbldr21.SetLocalSymInfo("lina")
...
Typ = GetType(Token).GetField("Value").FieldType
ReadIL.Emit(OpCodes.Stloc, 4)
ReadIL.MarkSequencePoint(doc4, 72, 1, 72, 100)
ReadIL.Emit(OpCodes.Ldc_I4, CInt(1))
Typ = GetType(System.Int32)
ReadIL.Emit(OpCodes.Conv_U)
ReadIL.Emit(OpCodes.Newarr, GetType(System.Char))
...
Typ = GetType(System.String)
ReadIL.Emit(OpCodes.Stfld, GetType(Token).GetField("Value"))
ReadIL.MarkSequencePoint(doc4, 76, 1, 76, 100)
...
ReadIL.Emit(OpCodes.Pop)
End If
ReadIL.MarkSequencePoint(doc4, 79, 1, 79, 100)
Dim typ27(-1) As Type
ReadIL.Emit(OpCodes.Ldloc, 11)
Typ = GetType(Token)
ReadIL.Emit(OpCodes.Ldfld, GetType(Token).GetField("Value"))
...
ReadIL.Emit(OpCodes.Pop)
End If
ReadIL.MarkSequencePoint(doc4, 81, 1, 81, 100)
Dim typ28(-1) As Type
ReadIL.Emit(OpCodes.Ldloc, 11)
Typ = GetType(Token)
ReadIL.Emit(OpCodes.Ldfld, GetType(Token).GetField("Value"))
...
ReadIL.MarkSequencePoint(doc4, 90, 1, 90, 100)
Dim locbldr22 As LocalBuilder = ReadIL.DeclareLocal(GetType(AssemblyStmt))
locbldr22.SetLocalSymInfo("asms")
ReadIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
ReadIL.Emit(OpCodes.Stloc, 12)
ReadIL.MarkSequencePoint(doc4, 91, 1, 91, 100)
Dim locbldr23 As LocalBuilder = ReadIL.DeclareLocal(GetType(Ident))
locbldr23.SetLocalSymInfo("asmn")
...
ReadIL.MarkSequencePoint(doc4, 92, 1, 92, 100)
Dim typ31(-1) As Type
...
Dim locbldr24 As LocalBuilder = ReadIL.DeclareLocal(GetType(Token))
locbldr24.SetLocalSymInfo("asmm")
ReadIL.Emit(OpCodes.Ldloc, 12)
Typ = GetType(AssemblyStmt)
...
ReadIL.MarkSequencePoint(doc4, 95, 1, 95, 100)
ReadIL.Emit(OpCodes.Ldloc, 13)
Typ = GetType(Ident)
ReadIL.Emit(OpCodes.Ldfld, GetType(Ident).GetField("Value"))
Typ = GetType(Ident).GetField("Value").FieldType
...
Dim locbldr25 As LocalBuilder = ReadIL.DeclareLocal(GetType(VerStmt))
locbldr25.SetLocalSymInfo("asmv")
ReadIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
ReadIL.Emit(OpCodes.Stloc, 15)
ReadIL.MarkSequencePoint(doc4, 110, 1, 110, 100)
Dim locbldr26 As LocalBuilder = ReadIL.DeclareLocal(GetType(IntLiteral).MakeArrayType())
locbldr26.SetLocalSymInfo("vns")
...
Dim locbldr27 As LocalBuilder = ReadIL.DeclareLocal(GetType(IntLiteral))
locbldr27.SetLocalSymInfo("vne")
ReadIL.MarkSequencePoint(doc4, 112, 1, 112, 100)
Dim locbldr28 As LocalBuilder = ReadIL.DeclareLocal(GetType(System.Int32).MakeArrayType())
locbldr28.SetLocalSymInfo("vernos")
...
Dim locbldr29 As LocalBuilder = ReadIL.DeclareLocal(GetType(Version))
locbldr29.SetLocalSymInfo("asmver")
Dim typ36(-1) As Type
ReadIL.Emit(OpCodes.Ldloc, 18)
Typ = GetType(System.Int32).MakeArrayType()
Typ02 = Typ
...
Dim locbldr30 As LocalBuilder = ReadIL.DeclareLocal(GetType(AssemblyName))
locbldr30.SetLocalSymInfo("asmnm")
...
ReadIL.MarkSequencePoint(doc4, 123, 1, 123, 100)
Dim typ37(-1) As Type
...
Dim locbldr31 As LocalBuilder = ReadIL.DeclareLocal(GetType(AppDomain))
locbldr31.SetLocalSymInfo("cad")
...
ReadIL.MarkSequencePoint(doc4, 126, 1, 126, 100)
Dim locbldr32 As LocalBuilder = ReadIL.DeclareLocal(GetType(AssemblyBuilderAccess))
locbldr32.SetLocalSymInfo("aasv")
ReadIL.Emit(OpCodes.Ldc_I4, CInt(2))
Typ = GetType(System.Int32)
ReadIL.Emit(OpCodes.Stloc, 22)
ReadIL.MarkSequencePoint(doc4, 127, 1, 127, 100)
Dim locbldr33 As LocalBuilder = ReadIL.DeclareLocal(GetType(System.String))
locbldr33.SetLocalSymInfo("curd")
...
Dim locbldr34 As LocalBuilder = ReadIL.DeclareLocal(GetType(System.String))
locbldr34.SetLocalSymInfo("asmnme")
ReadIL.Emit(OpCodes.Ldloc, 20)
Typ = GetType(AssemblyName)
Typ03 = Typ
...
Dim locbldr35 As LocalBuilder = ReadIL.DeclareLocal(GetType(AssemblyBuilder))
locbldr35.SetLocalSymInfo("ab")
...
ReadIL.MarkSequencePoint(doc4, 132, 1, 132, 100)
Dim typ41(-1) As Type
...
ReadIL.Emit(OpCodes.Stloc, 0)
ReadIL.MarkSequencePoint(doc4, 138, 1, 138, 100)
Dim typ43(-1) As Type
ReadIL.Emit(OpCodes.Ldloc, 0)
Typ = GetType(System.Type)
Typ03 = Typ
...
ReadIL.Emit(OpCodes.Stloc, 1)
ReadIL.MarkSequencePoint(doc4, 140, 1, 140, 100)
ReadIL.Emit(OpCodes.Ldloc, 1)
Typ = GetType(System.Boolean)
ReadIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa171 As System.Reflection.Emit.Label = ReadIL.DefineLabel()
Dim tru171 As System.Reflection.Emit.Label = ReadIL.DefineLabel()
Dim cont171 As System.Reflection.Emit.Label = ReadIL.DefineLabel()
ReadIL.Emit(OpCodes.Beq, tru171)
ReadIL.Emit(OpCodes.Br, fa171)
ReadIL.MarkLabel(tru171)
ReadIL.MarkSequencePoint(doc4, 141, 1, 141, 100)
Dim locbldr36 As LocalBuilder = ReadIL.DeclareLocal(GetType(DebugStmt))
locbldr36.SetLocalSymInfo("dbgs")
ReadIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
ReadIL.Emit(OpCodes.Stloc, 26)
ReadIL.MarkSequencePoint(doc4, 142, 1, 142, 100)
...
ReadIL.MarkSequencePoint(doc4, 143, 1, 143, 100)
ReadIL.Emit(OpCodes.Br, label0)
ReadIL.MarkSequencePoint(doc4, 144, 1, 144, 100)
ReadIL.Emit(OpCodes.Br, cont171)
ReadIL.MarkLabel(fa171)
ReadIL.Emit(OpCodes.Br, cont171)
ReadIL.MarkLabel(cont171)
ReadIL.MarkSequencePoint(doc4, 146, 1, 146, 100)
...
ReadIL.Emit(OpCodes.Stloc, 0)
ReadIL.MarkSequencePoint(doc4, 147, 1, 147, 100)
Dim typ45(-1) As Type
ReadIL.Emit(OpCodes.Ldloc, 0)
Typ = GetType(System.Type)
Typ03 = Typ
...
ReadIL.Emit(OpCodes.Stloc, 1)
ReadIL.MarkSequencePoint(doc4, 149, 1, 149, 100)
ReadIL.Emit(OpCodes.Ldloc, 1)
Typ = GetType(System.Boolean)
ReadIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa172 As System.Reflection.Emit.Label = ReadIL.DefineLabel()
Dim tru172 As System.Reflection.Emit.Label = ReadIL.DefineLabel()
Dim cont172 As System.Reflection.Emit.Label = ReadIL.DefineLabel()
ReadIL.Emit(OpCodes.Beq, tru172)
ReadIL.Emit(OpCodes.Br, fa172)
ReadIL.MarkLabel(tru172)
ReadIL.MarkSequencePoint(doc4, 150, 1, 150, 100)
Dim locbldr37 As LocalBuilder = ReadIL.DeclareLocal(GetType(ClassStmt))
locbldr37.SetLocalSymInfo("clss")
ReadIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
ReadIL.Emit(OpCodes.Stloc, 27)
ReadIL.MarkSequencePoint(doc4, 152, 1, 152, 100)
...
ReadIL.MarkSequencePoint(doc4, 157, 1, 157, 100)
ReadIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
ReadIL.Emit(OpCodes.Stsfld, GetType(AsmFactory).GetField("inClass"))
ReadIL.MarkSequencePoint(doc4, 158, 1, 158, 100)
ReadIL.Emit(OpCodes.Br, cont174)
ReadIL.MarkLabel(fa174)
ReadIL.Emit(OpCodes.Br, cont174)
ReadIL.MarkLabel(cont174)
ReadIL.MarkSequencePoint(doc4, 160, 1, 160, 100)
Dim locbldr38 As LocalBuilder = ReadIL.DeclareLocal(GetType(Attributes.Attribute).MakeArrayType())
locbldr38.SetLocalSymInfo("attrs")
...
ReadIL.MarkSequencePoint(doc4, 161, 1, 161, 100)
Dim locbldr39 As LocalBuilder = ReadIL.DeclareLocal(GetType(TypeAttributes))
locbldr39.SetLocalSymInfo("ta")
Dim typ46(-1) As Type
...
ReadIL.MarkSequencePoint(doc4, 162, 1, 162, 100)
Dim locbldr40 As LocalBuilder = ReadIL.DeclareLocal(GetType(Ident))
locbldr40.SetLocalSymInfo("clssnam")
ReadIL.Emit(OpCodes.Ldloc, 27)
Typ = GetType(ClassStmt)
...
ReadIL.MarkSequencePoint(doc4, 163, 1, 163, 100)
Dim locbldr41 As LocalBuilder = ReadIL.DeclareLocal(GetType(System.String))
locbldr41.SetLocalSymInfo("clsnamstr")
ReadIL.Emit(OpCodes.Ldloc, 30)
Typ = GetType(Ident)
ReadIL.Emit(OpCodes.Ldfld, GetType(Ident).GetField("Value"))
Typ = GetType(Ident).GetField("Value").FieldType
ReadIL.Emit(OpCodes.Stloc, 31)
ReadIL.MarkSequencePoint(doc4, 164, 1, 164, 100)
Dim locbldr42 As LocalBuilder = ReadIL.DeclareLocal(GetType(TypeTok))
locbldr42.SetLocalSymInfo("inhclstok")
ReadIL.Emit(OpCodes.Ldloc, 27)
Typ = GetType(ClassStmt)
...
ReadIL.MarkSequencePoint(doc4, 165, 1, 165, 100)
Dim locbldr43 As LocalBuilder = ReadIL.DeclareLocal(GetType(System.Type))
locbldr43.SetLocalSymInfo("inhtyp")
ReadIL.Emit(OpCodes.Ldnull)
ReadIL.Emit(OpCodes.Stloc, 33)
ReadIL.MarkSequencePoint(doc4, 166, 1, 166, 100)
Dim locbldr44 As LocalBuilder = ReadIL.DeclareLocal(GetType(System.Type))
locbldr44.SetLocalSymInfo("reft")
...
ReadIL.MarkSequencePoint(doc4, 167, 1, 167, 100)
Dim locbldr45 As LocalBuilder = ReadIL.DeclareLocal(GetType(System.Int32))
locbldr45.SetLocalSymInfo("cmp")
Dim typ47(-1) As Type
ReadIL.Emit(OpCodes.Ldloc, 32)
Typ = GetType(TypeTok)
...
ReadIL.MarkSequencePoint(doc4, 169, 1, 169, 100)
...
ReadIL.MarkSequencePoint(doc4, 170, 1, 170, 100)
...
ReadIL.MarkSequencePoint(doc4, 171, 1, 171, 100)
...
ReadIL.Emit(OpCodes.Stloc, 33)
ReadIL.MarkSequencePoint(doc4, 172, 1, 172, 100)
ReadIL.Emit(OpCodes.Br, cont176)
ReadIL.MarkLabel(fa176)
ReadIL.MarkSequencePoint(doc4, 173, 1, 173, 100)
Dim typ49(-1) As Type
ReadIL.Emit(OpCodes.Ldloc, 32)
Typ = GetType(TypeTok)
ReadIL.Emit(OpCodes.Ldfld, GetType(TypeTok).GetField("Value"))
...
ReadIL.Emit(OpCodes.Stloc, 33)
ReadIL.MarkSequencePoint(doc4, 174, 1, 174, 100)
ReadIL.Emit(OpCodes.Br, cont176)
ReadIL.MarkLabel(cont176)
ReadIL.MarkSequencePoint(doc4, 175, 1, 175, 100)
ReadIL.Emit(OpCodes.Br, cont175)
ReadIL.MarkLabel(fa175)
ReadIL.MarkSequencePoint(doc4, 176, 1, 176, 100)
ReadIL.Emit(OpCodes.Ldloc, 34)
Typ = GetType(System.Type)
ReadIL.Emit(OpCodes.Stloc, 33)
ReadIL.MarkSequencePoint(doc4, 177, 1, 177, 100)
ReadIL.Emit(OpCodes.Br, cont175)
ReadIL.MarkLabel(cont175)
ReadIL.MarkSequencePoint(doc4, 180, 1, 180, 100)
ReadIL.Emit(OpCodes.Ldsfld, GetType(AsmFactory).GetField("isNested"))
Typ = GetType(AsmFactory).GetField("isNested").FieldType
ReadIL.Emit(OpCodes.Ldc_I4, 0)
Typ = GetType(System.Boolean)
...
ReadIL.MarkSequencePoint(doc4, 181, 1, 181, 100)
Dim locbldr46 As LocalBuilder = ReadIL.DeclareLocal(GetType(ModuleBuilder))
locbldr46.SetLocalSymInfo("mdlbld")
...
ReadIL.MarkSequencePoint(doc4, 182, 1, 182, 100)
Dim typ50(-1) As Type
...
ReadIL.Emit(OpCodes.Stloc, 31)
ReadIL.MarkSequencePoint(doc4, 183, 1, 183, 100)
Dim typ51(-1) As Type
...
ReadIL.MarkSequencePoint(doc4, 185, 1, 185, 100)
Dim typ52(-1) As Type
...
ReadIL.Emit(OpCodes.Pop)
End If
ReadIL.MarkSequencePoint(doc4, 186, 1, 186, 100)
Dim typ53(-1) As Type
ReadIL.Emit(OpCodes.Ldloc, 31)
Typ = GetType(System.String)
ReDim Preserve typ53(UBound(typ53) + 1)
...
ReadIL.Emit(OpCodes.Pop)
End If
ReadIL.MarkSequencePoint(doc4, 187, 1, 187, 100)
ReadIL.Emit(OpCodes.Br, cont177)
ReadIL.MarkLabel(fa177)
ReadIL.MarkSequencePoint(doc4, 188, 1, 188, 100)
...
ReadIL.MarkSequencePoint(doc4, 189, 1, 189, 100)
Dim locbldr47 As LocalBuilder = ReadIL.DeclareLocal(GetType(TypeBuilder))
locbldr47.SetLocalSymInfo("ctb2")
...
ReadIL.MarkSequencePoint(doc4, 190, 1, 190, 100)
Dim typ54(-1) As Type
...
ReadIL.Emit(OpCodes.Pop)
End If
ReadIL.MarkSequencePoint(doc4, 191, 1, 191, 100)
Dim typ55(-1) As Type
ReadIL.Emit(OpCodes.Ldloc, 31)
Typ = GetType(System.String)
ReDim Preserve typ55(UBound(typ55) + 1)
...
ReadIL.Emit(OpCodes.Pop)
End If
ReadIL.MarkSequencePoint(doc4, 192, 1, 192, 100)
Dim typ56(-1) As Type
...
ReadIL.Emit(OpCodes.Stsfld, GetType(AsmFactory).GetField("CurnTypB"))
ReadIL.MarkSequencePoint(doc4, 193, 1, 193, 100)
ReadIL.Emit(OpCodes.Br, cont177)
ReadIL.MarkLabel(cont177)
ReadIL.MarkSequencePoint(doc4, 195, 1, 195, 100)
ReadIL.Emit(OpCodes.Br, label0)
ReadIL.MarkSequencePoint(doc4, 196, 1, 196, 100)
ReadIL.Emit(OpCodes.Br, cont172)
ReadIL.MarkLabel(fa172)
ReadIL.Emit(OpCodes.Br, cont172)
ReadIL.MarkLabel(cont172)
ReadIL.MarkSequencePoint(doc4, 198, 1, 198, 100)
...
ReadIL.Emit(OpCodes.Stloc, 0)
ReadIL.MarkSequencePoint(doc4, 199, 1, 199, 100)
Dim typ58(-1) As Type
ReadIL.Emit(OpCodes.Ldloc, 0)
Typ = GetType(System.Type)
Typ03 = Typ
...
ReadIL.Emit(OpCodes.Stloc, 1)
ReadIL.MarkSequencePoint(doc4, 201, 1, 201, 100)
ReadIL.Emit(OpCodes.Ldloc, 1)
Typ = GetType(System.Boolean)
ReadIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
...
ReadIL.MarkSequencePoint(doc4, 202, 1, 202, 100)
...
ReadIL.Emit(OpCodes.Pop)
End If
ReadIL.MarkSequencePoint(doc4, 203, 1, 203, 100)
ReadIL.Emit(OpCodes.Ldsfld, GetType(AsmFactory).GetField("isNested"))
Typ = GetType(AsmFactory).GetField("isNested").FieldType
ReadIL.Emit(OpCodes.Ldc_I4, 0)
Typ = GetType(System.Boolean)
...
ReadIL.MarkSequencePoint(doc4, 204, 1, 204, 100)
ReadIL.Emit(OpCodes.Ldc_I4, 0)
Typ = GetType(System.Boolean)
ReadIL.Emit(OpCodes.Stsfld, GetType(AsmFactory).GetField("inClass"))
ReadIL.MarkSequencePoint(doc4, 205, 1, 205, 100)
ReadIL.Emit(OpCodes.Br, cont179)
ReadIL.MarkLabel(fa179)
ReadIL.Emit(OpCodes.Br, cont179)
ReadIL.MarkLabel(cont179)
ReadIL.MarkSequencePoint(doc4, 206, 1, 206, 100)
ReadIL.Emit(OpCodes.Ldsfld, GetType(AsmFactory).GetField("isNested"))
Typ = GetType(AsmFactory).GetField("isNested").FieldType
ReadIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
...
ReadIL.MarkSequencePoint(doc4, 207, 1, 207, 100)
ReadIL.Emit(OpCodes.Ldsfld, GetType(AsmFactory).GetField("CurnTypB2"))
Typ = GetType(AsmFactory).GetField("CurnTypB2").FieldType
ReadIL.Emit(OpCodes.Stsfld, GetType(AsmFactory).GetField("CurnTypB"))
ReadIL.MarkSequencePoint(doc4, 208, 1, 208, 100)
ReadIL.Emit(OpCodes.Ldc_I4, 0)
Typ = GetType(System.Boolean)
ReadIL.Emit(OpCodes.Stsfld, GetType(AsmFactory).GetField("isNested"))
ReadIL.MarkSequencePoint(doc4, 209, 1, 209, 100)
ReadIL.Emit(OpCodes.Br, cont180)
ReadIL.MarkLabel(fa180)
ReadIL.Emit(OpCodes.Br, cont180)
ReadIL.MarkLabel(cont180)
ReadIL.MarkSequencePoint(doc4, 210, 1, 210, 100)
ReadIL.Emit(OpCodes.Br, label0)
ReadIL.MarkSequencePoint(doc4, 211, 1, 211, 100)
ReadIL.Emit(OpCodes.Br, cont178)
ReadIL.MarkLabel(fa178)
ReadIL.Emit(OpCodes.Br, cont178)
ReadIL.MarkLabel(cont178)
ReadIL.MarkSequencePoint(doc4, 213, 1, 213, 100)
ReadIL.MarkLabel(label0)
ReadIL.MarkSequencePoint(doc4, 215, 1, 215, 100)
...
Dim locbldr48 As LocalBuilder = EmitMSILIL.DeclareLocal(GetType(System.Int32))
...
Dim locbldr49 As LocalBuilder = EmitMSILIL.DeclareLocal(GetType(System.Int32))
...
Dim locbldr50 As LocalBuilder = EmitMSILIL.DeclareLocal(GetType(Stmt))
locbldr50.SetLocalSymInfo("stm")
EmitMSILIL.Emit(OpCodes.Ldnull)
EmitMSILIL.Emit(OpCodes.Stloc, 2)
EmitMSILIL.MarkSequencePoint(doc5, 8, 1, 8, 100)
Dim locbldr51 As LocalBuilder = EmitMSILIL.DeclareLocal(GetType(System.Type))
locbldr51.SetLocalSymInfo("typ")
EmitMSILIL.MarkSequencePoint(doc5, 9, 1, 9, 100)
Dim locbldr52 As LocalBuilder = EmitMSILIL.DeclareLocal(GetType(System.Boolean))
locbldr52.SetLocalSymInfo("b")
...
Dim locbldr53 As LocalBuilder = EmitMSILIL.DeclareLocal(asm.GetType("dylan.NET.Tokenizer.CodeGen.StmtReader"))
locbldr53.SetLocalSymInfo("sr")
...
Dim locbldr54 As LocalBuilder = EmitMSILIL.DeclareLocal(GetType(AssemblyBuilder))
locbldr54.SetLocalSymInfo("ab")
...
EmitMSILIL.Emit(OpCodes.Pop)
End If
EmitMSILIL.MarkSequencePoint(doc5, 35, 1, 35, 100)
...
EmitMSILIL.MarkSequencePoint(doc5, 37, 1, 37, 100)
EmitMSILIL.Emit(OpCodes.Br, label0)
EmitMSILIL.MarkSequencePoint(doc5, 38, 1, 38, 100)
EmitMSILIL.Emit(OpCodes.Br, cont182)
EmitMSILIL.MarkLabel(cont182)
EmitMSILIL.MarkSequencePoint(doc5, 40, 1, 40, 100)
EmitMSILIL.MarkLabel(label1)
EmitMSILIL.MarkSequencePoint(doc5, 42, 1, 42, 100)
...
doc3 = mdl.DefineDocument("E:\Code\dylannet\compiler\helpers.txt", Guid.Empty, Guid.Empty, Guid.Empty)
