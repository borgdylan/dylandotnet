...
Sub Importer()
Dim Importer As TypeBuilder = mdl.DefineType("dylan.NET.Tokenizer.CodeGen" & "." & "Importer", TypeAttributes.Public Or TypeAttributes.AutoLayout Or TypeAttributes.AnsiClass, GetType(System.Object))
...
ctor0IL.Emit(OpCodes.Conv_U)
ctor0IL.Emit(OpCodes.Newarr, GetType(System.String))
ctor0IL.Emit(OpCodes.Stsfld, LocImps)
...
Dim AddAsmparam00 As ParameterBuilder = AddAsm.DefineParameter(0, ParameterAttributes.RetVal, "")
Dim AddAsmparam01 As ParameterBuilder = AddAsm.DefineParameter(1, ParameterAttributes.None, "asm")
AddAsmIL.MarkSequencePoint(doc4, 15, 1, 15, 100)
Dim locbldr2 As LocalBuilder = AddAsmIL.DeclareLocal(GetType(System.Int32))
...
AddAsmIL.MarkSequencePoint(doc4, 16, 1, 16, 100)
Dim locbldr3 As LocalBuilder = AddAsmIL.DeclareLocal(GetType(System.Int32))
...
AddAsmIL.MarkSequencePoint(doc4, 17, 1, 17, 100)
Dim locbldr4 As LocalBuilder = AddAsmIL.DeclareLocal(GetType(System.Int32))
...
AddAsmIL.MarkSequencePoint(doc4, 18, 1, 18, 100)
Dim locbldr5 As LocalBuilder = AddAsmIL.DeclareLocal(GetType(System.Int32))
locbldr5.SetLocalSymInfo("i")
AddAsmIL.Emit(OpCodes.Ldc_I4, CInt(-1))
Typ = GetType(System.Int32)
AddAsmIL.Emit(OpCodes.Stloc, 3)
AddAsmIL.MarkSequencePoint(doc4, 20, 1, 20, 100)
Dim locbldr6 As LocalBuilder = AddAsmIL.DeclareLocal(GetType(Assembly).MakeArrayType())
...
AddAsmIL.MarkSequencePoint(doc4, 22, 1, 22, 100)
Dim label0 As System.Reflection.Emit.Label = AddAsmIL.DefineLabel()
AddAsmIL.MarkSequencePoint(doc4, 23, 1, 23, 100)
Dim label1 As System.Reflection.Emit.Label = AddAsmIL.DefineLabel()
AddAsmIL.MarkSequencePoint(doc4, 25, 1, 25, 100)
AddAsmIL.MarkLabel(label0)
AddAsmIL.MarkSequencePoint(doc4, 27, 1, 27, 100)
...
AddAsmIL.Emit(OpCodes.Add)
AddAsmIL.Emit(OpCodes.Stloc, 3)
AddAsmIL.MarkSequencePoint(doc4, 29, 1, 29, 100)
AddAsmIL.Emit(OpCodes.Ldloc, 0)
Typ = GetType(System.Int32)
AddAsmIL.Emit(OpCodes.Ldc_I4, CInt(0))
Typ = GetType(System.Int32)
Dim fa155 As System.Reflection.Emit.Label = AddAsmIL.DefineLabel()
Dim tru155 As System.Reflection.Emit.Label = AddAsmIL.DefineLabel()
Dim cont155 As System.Reflection.Emit.Label = AddAsmIL.DefineLabel()
AddAsmIL.Emit(OpCodes.Bgt, tru155)
AddAsmIL.Emit(OpCodes.Br, fa155)
AddAsmIL.MarkLabel(tru155)
AddAsmIL.MarkSequencePoint(doc4, 31, 1, 31, 100)
...
AddAsmIL.MarkSequencePoint(doc4, 33, 1, 33, 100)
AddAsmIL.Emit(OpCodes.Br, cont155)
AddAsmIL.MarkLabel(fa155)
AddAsmIL.Emit(OpCodes.Br, cont155)
AddAsmIL.MarkLabel(cont155)
AddAsmIL.MarkSequencePoint(doc4, 35, 1, 35, 100)
AddAsmIL.Emit(OpCodes.Ldloc, 3)
Typ = GetType(System.Int32)
AddAsmIL.Emit(OpCodes.Ldloc, 2)
Typ = GetType(System.Int32)
Dim fa156 As System.Reflection.Emit.Label = AddAsmIL.DefineLabel()
Dim tru156 As System.Reflection.Emit.Label = AddAsmIL.DefineLabel()
Dim cont156 As System.Reflection.Emit.Label = AddAsmIL.DefineLabel()
AddAsmIL.Emit(OpCodes.Beq, tru156)
AddAsmIL.Emit(OpCodes.Br, fa156)
AddAsmIL.MarkLabel(tru156)
AddAsmIL.MarkSequencePoint(doc4, 36, 1, 36, 100)
AddAsmIL.Emit(OpCodes.Br, label1)
AddAsmIL.MarkSequencePoint(doc4, 37, 1, 37, 100)
AddAsmIL.Emit(OpCodes.Br, cont156)
AddAsmIL.MarkLabel(fa156)
AddAsmIL.MarkSequencePoint(doc4, 38, 1, 38, 100)
AddAsmIL.Emit(OpCodes.Ldloc, 2)
Typ = GetType(System.Int32)
AddAsmIL.Emit(OpCodes.Ldc_I4, CInt(-1))
Typ = GetType(System.Int32)
Dim fa157 As System.Reflection.Emit.Label = AddAsmIL.DefineLabel()
Dim tru157 As System.Reflection.Emit.Label = AddAsmIL.DefineLabel()
Dim cont157 As System.Reflection.Emit.Label = AddAsmIL.DefineLabel()
AddAsmIL.Emit(OpCodes.Beq, fa157)
AddAsmIL.Emit(OpCodes.Br, tru157)
AddAsmIL.MarkLabel(tru157)
AddAsmIL.MarkSequencePoint(doc4, 39, 1, 39, 100)
AddAsmIL.Emit(OpCodes.Br, label0)
AddAsmIL.MarkSequencePoint(doc4, 40, 1, 40, 100)
AddAsmIL.Emit(OpCodes.Br, cont157)
AddAsmIL.MarkLabel(fa157)
AddAsmIL.MarkSequencePoint(doc4, 41, 1, 41, 100)
AddAsmIL.Emit(OpCodes.Br, label1)
AddAsmIL.MarkSequencePoint(doc4, 42, 1, 42, 100)
AddAsmIL.Emit(OpCodes.Br, cont157)
AddAsmIL.MarkLabel(cont157)
AddAsmIL.MarkSequencePoint(doc4, 43, 1, 43, 100)
AddAsmIL.Emit(OpCodes.Br, cont156)
AddAsmIL.MarkLabel(cont156)
AddAsmIL.MarkSequencePoint(doc4, 45, 1, 45, 100)
AddAsmIL.MarkLabel(label1)
AddAsmIL.MarkSequencePoint(doc4, 47, 1, 47, 100)
AddAsmIL.Emit(OpCodes.Ldloc, 4)
Typ = GetType(Assembly).MakeArrayType()
Typ02 = Typ
AddAsmIL.Emit(OpCodes.Ldloc, 0)
...
AddAsmIL.Emit(OpCodes.Stelem, GetType(Assembly).MakeArrayType().GetElementType())
AddAsmIL.MarkSequencePoint(doc4, 49, 1, 49, 100)
AddAsmIL.Emit(OpCodes.Ldloc, 4)
Typ = GetType(Assembly).MakeArrayType()
AddAsmIL.Emit(OpCodes.Stsfld, Asms)
AddAsmIL.MarkSequencePoint(doc4, 51, 1, 51, 100)
...
Dim addelemparam00 As ParameterBuilder = addelem.DefineParameter(0, ParameterAttributes.RetVal, "")
...
Dim locbldr7 As LocalBuilder = addelemIL.DeclareLocal(GetType(System.Int32))
...
addelemIL.MarkSequencePoint(doc4, 56, 1, 56, 100)
Dim locbldr8 As LocalBuilder = addelemIL.DeclareLocal(GetType(System.Int32))
...
addelemIL.MarkSequencePoint(doc4, 57, 1, 57, 100)
Dim locbldr9 As LocalBuilder = addelemIL.DeclareLocal(GetType(System.Int32))
...
addelemIL.MarkSequencePoint(doc4, 58, 1, 58, 100)
Dim locbldr10 As LocalBuilder = addelemIL.DeclareLocal(GetType(System.Int32))
locbldr10.SetLocalSymInfo("i")
addelemIL.Emit(OpCodes.Ldc_I4, CInt(-1))
Typ = GetType(System.Int32)
addelemIL.Emit(OpCodes.Stloc, 3)
addelemIL.MarkSequencePoint(doc4, 60, 1, 60, 100)
Dim locbldr11 As LocalBuilder = addelemIL.DeclareLocal(GetType(System.String).MakeArrayType())
...
addelemIL.MarkSequencePoint(doc4, 62, 1, 62, 100)
Dim label2 As System.Reflection.Emit.Label = addelemIL.DefineLabel()
addelemIL.MarkSequencePoint(doc4, 63, 1, 63, 100)
Dim label3 As System.Reflection.Emit.Label = addelemIL.DefineLabel()
addelemIL.MarkSequencePoint(doc4, 65, 1, 65, 100)
addelemIL.MarkLabel(label2)
addelemIL.MarkSequencePoint(doc4, 67, 1, 67, 100)
...
addelemIL.Emit(OpCodes.Add)
addelemIL.Emit(OpCodes.Stloc, 3)
addelemIL.MarkSequencePoint(doc4, 69, 1, 69, 100)
addelemIL.Emit(OpCodes.Ldloc, 0)
Typ = GetType(System.Int32)
addelemIL.Emit(OpCodes.Ldc_I4, CInt(0))
Typ = GetType(System.Int32)
Dim fa158 As System.Reflection.Emit.Label = addelemIL.DefineLabel()
Dim tru158 As System.Reflection.Emit.Label = addelemIL.DefineLabel()
Dim cont158 As System.Reflection.Emit.Label = addelemIL.DefineLabel()
addelemIL.Emit(OpCodes.Bgt, tru158)
addelemIL.Emit(OpCodes.Br, fa158)
addelemIL.MarkLabel(tru158)
addelemIL.MarkSequencePoint(doc4, 71, 1, 71, 100)
...
addelemIL.MarkSequencePoint(doc4, 73, 1, 73, 100)
addelemIL.Emit(OpCodes.Br, cont158)
addelemIL.MarkLabel(fa158)
addelemIL.Emit(OpCodes.Br, cont158)
addelemIL.MarkLabel(cont158)
addelemIL.MarkSequencePoint(doc4, 75, 1, 75, 100)
addelemIL.Emit(OpCodes.Ldloc, 3)
Typ = GetType(System.Int32)
addelemIL.Emit(OpCodes.Ldloc, 2)
Typ = GetType(System.Int32)
Dim fa159 As System.Reflection.Emit.Label = addelemIL.DefineLabel()
Dim tru159 As System.Reflection.Emit.Label = addelemIL.DefineLabel()
Dim cont159 As System.Reflection.Emit.Label = addelemIL.DefineLabel()
addelemIL.Emit(OpCodes.Beq, tru159)
addelemIL.Emit(OpCodes.Br, fa159)
addelemIL.MarkLabel(tru159)
addelemIL.MarkSequencePoint(doc4, 76, 1, 76, 100)
addelemIL.Emit(OpCodes.Br, label3)
addelemIL.MarkSequencePoint(doc4, 77, 1, 77, 100)
addelemIL.Emit(OpCodes.Br, cont159)
addelemIL.MarkLabel(fa159)
addelemIL.MarkSequencePoint(doc4, 78, 1, 78, 100)
addelemIL.Emit(OpCodes.Ldloc, 2)
Typ = GetType(System.Int32)
addelemIL.Emit(OpCodes.Ldc_I4, CInt(-1))
Typ = GetType(System.Int32)
Dim fa160 As System.Reflection.Emit.Label = addelemIL.DefineLabel()
Dim tru160 As System.Reflection.Emit.Label = addelemIL.DefineLabel()
Dim cont160 As System.Reflection.Emit.Label = addelemIL.DefineLabel()
addelemIL.Emit(OpCodes.Beq, fa160)
addelemIL.Emit(OpCodes.Br, tru160)
addelemIL.MarkLabel(tru160)
addelemIL.MarkSequencePoint(doc4, 79, 1, 79, 100)
addelemIL.Emit(OpCodes.Br, label2)
addelemIL.MarkSequencePoint(doc4, 80, 1, 80, 100)
addelemIL.Emit(OpCodes.Br, cont160)
addelemIL.MarkLabel(fa160)
addelemIL.MarkSequencePoint(doc4, 81, 1, 81, 100)
addelemIL.Emit(OpCodes.Br, label3)
addelemIL.MarkSequencePoint(doc4, 82, 1, 82, 100)
addelemIL.Emit(OpCodes.Br, cont160)
addelemIL.MarkLabel(cont160)
addelemIL.MarkSequencePoint(doc4, 83, 1, 83, 100)
addelemIL.Emit(OpCodes.Br, cont159)
addelemIL.MarkLabel(cont159)
addelemIL.MarkSequencePoint(doc4, 85, 1, 85, 100)
addelemIL.MarkLabel(label3)
addelemIL.MarkSequencePoint(doc4, 87, 1, 87, 100)
addelemIL.Emit(OpCodes.Ldloc, 4)
Typ = GetType(System.String).MakeArrayType()
Typ02 = Typ
addelemIL.Emit(OpCodes.Ldloc, 0)
...
Typ = GetType(System.String)
addelemIL.Emit(OpCodes.Stelem, GetType(System.String).MakeArrayType().GetElementType())
addelemIL.MarkSequencePoint(doc4, 89, 1, 89, 100)
addelemIL.Emit(OpCodes.Ldloc, 4)
Typ = GetType(System.String).MakeArrayType()
addelemIL.MarkSequencePoint(doc4, 91, 1, 91, 100)
...
Dim AddImpparam00 As ParameterBuilder = AddImp.DefineParameter(0, ParameterAttributes.RetVal, "")
Dim AddImpparam01 As ParameterBuilder = AddImp.DefineParameter(1, ParameterAttributes.None, "imp")
AddImpIL.MarkSequencePoint(doc4, 94, 1, 94, 100)
Dim typ3(-1) As Type
...
AddImpIL.MarkSequencePoint(doc4, 95, 1, 95, 100)
...
Dim AddLocImpparam00 As ParameterBuilder = AddLocImp.DefineParameter(0, ParameterAttributes.RetVal, "")
Dim AddLocImpparam01 As ParameterBuilder = AddLocImp.DefineParameter(1, ParameterAttributes.None, "imp")
AddLocImpIL.MarkSequencePoint(doc4, 98, 1, 98, 100)
Dim typ5(-1) As Type
AddLocImpIL.Emit(OpCodes.Ldsfld, LocImps)
Typ = LocImps.FieldType
ReDim Preserve typ5(UBound(typ5) + 1)
typ5(UBound(typ5)) = Typ
...
Typ = addelem.ReturnType
AddLocImpIL.Emit(OpCodes.Stsfld, LocImps)
AddLocImpIL.MarkSequencePoint(doc4, 99, 1, 99, 100)
...
Sub Loader()
Dim Loader As TypeBuilder = mdl.DefineType("dylan.NET.Tokenizer.CodeGen" & "." & "Loader", TypeAttributes.Public Or TypeAttributes.AutoLayout Or TypeAttributes.AnsiClass, GetType(System.Object))
...
ctor0IL.MarkSequencePoint(doc5, 11, 1, 11, 100)
...
Dim LoadClassparam00 As ParameterBuilder = LoadClass.DefineParameter(0, ParameterAttributes.RetVal, "")
Dim LoadClassparam01 As ParameterBuilder = LoadClass.DefineParameter(1, ParameterAttributes.None, "name")
LoadClassIL.MarkSequencePoint(doc5, 18, 1, 18, 100)
Dim locbldr12 As LocalBuilder = LoadClassIL.DeclareLocal(GetType(System.Type))
locbldr12.SetLocalSymInfo("typ")
LoadClassIL.Emit(OpCodes.Ldnull)
LoadClassIL.Emit(OpCodes.Stloc, 0)
LoadClassIL.MarkSequencePoint(doc5, 19, 1, 19, 100)
Dim locbldr13 As LocalBuilder = LoadClassIL.DeclareLocal(GetType(System.Int32))
locbldr13.SetLocalSymInfo("i")
LoadClassIL.Emit(OpCodes.Ldc_I4, CInt(-1))
Typ = GetType(System.Int32)
LoadClassIL.Emit(OpCodes.Stloc, 1)
LoadClassIL.MarkSequencePoint(doc5, 20, 1, 20, 100)
Dim locbldr14 As LocalBuilder = LoadClassIL.DeclareLocal(GetType(System.Int32))
locbldr14.SetLocalSymInfo("len")
LoadClassIL.Emit(OpCodes.Ldsfld, asm.GetType("dylan.NET.Tokenizer.CodeGen.Importer").GetField("Asms"))
Typ = asm.GetType("dylan.NET.Tokenizer.CodeGen.Importer").GetField("Asms").FieldType
...
LoadClassIL.MarkSequencePoint(doc5, 21, 1, 21, 100)
Dim locbldr15 As LocalBuilder = LoadClassIL.DeclareLocal(GetType(Assembly))
locbldr15.SetLocalSymInfo("curasm")
LoadClassIL.Emit(OpCodes.Ldnull)
LoadClassIL.Emit(OpCodes.Stloc, 3)
LoadClassIL.MarkSequencePoint(doc5, 22, 1, 22, 100)
Dim locbldr16 As LocalBuilder = LoadClassIL.DeclareLocal(GetType(System.Int32))
locbldr16.SetLocalSymInfo("j")
LoadClassIL.Emit(OpCodes.Ldc_I4, CInt(-1))
Typ = GetType(System.Int32)
LoadClassIL.Emit(OpCodes.Stloc, 4)
LoadClassIL.MarkSequencePoint(doc5, 23, 1, 23, 100)
Dim locbldr17 As LocalBuilder = LoadClassIL.DeclareLocal(GetType(System.Int32))
locbldr17.SetLocalSymInfo("len2")
LoadClassIL.Emit(OpCodes.Ldsfld, asm.GetType("dylan.NET.Tokenizer.CodeGen.Importer").GetField("Imps"))
Typ = asm.GetType("dylan.NET.Tokenizer.CodeGen.Importer").GetField("Imps").FieldType
LoadClassIL.Emit(OpCodes.Ldlen)
LoadClassIL.Emit(OpCodes.Conv_I4)
Typ = GetType(System.Int32)
LoadClassIL.Emit(OpCodes.Ldc_I4, CInt(1))
...
LoadClassIL.MarkSequencePoint(doc5, 24, 1, 24, 100)
Dim locbldr18 As LocalBuilder = LoadClassIL.DeclareLocal(GetType(System.String))
locbldr18.SetLocalSymInfo("curns")
LoadClassIL.Emit(OpCodes.Ldstr, "")
Typ = GetType(System.String)
LoadClassIL.Emit(OpCodes.Stloc, 6)
LoadClassIL.MarkSequencePoint(doc5, 25, 1, 25, 100)
Dim locbldr19 As LocalBuilder = LoadClassIL.DeclareLocal(GetType(System.String))
locbldr19.SetLocalSymInfo("tmpstr")
LoadClassIL.Emit(OpCodes.Ldstr, "")
Typ = GetType(System.String)
LoadClassIL.Emit(OpCodes.Stloc, 7)
LoadClassIL.MarkSequencePoint(doc5, 26, 1, 26, 100)
Dim locbldr20 As LocalBuilder = LoadClassIL.DeclareLocal(GetType(System.Boolean))
locbldr20.SetLocalSymInfo("nest")
LoadClassIL.Emit(OpCodes.Ldc_I4, 0)
Typ = GetType(System.Boolean)
LoadClassIL.Emit(OpCodes.Stloc, 8)
LoadClassIL.MarkSequencePoint(doc5, 28, 1, 28, 100)
Dim label0 As System.Reflection.Emit.Label = LoadClassIL.DefineLabel()
LoadClassIL.MarkSequencePoint(doc5, 29, 1, 29, 100)
Dim label1 As System.Reflection.Emit.Label = LoadClassIL.DefineLabel()
LoadClassIL.MarkSequencePoint(doc5, 30, 1, 30, 100)
Dim label2 As System.Reflection.Emit.Label = LoadClassIL.DefineLabel()
LoadClassIL.MarkSequencePoint(doc5, 31, 1, 31, 100)
Dim label3 As System.Reflection.Emit.Label = LoadClassIL.DefineLabel()
LoadClassIL.MarkSequencePoint(doc5, 32, 1, 32, 100)
Dim label4 As System.Reflection.Emit.Label = LoadClassIL.DefineLabel()
LoadClassIL.MarkSequencePoint(doc5, 34, 1, 34, 100)
Dim locbldr21 As LocalBuilder = LoadClassIL.DeclareLocal(GetType(System.String).MakeArrayType())
locbldr21.SetLocalSymInfo("na")
Dim typ1(-1) As Type
...
LoadClassIL.MarkSequencePoint(doc5, 35, 1, 35, 100)
...
LoadClassIL.MarkSequencePoint(doc5, 36, 1, 36, 100)
LoadClassIL.Emit(OpCodes.Ldloc, 9)
Typ = GetType(System.String).MakeArrayType()
LoadClassIL.Emit(OpCodes.Ldlen)
LoadClassIL.Emit(OpCodes.Conv_I4)
...
LoadClassIL.Emit(OpCodes.Ldc_I4, CInt(1))
Typ = GetType(System.Int32)
Dim fa161 As System.Reflection.Emit.Label = LoadClassIL.DefineLabel()
Dim tru161 As System.Reflection.Emit.Label = LoadClassIL.DefineLabel()
Dim cont161 As System.Reflection.Emit.Label = LoadClassIL.DefineLabel()
LoadClassIL.Emit(OpCodes.Bgt, tru161)
LoadClassIL.Emit(OpCodes.Br, fa161)
LoadClassIL.MarkLabel(tru161)
LoadClassIL.MarkSequencePoint(doc5, 37, 1, 37, 100)
LoadClassIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
LoadClassIL.Emit(OpCodes.Stloc, 8)
LoadClassIL.MarkSequencePoint(doc5, 38, 1, 38, 100)
LoadClassIL.Emit(OpCodes.Br, cont161)
LoadClassIL.MarkLabel(fa161)
LoadClassIL.Emit(OpCodes.Br, cont161)
LoadClassIL.MarkLabel(cont161)
LoadClassIL.MarkSequencePoint(doc5, 40, 1, 40, 100)
LoadClassIL.MarkLabel(label0)
LoadClassIL.MarkSequencePoint(doc5, 41, 1, 41, 100)
...
LoadClassIL.Emit(OpCodes.Stloc, 1)
LoadClassIL.MarkSequencePoint(doc5, 43, 1, 43, 100)
LoadClassIL.Emit(OpCodes.Ldsfld, asm.GetType("dylan.NET.Tokenizer.CodeGen.Importer").GetField("Asms"))
Typ = asm.GetType("dylan.NET.Tokenizer.CodeGen.Importer").GetField("Asms").FieldType
Typ02 = Typ
LoadClassIL.Emit(OpCodes.Ldloc, 1)
...
Typ = Typ.GetElementType()
LoadClassIL.Emit(OpCodes.Stloc, 3)
LoadClassIL.MarkSequencePoint(doc5, 45, 1, 45, 100)
Dim typ2(-1) As Type
...
LoadClassIL.Emit(OpCodes.Stloc, 0)
LoadClassIL.MarkSequencePoint(doc5, 46, 1, 46, 100)
LoadClassIL.Emit(OpCodes.Ldloc, 0)
Typ = GetType(System.Type)
LoadClassIL.Emit(OpCodes.Ldnull)
Dim fa162 As System.Reflection.Emit.Label = LoadClassIL.DefineLabel()
Dim tru162 As System.Reflection.Emit.Label = LoadClassIL.DefineLabel()
Dim cont162 As System.Reflection.Emit.Label = LoadClassIL.DefineLabel()
LoadClassIL.Emit(OpCodes.Beq, tru162)
LoadClassIL.Emit(OpCodes.Br, fa162)
LoadClassIL.MarkLabel(tru162)
LoadClassIL.MarkSequencePoint(doc5, 47, 1, 47, 100)
LoadClassIL.Emit(OpCodes.Br, cont162)
LoadClassIL.MarkLabel(fa162)
LoadClassIL.MarkSequencePoint(doc5, 48, 1, 48, 100)
LoadClassIL.Emit(OpCodes.Ldloc, 8)
Typ = GetType(System.Boolean)
LoadClassIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa163 As System.Reflection.Emit.Label = LoadClassIL.DefineLabel()
Dim tru163 As System.Reflection.Emit.Label = LoadClassIL.DefineLabel()
Dim cont163 As System.Reflection.Emit.Label = LoadClassIL.DefineLabel()
LoadClassIL.Emit(OpCodes.Beq, tru163)
LoadClassIL.Emit(OpCodes.Br, fa163)
LoadClassIL.MarkLabel(tru163)
LoadClassIL.MarkSequencePoint(doc5, 49, 1, 49, 100)
Dim typ3(-1) As Type
LoadClassIL.Emit(OpCodes.Ldloc, 0)
Typ = GetType(System.Type)
Typ03 = Typ
...
LoadClassIL.Emit(OpCodes.Stloc, 0)
LoadClassIL.MarkSequencePoint(doc5, 50, 1, 50, 100)
LoadClassIL.Emit(OpCodes.Br, cont163)
LoadClassIL.MarkLabel(fa163)
LoadClassIL.Emit(OpCodes.Br, cont163)
LoadClassIL.MarkLabel(cont163)
LoadClassIL.MarkSequencePoint(doc5, 51, 1, 51, 100)
LoadClassIL.Emit(OpCodes.Br, label2)
LoadClassIL.MarkSequencePoint(doc5, 52, 1, 52, 100)
LoadClassIL.Emit(OpCodes.Br, cont162)
LoadClassIL.MarkLabel(cont162)
LoadClassIL.MarkSequencePoint(doc5, 54, 1, 54, 100)
LoadClassIL.MarkLabel(label3)
LoadClassIL.MarkSequencePoint(doc5, 55, 1, 55, 100)
...
LoadClassIL.Emit(OpCodes.Add)
LoadClassIL.Emit(OpCodes.Stloc, 4)
LoadClassIL.MarkSequencePoint(doc5, 57, 1, 57, 100)
LoadClassIL.Emit(OpCodes.Ldsfld, asm.GetType("dylan.NET.Tokenizer.CodeGen.Importer").GetField("Imps"))
Typ = asm.GetType("dylan.NET.Tokenizer.CodeGen.Importer").GetField("Imps").FieldType
Typ02 = Typ
LoadClassIL.Emit(OpCodes.Ldloc, 4)
...
Typ = Typ.GetElementType()
LoadClassIL.Emit(OpCodes.Stloc, 6)
LoadClassIL.MarkSequencePoint(doc5, 59, 1, 59, 100)
Dim typ4(-1) As Type
...
LoadClassIL.Emit(OpCodes.Stloc, 7)
LoadClassIL.MarkSequencePoint(doc5, 60, 1, 60, 100)
Dim typ5(-1) As Type
LoadClassIL.Emit(OpCodes.Ldloc, 3)
Typ = GetType(Assembly)
Typ03 = Typ
...
LoadClassIL.Emit(OpCodes.Stloc, 0)
LoadClassIL.MarkSequencePoint(doc5, 61, 1, 61, 100)
LoadClassIL.Emit(OpCodes.Ldloc, 0)
Typ = GetType(System.Type)
LoadClassIL.Emit(OpCodes.Ldnull)
Dim fa164 As System.Reflection.Emit.Label = LoadClassIL.DefineLabel()
Dim tru164 As System.Reflection.Emit.Label = LoadClassIL.DefineLabel()
Dim cont164 As System.Reflection.Emit.Label = LoadClassIL.DefineLabel()
LoadClassIL.Emit(OpCodes.Beq, tru164)
LoadClassIL.Emit(OpCodes.Br, fa164)
LoadClassIL.MarkLabel(tru164)
LoadClassIL.MarkSequencePoint(doc5, 62, 1, 62, 100)
LoadClassIL.Emit(OpCodes.Br, cont164)
LoadClassIL.MarkLabel(fa164)
LoadClassIL.MarkSequencePoint(doc5, 63, 1, 63, 100)
LoadClassIL.Emit(OpCodes.Ldloc, 8)
Typ = GetType(System.Boolean)
LoadClassIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa165 As System.Reflection.Emit.Label = LoadClassIL.DefineLabel()
Dim tru165 As System.Reflection.Emit.Label = LoadClassIL.DefineLabel()
Dim cont165 As System.Reflection.Emit.Label = LoadClassIL.DefineLabel()
LoadClassIL.Emit(OpCodes.Beq, tru165)
LoadClassIL.Emit(OpCodes.Br, fa165)
LoadClassIL.MarkLabel(tru165)
LoadClassIL.MarkSequencePoint(doc5, 64, 1, 64, 100)
Dim typ6(-1) As Type
LoadClassIL.Emit(OpCodes.Ldloc, 0)
Typ = GetType(System.Type)
Typ03 = Typ
...
LoadClassIL.Emit(OpCodes.Stloc, 0)
LoadClassIL.MarkSequencePoint(doc5, 65, 1, 65, 100)
LoadClassIL.Emit(OpCodes.Br, cont165)
LoadClassIL.MarkLabel(fa165)
LoadClassIL.Emit(OpCodes.Br, cont165)
LoadClassIL.MarkLabel(cont165)
LoadClassIL.MarkSequencePoint(doc5, 66, 1, 66, 100)
LoadClassIL.Emit(OpCodes.Br, label2)
LoadClassIL.MarkSequencePoint(doc5, 67, 1, 67, 100)
LoadClassIL.Emit(OpCodes.Br, cont164)
LoadClassIL.MarkLabel(cont164)
LoadClassIL.MarkSequencePoint(doc5, 69, 1, 69, 100)
LoadClassIL.Emit(OpCodes.Ldloc, 4)
Typ = GetType(System.Int32)
LoadClassIL.Emit(OpCodes.Ldloc, 5)
Typ = GetType(System.Int32)
Dim fa166 As System.Reflection.Emit.Label = LoadClassIL.DefineLabel()
Dim tru166 As System.Reflection.Emit.Label = LoadClassIL.DefineLabel()
Dim cont166 As System.Reflection.Emit.Label = LoadClassIL.DefineLabel()
LoadClassIL.Emit(OpCodes.Beq, tru166)
LoadClassIL.Emit(OpCodes.Br, fa166)
LoadClassIL.MarkLabel(tru166)
LoadClassIL.MarkSequencePoint(doc5, 70, 1, 70, 100)
LoadClassIL.Emit(OpCodes.Ldc_I4, CInt(-1))
Typ = GetType(System.Int32)
LoadClassIL.Emit(OpCodes.Stloc, 4)
LoadClassIL.MarkSequencePoint(doc5, 71, 1, 71, 100)
LoadClassIL.Emit(OpCodes.Br, label4)
LoadClassIL.MarkSequencePoint(doc5, 72, 1, 72, 100)
LoadClassIL.Emit(OpCodes.Br, cont166)
LoadClassIL.MarkLabel(fa166)
LoadClassIL.MarkSequencePoint(doc5, 73, 1, 73, 100)
LoadClassIL.Emit(OpCodes.Br, label3)
LoadClassIL.MarkSequencePoint(doc5, 74, 1, 74, 100)
LoadClassIL.Emit(OpCodes.Br, cont166)
LoadClassIL.MarkLabel(cont166)
LoadClassIL.MarkSequencePoint(doc5, 76, 1, 76, 100)
LoadClassIL.MarkLabel(label4)
LoadClassIL.MarkSequencePoint(doc5, 78, 1, 78, 100)
LoadClassIL.Emit(OpCodes.Ldloc, 1)
Typ = GetType(System.Int32)
LoadClassIL.Emit(OpCodes.Ldloc, 2)
Typ = GetType(System.Int32)
Dim fa167 As System.Reflection.Emit.Label = LoadClassIL.DefineLabel()
Dim tru167 As System.Reflection.Emit.Label = LoadClassIL.DefineLabel()
Dim cont167 As System.Reflection.Emit.Label = LoadClassIL.DefineLabel()
LoadClassIL.Emit(OpCodes.Beq, tru167)
LoadClassIL.Emit(OpCodes.Br, fa167)
LoadClassIL.MarkLabel(tru167)
LoadClassIL.MarkSequencePoint(doc5, 79, 1, 79, 100)
LoadClassIL.Emit(OpCodes.Br, label1)
LoadClassIL.MarkSequencePoint(doc5, 80, 1, 80, 100)
LoadClassIL.Emit(OpCodes.Br, cont167)
LoadClassIL.MarkLabel(fa167)
LoadClassIL.MarkSequencePoint(doc5, 81, 1, 81, 100)
LoadClassIL.Emit(OpCodes.Br, label0)
LoadClassIL.MarkSequencePoint(doc5, 82, 1, 82, 100)
LoadClassIL.Emit(OpCodes.Br, cont167)
LoadClassIL.MarkLabel(cont167)
LoadClassIL.MarkSequencePoint(doc5, 84, 1, 84, 100)
LoadClassIL.MarkLabel(label1)
LoadClassIL.MarkSequencePoint(doc5, 85, 1, 85, 100)
LoadClassIL.MarkLabel(label2)
LoadClassIL.MarkSequencePoint(doc5, 87, 1, 87, 100)
LoadClassIL.Emit(OpCodes.Ldloc, 0)
Typ = GetType(System.Type)
LoadClassIL.MarkSequencePoint(doc5, 89, 1, 89, 100)
...
Dim LoadMethod As MethodBuilder = Loader.DefineMethod("LoadMethod", MethodAttributes.Public Or MethodAttributes.Static, GetType(MethodInfo), typ7)
Dim LoadMethodIL As ILGenerator = LoadMethod.GetILGenerator()
Dim LoadMethodparam00 As ParameterBuilder = LoadMethod.DefineParameter(0, ParameterAttributes.RetVal, "")
...
LoadMethodIL.MarkSequencePoint(doc5, 93, 1, 93, 100)
Dim locbldr22 As LocalBuilder = LoadMethodIL.DeclareLocal(GetType(System.Type))
locbldr22.SetLocalSymInfo("temptyp")
LoadMethodIL.Emit(OpCodes.Ldnull)
LoadMethodIL.Emit(OpCodes.Stloc, 0)
LoadMethodIL.MarkSequencePoint(doc5, 94, 1, 94, 100)
Dim locbldr23 As LocalBuilder = LoadMethodIL.DeclareLocal(GetType(System.Type).MakeArrayType())
locbldr23.SetLocalSymInfo("ints")
LoadMethodIL.Emit(OpCodes.Ldnull)
LoadMethodIL.Emit(OpCodes.Stloc, 1)
LoadMethodIL.MarkSequencePoint(doc5, 95, 1, 95, 100)
Dim locbldr24 As LocalBuilder = LoadMethodIL.DeclareLocal(GetType(System.Int32))
locbldr24.SetLocalSymInfo("i")
LoadMethodIL.Emit(OpCodes.Ldc_I4, CInt(-1))
Typ = GetType(System.Int32)
LoadMethodIL.Emit(OpCodes.Stloc, 2)
LoadMethodIL.MarkSequencePoint(doc5, 96, 1, 96, 100)
Dim locbldr25 As LocalBuilder = LoadMethodIL.DeclareLocal(GetType(System.Int32))
locbldr25.SetLocalSymInfo("len")
LoadMethodIL.Emit(OpCodes.Ldnull)
LoadMethodIL.Emit(OpCodes.Stloc, 3)
LoadMethodIL.MarkSequencePoint(doc5, 97, 1, 97, 100)
Dim locbldr26 As LocalBuilder = LoadMethodIL.DeclareLocal(GetType(MethodInfo))
locbldr26.SetLocalSymInfo("mtdinfo")
LoadMethodIL.Emit(OpCodes.Ldnull)
LoadMethodIL.Emit(OpCodes.Stloc, 4)
LoadMethodIL.MarkSequencePoint(doc5, 99, 1, 99, 100)
Dim typ8(-1) As Type
...
ReDim Preserve typ8(UBound(typ8) + 1)
typ8(UBound(typ8)) = Typ
LoadMethodIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("GetMethod", typ8))
Typ = Typ03.GetMethod("GetMethod", typ8).ReturnType
LoadMethodIL.Emit(OpCodes.Stloc, 4)
LoadMethodIL.MarkSequencePoint(doc5, 101, 1, 101, 100)
LoadMethodIL.Emit(OpCodes.Ldloc, 4)
Typ = GetType(MethodInfo)
LoadMethodIL.Emit(OpCodes.Ldnull)
Dim fa168 As System.Reflection.Emit.Label = LoadMethodIL.DefineLabel()
Dim tru168 As System.Reflection.Emit.Label = LoadMethodIL.DefineLabel()
Dim cont168 As System.Reflection.Emit.Label = LoadMethodIL.DefineLabel()
LoadMethodIL.Emit(OpCodes.Beq, tru168)
LoadMethodIL.Emit(OpCodes.Br, fa168)
LoadMethodIL.MarkLabel(tru168)
LoadMethodIL.MarkSequencePoint(doc5, 102, 1, 102, 100)
LoadMethodIL.Emit(OpCodes.Ldarg, 0)
Typ = GetType(System.Type)
Typ03 = Typ
...
LoadMethodIL.Emit(OpCodes.Stloc, 1)
LoadMethodIL.MarkSequencePoint(doc5, 103, 1, 103, 100)
...
LoadMethodIL.Emit(OpCodes.Stloc, 3)
LoadMethodIL.MarkSequencePoint(doc5, 105, 1, 105, 100)
Dim label5 As System.Reflection.Emit.Label = LoadMethodIL.DefineLabel()
LoadMethodIL.MarkSequencePoint(doc5, 106, 1, 106, 100)
Dim label6 As System.Reflection.Emit.Label = LoadMethodIL.DefineLabel()
LoadMethodIL.MarkSequencePoint(doc5, 107, 1, 107, 100)
Dim label7 As System.Reflection.Emit.Label = LoadMethodIL.DefineLabel()
LoadMethodIL.MarkSequencePoint(doc5, 109, 1, 109, 100)
LoadMethodIL.MarkLabel(label5)
LoadMethodIL.MarkSequencePoint(doc5, 111, 1, 111, 100)
...
LoadMethodIL.Emit(OpCodes.Stloc, 2)
LoadMethodIL.MarkSequencePoint(doc5, 113, 1, 113, 100)
LoadMethodIL.Emit(OpCodes.Ldloc, 1)
Typ = GetType(System.Type).MakeArrayType()
Typ02 = Typ
LoadMethodIL.Emit(OpCodes.Ldloc, 2)
...
LoadMethodIL.Emit(OpCodes.Stloc, 0)
LoadMethodIL.MarkSequencePoint(doc5, 114, 1, 114, 100)
Dim typ10(-1) As Type
...
ReDim Preserve typ10(UBound(typ10) + 1)
typ10(UBound(typ10)) = Typ
LoadMethodIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("GetMethod", typ10))
Typ = Typ03.GetMethod("GetMethod", typ10).ReturnType
LoadMethodIL.Emit(OpCodes.Stloc, 4)
LoadMethodIL.MarkSequencePoint(doc5, 116, 1, 116, 100)
LoadMethodIL.Emit(OpCodes.Ldloc, 4)
Typ = GetType(MethodInfo)
LoadMethodIL.Emit(OpCodes.Ldnull)
Dim fa169 As System.Reflection.Emit.Label = LoadMethodIL.DefineLabel()
Dim tru169 As System.Reflection.Emit.Label = LoadMethodIL.DefineLabel()
Dim cont169 As System.Reflection.Emit.Label = LoadMethodIL.DefineLabel()
LoadMethodIL.Emit(OpCodes.Beq, tru169)
LoadMethodIL.Emit(OpCodes.Br, fa169)
LoadMethodIL.MarkLabel(tru169)
LoadMethodIL.MarkSequencePoint(doc5, 117, 1, 117, 100)
LoadMethodIL.Emit(OpCodes.Br, cont169)
LoadMethodIL.MarkLabel(fa169)
LoadMethodIL.MarkSequencePoint(doc5, 118, 1, 118, 100)
LoadMethodIL.Emit(OpCodes.Br, label7)
LoadMethodIL.MarkSequencePoint(doc5, 119, 1, 119, 100)
LoadMethodIL.Emit(OpCodes.Br, cont169)
LoadMethodIL.MarkLabel(cont169)
LoadMethodIL.MarkSequencePoint(doc5, 121, 1, 121, 100)
LoadMethodIL.Emit(OpCodes.Ldloc, 2)
Typ = GetType(System.Int32)
LoadMethodIL.Emit(OpCodes.Ldloc, 3)
Typ = GetType(System.Int32)
Dim fa170 As System.Reflection.Emit.Label = LoadMethodIL.DefineLabel()
Dim tru170 As System.Reflection.Emit.Label = LoadMethodIL.DefineLabel()
Dim cont170 As System.Reflection.Emit.Label = LoadMethodIL.DefineLabel()
LoadMethodIL.Emit(OpCodes.Beq, tru170)
LoadMethodIL.Emit(OpCodes.Br, fa170)
LoadMethodIL.MarkLabel(tru170)
LoadMethodIL.MarkSequencePoint(doc5, 122, 1, 122, 100)
LoadMethodIL.Emit(OpCodes.Br, label6)
LoadMethodIL.MarkSequencePoint(doc5, 123, 1, 123, 100)
LoadMethodIL.Emit(OpCodes.Br, cont170)
LoadMethodIL.MarkLabel(fa170)
LoadMethodIL.MarkSequencePoint(doc5, 124, 1, 124, 100)
LoadMethodIL.Emit(OpCodes.Br, label5)
LoadMethodIL.MarkSequencePoint(doc5, 125, 1, 125, 100)
LoadMethodIL.Emit(OpCodes.Br, cont170)
LoadMethodIL.MarkLabel(cont170)
LoadMethodIL.MarkSequencePoint(doc5, 127, 1, 127, 100)
LoadMethodIL.MarkLabel(label6)
LoadMethodIL.MarkSequencePoint(doc5, 128, 1, 128, 100)
LoadMethodIL.MarkLabel(label7)
LoadMethodIL.MarkSequencePoint(doc5, 130, 1, 130, 100)
LoadMethodIL.Emit(OpCodes.Br, cont168)
LoadMethodIL.MarkLabel(fa168)
LoadMethodIL.Emit(OpCodes.Br, cont168)
LoadMethodIL.MarkLabel(cont168)
LoadMethodIL.MarkSequencePoint(doc5, 132, 1, 132, 100)
LoadMethodIL.Emit(OpCodes.Ldloc, 4)
Typ = GetType(MethodInfo)
LoadMethodIL.MarkSequencePoint(doc5, 134, 1, 134, 100)
...
Dim LoadField As MethodBuilder = Loader.DefineMethod("LoadField", MethodAttributes.Public Or MethodAttributes.Static, GetType(FieldInfo), typ11)
Dim LoadFieldIL As ILGenerator = LoadField.GetILGenerator()
Dim LoadFieldparam00 As ParameterBuilder = LoadField.DefineParameter(0, ParameterAttributes.RetVal, "")
...
LoadFieldIL.MarkSequencePoint(doc5, 138, 1, 138, 100)
Dim locbldr27 As LocalBuilder = LoadFieldIL.DeclareLocal(GetType(System.Type))
locbldr27.SetLocalSymInfo("temptyp")
LoadFieldIL.Emit(OpCodes.Ldnull)
LoadFieldIL.Emit(OpCodes.Stloc, 0)
LoadFieldIL.MarkSequencePoint(doc5, 139, 1, 139, 100)
Dim locbldr28 As LocalBuilder = LoadFieldIL.DeclareLocal(GetType(FIeldInfo))
locbldr28.SetLocalSymInfo("fldinfo")
LoadFieldIL.Emit(OpCodes.Ldnull)
LoadFieldIL.Emit(OpCodes.Stloc, 1)
LoadFieldIL.MarkSequencePoint(doc5, 141, 1, 141, 100)
Dim typ12(-1) As Type
...
ReDim Preserve typ12(UBound(typ12) + 1)
typ12(UBound(typ12)) = Typ
LoadFieldIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("GetField", typ12))
Typ = Typ03.GetMethod("GetField", typ12).ReturnType
LoadFieldIL.Emit(OpCodes.Stloc, 1)
LoadFieldIL.MarkSequencePoint(doc5, 143, 1, 143, 100)
LoadFieldIL.Emit(OpCodes.Ldloc, 1)
Typ = GetType(FIeldInfo)
LoadFieldIL.Emit(OpCodes.Ldnull)
Dim fa171 As System.Reflection.Emit.Label = LoadFieldIL.DefineLabel()
Dim tru171 As System.Reflection.Emit.Label = LoadFieldIL.DefineLabel()
Dim cont171 As System.Reflection.Emit.Label = LoadFieldIL.DefineLabel()
LoadFieldIL.Emit(OpCodes.Beq, fa171)
LoadFieldIL.Emit(OpCodes.Br, tru171)
LoadFieldIL.MarkLabel(tru171)
LoadFieldIL.MarkSequencePoint(doc5, 144, 1, 144, 100)
LoadFieldIL.Emit(OpCodes.Ldloc, 1)
Typ = GetType(FIeldInfo)
Typ03 = Typ
...
LoadFieldIL.MarkSequencePoint(doc5, 145, 1, 145, 100)
LoadFieldIL.Emit(OpCodes.Ldarg, 0)
Typ = GetType(System.Type)
Typ03 = Typ
...
LoadFieldIL.MarkSequencePoint(doc5, 146, 1, 146, 100)
Dim locbldr29 As LocalBuilder = LoadFieldIL.DeclareLocal(GetType(System.Object))
locbldr29.SetLocalSymInfo("nullref")
LoadFieldIL.Emit(OpCodes.Ldnull)
LoadFieldIL.Emit(OpCodes.Stloc, 2)
LoadFieldIL.MarkSequencePoint(doc5, 147, 1, 147, 100)
Dim typ15(-1) As Type
LoadFieldIL.Emit(OpCodes.Ldloc, 1)
Typ = GetType(FIeldInfo)
Typ03 = Typ
...
ReDim Preserve typ15(UBound(typ15) + 1)
typ15(UBound(typ15)) = Typ
LoadFieldIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("GetValue", typ15))
Typ = Typ03.GetMethod("GetValue", typ15).ReturnType
LoadFieldIL.Emit(OpCodes.Stsfld, FldLitVal)
LoadFieldIL.MarkSequencePoint(doc5, 148, 1, 148, 100)
Dim locbldr30 As LocalBuilder = LoadFieldIL.DeclareLocal(GetType(System.Object))
locbldr30.SetLocalSymInfo("obj")
LoadFieldIL.Emit(OpCodes.Ldsfld, FldLitVal)
Typ = FldLitVal.FieldType
LoadFieldIL.Emit(OpCodes.Stloc, 3)
LoadFieldIL.MarkSequencePoint(doc5, 149, 1, 149, 100)
...
LoadFieldIL.MarkSequencePoint(doc5, 150, 1, 150, 100)
LoadFieldIL.Emit(OpCodes.Ldsfld, EnumLitFlag)
Typ = EnumLitFlag.FieldType
LoadFieldIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa172 As System.Reflection.Emit.Label = LoadFieldIL.DefineLabel()
Dim tru172 As System.Reflection.Emit.Label = LoadFieldIL.DefineLabel()
Dim cont172 As System.Reflection.Emit.Label = LoadFieldIL.DefineLabel()
LoadFieldIL.Emit(OpCodes.Beq, tru172)
LoadFieldIL.Emit(OpCodes.Br, fa172)
LoadFieldIL.MarkLabel(tru172)
LoadFieldIL.MarkSequencePoint(doc5, 151, 1, 151, 100)
Dim typ17(-1) As Type
LoadFieldIL.Emit(OpCodes.Ldarg, 0)
Typ = GetType(System.Type)
ReDim Preserve typ17(UBound(typ17) + 1)
typ17(UBound(typ17)) = Typ
LoadFieldIL.Emit(OpCodes.Call, GetType(System.Enum).GetMethod("GetUnderlyingType", typ17))
Typ = GetType(System.Enum).GetMethod("GetUnderlyingType", typ17).ReturnType
LoadFieldIL.Emit(OpCodes.Stsfld, EnumLitTyp)
LoadFieldIL.MarkSequencePoint(doc5, 152, 1, 152, 100)
LoadFieldIL.Emit(OpCodes.Br, cont172)
LoadFieldIL.MarkLabel(fa172)
LoadFieldIL.Emit(OpCodes.Br, cont172)
LoadFieldIL.MarkLabel(cont172)
LoadFieldIL.MarkSequencePoint(doc5, 153, 1, 153, 100)
LoadFieldIL.Emit(OpCodes.Br, cont171)
LoadFieldIL.MarkLabel(fa171)
LoadFieldIL.Emit(OpCodes.Br, cont171)
LoadFieldIL.MarkLabel(cont171)
LoadFieldIL.MarkSequencePoint(doc5, 155, 1, 155, 100)
LoadFieldIL.Emit(OpCodes.Ldloc, 1)
Typ = GetType(FIeldInfo)
LoadFieldIL.MarkSequencePoint(doc5, 157, 1, 157, 100)
...
ReadIL.MarkSequencePoint(doc6, 5, 1, 5, 100)
Dim locbldr31 As LocalBuilder = ReadIL.DeclareLocal(GetType(System.Type))
locbldr31.SetLocalSymInfo("typ")
ReadIL.MarkSequencePoint(doc6, 6, 1, 6, 100)
Dim locbldr32 As LocalBuilder = ReadIL.DeclareLocal(GetType(System.Boolean))
locbldr32.SetLocalSymInfo("b")
ReadIL.Emit(OpCodes.Ldc_I4, 0)
Typ = GetType(System.Boolean)
ReadIL.Emit(OpCodes.Stloc, 1)
ReadIL.MarkSequencePoint(doc6, 8, 1, 8, 100)
Dim label0 As System.Reflection.Emit.Label = ReadIL.DefineLabel()
ReadIL.MarkSequencePoint(doc6, 10, 1, 10, 100)
...
ReadIL.MarkSequencePoint(doc6, 11, 1, 11, 100)
Dim typ2(-1) As Type
...
ReadIL.Emit(OpCodes.Stloc, 1)
ReadIL.MarkSequencePoint(doc6, 13, 1, 13, 100)
ReadIL.Emit(OpCodes.Ldloc, 1)
Typ = GetType(System.Boolean)
ReadIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa173 As System.Reflection.Emit.Label = ReadIL.DefineLabel()
Dim tru173 As System.Reflection.Emit.Label = ReadIL.DefineLabel()
Dim cont173 As System.Reflection.Emit.Label = ReadIL.DefineLabel()
ReadIL.Emit(OpCodes.Beq, tru173)
ReadIL.Emit(OpCodes.Br, fa173)
ReadIL.MarkLabel(tru173)
ReadIL.MarkSequencePoint(doc6, 14, 1, 14, 100)
Dim locbldr33 As LocalBuilder = ReadIL.DeclareLocal(GetType(RefasmStmt))
locbldr33.SetLocalSymInfo("rastm")
ReadIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
ReadIL.Emit(OpCodes.Stloc, 2)
ReadIL.MarkSequencePoint(doc6, 15, 1, 15, 100)
Dim locbldr34 As LocalBuilder = ReadIL.DeclareLocal(GetType(Token))
locbldr34.SetLocalSymInfo("ap")
...
ReadIL.MarkSequencePoint(doc6, 17, 1, 17, 100)
Dim locbldr35 As LocalBuilder = ReadIL.DeclareLocal(GetType(System.String))
locbldr35.SetLocalSymInfo("tmpstr")
Dim typ3(-1) As Type
...
ReadIL.MarkSequencePoint(doc6, 18, 1, 18, 100)
Dim locbldr36 As LocalBuilder = ReadIL.DeclareLocal(GetType(System.Boolean))
locbldr36.SetLocalSymInfo("compb")
Dim typ4(-1) As Type
...
ReadIL.MarkSequencePoint(doc6, 20, 1, 20, 100)
ReadIL.Emit(OpCodes.Ldloc, 5)
Typ = GetType(System.Boolean)
ReadIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa174 As System.Reflection.Emit.Label = ReadIL.DefineLabel()
Dim tru174 As System.Reflection.Emit.Label = ReadIL.DefineLabel()
Dim cont174 As System.Reflection.Emit.Label = ReadIL.DefineLabel()
ReadIL.Emit(OpCodes.Beq, tru174)
ReadIL.Emit(OpCodes.Br, fa174)
ReadIL.MarkLabel(tru174)
ReadIL.MarkSequencePoint(doc6, 21, 1, 21, 100)
ReadIL.Emit(OpCodes.Ldloc, 3)
Typ = GetType(Token)
ReadIL.Emit(OpCodes.Ldfld, GetType(Token).GetField("Value"))
Typ = GetType(Token).GetField("Value").FieldType
ReadIL.Emit(OpCodes.Stloc, 4)
ReadIL.MarkSequencePoint(doc6, 22, 1, 22, 100)
Dim locbldr37 As LocalBuilder = ReadIL.DeclareLocal(GetType(System.Char).MakeArrayType())
locbldr37.SetLocalSymInfo("tmpchrarr")
...
ReadIL.MarkSequencePoint(doc6, 23, 1, 23, 100)
...
ReadIL.MarkSequencePoint(doc6, 24, 1, 24, 100)
Dim typ6(-1) As Type
ReadIL.Emit(OpCodes.Ldloc, 4)
Typ = GetType(System.String)
Typ03 = Typ
...
ReadIL.Emit(OpCodes.Stloc, 4)
ReadIL.MarkSequencePoint(doc6, 25, 1, 25, 100)
ReadIL.Emit(OpCodes.Ldloc, 3)
Typ = GetType(Token)
ReadIL.Emit(OpCodes.Ldloc, 4)
Typ = GetType(System.String)
ReadIL.Emit(OpCodes.Stfld, GetType(Token).GetField("Value"))
ReadIL.MarkSequencePoint(doc6, 26, 1, 26, 100)
ReadIL.Emit(OpCodes.Br, cont174)
ReadIL.MarkLabel(fa174)
ReadIL.Emit(OpCodes.Br, cont174)
ReadIL.MarkLabel(cont174)
ReadIL.MarkSequencePoint(doc6, 28, 1, 28, 100)
Dim locbldr38 As LocalBuilder = ReadIL.DeclareLocal(GetType(Assembly))
locbldr38.SetLocalSymInfo("asm")
Dim typ7(-1) As Type
ReadIL.Emit(OpCodes.Ldloc, 3)
Typ = GetType(Token)
ReadIL.Emit(OpCodes.Ldfld, GetType(Token).GetField("Value"))
...
ReadIL.MarkSequencePoint(doc6, 29, 1, 29, 100)
Dim typ8(-1) As Type
ReadIL.Emit(OpCodes.Ldloc, 7)
Typ = GetType(Assembly)
ReDim Preserve typ8(UBound(typ8) + 1)
typ8(UBound(typ8)) = Typ
ReadIL.Emit(OpCodes.Call, asm.GetType("dylan.NET.Tokenizer.CodeGen.Importer").GetMethod("AddAsm", typ8))
Typ = asm.GetType("dylan.NET.Tokenizer.CodeGen.Importer").GetMethod("AddAsm", typ8).ReturnType
If Typ.ToString() = GetType(System.Void).ToString() Then

Else
ReadIL.Emit(OpCodes.Pop)
End If
ReadIL.MarkSequencePoint(doc6, 30, 1, 30, 100)
ReadIL.Emit(OpCodes.Br, label0)
ReadIL.MarkSequencePoint(doc6, 31, 1, 31, 100)
ReadIL.Emit(OpCodes.Br, cont173)
ReadIL.MarkLabel(fa173)
ReadIL.Emit(OpCodes.Br, cont173)
ReadIL.MarkLabel(cont173)
ReadIL.MarkSequencePoint(doc6, 33, 1, 33, 100)
...
ReadIL.Emit(OpCodes.Stloc, 0)
ReadIL.MarkSequencePoint(doc6, 34, 1, 34, 100)
Dim typ10(-1) As Type
ReadIL.Emit(OpCodes.Ldloc, 0)
Typ = GetType(System.Type)
Typ03 = Typ
...
ReadIL.Emit(OpCodes.Stloc, 1)
ReadIL.MarkSequencePoint(doc6, 36, 1, 36, 100)
ReadIL.Emit(OpCodes.Ldloc, 1)
Typ = GetType(System.Boolean)
ReadIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa175 As System.Reflection.Emit.Label = ReadIL.DefineLabel()
Dim tru175 As System.Reflection.Emit.Label = ReadIL.DefineLabel()
Dim cont175 As System.Reflection.Emit.Label = ReadIL.DefineLabel()
ReadIL.Emit(OpCodes.Beq, tru175)
ReadIL.Emit(OpCodes.Br, fa175)
ReadIL.MarkLabel(tru175)
ReadIL.MarkSequencePoint(doc6, 37, 1, 37, 100)
Dim locbldr39 As LocalBuilder = ReadIL.DeclareLocal(GetType(ImportStmt))
locbldr39.SetLocalSymInfo("istm")
ReadIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
ReadIL.Emit(OpCodes.Stloc, 8)
ReadIL.MarkSequencePoint(doc6, 38, 1, 38, 100)
Dim locbldr40 As LocalBuilder = ReadIL.DeclareLocal(GetType(Token))
locbldr40.SetLocalSymInfo("ina")
...
ReadIL.MarkSequencePoint(doc6, 40, 1, 40, 100)
Dim typ11(-1) As Type
ReadIL.Emit(OpCodes.Ldsfld, GetType(Utils.Constants).GetField("quot"))
Typ = GetType(Utils.Constants).GetField("quot").FieldType
ReDim Preserve typ11(UBound(typ11) + 1)
...
ReadIL.Emit(OpCodes.Stloc, 4)
ReadIL.MarkSequencePoint(doc6, 41, 1, 41, 100)
Dim typ12(-1) As Type
...
ReadIL.Emit(OpCodes.Stloc, 5)
ReadIL.MarkSequencePoint(doc6, 43, 1, 43, 100)
ReadIL.Emit(OpCodes.Ldloc, 5)
Typ = GetType(System.Boolean)
ReadIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
...
ReadIL.MarkSequencePoint(doc6, 44, 1, 44, 100)
ReadIL.Emit(OpCodes.Ldloc, 9)
Typ = GetType(Token)
ReadIL.Emit(OpCodes.Ldfld, GetType(Token).GetField("Value"))
Typ = GetType(Token).GetField("Value").FieldType
ReadIL.Emit(OpCodes.Stloc, 4)
ReadIL.MarkSequencePoint(doc6, 45, 1, 45, 100)
ReadIL.Emit(OpCodes.Ldc_I4, CInt(1))
Typ = GetType(System.Int32)
ReadIL.Emit(OpCodes.Conv_U)
ReadIL.Emit(OpCodes.Newarr, GetType(System.Char))
ReadIL.Emit(OpCodes.Stloc, 6)
ReadIL.MarkSequencePoint(doc6, 46, 1, 46, 100)
ReadIL.Emit(OpCodes.Ldloc, 6)
Typ = GetType(System.Char).MakeArrayType()
Typ02 = Typ
ReadIL.Emit(OpCodes.Ldc_I4, CInt(0))
...
ReadIL.Emit(OpCodes.Stelem, GetType(System.Char).MakeArrayType().GetElementType())
ReadIL.MarkSequencePoint(doc6, 47, 1, 47, 100)
Dim typ14(-1) As Type
ReadIL.Emit(OpCodes.Ldloc, 4)
Typ = GetType(System.String)
Typ03 = Typ
...
ReadIL.Emit(OpCodes.Stloc, 4)
ReadIL.MarkSequencePoint(doc6, 48, 1, 48, 100)
ReadIL.Emit(OpCodes.Ldloc, 9)
Typ = GetType(Token)
ReadIL.Emit(OpCodes.Ldloc, 4)
Typ = GetType(System.String)
ReadIL.Emit(OpCodes.Stfld, GetType(Token).GetField("Value"))
ReadIL.MarkSequencePoint(doc6, 49, 1, 49, 100)
ReadIL.Emit(OpCodes.Br, cont176)
ReadIL.MarkLabel(fa176)
ReadIL.Emit(OpCodes.Br, cont176)
ReadIL.MarkLabel(cont176)
ReadIL.MarkSequencePoint(doc6, 51, 1, 51, 100)
Dim typ15(-1) As Type
ReadIL.Emit(OpCodes.Ldloc, 9)
Typ = GetType(Token)
ReadIL.Emit(OpCodes.Ldfld, GetType(Token).GetField("Value"))
...
ReDim Preserve typ15(UBound(typ15) + 1)
typ15(UBound(typ15)) = Typ
ReadIL.Emit(OpCodes.Call, asm.GetType("dylan.NET.Tokenizer.CodeGen.Importer").GetMethod("AddImp", typ15))
Typ = asm.GetType("dylan.NET.Tokenizer.CodeGen.Importer").GetMethod("AddImp", typ15).ReturnType
If Typ.ToString() = GetType(System.Void).ToString() Then

Else
ReadIL.Emit(OpCodes.Pop)
End If
ReadIL.MarkSequencePoint(doc6, 52, 1, 52, 100)
ReadIL.Emit(OpCodes.Br, label0)
ReadIL.MarkSequencePoint(doc6, 53, 1, 53, 100)
ReadIL.Emit(OpCodes.Br, cont175)
ReadIL.MarkLabel(fa175)
ReadIL.Emit(OpCodes.Br, cont175)
ReadIL.MarkLabel(cont175)
ReadIL.MarkSequencePoint(doc6, 55, 1, 55, 100)
...
ReadIL.Emit(OpCodes.Stloc, 0)
ReadIL.MarkSequencePoint(doc6, 56, 1, 56, 100)
Dim typ17(-1) As Type
ReadIL.Emit(OpCodes.Ldloc, 0)
Typ = GetType(System.Type)
Typ03 = Typ
...
ReadIL.Emit(OpCodes.Stloc, 1)
ReadIL.MarkSequencePoint(doc6, 58, 1, 58, 100)
ReadIL.Emit(OpCodes.Ldloc, 1)
Typ = GetType(System.Boolean)
ReadIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
...
ReadIL.MarkSequencePoint(doc6, 59, 1, 59, 100)
Dim locbldr41 As LocalBuilder = ReadIL.DeclareLocal(GetType(LocimportStmt))
locbldr41.SetLocalSymInfo("listm")
ReadIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
ReadIL.Emit(OpCodes.Stloc, 10)
ReadIL.MarkSequencePoint(doc6, 60, 1, 60, 100)
Dim locbldr42 As LocalBuilder = ReadIL.DeclareLocal(GetType(Token))
locbldr42.SetLocalSymInfo("lina")
...
ReadIL.MarkSequencePoint(doc6, 62, 1, 62, 100)
Dim typ18(-1) As Type
ReadIL.Emit(OpCodes.Ldsfld, GetType(Utils.Constants).GetField("quot"))
Typ = GetType(Utils.Constants).GetField("quot").FieldType
ReDim Preserve typ18(UBound(typ18) + 1)
...
ReadIL.Emit(OpCodes.Stloc, 4)
ReadIL.MarkSequencePoint(doc6, 63, 1, 63, 100)
Dim typ19(-1) As Type
...
ReadIL.Emit(OpCodes.Stloc, 5)
ReadIL.MarkSequencePoint(doc6, 65, 1, 65, 100)
ReadIL.Emit(OpCodes.Ldloc, 5)
Typ = GetType(System.Boolean)
ReadIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
...
ReadIL.MarkSequencePoint(doc6, 66, 1, 66, 100)
ReadIL.Emit(OpCodes.Ldloc, 11)
Typ = GetType(Token)
ReadIL.Emit(OpCodes.Ldfld, GetType(Token).GetField("Value"))
Typ = GetType(Token).GetField("Value").FieldType
ReadIL.Emit(OpCodes.Stloc, 4)
ReadIL.MarkSequencePoint(doc6, 67, 1, 67, 100)
ReadIL.Emit(OpCodes.Ldc_I4, CInt(1))
Typ = GetType(System.Int32)
ReadIL.Emit(OpCodes.Conv_U)
ReadIL.Emit(OpCodes.Newarr, GetType(System.Char))
ReadIL.Emit(OpCodes.Stloc, 6)
ReadIL.MarkSequencePoint(doc6, 68, 1, 68, 100)
ReadIL.Emit(OpCodes.Ldloc, 6)
Typ = GetType(System.Char).MakeArrayType()
Typ02 = Typ
ReadIL.Emit(OpCodes.Ldc_I4, CInt(0))
...
ReadIL.Emit(OpCodes.Stelem, GetType(System.Char).MakeArrayType().GetElementType())
ReadIL.MarkSequencePoint(doc6, 69, 1, 69, 100)
Dim typ21(-1) As Type
ReadIL.Emit(OpCodes.Ldloc, 4)
Typ = GetType(System.String)
Typ03 = Typ
...
ReadIL.Emit(OpCodes.Stloc, 4)
ReadIL.MarkSequencePoint(doc6, 70, 1, 70, 100)
ReadIL.Emit(OpCodes.Ldloc, 11)
Typ = GetType(Token)
ReadIL.Emit(OpCodes.Ldloc, 4)
Typ = GetType(System.String)
ReadIL.Emit(OpCodes.Stfld, GetType(Token).GetField("Value"))
ReadIL.MarkSequencePoint(doc6, 71, 1, 71, 100)
ReadIL.Emit(OpCodes.Br, cont178)
ReadIL.MarkLabel(fa178)
ReadIL.Emit(OpCodes.Br, cont178)
ReadIL.MarkLabel(cont178)
ReadIL.MarkSequencePoint(doc6, 73, 1, 73, 100)
Dim typ22(-1) As Type
ReadIL.Emit(OpCodes.Ldloc, 11)
Typ = GetType(Token)
ReadIL.Emit(OpCodes.Ldfld, GetType(Token).GetField("Value"))
...
ReDim Preserve typ22(UBound(typ22) + 1)
typ22(UBound(typ22)) = Typ
ReadIL.Emit(OpCodes.Call, asm.GetType("dylan.NET.Tokenizer.CodeGen.Importer").GetMethod("AddLocImp", typ22))
Typ = asm.GetType("dylan.NET.Tokenizer.CodeGen.Importer").GetMethod("AddLocImp", typ22).ReturnType
If Typ.ToString() = GetType(System.Void).ToString() Then

Else
ReadIL.Emit(OpCodes.Pop)
End If
ReadIL.MarkSequencePoint(doc6, 74, 1, 74, 100)
ReadIL.Emit(OpCodes.Br, label0)
ReadIL.MarkSequencePoint(doc6, 75, 1, 75, 100)
ReadIL.Emit(OpCodes.Br, cont177)
ReadIL.MarkLabel(fa177)
ReadIL.Emit(OpCodes.Br, cont177)
ReadIL.MarkLabel(cont177)
ReadIL.MarkSequencePoint(doc6, 77, 1, 77, 100)
...
ReadIL.Emit(OpCodes.Stloc, 0)
ReadIL.MarkSequencePoint(doc6, 78, 1, 78, 100)
Dim typ24(-1) As Type
ReadIL.Emit(OpCodes.Ldloc, 0)
Typ = GetType(System.Type)
Typ03 = Typ
...
ReadIL.Emit(OpCodes.Stloc, 1)
ReadIL.MarkSequencePoint(doc6, 80, 1, 80, 100)
ReadIL.Emit(OpCodes.Ldloc, 1)
Typ = GetType(System.Boolean)
ReadIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
...
ReadIL.MarkSequencePoint(doc6, 82, 1, 82, 100)
Dim locbldr43 As LocalBuilder = ReadIL.DeclareLocal(GetType(AssemblyStmt))
locbldr43.SetLocalSymInfo("asms")
ReadIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
ReadIL.Emit(OpCodes.Stloc, 12)
ReadIL.MarkSequencePoint(doc6, 83, 1, 83, 100)
Dim locbldr44 As LocalBuilder = ReadIL.DeclareLocal(GetType(Ident))
locbldr44.SetLocalSymInfo("asmn")
...
ReadIL.MarkSequencePoint(doc6, 84, 1, 84, 100)
Dim typ25(-1) As Type
...
ReadIL.MarkSequencePoint(doc6, 85, 1, 85, 100)
Dim locbldr45 As LocalBuilder = ReadIL.DeclareLocal(GetType(Token))
locbldr45.SetLocalSymInfo("asmm")
ReadIL.Emit(OpCodes.Ldloc, 12)
Typ = GetType(AssemblyStmt)
...
ReadIL.MarkSequencePoint(doc6, 86, 1, 86, 100)
...
ReadIL.MarkSequencePoint(doc6, 87, 1, 87, 100)
ReadIL.Emit(OpCodes.Br, label0)
ReadIL.MarkSequencePoint(doc6, 89, 1, 89, 100)
ReadIL.Emit(OpCodes.Br, cont179)
ReadIL.MarkLabel(fa179)
ReadIL.Emit(OpCodes.Br, cont179)
ReadIL.MarkLabel(cont179)
ReadIL.MarkSequencePoint(doc6, 91, 1, 91, 100)
...
ReadIL.Emit(OpCodes.Stloc, 0)
ReadIL.MarkSequencePoint(doc6, 92, 1, 92, 100)
Dim typ27(-1) As Type
ReadIL.Emit(OpCodes.Ldloc, 0)
Typ = GetType(System.Type)
Typ03 = Typ
...
ReadIL.Emit(OpCodes.Stloc, 1)
ReadIL.MarkSequencePoint(doc6, 94, 1, 94, 100)
ReadIL.Emit(OpCodes.Ldloc, 1)
Typ = GetType(System.Boolean)
ReadIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
...
ReadIL.MarkSequencePoint(doc6, 95, 1, 95, 100)
Dim locbldr46 As LocalBuilder = ReadIL.DeclareLocal(GetType(VerStmt))
locbldr46.SetLocalSymInfo("asmv")
ReadIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
ReadIL.Emit(OpCodes.Stloc, 15)
ReadIL.MarkSequencePoint(doc6, 96, 1, 96, 100)
Dim locbldr47 As LocalBuilder = ReadIL.DeclareLocal(GetType(IntLiteral).MakeArrayType())
locbldr47.SetLocalSymInfo("vns")
...
ReadIL.MarkSequencePoint(doc6, 97, 1, 97, 100)
Dim locbldr48 As LocalBuilder = ReadIL.DeclareLocal(GetType(IntLiteral))
locbldr48.SetLocalSymInfo("vne")
ReadIL.MarkSequencePoint(doc6, 98, 1, 98, 100)
Dim locbldr49 As LocalBuilder = ReadIL.DeclareLocal(GetType(System.Int32).MakeArrayType())
locbldr49.SetLocalSymInfo("vernos")
ReadIL.Emit(OpCodes.Ldc_I4, CInt(4))
Typ = GetType(System.Int32)
ReadIL.Emit(OpCodes.Conv_U)
ReadIL.Emit(OpCodes.Newarr, GetType(System.Int32))
ReadIL.Emit(OpCodes.Stloc, 18)
ReadIL.MarkSequencePoint(doc6, 99, 1, 99, 100)
...
ReadIL.MarkSequencePoint(doc6, 100, 1, 100, 100)
...
ReadIL.MarkSequencePoint(doc6, 101, 1, 101, 100)
ReadIL.Emit(OpCodes.Ldloc, 16)
Typ = GetType(IntLiteral).MakeArrayType()
Typ02 = Typ
ReadIL.Emit(OpCodes.Ldc_I4, CInt(1))
...
Typ = GetType(IntLiteral).MakeArrayType().GetElementType()
ReadIL.Emit(OpCodes.Stloc, 17)
ReadIL.MarkSequencePoint(doc6, 102, 1, 102, 100)
ReadIL.Emit(OpCodes.Ldloc, 18)
Typ = GetType(System.Int32).MakeArrayType()
Typ02 = Typ
ReadIL.Emit(OpCodes.Ldc_I4, CInt(1))
...
Typ = GetType(IntLiteral).GetField("NumVal").FieldType
ReadIL.Emit(OpCodes.Stelem, GetType(System.Int32).MakeArrayType().GetElementType())
ReadIL.MarkSequencePoint(doc6, 103, 1, 103, 100)
ReadIL.Emit(OpCodes.Ldloc, 16)
Typ = GetType(IntLiteral).MakeArrayType()
Typ02 = Typ
...
Typ = GetType(IntLiteral).MakeArrayType().GetElementType()
ReadIL.Emit(OpCodes.Stloc, 17)
ReadIL.MarkSequencePoint(doc6, 104, 1, 104, 100)
ReadIL.Emit(OpCodes.Ldloc, 18)
Typ = GetType(System.Int32).MakeArrayType()
Typ02 = Typ
ReadIL.Emit(OpCodes.Ldc_I4, CInt(2))
...
Typ = GetType(IntLiteral).GetField("NumVal").FieldType
ReadIL.Emit(OpCodes.Stelem, GetType(System.Int32).MakeArrayType().GetElementType())
ReadIL.MarkSequencePoint(doc6, 105, 1, 105, 100)
ReadIL.Emit(OpCodes.Ldloc, 16)
Typ = GetType(IntLiteral).MakeArrayType()
Typ02 = Typ
...
Typ = GetType(IntLiteral).MakeArrayType().GetElementType()
ReadIL.Emit(OpCodes.Stloc, 17)
ReadIL.MarkSequencePoint(doc6, 106, 1, 106, 100)
ReadIL.Emit(OpCodes.Ldloc, 18)
Typ = GetType(System.Int32).MakeArrayType()
Typ02 = Typ
ReadIL.Emit(OpCodes.Ldc_I4, CInt(3))
...
Typ = GetType(IntLiteral).GetField("NumVal").FieldType
ReadIL.Emit(OpCodes.Stelem, GetType(System.Int32).MakeArrayType().GetElementType())
ReadIL.MarkSequencePoint(doc6, 107, 1, 107, 100)
Dim locbldr50 As LocalBuilder = ReadIL.DeclareLocal(GetType(Version))
locbldr50.SetLocalSymInfo("asmver")
Dim typ28(-1) As Type
ReadIL.Emit(OpCodes.Ldloc, 18)
Typ = GetType(System.Int32).MakeArrayType()
Typ02 = Typ
...
ReadIL.MarkSequencePoint(doc6, 108, 1, 108, 100)
Dim locbldr51 As LocalBuilder = ReadIL.DeclareLocal(GetType(AssemblyName))
locbldr51.SetLocalSymInfo("asmnm")
...
ReadIL.MarkSequencePoint(doc6, 109, 1, 109, 100)
Dim typ29(-1) As Type
...
ReadIL.Emit(OpCodes.Pop)
End If
ReadIL.MarkSequencePoint(doc6, 110, 1, 110, 100)
ReadIL.Emit(OpCodes.Ldloc, 20)
Typ = GetType(AssemblyName)
ReadIL.Emit(OpCodes.Stsfld, asm.GetType("dylan.NET.Tokenizer.CodeGen.AsmFactory").GetField("AsmNameStr"))
ReadIL.MarkSequencePoint(doc6, 111, 1, 111, 100)
Dim locbldr52 As LocalBuilder = ReadIL.DeclareLocal(GetType(AppDomain))
locbldr52.SetLocalSymInfo("cad")
...
ReadIL.MarkSequencePoint(doc6, 112, 1, 112, 100)
Dim locbldr53 As LocalBuilder = ReadIL.DeclareLocal(GetType(AssemblyBuilderAccess))
locbldr53.SetLocalSymInfo("aasv")
ReadIL.Emit(OpCodes.Ldc_I4, CInt(2))
Typ = GetType(System.Int32)
ReadIL.Emit(OpCodes.Stloc, 22)
ReadIL.MarkSequencePoint(doc6, 113, 1, 113, 100)
Dim locbldr54 As LocalBuilder = ReadIL.DeclareLocal(GetType(System.String))
locbldr54.SetLocalSymInfo("curd")
...
ReadIL.MarkSequencePoint(doc6, 114, 1, 114, 100)
Dim typ30(-1) As Type
...
ReadIL.MarkSequencePoint(doc6, 115, 1, 115, 100)
Dim locbldr55 As LocalBuilder = ReadIL.DeclareLocal(GetType(System.String))
locbldr55.SetLocalSymInfo("asmnme")
ReadIL.Emit(OpCodes.Ldloc, 20)
Typ = GetType(AssemblyName)
Typ03 = Typ
...
ReadIL.MarkSequencePoint(doc6, 116, 1, 116, 100)
Dim typ32(-1) As Type
...
ReadIL.Emit(OpCodes.Stloc, 24)
ReadIL.MarkSequencePoint(doc6, 117, 1, 117, 100)
Dim locbldr56 As LocalBuilder = ReadIL.DeclareLocal(GetType(AssemblyBuilder))
locbldr56.SetLocalSymInfo("ab")
...
ReadIL.MarkSequencePoint(doc6, 118, 1, 118, 100)
Dim typ33(-1) As Type
...
ReadIL.MarkSequencePoint(doc6, 119, 1, 119, 100)
ReadIL.Emit(OpCodes.Br, label0)
ReadIL.MarkSequencePoint(doc6, 120, 1, 120, 100)
ReadIL.Emit(OpCodes.Br, cont180)
ReadIL.MarkLabel(fa180)
ReadIL.Emit(OpCodes.Br, cont180)
ReadIL.MarkLabel(cont180)
ReadIL.MarkSequencePoint(doc6, 123, 1, 123, 100)
ReadIL.MarkLabel(label0)
ReadIL.MarkSequencePoint(doc6, 125, 1, 125, 100)
...
EmitMSILIL.MarkSequencePoint(doc7, 5, 1, 5, 100)
Dim locbldr57 As LocalBuilder = EmitMSILIL.DeclareLocal(GetType(System.Int32))
locbldr57.SetLocalSymInfo("i")
EmitMSILIL.Emit(OpCodes.Ldc_I4, CInt(-1))
Typ = GetType(System.Int32)
EmitMSILIL.Emit(OpCodes.Stloc, 0)
EmitMSILIL.MarkSequencePoint(doc7, 6, 1, 6, 100)
Dim locbldr58 As LocalBuilder = EmitMSILIL.DeclareLocal(GetType(System.Int32))
...
EmitMSILIL.MarkSequencePoint(doc7, 7, 1, 7, 100)
Dim locbldr59 As LocalBuilder = EmitMSILIL.DeclareLocal(GetType(Stmt))
locbldr59.SetLocalSymInfo("stm")
EmitMSILIL.Emit(OpCodes.Ldnull)
EmitMSILIL.Emit(OpCodes.Stloc, 2)
EmitMSILIL.MarkSequencePoint(doc7, 8, 1, 8, 100)
Dim locbldr60 As LocalBuilder = EmitMSILIL.DeclareLocal(GetType(System.Type))
locbldr60.SetLocalSymInfo("typ")
EmitMSILIL.MarkSequencePoint(doc7, 9, 1, 9, 100)
Dim locbldr61 As LocalBuilder = EmitMSILIL.DeclareLocal(GetType(System.Boolean))
locbldr61.SetLocalSymInfo("b")
EmitMSILIL.MarkSequencePoint(doc7, 11, 1, 11, 100)
Dim label0 As System.Reflection.Emit.Label = EmitMSILIL.DefineLabel()
EmitMSILIL.MarkSequencePoint(doc7, 12, 1, 12, 100)
Dim label1 As System.Reflection.Emit.Label = EmitMSILIL.DefineLabel()
EmitMSILIL.MarkSequencePoint(doc7, 14, 1, 14, 100)
EmitMSILIL.MarkLabel(label0)
EmitMSILIL.MarkSequencePoint(doc7, 16, 1, 16, 100)
...
EmitMSILIL.Emit(OpCodes.Stloc, 0)
EmitMSILIL.MarkSequencePoint(doc7, 18, 1, 18, 100)
EmitMSILIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(StmtSet)
EmitMSILIL.Emit(OpCodes.Ldfld, GetType(StmtSet).GetField("Stmts"))
Typ = GetType(StmtSet).GetField("Stmts").FieldType
...
Typ = Typ.GetElementType()
EmitMSILIL.Emit(OpCodes.Stloc, 2)
EmitMSILIL.MarkSequencePoint(doc7, 19, 1, 19, 100)
...
EmitMSILIL.MarkSequencePoint(doc7, 20, 1, 20, 100)
Dim typ2(-1) As Type
...
EmitMSILIL.MarkSequencePoint(doc7, 22, 1, 22, 100)
EmitMSILIL.Emit(OpCodes.Ldloc, 4)
Typ = GetType(System.Boolean)
EmitMSILIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa181 As System.Reflection.Emit.Label = EmitMSILIL.DefineLabel()
Dim tru181 As System.Reflection.Emit.Label = EmitMSILIL.DefineLabel()
Dim cont181 As System.Reflection.Emit.Label = EmitMSILIL.DefineLabel()
EmitMSILIL.Emit(OpCodes.Beq, tru181)
EmitMSILIL.Emit(OpCodes.Br, fa181)
EmitMSILIL.MarkLabel(tru181)
EmitMSILIL.MarkSequencePoint(doc7, 23, 1, 23, 100)
EmitMSILIL.Emit(OpCodes.Br, cont181)
EmitMSILIL.MarkLabel(fa181)
EmitMSILIL.MarkSequencePoint(doc7, 25, 1, 25, 100)
Dim locbldr62 As LocalBuilder = EmitMSILIL.DeclareLocal(asm.GetType("dylan.NET.Tokenizer.CodeGen.StmtReader"))
locbldr62.SetLocalSymInfo("sr")
...
EmitMSILIL.MarkSequencePoint(doc7, 26, 1, 26, 100)
Dim typ3(-1) As Type
...
End If
EmitMSILIL.MarkSequencePoint(doc7, 28, 1, 28, 100)
EmitMSILIL.Emit(OpCodes.Br, cont181)
EmitMSILIL.MarkLabel(cont181)
EmitMSILIL.MarkSequencePoint(doc7, 30, 1, 30, 100)
EmitMSILIL.Emit(OpCodes.Ldloc, 0)
Typ = GetType(System.Int32)
EmitMSILIL.Emit(OpCodes.Ldloc, 1)
Typ = GetType(System.Int32)
Dim fa182 As System.Reflection.Emit.Label = EmitMSILIL.DefineLabel()
Dim tru182 As System.Reflection.Emit.Label = EmitMSILIL.DefineLabel()
Dim cont182 As System.Reflection.Emit.Label = EmitMSILIL.DefineLabel()
EmitMSILIL.Emit(OpCodes.Beq, tru182)
EmitMSILIL.Emit(OpCodes.Br, fa182)
EmitMSILIL.MarkLabel(tru182)
EmitMSILIL.MarkSequencePoint(doc7, 31, 1, 31, 100)
EmitMSILIL.Emit(OpCodes.Br, label1)
EmitMSILIL.MarkSequencePoint(doc7, 32, 1, 32, 100)
EmitMSILIL.Emit(OpCodes.Br, cont182)
EmitMSILIL.MarkLabel(fa182)
EmitMSILIL.MarkSequencePoint(doc7, 33, 1, 33, 100)
EmitMSILIL.Emit(OpCodes.Br, label0)
EmitMSILIL.MarkSequencePoint(doc7, 34, 1, 34, 100)
EmitMSILIL.Emit(OpCodes.Br, cont182)
EmitMSILIL.MarkLabel(cont182)
EmitMSILIL.MarkSequencePoint(doc7, 36, 1, 36, 100)
EmitMSILIL.MarkLabel(label1)
EmitMSILIL.MarkSequencePoint(doc7, 38, 1, 38, 100)
...
doc4 = mdl.DefineDocument("E:\Code\dylannet\compiler\importer.txt", Guid.Empty, Guid.Empty, Guid.Empty)
doc5 = mdl.DefineDocument("E:\Code\dylannet\compiler\loader.txt", Guid.Empty, Guid.Empty, Guid.Empty)
doc6 = mdl.DefineDocument("E:\Code\dylannet\compiler\stmtreader.txt", Guid.Empty, Guid.Empty, Guid.Empty)
doc7 = mdl.DefineDocument("E:\Code\dylannet\compiler\codegenerator.txt", Guid.Empty, Guid.Empty, Guid.Empty)
