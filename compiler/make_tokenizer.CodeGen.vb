...
Dim locbldr103 As LocalBuilder = getCodeFromTypeIL.DeclareLocal(GetType(System.Int32))
locbldr103.SetLocalSymInfo("cod")
...
Dim locbldr104 As LocalBuilder = getCodeFromTypeIL.DeclareLocal(GetType(System.Boolean))
...
Dim locbldr105 As LocalBuilder = getCodeFromTypeIL.DeclareLocal(GetType(System.Type))
...
Typ = GetType(System.Boolean)
Dim fa50 As System.Reflection.Emit.Label = getCodeFromTypeIL.DefineLabel()
Dim tru50 As System.Reflection.Emit.Label = getCodeFromTypeIL.DefineLabel()
Dim cont50 As System.Reflection.Emit.Label = getCodeFromTypeIL.DefineLabel()
getCodeFromTypeIL.Emit(OpCodes.Beq, tru50)
getCodeFromTypeIL.Emit(OpCodes.Br, fa50)
getCodeFromTypeIL.MarkLabel(tru50)
...
getCodeFromTypeIL.Emit(OpCodes.Br, cont50)
getCodeFromTypeIL.MarkLabel(fa50)
getCodeFromTypeIL.Emit(OpCodes.Br, cont50)
getCodeFromTypeIL.MarkLabel(cont50)
...
getCodeFromTypeIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa51 As System.Reflection.Emit.Label = getCodeFromTypeIL.DefineLabel()
Dim tru51 As System.Reflection.Emit.Label = getCodeFromTypeIL.DefineLabel()
Dim cont51 As System.Reflection.Emit.Label = getCodeFromTypeIL.DefineLabel()
getCodeFromTypeIL.Emit(OpCodes.Beq, tru51)
getCodeFromTypeIL.Emit(OpCodes.Br, fa51)
getCodeFromTypeIL.MarkLabel(tru51)
...
getCodeFromTypeIL.Emit(OpCodes.Br, cont51)
getCodeFromTypeIL.MarkLabel(fa51)
getCodeFromTypeIL.Emit(OpCodes.Br, cont51)
getCodeFromTypeIL.MarkLabel(cont51)
...
Dim locbldr106 As LocalBuilder = getTypeFromCodeIL.DeclareLocal(GetType(System.Type))
...
Typ = GetType(System.Int32)
Dim fa63 As System.Reflection.Emit.Label = getTypeFromCodeIL.DefineLabel()
Dim tru63 As System.Reflection.Emit.Label = getTypeFromCodeIL.DefineLabel()
Dim cont63 As System.Reflection.Emit.Label = getTypeFromCodeIL.DefineLabel()
getTypeFromCodeIL.Emit(OpCodes.Beq, tru63)
getTypeFromCodeIL.Emit(OpCodes.Br, fa63)
getTypeFromCodeIL.MarkLabel(tru63)
...
getTypeFromCodeIL.Emit(OpCodes.Br, cont63)
getTypeFromCodeIL.MarkLabel(fa63)
getTypeFromCodeIL.Emit(OpCodes.Br, cont63)
getTypeFromCodeIL.MarkLabel(cont63)
getTypeFromCodeIL.MarkSequencePoint(doc7, 605, 1, 605, 100)
getTypeFromCodeIL.Emit(OpCodes.Ldarg, 0)
Typ = GetType(System.Int32)
getTypeFromCodeIL.Emit(OpCodes.Ldc_I4, CInt(8))
Typ = GetType(System.Int32)
Dim fa64 As System.Reflection.Emit.Label = getTypeFromCodeIL.DefineLabel()
Dim tru64 As System.Reflection.Emit.Label = getTypeFromCodeIL.DefineLabel()
Dim cont64 As System.Reflection.Emit.Label = getTypeFromCodeIL.DefineLabel()
getTypeFromCodeIL.Emit(OpCodes.Beq, tru64)
getTypeFromCodeIL.Emit(OpCodes.Br, fa64)
getTypeFromCodeIL.MarkLabel(tru64)
...
getTypeFromCodeIL.Emit(OpCodes.Br, cont64)
getTypeFromCodeIL.MarkLabel(fa64)
getTypeFromCodeIL.Emit(OpCodes.Br, cont64)
getTypeFromCodeIL.MarkLabel(cont64)
...
Typ = GetType(System.Int32)
Dim fa76 As System.Reflection.Emit.Label = PopOpIL.DefineLabel()
Dim tru76 As System.Reflection.Emit.Label = PopOpIL.DefineLabel()
Dim cont76 As System.Reflection.Emit.Label = PopOpIL.DefineLabel()
PopOpIL.Emit(OpCodes.Beq, tru76)
PopOpIL.Emit(OpCodes.Br, fa76)
PopOpIL.MarkLabel(tru76)
PopOpIL.MarkSequencePoint(doc9, 24, 1, 24, 100)
PopOpIL.Emit(OpCodes.Br, cont76)
PopOpIL.MarkLabel(fa76)
PopOpIL.MarkSequencePoint(doc9, 25, 1, 25, 100)
Dim locbldr107 As LocalBuilder = PopOpIL.DeclareLocal(GetType(System.Int32))
...
Typ = GetType(System.Int32)
Dim fa77 As System.Reflection.Emit.Label = TopOpIL.DefineLabel()
Dim tru77 As System.Reflection.Emit.Label = TopOpIL.DefineLabel()
Dim cont77 As System.Reflection.Emit.Label = TopOpIL.DefineLabel()
TopOpIL.Emit(OpCodes.Beq, tru77)
TopOpIL.Emit(OpCodes.Br, fa77)
TopOpIL.MarkLabel(tru77)
TopOpIL.MarkSequencePoint(doc9, 32, 1, 32, 100)
TopOpIL.Emit(OpCodes.Ldnull)
TopOpIL.MarkSequencePoint(doc9, 33, 1, 33, 100)
TopOpIL.Emit(OpCodes.Br, cont77)
TopOpIL.MarkLabel(fa77)
TopOpIL.MarkSequencePoint(doc9, 34, 1, 34, 100)
Dim locbldr108 As LocalBuilder = TopOpIL.DeclareLocal(GetType(System.Int32))
locbldr108.SetLocalSymInfo("ind")
TopOpIL.Emit(OpCodes.Ldarg_0)
TopOpIL.Emit(OpCodes.Ldfld, Stack)
Typ = Stack.FieldType
TopOpIL.Emit(OpCodes.Ldfld, GetType(Expr).GetField("Tokens"))
...
Dim locbldr109 As LocalBuilder = TopOpIL.DeclareLocal(GetType(Token))
...
Dim locbldr110 As LocalBuilder = RetPrecIL.DeclareLocal(GetType(System.Type))
...
Dim locbldr111 As LocalBuilder = RetPrecIL.DeclareLocal(GetType(System.Boolean))
...
Dim locbldr112 As LocalBuilder = RetPrecIL.DeclareLocal(GetType(System.Int32))
locbldr112.SetLocalSymInfo("prec")
...
Typ = GetType(System.Boolean)
Dim fa78 As System.Reflection.Emit.Label = RetPrecIL.DefineLabel()
Dim tru78 As System.Reflection.Emit.Label = RetPrecIL.DefineLabel()
Dim cont78 As System.Reflection.Emit.Label = RetPrecIL.DefineLabel()
RetPrecIL.Emit(OpCodes.Beq, tru78)
RetPrecIL.Emit(OpCodes.Br, fa78)
RetPrecIL.MarkLabel(tru78)
RetPrecIL.MarkSequencePoint(doc10, 29, 1, 29, 100)
Dim locbldr113 As LocalBuilder = RetPrecIL.DeclareLocal(GetType(Op))
locbldr113.SetLocalSymInfo("optok")
RetPrecIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Token)
...
RetPrecIL.Emit(OpCodes.Br, cont78)
RetPrecIL.MarkLabel(fa78)
RetPrecIL.Emit(OpCodes.Br, cont78)
RetPrecIL.MarkLabel(cont78)
...
RetPrecIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa79 As System.Reflection.Emit.Label = RetPrecIL.DefineLabel()
Dim tru79 As System.Reflection.Emit.Label = RetPrecIL.DefineLabel()
Dim cont79 As System.Reflection.Emit.Label = RetPrecIL.DefineLabel()
RetPrecIL.Emit(OpCodes.Beq, tru79)
RetPrecIL.Emit(OpCodes.Br, fa79)
RetPrecIL.MarkLabel(tru79)
...
RetPrecIL.Emit(OpCodes.Br, cont79)
RetPrecIL.MarkLabel(fa79)
RetPrecIL.Emit(OpCodes.Br, cont79)
RetPrecIL.MarkLabel(cont79)
...
Dim locbldr114 As LocalBuilder = isLParenIL.DeclareLocal(GetType(System.Type))
...
Dim locbldr115 As LocalBuilder = isOpIL.DeclareLocal(GetType(System.Type))
...
Dim locbldr116 As LocalBuilder = ConvToRPNIL.DeclareLocal(GetType(Expr))
locbldr116.SetLocalSymInfo("exp2")
...
Dim locbldr117 As LocalBuilder = ConvToRPNIL.DeclareLocal(GetType(System.Int32))
...
Dim locbldr118 As LocalBuilder = ConvToRPNIL.DeclareLocal(GetType(System.Int32))
...
Dim locbldr119 As LocalBuilder = ConvToRPNIL.DeclareLocal(GetType(System.Int32))
locbldr119.SetLocalSymInfo("int1")
ConvToRPNIL.Emit(OpCodes.Ldc_I4, CInt(0))
Typ = GetType(System.Int32)
ConvToRPNIL.Emit(OpCodes.Stloc, 3)
ConvToRPNIL.MarkSequencePoint(doc10, 73, 1, 73, 100)
Dim locbldr120 As LocalBuilder = ConvToRPNIL.DeclareLocal(GetType(System.Int32))
locbldr120.SetLocalSymInfo("int2")
ConvToRPNIL.Emit(OpCodes.Ldc_I4, CInt(0))
Typ = GetType(System.Int32)
ConvToRPNIL.Emit(OpCodes.Stloc, 4)
ConvToRPNIL.MarkSequencePoint(doc10, 74, 1, 74, 100)
Dim locbldr121 As LocalBuilder = ConvToRPNIL.DeclareLocal(GetType(Token))
...
Dim locbldr122 As LocalBuilder = ConvToRPNIL.DeclareLocal(GetType(Token))
locbldr122.SetLocalSymInfo("tok2")
ConvToRPNIL.Emit(OpCodes.Ldnull)
ConvToRPNIL.Emit(OpCodes.Stloc, 6)
ConvToRPNIL.MarkSequencePoint(doc10, 76, 1, 76, 100)
Dim locbldr123 As LocalBuilder = ConvToRPNIL.DeclareLocal(GetType(System.Type))
locbldr123.SetLocalSymInfo("typ")
ConvToRPNIL.Emit(OpCodes.Ldnull)
ConvToRPNIL.Emit(OpCodes.Stloc, 7)
ConvToRPNIL.MarkSequencePoint(doc10, 77, 1, 77, 100)
Dim locbldr124 As LocalBuilder = ConvToRPNIL.DeclareLocal(GetType(System.Boolean))
...
Dim locbldr125 As LocalBuilder = ConvToRPNIL.DeclareLocal(GetType(System.Boolean))
locbldr125.SetLocalSymInfo("orflg")
ConvToRPNIL.Emit(OpCodes.Ldc_I4, 0)
Typ = GetType(System.Boolean)
...
ConvToRPNIL.Emit(OpCodes.Ldc_I4, 0)
Typ = GetType(System.Boolean)
Dim fa81 As System.Reflection.Emit.Label = ConvToRPNIL.DefineLabel()
Dim tru81 As System.Reflection.Emit.Label = ConvToRPNIL.DefineLabel()
Dim cont81 As System.Reflection.Emit.Label = ConvToRPNIL.DefineLabel()
ConvToRPNIL.Emit(OpCodes.Beq, tru81)
ConvToRPNIL.Emit(OpCodes.Br, fa81)
ConvToRPNIL.MarkLabel(tru81)
...
ConvToRPNIL.Emit(OpCodes.Br, cont81)
ConvToRPNIL.MarkLabel(fa81)
ConvToRPNIL.Emit(OpCodes.Br, cont81)
ConvToRPNIL.MarkLabel(cont81)
...
Typ = GetType(System.Boolean)
Dim fa82 As System.Reflection.Emit.Label = ConvToRPNIL.DefineLabel()
Dim tru82 As System.Reflection.Emit.Label = ConvToRPNIL.DefineLabel()
Dim cont82 As System.Reflection.Emit.Label = ConvToRPNIL.DefineLabel()
ConvToRPNIL.Emit(OpCodes.Beq, tru82)
ConvToRPNIL.Emit(OpCodes.Br, fa82)
ConvToRPNIL.MarkLabel(tru82)
...
ConvToRPNIL.Emit(OpCodes.Beq, fa83)
ConvToRPNIL.Emit(OpCodes.Br, tru83)
...
ConvToRPNIL.Emit(OpCodes.Ble, tru84)
...
ConvToRPNIL.Emit(OpCodes.Br, cont82)
ConvToRPNIL.MarkLabel(fa82)
ConvToRPNIL.Emit(OpCodes.Br, cont82)
ConvToRPNIL.MarkLabel(cont82)
...
ConvToRPNIL.Emit(OpCodes.Beq, tru85)
ConvToRPNIL.Emit(OpCodes.Br, fa85)
...
ConvToRPNIL.Emit(OpCodes.Beq, tru86)
...
ConvToRPNIL.Emit(OpCodes.Beq, fa87)
ConvToRPNIL.Emit(OpCodes.Br, tru87)
...
ConvToRPNIL.Emit(OpCodes.Beq, tru91)
ConvToRPNIL.Emit(OpCodes.Br, fa91)
...
locbldr126.SetLocalSymInfo("tokf")
ConvToASTIL.MarkSequencePoint(doc10, 203, 1, 203, 100)
Dim locbldr127 As LocalBuilder = ConvToASTIL.DeclareLocal(GetType(System.Int32))
...
Dim locbldr128 As LocalBuilder = ConvToASTIL.DeclareLocal(GetType(System.Int32))
locbldr128.SetLocalSymInfo("j")
ConvToASTIL.Emit(OpCodes.Ldc_I4, CInt(0))
Typ = GetType(System.Int32)
ConvToASTIL.Emit(OpCodes.Stloc, 2)
ConvToASTIL.MarkSequencePoint(doc10, 205, 1, 205, 100)
Dim locbldr129 As LocalBuilder = ConvToASTIL.DeclareLocal(GetType(System.Int32))
...
Dim locbldr130 As LocalBuilder = ConvToASTIL.DeclareLocal(GetType(Token))
locbldr130.SetLocalSymInfo("tok")
...
Dim locbldr132 As LocalBuilder = ConvToASTIL.DeclareLocal(GetType(System.Type))
locbldr132.SetLocalSymInfo("typ")
ConvToASTIL.Emit(OpCodes.Ldnull)
ConvToASTIL.Emit(OpCodes.Stloc, 6)
ConvToASTIL.MarkSequencePoint(doc10, 209, 1, 209, 100)
Dim locbldr133 As LocalBuilder = ConvToASTIL.DeclareLocal(GetType(System.Boolean))
locbldr133.SetLocalSymInfo("b")
ConvToASTIL.Emit(OpCodes.Ldc_I4, 0)
Typ = GetType(System.Boolean)
ConvToASTIL.Emit(OpCodes.Stloc, 7)
ConvToASTIL.MarkSequencePoint(doc10, 210, 1, 210, 100)
Dim locbldr134 As LocalBuilder = ConvToASTIL.DeclareLocal(GetType(Op))
locbldr134.SetLocalSymInfo("optok")
...
ConvToASTIL.Emit(OpCodes.Ldc_I4, CInt(1))
Typ = GetType(System.Int32)
Dim fa96 As System.Reflection.Emit.Label = ConvToASTIL.DefineLabel()
Dim tru96 As System.Reflection.Emit.Label = ConvToASTIL.DefineLabel()
Dim cont96 As System.Reflection.Emit.Label = ConvToASTIL.DefineLabel()
ConvToASTIL.Emit(OpCodes.Beq, tru96)
ConvToASTIL.Emit(OpCodes.Br, fa96)
ConvToASTIL.MarkLabel(tru96)
...
ConvToASTIL.Emit(OpCodes.Br, cont96)
ConvToASTIL.MarkLabel(fa96)
ConvToASTIL.Emit(OpCodes.Br, cont96)
ConvToASTIL.MarkLabel(cont96)
...
Typ = GetType(System.Boolean)
Dim fa97 As System.Reflection.Emit.Label = ConvToASTIL.DefineLabel()
Dim tru97 As System.Reflection.Emit.Label = ConvToASTIL.DefineLabel()
Dim cont97 As System.Reflection.Emit.Label = ConvToASTIL.DefineLabel()
ConvToASTIL.Emit(OpCodes.Beq, tru97)
ConvToASTIL.Emit(OpCodes.Br, fa97)
ConvToASTIL.MarkLabel(tru97)
...
ConvToASTIL.Emit(OpCodes.Bge, tru98)
...
ConvToASTIL.Emit(OpCodes.Br, cont97)
ConvToASTIL.MarkLabel(fa97)
ConvToASTIL.Emit(OpCodes.Br, cont97)
ConvToASTIL.MarkLabel(cont97)
...
Dim locbldr135 As LocalBuilder = ASTEmitIL.DeclareLocal(GetType(System.Boolean))
locbldr135.SetLocalSymInfo("isop")
...
Dim locbldr136 As LocalBuilder = ASTEmitIL.DeclareLocal(GetType(Op))
locbldr136.SetLocalSymInfo("optok")
ASTEmitIL.MarkSequencePoint(doc10, 270, 1, 270, 100)
Dim locbldr137 As LocalBuilder = ASTEmitIL.DeclareLocal(GetType(Token))
locbldr137.SetLocalSymInfo("rc")
ASTEmitIL.MarkSequencePoint(doc10, 271, 1, 271, 100)
Dim locbldr138 As LocalBuilder = ASTEmitIL.DeclareLocal(GetType(Token))
locbldr138.SetLocalSymInfo("lc")
ASTEmitIL.MarkSequencePoint(doc10, 273, 1, 273, 100)
ASTEmitIL.Emit(OpCodes.Ldloc, 0)
Typ = GetType(System.Boolean)
ASTEmitIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa100 As System.Reflection.Emit.Label = ASTEmitIL.DefineLabel()
Dim tru100 As System.Reflection.Emit.Label = ASTEmitIL.DefineLabel()
Dim cont100 As System.Reflection.Emit.Label = ASTEmitIL.DefineLabel()
ASTEmitIL.Emit(OpCodes.Beq, tru100)
ASTEmitIL.Emit(OpCodes.Br, fa100)
ASTEmitIL.MarkLabel(tru100)
...
Typ = GetType(System.Boolean)
Dim fa101 As System.Reflection.Emit.Label = ASTEmitIL.DefineLabel()
Dim tru101 As System.Reflection.Emit.Label = ASTEmitIL.DefineLabel()
Dim cont101 As System.Reflection.Emit.Label = ASTEmitIL.DefineLabel()
ASTEmitIL.Emit(OpCodes.Beq, tru101)
ASTEmitIL.Emit(OpCodes.Br, fa101)
ASTEmitIL.MarkLabel(tru101)
...
ASTEmitIL.Emit(OpCodes.Pop)
End If
ASTEmitIL.MarkSequencePoint(doc10, 281, 1, 281, 100)
ASTEmitIL.Emit(OpCodes.Br, cont101)
ASTEmitIL.MarkLabel(fa101)
...
ASTEmitIL.Emit(OpCodes.Br, cont101)
ASTEmitIL.MarkLabel(cont101)
ASTEmitIL.MarkSequencePoint(doc10, 286, 1, 286, 100)
ASTEmitIL.Emit(OpCodes.Br, cont100)
ASTEmitIL.MarkLabel(fa100)
ASTEmitIL.MarkSequencePoint(doc10, 288, 1, 288, 100)
ASTEmitIL.Emit(OpCodes.Br, cont100)
ASTEmitIL.MarkLabel(cont100)
ASTEmitIL.MarkSequencePoint(doc10, 290, 1, 290, 100)
ASTEmitIL.Emit(OpCodes.Ret)
Dim typ59(-1) As Type
ReDim Preserve typ59(UBound(typ59) + 1)
typ59(UBound(typ59)) = GetType(Expr)
Dim Evaluate As MethodBuilder = Evaluator.DefineMethod("Evaluate", MethodAttributes.Public, GetType(System.Void), typ59)
...
EvaluateIL.MarkSequencePoint(doc10, 294, 1, 294, 100)
Dim locbldr139 As LocalBuilder = EvaluateIL.DeclareLocal(GetType(System.Int32))
...
EvaluateIL.MarkSequencePoint(doc10, 296, 1, 296, 100)
Dim locbldr140 As LocalBuilder = EvaluateIL.DeclareLocal(GetType(Expr))
locbldr140.SetLocalSymInfo("rpnexp")
EvaluateIL.MarkSequencePoint(doc10, 298, 1, 298, 100)
EvaluateIL.Emit(OpCodes.Ldloc, 0)
Typ = GetType(System.Int32)
EvaluateIL.Emit(OpCodes.Ldc_I4, CInt(1))
Typ = GetType(System.Int32)
Dim fa102 As System.Reflection.Emit.Label = EvaluateIL.DefineLabel()
Dim tru102 As System.Reflection.Emit.Label = EvaluateIL.DefineLabel()
Dim cont102 As System.Reflection.Emit.Label = EvaluateIL.DefineLabel()
EvaluateIL.Emit(OpCodes.Beq, tru102)
EvaluateIL.Emit(OpCodes.Br, fa102)
EvaluateIL.MarkLabel(tru102)
EvaluateIL.MarkSequencePoint(doc10, 299, 1, 299, 100)
EvaluateIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Expr)
EvaluateIL.Emit(OpCodes.Stloc, 1)
EvaluateIL.MarkSequencePoint(doc10, 300, 1, 300, 100)
EvaluateIL.Emit(OpCodes.Br, cont102)
EvaluateIL.MarkLabel(fa102)
EvaluateIL.MarkSequencePoint(doc10, 301, 1, 301, 100)
EvaluateIL.Emit(OpCodes.Ldloc, 0)
Typ = GetType(System.Int32)
EvaluateIL.Emit(OpCodes.Ldc_I4, CInt(3))
Typ = GetType(System.Int32)
Dim fa103 As System.Reflection.Emit.Label = EvaluateIL.DefineLabel()
Dim tru103 As System.Reflection.Emit.Label = EvaluateIL.DefineLabel()
Dim cont103 As System.Reflection.Emit.Label = EvaluateIL.DefineLabel()
EvaluateIL.Emit(OpCodes.Bge, tru103)
EvaluateIL.Emit(OpCodes.Br, fa103)
EvaluateIL.MarkLabel(tru103)
EvaluateIL.MarkSequencePoint(doc10, 302, 1, 302, 100)
...
EvaluateIL.Emit(OpCodes.Stloc, 1)
EvaluateIL.MarkSequencePoint(doc10, 303, 1, 303, 100)
EvaluateIL.Emit(OpCodes.Br, cont103)
EvaluateIL.MarkLabel(fa103)
EvaluateIL.Emit(OpCodes.Br, cont103)
EvaluateIL.MarkLabel(cont103)
EvaluateIL.MarkSequencePoint(doc10, 304, 1, 304, 100)
EvaluateIL.Emit(OpCodes.Br, cont102)
EvaluateIL.MarkLabel(cont102)
EvaluateIL.MarkSequencePoint(doc10, 306, 1, 306, 100)
Dim locbldr141 As LocalBuilder = EvaluateIL.DeclareLocal(GetType(Token))
locbldr141.SetLocalSymInfo("asttok")
EvaluateIL.Emit(OpCodes.Ldarg_0)
Dim typ61(-1) As Type
...
EvaluateIL.MarkSequencePoint(doc10, 307, 1, 307, 100)
EvaluateIL.Emit(OpCodes.Ldarg_0)
Dim typ62(-1) As Type
...
End If
EvaluateIL.MarkSequencePoint(doc10, 308, 1, 308, 100)
EvaluateIL.Emit(OpCodes.Ldarg_0)
Dim typ63(-1) As Type
EvaluateIL.Emit(OpCodes.Ldloc, 2)
Typ = GetType(Token)
...
EvaluateIL.Emit(OpCodes.Pop)
End If
EvaluateIL.MarkSequencePoint(doc10, 310, 1, 310, 100)
...
Dim locbldr142 As LocalBuilder = ReadIL.DeclareLocal(GetType(System.Type))
locbldr142.SetLocalSymInfo("typ")
ReadIL.MarkSequencePoint(doc11, 14, 1, 14, 100)
Dim locbldr143 As LocalBuilder = ReadIL.DeclareLocal(GetType(System.Boolean))
...
Dim locbldr144 As LocalBuilder = ReadIL.DeclareLocal(GetType(RefasmStmt))
locbldr144.SetLocalSymInfo("rastm")
ReadIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
ReadIL.Emit(OpCodes.Stloc, 2)
ReadIL.MarkSequencePoint(doc11, 23, 1, 23, 100)
Dim locbldr145 As LocalBuilder = ReadIL.DeclareLocal(GetType(Token))
locbldr145.SetLocalSymInfo("ap")
...
Dim locbldr146 As LocalBuilder = ReadIL.DeclareLocal(GetType(System.String))
locbldr146.SetLocalSymInfo("tmpstr")
Dim typ3(-1) As Type
...
Dim locbldr147 As LocalBuilder = ReadIL.DeclareLocal(GetType(System.Boolean))
locbldr147.SetLocalSymInfo("compb")
Dim typ4(-1) As Type
...
Dim locbldr148 As LocalBuilder = ReadIL.DeclareLocal(GetType(System.Char).MakeArrayType())
locbldr148.SetLocalSymInfo("tmpchrarr")
...
Dim locbldr149 As LocalBuilder = ReadIL.DeclareLocal(GetType(Assembly))
locbldr149.SetLocalSymInfo("asm")
Dim typ7(-1) As Type
ReadIL.Emit(OpCodes.Ldloc, 3)
Typ = GetType(Token)
ReadIL.Emit(OpCodes.Ldfld, GetType(Token).GetField("Value"))
...
Dim locbldr150 As LocalBuilder = ReadIL.DeclareLocal(GetType(ImportStmt))
locbldr150.SetLocalSymInfo("istm")
ReadIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
...
locbldr151.SetLocalSymInfo("ina")
...
Dim locbldr152 As LocalBuilder = ReadIL.DeclareLocal(GetType(LocimportStmt))
locbldr152.SetLocalSymInfo("listm")
ReadIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
ReadIL.Emit(OpCodes.Stloc, 10)
ReadIL.MarkSequencePoint(doc11, 73, 1, 73, 100)
Dim locbldr153 As LocalBuilder = ReadIL.DeclareLocal(GetType(Token))
locbldr153.SetLocalSymInfo("lina")
...
Dim locbldr154 As LocalBuilder = ReadIL.DeclareLocal(GetType(AssemblyStmt))
locbldr154.SetLocalSymInfo("asms")
ReadIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
ReadIL.Emit(OpCodes.Stloc, 12)
ReadIL.MarkSequencePoint(doc11, 99, 1, 99, 100)
Dim locbldr155 As LocalBuilder = ReadIL.DeclareLocal(GetType(Ident))
locbldr155.SetLocalSymInfo("asmn")
...
Dim locbldr156 As LocalBuilder = ReadIL.DeclareLocal(GetType(Token))
locbldr156.SetLocalSymInfo("asmm")
ReadIL.Emit(OpCodes.Ldloc, 12)
Typ = GetType(AssemblyStmt)
...
Dim locbldr157 As LocalBuilder = ReadIL.DeclareLocal(GetType(VerStmt))
locbldr157.SetLocalSymInfo("asmv")
ReadIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
ReadIL.Emit(OpCodes.Stloc, 15)
ReadIL.MarkSequencePoint(doc11, 118, 1, 118, 100)
Dim locbldr158 As LocalBuilder = ReadIL.DeclareLocal(GetType(IntLiteral).MakeArrayType())
locbldr158.SetLocalSymInfo("vns")
...
Dim locbldr159 As LocalBuilder = ReadIL.DeclareLocal(GetType(IntLiteral))
locbldr159.SetLocalSymInfo("vne")
ReadIL.MarkSequencePoint(doc11, 120, 1, 120, 100)
Dim locbldr160 As LocalBuilder = ReadIL.DeclareLocal(GetType(System.Int32).MakeArrayType())
locbldr160.SetLocalSymInfo("vernos")
...
Dim locbldr161 As LocalBuilder = ReadIL.DeclareLocal(GetType(Version))
locbldr161.SetLocalSymInfo("asmver")
Dim typ36(-1) As Type
ReadIL.Emit(OpCodes.Ldloc, 18)
Typ = GetType(System.Int32).MakeArrayType()
Typ02 = Typ
...
Dim locbldr162 As LocalBuilder = ReadIL.DeclareLocal(GetType(AssemblyName))
locbldr162.SetLocalSymInfo("asmnm")
...
Dim locbldr163 As LocalBuilder = ReadIL.DeclareLocal(GetType(AppDomain))
locbldr163.SetLocalSymInfo("cad")
...
Dim locbldr164 As LocalBuilder = ReadIL.DeclareLocal(GetType(AssemblyBuilderAccess))
locbldr164.SetLocalSymInfo("aasv")
ReadIL.Emit(OpCodes.Ldc_I4, CInt(2))
Typ = GetType(System.Int32)
ReadIL.Emit(OpCodes.Stloc, 22)
ReadIL.MarkSequencePoint(doc11, 135, 1, 135, 100)
Dim locbldr165 As LocalBuilder = ReadIL.DeclareLocal(GetType(System.String))
locbldr165.SetLocalSymInfo("curd")
...
Dim locbldr166 As LocalBuilder = ReadIL.DeclareLocal(GetType(System.String))
locbldr166.SetLocalSymInfo("asmnme")
ReadIL.Emit(OpCodes.Ldloc, 20)
Typ = GetType(AssemblyName)
Typ03 = Typ
...
Dim locbldr167 As LocalBuilder = ReadIL.DeclareLocal(GetType(AssemblyBuilder))
locbldr167.SetLocalSymInfo("ab")
...
Dim locbldr168 As LocalBuilder = ReadIL.DeclareLocal(GetType(ModuleBuilder))
locbldr168.SetLocalSymInfo("mdlbldbg")
...
ReadIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa113 As System.Reflection.Emit.Label = ReadIL.DefineLabel()
Dim tru113 As System.Reflection.Emit.Label = ReadIL.DefineLabel()
Dim cont113 As System.Reflection.Emit.Label = ReadIL.DefineLabel()
ReadIL.Emit(OpCodes.Beq, tru113)
ReadIL.Emit(OpCodes.Br, fa113)
ReadIL.MarkLabel(tru113)
ReadIL.MarkSequencePoint(doc11, 150, 1, 150, 100)
Dim locbldr169 As LocalBuilder = ReadIL.DeclareLocal(GetType(System.Type))
locbldr169.SetLocalSymInfo("dtyp")
...
Dim locbldr170 As LocalBuilder = ReadIL.DeclareLocal(GetType(DebuggableAttribute.DebuggingModes))
locbldr170.SetLocalSymInfo("debugattr")
ReadIL.Emit(OpCodes.Ldc_I4, CInt(1))
Typ = GetType(System.Int32)
...
Dim locbldr171 As LocalBuilder = ReadIL.DeclareLocal(GetType(System.Object))
locbldr171.SetLocalSymInfo("oattr")
...
Dim locbldr172 As LocalBuilder = ReadIL.DeclareLocal(GetType(System.Type))
locbldr172.SetLocalSymInfo("dattyp")
...
Dim locbldr173 As LocalBuilder = ReadIL.DeclareLocal(GetType(System.Type).MakeArrayType())
locbldr173.SetLocalSymInfo("tarr")
ReadIL.Emit(OpCodes.Ldc_I4, CInt(1))
Typ = GetType(System.Int32)
ReadIL.Emit(OpCodes.Conv_U)
...
Dim locbldr174 As LocalBuilder = ReadIL.DeclareLocal(GetType(ConstructorInfo))
locbldr174.SetLocalSymInfo("dctor")
Dim typ45(-1) As Type
...
Dim locbldr175 As LocalBuilder = ReadIL.DeclareLocal(GetType(System.Object).MakeArrayType())
locbldr175.SetLocalSymInfo("oarr")
ReadIL.Emit(OpCodes.Ldc_I4, CInt(1))
Typ = GetType(System.Int32)
ReadIL.Emit(OpCodes.Conv_U)
...
Dim locbldr176 As LocalBuilder = ReadIL.DeclareLocal(GetType(CustomAttributeBuilder))
locbldr176.SetLocalSymInfo("dbuilder")
Dim typ46(-1) As Type
...
ReadIL.Emit(OpCodes.Br, cont113)
ReadIL.MarkLabel(fa113)
ReadIL.Emit(OpCodes.Br, cont113)
ReadIL.MarkLabel(cont113)
...
ReadIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa114 As System.Reflection.Emit.Label = ReadIL.DefineLabel()
Dim tru114 As System.Reflection.Emit.Label = ReadIL.DefineLabel()
Dim cont114 As System.Reflection.Emit.Label = ReadIL.DefineLabel()
ReadIL.Emit(OpCodes.Beq, tru114)
ReadIL.Emit(OpCodes.Br, fa114)
ReadIL.MarkLabel(tru114)
ReadIL.MarkSequencePoint(doc11, 173, 1, 173, 100)
Dim locbldr177 As LocalBuilder = ReadIL.DeclareLocal(GetType(DebugStmt))
locbldr177.SetLocalSymInfo("dbgs")
ReadIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
...
ReadIL.Emit(OpCodes.Br, cont114)
ReadIL.MarkLabel(fa114)
ReadIL.Emit(OpCodes.Br, cont114)
ReadIL.MarkLabel(cont114)
...
ReadIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa115 As System.Reflection.Emit.Label = ReadIL.DefineLabel()
Dim tru115 As System.Reflection.Emit.Label = ReadIL.DefineLabel()
Dim cont115 As System.Reflection.Emit.Label = ReadIL.DefineLabel()
ReadIL.Emit(OpCodes.Beq, tru115)
ReadIL.Emit(OpCodes.Br, fa115)
ReadIL.MarkLabel(tru115)
ReadIL.MarkSequencePoint(doc11, 182, 1, 182, 100)
Dim locbldr178 As LocalBuilder = ReadIL.DeclareLocal(GetType(ClassStmt))
...
ReadIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa116 As System.Reflection.Emit.Label = ReadIL.DefineLabel()
Dim tru116 As System.Reflection.Emit.Label = ReadIL.DefineLabel()
Dim cont116 As System.Reflection.Emit.Label = ReadIL.DefineLabel()
ReadIL.Emit(OpCodes.Beq, tru116)
ReadIL.Emit(OpCodes.Br, fa116)
ReadIL.MarkLabel(tru116)
...
ReadIL.Emit(OpCodes.Br, cont116)
ReadIL.MarkLabel(fa116)
ReadIL.Emit(OpCodes.Br, cont116)
ReadIL.MarkLabel(cont116)
ReadIL.MarkSequencePoint(doc11, 188, 1, 188, 100)
ReadIL.Emit(OpCodes.Ldsfld, GetType(AsmFactory).GetField("isNested"))
Typ = GetType(AsmFactory).GetField("isNested").FieldType
ReadIL.Emit(OpCodes.Ldc_I4, 0)
Typ = GetType(System.Boolean)
Dim fa117 As System.Reflection.Emit.Label = ReadIL.DefineLabel()
Dim tru117 As System.Reflection.Emit.Label = ReadIL.DefineLabel()
Dim cont117 As System.Reflection.Emit.Label = ReadIL.DefineLabel()
ReadIL.Emit(OpCodes.Beq, tru117)
ReadIL.Emit(OpCodes.Br, fa117)
ReadIL.MarkLabel(tru117)
...
ReadIL.Emit(OpCodes.Br, cont117)
ReadIL.MarkLabel(fa117)
ReadIL.Emit(OpCodes.Br, cont117)
ReadIL.MarkLabel(cont117)
ReadIL.MarkSequencePoint(doc11, 192, 1, 192, 100)
Dim locbldr179 As LocalBuilder = ReadIL.DeclareLocal(GetType(Attributes.Attribute).MakeArrayType())
locbldr179.SetLocalSymInfo("attrs")
...
Dim locbldr180 As LocalBuilder = ReadIL.DeclareLocal(GetType(TypeAttributes))
...
Dim locbldr181 As LocalBuilder = ReadIL.DeclareLocal(GetType(Ident))
locbldr181.SetLocalSymInfo("clssnam")
ReadIL.Emit(OpCodes.Ldloc, 36)
Typ = GetType(ClassStmt)
...
Dim locbldr182 As LocalBuilder = ReadIL.DeclareLocal(GetType(System.String))
locbldr182.SetLocalSymInfo("clsnamstr")
...
Dim locbldr183 As LocalBuilder = ReadIL.DeclareLocal(GetType(TypeTok))
locbldr183.SetLocalSymInfo("inhclstok")
ReadIL.Emit(OpCodes.Ldloc, 36)
Typ = GetType(ClassStmt)
...
Dim locbldr184 As LocalBuilder = ReadIL.DeclareLocal(GetType(System.Type))
locbldr184.SetLocalSymInfo("inhtyp")
ReadIL.Emit(OpCodes.Ldnull)
ReadIL.Emit(OpCodes.Stloc, 42)
ReadIL.MarkSequencePoint(doc11, 198, 1, 198, 100)
Dim locbldr185 As LocalBuilder = ReadIL.DeclareLocal(GetType(System.Type))
locbldr185.SetLocalSymInfo("reft")
...
Dim locbldr186 As LocalBuilder = ReadIL.DeclareLocal(GetType(System.Int32))
locbldr186.SetLocalSymInfo("cmp")
Dim typ54(-1) As Type
ReadIL.Emit(OpCodes.Ldloc, 41)
Typ = GetType(TypeTok)
...
Typ = GetType(System.Type)
ReadIL.Emit(OpCodes.Ldnull)
Dim fa118 As System.Reflection.Emit.Label = ReadIL.DefineLabel()
Dim tru118 As System.Reflection.Emit.Label = ReadIL.DefineLabel()
Dim cont118 As System.Reflection.Emit.Label = ReadIL.DefineLabel()
ReadIL.Emit(OpCodes.Beq, tru118)
ReadIL.Emit(OpCodes.Br, fa118)
ReadIL.MarkLabel(tru118)
ReadIL.MarkSequencePoint(doc11, 202, 1, 202, 100)
ReadIL.Emit(OpCodes.Ldloc, 44)
Typ = GetType(System.Int32)
ReadIL.Emit(OpCodes.Ldc_I4, CInt(0))
Typ = GetType(System.Int32)
Dim fa119 As System.Reflection.Emit.Label = ReadIL.DefineLabel()
Dim tru119 As System.Reflection.Emit.Label = ReadIL.DefineLabel()
Dim cont119 As System.Reflection.Emit.Label = ReadIL.DefineLabel()
ReadIL.Emit(OpCodes.Beq, tru119)
ReadIL.Emit(OpCodes.Br, fa119)
ReadIL.MarkLabel(tru119)
...
ReadIL.Emit(OpCodes.Br, cont119)
ReadIL.MarkLabel(fa119)
...
ReadIL.Emit(OpCodes.Br, cont119)
ReadIL.MarkLabel(cont119)
ReadIL.MarkSequencePoint(doc11, 207, 1, 207, 100)
ReadIL.Emit(OpCodes.Br, cont118)
ReadIL.MarkLabel(fa118)
...
ReadIL.Emit(OpCodes.Br, cont118)
ReadIL.MarkLabel(cont118)
ReadIL.MarkSequencePoint(doc11, 212, 1, 212, 100)
ReadIL.Emit(OpCodes.Ldsfld, GetType(AsmFactory).GetField("isNested"))
Typ = GetType(AsmFactory).GetField("isNested").FieldType
ReadIL.Emit(OpCodes.Ldc_I4, 0)
Typ = GetType(System.Boolean)
Dim fa120 As System.Reflection.Emit.Label = ReadIL.DefineLabel()
Dim tru120 As System.Reflection.Emit.Label = ReadIL.DefineLabel()
Dim cont120 As System.Reflection.Emit.Label = ReadIL.DefineLabel()
ReadIL.Emit(OpCodes.Beq, tru120)
ReadIL.Emit(OpCodes.Br, fa120)
ReadIL.MarkLabel(tru120)
ReadIL.MarkSequencePoint(doc11, 213, 1, 213, 100)
Dim locbldr187 As LocalBuilder = ReadIL.DeclareLocal(GetType(ModuleBuilder))
locbldr187.SetLocalSymInfo("mdlbld")
ReadIL.Emit(OpCodes.Ldsfld, GetType(AsmFactory).GetField("MdlB"))
Typ = GetType(AsmFactory).GetField("MdlB").FieldType
...
ReadIL.Emit(OpCodes.Br, cont120)
ReadIL.MarkLabel(fa120)
...
Dim locbldr188 As LocalBuilder = ReadIL.DeclareLocal(GetType(TypeBuilder))
locbldr188.SetLocalSymInfo("ctb2")
...
ReadIL.Emit(OpCodes.Br, cont120)
ReadIL.MarkLabel(cont120)
ReadIL.MarkSequencePoint(doc11, 227, 1, 227, 100)
ReadIL.Emit(OpCodes.Br, label0)
ReadIL.MarkSequencePoint(doc11, 228, 1, 228, 100)
ReadIL.Emit(OpCodes.Br, cont115)
ReadIL.MarkLabel(fa115)
ReadIL.Emit(OpCodes.Br, cont115)
ReadIL.MarkLabel(cont115)
...
ReadIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa121 As System.Reflection.Emit.Label = ReadIL.DefineLabel()
Dim tru121 As System.Reflection.Emit.Label = ReadIL.DefineLabel()
Dim cont121 As System.Reflection.Emit.Label = ReadIL.DefineLabel()
ReadIL.Emit(OpCodes.Beq, tru121)
ReadIL.Emit(OpCodes.Br, fa121)
ReadIL.MarkLabel(tru121)
ReadIL.MarkSequencePoint(doc11, 234, 1, 234, 100)
Dim locbldr189 As LocalBuilder = ReadIL.DeclareLocal(GetType(FieldStmt))
locbldr189.SetLocalSymInfo("flss")
ReadIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
ReadIL.Emit(OpCodes.Stloc, 47)
ReadIL.MarkSequencePoint(doc11, 236, 1, 236, 100)
Dim locbldr190 As LocalBuilder = ReadIL.DeclareLocal(GetType(Attributes.Attribute).MakeArrayType())
locbldr190.SetLocalSymInfo("fattrs")
...
Dim locbldr191 As LocalBuilder = ReadIL.DeclareLocal(GetType(FieldAttributes))
locbldr191.SetLocalSymInfo("fa")
Dim typ66(-1) As Type
...
Dim locbldr192 As LocalBuilder = ReadIL.DeclareLocal(GetType(Ident))
locbldr192.SetLocalSymInfo("flssnam")
ReadIL.Emit(OpCodes.Ldloc, 47)
Typ = GetType(FieldStmt)
...
Dim locbldr193 As LocalBuilder = ReadIL.DeclareLocal(GetType(System.String))
locbldr193.SetLocalSymInfo("flsnamstr")
...
Dim locbldr194 As LocalBuilder = ReadIL.DeclareLocal(GetType(TypeTok))
locbldr194.SetLocalSymInfo("ftyptok")
ReadIL.Emit(OpCodes.Ldloc, 47)
Typ = GetType(FieldStmt)
...
Dim locbldr195 As LocalBuilder = ReadIL.DeclareLocal(GetType(System.Type))
locbldr195.SetLocalSymInfo("ftyp")
ReadIL.Emit(OpCodes.Ldnull)
...
Dim locbldr196 As LocalBuilder = ReadIL.DeclareLocal(GetType(TypeBuilder))
locbldr196.SetLocalSymInfo("typb2")
ReadIL.Emit(OpCodes.Ldsfld, GetType(AsmFactory).GetField("CurnTypB"))
Typ = GetType(AsmFactory).GetField("CurnTypB").FieldType
...
ReadIL.Emit(OpCodes.Ldc_I4, 0)
Typ = GetType(System.Boolean)
Dim fa122 As System.Reflection.Emit.Label = ReadIL.DefineLabel()
Dim tru122 As System.Reflection.Emit.Label = ReadIL.DefineLabel()
Dim cont122 As System.Reflection.Emit.Label = ReadIL.DefineLabel()
ReadIL.Emit(OpCodes.Beq, tru122)
ReadIL.Emit(OpCodes.Br, fa122)
ReadIL.MarkLabel(tru122)
...
ReadIL.Emit(OpCodes.Br, cont122)
ReadIL.MarkLabel(fa122)
...
ReadIL.Emit(OpCodes.Br, cont121)
ReadIL.MarkLabel(fa121)
ReadIL.Emit(OpCodes.Br, cont121)
ReadIL.MarkLabel(cont121)
...
ReadIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa123 As System.Reflection.Emit.Label = ReadIL.DefineLabel()
Dim tru123 As System.Reflection.Emit.Label = ReadIL.DefineLabel()
Dim cont123 As System.Reflection.Emit.Label = ReadIL.DefineLabel()
ReadIL.Emit(OpCodes.Beq, tru123)
ReadIL.Emit(OpCodes.Br, fa123)
ReadIL.MarkLabel(tru123)
...
ReadIL.Emit(OpCodes.Ldc_I4, 0)
Typ = GetType(System.Boolean)
Dim fa124 As System.Reflection.Emit.Label = ReadIL.DefineLabel()
Dim tru124 As System.Reflection.Emit.Label = ReadIL.DefineLabel()
Dim cont124 As System.Reflection.Emit.Label = ReadIL.DefineLabel()
ReadIL.Emit(OpCodes.Beq, tru124)
ReadIL.Emit(OpCodes.Br, fa124)
ReadIL.MarkLabel(tru124)
...
ReadIL.Emit(OpCodes.Br, cont124)
ReadIL.MarkLabel(fa124)
ReadIL.Emit(OpCodes.Br, cont124)
ReadIL.MarkLabel(cont124)
ReadIL.MarkSequencePoint(doc11, 283, 1, 283, 100)
ReadIL.Emit(OpCodes.Ldsfld, GetType(AsmFactory).GetField("isNested"))
Typ = GetType(AsmFactory).GetField("isNested").FieldType
ReadIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa125 As System.Reflection.Emit.Label = ReadIL.DefineLabel()
Dim tru125 As System.Reflection.Emit.Label = ReadIL.DefineLabel()
Dim cont125 As System.Reflection.Emit.Label = ReadIL.DefineLabel()
ReadIL.Emit(OpCodes.Beq, tru125)
ReadIL.Emit(OpCodes.Br, fa125)
ReadIL.MarkLabel(tru125)
...
ReadIL.Emit(OpCodes.Br, cont125)
ReadIL.MarkLabel(fa125)
ReadIL.Emit(OpCodes.Br, cont125)
ReadIL.MarkLabel(cont125)
ReadIL.MarkSequencePoint(doc11, 290, 1, 290, 100)
ReadIL.Emit(OpCodes.Br, label0)
ReadIL.MarkSequencePoint(doc11, 291, 1, 291, 100)
ReadIL.Emit(OpCodes.Br, cont123)
ReadIL.MarkLabel(fa123)
ReadIL.Emit(OpCodes.Br, cont123)
ReadIL.MarkLabel(cont123)
...
ReadIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa126 As System.Reflection.Emit.Label = ReadIL.DefineLabel()
Dim tru126 As System.Reflection.Emit.Label = ReadIL.DefineLabel()
Dim cont126 As System.Reflection.Emit.Label = ReadIL.DefineLabel()
ReadIL.Emit(OpCodes.Beq, tru126)
ReadIL.Emit(OpCodes.Br, fa126)
ReadIL.MarkLabel(tru126)
ReadIL.MarkSequencePoint(doc11, 297, 1, 297, 100)
Dim locbldr197 As LocalBuilder = ReadIL.DeclareLocal(GetType(MethodStmt))
locbldr197.SetLocalSymInfo("mtss")
ReadIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
...
Dim locbldr198 As LocalBuilder = ReadIL.DeclareLocal(GetType(Attributes.Attribute).MakeArrayType())
locbldr198.SetLocalSymInfo("mattrs")
...
Dim locbldr199 As LocalBuilder = ReadIL.DeclareLocal(GetType(MethodAttributes))
locbldr199.SetLocalSymInfo("ma")
Dim typ77(-1) As Type
...
Dim locbldr200 As LocalBuilder = ReadIL.DeclareLocal(GetType(Ident))
locbldr200.SetLocalSymInfo("mtssnam")
ReadIL.Emit(OpCodes.Ldloc, 55)
Typ = GetType(MethodStmt)
...
locbldr201.SetLocalSymInfo("mtssnamstr")
...
Dim locbldr202 As LocalBuilder = ReadIL.DeclareLocal(GetType(Expr).MakeArrayType())
locbldr202.SetLocalSymInfo("paramarr")
ReadIL.Emit(OpCodes.Ldloc, 55)
Typ = GetType(MethodStmt)
...
Dim locbldr203 As LocalBuilder = ReadIL.DeclareLocal(GetType(System.Int32))
locbldr203.SetLocalSymInfo("paramlen")
...
Dim locbldr204 As LocalBuilder = ReadIL.DeclareLocal(GetType(TypeTok))
locbldr204.SetLocalSymInfo("rettyptok")
ReadIL.Emit(OpCodes.Ldloc, 55)
Typ = GetType(MethodStmt)
...
Dim locbldr205 As LocalBuilder = ReadIL.DeclareLocal(GetType(System.Type))
locbldr205.SetLocalSymInfo("rettyp")
ReadIL.Emit(OpCodes.Ldnull)
...
ReadIL.Emit(OpCodes.Ldc_I4, CInt(0))
Typ = GetType(System.Int32)
Dim fa127 As System.Reflection.Emit.Label = ReadIL.DefineLabel()
Dim tru127 As System.Reflection.Emit.Label = ReadIL.DefineLabel()
Dim cont127 As System.Reflection.Emit.Label = ReadIL.DefineLabel()
ReadIL.Emit(OpCodes.Beq, tru127)
ReadIL.Emit(OpCodes.Br, fa127)
ReadIL.MarkLabel(tru127)
ReadIL.MarkSequencePoint(doc11, 330, 1, 330, 100)
ReadIL.Emit(OpCodes.Br, cont127)
ReadIL.MarkLabel(fa127)
...
ReadIL.Emit(OpCodes.Br, cont127)
ReadIL.MarkLabel(cont127)
ReadIL.MarkSequencePoint(doc11, 335, 1, 335, 100)
Dim locbldr206 As LocalBuilder = ReadIL.DeclareLocal(GetType(TypeBuilder))
locbldr206.SetLocalSymInfo("typb")
ReadIL.Emit(OpCodes.Ldsfld, GetType(AsmFactory).GetField("CurnTypB"))
Typ = GetType(AsmFactory).GetField("CurnTypB").FieldType
ReadIL.Emit(OpCodes.Stloc, 64)
ReadIL.MarkSequencePoint(doc11, 336, 1, 336, 100)
Dim locbldr207 As LocalBuilder = ReadIL.DeclareLocal(GetType(System.Boolean))
locbldr207.SetLocalSymInfo("isconstr")
Dim typ80(-1) As Type
...
ReadIL.Emit(OpCodes.Ldc_I4, 0)
Typ = GetType(System.Boolean)
Dim fa128 As System.Reflection.Emit.Label = ReadIL.DefineLabel()
Dim tru128 As System.Reflection.Emit.Label = ReadIL.DefineLabel()
Dim cont128 As System.Reflection.Emit.Label = ReadIL.DefineLabel()
ReadIL.Emit(OpCodes.Beq, tru128)
ReadIL.Emit(OpCodes.Br, fa128)
ReadIL.MarkLabel(tru128)
...
ReadIL.Emit(OpCodes.Ldc_I4, 0)
Typ = GetType(System.Boolean)
Dim fa129 As System.Reflection.Emit.Label = ReadIL.DefineLabel()
Dim tru129 As System.Reflection.Emit.Label = ReadIL.DefineLabel()
Dim cont129 As System.Reflection.Emit.Label = ReadIL.DefineLabel()
ReadIL.Emit(OpCodes.Beq, tru129)
ReadIL.Emit(OpCodes.Br, fa129)
ReadIL.MarkLabel(tru129)
...
ReadIL.Emit(OpCodes.Br, cont129)
ReadIL.MarkLabel(fa129)
...
ReadIL.Emit(OpCodes.Br, cont129)
ReadIL.MarkLabel(cont129)
ReadIL.MarkSequencePoint(doc11, 349, 1, 349, 100)
ReadIL.Emit(OpCodes.Br, cont128)
ReadIL.MarkLabel(fa128)
ReadIL.MarkSequencePoint(doc11, 350, 1, 350, 100)
Dim locbldr208 As LocalBuilder = ReadIL.DeclareLocal(GetType(CallingConventions))
locbldr208.SetLocalSymInfo("stdcallconv")
ReadIL.Emit(OpCodes.Ldc_I4, CInt(1))
Typ = GetType(System.Int32)
...
ReadIL.Emit(OpCodes.Ldc_I4, 0)
Typ = GetType(System.Boolean)
Dim fa130 As System.Reflection.Emit.Label = ReadIL.DefineLabel()
Dim tru130 As System.Reflection.Emit.Label = ReadIL.DefineLabel()
Dim cont130 As System.Reflection.Emit.Label = ReadIL.DefineLabel()
ReadIL.Emit(OpCodes.Beq, tru130)
ReadIL.Emit(OpCodes.Br, fa130)
ReadIL.MarkLabel(tru130)
...
ReadIL.Emit(OpCodes.Br, cont130)
ReadIL.MarkLabel(fa130)
...
ReadIL.Emit(OpCodes.Ldc_I4, CInt(0))
Typ = GetType(System.Int32)
Dim fa131 As System.Reflection.Emit.Label = ReadIL.DefineLabel()
Dim tru131 As System.Reflection.Emit.Label = ReadIL.DefineLabel()
Dim cont131 As System.Reflection.Emit.Label = ReadIL.DefineLabel()
ReadIL.Emit(OpCodes.Beq, tru131)
ReadIL.Emit(OpCodes.Br, fa131)
ReadIL.MarkLabel(tru131)
ReadIL.MarkSequencePoint(doc11, 370, 1, 370, 100)
ReadIL.Emit(OpCodes.Br, cont131)
ReadIL.MarkLabel(fa131)
ReadIL.MarkSequencePoint(doc11, 371, 1, 371, 100)
ReadIL.Emit(OpCodes.Ldloc, 65)
Typ = GetType(System.Boolean)
ReadIL.Emit(OpCodes.Ldc_I4, 0)
Typ = GetType(System.Boolean)
Dim fa132 As System.Reflection.Emit.Label = ReadIL.DefineLabel()
Dim tru132 As System.Reflection.Emit.Label = ReadIL.DefineLabel()
Dim cont132 As System.Reflection.Emit.Label = ReadIL.DefineLabel()
ReadIL.Emit(OpCodes.Beq, tru132)
ReadIL.Emit(OpCodes.Br, fa132)
ReadIL.MarkLabel(tru132)
...
ReadIL.Emit(OpCodes.Br, cont132)
ReadIL.MarkLabel(fa132)
...
ReadIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa133 As System.Reflection.Emit.Label = ReadIL.DefineLabel()
Dim tru133 As System.Reflection.Emit.Label = ReadIL.DefineLabel()
Dim cont133 As System.Reflection.Emit.Label = ReadIL.DefineLabel()
ReadIL.Emit(OpCodes.Beq, tru133)
ReadIL.Emit(OpCodes.Br, fa133)
ReadIL.MarkLabel(tru133)
...
Dim locbldr209 As LocalBuilder = ReadIL.DeclareLocal(GetType(System.Int32))
locbldr209.SetLocalSymInfo("mnamcomp")
Dim typ95(-1) As Type
...
Dim locbldr210 As LocalBuilder = ReadIL.DeclareLocal(GetType(System.Int32))
locbldr210.SetLocalSymInfo("amodecomp")
Dim typ96(-1) As Type
ReadIL.Emit(OpCodes.Ldsfld, GetType(AsmFactory).GetField("AsmMode"))
Typ = GetType(AsmFactory).GetField("AsmMode").FieldType
...
ReadIL.Emit(OpCodes.Ldc_I4, CInt(0))
Typ = GetType(System.Int32)
Dim fa134 As System.Reflection.Emit.Label = ReadIL.DefineLabel()
Dim tru134 As System.Reflection.Emit.Label = ReadIL.DefineLabel()
Dim cont134 As System.Reflection.Emit.Label = ReadIL.DefineLabel()
ReadIL.Emit(OpCodes.Beq, tru134)
ReadIL.Emit(OpCodes.Br, fa134)
ReadIL.MarkLabel(tru134)
ReadIL.MarkSequencePoint(doc11, 391, 1, 391, 100)
ReadIL.Emit(OpCodes.Ldloc, 68)
Typ = GetType(System.Int32)
ReadIL.Emit(OpCodes.Ldc_I4, CInt(0))
Typ = GetType(System.Int32)
Dim fa135 As System.Reflection.Emit.Label = ReadIL.DefineLabel()
Dim tru135 As System.Reflection.Emit.Label = ReadIL.DefineLabel()
Dim cont135 As System.Reflection.Emit.Label = ReadIL.DefineLabel()
ReadIL.Emit(OpCodes.Beq, tru135)
ReadIL.Emit(OpCodes.Br, fa135)
ReadIL.MarkLabel(tru135)
...
ReadIL.Emit(OpCodes.Br, cont135)
ReadIL.MarkLabel(fa135)
ReadIL.Emit(OpCodes.Br, cont135)
ReadIL.MarkLabel(cont135)
ReadIL.MarkSequencePoint(doc11, 394, 1, 394, 100)
ReadIL.Emit(OpCodes.Br, cont134)
ReadIL.MarkLabel(fa134)
ReadIL.Emit(OpCodes.Br, cont134)
ReadIL.MarkLabel(cont134)
ReadIL.MarkSequencePoint(doc11, 395, 1, 395, 100)
ReadIL.Emit(OpCodes.Br, label0)
ReadIL.MarkSequencePoint(doc11, 396, 1, 396, 100)
ReadIL.Emit(OpCodes.Br, cont133)
ReadIL.MarkLabel(fa133)
ReadIL.Emit(OpCodes.Br, cont133)
ReadIL.MarkLabel(cont133)
ReadIL.MarkSequencePoint(doc11, 398, 1, 398, 100)
Dim locbldr211 As LocalBuilder = ReadIL.DeclareLocal(GetType(Ident))
locbldr211.SetLocalSymInfo("vnam")
ReadIL.MarkSequencePoint(doc11, 399, 1, 399, 100)
Dim locbldr212 As LocalBuilder = ReadIL.DeclareLocal(GetType(TypeTok))
locbldr212.SetLocalSymInfo("vtyptok")
ReadIL.MarkSequencePoint(doc11, 400, 1, 400, 100)
Dim locbldr213 As LocalBuilder = ReadIL.DeclareLocal(GetType(System.Type))
locbldr213.SetLocalSymInfo("vtyp")
ReadIL.Emit(OpCodes.Ldnull)
ReadIL.Emit(OpCodes.Stloc, 71)
ReadIL.MarkSequencePoint(doc11, 401, 1, 401, 100)
Dim locbldr214 As LocalBuilder = ReadIL.DeclareLocal(asm.GetType("dylan.NET.Tokenizer.CodeGen.Evaluator"))
locbldr214.SetLocalSymInfo("eval")
ReadIL.Emit(OpCodes.Ldnull)
...
Dim locbldr215 As LocalBuilder = ReadIL.DeclareLocal(GetType(VarStmt))
locbldr215.SetLocalSymInfo("curv")
ReadIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
...
Dim locbldr216 As LocalBuilder = ReadIL.DeclareLocal(GetType(VarAsgnStmt))
locbldr216.SetLocalSymInfo("curva")
ReadIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
...
Dim locbldr217 As LocalBuilder = ReadIL.DeclareLocal(GetType(AssignStmt))
locbldr217.SetLocalSymInfo("asgnstm")
ReadIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
...
Dim locbldr218 As LocalBuilder = EmitMSILIL.DeclareLocal(GetType(System.Int32))
...
Dim locbldr219 As LocalBuilder = EmitMSILIL.DeclareLocal(GetType(System.Int32))
...
Dim locbldr220 As LocalBuilder = EmitMSILIL.DeclareLocal(GetType(Stmt))
locbldr220.SetLocalSymInfo("stm")
EmitMSILIL.Emit(OpCodes.Ldnull)
EmitMSILIL.Emit(OpCodes.Stloc, 2)
EmitMSILIL.MarkSequencePoint(doc12, 16, 1, 16, 100)
Dim locbldr221 As LocalBuilder = EmitMSILIL.DeclareLocal(GetType(System.Type))
locbldr221.SetLocalSymInfo("typ")
EmitMSILIL.MarkSequencePoint(doc12, 17, 1, 17, 100)
Dim locbldr222 As LocalBuilder = EmitMSILIL.DeclareLocal(GetType(System.Boolean))
locbldr222.SetLocalSymInfo("b")
...
Typ = GetType(System.Boolean)
Dim fa139 As System.Reflection.Emit.Label = EmitMSILIL.DefineLabel()
Dim tru139 As System.Reflection.Emit.Label = EmitMSILIL.DefineLabel()
Dim cont139 As System.Reflection.Emit.Label = EmitMSILIL.DefineLabel()
EmitMSILIL.Emit(OpCodes.Beq, tru139)
EmitMSILIL.Emit(OpCodes.Br, fa139)
EmitMSILIL.MarkLabel(tru139)
EmitMSILIL.MarkSequencePoint(doc12, 31, 1, 31, 100)
EmitMSILIL.Emit(OpCodes.Br, cont139)
EmitMSILIL.MarkLabel(fa139)
EmitMSILIL.MarkSequencePoint(doc12, 33, 1, 33, 100)
Dim locbldr223 As LocalBuilder = EmitMSILIL.DeclareLocal(asm.GetType("dylan.NET.Tokenizer.CodeGen.StmtReader"))
locbldr223.SetLocalSymInfo("sr")
...
EmitMSILIL.Emit(OpCodes.Br, cont139)
EmitMSILIL.MarkLabel(cont139)
EmitMSILIL.MarkSequencePoint(doc12, 38, 1, 38, 100)
EmitMSILIL.Emit(OpCodes.Ldloc, 0)
Typ = GetType(System.Int32)
EmitMSILIL.Emit(OpCodes.Ldloc, 1)
Typ = GetType(System.Int32)
Dim fa140 As System.Reflection.Emit.Label = EmitMSILIL.DefineLabel()
Dim tru140 As System.Reflection.Emit.Label = EmitMSILIL.DefineLabel()
Dim cont140 As System.Reflection.Emit.Label = EmitMSILIL.DefineLabel()
EmitMSILIL.Emit(OpCodes.Beq, tru140)
EmitMSILIL.Emit(OpCodes.Br, fa140)
EmitMSILIL.MarkLabel(tru140)
...
Dim locbldr224 As LocalBuilder = EmitMSILIL.DeclareLocal(GetType(AssemblyBuilder))
locbldr224.SetLocalSymInfo("ab")
...
EmitMSILIL.Emit(OpCodes.Br, cont140)
EmitMSILIL.MarkLabel(fa140)
