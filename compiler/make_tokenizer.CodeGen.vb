...
ReadIL.MarkSequencePoint(doc8, 16, 1, 16, 100)
...
ReadIL.MarkSequencePoint(doc8, 19, 1, 19, 100)
Dim typ2(-1) As Type
...
ReadIL.MarkSequencePoint(doc8, 34, 1, 34, 100)
...
ReadIL.MarkSequencePoint(doc8, 37, 1, 37, 100)
Dim typ8(-1) As Type
...
ReadIL.MarkSequencePoint(doc8, 41, 1, 41, 100)
...
ReadIL.Emit(OpCodes.Stloc, 0)
ReadIL.MarkSequencePoint(doc8, 44, 1, 44, 100)
Dim typ12(-1) As Type
ReadIL.Emit(OpCodes.Ldloc, 0)
Typ = GetType(System.Type)
Typ03 = Typ
...
Typ = GetType(Token).GetField("Value").FieldType
ReadIL.Emit(OpCodes.Stloc, 4)
ReadIL.MarkSequencePoint(doc8, 55, 1, 55, 100)
ReadIL.Emit(OpCodes.Ldc_I4, CInt(1))
Typ = GetType(System.Int32)
ReadIL.Emit(OpCodes.Conv_U)
ReadIL.Emit(OpCodes.Newarr, GetType(System.Char))
...
Typ = GetType(System.String)
ReadIL.Emit(OpCodes.Stfld, GetType(Token).GetField("Value"))
ReadIL.MarkSequencePoint(doc8, 59, 1, 59, 100)
...
ReadIL.Emit(OpCodes.Pop)
End If
ReadIL.MarkSequencePoint(doc8, 62, 1, 62, 100)
Dim typ18(-1) As Type
ReadIL.Emit(OpCodes.Ldloc, 9)
Typ = GetType(Token)
ReadIL.Emit(OpCodes.Ldfld, GetType(Token).GetField("Value"))
...
ReadIL.Emit(OpCodes.Br, label0)
ReadIL.MarkSequencePoint(doc8, 66, 1, 66, 100)
...
ReadIL.Emit(OpCodes.Stloc, 0)
ReadIL.MarkSequencePoint(doc8, 69, 1, 69, 100)
Dim typ21(-1) As Type
ReadIL.Emit(OpCodes.Ldloc, 0)
Typ = GetType(System.Type)
Typ03 = Typ
...
Typ = GetType(Token).GetField("Value").FieldType
ReadIL.Emit(OpCodes.Stloc, 4)
ReadIL.MarkSequencePoint(doc8, 80, 1, 80, 100)
ReadIL.Emit(OpCodes.Ldc_I4, CInt(1))
Typ = GetType(System.Int32)
ReadIL.Emit(OpCodes.Conv_U)
ReadIL.Emit(OpCodes.Newarr, GetType(System.Char))
...
Typ = GetType(System.String)
ReadIL.Emit(OpCodes.Stfld, GetType(Token).GetField("Value"))
ReadIL.MarkSequencePoint(doc8, 84, 1, 84, 100)
...
ReadIL.Emit(OpCodes.Pop)
End If
ReadIL.MarkSequencePoint(doc8, 87, 1, 87, 100)
Dim typ27(-1) As Type
ReadIL.Emit(OpCodes.Ldloc, 11)
Typ = GetType(Token)
ReadIL.Emit(OpCodes.Ldfld, GetType(Token).GetField("Value"))
...
ReadIL.Emit(OpCodes.Pop)
End If
ReadIL.MarkSequencePoint(doc8, 89, 1, 89, 100)
Dim typ28(-1) As Type
ReadIL.Emit(OpCodes.Ldloc, 11)
Typ = GetType(Token)
ReadIL.Emit(OpCodes.Ldfld, GetType(Token).GetField("Value"))
...
ReadIL.MarkSequencePoint(doc8, 100, 1, 100, 100)
Dim typ31(-1) As Type
...
ReadIL.MarkSequencePoint(doc8, 102, 1, 102, 100)
...
ReadIL.MarkSequencePoint(doc8, 104, 1, 104, 100)
ReadIL.Emit(OpCodes.Ldloc, 13)
Typ = GetType(Ident)
ReadIL.Emit(OpCodes.Ldfld, GetType(Ident).GetField("Value"))
Typ = GetType(Ident).GetField("Value").FieldType
...
ReadIL.Emit(OpCodes.Pop)
End If
ReadIL.MarkSequencePoint(doc8, 107, 1, 107, 100)
Dim typ33(-1) As Type
ReadIL.Emit(OpCodes.Ldloc, 13)
Typ = GetType(Ident)
ReadIL.Emit(OpCodes.Ldfld, GetType(Ident).GetField("Value"))
...
ReadIL.Emit(OpCodes.Pop)
End If
ReadIL.MarkSequencePoint(doc8, 132, 1, 132, 100)
ReadIL.Emit(OpCodes.Ldloc, 20)
Typ = GetType(AssemblyName)
ReadIL.Emit(OpCodes.Stsfld, GetType(AsmFactory).GetField("AsmNameStr"))
...
ReadIL.MarkSequencePoint(doc8, 134, 1, 134, 100)
...
ReadIL.Emit(OpCodes.Stloc, 24)
ReadIL.MarkSequencePoint(doc8, 139, 1, 139, 100)
...
ReadIL.MarkSequencePoint(doc8, 154, 1, 154, 100)
...
ReadIL.MarkSequencePoint(doc8, 155, 1, 155, 100)
...
ReadIL.MarkSequencePoint(doc8, 160, 1, 160, 100)
Dim typ47(-1) As Type
ReadIL.Emit(OpCodes.Ldloc, 25)
Typ = GetType(AssemblyBuilder)
Typ03 = Typ
...
ReadIL.MarkSequencePoint(doc8, 169, 1, 169, 100)
...
ReadIL.Emit(OpCodes.Stloc, 1)
ReadIL.MarkSequencePoint(doc8, 172, 1, 172, 100)
ReadIL.Emit(OpCodes.Ldloc, 1)
Typ = GetType(System.Boolean)
ReadIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
...
ReadIL.MarkSequencePoint(doc8, 175, 1, 175, 100)
ReadIL.Emit(OpCodes.Br, label0)
...
ReadIL.Emit(OpCodes.Stloc, 0)
ReadIL.MarkSequencePoint(doc8, 179, 1, 179, 100)
Dim typ52(-1) As Type
ReadIL.Emit(OpCodes.Ldloc, 0)
Typ = GetType(System.Type)
Typ03 = Typ
...
ReadIL.MarkSequencePoint(doc8, 192, 1, 192, 100)
...
ReadIL.MarkSequencePoint(doc8, 202, 1, 202, 100)
...
ReadIL.MarkSequencePoint(doc8, 203, 1, 203, 100)
...
ReadIL.MarkSequencePoint(doc8, 208, 1, 208, 100)
ReadIL.Emit(OpCodes.Ldloc, 43)
Typ = GetType(System.Type)
ReadIL.Emit(OpCodes.Stloc, 42)
...
ReadIL.Emit(OpCodes.Pop)
End If
ReadIL.MarkSequencePoint(doc8, 218, 1, 218, 100)
Dim typ60(-1) As Type
ReadIL.Emit(OpCodes.Ldloc, 40)
Typ = GetType(System.String)
...
ReadIL.MarkSequencePoint(doc8, 221, 1, 221, 100)
...
ReadIL.Emit(OpCodes.Pop)
End If
ReadIL.MarkSequencePoint(doc8, 224, 1, 224, 100)
Dim typ63(-1) As Type
...
ReadIL.MarkSequencePoint(doc8, 227, 1, 227, 100)
ReadIL.Emit(OpCodes.Br, label0)
...
ReadIL.Emit(OpCodes.Pop)
End If
ReadIL.MarkSequencePoint(doc8, 301, 1, 301, 100)
...
ReadIL.MarkSequencePoint(doc8, 352, 1, 352, 100)
...
ReadIL.Emit(OpCodes.Pop)
End If
ReadIL.MarkSequencePoint(doc8, 356, 1, 356, 100)
...
ReadIL.Emit(OpCodes.Pop)
End If
ReadIL.MarkSequencePoint(doc8, 393, 1, 393, 100)
...
ReadIL.MarkSequencePoint(doc8, 410, 1, 410, 100)
ReadIL.Emit(OpCodes.Ldloc, 72)
Typ = GetType(VarStmt)
...
ReadIL.MarkSequencePoint(doc8, 437, 1, 437, 100)
...
ReadIL.Emit(OpCodes.Stloc, 70)
ReadIL.MarkSequencePoint(doc8, 452, 1, 452, 100)
...
ReadIL.Emit(OpCodes.Pop)
End If
ReadIL.MarkSequencePoint(doc8, 455, 1, 455, 100)
ReadIL.Emit(OpCodes.Ldsfld, GetType(ILEmitter).GetField("LocInd"))
Typ = GetType(ILEmitter).GetField("LocInd").FieldType
ReadIL.Emit(OpCodes.Ldc_I4, CInt(1))
Typ = GetType(System.Int32)
...
ReadIL.Emit(OpCodes.Pop)
End If
ReadIL.MarkSequencePoint(doc8, 458, 1, 458, 100)
ReadIL.Emit(OpCodes.Br, label0)
ReadIL.MarkSequencePoint(doc8, 459, 1, 459, 100)
ReadIL.Emit(OpCodes.Br, cont83)
ReadIL.MarkLabel(fa83)
ReadIL.Emit(OpCodes.Br, cont83)
ReadIL.MarkLabel(cont83)
ReadIL.MarkSequencePoint(doc8, 462, 1, 462, 100)
ReadIL.MarkLabel(label0)
ReadIL.MarkSequencePoint(doc8, 464, 1, 464, 100)
...
EmitMSILIL.MarkSequencePoint(doc9, 13, 1, 13, 100)
...
EmitMSILIL.MarkSequencePoint(doc9, 15, 1, 15, 100)
...
EmitMSILIL.MarkSequencePoint(doc9, 17, 1, 17, 100)
...
EmitMSILIL.MarkSequencePoint(doc9, 24, 1, 24, 100)
...
Typ = Typ.GetElementType()
EmitMSILIL.Emit(OpCodes.Stloc, 2)
EmitMSILIL.MarkSequencePoint(doc9, 27, 1, 27, 100)
...
EmitMSILIL.MarkSequencePoint(doc9, 31, 1, 31, 100)
...
EmitMSILIL.Emit(OpCodes.Pop)
End If
EmitMSILIL.MarkSequencePoint(doc9, 41, 1, 41, 100)
...
EmitMSILIL.Emit(OpCodes.Pop)
End If
EmitMSILIL.MarkSequencePoint(doc9, 43, 1, 43, 100)
Dim typ6(-1) As Type
EmitMSILIL.Emit(OpCodes.Ldloc, 6)
Typ = GetType(AssemblyBuilder)
Typ03 = Typ
...
EmitMSILIL.Emit(OpCodes.Pop)
End If
EmitMSILIL.MarkSequencePoint(doc9, 46, 1, 46, 100)
EmitMSILIL.Emit(OpCodes.Br, label1)
EmitMSILIL.MarkSequencePoint(doc9, 47, 1, 47, 100)
EmitMSILIL.Emit(OpCodes.Br, cont85)
EmitMSILIL.MarkLabel(fa85)
EmitMSILIL.MarkSequencePoint(doc9, 48, 1, 48, 100)
EmitMSILIL.Emit(OpCodes.Br, label0)
EmitMSILIL.MarkSequencePoint(doc9, 49, 1, 49, 100)
EmitMSILIL.Emit(OpCodes.Br, cont85)
EmitMSILIL.MarkLabel(cont85)
EmitMSILIL.MarkSequencePoint(doc9, 51, 1, 51, 100)
EmitMSILIL.MarkLabel(label1)
EmitMSILIL.MarkSequencePoint(doc9, 53, 1, 53, 100)
...
doc8 = mdl.DefineDocument("E:\Code\dylannet\compiler\codegen\stmtreader.dyl", Guid.Empty, Guid.Empty, Guid.Empty)
doc9 = mdl.DefineDocument("E:\Code\dylannet\compiler\codegen\codegenerator.dyl", Guid.Empty, Guid.Empty, Guid.Empty)
