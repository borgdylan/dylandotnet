...
isSepIL.Emit(OpCodes.Beq, fa36)
isSepIL.Emit(OpCodes.Br, tru36)
...
isSepIL.Emit(OpCodes.Call, GetType(System.Convert).GetMethod("ToChar", typ42))
...
isSepIL.Emit(OpCodes.Call, GetType(Char).GetMethod("IsDigit", typ43))
Typ = GetType(Char).GetMethod("IsDigit", typ43).ReturnType
isSepIL.Emit(OpCodes.Stloc, 4)
...
isSepIL.Emit(OpCodes.Beq, fa45)
isSepIL.Emit(OpCodes.Br, tru45)
...
isSepIL.Emit(OpCodes.Call, GetType(System.Convert).GetMethod("ToChar", typ47))
Typ = GetType(System.Convert).GetMethod("ToChar", typ47).ReturnType
isSepIL.Emit(OpCodes.Stloc, 3)
...
isSepIL.Emit(OpCodes.Call, GetType(Char).GetMethod("IsDigit", typ48))
Typ = GetType(Char).GetMethod("IsDigit", typ48).ReturnType
isSepIL.Emit(OpCodes.Stloc, 4)
...
isSepIL.Emit(OpCodes.Call, GetType(System.Convert).GetMethod("ToString", typ51))
Typ = GetType(System.Convert).GetMethod("ToString", typ51).ReturnType
ReDim Preserve typ50(UBound(typ50) + 1)
typ50(UBound(typ50)) = Typ
isSepIL.Emit(OpCodes.Call, GetType(String).GetMethod("Compare", typ50))
...
isSepIL.Emit(OpCodes.Call, GetType(System.Convert).GetMethod("ToChar", typ52))
Typ = GetType(System.Convert).GetMethod("ToChar", typ52).ReturnType
...
isSepIL.Emit(OpCodes.Call, GetType(System.Convert).GetMethod("ToString", typ54))
...
typ55(UBound(typ55)) = GetType(Stmt)
ReDim Preserve typ55(UBound(typ55) + 1)
typ55(UBound(typ55)) = GetType(System.String)
Dim Analyze As MethodBuilder = Line.DefineMethod("Analyze", MethodAttributes.Public, GetType(Stmt), typ55)
...
AnalyzeIL.MarkSequencePoint(doc2, 400, 1, 400, 100)
...
AnalyzeIL.Emit(OpCodes.Beq, tru52)
...
ReDim Preserve typ57(UBound(typ57) + 1)
typ57(UBound(typ57)) = Typ
AnalyzeIL.Emit(OpCodes.Call, GetType(String).GetMethod("Compare", typ57))
...
AnalyzeIL.Emit(OpCodes.Beq, fa53)
AnalyzeIL.Emit(OpCodes.Br, tru53)
...
AnalyzeIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("AddToken", typ58))
...
AnalyzeIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("get_Chars", typ59))
Typ = Typ03.GetMethod("get_Chars", typ59).ReturnType
Dim typ60 As Type() = {Typ}
AnalyzeIL.Emit(OpCodes.Call, GetType(System.Convert).GetMethod("ToString", typ60))
...
AnalyzeIL.Emit(OpCodes.Blt, tru54)
...
ReDim Preserve typ66(UBound(typ66) + 1)
typ66(UBound(typ66)) = Typ
AnalyzeIL.Emit(OpCodes.Call, GetType(String).GetMethod("Concat", typ66))
...
ReDim Preserve typ67(UBound(typ67) + 1)
typ67(UBound(typ67)) = Typ
AnalyzeIL.Emit(OpCodes.Call, GetType(String).GetMethod("Concat", typ67))
Typ = GetType(String).GetMethod("Concat", typ67).ReturnType
AnalyzeIL.Emit(OpCodes.Stloc, 5)
AnalyzeIL.MarkSequencePoint(doc2, 454, 1, 454, 100)
AnalyzeIL.Emit(OpCodes.Br, cont55)
...
ReDim Preserve typ68(UBound(typ68) + 1)
typ68(UBound(typ68)) = Typ
AnalyzeIL.Emit(OpCodes.Call, GetType(String).GetMethod("Compare", typ68))
...
AnalyzeIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("AddToken", typ69))
...
AnalyzeIL.Emit(OpCodes.Blt, tru60)
