...
Dim locbldr33 As LocalBuilder = AnalyzeStringIL.DeclareLocal(GetType(StmtSet))
locbldr33.SetLocalSymInfo("stmts")
...
Dim locbldr34 As LocalBuilder = AnalyzeStringIL.DeclareLocal(GetType(Stmt))
locbldr34.SetLocalSymInfo("curstmt")
...
Dim locbldr35 As LocalBuilder = AnalyzeStringIL.DeclareLocal(asm.GetType("dylan.NET.Tokenizer.Lexer.Line"))
locbldr35.SetLocalSymInfo("curln")
AnalyzeStringIL.Emit(OpCodes.Ldnull)
AnalyzeStringIL.Emit(OpCodes.Stloc, 2)
AnalyzeStringIL.MarkSequencePoint(doc3, 119, 1, 119, 100)
Dim locbldr36 As LocalBuilder = AnalyzeStringIL.DeclareLocal(GetType(StringReader))
locbldr36.SetLocalSymInfo("sr")
Dim typ17(-1) As Type
...
Dim locbldr37 As LocalBuilder = AnalyzeStringIL.DeclareLocal(GetType(System.Boolean))
locbldr37.SetLocalSymInfo("crflag")
...
Dim locbldr38 As LocalBuilder = AnalyzeStringIL.DeclareLocal(GetType(System.Boolean))
locbldr38.SetLocalSymInfo("lfflag")
AnalyzeStringIL.Emit(OpCodes.Ldc_I4, 0)
Typ = GetType(System.Boolean)
AnalyzeStringIL.Emit(OpCodes.Stloc, 5)
AnalyzeStringIL.MarkSequencePoint(doc3, 122, 1, 122, 100)
Dim locbldr39 As LocalBuilder = AnalyzeStringIL.DeclareLocal(GetType(System.Boolean))
locbldr39.SetLocalSymInfo("andflg")
AnalyzeStringIL.Emit(OpCodes.Ldc_I4, 0)
Typ = GetType(System.Boolean)
AnalyzeStringIL.Emit(OpCodes.Stloc, 6)
AnalyzeStringIL.MarkSequencePoint(doc3, 123, 1, 123, 100)
Dim locbldr40 As LocalBuilder = AnalyzeStringIL.DeclareLocal(GetType(System.Boolean))
locbldr40.SetLocalSymInfo("orflg")
AnalyzeStringIL.Emit(OpCodes.Ldc_I4, 0)
Typ = GetType(System.Boolean)
AnalyzeStringIL.Emit(OpCodes.Stloc, 7)
AnalyzeStringIL.MarkSequencePoint(doc3, 124, 1, 124, 100)
Dim locbldr41 As LocalBuilder = AnalyzeStringIL.DeclareLocal(GetType(System.String))
locbldr41.SetLocalSymInfo("buf")
...
Dim locbldr42 As LocalBuilder = AnalyzeStringIL.DeclareLocal(GetType(System.Int32))
locbldr42.SetLocalSymInfo("curline")
...
Dim locbldr43 As LocalBuilder = AnalyzeStringIL.DeclareLocal(GetType(System.Int32))
locbldr43.SetLocalSymInfo("curstmtlen")
...
Dim locbldr44 As LocalBuilder = AnalyzeStringIL.DeclareLocal(GetType(System.Int32))
locbldr44.SetLocalSymInfo("n")
AnalyzeStringIL.Emit(OpCodes.Ldc_I4, CInt(0))
Typ = GetType(System.Int32)
...
locbldr45.SetLocalSymInfo("ch")
AnalyzeStringIL.Emit(OpCodes.Ldstr, "")
Typ = GetType(System.String)
AnalyzeStringIL.Emit(OpCodes.Stloc, 12)
AnalyzeStringIL.MarkSequencePoint(doc3, 130, 1, 130, 100)
Dim locbldr46 As LocalBuilder = AnalyzeStringIL.DeclareLocal(GetType(System.Char))
locbldr46.SetLocalSymInfo("chr")
...
AnalyzeStringIL.Emit(OpCodes.Ldc_I4, CInt(0))
Typ = GetType(System.Int32)
Dim fa71 As System.Reflection.Emit.Label = AnalyzeStringIL.DefineLabel()
Dim tru71 As System.Reflection.Emit.Label = AnalyzeStringIL.DefineLabel()
Dim cont71 As System.Reflection.Emit.Label = AnalyzeStringIL.DefineLabel()
AnalyzeStringIL.Emit(OpCodes.Blt, tru71)
AnalyzeStringIL.Emit(OpCodes.Br, fa71)
AnalyzeStringIL.MarkLabel(tru71)
...
AnalyzeStringIL.Emit(OpCodes.Br, cont71)
AnalyzeStringIL.MarkLabel(fa71)
AnalyzeStringIL.Emit(OpCodes.Br, cont71)
AnalyzeStringIL.MarkLabel(cont71)
...
AnalyzeStringIL.Emit(OpCodes.Ldc_I4, CInt(0))
Typ = GetType(System.Int32)
Dim fa72 As System.Reflection.Emit.Label = AnalyzeStringIL.DefineLabel()
Dim tru72 As System.Reflection.Emit.Label = AnalyzeStringIL.DefineLabel()
Dim cont72 As System.Reflection.Emit.Label = AnalyzeStringIL.DefineLabel()
AnalyzeStringIL.Emit(OpCodes.Beq, tru72)
AnalyzeStringIL.Emit(OpCodes.Br, fa72)
AnalyzeStringIL.MarkLabel(tru72)
...
AnalyzeStringIL.Emit(OpCodes.Br, cont72)
AnalyzeStringIL.MarkLabel(fa72)
AnalyzeStringIL.Emit(OpCodes.Br, cont72)
AnalyzeStringIL.MarkLabel(cont72)
...
AnalyzeStringIL.Emit(OpCodes.Beq, tru73)
...
AnalyzeStringIL.Emit(OpCodes.Beq, fa76)
AnalyzeStringIL.Emit(OpCodes.Br, tru76)
