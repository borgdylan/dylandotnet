...
isSepIL.Emit(OpCodes.Beq, fa22)
isSepIL.Emit(OpCodes.Br, tru22)
...
isSepIL.Emit(OpCodes.Beq, fa33)
isSepIL.Emit(OpCodes.Br, tru33)
...
isSepIL.Emit(OpCodes.Call, GetType(System.Convert).GetMethod("ToChar", typ37))
Typ = GetType(System.Convert).GetMethod("ToChar", typ37).ReturnType
isSepIL.Emit(OpCodes.Stloc, 3)
...
isSepIL.Emit(OpCodes.Call, GetType(Char).GetMethod("IsDigit", typ38))
Typ = GetType(Char).GetMethod("IsDigit", typ38).ReturnType
isSepIL.Emit(OpCodes.Stloc, 4)
...
isSepIL.Emit(OpCodes.Beq, fa40)
isSepIL.Emit(OpCodes.Br, tru40)
...
isSepIL.Emit(OpCodes.Call, GetType(System.Convert).GetMethod("ToString", typ46))
Typ = GetType(System.Convert).GetMethod("ToString", typ46).ReturnType
ReDim Preserve typ45(UBound(typ45) + 1)
typ45(UBound(typ45)) = Typ
...
isSepIL.Emit(OpCodes.Call, GetType(System.Convert).GetMethod("ToString", typ49))
Typ = GetType(System.Convert).GetMethod("ToString", typ49).ReturnType
ReDim Preserve typ48(UBound(typ48) + 1)
typ48(UBound(typ48)) = Typ
...
ReDim Preserve typ50(UBound(typ50) + 1)
typ50(UBound(typ50)) = GetType(System.String)
Dim Analyze As MethodBuilder = Line.DefineMethod("Analyze", MethodAttributes.Public, GetType(Stmt), typ50)
...
AnalyzeIL.MarkSequencePoint(doc2, 354, 1, 354, 100)
...
AnalyzeIL.Emit(OpCodes.Beq, tru45)
AnalyzeIL.Emit(OpCodes.Br, fa45)
...
AnalyzeIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("get_Chars", typ54))
Typ = Typ03.GetMethod("get_Chars", typ54).ReturnType
Dim typ55 As Type() = {Typ}
AnalyzeIL.Emit(OpCodes.Call, GetType(System.Convert).GetMethod("ToString", typ55))
...
AnalyzeIL.Emit(OpCodes.Blt, tru49)
...
AnalyzeIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("get_Chars", typ56))
Typ = Typ03.GetMethod("get_Chars", typ56).ReturnType
Dim typ57 As Type() = {Typ}
AnalyzeIL.Emit(OpCodes.Call, GetType(System.Convert).GetMethod("ToString", typ57))
...
ReDim Preserve typ61(UBound(typ61) + 1)
typ61(UBound(typ61)) = Typ
AnalyzeIL.Emit(OpCodes.Call, GetType(String).GetMethod("Concat", typ61))
Typ = GetType(String).GetMethod("Concat", typ61).ReturnType
AnalyzeIL.Emit(OpCodes.Stloc, 5)
...
ReDim Preserve typ63(UBound(typ63) + 1)
typ63(UBound(typ63)) = Typ
AnalyzeIL.Emit(OpCodes.Call, GetType(String).GetMethod("Compare", typ63))
...
AnalyzeIL.Emit(OpCodes.Beq, fa54)
AnalyzeIL.Emit(OpCodes.Br, tru54)
...
AnalyzeIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("AddToken", typ64))
Typ = Typ03.GetMethod("AddToken", typ64).ReturnType
If Typ.ToString() = GetType(System.Void).ToString() Then
...
AnalyzeIL.Emit(OpCodes.Blt, tru55)
