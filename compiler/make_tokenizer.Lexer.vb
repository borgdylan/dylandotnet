...
typ0(UBound(typ0)) = GetType(System.Char)
Dim isDigit As MethodBuilder = Line.DefineMethod("isDigit", MethodAttributes.Public, GetType(System.Boolean), typ0)
Dim isDigitIL As ILGenerator = isDigit.GetILGenerator()
Dim isDigitparam01 As ParameterBuilder = isDigit.DefineParameter(1, ParameterAttributes.None, "c")
isDigitIL.MarkSequencePoint(doc2, 25, 1, 25, 100)
Dim locbldr0 As LocalBuilder = isDigitIL.DeclareLocal(GetType(System.Int32))
locbldr0.SetLocalSymInfo("cn")
isDigitIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(System.Char)
Dim typ1 As Type() = {Typ}
isDigitIL.Emit(OpCodes.Call, GetType(System.Convert).GetMethod("ToInt32", typ1))
Typ = GetType(System.Convert).GetMethod("ToInt32", typ1).ReturnType
isDigitIL.Emit(OpCodes.Stloc, 0)
isDigitIL.MarkSequencePoint(doc2, 26, 1, 26, 100)
Dim locbldr1 As LocalBuilder = isDigitIL.DeclareLocal(GetType(System.Int32))
locbldr1.SetLocalSymInfo("zn")
isDigitIL.Emit(OpCodes.Ldstr, "0")
Typ = GetType(System.String)
Dim typ2 As Type() = {Typ}
isDigitIL.Emit(OpCodes.Call, GetType(System.Convert).GetMethod("ToChar", typ2))
Typ = GetType(System.Convert).GetMethod("ToChar", typ2).ReturnType
Dim typ3 As Type() = {Typ}
isDigitIL.Emit(OpCodes.Call, GetType(System.Convert).GetMethod("ToInt32", typ3))
Typ = GetType(System.Convert).GetMethod("ToInt32", typ3).ReturnType
isDigitIL.Emit(OpCodes.Stloc, 1)
isDigitIL.MarkSequencePoint(doc2, 27, 1, 27, 100)
Dim locbldr2 As LocalBuilder = isDigitIL.DeclareLocal(GetType(System.Int32))
locbldr2.SetLocalSymInfo("nn")
isDigitIL.Emit(OpCodes.Ldstr, "9")
Typ = GetType(System.String)
Dim typ4 As Type() = {Typ}
isDigitIL.Emit(OpCodes.Call, GetType(System.Convert).GetMethod("ToChar", typ4))
Typ = GetType(System.Convert).GetMethod("ToChar", typ4).ReturnType
Dim typ5 As Type() = {Typ}
isDigitIL.Emit(OpCodes.Call, GetType(System.Convert).GetMethod("ToInt32", typ5))
Typ = GetType(System.Convert).GetMethod("ToInt32", typ5).ReturnType
isDigitIL.Emit(OpCodes.Stloc, 2)
isDigitIL.MarkSequencePoint(doc2, 29, 1, 29, 100)
Dim locbldr3 As LocalBuilder = isDigitIL.DeclareLocal(GetType(System.Boolean))
locbldr3.SetLocalSymInfo("res")
isDigitIL.Emit(OpCodes.Ldc_I4, 0)
Typ = GetType(System.Boolean)
isDigitIL.Emit(OpCodes.Stloc, 3)
isDigitIL.MarkSequencePoint(doc2, 31, 1, 31, 100)
isDigitIL.Emit(OpCodes.Ldloc, 0)
Typ = GetType(System.Int32)
isDigitIL.Emit(OpCodes.Ldloc, 1)
Typ = GetType(System.Int32)
Dim fa0 As System.Reflection.Emit.Label = isDigitIL.DefineLabel()
Dim tru0 As System.Reflection.Emit.Label = isDigitIL.DefineLabel()
Dim cont0 As System.Reflection.Emit.Label = isDigitIL.DefineLabel()
isDigitIL.Emit(OpCodes.Bge, tru0)
isDigitIL.Emit(OpCodes.Br, fa0)
isDigitIL.MarkLabel(tru0)
isDigitIL.MarkSequencePoint(doc2, 32, 1, 32, 100)
isDigitIL.Emit(OpCodes.Ldloc, 0)
Typ = GetType(System.Int32)
isDigitIL.Emit(OpCodes.Ldloc, 2)
Typ = GetType(System.Int32)
Dim fa1 As System.Reflection.Emit.Label = isDigitIL.DefineLabel()
Dim tru1 As System.Reflection.Emit.Label = isDigitIL.DefineLabel()
Dim cont1 As System.Reflection.Emit.Label = isDigitIL.DefineLabel()
isDigitIL.Emit(OpCodes.Ble, tru1)
isDigitIL.Emit(OpCodes.Br, fa1)
isDigitIL.MarkLabel(tru1)
isDigitIL.MarkSequencePoint(doc2, 33, 1, 33, 100)
isDigitIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
isDigitIL.Emit(OpCodes.Stloc, 3)
isDigitIL.MarkSequencePoint(doc2, 34, 1, 34, 100)
isDigitIL.Emit(OpCodes.Br, cont1)
isDigitIL.MarkLabel(fa1)
isDigitIL.Emit(OpCodes.Br, cont1)
isDigitIL.MarkLabel(cont1)
isDigitIL.MarkSequencePoint(doc2, 35, 1, 35, 100)
isDigitIL.Emit(OpCodes.Br, cont0)
isDigitIL.MarkLabel(fa0)
isDigitIL.Emit(OpCodes.Br, cont0)
isDigitIL.MarkLabel(cont0)
isDigitIL.MarkSequencePoint(doc2, 37, 1, 37, 100)
isDigitIL.Emit(OpCodes.Ldloc, 3)
Typ = GetType(System.Boolean)
isDigitIL.MarkSequencePoint(doc2, 39, 1, 39, 100)
isDigitIL.Emit(OpCodes.Ret)
Dim typ6(-1) As Type
...
ReDim Preserve typ6(UBound(typ6) + 1)
typ6(UBound(typ6)) = GetType(System.Boolean).MakeByRefType()
Dim isSep As MethodBuilder = Line.DefineMethod("isSep", MethodAttributes.Public, GetType(System.Boolean), typ6)
...
isSepIL.MarkSequencePoint(doc2, 43, 1, 43, 100)
Dim locbldr4 As LocalBuilder = isSepIL.DeclareLocal(GetType(System.Int32))
locbldr4.SetLocalSymInfo("comp")
isSepIL.Emit(OpCodes.Ldc_I4, CInt(0))
Typ = GetType(System.Int32)
isSepIL.Emit(OpCodes.Stloc, 0)
isSepIL.MarkSequencePoint(doc2, 44, 1, 44, 100)
Dim locbldr5 As LocalBuilder = isSepIL.DeclareLocal(GetType(System.Boolean))
locbldr5.SetLocalSymInfo("orflg")
isSepIL.Emit(OpCodes.Ldc_I4, 0)
Typ = GetType(System.Boolean)
isSepIL.Emit(OpCodes.Stloc, 1)
isSepIL.MarkSequencePoint(doc2, 45, 1, 45, 100)
Dim locbldr6 As LocalBuilder = isSepIL.DeclareLocal(GetType(System.Boolean))
locbldr6.SetLocalSymInfo("ob")
isSepIL.Emit(OpCodes.Ldc_I4, 0)
Typ = GetType(System.Boolean)
isSepIL.Emit(OpCodes.Stloc, 2)
isSepIL.MarkSequencePoint(doc2, 46, 1, 46, 100)
Dim locbldr7 As LocalBuilder = isSepIL.DeclareLocal(GetType(System.Char))
locbldr7.SetLocalSymInfo("tc")
isSepIL.Emit(OpCodes.Ldstr, "a")
Typ = GetType(System.String)
Dim typ7 As Type() = {Typ}
isSepIL.Emit(OpCodes.Call, GetType(System.Convert).GetMethod("ToChar", typ7))
...
Dim locbldr8 As LocalBuilder = isSepIL.DeclareLocal(GetType(System.Boolean))
locbldr8.SetLocalSymInfo("tb")
isSepIL.Emit(OpCodes.Ldc_I4, 0)
Typ = GetType(System.Boolean)
...
isSepIL.MarkSequencePoint(doc2, 67, 1, 67, 100)
isSepIL.Emit(OpCodes.Ldarg_0)
isSepIL.Emit(OpCodes.Ldfld, InStr)
Typ = InStr.FieldType
isSepIL.Emit(OpCodes.Ldarg_0)
...
isSepIL.Emit(OpCodes.Beq, tru26)
isSepIL.Emit(OpCodes.Br, fa26)
...
isSepIL.Emit(OpCodes.Beq, fa28)
isSepIL.Emit(OpCodes.Br, tru28)
...
isSepIL.Emit(OpCodes.Br, label0)
isSepIL.MarkSequencePoint(doc2, 249, 1, 249, 100)
isSepIL.Emit(OpCodes.Br, cont28)
...
isSepIL.Emit(OpCodes.Beq, fa41)
isSepIL.Emit(OpCodes.Br, tru41)
...
ReDim Preserve typ44(UBound(typ44) + 1)
typ44(UBound(typ44)) = Typ
isSepIL.Emit(OpCodes.Call, GetType(String).GetMethod("Compare", typ44))
...
ReDim Preserve typ45(UBound(typ45) + 1)
typ45(UBound(typ45)) = Typ
isSepIL.Emit(OpCodes.Call, GetType(String).GetMethod("Compare", typ45))
...
isSepIL.Emit(OpCodes.Stloc, 0)
isSepIL.MarkSequencePoint(doc2, 320, 1, 320, 100)
isSepIL.Emit(OpCodes.Ldloc, 0)
Typ = GetType(System.Int32)
isSepIL.Emit(OpCodes.Ldc_I4, CInt(0))
Typ = GetType(System.Int32)
...
isSepIL.Emit(OpCodes.Beq, tru44)
isSepIL.Emit(OpCodes.Br, fa44)
...
Typ = GetType(System.Boolean)
isSepIL.Emit(OpCodes.Stobj, Typ04)
isSepIL.MarkSequencePoint(doc2, 322, 1, 322, 100)
isSepIL.Emit(OpCodes.Ldarg, 4)
Typ = GetType(System.Boolean).MakeByRefType()
Typ04 = Typ.GetElementType()
isSepIL.Emit(OpCodes.Ldc_I4, 0)
...
isSepIL.Emit(OpCodes.Beq, fa46)
isSepIL.Emit(OpCodes.Br, tru46)
...
ReDim Preserve typ49(UBound(typ49) + 1)
typ49(UBound(typ49)) = Typ
isSepIL.Emit(OpCodes.Call, GetType(String).GetMethod("Compare", typ49))
Typ = GetType(String).GetMethod("Compare", typ49).ReturnType
isSepIL.Emit(OpCodes.Stloc, 0)
isSepIL.MarkSequencePoint(doc2, 346, 1, 346, 100)
isSepIL.Emit(OpCodes.Ldloc, 0)
Typ = GetType(System.Int32)
isSepIL.Emit(OpCodes.Ldc_I4, CInt(0))
Typ = GetType(System.Int32)
...
Typ = GetType(System.Boolean)
isSepIL.Emit(OpCodes.Stloc, 2)
isSepIL.MarkSequencePoint(doc2, 348, 1, 348, 100)
...
isSepIL.Emit(OpCodes.Call, GetType(System.Convert).GetMethod("ToChar", typ50))
Typ = GetType(System.Convert).GetMethod("ToChar", typ50).ReturnType
isSepIL.Emit(OpCodes.Stloc, 3)
...
isSepIL.Emit(OpCodes.Call, GetType(Char).GetMethod("IsDigit", typ51))
Typ = GetType(Char).GetMethod("IsDigit", typ51).ReturnType
isSepIL.Emit(OpCodes.Stloc, 4)
...
isSepIL.Emit(OpCodes.Beq, tru48)
isSepIL.Emit(OpCodes.Br, fa48)
...
ReDim Preserve typ53(UBound(typ53) + 1)
typ53(UBound(typ53)) = Typ
isSepIL.Emit(OpCodes.Call, GetType(String).GetMethod("Compare", typ53))
...
isSepIL.Emit(OpCodes.Beq, fa50)
isSepIL.Emit(OpCodes.Br, tru50)
...
ReDim Preserve typ54(UBound(typ54) + 1)
typ54(UBound(typ54)) = Typ
isSepIL.Emit(OpCodes.Call, GetType(String).GetMethod("Compare", typ54))
Typ = GetType(String).GetMethod("Compare", typ54).ReturnType
isSepIL.Emit(OpCodes.Stloc, 0)
isSepIL.MarkSequencePoint(doc2, 372, 1, 372, 100)
isSepIL.Emit(OpCodes.Ldloc, 0)
Typ = GetType(System.Int32)
isSepIL.Emit(OpCodes.Ldc_I4, CInt(0))
Typ = GetType(System.Int32)
...
isSepIL.MarkSequencePoint(doc2, 375, 1, 375, 100)
isSepIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
isSepIL.Emit(OpCodes.Stloc, 2)
...
isSepIL.Emit(OpCodes.Call, GetType(System.Convert).GetMethod("ToChar", typ55))
Typ = GetType(System.Convert).GetMethod("ToChar", typ55).ReturnType
isSepIL.Emit(OpCodes.Stloc, 3)
...
isSepIL.Emit(OpCodes.Call, GetType(Char).GetMethod("IsDigit", typ56))
Typ = GetType(Char).GetMethod("IsDigit", typ56).ReturnType
isSepIL.Emit(OpCodes.Stloc, 4)
...
isSepIL.MarkSequencePoint(doc2, 384, 1, 384, 100)
isSepIL.Emit(OpCodes.Ldarg, 3)
Typ = GetType(System.Boolean).MakeByRefType()
Typ04 = Typ.GetElementType()
isSepIL.Emit(OpCodes.Ldc_I4, 1)
...
Typ = GetType(System.Boolean)
isSepIL.Emit(OpCodes.Stloc, 2)
isSepIL.MarkSequencePoint(doc2, 387, 1, 387, 100)
isSepIL.Emit(OpCodes.Br, label0)
...
Dim locbldr9 As LocalBuilder = isSepIL.DeclareLocal(GetType(System.Char))
locbldr9.SetLocalSymInfo("tabchr")
isSepIL.Emit(OpCodes.Ldc_I4, CInt(9))
Typ = GetType(System.Int32)
Dim typ57 As Type() = {Typ}
isSepIL.Emit(OpCodes.Call, GetType(System.Convert).GetMethod("ToChar", typ57))
Typ = GetType(System.Convert).GetMethod("ToChar", typ57).ReturnType
...
isSepIL.Emit(OpCodes.Call, GetType(System.Convert).GetMethod("ToString", typ59))
Typ = GetType(System.Convert).GetMethod("ToString", typ59).ReturnType
ReDim Preserve typ58(UBound(typ58) + 1)
typ58(UBound(typ58)) = Typ
isSepIL.Emit(OpCodes.Call, GetType(String).GetMethod("Compare", typ58))
...
isSepIL.Emit(OpCodes.Ldc_I4, CInt(0))
Typ = GetType(System.Int32)
Dim fa53 As System.Reflection.Emit.Label = isSepIL.DefineLabel()
Dim tru53 As System.Reflection.Emit.Label = isSepIL.DefineLabel()
Dim cont53 As System.Reflection.Emit.Label = isSepIL.DefineLabel()
isSepIL.Emit(OpCodes.Beq, tru53)
isSepIL.Emit(OpCodes.Br, fa53)
isSepIL.MarkLabel(tru53)
...
Typ = GetType(System.Boolean)
isSepIL.Emit(OpCodes.Stobj, Typ04)
isSepIL.MarkSequencePoint(doc2, 396, 1, 396, 100)
isSepIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
isSepIL.Emit(OpCodes.Stloc, 2)
...
isSepIL.Emit(OpCodes.Br, cont53)
isSepIL.MarkLabel(fa53)
...
Typ = GetType(System.Boolean)
isSepIL.Emit(OpCodes.Stloc, 2)
isSepIL.MarkSequencePoint(doc2, 401, 1, 401, 100)
isSepIL.Emit(OpCodes.Br, cont53)
isSepIL.MarkLabel(cont53)
isSepIL.MarkSequencePoint(doc2, 403, 1, 403, 100)
Dim locbldr10 As LocalBuilder = isSepIL.DeclareLocal(GetType(System.Char))
locbldr10.SetLocalSymInfo("spchr")
isSepIL.Emit(OpCodes.Ldc_I4, CInt(32))
Typ = GetType(System.Int32)
Dim typ60 As Type() = {Typ}
isSepIL.Emit(OpCodes.Call, GetType(System.Convert).GetMethod("ToChar", typ60))
Typ = GetType(System.Convert).GetMethod("ToChar", typ60).ReturnType
...
isSepIL.Emit(OpCodes.Call, GetType(System.Convert).GetMethod("ToString", typ62))
Typ = GetType(System.Convert).GetMethod("ToString", typ62).ReturnType
ReDim Preserve typ61(UBound(typ61) + 1)
typ61(UBound(typ61)) = Typ
isSepIL.Emit(OpCodes.Call, GetType(String).GetMethod("Compare", typ61))
Typ = GetType(String).GetMethod("Compare", typ61).ReturnType
isSepIL.Emit(OpCodes.Stloc, 0)
isSepIL.MarkSequencePoint(doc2, 406, 1, 406, 100)
isSepIL.Emit(OpCodes.Ldloc, 0)
Typ = GetType(System.Int32)
isSepIL.Emit(OpCodes.Ldc_I4, CInt(0))
Typ = GetType(System.Int32)
Dim fa54 As System.Reflection.Emit.Label = isSepIL.DefineLabel()
Dim tru54 As System.Reflection.Emit.Label = isSepIL.DefineLabel()
Dim cont54 As System.Reflection.Emit.Label = isSepIL.DefineLabel()
isSepIL.Emit(OpCodes.Beq, tru54)
isSepIL.Emit(OpCodes.Br, fa54)
isSepIL.MarkLabel(tru54)
...
Typ = GetType(System.Boolean)
isSepIL.Emit(OpCodes.Stobj, Typ04)
isSepIL.MarkSequencePoint(doc2, 408, 1, 408, 100)
isSepIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
isSepIL.Emit(OpCodes.Stloc, 2)
isSepIL.MarkSequencePoint(doc2, 409, 1, 409, 100)
isSepIL.Emit(OpCodes.Br, label0)
isSepIL.MarkSequencePoint(doc2, 410, 1, 410, 100)
isSepIL.Emit(OpCodes.Br, cont54)
isSepIL.MarkLabel(fa54)
isSepIL.MarkSequencePoint(doc2, 411, 1, 411, 100)
isSepIL.Emit(OpCodes.Ldarg, 3)
Typ = GetType(System.Boolean).MakeByRefType()
Typ04 = Typ.GetElementType()
isSepIL.Emit(OpCodes.Ldc_I4, 0)
Typ = GetType(System.Boolean)
isSepIL.Emit(OpCodes.Stobj, Typ04)
isSepIL.MarkSequencePoint(doc2, 412, 1, 412, 100)
isSepIL.Emit(OpCodes.Ldc_I4, 0)
Typ = GetType(System.Boolean)
isSepIL.Emit(OpCodes.Stloc, 2)
isSepIL.MarkSequencePoint(doc2, 413, 1, 413, 100)
isSepIL.Emit(OpCodes.Br, cont54)
isSepIL.MarkLabel(cont54)
isSepIL.MarkSequencePoint(doc2, 415, 1, 415, 100)
isSepIL.Emit(OpCodes.Br, cont6)
isSepIL.MarkLabel(fa6)
isSepIL.MarkSequencePoint(doc2, 416, 1, 416, 100)
isSepIL.Emit(OpCodes.Ldarg, 3)
Typ = GetType(System.Boolean).MakeByRefType()
Typ04 = Typ.GetElementType()
isSepIL.Emit(OpCodes.Ldc_I4, 0)
Typ = GetType(System.Boolean)
isSepIL.Emit(OpCodes.Stobj, Typ04)
isSepIL.MarkSequencePoint(doc2, 417, 1, 417, 100)
isSepIL.Emit(OpCodes.Ldc_I4, 0)
Typ = GetType(System.Boolean)
isSepIL.Emit(OpCodes.Stloc, 2)
isSepIL.MarkSequencePoint(doc2, 418, 1, 418, 100)
isSepIL.Emit(OpCodes.Br, cont6)
isSepIL.MarkLabel(cont6)
isSepIL.MarkSequencePoint(doc2, 420, 1, 420, 100)
isSepIL.MarkLabel(label0)
isSepIL.MarkSequencePoint(doc2, 422, 1, 422, 100)
isSepIL.Emit(OpCodes.Ldarg_0)
isSepIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(System.String)
isSepIL.Emit(OpCodes.Stfld, PrevChar)
isSepIL.MarkSequencePoint(doc2, 423, 1, 423, 100)
isSepIL.Emit(OpCodes.Ldloc, 2)
Typ = GetType(System.Boolean)
isSepIL.MarkSequencePoint(doc2, 425, 1, 425, 100)
isSepIL.Emit(OpCodes.Ret)
Dim typ63(-1) As Type
ReDim Preserve typ63(UBound(typ63) + 1)
typ63(UBound(typ63)) = GetType(Stmt)
ReDim Preserve typ63(UBound(typ63) + 1)
typ63(UBound(typ63)) = GetType(System.String)
Dim Analyze As MethodBuilder = Line.DefineMethod("Analyze", MethodAttributes.Public, GetType(Stmt), typ63)
...
Dim locbldr11 As LocalBuilder = AnalyzeIL.DeclareLocal(GetType(System.String))
locbldr11.SetLocalSymInfo("curchar")
AnalyzeIL.Emit(OpCodes.Ldstr, "")
Typ = GetType(System.String)
AnalyzeIL.Emit(OpCodes.Stloc, 0)
AnalyzeIL.MarkSequencePoint(doc2, 430, 1, 430, 100)
Dim locbldr12 As LocalBuilder = AnalyzeIL.DeclareLocal(GetType(System.String))
locbldr12.SetLocalSymInfo("lachar")
AnalyzeIL.Emit(OpCodes.Ldstr, "")
Typ = GetType(System.String)
AnalyzeIL.Emit(OpCodes.Stloc, 1)
AnalyzeIL.MarkSequencePoint(doc2, 431, 1, 431, 100)
Dim locbldr13 As LocalBuilder = AnalyzeIL.DeclareLocal(GetType(Token))
locbldr13.SetLocalSymInfo("curtok")
AnalyzeIL.Emit(OpCodes.Ldnull)
AnalyzeIL.Emit(OpCodes.Stloc, 2)
AnalyzeIL.MarkSequencePoint(doc2, 432, 1, 432, 100)
...
locbldr15.SetLocalSymInfo("comp")
...
AnalyzeIL.Emit(OpCodes.Stloc, 3)
AnalyzeIL.MarkSequencePoint(doc2, 436, 1, 436, 100)
Dim locbldr16 As LocalBuilder = AnalyzeIL.DeclareLocal(GetType(System.String))
locbldr16.SetLocalSymInfo("buf")
AnalyzeIL.Emit(OpCodes.Ldstr, "")
Typ = GetType(System.String)
AnalyzeIL.Emit(OpCodes.Stloc, 5)
AnalyzeIL.MarkSequencePoint(doc2, 437, 1, 437, 100)
Dim locbldr17 As LocalBuilder = AnalyzeIL.DeclareLocal(GetType(System.Boolean))
locbldr17.SetLocalSymInfo("cuttok")
AnalyzeIL.Emit(OpCodes.Ldc_I4, 0)
Typ = GetType(System.Boolean)
AnalyzeIL.Emit(OpCodes.Stloc, 6)
AnalyzeIL.MarkSequencePoint(doc2, 438, 1, 438, 100)
Dim locbldr18 As LocalBuilder = AnalyzeIL.DeclareLocal(GetType(System.Boolean))
locbldr18.SetLocalSymInfo("sc")
AnalyzeIL.Emit(OpCodes.Ldc_I4, 0)
Typ = GetType(System.Boolean)
AnalyzeIL.Emit(OpCodes.Stloc, 7)
AnalyzeIL.MarkSequencePoint(doc2, 439, 1, 439, 100)
Dim locbldr19 As LocalBuilder = AnalyzeIL.DeclareLocal(GetType(System.Boolean))
locbldr19.SetLocalSymInfo("scl")
AnalyzeIL.Emit(OpCodes.Ldc_I4, 0)
Typ = GetType(System.Boolean)
AnalyzeIL.Emit(OpCodes.Stloc, 8)
AnalyzeIL.MarkSequencePoint(doc2, 440, 1, 440, 100)
Dim locbldr20 As LocalBuilder = AnalyzeIL.DeclareLocal(GetType(System.Int32))
locbldr20.SetLocalSymInfo("i")
AnalyzeIL.Emit(OpCodes.Ldc_I4, CInt(-1))
Typ = GetType(System.Int32)
AnalyzeIL.Emit(OpCodes.Stloc, 9)
AnalyzeIL.MarkSequencePoint(doc2, 441, 1, 441, 100)
Dim locbldr21 As LocalBuilder = AnalyzeIL.DeclareLocal(GetType(System.Int32))
locbldr21.SetLocalSymInfo("j")
AnalyzeIL.Emit(OpCodes.Ldc_I4, CInt(0))
Typ = GetType(System.Int32)
...
AnalyzeIL.MarkSequencePoint(doc2, 451, 1, 451, 100)
...
AnalyzeIL.MarkSequencePoint(doc2, 456, 1, 456, 100)
AnalyzeIL.Emit(OpCodes.Ldc_I4, 0)
Typ = GetType(System.Boolean)
AnalyzeIL.Emit(OpCodes.Stloc, 7)
...
ReDim Preserve typ65(UBound(typ65) + 1)
typ65(UBound(typ65)) = Typ
AnalyzeIL.Emit(OpCodes.Call, GetType(String).GetMethod("Compare", typ65))
...
AnalyzeIL.Emit(OpCodes.Beq, fa58)
AnalyzeIL.Emit(OpCodes.Br, tru58)
AnalyzeIL.MarkLabel(tru58)
AnalyzeIL.MarkSequencePoint(doc2, 462, 1, 462, 100)
...
AnalyzeIL.MarkSequencePoint(doc2, 464, 1, 464, 100)
AnalyzeIL.Emit(OpCodes.Ldloc, 2)
Typ = GetType(Token)
...
AnalyzeIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("AddToken", typ66))
Typ = Typ03.GetMethod("AddToken", typ66).ReturnType
...
AnalyzeIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("get_Chars", typ67))
Typ = Typ03.GetMethod("get_Chars", typ67).ReturnType
Dim typ68 As Type() = {Typ}
AnalyzeIL.Emit(OpCodes.Call, GetType(System.Convert).GetMethod("ToString", typ68))
...
AnalyzeIL.Emit(OpCodes.Blt, tru59)
AnalyzeIL.Emit(OpCodes.Br, fa59)
...
AnalyzeIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("get_Chars", typ69))
Typ = Typ03.GetMethod("get_Chars", typ69).ReturnType
Dim typ70 As Type() = {Typ}
AnalyzeIL.Emit(OpCodes.Call, GetType(System.Convert).GetMethod("ToString", typ70))
Typ = GetType(System.Convert).GetMethod("ToString", typ70).ReturnType
AnalyzeIL.Emit(OpCodes.Stloc, 1)
...
ReDim Preserve typ72(UBound(typ72) + 1)
typ72(UBound(typ72)) = Typ
AnalyzeIL.Emit(OpCodes.Call, GetType(String).GetMethod("Compare", typ72))
...
AnalyzeIL.Emit(OpCodes.Beq, fa61)
AnalyzeIL.Emit(OpCodes.Br, tru61)
AnalyzeIL.MarkLabel(tru61)
AnalyzeIL.MarkSequencePoint(doc2, 486, 1, 486, 100)
AnalyzeIL.Emit(OpCodes.Newobj, GetType(Token).GetConstructor(Type.EmptyTypes))
AnalyzeIL.Emit(OpCodes.Stloc, 2)
...
Typ = GetType(System.String)
AnalyzeIL.Emit(OpCodes.Stfld, GetType(Token).GetField("Value"))
AnalyzeIL.MarkSequencePoint(doc2, 488, 1, 488, 100)
AnalyzeIL.Emit(OpCodes.Ldloc, 2)
Typ = GetType(Token)
AnalyzeIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
...
AnalyzeIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("AddToken", typ73))
...
AnalyzeIL.Emit(OpCodes.Beq, tru62)
AnalyzeIL.Emit(OpCodes.Br, fa62)
...
ReDim Preserve typ74(UBound(typ74) + 1)
typ74(UBound(typ74)) = Typ
AnalyzeIL.Emit(OpCodes.Call, GetType(String).GetMethod("Concat", typ74))
Typ = GetType(String).GetMethod("Concat", typ74).ReturnType
AnalyzeIL.Emit(OpCodes.Stloc, 5)
...
ReDim Preserve typ75(UBound(typ75) + 1)
typ75(UBound(typ75)) = Typ
AnalyzeIL.Emit(OpCodes.Call, GetType(String).GetMethod("Concat", typ75))
Typ = GetType(String).GetMethod("Concat", typ75).ReturnType
AnalyzeIL.Emit(OpCodes.Stloc, 5)
AnalyzeIL.MarkSequencePoint(doc2, 497, 1, 497, 100)
AnalyzeIL.Emit(OpCodes.Br, cont60)
AnalyzeIL.MarkLabel(cont60)
AnalyzeIL.MarkSequencePoint(doc2, 499, 1, 499, 100)
AnalyzeIL.Emit(OpCodes.Ldloc, 9)
Typ = GetType(System.Int32)
AnalyzeIL.Emit(OpCodes.Ldloc, 3)
Typ = GetType(System.Int32)
...
AnalyzeIL.Emit(OpCodes.Beq, tru63)
AnalyzeIL.Emit(OpCodes.Br, fa63)
AnalyzeIL.MarkLabel(tru63)
AnalyzeIL.MarkSequencePoint(doc2, 500, 1, 500, 100)
AnalyzeIL.Emit(OpCodes.Br, label2)
AnalyzeIL.MarkSequencePoint(doc2, 501, 1, 501, 100)
AnalyzeIL.Emit(OpCodes.Br, cont63)
AnalyzeIL.MarkLabel(fa63)
AnalyzeIL.MarkSequencePoint(doc2, 502, 1, 502, 100)
AnalyzeIL.Emit(OpCodes.Br, label1)
AnalyzeIL.MarkSequencePoint(doc2, 503, 1, 503, 100)
AnalyzeIL.Emit(OpCodes.Br, cont63)
AnalyzeIL.MarkLabel(cont63)
AnalyzeIL.MarkSequencePoint(doc2, 505, 1, 505, 100)
AnalyzeIL.MarkLabel(label2)
AnalyzeIL.MarkSequencePoint(doc2, 507, 1, 507, 100)
Dim typ76(-1) As Type
AnalyzeIL.Emit(OpCodes.Ldloc, 5)
Typ = GetType(System.String)
...
ReDim Preserve typ76(UBound(typ76) + 1)
typ76(UBound(typ76)) = Typ
AnalyzeIL.Emit(OpCodes.Call, GetType(String).GetMethod("Compare", typ76))
Typ = GetType(String).GetMethod("Compare", typ76).ReturnType
AnalyzeIL.Emit(OpCodes.Stloc, 4)
AnalyzeIL.MarkSequencePoint(doc2, 508, 1, 508, 100)
AnalyzeIL.Emit(OpCodes.Ldloc, 4)
Typ = GetType(System.Int32)
AnalyzeIL.Emit(OpCodes.Ldc_I4, CInt(0))
Typ = GetType(System.Int32)
...
AnalyzeIL.Emit(OpCodes.Beq, fa64)
AnalyzeIL.Emit(OpCodes.Br, tru64)
AnalyzeIL.MarkLabel(tru64)
AnalyzeIL.MarkSequencePoint(doc2, 509, 1, 509, 100)
AnalyzeIL.Emit(OpCodes.Newobj, GetType(Token).GetConstructor(Type.EmptyTypes))
AnalyzeIL.Emit(OpCodes.Stloc, 2)
AnalyzeIL.MarkSequencePoint(doc2, 510, 1, 510, 100)
AnalyzeIL.Emit(OpCodes.Ldloc, 2)
Typ = GetType(Token)
AnalyzeIL.Emit(OpCodes.Ldloc, 5)
Typ = GetType(System.String)
AnalyzeIL.Emit(OpCodes.Stfld, GetType(Token).GetField("Value"))
AnalyzeIL.MarkSequencePoint(doc2, 511, 1, 511, 100)
AnalyzeIL.Emit(OpCodes.Ldloc, 2)
Typ = GetType(Token)
AnalyzeIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
...
Typ = GetType(Stmt).GetField("Line").FieldType
AnalyzeIL.Emit(OpCodes.Stfld, GetType(Token).GetField("Line"))
AnalyzeIL.MarkSequencePoint(doc2, 512, 1, 512, 100)
Dim typ77(-1) As Type
AnalyzeIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
Typ03 = Typ
...
AnalyzeIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("AddToken", typ77))
Typ = Typ03.GetMethod("AddToken", typ77).ReturnType
If Typ.ToString() = GetType(System.Void).ToString() Then

Else
AnalyzeIL.Emit(OpCodes.Pop)
End If
AnalyzeIL.MarkSequencePoint(doc2, 513, 1, 513, 100)
AnalyzeIL.Emit(OpCodes.Br, cont64)
AnalyzeIL.MarkLabel(fa64)
AnalyzeIL.Emit(OpCodes.Br, cont64)
AnalyzeIL.MarkLabel(cont64)
AnalyzeIL.MarkSequencePoint(doc2, 514, 1, 514, 100)
AnalyzeIL.Emit(OpCodes.Ldstr, "")
Typ = GetType(System.String)
AnalyzeIL.Emit(OpCodes.Stloc, 5)
AnalyzeIL.MarkSequencePoint(doc2, 516, 1, 516, 100)
AnalyzeIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(Stmt)
AnalyzeIL.MarkSequencePoint(doc2, 518, 1, 518, 100)
...
Dim locbldr22 As LocalBuilder = AnalyzeIL.DeclareLocal(GetType(StmtSet))
locbldr22.SetLocalSymInfo("stmts")
AnalyzeIL.Emit(OpCodes.Newobj, GetType(StmtSet).GetConstructor(Type.EmptyTypes))
AnalyzeIL.Emit(OpCodes.Stloc, 0)
AnalyzeIL.MarkSequencePoint(doc3, 14, 1, 14, 100)
Dim locbldr23 As LocalBuilder = AnalyzeIL.DeclareLocal(GetType(Stmt))
locbldr23.SetLocalSymInfo("curstmt")
AnalyzeIL.Emit(OpCodes.Ldnull)
AnalyzeIL.Emit(OpCodes.Stloc, 1)
AnalyzeIL.MarkSequencePoint(doc3, 15, 1, 15, 100)
Dim locbldr24 As LocalBuilder = AnalyzeIL.DeclareLocal(asm.GetType("dylan.NET.Tokenizer.Lexer.Line"))
locbldr24.SetLocalSymInfo("curln")
AnalyzeIL.Emit(OpCodes.Ldnull)
AnalyzeIL.Emit(OpCodes.Stloc, 2)
AnalyzeIL.MarkSequencePoint(doc3, 17, 1, 17, 100)
Dim locbldr25 As LocalBuilder = AnalyzeIL.DeclareLocal(GetType(StreamReader))
locbldr25.SetLocalSymInfo("sr")
Dim typ1(-1) As Type
AnalyzeIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(System.String)
...
Dim locbldr26 As LocalBuilder = AnalyzeIL.DeclareLocal(GetType(System.Boolean))
locbldr26.SetLocalSymInfo("crflag")
AnalyzeIL.Emit(OpCodes.Ldc_I4, 0)
Typ = GetType(System.Boolean)
AnalyzeIL.Emit(OpCodes.Stloc, 4)
AnalyzeIL.MarkSequencePoint(doc3, 19, 1, 19, 100)
Dim locbldr27 As LocalBuilder = AnalyzeIL.DeclareLocal(GetType(System.Boolean))
locbldr27.SetLocalSymInfo("lfflag")
AnalyzeIL.Emit(OpCodes.Ldc_I4, 0)
Typ = GetType(System.Boolean)
AnalyzeIL.Emit(OpCodes.Stloc, 5)
AnalyzeIL.MarkSequencePoint(doc3, 20, 1, 20, 100)
Dim locbldr28 As LocalBuilder = AnalyzeIL.DeclareLocal(GetType(System.Boolean))
locbldr28.SetLocalSymInfo("andflg")
AnalyzeIL.Emit(OpCodes.Ldc_I4, 0)
Typ = GetType(System.Boolean)
AnalyzeIL.Emit(OpCodes.Stloc, 6)
AnalyzeIL.MarkSequencePoint(doc3, 21, 1, 21, 100)
Dim locbldr29 As LocalBuilder = AnalyzeIL.DeclareLocal(GetType(System.Boolean))
locbldr29.SetLocalSymInfo("orflg")
AnalyzeIL.Emit(OpCodes.Ldc_I4, 0)
Typ = GetType(System.Boolean)
AnalyzeIL.Emit(OpCodes.Stloc, 7)
AnalyzeIL.MarkSequencePoint(doc3, 22, 1, 22, 100)
Dim locbldr30 As LocalBuilder = AnalyzeIL.DeclareLocal(GetType(System.String))
locbldr30.SetLocalSymInfo("buf")
AnalyzeIL.Emit(OpCodes.Ldstr, "")
Typ = GetType(System.String)
AnalyzeIL.Emit(OpCodes.Stloc, 8)
AnalyzeIL.MarkSequencePoint(doc3, 23, 1, 23, 100)
Dim locbldr31 As LocalBuilder = AnalyzeIL.DeclareLocal(GetType(System.Int32))
locbldr31.SetLocalSymInfo("curline")
AnalyzeIL.Emit(OpCodes.Ldc_I4, CInt(0))
Typ = GetType(System.Int32)
AnalyzeIL.Emit(OpCodes.Stloc, 9)
AnalyzeIL.MarkSequencePoint(doc3, 24, 1, 24, 100)
Dim locbldr32 As LocalBuilder = AnalyzeIL.DeclareLocal(GetType(System.Int32))
locbldr32.SetLocalSymInfo("curstmtlen")
AnalyzeIL.Emit(OpCodes.Ldc_I4, CInt(-1))
Typ = GetType(System.Int32)
AnalyzeIL.Emit(OpCodes.Stloc, 10)
AnalyzeIL.MarkSequencePoint(doc3, 27, 1, 27, 100)
Dim locbldr33 As LocalBuilder = AnalyzeIL.DeclareLocal(GetType(System.Int32))
locbldr33.SetLocalSymInfo("n")
AnalyzeIL.Emit(OpCodes.Ldc_I4, CInt(0))
Typ = GetType(System.Int32)
AnalyzeIL.Emit(OpCodes.Stloc, 11)
AnalyzeIL.MarkSequencePoint(doc3, 29, 1, 29, 100)
Dim locbldr34 As LocalBuilder = AnalyzeIL.DeclareLocal(GetType(System.String))
locbldr34.SetLocalSymInfo("ch")
AnalyzeIL.Emit(OpCodes.Ldstr, "")
Typ = GetType(System.String)
AnalyzeIL.Emit(OpCodes.Stloc, 12)
AnalyzeIL.MarkSequencePoint(doc3, 30, 1, 30, 100)
Dim locbldr35 As LocalBuilder = AnalyzeIL.DeclareLocal(GetType(System.Char))
locbldr35.SetLocalSymInfo("chr")
...
Dim locbldr36 As LocalBuilder = AnalyzeIL.DeclareLocal(GetType(System.Int32))
...
AnalyzeIL.Emit(OpCodes.Blt, tru65)
...
AnalyzeIL.Emit(OpCodes.Beq, tru68)
AnalyzeIL.Emit(OpCodes.Br, fa68)
...
AnalyzeIL.Emit(OpCodes.Ldc_I4, CInt(-1))
Typ = GetType(System.Int32)
Dim fa71 As System.Reflection.Emit.Label = AnalyzeIL.DefineLabel()
Dim tru71 As System.Reflection.Emit.Label = AnalyzeIL.DefineLabel()
Dim cont71 As System.Reflection.Emit.Label = AnalyzeIL.DefineLabel()
AnalyzeIL.Emit(OpCodes.Beq, tru71)
AnalyzeIL.Emit(OpCodes.Br, fa71)
AnalyzeIL.MarkLabel(tru71)
...
AnalyzeIL.Emit(OpCodes.Ldc_I4, CInt(0))
Typ = GetType(System.Int32)
Dim fa72 As System.Reflection.Emit.Label = AnalyzeIL.DefineLabel()
Dim tru72 As System.Reflection.Emit.Label = AnalyzeIL.DefineLabel()
Dim cont72 As System.Reflection.Emit.Label = AnalyzeIL.DefineLabel()
AnalyzeIL.Emit(OpCodes.Beq, fa72)
AnalyzeIL.Emit(OpCodes.Br, tru72)
AnalyzeIL.MarkLabel(tru72)
...
AnalyzeIL.Emit(OpCodes.Br, cont72)
AnalyzeIL.MarkLabel(fa72)
AnalyzeIL.Emit(OpCodes.Br, cont72)
AnalyzeIL.MarkLabel(cont72)
AnalyzeIL.MarkSequencePoint(doc3, 102, 1, 102, 100)
AnalyzeIL.Emit(OpCodes.Br, label1)
AnalyzeIL.MarkSequencePoint(doc3, 103, 1, 103, 100)
AnalyzeIL.Emit(OpCodes.Br, cont71)
AnalyzeIL.MarkLabel(fa71)
...
Dim AnalyzeString As MethodBuilder = Lexer.DefineMethod("AnalyzeString", MethodAttributes.Public, GetType(StmtSet), typ16)
Dim AnalyzeStringIL As ILGenerator = AnalyzeString.GetILGenerator()
Dim AnalyzeStringparam01 As ParameterBuilder = AnalyzeString.DefineParameter(1, ParameterAttributes.None, "str")
AnalyzeStringIL.MarkSequencePoint(doc3, 116, 1, 116, 100)
Dim locbldr37 As LocalBuilder = AnalyzeStringIL.DeclareLocal(GetType(StmtSet))
locbldr37.SetLocalSymInfo("stmts")
AnalyzeStringIL.Emit(OpCodes.Newobj, GetType(StmtSet).GetConstructor(Type.EmptyTypes))
AnalyzeStringIL.Emit(OpCodes.Stloc, 0)
AnalyzeStringIL.MarkSequencePoint(doc3, 117, 1, 117, 100)
Dim locbldr38 As LocalBuilder = AnalyzeStringIL.DeclareLocal(GetType(Stmt))
locbldr38.SetLocalSymInfo("curstmt")
AnalyzeStringIL.Emit(OpCodes.Ldnull)
AnalyzeStringIL.Emit(OpCodes.Stloc, 1)
AnalyzeStringIL.MarkSequencePoint(doc3, 118, 1, 118, 100)
Dim locbldr39 As LocalBuilder = AnalyzeStringIL.DeclareLocal(asm.GetType("dylan.NET.Tokenizer.Lexer.Line"))
locbldr39.SetLocalSymInfo("curln")
AnalyzeStringIL.Emit(OpCodes.Ldnull)
AnalyzeStringIL.Emit(OpCodes.Stloc, 2)
AnalyzeStringIL.MarkSequencePoint(doc3, 119, 1, 119, 100)
Dim locbldr40 As LocalBuilder = AnalyzeStringIL.DeclareLocal(GetType(StringReader))
locbldr40.SetLocalSymInfo("sr")
Dim typ17(-1) As Type
AnalyzeStringIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(System.String)
ReDim Preserve typ17(UBound(typ17) + 1)
typ17(UBound(typ17)) = Typ
AnalyzeStringIL.Emit(OpCodes.Newobj, GetType(StringReader).GetConstructor(typ17))
AnalyzeStringIL.Emit(OpCodes.Stloc, 3)
AnalyzeStringIL.MarkSequencePoint(doc3, 120, 1, 120, 100)
Dim locbldr41 As LocalBuilder = AnalyzeStringIL.DeclareLocal(GetType(System.Boolean))
locbldr41.SetLocalSymInfo("crflag")
AnalyzeStringIL.Emit(OpCodes.Ldc_I4, 0)
Typ = GetType(System.Boolean)
AnalyzeStringIL.Emit(OpCodes.Stloc, 4)
AnalyzeStringIL.MarkSequencePoint(doc3, 121, 1, 121, 100)
Dim locbldr42 As LocalBuilder = AnalyzeStringIL.DeclareLocal(GetType(System.Boolean))
locbldr42.SetLocalSymInfo("lfflag")
AnalyzeStringIL.Emit(OpCodes.Ldc_I4, 0)
Typ = GetType(System.Boolean)
AnalyzeStringIL.Emit(OpCodes.Stloc, 5)
AnalyzeStringIL.MarkSequencePoint(doc3, 122, 1, 122, 100)
Dim locbldr43 As LocalBuilder = AnalyzeStringIL.DeclareLocal(GetType(System.Boolean))
locbldr43.SetLocalSymInfo("andflg")
AnalyzeStringIL.Emit(OpCodes.Ldc_I4, 0)
Typ = GetType(System.Boolean)
AnalyzeStringIL.Emit(OpCodes.Stloc, 6)
AnalyzeStringIL.MarkSequencePoint(doc3, 123, 1, 123, 100)
Dim locbldr44 As LocalBuilder = AnalyzeStringIL.DeclareLocal(GetType(System.Boolean))
locbldr44.SetLocalSymInfo("orflg")
AnalyzeStringIL.Emit(OpCodes.Ldc_I4, 0)
Typ = GetType(System.Boolean)
AnalyzeStringIL.Emit(OpCodes.Stloc, 7)
AnalyzeStringIL.MarkSequencePoint(doc3, 124, 1, 124, 100)
Dim locbldr45 As LocalBuilder = AnalyzeStringIL.DeclareLocal(GetType(System.String))
locbldr45.SetLocalSymInfo("buf")
AnalyzeStringIL.Emit(OpCodes.Ldstr, "")
Typ = GetType(System.String)
AnalyzeStringIL.Emit(OpCodes.Stloc, 8)
AnalyzeStringIL.MarkSequencePoint(doc3, 125, 1, 125, 100)
Dim locbldr46 As LocalBuilder = AnalyzeStringIL.DeclareLocal(GetType(System.Int32))
locbldr46.SetLocalSymInfo("curline")
AnalyzeStringIL.Emit(OpCodes.Ldc_I4, CInt(0))
Typ = GetType(System.Int32)
AnalyzeStringIL.Emit(OpCodes.Stloc, 9)
AnalyzeStringIL.MarkSequencePoint(doc3, 126, 1, 126, 100)
Dim locbldr47 As LocalBuilder = AnalyzeStringIL.DeclareLocal(GetType(System.Int32))
locbldr47.SetLocalSymInfo("curstmtlen")
AnalyzeStringIL.Emit(OpCodes.Ldc_I4, CInt(-1))
Typ = GetType(System.Int32)
AnalyzeStringIL.Emit(OpCodes.Stloc, 10)
AnalyzeStringIL.MarkSequencePoint(doc3, 128, 1, 128, 100)
Dim locbldr48 As LocalBuilder = AnalyzeStringIL.DeclareLocal(GetType(System.Int32))
locbldr48.SetLocalSymInfo("n")
AnalyzeStringIL.Emit(OpCodes.Ldc_I4, CInt(0))
Typ = GetType(System.Int32)
AnalyzeStringIL.Emit(OpCodes.Stloc, 11)
AnalyzeStringIL.MarkSequencePoint(doc3, 129, 1, 129, 100)
Dim locbldr49 As LocalBuilder = AnalyzeStringIL.DeclareLocal(GetType(System.String))
locbldr49.SetLocalSymInfo("ch")
AnalyzeStringIL.Emit(OpCodes.Ldstr, "")
Typ = GetType(System.String)
AnalyzeStringIL.Emit(OpCodes.Stloc, 12)
AnalyzeStringIL.MarkSequencePoint(doc3, 130, 1, 130, 100)
Dim locbldr50 As LocalBuilder = AnalyzeStringIL.DeclareLocal(GetType(System.Char))
locbldr50.SetLocalSymInfo("chr")
AnalyzeStringIL.Emit(OpCodes.Ldstr, "a")
Typ = GetType(System.String)
Dim typ18 As Type() = {Typ}
AnalyzeStringIL.Emit(OpCodes.Call, GetType(System.Convert).GetMethod("ToChar", typ18))
Typ = GetType(System.Convert).GetMethod("ToChar", typ18).ReturnType
AnalyzeStringIL.Emit(OpCodes.Stloc, 13)
AnalyzeStringIL.MarkSequencePoint(doc3, 131, 1, 131, 100)
Dim locbldr51 As LocalBuilder = AnalyzeStringIL.DeclareLocal(GetType(System.Int32))
locbldr51.SetLocalSymInfo("comp")
AnalyzeStringIL.Emit(OpCodes.Ldc_I4, CInt(0))
Typ = GetType(System.Int32)
AnalyzeStringIL.Emit(OpCodes.Stloc, 14)
AnalyzeStringIL.MarkSequencePoint(doc3, 135, 1, 135, 100)
Dim label2 As System.Reflection.Emit.Label = AnalyzeStringIL.DefineLabel()
AnalyzeStringIL.MarkSequencePoint(doc3, 136, 1, 136, 100)
Dim label3 As System.Reflection.Emit.Label = AnalyzeStringIL.DefineLabel()
AnalyzeStringIL.MarkSequencePoint(doc3, 138, 1, 138, 100)
AnalyzeStringIL.Emit(OpCodes.Ldloc, 3)
Typ = GetType(StringReader)
Typ03 = Typ
AnalyzeStringIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("Peek", Type.EmptyTypes))
Typ = Typ03.GetMethod("Peek", Type.EmptyTypes).ReturnType
AnalyzeStringIL.Emit(OpCodes.Stloc, 11)
AnalyzeStringIL.MarkSequencePoint(doc3, 140, 1, 140, 100)
AnalyzeStringIL.Emit(OpCodes.Ldloc, 11)
Typ = GetType(System.Int32)
AnalyzeStringIL.Emit(OpCodes.Ldc_I4, CInt(0))
Typ = GetType(System.Int32)
Dim fa73 As System.Reflection.Emit.Label = AnalyzeStringIL.DefineLabel()
Dim tru73 As System.Reflection.Emit.Label = AnalyzeStringIL.DefineLabel()
Dim cont73 As System.Reflection.Emit.Label = AnalyzeStringIL.DefineLabel()
AnalyzeStringIL.Emit(OpCodes.Blt, tru73)
AnalyzeStringIL.Emit(OpCodes.Br, fa73)
AnalyzeStringIL.MarkLabel(tru73)
AnalyzeStringIL.MarkSequencePoint(doc3, 141, 1, 141, 100)
AnalyzeStringIL.Emit(OpCodes.Br, label3)
AnalyzeStringIL.MarkSequencePoint(doc3, 142, 1, 142, 100)
AnalyzeStringIL.Emit(OpCodes.Br, cont73)
AnalyzeStringIL.MarkLabel(fa73)
AnalyzeStringIL.Emit(OpCodes.Br, cont73)
AnalyzeStringIL.MarkLabel(cont73)
AnalyzeStringIL.MarkSequencePoint(doc3, 144, 1, 144, 100)
AnalyzeStringIL.MarkLabel(label2)
AnalyzeStringIL.MarkSequencePoint(doc3, 146, 1, 146, 100)
AnalyzeStringIL.Emit(OpCodes.Ldloc, 3)
Typ = GetType(StringReader)
Typ03 = Typ
AnalyzeStringIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("Read", Type.EmptyTypes))
Typ = Typ03.GetMethod("Read", Type.EmptyTypes).ReturnType
AnalyzeStringIL.Emit(OpCodes.Stloc, 11)
AnalyzeStringIL.MarkSequencePoint(doc3, 148, 1, 148, 100)
AnalyzeStringIL.Emit(OpCodes.Ldloc, 11)
Typ = GetType(System.Int32)
Dim typ21 As Type() = {Typ}
AnalyzeStringIL.Emit(OpCodes.Call, GetType(System.Convert).GetMethod("ToChar", typ21))
Typ = GetType(System.Convert).GetMethod("ToChar", typ21).ReturnType
AnalyzeStringIL.Emit(OpCodes.Stloc, 13)
AnalyzeStringIL.MarkSequencePoint(doc3, 149, 1, 149, 100)
AnalyzeStringIL.Emit(OpCodes.Ldloc, 13)
Typ = GetType(System.Char)
Dim typ22 As Type() = {Typ}
AnalyzeStringIL.Emit(OpCodes.Call, GetType(System.Convert).GetMethod("ToString", typ22))
Typ = GetType(System.Convert).GetMethod("ToString", typ22).ReturnType
AnalyzeStringIL.Emit(OpCodes.Stloc, 12)
AnalyzeStringIL.MarkSequencePoint(doc3, 150, 1, 150, 100)
Dim typ23(-1) As Type
AnalyzeStringIL.Emit(OpCodes.Ldloc, 12)
Typ = GetType(System.String)
ReDim Preserve typ23(UBound(typ23) + 1)
typ23(UBound(typ23)) = Typ
AnalyzeStringIL.Emit(OpCodes.Ldsfld, GetType(Utils.Constants).GetField("cr"))
Typ = GetType(Utils.Constants).GetField("cr").FieldType
ReDim Preserve typ23(UBound(typ23) + 1)
typ23(UBound(typ23)) = Typ
AnalyzeStringIL.Emit(OpCodes.Call, GetType(String).GetMethod("Compare", typ23))
Typ = GetType(String).GetMethod("Compare", typ23).ReturnType
AnalyzeStringIL.Emit(OpCodes.Stloc, 14)
AnalyzeStringIL.MarkSequencePoint(doc3, 152, 1, 152, 100)
AnalyzeStringIL.Emit(OpCodes.Ldloc, 14)
Typ = GetType(System.Int32)
AnalyzeStringIL.Emit(OpCodes.Ldc_I4, CInt(0))
Typ = GetType(System.Int32)
Dim fa74 As System.Reflection.Emit.Label = AnalyzeStringIL.DefineLabel()
Dim tru74 As System.Reflection.Emit.Label = AnalyzeStringIL.DefineLabel()
Dim cont74 As System.Reflection.Emit.Label = AnalyzeStringIL.DefineLabel()
AnalyzeStringIL.Emit(OpCodes.Beq, tru74)
AnalyzeStringIL.Emit(OpCodes.Br, fa74)
AnalyzeStringIL.MarkLabel(tru74)
AnalyzeStringIL.MarkSequencePoint(doc3, 153, 1, 153, 100)
AnalyzeStringIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
AnalyzeStringIL.Emit(OpCodes.Stloc, 4)
AnalyzeStringIL.MarkSequencePoint(doc3, 154, 1, 154, 100)
AnalyzeStringIL.Emit(OpCodes.Br, cont74)
AnalyzeStringIL.MarkLabel(fa74)
AnalyzeStringIL.Emit(OpCodes.Br, cont74)
AnalyzeStringIL.MarkLabel(cont74)
AnalyzeStringIL.MarkSequencePoint(doc3, 156, 1, 156, 100)
Dim typ24(-1) As Type
AnalyzeStringIL.Emit(OpCodes.Ldloc, 12)
Typ = GetType(System.String)
ReDim Preserve typ24(UBound(typ24) + 1)
typ24(UBound(typ24)) = Typ
AnalyzeStringIL.Emit(OpCodes.Ldsfld, GetType(Utils.Constants).GetField("lf"))
Typ = GetType(Utils.Constants).GetField("lf").FieldType
ReDim Preserve typ24(UBound(typ24) + 1)
typ24(UBound(typ24)) = Typ
AnalyzeStringIL.Emit(OpCodes.Call, GetType(String).GetMethod("Compare", typ24))
Typ = GetType(String).GetMethod("Compare", typ24).ReturnType
AnalyzeStringIL.Emit(OpCodes.Stloc, 14)
AnalyzeStringIL.MarkSequencePoint(doc3, 158, 1, 158, 100)
AnalyzeStringIL.Emit(OpCodes.Ldloc, 14)
Typ = GetType(System.Int32)
AnalyzeStringIL.Emit(OpCodes.Ldc_I4, CInt(0))
Typ = GetType(System.Int32)
Dim fa75 As System.Reflection.Emit.Label = AnalyzeStringIL.DefineLabel()
Dim tru75 As System.Reflection.Emit.Label = AnalyzeStringIL.DefineLabel()
Dim cont75 As System.Reflection.Emit.Label = AnalyzeStringIL.DefineLabel()
AnalyzeStringIL.Emit(OpCodes.Beq, tru75)
AnalyzeStringIL.Emit(OpCodes.Br, fa75)
AnalyzeStringIL.MarkLabel(tru75)
AnalyzeStringIL.MarkSequencePoint(doc3, 159, 1, 159, 100)
AnalyzeStringIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
AnalyzeStringIL.Emit(OpCodes.Stloc, 5)
AnalyzeStringIL.MarkSequencePoint(doc3, 160, 1, 160, 100)
AnalyzeStringIL.Emit(OpCodes.Br, cont75)
AnalyzeStringIL.MarkLabel(fa75)
AnalyzeStringIL.Emit(OpCodes.Br, cont75)
AnalyzeStringIL.MarkLabel(cont75)
AnalyzeStringIL.MarkSequencePoint(doc3, 162, 1, 162, 100)
AnalyzeStringIL.Emit(OpCodes.Ldloc, 4)
Typ = GetType(System.Boolean)
AnalyzeStringIL.Emit(OpCodes.Ldloc, 5)
Typ = GetType(System.Boolean)
AnalyzeStringIL.Emit(OpCodes.And)
AnalyzeStringIL.Emit(OpCodes.Stloc, 6)
AnalyzeStringIL.MarkSequencePoint(doc3, 163, 1, 163, 100)
AnalyzeStringIL.Emit(OpCodes.Ldloc, 4)
Typ = GetType(System.Boolean)
AnalyzeStringIL.Emit(OpCodes.Ldloc, 5)
Typ = GetType(System.Boolean)
AnalyzeStringIL.Emit(OpCodes.Or)
AnalyzeStringIL.Emit(OpCodes.Stloc, 7)
AnalyzeStringIL.MarkSequencePoint(doc3, 165, 1, 165, 100)
AnalyzeStringIL.Emit(OpCodes.Ldloc, 7)
Typ = GetType(System.Boolean)
AnalyzeStringIL.Emit(OpCodes.Ldc_I4, 0)
Typ = GetType(System.Boolean)
Dim fa76 As System.Reflection.Emit.Label = AnalyzeStringIL.DefineLabel()
Dim tru76 As System.Reflection.Emit.Label = AnalyzeStringIL.DefineLabel()
Dim cont76 As System.Reflection.Emit.Label = AnalyzeStringIL.DefineLabel()
AnalyzeStringIL.Emit(OpCodes.Beq, tru76)
AnalyzeStringIL.Emit(OpCodes.Br, fa76)
AnalyzeStringIL.MarkLabel(tru76)
AnalyzeStringIL.MarkSequencePoint(doc3, 166, 1, 166, 100)
Dim typ25(-1) As Type
AnalyzeStringIL.Emit(OpCodes.Ldloc, 8)
Typ = GetType(System.String)
ReDim Preserve typ25(UBound(typ25) + 1)
typ25(UBound(typ25)) = Typ
AnalyzeStringIL.Emit(OpCodes.Ldloc, 12)
...
ReDim Preserve typ25(UBound(typ25) + 1)
typ25(UBound(typ25)) = Typ
AnalyzeStringIL.Emit(OpCodes.Call, GetType(String).GetMethod("Concat", typ25))
Typ = GetType(String).GetMethod("Concat", typ25).ReturnType
AnalyzeStringIL.Emit(OpCodes.Stloc, 8)
AnalyzeStringIL.MarkSequencePoint(doc3, 167, 1, 167, 100)
AnalyzeStringIL.Emit(OpCodes.Br, cont76)
AnalyzeStringIL.MarkLabel(fa76)
AnalyzeStringIL.MarkSequencePoint(doc3, 168, 1, 168, 100)
AnalyzeStringIL.Emit(OpCodes.Ldloc, 5)
Typ = GetType(System.Boolean)
AnalyzeStringIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa77 As System.Reflection.Emit.Label = AnalyzeStringIL.DefineLabel()
Dim tru77 As System.Reflection.Emit.Label = AnalyzeStringIL.DefineLabel()
Dim cont77 As System.Reflection.Emit.Label = AnalyzeStringIL.DefineLabel()
AnalyzeStringIL.Emit(OpCodes.Beq, tru77)
AnalyzeStringIL.Emit(OpCodes.Br, fa77)
AnalyzeStringIL.MarkLabel(tru77)
AnalyzeStringIL.MarkSequencePoint(doc3, 169, 1, 169, 100)
AnalyzeStringIL.Emit(OpCodes.Ldloc, 9)
Typ = GetType(System.Int32)
AnalyzeStringIL.Emit(OpCodes.Ldc_I4, CInt(1))
Typ = GetType(System.Int32)
AnalyzeStringIL.Emit(OpCodes.Add)
AnalyzeStringIL.Emit(OpCodes.Stloc, 9)
AnalyzeStringIL.MarkSequencePoint(doc3, 171, 1, 171, 100)
AnalyzeStringIL.Emit(OpCodes.Newobj, GetType(Stmt).GetConstructor(Type.EmptyTypes))
AnalyzeStringIL.Emit(OpCodes.Stloc, 1)
AnalyzeStringIL.MarkSequencePoint(doc3, 172, 1, 172, 100)
AnalyzeStringIL.Emit(OpCodes.Ldloc, 1)
Typ = GetType(Stmt)
AnalyzeStringIL.Emit(OpCodes.Ldloc, 9)
Typ = GetType(System.Int32)
AnalyzeStringIL.Emit(OpCodes.Stfld, GetType(Stmt).GetField("Line"))
AnalyzeStringIL.MarkSequencePoint(doc3, 173, 1, 173, 100)
AnalyzeStringIL.Emit(OpCodes.Newobj, asm.GetType("dylan.NET.Tokenizer.Lexer.Line").GetConstructor(Type.EmptyTypes))
AnalyzeStringIL.Emit(OpCodes.Stloc, 2)
AnalyzeStringIL.MarkSequencePoint(doc3, 174, 1, 174, 100)
Dim typ26(-1) As Type
AnalyzeStringIL.Emit(OpCodes.Ldloc, 2)
Typ = asm.GetType("dylan.NET.Tokenizer.Lexer.Line")
Typ03 = Typ
AnalyzeStringIL.Emit(OpCodes.Ldloc, 1)
Typ = GetType(Stmt)
...
ReDim Preserve typ26(UBound(typ26) + 1)
typ26(UBound(typ26)) = Typ
AnalyzeStringIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("Analyze", typ26))
Typ = Typ03.GetMethod("Analyze", typ26).ReturnType
AnalyzeStringIL.Emit(OpCodes.Stloc, 1)
AnalyzeStringIL.MarkSequencePoint(doc3, 175, 1, 175, 100)
AnalyzeStringIL.Emit(OpCodes.Ldloc, 1)
Typ = GetType(Stmt)
AnalyzeStringIL.Emit(OpCodes.Ldfld, GetType(Stmt).GetField("Tokens"))
Typ = GetType(Stmt).GetField("Tokens").FieldType
AnalyzeStringIL.Emit(OpCodes.Ldlen)
AnalyzeStringIL.Emit(OpCodes.Conv_I4)
Typ = GetType(System.Int32)
AnalyzeStringIL.Emit(OpCodes.Stloc, 10)
AnalyzeStringIL.MarkSequencePoint(doc3, 177, 1, 177, 100)
AnalyzeStringIL.Emit(OpCodes.Ldloc, 10)
Typ = GetType(System.Int32)
AnalyzeStringIL.Emit(OpCodes.Ldc_I4, CInt(0))
Typ = GetType(System.Int32)
Dim fa78 As System.Reflection.Emit.Label = AnalyzeStringIL.DefineLabel()
Dim tru78 As System.Reflection.Emit.Label = AnalyzeStringIL.DefineLabel()
Dim cont78 As System.Reflection.Emit.Label = AnalyzeStringIL.DefineLabel()
AnalyzeStringIL.Emit(OpCodes.Beq, fa78)
AnalyzeStringIL.Emit(OpCodes.Br, tru78)
AnalyzeStringIL.MarkLabel(tru78)
AnalyzeStringIL.MarkSequencePoint(doc3, 178, 1, 178, 100)
Dim typ27(-1) As Type
AnalyzeStringIL.Emit(OpCodes.Ldloc, 0)
Typ = GetType(StmtSet)
Typ03 = Typ
AnalyzeStringIL.Emit(OpCodes.Ldloc, 1)
Typ = GetType(Stmt)
ReDim Preserve typ27(UBound(typ27) + 1)
typ27(UBound(typ27)) = Typ
AnalyzeStringIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("AddStmt", typ27))
Typ = Typ03.GetMethod("AddStmt", typ27).ReturnType
If Typ.ToString() = GetType(System.Void).ToString() Then

Else
AnalyzeStringIL.Emit(OpCodes.Pop)
End If
AnalyzeStringIL.MarkSequencePoint(doc3, 179, 1, 179, 100)
AnalyzeStringIL.Emit(OpCodes.Br, cont78)
AnalyzeStringIL.MarkLabel(fa78)
AnalyzeStringIL.Emit(OpCodes.Br, cont78)
AnalyzeStringIL.MarkLabel(cont78)
AnalyzeStringIL.MarkSequencePoint(doc3, 181, 1, 181, 100)
AnalyzeStringIL.Emit(OpCodes.Ldstr, "")
Typ = GetType(System.String)
AnalyzeStringIL.Emit(OpCodes.Stloc, 8)
AnalyzeStringIL.MarkSequencePoint(doc3, 182, 1, 182, 100)
AnalyzeStringIL.Emit(OpCodes.Ldc_I4, 0)
Typ = GetType(System.Boolean)
AnalyzeStringIL.Emit(OpCodes.Stloc, 4)
AnalyzeStringIL.MarkSequencePoint(doc3, 183, 1, 183, 100)
AnalyzeStringIL.Emit(OpCodes.Ldc_I4, 0)
Typ = GetType(System.Boolean)
AnalyzeStringIL.Emit(OpCodes.Stloc, 5)
AnalyzeStringIL.MarkSequencePoint(doc3, 184, 1, 184, 100)
AnalyzeStringIL.Emit(OpCodes.Br, cont77)
AnalyzeStringIL.MarkLabel(fa77)
AnalyzeStringIL.Emit(OpCodes.Br, cont77)
AnalyzeStringIL.MarkLabel(cont77)
AnalyzeStringIL.MarkSequencePoint(doc3, 185, 1, 185, 100)
AnalyzeStringIL.Emit(OpCodes.Br, cont76)
AnalyzeStringIL.MarkLabel(cont76)
AnalyzeStringIL.MarkSequencePoint(doc3, 187, 1, 187, 100)
AnalyzeStringIL.Emit(OpCodes.Ldloc, 3)
Typ = GetType(StringReader)
Typ03 = Typ
AnalyzeStringIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("Peek", Type.EmptyTypes))
Typ = Typ03.GetMethod("Peek", Type.EmptyTypes).ReturnType
AnalyzeStringIL.Emit(OpCodes.Stloc, 11)
AnalyzeStringIL.MarkSequencePoint(doc3, 189, 1, 189, 100)
AnalyzeStringIL.Emit(OpCodes.Ldloc, 11)
Typ = GetType(System.Int32)
AnalyzeStringIL.Emit(OpCodes.Ldc_I4, CInt(-1))
Typ = GetType(System.Int32)
Dim fa79 As System.Reflection.Emit.Label = AnalyzeStringIL.DefineLabel()
Dim tru79 As System.Reflection.Emit.Label = AnalyzeStringIL.DefineLabel()
Dim cont79 As System.Reflection.Emit.Label = AnalyzeStringIL.DefineLabel()
AnalyzeStringIL.Emit(OpCodes.Beq, tru79)
AnalyzeStringIL.Emit(OpCodes.Br, fa79)
AnalyzeStringIL.MarkLabel(tru79)
AnalyzeStringIL.MarkSequencePoint(doc3, 190, 1, 190, 100)
AnalyzeStringIL.Emit(OpCodes.Ldloc, 9)
Typ = GetType(System.Int32)
AnalyzeStringIL.Emit(OpCodes.Ldc_I4, CInt(1))
Typ = GetType(System.Int32)
AnalyzeStringIL.Emit(OpCodes.Add)
AnalyzeStringIL.Emit(OpCodes.Stloc, 9)
AnalyzeStringIL.MarkSequencePoint(doc3, 192, 1, 192, 100)
AnalyzeStringIL.Emit(OpCodes.Newobj, GetType(Stmt).GetConstructor(Type.EmptyTypes))
AnalyzeStringIL.Emit(OpCodes.Stloc, 1)
AnalyzeStringIL.MarkSequencePoint(doc3, 193, 1, 193, 100)
AnalyzeStringIL.Emit(OpCodes.Ldloc, 1)
Typ = GetType(Stmt)
AnalyzeStringIL.Emit(OpCodes.Ldloc, 9)
Typ = GetType(System.Int32)
AnalyzeStringIL.Emit(OpCodes.Stfld, GetType(Stmt).GetField("Line"))
AnalyzeStringIL.MarkSequencePoint(doc3, 194, 1, 194, 100)
AnalyzeStringIL.Emit(OpCodes.Newobj, asm.GetType("dylan.NET.Tokenizer.Lexer.Line").GetConstructor(Type.EmptyTypes))
AnalyzeStringIL.Emit(OpCodes.Stloc, 2)
AnalyzeStringIL.MarkSequencePoint(doc3, 195, 1, 195, 100)
Dim typ29(-1) As Type
AnalyzeStringIL.Emit(OpCodes.Ldloc, 2)
Typ = asm.GetType("dylan.NET.Tokenizer.Lexer.Line")
Typ03 = Typ
...
ReDim Preserve typ29(UBound(typ29) + 1)
typ29(UBound(typ29)) = Typ
AnalyzeStringIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("Analyze", typ29))
Typ = Typ03.GetMethod("Analyze", typ29).ReturnType
AnalyzeStringIL.Emit(OpCodes.Stloc, 1)
AnalyzeStringIL.MarkSequencePoint(doc3, 196, 1, 196, 100)
AnalyzeStringIL.Emit(OpCodes.Ldloc, 1)
Typ = GetType(Stmt)
AnalyzeStringIL.Emit(OpCodes.Ldfld, GetType(Stmt).GetField("Tokens"))
Typ = GetType(Stmt).GetField("Tokens").FieldType
...
Typ = GetType(System.Int32)
AnalyzeStringIL.Emit(OpCodes.Stloc, 10)
AnalyzeStringIL.MarkSequencePoint(doc3, 198, 1, 198, 100)
AnalyzeStringIL.Emit(OpCodes.Ldloc, 10)
Typ = GetType(System.Int32)
AnalyzeStringIL.Emit(OpCodes.Ldc_I4, CInt(0))
Typ = GetType(System.Int32)
Dim fa80 As System.Reflection.Emit.Label = AnalyzeStringIL.DefineLabel()
Dim tru80 As System.Reflection.Emit.Label = AnalyzeStringIL.DefineLabel()
Dim cont80 As System.Reflection.Emit.Label = AnalyzeStringIL.DefineLabel()
AnalyzeStringIL.Emit(OpCodes.Beq, fa80)
AnalyzeStringIL.Emit(OpCodes.Br, tru80)
AnalyzeStringIL.MarkLabel(tru80)
AnalyzeStringIL.MarkSequencePoint(doc3, 199, 1, 199, 100)
Dim typ30(-1) As Type
AnalyzeStringIL.Emit(OpCodes.Ldloc, 0)
Typ = GetType(StmtSet)
Typ03 = Typ
...
ReDim Preserve typ30(UBound(typ30) + 1)
typ30(UBound(typ30)) = Typ
AnalyzeStringIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("AddStmt", typ30))
Typ = Typ03.GetMethod("AddStmt", typ30).ReturnType
If Typ.ToString() = GetType(System.Void).ToString() Then

Else
AnalyzeStringIL.Emit(OpCodes.Pop)
End If
AnalyzeStringIL.MarkSequencePoint(doc3, 200, 1, 200, 100)
AnalyzeStringIL.Emit(OpCodes.Br, cont80)
AnalyzeStringIL.MarkLabel(fa80)
AnalyzeStringIL.Emit(OpCodes.Br, cont80)
AnalyzeStringIL.MarkLabel(cont80)
AnalyzeStringIL.MarkSequencePoint(doc3, 202, 1, 202, 100)
AnalyzeStringIL.Emit(OpCodes.Br, label3)
AnalyzeStringIL.MarkSequencePoint(doc3, 203, 1, 203, 100)
AnalyzeStringIL.Emit(OpCodes.Br, cont79)
AnalyzeStringIL.MarkLabel(fa79)
AnalyzeStringIL.MarkSequencePoint(doc3, 204, 1, 204, 100)
AnalyzeStringIL.Emit(OpCodes.Br, label2)
AnalyzeStringIL.MarkSequencePoint(doc3, 205, 1, 205, 100)
AnalyzeStringIL.Emit(OpCodes.Br, cont79)
AnalyzeStringIL.MarkLabel(cont79)
AnalyzeStringIL.MarkSequencePoint(doc3, 207, 1, 207, 100)
AnalyzeStringIL.MarkLabel(label3)
AnalyzeStringIL.MarkSequencePoint(doc3, 209, 1, 209, 100)
AnalyzeStringIL.Emit(OpCodes.Ldloc, 3)
Typ = GetType(StringReader)
Typ03 = Typ
AnalyzeStringIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("Close", Type.EmptyTypes))
Typ = Typ03.GetMethod("Close", Type.EmptyTypes).ReturnType
If Typ.ToString() = GetType(System.Void).ToString() Then
...
AnalyzeStringIL.Emit(OpCodes.Pop)
End If
AnalyzeStringIL.MarkSequencePoint(doc3, 211, 1, 211, 100)
AnalyzeStringIL.Emit(OpCodes.Ldloc, 0)
Typ = GetType(StmtSet)
AnalyzeStringIL.MarkSequencePoint(doc3, 212, 1, 212, 100)
AnalyzeStringIL.Emit(OpCodes.Ret)
Lexer.CreateType()
End Sub
...
asmName.Version = New System.Version(11, 2, 8, 9)
...
Dim vaBuilder As CustomAttributeBuilder = New CustomAttributeBuilder(vaCtor, New Object() {"11.2.8.9"})
