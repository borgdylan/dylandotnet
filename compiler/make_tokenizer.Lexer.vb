...
isSepIL.Emit(OpCodes.Beq, fa15)
isSepIL.Emit(OpCodes.Br, tru15)
...
isSepIL.Emit(OpCodes.Beq, fa23)
isSepIL.Emit(OpCodes.Br, tru23)
...
isSepIL.Emit(OpCodes.Beq, fa29)
isSepIL.Emit(OpCodes.Br, tru29)
...
isSepIL.Emit(OpCodes.Beq, fa37)
isSepIL.Emit(OpCodes.Br, tru37)
...
isSepIL.Emit(OpCodes.Call, GetType(System.Convert).GetMethod("ToChar", typ38))
Typ = GetType(System.Convert).GetMethod("ToChar", typ38).ReturnType
isSepIL.Emit(OpCodes.Stloc, 3)
...
isSepIL.Emit(OpCodes.Call, GetType(Char).GetMethod("IsDigit", typ39))
Typ = GetType(Char).GetMethod("IsDigit", typ39).ReturnType
isSepIL.Emit(OpCodes.Stloc, 4)
...
isSepIL.Emit(OpCodes.Ldarg, 2)
Typ = GetType(System.String)
Dim typ43 As Type() = {Typ}
isSepIL.Emit(OpCodes.Call, GetType(System.Convert).GetMethod("ToChar", typ43))
Typ = GetType(System.Convert).GetMethod("ToChar", typ43).ReturnType
isSepIL.Emit(OpCodes.Stloc, 3)
...
isSepIL.Emit(OpCodes.Call, GetType(Char).GetMethod("IsDigit", typ44))
Typ = GetType(Char).GetMethod("IsDigit", typ44).ReturnType
isSepIL.Emit(OpCodes.Stloc, 4)
...
isSepIL.Emit(OpCodes.Call, GetType(System.Convert).GetMethod("ToChar", typ45))
Typ = GetType(System.Convert).GetMethod("ToChar", typ45).ReturnType
...
isSepIL.Emit(OpCodes.Call, GetType(System.Convert).GetMethod("ToString", typ47))
Typ = GetType(System.Convert).GetMethod("ToString", typ47).ReturnType
ReDim Preserve typ46(UBound(typ46) + 1)
typ46(UBound(typ46)) = Typ
...
isSepIL.Emit(OpCodes.Call, GetType(System.Convert).GetMethod("ToChar", typ48))
Typ = GetType(System.Convert).GetMethod("ToChar", typ48).ReturnType
...
isSepIL.Emit(OpCodes.Call, GetType(System.Convert).GetMethod("ToString", typ50))
...
ReDim Preserve typ51(UBound(typ51) + 1)
typ51(UBound(typ51)) = GetType(System.String)
Dim Analyze As MethodBuilder = Line.DefineMethod("Analyze", MethodAttributes.Public, GetType(Stmt), typ51)
...
AnalyzeIL.MarkSequencePoint(doc2, 365, 1, 365, 100)
...
AnalyzeIL.MarkSequencePoint(doc2, 368, 1, 368, 100)
...
AnalyzeIL.MarkSequencePoint(doc2, 370, 1, 370, 100)
...
AnalyzeIL.MarkSequencePoint(doc2, 376, 1, 376, 100)
AnalyzeIL.Emit(OpCodes.Ldloc, 3)
Typ = GetType(System.Int32)
AnalyzeIL.Emit(OpCodes.Ldc_I4, CInt(-1))
Typ = GetType(System.Int32)
...
AnalyzeIL.Emit(OpCodes.Beq, tru46)
...
AnalyzeIL.MarkSequencePoint(doc2, 378, 1, 378, 100)
...
AnalyzeIL.Emit(OpCodes.Beq, tru48)
AnalyzeIL.Emit(OpCodes.Br, fa48)
...
ReDim Preserve typ53(UBound(typ53) + 1)
typ53(UBound(typ53)) = Typ
AnalyzeIL.Emit(OpCodes.Call, GetType(String).GetMethod("Compare", typ53))
...
AnalyzeIL.Emit(OpCodes.Beq, fa49)
AnalyzeIL.Emit(OpCodes.Br, tru49)
...
AnalyzeIL.Emit(OpCodes.Stloc, 2)
AnalyzeIL.MarkSequencePoint(doc2, 394, 1, 394, 100)
...
AnalyzeIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("AddToken", typ54))
Typ = Typ03.GetMethod("AddToken", typ54).ReturnType
...
Typ = GetType(System.Boolean)
AnalyzeIL.Emit(OpCodes.Stloc, 7)
AnalyzeIL.MarkSequencePoint(doc2, 402, 1, 402, 100)
AnalyzeIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
AnalyzeIL.Emit(OpCodes.Stloc, 8)
...
AnalyzeIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("get_Chars", typ55))
Typ = Typ03.GetMethod("get_Chars", typ55).ReturnType
Dim typ56 As Type() = {Typ}
AnalyzeIL.Emit(OpCodes.Call, GetType(System.Convert).GetMethod("ToString", typ56))
...
AnalyzeIL.Emit(OpCodes.Blt, tru50)
...
AnalyzeIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("get_Chars", typ57))
Typ = Typ03.GetMethod("get_Chars", typ57).ReturnType
Dim typ58 As Type() = {Typ}
AnalyzeIL.Emit(OpCodes.Call, GetType(System.Convert).GetMethod("ToString", typ58))
Typ = GetType(System.Convert).GetMethod("ToString", typ58).ReturnType
AnalyzeIL.Emit(OpCodes.Stloc, 1)
...
AnalyzeIL.Emit(OpCodes.Beq, tru51)
AnalyzeIL.Emit(OpCodes.Br, fa51)
...
ReDim Preserve typ60(UBound(typ60) + 1)
typ60(UBound(typ60)) = Typ
AnalyzeIL.Emit(OpCodes.Call, GetType(String).GetMethod("Compare", typ60))
...
AnalyzeIL.Emit(OpCodes.Beq, fa52)
AnalyzeIL.Emit(OpCodes.Br, tru52)
AnalyzeIL.MarkLabel(tru52)
AnalyzeIL.MarkSequencePoint(doc2, 417, 1, 417, 100)
AnalyzeIL.Emit(OpCodes.Newobj, GetType(Token).GetConstructor(Type.EmptyTypes))
AnalyzeIL.Emit(OpCodes.Stloc, 2)
...
AnalyzeIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("AddToken", typ61))
Typ = Typ03.GetMethod("AddToken", typ61).ReturnType
If Typ.ToString() = GetType(System.Void).ToString() Then
...
ReDim Preserve typ62(UBound(typ62) + 1)
typ62(UBound(typ62)) = Typ
AnalyzeIL.Emit(OpCodes.Call, GetType(String).GetMethod("Concat", typ62))
...
AnalyzeIL.MarkSequencePoint(doc2, 426, 1, 426, 100)
...
ReDim Preserve typ63(UBound(typ63) + 1)
typ63(UBound(typ63)) = Typ
AnalyzeIL.Emit(OpCodes.Call, GetType(String).GetMethod("Concat", typ63))
...
ReDim Preserve typ64(UBound(typ64) + 1)
typ64(UBound(typ64)) = Typ
AnalyzeIL.Emit(OpCodes.Call, GetType(String).GetMethod("Compare", typ64))
...
AnalyzeIL.Emit(OpCodes.Beq, fa55)
AnalyzeIL.Emit(OpCodes.Br, tru55)
...
AnalyzeIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("AddToken", typ65))
Typ = Typ03.GetMethod("AddToken", typ65).ReturnType
If Typ.ToString() = GetType(System.Void).ToString() Then
...
locbldr28.SetLocalSymInfo("n")
AnalyzeIL.Emit(OpCodes.Ldc_I4, CInt(0))
Typ = GetType(System.Int32)
AnalyzeIL.Emit(OpCodes.Stloc, 10)
AnalyzeIL.MarkSequencePoint(doc3, 20, 1, 20, 100)
Dim locbldr29 As LocalBuilder = AnalyzeIL.DeclareLocal(GetType(System.String))
locbldr29.SetLocalSymInfo("ch")
AnalyzeIL.Emit(OpCodes.Ldstr, "")
Typ = GetType(System.String)
AnalyzeIL.Emit(OpCodes.Stloc, 11)
AnalyzeIL.MarkSequencePoint(doc3, 21, 1, 21, 100)
Dim locbldr30 As LocalBuilder = AnalyzeIL.DeclareLocal(GetType(System.Char))
locbldr30.SetLocalSymInfo("chr")
...
locbldr31.SetLocalSymInfo("comp")
AnalyzeIL.Emit(OpCodes.Ldc_I4, CInt(0))
Typ = GetType(System.Int32)
...
AnalyzeIL.Emit(OpCodes.Blt, tru56)
...
AnalyzeIL.Emit(OpCodes.Beq, tru59)
