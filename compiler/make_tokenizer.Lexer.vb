...
isSepIL.Emit(OpCodes.Call, GetType(System.Convert).GetMethod("ToString", typ44))
...
ReDim Preserve typ48(UBound(typ48) + 1)
typ48(UBound(typ48)) = GetType(System.String)
Dim Analyze As MethodBuilder = Line.DefineMethod("Analyze", MethodAttributes.Public, GetType(Stmt), typ48)
...
AnalyzeIL.MarkSequencePoint(doc2, 340, 1, 340, 100)
...
AnalyzeIL.MarkSequencePoint(doc2, 346, 1, 346, 100)
...
AnalyzeIL.MarkSequencePoint(doc2, 350, 1, 350, 100)
...
ReDim Preserve typ50(UBound(typ50) + 1)
typ50(UBound(typ50)) = Typ
AnalyzeIL.Emit(OpCodes.Call, GetType(String).GetMethod("Compare", typ50))
...
AnalyzeIL.Emit(OpCodes.Beq, fa46)
AnalyzeIL.Emit(OpCodes.Br, tru46)
...
AnalyzeIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("AddToken", typ51))
Typ = Typ03.GetMethod("AddToken", typ51).ReturnType
...
AnalyzeIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("get_Chars", typ52))
Typ = Typ03.GetMethod("get_Chars", typ52).ReturnType
Dim typ53 As Type() = {Typ}
AnalyzeIL.Emit(OpCodes.Call, GetType(System.Convert).GetMethod("ToString", typ53))
...
AnalyzeIL.Emit(OpCodes.Blt, tru47)
...
ReDim Preserve typ59(UBound(typ59) + 1)
typ59(UBound(typ59)) = Typ
AnalyzeIL.Emit(OpCodes.Call, GetType(String).GetMethod("Concat", typ59))
...
ReDim Preserve typ60(UBound(typ60) + 1)
typ60(UBound(typ60)) = Typ
AnalyzeIL.Emit(OpCodes.Call, GetType(String).GetMethod("Concat", typ60))
...
ReDim Preserve typ61(UBound(typ61) + 1)
typ61(UBound(typ61)) = Typ
AnalyzeIL.Emit(OpCodes.Call, GetType(String).GetMethod("Compare", typ61))
...
AnalyzeIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("AddToken", typ62))
Typ = Typ03.GetMethod("AddToken", typ62).ReturnType
If Typ.ToString() = GetType(System.Void).ToString() Then
...
AnalyzeIL.Emit(OpCodes.Blt, tru53)
