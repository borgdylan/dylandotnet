...
Dim locbldr219 As LocalBuilder = LoadMethodIL.DeclareLocal(GetType(System.Boolean))
locbldr219.SetLocalSymInfo("vre")
LoadMethodIL.MarkSequencePoint(doc6, 340, 1, 340, 100)
Dim locbldr220 As LocalBuilder = LoadMethodIL.DeclareLocal(GetType(System.Boolean))
locbldr220.SetLocalSymInfo("nme")
LoadMethodIL.MarkSequencePoint(doc6, 341, 1, 341, 100)
Dim locbldr221 As LocalBuilder = LoadMethodIL.DeclareLocal(GetType(Assembly))
locbldr221.SetLocalSymInfo("asm")
LoadMethodIL.Emit(OpCodes.Ldarg, 0)
Typ = GetType(System.Type)
Typ03 = Typ
...
Dim locbldr222 As LocalBuilder = LoadMethodIL.DeclareLocal(GetType(AssemblyName))
locbldr222.SetLocalSymInfo("asmn")
...
Dim locbldr223 As LocalBuilder = LoadMethodIL.DeclareLocal(GetType(AssemblyName))
locbldr223.SetLocalSymInfo("asmnc")
...
LoadMethodIL.Emit(OpCodes.Stloc, 14)
LoadMethodIL.MarkSequencePoint(doc6, 344, 1, 344, 100)
Dim locbldr224 As LocalBuilder = LoadMethodIL.DeclareLocal(GetType(Version))
locbldr224.SetLocalSymInfo("v1")
LoadMethodIL.Emit(OpCodes.Ldloc, 13)
Typ = GetType(AssemblyName)
Typ03 = Typ
LoadMethodIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("get_Version", Type.EmptyTypes))
Typ = Typ03.GetMethod("get_Version", Type.EmptyTypes).ReturnType
LoadMethodIL.Emit(OpCodes.Stloc, 15)
LoadMethodIL.MarkSequencePoint(doc6, 345, 1, 345, 100)
Dim locbldr225 As LocalBuilder = LoadMethodIL.DeclareLocal(GetType(Version))
locbldr225.SetLocalSymInfo("v2")
LoadMethodIL.Emit(OpCodes.Ldloc, 14)
Typ = GetType(AssemblyName)
Typ03 = Typ
LoadMethodIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("get_Version", Type.EmptyTypes))
Typ = Typ03.GetMethod("get_Version", Type.EmptyTypes).ReturnType
LoadMethodIL.Emit(OpCodes.Stloc, 16)
LoadMethodIL.MarkSequencePoint(doc6, 346, 1, 346, 100)
Dim locbldr226 As LocalBuilder = LoadMethodIL.DeclareLocal(GetType(System.String))
locbldr226.SetLocalSymInfo("n1")
LoadMethodIL.Emit(OpCodes.Ldloc, 13)
Typ = GetType(AssemblyName)
Typ03 = Typ
LoadMethodIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("get_Name", Type.EmptyTypes))
Typ = Typ03.GetMethod("get_Name", Type.EmptyTypes).ReturnType
LoadMethodIL.Emit(OpCodes.Stloc, 17)
LoadMethodIL.MarkSequencePoint(doc6, 347, 1, 347, 100)
Dim locbldr227 As LocalBuilder = LoadMethodIL.DeclareLocal(GetType(System.String))
locbldr227.SetLocalSymInfo("n2")
LoadMethodIL.Emit(OpCodes.Ldloc, 14)
Typ = GetType(AssemblyName)
Typ03 = Typ
LoadMethodIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("get_Name", Type.EmptyTypes))
Typ = Typ03.GetMethod("get_Name", Type.EmptyTypes).ReturnType
LoadMethodIL.Emit(OpCodes.Stloc, 18)
LoadMethodIL.MarkSequencePoint(doc6, 348, 1, 348, 100)
Dim typ40(-1) As Type
LoadMethodIL.Emit(OpCodes.Ldloc, 15)
Typ = GetType(Version)
Typ03 = Typ
LoadMethodIL.Emit(OpCodes.Ldloc, 16)
Typ = GetType(Version)
ReDim Preserve typ40(UBound(typ40) + 1)
typ40(UBound(typ40)) = Typ
LoadMethodIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("Equals", typ40))
...
Dim typ41(-1) As Type
LoadMethodIL.Emit(OpCodes.Ldloc, 17)
Typ = GetType(System.String)
Typ03 = Typ
LoadMethodIL.Emit(OpCodes.Ldloc, 18)
Typ = GetType(System.String)
ReDim Preserve typ41(UBound(typ41) + 1)
typ41(UBound(typ41)) = Typ
LoadMethodIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("Equals", typ41))
Typ = Typ03.GetMethod("Equals", typ41).ReturnType
...
Dim locbldr228 As LocalBuilder = LoadMethodIL.DeclareLocal(GetType(System.Boolean))
locbldr228.SetLocalSymInfo("orflg")
LoadMethodIL.Emit(OpCodes.Ldsfld, ProtectedFlag)
Typ = ProtectedFlag.FieldType
LoadMethodIL.Emit(OpCodes.Ldloc, 9)
Typ = GetType(System.Boolean)
LoadMethodIL.Emit(OpCodes.Or)
LoadMethodIL.Emit(OpCodes.Stloc, 19)
LoadMethodIL.MarkSequencePoint(doc6, 353, 1, 353, 100)
Dim locbldr229 As LocalBuilder = LoadMethodIL.DeclareLocal(GetType(System.Boolean))
locbldr229.SetLocalSymInfo("andflg")
LoadMethodIL.Emit(OpCodes.Ldsfld, ProtectedFlag)
Typ = ProtectedFlag.FieldType
LoadMethodIL.Emit(OpCodes.Ldloc, 9)
Typ = GetType(System.Boolean)
LoadMethodIL.Emit(OpCodes.And)
LoadMethodIL.Emit(OpCodes.Stloc, 20)
...
LoadMethodIL.Emit(OpCodes.Ldloc, 8)
Typ = GetType(System.Boolean)
LoadMethodIL.Emit(OpCodes.Ldloc, 20)
Typ = GetType(System.Boolean)
LoadMethodIL.Emit(OpCodes.And)
LoadMethodIL.Emit(OpCodes.Stloc, 8)
...
LoadMethodIL.Emit(OpCodes.Ldloc, 8)
Typ = GetType(System.Boolean)
LoadMethodIL.Emit(OpCodes.Ldloc, 19)
Typ = GetType(System.Boolean)
LoadMethodIL.Emit(OpCodes.And)
LoadMethodIL.Emit(OpCodes.Stloc, 8)
...
LoadMethodIL.MarkSequencePoint(doc6, 364, 1, 364, 100)
LoadMethodIL.Emit(OpCodes.Ldloc, 4)
Typ = GetType(MethodInfo)
Typ03 = Typ
...
LoadMethodIL.Emit(OpCodes.And)
LoadMethodIL.Emit(OpCodes.Stloc, 8)
LoadMethodIL.MarkSequencePoint(doc6, 366, 1, 366, 100)
LoadMethodIL.Emit(OpCodes.Ldloc, 8)
Typ = GetType(System.Boolean)
LoadMethodIL.Emit(OpCodes.Ldc_I4, 0)
Typ = GetType(System.Boolean)
...
LoadMethodIL.Emit(OpCodes.Ldnull)
LoadMethodIL.Emit(OpCodes.Stloc, 4)
LoadMethodIL.MarkSequencePoint(doc6, 368, 1, 368, 100)
...
LoadMethodIL.MarkSequencePoint(doc6, 372, 1, 372, 100)
...
LoadMethodIL.MarkSequencePoint(doc6, 379, 1, 379, 100)
LoadMethodIL.Emit(OpCodes.Ldloc, 4)
Typ = GetType(MethodInfo)
LoadMethodIL.Emit(OpCodes.Ldnull)
...
LoadMethodIL.MarkSequencePoint(doc6, 380, 1, 380, 100)
LoadMethodIL.Emit(OpCodes.Ldloc, 4)
Typ = GetType(MethodInfo)
Typ03 = Typ
LoadMethodIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("get_ReturnType", Type.EmptyTypes))
Typ = Typ03.GetMethod("get_ReturnType", Type.EmptyTypes).ReturnType
LoadMethodIL.Emit(OpCodes.Stsfld, MemberTyp)
LoadMethodIL.MarkSequencePoint(doc6, 381, 1, 381, 100)
LoadMethodIL.Emit(OpCodes.Br, cont346)
LoadMethodIL.MarkLabel(fa346)
LoadMethodIL.Emit(OpCodes.Br, cont346)
LoadMethodIL.MarkLabel(cont346)
LoadMethodIL.MarkSequencePoint(doc6, 383, 1, 383, 100)
LoadMethodIL.Emit(OpCodes.Br, cont339)
LoadMethodIL.MarkLabel(fa339)
LoadMethodIL.Emit(OpCodes.Br, cont339)
LoadMethodIL.MarkLabel(cont339)
LoadMethodIL.MarkSequencePoint(doc6, 385, 1, 385, 100)
LoadMethodIL.Emit(OpCodes.Ldloc, 4)
Typ = GetType(MethodInfo)
LoadMethodIL.MarkSequencePoint(doc6, 387, 1, 387, 100)
LoadMethodIL.Emit(OpCodes.Ret)
Dim typ47(-1) As Type
ReDim Preserve typ47(UBound(typ47) + 1)
typ47(UBound(typ47)) = GetType(System.Type)
ReDim Preserve typ47(UBound(typ47) + 1)
typ47(UBound(typ47)) = GetType(System.Type).MakeArrayType()
Dim LoadCtor As MethodBuilder = Loader.DefineMethod("LoadCtor", MethodAttributes.Public Or MethodAttributes.Static, GetType(ConstructorInfo), typ47)
...
LoadCtorIL.MarkSequencePoint(doc6, 391, 1, 391, 100)
Dim locbldr230 As LocalBuilder = LoadCtorIL.DeclareLocal(GetType(Binder))
locbldr230.SetLocalSymInfo("nullbind")
LoadCtorIL.Emit(OpCodes.Ldnull)
LoadCtorIL.Emit(OpCodes.Stloc, 0)
LoadCtorIL.MarkSequencePoint(doc6, 392, 1, 392, 100)
Dim locbldr231 As LocalBuilder = LoadCtorIL.DeclareLocal(GetType(ParameterModifier).MakeArrayType())
locbldr231.SetLocalSymInfo("parammodifs")
...
Dim locbldr232 As LocalBuilder = LoadCtorIL.DeclareLocal(GetType(BindingFlags))
locbldr232.SetLocalSymInfo("bindflgs")
...
LoadCtorIL.MarkSequencePoint(doc6, 394, 1, 394, 100)
Dim locbldr233 As LocalBuilder = LoadCtorIL.DeclareLocal(GetType(ConstructorInfo))
locbldr233.SetLocalSymInfo("ctorinf")
Dim typ48(-1) As Type
...
ReDim Preserve typ48(UBound(typ48) + 1)
typ48(UBound(typ48)) = Typ
LoadCtorIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("GetConstructor", typ48))
...
LoadCtorIL.MarkSequencePoint(doc6, 398, 1, 398, 100)
...
ReDim Preserve typ49(UBound(typ49) + 1)
typ49(UBound(typ49)) = Typ
LoadCtorIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("GetConstructor", typ49))
Typ = Typ03.GetMethod("GetConstructor", typ49).ReturnType
LoadCtorIL.Emit(OpCodes.Stloc, 3)
...
Dim locbldr234 As LocalBuilder = LoadCtorIL.DeclareLocal(GetType(System.Boolean))
locbldr234.SetLocalSymInfo("b")
...
Dim locbldr235 As LocalBuilder = LoadCtorIL.DeclareLocal(GetType(System.Boolean))
locbldr235.SetLocalSymInfo("havinternal")
LoadCtorIL.MarkSequencePoint(doc6, 413, 1, 413, 100)
Dim locbldr236 As LocalBuilder = LoadCtorIL.DeclareLocal(GetType(System.Boolean))
locbldr236.SetLocalSymInfo("vre")
LoadCtorIL.MarkSequencePoint(doc6, 414, 1, 414, 100)
Dim locbldr237 As LocalBuilder = LoadCtorIL.DeclareLocal(GetType(System.Boolean))
locbldr237.SetLocalSymInfo("nme")
LoadCtorIL.MarkSequencePoint(doc6, 415, 1, 415, 100)
Dim locbldr238 As LocalBuilder = LoadCtorIL.DeclareLocal(GetType(Assembly))
locbldr238.SetLocalSymInfo("asm")
LoadCtorIL.Emit(OpCodes.Ldarg, 0)
Typ = GetType(System.Type)
Typ03 = Typ
...
Dim locbldr239 As LocalBuilder = LoadCtorIL.DeclareLocal(GetType(AssemblyName))
locbldr239.SetLocalSymInfo("asmn")
...
Dim locbldr240 As LocalBuilder = LoadCtorIL.DeclareLocal(GetType(AssemblyName))
locbldr240.SetLocalSymInfo("asmnc")
LoadCtorIL.Emit(OpCodes.Ldsfld, asm.GetType("dylan.NET.Reflection.AsmFactory").GetField("AsmNameStr"))
Typ = asm.GetType("dylan.NET.Reflection.AsmFactory").GetField("AsmNameStr").FieldType
LoadCtorIL.Emit(OpCodes.Stloc, 10)
LoadCtorIL.MarkSequencePoint(doc6, 418, 1, 418, 100)
Dim locbldr241 As LocalBuilder = LoadCtorIL.DeclareLocal(GetType(Version))
locbldr241.SetLocalSymInfo("v1")
LoadCtorIL.Emit(OpCodes.Ldloc, 9)
Typ = GetType(AssemblyName)
Typ03 = Typ
LoadCtorIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("get_Version", Type.EmptyTypes))
Typ = Typ03.GetMethod("get_Version", Type.EmptyTypes).ReturnType
LoadCtorIL.Emit(OpCodes.Stloc, 11)
LoadCtorIL.MarkSequencePoint(doc6, 419, 1, 419, 100)
Dim locbldr242 As LocalBuilder = LoadCtorIL.DeclareLocal(GetType(Version))
locbldr242.SetLocalSymInfo("v2")
LoadCtorIL.Emit(OpCodes.Ldloc, 10)
Typ = GetType(AssemblyName)
Typ03 = Typ
LoadCtorIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("get_Version", Type.EmptyTypes))
Typ = Typ03.GetMethod("get_Version", Type.EmptyTypes).ReturnType
LoadCtorIL.Emit(OpCodes.Stloc, 12)
LoadCtorIL.MarkSequencePoint(doc6, 420, 1, 420, 100)
Dim locbldr243 As LocalBuilder = LoadCtorIL.DeclareLocal(GetType(System.String))
locbldr243.SetLocalSymInfo("n1")
LoadCtorIL.Emit(OpCodes.Ldloc, 9)
Typ = GetType(AssemblyName)
Typ03 = Typ
LoadCtorIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("get_Name", Type.EmptyTypes))
Typ = Typ03.GetMethod("get_Name", Type.EmptyTypes).ReturnType
LoadCtorIL.Emit(OpCodes.Stloc, 13)
LoadCtorIL.MarkSequencePoint(doc6, 421, 1, 421, 100)
Dim locbldr244 As LocalBuilder = LoadCtorIL.DeclareLocal(GetType(System.String))
locbldr244.SetLocalSymInfo("n2")
LoadCtorIL.Emit(OpCodes.Ldloc, 10)
Typ = GetType(AssemblyName)
Typ03 = Typ
LoadCtorIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("get_Name", Type.EmptyTypes))
Typ = Typ03.GetMethod("get_Name", Type.EmptyTypes).ReturnType
LoadCtorIL.Emit(OpCodes.Stloc, 14)
LoadCtorIL.MarkSequencePoint(doc6, 422, 1, 422, 100)
Dim typ57(-1) As Type
LoadCtorIL.Emit(OpCodes.Ldloc, 11)
Typ = GetType(Version)
Typ03 = Typ
LoadCtorIL.Emit(OpCodes.Ldloc, 12)
Typ = GetType(Version)
ReDim Preserve typ57(UBound(typ57) + 1)
typ57(UBound(typ57)) = Typ
LoadCtorIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("Equals", typ57))
...
Dim typ58(-1) As Type
LoadCtorIL.Emit(OpCodes.Ldloc, 13)
Typ = GetType(System.String)
Typ03 = Typ
LoadCtorIL.Emit(OpCodes.Ldloc, 14)
Typ = GetType(System.String)
ReDim Preserve typ58(UBound(typ58) + 1)
typ58(UBound(typ58)) = Typ
LoadCtorIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("Equals", typ58))
...
Dim locbldr245 As LocalBuilder = LoadCtorIL.DeclareLocal(GetType(System.Boolean))
locbldr245.SetLocalSymInfo("orflg")
LoadCtorIL.Emit(OpCodes.Ldsfld, ProtectedFlag)
Typ = ProtectedFlag.FieldType
LoadCtorIL.Emit(OpCodes.Ldloc, 5)
Typ = GetType(System.Boolean)
LoadCtorIL.Emit(OpCodes.Or)
LoadCtorIL.Emit(OpCodes.Stloc, 15)
LoadCtorIL.MarkSequencePoint(doc6, 427, 1, 427, 100)
Dim locbldr246 As LocalBuilder = LoadCtorIL.DeclareLocal(GetType(System.Boolean))
locbldr246.SetLocalSymInfo("andflg")
LoadCtorIL.Emit(OpCodes.Ldsfld, ProtectedFlag)
Typ = ProtectedFlag.FieldType
LoadCtorIL.Emit(OpCodes.Ldloc, 5)
Typ = GetType(System.Boolean)
LoadCtorIL.Emit(OpCodes.And)
LoadCtorIL.Emit(OpCodes.Stloc, 16)
...
Typ = Typ03.GetMethod("get_IsFamilyAndAssembly", Type.EmptyTypes).ReturnType
LoadCtorIL.Emit(OpCodes.Stloc, 4)
LoadCtorIL.MarkSequencePoint(doc6, 430, 1, 430, 100)
LoadCtorIL.Emit(OpCodes.Ldloc, 4)
Typ = GetType(System.Boolean)
LoadCtorIL.Emit(OpCodes.Ldloc, 16)
Typ = GetType(System.Boolean)
LoadCtorIL.Emit(OpCodes.And)
LoadCtorIL.Emit(OpCodes.Stloc, 4)
...
LoadCtorIL.MarkSequencePoint(doc6, 432, 1, 432, 100)
LoadCtorIL.Emit(OpCodes.Ldloc, 3)
Typ = GetType(ConstructorInfo)
Typ03 = Typ
...
LoadCtorIL.Emit(OpCodes.Ldloc, 4)
Typ = GetType(System.Boolean)
LoadCtorIL.Emit(OpCodes.Ldloc, 15)
Typ = GetType(System.Boolean)
LoadCtorIL.Emit(OpCodes.And)
LoadCtorIL.Emit(OpCodes.Stloc, 4)
...
Typ = Typ03.GetMethod("get_IsFamily", Type.EmptyTypes).ReturnType
LoadCtorIL.Emit(OpCodes.Stloc, 4)
LoadCtorIL.MarkSequencePoint(doc6, 436, 1, 436, 100)
LoadCtorIL.Emit(OpCodes.Ldloc, 4)
Typ = GetType(System.Boolean)
LoadCtorIL.Emit(OpCodes.Ldsfld, ProtectedFlag)
Typ = ProtectedFlag.FieldType
LoadCtorIL.Emit(OpCodes.And)
LoadCtorIL.Emit(OpCodes.Stloc, 4)
LoadCtorIL.MarkSequencePoint(doc6, 437, 1, 437, 100)
LoadCtorIL.Emit(OpCodes.Ldloc, 4)
Typ = GetType(System.Boolean)
LoadCtorIL.Emit(OpCodes.Ldc_I4, 0)
Typ = GetType(System.Boolean)
...
Typ = Typ03.GetMethod("get_IsAssembly", Type.EmptyTypes).ReturnType
LoadCtorIL.Emit(OpCodes.Stloc, 4)
LoadCtorIL.MarkSequencePoint(doc6, 439, 1, 439, 100)
LoadCtorIL.Emit(OpCodes.Ldloc, 4)
Typ = GetType(System.Boolean)
LoadCtorIL.Emit(OpCodes.Ldloc, 5)
Typ = GetType(System.Boolean)
...
LoadCtorIL.MarkSequencePoint(doc6, 441, 1, 441, 100)
LoadCtorIL.Emit(OpCodes.Ldnull)
LoadCtorIL.Emit(OpCodes.Stloc, 3)
...
LoadCtorIL.MarkSequencePoint(doc6, 454, 1, 454, 100)
LoadCtorIL.Emit(OpCodes.Ldarg, 0)
Typ = GetType(System.Type)
LoadCtorIL.Emit(OpCodes.Stsfld, MemberTyp)
LoadCtorIL.MarkSequencePoint(doc6, 455, 1, 455, 100)
LoadCtorIL.Emit(OpCodes.Br, cont355)
LoadCtorIL.MarkLabel(fa355)
LoadCtorIL.Emit(OpCodes.Br, cont355)
LoadCtorIL.MarkLabel(cont355)
LoadCtorIL.MarkSequencePoint(doc6, 458, 1, 458, 100)
LoadCtorIL.Emit(OpCodes.Br, cont348)
LoadCtorIL.MarkLabel(fa348)
LoadCtorIL.Emit(OpCodes.Br, cont348)
LoadCtorIL.MarkLabel(cont348)
LoadCtorIL.MarkSequencePoint(doc6, 460, 1, 460, 100)
LoadCtorIL.Emit(OpCodes.Ldloc, 3)
Typ = GetType(ConstructorInfo)
LoadCtorIL.MarkSequencePoint(doc6, 462, 1, 462, 100)
LoadCtorIL.Emit(OpCodes.Ret)
Dim typ63(-1) As Type
ReDim Preserve typ63(UBound(typ63) + 1)
typ63(UBound(typ63)) = GetType(MethodInfo).MakeArrayType()
ReDim Preserve typ63(UBound(typ63) + 1)
typ63(UBound(typ63)) = GetType(MethodInfo)
Dim addelemmtdinfo As MethodBuilder = Loader.DefineMethod("addelemmtdinfo", MethodAttributes.Public Or MethodAttributes.Static, GetType(MethodInfo).MakeArrayType(), typ63)
...
Dim locbldr247 As LocalBuilder = addelemmtdinfoIL.DeclareLocal(GetType(System.Int32))
locbldr247.SetLocalSymInfo("len")
...
Dim locbldr248 As LocalBuilder = addelemmtdinfoIL.DeclareLocal(GetType(System.Int32))
locbldr248.SetLocalSymInfo("destl")
...
Dim locbldr249 As LocalBuilder = addelemmtdinfoIL.DeclareLocal(GetType(System.Int32))
locbldr249.SetLocalSymInfo("stopel")
addelemmtdinfoIL.Emit(OpCodes.Ldloc, 0)
Typ = GetType(System.Int32)
addelemmtdinfoIL.Emit(OpCodes.Ldc_I4, CInt(1))
Typ = GetType(System.Int32)
...
Dim locbldr250 As LocalBuilder = addelemmtdinfoIL.DeclareLocal(GetType(System.Int32))
locbldr250.SetLocalSymInfo("i")
addelemmtdinfoIL.Emit(OpCodes.Ldc_I4, CInt(-1))
Typ = GetType(System.Int32)
addelemmtdinfoIL.Emit(OpCodes.Stloc, 3)
addelemmtdinfoIL.MarkSequencePoint(doc6, 471, 1, 471, 100)
Dim locbldr251 As LocalBuilder = addelemmtdinfoIL.DeclareLocal(GetType(MethodInfo).MakeArrayType())
locbldr251.SetLocalSymInfo("destarr")
...
addelemmtdinfoIL.MarkSequencePoint(doc6, 484, 1, 484, 100)
addelemmtdinfoIL.Emit(OpCodes.Br, cont356)
addelemmtdinfoIL.MarkLabel(fa356)
addelemmtdinfoIL.Emit(OpCodes.Br, cont356)
addelemmtdinfoIL.MarkLabel(cont356)
addelemmtdinfoIL.MarkSequencePoint(doc6, 486, 1, 486, 100)
addelemmtdinfoIL.Emit(OpCodes.Ldloc, 3)
Typ = GetType(System.Int32)
...
addelemmtdinfoIL.MarkSequencePoint(doc6, 487, 1, 487, 100)
addelemmtdinfoIL.Emit(OpCodes.Br, label14)
addelemmtdinfoIL.MarkSequencePoint(doc6, 488, 1, 488, 100)
addelemmtdinfoIL.Emit(OpCodes.Br, cont357)
addelemmtdinfoIL.MarkLabel(fa357)
addelemmtdinfoIL.MarkSequencePoint(doc6, 489, 1, 489, 100)
addelemmtdinfoIL.Emit(OpCodes.Ldloc, 2)
Typ = GetType(System.Int32)
addelemmtdinfoIL.Emit(OpCodes.Ldc_I4, CInt(-1))
Typ = GetType(System.Int32)
...
addelemmtdinfoIL.MarkSequencePoint(doc6, 490, 1, 490, 100)
addelemmtdinfoIL.Emit(OpCodes.Br, label13)
addelemmtdinfoIL.MarkSequencePoint(doc6, 491, 1, 491, 100)
addelemmtdinfoIL.Emit(OpCodes.Br, cont358)
addelemmtdinfoIL.MarkLabel(fa358)
addelemmtdinfoIL.MarkSequencePoint(doc6, 492, 1, 492, 100)
addelemmtdinfoIL.Emit(OpCodes.Br, label14)
addelemmtdinfoIL.MarkSequencePoint(doc6, 493, 1, 493, 100)
addelemmtdinfoIL.Emit(OpCodes.Br, cont358)
addelemmtdinfoIL.MarkLabel(cont358)
addelemmtdinfoIL.MarkSequencePoint(doc6, 494, 1, 494, 100)
addelemmtdinfoIL.Emit(OpCodes.Br, cont357)
addelemmtdinfoIL.MarkLabel(cont357)
addelemmtdinfoIL.MarkSequencePoint(doc6, 496, 1, 496, 100)
addelemmtdinfoIL.MarkLabel(label14)
addelemmtdinfoIL.MarkSequencePoint(doc6, 498, 1, 498, 100)
addelemmtdinfoIL.Emit(OpCodes.Ldloc, 4)
Typ = GetType(MethodInfo).MakeArrayType()
Typ02 = Typ
addelemmtdinfoIL.Emit(OpCodes.Ldloc, 0)
...
Typ = GetType(MethodInfo)
addelemmtdinfoIL.Emit(OpCodes.Stelem, GetType(MethodInfo).MakeArrayType().GetElementType())
addelemmtdinfoIL.MarkSequencePoint(doc6, 500, 1, 500, 100)
addelemmtdinfoIL.Emit(OpCodes.Ldloc, 4)
Typ = GetType(MethodInfo).MakeArrayType()
addelemmtdinfoIL.MarkSequencePoint(doc6, 502, 1, 502, 100)
addelemmtdinfoIL.Emit(OpCodes.Ret)
Dim typ64(-1) As Type
ReDim Preserve typ64(UBound(typ64) + 1)
typ64(UBound(typ64)) = GetType(System.Type)
Dim LoadSpecMtds As MethodBuilder = Loader.DefineMethod("LoadSpecMtds", MethodAttributes.Public Or MethodAttributes.Static, GetType(MethodInfo).MakeArrayType(), typ64)
...
Dim locbldr252 As LocalBuilder = LoadSpecMtdsIL.DeclareLocal(GetType(System.Int32))
locbldr252.SetLocalSymInfo("i")
LoadSpecMtdsIL.Emit(OpCodes.Ldc_I4, CInt(-1))
Typ = GetType(System.Int32)
LoadSpecMtdsIL.Emit(OpCodes.Stloc, 0)
LoadSpecMtdsIL.MarkSequencePoint(doc6, 507, 1, 507, 100)
Dim locbldr253 As LocalBuilder = LoadSpecMtdsIL.DeclareLocal(GetType(MethodInfo))
locbldr253.SetLocalSymInfo("mtdinfo")
LoadSpecMtdsIL.Emit(OpCodes.Ldnull)
LoadSpecMtdsIL.Emit(OpCodes.Stloc, 1)
LoadSpecMtdsIL.MarkSequencePoint(doc6, 508, 1, 508, 100)
Dim locbldr254 As LocalBuilder = LoadSpecMtdsIL.DeclareLocal(GetType(MethodInfo).MakeArrayType())
...
Dim locbldr255 As LocalBuilder = LoadSpecMtdsIL.DeclareLocal(GetType(MethodInfo).MakeArrayType())
locbldr255.SetLocalSymInfo("mtdinfog")
...
Dim locbldr256 As LocalBuilder = LoadSpecMtdsIL.DeclareLocal(GetType(System.Int32))
locbldr256.SetLocalSymInfo("len")
...
Dim locbldr257 As LocalBuilder = LoadSpecMtdsIL.DeclareLocal(GetType(System.Boolean))
...
LoadSpecMtdsIL.MarkSequencePoint(doc6, 516, 1, 516, 100)
Dim label16 As System.Reflection.Emit.Label = LoadSpecMtdsIL.DefineLabel()
LoadSpecMtdsIL.MarkSequencePoint(doc6, 518, 1, 518, 100)
...
Typ = GetType(MethodInfo).MakeArrayType().GetElementType()
LoadSpecMtdsIL.Emit(OpCodes.Stloc, 1)
LoadSpecMtdsIL.MarkSequencePoint(doc6, 523, 1, 523, 100)
...
LoadSpecMtdsIL.Emit(OpCodes.Stloc, 5)
LoadSpecMtdsIL.MarkSequencePoint(doc6, 524, 1, 524, 100)
...
LoadSpecMtdsIL.MarkSequencePoint(doc6, 525, 1, 525, 100)
Dim typ67(-1) As Type
...
LoadSpecMtdsIL.Emit(OpCodes.Stloc, 3)
LoadSpecMtdsIL.MarkSequencePoint(doc6, 526, 1, 526, 100)
LoadSpecMtdsIL.Emit(OpCodes.Br, cont360)
LoadSpecMtdsIL.MarkLabel(fa360)
LoadSpecMtdsIL.Emit(OpCodes.Br, cont360)
LoadSpecMtdsIL.MarkLabel(cont360)
LoadSpecMtdsIL.MarkSequencePoint(doc6, 529, 1, 529, 100)
LoadSpecMtdsIL.Emit(OpCodes.Ldloc, 0)
Typ = GetType(System.Int32)
...
LoadSpecMtdsIL.MarkSequencePoint(doc6, 530, 1, 530, 100)
LoadSpecMtdsIL.Emit(OpCodes.Br, label16)
LoadSpecMtdsIL.MarkSequencePoint(doc6, 531, 1, 531, 100)
LoadSpecMtdsIL.Emit(OpCodes.Br, cont361)
LoadSpecMtdsIL.MarkLabel(fa361)
LoadSpecMtdsIL.MarkSequencePoint(doc6, 532, 1, 532, 100)
LoadSpecMtdsIL.Emit(OpCodes.Br, label15)
LoadSpecMtdsIL.MarkSequencePoint(doc6, 533, 1, 533, 100)
LoadSpecMtdsIL.Emit(OpCodes.Br, cont361)
LoadSpecMtdsIL.MarkLabel(cont361)
LoadSpecMtdsIL.MarkSequencePoint(doc6, 535, 1, 535, 100)
LoadSpecMtdsIL.MarkLabel(label16)
LoadSpecMtdsIL.MarkSequencePoint(doc6, 537, 1, 537, 100)
LoadSpecMtdsIL.Emit(OpCodes.Br, cont359)
LoadSpecMtdsIL.MarkLabel(fa359)
LoadSpecMtdsIL.Emit(OpCodes.Br, cont359)
LoadSpecMtdsIL.MarkLabel(cont359)
LoadSpecMtdsIL.MarkSequencePoint(doc6, 540, 1, 540, 100)
LoadSpecMtdsIL.Emit(OpCodes.Ldloc, 3)
Typ = GetType(MethodInfo).MakeArrayType()
LoadSpecMtdsIL.MarkSequencePoint(doc6, 542, 1, 542, 100)
LoadSpecMtdsIL.Emit(OpCodes.Ret)
Dim typ68(-1) As Type
ReDim Preserve typ68(UBound(typ68) + 1)
typ68(UBound(typ68)) = GetType(ParameterInfo).MakeArrayType()
ReDim Preserve typ68(UBound(typ68) + 1)
typ68(UBound(typ68)) = GetType(System.Type).MakeArrayType()
Dim CompareParamsToTyps As MethodBuilder = Loader.DefineMethod("CompareParamsToTyps", MethodAttributes.Public Or MethodAttributes.Static, GetType(System.Boolean), typ68)
...
CompareParamsToTypsIL.MarkSequencePoint(doc6, 546, 1, 546, 100)
Dim locbldr258 As LocalBuilder = CompareParamsToTypsIL.DeclareLocal(GetType(System.Boolean))
locbldr258.SetLocalSymInfo("ans")
...
Dim locbldr259 As LocalBuilder = CompareParamsToTypsIL.DeclareLocal(GetType(System.Boolean))
locbldr259.SetLocalSymInfo("b")
CompareParamsToTypsIL.Emit(OpCodes.Ldc_I4, 0)
Typ = GetType(System.Boolean)
CompareParamsToTypsIL.Emit(OpCodes.Stloc, 1)
CompareParamsToTypsIL.MarkSequencePoint(doc6, 548, 1, 548, 100)
Dim locbldr260 As LocalBuilder = CompareParamsToTypsIL.DeclareLocal(GetType(ParameterInfo))
locbldr260.SetLocalSymInfo("p")
CompareParamsToTypsIL.MarkSequencePoint(doc6, 549, 1, 549, 100)
Dim locbldr261 As LocalBuilder = CompareParamsToTypsIL.DeclareLocal(GetType(System.Type))
locbldr261.SetLocalSymInfo("ta")
CompareParamsToTypsIL.MarkSequencePoint(doc6, 550, 1, 550, 100)
Dim locbldr262 As LocalBuilder = CompareParamsToTypsIL.DeclareLocal(GetType(System.Type))
locbldr262.SetLocalSymInfo("tb")
...
Dim locbldr263 As LocalBuilder = CompareParamsToTypsIL.DeclareLocal(GetType(System.Int32))
locbldr263.SetLocalSymInfo("i")
...
Dim locbldr264 As LocalBuilder = CompareParamsToTypsIL.DeclareLocal(GetType(System.Int32))
...
CompareParamsToTypsIL.MarkSequencePoint(doc6, 558, 1, 558, 100)
...
CompareParamsToTypsIL.MarkSequencePoint(doc6, 570, 1, 570, 100)
...
ReDim Preserve typ70(UBound(typ70) + 1)
typ70(UBound(typ70)) = Typ
CompareParamsToTypsIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("Equals", typ70))
Typ = Typ03.GetMethod("Equals", typ70).ReturnType
CompareParamsToTypsIL.Emit(OpCodes.Stloc, 1)
CompareParamsToTypsIL.MarkSequencePoint(doc6, 574, 1, 574, 100)
CompareParamsToTypsIL.Emit(OpCodes.Ldloc, 1)
Typ = GetType(System.Boolean)
CompareParamsToTypsIL.Emit(OpCodes.Ldc_I4, 0)
Typ = GetType(System.Boolean)
...
CompareParamsToTypsIL.MarkSequencePoint(doc6, 575, 1, 575, 100)
CompareParamsToTypsIL.Emit(OpCodes.Ldc_I4, 0)
Typ = GetType(System.Boolean)
CompareParamsToTypsIL.Emit(OpCodes.Stloc, 0)
CompareParamsToTypsIL.MarkSequencePoint(doc6, 576, 1, 576, 100)
CompareParamsToTypsIL.Emit(OpCodes.Br, label18)
CompareParamsToTypsIL.MarkSequencePoint(doc6, 577, 1, 577, 100)
...
CompareParamsToTypsIL.MarkSequencePoint(doc6, 579, 1, 579, 100)
CompareParamsToTypsIL.Emit(OpCodes.Ldloc, 5)
Typ = GetType(System.Int32)
...
CompareParamsToTypsIL.MarkSequencePoint(doc6, 580, 1, 580, 100)
CompareParamsToTypsIL.Emit(OpCodes.Br, label18)
CompareParamsToTypsIL.MarkSequencePoint(doc6, 581, 1, 581, 100)
CompareParamsToTypsIL.Emit(OpCodes.Br, cont365)
CompareParamsToTypsIL.MarkLabel(fa365)
CompareParamsToTypsIL.MarkSequencePoint(doc6, 582, 1, 582, 100)
CompareParamsToTypsIL.Emit(OpCodes.Br, label17)
CompareParamsToTypsIL.MarkSequencePoint(doc6, 583, 1, 583, 100)
CompareParamsToTypsIL.Emit(OpCodes.Br, cont365)
CompareParamsToTypsIL.MarkLabel(cont365)
CompareParamsToTypsIL.MarkSequencePoint(doc6, 585, 1, 585, 100)
CompareParamsToTypsIL.MarkLabel(label18)
CompareParamsToTypsIL.MarkSequencePoint(doc6, 587, 1, 587, 100)
CompareParamsToTypsIL.Emit(OpCodes.Br, cont362)
CompareParamsToTypsIL.MarkLabel(fa362)
CompareParamsToTypsIL.MarkSequencePoint(doc6, 588, 1, 588, 100)
CompareParamsToTypsIL.Emit(OpCodes.Ldc_I4, 0)
Typ = GetType(System.Boolean)
CompareParamsToTypsIL.Emit(OpCodes.Stloc, 0)
CompareParamsToTypsIL.MarkSequencePoint(doc6, 589, 1, 589, 100)
CompareParamsToTypsIL.Emit(OpCodes.Br, cont362)
CompareParamsToTypsIL.MarkLabel(cont362)
CompareParamsToTypsIL.MarkSequencePoint(doc6, 591, 1, 591, 100)
CompareParamsToTypsIL.Emit(OpCodes.Ldloc, 0)
Typ = GetType(System.Boolean)
CompareParamsToTypsIL.MarkSequencePoint(doc6, 592, 1, 592, 100)
CompareParamsToTypsIL.Emit(OpCodes.Ret)
Dim typ71(-1) As Type
ReDim Preserve typ71(UBound(typ71) + 1)
typ71(UBound(typ71)) = GetType(System.Type)
ReDim Preserve typ71(UBound(typ71) + 1)
typ71(UBound(typ71)) = GetType(System.String)
ReDim Preserve typ71(UBound(typ71) + 1)
typ71(UBound(typ71)) = GetType(System.Type)
ReDim Preserve typ71(UBound(typ71) + 1)
typ71(UBound(typ71)) = GetType(System.Type)
Dim LoadBinOp As MethodBuilder = Loader.DefineMethod("LoadBinOp", MethodAttributes.Public Or MethodAttributes.Static, GetType(MethodInfo), typ71)
...
LoadBinOpIL.MarkSequencePoint(doc6, 596, 1, 596, 100)
Dim locbldr265 As LocalBuilder = LoadBinOpIL.DeclareLocal(GetType(System.Type).MakeArrayType())
locbldr265.SetLocalSymInfo("typs")
...
Dim locbldr266 As LocalBuilder = LoadBinOpIL.DeclareLocal(GetType(System.Int32))
locbldr266.SetLocalSymInfo("i")
LoadBinOpIL.Emit(OpCodes.Ldc_I4, CInt(-1))
Typ = GetType(System.Int32)
LoadBinOpIL.Emit(OpCodes.Stloc, 1)
LoadBinOpIL.MarkSequencePoint(doc6, 600, 1, 600, 100)
Dim locbldr267 As LocalBuilder = LoadBinOpIL.DeclareLocal(GetType(MethodInfo))
locbldr267.SetLocalSymInfo("mtdinfo")
LoadBinOpIL.Emit(OpCodes.Ldnull)
LoadBinOpIL.Emit(OpCodes.Stloc, 2)
LoadBinOpIL.MarkSequencePoint(doc6, 601, 1, 601, 100)
Dim locbldr268 As LocalBuilder = LoadBinOpIL.DeclareLocal(GetType(MethodInfo).MakeArrayType())
locbldr268.SetLocalSymInfo("mtdinfos")
Dim typ72(-1) As Type
...
LoadBinOpIL.MarkSequencePoint(doc6, 602, 1, 602, 100)
Dim locbldr269 As LocalBuilder = LoadBinOpIL.DeclareLocal(GetType(System.Int32))
locbldr269.SetLocalSymInfo("len")
...
Dim locbldr270 As LocalBuilder = LoadBinOpIL.DeclareLocal(GetType(System.Boolean))
locbldr270.SetLocalSymInfo("b")
LoadBinOpIL.Emit(OpCodes.Ldc_I4, 0)
Typ = GetType(System.Boolean)
LoadBinOpIL.Emit(OpCodes.Stloc, 5)
LoadBinOpIL.MarkSequencePoint(doc6, 604, 1, 604, 100)
Dim locbldr271 As LocalBuilder = LoadBinOpIL.DeclareLocal(GetType(System.Int32))
locbldr271.SetLocalSymInfo("comp")
LoadBinOpIL.Emit(OpCodes.Ldc_I4, CInt(0))
Typ = GetType(System.Int32)
LoadBinOpIL.Emit(OpCodes.Stloc, 6)
LoadBinOpIL.MarkSequencePoint(doc6, 605, 1, 605, 100)
Dim locbldr272 As LocalBuilder = LoadBinOpIL.DeclareLocal(GetType(System.String))
locbldr272.SetLocalSymInfo("nstr")
LoadBinOpIL.MarkSequencePoint(doc6, 606, 1, 606, 100)
Dim locbldr273 As LocalBuilder = LoadBinOpIL.DeclareLocal(GetType(ParameterInfo).MakeArrayType())
locbldr273.SetLocalSymInfo("ps")
...
LoadBinOpIL.MarkSequencePoint(doc6, 611, 1, 611, 100)
...
LoadBinOpIL.MarkSequencePoint(doc6, 615, 1, 615, 100)
...
ReDim Preserve typ74(UBound(typ74) + 1)
typ74(UBound(typ74)) = Typ
LoadBinOpIL.Emit(OpCodes.Call, GetType(String).GetMethod("Compare", typ74))
Typ = GetType(String).GetMethod("Compare", typ74).ReturnType
LoadBinOpIL.Emit(OpCodes.Stloc, 6)
LoadBinOpIL.MarkSequencePoint(doc6, 621, 1, 621, 100)
...
LoadBinOpIL.MarkSequencePoint(doc6, 623, 1, 623, 100)
LoadBinOpIL.Emit(OpCodes.Ldloc, 2)
Typ = GetType(MethodInfo)
Typ03 = Typ
...
LoadBinOpIL.Emit(OpCodes.Stloc, 5)
LoadBinOpIL.MarkSequencePoint(doc6, 626, 1, 626, 100)
...
LoadBinOpIL.MarkSequencePoint(doc6, 628, 1, 628, 100)
LoadBinOpIL.Emit(OpCodes.Br, cont368)
LoadBinOpIL.MarkLabel(fa368)
LoadBinOpIL.MarkSequencePoint(doc6, 629, 1, 629, 100)
LoadBinOpIL.Emit(OpCodes.Ldnull)
LoadBinOpIL.Emit(OpCodes.Stloc, 2)
LoadBinOpIL.MarkSequencePoint(doc6, 630, 1, 630, 100)
LoadBinOpIL.Emit(OpCodes.Br, cont368)
LoadBinOpIL.MarkLabel(cont368)
LoadBinOpIL.MarkSequencePoint(doc6, 632, 1, 632, 100)
LoadBinOpIL.Emit(OpCodes.Br, cont367)
LoadBinOpIL.MarkLabel(fa367)
LoadBinOpIL.MarkSequencePoint(doc6, 633, 1, 633, 100)
LoadBinOpIL.Emit(OpCodes.Ldnull)
LoadBinOpIL.Emit(OpCodes.Stloc, 2)
LoadBinOpIL.MarkSequencePoint(doc6, 634, 1, 634, 100)
LoadBinOpIL.Emit(OpCodes.Br, cont367)
LoadBinOpIL.MarkLabel(cont367)
LoadBinOpIL.MarkSequencePoint(doc6, 636, 1, 636, 100)
LoadBinOpIL.Emit(OpCodes.Ldloc, 1)
Typ = GetType(System.Int32)
...
LoadBinOpIL.MarkSequencePoint(doc6, 637, 1, 637, 100)
LoadBinOpIL.Emit(OpCodes.Br, label20)
LoadBinOpIL.MarkSequencePoint(doc6, 638, 1, 638, 100)
LoadBinOpIL.Emit(OpCodes.Br, cont369)
LoadBinOpIL.MarkLabel(fa369)
LoadBinOpIL.MarkSequencePoint(doc6, 639, 1, 639, 100)
LoadBinOpIL.Emit(OpCodes.Br, label19)
LoadBinOpIL.MarkSequencePoint(doc6, 640, 1, 640, 100)
LoadBinOpIL.Emit(OpCodes.Br, cont369)
LoadBinOpIL.MarkLabel(cont369)
LoadBinOpIL.MarkSequencePoint(doc6, 642, 1, 642, 100)
LoadBinOpIL.MarkLabel(label20)
LoadBinOpIL.MarkSequencePoint(doc6, 644, 1, 644, 100)
LoadBinOpIL.Emit(OpCodes.Br, cont366)
LoadBinOpIL.MarkLabel(fa366)
LoadBinOpIL.Emit(OpCodes.Br, cont366)
LoadBinOpIL.MarkLabel(cont366)
LoadBinOpIL.MarkSequencePoint(doc6, 647, 1, 647, 100)
LoadBinOpIL.Emit(OpCodes.Ldloc, 2)
Typ = GetType(MethodInfo)
LoadBinOpIL.MarkSequencePoint(doc6, 649, 1, 649, 100)
LoadBinOpIL.Emit(OpCodes.Ret)
Dim typ77(-1) As Type
ReDim Preserve typ77(UBound(typ77) + 1)
typ77(UBound(typ77)) = GetType(System.Type)
ReDim Preserve typ77(UBound(typ77) + 1)
typ77(UBound(typ77)) = GetType(System.String)
ReDim Preserve typ77(UBound(typ77) + 1)
typ77(UBound(typ77)) = GetType(System.Type)
ReDim Preserve typ77(UBound(typ77) + 1)
typ77(UBound(typ77)) = GetType(System.Type)
Dim LoadConvOp As MethodBuilder = Loader.DefineMethod("LoadConvOp", MethodAttributes.Public Or MethodAttributes.Static, GetType(MethodInfo), typ77)
...
LoadConvOpIL.MarkSequencePoint(doc6, 653, 1, 653, 100)
Dim locbldr274 As LocalBuilder = LoadConvOpIL.DeclareLocal(GetType(System.Type).MakeArrayType())
locbldr274.SetLocalSymInfo("typs")
...
Dim locbldr275 As LocalBuilder = LoadConvOpIL.DeclareLocal(GetType(System.Int32))
locbldr275.SetLocalSymInfo("i")
LoadConvOpIL.Emit(OpCodes.Ldc_I4, CInt(-1))
Typ = GetType(System.Int32)
LoadConvOpIL.Emit(OpCodes.Stloc, 1)
LoadConvOpIL.MarkSequencePoint(doc6, 656, 1, 656, 100)
Dim locbldr276 As LocalBuilder = LoadConvOpIL.DeclareLocal(GetType(MethodInfo))
locbldr276.SetLocalSymInfo("mtdinfo")
LoadConvOpIL.Emit(OpCodes.Ldnull)
LoadConvOpIL.Emit(OpCodes.Stloc, 2)
LoadConvOpIL.MarkSequencePoint(doc6, 657, 1, 657, 100)
Dim locbldr277 As LocalBuilder = LoadConvOpIL.DeclareLocal(GetType(MethodInfo).MakeArrayType())
locbldr277.SetLocalSymInfo("mtdinfos")
Dim typ78(-1) As Type
...
Dim locbldr278 As LocalBuilder = LoadConvOpIL.DeclareLocal(GetType(System.Int32))
...
LoadConvOpIL.MarkSequencePoint(doc6, 659, 1, 659, 100)
Dim locbldr279 As LocalBuilder = LoadConvOpIL.DeclareLocal(GetType(System.Boolean))
locbldr279.SetLocalSymInfo("b")
LoadConvOpIL.Emit(OpCodes.Ldc_I4, 0)
Typ = GetType(System.Boolean)
LoadConvOpIL.Emit(OpCodes.Stloc, 5)
LoadConvOpIL.MarkSequencePoint(doc6, 660, 1, 660, 100)
Dim locbldr280 As LocalBuilder = LoadConvOpIL.DeclareLocal(GetType(System.Int32))
locbldr280.SetLocalSymInfo("comp")
LoadConvOpIL.Emit(OpCodes.Ldc_I4, CInt(0))
Typ = GetType(System.Int32)
LoadConvOpIL.Emit(OpCodes.Stloc, 6)
LoadConvOpIL.MarkSequencePoint(doc6, 661, 1, 661, 100)
Dim locbldr281 As LocalBuilder = LoadConvOpIL.DeclareLocal(GetType(System.String))
locbldr281.SetLocalSymInfo("nstr")
LoadConvOpIL.MarkSequencePoint(doc6, 662, 1, 662, 100)
Dim locbldr282 As LocalBuilder = LoadConvOpIL.DeclareLocal(GetType(ParameterInfo).MakeArrayType())
locbldr282.SetLocalSymInfo("ps")
LoadConvOpIL.MarkSequencePoint(doc6, 663, 1, 663, 100)
Dim locbldr283 As LocalBuilder = LoadConvOpIL.DeclareLocal(GetType(System.Type))
locbldr283.SetLocalSymInfo("rett")
...
LoadConvOpIL.MarkSequencePoint(doc6, 667, 1, 667, 100)
...
ReDim Preserve typ80(UBound(typ80) + 1)
typ80(UBound(typ80)) = Typ
LoadConvOpIL.Emit(OpCodes.Call, GetType(String).GetMethod("Compare", typ80))
...
LoadConvOpIL.MarkSequencePoint(doc6, 681, 1, 681, 100)
Dim typ82(-1) As Type
...
ReDim Preserve typ84(UBound(typ84) + 1)
typ84(UBound(typ84)) = Typ
LoadConvOpIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("Equals", typ84))
Typ = Typ03.GetMethod("Equals", typ84).ReturnType
LoadConvOpIL.Emit(OpCodes.Stloc, 5)
...
LoadConvOpIL.MarkSequencePoint(doc6, 689, 1, 689, 100)
...
LoadConvOpIL.MarkSequencePoint(doc6, 691, 1, 691, 100)
LoadConvOpIL.Emit(OpCodes.Ldnull)
LoadConvOpIL.Emit(OpCodes.Stloc, 2)
LoadConvOpIL.MarkSequencePoint(doc6, 692, 1, 692, 100)
LoadConvOpIL.Emit(OpCodes.Br, cont373)
LoadConvOpIL.MarkLabel(cont373)
LoadConvOpIL.MarkSequencePoint(doc6, 694, 1, 694, 100)
LoadConvOpIL.Emit(OpCodes.Br, cont372)
LoadConvOpIL.MarkLabel(fa372)
LoadConvOpIL.MarkSequencePoint(doc6, 695, 1, 695, 100)
LoadConvOpIL.Emit(OpCodes.Ldnull)
LoadConvOpIL.Emit(OpCodes.Stloc, 2)
LoadConvOpIL.MarkSequencePoint(doc6, 696, 1, 696, 100)
LoadConvOpIL.Emit(OpCodes.Br, cont372)
LoadConvOpIL.MarkLabel(cont372)
LoadConvOpIL.MarkSequencePoint(doc6, 698, 1, 698, 100)
LoadConvOpIL.Emit(OpCodes.Br, cont371)
LoadConvOpIL.MarkLabel(fa371)
LoadConvOpIL.MarkSequencePoint(doc6, 699, 1, 699, 100)
LoadConvOpIL.Emit(OpCodes.Ldnull)
LoadConvOpIL.Emit(OpCodes.Stloc, 2)
LoadConvOpIL.MarkSequencePoint(doc6, 700, 1, 700, 100)
LoadConvOpIL.Emit(OpCodes.Br, cont371)
LoadConvOpIL.MarkLabel(cont371)
LoadConvOpIL.MarkSequencePoint(doc6, 702, 1, 702, 100)
LoadConvOpIL.Emit(OpCodes.Ldloc, 1)
Typ = GetType(System.Int32)
...
LoadConvOpIL.MarkSequencePoint(doc6, 703, 1, 703, 100)
LoadConvOpIL.Emit(OpCodes.Br, label22)
LoadConvOpIL.MarkSequencePoint(doc6, 704, 1, 704, 100)
LoadConvOpIL.Emit(OpCodes.Br, cont374)
LoadConvOpIL.MarkLabel(fa374)
LoadConvOpIL.MarkSequencePoint(doc6, 705, 1, 705, 100)
LoadConvOpIL.Emit(OpCodes.Br, label21)
LoadConvOpIL.MarkSequencePoint(doc6, 706, 1, 706, 100)
LoadConvOpIL.Emit(OpCodes.Br, cont374)
LoadConvOpIL.MarkLabel(cont374)
LoadConvOpIL.MarkSequencePoint(doc6, 708, 1, 708, 100)
LoadConvOpIL.MarkLabel(label22)
LoadConvOpIL.MarkSequencePoint(doc6, 710, 1, 710, 100)
LoadConvOpIL.Emit(OpCodes.Br, cont370)
LoadConvOpIL.MarkLabel(fa370)
LoadConvOpIL.Emit(OpCodes.Br, cont370)
LoadConvOpIL.MarkLabel(cont370)
LoadConvOpIL.MarkSequencePoint(doc6, 713, 1, 713, 100)
LoadConvOpIL.Emit(OpCodes.Ldloc, 2)
Typ = GetType(MethodInfo)
LoadConvOpIL.MarkSequencePoint(doc6, 715, 1, 715, 100)
LoadConvOpIL.Emit(OpCodes.Ret)
Dim typ85(-1) As Type
ReDim Preserve typ85(UBound(typ85) + 1)
typ85(UBound(typ85)) = GetType(System.Type)
ReDim Preserve typ85(UBound(typ85) + 1)
typ85(UBound(typ85)) = GetType(System.String)
Dim LoadField As MethodBuilder = Loader.DefineMethod("LoadField", MethodAttributes.Public Or MethodAttributes.Static, GetType(FieldInfo), typ85)
...
Dim locbldr284 As LocalBuilder = LoadFieldIL.DeclareLocal(GetType(System.Type))
locbldr284.SetLocalSymInfo("temptyp")
LoadFieldIL.Emit(OpCodes.Ldnull)
LoadFieldIL.Emit(OpCodes.Stloc, 0)
LoadFieldIL.MarkSequencePoint(doc6, 722, 1, 722, 100)
Dim locbldr285 As LocalBuilder = LoadFieldIL.DeclareLocal(GetType(FieldInfo))
locbldr285.SetLocalSymInfo("fldinfo")
LoadFieldIL.Emit(OpCodes.Ldnull)
LoadFieldIL.Emit(OpCodes.Stloc, 1)
LoadFieldIL.MarkSequencePoint(doc6, 724, 1, 724, 100)
Dim typ86(-1) As Type
...
ReDim Preserve typ86(UBound(typ86) + 1)
typ86(UBound(typ86)) = Typ
LoadFieldIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("GetField", typ86))
Typ = Typ03.GetMethod("GetField", typ86).ReturnType
LoadFieldIL.Emit(OpCodes.Stloc, 1)
LoadFieldIL.MarkSequencePoint(doc6, 725, 1, 725, 100)
Dim locbldr286 As LocalBuilder = LoadFieldIL.DeclareLocal(GetType(BindingFlags))
locbldr286.SetLocalSymInfo("bindflgs")
...
ReDim Preserve typ87(UBound(typ87) + 1)
typ87(UBound(typ87)) = Typ
LoadFieldIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("GetField", typ87))
Typ = Typ03.GetMethod("GetField", typ87).ReturnType
LoadFieldIL.Emit(OpCodes.Stloc, 1)
...
Dim locbldr287 As LocalBuilder = LoadFieldIL.DeclareLocal(GetType(System.Boolean))
...
Dim locbldr288 As LocalBuilder = LoadFieldIL.DeclareLocal(GetType(System.Boolean))
locbldr288.SetLocalSymInfo("havinternal")
LoadFieldIL.MarkSequencePoint(doc6, 739, 1, 739, 100)
Dim locbldr289 As LocalBuilder = LoadFieldIL.DeclareLocal(GetType(System.Boolean))
locbldr289.SetLocalSymInfo("vre")
LoadFieldIL.MarkSequencePoint(doc6, 740, 1, 740, 100)
Dim locbldr290 As LocalBuilder = LoadFieldIL.DeclareLocal(GetType(System.Boolean))
locbldr290.SetLocalSymInfo("nme")
LoadFieldIL.MarkSequencePoint(doc6, 741, 1, 741, 100)
Dim locbldr291 As LocalBuilder = LoadFieldIL.DeclareLocal(GetType(Assembly))
locbldr291.SetLocalSymInfo("asm")
LoadFieldIL.Emit(OpCodes.Ldarg, 0)
Typ = GetType(System.Type)
Typ03 = Typ
...
Dim locbldr292 As LocalBuilder = LoadFieldIL.DeclareLocal(GetType(AssemblyName))
locbldr292.SetLocalSymInfo("asmn")
...
Dim locbldr293 As LocalBuilder = LoadFieldIL.DeclareLocal(GetType(AssemblyName))
locbldr293.SetLocalSymInfo("asmnc")
...
LoadFieldIL.MarkSequencePoint(doc6, 744, 1, 744, 100)
Dim locbldr294 As LocalBuilder = LoadFieldIL.DeclareLocal(GetType(Version))
locbldr294.SetLocalSymInfo("v1")
LoadFieldIL.Emit(OpCodes.Ldloc, 8)
Typ = GetType(AssemblyName)
Typ03 = Typ
LoadFieldIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("get_Version", Type.EmptyTypes))
Typ = Typ03.GetMethod("get_Version", Type.EmptyTypes).ReturnType
LoadFieldIL.Emit(OpCodes.Stloc, 10)
LoadFieldIL.MarkSequencePoint(doc6, 745, 1, 745, 100)
Dim locbldr295 As LocalBuilder = LoadFieldIL.DeclareLocal(GetType(Version))
locbldr295.SetLocalSymInfo("v2")
LoadFieldIL.Emit(OpCodes.Ldloc, 9)
Typ = GetType(AssemblyName)
Typ03 = Typ
LoadFieldIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("get_Version", Type.EmptyTypes))
Typ = Typ03.GetMethod("get_Version", Type.EmptyTypes).ReturnType
LoadFieldIL.Emit(OpCodes.Stloc, 11)
LoadFieldIL.MarkSequencePoint(doc6, 746, 1, 746, 100)
Dim locbldr296 As LocalBuilder = LoadFieldIL.DeclareLocal(GetType(System.String))
locbldr296.SetLocalSymInfo("n1")
LoadFieldIL.Emit(OpCodes.Ldloc, 8)
Typ = GetType(AssemblyName)
Typ03 = Typ
LoadFieldIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("get_Name", Type.EmptyTypes))
Typ = Typ03.GetMethod("get_Name", Type.EmptyTypes).ReturnType
LoadFieldIL.Emit(OpCodes.Stloc, 12)
LoadFieldIL.MarkSequencePoint(doc6, 747, 1, 747, 100)
Dim locbldr297 As LocalBuilder = LoadFieldIL.DeclareLocal(GetType(System.String))
locbldr297.SetLocalSymInfo("n2")
LoadFieldIL.Emit(OpCodes.Ldloc, 9)
Typ = GetType(AssemblyName)
Typ03 = Typ
LoadFieldIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("get_Name", Type.EmptyTypes))
Typ = Typ03.GetMethod("get_Name", Type.EmptyTypes).ReturnType
LoadFieldIL.Emit(OpCodes.Stloc, 13)
LoadFieldIL.MarkSequencePoint(doc6, 748, 1, 748, 100)
Dim typ95(-1) As Type
LoadFieldIL.Emit(OpCodes.Ldloc, 10)
Typ = GetType(Version)
Typ03 = Typ
LoadFieldIL.Emit(OpCodes.Ldloc, 11)
Typ = GetType(Version)
ReDim Preserve typ95(UBound(typ95) + 1)
typ95(UBound(typ95)) = Typ
LoadFieldIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("Equals", typ95))
Typ = Typ03.GetMethod("Equals", typ95).ReturnType
LoadFieldIL.Emit(OpCodes.Stloc, 5)
LoadFieldIL.MarkSequencePoint(doc6, 749, 1, 749, 100)
Dim typ96(-1) As Type
LoadFieldIL.Emit(OpCodes.Ldloc, 12)
Typ = GetType(System.String)
Typ03 = Typ
LoadFieldIL.Emit(OpCodes.Ldloc, 13)
Typ = GetType(System.String)
ReDim Preserve typ96(UBound(typ96) + 1)
typ96(UBound(typ96)) = Typ
LoadFieldIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("Equals", typ96))
Typ = Typ03.GetMethod("Equals", typ96).ReturnType
...
Dim locbldr298 As LocalBuilder = LoadFieldIL.DeclareLocal(GetType(System.Boolean))
locbldr298.SetLocalSymInfo("orflg")
LoadFieldIL.Emit(OpCodes.Ldsfld, ProtectedFlag)
Typ = ProtectedFlag.FieldType
LoadFieldIL.Emit(OpCodes.Ldloc, 4)
Typ = GetType(System.Boolean)
LoadFieldIL.Emit(OpCodes.Or)
LoadFieldIL.Emit(OpCodes.Stloc, 14)
LoadFieldIL.MarkSequencePoint(doc6, 752, 1, 752, 100)
Dim locbldr299 As LocalBuilder = LoadFieldIL.DeclareLocal(GetType(System.Boolean))
locbldr299.SetLocalSymInfo("andflg")
LoadFieldIL.Emit(OpCodes.Ldsfld, ProtectedFlag)
Typ = ProtectedFlag.FieldType
LoadFieldIL.Emit(OpCodes.Ldloc, 4)
Typ = GetType(System.Boolean)
LoadFieldIL.Emit(OpCodes.And)
LoadFieldIL.Emit(OpCodes.Stloc, 15)
...
LoadFieldIL.Emit(OpCodes.Ldloc, 3)
Typ = GetType(System.Boolean)
LoadFieldIL.Emit(OpCodes.Ldloc, 15)
Typ = GetType(System.Boolean)
LoadFieldIL.Emit(OpCodes.And)
LoadFieldIL.Emit(OpCodes.Stloc, 3)
...
LoadFieldIL.Emit(OpCodes.Ldloc, 3)
Typ = GetType(System.Boolean)
LoadFieldIL.Emit(OpCodes.Ldloc, 14)
Typ = GetType(System.Boolean)
LoadFieldIL.Emit(OpCodes.And)
LoadFieldIL.Emit(OpCodes.Stloc, 3)
...
Typ = Typ03.GetMethod("get_IsAssembly", Type.EmptyTypes).ReturnType
LoadFieldIL.Emit(OpCodes.Stloc, 3)
LoadFieldIL.MarkSequencePoint(doc6, 764, 1, 764, 100)
LoadFieldIL.Emit(OpCodes.Ldloc, 3)
Typ = GetType(System.Boolean)
LoadFieldIL.Emit(OpCodes.Ldloc, 4)
Typ = GetType(System.Boolean)
LoadFieldIL.Emit(OpCodes.And)
LoadFieldIL.Emit(OpCodes.Stloc, 3)
LoadFieldIL.MarkSequencePoint(doc6, 765, 1, 765, 100)
LoadFieldIL.Emit(OpCodes.Ldloc, 3)
Typ = GetType(System.Boolean)
LoadFieldIL.Emit(OpCodes.Ldc_I4, 0)
Typ = GetType(System.Boolean)
...
LoadFieldIL.Emit(OpCodes.Ldnull)
LoadFieldIL.Emit(OpCodes.Stloc, 1)
LoadFieldIL.MarkSequencePoint(doc6, 767, 1, 767, 100)
...
LoadFieldIL.MarkSequencePoint(doc6, 780, 1, 780, 100)
LoadFieldIL.Emit(OpCodes.Ldloc, 1)
Typ = GetType(FieldInfo)
Typ03 = Typ
...
LoadFieldIL.MarkSequencePoint(doc6, 781, 1, 781, 100)
LoadFieldIL.Emit(OpCodes.Ldloc, 1)
Typ = GetType(FieldInfo)
Typ03 = Typ
...
LoadFieldIL.MarkSequencePoint(doc6, 782, 1, 782, 100)
LoadFieldIL.Emit(OpCodes.Ldarg, 0)
Typ = GetType(System.Type)
Typ03 = Typ
...
LoadFieldIL.MarkSequencePoint(doc6, 783, 1, 783, 100)
Dim locbldr300 As LocalBuilder = LoadFieldIL.DeclareLocal(GetType(System.Object))
locbldr300.SetLocalSymInfo("nullref")
LoadFieldIL.Emit(OpCodes.Ldnull)
LoadFieldIL.Emit(OpCodes.Stloc, 16)
LoadFieldIL.MarkSequencePoint(doc6, 784, 1, 784, 100)
...
LoadFieldIL.MarkSequencePoint(doc6, 785, 1, 785, 100)
Dim typ104(-1) As Type
LoadFieldIL.Emit(OpCodes.Ldloc, 1)
Typ = GetType(FieldInfo)
Typ03 = Typ
LoadFieldIL.Emit(OpCodes.Ldloc, 16)
Typ = GetType(System.Object)
ReDim Preserve typ104(UBound(typ104) + 1)
typ104(UBound(typ104)) = Typ
LoadFieldIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("GetValue", typ104))
Typ = Typ03.GetMethod("GetValue", typ104).ReturnType
LoadFieldIL.Emit(OpCodes.Stsfld, FldLitVal)
LoadFieldIL.MarkSequencePoint(doc6, 786, 1, 786, 100)
Dim locbldr301 As LocalBuilder = LoadFieldIL.DeclareLocal(GetType(System.Object))
locbldr301.SetLocalSymInfo("obj")
LoadFieldIL.Emit(OpCodes.Ldsfld, FldLitVal)
Typ = FldLitVal.FieldType
LoadFieldIL.Emit(OpCodes.Stloc, 17)
LoadFieldIL.MarkSequencePoint(doc6, 787, 1, 787, 100)
LoadFieldIL.Emit(OpCodes.Ldloc, 17)
Typ = GetType(System.Object)
Typ03 = Typ
...
LoadFieldIL.MarkSequencePoint(doc6, 788, 1, 788, 100)
LoadFieldIL.Emit(OpCodes.Br, cont383)
LoadFieldIL.MarkLabel(fa383)
LoadFieldIL.Emit(OpCodes.Br, cont383)
LoadFieldIL.MarkLabel(cont383)
LoadFieldIL.MarkSequencePoint(doc6, 789, 1, 789, 100)
...
LoadFieldIL.MarkSequencePoint(doc6, 790, 1, 790, 100)
Dim typ106(-1) As Type
LoadFieldIL.Emit(OpCodes.Ldarg, 0)
Typ = GetType(System.Type)
ReDim Preserve typ106(UBound(typ106) + 1)
typ106(UBound(typ106)) = Typ
LoadFieldIL.Emit(OpCodes.Call, GetType(System.Enum).GetMethod("GetUnderlyingType", typ106))
Typ = GetType(System.Enum).GetMethod("GetUnderlyingType", typ106).ReturnType
LoadFieldIL.Emit(OpCodes.Stsfld, EnumLitTyp)
LoadFieldIL.MarkSequencePoint(doc6, 791, 1, 791, 100)
LoadFieldIL.Emit(OpCodes.Br, cont384)
LoadFieldIL.MarkLabel(fa384)
LoadFieldIL.Emit(OpCodes.Br, cont384)
LoadFieldIL.MarkLabel(cont384)
LoadFieldIL.MarkSequencePoint(doc6, 792, 1, 792, 100)
LoadFieldIL.Emit(OpCodes.Br, cont382)
LoadFieldIL.MarkLabel(fa382)
LoadFieldIL.Emit(OpCodes.Br, cont382)
LoadFieldIL.MarkLabel(cont382)
LoadFieldIL.MarkSequencePoint(doc6, 795, 1, 795, 100)
LoadFieldIL.Emit(OpCodes.Ldloc, 1)
Typ = GetType(FieldInfo)
LoadFieldIL.MarkSequencePoint(doc6, 797, 1, 797, 100)
...
Dim locbldr302 As LocalBuilder = PrintStringIL.DeclareLocal(GetType(System.String))
locbldr302.SetLocalSymInfo("str")
...
Dim locbldr303 As LocalBuilder = WriteClassIL.DeclareLocal(GetType(System.Boolean))
locbldr303.SetLocalSymInfo("isAbstract")
...
Dim locbldr304 As LocalBuilder = WriteClassIL.DeclareLocal(GetType(System.Boolean))
locbldr304.SetLocalSymInfo("isAnsi")
WriteClassIL.Emit(OpCodes.Ldarg, 0)
Typ = GetType(System.Type)
Typ03 = Typ
...
Dim locbldr305 As LocalBuilder = WriteClassIL.DeclareLocal(GetType(System.Boolean))
locbldr305.SetLocalSymInfo("isAutoChar")
WriteClassIL.Emit(OpCodes.Ldarg, 0)
Typ = GetType(System.Type)
Typ03 = Typ
...
Dim locbldr306 As LocalBuilder = WriteClassIL.DeclareLocal(GetType(System.Boolean))
locbldr306.SetLocalSymInfo("isAuto")
WriteClassIL.Emit(OpCodes.Ldarg, 0)
Typ = GetType(System.Type)
Typ03 = Typ
...
Dim locbldr307 As LocalBuilder = WriteClassIL.DeclareLocal(GetType(System.Boolean))
locbldr307.SetLocalSymInfo("isEnum")
WriteClassIL.Emit(OpCodes.Ldarg, 0)
Typ = GetType(System.Type)
Typ03 = Typ
...
Dim locbldr308 As LocalBuilder = WriteClassIL.DeclareLocal(GetType(System.Boolean))
locbldr308.SetLocalSymInfo("isInterface")
WriteClassIL.Emit(OpCodes.Ldarg, 0)
Typ = GetType(System.Type)
Typ03 = Typ
...
Dim locbldr309 As LocalBuilder = WriteClassIL.DeclareLocal(GetType(System.Boolean))
locbldr309.SetLocalSymInfo("isNestedPrivate")
WriteClassIL.Emit(OpCodes.Ldarg, 0)
Typ = GetType(System.Type)
Typ03 = Typ
...
Dim locbldr310 As LocalBuilder = WriteClassIL.DeclareLocal(GetType(System.Boolean))
locbldr310.SetLocalSymInfo("isNestedPublic")
WriteClassIL.Emit(OpCodes.Ldarg, 0)
Typ = GetType(System.Type)
Typ03 = Typ
...
Dim locbldr311 As LocalBuilder = WriteClassIL.DeclareLocal(GetType(System.Boolean))
locbldr311.SetLocalSymInfo("isPrivate")
WriteClassIL.Emit(OpCodes.Ldarg, 0)
Typ = GetType(System.Type)
Typ03 = Typ
...
Dim locbldr312 As LocalBuilder = WriteClassIL.DeclareLocal(GetType(System.Boolean))
locbldr312.SetLocalSymInfo("isPublic")
WriteClassIL.Emit(OpCodes.Ldarg, 0)
Typ = GetType(System.Type)
Typ03 = Typ
...
Dim locbldr313 As LocalBuilder = WriteClassIL.DeclareLocal(GetType(System.String))
locbldr313.SetLocalSymInfo("name")
WriteClassIL.Emit(OpCodes.Ldarg, 0)
Typ = GetType(System.Type)
Typ03 = Typ
...
Dim locbldr314 As LocalBuilder = WriteClassIL.DeclareLocal(GetType(System.Type))
locbldr314.SetLocalSymInfo("bt")
WriteClassIL.Emit(OpCodes.Ldarg, 0)
Typ = GetType(System.Type)
Typ03 = Typ
...
Dim locbldr315 As LocalBuilder = WriteClassIL.DeclareLocal(GetType(System.String))
locbldr315.SetLocalSymInfo("btstr")
