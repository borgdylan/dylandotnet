...
typ37(UBound(typ37)) = GetType(System.String)
Dim ProcessMSYSPath As MethodBuilder = ParseUtils.DefineMethod("ProcessMSYSPath", MethodAttributes.Public Or MethodAttributes.Static, GetType(System.String), typ37)
Dim ProcessMSYSPathIL As ILGenerator = ProcessMSYSPath.GetILGenerator()
Dim ProcessMSYSPathparam01 As ParameterBuilder = ProcessMSYSPath.DefineParameter(1, ParameterAttributes.None, "p")
ProcessMSYSPathIL.MarkSequencePoint(doc4, 356, 1, 356, 100)
Dim locbldr50 As LocalBuilder = ProcessMSYSPathIL.DeclareLocal(GetType(OperatingSystem))
locbldr50.SetLocalSymInfo("os")
ProcessMSYSPathIL.Emit(OpCodes.Call, GetType(Environment).GetMethod("get_OSVersion", Type.EmptyTypes))
Typ = GetType(Environment).GetMethod("get_OSVersion", Type.EmptyTypes).ReturnType
ProcessMSYSPathIL.Emit(OpCodes.Stloc, 0)
ProcessMSYSPathIL.MarkSequencePoint(doc4, 357, 1, 357, 100)
Dim locbldr51 As LocalBuilder = ProcessMSYSPathIL.DeclareLocal(GetType(PlatformID))
locbldr51.SetLocalSymInfo("platf")
ProcessMSYSPathIL.Emit(OpCodes.Ldloc, 0)
Typ = GetType(OperatingSystem)
Typ03 = Typ
ProcessMSYSPathIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("get_Platform", Type.EmptyTypes))
Typ = Typ03.GetMethod("get_Platform", Type.EmptyTypes).ReturnType
ProcessMSYSPathIL.Emit(OpCodes.Stloc, 1)
ProcessMSYSPathIL.MarkSequencePoint(doc4, 358, 1, 358, 100)
Dim locbldr52 As LocalBuilder = ProcessMSYSPathIL.DeclareLocal(GetType(PlatformID))
locbldr52.SetLocalSymInfo("winnt")
ProcessMSYSPathIL.Emit(OpCodes.Ldc_I4, CInt(2))
Typ = GetType(System.Int32)
ProcessMSYSPathIL.Emit(OpCodes.Stloc, 2)
ProcessMSYSPathIL.MarkSequencePoint(doc4, 359, 1, 359, 100)
Dim locbldr53 As LocalBuilder = ProcessMSYSPathIL.DeclareLocal(GetType(System.Boolean))
locbldr53.SetLocalSymInfo("b")
ProcessMSYSPathIL.Emit(OpCodes.Ldc_I4, 0)
Typ = GetType(System.Boolean)
ProcessMSYSPathIL.Emit(OpCodes.Stloc, 3)
ProcessMSYSPathIL.MarkSequencePoint(doc4, 360, 1, 360, 100)
Dim locbldr54 As LocalBuilder = ProcessMSYSPathIL.DeclareLocal(GetType(System.String).MakeArrayType())
locbldr54.SetLocalSymInfo("arr")
ProcessMSYSPathIL.MarkSequencePoint(doc4, 361, 1, 361, 100)
Dim locbldr55 As LocalBuilder = ProcessMSYSPathIL.DeclareLocal(GetType(System.String))
locbldr55.SetLocalSymInfo("str")
ProcessMSYSPathIL.MarkSequencePoint(doc4, 362, 1, 362, 100)
Dim locbldr56 As LocalBuilder = ProcessMSYSPathIL.DeclareLocal(GetType(System.Int32))
locbldr56.SetLocalSymInfo("num")
ProcessMSYSPathIL.Emit(OpCodes.Ldc_I4, CInt(0))
Typ = GetType(System.Int32)
ProcessMSYSPathIL.Emit(OpCodes.Stloc, 6)
ProcessMSYSPathIL.MarkSequencePoint(doc4, 364, 1, 364, 100)
ProcessMSYSPathIL.Emit(OpCodes.Ldloc, 1)
Typ = GetType(PlatformID)
ProcessMSYSPathIL.Emit(OpCodes.Ldloc, 2)
Typ = GetType(PlatformID)
Dim fa39 As System.Reflection.Emit.Label = ProcessMSYSPathIL.DefineLabel()
Dim tru39 As System.Reflection.Emit.Label = ProcessMSYSPathIL.DefineLabel()
Dim cont39 As System.Reflection.Emit.Label = ProcessMSYSPathIL.DefineLabel()
ProcessMSYSPathIL.Emit(OpCodes.Beq, tru39)
ProcessMSYSPathIL.Emit(OpCodes.Br, fa39)
ProcessMSYSPathIL.MarkLabel(tru39)
ProcessMSYSPathIL.MarkSequencePoint(doc4, 366, 1, 366, 100)
Dim typ39(-1) As Type
ProcessMSYSPathIL.Emit(OpCodes.Ldarg, 0)
Typ = GetType(System.String)
Typ03 = Typ
ProcessMSYSPathIL.Emit(OpCodes.Ldstr, "/")
Typ = GetType(System.String)
ReDim Preserve typ39(UBound(typ39) + 1)
typ39(UBound(typ39)) = Typ
ProcessMSYSPathIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("Contains", typ39))
Typ = Typ03.GetMethod("Contains", typ39).ReturnType
ProcessMSYSPathIL.Emit(OpCodes.Stloc, 3)
ProcessMSYSPathIL.MarkSequencePoint(doc4, 368, 1, 368, 100)
ProcessMSYSPathIL.Emit(OpCodes.Ldloc, 3)
Typ = GetType(System.Boolean)
ProcessMSYSPathIL.Emit(OpCodes.Ldc_I4, 1)
Typ = GetType(System.Boolean)
Dim fa40 As System.Reflection.Emit.Label = ProcessMSYSPathIL.DefineLabel()
Dim tru40 As System.Reflection.Emit.Label = ProcessMSYSPathIL.DefineLabel()
Dim cont40 As System.Reflection.Emit.Label = ProcessMSYSPathIL.DefineLabel()
ProcessMSYSPathIL.Emit(OpCodes.Beq, tru40)
ProcessMSYSPathIL.Emit(OpCodes.Br, fa40)
ProcessMSYSPathIL.MarkLabel(tru40)
ProcessMSYSPathIL.MarkSequencePoint(doc4, 370, 1, 370, 100)
Dim typ40(-1) As Type
ProcessMSYSPathIL.Emit(OpCodes.Ldarg, 0)
Typ = GetType(System.String)
Typ03 = Typ
ProcessMSYSPathIL.Emit(OpCodes.Ldstr, "/")
Typ = GetType(System.String)
Dim typ41 As Type() = {Typ}
ProcessMSYSPathIL.Emit(OpCodes.Call, GetType(System.Convert).GetMethod("ToChar", typ41))
Typ = GetType(System.Convert).GetMethod("ToChar", typ41).ReturnType
ReDim Preserve typ40(UBound(typ40) + 1)
typ40(UBound(typ40)) = Typ
ProcessMSYSPathIL.Emit(OpCodes.Ldstr, "\")
Typ = GetType(System.String)
Dim typ42 As Type() = {Typ}
ProcessMSYSPathIL.Emit(OpCodes.Call, GetType(System.Convert).GetMethod("ToChar", typ42))
Typ = GetType(System.Convert).GetMethod("ToChar", typ42).ReturnType
ReDim Preserve typ40(UBound(typ40) + 1)
typ40(UBound(typ40)) = Typ
ProcessMSYSPathIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("Replace", typ40))
Typ = Typ03.GetMethod("Replace", typ40).ReturnType
ProcessMSYSPathIL.Emit(OpCodes.Starg, 0)
ProcessMSYSPathIL.MarkSequencePoint(doc4, 372, 1, 372, 100)
Dim typ43(-1) As Type
ProcessMSYSPathIL.Emit(OpCodes.Ldarg, 0)
Typ = GetType(System.String)
ReDim Preserve typ43(UBound(typ43) + 1)
typ43(UBound(typ43)) = Typ
ProcessMSYSPathIL.Emit(OpCodes.Call, GetType(File).GetMethod("Exists", typ43))
Typ = GetType(File).GetMethod("Exists", typ43).ReturnType
ProcessMSYSPathIL.Emit(OpCodes.Stloc, 3)
ProcessMSYSPathIL.MarkSequencePoint(doc4, 374, 1, 374, 100)
ProcessMSYSPathIL.Emit(OpCodes.Ldloc, 3)
Typ = GetType(System.Boolean)
ProcessMSYSPathIL.Emit(OpCodes.Ldc_I4, 0)
Typ = GetType(System.Boolean)
Dim fa41 As System.Reflection.Emit.Label = ProcessMSYSPathIL.DefineLabel()
Dim tru41 As System.Reflection.Emit.Label = ProcessMSYSPathIL.DefineLabel()
Dim cont41 As System.Reflection.Emit.Label = ProcessMSYSPathIL.DefineLabel()
ProcessMSYSPathIL.Emit(OpCodes.Beq, tru41)
ProcessMSYSPathIL.Emit(OpCodes.Br, fa41)
ProcessMSYSPathIL.MarkLabel(tru41)
ProcessMSYSPathIL.MarkSequencePoint(doc4, 376, 1, 376, 100)
Dim typ44(-1) As Type
ProcessMSYSPathIL.Emit(OpCodes.Ldarg, 0)
Typ = GetType(System.String)
...
ReDim Preserve typ44(UBound(typ44) + 1)
typ44(UBound(typ44)) = Typ
ProcessMSYSPathIL.Emit(OpCodes.Call, StringParser)
Typ = StringParser.ReturnType
ProcessMSYSPathIL.Emit(OpCodes.Stloc, 4)
ProcessMSYSPathIL.MarkSequencePoint(doc4, 378, 1, 378, 100)
ProcessMSYSPathIL.Emit(OpCodes.Ldloc, 4)
Typ = GetType(System.String).MakeArrayType()
Typ02 = Typ
ProcessMSYSPathIL.Emit(OpCodes.Ldc_I4, CInt(0))
Typ = GetType(System.Int32)
ProcessMSYSPathIL.Emit(OpCodes.Conv_U)
Typ = Typ02
ProcessMSYSPathIL.Emit(OpCodes.Ldelem, GetType(System.String).MakeArrayType().GetElementType())
Typ = GetType(System.String).MakeArrayType().GetElementType()
ProcessMSYSPathIL.Emit(OpCodes.Stloc, 5)
ProcessMSYSPathIL.MarkSequencePoint(doc4, 379, 1, 379, 100)
ProcessMSYSPathIL.Emit(OpCodes.Ldloc, 5)
Typ = GetType(System.String)
Typ03 = Typ
ProcessMSYSPathIL.Emit(OpCodes.Callvirt, Typ03.GetMethod("get_Length", Type.EmptyTypes))
Typ = Typ03.GetMethod("get_Length", Type.EmptyTypes).ReturnType
ProcessMSYSPathIL.Emit(OpCodes.Stloc, 6)
ProcessMSYSPathIL.MarkSequencePoint(doc4, 381, 1, 381, 100)
ProcessMSYSPathIL.Emit(OpCodes.Ldloc, 6)
Typ = GetType(System.Int32)
ProcessMSYSPathIL.Emit(OpCodes.Ldc_I4, CInt(1))
Typ = GetType(System.Int32)
Dim fa42 As System.Reflection.Emit.Label = ProcessMSYSPathIL.DefineLabel()
Dim tru42 As System.Reflection.Emit.Label = ProcessMSYSPathIL.DefineLabel()
Dim cont42 As System.Reflection.Emit.Label = ProcessMSYSPathIL.DefineLabel()
ProcessMSYSPathIL.Emit(OpCodes.Beq, tru42)
ProcessMSYSPathIL.Emit(OpCodes.Br, fa42)
ProcessMSYSPathIL.MarkLabel(tru42)
ProcessMSYSPathIL.MarkSequencePoint(doc4, 382, 1, 382, 100)
Dim typ46(-1) As Type
ProcessMSYSPathIL.Emit(OpCodes.Ldloc, 5)
Typ = GetType(System.String)
...
ReDim Preserve typ46(UBound(typ46) + 1)
typ46(UBound(typ46)) = Typ
ProcessMSYSPathIL.Emit(OpCodes.Call, GetType(String).GetMethod("Concat", typ46))
Typ = GetType(String).GetMethod("Concat", typ46).ReturnType
ProcessMSYSPathIL.Emit(OpCodes.Stloc, 5)
ProcessMSYSPathIL.MarkSequencePoint(doc4, 383, 1, 383, 100)
ProcessMSYSPathIL.Emit(OpCodes.Ldloc, 4)
Typ = GetType(System.String).MakeArrayType()
Typ02 = Typ
ProcessMSYSPathIL.Emit(OpCodes.Ldc_I4, CInt(0))
...
ProcessMSYSPathIL.Emit(OpCodes.Ldloc, 5)
Typ = GetType(System.String)
ProcessMSYSPathIL.Emit(OpCodes.Stelem, GetType(System.String).MakeArrayType().GetElementType())
ProcessMSYSPathIL.MarkSequencePoint(doc4, 384, 1, 384, 100)
ProcessMSYSPathIL.Emit(OpCodes.Br, cont42)
ProcessMSYSPathIL.MarkLabel(fa42)
ProcessMSYSPathIL.Emit(OpCodes.Br, cont42)
ProcessMSYSPathIL.MarkLabel(cont42)
ProcessMSYSPathIL.MarkSequencePoint(doc4, 386, 1, 386, 100)
Dim typ47(-1) As Type
ProcessMSYSPathIL.Emit(OpCodes.Ldstr, "\")
Typ = GetType(System.String)
...
ReDim Preserve typ47(UBound(typ47) + 1)
typ47(UBound(typ47)) = Typ
ProcessMSYSPathIL.Emit(OpCodes.Call, GetType(String).GetMethod("Join", typ47))
Typ = GetType(String).GetMethod("Join", typ47).ReturnType
ProcessMSYSPathIL.Emit(OpCodes.Starg, 0)
ProcessMSYSPathIL.MarkSequencePoint(doc4, 388, 1, 388, 100)
ProcessMSYSPathIL.Emit(OpCodes.Br, cont41)
ProcessMSYSPathIL.MarkLabel(fa41)
ProcessMSYSPathIL.Emit(OpCodes.Br, cont41)
ProcessMSYSPathIL.MarkLabel(cont41)
ProcessMSYSPathIL.MarkSequencePoint(doc4, 390, 1, 390, 100)
ProcessMSYSPathIL.Emit(OpCodes.Br, cont40)
ProcessMSYSPathIL.MarkLabel(fa40)
ProcessMSYSPathIL.Emit(OpCodes.Br, cont40)
ProcessMSYSPathIL.MarkLabel(cont40)
ProcessMSYSPathIL.MarkSequencePoint(doc4, 392, 1, 392, 100)
ProcessMSYSPathIL.Emit(OpCodes.Br, cont39)
ProcessMSYSPathIL.MarkLabel(fa39)
ProcessMSYSPathIL.Emit(OpCodes.Br, cont39)
ProcessMSYSPathIL.MarkLabel(cont39)
ProcessMSYSPathIL.MarkSequencePoint(doc4, 394, 1, 394, 100)
ProcessMSYSPathIL.Emit(OpCodes.Ldarg, 0)
Typ = GetType(System.String)
ProcessMSYSPathIL.MarkSequencePoint(doc4, 395, 1, 395, 100)
ProcessMSYSPathIL.Emit(OpCodes.Ret)
...
ReadStringIL.MarkSequencePoint(doc5, 12, 1, 12, 100)
...
ReadStringIL.MarkSequencePoint(doc5, 13, 1, 13, 100)
...
ReadIntegerIL.MarkSequencePoint(doc5, 16, 1, 16, 100)
...
ReadIntegerIL.MarkSequencePoint(doc5, 17, 1, 17, 100)
...
ReadSbyteIL.MarkSequencePoint(doc5, 20, 1, 20, 100)
...
ReadSbyteIL.MarkSequencePoint(doc5, 21, 1, 21, 100)
...
ReadShortIL.MarkSequencePoint(doc5, 24, 1, 24, 100)
...
ReadShortIL.MarkSequencePoint(doc5, 25, 1, 25, 100)
...
ReadLongIL.MarkSequencePoint(doc5, 28, 1, 28, 100)
...
ReadLongIL.MarkSequencePoint(doc5, 29, 1, 29, 100)
...
ReadSingleIL.MarkSequencePoint(doc5, 32, 1, 32, 100)
...
ReadSingleIL.MarkSequencePoint(doc5, 33, 1, 33, 100)
...
ReadDoubleIL.MarkSequencePoint(doc5, 36, 1, 36, 100)
...
ReadDoubleIL.MarkSequencePoint(doc5, 37, 1, 37, 100)
...
ReadBooleanIL.MarkSequencePoint(doc5, 44, 1, 44, 100)
...
ReadBooleanIL.MarkSequencePoint(doc5, 45, 1, 45, 100)
...
InitInSIL.MarkSequencePoint(doc6, 30, 1, 30, 100)
InitInSIL.Emit(OpCodes.Ldsfld, InS)
Typ = InS.FieldType
InitInSIL.Emit(OpCodes.Ldnull)
Dim fa43 As System.Reflection.Emit.Label = InitInSIL.DefineLabel()
Dim tru43 As System.Reflection.Emit.Label = InitInSIL.DefineLabel()
Dim cont43 As System.Reflection.Emit.Label = InitInSIL.DefineLabel()
InitInSIL.Emit(OpCodes.Beq, fa43)
InitInSIL.Emit(OpCodes.Br, tru43)
InitInSIL.MarkLabel(tru43)
InitInSIL.MarkSequencePoint(doc6, 31, 1, 31, 100)
InitInSIL.Emit(OpCodes.Ldsfld, InS)
Typ = InS.FieldType
Typ03 = Typ
...
End If
InitInSIL.MarkSequencePoint(doc6, 32, 1, 32, 100)
InitInSIL.Emit(OpCodes.Br, cont43)
InitInSIL.MarkLabel(fa43)
InitInSIL.Emit(OpCodes.Br, cont43)
InitInSIL.MarkLabel(cont43)
InitInSIL.MarkSequencePoint(doc6, 33, 1, 33, 100)
Dim typ2(-1) As Type
...
InitInSIL.MarkSequencePoint(doc6, 34, 1, 34, 100)
...
InitOutSIL.MarkSequencePoint(doc6, 37, 1, 37, 100)
InitOutSIL.Emit(OpCodes.Ldsfld, OutS)
Typ = OutS.FieldType
InitOutSIL.Emit(OpCodes.Ldnull)
Dim fa44 As System.Reflection.Emit.Label = InitOutSIL.DefineLabel()
Dim tru44 As System.Reflection.Emit.Label = InitOutSIL.DefineLabel()
Dim cont44 As System.Reflection.Emit.Label = InitOutSIL.DefineLabel()
InitOutSIL.Emit(OpCodes.Beq, fa44)
InitOutSIL.Emit(OpCodes.Br, tru44)
InitOutSIL.MarkLabel(tru44)
InitOutSIL.MarkSequencePoint(doc6, 38, 1, 38, 100)
InitOutSIL.Emit(OpCodes.Ldsfld, OutS)
Typ = OutS.FieldType
Typ03 = Typ
...
End If
InitOutSIL.MarkSequencePoint(doc6, 39, 1, 39, 100)
InitOutSIL.Emit(OpCodes.Br, cont44)
InitOutSIL.MarkLabel(fa44)
InitOutSIL.Emit(OpCodes.Br, cont44)
InitOutSIL.MarkLabel(cont44)
InitOutSIL.MarkSequencePoint(doc6, 40, 1, 40, 100)
Dim typ5(-1) As Type
...
InitOutSIL.MarkSequencePoint(doc6, 41, 1, 41, 100)
...
InitInOutSWithStdIL.MarkSequencePoint(doc6, 44, 1, 44, 100)
Dim typ6(-1) As Type
...
End If
InitInOutSWithStdIL.MarkSequencePoint(doc6, 45, 1, 45, 100)
Dim typ7(-1) As Type
...
InitInOutSWithStdIL.Emit(OpCodes.Pop)
End If
InitInOutSWithStdIL.MarkSequencePoint(doc6, 46, 1, 46, 100)
...
CloseInSIL.MarkSequencePoint(doc6, 49, 1, 49, 100)
CloseInSIL.Emit(OpCodes.Ldsfld, InS)
Typ = InS.FieldType
CloseInSIL.Emit(OpCodes.Ldnull)
Dim fa45 As System.Reflection.Emit.Label = CloseInSIL.DefineLabel()
Dim tru45 As System.Reflection.Emit.Label = CloseInSIL.DefineLabel()
Dim cont45 As System.Reflection.Emit.Label = CloseInSIL.DefineLabel()
CloseInSIL.Emit(OpCodes.Beq, fa45)
CloseInSIL.Emit(OpCodes.Br, tru45)
CloseInSIL.MarkLabel(tru45)
CloseInSIL.MarkSequencePoint(doc6, 50, 1, 50, 100)
CloseInSIL.Emit(OpCodes.Ldsfld, InS)
Typ = InS.FieldType
Typ03 = Typ
...
End If
CloseInSIL.MarkSequencePoint(doc6, 51, 1, 51, 100)
CloseInSIL.Emit(OpCodes.Ldnull)
CloseInSIL.Emit(OpCodes.Stsfld, InS)
CloseInSIL.MarkSequencePoint(doc6, 52, 1, 52, 100)
CloseInSIL.Emit(OpCodes.Br, cont45)
CloseInSIL.MarkLabel(fa45)
CloseInSIL.Emit(OpCodes.Br, cont45)
CloseInSIL.MarkLabel(cont45)
CloseInSIL.MarkSequencePoint(doc6, 53, 1, 53, 100)
...
CloseOutSIL.MarkSequencePoint(doc6, 56, 1, 56, 100)
CloseOutSIL.Emit(OpCodes.Ldsfld, OutS)
Typ = OutS.FieldType
CloseOutSIL.Emit(OpCodes.Ldnull)
Dim fa46 As System.Reflection.Emit.Label = CloseOutSIL.DefineLabel()
Dim tru46 As System.Reflection.Emit.Label = CloseOutSIL.DefineLabel()
Dim cont46 As System.Reflection.Emit.Label = CloseOutSIL.DefineLabel()
CloseOutSIL.Emit(OpCodes.Beq, fa46)
CloseOutSIL.Emit(OpCodes.Br, tru46)
CloseOutSIL.MarkLabel(tru46)
CloseOutSIL.MarkSequencePoint(doc6, 57, 1, 57, 100)
CloseOutSIL.Emit(OpCodes.Ldsfld, OutS)
Typ = OutS.FieldType
Typ03 = Typ
...
End If
CloseOutSIL.MarkSequencePoint(doc6, 58, 1, 58, 100)
CloseOutSIL.Emit(OpCodes.Ldnull)
CloseOutSIL.Emit(OpCodes.Stsfld, OutS)
CloseOutSIL.MarkSequencePoint(doc6, 59, 1, 59, 100)
CloseOutSIL.Emit(OpCodes.Br, cont46)
CloseOutSIL.MarkLabel(fa46)
CloseOutSIL.Emit(OpCodes.Br, cont46)
CloseOutSIL.MarkLabel(cont46)
CloseOutSIL.MarkSequencePoint(doc6, 60, 1, 60, 100)
...
ReadLineIL.MarkSequencePoint(doc6, 63, 1, 63, 100)
ReadLineIL.Emit(OpCodes.Ldsfld, UseConsole)
Typ = UseConsole.FieldType
ReadLineIL.Emit(OpCodes.Ldc_I4, 0)
Typ = GetType(System.Boolean)
Dim fa47 As System.Reflection.Emit.Label = ReadLineIL.DefineLabel()
Dim tru47 As System.Reflection.Emit.Label = ReadLineIL.DefineLabel()
Dim cont47 As System.Reflection.Emit.Label = ReadLineIL.DefineLabel()
ReadLineIL.Emit(OpCodes.Beq, tru47)
ReadLineIL.Emit(OpCodes.Br, fa47)
ReadLineIL.MarkLabel(tru47)
ReadLineIL.MarkSequencePoint(doc6, 64, 1, 64, 100)
ReadLineIL.Emit(OpCodes.Ldsfld, InS)
Typ = InS.FieldType
ReadLineIL.Emit(OpCodes.Ldnull)
Dim fa48 As System.Reflection.Emit.Label = ReadLineIL.DefineLabel()
Dim tru48 As System.Reflection.Emit.Label = ReadLineIL.DefineLabel()
Dim cont48 As System.Reflection.Emit.Label = ReadLineIL.DefineLabel()
ReadLineIL.Emit(OpCodes.Beq, fa48)
ReadLineIL.Emit(OpCodes.Br, tru48)
ReadLineIL.MarkLabel(tru48)
ReadLineIL.MarkSequencePoint(doc6, 65, 1, 65, 100)
ReadLineIL.Emit(OpCodes.Ldsfld, InS)
Typ = InS.FieldType
Typ03 = Typ
...
ReadLineIL.MarkSequencePoint(doc6, 66, 1, 66, 100)
ReadLineIL.Emit(OpCodes.Br, cont48)
ReadLineIL.MarkLabel(fa48)
ReadLineIL.MarkSequencePoint(doc6, 67, 1, 67, 100)
ReadLineIL.Emit(OpCodes.Ldstr, "")
Typ = GetType(System.String)
ReadLineIL.MarkSequencePoint(doc6, 68, 1, 68, 100)
ReadLineIL.Emit(OpCodes.Br, cont48)
ReadLineIL.MarkLabel(cont48)
ReadLineIL.MarkSequencePoint(doc6, 69, 1, 69, 100)
ReadLineIL.Emit(OpCodes.Br, cont47)
ReadLineIL.MarkLabel(fa47)
ReadLineIL.MarkSequencePoint(doc6, 70, 1, 70, 100)
ReadLineIL.Emit(OpCodes.Call, GetType(Console).GetMethod("ReadLine", Type.EmptyTypes))
Typ = GetType(Console).GetMethod("ReadLine", Type.EmptyTypes).ReturnType
ReadLineIL.MarkSequencePoint(doc6, 71, 1, 71, 100)
ReadLineIL.Emit(OpCodes.Br, cont47)
ReadLineIL.MarkLabel(cont47)
ReadLineIL.MarkSequencePoint(doc6, 72, 1, 72, 100)
...
WriteLineIL.MarkSequencePoint(doc6, 75, 1, 75, 100)
WriteLineIL.Emit(OpCodes.Ldsfld, UseConsole)
Typ = UseConsole.FieldType
WriteLineIL.Emit(OpCodes.Ldc_I4, 0)
Typ = GetType(System.Boolean)
Dim fa49 As System.Reflection.Emit.Label = WriteLineIL.DefineLabel()
Dim tru49 As System.Reflection.Emit.Label = WriteLineIL.DefineLabel()
Dim cont49 As System.Reflection.Emit.Label = WriteLineIL.DefineLabel()
WriteLineIL.Emit(OpCodes.Beq, tru49)
WriteLineIL.Emit(OpCodes.Br, fa49)
WriteLineIL.MarkLabel(tru49)
WriteLineIL.MarkSequencePoint(doc6, 76, 1, 76, 100)
WriteLineIL.Emit(OpCodes.Ldsfld, OutS)
Typ = OutS.FieldType
WriteLineIL.Emit(OpCodes.Ldnull)
Dim fa50 As System.Reflection.Emit.Label = WriteLineIL.DefineLabel()
Dim tru50 As System.Reflection.Emit.Label = WriteLineIL.DefineLabel()
Dim cont50 As System.Reflection.Emit.Label = WriteLineIL.DefineLabel()
WriteLineIL.Emit(OpCodes.Beq, fa50)
WriteLineIL.Emit(OpCodes.Br, tru50)
WriteLineIL.MarkLabel(tru50)
WriteLineIL.MarkSequencePoint(doc6, 77, 1, 77, 100)
Dim typ12(-1) As Type
WriteLineIL.Emit(OpCodes.Ldsfld, OutS)
Typ = OutS.FieldType
Typ03 = Typ
...
End If
WriteLineIL.MarkSequencePoint(doc6, 78, 1, 78, 100)
WriteLineIL.Emit(OpCodes.Br, cont50)
WriteLineIL.MarkLabel(fa50)
WriteLineIL.MarkSequencePoint(doc6, 79, 1, 79, 100)
WriteLineIL.Emit(OpCodes.Br, cont50)
WriteLineIL.MarkLabel(cont50)
WriteLineIL.MarkSequencePoint(doc6, 80, 1, 80, 100)
WriteLineIL.Emit(OpCodes.Br, cont49)
WriteLineIL.MarkLabel(fa49)
WriteLineIL.MarkSequencePoint(doc6, 81, 1, 81, 100)
Dim typ13(-1) As Type
WriteLineIL.Emit(OpCodes.Ldarg, 0)
Typ = GetType(System.String)
ReDim Preserve typ13(UBound(typ13) + 1)
...
WriteLineIL.Emit(OpCodes.Pop)
End If
WriteLineIL.MarkSequencePoint(doc6, 82, 1, 82, 100)
WriteLineIL.Emit(OpCodes.Br, cont49)
WriteLineIL.MarkLabel(cont49)
WriteLineIL.MarkSequencePoint(doc6, 83, 1, 83, 100)
...
WriteIL.MarkSequencePoint(doc6, 86, 1, 86, 100)
WriteIL.Emit(OpCodes.Ldsfld, UseConsole)
Typ = UseConsole.FieldType
WriteIL.Emit(OpCodes.Ldc_I4, 0)
Typ = GetType(System.Boolean)
Dim fa51 As System.Reflection.Emit.Label = WriteIL.DefineLabel()
Dim tru51 As System.Reflection.Emit.Label = WriteIL.DefineLabel()
Dim cont51 As System.Reflection.Emit.Label = WriteIL.DefineLabel()
WriteIL.Emit(OpCodes.Beq, tru51)
WriteIL.Emit(OpCodes.Br, fa51)
WriteIL.MarkLabel(tru51)
WriteIL.MarkSequencePoint(doc6, 87, 1, 87, 100)
WriteIL.Emit(OpCodes.Ldsfld, OutS)
Typ = OutS.FieldType
WriteIL.Emit(OpCodes.Ldnull)
Dim fa52 As System.Reflection.Emit.Label = WriteIL.DefineLabel()
Dim tru52 As System.Reflection.Emit.Label = WriteIL.DefineLabel()
Dim cont52 As System.Reflection.Emit.Label = WriteIL.DefineLabel()
WriteIL.Emit(OpCodes.Beq, fa52)
WriteIL.Emit(OpCodes.Br, tru52)
WriteIL.MarkLabel(tru52)
WriteIL.MarkSequencePoint(doc6, 88, 1, 88, 100)
Dim typ15(-1) As Type
WriteIL.Emit(OpCodes.Ldsfld, OutS)
Typ = OutS.FieldType
Typ03 = Typ
...
End If
WriteIL.MarkSequencePoint(doc6, 89, 1, 89, 100)
WriteIL.Emit(OpCodes.Br, cont52)
WriteIL.MarkLabel(fa52)
WriteIL.MarkSequencePoint(doc6, 90, 1, 90, 100)
WriteIL.Emit(OpCodes.Br, cont52)
WriteIL.MarkLabel(cont52)
WriteIL.MarkSequencePoint(doc6, 91, 1, 91, 100)
WriteIL.Emit(OpCodes.Br, cont51)
WriteIL.MarkLabel(fa51)
WriteIL.MarkSequencePoint(doc6, 92, 1, 92, 100)
Dim typ16(-1) As Type
WriteIL.Emit(OpCodes.Ldarg, 0)
Typ = GetType(System.String)
ReDim Preserve typ16(UBound(typ16) + 1)
...
WriteIL.Emit(OpCodes.Pop)
End If
WriteIL.MarkSequencePoint(doc6, 93, 1, 93, 100)
WriteIL.Emit(OpCodes.Br, cont51)
WriteIL.MarkLabel(cont51)
WriteIL.MarkSequencePoint(doc6, 94, 1, 94, 100)
...
ReDim Preserve typ17(UBound(typ17) + 1)
typ17(UBound(typ17)) = GetType(System.String)
Dim WriteWarn As MethodBuilder = StreamUtils.DefineMethod("WriteWarn", MethodAttributes.Public Or MethodAttributes.Static, GetType(System.Void), typ17)
Dim WriteWarnIL As ILGenerator = WriteWarn.GetILGenerator()
Dim WriteWarnparam01 As ParameterBuilder = WriteWarn.DefineParameter(1, ParameterAttributes.None, "line")
Dim WriteWarnparam02 As ParameterBuilder = WriteWarn.DefineParameter(2, ParameterAttributes.None, "file")
Dim WriteWarnparam03 As ParameterBuilder = WriteWarn.DefineParameter(3, ParameterAttributes.None, "msg")
WriteWarnIL.MarkSequencePoint(doc6, 98, 1, 98, 100)
Dim locbldr57 As LocalBuilder = WriteWarnIL.DeclareLocal(GetType(System.String))
locbldr57.SetLocalSymInfo("str")
Dim typ18(-1) As Type
WriteWarnIL.Emit(OpCodes.Ldstr, "WARNING: ")
Typ = GetType(System.String)
ReDim Preserve typ18(UBound(typ18) + 1)
typ18(UBound(typ18)) = Typ
WriteWarnIL.Emit(OpCodes.Ldarg, 2)
Typ = GetType(System.String)
ReDim Preserve typ18(UBound(typ18) + 1)
typ18(UBound(typ18)) = Typ
WriteWarnIL.Emit(OpCodes.Ldstr, " at line ")
Typ = GetType(System.String)
ReDim Preserve typ18(UBound(typ18) + 1)
typ18(UBound(typ18)) = Typ
WriteWarnIL.Emit(OpCodes.Ldarg, 0)
Typ = GetType(System.Int32)
Dim typ19 As Type() = {Typ}
WriteWarnIL.Emit(OpCodes.Call, GetType(System.Convert).GetMethod("ToString", typ19))
Typ = GetType(System.Convert).GetMethod("ToString", typ19).ReturnType
ReDim Preserve typ18(UBound(typ18) + 1)
typ18(UBound(typ18)) = Typ
WriteWarnIL.Emit(OpCodes.Call, GetType(String).GetMethod("Concat", typ18))
Typ = GetType(String).GetMethod("Concat", typ18).ReturnType
WriteWarnIL.Emit(OpCodes.Stloc, 0)
WriteWarnIL.MarkSequencePoint(doc6, 99, 1, 99, 100)
Dim typ20(-1) As Type
WriteWarnIL.Emit(OpCodes.Ldloc, 0)
Typ = GetType(System.String)
ReDim Preserve typ20(UBound(typ20) + 1)
typ20(UBound(typ20)) = Typ
WriteWarnIL.Emit(OpCodes.Ldstr, " in file: ")
Typ = GetType(System.String)
ReDim Preserve typ20(UBound(typ20) + 1)
typ20(UBound(typ20)) = Typ
WriteWarnIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(System.String)
ReDim Preserve typ20(UBound(typ20) + 1)
typ20(UBound(typ20)) = Typ
WriteWarnIL.Emit(OpCodes.Call, GetType(String).GetMethod("Concat", typ20))
Typ = GetType(String).GetMethod("Concat", typ20).ReturnType
WriteWarnIL.Emit(OpCodes.Stloc, 0)
WriteWarnIL.MarkSequencePoint(doc6, 100, 1, 100, 100)
Dim typ21(-1) As Type
WriteWarnIL.Emit(OpCodes.Ldloc, 0)
Typ = GetType(System.String)
ReDim Preserve typ21(UBound(typ21) + 1)
typ21(UBound(typ21)) = Typ
WriteWarnIL.Emit(OpCodes.Call, WriteLine)
Typ = WriteLine.ReturnType
If Typ.ToString() = GetType(System.Void).ToString() Then

Else
WriteWarnIL.Emit(OpCodes.Pop)
End If
WriteWarnIL.MarkSequencePoint(doc6, 102, 1, 102, 100)
WriteWarnIL.Emit(OpCodes.Ret)
Dim typ22(-1) As Type
ReDim Preserve typ22(UBound(typ22) + 1)
typ22(UBound(typ22)) = GetType(System.Int32)
ReDim Preserve typ22(UBound(typ22) + 1)
typ22(UBound(typ22)) = GetType(System.String)
ReDim Preserve typ22(UBound(typ22) + 1)
typ22(UBound(typ22)) = GetType(System.String)
Dim WriteError As MethodBuilder = StreamUtils.DefineMethod("WriteError", MethodAttributes.Public Or MethodAttributes.Static, GetType(System.Void), typ22)
Dim WriteErrorIL As ILGenerator = WriteError.GetILGenerator()
Dim WriteErrorparam01 As ParameterBuilder = WriteError.DefineParameter(1, ParameterAttributes.None, "line")
Dim WriteErrorparam02 As ParameterBuilder = WriteError.DefineParameter(2, ParameterAttributes.None, "file")
Dim WriteErrorparam03 As ParameterBuilder = WriteError.DefineParameter(3, ParameterAttributes.None, "msg")
WriteErrorIL.MarkSequencePoint(doc6, 106, 1, 106, 100)
Dim locbldr58 As LocalBuilder = WriteErrorIL.DeclareLocal(GetType(System.String))
locbldr58.SetLocalSymInfo("str")
Dim typ23(-1) As Type
WriteErrorIL.Emit(OpCodes.Ldstr, "ERROR: ")
Typ = GetType(System.String)
ReDim Preserve typ23(UBound(typ23) + 1)
typ23(UBound(typ23)) = Typ
WriteErrorIL.Emit(OpCodes.Ldarg, 2)
Typ = GetType(System.String)
ReDim Preserve typ23(UBound(typ23) + 1)
typ23(UBound(typ23)) = Typ
WriteErrorIL.Emit(OpCodes.Ldstr, " at line ")
Typ = GetType(System.String)
ReDim Preserve typ23(UBound(typ23) + 1)
typ23(UBound(typ23)) = Typ
WriteErrorIL.Emit(OpCodes.Ldarg, 0)
Typ = GetType(System.Int32)
Dim typ24 As Type() = {Typ}
WriteErrorIL.Emit(OpCodes.Call, GetType(System.Convert).GetMethod("ToString", typ24))
Typ = GetType(System.Convert).GetMethod("ToString", typ24).ReturnType
ReDim Preserve typ23(UBound(typ23) + 1)
typ23(UBound(typ23)) = Typ
WriteErrorIL.Emit(OpCodes.Call, GetType(String).GetMethod("Concat", typ23))
Typ = GetType(String).GetMethod("Concat", typ23).ReturnType
WriteErrorIL.Emit(OpCodes.Stloc, 0)
WriteErrorIL.MarkSequencePoint(doc6, 107, 1, 107, 100)
Dim typ25(-1) As Type
WriteErrorIL.Emit(OpCodes.Ldloc, 0)
Typ = GetType(System.String)
ReDim Preserve typ25(UBound(typ25) + 1)
typ25(UBound(typ25)) = Typ
WriteErrorIL.Emit(OpCodes.Ldstr, " in file: ")
Typ = GetType(System.String)
ReDim Preserve typ25(UBound(typ25) + 1)
typ25(UBound(typ25)) = Typ
WriteErrorIL.Emit(OpCodes.Ldarg, 1)
Typ = GetType(System.String)
ReDim Preserve typ25(UBound(typ25) + 1)
typ25(UBound(typ25)) = Typ
WriteErrorIL.Emit(OpCodes.Call, GetType(String).GetMethod("Concat", typ25))
Typ = GetType(String).GetMethod("Concat", typ25).ReturnType
WriteErrorIL.Emit(OpCodes.Stloc, 0)
WriteErrorIL.MarkSequencePoint(doc6, 108, 1, 108, 100)
Dim typ26(-1) As Type
WriteErrorIL.Emit(OpCodes.Ldloc, 0)
Typ = GetType(System.String)
ReDim Preserve typ26(UBound(typ26) + 1)
typ26(UBound(typ26)) = Typ
WriteErrorIL.Emit(OpCodes.Call, WriteLine)
Typ = WriteLine.ReturnType
If Typ.ToString() = GetType(System.Void).ToString() Then

Else
WriteErrorIL.Emit(OpCodes.Pop)
End If
WriteErrorIL.MarkSequencePoint(doc6, 109, 1, 109, 100)
WriteErrorIL.Emit(OpCodes.Call, CloseInS)
Typ = CloseInS.ReturnType
If Typ.ToString() = GetType(System.Void).ToString() Then

Else
WriteErrorIL.Emit(OpCodes.Pop)
End If
WriteErrorIL.MarkSequencePoint(doc6, 110, 1, 110, 100)
WriteErrorIL.Emit(OpCodes.Call, CloseOutS)
Typ = CloseOutS.ReturnType
If Typ.ToString() = GetType(System.Void).ToString() Then

Else
WriteErrorIL.Emit(OpCodes.Pop)
End If
WriteErrorIL.MarkSequencePoint(doc6, 111, 1, 111, 100)
Dim typ27(-1) As Type
WriteErrorIL.Emit(OpCodes.Ldc_I4, CInt(1))
Typ = GetType(System.Int32)
ReDim Preserve typ27(UBound(typ27) + 1)
typ27(UBound(typ27)) = Typ
WriteErrorIL.Emit(OpCodes.Call, GetType(Environment).GetMethod("Exit", typ27))
Typ = GetType(Environment).GetMethod("Exit", typ27).ReturnType
If Typ.ToString() = GetType(System.Void).ToString() Then

Else
WriteErrorIL.Emit(OpCodes.Pop)
End If
WriteErrorIL.MarkSequencePoint(doc6, 113, 1, 113, 100)
WriteErrorIL.Emit(OpCodes.Ret)
